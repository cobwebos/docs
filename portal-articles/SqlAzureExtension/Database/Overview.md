---
title: "SQL 数据库概述 |Microsoft 文档"
description: "在 Azure 门户中的 SQL 数据库概述的帮助内容"
...
Azure SQL 数据库是使用 Microsoft SQL Server 引擎的关系数据库即服务。 SQL 数据库是高性能、可靠且安全的数据库，可用于以所选编程语言构建数据驱动的应用程序和网站，而无需管理基础结构。 使用我们的快速入门、教程和示例了解如何使用 SQL 数据库。

## <a name="5-minute-quickstarts"></a>5 分钟快速入门

了解如何创建 SQL 数据库、使用 SQL Management Studio 管理该数据库以及采用 C#、Java、Python、Node.js 和 Ruby 通过该数据库进行开发：

- [在 Azure 应用服务中创建 Java Web 应用](/azure/sql-database/sql-database-get-started-portal)
...
了解如何创建、 管理和迁移数据库使用 SQL DB。

- [创建和设计新 SQL 数据库的架构](/azure/sql-database/sql-database-design-first-database)
- [迁移现有 SQL Server 数据库以使用 Azure SQL 数据库](/azure/sql-database/sql-database-migrate-your-sql-server-database)
...
- [请访问文档以了解详细信息](/azure/sql-database/index)
