...
资源组中的资源不会继承标记。 若要将标记添加到资源，请使用 **azure 资源集**。 请传递要将标记添加到的资源类型的 API 版本号。 如果需要检索 API 版本，请对你要设置的类型使用以下具有资源提供程序的命令：
...
标记直接存在于资源和资源组中。 若要查看现有标记，请使用 **azure group show** 获取资源组及其资源。
