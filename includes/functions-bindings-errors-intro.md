...
默认情况下，这些触发器最多触发5次请求。 第五次重试后，Azure 队列存储和 Azure 服务总线都会触发向[病毒队列](..\articles\azure-functions\functions-bindings-storage-queue-trigger.md#poison-messages)写入一条消息。
