...
[为 Azure 准备 Oracle Linux 虚拟机](../articles/virtual-machines/linux/oracle-create-upload-vhd.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)逐步引导读者满足先决条件，为 Oracle Linux 6.4+ 和 Oracle Linux 7.0+ 创建虚拟机。
