...
使用文本编辑器将 `{YOUR_COMPANY_NAME_HERE}` 的两个实例替换为下载的 `EnvironmentalSensorInline.capabilitymodel.json` 文件中的公司名称。 请仅使用字符 a-z、A-Z、0-9 和下划线。
...
1. 在“创建新设备”对话框中，确保“环境传感器”为模板类型，且“模拟此设备?”设置为“否”。
