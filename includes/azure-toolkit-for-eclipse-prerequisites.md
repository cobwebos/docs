...
可以在 Eclipse Marketplace 的 [Azure Toolkit for Eclipse（适用于 Eclipse 的 Azure 工具包）](http://marketplace.eclipse.org/content/azure-toolkit-eclipse)页面中找到详细信息。

> [AZURE.IMPORTANT] 如果要在 Windows 上使用适用于 Eclipse 的 Azure 工具包，则运行该工具包需要安装 Azure SDK 2.9.1 或更高版本。安装 Azure SDK 有两个选项：
> 
