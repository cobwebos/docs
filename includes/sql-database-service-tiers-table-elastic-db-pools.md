...
| 池大小 (eDTU)  |  **1200** | **1600** | **2000** | **2500** | 
|:---|---:|---:|---:| ---: | ---: | ---: | ---: |---: |---: |---: |
| 每个池的最大存储空间* | 1.2 TB | 1.6 TB | 2 TB | 2.4 TB | 
| 每个池的最大数据库数 | 500 | 500 | 500 | 500 | 500 | 
| 每个池的最大并发工作线程数 |  2400 | 3200 | 4000 | 5000 |
| 每个池的最大并发登录数 |  2400 | 3200 | 4000 | 5000 | 
...
| 每个池的最大并发会话数 | 30000 | 30000 | 30000 | 30000 | 30000 | 
| 每个数据库的最小 eDTU 数 | {0,25,50,75,<br>125} | {0,25,50,75,<br>125,250} | {0,25,50,75,<br>125,250,500} | {0,25,50,75,<br>125,250,500,<br>1000} | {0,25,50,75,<br>125,250,500,<br>1000} | 
| 每个数据库的最大 eDTU 数 | {25,50,75,<br>125} | {25,50,75,<br>125,250} | {25,50,75,<br>125,250,500} | {25,50,75,<br>125,250,500,<br>1000} | {25,50,75,<br>125,250,500,<br>1000} |  
||||||||

### <a name="premium-elastic-pool-limits-continued"></a>高级弹性池限制（续）

| 池大小 (eDTU)  |  **2000** | **2500** | **3000** | **3500** | 
|:---|---:|---:|---:| ---: | ---: | ---: | ---: |---: |---: |---: |
| 每个池的最大存储空间* | 750 GB| 750 GB| 750 GB| 750 GB| 
| 每个池的最大数据库数 | 100 | 100 | 100 | 100 | 100 | 
| 每个池的最大并发工作线程数 |  3200 | 4000 | 4800 | 5600 | 
| 每个池的最大并发登录数 |  3200 | 4000 | 4800 | 5600 | 
| 每个池的最大并发会话数 | 30000 | 30000 | 30000 | 30000 | 30000 | 
| 每个数据库的最小 eDTU 数 | {0,25,50,75,<br>125,250,500,<br>1000,1750} | {0,25,50,75,<br>125,250,500,<br>1000,1750} | {0,25,50,75,<br>125,250,500,<br>1000,1750} | {0,25,50,75,<br>125,250,500,<br>1000,1750} | 
| 每个数据库的最大 eDTU 数 | {25,50,75,<br>125,250,500,<br>1000,1750} | {25,50,75,<br>125,250,500,<br>1000,1750} | {25,50,75,<br>125,250,500,<br>1000,1750} | {25,50,75,<br>125,250,500,<br>1000,1750} | 
||||||||
