...
> 
> 1. 使用 `Disable-AzAlias` 禁用 `Az`（若已启用）中的 AzureRM 别名。 在没有安装 `Az` 或禁用别名的情况下，也可以运行此命令。
> 2. 请遵循 [AzureRM 的最新安装说明](/powershell/azure/azurerm/install-Az-ps)。 即使已安装 `AzureRM`，也请将其更新到最新版本。
