...
7. 选择区域值，例如美国西部。 
8. 单击右箭头。
9. 在“查看购买”选项卡上，检查计划和定价信息，并查看法律条款。 如果同意这些条款，请单击复选标记。 单击复选标记后，您的 Pusher 帐户将开始设置过程。 
   
   ![store-screen-2][store-screen-2]
10. 确认购买后，系统会将你重定向到外接程序仪表板，并显示消息“购买 Pusher”。
    
    ![store-screen-3][store-screen-3]

随后将立即预配你的 Pusher 帐户，并显示消息“已成功购买外接程序 Pusher”。 已创建您的帐户，您现在可以使用 Pusher 服务。
...
有关 Pusher 入门的详细信息，请参阅[了解 Pusher][Understanding Pusher]。
