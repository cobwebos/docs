...
1. 通过远程桌面连接到虚拟机。有关连接到 VM 的详细说明，请参阅[《Open a SQL VM with Remote Desktop》（使用远程桌面打开 SQL VM)](/documentation/articles/virtual-machines-windows-portal-sql-server-provision/#open-the-vm-with-remote-desktop)。

1. 登录后，在开始屏幕中，键入“WF.msc”，然后按 ENTER。
