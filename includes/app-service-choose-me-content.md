...
## <a name="tell-me-about-app-service"></a>我想了解 App Service
...
如[上图](#appservice_diagram)所示，可以通过多种方式将代码和其他 Web 内容发布到 Azure 应用服务。 你可以使用 FTP、FTPS 或 Microsoft 的 WebDeploy 技术。 Azure App Service 还支持从源控件系统发布代码，例如 Git、GitHub、CodePlex、BitBucket、Dropbox、Mercurial、Team Foundation Server 和基于云的 Team Foundation Service。
