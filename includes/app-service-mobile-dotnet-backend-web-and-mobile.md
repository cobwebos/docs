...
1. 在 [Azure 管理门户](https://manage.windowsazure.cn/)中，使用与移动应用相同的资源组和托管计划创建新的网站。
...
4. 接下来，我们将从 Azure 管理门户获取移动应用连接字符串：
...
* 有关从管理门户更改为新门户的指南，请参阅：[有关在 Azure 管理门户中导航的参考](https://manage.windowsazure.cn/)
