...
* **Node.js 后端（通过 Node.js 代码）** ：  
    ...
    有关更多详细信息[, 请参阅如何:需要对表](../articles/app-service-mobile/app-service-mobile-node-backend-how-to-use-server-sdk.md#howto-tables-auth)的访问进行身份验证。 若要了解如何从网站下载快速入门代码项目, 请参阅[如何:使用 Git](../articles/app-service-mobile/app-service-mobile-node-backend-how-to-use-server-sdk.md#download-quickstart)下载 node.js 后端快速入门代码项目。
