...
| 限制 | 每个中心的值 |
| --- | --- |
| 标识注册表操作 <br/> （创建、检索、列表、更新、删除）， <br/> 单个或批量导入/导出 |5000/分钟/单位（适用于 S3） <br/> 100/分钟/单位（适用于 S1 和 S2）。 |
...
| 文件上载操作 |5000 个文件上载通知/分钟/单位（适用于 S3），100 个文件上载通知/分钟/单位（适用于 S1 和 S2）。 <br/> Azure 存储帐户一次可传出&10000; 个 SAS URI。<br/> 一次可传出&10; 个 SAS URI/设备。 |
...
| 作业操作 <br/> （创建、更新、列表、删除） | 5000/分钟/单位（适用于 S3），100/分钟/单位（适用于 S2），100/分钟/单位（适用于 S1） |
