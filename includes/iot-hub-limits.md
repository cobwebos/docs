...
| 文件上传操作 |83.33 文件上传起始次数/秒/单位（5000/分钟/单位）（适用于 S3），1.67 文件上传起始次数/秒/单位（100/分钟/单位）（适用于 S1 和 S2）。 <br/> Azure 存储帐户一次可传出 10,000 个 SAS URI。<br/> 一次可传出 10 个 SAS URI/设备。 |
