...
>
> 此漏洞影响 Intel® Core® 处理器和 Intel® Xeon® 处理器。  Microsoft Azure 已发布的操作系统更新和部署新微代码，因为它可由 Intel，在我们的全套产品来保护我们客户免受这些新的漏洞。   Azure 正在与 Intel 密切合作，以便在平台上正式发布新的微代码之前对其进行测试和验证。 
>
