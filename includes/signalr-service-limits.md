...
| 资源 | 默认限制 | 最大限制 | 
| --- | --- | --- |
| 免费层每个实例的 Azure SignalR 服务单元 |1 |1 |
| 标准层每个实例的 Azure SignalR 服务单元 |100 |100 |
| 免费套餐每个区域每个订阅的 Azure SignalR 服务单元|5 |5 |
| 每个区域每个订阅的 Azure SignalR 服务单元计数总计 |150 |无限制 |
| 免费层每天每个单元的连接数 |20 |20 |
