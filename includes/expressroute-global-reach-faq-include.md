...
[特定国家/地区或地方](../articles/expressroute/expressroute-global-reach.md)支持 ExpressRoute Global Reach。 必须在上述国家/地区或地方的对等互连位置创建 ExpressRoute 线路。
...
ExpressRoute Global Reach 启用的本地网络之间的网络吞吐量以两条 ExpressRoute 线路中吞吐量较小者为准。 本地到 Azure 的流量和本地到本地的流量共享同一线路，并受到相同带宽上限的限制。 
