...
| [保护 .NET Web API](../articles/active-directory-b2c/active-directory-b2c-devquickstarts-api-dotnet.md) | [向 Javascript SPA (.NET) 添加注册和登录](https://github.com/Azure-Samples/active-directory-b2c-javascript-singlepageapp-dotnet-webapi) | [使用 OpenID Connect 的 Web 应用](../articles/active-directory-b2c/active-directory-b2c-reference-oidc.md) |
