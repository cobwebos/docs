...
> [!NOTE]
> 有关 Azure 侦听器的故障排除提示，请参阅 AlwaysOn 支持团队[博客](https://blogs.msdn.microsoft.com/alwaysonpro/2017/02/22/troubleshooting-internal-load-balancer-listener-connectivity-in-azure)中的 [Troubleshooting availability group listener in Azure](https://blogs.msdn.com/b/alwaysonpro/)（排查 Azure 中的可用性组侦听器问题）。
> 
> 
