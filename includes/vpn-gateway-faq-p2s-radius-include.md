...
### <a name="does-radius-authentication-work-with-the-openvpn-client"></a>RADIUS 身份验证是否与 OpenVPN 客户端配合使用？

仅通过 PowerShell 支持 OpenVPN 协议进行 RADIUS 身份验证。
