...
| 队列或主题大小 |实体 |创建队列或主题时定义。 <br/><br/> 后续的传入消息会被拒绝，且调用代码会收到异常。 |1、2、3、4 GB 或 5 GB。<br /><br />在高级 SKU 以及启用了[分区](/azure/service-bus-messaging/service-bus-partitioning)的标准 SKU 中，队列或主题的最大大小是 80 GB。 |
