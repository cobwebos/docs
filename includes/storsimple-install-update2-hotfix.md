...
3. 在 Microsoft 更新目录的搜索框中，输入要下载的修补程序的知识库 (KB) 编号（例如 **3121901**），然后单击“搜索”。
   
    随后将显示修补程序列表，例如“适用于 StorSimple 8000 系列的累积软件捆绑包更新 2.0”。
   
    ![搜索目录](./media/storsimple-install-update2-hotfix/HCS_SearchCatalog1-include.png)
4. 单击 **“添加”**。 该更新随即添加到购物篮中。
5. 搜索上表中所列的其他任何修补程序（**3121900**、**3080728**、**3090322** 和 **3121899**），然后将每个修补程序添加到购物篮中。
6. 单击“查看购物篮”。
...
6. 完成软件更新后，重复步骤 3-5 安装并监视 SaaS 代理与 MDS 代理。 确保先安装 `all-hcsmdssoftwareupdate_0b438ddf0d5b686aada2378b754fac8c7f2160e9.exe`，再安装 `all-cismdsagentupdatebundle_f98e62f4d56c79e2a6644d027af7a2393a93827a.exe`。
7. 验证系统软件版本。 键入：
