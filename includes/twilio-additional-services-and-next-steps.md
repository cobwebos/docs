...
除了此处所示的示例，Twilio 还提供基于 web 的 Api，可用于从 Azure 应用程序的其他 Twilio 功能。 有关完整详细信息，请参阅[Twilio API 文档][twilio_api_documentation]。

## <a name="NextSteps"></a>后续步骤
现在，你已了解 Twilio 服务的基础知识，单击下面的链接以了解详细信息：
