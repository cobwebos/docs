...
1. 导航到 <a href="http://cloud.google.com/console" target="_blank">Google Cloud Console</a> 网站，使用你的 Google 帐户凭据登录，然后单击"创建项目"。
	...
	>[AZURE.NOTE]如果你已拥有现成项目，在登录后你将定向到"项目"页。<strong></strong>若要从仪表板创建新项目，请展开"API 项目"<strong></strong>，然后单击"创建..."<strong></strong>然后在"其他项目"下<strong></strong>输入项目名称，并单击"创建项目"。<strong></strong>
