...
:::image type="content" source="../articles/digital-twins/media/how-to-set-up-instance/cloud-shell/owner-role.png" alt-text="Azure 门户突出显示 &quot;对象 ID&quot; 字段中的 GUID 的用户页面视图" 以外的其他内容，则可以通过以下方式之一继续：
