...
|[PowerShell](../articles/azure-functions/functions-reference-powershell.md) |空值|GA （PowerShell Core 6）| GA （PowerShell Core 6）|
|[Python](../articles/azure-functions/functions-reference-python.md#python-version)|不适用|GA （Python 3.6 & 3.7）| GA （Python 3.6、3.7、& 3.8）|
|[TypeScript](../articles/azure-functions/functions-reference-node.md#typescript) |不适用|GA<sup>1</sup>| GA<sup>1</sup> |
