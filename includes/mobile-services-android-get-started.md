...
4. 在左侧的“项目资源管理器”窗口中，确保选择了“项目”选项卡，然后依次打开“app”、“src”、“java”，并双击 **ToDoactivity**。

   	![](./media/mobile-services-android-get-started/Android-Studio-quickstart.png)


5. 如果你下载了 SDK 版本 2.0，则需要使用移动服务的 Url 和密钥更新代码：
...
6. 在“运行”菜单中，单击“运行”，以便在 Android 模拟器中启动项目。

	> [AZURE.IMPORTANT]若要在 Android 模拟器中运行项目，必须至少定义一个 Android 虚拟设备 (AVD)。使用 AVD 管理器创建和管理这些设备。

7. 在应用程序中键入有意义的文本（例如 _Complete the tutorial_），然后单击“添加”。
