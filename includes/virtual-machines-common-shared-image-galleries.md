...
下表列出了源区域。 所有公共区域都可以是目标区域, 但是若要复制到澳大利亚中部和澳大利亚中部 2, 需要订阅白名单。 要请求允许列表，请转到： https://azure.microsoft.com/en-au/global-infrastructure/australia/contact/
