...
2. 如有必要，运行 **`New-AzureRmResourceGroup`** cmdlet 创建一个新的资源组。以下命令在*“美国中部”*Azure 区域创建了一个名为 *TestRG* 的资源组。有关资源组的详细信息，请访问 [Azure 资源管理器概述](../articles/resource-group-overview.md)。
