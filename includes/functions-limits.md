...
---
| 资源 | [消费计划](../articles/azure-functions/functions-scale.md#consumption-plan) | [保费计划](../articles/azure-functions/functions-scale.md#premium-plan) | [应用服务计划](../articles/azure-functions/functions-scale.md#app-service-plan)<sup>1</sup> |
| --- | --- | --- | --- |
...
|最大[超时持续时间](../articles/azure-functions/functions-scale.md#timeout)（分钟） |10 | 无界<sup>8</sup> | 不受限制<sup>3</sup> |
...
| [应用服务计划](../articles/app-service/overview-hosting-plans.md) | 每个区域 100[个](https://azure.microsoft.com/global-infrastructure/regions/) |每个资源组 100 个 |每个资源组 100 个 |
