...
> [!NOTE]
> VpnGw SKU（VpnGw1、VpnGw1AZ、VpnGw2、VpnGw2AZ、VpnGw3、VpnGw3AZ、VpnGw4、VpnGw4AZ、VpnGw5 和 VpnGw5AZ）仅支持资源管理器部署模型。 经典虚拟网络应继续使用老版（旧版）SKU。
...
| **除基本 SKU 外的所有第 1 代和第 2 代 SKU** | **基于路由的 VPN：** 多达 30 个隧道 （*）、P2S、BGP、主动主动、自定义 IPsec/IKE 策略、ExpressRoute/VPN 共存 |
|        |             |
...
###  <a name="gateway-skus---production-vs-dev-test-workloads"></a><a name="workloads"></a>网关 SKU - 生产与开发测试工作负载
