...
|----|:----:|:----:|:----:|
|[本地计算机](../articles/machine-learning/how-to-create-attach-compute-sdk.md#local)| 是 | &nbsp; | &nbsp; |
|[Azure 机器学习计算群集](../articles/machine-learning/how-to-create-attach-compute-sdk.md#amlcompute)| 是且 <br/>超参数优化 | 是 | 是 |
|[Azure 机器学习计算实例](../articles/machine-learning/how-to-create-attach-compute-sdk.md#instance) | 是且 <br/>超参数优化 | 是 |  |
|[远程 VM](../articles/machine-learning/how-to-create-attach-compute-sdk.md#vm) | 是且 <br/>超参数优化 | 是 | &nbsp; |
|[Azure&nbsp;Databricks](../articles/machine-learning/how-to-create-attach-compute-sdk.md#databricks)| 是（仅限 SDK 本地模式） | 是 | &nbsp; |
