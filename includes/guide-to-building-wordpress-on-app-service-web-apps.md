...
* [如何为 WordPress 应用购买 ClearDB 共享 MySQL 托管](http://blog.syntaxc4.net/post/2012/12/03/provisioning-a-mysql-database-from-the-windows-azure-store.aspx)
* [如何为 WordPress 应用购买 ClearDB 专用 MySQL 群集](https://azure.microsoft.com/blog/announcing-new-mysql-premium-tiers-from-cleardb/)
* [部署由 MySQL 复制群集支持的 WordPress Web 应用](https://azure.microsoft.com/documentation/templates/wordpress-mysql-replication/)
* [使用 Percona 群集构建自己的双主 MySQL 群集](https://azure.microsoft.com/documentation/templates/mysql-ha-pxc/)并[详细了解如何管理群集](https://github.com/fanjeffrey/axiom.articles/tree/master/pxc)
* [部署由具有主从配置的 MySQL 复制群集支持的 WordPress](https://azure.microsoft.com/documentation/templates/mysql-replication/)
* [部署受 ProjectNami 所托管的 SQL Azure DB 支持的 WordPress 应用](https://azure.microsoft.com/marketplace/partners/projectnami/projectnami/)
* [如何生成 WordPress 多站点 Web 应用](../articles/app-service-web/web-sites-php-convert-wordpress-multisite.md)

### <a name="porting-your-application-to-app-service"></a>将应用程序移植到应用服务
* [如何规划迁移到 Azure 应用服务](https://azure.microsoft.com/blog/how-to-plan-your-migration-to-azure-websites/)
* [如何将现有 WordPress 站点迁移到 Azure Web 应用](https://sunithamk.wordpress.com/2013/11/06/migrate-your-existing-wordpress-site-to-windows-azure/)
* [如何将 Web 应用从 Linux 迁移到 Azure Web 应用](https://www.movemetothecloud.net/LinuxMigration)
* [在 Azure Web 应用中推出之前的查检表](https://sunithamk.wordpress.com/2015/10/27/azure-web-apps-basic-operations-checklist/)
