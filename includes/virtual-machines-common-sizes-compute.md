...
F 系列基于 2.4 GHz Intel Xeon® E5-2673 v3 (Haswell) 处理器，该处理器使用 Intel Turbo Boost 技术 2.0，可实现高达 3.1 GHz 的时钟速度。 此 CPU 性能与 Dv2 系列的 VM 相同。  根据每个 vCPU 的 Azure 计算单位 (ACU)，在较低的小时价列表中，F 系列在 Azure 产品组合中具有最高性价比。 
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Standard_F1s |1 |#N/A |4 |#N/A |4,000 / 32 (12) |3,200 / 48 |2 / 750 |
| Standard_F2s |#N/A |4 |8 |4 |8,000 / 64 (24) |6,400 / 96 |2 / 1500 |
...
|--------------|-----------|-------------|----------------|----------------------------------------------------------|-----------------------------------|------------------------------|
| Standard_F1  | 1         | #N/A           | 16             | 3000/46/23                                           | 2/2x500                         | 2 / 750                 |
| Standard_F2  | #N/A         | 4           | 32             | 6000/93/46                                           | 4/4x500                         | 2 / 1500                     |
