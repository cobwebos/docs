...
<sup>2</sup>使用超过64的 vCPU 需要以下受支持的来宾操作系统之一： Windows Server 2016、UBUNTU 16.04 LTS、SLES 12 SP2 和 Red Hat Enterprise Linux、CentOS 7.3 或使用 .lis 4.2.1 Oracle Linux 7.3。
