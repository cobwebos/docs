...
本教程详细介绍了如何在新的 Unity HoloLens 应用中使用 Azure 空间定位点。 若要深入了解如何在新 Android 应用中使用 Azure 空间定位点，请继续学习下一教程。

> [!div class="nextstepaction"]
> [启动新的 Android 应用](/azure/spatial-anchors/tutorials/tutorial-new-android-app)
