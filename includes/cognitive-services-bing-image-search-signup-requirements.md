...
ms.locfileid: "85603259"
---
## <a name="create-an-azure-resource"></a>创建 Azure 资源

通过创建以下 Azure 资源之一开始使用必应图像搜索 API。

### <a name="bing-search-v7-resource"></a>[必应搜索 v7 资源](https://ms.portal.azure.com/#create/Microsoft.CognitiveServicesBingSearch-v7)
