...
ms.locfileid: "76021234"
---
本部分提供有关较旧代虚拟机大小的信息。 仍支持这些大小，但不会获得额外的容量。 有一些较新的或备用的大小已正式发布。 请参阅[azure 中 Windows 虚拟机的大小](../articles/virtual-machines/windows/sizes.md)或[azure 中 Linux 虚拟机的大小](../articles/virtual-machines/linux/sizes.md)，以选择最适合你需求的 VM 大小。  

有关调整 Linux VM 大小的详细信息，请参阅[使用 Azure CLI 调整 linux 虚拟机的大小](../articles/virtual-machines/linux/change-vm-size.md)。 如果使用的是 Windows Vm 并且喜欢使用 PowerShell，请参阅[调整 WINDOWS vm 的大小](../articles/virtual-machines/windows/resize-vm.md)。  
...
<sup>1</sup>对于 MPI 应用程序，专用 RDMA 后端网络是通过 QDR 无限网络来实现的，它可提供超高延迟和高带宽。  
...
|--------------|-----------|-------------|----------------|----------------------------------------------------------|-----------------------------------|------------------------------|
| Standard_D1  | 第         | 3.5         | 50             | 3000/46/23                                           | 4/4x500                         | 2 / 500                 |
