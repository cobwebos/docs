...
托管磁盘是一种通过处理存储帐户管理来简化 Azure IaaS VM 的磁盘管理的功能。 有关详细信息，请参阅[托管磁盘概述](../articles/virtual-machines/managed-disks-overview.md)。
...
是否可以将超级磁盘附加到现有 VM？
可能可以，VM 必须处于支持超级磁盘的区域和可用性区域对中。 有关详细信息，请参阅[超级磁盘入门](../articles/virtual-machines/disks-enable-ultra-ssd.md)。
