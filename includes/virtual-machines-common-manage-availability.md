...
<!--Image reference-->
   ![更新域和容错域配置的概念绘制](./media/virtual-machines-common-manage-availability/ud-fd-configuration.png)
...
<!--Image reference-->
   ![应用层](./media/virtual-machines-common-manage-availability/application-tiers.png)
