...
| 资源 | 默认限制 | 最大限制 |
| --- | --- | --- |
| 每个[订阅](../articles/billing-buy-sign-up-azure-subscription.md)的 vCPU 数量 <sup>1</sup> |20 个 |10,000 |
...
| 每个订阅的[本地网络数](/previous-versions/azure/reference/jj157100(v=azure.100)) |10 个 |500 |
| 每个订阅的 DNS 服务器 |9 |100 |
| 每个订阅的保留的 IP |20 |100 |
