资源|默认限制|最大限制
---|---|---
每个[订阅](/documentation/articles/billing-buy-sign-up-azure-subscription/)的核心数 <sup>1</sup>|20|10,000
...
<sup>2</sup>这包括标准和高级存储帐户。如果需要的存储帐户超过 200 个，请通过 [Azure 支持](https://azure.microsoft.com/support/faq/)提出请求。Azure 存储空间团队将评审你的业务案例，最多可以批准 250 个存储帐户。
