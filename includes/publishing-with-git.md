[Azure Web 应用](/documentation/services/web-sites/)支持从源代码控制和存储库工具（例如，Git 和 Mercurial）部署到 Web Apps。你可以使用这些工具维护网站的内容和代码，然后在需要时快速轻松地将更改推送到你的 Azure Web 应用。
...
* [从存储库网站（例如，GitHub 或 Mercurial）上部署文件](#Step7)
...
8. 对你的项目进行更改，然后将更新推送到已与此网站关联的存储库。在管理门户上单击“同步”，完成推送到存储库后，你的网站应很快更新以反映更改。
...
[快速启动 - Mercurial]: http://mercurial.selenic.com/wiki/QuickStart
