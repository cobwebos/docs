...
-   [Git 文档][Git 文档]
  ...
  [使用 Visual Studio Online 向 Azure 持续传送项目]: http://windowsazure.cn/zh-cn/documentation/articles/cloud-services-continuous-delivery-use-vso/
  [针对 Mac 和 Linux 的 Azure 命令行工具]: /zh-cn/develop/nodejs/how-to-guides/command-line-tools/
  [安装 Git]: #Step1
  [创建本地存储库]: #Step2
  [添加网页]: #Step3
  [启用网站存储库]: #Step4
