...
ms.locfileid: "66123252"
---
现在，已了解有关 Azure 队列存储的基础知识，可单击下面的链接来了解更复杂的存储任务。

* 有关可用 API 的完整详细信息，请查看[用于 .NET 的 Azure 存储客户端库](https://go.microsoft.com/fwlink/?LinkID=390731)参考中的队列服务参考文档。
...
* 查看更多功能指南，以了解在 Azure 中存储数据的其他方式。
  ...
  * 若要使用 Azure 存储 Blob，请[通过 .NET 开始使用 Azure Blob 存储](../articles/storage/blobs/storage-dotnet-how-to-use-blobs.md)。
