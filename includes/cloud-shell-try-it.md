...
| 在浏览器中打开 [Azure Cloud Shell](https://shell.azure.com)。 | <a href="https://shell.azure.com" title="启动 Azure Cloud Shell"><img name="launch-cloud-shell" src="https://docs.microsoft.com/azure/includes/media/cloud-shell-try-it/launchcloudshell.png" /></a> |
