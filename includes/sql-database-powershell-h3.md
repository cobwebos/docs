...
首先，应安装并运行最新的 [Azure PowerShell](https://msdn.microsoft.com/library/mt619274\(v=azure.300\).aspx)。 有关详细信息，请参阅 [如何安装和配置 Azure PowerShell](/powershell/azureps-cmdlets-docs)。
