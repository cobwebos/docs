...
| Web 作业 | _\<job_name>/run.\<extension>_ 适用于连续 Web 作业的 "_应用 \_ 数据/作业/连续_" 或 "_应用 \_ 数据/作业/已触发_的 web 作业"。 有关详细信息，请参阅[Kudu Web 作业文档](https://github.com/projectkudu/kudu/wiki/WebJobs)。 |
