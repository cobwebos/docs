...
3. 通过以下步骤设置市场活动的第一个字段：
    ...
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 为市场活动命名。
   
    b.保留“数据库类型”设置，即设置为“共享”。 选择“系统通知 -> 简易”作为“传递类型”：这是简易的 Android 推送通知类型，有一个标题和一小行文本。
   
    c. 选择“随时”作为“传递时间”，允许应用随时接收通知，无论应用是否已启动。
   
    d.单击“下一步”。 在通知文本中键入“标题”（在推送中以粗体显示）。
   
    e.在“新建 MySQL 数据库”边栏选项卡中，接受法律条款，然后单击“确定”。 然后键入“消息”
