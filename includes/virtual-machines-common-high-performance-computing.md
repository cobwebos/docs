...
* [RogueWave 的基于 CentOS 的 HPC](https://azuremarketplace.microsoft.com/marketplace/apps/RogueWave.CentOSbased74HPC?tab=Overview)
...
* 在 Azure Batch 上[呈现应用程序](../articles/batch/batch-rendering-service.md)，包括 Autodesk Maya、3ds Max，以及 Arnold、Chaos Group V-Ray 和 Blender
...
使用 [Azure CycleCloud](https://docs.microsoft.com/azure/cyclecloud/overview) 在 Azure VM 上创建和优化 HPC 群集时，可以轻松高效地管理常见工作负荷。
...
* [Azure 上的并行虚拟文件系统](https://azure.microsoft.com/resources/parallel-virtual-file-systems-on-microsoft-azure/)，包括 [Lustre](http://lustre.org/) 和 [BeeGFS](http://www.beegfs.com/content/)。
...
* [容器实例](../articles/container-instances/container-instances-overview.md)
...
* 详细了解针对[高性能计算](https://azure.microsoft.com/solutions/high-performance-computing/)、[渲染](https://azure.microsoft.com/solutions/big-compute/rendering/)、[银行和资本市场](https://finance.azure.com/)和[基因组学](https://enterprise.microsoft.com/industries/health/genomics/)的 Azure 解决方案。

* 详细了解 Azure 中的[大计算解决方案体系结构](https://azure.microsoft.com/solutions/architecture/?solution=high-performance-computing)。
