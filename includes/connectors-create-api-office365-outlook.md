...
在逻辑应用中使用 Office 365 帐户之前，请先授权该逻辑应用可以连接到你的 Office 365 帐户。 可以在 Azure 门户中的逻辑应用内轻松地执行此操作。  

按照以下步骤操作，即可授权逻辑应用连接到你的 Office 365 帐户：

1. 创建逻辑应用。 在逻辑应用设计器的下拉列表中选择“显示 Microsoft 托管的 API”，然后在搜索框中输入“office 365”。 选择其中一个触发器或操作：  
    ![Office 365 连接创建步骤](./media/connectors-create-api-office365-outlook/office365-sendemail.png)  
2. 如果以前尚未创建任何与 Office 365 的连接，系统会提示你使用你的 Office 365 凭据进行登录：  
...
3. 选择“登录”，然后输入用户名和密码。 选择“登录”：  
    ...
    这些凭据将用于授权逻辑应用连接到你的 Office 365 帐户，然后访问该帐户。 
