...
| 大小 | vCPU | 内存：GiB | 临时存储 (SSD) GiB | 最大数据磁盘数 | 缓存和临时存储的最大吞吐量：IOPS/MBps（以 GiB 为单位的缓存大小） | 非缓存磁盘最大吞吐量：IOPS / MBps | 最大 NIC 数/预期网络性能 (Mbps) |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Standard_DS1_v2 |1 |3.5 |7 |#N/A |4,000 / 32 (43) |3,200 / 48 |2 / 750 |
| Standard_DS2_v2 |#N/A |7 |14 |4 |8,000 / 64 (86) |6,400 / 96 |2 / 1500 |
...
| Standard_D2_v2    | #N/A         | 7           | 100            | 6000/93/46                                           | 4/4x500                         | 2 / 1500                     |
...
| 大小 | vCPU | 内存：GiB | 临时存储 (SSD) GiB | 最大数据磁盘数 | 缓存和临时存储的最大吞吐量：IOPS/MBps（以 GiB 为单位的缓存大小） | 非缓存磁盘最大吞吐量：IOPS / MBps | 最大 NIC 数/预期网络性能 (Mbps) |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Standard_DS1 |1 |3.5 |7 |#N/A |4,000 / 32 (43) |3,200 / 32 |2 / 500 |
| Standard_DS2 |#N/A |7 |14 |4 |8,000 / 64 (86) |6,400 / 64 |2 / 1000 |
...
| Standard_D2  | #N/A         | 7           | 100            | 6000/93/46                                           | 4/4x500                         | 2 / 1000                     |
