...
8. 在**磁盘管理**窗口中，已装入的卷将出现在下图中所示。 右键单击发现的卷 （单击磁盘名称），然后单击**联机**。
     ...
     ![初始化格式卷](./media/storsimple-mount-initialize-format-volume/HCS_InitializeFormatVolume-include.png) 
...
![可用的视频](./media/storsimple-mount-initialize-format-volume/Video_icon.png)**可用的视频**

若要观看的视频，演示如何装载、 初始化和格式化 StorSimple 卷，请单击[此处](https://azure.microsoft.com/documentation/videos/mount-initialize-and-format-a-storsimple-volume/)。
