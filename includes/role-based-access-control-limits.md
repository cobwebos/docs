...
| [每个租户的 Azure 资源自定义角色数](../articles/role-based-access-control/custom-roles.md)<br/>（例如 Azure 政府、 Azure Germany 和 Azure 中国的 21Vianet 专用的云） | 2,000 |
