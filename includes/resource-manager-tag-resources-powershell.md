### <a name="tag-cmdlet-changes-in-latest-powershell-version"></a>最新 PowerShell 版本中的标记 cmdlet 更改
2016 年 8 月版的 Azure PowerShell 2.0 对如何使用标记进行了重大更改。 在继续之前，请检查 AzureRm.Resources 模块的版本。
...
### <a name="updating-your-script-for-changes-in-latest-version"></a>更新脚本以获取最新版本的更改
在最新版本中，**Tags** 参数名称已更改为 **Tag**，类型已从 `Hashtable[]` 更改为 `Hashtable`。 不再需要为每个条目提供“名称”和“值”。 而是提供**键 =“值”**格式的键/值对。
...
### <a name="version-301-or-later"></a>3.0.1 版本或更高版本
...
### <a name="versions-earlier-than-301"></a>低于 3.0.1 的版本
标记直接存在于资源和资源组中。 若要查看现有标记，请使用 **Get-AzureRmResource** 查看资源，或使用 **Get-AzureRmResourceGroup** 查看资源组。 
