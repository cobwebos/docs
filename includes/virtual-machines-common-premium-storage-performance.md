...
| CentOS | 6.5、6.6、6.7、7.0 或更高版本| &nbsp; | [需要使用 LIS4](https://www.microsoft.com/download/details.aspx?id=55106) <br> 请参阅下一部分中的注释** |
| CentOS | 7.1+ 或更高版本| 3.10.0-229.1.2.el7+ | [建议使用使用 LIS4](https://www.microsoft.com/download/details.aspx?id=55106) <br> 请参阅下一部分中的注释** |
