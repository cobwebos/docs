...
| 测试方案 | 目标卷 | 名称 | 结果 |
| --- | --- | --- | --- |
| 每个  读取 IOPS |CacheReads |RandomWrites\_8K |50,000 IOPS |
| 每个  写入 IOPS |NoCacheWrites |RandomReads\_8K |64,000 IOPS |
| 每个  组合 IOPS |CacheReads |RandomWrites\_8K |100,000 IOPS |
| NoCacheWrites |RandomReads\_8K | &nbsp; | &nbsp; |
| 每个  读取 MB/秒 |CacheReads |RandomWrites\_64K |524 MB/秒 |
| 每个  写入 MB/秒 |NoCacheWrites |RandomReads\_64K |524 MB/秒 |
