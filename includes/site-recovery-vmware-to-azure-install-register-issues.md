...
可以通过查看 **%ProgramData%_ASRLogs**文件夹中的日志来调试注册失败。
...
|06:28:45: 未能创建证书<br>06:28:45: 安装无法继续。 无法创建用于在 Site Recovery 中进行身份验证的证书。 重新运行安装程序 | 确保您以本地管理员身份运行安装程序。 |
