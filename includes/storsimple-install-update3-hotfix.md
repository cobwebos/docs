...
3. 在 Microsoft 更新目录的搜索框中，输入你想要下载，例如的修补程序的知识库 (KB) 数**3186843**，然后单击**搜索**。
   
    该修补程序列表显示，例如，**累积软件捆绑更新 3.0 for StorSimple 8000 系列**。
   
    ![搜索目录](./media/storsimple-install-update2-hotfix/HCS_SearchCatalog1-include.png)
4. 单击 **“添加”**。 该更新添加到购物篮中。
5. 上表中列出的任何其他的修补程序的搜索 (**3186859**)，并添加到购物篮的每个。
6. 单击**查看购物篮**。
...
1. 当软件更新已完成，请验证系统软件版本。 键入：
   ...
   * `MdsAgentVersion: 30.0.4698.16`
     ...
     > 
     > 
2. 重复步骤 3-5 安装 LSI 固件和驱动程序修补程序**KB3186859**。 安装的修补程序后，使用`Get-HcsSystem`cmdlet。 LSI 版本应为：
   
   * `Lsisas2Version: 2.0.78.00`
3. 重复步骤 3-5 来安装 Storport 和 Spaceport 更新**KB3121261**。
4. 如果你要更新从 Update 2 或更早版本，你将需要下载：
   
   * 使用 KB3146621 iSCSI 修复
   * WMI 修复使用 KB3103616
