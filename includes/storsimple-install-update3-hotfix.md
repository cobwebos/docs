...
5. 搜索上表中所列的其他任何修补程序 (**3186859**)，然后将每个修补程序添加到购物篮中。
6. 单击“查看购物篮”。
...
3. 重复步骤 3-5 安装 Storport 和 Spaceport 更新 **KB3121261**。
4. 如果要从 Update 2 或更低的版本更新，则还需要下载：
   
   * 使用 KB3146621 的 iSCSI 修复程序
   * 使用 KB3103616 的 WMI 修复程序
