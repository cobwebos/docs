...
<sup>1</sup>达到 800 部署每个资源组的限制，如果不再需要历史记录中删除部署。 从部署历史记录中删除条目不会影响已部署的资源。 可以使用 Azure CLI 的 [az group deployment delete](/cli/azure/group/deployment) 或 PowerShell 中的 [Remove-AzResourceGroupDeployment](/powershell/module/az.resources/remove-azresourcegroupdeployment) 删除历史记录中的条目。  有关 PowerShell 脚本，可自动删除部署中的持续集成和持续交付 (CI/CD) 方案中，请参阅[删除 deployments.ps1](https://gist.github.com/bmoore-msft/ed33fb940dafb09380174b7fca57651f)。
