...
4. 查找**社区服务器**的**当前稳定版本**，在 Windows 专栏中选择最新 **64 位**版本。 下载，并运行 MSI 安装程序。
...
9. 或者，可以将 mongod.exe 作为一项服务来安装：
    ...
    若要启动该服务，请运行以下命令：
        ...
        C:\> net start MongoDB
10. 现在，MongoDB 已安装且处于运行状态，需要在 Windows 防火墙中打开一个端口才能远程连接到 MongoDB。  从“开始”菜单中，选择“管理工具”，并选择“高级安全 Windows 防火墙”。
11. a) 在左窗格中，选择“入站规则”。  在右侧的“操作”窗格中，选择“新建规则...”。

    ![Windows 防火墙][Image1]

    b) 在“新建入站规则向导”中，选择“端口”，并单击“下一步”。

    ![Windows 防火墙][Image2]

    c) 选择“TCP”，并选择“特定本地端口”。  指定端口“27017”（MongoDB 侦听的默认端口），并单击“下一步”。
...
12. 如果在创建虚拟机时未配置 MongoDB 的终结点，可以现在完成此操作。 需要防火墙规则和终结点能够远程连接到 MongoDB。

  在 Azure 门户中，依次单击“虚拟机(经典)”、新建虚拟机的名称和“终结点”。
