...
---
如果用户没有应用标记所需的访问权限，则可以将**标记参与者**角色分配给该用户。 有关详细信息，请参阅[教程：使用 RBAC 和 Azure 门户授予用户对 Azure 资源的访问权限](../articles/role-based-access-control/quickstart-assign-role-user-portal.md)。
