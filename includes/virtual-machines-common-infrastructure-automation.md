...
- 自动执行 VM 的配置
    - 工具包括[易居](#ansible)[、Chef、](#chef)[人偶](#puppet)和[Azure 资源管理器模板](#azure-resource-manager-template)。
...
- [在 Linux 上安装和配置与 Azure 配合使用的 Ansible](../articles/ansible/ansible-install-configure.md)。
- [创建 Linux 虚拟机](../articles/ansible/ansible-create-vm.md)。
- [管理 Linux 虚拟机](../articles/ansible/ansible-manage-linux-vm.md)。
...
- [创建 PowerShell 运行簿](../articles/automation/automation-first-runbook-textual-powershell.md)。
...
- [Azure 开发人员服务](https://docs.microsoft.com/azure/devops/user-guide/index?view=vsts)。
...
- [使用资源管理器模板部署 Spot VM。](../articles/virtual-machines/linux/spot-template.md)
