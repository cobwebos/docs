...
可以根据自己的合规性策略，在 Azure 密钥保管库中轮换客户管理的密钥。 当密钥旋转时，必须更新认知服务资源才能使用新密钥 URI。 若要了解如何更新资源以在 Azure 门户中使用新版本的密钥，请参阅[使用 Azure 门户为认知服务配置客户管理的密钥](..\articles\cognitive-services\Encryption\cognitive-services-encryption-keys-portal.md)中的 "**更新密钥版本**" 一节。
