...
1. 登录到 [Azure 经典门户][Azure 经典门户]，然后单击屏幕底部的“新建”。
...
对于不同类型的生成环境，可以从 [Maven 中央存储库][Maven 包]或 [GitHub 上的版本分发点](https://github.com/Azure/azure-event-hubs/releases)显式获取最新发布的 JAR 文件。  
...
[Maven 包]: https://search.maven.org/#search%7Cga%7C1%7Ca%3A%22azure-eventhubs-eph%22
