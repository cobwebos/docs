...
1. 选择“+ 添加”。
    ...
    :::image type="content" source="media/virtual-machines-disks-double-encryption-at-rest-portal/double-encryption-add-disk-encryption-set.png" alt-text="主 Azure 门户的屏幕截图，在搜索栏中突出显示磁盘加密集。":::
...
1. 导航到所创建的磁盘加密集，然后选择显示的错误。 这会将磁盘加密设置为 "有效"。
    ...
    :::image type="content" source="media/virtual-machines-disks-double-encryption-at-rest-portal/double-encryption-disk-set-error.png" alt-text="主 Azure 门户的屏幕截图，在搜索栏中突出显示磁盘加密集。":::
