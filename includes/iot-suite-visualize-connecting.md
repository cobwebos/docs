...
2. 在“设备列表”中，应会看到设备状态现在为“正在运行”。
   
    ![][18]
3. 单击“仪表板”返回到仪表板，在“要查看的设备”下拉列表中选择设备，以查看其遥测数据。 示例应用程序的遥测数据是 50 个单位的内部温度、55 个单位的外部温度，以及 50 个单位的湿度。 请注意，仪表板默认只显示温度和湿度的值。
   
    ![][img-telemetry]

## <a name="send-a-command-to-your-device"></a>将命令发送到设备
远程监视解决方案中的仪表板可让用户通过 IoT 中心向设备发送命令。 例如，在远程监视解决方案中，你可以发送命令来设置设备的内部温度。
...
3. 在“设备详细信息”面板中，单击“命令”。
    ...
    ![][13]
4. 在“命令”下拉列表中选择“SetTemperature”，然后在“温度”中输入新的温度值。 单击“发送命令”将命令发送到设备。
   
    ![][14]
   
   > [!NOTE]
   > 命令历史记录最初将命令状态显示为“挂起”。 设备确认命令后，状态将更改为“成功”。
   > 
   > 
