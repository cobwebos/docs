...
您可以在解决方案中的 **"设备资源管理器"** 页上查看从设备发送的遥测数据。

1. 在 **"设备资源管理器"** 页上的设备列表中选择预配的设备。 一个面板将显示有关设备的信息，其中包括设备遥测绘图：
...
要在设备上调用方法，请使用远程监视解决方案中的 **"设备资源管理器**"页。 例如，在远程监视解决方案**中，冷水机组**设备实现**重新启动**方法。

1. 选择 **"设备"** 以导航到解决方案中的 **"设备资源管理器"** 页。

1. 在 **"设备资源管理器"** 页上的设备列表中选择预配的设备：

    ![选择真实设备](media/iot-suite-visualize-connecting/devicesselect.png)

1. 要显示可以在设备上调用的方法的列表，请选择 **"作业**"，然后选择 **"方法**"。 若要计划在多个设备上运行的作业，可以在列表中选择多个设备。 “作业”面板会显示普遍适用于所有选定设备的方法类型****。

1. 选择**重新启动**，将作业名称设置为**重新启动物理冷位，** 然后选择 **"应用**：
...
> [!NOTE]
> 要跟踪解决方案中的作业状态，请选择"**查看作业状态**"。

## <a name="next-steps"></a>后续步骤

"[自定义远程监视"解决方案加速器](../articles/iot-accelerators/iot-accelerators-remote-monitoring-customize.md)介绍了自定义解决方案加速器的一些方法。