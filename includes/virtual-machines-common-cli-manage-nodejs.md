...
> [!NOTE]
> 这些示例不包括通常为 Resource Manager 中的 VM 部署建议的基于模板的操作。 有关信息，请参阅[将 Azure CLI 与 Azure 资源管理器配合使用](../articles/xplat-cli-azure-resource-manager.md)和[使用 Azure 资源管理器模板和 Azure CLI 部署和管理虚拟机](../articles/virtual-machines/linux/create-ssh-secured-vm-from-template.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)。
> 
> 
