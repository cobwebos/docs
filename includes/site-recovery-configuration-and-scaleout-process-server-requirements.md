...
IIS | -无预先存在的默认网站。 <br> -无预先存在的网站或应用程序在端口443上进行侦听。 <br>-启用[匿名身份验证](https://technet.microsoft.com/library/cc731244(v=ws.10).aspx)。 <br> -启用[FastCGI](https://technet.microsoft.com/library/cc753077(v=ws.10).aspx)设置。
| 
...
MySQL | 应安装 MySQL。 可以手动安装，也可以 Azure Site Recovery 安装。 （有关详细信息，请参阅[配置设置](../articles/site-recovery/vmware-azure-deploy-configuration-server.md#configure-settings)。）
...
12 个 vCPU<br/><br/> 2 个插槽 * 6 个核心 \@ 2.5 GHz | 18 GB | 600 GB | 500 GB 到 1 TB | 100 到 150 台计算机
16 个 vCPU<br/><br/> 2 个插槽 * 8 个核心 \@ 2.5 GHz | 32 GB | 1 TB | 1到 2 TB | 150到200台计算机
