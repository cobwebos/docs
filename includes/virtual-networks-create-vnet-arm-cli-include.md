...
1. 如果从未使用过 Azure CLI，请参阅[安装和配置 Azure CLI](../articles/xplat-cli-install.md)，然后按照说明执行到选择 Azure 帐户和订阅的步骤。
...
3. 如有必要，请运行 **azure group create** 以创建新资源组，如下所示。请注意命令的输出。在输出后显示的列表说明了所用的参数。有关资源组的详细信息，请访问 [Azure 资源管理器概述](../articles/virtual-network/resource-group-overview.md#resource-groups)。
