* [使用各种身份验证和授权方法保护 Web 应用](../articles/app-service-web/web-sites-authentication-authorization.md)
  * [为应用设置 Azure Active Directory 身份验证](https://azure.microsoft.com/blog/azure-websites-authentication-authorization/)
* [启用传输层安全性 (TLS/SSL) - HTTPS 保护应用流量安全](../articles/app-service-web/web-sites-configure-ssl-certificate.md)
  * [强制所有传入流量通过 HTTPS 连接](http://microsoftazurewebsitescheatsheet.info/#force-https)
...
* [配置 TLS 相互身份验证来要求将客户端证书连接到你的 Web 应用](../articles/app-service-web/app-service-web-configure-tls-mutual-auth.md)
...
* [使用点到站点 VPN 安全连接应用与专用网络资源](../articles/app-service-web/web-sites-integrate-with-vnet.md)
* [使用混合连接安全连接应用与专用网络资源](../articles/app-service-web/web-sites-hybrid-connection-get-started.md)
* [使用应用服务环境 (ASE) 实现应用的安全隔离](../articles/app-service-web/app-service-app-service-environment-intro.md)
  * [在 ASE 前面配置 Web 应用程序防火墙 (WAF)](../articles/app-service-web/app-service-app-service-environment-web-application-firewall.md)
