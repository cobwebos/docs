了解如何使用其他类型的触发器创建函数或如何将函数与其他 Azure 服务集成。
...
+ [创建由通用 webhook 触发的函数](../articles/azure-functions/functions-create-generic-webhook-triggered-function.md)
...
+ [使用 Functions 在 Azure Cosmos DB 中存储非结构化数据](../articles/azure-functions/functions-integrate-store-unstructured-data-cosmosdb.md)
