* 如果非托管磁盘位于此前使用 Azure Storage Service Encryption 加密的存储帐户中，则不能将其转换成托管磁盘。 如需在托管磁盘中复制和使用这些 VHD 的步骤，请参阅[本文后面的内容](#managed-disks-and-azure-storage-service-encryption)。
