...
1. 默认情况下，解决方案门户显示*仪表板*。 您可以导航到解决方案门户使用上页面的左侧的菜单的其他区域。
...
如果你尚未这样做，请向远程监视解决方案中添加自定义设备。 完成解决方案仪表板中的以下步骤：
...
1. 选择**让我定义我自己的设备 ID**。 输入设备 ID，如**rasppi**，单击**检查 ID**以验证你尚未在解决方案中，使用名称，然后单击**创建**来预配该设备。

   ![添加设备 ID][3]

1. 记下的设备凭据 (**设备 ID**， **IoT 中心主机名**，和**设备密钥**)。 Raspberry Pi 上的客户端应用程序需要这些值可连接到远程监视解决方案。 然后单击**完成**。
