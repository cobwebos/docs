...
如果你使用的是 Mobile Apps，请参阅 [Add push notifications for Mobile Apps（为 Mobile Apps 添加推送通知）](../articles/app-service-mobile/app-service-mobile-windows-store-dotnet-get-started-push.md)教程，然后选择顶层的平台。

如果你使用的是 Java 或 PHP，请参阅[如何从 Java/PHP 使用通知中心](../articles/notification-hubs/notification-hubs-java-backend-how-to.md)。你可使用[通知中心 REST 接口](http://msdn.microsoft.com/library/windowsazure/dn223264.aspx)通过任何后端发送通知。
