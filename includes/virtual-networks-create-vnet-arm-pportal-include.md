...
2. 依次单击“新建”>“网络”>“虚拟网络”、单击“选择部署模型”列表中的“Resource Manager”，然后单击“创建”（如下图所示）。
...
4. 单击**“资源组”**并选择要将 VNet 添加到的资源组，或者单击**“新建”**将 VNet 添加到新资源组。下图显示了名为 **TestRG** 的新资源组的资源组设置。有关资源组的详细信息，请访问 [Azure 资源管理器概述](../articles/resource-group-overview.md#resource-groups)。
...
8. 等待创建 VNet，然后在“虚拟网络”边栏选项卡中，依次单击“所有设置”>“子网”>“添加”（如下所示）。
