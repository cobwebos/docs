...
1. 语音 SDK 要求为 Windows 10 Fall Creators Update 或更高版本生成应用程序。 在弹出的“新建通用 Windows 平台项目”窗口中，选择“Windows 10 Fall Creators Update(10.0; 内部版本 16299)”作为“最低版本”    。 在“目标版本”框中，选择此版本或任何更高版本，然后单击“确定”。  
