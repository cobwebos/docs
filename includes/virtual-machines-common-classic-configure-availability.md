...
* [选项 1：创建虚拟机和可用性集在同一时间][Option 1: Create a virtual machine and an availability set at the same time]。 然后，在创建虚拟机时会新的虚拟机添加到该集。
...
## <a id="addmachine"> </a>选项 2:将现有的虚拟机添加到可用性集
