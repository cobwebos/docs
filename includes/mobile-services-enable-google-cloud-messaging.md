...
6. 在“创建新密钥”中，单击“服务器密钥”，键入密钥的名称，并单击“创建”。
7. 记下“API 密钥”值。
   
    接下来，将使用此 API 密钥值，让 Azure 对 GCM 进行身份验证并代表应用程序发送推送通知。
