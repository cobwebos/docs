...
1. 使用 LUIS 订阅密钥和[区域](~/articles/cognitive-services/speech-service/regions.md#regions-for-intent-recognition)作为参数创建语音配置。 LUIS 订阅密钥在服务文档中称为**终结点密钥**。 不能使用 LUIS 创作密钥。 （请参见本部分中后面的注释。）
