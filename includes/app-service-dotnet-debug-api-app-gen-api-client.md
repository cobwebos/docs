## <a name="generate-an-api-app-client"></a>生成 API 应用客户端
...
3. 在“添加新项目”对话框中执行以下步骤：
   
   1. 选择“Windows 桌面”类别。
   2. 选择“控制台应用程序”项目模板。
   3. 为该项目命名。
   4. 单击“确定”，在现有解决方案中生成新的项目。
...
5. 在“添加 Microsoft Azure API 应用客户端”对话框中执行以下步骤： 
...
6. 从项目根目录打开 **Program.cs**，使用以下代码替换 **Main** 方法： 
