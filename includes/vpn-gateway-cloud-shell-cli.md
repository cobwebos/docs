...
若要打开 Cloud Shell，只需要从代码块的右上角选择“试一试”。  你还可以在单独的浏览器选项卡中启动 Cloud Shell [https://shell.azure.com](https://shell.azure.com) ，方法是转到并切换左侧的下拉列表以反映 Bash 或 PowerShell。 选择“复制”以复制代码块，将其粘贴到 Cloud Shell 中，然后按 Enter 来运行它。 
