...
| 每个存储帐户的最大入口 <sup>3</sup>（美国区域） | 如果已启用 RA-GRS/GRS/ZRS<sup>4</sup>，则为 10 Gbps；LRS<sup>2</sup> 为 20 Gbps |
| 每个存储帐户的最大出口 <sup>3</sup>（美国区域） | 如果已启用 GRS/GRS/ZRS<sup>4</sup>，则为 20 Gbps；LRS<sup>2</sup> 为 30 Gbps |
| 每个存储帐户的最大入口<sup>3</sup>（非美国区域） | 如果已启用 RA-GRS/GRS/ZRS<sup>4</sup>，则为 5 Gbps；LRS<sup>2</sup> 为 10 Gbps |
