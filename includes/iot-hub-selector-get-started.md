...
Azure IoT 中心是一项完全托管的服务，可在数百万台物联网 (IoT) 设备和一个解决方案后端之间实现安全可靠的双向通信。 IoT 项目面临的最大挑战之一是如何可靠且安全地将设备连接到解决方案后端。 为了解决此难题，IoT 中心：
...
* 在 IoT 中心内创建设备标识。
* 创建一个模拟设备应用，用于将遥测数据发送到解决方案后端，以及从解决方案后端接收命令。
