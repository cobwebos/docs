1. 在门户中，转到“新建”。 在搜索中键入“虚拟网络网关”。 在搜索返回结果中找到“虚拟网络网关”，然后单击该条目。 这会打开“创建虚拟网络网关”边栏选项卡。
2. 单击“虚拟网络网关”边栏选项卡底部的“创建”。 “创建虚拟网络网关”边栏选项卡将会打开。 填写虚拟网络网关的值。
   
    ![创建虚拟网络网关边栏选项卡字段](./media/vpn-gateway-add-gw-rm-portal-include/createvnetgw300.png "Create virtual network gateway blade fields")
...
14. 单击“创建”  开始创建网关。 将会验证这些设置，并会在仪表板上看到“正在部署虚拟网络网关”磁贴。 创建网关最多可能需要 45 分钟。 你可能需要刷新门户页才能看到完成状态。
    ...
    ![部署虚拟网络网关](./media/vpn-gateway-add-gw-rm-portal-include/deployvnetgw150.png "Deploying Virtual network gateway")
