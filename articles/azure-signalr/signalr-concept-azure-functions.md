...
> [!NOTE]
> 了解如何在交互式教程一起使用 SignalR 和 Azure Functions[启用自动更新中使用 Azure Functions 和 SignalR 服务的 web 应用程序](https://docs.microsoft.com/learn/modules/automatic-update-of-a-webapp-using-azure-functions-and-signalr)。
...
有关如何结合使用 Azure Functions 和 SignalR 服务的完整详细信息，请访问以下资源：

* [Azure Functions 开发和使用 SignalR 服务的配置](signalr-concept-serverless-development-config.md)
* [启用自动更新中使用 Azure Functions 和 SignalR 服务的 web 应用程序](https://docs.microsoft.com/learn/modules/automatic-update-of-a-webapp-using-azure-functions-and-signalr)
