---
title: 使用 Azure Functions 和 Azure SignalR 生成实时应用
description: 在无服务器应用程序中使用 Azure SignalR Service 的概述。
author: sffamily
ms.service: signalr
ms.topic: overview
ms.date: 09/18/2018
...
在本文中，你将大致了解如何结合使用 Azure Functions 和 SignalR Service 实现各种无服务器实时消息传递的情景。 请按照以下其中一个快速入门了解详细信息。
