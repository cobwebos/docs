<properties 
	pageTitle="在 HDInsight Hadoop 中使用 Hive 进行网站日志分析| Azure" 
...
- 你必须已设置 **HDInsight 群集**。有关说明，请参阅[设置 HDInsight 群集][hdinsight-provision]。 
...
[hdinsight-hive-analyze-sensor-data]: hdinsight-use-hive-sensor-data-analysis
