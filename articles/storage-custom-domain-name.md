...
<p>此任务中的过程适用于 Azure 存储帐户。对于云服务，请参阅<a href = "/zh-cn/develop/net/common-tasks/custom-dns/">为 Azure 云服务配置自定义域名]</a>；对于网站，请参阅<a href="/zh-cn/develop/net/common-tasks/custom-dns-web-site/">为 Azure 网站配置自定义域名</a>。</p>
</div>
