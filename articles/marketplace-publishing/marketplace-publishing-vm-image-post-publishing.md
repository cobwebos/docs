---
title: "管理 Azure 应用商店中的虚拟机映像 | Microsoft Docs"
description: "有关如何在初始发布后管理 Azure 应用商店中的虚拟机映像的详细指南"
...
本文介绍如何在 Azure 应用商店中更新实时虚拟机产品。 其中将指导你完成将一个或多个新 SKU 添加到现有产品的过程。 此外，还将引导你完成删除从应用商店的实时虚拟机产品或 SKU 的过程。
...
在产品和 SKU 列出“应用商店”后，无法更改以下文本框：[](http://azure.microsoft.com/marketplace)
...
6. 在“OS VHD URL”框中，输入为操作系统 VHD 创建的共享访问签名 URI 并保存所做的更改。
   ...
   >
   >
7. 转到“发布”选项卡，然后单击“推送到过渡环境”。 有关在过渡环境中测试产品的详细指导，请参阅[测试应用商店的 VM 产品](marketplace-publishing-vm-image-test-in-staging.md)。
8. 在过渡环境中测试产品后，导航到发布门户中的“发布”选项卡。 单击“请求批准推送到生产”按钮，在应用商店中重新发布产品。
...
可以更新应用商店中实时产品或 SKU 的非技术（市场营销、法律、支持、类别）详细信息。
...
6. 在“详细信息”选项卡的“徽标”部分中更新徽标。 确保徽标遵守 [Azure 应用商店准则](marketplace-publishing-push-to-staging.md#step-1-provide-marketplace-marketing-content)。
...
5. 单击“计划”选项卡。 在“SKU”部分中，更新 SKU 的“标题”、“摘要”和“说明”，然后保存更改。
   ...
   * 不要在 SKU 标题和产品摘要下输入重复文本。
   >
   >
6. 转到“发布”选项卡，然后单击“推送到过渡环境”。 有关在过渡环境中测试产品的详细指导，请参阅[测试应用商店的 VM 产品](marketplace-publishing-vm-image-test-in-staging.md)。
7. 在过渡环境中测试产品后，导航到发布门户中的“发布”选项卡。 单击“请求批准推送到生产”按钮，在应用商店中重新发布产品。
...
7. 若要更新或删除现有链接，请选择该链接，然后单击“编辑”按钮或“删除”按钮。
   ...
   >
   >
8. 转到“发布”选项卡，然后单击“推送到过渡环境”。 有关在过渡环境中测试产品的详细指导，请参阅[测试应用商店的 VM 产品](marketplace-publishing-vm-image-test-in-staging.md)。
9. 在过渡环境中测试产品后，导航到发布门户中的“发布”选项卡。 单击“请求批准推送到生产”按钮，在应用商店中重新发布产品。
...
2. 转到“虚拟机”选项卡并选择你的产品。
3. 在左侧菜单中，单击“类别”选项卡。
4. 在“类别”部分中，更新产品类别并保存更改。 可以为 Azure 应用商店库选择最多五个类别。
5. 转到“发布”选项卡，然后单击“推送到过渡环境”。 有关在过渡环境中测试产品的详细指导，请参阅[测试应用商店的 VM 产品](marketplace-publishing-vm-image-test-in-staging.md)。
6. 在过渡环境中测试产品后，导航到发布门户中的“发布”选项卡。 单击“请求批准推送到生产”按钮，在应用商店中重新发布产品。
...
4. 在对话框中，以小写形式输入“SKU 标识符”。 若要使用 BYOL 计费模型发布新 SKU，请选中“自带许可(BYOL)模型”复选框。 否则，请清除该复选框。 单击勾选标记创建新 SKU。 如果未选择 BYOL 计费模型，则计费模型将自动设置为“每小时”。 如果想要为每小时计费模型启用 30 天免费试用，请针对“是否提供免费试用?”单击“一个月”。 否则，选择“无试用”。 （仅当创建新 SKU 时未选择 BYOL 时，才显示选项“是否提供免费试用?”。）
   ...
   > [!IMPORTANT]
   > 仅在批准发布解决方案模板的情况下，才可将“针对应用商店隐藏此 SKU，因为它始终应通过解决方案模板购买”选项标记为“是”。 否则，此选项应始终为“否”。
   >
   >
...
6. 若要添加新 SKU 的市场营销材料，请参阅[提供应用商店市场营销内容](marketplace-publishing-push-to-staging.md#step-1-provide-marketplace-marketing-content)。
...
## <a name="delete-a-listed-offer-from-the-marketplace"></a>从应用商店中删除已列出的产品
请求删除实时产品时，需要注意多个方面。 若要从支持团队获取有关从应用商店中删除已列出的产品的指南，请执行以下步骤：
...
## <a name="delete-a-listed-sku-from-the-marketplace"></a>从应用商店中删除已列出的 SKU
若要从应用商店中删除已列出的 SKU，请执行以下步骤：
...
5. 转到发布门户中的“发布”选项卡。 单击“请求批准推送到生产”按钮，在 Azure 应用商店中重新发布产品。
6. 在应用商店中重新发布产品后，该 SKU 将从应用商店和 Azure 门户中删除。

## <a name="delete-the-current-version-of-a-listed-sku-from-the-marketplace"></a>从应用商店中删除已列出的 SKU 的当前版本
若要从应用商店中删除已列出的 SKU 的当前版本，请执行以下步骤： 
...
5. 转到发布门户中的“发布”选项卡。 单击“请求批准推送到生产”按钮，在 Azure 应用商店中重新发布产品。
6. 在应用商店中重新发布产品后，已列出的 SKU 的当前版本将从应用商店和 Azure 门户中删除。 然后，SKU 将回滚到其以前的版本。
...
12. 转到“发布”选项卡，然后单击“推送到过渡环境”。 有关在过渡环境中测试产品的详细指导，请参阅[测试应用商店的 VM 产品](marketplace-publishing-vm-image-test-in-staging.md)。
13. 在过渡环境中测试产品后，导航到发布门户中的“发布”选项卡。 单击“请求批准推送到生产”按钮，在应用商店中重新发布产品。
...
5. 完成更改后，请单击“请求批准推送到生产”按钮，在应用商店中重新发布产品。

## <a name="see-also"></a>另请参阅
* [入门：将产品发布到 Azure 应用商店](marketplace-publishing-getting-started.md)
* [了解付款报告](marketplace-publishing-report-payout.md)
* [更改云解决方案提供商经销商激励](marketplace-publishing-csp-incentive.md)
* [排查应用商店中的常见发布问题](marketplace-publishing-support-common-issues.md)
