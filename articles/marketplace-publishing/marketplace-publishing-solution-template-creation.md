---
title: 为市场创建解决方案模板指南 | Microsoft Docs
...
* VM 扩展：[ VM 代理和 VM 扩展概述](https://msdn.microsoft.com/library/azure/dn832621.aspx)和 [Azure VM 扩展和功能](https://docs.microsoft.com/azure/virtual-machines/extensions/features-windows)
