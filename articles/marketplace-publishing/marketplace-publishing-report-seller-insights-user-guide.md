...
管理员和用户需要使用有效的 Microsoft 帐户 (LiveID http://signup.live.com) 或公司的帐户进行身份验证。 请确保输入的 ID 与受监视的邮箱相关联。
...
为了激活你的服务，管理员应导航到邀请电子邮件中所列的 URL (https://reports.azure.com)。

>[!NOTE]
>注意：如果管理员电子邮件列为 Microsoft 帐户，并且你尚未创建与从中接收邀请的电子邮件地址关联的 Microsoft 帐户，则在创建 Microsoft 帐户时，你需要通过导航到 https://signup.live.command 进行登录，利用此电子邮件地址创建该帐户。
...
>[!NOTE]
>管理员是实际将解决方案发布到 Azure 应用商店的帐户所有者。  此帐户的所有者可向其他人提供访问权限。  
...
1. 选择“摘要”选项卡。
2. 在此处输入所需时间段的开始日期，然后单击“应用”。 将显示 3 个月的数据。
3. 此处显示所选 3 个月时间段的新订单趋势数据。
4. 此处将按“渠道”和“产品类型”显示所选时间段的新订单。
5. 从此面板中选择“排名靠前的 5 个市场”、“表现最佳的 5 款产品”或“排名靠前的 5 家客户”视图。
...
A. 在“面板 A”中，可以选择“订单和用途”选项卡。  在此处可以从“报告类型”选项卡中选择“订单”或“用途”，然后使用滑块选择所需的数据。

B. 在“面板 B”中，可以选择每月数据 -“订单”或“用途”，具体取决于在面板 A 的“报告类型”中选择的内容。显示的数据将反映所输入的日期，以及在面板 A 中使用滑块应用的筛选器。

C. 在“面板 C”中，可以选择 3 个月的趋势数据 -“订单”或“用途”，具体取决于在面板 A 的“报告类型”中选择的内容。显示的数据将反映所输入的日期，以及在面板 A 中使用滑块应用的筛选器。

D. *面板 D*：此面板提供各个订阅相关的数据。  可从此面板下载 Excel 或 csv 格式的数据。
...
![面板图 A][10]
  ...
  2. 从“报告类型”选项卡中选择“订单”。
  3. 使用“筛选器”符号可以显示切片器可隐藏已显示的切片器（“高级筛选器”）。  使用这些切片器可按 Azure 许可证类型、应用商店许可证类型、市场、产品类型和预览状态筛选想要查看的数据。  有关这些术语的定义，请参阅“帮助”选项卡。
  4. 选择所需的开始日期，然后单击“转到”。
...
####<a name="trend-view---panel-c"></a>趋势视图 - 面板 C
  ...
  1. 选择“趋势视图”。
  2. 从“主题区域”下拉列表中选择要查看的项；单击“应用”。  默认设置为“全选”。

  ![订单每月视图面板 C 中的主题区域下拉列表][17]
  3. 使用筛选器符号选择“全部”数据，或者为所有选择项选择“排名靠前的 10 个”。  默认设置为“排名靠前的 10 个”。

  ![订单每月视图面板 C 中的筛选器符号][18]
  4. 翻转所选图表中的每个条形可以显示基础数据。
  5. 切换“+”符号可以显示选择查看的每个图表下面的数据。
...
![面板图 B][11]
  ...
  1. 选择“每月视图”。
  2. 将以小时为单位显示用途摘要详细信息。
  3. 对于“每月视图”，“用途摘要”面板提供以下信息的图表视图：
    - 按市场列出的排名靠前的 10 种用途
    - 按产品类型列出的排名靠前的 10 种用途
    - 按 Azure 许可证类型列出的用途
    - 按应用商店许可证类型列出的用途

>[!NOTE]
>显示的数据将反映使用面板 A 中的切片器应用的筛选器 - 例如，为“非正常用途”显示图表。
...
###<a name="accessing-detailed-customer-data"></a>访问详细客户数据
  ...
  1. 在“订单详细信息”面板中的“订单”或“用途”下，单击所需的 Azure 订阅 ID。  请注意，只能单击非 BYOL 应用商店许可证类型，出于安全原因，BYOL 订阅 ID 已被屏蔽。

  ![订单和用途客户详细信息面板中的详细信息][26]
  2. 你将重定向到“客户”选项卡，可以检索订阅 ID 关联到的客户的详细数据。
...
###<a name="customer-data"></a>客户数据
  ...
  1. 选择“客户”选项卡。
  2. 使用切片器可按 Azure 许可类型或应用商店许可证类型筛选想要查看的数据。
  3. 选择所需时间段的“开始日期”和“结束日期”。
  4. 将显示按应用商店许可证类型列出的客户摘要详细信息。
...
1. 选择“用户管理”选项卡。
2. 若要添加用户，请导航到“用户管理”，然后单击“添加用户”。
3. 若要添加用户，请输入与其 Microsoft 帐户或公司帐户关联的电子邮件地址，然后单击“继续”。
4. 管理员可以向用户分配只读的报告访问权限。
5. 输入用户详细信息 - 名字、姓氏和电子邮件，然后单击“继续”。
6. 单击要向用户分配的权限，然后单击“继续”。
7. 检查输入的信息，然后单击“保存”继续。  现已成功添加用户。
...
1. 选择“用户管理”选项卡，然后单击“编辑用户”。
2. 找到要修改其权限的用户。  请注意，也可以在此处添加用户。
3. 单击要对该用户删除的权限。  请注意，也可以在此处删除用户。
...
1. 输入你的联系信息、时区、区域和语言首选项，然后选择“继续”。
2. 为事件指定一个标题，并提供尽可能多的信息。  还可以上载包含屏幕截图等参考信息的支持文件，然后选择“提交”。
...
7. 在此处，验证组织帐户的密码是否有效。 如果密码无效，请执行***密码重置***。
