...
如果使用 [Linux 命令行工具](https://docs.microsoft.com/cli/azure/get-started-with-az-cli2)，请使用以下命令：`azure vm image create <image name> --location <Location of the data center> --OS Linux <LocationOfLocalVHD>`
