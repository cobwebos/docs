...
若要开始发布过程，需要创建 Microsoft 帐户。 此帐户用于注册 **Microsoft 开发人员中心**和 **Azure 发布门户**。 对于 Azure 市场产品/服务，只应具有一个 Microsoft 帐户。 它不应该特定于服务或产品。
...
6. 输入“发布者显示名称”，通常为公司名称。
   ...
   > [!TIP]
   > 优惠列出后，开发人员中心中输入的发布者显示名称不会显示在 Azure 市场中。 但若要完成注册过程，必须填写该名称。
   >
   >
7. 输入用于帐户验证的“联系人信息”。
