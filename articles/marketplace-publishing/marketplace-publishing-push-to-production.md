...
3. 单击按钮“请求批准推送到生产”。 发出请求后，批准团队会执行最终审查，随后产品/服务会在 Azure 应用商店中可用。
...
> * 如果上述步骤都成功，产品/服务将批准用于生产。 此时，发布门户中的状态将变为“已列出”。 但是，此“已列出”状态并不表示过程已完成。 需要先完成以下步骤，产品/服务才能在 Azure 应用商店中可用。
...
* 特大徽标是可选项。 发布者可以选择不上传特大徽标。 **但是，在上传特大图标后，将无法将其从发布门户中删除。此时，合作伙伴必须遵循特大图标的 Azure 应用商店准则，否则产品/服务将不批准用于生产。**
