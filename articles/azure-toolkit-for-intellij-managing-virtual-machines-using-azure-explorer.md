...
# <a name="managing-virtual-machines-using-the-azure-explorer-for-intellij"></a>使用用于 IntelliJ 的 Azure 资源管理器管理虚拟机

Azure 资源管理器是用于 IntelliJ 的 Azure 工具包的一部分，它为 Java 开发人员提供易用的解决方案，用于从 IntelliJ IDE 内部管理其 Azure 帐户中的虚拟机。

[!INCLUDE [azure-toolkit-for-intellij-prerequisites](../includes/azure-toolkit-for-intellij-prerequisites.md)]

[!INCLUDE [azure-toolkit-for-intellij-show-azure-explorer](../includes/azure-toolkit-for-intellij-show-azure-explorer.md)]

## <a name="creating-a-virtual-machine-in-intellij"></a>在 IntelliJ 中创建虚拟机

以下步骤将引导你完成使用 Azure 资源管理器创建虚拟机的步骤。

1. 按照[用于 IntelliJ 的 Azure 工具包的登录说明]一文中的步骤登录到 Azure 帐户。

1. 在“Azure 资源管理器”工具窗口中，展开 **Azure** 节点，右键单击“虚拟机”，然后单击“创建 VM”。
   ![“创建 VM”菜单][CR01]
...
1. 在该向导的下一屏幕上，指定以下选项，然后单击“下一步”：![“新建虚拟机”向导][CR03]
   ...
   a. **位置**：指定将创建虚拟机的位置；例如“美国西部”。

   b. **建议的映像**：指定你将从常用映像的简化列表中选择映像。

   c. **自定义映像**：指定你将选择自定义映像，为此将需要指定以下选项：

      * **发布者**：指定创建了用于创建虚拟机的映像的发布者，例如“Microsoft”。

      * **产品/服务**：指定要使用哪一个从所选发布者提供的虚拟机；例如“JDK”。

      * **Sku**：从所选产品/服务中指定要使用的*库存单位 (SKU)*；例如“JDK_8”。
...
1. 在该向导的下一屏幕上，指定以下选项，然后单击“下一步”：![“新建虚拟机”向导][CR04]
   ...
   d. **密码**和**确认**：指定管理员帐户的密码。

1. 在该向导的最后一个屏幕上，指定以下选项，然后单击“完成”：![“新建虚拟机”向导][CR07]

   a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 **资源组**：为虚拟机指定资源组；需要选择以下选项之一：
      * **新建**：指定要创建新的资源组。
      * **使用现有**：指定将从列表中选择与 Azure 帐户关联的资源组。

   b. **存储帐户**：指定要用于存储虚拟机的存储帐户，可以选择现有存储帐户，也可以创建新帐户。 如果选择“&lt;&lt;新建&gt;&gt;”，将显示以下对话框：

      ![“新建存储帐户”对话框][CR05]

   c. **虚拟网络**和**子网**：指定虚拟机将连接到的虚拟网络和子网；可以选择现有网络和子网以用于虚拟机，也可以创建新的网络和子网。 如果选择“&lt;&lt;新建&gt;&gt;”，将显示以下对话框：
...
## <a name="restarting-a-virtual-machine-in-intellij"></a>在 IntelliJ 中重新启动虚拟机

若要在 IntelliJ 中使用 Azure 资源管理器重新启动虚拟机，请使用以下步骤：

1. 在“Azure 资源管理器”工具窗口中，右键单击虚拟机，然后选择“重新启动”。
   ![重新启动虚拟机][RE01]

1. 出现提示时，单击“是”以重新启动虚拟机。
   ![重新启动虚拟机][RE02]

## <a name="shutting-down-a-virtual-machine-in-intellij"></a>在 IntelliJ 中关闭虚拟机

若要在 IntelliJ 中使用 Azure 资源管理器关闭正在运行的虚拟机，请使用以下步骤：

1. 在“Azure 资源管理器”工具窗口中，右键单击虚拟机，然后选择“关闭”。
   ![关闭虚拟机][SH01]

1. 出现提示时，单击“是”以关闭虚拟机。
   ![关闭虚拟机][SH02]

## <a name="deleting-a-virtual-machine-in-intellij"></a>在 IntelliJ 中删除虚拟机

若要在 IntelliJ 中使用 Azure 资源管理器删除虚拟机，请使用以下步骤：

1. 在“Azure 资源管理器”工具窗口中，右键单击虚拟机，然后选择“删除”。
   ![删除虚拟机][DE01]
