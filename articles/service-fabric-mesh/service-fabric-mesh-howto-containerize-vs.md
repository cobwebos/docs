...
description: 将服务结构网格容器业务流程支持添加到使用完整 .NET 框架ASP.NET和控制台项目。
author: dkkapur
ms.author: dekapur
ms.date: 11/08/2018
ms.topic: conceptual
...
* 如果没有 Azure 订阅，则可以在开始之前[创建一个免费帐户](https://azure.microsoft.com/free/?WT.mc_id=A261C142F)。
