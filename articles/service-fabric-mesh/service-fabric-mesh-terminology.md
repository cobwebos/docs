...
**Service Fabric 本机应用程序**：Service Fabric 本机应用程序由[本机应用程序模型](../service-fabric/service-fabric-application-model.md)（基于 XML 的应用程序和服务清单）描述。  Service Fabric 本机应用程序无法在 Service Fabric 网格中运行。
