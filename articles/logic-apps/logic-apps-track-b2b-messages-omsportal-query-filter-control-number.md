...
若要查找[Azure Monitor 日志](../log-analytics/log-analytics-overview.md)跟踪的 AS2、X12 或 EDIFACT 消息，可以创建基于特定条件筛选操作的查询。 例如，你可以根据特定的交换控制编号查找消息。
...
* 如果尚未这样做，请将[诊断数据发布到 Azure Monitor 日志](../logic-apps/logic-apps-track-b2b-messages-omsportal.md)，并[在 Azure Monitor 日志中设置消息跟踪](../logic-apps/logic-apps-track-b2b-messages-omsportal.md)。
