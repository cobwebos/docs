...
为了使模块可与任何租户和订阅访问令牌一起使用，建议通过 [ARMClient](https://github.com/projectkudu/ARMClient) 命令行工具来使用它。  此[博客文章](https://blog.davidebbo.com/2015/01/azure-resource-manager-client.html)详细讨论了 ARMClient。
