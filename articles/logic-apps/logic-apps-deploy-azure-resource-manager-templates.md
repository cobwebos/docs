...
* [概述：使用 Azure 资源管理器模板自动部署逻辑应用](logic-apps-azure-resource-manager-templates-overview.md)
...
* [教程：Azure 资源管理器模板与 Azure 管道的持续集成](../azure-resource-manager/templates/template-tutorial-use-azure-pipelines.md)
