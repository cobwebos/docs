...
本文介绍了使用 [Azure 逻辑应用](../logic-apps/logic-apps-overview.md)创建工作流时可以使用的函数。 若要详细了解逻辑应用定义中的函数，请参阅 [Azure 逻辑应用的工作流定义语言](../logic-apps/logic-apps-workflow-definition-language.md#functions)。 
