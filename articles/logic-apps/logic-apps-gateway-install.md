...
用户会使用工作或学校帐户进行登录。 这是组织帐户。 如果注册 Office 365 产品/服务但不提供实际工作电子邮件，则其类似于 jeff@contoso.onmicrosoft.com。 云服务内的帐户存储在 Azure Active Directory (AAD) 中的租户中。 在大多数情况下，AAD 帐户的 UPN 会与电子邮件地址匹配。
...
* [创建与逻辑应用之间的本地连接](../logic-apps/logic-apps-gateway-connection.md)
