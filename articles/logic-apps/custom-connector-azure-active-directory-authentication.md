...
本教程使用 Azure 资源管理器 API 作为示例。 Azure 资源管理器可帮助管理在 Azure 中生成的解决方案（例如数据库、虚拟机和 Web 应用）的组件。 若要从工作流管理 Azure 资源，Azure 资源管理器的自定义连接器可能会发挥作用。 有关详细信息，请参阅 [Azure Resource Manager 概述](../azure-resource-manager/resource-group-overview.md)。
...
2. 在 Azure 主菜单中，选择“Azure Active Directory”，以便可以查看当前目录。
   ...
   > [!TIP]
   > 如果 Azure 主菜单中未显示“Azure Active Directory”，请选择“更多服务”。 在“筛选”框中，键入“Azure Active Directory”作为筛选器，选择“Azure Active Directory”。
