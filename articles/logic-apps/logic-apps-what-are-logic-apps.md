---
title: "连接应用并将数据与工作流相集成 - Azure 逻辑应用 | Microsoft 文档"
description: "通过连接应用并将数据与 Azure 逻辑应用相集成，创建工作流并使过程自动化。"
author: kevinlam1
manager: anneta
editor: 
services: logic-apps
...
![流应用设计器](media/logic-apps-what-are-logic-apps/LogicAppCapture2.png)

如前所述，使用逻辑应用可以自动执行业务流程。 下面是一些示例：  

* 将已上传到 FTP 服务器的文件移到 Azure 存储中
* 跨本地和云系统处理并路由订单
