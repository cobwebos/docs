...
* 已定义并与 Azure 订阅关联的[集成帐户](logic-apps-enterprise-integration-create-integration-account.md)。 必须拥有集成帐户，才能使用编码 EDIFACT 消息连接器。 
...
3.  在搜索框中，输入“EDIFACT”作为筛选器。 选择**按协议名称编码 EDIFACT 消息**，或**按标识编码到 EDIFACT 消息**。
