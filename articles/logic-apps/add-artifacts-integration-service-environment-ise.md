...
创建[integration service 环境 (ISE)](../logic-apps/connect-virtual-network-vnet-isolated-environment-overview.md)后, 添加逻辑应用、集成帐户和自定义连接器等项目, 以便它们可以访问 Azure 虚拟网络中的资源。
...
## <a name="create-logic-apps-in-an-ise"></a>在 ISE 中创建逻辑应用
...
## <a name="create-integration-accounts-in-an-ise"></a>在 ISE 中创建集成帐户
...
## <a name="create-custom-connectors-in-an-ise"></a>在 ISE 中创建自定义连接器
