...
* 若要获取路线的行程时间，需要必应地图 API 的访问密钥。 若要获取此密钥，请执行[如何获取必应地图密钥](https://msdn.microsoft.com/library/ff428642.aspx)中的步骤。 
...
3. 如果没有必应地图连接，系统会提示创建一个连接。 提供以下连接详细信息，然后选择“创建”  。
   ...
   | **API 密钥** | <*your-Bing-Maps-key*> | 输入以前接收的必应地图密钥。 如果没有必应地图密钥，请了解[如何获取密钥](https://msdn.microsoft.com/library/ff428642.aspx)。 | 
   | | | |  
