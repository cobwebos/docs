...
通过 Visual Studio 2015 的 [Enterprise Integration Pack](logic-apps-enterprise-integration-overview.md "了解 enterprise integration pack") 可以创建 Biztalk 集成项目。  通过创建集成映射文件可以直观地在两个 XML 架构文件之间映射项目。  在生成此项目之后，会输出 XSLT 文档。
