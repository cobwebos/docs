...
1. In the [Azure Management Portal](http://manage.windowsazure.cn/), from the web site's Management pages, click the **Monitor** tab to display the **Monitor** management page. By default the chart on the **Monitor** page displays the same metrics as the chart on the **Dashboard** page.
...
For more information about Azure Storage Accounts, see [How to Manage Storage Accounts](http://www.windowsazure.cn/zh-cn/manage/services/storage/how-to-manage-a-storage-account/).
...
- **Web Server Logging** - Turn on Web Server logging to save web site logs using the W3C extended log file format. Web server logging produces a record of all incoming requests to your web site, which contains information such as the client IP address, requested URI, HTTP status code of the response, and the user agent string of the client. You can save the logs to an Azure Storage Account or to the File System.
 ...
 To save web server logs to an Azure Storage Account, choose **Storage**, and then choose **manage storage** to specify a storage account and an Azure Blob Container where the logs will be kept. For more information about Azure Storage Accounts, see [How to Manage Storage Accounts](http://www.windowsazure.cn/zh-cn/manage/services/storage/how-to-manage-a-storage-account/).
...
1. From the **Start Screen** or the **Start Menu**, search for **Azure PowerShell**. Right-click the **Azure PowerShell** entry and select **Run as Administrator**.
	...
	<div class="dev-callout"> 
	<b>Note</b> 
	<p>If <b>Azure PowerShell</b> is not installed, see <a href="http://msdn.microsoft.com/zh-cn/library/azure/jj554332.aspx">Getting Started with Azure PowerShell Cmdlets</a> for installation and configuration information.</p>
	</div>
...
<div class="dev-callout"> 
<b>Note</b> 
<p>If the <b>azure</b> command is not installed, see <a href="http://azure.microsoft.com/zh-cn/documentation/articles/xplat-cli/">How to use the Azure Command-Line Tools</a> for installation and configuration information.</p>
</div>
...
5.	Enter the URL for the service that you want to monitor. For example, [http://contoso.chinacloudapp.cn](http://contoso.chinacloudapp.cn).
...
- [Scott Guthrie introduces Azure Web Sites and sets up Endpoint Monitoring](http://azure.microsoft.com/zh-cn/documentation/videos/websites-and-endpoint-monitoring-scottgu/)

- [Keeping Azure Web Sites up plus Endpoint Monitoring - with Stefan Schackow](http://azure.microsoft.com/zh-cn/documentation/videos/azure-web-sites-endpoint-monitoring-and-staying-up/)
