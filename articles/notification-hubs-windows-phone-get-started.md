...
You can send notifications using notification hubs from any back-end using the <a href="http://msdn.microsoft.com/zh-cn/library/azure/dn223264.aspx">REST interface</a>. This tutorial sends notifications with a .NET console app, and with a Mobile Service using a node script.
