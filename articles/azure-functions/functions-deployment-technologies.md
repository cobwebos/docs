...
| 部署技术 | Windows 消耗 | Windows 高级版（预览） | Windows 专用  | Linux 消耗 | Linux 高级版（预览） | Linux 专用 |
|-----------------------|:-------------------:|:-------------------------:|:------------------:|:---------------------------:|:-------------:|:---------------:|
| 外部包 URL<sup>1</sup> |✔|✔|✔|✔|✔|✔|
| 压缩部署 |✔|✔|✔|✔|✔|✔|
| Docker 容器 | | | | |✔|✔|
...
| | Windows 消耗 | Windows 高级版（预览） | Windows 专用 | Linux 消耗 | Linux 高级版（预览）| Linux 专用 |
|-|:-----------------: |:-------------------------:|:-----------------:|:---------------------------:|:---------------:|:---------------:|
| C# | | | | | |
