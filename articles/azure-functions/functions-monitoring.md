...
若要开始，请[安装和配置 Azure PowerShell](/powershell/azureps-cmdlets-docs)。
...
有关详细信息，请参阅[如何：流式传输 Web 应用的日志](../app-service-web/web-sites-enable-diagnostic-log.md#streamlogs)。 
