...
此示例脚本将创建一个 Azure Function App，作为函数的容器。 将使用消耗计划创建最适合事件驱动无服务器工作负荷的 Function App。
...
[!code-azurecli[主要](../../../cli_scripts/azure-functions/create-function-app-consumption/create-function-app-consumption.sh "基于消耗计划创建 Azure Function")]
