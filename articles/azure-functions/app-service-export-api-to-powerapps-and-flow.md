...
> [!IMPORTANT]
> 本文中显示的 API 定义功能仅适用于 Azure 函数运行时和应用服务应用[的版本 1.x。](functions-versions.md#creating-1x-apps) 函数的版本 2.x 与 API 管理集成，以创建和维护 OpenAPI 定义。 要了解更多信息，请参阅[为具有 Azure API 管理的功能创建 OpenAPI 定义](functions-openapi-definition.md)。 
