...
1. 在“添加 Archetype”窗口中按以下说明填写各个字段****：
    ...
    - _版本_： 检查并使用[来自中央存储库](https://mvnrepository.com/artifact/com.microsoft.azure/azure-functions-archetype)
    ![的最新版本 从 IntelliJ IDEA 中的原型创建 Maven 项目](media/functions-create-first-java-intellij/functions-create-intellij.png)  
1. 选择 **"确定**"，然后选择 **"下一步**"。
...
1. 展开**插件** > **azure 函数**和打开的 Azure**函数：运行**以启动 Azure 函数本地运行时。  
...
1. 请在“运行”菜单中选择“编辑配置”********。
1. 选择“(+)”添加“远程”********。
1. 填写“名称”和“设置”字段，然后选择“确定”以保存配置____****。
