...
1. 在“添加 Archetype”窗口中按以下说明填写各个字段  ：
    ...
    - _版本_：检查并使用[中央存储库](https://mvnrepository.com/artifact/com.microsoft.azure/azure-functions-archetype)
    ![中的最新版本，通过 IntelliJ 创意中的原型创建 Maven 项目](media/functions-create-first-java-intellij/functions-create-intellij.png)  
1. 选择“确定”  ，然后选择“下一步”  。
