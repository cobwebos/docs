...
还需要至少具有一个项目的 GitHub 帐户。 可以[注册免费 GitHub 帐户](https://github.com/join)（如果还没有）。
...
2. 在新函数中，单击“</> 获取函数 URL”，然后复制并保存相关值。 针对“</> 获取 GitHub 机密”执行相同的操作。 请使用这些值在 GitHub 中配置 Webhook。 
