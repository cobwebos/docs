---
title: Azure 活动中心触发器为 Azure 函数
description: 了解如何在 Azure 函数中使用 Azure 事件中心触发器。
...
ms.locfileid: "79277669"
---
# <a name="azure-event-hubs-bindings-for-azure-functions"></a>Azure Functions 的 Azure 事件中心绑定

本文介绍如何使用 Azure 函数的[Azure 事件中心](../event-hubs/event-hubs-what-is-event-hubs.md)触发器。 Azure 函数支持事件中心的触发器和[输出绑定](functions-bindings-event-hubs-output.md)。
