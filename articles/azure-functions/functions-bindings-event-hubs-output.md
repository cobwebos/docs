---
title: Azure 事件中心输出绑定用于 Azure 函数
description: 了解如何使用 Azure 函数将消息写入 Azure 事件中心流。
...
---
# <a name="azure-event-hubs-output-binding-for-azure-functions"></a>Azure 事件中心输出绑定用于 Azure 函数

本文介绍如何使用 Azure Functions 的 [Azure 事件中心](../event-hubs/event-hubs-what-is-event-hubs.md)绑定。 Azure Functions 支持事件中心的触发器和输出绑定。

有关设置和配置详细信息的信息，请参阅[概述](functions-bindings-event-hubs.md)。
