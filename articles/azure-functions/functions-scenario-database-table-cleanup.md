...
你需要在[使用 Azure 门户在 AZURE SQL 数据库中完成创建数据库](../azure-sql/database/single-database-create-quickstart.md)时，获取创建的数据库的连接字符串。
...
你需要添加包含 SqlClient 库的 NuGet 包。 此数据访问库需要连接到 SQL 数据库。
