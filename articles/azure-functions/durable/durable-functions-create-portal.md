...
如果要创建 JavaScript 持久函数，则需要安装[`durable-functions`npm 包](https://www.npmjs.com/package/durable-functions)。
...
1. 展开函数应用，然后单击**函数**旁边的**+** 按钮。 如果这是函数应用中的第一个函数，请依次选择“门户中”****、“继续”****。 否则，请转到第三步。
