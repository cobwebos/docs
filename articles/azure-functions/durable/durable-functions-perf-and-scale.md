...
队列、 表和 blob 由 Durable Functions 中配置的 Azure 存储帐户创建。 可以使用 **host.json** 文件中的 `durableTask/azureStorageConnectionStringName` 设置指定要使用的帐户。
...
> [创建第一个持久函数中C#](durable-functions-create-first-csharp.md)
