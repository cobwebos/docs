...
Durable Functions 是 *Azure Functions* 和 [Azure WebJobs](../functions-overview.md) 的扩展，可用于在无服务器环境中编写有状态函数[](../../app-service/web-sites-create-web-jobs.md)。 该扩展可用于管理状态、检查点和重启。 如果你不熟悉 Durable Functions，请参阅[概述文档](durable-functions-overview.md)。
