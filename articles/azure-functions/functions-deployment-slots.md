...
1. 导航到 function app
1. 单击要交换的源槽名称
1. 在 "*概述*" 选项卡中，单击 "**交换**" 按钮 ![Swap Azure Functions 部署槽 "](./media/functions-deployment-slots/azure-functions-deployment-slots-swap.png)
1. 验证交换的配置设置，并单击 "**交换**" ![Swap Azure Functions 部署槽 "](./media/functions-deployment-slots/azure-functions-deployment-slots-swap-config.png)
