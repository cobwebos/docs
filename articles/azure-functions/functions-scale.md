...
即使启用了 AlwaysOn，各函数的执行超时也由 `functionTimeout`host.json[ 项目文件中的 ](functions-host-json.md#functiontimeout) 设置控制。

## <a name="determine-the-hosting-plan-of-an-existing-application"></a>确定现有应用程序的托管计划

要确定你的函数应用所使用的托管计划，请在 **Azure 门户**中参阅函数应用的“概览”选项卡中的“应用服务计划/定价层”[](https://portal.azure.com)。 对于应用服务计划，还指明了定价层。
