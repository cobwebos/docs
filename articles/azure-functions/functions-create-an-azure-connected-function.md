<properties
   pageTitle="创建要与 Azure 服务绑定的 Azure Function | Microsoft Azure"
...
# 创建要与 Azure 服务绑定的 Azure Function
   
[AZURE.INCLUDE [入门笔记](../../includes/functions-getting-started.md)]

在此短片中，将介绍如何创建用于侦听 Azure 队列上消息的 Azure Function，以及将消息复制到 Azure Blob。
