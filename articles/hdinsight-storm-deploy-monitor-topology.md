...
有关详细信息，请参阅 <a href="https://github.com/apache/storm/blob/master/STORM-UI-REST-API.md" target="_base">Storm UI 自定义 API</a>。以下信息特定于将 REST API 与 Apache Storm on HDInsight 配合使用的情况。
