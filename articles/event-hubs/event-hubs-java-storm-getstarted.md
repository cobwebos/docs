---
title: "使用 Apache Storm 通过 Java 使用事件中心入门 | Microsoft Docs"
...
> [!NOTE]
> 在本教程中，只出于开发目的以本地模式使用 Storm。 请参阅 [HDInsight Storm 概述][HDInsight Storm Overview]和官方 [Apache Storm][Apache Storm] 文档，以了解 Storm 部署和模式的详细信息。
> 
> 
