...
* 使用[MirrorMaker](https://cwiki.apache.org/confluence/pages/viewpage.action?pageId=27846330)到[将从在本地的 Kafka 的事件流式传输到 Kafka 启用云上的事件中心。](event-hubs-kafka-mirror-maker-tutorial.md)
