...
### <a name="cli"></a>CLI
使用 [az eventhubs eventhub update](/cli/azure/eventhubs/eventhub?view=azure-cli-latest#az-eventhubs-eventhub-update) CLI PowerShell 命令更新事件中心中的分区。 
