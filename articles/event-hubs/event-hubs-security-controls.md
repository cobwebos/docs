...
| 安全控制 | Yes/No | 说明| 文档 |
|---|---|--|--|
| 身份验证| 是 | | [授予对 Azure 事件中心的访问权限](authorize-access-event-hubs.md)，[使用 Azure Active Directory 授予对事件中心资源的访问权限](authorize-access-azure-active-directory.md)，[使用共享访问签名授权访问事件中心资源](authorize-access-shared-access-signature.md) |
