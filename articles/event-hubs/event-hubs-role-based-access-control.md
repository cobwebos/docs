...
Azure 提供了以下用于授权对事件中心命名空间的访问权限的内置 RBAC 角色:

[Azure 事件中心数据所有者 (预览版)](../role-based-access-control/built-in-roles.md#azure-event-hubs-data-owner-preview)角色允许对事件中心命名空间及其实体 (队列、主题、订阅和筛选器) 进行数据访问

>[!IMPORTANT]
> 我们之前已支持向“所有者”或“参与者”角色添加托管标识。 但是，不再授予“所有者”和“参与者”角色的数据访问权限。 如果你使用的是 "**所有者**" 或 "**参与者**" 角色, 请切换到 "使用**Azure 事件中心数据所有者 (预览版)** " 角色。
...
此介绍描述了一个简单的控制台应用程序，[其代码位于 GitHub 上](https://github.com/Azure/azure-event-hubs/tree/master/samples/DotNet/Microsoft.Azure.EventHubs/Rbac/AzureEventHubsSDK)
