...
必须先为 VM 上的 Azure 资源启用托管标识，然后才能使用 Azure 资源的托管标识来授权 VM 的事件中心资源。 若要了解如何启用 Azure 资源的托管标识，请参阅以下文章之一：
