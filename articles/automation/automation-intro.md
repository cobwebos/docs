...
---
# Azure 自动化概述
<a id="azure-automation-overview" class="xliff"></a>
...
## 使用 Runbook 实现过程的自动化
<a id="automating-processes-with-runbooks" class="xliff"></a>
...
## Runbook 可以自动化哪些任务？
<a id="what-can-runbooks-automate" class="xliff"></a>
...
## 从社区获取 Runbook
<a id="getting-runbooks-from-the-community" class="xliff"></a>
...
<a id="creating-runbooks-with-azure-automation" class="xliff"></a>
...
## 使用所需状态配置自动执行配置管理
<a id="automating-configuration-management-with-desired-state-configuration" class="xliff"></a>
...
<a id="creating-your-own-dsc-configurations-with-azure-automation" class="xliff"></a>
...
## 获取模块和配置
<a id="getting-modules-and-configurations" class="xliff"></a>
...
## Azure 自动化实际应用示例
<a id="example-practical-applications-of-azure-automation" class="xliff"></a>
...
<a id="how-does-azure-automation-relate-to-other-automation-tools" class="xliff"></a>
...
## 从哪里可以获得详细信息？
<a id="where-can-i-get-more-information" class="xliff"></a>
...
## 我是否可以提供反馈？
<a id="can-i-provide-feedback" class="xliff"></a>
