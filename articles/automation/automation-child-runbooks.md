...
- [PowerShell Runbook](/documentation/articles/automation-runbook-types/#powershell-runbooks) 和[图形 Runbook](/documentation/articles/automation-runbook-types/#graphical-runbooks) 可以互相内联调用（两者都基于 PowerShell）。
- [PowerShell 工作流 Runbook](/documentation/articles/automation-runbook-types/#powershell-workflow-runbooks) 和图形 PowerShell 工作流 Runbook 可以互相内联调用（两者都基于 PowerShell 工作流）。
