...
description: 使用更改跟踪的文件内容更改功能查看已更改文件的内容。
services: automation
...
* 使用的存储帐户只能连接1个 Automation 帐户。

* 你的自动化帐户中已启用[更改跟踪](automation-change-tracking.md)。
...
1. 在**更改跟踪**的 "编辑设置" 页上，选择 " **Windows 文件**" 或 " **Linux 文件**" 选项卡，然后单击 "**添加**"
...
1. 在 "更改详细信息" 窗格中，可以看到文件信息之前和之后的标准。 选择 "**查看文件内容更改**" 以查看文件的内容。
