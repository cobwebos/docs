...
有关此过程的详细信息记录在[载入由 Azure Automation State Configuration 管理的计算机](/azure/automation/automation-dsc-onboarding#onboard-a-vm-using-azure-portal)页中。
