...
对于 Azure 节点，可以更正从 Azure 门户或使用 Az 模块 cmdlet 的漂移。 有关此过程的详细信息记录在[载入计算机中，供 Azure 自动化状态配置进行管理](automation-dsc-onboarding.md#onboard-vms-by-using-the-azure-portal)。
