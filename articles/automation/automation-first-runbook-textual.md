...
1. 单击“测试窗格”  打开测试窗格。<br><br> ![](media/automation-first-runbook-textual/automation-runbook-edit-controls-test.png)
...
1. 单击“发布”以发布该 Runbook，然后在出现提示时单击“是”。<br><br> ![](media/automation-first-runbook-textual/automation-runbook-edit-controls-publish.png)
...
4. 我们只想要启动 Runbook，因此单击“启动”，然后在出现提示时单击“是”。<br><br> ![启动 Runbook](media/automation-first-runbook-textual/automation-runbook-controls-start.png)
...
11. 单击“作业”打开此 Runbook 的“作业”窗格  。 这将列出此 Runbook 创建的所有作业。 由于我们只运行该作业一次，应该只会看到一个列出的作业。<br><br> ![作业](media/automation-first-runbook-textual/runbook-control-job-tile.png)
...
6. 单击“启动”以启动测试  。 测试完成后，应收到类似以下显示你帐户中基本信息的输出。 这可确认凭据有效。<br><br> ![身份验证](media/automation-first-runbook-textual/runbook-auth-output.png)
