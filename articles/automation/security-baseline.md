...
如果你使用的是 Azure 虚拟机支持的混合 Runbook 辅助角色，请确保使用网络安全组（NSG）启用了包含这些辅助角色的子网，并将流日志配置为将日志转发到存储帐户以进行流量审核。 你还可以将 NSG 流日志转发到 Log Analytics 工作区，并使用流量分析来深入了解 Azure 云中的流量流。 流量分析的优势包括能够可视化网络活动、识别热点、识别安全威胁、了解流量流模式，以及查明网络不当配置。
...
* [将 Azure 自动化作业数据转发到 Azure Monitor 日志](https://docs.microsoft.com/azure/automation/automation-manage-send-joblogs-log-analytics)

* [将 DSC 与 Azure Monitor 日志集成](https://docs.microsoft.com/azure/automation/automation-dsc-diagnostics)

* [链接的 Log Analytics 工作区支持的区域](https://docs.microsoft.com/azure/automation/how-to/region-mappings)

* [查询更新管理日志](https://docs.microsoft.com/azure/automation/automation-update-management-query-logs)
...
* [在 Azure 安全中心内配置数据收集层](https://docs.microsoft.com/azure/security-center/security-center-enable-data-collection#data-collection-tier)
...
* [了解 Azure Monitor 中的日志查询](https://docs.microsoft.com/azure/azure-monitor/log-query/get-started-portal)
...
* [如何发出 Azure Monitor 日志数据的警报](https://docs.microsoft.com/azure/azure-monitor/learn/tutorial-response)
...
* [删除运行方式帐户或经典运行方式帐户](https://docs.microsoft.com/azure/automation/manage-runas-account#delete-a-run-as-or-classic-run-as-account)

* [管理 Azure 自动化运行方式帐户](https://docs.microsoft.com/azure/automation/manage-runas-account)
...
**指导**：围绕专用管理帐户的使用创建标准操作程序。 使用 Azure 安全中心标识和访问管理来监视管理帐户的数量。 每次使用 runbook 的自动化帐户运行方式帐户时，请确保还会在你的清单中跟踪这些服务主体，因为它们常常需要提升的权限。 将这些标识的范围限定为你的 runbook 成功执行其自动过程所需的最低特权权限。 删除任何未使用的运行方式帐户，以最大程度地降低公开攻击面。
...
* [使用 Azure AD 向 Azure 进行身份验证](https://docs.microsoft.com/azure/automation/automation-use-azure-ad)
...
* [将 runbook 身份验证用于托管标识](https://docs.microsoft.com/azure/automation/automation-hrw-run-runbooks#runbook-auth-managed-identities)
...
**指导**：为开发、测试和生产实施单独的订阅和/或管理组。 使用独立的自动化帐户资源隔离环境。 混合 Runbook 辅助角色等资源应该由虚拟网络/子网分开、正确标记并在网络安全组（NSG）或 Azure 防火墙内进行保护。 对于存储或处理敏感数据的虚拟机，请在不使用策略和过程时将其关闭。
...
* [管理角色权限和安全性](https://docs.microsoft.com/azure/automation/automation-role-based-access-control)
...
使用混合 Runbook 辅助角色时，虚拟机上的虚拟磁盘使用服务器端加密或 Azure 磁盘加密（ADE）加密。 Azure 磁盘加密利用 Windows 的 BitLocker 功能，通过来宾 VM 中的客户托管密钥来加密托管磁盘。 使用客户托管密钥的服务器端加密通过加密存储服务中的数据，使你能够将任何 OS 类型和映像用于 VM，从而改进了 ADE。
...
* [Azure Automation 中的托管变量](https://docs.microsoft.com/azure/automation/shared-resources/variables)
...
* [Azure 安全中心的安全建议](https://docs.microsoft.com/azure/security-center/security-center-recommendations)

* [安全中心推荐参考](https://docs.microsoft.com/azure/security-center/recommendations-reference)
...
* [Azure 自动化的 azure 策略示例内置功能](https://docs.microsoft.com/azure/automation/policy-samples)
...
* [在 Azure 自动化中管理模块](https://docs.microsoft.com/azure/automation/shared-resources/modules)
...
* [Azure Web 应用程序防火墙概述](https://docs.microsoft.com/azure/web-application-firewall/overview)
...
* [使用源代码管理集成](https://docs.microsoft.com/azure/automation/source-control-integration)

* [有关创建 Azure 资源管理器模板的信息](https://docs.microsoft.com/azure/azure-resource-manager/templates/quickstart-create-templates-use-the-portal)

* [如何配置和管理 Azure Policy](https://docs.microsoft.com/azure/governance/policy/tutorials/create-and-manage)

* [了解 Azure Policy 效果](https://docs.microsoft.com/azure/governance/policy/concepts/effects)

* [使用 Azure 资源管理器模板部署自动化帐户](https://docs.microsoft.com/azure/automation/automation-create-account-template#deploy-the-template)
...
* [Azure 自动化资源的 azure 资源管理器模板参考](https://docs.microsoft.com/azure/templates/microsoft.automation/allversions)

* [使用 Azure 资源管理器模板创建自动化帐户](https://docs.microsoft.com/azure/automation/automation-create-account-template)
