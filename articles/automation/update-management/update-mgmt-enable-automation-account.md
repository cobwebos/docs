...
本文介绍如何使用自动化帐户为你的环境中的 Vm 启用 [更新管理](update-mgmt-overview.md) 功能，其中包括注册到 [已启用 Azure Arc 的服务器](../../azure-arc/servers/overview.md) (预览版) 的计算机或服务器。 要大规模启用 Azure VM，必须使用更新管理启用现有 Azure VM。
