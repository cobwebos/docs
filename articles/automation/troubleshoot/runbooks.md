...
1. 如果 runbook 已挂起或意外失败：
    ...
    * 处理作业引发的[任何异常](../automation-runbook-execution.md#handling-exceptions)。
...
有关使用 Azure 沙盒的详细信息，请参阅[在 Azure 自动化中执行 Runbook](../automation-runbook-execution.md#where-to-run-your-runbooks)。
