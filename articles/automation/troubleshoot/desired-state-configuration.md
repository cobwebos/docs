...
### <a name="failure-linux-temp-noexec"></a>场景：应用在 Linux 中的配置，并出现常规错误发生故障

#### <a name="issue"></a>问题

当应用在 Linux 中的配置，发生故障，包含错误：
...
客户已确定，如果 /tmp 位置设置为 noexec，当前版本的 DSC 将无法应用配置。

#### <a name="resolution"></a>解决方法

* 从 /tmp 位置删除 noexec 选项。
