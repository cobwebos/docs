...
2. 运行以下 PowerShell 命令，然后使用上一`[your resource ID]`节`[resource ID of the log analytics workspace]`的值编辑 值。
...
3. 要打开"**创建规则"** 屏幕，请单击页面顶部**的新警报规则**。 有关用于配置警报的选项的详细信息，请参阅 [Azure 中的日志警报](../azure-monitor/platform/alerts-unified-log.md)。
