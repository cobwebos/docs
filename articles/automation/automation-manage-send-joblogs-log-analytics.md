...
现在，你已开始将自动化作业日志发送到 Log Analytics，接下来让我们看一下在 Log Analytics 中可以对这些日志执行哪些操作。
...
1. 若要打开“创建规则”屏幕，请单击页面顶部的“+ 新建警报规则”。 有关用于配置警报的选项的详细信息，请参阅 [Azure 中的日志警报](../monitoring-and-diagnostics/monitor-alerts-unified-log.md)。
