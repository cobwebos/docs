...
Python Runbook 是基于 Python 脚本语言的文本 Runbook。 Azure 自动化支持 Python 2 和 Python 3 Runbook。
若要了解 Python，请访问 [https://www.python.org/](https://www.python.org/)。
有关 Python Runbook 示例，请参阅[我在 Azure 自动化中的第一个 Python Runbook](automation-first-runbook-textual-python2.md)。

## <a name="bash-runbooks"></a>Bash Runbook

Bash Runbook 是基于 GNU Bash shell 的文本 Runbook。 若要了解 Bash，请访问 [https://www.gnu.org/software/bash/](https://www.gnu.org/software/bash/)。
