...
在 Azure 门户中，请参阅资源组，并选择 "**监视**" > **警报** > **管理警报规则**。
...
在 Azure 门户中，选择 "**自动化帐户**" > **相关资源**" > **链接的工作区**"。 选择 "**取消链接工作区**" 以从自动化帐户取消链接工作区。

![取消工作区与自动化帐户的链接](../media/move-account/unlink-workspace.png)

## <a name="move-your-automation-account"></a>移动自动化帐户

删除以前的项目后，你可以继续删除你的自动化帐户及其 runbook。 在 Azure 门户中，浏览到自动化帐户的资源组。 选择 "**移动**" > **移动到另一个订阅**。
...
有关配置解决方案的详细说明，请参阅[Azure 自动化中的在空闲时间启动/停止 VM 解决方案](../automation-solution-vm-management.md)。
