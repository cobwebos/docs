...
1. 在 Azure 门户中，选择你的自动化帐户。
2. 单击“Runbook”磁贴打开 Runbook 的列表。
3. 单击想要编辑的 Runbook 的名称，然后单击“编辑”按钮。
4. 执行所需的编辑。
5. 完成编辑后，单击“保存”。
...
2. 展开“库”控件中的“资产”节点。
3. 展开所需资产类型的节点。
4. 右键单击要插入的资产，然后选择“添加到画布”。  对于[变量资产](automation-variables.md)，可选择“将‘获取变量’添加到画布”或“将‘设置变量’添加到画布”，具体取决于你是要获取变量还是要设置变量。
...
2. 选择“Runbook”选项卡。
3. 单击想要编辑的 Runbook 的名称，然后选择“创作”选项卡。
4. 单击屏幕底部的“编辑”按钮。
5. 执行所需的编辑。
6. 完成编辑后，单击“保存”。
...
4. 在“活动”窗格中，选择一个活动。
5. 在“说明”列中，记下活动说明。 你也可以选择单击“查看详细帮助”，以便在浏览器中启动活动的帮助。
