...
|警报  |描述|负载架构  |
|---------|---------|---------|
|[常见警报](../azure-monitor/platform/alerts-common-schema.md?toc=%2fazure%2fautomation%2ftoc.json)|通用警报架构将目前 Azure 中的警报通知的使用体验进行了标准化。|常见警报负载架构|
