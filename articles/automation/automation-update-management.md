...
若要确认 Operations Manager 管理组是否正在与 Azure Monitor 日志通信，请参阅[验证 Operations Manager 与 Azure Monitor 日志集成](../azure-monitor/platform/om-agents.md#validate-operations-manager-integration-with-log-analytics)。
