---
title: 使用活动日志警报监视 Azure 自动化 Runbook
description: 本文逐步讲解如何使用活动日志监视 Azure 自动化 Runbook
services: automation
...
ms.locfileid: "34356932"
---
# <a name="monitoring-runbooks-with-azure-activity-log-alerts"></a>使用 Azure 活动日志警报监视 Runbook
