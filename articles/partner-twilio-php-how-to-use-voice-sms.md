...
Azure 客户在升级 Twilio 帐户后即可获得[特惠套餐](https://www.twilio.com/azure)：10 美元的 Twilio 信用额度。 此 Twilio 信用可应用于任何 Twilio 使用（10 美元信用等价于发送多达 1,000 条 SMS 消息或接收长达 1000 分钟的入站语音，具体取决电话号码和消息或呼叫目标的位置）。 兑换此 Twilio 积分，并开始在[https://ahoy.twilio.com/azure](https://ahoy.twilio.com/azure)： .
...
使用 Twilio 服务且在 Azure 中运行的 PHP 应用程序与任何其他使用 Twilio 服务的 PHP 应用程序之间没有任何差别。 Twilio 服务是基于 REST 的且可通过几种方法从 PHP 中调用，本文将重点介绍如何将 Twilio 服务与 [GitHub 提供的用于 PHP 的 Twilio 库][twilio_php]一起使用。 有关将 Twilio 库用于 PHP 的详细信息，[https://www.twilio.com/docs/libraries/php][twilio_lib_docs]请参阅。
...
1. 从 GitHub 下载用于 PHP 的[https://github.com/twilio/twilio-php][twilio_php]Twilio 库，并将**服务**目录添加到应用程序中。
