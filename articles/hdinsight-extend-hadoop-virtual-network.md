...
> [AZURE.NOTE] HDInsight 目前不支持基于地缘的 Azure 虚拟网络。在使用 HDInsight 时，你必须使用基于位置的虚拟网络。

## <a id="whatis"></a>Azure 虚拟网络是什么？

[使用 Azure 虚拟网络](/documentation/services/networking/) ，你可以创建一个安全的永久性网络，包含你的解决方案所需的资源。通过虚拟网络，你可以：
