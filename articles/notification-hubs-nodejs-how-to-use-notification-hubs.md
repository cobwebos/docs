...
Azure Service Bus Notification Hubs provide an easy-to-use, multiplatform, scalable infrastructure for sending push notifications to mobile devices. For more information, see [Azure Service Bus Notification Hubs](http://msdn.microsoft.com/zh-cn/library/azure/jj927170.aspx).
...
* NotificationClass - The priority of the notification. See the HTTP Header Elements section of [Push notifications from a server](http://msdn.microsoft.com/zh-cn/library/hh221551.aspx) for valid values.
* Options - optional request headers
* Callback - the callback function

For a list of valid TargetName, NotificationClass, and header options, see [Push notifications from a server](http://msdn.microsoft.com/zh-cn/library/hh221551.aspx).
