...
有关支持的服务、费用和配置的详细信息，请参阅[常见问题页](/documentation/articles/expressroute-faqs/)。有关提供 Microsoft 对等互连支持的连接提供商列表的信息，请参阅 [ExpressRoute Locations](/documentation/articles/expressroute-locations/)（ExpressRoute 位置）页。
