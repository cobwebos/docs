...
> [!NOTE]
> 在经典模式下，ExpressRoute 线路没有绑定到区域的概念。 在资源管理器 (ARM) 中，每个资源都需要映射到 Azure 区域。 从技术上来讲，Move-AzureRmExpressRouteCircuit cmdlet 中指定的区域可以是任何区域。 对组织来说，建议选择一个最能代表对等位置的区域。
> 
