...
当前支持 ExpressRoute 的大多数区域支持 ExpressRoute Global Reach。 可以参考 [ExpressRoute 连接提供商](expressroute-locations-providers.md#partners) 以获取当前支持的区域。 
