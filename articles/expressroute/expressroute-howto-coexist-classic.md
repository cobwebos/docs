<properties
   pageTitle="配置可以并存的 ExpressRoute 连接和站点到站点 VPN 连接 | Microsoft Azure"
...
>[AZURE.IMPORTANT] 按以下说明进行操作之前，必须预先配置ExpressRoute 线路。在按以下步骤操作之前，请务必遵循相关指南来[创建 ExpressRoute 线路](expressroute-howto-circuit-classic.md)和[配置路由](expressroute-howto-routing-classic.md)。
