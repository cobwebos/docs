...
> [AZURE.SELECTOR]
[按提供商显示位置](/documentation/articles/expressroute/expressroute-locations/#connectivity-provider-locations)
[按位置显示提供商](/documentation/articles/expressroute/expressroute-locations-providers/#connectivity-provider-locations)
...
| **亚特兰大** | Equinix |
| **金奈** | Tata Communications |
| **芝加哥** | AT&T NetBond、Comcast、Equinix、Level 3 Communications、Zayo Group |
| **达拉斯** | AT&T NetBond、Equinix、Level 3 Communications、Megaport |
| **都柏林** | Colt |
...
| **洛杉矶** | CoreSite、Equinix、Megaport、Zayo Group |
| **墨尔本** | Equinix、Megaport、NEXTDC、Telstra Corporation |
| **纽约** | Equinix、Megaport、Zayo Group |
| **蒙特利尔** | Cologix+ |
| **孟买** | Tata Communications |
...
| **悉尼** | AT&T NetBond、British Telecom、Equinix、Megaport、NEXTDC、Telstra Corporation、Verizon |
...
| **华盛顿特区** | Aryaka Networks、AT&T NetBond、British Telecom、Comcast、Equinix、InterCloud、Level 3 Communications、Megaport、Orange、Tata Communications、Verizon、Zayo Group |
...
- 从 Exchange 连接服务提供商处订购一条 ExpressRoute 线路以连接到 Microsoft。
	- 根据[创建 ExpressRoute 线路](/documentation/articles/expressroute/expressroute-howto-circuit-classic/)中的步骤来设置连接。
...
- 确保符合所有先决条件。请参阅 [ExpressRoute 先决条件](/documentation/articles/expressroute/expressroute-prerequisites/)。
