...
| **北美** | 美国东部、美国西部、美国东部 2 区、美国西部 2 区、美国中部、美国中南部、美国中北部、美国中西部、加拿大中部、加拿大东部 |亚特兰大、芝加哥、达拉斯、丹佛、拉斯维加斯、洛杉矶、迈阿密、纽约、圣安东尼奥、西雅图、硅谷、硅谷 2、华盛顿特区、华盛顿特区 2、蒙特利尔、魁北克市、多伦多、温哥华 |
...
| **迪拜 2** | [du datamena](http://datamena.com/solutions/data-centre) | 3 | 阿拉伯联合酋长国北部 | 不适用 | du datamena、Megaport、Orange、Orixcom |
...
| **法兰克福** | [Interxion FRA11](https://www.interxion.com/Locations/frankfurt/) | 1 | 德国中西部 | 10G，100G | AT&T NetBond、CenturyLink Cloud Connect、Colt、DE-CIX、Equinix、GEANT、Interxion、Megaport、Orange、Telia Carrier |
...
| **香港特别行政区 2** | [MEGA-i](https://www.iadvantage.net/index.php/locations/mega-i) | 2 | 不适用 | 10G | China Telecom Global、PCCW Global Limited |
...
| **London2** | [Telehouse North Two](https://www.telehouse.net/data-centres/emea/uk-data-centres/london-data-centres/north-two) | 1 | 英国南部 | 10G，100G | CenturyLink Cloud Connect、Colt、IX Reach、Equinix、Megaport、Telehouse - KDDI |
| **洛杉矶** | [CoreSite LA1](https://www.coresite.com/data-centers/locations/los-angeles/one-wilshire) | 1 | 不适用 | 10G | CoreSite、Equinix、Megaport、Neutrona Networks、NTT、Transtelco、Zayo |
...
| **迈阿密** | [Equinix MI1](https://www.equinix.com/locations/americas-colocation/united-states-colocation/miami-data-centers/mi1/) | 1 | 不适用 | 10G | Claro、C3ntro、Equinix、Megaport、Neutrona Networks |
| **米兰** | [IRIDEOS](https://irideos.it/en/data-centers/) | 1 | 不适用 | 10G | |
...
| **Mumbai** | Tata Communications | 2 | 印度西部 | 10G | Global CloudXchange (GCX)、Reliance Jio、Sify、Tata Communications、Verizon |
| **孟买 2** | Airtel | 2 | 印度西部 | 不适用 | Airtel、Sify、Vodafone Idea |
| **慕尼黑** | [EdgeConneX](https://www.edgeconnex.com/locations/europe/) | 1 | 不适用 | 10G，100G | |
...
| **奥斯陆** | [DigiPlex Ulven](https://www.digiplex.com/locations/oslo-datacentre) | 1 | 挪威东部 | 10G，100G | Megaport、Telenor、Telia Carrier |
...
| **首尔** | [KINX Gasan IDC](https://www.kinx.net/support/location/?lang=en) | 2 | 韩国中部 | 10G，100G | KINX、KT、LG CNS、Sejong Telecom |
...
| **斯塔万格** | [Green Mountain DC1](https://greenmountain.no/dc1-stavanger/) | 1 | 挪威西部 | 10G，100G | |
...
| **华盛顿特区 2** | [Coresite Reston](https://www.coresite.com/data-centers/locations/northern-virginia-washington-dc/reston-campus) | 1 | 美国东部、美国东部 2 | 10G，100G | CenturyLink Cloud Connect、Coresite、Intelsat、Viasat、Zayo | 
...
## <a name="connectivity-through-satellite-operators"></a>通过卫星服务运营商建立的连接
