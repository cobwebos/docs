...
可以通过 Microsoft 对等互连访问 Microsoft 365 服务（如 Exchange Online、SharePoint Online 和 Skype for Business）以及 Azure 公共服务（如存储和 SQL 数据库）。 Azure 公共服务可按区域选择，但不能针对每个公共服务定义。
