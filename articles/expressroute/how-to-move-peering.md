...
## <a name="2-validate-microsoft-peering-is-enabled"></a><a name="validate"></a>2. 验证是否已启用 Microsoft 对等互连
...
## <a name="3-configure-and-attach-a-route-filter-to-the-circuit"></a><a name="routefilter"></a>3. 配置路由筛选器并将其附加到线路
