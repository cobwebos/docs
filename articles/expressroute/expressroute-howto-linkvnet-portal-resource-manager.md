...
![跨订阅连接](./media/expressroute-howto-linkvnet-portal-resource-manager/authorization.png)

2. 保存配置后，复制“资源 ID”和“授权密钥”。
![跨订阅连接](./media/expressroute-howto-linkvnet-portal-resource-manager/authkey.png)

**删除授权**

可通过选择连接的边栏选项卡中的“删除”图标来删除连接。
...
1.  单击“+新建”按钮。
    ![跨订阅连接](./media/expressroute-howto-linkvnet-portal-resource-manager/Connection1.png)

2.  在应用商店中搜索“连接”，然后选择它并单击“创建”。
    ![跨订阅连接](./media/expressroute-howto-linkvnet-portal-resource-manager/Connection2.png)

3.  确保“连接类型”设置为“ExpressRoute”。

4.  在“基本信息”选项卡中填写详细信息，然后单击“确定”。
    ![跨订阅连接](./media/expressroute-howto-linkvnet-portal-resource-manager/Connection3.png)

5.  在“设置”选项卡中，选择“虚拟网络网关”并选中“兑换授权”复选框。

6.  输入“授权密钥”和“对等线路 URI”，并为连接命名。 单击“确定”****
    ![跨订阅连接](./media/expressroute-howto-linkvnet-portal-resource-manager/Connection4.png)

7.  在“摘要”选项卡中检查信息，然后单击“确定”。
