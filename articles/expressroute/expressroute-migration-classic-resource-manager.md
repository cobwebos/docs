---
title: Azure 快速路由：将经典 VNet 迁移到资源管理器
...
* 查看以下资源迁移文档：
    ...
    * [有关平台支持的从经典部署模型到 Azure 资源管理器的迁移的技术深入探讨](../virtual-machines/virtual-machines-windows-migration-classic-resource-manager-deep-dive.md)
