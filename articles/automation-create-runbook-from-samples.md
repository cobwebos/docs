<properties 
	pageTitle="Azure Automation 入门" 
	description="了解如何在 Azure 中导入和运行 Automation 作业。" 
	services="automation" 
	documentationCenter="" 
	authors="bwren" 
	manager="stevenka" 
...
通过 Microsoft Azure Automation，用户可以自动完成通常要在云环境中执行的手动、长时间进行、易出错且重复性高的任务。你可以使用 Runbook 来创建、监视、管理和部署 Azure 环境中的资源。所谓的 Runbook，基本上就是指 Windows PowerShell 工作流。在本指南中，你将学习运行一个简单示例 Runbook 的教程。然后，你将查找用于浏览更高级服务功能的资源。

## 教程
本教程将逐步引导你完成创建 Automation 帐户、将一个示例"Hello World"Runbook 导入 Azure Automation、执行该 Runbook 并查看其输出的过程。

若要完成本教程，你需要一个 Azure 订阅。如果你没有订阅，可以<a href="/pricing/1rmb-trial/" target="_blank">注册免费试用版</a>。

[AZURE.INCLUDE [automation-note-authentication](../includes/automation-note-authentication.md)]

## <a name="automationaccount"></a>创建 Automation 帐户

Automation 帐户是 Automation 资源的容器：它提供了一种方式让你划分环境，或者进一步组织你的工作流。有关详细信息，请参阅 Automation 库中的 [Automation 帐户](https://msdn.microsoft.com/zh-cn/library/dn794195.aspx)。如果你已创建 Automation 帐户，可以跳过此步骤。

1.	登录到 [Azure 管理门户](http://manage.windowsazure.cn)。

2.	在管理门户中，单击"创建 Automation 帐户"。

	![Create Account](./media/automation/automation_01_CreateAccount.png)

3.	在"添加新的 Automation 帐户"页上，输入一个名称并选择该帐户的区域。该区域指定要将帐户中的 Automation 资源存储在哪个位置。这不会影响帐户的功能，但是，如果帐户所在区域靠近其他 Azure 资源的存储位置，则 Runbook 可以更快地执行。准备就绪后，单击复选标记。

	![Add New Account](./media/automation/automation_02_addnewautoacct.png)
 
## <a name="importrunbook"></a>从 Runbook 库导入 Runbook

["Runbook 库"](https://msdn.microsoft.com/zh-cn/library/azure/dn781422.aspx)包括你可以直接导入 Azure Automation 帐户的示例 Runbook，从而可让你利用其他 Azure Automation 和 PowerShell 用户的工作。在此步骤中，你将使用该库导入"Hello World"示例 Runbook。

4.	在"Automation"页上，单击你刚刚创建的新帐户。
...
7.  选择"教程"类别，然后选择"Hello World for Azure Automation"。单击右箭头按钮。
...
2. 有关 Azure Automation 功能的详细信息，请参阅下面列出的[资源](#resources)。
3. 订阅 [Azure Automation 博客](http://azure.microsoft.com/blog/tag/azure-automation)，随时了解 Azure Automation 团队提供的最新信息。

## <a name="resources"></a>资源

我们提供了其他多种资源，以帮助你了解有关 Azure Automation 的信息以及如何创建你自己的 Runbook。

- [Azure Automation 库](https://msdn.microsoft.com/zh-cn/library/azure/dn643629.aspx)提供了有关配置和管理 Azure Automation 以及创作自己的 Runbook 的完整文档。
...
- [Azure Automation 博客](http://azure.microsoft.com/blog/tag/azure-automation)提供了有关 Microsoft Azure Automation 的最新信息。
...
Microsoft 和 Azure Automation 社区提供了示例 Runbook，可帮助你开始创建自己的解决方案和实用 Runbook，可用作更大 Automation 任务的构建基块。可以从 [脚本中心](http://go.microsoft.com/fwlink/p/?LinkId=393029)下载这些示例 Runbook，或者使用 [Runbook 库](https://msdn.microsoft.com/zh-cn/library/azure/dn781422.aspx)直接将其导入 Azure Automation。
