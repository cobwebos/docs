---
title: "技术指南：从本地恢复到 Azure | Microsoft Docs"
...
* **存储**：StorSimple 可将文件系统扩展到 Azure 存储。 Azure 备份服务提供将文件和 SQL 数据库备份到 Azure 存储空间的功能。
...
有关详细信息，请参阅[什么是 Azure 备份？](../backup/backup-introduction-to-azure-backup.md)和[为 DPM 数据配置 Azure 备份](https://technet.microsoft.com/library/jj728752.aspx)。
...
有关详细信息，请参阅 [Azure 虚拟机中 SQL Server 的高可用性和灾难恢复](../virtual-machines/windows/sql/virtual-machines-windows-sql-high-availability-dr.md)和 [Azure 虚拟机中 SQL Server 的备份和还原](../virtual-machines/windows/sql/virtual-machines-windows-sql-backup-recovery.md)。
