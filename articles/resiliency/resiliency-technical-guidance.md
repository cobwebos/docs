...
---
# <a name="azure-resiliency-technical-guidance"></a>Azure 复原技术指南
...
本系列文章涵盖了前一方面：Azure 平台关于复原（有时称为业务连续性）的功能和限制。 如果对后者感兴趣，请参阅侧重于 [Azure 应用程序的灾难恢复和高可用性](https://aka.ms/drtechguide)的系列文章。 尽管本系列文章提及了体系结构和设计模式，但并未重点介绍。 有关设计指南，可以参阅[其他资源](#additional-resources)部分中的资料。
...
* [构建在 Microsoft Azure 之上的应用程序灾难恢复和高可用性](resiliency-disaster-recovery-high-availability-azure-applications.md)。
...
* [Microsoft Azure 服务复原指南](resiliency-service-guidance-index.md)。
...
* [Azure 虚拟机中 SQL Server 的备份和还原](../virtual-machines/windows/sql/virtual-machines-windows-sql-backup-recovery.md)。
...
* [技术案例研究：使用云技术改进灾难恢复](https://www.microsoft.com/itshowcase/Article/Content/737/Using-cloud-technologies-to-improve-disaster-recovery)。
