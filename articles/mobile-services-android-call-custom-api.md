<properties writer="ricksal" pageTitle="从 Android 客户端调用自定义 API | 移动开发人员中心" metaKeywords="" description="了解如何定义自定义 API，然后从使用 Azure 移动服务的 Android 应用程序调用它。" metaCanonical="" disqusComments="1" umbracoNaviHide="1" services="mobile-services" documentationCenter="Mobile" title="Call a custom API from the client" authors="glenga"  />
...
[推送通知入门]: /zh-cn/documentation/articles/mobile-services-android-get-started-push/
