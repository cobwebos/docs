...
以启动 `docker-compose.yml`中指定的 Docker 容器. 你将看到与类似的输出。

```
正在创建 wordpress_db_1...正在创建 wordpress_wordpress_1...```
...
* 请尝试将 Docker Compose 与 [Docker Swarm](virtual-machines-docker-swarm) 群集集成。有关方案，请参阅 [Docker Compose/Swarm 集成](https://github.com/docker/compose/blob/master/SWARM)。
