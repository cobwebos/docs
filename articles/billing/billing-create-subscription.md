...
若要详细了解计费帐户并确定计费帐户的类型，请参阅[在 Azure 门户中查看计费帐户](billing-view-all-accounts.md)。
...
|字段  |定义  |
|---------|---------|
|Name     | 该显示名称可帮助你轻松识别 Azure 门户中的订阅。  |
...
你还可以通过编程方式创建另外的订阅。 有关详细信息，请参阅[以编程方式创建 Azure 订阅](../azure-resource-manager/programmatically-create-subscription.md)。
