...
若要查看你是否为帐户管理员，请转到 [Azure 门户中的“订阅”](https://portal.azure.com/#blade/Microsoft_Azure_Billing/SubscriptionsBlade)。 查看你有权访问的订阅的列表。 在“我的角色”  下查看。 如果显示*帐户管理员*，则可以进行操作。 如果显示所有者  等其他信息，则表示没有完全权限。
