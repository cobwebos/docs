...
注册 Azure 免费帐户时，将获得免费试用订阅，它提供为期 30 天、价值 $200 的 Azure 信用额度以及 12 个月的免费服务。 30 天结束后，Azure 会禁用订阅。 禁用订阅是为了防止你在意外情况下因使用量超出订阅的信用额度和免费服务而产生相应的费用。 若要继续使用 Azure 服务，则必须[升级订阅](billing-upgrade-azure-subscription.md)。 升级之后，你的订阅仍可使用 12 个月的免费服务。 只需对超过免费服务及用量的使用量付费即可。
...
- 了解如何[监视和管理 Azure 的计费活动](billing-getting-started.md)。
