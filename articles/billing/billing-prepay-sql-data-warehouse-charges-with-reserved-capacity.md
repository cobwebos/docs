---
title: 通过 Azure 预留容量节省 SQL 数据仓库的费用成本
...
可在 [Azure 门户](https://portal.azure.com/#blade/Microsoft_Azure_Reservations/ReservationsBrowseBlade)中购买 Azure SQL 数据仓库预留容量。 通过[提前付款或按月付款](billing-monthly-payments-reservations.md)的方式为预留付款。 购买预留容量：
...
有关预留购买如何针对企业客户和即用即付客户进行计费的详细信息，请参阅[了解适用于企业合约的 Azure 预留使用情况](billing-understand-reserved-instance-usage-ea.md)和[了解即用即付订阅的 Azure 预留使用情况](billing-understand-reserved-instance-usage.md)。
...
- 若要详细了解预留折扣如何应用于 Azure SQL 数据仓库，请参阅[预留折扣如何应用于 Azure SQL 数据仓库](billing-prepay-sql-data-warehouse-charges-with-reserved-capacity.md)。
