---
title: 了解企业的 Azure 预留实例使用情况 | Microsoft Docs
description: 了解如何读取使用情况，以了解如何应用适用于企业合约的 Azure 虚拟机预留实例。
services: billing
documentationcenter: ''
...
ms.locfileid: "37064297"
---
# <a name="understand-azure-reserved-instance-usage-for-your-enterprise-enrollment"></a>了解适用于企业合约的 Azure 预留实例使用情况
