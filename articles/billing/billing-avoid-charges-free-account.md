...
当额度用尽或 30 天期限已过，订阅和服务将禁用。 若要继续使用 Azure 服务，必须升级帐户。 有关详细信息，请参阅[升级 Azure 免费帐户](billing-upgrade-azure-subscription.md)。 升级后，仍然可以使用 12 个月的免费服务，并且仅对超出免费服务和数量的使用量付费。
...
升级帐户后，需要按即用即付费率为 Azure 免费帐户未免费提供的服务付款。 若要了解有关免费帐户所含服务的信息，请参阅 [Azure 免费帐户常见问题解答](https://azure.microsoft.com/free/free-account-faq/)。 可以在 Azure 门户中检查服务使用情况。 若要了解详细信息，请参阅[定期检查门户的成本明细和消耗率](billing-getting-started.md#costs)。
