...
## <a name="error-we-cannot-proceed-with-signup-due-to-an-issue-with-your-account-please-contact-billing-support"></a>错误“由于你的帐户存在问题，我们无法处理注册。 请联系计费支持人员。” 
...
4. 如果刷新后未解决此问题，请退出并重新启动浏览器，然后重试。
...
* 再次确认输入的电话号码，包括下拉菜单中所选择的国家/地区代码。
...
虚拟或预付信用卡或借记卡不能作为 Azure 订阅有效的付款选项。 要查看可能导致卡被拒绝的其他原因，请参阅[借记卡或信用卡在注册 Azure 时被拒绝](billing-credit-card-fails-during-azure-sign-up.md)。
...
* BizSpark
  * 登录到 [BizSpark 门户](https://www.microsoft.com/bizspark/default.aspx#start-two)，并验证 BizSpark 和 BizSpark Plus 的资格状态。
