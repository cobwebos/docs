...
- **Microsoft 合作伙伴协议**：Microsoft 合作伙伴协议的计费帐户是为云解决方案提供商 (CSP) 合作伙伴创建的，用于在新的商业体验中管理其客户。 合作伙伴至少需要有一个客户拥有 [Azure 计划](https://docs.microsoft.com/partner-center/purchase-azure-plan)，才能在 Azure 门户中管理其计费帐户。 有关详细信息，请参阅 [Microsoft 合作伙伴协议的计费帐户入门](mpa-overview.md)。
...
### <a name="microsoft-online-services-program"></a>Microsoft Online Services 计划
 ...
 ![显示 MOSP 层次结构的屏幕截图](./media/billing-view-all-accounts/mosp-hierarchy.png)
...
![显示 EA 层次结构的屏幕截图](./media/billing-view-all-accounts/ea-hierarchy.png)
...
![显示 MCA 层次结构的屏幕截图](./media/billing-view-all-accounts/mca-hierarchy.png)
...
![显示 MPA 层次结构的屏幕截图](./media/billing-view-all-accounts/mpa-hierarchy.png)
...
3. 在概览页中，选择“切换范围”。 
   ...
   ![显示计费范围的屏幕截图](./media/billing-view-all-accounts/overview-select-scopes.png)
...
4. 选择要查看详细信息的范围。
   ...
   ![显示计费范围的屏幕截图](./media/billing-view-all-accounts/list-of-scopes.png)
