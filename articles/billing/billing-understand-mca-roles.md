...
|计费帐户读取器|只读的所有内容的视图上计费帐户|
|计费配置文件所有者|管理计费配置文件的所有内容|
|计费配置文件参与者|管理计费的配置文件的权限之外的所有内容|
|计费配置文件读者|只读的所有内容的视图上计费配置文件|
|发票管理器|查看和支付发票计费配置文件|
|发票部分所有者|管理发票一节中的所有内容|
|发票部分参与者|管理发票部分上的权限之外的所有内容|
|发票部分读取器|只读的所有内容的视图上的发票部分|
...
|任务|计费配置文件所有者|计费配置文件参与者|计费配置文件读者|发票管理器|计费帐户所有者|计费帐户参与者|计费帐户读取器
|---|---|---|---|---|---|---|---|
|查看现有权限计费的配置文件|✔|✔|✔|✔|✔|✔|✔|
...
|任务|发票部分所有者|发票部分参与者|发票部分读取器|Azure 订阅创建者|计费帐户所有者|计费帐户参与者|计费帐户读取器 | |
|---|---|---|---|---|---|---|---|---|
|查看发票部分上的所有权限|✔|✔|✔|✔|✔|✔|✔| |
|授予其他人查看和管理的发票部分的权限|✔|✘|✘|✘|✘|✘|✘| |
|查看发票部分属性|✔|✔|✔|✔|✔|✔|✔| |
...
### <a name="manage-subscriptions-for-invoice-section"></a>管理发票部分的订阅
...
|任务|发票部分所有者|发票部分参与者|发票部分读取器|Azure 订阅创建者|
|---|---|---|---|---|
|创建 Azure 订阅|✔|✔|✘|✔|
|更新订阅的成本中心|✔|✔|✘|✘|
|更改订阅的发票部分|✔|✔|✘|✘|
