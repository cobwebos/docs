...
可以使用 [Azure PowerShell 工具](https://msdn.microsoft.com/zh-CN/library/azure/jj156055.aspx) 中提供的 PowerShell cmdlet 在 Azure Automation 中管理密钥保管库。Azure Automation 现成地提供了这些密钥保管库 PowerShell cmdlet，因此，你可以在该服务中执行所有密钥保管库管理任务。你还可以将 Azure Automation 中的这些 cmdlet 与其他 Azure 服务的 cmdlet 搭配使用，以自动完成跨 Azure 服务和第三方系统的复杂任务。
