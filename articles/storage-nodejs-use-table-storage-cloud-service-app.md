...
views 目录中的 layout.jade 文件用作其他 .jade 文件的全局模板。在此步骤中，你需要修改它以使用 [Twitter Bootstrap](https://github.com/twbs/bootstrap)（一个可以轻松设计美观网站的工具包）。

1. 下载并提取 [Twitter Bootstrap] 的文件(http://getbootstrap.com/)。 将 bootstrap.min.css 文件从 bootstrap\css 文件夹复制到您的 tasklist 应用程序的 public\stylesheets 目录。
