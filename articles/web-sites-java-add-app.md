...
按照 [Microsoft Azure 网站和 Java 入门][]中的说明初始化 Java 网站后，即可通过将 WAR 置于 **webapps** 文件夹中来上载应用程序。
...
请注意，你可以使用源代码管理来上载你的应用程序或网页，包括在连续集成方案中也这样做。有关源代码管理与你的网站配合使用的说明，请参阅[从源代码管理发布到 Azure 网站][]。对于上载应用程序或网页，FTP 也是一种可选择的方式。
