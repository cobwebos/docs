...
* 将 AI 与 SQL 集成，并使用机器学习模型通过 T-SQL PREDICT 函数对数据进行评分 

### <a name="industry-standard-apache-spark"></a>行业标准 Apache Spark

Synapse Spark 与 Apache Spark 深度无缝集成 -- Apache Spark 是最流行的用于数据准备、数据工程、ETL 和机器学习的开源大数据引擎。 
...
### <a name="interop-of-sql-and-spark-on-your-data-lake"></a>Data Lake 中 SQL 和 Spark 的互操作
