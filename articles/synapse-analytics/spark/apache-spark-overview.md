...
| 容易创建 |可以使用 Azure 门户、Azure PowerShell 或 Synapse Analytics .NET SDK，在 Azure Synapse 中快速创建新的 Spark 池。 请参阅 [Synapse Analytics 中的 Spark 池入门](apache-spark-notebook-create-spark-use-sql.md)。 |
...
- [快速入门：在 Azure Synapse 中创建 Spark 池](./apache-spark-notebook-create-spark-use-sql.md)
...
- [在 Azure Synapse 中创建 Spark 池](./apache-spark-notebook-create-spark-use-sql.md)
