...
- 找到 STG1
- 导航到 CNT1
- 确保将 WS1 的 MSI （托管服务标识）分配给 CNT1 上的**存储 Blob 数据参与者**角色。
  - 如果看不到它，请对其进行分配。
...
| --- | --- | --- | --- | --- |
| 1 | 将 parquet 文件上传到 CNT1 | 是 | 是 | 是 |
| 2 | 使用 SQL 点播读取 parquet 文件 | 是 | 是 | 是 |
| 3 | 创建 Spark 池 | 是 [1] | 是 [1] | 是  |
| 4 | 使用笔记本读取 parquet 文件 | 是 | 是 | 是 |
| 5 | 从笔记本创建管道，并触发管道立即运行 | 是 | 是 | 是 |
...
| --- | --- | --- | --- |
| 打开 Synapse Studio | 是 | 是 | 是 |
| 查看本中心 | 是 | 是 | 是 |
| 查看数据中心 | 是 | 是 | 是 |
| 数据中心/请参阅链接 ADLS Gen2 帐户和容器 | 是 [1] | 是 [1] | 是 [1] |
| 数据中心/请参阅数据库 | 是 | 是 | 是 |
| 数据中心/查看数据库中的对象 | 是 | 是 | 是 |
| 数据中心/访问 SQL 池中数据库中的数据 | 是   | 是   | 是   |
| 数据中心/访问 SQL 点播数据库中的数据 | 是 [2]  | 是  | 是 [2]  |
| Spark 数据库中的数据中心/访问数据 | 是 [2] | 是 [2] | 是 [2] |
| 使用开发中心 | 是 | 是 | 是 |
| 开发中心/作者 SQL 脚本 | 是 | 是 | 是 |
| 开发中心/作者 Spark 作业定义 | 是 | 是 | 是 |
| 开发中心/作者笔记本 | 是 | 是 | 是 |
| 开发中心/作者数据流 | 是 | 是 | 是 |
| 使用协调中心 | 是 | 是 | 是 |
| 安排中心/使用管道 | 是 | 是 | 是 |
...
| 管理中心/触发器 | 是 | 是 | 是 |
| 管理中心/链接服务 | 是 | 是 | 是 |
| 管理中心/访问控制（将用户分配到 Synapse 工作区角色） | 是 | 是 | 是 |
| 管理中心/集成运行时 | 是 | 是 | 是 |
| 使用监视集线器 | 是 | 是 | 是 |
| 监视集线器/业务流程/管道运行  | 是 | 是 | 是 |
| 监视集线器/业务流程/触发器运行  | 是 | 是 | 是 |
| 监视集线器/业务流程/集成运行时  | 是 | 是 | 是 |
| 监视集线器/活动/Spark 应用程序 | 是 | 是 | 是  |
| 监视集线器/活动/SQL 请求 | 是 | 是 | 是 |
| 监视集线器/活动/Spark 池 | 是 | 是 | 是  |
| 监视集线器/触发器 | 是 | 是 | 是 |
| 管理中心/链接服务 | 是 | 是 | 是 |
| 管理中心/访问控制（将用户分配到 Synapse 工作区角色） | 是 | 是 | 是 |
| 管理中心/集成运行时 | 是 | 是 | 是 |
