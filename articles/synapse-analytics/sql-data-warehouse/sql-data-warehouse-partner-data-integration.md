...
要使用 Azure Synapse 的 Synapse SQL 池功能创建数据仓库解决方案，可以从各种行业领先的工具中进行选择。 本文重点介绍 Microsoft 合作伙伴公司，这些合作伙伴具有支持 Azure Synapse 的官方数据集成解决方案。

## <a name="data-integration-partners"></a>数据集成合作伙伴

| Partner | 说明 | 网站/产品链接 |
| ------- | ----------- | -------------------- |
| ![Alooma](./media/sql-data-warehouse-partner-data-integration/alooma_logo.png) |**Alooma**<br> Alooma 是一种提取、转换和加载 （ETL） 解决方案，使数据团队能够实时集成、丰富和流式传输数据从各种数据孤岛到 Azure Synapse 数据仓库。 |[产品页](https://www.alooma.com/) |
...
| ![Attunity](./media/sql-data-warehouse-partner-data-integration/attunity_logo.png) |**团结（云束）**<br>Attunity CloudBeam 提供了一个自动化解决方案，用于将数据加载到 Azure 突触数据仓库中。 它简化了来自许多来源的数据的批处理加载和增量复制 - SQL Server、Oracle、DB2、Sybase、MySQL 等。 |[产品页](http://www.attunity.com/attunity-cloudbeam-for-azure/)<br>[Azure 市场](https://azure.microsoft.com/marketplace/partners/attunity-cloudbeam/cloudbeam-dw-byol/) <br> |
| ![Denodo](./media/sql-data-warehouse-partner-data-integration/denodo_logo.png) |**Denodo**<br>Denodo 提供跨组织各种数据源对数据的实时访问。 它使用数据虚拟化跨多个源桥接数据，而无需复制。 它提供了对驻留在企业、大数据和云源中的结构化和非结构化数据的广泛访问，包括批处理和实时数据。|[产品页](https://www.denodo.com/en)<br>[Azure 市场](https://azuremarketplace.microsoft.com/marketplace/apps/denodo.denodo-platform-7_0)<br> |
| ![五特兰](./media/sql-data-warehouse-partner-data-integration/fivetran_logo.png) |**五特兰**<br>Fivetran 可帮助您集中来自不同来源的数据。 它具有零维护、零配置数据管道产品，并列出了越来越多的所有常用数据源的内置连接器。 在验证数据源和目标数据仓库后，安装程序需要五分钟。|[产品页](https://fivetran.com/)<br> |
