...
* 使用 AdventureWorksDW 示例数据预先加载的 SQL 池。 若要设置此设置，请参阅[创建 SQL 池](create-data-warehouse-portal.md)并选择加载示例数据。 如果已有数据仓库但没有示例数据，可以[手动加载示例数据](load-data-from-azure-blob-storage-using-polybase.md)。
