---
title: 快速入门：缩放 Azure Synapse Analytics 中的计算 - T-SQL
...
下载并安装最新版本的 [SQL Server Management Studio](/sql/ssms/download-sql-server-management-studio-ssms?toc=/azure/synapse-analytics/sql-data-warehouse/toc.json&bc=/azure/synapse-analytics/sql-data-warehouse/breadcrumb/toc.json&view=azure-sqldw-latest) (SSMS)。
...
若要返回有关 Azure Synapse 上各种管理操作的信息，请针对 [sys.dm_operation_status](/sql/relational-databases/system-dynamic-management-views/sys-dm-operation-status-azure-sql-database?toc=/azure/synapse-analytics/sql-data-warehouse/toc.json&bc=/azure/synapse-analytics/sql-data-warehouse/breadcrumb/toc.json&view=azure-sqldw-latest) DMV 运行以下查询。 例如，它返回操作和操作状态，后者为 IN_PROGRESS 或 COMPLETED。
