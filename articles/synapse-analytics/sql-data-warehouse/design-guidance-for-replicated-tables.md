...
- [创建表（SQL 分析）](/sql/t-sql/statements/create-table-azure-sql-data-warehouse)
- [创建表格作为选择（SQL 分析）](/sql/t-sql/statements/create-table-as-select-azure-sql-data-warehouse)
