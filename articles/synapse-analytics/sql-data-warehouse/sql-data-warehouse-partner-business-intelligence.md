...
要使用 Azure Synapse 中的 Synapse SQL 池创建完整的数据仓库解决方案，你可以从各种行业领先的工具中进行选择。  本文重点介绍其正式商业智能 (BI) 解决方案支持 Azure SQL 数据仓库的 Microsoft 合作伙伴公司。
...
| ![IBM Cognos](./media/sql-data-warehouse-partner-business-intelligence/cognos_analytics_logo.png) |**IBM Cognos Analytics**<br>Cognos Analytic 包括智能自助服务功能，无论你是经验丰富的业务分析员，需要检查庞大供应链中的缺陷，还是营销人员，需要优化单个营销活动，都可以简单、清晰并轻松地使用这项分析。 Cognos Analytic 使用 AI 和其他智能功能来努力指导数据探索，并使用户能够更轻松地获得所需的答案|[产品页](https://www.ibm.com/products/cognos-analytics)<br>|
...
| ![Microstrategy](./media/sql-data-warehouse-partner-business-intelligence/microstrategy_logo.png) |**MicroStrategy**<br>MicroStrategy 平台提供一整套商业智能和分析功能，使组织能够从其业务数据中获取价值。 MicroStrategy 强大的分析引擎、全面的工具集、多种多样的数据连接器和可扩展的开放式架构，可确保你拥有将分析访问权限扩展到每个团队和业务职能部门所需的一切 |[产品页](https://www.microstrategy.com/us/product/analytics)<br> [Azure 市场](https://azuremarketplace.microsoft.com/marketplace/apps/microstrategy.microstrategy_enterprise_platform_vm)<br> |
...
| ![ThoughtSpot](./media/sql-data-warehouse-partner-business-intelligence/thoughtspot-logo.png) |**ThoughtSpot**<br>使用搜索从数十亿行数据中获取详细见解，或者让 AI 从你可能没有想到的问题中发现见解。 ThoughtSpot 可帮助商务人士在几秒钟内找到隐藏在公司数据中的见解。 使用搜索分析数据并在需要时自动获得见解。|[产品页](https://www.thoughtspot.com)<br>|
| ![Yellowfin](./media/sql-data-warehouse-partner-business-intelligence/yellowfin_logo.png) |**Yellowfin**<br>BARC 的 BI 调查报告将 Yellowfin 评选为特别报告和仪表板领域最顶级的云 BI 供应商。 连接到 Synapse SQL 池，并使用屡获殊荣的协作 BI 和定位智能功能来创建和共享精美的报告与仪表板。 |[产品页](https://www.yellowfinbi.com/)<br> [Azure 市场](https://azuremarketplace.microsoft.com/marketplace/apps/yellowfin.yellowfin-for-azure-byol) |
