...
ms.locfileid: "80351355"
---
# <a name="t-sql-statements-supported-in-sql-analytics"></a>SQL 分析中支持的 T-SQL 语句
...
* [创建表](https://msdn.microsoft.com/library/mt203953.aspx)
...
* [截图表](https://msdn.microsoft.com/library/ms177570.aspx)
...
* [解释](https://msdn.microsoft.com/library/mt631615.aspx)
...
有关详细信息参考，请参阅[SQL 分析 中的 T-SQL 语言元素](sql-data-warehouse-reference-tsql-language-elements.md)，以及 SQL Analytics[中的系统视图](sql-data-warehouse-reference-tsql-system-views.md)。
