...
SQL 池当前不支持[@@NESTLEVEL](/sql/t-sql/functions/nestlevel-transact-sql?toc=/azure/synapse-analytics/sql-data-warehouse/toc.json&bc=/azure/synapse-analytics/sql-data-warehouse/breadcrumb/toc.json&view=azure-sqldw-latest)。 因此，您需要跟踪嵌套级别。 您不太可能超过八个嵌套级别限制。 但是，如果您这样做，则需要重新编写代码以适合此限制中的嵌套级别。
