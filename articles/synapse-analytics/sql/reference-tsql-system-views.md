...
## <a name="sql-pool-dynamic-management-views-dmvs"></a> (Dmv) 的 SQL 池动态管理视图
...
SQL 池公开了许多 SQL Server 动态管理视图 (DMV)。 在 SQL 池中查询这些视图时，它们将报告分布区上运行的 SQL 数据库的状态。
