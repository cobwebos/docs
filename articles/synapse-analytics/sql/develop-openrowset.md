...
| 外部数据源       | 前缀 | 存储帐户路径                                 |
| -------------------------- | ------ | ---------------------------------------------------- |
| Azure Blob 存储         | https  | \<storage_account>.blob.core.windows.net/path/file   |
| Azure Blob 存储         | wasb   | \<container>@\<storage_account>.blob.core.windows.net/path/file |
