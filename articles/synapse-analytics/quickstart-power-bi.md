...
ms.locfileid: "83656010"
---
# <a name="quickstart-linking-a-power-bi-workspace-to-a-synapse-analytics-workspace-preview"></a>快速入门：将 Power BI 工作区链接到 Synapse Analytics 工作区（预览版）
