...
1. 上传一些 `PARQUET` 文件。
2. 选择一个或多个文件，然后创建新的 SQL 脚本或 Spark 笔记本来查看文件内容。 若要创建笔记本，需要[在工作区中创建 Apache Spark 池](spark/apache-spark-notebook-create-spark-use-sql.md)。
...
- [创建 Apache Spark 池](spark/apache-spark-notebook-create-spark-use-sql.md)
