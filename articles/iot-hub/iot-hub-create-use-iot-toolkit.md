...
description: 了解如何使用可视化工作室代码的 Azure IoT 工具在资源组中创建 Azure IoT 中心。
...
* [请参阅用于 VS 代码 wiki 的 Azure IoT 中心页面](https://github.com/microsoft/vscode-azure-iot-toolkit/wiki)。
