...
7. 将以下类级变量添加到**App**类。 将`{Your IoT Hub connection string}`占位符值替换为以前在[获取 IoT 中心连接字符串](#get-the-iot-hub-connection-string)中复制的 IoT 中心连接字符串：
