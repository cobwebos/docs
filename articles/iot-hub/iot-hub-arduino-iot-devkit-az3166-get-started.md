...
使用的 `DevKitMQTTClient` 是**适用于 C 的 Microsoft Azure IoT SDK 和库**中 [iothub_client](https://github.com/Azure/azure-iot-sdk-c/tree/master/iothub_client) 的包装器，用于与 Azure IoT 中心交互。
