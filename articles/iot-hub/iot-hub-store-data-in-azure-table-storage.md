...
5. 在该函数应用中，通过执行以下操作创建一个新函数：
   ...
   a.在“横幅徽标”下面，选择“删除上传的徽标”。 单击“新建函数”。

   b.在“磁贴徽标”下面，选择“删除上传的徽标”。 为“语言”选择“JavaScript”，为“方案”选择“数据处理”。
...
6. 执行以下操作配置函数的输出：
   ...
   a.在“横幅徽标”下面，选择“删除上传的徽标”。 单击“集成” > “新建输出” > “Azure 表存储” > “选择”。
   ...
   b.在“磁贴徽标”下面，选择“删除上传的徽标”。 输入所需的信息。
