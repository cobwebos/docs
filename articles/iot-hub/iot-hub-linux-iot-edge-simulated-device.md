...
在文本编辑器中，打开 **iot-edge** 存储库本地副本中的文件 **samples/simulated_device_cloud_upload/src/simulated_device_cloud_upload_lin.json**。 此文件配置示例网关中的 IoT Edge 模块：
...
2. 运行以下命令：
    ...
    ```
3. 可使用[设备资源管理器][lnk-device-explorer]或 [iothub-explorer][lnk-iothub-explorer] 工具监视 IoT 中心从 IoT Edge 网关接收的消息。
