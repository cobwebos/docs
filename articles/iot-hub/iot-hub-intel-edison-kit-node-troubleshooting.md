---
title: "将 Intel Edison（节点）连接到 Azure IoT - 第 4 课：疑难解答 | Microsoft Docs"
...
### <a name="configure-vs-code-to-connect-to-the-remote-device"></a>将 VS Code 配置为连接到远程设备

打开左侧的“调试”面板。

单击绿色的“启动调试”(F5) 按钮。 VS Code 将打开 **launch.json** 文件，用户需要对该文件进行更新。
...
若要详细了解调试器，请参阅 [VS Code 中的 JavaScript](https://code.visualstudio.com/docs/languages/javascript#_debugging)。

![远程交互式调试](media/iot-hub-intel-edison-lessons/troubleshooting/remote_debugging_interactive.png)
