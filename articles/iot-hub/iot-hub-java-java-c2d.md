...
---
# <a name="tutorial-how-to-send-cloud-to-device-messages-with-iot-hub-and-java"></a>教程：如何使用 IoT 中心和 Java 发送“云到设备”消息
...
在本部分中，会创建 Java 控制台应用，用于向模拟设备应用发送“云到设备”消息。 你需要使用 [IoT 中心入门]教程中添加的设备的设备 ID。 还需要可在 [Azure 门户]中找到的你的 IoT 中心的连接字符串。
...
2. 在 send-c2d-messages 文件夹中的命令提示符下，运行以下命令以发送“云到设备”消息并等待反馈确认：
