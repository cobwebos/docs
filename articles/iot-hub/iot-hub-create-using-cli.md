...
description: 了解如何使用 Azure CLI 命令创建资源组，然后在资源组中创建 IoT 中心。 还了解如何删除集线器。
author: robinsh
ms.service: iot-hub
services: iot-hub
ms.topic: conceptual
...
要[删除 IoT 中心](https://docs.microsoft.com/cli/azure/iot/hub#az-iot-hub-delete)，请运行以下命令：
...
要[删除资源组](https://docs.microsoft.com/cli/azure/group#az-group-delete)及其所有资源，请运行以下命令：
