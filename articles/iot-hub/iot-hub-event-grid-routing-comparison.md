...
* **哪些终结点需要接收此信息？**
   ...
   与事件网格的 IoT 中心集成支持每个 IoT 中心 500 个终结点和大量的终结点类型。 它本身与 Azure Functions、逻辑应用、存储和服务总线队列集成, 还可与 webhook 一起使用, 以扩展 Azure 服务生态系统外和第三方业务应用程序的发送数据。
