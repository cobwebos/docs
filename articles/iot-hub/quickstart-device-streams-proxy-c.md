...
1. 编辑 *iothub_client/示例/iothub_client_c2d_streaming_sample* 文件夹中的源文件 *iothub_client_c2d_streaming_sample.c*，并提供设备连接字符串、目标设备 IP/主机名和 SSH 端口 22：
