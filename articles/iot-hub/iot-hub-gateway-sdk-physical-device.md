...
本演练的[蓝牙低功耗示例][lnk-ble-samplecode]演示如何使用 [Microsoft Azure IoT 网关 SDK][lnk-sdk] 从物理设备将设备到云遥测转发到 IoT 中心以及如何从 IoT 中心将命令路由到物理设备。
...
[lnk-create-hub]: /documentation/articles/iot-hub-manage-through-portal.md/
