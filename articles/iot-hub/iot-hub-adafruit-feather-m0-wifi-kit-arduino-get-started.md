...
<a id="connect-adafruit-feather-m0-wifi-to-azure-iot-hub-in-the-cloud" class="xliff"></a>
...
<a id="connect-feather-m0-wifi-with-the-sensor-and-your-computer" class="xliff"></a>
在此部分中，将传感器连接到开发板。 然后，将设备插入计算机以供进一步使用。
### 将 DHT22 温度和湿度传感器连接到 Feather M0 WiFi
<a id="connect-a-dht22-temperature-and-humidity-sensor-to-feather-m0-wifi" class="xliff"></a>
...
<a id="connect-feather-m0-wifi-to-your-computer" class="xliff"></a>
...
<a id="get-the-sample-application-from-github-and-prepare-arduino-ide" class="xliff"></a>
...
1. 依次单击“工具” > “开发板” > “开发板管理器”，然后安装 `Arduino SAMD Boards` 版本 `1.6.2` 或更高版本。 然后，安装 `Adafruit SAMD` 包以添加开发板文件定义。
...
1. 手动安装 `Adafruit_WINC1500`。 访问[此链接](https://github.com/adafruit/Adafruit_WINC1500)并单击“克隆或下载”按钮，然后单击“下载 ZIP”。 然后，在 Arduino IDE 中，转到“Sketch”（草图） -> “Include Library”（包含库） -> “Add .zip Library”（添加 .zip 库）并添加你刚才下载的 zip 文件。

### 没有真正的 BME280 传感器？
<a id="dont-have-a-real-bme280-sensor" class="xliff"></a>
...
<a id="deploy-the-sample-application-to-feather-m0-wifi" class="xliff"></a>
