...
还可以通过服务 API 从 IoT 中心导出和导入设备标识，方法是使用[REST API](/rest/api/iothub/service/createimportexportjob)或某个 Iot 中心[服务 sdk](/azure/iot-hub/iot-hub-devguide-sdks#azure-iot-hub-service-sdks)。
