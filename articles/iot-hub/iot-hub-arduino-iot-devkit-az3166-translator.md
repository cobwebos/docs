---
title: 使翻译器具有 Azure 功能、认知服务、IoT 开发工具包
...
1. 在 VS 代码`F1`中，单击 、键入并选择**Azure IoT 设备工作台：预配 Azure 服务..."**![预配 Azure 服务](media/iot-hub-arduino-iot-devkit-az3166-translator/provision.png)
...
1. 单击`F1`，键入并选择**Azure IoT 设备工作台：部署到 Azure..."** 如果 VS 代码要求确认重新部署，请单击"**是**"。
...
1. 单击`F1`，键入并选择**Azure IoT 设备工作台：配置设备设置... >配置设备连接字符串**。 选择“选择 IoT 中心设备连接字符串”，将其配置到 DevKit****。
