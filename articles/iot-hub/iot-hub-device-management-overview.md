<properties
 pageTitle="设备管理概述 | Microsoft Azure"
...
2.  **设备属性**：设备属性是预定义的属性字典，用于描述物理设备。物理设备是每个设备属性的主机，是每个对应值的权威存储位置。这些属性的最终一致表示存储在云中的设备克隆中。相干性和新鲜度受同步设置影响，如[教程：如何使用成对设备][lnk-tutorial-twin]中所述。设备属性的一些示例包括固件版本、电池剩余电量和制造商名称。
...
若要了解有关上述职责与物理设备上的实现的详细信息，请参阅[面向 C 的 Azure IoT 中心设备管理客户端库简介][lnk-library-c]。
