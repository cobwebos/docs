...
## <a name="custom-routing-endpoints"></a>自定义路由终结点
可将订阅中的现有 Azure 服务链接到用作消息路由终结点的 IoT 中心。 这些服务终结点用作消息路由的“接收器”。 设备无法直接写入附加终结点。 若要深入了解消息路由，请参阅[通过 IoT 中心发送和接收消息][lnk-devguide-messaging]中的开发人员指南条目。
