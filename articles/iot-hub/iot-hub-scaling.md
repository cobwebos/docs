...
| [创建或更新设备](https://docs.microsoft.com/rest/api/iothub/service/service/createorupdatedevice) | 是 | 是 |
| 放置模块 | 是 | 是 |
| [查询 IoT 中心](https://docs.microsoft.com/rest/api/iothub/service/service/queryiothub) | 是 | 是 |
| 查询模块 | 是 | 是 |
