---
title: 使用 Azure Cosmos DB 将来自 Azure IoT 中心的设备连接事件排序
...
3. 选择“创建”以创建逻辑应用。
   ...
   > [!NOTE]
   > 若要查找并再次打开你的逻辑应用，请选择“资源组”，然后选择要在本操作指南中使用的资源组。 然后选择你的新逻辑应用。 此时会打开逻辑应用设计器。

4. 在逻辑应用设计器中向右滚动，直至看到常用的触发器。 在“模板”下，选择“空白逻辑应用”，以便从头开始生成逻辑应用。 
...
6. 对于“终结点详细信息”，请选择“Webhook”作为“终结点类型”，单击“选择终结点”并粘贴从逻辑应用中复制的 URL，然后确认选择。 
...
5. 可以添加具有不同设备 ID 的多个设备。
   ...
   ![已添加到中心的设备](./media/iot-hub-how-to-order-connection-state-events/AddIoTDevice.png)
