...
模块标识和模块孪生为公共预览版。 它仅在 IoT 中心预发布设备 Sdk 中提供。 在 Visual Studio 中，打开“工具”>“NuGet 包管理器”>“管理解决方案的 NuGet 包”。 搜索 Microsoft.Azure.Devices.Client。 请确保已选中 "包括预发行版" 复选框。 选择最新版本并安装。 现在可以访问所有模块功能。
