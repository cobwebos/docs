...
有关如何解决 Adafruit Feather M0 WiFi Arduino 的常见问题的信息，请参阅[官方故障排除页](https://learn.adafruit.com/adafruit-feather-m0-wifi-atwinc1500?view=all#faq)。
...
或者，可以添加 `--listen` 以打开串行端口，从而输出设备的日志信息。
