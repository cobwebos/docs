---
title: "Azure IoT 中心云到设备通信指南 | Microsoft Docs"
...
---
# <a name="cloud-to-device-communications-guidance"></a>云到设备通信指南
...
| 数据流 | 双向。 设备应用可立即响应方法。 后端根据上下文接收请求结果。 | 单向。 设备应用接收更改了属性的通知。 | 单向。 设备应用接收消息
...
| 协议 | 在 MQTT 和 AMQP 上可用。 | 目前仅在使用 MQTT 时提供。 | 在所有协议上可用。 使用 HTTP 时，设备必须轮询。 |
