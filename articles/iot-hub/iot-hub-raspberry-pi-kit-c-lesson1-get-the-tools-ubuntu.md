---
title: "将 Raspberry Pi (C) 连接到 Azure IoT - 第 1 课：获取工具 (Ubuntu) |Microsoft Docs"
...
如果在 Ubuntu 上安装 Node.js 和这些额外的开发工具时，请参阅[故障排除指南](iot-hub-raspberry-pi-kit-c-troubleshooting.md)来查找常见问题的解决方案。
