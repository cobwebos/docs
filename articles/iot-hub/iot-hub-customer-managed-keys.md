...
此功能需要在以下区域之一创建新的 IoT 中心（基本或标准层）：美国东部、美国西部2或美国中南部。 若要尝试此功能，请通过[Microsoft 支持](https://azure.microsoft.com/support/create-ticket/)联系我们。 联系 Microsoft 支持部门时，共享公司名称和订阅 ID。
