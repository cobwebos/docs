...
> [!NOTE]
> Azure 有两种不同的部署模型来创建和使用资源[：Azure 资源管理器和经典](../azure-resource-manager/management/deployment-models.md)。  本文介绍了如何使用 Azure 资源管理器部署模型。
...
* Visual Studio。
* 有效的 Azure 帐户。 <br/>如果您没有帐户，只需几分钟即可创建[免费帐户][lnk-free-trial]。
