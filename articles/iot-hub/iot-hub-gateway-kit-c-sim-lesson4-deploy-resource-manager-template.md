---
title: "模拟设备和 Azure IoT 网关 - 第 4 课：保存消息 | Microsoft Docs"
...
- [第 2 课：准备好主机和 Azure IoT 中心](iot-hub-gateway-kit-c-sim-lesson2-get-the-tools-win32.md)
...
[读取 Azure 存储中保存的消息](iot-hub-gateway-kit-c-sim-lesson4-read-table-storage.md)。
