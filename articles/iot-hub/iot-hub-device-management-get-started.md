...
> [!NOTE]
> 即使有现有的 IoT 中心，也必须创建一个新的 IoT 中心来启用设备管理功能，因为现有 IoT 中心尚不具备这些功能。公开发布设备管理功能后，将升级全部现有 IoT 中心，以获得设备管理功能。
> 
> 
...
3. 在“IoT 中心”边栏选项卡中，选择 IoT 中心的配置。
   ...
   * 在“位置”中，选择托管 IoT 中心的位置。在公开预览期间，仅在美国东部、北欧和东亚提供 IoT 中心设备管理功能。未来将在所有区域提供该功能。
   ...
   > [!NOTE]
   > 如果不选中“启用设备管理”复选框，示例将不起作用。<br/>如果选中“启用设备管理”，可以创建仅受美国东部、北欧和东亚支持的，而不适用于生产方案的预览版 IoT 中心。无法将设备迁入和迁出已启用设备管理的中心。
   > 
   > 
