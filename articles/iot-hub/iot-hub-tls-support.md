...
## <a name="restrict-connections-to-tls-12-in-your-iot-hub-resource"></a>在 IoT 中心资源中将连接限制为 TLS 1.2

为了提高安全性，建议将 IoT 中心配置为仅允许那些使用 TLS 版本 1.2 的客户端连接，并强制使用[建议的密码](#recommended-ciphers)。

为此，请在任何[支持的区域](#supported-regions)中预配新的 IoT 中心并将 Azure 资源管理器模板的 IoT 中心资源规范中的 `minTlsVersion` 属性设置为 `1.2`：
...
需要使用 TLS 1.2 的 IoT 中心可在以下区域中创建：
