...
Use the [Management Portal](https://manage.windowsazure.cn) to perform the following steps with your Azure subscription. These are needed so you can later deploy Azure nodes from the on-premises head node. 
...
1. From the head node computer, sign in to the [Management Portal](https://manage.windowsazure.cn).
...
4. To confirm that the role instances are running, in the [Management Portal](https://manage.windowsazure.cn), click **Cloud Services**, click the name of your cloud service, and then click **Instances**. 
