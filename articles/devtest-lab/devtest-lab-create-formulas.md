---
title: "在 Azure 开发测试实验室中创建公式 | Microsoft 文档"
description: "了解如何创建 Azure 开发测试实验室公式并用其创建新的 VM。"
...
---
# <a name="create-azure-devtest-labs-formulas"></a>创建 Azure 开发测试实验室公式

[!INCLUDE [devtest-lab-formula-definition](../../includes/devtest-lab-formula-definition.md)]

本文将介绍如何从基项（自定义映像、应用商店映像或其他公式）或现有 VM 创建公式。 
...
7. 在“创建公式”边栏选项卡上，指定以下值：
    ...
    * “公式名称” - 输入公式的名称。 创建 VM 时，此值将显示在基本映像列表中。 在键入该名称时会对其进行验证，如果无效，则会显示一条消息，指出有效名称的要求。
    ...
    * “项目” - 选择此项会打开“添加项目”边栏选项卡，你可以从中选择并配置要添加到基本映像的项目。 有关项目的详细信息，请参阅[管理 Azure 开发测试实验室中的 VM 项目](./devtest-lab-add-vm-with-artifacts.md)。
...
- [管理 Azure 开发测试实验室公式](devtest-lab-manage-formulas.md)
