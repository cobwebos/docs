...
# <a name="health-endpoint-monitoring"></a>Health Endpoint Monitoring
...
```
## <a name="monitoring-endpoints-in-azure-hosted-applications"></a>Monitoring endpoints in Azure hosted applications 
