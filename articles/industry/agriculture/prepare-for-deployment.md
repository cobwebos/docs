...
|S.No  |资源名称  |Azure FarmBeats Component  |
|---------|---------|---------|
...
|5  |    时序见解       |     数据中心      |
|6 |      EventHub Namespace    |  数据中心       |
|7  |    Azure 数据工厂 V2       |     Data hub/ Accelerator      |
|8  |批处理帐户    |数据中心   |
|9  |       存储帐户     |  Data hub/ Accelerator        |
|10  |    逻辑应用        |     数据中心      |
|11  |    API connection        |     数据中心      |
|12|      应用服务      |  Data hub/Accelerator       |
|13 |    应用服务计划        |     Data hub/ Accelerator      |
...
转到  https://scihub.copernicus.eu/dhus/#/self-registration 。 In the registration page, provide a first name, last name, username, password, and email.
...
4. First-time users will be prompted to select a subscription to create a storage account and Microsoft Azure Files share. 选择“创建存储”。
...
|位置 |Location where you would like to create the resources|
...
The steps for upgrade are similar to the first-time installation. 执行以下步骤：
...
4. 选择资源组名称。 Type in the name again to double-check, and select Delete to remove the resource group, and all its underlying resources.
