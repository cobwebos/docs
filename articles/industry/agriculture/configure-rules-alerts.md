---
title: 在 Azure FarmBeats 中配置规则和管理警报
...
ms.locfileid: "73798526"
---
# <a name="configure-rules-and-manage-alerts-in-farmbeats"></a>在 FarmBeats 中配置规则和管理警报
...
2. 选择 "**新建规则**"。 将显示 "新建规则" 窗口。
    ...
    ![项目场节拍](./media/configure-rules-and-alerts/new-rule-1.png)

3. 输入**规则名称**和**规则说明**，然后从 "**选择场**" 下拉菜单中选择场。
4. 键入场名称以选择 "场和**条件**" 部分显示在同一窗口中。  

    ![项目场节拍](./media/configure-rules-and-alerts/new-rule-condition-1.png)
...
9. 在 "**操作**" 中，切换到 "**已启用电子邮件**" 切换按钮以启用电子邮件警报。
    ...
    ![项目场节拍](./media/configure-rules-and-alerts/new-rule-email-1.png)
...
"**场**" 页显示可用规则的列表。 选择**规则名称**。 窗口将显示适用于所选规则的以下详细信息：
 ...
 - 受规则影响的设备数
    ...
    ![项目场节拍](./media/configure-rules-and-alerts/view-rule-1.png)
...
2. 选择要编辑的规则。
    ...
    ![项目场节拍](./media/configure-rules-and-alerts/edit-rule-action-bar-1.png)

3. 从操作栏中选择 "**编辑**"，将显示 "**编辑规则**" 窗口。

    ![项目场节拍](./media/configure-rules-and-alerts/edit-rule-one-1.png)
...
8. 选择 " **+ 添加条件**" 可向规则中添加/编辑条件。
    ...
    ![项目场节拍](./media/configure-rules-and-alerts/edit-rule-two-1.png)
...
2. 选择要更改其状态的规则。
    ...
    ![项目场节拍](./media/configure-rules-and-alerts/change-status-rule-action-bar-1.png)

3. 从操作栏中选择 "**更改状态**"。 将显示 "**更改状态**" 窗口。

    ![项目场节拍](./media/configure-rules-and-alerts/rule-change-status-1.png)
...
2. 选择要删除的规则。
    ...
    ![项目场节拍](./media/configure-rules-and-alerts/delete-rule-action-bar-1.png)

3. 从操作栏中选择 "**删除**"。

    ![项目场节拍](./media/configure-rules-and-alerts/delete-rule-1.png)
