...
* 若要使用 Azure CLI 命令，请参阅[资源管理器模式中的 Azure CLI 命令](virtual-machines/azure-cli-arm-commands.md)和[服务管理模式中的 Azure CLI 命令](https://docs.microsoft.com/cli/azure/get-started-with-az-cli2)。
