---
title: Azure Location Based Services 中的缩放级别和磁贴网格 | Microsoft Docs
description: 了解 Azure Location Based Services 中的缩放级别和磁贴网格
...
Azure Location Based Services 使用球面 Mercator 投影坐标系统 (EPSG: 3857)。
...
每个后续缩放级别都将前一个缩放级别的磁贴分为四份，从而创建一个 2 <sup>缩放</sup> x 2 <sup>缩放</sup>的网格。 缩放级别 20 是一个 2<sup>20</sup> x 2<sup>20</sup> 的网格，或 1,048,576 x 1,048,576 的磁贴（总面积为 109,951,162,778）。
