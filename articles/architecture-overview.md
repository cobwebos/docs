...
[下载 Azure 符号/图标集][]以创建描述（或使用）Azure 的技术材料 - 例如体系结构图、培训材料、演示文稿、数据表、信息图和白皮书。你可以下载 PPT、Visio 或 PNG 格式的符号。我们想要知道你的想法，因此下载文件中包含了有关如何提供反馈的说明。
...
有关 Azure 中其他常见设计模式的信息，请参阅[云设计模式][]。
