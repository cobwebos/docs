...
-   你必须已经设置了 HDInsight 群集。有关可用于创建这种群集的各种不同方法的说明，请参阅 [Azure HDInsight 入门][Azure HDInsight 入门]或[设置 HDInsight 群集][设置 HDInsight 群集]。
...
2.  [WordCount MapReduce 程序的 Java 代码][WordCount MapReduce 程序的 Java 代码]
3.  [摘要][摘要]
4.  [后续步骤][后续步骤]
