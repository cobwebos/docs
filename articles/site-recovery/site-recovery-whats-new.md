...
- 在移动服务扩展（适用于 Azure Vm）和移动服务代理（对于 VMware/物理计算机）的版本 9:30. x （预计从 11 2019 月1日开始）和移动服务代理（对于 VMware/物理计算机）中，某些计算机操作系统必须运行服务堆栈更新和 SHA-1。 下表显示了详细信息。
...
**功能** | **详细信息**
--- | ---
**Linux 支持** | 为 Oracle Linux 6.8 和 6.9/7.0 以及 UEK5 内核添加了支持。
...
**功能** | **详细信息**
--- | ---
**Linux 支持** | 为 Oracle Linux 6.8 和 6.9/7.0 添加了支持;对于 UEK5 内核，还会提供。
