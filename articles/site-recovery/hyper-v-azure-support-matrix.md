...
主机网络：IPv4 | 是 | 是
主机网络：IPv6 | No | No
来宾 VM 网络：NIC 组合 | No | No
来宾 VM 网络：IPv4 | 是 | 是
来宾 VM 网络：IPv6 | No | 是
来宾 VM 网络：静态 IP (Windows) | 是 | 是
来宾 VM 网络：静态 IP (Linux) | No | No
来宾 VM 网络：多 NIC | 是 | 是
...
修改存储帐户 | 不。 启用复制后，无法修改目标 Azure 存储帐户。 修改、禁用和重新启用灾难恢复。 | No
...
--- | --- | ---
跨资源组移动保管库<br/><br/> 订阅内和跨订阅移动 | No | No
跨资源组移动存储、网络和 Azure VM<br/><br/> 订阅内和跨订阅移动 | No | No
