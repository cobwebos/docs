---
title: "使用 Azure Site Recovery PowerShell 将 VMware 虚拟机复制和故障转移到 Azure | Microsoft Docs"
...
## <a name="add-a-vcenter-server-and-discover-vmware-virtual-machines"></a>添加 vCenter 服务器，并发现 VMware 虚拟机
