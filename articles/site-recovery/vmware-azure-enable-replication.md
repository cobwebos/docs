---
title: 使用 Azure Site Recovery 为 VMware到 Azure 的灾难恢复启用 VMware VM 的复制 | Microsoft Docs description: 本文介绍如何使用 Azure Site Recovery 启用 VMware VM 的复制以便灾难恢复到 Azure。
