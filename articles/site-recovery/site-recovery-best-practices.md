...
- **容量规划**：如果要复制 Hyper-V VM，请阅读 [Capacity Planner](http://www.microsoft.com/zh-cn/download/details.aspx?id=39057)。
- **复制带宽**：如果你的复制带宽不足，请注意：
