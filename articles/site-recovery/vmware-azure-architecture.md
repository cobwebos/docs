...
有关本地 Azure Site Recovery 基础结构与 Azure 服务之间的通信的完整 Url 列表，请参阅 ["先决条件" 一文中的 "网络要求" 部分](vmware-azure-deploy-configuration-server.md#prerequisites)。
