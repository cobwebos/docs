...
![源虚拟机上的页面文件设置](./media/site-recovery-exclude-disk/pagefile-on-d-drive-sourceVM.png)
...
![Azure 虚拟机上的页面文件设置](./media/site-recovery-exclude-disk/pagefile-on-Azure-vm-after-failover.png)
...
![本地虚拟机上的页面文件设置](./media/site-recovery-exclude-disk/pagefile-on-g-drive-sourceVM.png)
