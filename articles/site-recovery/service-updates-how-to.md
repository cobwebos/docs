...
如果要手动管理更新，可以选择以下选项之一：

1. 新代理更新可用时，Site Recovery 在保管库中向页面顶部提供通知。 在保管库 >“复制的项”中，单击屏幕顶部的此通知：**** 
    
    **新 Site Recovery 复制代理更新可用。单击以安装->** <br/><br/>选择要将更新应用到的 VM，然后单击“确定”。****

2. 在 "VM 灾难恢复概述" 页上，你将看到 "代理状态" 字段，如果代理已过期，将显示 "关键升级"。 单击它，然后按照后续说明手动升级虚拟机。
