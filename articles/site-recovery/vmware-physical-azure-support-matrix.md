...
若要了解可以在单个资源组下保护的虚拟机数量，请参阅有关[订阅限制和配额](https://docs.microsoft.com/azure/azure-subscription-service-limits#resource-group-limits)的文章
