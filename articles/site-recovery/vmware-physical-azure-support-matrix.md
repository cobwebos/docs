...
/root 分区上的可用空间要求 | 2 GB <br/><br/> 安装文件夹 XFSv5 上的可用空间为 250 MB | 从版本 9.10 开始，移动服务支持 XFS 文件系统上的 XFSv5 功能，例如元数据校验和。 可使用 xfs_info 实用工具来检查分区的 XFS 超级块。 如果`ftype`设置为 1，则正在使用 XFSv5 功能。
