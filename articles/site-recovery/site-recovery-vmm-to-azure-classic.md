<properties
	pageTitle="将 VMM 云中的 Hyper-V 虚拟机复制到 Azure | Microsoft Azure"
...
> [AZURE.NOTE] [Migration of storage accounts](../resource-group-move-resources.md) 在同一订阅中或在跨订阅之间的跨资源组不支持用于部署站点恢复的存储帐户。
...
> [AZURE.NOTE] [Migration of networks](../resource-group-move-resources.md) 在同一订阅中或在跨订阅之间的跨资源组不支持用于部署站点恢复的网络。
