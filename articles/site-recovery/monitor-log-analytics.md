...
此查询绘制所有受保护 Azure VM 的当前复制运行状况的饼图，这些 VM 划分为三种状态：“正常”、“警告”或“严重”。
...
此查询绘制使用 Site Recovery 复制的 Azure VM 的条形图，其中的信息已按恢复点目标 (RPO) 划分：小于 15 分钟、15-30 分钟、大于 30 分钟。
