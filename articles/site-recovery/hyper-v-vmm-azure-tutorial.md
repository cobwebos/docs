...
> [!NOTE]
> 教程中介绍了某个方案的最简单部署路径。 它们尽可能使用默认选项，并且不显示所有可能的设置和路径。 有关详细说明，查看中的文章**操作方法指南**一部分[Site Recovery 文档](https://docs.microsoft.com/en-us/azure/site-recovery)。

## <a name="before-you-begin"></a>开始之前

此教程为系列教程中的第三个教程。 它假定，已在前面的教程中完成任务：
...
1. 在 Azure 门户中，转到**恢复服务保管库**并选择保管库。 在前面的教程中，我们已准备好保管库 **ContosoVMVault**。
2. 在中**Getting Started**，选择**Site Recovery**，然后选择**准备基础结构**。
...
2. 对于本教程，我们不需要部署规划器。 在中**已完成部署规划？**，选择**我将稍后进行**，然后选择**确定**。
...
5. 在中**虚拟机** > **选择**，选择想要复制的 VM。 选择“确定”。

   可以在“作业” > “Site Recovery 作业”中，跟踪“启用保护”操作的进度。 之后**最后完成保护**作业完成，初始复制已完成，并且 VM 准备好进行故障转移。
