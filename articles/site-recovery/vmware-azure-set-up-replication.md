---
title: 使用 Azure 站点恢复设置 VMware 灾难恢复的复制策略*微软文档
...
---
# <a name="configure-and-manage-replication-policies-for-vmware-disaster-recovery"></a>配置和管理 VMware 灾难恢复的复制策略
...
1. 选择复制策略。
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 若要将策略与配置服务器取消关联，请确保没有复制计算机在使用该策略。 然后，单击“取消关联”****。
    b.保留“数据库类型”设置，即设置为“共享”。 若要删除策略，请确保它未与配置服务器关联。 然后单击“删除”****。 应需要 30-60 秒才能删除。
2. 单击“确定”。
