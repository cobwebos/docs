...
>[!NOTE]
>
> - 不支持将 Azure 虚拟机从一个订阅复制到另一个订阅的灾难恢复方案。
> - 不支持在多个订阅之间迁移 Azure 虚拟机。
> - 不支持在同一区域内迁移 Azure 虚拟机。
> - 不支持将 Azure 虚拟机从经典部署模型迁移到资源管理器部署模型。
...
- [复制 Azure VM](azure-to-azure-quickstart.md)，开始对工作负荷进行保护
