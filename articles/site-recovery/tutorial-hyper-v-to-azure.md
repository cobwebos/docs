...
6. 在“是否使用 System Center VMM”中，选择“否”。 然后单击“确定”。

    ![复制目标](./media/tutorial-hyper-v-to-azure/replication-goal.png)

## <a name="set-up-the-source-environment"></a>设置源环境

要设置源环境，请在 Hyper-V 站点中添加 Hyper-V 主机，下载并安装 Azure Site Recovery 提供程序和 Azure 恢复服务代理，并在保管库中注册该 Hyper-V 站点。 
...
5. 下载保管库注册密钥。 运行安装提供程序时需要用到此选项。 生成的密钥有效期为 5 天。
    ...
    ![下载提供程序](./media/tutorial-hyper-v-to-azure/download.png)
