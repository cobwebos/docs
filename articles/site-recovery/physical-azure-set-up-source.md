...
- 安装配置服务器的物理计算机。
- 如果在要安装配置服务器的计算机上禁用了 TLS 1.0，请确保已启用 TLs 1.2，并且计算机上已安装 .NET Framework 版本4.6 或更高版本（启用了强密码）。 [了解详细信息](https://support.microsoft.com/help/4033999/how-to-resolve-azure-site-recovery-agent-issues-after-disabling-tls-1)。
