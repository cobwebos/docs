<properties
	pageTitle="监视虚拟机和物理服务器的保护及其故障排除 | Microsoft Azure" 
...
| **应用程序和服务日志/MicrosoftAzureRecoveryServices/Replication**（Hyper-V 主机） | 提供有用的日志用于排查许多 Microsoft Azure 恢复服务代理问题。<br/> ![Hyper-V 主机的事件源](./media/site-recovery-monitoring-and-troubleshooting/eventviewer03.png) |
| **应用程序和服务日志/Microsoft/Azure Site Recovery/Provider/Operational**（Hyper-V 主机） | 提供有用的日志用于排查许多 Microsoft Azure Site Recovery 服务问题。<br/> ![Hyper-V 主机的事件源](./media/site-recovery-monitoring-and-troubleshooting/eventviewer02.png) |
