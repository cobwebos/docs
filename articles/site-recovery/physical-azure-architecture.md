...
**复制的服务器** | 移动服务安装在复制的每台服务器上。 | 建议允许从进程服务器自动安装。 或者，您也可以手动安装该服务，或使用自动部署方法，例如 Configuration Manager。
...
4. 流量通过 Internet 复制到 Azure 存储公共终结点。 或者，可以使用 Azure ExpressRoute [公共对等互连](../expressroute/about-public-peering.md)。 不支持通过站点到站点 VPN 将流量从本地站点复制到 Azure。
