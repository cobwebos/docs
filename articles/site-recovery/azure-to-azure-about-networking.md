...
- Site Recovery 服务终结点 IP 地址（[以 XML 文件形式提供](https://aka.ms/site-recovery-public-ips)，具体取决于目标位置）。 建议在 Site Recovery 服务访问时允许访问标记 **"AzureSiteRecovery"** 。
...
Site Recovery IP 地址范围如下：
   ...
   **目标** | **Site Recovery IP** |  **Site Recovery 监视 IP**
   --- | --- | ---
   亚洲东部 | 52.175.17.132 | 13.94.47.61
   亚洲东南部 | 52.187.58.193 | 13.76.179.223
   ...
   美国弗吉尼亚州政府 | 52.227.178.114 | 23.97.0.197
   ...
   挪威东部 | 51.120.100.64| 51.120.98.128
...
> [!NOTE]
> 建议使用**AzureSiteRecovery 标记**而不是 IP 地址，以允许**Site Recovery 服务**的访问。
