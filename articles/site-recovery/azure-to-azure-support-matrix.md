...
**Azure 门户** | 支持
**经典门户** | 不支持
**PowerShell** | [预览](azure-to-azure-powershell.md)
**REST API** | 目前不支持
**CLI** | 目前不支持
...
**版本** | **移动服务版本** | **内核版本** |
--- | --- | --- |
Debian 7 | 9.14、9.15 | 3.2.0-4-amd64 到 3.2.0-5-amd64、3.16.0-0.bpo.4-amd64 |
...
加速网络 | 不支持 | 可以复制启用了加速网络的 VM，但故障转移 VM 不会启用加快网络。 而且，还会在故障回复后禁用源 VM 的加速网络。
