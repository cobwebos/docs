...
description: 了解如何将配置有 Azure Site Recovery 的 & SCVMM 2012 R2 的 Windows Server 2012 R2 主机升级到 Windows Server 2016 & SCVMM 2016。
...
> [!IMPORTANT]
> 请参阅[先决条件](/system-center/vmm/upgrade-vmm?view=sc-vmm-2016#requirements-and-limitations)的详细 SCVMM 文档
...
2. [保留 SCVMM 数据库并升级操作系统](/system-center/vmm/upgrade-vmm?view=sc-vmm-2016#back-up-and-upgrade-the-operating-system)
3. 在“添加/删除程序”中，选择“VMM” > “卸载”。    b. 依次选择“删除功能”、“VMM 管理服务器和 VMM 控制台”。   c. 在“数据库选项”中，选择“保留数据库”。   d. 查看摘要，然后单击“卸载”  。

4. [安装 VMM 2016](/system-center/vmm/upgrade-vmm?view=sc-vmm-2016#install-vmm-2016)
...
1.  导航到“控制面板”->“程序”->“程序和功能”->“Microsoft Azure Site Recovery”并单击“卸载”，以卸载 ASR 提供程序
2. 根据想要执行的升级模式遵循[此处](/system-center/vmm/upgrade-vmm?view=sc-vmm-2016#upgrade-a-standalone-vmm-server)所述的步骤。
