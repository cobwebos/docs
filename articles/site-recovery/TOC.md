...
# 入门
## [复制 Azure VM（预览）](azure-to-azure-walkthrough-overview.md)
### [步骤 1：查看体系结构](azure-to-azure-walkthrough-architecture.md)
### [步骤 2：开始之前](azure-to-azure-walkthrough-prerequisites.md)
### [步骤 3：规划网络](azure-to-azure-walkthrough-network.md)
### [步骤 4：创建保管库](azure-to-azure-walkthrough-vault.md)
### [步骤 5：启用复制](azure-to-azure-walkthrough-enable-replication.md)
### [步骤 6：运行测试故障转移](azure-to-azure-walkthrough-test-failover.md)
...
## [将 Hyper-V VM 复制到 Azure（包含 VMM）](vmm-to-azure-walkthrough-overview.md)
...
## [将 Hyper-V VM 复制到辅助站点（包含 VMM）](vmm-to-vmm-walkthrough-overview.md)
### [步骤 1：查看体系结构](vmm-to-vmm-walkthrough-architecture.md)
### [步骤 2：查看先决条件和限制](vmm-to-vmm-walkthrough-prerequisites.md)
### [步骤 3：规划网络](vmm-to-vmm-walkthrough-network.md)
### [步骤 4：准备 VMM 和 Hyper-V](vmm-to-vmm-walkthrough-vmm-hyper-v.md)
### [步骤 5：创建保管库](vmm-to-vmm-walkthrough-create-vault.md)
### [步骤 6：设置源和目标](vmm-to-vmm-walkthrough-source-target.md)
### [步骤 7：配置网络映射](vmm-to-vmm-walkthrough-network-mapping.md)
### [步骤 8：创建复制策略](vmm-to-vmm-walkthrough-replication.md)
### [步骤 9：启用复制](vmm-to-vmm-walkthrough-enable-replication.md)
### [步骤 10：运行测试故障转移](vmm-to-vmm-walkthrough-test-failover.md)
