...
如果你从未听说过 Azure 自动化，请在[此处](/home/features/automation/)注册。阅读有关 [Azure Site Recovery](/home/features/site-recovery/) 的详细信息，并在[此处](/zh-cn/blog/?p=166264)了解如何使用恢复计划来协调到 Azure 的恢复。
...
1.  在 Azure 自动化帐户中使用名称 
**OpenPort80** 创建一个新的 Runbook
