...
> [!NOTE]
> OVA 模板一起提供的许可证是有效的 180 天的评估许可证。 发布此期间，客户需要激活 windows 的已采购的许可证。
...
1. 通过 OVF 部署在配置服务器上的许可证有效期是多长？ 如果不重新激活许可证会发生什么？
    ...
    OVA 模板一起提供的许可证是有效的 180 天的评估许可证。 到期之前需要激活许可证。 否则，这可能导致配置服务器频繁关闭，因而妨碍复制活动。
