...
description: "汇总了使用 Azure Site Recovery 服务将 VMware VM 复制到 Azure 时支持的操作系统和组件。"
...
**服务器** | **要求** | **详细信息**
--- | --- | ---
**VMware** | vCenter Server 6.5、6.0 或 5.5 或者 vSphere 6.5、6.0、5.5 | 建议你使用 vCenter 服务器
**物理服务器** | 不可用
...
**VM 名称** | 1 - 63 个字符。<br/><br/> 限制为字母、数字和连字符。<br/><br/> 计算机名称必须以字母或数字开头和结尾。 | 请在 Site Recovery 中的计算机属性中更新该值。
