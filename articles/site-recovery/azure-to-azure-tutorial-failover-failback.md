...
ms.locfileid: "57729039"
---
# <a name="fail-over-and-reprotect-azure-vms-between-azure-regions"></a>在 Azure 区域之间故障转移和重新保护 Azure VM
...
- 阅读[如何故障回复](azure-to-azure-tutorial-failback.md)。
