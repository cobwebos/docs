...
1. 在“已复制项”  中，选择要故障转移的 VM >“故障转移” 
   ...
   ![显示 VM 的故障转移选项的屏幕截图。](./media/azure-to-azure-tutorial-failover-failback/failover.png)
...
![显示在添加了磁盘时进行故障转移的屏幕截图。](./media/azure-to-azure-tutorial-failover-failback/failover-added.png)
...
2. 在“保管库” > “已复制项”中，右键单击已故障转移的 VM，并选择“重新保护”。   
   ...
   ![VM 重新保护选项的屏幕截图。](./media/azure-to-azure-tutorial-failover-failback/reprotect.png)
