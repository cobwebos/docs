...
2. 如果配置服务器已更新到最新版本，则会看到一条通知，指出“新的 Site Recovery 复制代理更新已可用。 单击可安装。”
     ...
     ![“复制的项”窗口](.\media\site-recovery-vmware-to-azure-install-mob-svc\replicated-item-notif.png)
3. 选择通知以打开虚拟机选择页面。
4. 选择要升级移动服务的虚拟机，然后选择“确定”。

     ![“复制的项”VM 列表](.\media\site-recovery-vmware-to-azure-install-mob-svc\update-okpng.png)

将为所选的每个虚拟机启动“更新移动服务”作业。

> [!NOTE]
> [详细了解](site-recovery-vmware-to-azure-manage-configuration-server.md)如何为用于安装移动服务的帐户更新密码。
