...
**如何修复**： Azure Site Recovery 无法为存储空间直通配置创建应用程序一致的恢复点。 请参阅介绍如何正确[配置复制策略](https://docs.microsoft.com/azure/site-recovery/azure-to-azure-how-to-enable-replication-s2d-vms)的文章
