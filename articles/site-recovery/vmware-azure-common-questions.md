---
title: 有关 VMware 到 Azure 灾难恢复的常见问题 Azure Site Recovery
...
ms.locfileid: "73053682"
---
# <a name="common-questions-about-vmware-to-azure-replication"></a>有关 VMware 到 Azure 复制的常见问题
...
是的，可以在为新 VM 启用复制时将这些 VM 添加到现有复制组。 尽管如此
...
对于到 Azure 的 VMware 复制，可以修改磁盘大小。 如果要添加新磁盘，则必须添加磁盘并重新启用 VM 保护。
