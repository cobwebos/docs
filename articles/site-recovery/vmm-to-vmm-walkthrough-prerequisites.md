...
**要求** | **详细信息**
--- | ---
**Azure** | [Microsoft Azure](http://azure.microsoft.com/) 订阅。<br/><br/> 可以从 [免费试用版](https://azure.microsoft.com/pricing/free-trial/)开始。<br/><br/> [详细了解](https://azure.microsoft.com/pricing/details/site-recovery/) Site Recovery 定价。<br/><br/> 若要查看 Site Recovery 的受支持区域，请参阅 [Azure Site Recovery 定价详细信息](https://azure.microsoft.com/pricing/details/site-recovery/)中的“地域可用性”。
