---
title: "准备 Azure 资源以便使用 Azure Site Recovery 将本地物理服务器复制到 Azure | Microsoft Docs"
...
- Azure 门户中的 Site Recovery 可以使用在 [Resource Manager](../resource-manager-deployment-model.md) 或经典模式下创建的网络。
- 该网络应位于与恢复服务保管库相同的区域。
