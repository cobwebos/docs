...
在教师发起人门户或 [Azure 门户](https://portal.azure.com)中将工作或学校帐户（例如 student1@school.edu）添加为基于角色的访问控制 (RBAC) 时，Azure 会自动向收件人发送电子邮件。 此电子邮件要求用户在接收对订阅的访问权限之前接受新帐户和 Azure 角色。 如果你是课程助教 (TA) 或教授，请务必将这一点告知学生，使其订阅按预期显示在 Azure 门户中。 电子邮件应如下所示：
