...
- Api：C# Azure Functions 应用程序，该应用程序实现向静态应用提供天气信息的 API 终结点。 [`WeatherForecastFunction`](https://github.com/staticwebev/blazor-starter/blob/main/Api/WeatherForecastFunction.cs) 返回 `WeatherForecast` 对象的数组。
