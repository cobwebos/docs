...
| 状态 | 图标 | 说明 |
| --- | :----: | --- |
| 运行 | <img src= "./media/active-directory-domain-services-alerts/running-icon.png" width = "15" alt="Green check mark for running"> | Azure AD DS 托管域正在正常运行，且没有任何严重或警告警报。 域可能包含信息性警报。 |
