...
遵循[在 Azure 经典门户中创建运行 Windows 的虚拟机](../virtual-machines/windows/classic/tutorial.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json)教程中所述的说明操作。 请务必将这个新建的虚拟机加入已在其中启用了 Azure AD 域服务的同一个虚拟网络。 使用“快速创建”选项无法将虚拟机加入虚拟网络。 因此，需要使用“从库中”选项创建虚拟机。
