...
## <a name="task-5-enable-password-synchronization-to-aad-domain-services-for-a-cloudonly-azure-ad-tenant"></a>任务 5：对仅限云的 Azure AD 租户启用 AAD 域服务密码同步
...
### <a name="enable-ntlm-and-kerberos-credential-hash-generation-for-a-cloudonly-azure-ad-tenant"></a>对仅限云的 Azure AD 租户启用 NTLM 和 Kerberos 凭据哈希生成
