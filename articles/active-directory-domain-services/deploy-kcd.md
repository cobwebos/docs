---
title: Azure Active Directory 域服务：启用 Kerberos 约束委派 | Microsoft Docs
...
假设在计算机 "contoso-webapp.contoso.com" 上运行 web 应用。 它需要在域用户的上下文中访问资源 (在 "contoso-api.contoso.com" 上运行的 web API)。 下面是为此方案设置基于资源的 KCD 的方法：
