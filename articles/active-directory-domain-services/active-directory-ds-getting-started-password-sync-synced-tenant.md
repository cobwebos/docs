...
## 任务 5：对已同步的 Azure AD 租户启用 AAD 域服务的密码同步
...
推荐的版本：**1.1.281.0** — 于 2016 年 9 月 7 日发布
  ...
  > [AZURE.WARNING] 必须安装推荐的最新的 Azure AD Connect 版本，才能将旧密码凭据（NTLM 和 Kerberos 身份验证需要的）同步到 Azure AD 租户。此功能不可用于之前的 Azure AD Connect 版本或旧版的 DirSync 工具。
