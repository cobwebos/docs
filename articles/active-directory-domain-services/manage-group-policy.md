...
2. 可以自定义这些内置 GPO，以便在托管域上配置组策略。 右键单击该 GPO，并单击“编辑...”自定义内置 GPO。  可以使用组策略配置编辑器工具自定义该 GPO。
...
可以创建或导入自己的自定义组策略对象。 还可以将自定义 GPO 链接到在托管域中创建的自定义 OU。 有关创建自定义组织单位的详细信息，请参阅[在托管域中创建自定义 OU](create-ou.md)。
