...
当 Azure AD DS 托管域和虚拟网络属于两个不同的 Azure AD 租户时，会发生不匹配的目录错误。 例如，你可能有一个名为*contoso.com*的 Azure AD DS 托管域，该域在 contoso 的 Azure AD 租户中运行。 但是，托管域的 Azure 虚拟网络属于 Fabrikam Azure AD 租户。
