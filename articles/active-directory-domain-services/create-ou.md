...
当您创建和运行使用 Azure AD DS 的工作负荷时，可能需要为应用程序创建服务帐户以对其自身进行身份验证。 若要组织这些服务帐户，通常在 Azure AD DS 托管域中创建自定义 OU，然后在该 OU 中创建服务帐户。
...
1. 在左窗格中，选择 Azure AD DS 托管域，如*aaddscontoso.com*。 将显示现有 Ou 和资源的列表：
    ...
    ![在 Active Directory 管理中心中选择 Azure AD DS 托管域](./media/create-ou/create-ou-adac-overview.png)
