...
本文帮助你通过使用 Azure 经典门户为 Azure Active Directory (Azure AD) 租户启用 Azure Active Directory 域服务 (Azure AD DS)。
...
5. 要将组添加到 Azure AD 租户，请在窗口底部的任务窗格中单击“添加组”。
