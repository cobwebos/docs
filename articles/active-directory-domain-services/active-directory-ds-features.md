---
title: Azure Active Directory 域服务：功能 | Microsoft Docs
...
* **可在许多 Azure 全球区域中使用：** 请参阅“ [Azure 服务（按区域）](https://azure.microsoft.com/regions/#services/) ”页面，了解 Azure AD 域服务可用的 Azure 区域。
...
* **使用熟悉的管理工具：** 可以使用 Active Directory 管理中心或 Active Directory PowerShell 等熟悉的 Windows Server Active Directory 管理工具来管理托管域。
