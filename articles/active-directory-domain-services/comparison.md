---
title: 如何确定 Azure AD 域服务是否适合具体的用例
...
* 查看 [Azure AD 域服务的常见部署方案](scenarios.md)。
* 最后，[将 Azure AD 域服务与 DIY AD 选项进行比较](comparison.md#compare-azure-ad-domain-services-to-diy-ad-domain-in-azure)。
...
| --- |:---:|:---:|
| [**托管服务**](comparison.md#managed-service) |**&#x2713;** |**&#x2715;** |
| [**安全部署**](comparison.md#secure-deployments) |**&#x2713;** |管理员需要保护部署。 |
| [**DNS 服务器**](comparison.md#dns-server) |**&#x2713;** （托管服务） |**&#x2713;** |
| [**域管理员或企业管理员权限**](comparison.md#domain-or-enterprise-administrator-privileges) |**&#x2715;** |**&#x2713;** |
| [**域加入**](comparison.md#domain-join) |**&#x2713;** |**&#x2713;** |
| [**使用 NTLM 和 Kerberos 进行域身份验证**](comparison.md#domain-authentication-using-ntlm-and-kerberos) |**&#x2713;** |**&#x2713;** |
| [**Kerberos 约束委派**](comparison.md#kerberos-constrained-delegation)|基于资源|基于资源和基于帐户|
| [**自定义 OU 结构**](comparison.md#custom-ou-structure) |**&#x2713;** |**&#x2713;** |
| [**架构扩展**](comparison.md#schema-extensions) |**&#x2715;** |**&#x2713;** |
| [**AD 域/林信任**](comparison.md#ad-domain-or-forest-trusts) |**&#x2715;** |**&#x2713;** |
| [**LDAP 读取**](comparison.md#ldap-read) |**&#x2713;** |**&#x2713;** |
| [**安全 LDAP (LDAPS)** ](comparison.md#secure-ldap) |**&#x2713;** |**&#x2713;** |
| [**LDAP 写入**](comparison.md#ldap-write) |**&#x2715;** |**&#x2713;** |
| [**组策略**](comparison.md#group-policy) |**&#x2713;** |**&#x2713;** |
| [**地理分散的部署**](comparison.md#geo-dispersed-deployments) |**&#x2715;** |**&#x2713;** |
...
> [!NOTE]
> 可能觉得 DIY 选项更适合部署用例。 欢迎各位[分享反馈](contact-us.md)，让我们了解哪些功能可在你们今后选择 Azure AD 域服务时提供帮助。 此外，这些反馈可帮助我们改进服务，使其更好地满足部署需求，适合具体的用例。
>
>
...
* [在 Azure 虚拟机上部署 Windows Server Active Directory 的指南](/windows-server/identity/ad-ds/introduction-to-active-directory-domain-services-ad-ds-virtualization-level-100)
