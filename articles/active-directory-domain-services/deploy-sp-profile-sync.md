...
有关更多详细信息，请参阅[在 SharePoint Server 中授予 Active Directory 域服务权限以实现配置文件同步](/SharePoint/administration/user-profile-service-administration)
