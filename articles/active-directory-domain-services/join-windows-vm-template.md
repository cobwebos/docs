...
* **Azure CLI**：[安装和配置](https://azure.microsoft.com/documentation/articles/xplat-cli-install/)
...
* [Azure PowerShell 概述](/powershell/azure/overview)
* [Azure 快速入门模板-域加入新的 VM](https://azure.microsoft.com/resources/templates/201-vm-domain-join/)
* [Azure 快速入门模板-域加入现有 Vm](https://azure.microsoft.com/resources/templates/201-vm-domain-join-existing/)
