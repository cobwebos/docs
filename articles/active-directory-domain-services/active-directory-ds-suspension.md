...
Azure 门户中的“Azure AD DS 运行状况”页上会显示一个[警报](active-directory-ds-troubleshoot-alerts.md)，声明域已挂起。 域的状态也显示“挂起”。
...
- [解决托管域的警报](active-directory-ds-troubleshoot-alerts.md)
- [详细了解 Azure Active Directory 域服务](active-directory-ds-overview.md)
