...
> * 使用 Kubernetes 的基于角色的访问控制（RBAC）控制对资源的访问
...
2. 访问 Kubernetes API。 此访问级别通过[KUBERNETES RBAC](#use-kubernetes-role-based-access-controls-rbac) （传统）或通过将 Azure RBAC 与 AKS 集成以进行 Kubernetes 授权控制。
