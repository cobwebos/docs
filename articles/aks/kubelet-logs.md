...
在操作 AKS 群集的过程中，可能需要查看日志来排查问题。 内置到 Azure 门户是能够查看日志[AKS 主组件][aks-master-logs] or [containers in an AKS cluster][azure-container-logs]。 有时，可能需要从 AKS 节点获取 *kubelet* 日志以进行故障排除。
...
首先，与需要在其上查看 *kubelet* 日志的节点建立 SSH 连接。 此操作的详细，请参阅[通过 ssh 登录到 Azure Kubernetes 服务 (AKS) 群集节点][aks-ssh]文档。
...
如果需要从 Kubernetes 主服务器的其他疑难解答信息，请参阅[查看在 AKS 中日志的主节点的 Kubernetes][aks-master-logs]。
