...
存储类用于定义如何创建 Azure 文件共享。 在自动创建一个存储帐户[节点的资源组][node-resource-group]for use with the storage class to hold the Azure file shares. Choose of the following [Azure storage redundancy][storage-skus]有关*skuName*:
