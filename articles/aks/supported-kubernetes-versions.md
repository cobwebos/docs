...
引入新的次要版本后，将停止对最早次要版本和修补程序版本的支持。 在发布新的次要版本和即将发布版本停用之前的 30 天内通过进行公告[Azure 更新通道][azure-update-channel]。 在上例中，1.12.x 已发布，停用的版本是 1.8.g + 1.8.h。
