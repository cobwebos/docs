...
> [!NOTE]
> 从12月9日开始，2019 AKS 将转到支持最新（N）-2 版本的 Kubernetes。 此更改是为了符合 Kubernetes 版本支持的上游窗口，并确保使用最新的和最安全的版本。 若要了解更多信息，请阅读[此处的公告](https://azure.microsoft.com/updates/azure-kubernetes-service-will-be-retiring-support-for-kubernetes-versions-1-11-and-1-12/)。
...
并且 AKS 发布了 1.13. *，这意味着 1.9.* 版本（所有 1.9 版本）将被删除并且不再受支持。
...
AKS 发布了每周服务更新，该更新汇总了在[github](https://github.com/Azure/AKS/releases)上的服务上发布的新 Kubernetes 版本、服务更改和组件更新。
...
- 如果支持的 AKS 版本为 1.13.a、1.12.b+1.12.c、1.11.d+1.11.e和 1.10.f+1.10.g并且你使用 1.9.h 或 1.9.i，则你不在支持范围内。
...
可以。 但是，如果群集不使用 AKS 支持的版本之一，该群集不会涵盖在 AKS 支持策略内。 Azure 不会自动升级群集或将其删除。
