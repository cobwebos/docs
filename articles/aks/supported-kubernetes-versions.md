...
* 对于 Kubernetes 的新**次要**版本
  ...
  * Azure 支持向客户提供从公共通知日期起**30 天**的时间，以升级到受支持的次要版本。 过去30天后，需要更新次要版本以继续获得支持。
* 对于 Kubernetes 的新**修补程序**版本
  * 在发布新的修补程序版本以及升级到最新修补程序版本之前，我们会通知所有用户。
  * 删除较旧的修补程序版本后，Azure 支持向客户提供**30 天**的时间来升级到受支持的修补程序版本。 过去30天后，需要更新修补程序版本以继续获得支持。
...
如果群集超出了3个多个次要版本的支持，并发现存在安全风险，则 Azure 会联系你以主动升级你的群集。 如果你不执行进一步的操作，Azure 保留你代表你强制升级群集的权利。
