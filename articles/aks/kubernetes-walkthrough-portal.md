...
在 Azure 门户的左上角，选择“+ 创建资源” > “容器” >  “Kubernetes 服务”    。
...
2. 在“缩放”  页上，保留默认选项。 在屏幕底部，单击“下一步:身份验证”  。
3. 在“身份验证”  页上，配置以下选项：
...
在 cloud shell 中，使用 `nano` 或 `vi` 创建名为 `azure-vote.yaml` 的文件，并复制到以下 YAML 定义中：
