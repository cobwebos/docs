...
- 使用[AKS 群集凭据][aks-credentials]配置的[AKS 群集][aks-quickstart]和 @no__t
...
本文介绍了如何将 Jenkins 用作 CI/CD 解决方案的一部分。 AKS 可以与其他 CI/CD 解决方案和自动化工具（如[Azure DevOps 项目][azure-devops]或[使用 Ansible 创建 AKS 群集][aks-ansible]）集成。
