...
或者，你可以将托管标识用于权限，而不是服务主体。 托管标识比服务主体更易于管理，并且不需要更新或旋转。 有关详细信息，请参阅[使用托管标识](use-managed-identity.md)。
...
在本文中，已更新 AKS 群集本身和 AAD 集成应用程序的服务主体。 有关如何为群集中的工作负载管理标识的详细信息，请参阅 [AKS 中的身份验证和授权的最佳做法][best-practices-identity]。
