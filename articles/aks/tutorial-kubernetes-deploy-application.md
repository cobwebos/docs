---
title: "Azure 上的 Kubernetes 教程 - 部署应用程序 | Microsoft Docs"
...
若要监视进度，请将 [kubectl get service](https://kubernetes.io/docs/user-guide/kubectl/v1.7/#get) 命令与 `--watch` 参数配合使用。
...
> [缩放 Kubernetes 应用程序和基础结构](./tutorial-kubernetes-scale.md)
