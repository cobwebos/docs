...
> [!NOTE]
> 升级 AKS 群集时，不能跳过 Kubernetes 次要版本。 例如，允许在 1.8.x -> 1.9.x 或 1.9.x -> 1.10.x 之间升级，但是不允许 1.8 -> 1.10。 若要从 1.8 升级到 1.10，需要先从 1.8 升级到 1.9，然后再从 1.9 升级到 1.10
