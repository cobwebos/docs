...
在 Azure Kubernetes 服务 (AKS) 中开发和运行应用程序时，容器的安全性是需要考虑的一个重要方面。 包括过时基础映像或应用程序运行时的容器可能会带来安全风险和可能的攻击途径。 为了尽量降低这些风险，你应集成一些工具，这些工具扫描并修正容器中的问题。
