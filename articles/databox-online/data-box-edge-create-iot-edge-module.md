...
---
# <a name="develop-a-c-iot-edge-module-to-move-files-on-data-box-edge"></a>开发 c # IoT Edge 模块以在 Data Box Edge 上移动文件
...
3. 提供：
   ...
   4. 选择一个**位置**。 我们建议此位置应该与 Data Box Edge 资源的关联位置相同。
   5. 将“管理员用户”切换到“启用”。********
   6. 将 SKU 设置为“基本”****。
