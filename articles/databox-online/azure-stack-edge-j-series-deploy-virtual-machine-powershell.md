...
## <a name="create-managed-disks-from-the-vhd"></a>从 VHD 创建托管磁盘
...
## <a name="create-a-vm-image-from-the-image-managed-disk"></a>从映像托管磁盘创建 VM 映像
...
## <a name="create-vm-with-previously-created-resources"></a>创建具有以前创建的资源的 VM
