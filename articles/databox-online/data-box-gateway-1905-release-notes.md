...
- **现场可编程入口阵列（FPGA）日志记录改进**-在此版本中，我们已进行了与 FPGA 相关的日志记录和警报增强功能。 如果使用 FPGA 的 Edge 计算功能，则这是 Data Box Edge 的必需更新。 有关详细信息，请参阅如何[在 Data Box Edge 上通过 Edge 计算转换数据](data-box-edge-deploy-configure-compute-advanced.md)。
