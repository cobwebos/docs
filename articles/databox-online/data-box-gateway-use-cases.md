...
description: Azure 数据框网关，可用于将数据传输到 Azure 的虚拟设备存储解决方案描述用例
services: databox
author: alkohli
ms.service: databox
...
在开始之前，请确保正在运行 Data Box Gateway 设备。 按照[教程：准备部署 Azure Data Box Gateway](data-box-gateway-deploy-prep.md) 中详述的步骤操作，然后转到下一个教程，直到拥有一个可运行的设备。
