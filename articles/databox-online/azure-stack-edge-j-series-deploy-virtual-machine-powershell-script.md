...
ms.locfileid: "89256117"
---
# <a name="deploy-vms-on-your-azure-stack-edge-gpu-device-via-azure-powershell-script"></a>通过 Azure PowerShell 脚本在 Azure Stack Edge GPU 设备上部署 Vm
