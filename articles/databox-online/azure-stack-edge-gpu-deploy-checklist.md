...
|                                   | <li>端口1的至少1个 1-GbE RJ-45 网络电缆 </li><li> 至少1个 25-GbE SFP + 铜缆，适用于端口3、端口4、端口5或端口6</li>| 客户需要购买这些缆线。<br>有关设备网卡支持的网络电缆、交换机和收发器的完整列表，请参阅 [Cavium FastlinQ 41000 系列互操作性矩阵。](https://www.marvell.com/documents/xalflardzafh32cfvi0z/)                                                                          | 
| 设备首次连接      | 端口1具有固定 IP (192.168.100.10/24) 用于初始连接。 <li>需要使用便携式计算机直接连接到端口1，并使用 192.168.100.0/24 网络上的 IP 地址。</li><li> 使用位于以下位置的设备本地 UI： `https://192.168.100.10` 进行进一步配置。</li>|                                                                                                                   |
