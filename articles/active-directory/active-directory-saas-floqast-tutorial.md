...
4. 在搜索框中，键入“FloQast”，在结果面板中选择“FloQast”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 FloQast](./media/active-directory-saas-floqast-tutorial/tutorial_floqast_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-floqast-tutorial/tutorial_floqast_samlbase.png)

3. 在“FloQast 域和 URL”部分，如果要在 IDP 发起的模式下配置应用程序，请执行以下步骤：

    ![FloQast 域和 URL 单一登录信息](./media/active-directory-saas-floqast-tutorial/tutorial_floqast_url.png)

     在“标识符”文本框中，键入一个 URL：`https://go.floqast.com/`

4. 如果要在 SP 发起的模式下配置应用程序，请选中“显示高级 URL 设置”，并执行以下步骤：

    ![FloQast 域和 URL 单一登录信息](./media/active-directory-saas-floqast-tutorial/tutorial_floqast_url1.png)
...
5. FloQast 应用程序需要特定格式的 SAML 断言。 请为此应用程序配置以下声明。 可以在应用程序集成页的“用户属性”部分管理这些属性的值。 以下屏幕截图显示一个示例。
    ...
    ![配置单一登录属性](./media/active-directory-saas-floqast-tutorial/tutorial_floqast_attribute.png)
...
6. 在“单一登录”对话框的“用户属性”部分，按图中所示配置 SAML 令牌属性，然后执行以下步骤：
    ...
    ![配置单一登录 Add](./media/active-directory-saas-floqast-tutorial/tutorial_attribute_04.png)

    ![配置单一登录 Addattb](./media/active-directory-saas-floqast-tutorial/tutorial_attribute_05.png)
...
7. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件并执行以下步骤：
    ...
    ![证书下载链接](./media/active-directory-saas-floqast-tutorial/tutorial_floqast_certificate.png)

    a. 选中“显示高级证书签名设置”。

    ![证书断言](./media/active-directory-saas-floqast-tutorial/tutorial_floqast_certificateassertion.png)

    b. 选择“签名选项”作为“签名 SAML 响应和断言”。

8. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/active-directory-saas-floqast-tutorial/tutorial_general_400.png)
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-floqast-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-floqast-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-floqast-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-floqast-tutorial/create_aaduser_04.png)
...
2. 在应用程序列表中，选择“FloQast”。
    ...
    ![应用程序列表中的 FloQast 链接](./media/active-directory-saas-floqast-tutorial/tutorial_floqast_app.png)  
