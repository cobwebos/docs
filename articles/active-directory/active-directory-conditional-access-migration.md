...
- [Azure Active Directory 中条件访问的最佳做法](conditional-access/best-practices.md)，获取有关在组织中部署条件访问的一些指导。

- [通过 Azure Active Directory 条件访问要求特定应用必须使用 MFA](conditional-access/app-based-mfa.md)，熟悉 Azure 门户中的用户界面。
