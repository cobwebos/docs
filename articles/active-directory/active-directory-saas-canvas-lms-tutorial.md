...
4. 在“搜索框”中，键入“Canvas”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-canvas-lms-tutorial/tutorial_canvaslms_search.png)

5. 在结果面板中，选择“Canvas”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-canvas-lms-tutorial/tutorial_canvaslms_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-canvas-lms-tutorial/tutorial_canvaslms_samlbase.png)

3. 在“Canvas 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-canvas-lms-tutorial/tutorial_canvaslms_url.png)
...
4. 在“SAML 签名证书”部分中，复制证书的 THUMBPRINT 值。
    ...
    ![配置单一登录](./media/active-directory-saas-canvas-lms-tutorial/tutorial_canvaslms_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录](./media/active-directory-saas-canvas-lms-tutorial/tutorial_general_400.png)

6. 在“Canvas 配置”部分，单击“配置 Canvas”打开“配置登录”窗口。 从“快速参考”部分中复制“更改密码 URL”、“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![配置单一登录](./media/active-directory-saas-canvas-lms-tutorial/tutorial_canvaslms_configure.png) 
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-canvas-lms-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-canvas-lms-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-canvas-lms-tutorial/create_aaduser_03.png) 
...
2. 在应用程序列表中，选择“Canvas”。
    ...
    ![配置单一登录](./media/active-directory-saas-canvas-lms-tutorial/tutorial_canvaslms_app.png) 
