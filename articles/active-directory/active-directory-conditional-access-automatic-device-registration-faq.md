...
---
# <a name="automatic-device-registration-faq"></a>自动设备注册常见问题
...
**答：**目前，无法在 Azure 门户中所有已注册的设备。 可以使用 Azure PowerShell 查找所有设备。 有关详细信息，请参阅 [Get-MsolDevice](https://docs.microsoft.com/en-us/powershell/msonline/v1/get-msoldevice) cmdlet。
...
**答：**Azure 门户中的设备记录 (deviceID) 和状态必须与客户端匹配，并满足条件访问的所有评估条件。 有关详细信息，请参阅 [Azure Active Directory 设备注册入门](active-directory-conditional-access-device-registration-overview.md)。
