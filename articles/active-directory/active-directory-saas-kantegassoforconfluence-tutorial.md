...
4. 在搜索框中，键入“Kantega SSO for Confluence”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-kantegassoforconfluence-tutorial/tutorial_kantegassoforconfluence_search.png)

5. 在结果面板中，选择“Kantega SSO for Confluence”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-kantegassoforconfluence-tutorial/tutorial_kantegassoforconfluence_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-kantegassoforconfluence-tutorial/tutorial_kantegassoforconfluence_samlbase.png)
...
4. 在“SP”发起的模式下，请选中“显示高级 URL 设置”并执行以下步骤：
    ...
    ![配置单一登录](./media/active-directory-saas-kantegassoforconfluence-tutorial/tutorial_kantegassoforconfluence_url2.png)
...
6. 单击“保存”按钮。
    ...
    ![配置单一登录](./media/active-directory-saas-kantegassoforconfluence-tutorial/tutorial_general_400.png)
...
9. 下“ATLASSIAN MARKETPLACE”选项卡下，单击“查找新外接程序”。 

    ![配置单一登录](./media/active-directory-saas-kantegassoforconfluence-tutorial/addon.png)

10. 搜索“Kantega SSO for Confluence SAML Kerberos”，然后单击“安装”按钮安装新的 SAML 插件。

    ![配置单一登录](./media/active-directory-saas-kantegassoforconfluence-tutorial/addon2.png)

11. 插件安装随即开始。

    ![配置单一登录](./media/active-directory-saas-kantegassoforconfluence-tutorial/addon3.png)

12. 安装完成后。 单击“关闭”。

    ![配置单一登录](./media/active-directory-saas-kantegassoforconfluence-tutorial/addon33.png)

13. 单击“管理”。

    ![配置单一登录](./media/active-directory-saas-kantegassoforconfluence-tutorial/addon34.png)
    
14. 单击“配置”配置新的插件。

    ![配置单一登录](./media/active-directory-saas-kantegassoforconfluence-tutorial/addon35.png)

15. 也可在“用户和安全”选项卡下找到此新插件。

    ![配置单一登录](./media/active-directory-saas-kantegassoforconfluence-tutorial/addon36.png)
    
16. 在“SAML”部分中。 从“添加标识提供者”下拉菜单选择“Azure Active Directory (Azure AD)”。

    ![配置单一登录](./media/active-directory-saas-kantegassoforconfluence-tutorial/addon4.png)

17. 选择订阅级别为“基本”。

    ![配置单一登录](./media/active-directory-saas-kantegassoforconfluence-tutorial/addon5.png)       
...
21. 验证签名证书，然后单击“下一步”。
    ...
    ![配置单一登录](./media/active-directory-saas-kantegassoforconfluence-tutorial/addon9.png)
...
23. 单击“完成” 。   
    ...
    ![配置单一登录](./media/active-directory-saas-kantegassoforconfluence-tutorial/addon11.png)
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-kantegassoforconfluence-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-kantegassoforconfluence-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-kantegassoforconfluence-tutorial/create_aaduser_03.png) 
...
2. 在应用程序列表中，选择“Kantega SSO for Confluence”。
    ...
    ![配置单一登录](./media/active-directory-saas-kantegassoforconfluence-tutorial/tutorial_kantegassoforconfluence_app.png) 
