...
请注意，以下文档假设已了解如何[在旧版门户中为 Azure Active Directory 预配应用程序](develop/active-directory-how-to-integrate.md)，并且已将应用程序与 [Microsoft Identity Android SDK](https://github.com/AzureAD/azure-activedirectory-library-for-android) 集成。
...
需要使用 [Azure 经典门户](https://manage.windowsazure.com/)在应用注册中指定此重定向 URI。 有关 Azure AD 应用注册的详细信息，请参阅[与 Azure Active Directory 集成](develop/active-directory-how-to-integrate.md)。
