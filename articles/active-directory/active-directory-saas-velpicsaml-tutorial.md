...
3. **[创建 Velpic SAML 测试用户](#creating-a-velpic-saml-test-user)** -若要在链接到的 Azure AD 表示形式她的 Velpic SAML 具有 Britta 人 Simon 的副本。
...
12. 输入详细信息，如下所示：
    ...
    e.在“新建 MySQL 数据库”边栏选项卡中，接受法律条款，并单击“确定”。 从文本框复制“单一登录 URL”，然后将其粘贴到 Azure 门户中。
...
2. 在“新建用户”对话框页中，执行以下步骤。
    ...
    e.在“新建 MySQL 数据库”边栏选项卡中，接受法律条款，并单击“确定”。 其余信息为可选，可根据需要填写。
