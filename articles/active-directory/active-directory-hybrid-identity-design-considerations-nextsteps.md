...
-利用符合你的需求的特定解决方案应用方案是查看和规划部署移动设备管理基础结构的详细信息的好办法。 以下解决方案概述了多个最常见的移动设备管理方案：
...
* [管理移动设备的 Configuration Manager 2007 解决方案](https://technet.microsoft.com/library/dn508400.aspx)可帮助你管理移动设备，当你的基础结构停留在 System Center Configuration Manager 2007 时。 此解决方案介绍了如何设置运行 System Center 2012 Configuration Manager 的单个服务器，以便可以运行 Microsoft Intune 并充分利用其 MDM 功能。
...
* [Microsoft System Center](https://technet.microsoft.com/library/cc507089.aspx)解决方案可帮助你捕获并汇总有关你的基础结构、 策略、 过程和最佳实践的知识，以便你的 IT 员工可以生成可管理的系统并自动执行操作。
* [Microsoft Intune](https://technet.microsoft.com/library/jj676587.aspx)是一种基于云的设备管理服务，可帮助你管理计算机和移动设备并保护公司的信息的安全。
* [适用于 Office 365 的 MDM](https://technet.microsoft.com/library/ms.o365.cc.devicepolicy.aspx)允许你管理和保护移动设备时所连接到 Office 365 组织。 可以使用 MDM for Office 365 设置设备安全策略和访问规则，以及擦除丢失或被盗的移动设备。
