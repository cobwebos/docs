...
1. 使用组织中的全局管理员帐户登录到[Microsoft 365 管理中心](https://admin.microsoft.com)。 如果尝试删除具有初始默认域 contoso.onmicrosoft.com 的 "Contoso" 目录，请使用 UPN （如 admin@contoso.onmicrosoft.com）登录。
...
1. 使用组织中的全局管理员帐户登录到[Azure AD 管理中心](https://aad.portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/Overview)。 如果尝试删除包含初始默认域 contoso.onmicrosoft.com 的 "Contoso" 目录，请使用 UPN （如 admin@contoso.onmicrosoft.com）登录。
