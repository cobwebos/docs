...
> [!NOTE]
> 若要请求加入安全组或 Office 365 组，以及允许所有者批准或拒绝成员身份请求，用户需要 Azure Active Directory Premium （P1 或 P2）许可证。 如果没有 Azure Active Directory Premium 许可证，用户仍可在访问面板中管理他们的组，但不能在访问面板中创建需要所有者批准的组，也不能请求加入组。 
