...
这些权限是否替代 SharePoint 或 Microsoft 团队来宾设置？ | 不能。 这些现有设置仍然会控制这些应用程序中的体验和访问权限。 例如，如果您在 SharePoint 中看到问题，请仔细检查您的外部共享设置。
...
这些权限是否默认设置？ | 不能。 现有的默认权限保持不变。 您可以选择将权限设置为更严格的权限。
