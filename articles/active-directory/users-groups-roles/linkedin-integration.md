---
title: 在 Azure Active Directory 中启用领英连接集成 | Microsoft Docs
...
ms.locfileid: "44492815"
---
# <a name="linkedin-account-connections"></a>领英帐户连接

本文介绍如何在 Azure Active Directory (Azure AD) 管理中心启用或禁用租户的领英帐户连接。

> [!IMPORTANT]
> 我们目前正在推出适用于 Azure AD 租户的领英帐户连接设置。 针对你的租户推出此功能后，默认会启用此功能。 
> 
> 异常：
...
## <a name="enable-or-disable-linkedin-account-connections-for-your-tenant-in-the-azure-portal"></a>在 Azure 门户中为租户启用或禁用领英帐户连接

可以针对整个租户或者仅针对租户中的选定用户启用或禁用领英帐户连接。
...
## <a name="enable-or-disable-linkedin-account-connections-for-your-tenant-using-group-policy"></a>使用组策略中为租户启用或禁用领英帐户连接
