...
1. 在“分配许可证”页上，单击“分配选项”，这将显示我们先前选择的两个产品中包括的所有服务计划。******** 查找**Yammer 企业，** 并将其**关闭**以从产品许可证禁用该服务。 在“许可证选项”的底部单击“确定”确认操作。********
...
1. 转到**Azure 活动目录** > **组**。 选择已向其分配许可证的组。
...
1. 请参阅**Azure 活动目录** > **用户和组** > *名称* > **审核日志**下有关许可证处理的详细信息。 检查以下活动：
