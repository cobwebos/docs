...
如果更改 DNS 注册机构，不需要 Azure AD 中执行额外的配置任务。 可以继续对 Azure AD 使用该域名，而不会遇到中断。 如果将自定义域名用于 Microsoft 365、Intune 或依赖于 Azure AD 中的自定义域名的其他服务，请参阅这些服务的文档。
