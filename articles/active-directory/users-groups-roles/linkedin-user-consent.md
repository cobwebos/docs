---
title: LinkedIn数据共享和同意 - Azure 活动目录 |微软文档
...
ms.locfileid: "74025391"
---
# <a name="linkedin-account-connections-data-sharing-and-consent"></a>LinkedIn帐户连接数据共享和同意

您可以使活动目录 （Azure AD） 组织中的用户同意将其 Microsoft 工作或学校帐户与其LinkedIn帐户连接。 用户连接其帐户后，某些 Microsoft 应用和服务中提供了来自LinkedIn的信息和亮点。 用户还可以期望通过来自 Microsoft 的信息改进和丰富领英上的网络体验。
...
![在组织中实现LinkedIn集成](./media/linkedin-user-consent/display-example.png)

## <a name="enable-and-announce-linkedin-integration"></a>启用并公布领英集成

必须是 Azure Active Directory 管理员才能管理组织的设置。 可以为所有用户或一组特定用户启用它。

1. 要启用或禁用集成，请按照["同意LinkedIn Azure AD 组织集成](linkedin-integration.md)"中的步骤操作。
...
有关领英对个人数据的使用的详细信息，请参阅[领英隐私策略](https://www.linkedin.com/legal/privacy-policy)。 对于LinkedIn服务、数据传输和存储，数据可以从欧盟流向美国并返回，并且您的隐私受到保护，如[欧盟数据传输](https://www.linkedin.com/help/linkedin/answer/62533)中所述。
