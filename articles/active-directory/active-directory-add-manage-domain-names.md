...
创建目录后，初始域名（例如“contoso.onmicrosoft.com”）也是目录的主域名。 在 [Azure 经典门户](https://manage.windowsazure.com/)或其他门户（如 Office 365 管理门户）中创建新用户时，主域是新用户的默认域名。 这简化了管理员在门户中创建新用户的过程。
