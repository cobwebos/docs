...
| WritebackNotEnabled = 10 |很抱歉 <br> 你目前无法重置密码，因为管理员未为你的组织启用必要的服务。 无法采取进一步操作来解决这种情况。 请联系管理员，并请求他们检查你组织的配置。 若要了解此必要服务的详细信息，请参阅[配置密码写回](https://docs.microsoft.com/azure/active-directory/active-directory-passwords-writeback#configure-password-writeback)。 | SSPR_0010：我们检测到尚未启用密码写回。 请联系管理员，并请求他们启用密码写回。 |
...
| **错误** | 解决方案 |
| --- | --- |
| 未针对密码重置启用目录 - **管理员未启用此功能** | 将“自助密码重置已启用”标志切换为“选定”或“全部”，再单击“保存” |
...
| **错误** | 解决方案 |
| --- | --- |
| 未针对密码重置启用目录。 | 将“自助密码重置已启用”标志切换为“选定”或“全部”，再单击“保存” |
