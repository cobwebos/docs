...
6. 在搜索框中，键入“Splunk Enterprise”或“Splunk Cloud”。
...
通过将 Azure AD 中“用户名”的值分配为 Splunk Enterprise and Splunk Cloud 中“用户名”的值来建立此链接关系。
...
在本部分中，在经典门户中启用 Azure AD 单一登录，并在“Splunk Enterprise and Splunk Cloud”应用程序中配置单一登录。


**若要配置 Splunk Enterprise and Splunk Cloud 的 Azure AD 单一登录，请执行以下步骤：**

1. 在经典门户中的“Splunk Enterprise and Splunk Cloud”应用程序集成页上，单击“配置单一登录”，打开“配置单一登录”对话框。
...
3. 在“配置应用设置”对话框页上，执行以下步骤：
    ...
    ![配置单一登录](./media/active-directory-saas-splunk-enterprise-and-splunk-cloud-tutorial/tutorial_splunk_04.png) 

    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 在“登录 URL”文本框中，使用以下模式键入用户用于登录“Splunk Enterprise and Splunk Cloud”应用程序的 URL：`https://<splunkserverUrl>/en-US/app/launcher/home`
    
    b.保留“数据库类型”设置，即设置为“共享”。 在“标识符”文本框中，键入 Splunk 服务器的 URL
...
5. 若要为应用程序配置 SSO，请联系 Splunk Enterprise and Splunk Cloud 支持团队，并向其提供以下信息：
    ...
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 下载的**联合元数据**
...
1. 在 **Azure 经典门户**中，在左侧导航窗格上，单击“Active Directory”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-splunk-enterprise-and-splunk-cloud-tutorial/create_aaduser_09.png) 

2. 在“目录”列表中，选择要启用目录集成的目录。

3. 若要显示用户列表，请在顶部菜单中，单击“用户”。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-splunk-enterprise-and-splunk-cloud-tutorial/create_aaduser_03.png) 

4. 若要打开“添加用户”对话框，请在底部工具栏中单击“添加用户”。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-splunk-enterprise-and-splunk-cloud-tutorial/create_aaduser_04.png) 

5. 在“告诉我们有关此用户的信息”对话框页中，执行以下步骤： ![创建 Azure AD 测试用户](./media/active-directory-saas-splunk-enterprise-and-splunk-cloud-tutorial/create_aaduser_05.png) 
...
6.  在“用户配置文件”对话框页面上，执行以下步骤：![创建 Azure AD 测试用户](./media/active-directory-saas-splunk-enterprise-and-splunk-cloud-tutorial/create_aaduser_06.png) 
...
7. 在“获取临时密码”对话框页上，单击“创建”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-splunk-enterprise-and-splunk-cloud-tutorial/create_aaduser_07.png) 

8. 在“获取临时密码”对话框页上，执行以下步骤：

    ![创建 Azure AD 测试用户](./media/active-directory-saas-splunk-enterprise-and-splunk-cloud-tutorial/create_aaduser_08.png) 
...
### <a name="creating-an-splunk-enterprise-and-splunk-cloud-test-user"></a>创建 Splunk Enterprise and Splunk Cloud 测试用户
...
2. 在应用程序列表中，选择“Splunk Enterprise and Splunk Cloud”。
    ...
    ![配置单一登录](./media/active-directory-saas-splunk-enterprise-and-splunk-cloud-tutorial/tutorial_splunk_50.png) 
