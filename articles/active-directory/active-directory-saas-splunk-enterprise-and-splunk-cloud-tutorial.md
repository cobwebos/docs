...
- 一个 Azure AD 订阅
- 已启用 Splunk Enterprise or Splunk Cloud SSO 的订阅
...
3. 在“配置应用设置”对话框页上，执行以下步骤：
  ...
  1. 在“登录 URL”文本框中，使用以下模式键入用户用于登录“Splunk Enterprise and Splunk Cloud”应用程序的 URL：`https://<splunkserverUrl>/en-US/app/launcher/home`
  2. 在“标识符”文本框中，键入 Splunk 服务器的 URL。
  3. 在“回复 URL”文本框中，使用以下模式键入 URL：`https://<splunkserver>/saml/acs`
  4. 单击“下一步”。
...
6.  在“用户配置文件”对话框页上，执行以下步骤：
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-splunk-enterprise-and-splunk-cloud-tutorial/create_aaduser_06.png) 
...
在本部分中，通过授予 Britta Simon 访问 Splunk Enterprise and Splunk Cloud 的权限，允许她使用 Azure SSO。
