---
title: Windows 身份验证和 Azure MFA 服务器 - Azure 活动目录
...
## <a name="to-secure-an-application-with-windows-authentication-use-the-following-procedure"></a>要使用 Windows 身份验证保护应用程序，请使用以下步骤
