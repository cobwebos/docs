...
![管理你使用用户门户的 MFA 服务器帐户](./media/howto-mfaserver-deploy-userportal/portalsettings.png)
...
![使用短信的用户门户验证](./media/howto-mfaserver-deploy-userportal/text.png)
