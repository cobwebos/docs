...
当注册自助服务密码重置时，用户不能选择注册其移动应用[https://aka.ms/ssprsetup](https://aka.ms/ssprsetup)。 用户可以在上注册其移动[https://aka.ms/mfasetup](https://aka.ms/mfasetup)应用，也可以在新的安全信息注册[https://aka.ms/setupsecurityinfo](https://aka.ms/setupsecurityinfo)预览中注册。
