---
title: 开始使用基于证书的身份验证-Azure Active Directory
...
- 假设已配置一个[公钥基础结构 (PKI)](https://go.microsoft.com/fwlink/?linkid=841737) 和 [AD FS](../hybrid/how-to-connect-fed-whatis.md)。
