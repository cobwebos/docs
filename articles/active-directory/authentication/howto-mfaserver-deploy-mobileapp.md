---
title: Azure MFA 服务器移动应用 Web 服务 - Azure 活动目录
...
Microsoft Authenticator 应用提供一个附加的带外验证选项。 Azure 多重身份验证不会在登录期间向用户发送自动电话呼叫或 SMS，而是将通知推送到用户的智能手机或平板电脑上的 Microsoft 身份验证器应用。 用户只需在应用中点击 **"验证**"（或输入 PIN 并点击"身份验证"即可完成其登录。
