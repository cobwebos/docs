...
如果已启用[组合注册](https://docs.microsoft.com/azure/active-directory/authentication/concept-registration-mfa-sspr-combined)，则在 "**安全**  >  **身份验证方法**" 下会找到有关审核日志中的用户活动的信息。
