...
* **问：我能否代表用户定义密码重置数据？**
  ...
  > **答：** 能。你可以使用 Azure AD Connect、PowerShell、[Azure 门户](https://portal.azure.com)或 Office 365 管理中心实现此目的。 有关详细信息，请参阅 [Azure AD 自助密码重置使用的数据](howto-sspr-authenticationdata.md)。
  >
  >
* **问：我能否从本地同步安全问题数据？**
