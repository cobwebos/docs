...
ms.locfileid: "87027693"
---
# <a name="configure-azure-multi-factor-authentication-settings"></a>配置 Azure 多重身份验证设置

若要自定义 Azure 多重身份验证的最终用户体验，可以配置帐户锁定阈值或欺诈警报和通知等设置的选项。 某些设置直接存在于 Azure Active Directory （Azure AD）的 Azure 门户中，某些设置在单独的 Azure 多重身份验证门户中。
