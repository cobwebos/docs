...
2. 浏览到“Azure Active Directory” > “MFA 服务器” > “欺诈警报”。
   ...
   ![打开欺诈警报](./media/howto-mfa-mfasettings/fraudalert.png)
...
2. 浏览到“Azure Active Directory” > “MFA 服务器” > “免验证一次”。
   ...
   ![创建免验证一次](./media/howto-mfa-mfasettings/onetimebypass.png)
...
2. 浏览到“Azure Active Directory” > “MFA 服务器” > “缓存规则”。
   ...
   ![设置缓存规则](./media/howto-mfa-mfasettings/cachingrules.png)
...
![通过服务设置启用受信任 IP](./media/howto-mfa-mfasettings/trustedips3.png)
...
* 某些高级体系结构要求使用组合凭据进行客户端双重验证。 凭据可以包括工作或学校帐户的用户名和密码以及应用密码。 要求取决于如何执行身份验证。 对于针对本地基础结构进行身份验证的客户端，需要使用工作或学校帐户用户名和密码。 对于针对 Azure AD 进行身份验证的客户端，需要使用应用密码。
  ...
  * 使用 Azure 多重身份验证。
  ...
  ![在联合组织中使用应用密码](./media/howto-mfa-mfasettings/federated.png)
...
5. 在“服务设置”页上，选择“允许用户创建应用密码，以登录非浏览器应用”选项。
   ...
   ![允许用户创建应用密码](./media/howto-mfa-mfasettings/trustedips3.png)
...
5. 在“服务设置”页上的“管理记住多重身份验证设置”下，选择“允许用户在其信任的设备上记住多重身份验证”选项。
   ...
   ![为受信任的设备记住多重身份验证](./media/howto-mfa-mfasettings/remember.png)
...
![为受信任的设备选择“不再询问”](./media/howto-mfa-mfasettings/trusted.png)
