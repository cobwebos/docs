...
1. 为帐户启用手机登录。
  ...
  - 如果还没有 Microsoft Authenticator 应用，请按照 [Microsoft Authenticator 页](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md)中步骤安装和添加 Microsoft 个人帐户。 新添加的帐户会自动启用，因此请放心执行后续操作。
...
如果有关于此应用的常见问题，请参阅 [Microsoft Authenticator 常见问题解答](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-faq.md)
