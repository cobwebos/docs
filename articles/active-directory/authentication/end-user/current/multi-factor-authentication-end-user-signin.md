...
了解如何[管理双重验证设置](../../../../multi-factor-authentication/end-user/multi-factor-authentication-end-user-manage-settings.md)。

了解如何[开始使用 Microsoft 验证器应用](../../../../multi-factor-authentication/end-user/microsoft-authenticator-app-how-to.md)，以便使用通知（而不是短信和电话呼叫）登录。
