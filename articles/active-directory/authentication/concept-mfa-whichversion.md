...
description: 通过询问自己想要保护什么以及用户的位置，选择适合多重身份验证安全解决方案。
...
| Azure AD 和使用 DirSync、Azure AD Sync、Azure AD Connect 的本地 AD - 没有密码哈希同步或直通身份验证 |● |● |
| Azure AD 和使用 DirSync、Azure AD Sync、Azure AD Connect 的本地 AD - 包含密码哈希同步或直通身份验证 |● | |
| 本地 Active Directory | |● |
