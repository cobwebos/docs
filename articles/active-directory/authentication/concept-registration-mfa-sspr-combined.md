...
本文概述了安全注册的组合。 要开始使用组合安全注册，请参阅以下文章：

> [!div class="nextstepaction"]
> [启用组合安全注册](howto-registration-mfa-sspr-combined.md)
...
要开始，请参阅[启用自助服务密码重置](tutorial-enable-sspr.md)和[启用 Azure 多重身份验证 的](tutorial-enable-azure-mfa.md)教程。
