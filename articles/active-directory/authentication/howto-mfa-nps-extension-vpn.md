...
如需针对多重身份验证配置用户的帮助，请参阅文章[如何对用户或组要求双重验证](howto-mfa-userstates.md)和[为双重验证设置帐户](../../multi-factor-authentication/end-user/multi-factor-authentication-end-user-first-time.md)
