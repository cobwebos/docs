...
3. **[创建 ThousandEyes 测试用户](#creating-a-thousandeyes-test-user)** -若要在 ThousandEyes 链接到用户的 Azure AD 表示具有 Britta 人 Simon 的副本。
...
11. 在“设置单一登录”部分中，执行以下步骤：
    ...
    b. 在“登录页 URL”文本框中，粘贴从 Azure 门户复制的“SAML 单一登录服务 URL”值。
...
**要将用户帐户预配到 ThousandEyes，请执行以下步骤：**
