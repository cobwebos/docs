...
4. 在搜索框中，键入“ThousandEyes”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-thousandeyes-tutorial/tutorial_thousandeyes_search.png)

5. 在结果面板中，选择“ThousandEyes”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-thousandeyes-tutorial/tutorial_thousandeyes_addfromgallery.png)
...
3. **[创建 ThousandEyes 测试用户](#creating-a-thousandeyes-test-user)** - 以在 ThousandEyes 中具有对应的 Britta Simon 用户，该用户与 Azure AD 中表示 Britta Simon 的用户相关联。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-thousandeyes-tutorial/tutorial_thousandeyes_samlbase.png)

3. 在“ThousandEyes 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-thousandeyes-tutorial/tutorial_thousandeyes_url.png)

    在“登录 URL”文本框中，键入 URL `https://app.thousandeyes.com/login/sso`

4. 在“SAML 签名证书”部分中，单击“证书(Base64)”，然后在计算机上保存证书文件。

    ![配置单一登录](./media/active-directory-saas-thousandeyes-tutorial/tutorial_thousandeyes_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录](./media/active-directory-saas-thousandeyes-tutorial/tutorial_general_400.png)

6. 在“ThousandEyes 配置”部分中，单击“配置 ThousandEyes”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![配置单一登录](./media/active-directory-saas-thousandeyes-tutorial/tutorial_thousandeyes_configure.png) 
...
11. 在“设置单一登录”部分中，执行以下步骤：
    ...
    b.在“磁贴徽标”下面，选择“删除上传的徽标”。 在“登录页 URL”文本框中，粘贴从 Azure 门户复制的“SAML 单一登录服务 URL”值。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-thousandeyes-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-thousandeyes-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-thousandeyes-tutorial/create_aaduser_03.png) 

4. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-thousandeyes-tutorial/create_aaduser_04.png) 
...
5. 在“添加用户和帐户”部分中，执行以下步骤：
    ...
    a.在“横幅徽标”下面，选择“删除上传的徽标”。 在“名称”文本框中，键入用户名（如 Britta Simon）。

    b.在“磁贴徽标”下面，选择“删除上传的徽标”。 在“电子邮件地址”文本框中，键入用户的电子邮件地址（如 brittasimon@contoso.com）。
   
    b.在“磁贴徽标”下面，选择“删除上传的徽标”。 单击“将新用户添加到帐户”。
...
2. 在应用程序列表中，选择“ThousandEyes”。
    ...
    ![配置单一登录](./media/active-directory-saas-thousandeyes-tutorial/tutorial_thousandeyes_app.png) 
