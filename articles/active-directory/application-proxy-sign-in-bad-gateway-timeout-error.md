...
作为第一个快捷步骤，仔细检查并通过“企业应用程序”打开此应用程序，并选择“应用程序代理”菜单来修复内部 URL。 确认内部 URL 正确，即用于从本地网络访问应用程序的 URL。
...
4.  此处，有几种方法可进一步深入探讨：
  ...
  * 调查非活动连接器：如果连接器显示为非活动，它将无法访问服务。 这通常是因为某些必需的端口遭到阻止。 若要解决此问题，则继续“验证所有必需端口都已列入允许列表”。
