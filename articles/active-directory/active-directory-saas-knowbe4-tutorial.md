...
4. 在搜索框中，键入“KnowBe4 安全意识培训”。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-KnowBe4-tutorial/tutorial_knowbe4sat_search.png)

5. 在结果窗格中，选择“KnowBe4 安全意识培训”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-KnowBe4-tutorial/tutorial_knowbe4sat_addfromgallery.png)
...
3. **[创建 KnowBe4 安全意识培训测试用户](#creating-a-knowbe4-security-awareness-training-test-user)** - 在 KnowBe4 安全意识培训中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-KnowBe4-tutorial/tutorial_knowbe4sat_samlbase.png)

3. 在“KnowBe4 安全意识培训域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-KnowBe4-tutorial/tutorial_knowbe4sat_url.png)

    在“登录 URL”文本框中，使用以下模式键入 URL：`https://<companyname>.KnowBe4.com/auth/saml/<instancename>`

    > [!NOTE] 
    > 此值不是真实值。 请使用实际登录 URL 更新此值。 请联系 [KnowBe4 安全意识培训客户端支持团队](mailto:support@KnowBe4.com)获取此值。 
 

4. 在“SAML 签名证书”部分中，单击“证书(原始)”，然后在计算机上保存证书文件。

    ![配置单一登录](./media/active-directory-saas-KnowBe4-tutorial/tutorial_knowbe4sat_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录](./media/active-directory-saas-KnowBe4-tutorial/tutorial_general_400.png)

6. 在“KnowBe4 安全意识培训配置”部分中，单击“配置 KnowBe4 安全意识培训”，打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![配置单一登录](./media/active-directory-saas-KnowBe4-tutorial/tutorial_knowbe4sat_configure.png) 
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-KnowBe4-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-KnowBe4-tutorial/create_aaduser_02.png) 
...
### <a name="creating-a-knowbe4-security-awareness-training-test-user"></a>创建 KnowBe4 安全意识培训测试用户
...
2. 在应用程序列表中，选择“KnowBe4 安全意识培训”。
    ...
    ![配置单一登录](./media/active-directory-saas-KnowBe4-tutorial/tutorial_knowbe4sat_app.png) 
