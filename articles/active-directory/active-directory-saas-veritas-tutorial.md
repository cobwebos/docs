...
3. **[创建 Veritas 企业 Vault.cloud SSO 测试用户](#creating-a-veritas-enterprise-vaultcloud-sso-test-user)** -若要链接到用户的 Azure AD 表示 Veritas 企业 Vault.cloud sso 具有 Britta 人 Simon 的副本。
