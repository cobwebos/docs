...
4. 在搜索框中，键入“Fuse”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_001.png)

5. 在结果窗格中，选择“Fuse”，然后单击“添加”按钮添加该应用程序。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_01.png)
...
5. 在“创建新证书”对话框中，单击日历图标，然后选择“到期日期”。 然后单击“保存”按钮。
    ...
    ![配置单一登录](./media/active-directory-saas-fuse-tutorial/tutorial_general_300.png)
...
7. 在弹出的“滚动更新证书”窗口中，单击“确定”。
    ...
    ![配置单一登录](./media/active-directory-saas-fuse-tutorial/tutorial_general_400.png)

8. 在“SAML 签名证书”部分中，单击“证书(原始)”，然后在计算机上保存证书文件。

    ![配置单一登录](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_05.png) 

9. 在“Fuse 配置”部分，单击“配置 Fuse”打开“配置登录”窗口。

    ![配置单一登录](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_06.png) 

    ![配置单一登录](./media/active-directory-saas-fuse-tutorial/tutorial_fuse_07.png)
...
2. 转到“用户和组”，单击“所有用户”显示用户列表。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-fuse-tutorial/create_aaduser_02.png) 
