...
4. 在搜索框中，键入“HPE SaaS”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-hpesaas-tutorial/tutorial_hpesaas_search.png)

5. 在结果面板中，选择“HPE SaaS”，并单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-hpesaas-tutorial/tutorial_hpesaas_addfromgallery.png)
...
3. **[创建 HPE SaaS 测试用户](#creating-an-hpe-saas-test-user)** - 在 HPE SaaS 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-hpesaas-tutorial/tutorial_hpesaas_samlbase.png)

3. 在“HPE SaaS 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-hpesaas-tutorial/tutorial_hpesaas_url.png)
...
4. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![配置单一登录](./media/active-directory-saas-hpesaas-tutorial/tutorial_hpesaas_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录](./media/active-directory-saas-hpesaas-tutorial/tutorial_general_400.png)

6. 若要在 **HPE SaaS** 端配置单一登录，需将下载的**元数据 XML** 发送给 [HPE SaaS 支持团队](https://saas.hpe.com/en-us/contact)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-hpesaas-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-hpesaas-tutorial/create_aaduser_02.png) 
...
2. 在应用程序列表中，选择“HPE SaaS”。
    ...
    ![配置单一登录](./media/active-directory-saas-hpesaas-tutorial/tutorial_hpesaas_app.png) 
