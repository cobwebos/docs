...
3. **[创建 Dow Jones Factiva 测试用户](#creating-a-dow-jones-factiva-test-user)** - 在 Dow Jones Factiva 中创建 Britta Simon 的对应用户，该用户与 Azure AD 中表示 Britta Simon 的用户相关联。
...
6. 若要在 Dow Jones Factiva 端配置单一登录，需要将下载的元数据 XML 发送给 [Dow Jones Factiva 支持团队](https://www.dowjones.com/contact/)。 他们会对此进行设置，使 SAML SSO 连接在两端均正确设置。
