...
12. 选择“应用注册”。
   ...
   ![选择“应用注册”](./media/application-proxy-ping-access/app-registrations.png)

13. 选择刚添加的应用，并选择“回复 URL”。

   ![选择“回复 URL”](./media/application-proxy-ping-access/reply-urls.png)
...
1. 在应用设置边栏选项卡中，选择“属性”。 
  ...
  ![选择“属性”](./media/application-proxy-ping-access/properties.png)

2. 保存“应用程序 ID”值。 配置 PingAccess 时，此值将用作客户端 ID。
3. 在应用设置边栏选项卡中，选择“密钥”。

  ![选择“密钥”](./media/application-proxy-ping-access/Keys.png)
...
5. 选择“保存”。 一个 GUID 随即出现在“值”字段中。
  ...
  ![新建密钥](./media/application-proxy-ping-access/create-keys.png)
