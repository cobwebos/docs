...
- **面向 IT 管理员。** Azure AD 使用了更强大的标识管理，并且可以通过单一登录 (SSO) 来访问数千个[基于云的 SaaS 应用](active-directory-saas-tutorial-list.md)和本地应用，为你的组织提供更安全的解决方案。 通过这些应用，你还会实现基于云的应用安全性、无缝访问、增强的协作，并可自动完成员工的标识生命周期，从而增强安全性和符合性。
