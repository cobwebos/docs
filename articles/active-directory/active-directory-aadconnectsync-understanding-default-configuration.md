...
由于这是一条现成的规则，因此在打开该规则时将看到警告。你不应该[对现成规则进行任何更改](active-directory-aadconnectsync-best-practices-changing-default-configuration.md)，因此系统会询问你的意图为何。在本例中，你只想要查看规则，因此请选择“否”。
