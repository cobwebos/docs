...
本部分的目的是基于名为“Britta Simon”的测试用户展示如何配置并测试 Namely 的 Azure AD 单一登录。
...
本部分的目的是在 Azure 经典门户中启用 Azure AD 单一登录并在 Namely 应用程序中配置单一登录。 
...
3. 在“配置应用设置”对话框页上，执行以下步骤：
    ...
    a. 在“登录 URL”文本框中，键入用户用来登录 Namely 应用程序的 URL（例如：*https://fabrikam.Namely.com/*）。
...
本部分的目的是通过向 Britta Simon 授予对 Namely 的访问权限，使她能够使用 Azure 单一登录。
