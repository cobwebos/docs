...
首先，在[应用注册门户](https://apps.dev.microsoft.com)中创建应用，或者遵循以下[详细步骤](active-directory-v2-app-registration.md)。请确保：
...
有关 REST API 工作方式的讨论到此为止。你可以自由摸索代码，但是如果想要深入了解如何使用 Azure AD 保护 Web API，请参阅[此文](active-directory-v2-devquickstarts-dotnet-api.md)。
