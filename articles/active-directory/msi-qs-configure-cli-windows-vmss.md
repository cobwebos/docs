...
1. 如果在本地控制台中使用 Azure CLI，首先请使用 [az login](/cli/azure/#az_login) 登录到 Azure。 使用与要在其下部署虚拟机规模集的 Azure 订阅关联的帐户：
...
1. 如果在本地控制台中使用 Azure CLI，首先请使用 [az login](/cli/azure/#az_login) 登录到 Azure。 使用与包含虚拟机规模集的 Azure 订阅关联的帐户。
