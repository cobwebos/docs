...
请遵循以下步骤，从任何工作或学校帐户登录屏幕更改工作或学校帐户密码。
 ...
 4. 选择重置密码的选项。依据管理员配置系统的方式，你可能会看到以下一个或多个选项：
	 ...
	 * **向我的移动电话发短信** - 将包含 6 位数代码的短信发送到你的**移动电话**或**身份验证电子邮件**（由你选择）。
	 * **呼叫我的移动电话** - 拨打你的**移动电话**或**身份验证电话**（由你选择）- 按 *#* 键确认呼叫。
	 * **呼叫我的办公电话** - 拨打你的**办公电话** - 按 *#* 键确认呼叫。
	 * **回答安全提示问题** - 显示预先注册要回答的安全提示问题。

    ![][003]
	 
 5. 我们使用“向我的移动电话发短信”选项作为示例。如果你使用基于电话的选项，则在我们发送短信之前，你需要确认电话号码。请输入完整电话号码，然后单击“下一步”确认号码正确，然后发送短信。
