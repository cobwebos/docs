...
要使用 Azure 门户管理设备，这些设备需要[已注册或已加入](device-management-introduction.md#getting-devices-under-the-control-of-azure-ad) Azure AD。 作为管理员，可以通过配置设备设置来微调注册和加入设备的过程。 
...
- **用户可将设备加入 Azure AD** - 可通过此设置选择可以[将设备加入](device-management-introduction.md#azure-ad-joined-devices) Azure AD 的用户。 默认值为“全部”。
