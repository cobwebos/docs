...
- Windows 7 或更高版本上的 Internet Explorer 8、9 和 10（另请参阅 [IE 扩展部署指南](active-directory-saas-ie-group-policy.md)）
...
*	Azure AD 支持自动预配和取消预配 [Azure Active Directory 应用程序库](http://azure.microsoft.com/zh-cn/marketplace/active-directory/all/)中所有“特色”应用。
