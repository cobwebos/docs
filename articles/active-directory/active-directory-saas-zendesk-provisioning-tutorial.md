...
4. 在搜索框中，键入“Zendesk”。
    ...
    ![Zendesk 预配](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk6.png)

5. 在结果面板中，选择“Zendesk”，然后单击“添加”按钮将 Zendesk 添加到 SaaS 应用程序列表。

    ![Zendesk 预配](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk7.png)

    ![Zendesk 预配](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk20.png)
...
> [!TIP]
> 还可选择按照 [Zendesk 单一登录教程](active-directory-saas-zendesk-tutorial.md)中提供的说明为 Zendesk 启用基于 SAML 的单一登录。 可以独立于自动用户预配配置单一登录，尽管这两个功能互相补充。
...
2. 从 SaaS 应用程序列表中选择 Zendesk。
    ...
    ![Zendesk 预配](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk3.png)

3. 选择“预配”选项卡。
    
    ![Zendesk 预配](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk16.png)
...
6. Zendesk 帐户的“机密令牌”位于“管理”>“API”>“设置”中。 
    ...
    ![Zendesk 预配](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk4.png) ![Zendesk Provisioning](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk2.png)

7. 填入步骤 5 中所示的字段后，单击“测试连接”以确保 Azure AD 可以连接到 Zendesk。 如果连接失败，请确保 Zendesk 帐户具有管理员权限，然后重试。

    ![Zendesk 预配](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk19.png)
    
8. 在“通知电子邮件”字段中，输入应接收预配错误通知的个人或组的电子邮件地址，并选中复选框“发生故障时发送电子邮件通知”。

    ![Zendesk 预配](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk9.png)

9. 单击“ **保存**”。

10. 在“映射”部分下，选择“将 Azure Active Directory 用户同步到 Zendesk”。

    ![Zendesk 预配](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk10.png)

11. 在“属性映射”部分中，查看从 Azure AD 同步到 Zendesk 的用户属性。 选为“匹配”属性的特性用于匹配 Zendesk 中的用户帐户以执行更新操作。 选择“保存”按钮以提交任何更改。

    ![Zendesk 预配](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk11.png)

12. 在“映射”部分下，选择“将 Azure Active Directory 组同步到 Zendesk”。

    ![Zendesk 预配](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk12.png)

13. 在“属性映射”部分中，查看从 Azure AD 同步到 Zendesk 的组属性。 选为“匹配”属性的特性用于匹配 Zendesk 中的组以执行更新操作。 选择“保存”按钮以提交任何更改。

    ![Zendesk 预配](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk13.png)
...
15. 若要为 Zendesk 启用 Azure AD 预配服务，请在“设置”部分中将“预配状态”更改为“启用”。
    ...
    ![Zendesk 预配](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk14.png)

16. 通过在“设置”部分的“范围”中选择所需的值，定义要预配到 Zendesk 的用户和/或组。

    ![Zendesk 预配](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk15.png)

17. 已准备好预配时，单击“保存”。

    ![Zendesk 预配](./media/active-directory-saas-zendesk-provisioning-tutorial/ZenDesk18.png)
