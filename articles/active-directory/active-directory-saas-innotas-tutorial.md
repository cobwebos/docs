...
## <a name="enabling-the-application-integration-for-innotas"></a>为 Innotas 启用应用程序集成
本部分的目的是概述如何为 Innotas 启用应用程序集成。

### <a name="to-enable-the-application-integration-for-innotas-perform-the-following-steps"></a>若要为 Innotas 启用应用程序集成，请执行以下步骤：
...
5. 在“要执行什么操作”对话框中，单击“从库中添加应用程序”。
   ...
   ![从库中添加应用程序](./media/active-directory-saas-innotas-tutorial/IC749322.png "Add an application from gallerry")
6. 在搜索框中，键入“Innotas”。
...
3. 在“配置应用 URL”页上的“Innotas 登录 URL”文本框中，使用模式“*https://\<tenant-name\>.Innotas.com*”键入 URL，然后单击“下一步”。
   ...
   ![配置应用 URL](./media/active-directory-saas-innotas-tutorial/IC777336.png "Configure app URL")
...
### <a name="to-assign-users-to-innotas-perform-the-following-steps"></a>若要将用户分配到 Innotas，请执行以下步骤：
