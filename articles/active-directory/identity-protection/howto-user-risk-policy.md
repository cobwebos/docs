---
title: 如何在 Azure Active Directory Identity Protection 中配置用户风险策略| Microsoft Docs
description: 了解如何配置 Azure AD Identity Protection 用户风险策略。
