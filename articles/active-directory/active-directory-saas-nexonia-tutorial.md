...
4. 在搜索框中，键入“Nexonia”，在结果面板中选择“Nexonia”，然后单击“添加”按钮添加应用程序。
    ...
    ![结果列表中的 Nexonia](./media/active-directory-saas-nexonia-tutorial/tutorial_nexonia_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-nexonia-tutorial/tutorial_nexonia_samlbase.png)

3. 在“Nexonia 域和 URL”部分中，执行以下步骤：

    ![Nexonia 域和 URL 单一登录信息](./media/active-directory-saas-nexonia-tutorial/tutorial_nexonia_url.png)
...
4. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。
    ...
    ![证书下载链接](./media/active-directory-saas-nexonia-tutorial/tutorial_nexonia_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/active-directory-saas-nexonia-tutorial/tutorial_general_400.png)

6. 在“Nexonia 配置”部分中，单击“配置 Nexonia”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![Nexonia 配置](./media/active-directory-saas-nexonia-tutorial/tutorial_nexonia_configure.png) 
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-nexonia-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-nexonia-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-nexonia-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-nexonia-tutorial/create_aaduser_04.png)
...
2. 在应用程序列表中，选择“Nexonia”。
    ...
    ![应用程序列表中的 Nexonia 链接](./media/active-directory-saas-nexonia-tutorial/tutorial_nexonia_app.png)  
