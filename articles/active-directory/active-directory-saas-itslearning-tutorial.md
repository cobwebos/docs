...
4. 在搜索框中，键入“itslearning”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-itslearning-tutorial/tutorial_itslearning_search.png)

5. 在结果面板中，选择“itslearning”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-itslearning-tutorial/tutorial_itslearning_addfromgallery.png)
...
3. [创建 itslearning 测试用户](#creating-an-itslearning-test-user) - 在 itslearning 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
3. 在“itslearning 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-itslearning-tutorial/tutorial_itslearning_url.png)

    a.在“横幅徽标”下面，选择“删除上传的徽标”。 在“登录 URL”文本框中，键入 URL：
    | |
    |--| 
    | `https://www.itslearning.com/index.aspx`|
    | `https://us1.itslearning.com/index.aspx`|

    b.在“磁贴徽标”下面，选择“删除上传的徽标”。 在“标识符”文本框中，键入 URL：`urn:mace:saml2v2.no:services:com.itslearning`
...
6. 若要在 itslearning 端配置单一登录，需要将下载的元数据 XML 发送给 [itslearning 支持团队](mailto:support@itslearning.com)。 他们会对此进行设置，使 SAML SSO 连接在两端均正确设置。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-itslearning-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-itslearning-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-itslearning-tutorial/create_aaduser_03.png) 

4. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-itslearning-tutorial/create_aaduser_04.png) 
...
单击访问面板中的“itslearning”磁贴时，应显示 itslearning 应用程序的登录页。 单击“使用 Windows Azure ACS1 登录”即可成功登录到应用程序。
  ...
  ![登录](./media/active-directory-saas-itslearning-tutorial/login.png)
