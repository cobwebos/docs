...
4. 在搜索框中，键入“RealtimeBoard”，在结果面板中选择“RealtimeBoard”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 RealtimeBoard](./media/active-directory-saas-realtimeboard-tutorial/tutorial_realtimeboard_addfromgallery.png)
...
3. **[创建 RealtimeBoard 测试用户](#create-a-realtimeboard-test-user)** - 在 RealtimeBoard 中创建 Britta Simon 的对应用户，将其链接到该用户的 Azure AD 表示形式。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-realtimeboard-tutorial/tutorial_realtimeboard_samlbase.png)

3. 在“RealtimeBoard 域和 URL”部分中，如果要在“IDP”启动的模式下配置应用程序，请执行以下步骤：

    ![RealtimeBoard 域和 URL 单一登录信息](./media/active-directory-saas-realtimeboard-tutorial/tutorial_realtimeboard_url.png)

    在“标识符”文本框中，键入 URL：`https://realtimeboard.com/`

4. 如果要在“SP”发起的模式下配置应用程序，请选中“显示高级 URL 设置”：

    ![配置单一登录](./media/active-directory-saas-realtimeboard-tutorial/tutorial_realtimeboard_url2.png)

    在“登录 URL”文本框中，键入 URL `https://realtimeboard.com/sso/saml`

5. 在“SAML 签名证书”部分中，单击“元数据 XML”，然后在计算机上保存元数据文件。

    ![证书下载链接](./media/active-directory-saas-realtimeboard-tutorial/tutorial_realtimeboard_certificate.png) 
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-realtimeboard-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-realtimeboard-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-realtimeboard-tutorial/create_aaduser_03.png)
...
2. 在应用程序列表中，选择“RealtimeBoard”。
    ...
    ![应用程序列表中的 RealtimeBoard 链接](./media/active-directory-saas-realtimeboard-tutorial/tutorial_realtimeboard_app.png)  
