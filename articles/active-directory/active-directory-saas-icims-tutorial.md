---
title: "教程：Azure Active Directory 与 ICIMS 集成 | Microsoft Docs"
...
本教程的目的是说明如何将 ICIMS 与 Azure Active Directory (Azure AD) 集成。

将 ICIMS 与 Azure AD 集成提供以下优势：

* 可在 Azure AD 中控制谁有权访问 ICIMS
* 可以让用户使用其 Azure AD 帐户自动登录到 ICIMS 单一登录 (SSO)
...
## <a name="add-icims-from-the-gallery"></a>从库中添加 ICIMS
若要配置 ICIMS 与 Azure AD 的集成，需要从库中将 ICIMS 添加到托管 SaaS 应用列表。
...
6. 在搜索框中，键入“ICIMS”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-icims-tutorial/tutorial_icims_01.png)
7. 在结果窗格中，选择“ICIMS”，然后单击“完成”以添加该应用程序。
   
    ![创建 Azure AD 测试用户](./media/active-directory-saas-icims-tutorial/tutorial_icims_02.png)

## <a name="configure-and-test-azure-ad-sso"></a>配置和测试 Azure AD SSO
本部分旨在说明如何基于名为“Britta Simon”的测试用户配置和测试 ICIMS 的 Azure AD SSO。

若要运行 SSO，Azure AD 需要知道与 Azure AD 用户相对应的 ICIMS 用户。 换句话说，需要在 Azure AD 用户与 ICIMS 中相关用户之间建立链接关系。  

通过将 Azure AD 中“用户名”的值分配为 ICIMS 中“用户名”的值来建立此链接关系。

若要使用 ICIMS 配置和测试 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configuring-azure-ad-single-single-sign-on)** - 让用户能够使用此功能。
2. **[创建 Azure AD 测试用户](#creating-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
3. **[创建 ICIMS 测试用户](#creating-a-icims-test-user)** - 在 ICIMS 中创建 Britta Simon 的对应者，链接到她的 Azure AD 表示形式。
4. **[分配 Azure AD 测试用户](#assigning-the-azure-ad-test-user)** - 让 Britta Simon 使用 Azure AD 单一登录。
5. **[测试单一登录](#testing-single-sign-on)** - 验证配置是否正常工作。

### <a name="configure-azure-ad-sso"></a>配置 Azure AD SSO
本部分旨在介绍如何在 Azure 经典门户中启用 Azure AD SSO 并在 ICIMS 应用程序中配置 SSO。

**若要使用 ICIMS 配置 Azure AD 单一登录，请执行以下步骤：**

1. 在 Azure 经典门户中的“ICIMS”应用程序集成页上，单击“配置单一登录”，打开“配置单一登录”对话框。
   
    ![配置单一登录][6] 
2. 在“你希望用户如何登录 ICIMS”页上，选择“Azure AD 单一登录”，然后单击“下一步”。
...
3. 在“配置应用设置”对话框页上，执行以下步骤：
  ...
  1. 在“登录 URL”文本框中，使用以下模式键入用户用于登录 ICIMS 应用程序的 URL：`https://<tenant name>.icims.com`。
  2. 单击“资源组名称” 的 Azure 数据工厂。
4. 在“配置 ICIMS 的单一登录”页上，执行以下步骤：
   
    ![配置单一登录](./media/active-directory-saas-icims-tutorial/tutorial_icims_05.png)   
  1. 单击“下载元数据”，然后在计算机上保存该文件。 
  2. 单击“资源组名称” 的 Azure 数据工厂。
5. 若要为应用程序配置 SSO，请联系 ICIMS 支持团队，并将下载的元数据文件作为附件通过电子邮件发送。 此外，请提供颁发者 URL、SAML SSO URL 和注销 URL，以便可以针对 SSO 集成配置它们。
...
1. 在 **Azure 经典门户**中，在左侧导航窗格上，单击“Active Directory”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-icims-tutorial/create_aaduser_09.png) 
2. 在“目录”列表中，选择要启用目录集成的目录。
3. 若要显示用户列表，请在顶部菜单中，单击“用户”。
   
    ![创建 Azure AD 测试用户](./media/active-directory-saas-icims-tutorial/create_aaduser_03.png) 
4. 若要打开“添加用户”对话框，请在底部工具栏中单击“添加用户”。
   
    ![创建 Azure AD 测试用户](./media/active-directory-saas-icims-tutorial/create_aaduser_04.png) 
5. 在“告诉我们有关此用户的信息”对话框页上，执行以下步骤：
   
    ![创建 Azure AD 测试用户](./media/active-directory-saas-icims-tutorial/create_aaduser_05.png) 
  1. 在“用户类型”中，选择“你的组织中的新用户”。
  2. 在“用户名”文本框中，键入“BrittaSimon”。
  3. 单击“资源组名称” 的 Azure 数据工厂。
6. 在“用户配置文件”对话框页上，执行以下步骤：
   
   ![创建 Azure AD 测试用户](./media/active-directory-saas-icims-tutorial/create_aaduser_06.png)  
...
7. 在“获取临时密码”对话框页上，单击“创建”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-icims-tutorial/create_aaduser_07.png) 
8. 在“获取临时密码”对话框页上，执行以下步骤：
   
    ![创建 Azure AD 测试用户](./media/active-directory-saas-icims-tutorial/create_aaduser_08.png)  
  1. 写下“新密码”的值。
  2. 单击“完成”。   

### <a name="create-a-icims-test-user"></a>创建 ICIMS 测试用户
本部分的目的是在 ICIMS 中创建名为“Britta Simon”的用户。 请与 ICIMS 支持团队协作，将用户添加到 ICIMS 帐户中。 

>[!NOTE]
>如果需要手动创建用户，则需要联系 ICIMS 支持团队。
> 

### <a name="assign-the-azure-ad-test-user"></a>分配 Azure AD 测试用户
本部分旨在通过授予 Britta Simon 访问 ICIMS 的权限，允许她使用 Azure SSO。

![分配用户][200] 

**若要将 Britta Simon 分配到 ICIMS，请执行以下步骤：**
...
单击访问面板中的 ICIMS 磁贴时，你应自动登录到 ICIMS 应用程序。
