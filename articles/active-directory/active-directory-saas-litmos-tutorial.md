...
4. 在搜索框中，键入“Litmos”，在结果面板中选择“Litmos”，然后单击“添加”按钮添加应用程序。
    ...
    ![结果列表中的 Litmos](./media/active-directory-saas-litmos-tutorial/tutorial_litmos_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-litmos-tutorial/tutorial_litmos_samlbase.png)
...
5. 在配置过程中，需要为 Litmos 应用程序自定义 **SAML 令牌属性**。
    ...
    ![“属性”部分](./media/active-directory-saas-litmos-tutorial/tutorial_attribute.png)
...
6. 单击“保存”按钮。
    ...
    ![配置单一登录“保存”按钮](./media/active-directory-saas-litmos-tutorial/tutorial_general_400.png)
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-litmos-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-litmos-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-litmos-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-litmos-tutorial/create_aaduser_04.png)
...
2. 在应用程序列表中，选择“Litmos”。
    ...
    ![应用程序列表中的 Litmos 链接](./media/active-directory-saas-litmos-tutorial/tutorial_litmos_app.png)  
