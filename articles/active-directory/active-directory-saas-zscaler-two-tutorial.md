...
5. 在“要执行什么操作”对话框中，单击“从库中添加应用程序”。
   ...
   ![从库添加应用程序](./media/active-directory-saas-zscaler-two-tutorial/IC749322.png "从库添加应用程序")
...
3. 在“配置应用 URL”页的“ZScaler Two 登录 URL”文本框中，键入用户登录到 ZScaler Two 应用程序时使用的 URL，然后单击“下一步”。
   ...
   ![配置应用 URL](./media/active-directory-saas-zscaler-two-tutorial/IC800204.png "配置应用 URL")
