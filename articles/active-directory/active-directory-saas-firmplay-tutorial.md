...
在本部分中，你将配置和测试 Azure AD 单一登录与 FirmPlay-基于一个名为"Britta 人 Simon"的测试用户的招聘的员工支持。
...
3. **[创建员工倡议招聘测试的用户的 FirmPlay-](#creating-a-firmplay---employee-advocacy-for-recruiting-test-user)**  -若要在 FirmPlay 具有 Britta 人 Simon 的副本： 的它招聘的员工支持链接到的 Azure AD 表示形式她。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-firmplay-tutorial/tutorial_firmplay_01.png)

3. 在“FirmPlay - Employee Advocacy for Recruiting 域和 URL”部分的“登录 URL”文本框中，使用以下模式键入 URL：`https://<your-subdomain>.firmplay.com/`

    ![配置单一登录](./media/active-directory-saas-firmplay-tutorial/tutorial_firmplay_02.png)
...
9. 在“FirmPlay - Employee Advocacy for Recruiting”部分中，单击“配置 FirmPlay - Employee Advocacy for Recruiting”打开“配置登录”对话框。
    ...
    ![配置单一登录](./media/active-directory-saas-firmplay-tutorial/tutorial_firmplay_06.png) 

    ![配置单一登录](./media/active-directory-saas-firmplay-tutorial/tutorial_firmplay_07.png)
...
1. 在 Azure 管理门户的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-firmplay-tutorial/create_aaduser_01.png) 

2. 转到“用户和组”，单击“所有用户”显示用户列表。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-firmplay-tutorial/create_aaduser_02.png) 

3. 在对话框顶部单击“添加”，打开“用户”对话框。
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-firmplay-tutorial/create_aaduser_03.png) 
...
2. 在应用程序列表中，选择“FirmPlay - Employee Advocacy for Recruiting”。
    ...
    ![配置单一登录](./media/active-directory-saas-firmplay-tutorial/tutorial_firmplay_50.png) 
