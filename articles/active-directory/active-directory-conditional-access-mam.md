...
- 如何[配置条件访问策略](conditional-access/app-based-mfa.md)。

- [迁移条件访问策略](conditional-access/best-practices.md#policy-migration)。
...
若要了解如何配置条件访问策略，请参阅[通过 Azure Active Directory 条件访问要求特定应用必须使用 MFA](conditional-access/app-based-mfa.md)。
