...
3. **[创建 MOVEit 传送-Azure AD 集成测试用户](#create-a-moveit-transfer---azure-ad-integration-test-user)** -若要在 MOVEit 传输-链接到用户的 Azure AD 表示的 Azure AD 集成具有 Britta 人 Simon 的副本。
