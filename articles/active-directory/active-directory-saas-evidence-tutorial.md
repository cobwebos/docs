...
4. 在搜索框中，键入“Evidence.com”，在结果面板中选择“Evidence.com”，然后单击“添加”按钮添加该应用程序。

    ![结果列表中的 Evidence.com](./media/active-directory-saas-evidence-tutorial/tutorial_evidence.com_addfromgallery.png)
...
3. **[创建 Evidence.com 测试用户](#create-a-evidencecom-test-user)** - 在 Evidence.com 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-evidence-tutorial/tutorial_evidence.com_samlbase.png)

3. 在“Evidence.com 域和 URL”部分中，执行以下步骤：

    ![Evidence.com 域和 URL 单一登录信息](./media/active-directory-saas-evidence-tutorial/tutorial_evidence.com_url.png)
...
4. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。
    ...
    ![证书下载链接](./media/active-directory-saas-evidence-tutorial/tutorial_evidence.com_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/active-directory-saas-evidence-tutorial/tutorial_general_400.png)

6. 在“Evidence.com 配置”部分中，单击“配置 Evidence.com”以打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![Evidence.com 配置](./media/active-directory-saas-evidence-tutorial/tutorial_evidence.com_configure.png) 

7. 在另一个 Web 浏览器窗口中，以管理员身份登录到 Evidence.com 租户，然后导航到“管理”选项卡。

8. 单击“代理单一登录”

9. 选择“基于 SAML 的单一登录”

10. 将 Azure 门户中显示的“SAML 实体 ID”、“SAML 单一登录服务 URL”和“注销 URL”值复制到 Evidence.com 中的对应字段。

11. 在记事本中打开下载的“证书(Base64)”文件，将其内容复制到剪贴板，然后将其粘贴到“安全证书”框中。 

12. 在 Evidence.com 中保存配置。
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-evidence-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-evidence-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-evidence-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-evidence-tutorial/create_aaduser_04.png)
...
2. 在应用程序列表中，选择“Evidence.com”。

    ![应用程序列表中的 Evidence.com 链接](./media/active-directory-saas-evidence-tutorial/tutorial_evidence.com_app.png)  
