...
5. 在“要执行什么操作”对话框中，单击“从库中添加应用程序”。
    ...
    ![应用程序][4]
6. 在搜索框中，键入“BGS Online”。
   
    ![创建 Azure AD 测试用户](./media/active-directory-saas-bgsonline-tutorial/tutorial_bgsonline_01.png)
7. 在结果窗格中，选择“BGS Online”，然后单击“完成”以添加该应用程序。
...
1. 在经典门户中的“BGS Online”应用程序集成页上，单击“配置单一登录”，打开“配置单一登录”对话框。
    ...
    ![配置单一登录][6] 
2. 在“你希望用户如何登录 BGS Online”页上，选择“Azure AD 单一登录”，然后单击“下一步”。
   
    ![配置单一登录](./media/active-directory-saas-bgsonline-tutorial/tutorial_bgsonline_03.png) 
...
1. 在 **Azure 经典门户**中，在左侧导航窗格上，单击“Active Directory”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-bgsonline-tutorial/create_aaduser_09.png) 
...
2. 在应用程序列表中，选择“BGS Online”。
    ...
    ![配置单一登录](./media/active-directory-saas-bgsonline-tutorial/tutorial_bgsonline_50.png) 
3. 在顶部菜单中，单击“用户”。
