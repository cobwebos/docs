...
- **[Azure Active Directory 中的设备管理简介](device-management-introduction.md)** - 此文章概述了可以用来将设备置于组织控制下的各种选项。 
...
在环境中配置基于设备的条件访问策略之前，应该参阅 [Azure Active Directory 中的条件访问最佳做法](conditional-access/best-practices.md)。
