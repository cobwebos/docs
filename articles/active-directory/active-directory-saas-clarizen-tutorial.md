...
3. **[创建 Clarizen 测试用户](#create-a-clarizen-test-user)**，在 Clarizen 中创建 Britta Simon 的对应用户，将其链接到她的 Azure AD 表示形式。
...
3. 在“Clarizen 域和 URL”部分中，执行以下步骤：
    ...
    > [!NOTE]
    > 这些不是实际值。 必须使用实际的标识符和回复 URL。 此处，我们建议你使用唯一的字符串值作为标识符。 若要获取实际值，请与 [Clarizen 支持团队](https://success.clarizen.com/hc/en-us/requests/new)联系。

4. 在“SAML 签名证书”部分中，单击“创建新证书”。

    ![单击“创建新证书”](./media/active-directory-saas-clarizen-tutorial/tutorial_clarizen_03.png)     

5. 在“创建新证书”对话框中，单击日历图标，然后选择一个到期日期。 然后单击“保存”。
...
11. 单击你的用户名，然后单击“设置”。
    ...
    ![单击你的用户名下的“设置”](./media/active-directory-saas-clarizen-tutorial/tutorial_clarizen_001.png "设置")
...
1. 在 Azure 门户中，打开应用程序视图，浏览到目录视图，单击“企业应用程序”，然后单击“所有应用程序”。
