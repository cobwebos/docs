...
> [!TIP]
> 在 Azure AD 中注册任何应用程序可以使用 v2.0 终结点，即使他们不在个人帐户登录。  这样一来，您可以将迁移到 2.0 版的现有应用程序和[MSAL](reference-v2-libraries.md)而无需重新创建你的应用程序。  
...
如果已准备好查看部分示例请求，请从下列教程之一开始。 每个教程对应一种特定的身份验证方案。 如果在确定适当的流时需要帮助，请查看[可使用 v2.0 构建的应用类型](v2-app-types.md)。
