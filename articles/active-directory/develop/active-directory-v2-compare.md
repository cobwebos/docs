---
title: "Azure AD v2.0 终结点 | Microsoft Docs"
...
v2.0 终结点允许开发人员编写可接受使用单一身份验证终结点同时从 Microsoft 帐户和 Azure AD 帐户登录的应用。  这样，你就可以编写完全不可认知帐户的应用；可以忽略用户登录时所用的帐户类型。  当然，*可以*让应用知道特定会话中所使用的帐户类型，但不必这么做。
