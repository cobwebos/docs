...
v2.0 终结点颁发的令牌中的声明与正式发布的 Azure AD 终结点颁发的令牌不会完全相同。 要迁移到新服务的应用不应当假定特定的声明将存在于 id_tokens 或 access_tokens 中。 若要了解 v2.0 令牌中发出的特定声明，请参阅 [v2.0 令牌参考](active-directory-v2-tokens.md)。
