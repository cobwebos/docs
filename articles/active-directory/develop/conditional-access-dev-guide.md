...
条件性访问策略不仅可应用于应用，还可应用于应用访问的 Web API。 若要详细了解如何配置条件访问策略，请参阅[快速入门：要求使用 Azure Active Directory 条件访问对特定应用进行 MFA](../conditional-access/app-based-mfa.md)。
