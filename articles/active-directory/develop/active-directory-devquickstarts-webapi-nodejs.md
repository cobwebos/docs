...
本教程的范围包括有关保护 API 终结点的注意事项。 本文未涉及有关登录和保留身份验证令牌的注意事项，这些问题由客户端应用程序负责。 有关客户端实现的详细信息，请查看[使用 Azure AD 进行 Node.js Web 应用登录和注销](quickstart-v1-openid-connect-code.md)。
...
> [使用 Azure AD 进行 Node.js Web 应用登录和注销](quickstart-v1-openid-connect-code.md)