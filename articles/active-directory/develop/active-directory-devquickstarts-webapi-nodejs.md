---
title: "Azure AD NodeJS 入门 | Microsoft Docs"
...
ms.openlocfilehash: 8096a0f8c3797d7945a274e79ed253896a0fdab2


---
# <a name="getting-started-with-web-api-for-node"></a>节点 WEB API 入门
...
若要使用本示例，你需要一个 Azure Active Directory 租户。 如果不确定什么是租户或者如何获取租户，请参阅[如何获取 Azure AD 租户](active-directory-howto-tenant.md)。
...
5. 根据提示创建一个新的 **Web 应用程序和/或 WebAPI**。
  ...
  * “登录 URL”是应用的基本 URL。  示例代码的默认值是 `https://localhost:8080`。
...
7. 从“设置”页为应用创建“密钥”，并复制该密钥。  稍后您将需要它。
...
> [!NOTE]
> 本演练假定用户为 MongoDB 使用默认的安装与服务器终结点，在编写本文时，该终结点为：mongodb://localhost
> 
> 
...
## <a name="congratulations-you-have-a-rest-api-service-using-oauth2"></a>祝贺你！ 你已经创建了一个使用 OAuth2 的 REST API 服务！
