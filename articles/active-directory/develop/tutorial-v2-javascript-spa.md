---
title: Azure AD v2.0 JavaScript 单页面应用程序 (SPA) 设置向导
...
> [!NOTE]
> *Msal.js* 面向 Microsoft 标识平台终结点，个人帐户以及学校和工作帐户可通过该终结点登录并获取令牌。 Microsoft 标识平台终结点有[一些限制](azure-ad-endpoint-comparison.md#limitations)。
