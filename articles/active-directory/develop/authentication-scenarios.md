...
* 开发人员可以使用开源 Azure AD 身份验证库处理协议细节，方便你进行身份验证。 有关详细信息，请参阅 Azure AD [v2.0 身份验证库](reference-v2-libraries.md)和 [v1.0 身份验证库](active-directory-authentication-libraries.md)。
