---
title: "Azure AD v2.0 终结点的更改 | Microsoft Docs"
...
与 `profile_info` 相似，我们同时也从响应中删除 `id_token_expires_in` 参数。  以前，v2.0 终结点会返回 `id_token_expires_in` 的值以及每个 id_token 响应，例如在授权响应中：
