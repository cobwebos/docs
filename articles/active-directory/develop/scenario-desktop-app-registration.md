...
- 如果要使用设备代码流，则尚无法使用其 Microsoft 个人帐户登录用户。
...
- 如果为 macOS 构建本机 Objective-C 或 Swift 应用，请基于应用程序的捆绑标识符以以下格式注册重定向 URI：msauth.<your.app.bundle.id>：//auth.将<your.app.bundle.id>替换为应用程序的捆绑标识符。
