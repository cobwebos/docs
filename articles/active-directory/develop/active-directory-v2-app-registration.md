...
首先，导航到 [https://apps.dev.microsoft.com/?deeplink=/appList](https://apps.dev.microsoft.com/?referrer=https://azure.microsoft.com/documentation/articles&deeplink=/appList)。  这是新的应用注册门户，可供你管理 Microsoft 应用。
...
现在你已有一个 Microsoft 应用，可以完成我们的 v2.0 快速入门教程之一了。  以下是一些建议：
