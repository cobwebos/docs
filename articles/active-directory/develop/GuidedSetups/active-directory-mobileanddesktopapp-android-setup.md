...
> 想要改为下载此示例的 Android Studio 项目？ [下载项目](https://github.com/Azure-Samples/active-directory-android-native-v2/archive/master.zip)并跳到[配置](#create-an-application-express)步骤，在执行前配置代码示例。
