...
按 `F5` 在 Visual Studio 中运行项目。 浏览器将打开 http://localhost:{端口} 并将你重定向到该网址，其中你将看到“使用 Microsoft 登录”按钮。 继续操作并单击它以登录。
...
选择超链接，查看用户的声明。 这将你引至控制器和视图，仅供通过身份验证的用户访问。
...
#### <a name="expected-results"></a>预期结果
应收到提示，要求你进行身份验证以查看视图。

## <a name="additional-information"></a>其他信息

<!--start-collapse-->
### <a name="protect-your-entire-web-site"></a>保护整个网站
若要保护你的整个网站，请在 `Global.asax` `Application_Start` 方法中将 `AuthorizeAttribute` 添加到 `GlobalFilters`：
