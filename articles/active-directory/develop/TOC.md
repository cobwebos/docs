...
## [身份验证方案](active-directory-authentication-scenarios.md)
...
## [开发人员指南](active-directory-developers-guide.md)
## [OAuth2 隐式授权](active-directory-dev-understanding-oauth2-implicit-grant.md)
## [Azure AD 中的应用程序](active-directory-how-applications-are-added.md)
...
# 如何
## [获取租户](active-directory-howto-tenant.md)
## [将任何 Azure AD 用户登录](active-directory-devhowto-multi-tenant-overview.md)
## [集成应用](active-directory-integrating-applications.md)
## 启用 SSO
...
## [了解应用清单](active-directory-application-manifest.md)
## [对 Web 用户进行身份验证](active-directory-java-authenticate-users-access-control-eclipse.md)
## 使用 SAML
...
## [使用签名密钥滚动更新](active-directory-signing-key-rollover.md)


## 使用 V2 终结点
### [概述](active-directory-appmodel-v2-overview.md)
### [V2 有何不同？](active-directory-v2-compare.md)
...
### [注册门户](active-directory-v2-registration-portal.md)
...
#### [最新更新](active-directory-v2-preview-oidc-changes.md)
### 移动应用
...
### Web 应用和 API
#### [AngularJS 与 NodeJS](active-directory-v2-devquickstarts-angular-node.md)
#### [AngularJS 与 .NET](active-directory-v2-devquickstarts-angular-dotnet.md)
...
#### [调用 Web API](active-directory-v2-devquickstarts-webapp-webapi-dotnet.md)
### 直接与协议集成
#### [注册应用](active-directory-v2-app-registration.md)
#### [OpenID Connect](active-directory-v2-protocols-oidc.md)
#### [隐式流](active-directory-v2-protocols-implicit.md)
#### [OAuth 2.0 授权代码](active-directory-v2-protocols-oauth-code.md)
#### [OAuth 2.0 客户端凭据](active-directory-v2-protocols-oauth-client-creds.md)
#### [服务到服务调用](active-directory-protocols-oauth-service-to-service.md)

## 使用 Visual Studio
### [.NET 入门](vs-active-directory-dotnet-getting-started.md)
### [我的 MVC 项目发生了什么情况？](vs-active-directory-dotnet-what-happened.md)
