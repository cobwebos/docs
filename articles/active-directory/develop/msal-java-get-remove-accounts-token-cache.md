...
ms.locfileid: "73905506"
---
# <a name="get-and-remove-accounts-from-the-token-cache-using-msal-for-java-msal4j"></a>使用 MSAL for Java 从令牌缓存获取和删除帐户（MSAL4j）

默认情况下，MSAL4J 提供内存中的令牌缓存。 内存中令牌缓存持续时间为应用程序实例。
