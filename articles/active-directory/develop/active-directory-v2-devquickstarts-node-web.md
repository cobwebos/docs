---
title: "Azure AD v2.0 NodeJS Web 应用 | Microsoft Docs"
...
---
# <a name="add-sign-in-to-a-nodejs-web-app"></a>将登录凭据添加到 nodeJS Web 应用
> [!NOTE]
...
本教程的代码 [在 GitHub 上](https://github.com/AzureADQuickStarts/AppModelv2-WebApp-OpenIDConnect-nodejs)维护。  若要遵照该代码，可以[下载 .zip 格式的应用骨架](https://github.com/AzureADQuickStarts/AppModelv2-WebApp-OpenIDConnect-nodejs/archive/skeleton.zip)，或克隆该骨架：
...
若要参考，请在[此处查看 .zip 格式的](https://github.com/AzureADQuickStarts/AppModelv2-WebApp-OpenIDConnect-nodejs/archive/complete.zip)完整示例（不含配置值），也可从 GitHub 克隆该示例：
