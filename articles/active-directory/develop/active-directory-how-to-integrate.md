...
ms.locfileid: "72374035"
---
# <a name="integrating-with-azure-active-directory"></a>与 Azure Active Directory 集成

[!INCLUDE [active-directory-devguide](../../../includes/active-directory-devguide.md)]

在本文中，你将了解将应用程序与 Azure Active Directory （Azure AD）集成并获取集成资源所带来的好处。 Azure AD 为组织提供适用于云应用程序的企业级标识管理。 Azure AD 集成可以简化用户登录体验，并帮助应用程序符合 IT 策略。
