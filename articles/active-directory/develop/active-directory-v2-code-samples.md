...
> [!NOTE]
> 如果对 V1 示例感兴趣，请参阅 [Azure AD 代码示例（V1 终结点）](active-directory-code-samples.md)。

若要了解每种示例类型的基本方案，请参阅 [Azure Active Directory v2.0 终结点的应用类型](active-directory-v2-flows.md)。
