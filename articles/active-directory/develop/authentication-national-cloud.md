...
> [!NOTE]
> [Azure AD v2.0 授权]( https://docs.microsoft.com/azure/active-directory/develop/active-directory-appmodel-v2-overview)和令牌终结点仅适用于全局服务。 国家云部署不支持它们。
