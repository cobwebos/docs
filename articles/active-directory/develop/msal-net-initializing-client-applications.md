...
同样，以下代码将实例化机密应用程序（位于 `https://myapp.azurewebsites.net`的 Web 应用），该应用程序处理来自 Microsoft Azure 公有云中用户的令牌、其工作和学校帐户，或者其个人 Microsoft 帐户。 标识提供者通过共享客户端机密标识该应用程序：
