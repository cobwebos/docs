...
* 管理员可以通过使用 [Azure 门户][AZURE-portal]的[企业应用程序](https://portal.azure.com/#blade/Microsoft_AAD_IAM/StartboardApplicationsMenuBlade/AllApps)部分删除应用程序，以撤销对这些应用程序的访问权限。
