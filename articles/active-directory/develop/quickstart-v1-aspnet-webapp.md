...
> [!NOTE]
> 本设置指南可帮助用户在 ASP.NET 应用程序中实现通过工作和学校帐户登录。 如果除了工作和学校帐户登录外，还想实现个人帐户登录，可以使用 [v2 终结点](azure-ad-endpoint-comparison.md)。 请参阅[此 v2 终结点的 ASP.NET 设置指南](tutorial-v2-asp-webapp.md)和[此文档](active-directory-v2-limitations.md)，其中讲解了 v2 终结点的当前限制。
<br/><br/>
...
<!--start-collapse-->
> [!NOTE]
> 此页以 SVG 形式添加登录按钮，背景为黑色：<br/>![使用 Microsoft 登录](./media/quickstart-v1-aspnet-webapp/aspnetsigninbuttonsample.png)<br/> 对于多个登录按钮，请转到[本页](https://docs.microsoft.com/azure/active-directory/develop/active-directory-branding-guidelines "品牌准则")。
<!--end-collapse-->
