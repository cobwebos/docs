...
| 资产                                | PNG 格式 | SVG 格式 |
| ------------------------------------ | ---------- | ---------- |
| Microsoft 徽标  | ![Microsoft 徽标 PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_MSSymbol_19.png) | ![Microsoft 徽标 SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_MSSymbol_19.svg) |
...
![Microsoft 登录红线](./media/active-directory-branding-guidelines/Sign-in-with-Microsoft-redlines.png)

若要下载官方图像以在应用中使用，请右键单击要使用的图像，然后将其保存到计算机。

| 资产                                | PNG 格式 | SVG 格式 |
| ------------------------------------ | ---------- | ---------- |
| Microsoft 登录（深色主题）  | ![登录按钮深色主题 PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark.png) | ![Microsoft 登录按钮深色主题 SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark.svg) |
| Microsoft 登录（浅色主题） | ![登录按钮浅色主题 PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light.png) | ![Microsoft 登录按钮浅色主题 SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light.svg) |
| 登录（深色主题）                 | ![登录短按钮深色主题 PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark_short.png) | ![登录短按钮深色主题 SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_dark_short.svg) |
| 登录（浅色主题）                | ![登录短按钮浅色主题 PNG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light_short.png) | ![登录短按钮浅色主题 SVG](./media/active-directory-branding-guidelines/MS-SymbolLockup_SignIn_light_short.svg) |
