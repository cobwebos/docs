---
title: 受支持的帐户类型的验证差异-Microsoft 标识平台 |Microsoft
...
| 注销 URL | 允许 http://localhost <br><br> 最大长度为 255 个字符 | 允许 http://localhost <br><br> 最大长度为 255 个字符 | <br><br> https://localhost对于 MSA， http://localhost允许，失败 <br><br> 最大长度为 255 个字符 <br><br> 不允许使用 HTTP 方案 <br><br> 不支持通配符 | 
