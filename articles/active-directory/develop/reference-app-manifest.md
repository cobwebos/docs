...
|availableToOtherTenants|布尔值|`true`|如果此值设置为 true，则应用程序可供其他租户使用。 如果设置为 false，则应用只可供它注册到的租户使用。 有关详细信息，请参阅：[如何使用多租户应用程序模式将任何 Azure Active Directory (AD) 用户登录](howto-convert-app-to-be-multi-tenant.md)。 |
...
* 有关应用程序的应用程序对象与服务主体对象之间关系的详细信息，请参阅 [Azure AD 中的应用程序对象和服务主体对象](app-objects-and-service-principals.md)。
