...
> [!NOTE]
> 我们不再支持在[应用程序注册门户](https://apps.dev.microsoft.com/?referrer=https://azure.microsoft.com/)中注册和管理聚合和 Azure AD 应用程序, 这可能是从2019开始。 建议你使用 Azure 门户中的[应用注册](https://aka.ms/appregistrations)体验来管理现有的应用程序并注册新的应用程序。
