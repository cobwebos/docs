...
4. 在搜索框中，键入“ZIVVER”，在结果面板中选择“ZIVVER”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 ZIVVER](./media/active-directory-saas-zivver-tutorial/tutorial_zivver_addfromgallery.png)
...
3. **[创建 ZIVVER 测试用户](#create-a-zivver-test-user)** - 在 ZIVVER 中创建 Britta Simon 的对应用户，将其链接到该用户的 Azure AD 表示形式。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-zivver-tutorial/tutorial_zivver_samlbase.png)

3. 在“ZIVVER 域和 URL”部分中，执行以下步骤：

    ![ZIVVER 域和 URL 单一登录信息](./media/active-directory-saas-zivver-tutorial/tutorial_zivver_url.png)

    在“标识符”文本框中，键入 URL：`https://app.zivver.com/SAML/Zivver`

4. 在“SAML 签名证书”部分中，单击“元数据 XML”，然后在计算机上保存元数据文件。

    ![证书下载链接](./media/active-directory-saas-zivver-tutorial/tutorial_zivver_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/active-directory-saas-zivver-tutorial/tutorial_general_400.png)
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-zivver-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-zivver-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-zivver-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-zivver-tutorial/create_aaduser_04.png)
...
2. 在应用程序列表中，选择“ZIVVER”。
    ...
    ![应用程序列表中的 ZIVVER 链接](./media/active-directory-saas-zivver-tutorial/tutorial_zivver_app.png)  
