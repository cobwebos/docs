...
本教程的目的是展示如何将 Fieldglass 与 Azure Active Directory (Azure AD) 进行集成。
...
6. 在搜索框中，键入 **Fieldglass**。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-fieldglass-tutorial/tutorial_fieldglass_01.png)
7. 在结果窗格中，选择“Fieldglass”，然后单击“完成”以添加该应用程序。
   
    ![在库中选择应用](./media/active-directory-saas-fieldglass-tutorial/tutorial_fieldglass_0001.png)

## <a name="configuring-and-testing-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录
本部分旨在展示如何根据名为“Britta Simon”的测试用户，配置和测试 Fieldglass 的 Azure AD 单一登录。

若要使用单一登录，Azure AD 需要知道与 Azure AD 用户相对应的 Fieldglass 用户。 换句话说，需要在 Azure AD 用户与 Fieldglass 中的相关用户间建立链接关系。

可通过将 Azure AD 中“用户名”的值分配为 Fieldglass 中“用户名”的值来建立此关联关系。
...
3. **[创建 Fieldglass 测试用户](#creating-a-fieldglass-test-user)** - 在 Fieldglass 中创建 Britta Simon 的对应用户，将其链接到其 Azure AD 表示形式。
4. **[分配 Azure AD 测试用户](#assigning-the-azure-ad-test-user)** - 让 Britta Simon 使用 Azure AD 单一登录。
5. **[测试单一登录](#testing-single-sign-on)** - 验证配置是否正常工作。

### <a name="configuring-azure-ad-single-sign-on"></a>配置 Azure AD 单一登录
此部分会在经典门户中启用 Azure AD 单一登录，并在 Fieldglass 应用程序中配置单一登录。

**若要配置 Fieldglass 的 Azure AD 单一登录，请执行以下步骤：**

1. 在经典门户中的“Fieldglass”应用程序集成页上，单击“配置单一登录”，打开“配置单一登录”对话框。
   
    ![配置单一登录][6] 
2. 在“你希望用户如何登录 Fieldglass”页上，选择“Azure AD 单一登录”，然后单击“下一步”。
...
3. 在“配置应用设置”对话框页上，执行以下步骤，然后单击“下一步”：
    ...
    a. 在“标识符”文本框中，键入 URL `https://www.fieldglass.com` 或使用以下模式：`https://<company name>.fgvms.com`
    ...
    > [!NOTE]
    > 请注意，这些不是实际值。 必须使用实际标识符和回复 URL 更新这些值。 若要获取这些值，请联系 [Fieldglass](http://www.fieldglass.com/solutions/support)。
    > 
    >
     
4. 在“配置 Fieldglass 的单一登录”页上，执行以下步骤并单击“下一步”：
...
1. 在 **Azure 经典门户**中，在左侧导航窗格上，单击“Active Directory”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-fieldglass-tutorial/create_aaduser_09.png)
...
7. 在“获取临时密码”对话框页上，单击“创建”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-fieldglass-tutorial/create_aaduser_07.png)
...
本部分的目的是在 Fieldglass 中创建名为 Britta Simon 的用户。请与 Fieldglass 支持团队合作，在 Fieldglass 帐户中添加用户。

### <a name="assigning-the-azure-ad-test-user"></a>分配 Azure AD 测试用户
本部分旨在通过授予 Britta Simon 访问 Fieldglass 的权限，允许她使用 Azure 单一登录。
