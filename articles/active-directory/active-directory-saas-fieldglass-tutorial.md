...
7. 若要在“Fieldglass”端配置单一登录，需要将下载的“证书(Base64)”和“注销 URL、SAML 实体 ID”发送给 [Fieldglass 支持团队](http://www.fieldglass.com/solutions/support) 。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
