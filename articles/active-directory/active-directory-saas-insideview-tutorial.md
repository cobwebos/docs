...
4. 在搜索框中，键入“InsideView”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-insideview-tutorial/tutorial_insideview_search.png)

5. 在结果窗格中，选择“InsideView”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-insideview-tutorial/tutorial_insideview_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-insideview-tutorial/tutorial_insideview_samlbase.png)

3. 在“InsideView 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-insideview-tutorial/tutorial_insideview_url.png)
...
4. 在“SAML 签名证书”部分中，单击“证书(原始)”，然后在计算机上保存证书文件。
    ...
    ![配置单一登录](./media/active-directory-saas-insideview-tutorial/tutorial_insideview_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录](./media/active-directory-saas-insideview-tutorial/tutorial_general_400.png)

6. 在“InsideView 配置”部分中，单击“配置 InsideView”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 单一登录服务 URL”

    ![配置单一登录](./media/active-directory-saas-insideview-tutorial/tutorial_insideview_configure.png) 
...
9. 在“添加新 SAML”部分中，执行以下步骤：
    ...
    a.在“横幅徽标”下面，选择“删除上传的徽标”。 在“STS 名称”文本框中，键入配置名称。

    b.在“磁贴徽标”下面，选择“删除上传的徽标”。 在“SamlP/WS-Fed 未经请求的终结点”文本框中，粘贴从 Azure 门户复制的 SAML 单一登录服务 URL 值。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-insideview-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-insideview-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-insideview-tutorial/create_aaduser_03.png) 

4. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-insideview-tutorial/create_aaduser_04.png) 
...
2. 在应用程序列表中，选择“InsideView”。
    ...
    ![配置单一登录](./media/active-directory-saas-insideview-tutorial/tutorial_insideview_app.png) 
