...
## <a name="enabling-the-application-integration-for-insideview"></a>为 InsideView 启用应用程序集成
本部分的目的是概述如何为 InsideView 启用应用程序集成。

### <a name="to-enable-the-application-integration-for-insideview-perform-the-following-steps"></a>若要为 InsideView 启用应用程序集成，请执行以下步骤：
...
5. 在“要执行什么操作”对话框中，单击“从库中添加应用程序”。
   ...
   ![从库中添加应用程序](./media/active-directory-saas-insideview-tutorial/IC749322.png "Add an application from gallerry")
...
3. 在“配置应用 URL”页上的“InsideView 回复 URL”文本框中，键入 InsideView SSO URL（例如：`https://my.insideview.com/iv/<STS Name>/login.iv`），然后单击“下一步”。
   ...
   ![配置应用 URL](./media/active-directory-saas-insideview-tutorial/IC794133.png "Configure App URL")
...
7. 在“添加新 SAML”部分中，执行以下步骤：
   ...
   8. 在“Crm 姓氏映射”文本框中，键入“http://schemas.xmlsoap.org/ws/2005/05/identity/claims/surname”。
   9. 单击“保存” 。
...
要使 Azure AD 用户能够登录 InsideView，必须将这些用户预配到 InsideView 中。  
对于 InsideView，预配是一项手动任务。
...
### <a name="to-assign-users-to-insideview-perform-the-following-steps"></a>若要将用户分配到 InsideView，请执行以下步骤：
