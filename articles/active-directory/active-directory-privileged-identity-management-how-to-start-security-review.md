...
![开始访问审阅 - 屏幕截图](./media/active-directory-privileged-identity-management-how-to-start-security-review/PIM_start_review.png)

### <a name="configure-the-review"></a>配置审阅
要创建访问审阅，需要为其命名并设置开始日期和结束日期。

![配置审阅 - 屏幕截图](./media/active-directory-privileged-identity-management-how-to-start-security-review/PIM_review_configure.png)
...
1. 导航到**审阅角色成员身份**
    ...
    ![审阅角色成员身份 - 屏幕截图](./media/active-directory-privileged-identity-management-how-to-start-security-review/PIM_review_role.png)
2. 从列表中选择一个角色。
...
1. 导航到**选择审阅者**
    ...
    ![选择审阅者 - 屏幕快照](./media/active-directory-privileged-identity-management-how-to-start-security-review/PIM_review_reviewers.png)
2. 选择以下选项之一：
