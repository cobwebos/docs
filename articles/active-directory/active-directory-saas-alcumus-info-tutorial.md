...
4. 在“搜索框”中，键入“Alcumus Info Exchange”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-alcumus-info-tutorial/tutorial_alcumusinfoexchange_search.png)

5. 在“结果”窗格中，选择“Alcumus Info Exchange”，然后单击“添加”按钮，添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-alcumus-info-tutorial/tutorial_alcumusinfoexchange_addfromgallery.png)
...
3. **[创建 Alcumus 信息 Exchange 测试用户](#creating-an-alcumus-info-exchange-test-user)** -若要链接到用户的 Azure AD 表示的 Alcumus 信息交换中具有 Britta 人 Simon 的副本。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-alcumus-info-tutorial/tutorial_alcumusinfoexchange_samlbase.png)

3. 在“Alcumus Info Exchange 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-alcumus-info-tutorial/tutorial_alcumusinfoexchange_url.png)
    ...
    > [!NOTE] 
    > 这些不是实际值。 使用实际标识符和回复 URL 更新这些值。 请与 [Alcumus Info Exchange 支持团队](mailto:helpdesk@alcumusgroup.com)联系以获取这些值。
 
4. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。

    ![配置单一登录](./media/active-directory-saas-alcumus-info-tutorial/tutorial_alcumusinfoexchange_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录](./media/active-directory-saas-alcumus-info-tutorial/tutorial_general_400.png)
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-alcumus-info-tutorial/create_aaduser_01.png) 
...
2. 在应用程序列表中，选择“Alcumus Info Exchange”。
    ...
    ![配置单一登录](./media/active-directory-saas-alcumus-info-tutorial/tutorial_alcumusinfoexchange_app.png) 
