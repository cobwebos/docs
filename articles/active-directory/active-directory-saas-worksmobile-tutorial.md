...
4. 在搜索框中，键入“LINE WORKS”，在结果面板中选择“LINE WORKS”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 LINE WORKS](./media/active-directory-saas-lineworks-tutorial/tutorial_lineworks_addfromgallery.png)
...
可通过将 Azure AD 中“用户名”的值指定为 LINE WORKS 中“用户名”的值来建立此链接关系。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-lineworks-tutorial/tutorial_lineworks_samlbase.png)

3. 在“LINE WORKS 域和 URL”部分中，执行以下步骤：

    ![LINE WORKS 域和 URL 单一登录信息](./media/active-directory-saas-lineworks-tutorial/tutorial_lineworks_url.png)
    ...
    > [!NOTE] 
    > 此值不是真实值。 使用实际登录 URL 更新此值。 若要获取此值，请联系 [LINE WORKS 客户端支持团队](mailto:dl_ssoinfo@worksmobile.com)。

4. 在“SAML 签名证书”部分中，单击“证书(原始)”，并在计算机上保存证书文件。

    ![证书下载链接](./media/active-directory-saas-lineworks-tutorial/tutorial_lineworks_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/active-directory-saas-lineworks-tutorial/tutorial_general_400.png)

6. 在“LINE WORKS 配置”部分中，单击“配置 LINE WORKS”以打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![LINE WORKS 配置](./media/active-directory-saas-lineworks-tutorial/tutorial_lineworks_configure.png) 

7. 若要在 **LINE WORKS** 端配置单一登录，需要将下载的**证书文件、注销 URL、SAML 实体 ID 和 SAML 单一登录服务 URL** 发送给 [LINE WORKS 支持团队](mailto:dl_ssoinfo@worksmobile.com)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-lineworks-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-lineworks-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-lineworks-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-lineworks-tutorial/create_aaduser_04.png)
...
在本部分中，将在 LINE WORKS 中创建名为 Britta Simon 的用户。 请与 [LINE WORKS 支持团队](mailto:dl_ssoinfo@worksmobile.com)协作，以在 LINE WORKS 平台中添加用户。
...
**要将 Britta Simon 分配到 LINE WORKS，请执行以下步骤：**
...
2. 在应用程序列表中，选择“LINE WORKS”。
    ...
    ![应用程序列表中的 LINE WORKS 链接](./media/active-directory-saas-lineworks-tutorial/tutorial_lineworks_app.png)  
