...
要配置 WORKS MOBILE 与 Azure AD 的集成，需要从库中将 WORKS MOBILE 添加到托管 SaaS 应用列表。
...
4. 在搜索框中键入 **WORKS MOBILE**。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-worksmobile-tutorial/tutorial_worksmobile_search.png)

5. 在结果面板中选择“WORKS MOBILE”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-worksmobile-tutorial/tutorial_worksmobile_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录
在本部分中，将基于名为“Britta Simon”的测试用户配置和测试 WORKS MOBILE 的 Azure AD 单一登录。
...
3. **[创建 WORKS MOBILE 测试用户](#creating-a-works-mobile-test-user)** - 在 WORKS MOBILE 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
4. **[分配 Azure AD 测试用户](#assigning-the-azure-ad-test-user)** - 让 Britta Simon 使用 Azure AD 单一登录。
5. **[测试单一登录](#testing-single-sign-on)** - 验证配置是否正常工作。

### <a name="configuring-azure-ad-single-sign-on"></a>配置 Azure AD 单一登录

在本部分中，将在 Azure 门户中启用 Azure AD 单一登录并在 WORKS MOBILE 应用程序中配置单一登录。

**若要配置 WORKS MOBILE 的 Azure AD 单一登录，请执行以下步骤：**

1. 在 Azure 门户的“WORKS MOBILE”应用程序集成页上，单击“单一登录”。

    ![配置单一登录][4]

2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
 
    ![配置单一登录](./media/active-directory-saas-worksmobile-tutorial/tutorial_worksmobile_samlbase.png)

3. 在“WORKS MOBILE 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-worksmobile-tutorial/tutorial_worksmobile_url.png)

    a. 在“登录 URL”文本框中，使用以下模式键入 URL：`https://<subdomain>.worksmobile.com/jp/myservice`

    b. 在“标识符”文本框中，键入 `worksmobile.com` 值。

    > [!NOTE] 
    > 此值不是真实值。 使用实际登录 URL 更新此值。 请联系 [WORKS MOBILE 客户端支持团队](mailto:dl_ssoinfo@worksmobile.com)获取此值。 
 
4. 在“SAML 签名证书”部分中，单击“证书(原始)”，并在计算机上保存证书文件。

    ![配置单一登录](./media/active-directory-saas-worksmobile-tutorial/tutorial_worksmobile_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录](./media/active-directory-saas-worksmobile-tutorial/tutorial_general_400.png)

6. 在“WORKS MOBILE 配置”部分，单击“配置 WORKS MOBILE”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![配置单一登录](./media/active-directory-saas-worksmobile-tutorial/tutorial_worksmobile_configure.png) 

7. 若要为应用程序配置 SSO，请联系 [WORKS MOBILE 支持团队](mailto:dl_ssoinfo@worksmobile.com)，并向他们提供以下信息： 
...
在本部分中，通过授予 Britta Simon 访问 WORKS MOBILE 的权限，允许她使用 Azure 单一登录。

![分配用户][200] 

**要将 Britta Simon 分配到 WORKS MOBILE，请执行以下步骤：**
...
2. 在应用程序列表中，选择“WORKS MOBILE”。
    ...
    ![配置单一登录](./media/active-directory-saas-worksmobile-tutorial/tutorial_worksmobile_app.png) 
