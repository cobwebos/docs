...
description: "可以利用 Azure Active Directory 访问评审控制组成员身份和应用程序访问权限，从而满足组织的监管、风险管理和符合性计划。"
...
- 可以使用对应用程序和组成员身份访问权限的访问评审来再次验证来宾用户的访问权限，同时为审阅者提供见解，使他们能够有效地决定来宾用户是否应具有持续的访问权限。
