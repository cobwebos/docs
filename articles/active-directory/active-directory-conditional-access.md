<properties 
	...
	description="允许从合规的已知设备对企业网络中的特定资源进行随处访问，并禁止从丢失、被盗或不合规的设备进行访问。"
...
- [Azure Active Directory Device Registration 概述](active-directory-conditional-access-device-registration-overview.md)
- [使用 Azure Active Directory Device Registration 设置本地条件性访问](active-directory-conditional-access-on-premises-setup.md)
- [Office 365 服务的条件性访问设备策略](active-directory-conditional-access-device-policies.md)
