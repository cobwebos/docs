...
4. 在搜索框中，键入“TrackVia”，在结果面板中选择“TrackVia”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 TrackVia](./media/active-directory-saas-trackvia-tutorial/tutorial_trackvia_addfromgallery.png)
...
3. **[创建 TrackVia 测试用户](#create-a-trackvia-test-user)**：在 TrackVia 中创建 Britta Simon 的对应用户，并将其关联到该用户的 Azure AD 表示形式。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-trackvia-tutorial/tutorial_trackvia_samlbase.png)

3. 在“TrackVia 域和 URL”部分中，如果要在 **IDP** 发起的模式下配置应用程序，请执行以下步骤：

    ![TrackVia 域和 URL 单一登录信息](./media/active-directory-saas-trackvia-tutorial/tutorial_trackvia_url.png)

    在“标识符”文本框中，键入值 `TrackVia`

4. 如果要在 SP 发起的模式下配置应用程序，请选中“显示高级 URL 设置”，并执行以下步骤：

    ![TrackVia 域和 URL 单一登录信息](./media/active-directory-saas-trackvia-tutorial/tutorial_trackvia_url1.png)
...
5. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![证书下载链接](./media/active-directory-saas-trackvia-tutorial/tutorial_trackvia_certificate.png) 
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-trackvia-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-trackvia-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-trackvia-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-trackvia-tutorial/create_aaduser_04.png)
...
2. 在应用程序列表中，选择“TrackVia”。
    ...
    ![应用程序列表中的 TrackVia 链接](./media/active-directory-saas-trackvia-tutorial/tutorial_trackvia_app.png)  
