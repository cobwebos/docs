...
>-	可以通过基于用户或基于身份验证的提供程序使用 Azure Multi-Factor Authentication。有关详细信息，请参阅[什么是 Azure Multi-Factor Authentication？](multi-factor-authentication.md)
...
| | [使用 UI 或 Windows PowerShell cmdlet 进行用户和组管理](active-directory-administer.md)| ![勾选标记][12]| ![勾选标记][12]| ![勾选标记][12]|
| | [设备注册](active-directory-conditional-access-device-registration-overview.md)| ![勾选标记][12]| ![勾选标记][12]| ![勾选标记][12]|
| | [访问面板门户，适合对 SaaS 和自定义应用程序进行基于 SSO 的用户访问](active-directory-saas-access-panel-introduction.md)| ![勾选标记][12] 每个用户最多 10 个应用 [2]| ![勾选标记][12] 每个用户最多 1- 个应用 [2]| ![勾选标记][12] 无应用限制|
| | [基于用户的应用程序访问管理和设置](active-directory-saas-app-provisioning.md)| ![勾选标记][12]| ![勾选标记][12]| ![勾选标记][12]|
| | 云用户的自助密码更改| ![勾选标记][12]| ![勾选标记][12]| ![勾选标记][12]|
| | [Azure AD Connect – 用于在本地目录与 Azure Active Directory 之间同步](active-directory-aadconnect.md)| ![勾选标记][12]| ![勾选标记][12]| ![勾选标记][12]|
| | [标准安全报告](active-directory-view-access-usage-reports.md)| ![勾选标记][12]| ![勾选标记][12]| ![勾选标记][12]|
| | [B2B 协作（跨组织协作）（预览版）](active-directory-b2b-collaboration-overview.md)| ![勾选标记][12]| ![勾选标记][12]| ![勾选标记][12]|
| **高级和基本版功能**| [对“登录”和“访问面板”页自定义公司徽标和颜色](active-directory-add-company-branding.md)| Office 365 订阅已随附 [4]| ![勾选标记][12]| ![勾选标记][12]|
| | [云用户的自助密码重置](active-directory-passwords.md)| Office 365 订阅已随附 [4]| ![勾选标记][12]| ![勾选标记][12]|
| | [应用程序代理：对本地 Web 应用程序进行安全远程访问和 SSO](active-directory-application-proxy-get-started.md)| | ![勾选标记][12]| ![勾选标记][12]|
| | [基于组的应用程序访问管理和设置](active-directory-accessmanagement-group-saasapps.md)| | ![勾选标记][12]| ![勾选标记][12]|
| | [高可用性 SLA 运行时间 (99.9%)](https://azure.microsoft.com/zh-CN/support/legal/sla/)| Microsoft Online Services SLA [5]| ![勾选标记][12]| ![勾选标记][12]|
| **仅限高级版的功能**| [高级应用程序使用情况报告](active-directory-view-access-usage-reports.md)| | | ![勾选标记][12]|
| | [面向云用户的自助组管理](面向 Azure AD 中用户的自助组管理)| | | ![勾选标记][12]|
| | [自助服务密码重置与本地回写](active-directory-passwords-getting-started.md/#enable-users-to-reset-or-change-their-ad-passwords)| | | ![勾选标记][12]|
...
| | [高级异常安全报告（基于机器学习）](active-directory-view-access-usage-reports.md)| | | ![勾选标记][12]|
| | [云应用发现](active-directory-cloudappdiscovery-whatis.md)| | | ![勾选标记][12]|
| | [面向云用户的 Multi-Factor Authentication 服务](multi-factor-authentication.md)| Office 365 订阅已随附 [4]| | ![勾选标记][12]|
| | [面向本地用户的 Multi-Factor Authentication 服务](multi-factor-authentication.md)| | | ![勾选标记][12]|
| | [Azure Active Directory Connect Health – 用于监视本地 Active Directory 基础结构的运行状况并获取使用情况分析](active-directory-aadconnect-health.md)| | | ![勾选标记][12]|
