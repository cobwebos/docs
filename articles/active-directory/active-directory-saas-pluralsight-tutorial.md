...
4. 在搜索框中，键入“Pluralsight”。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-pluralsight-tutorial/tutorial_pluralsight_search.png)

5. 在结果面板中，选择“Pluralsight”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-pluralsight-tutorial/tutorial_pluralsight_addfromgallery.png)
...
3. [创建 Pluralsight 测试用户](#creating-a-pluralsight-test-user) - 在 Pluralsight 中有一个与 Azure AD 中的 Britta Simon 相对应的关联用户。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-pluralsight-tutorial/tutorial_pluralsight_samlbase.png)

3. 在“Pluralsight 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-pluralsight-tutorial/tutorial_pluralsight_url.png)

    在“登录 URL”文本框中，使用以下模式键入 URL：`https://<instance name>.pluralsight.com/sso/<company name>`

    > [!NOTE] 
    > 此值不是真实值。 请使用实际登录 URL 更新此值。 请联系 [Pluralsight 客户端支持团队](mailto:support@pluralsight.com)获取此值。 
 


4. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。

    ![配置单一登录](./media/active-directory-saas-pluralsight-tutorial/tutorial_pluralsight_certificate.png) 
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-pluralsight-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-pluralsight-tutorial/create_aaduser_02.png) 
...
2. 在应用程序列表中，选择“Pluralsight”。
    ...
    ![配置单一登录](./media/active-directory-saas-pluralsight-tutorial/tutorial_pluralsight_app.png) 
...
单击访问面板中的“Pluralsight”磁贴时，用户就会自动登录到 Pluralsight 应用程序。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](active-directory-saas-access-panel-introduction.md)（访问面板简介）。
