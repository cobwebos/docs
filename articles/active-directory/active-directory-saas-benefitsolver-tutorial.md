...
4. 在搜索框中，键入“Benefitsolver”，在结果面板中选择“Benefitsolver”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 Benefitsolver](./media/active-directory-saas-benefitsolver-tutorial/tutorial_benefitsolver_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-benefitsolver-tutorial/tutorial_benefitsolver_samlbase.png)

3. 在“Benefitsolver 域和 URL”部分中，执行以下步骤：

    ![Benefitsolver 域和 URL 单一登录信息](./media/active-directory-saas-benefitsolver-tutorial/tutorial_benefitsolver_url.png)
...
4. Benefitsolver 应用程序需要特定格式的 SAML 断言，这要求将自定义属性映射添加到 **SAML 令牌属性**配置。
    ...
    ![Benefitsolver 属性部分](./media/active-directory-saas-benefitsolver-tutorial/tutorial_attribute.png)
...
5. 在“单一登录”对话框的“用户属性”部分，按图中所示配置 SAML 令牌属性，然后执行以下步骤：
    ...
    ![Benefitsolver 属性部分](./media/active-directory-saas-benefitsolver-tutorial/tutorial_attribute_04.png)
    
    ![Benefitsolver 属性部分](./media/active-directory-saas-benefitsolver-tutorial/tutorial_attribute_05.png)
...
7. 单击“保存”按钮。
    ...
    ![配置单一登录“保存”按钮](./media/active-directory-saas-benefitsolver-tutorial/tutorial_general_400.png)
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-benefitsolver-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-benefitsolver-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-benefitsolver-tutorial/create_aaduser_03.png)
...
2. 在应用程序列表中选择“Benefitsolver”。
    ...
    ![应用程序列表中的 Benefitsolver 链接](./media/active-directory-saas-benefitsolver-tutorial/tutorial_benefitsolver_app.png)  
