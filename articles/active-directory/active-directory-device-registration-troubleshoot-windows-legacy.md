...
对于 Windows 10 或 Windows Server 2016，请参阅[排查已加入 Azure AD 域的 Windows 10 和 Windows Server 2016 计算机的自动注册问题](active-directory-device-registration-troubleshoot-windows.md)。

本主题假设已根据[如何配置已加入域的 Windows 设备的 Azure Active Directory 自动注册](active-directory-device-registration-get-started.md)中所述配置了已加入域的设备的自动注册。
