...
4. 在搜索框中，键入“Kantega SSO for Bitbucket”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-kantegassoforbitbucket-tutorial/tutorial_kantegassoforbitbucket_search.png)

5. 在结果面板中，选择“Kantega SSO for Bitbucket”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-kantegassoforbitbucket-tutorial/tutorial_kantegassoforbitbucket_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-kantegassoforbitbucket-tutorial/tutorial_kantegassoforbitbucket_samlbase.png)
...
4. 在“SP”发起的模式下，请选中“显示高级 URL 设置”并执行以下步骤：
    ...
    ![配置单一登录](./media/active-directory-saas-kantegassoforbitbucket-tutorial/tutorial_kantegassoforbitbucket_url2.png)
...
6. 单击“保存”按钮。
    ...
    ![配置单一登录](./media/active-directory-saas-kantegassoforbitbucket-tutorial/tutorial_general_400.png)

7. 在另一个 Web 浏览器窗口中，以管理员身份登录到 Bitbucket 管理门户。

8. 单击齿轮，然后单击“查找新加载项”。

    ![配置单一登录](./media/active-directory-saas-kantegassoforbitbucket-tutorial/addon1.png)

9. 搜索“Kantega SSO for Bitbucket SAML & Kerberos”，然后单击“安装”按钮安装新的 SAML 插件。

    ![配置单一登录](./media/active-directory-saas-kantegassoforbitbucket-tutorial/addon2.png)

10. 插件安装随即开始。

    ![配置单一登录](./media/active-directory-saas-kantegassoforbitbucket-tutorial/addon31.png)

11. 安装完成后。 单击“关闭”。

    ![配置单一登录](./media/active-directory-saas-kantegassoforbitbucket-tutorial/addon33.png)

12. 单击“管理”。

    ![配置单一登录](./media/active-directory-saas-kantegassoforbitbucket-tutorial/addon34.png)
    
13. 单击“配置”配置新的插件。    

    ![配置单一登录](./media/active-directory-saas-kantegassoforbitbucket-tutorial/addon35.png)

14. 在“SAML”部分中。 从“添加标识提供者”下拉菜单选择“Azure Active Directory (Azure AD)”。

    ![配置单一登录](./media/active-directory-saas-kantegassoforbitbucket-tutorial/addon4.png)

15. 选择订阅级别为“基本”。

    ![配置单一登录](./media/active-directory-saas-kantegassoforbitbucket-tutorial/addon5.png)
...
19. 验证签名证书，然后单击“下一步”。  
    ...
    ![配置单一登录](./media/active-directory-saas-kantegassoforbitbucket-tutorial/addon9.png)
...
21. 单击“完成” 。
    ...
    ![配置单一登录](./media/active-directory-saas-kantegassoforbitbucket-tutorial/addon11.png)
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-kantegassoforbitbucket-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-kantegassoforbitbucket-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-kantegassoforbitbucket-tutorial/create_aaduser_03.png) 
...
2. 单击“设置”图标。
    ...
    ![添加员工](./media/active-directory-saas-kantegassoforbitbucket-tutorial/user1.png) 

3. 在“管理”选项卡部分下，单击“用户”。

    ![添加员工](./media/active-directory-saas-kantegassoforbitbucket-tutorial/user2.png)

4. 单击“创建用户”。

    ![添加员工](./media/active-directory-saas-kantegassoforbitbucket-tutorial/user3.png)     
...
2. 在应用程序列表中，选择“Kantega SSO for Bitbucket”。
    ...
    ![配置单一登录](./media/active-directory-saas-kantegassoforbitbucket-tutorial/tutorial_kantegassoforbitbucket_app.png) 
