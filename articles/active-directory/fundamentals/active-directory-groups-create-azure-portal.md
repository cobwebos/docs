---
title: 如何使用 Azure Active Directory 创建基本组并添成员 |Microsoft Docs
...
ms.locfileid: "45574906"
---
# <a name="how-to-create-a-basic-group-and-add-members-using-azure-active-directory"></a>如何使用 Azure Active Directory 创建基本组并添成员
