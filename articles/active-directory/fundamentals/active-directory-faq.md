...
有关详细信息，请参阅[在云中监视本地标识基础结构和同步服务](../hybrid/whatis-azure-ad-connect.md)。  
...
有关预先集成的应用程序的完整列表，请参阅 [Active Directory 市场](https://azuremarketplace.microsoft.com/marketplace/apps/Microsoft.AzureActiveDirectory)。
...
* [Azure AD 的身份验证方案](../develop/authentication-vs-authorization.md)
* [Active Directory 身份验证协议](/previous-versions/azure/dn151124(v=azure.100))
...
有关详细信息，请参阅[使用 Azure Active Directory 自动预配和取消预配 SaaS 应用程序的用户](../app-provisioning/user-provisioning.md)。
