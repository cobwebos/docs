---
title: 存档 Azure 活动目录中的新增功能？ | Microsoft Docs
...
ms.locfileid: "81253163"
---
# <a name="archive-for-whats-new-in-azure-active-directory"></a>存档 Azure 活动目录中的新增功能？

主要内容在[Azure 活动目录中新增？ 发行说明](whats-new.md)文章包含过去六个月的更新，而本文包含所有较旧的信息。

Azure 活动目录中的新增功能是什么？发行说明提供有关：
...
从 2019 年 10 月 1 日开始，Power BI 将开始弃用所有内容包，包括 Azure AD Power BI 内容包。 作为此内容包的替代方法，可以使用 Azure AD 工作簿来深入了解 Azure AD 相关服务。 其他工作簿即将推出，包括有关仅报告模式下的条件访问策略的工作簿、基于应用同意的见解等。

有关工作簿的详细信息，请参阅[如何使用 Azure 活动目录报表的 Azure 监视器工作簿](https://docs.microsoft.com/azure/active-directory/reports-monitoring/howto-use-azure-monitor-workbooks)。 有关内容包弃用的详细信息，请参阅["宣布电源 BI 模板应用通用性](https://powerbi.microsoft.com/blog/announcing-power-bi-template-apps-general-availability/)博客文章"。

---

### <a name="my-profile-is-renaming-and-integrating-with-the-microsoft-office-account-page"></a>我的个人资料正在重命名并与 Microsoft Office 帐户页集成

**类型：** 更改计划  
**服务类别：** 我的个人资料/帐户  
**产品功能：** 协作

从 10 月开始，"我的个人资料"体验将成为我的帐户。 作为这一更改的一部分，当前显示的任何地方，"**我的个人资料**将更改为**我的帐户**"。 除了命名更改和一些设计改进外，更新后的体验还将提供与 Microsoft Office 帐户页的额外集成。 具体来说，您将能够从 **"概述帐户"** 页访问 Office 安装和订阅，以及**隐私**页面中与 Office 相关的联系人首选项。

有关"我的个人资料（预览）"体验的详细信息，请参阅["我的个人资料（预览）"门户概述](https://docs.microsoft.com/azure/active-directory/user-help/myprofile-portal-overview)。

---

### <a name="bulk-manage-groups-and-members-using-csv-files-in-the-azure-ad-portal-public-preview"></a>在 Azure AD 门户（公共预览）中使用 CSV 文件批量管理组和成员

**类型：** 新功能  
**服务类别：** 组管理  
**产品功能：** 协作

我们很高兴地在 Azure AD 门户中宣布批量组管理体验的公开预览可用性。 现在，您可以使用 CSV 文件和 Azure AD 门户来管理组和成员列表，包括：
...
### <a name="dynamic-consent-is-now-supported-through-a-new-admin-consent-endpoint"></a>动态同意现在通过新的管理员同意终结点支持

**类型：** 新功能  
**服务类别：** 身份验证（登录）  
**产品功能：** 用户身份验证

我们创建了一个新的管理员同意终结点来支持动态同意，这对想要在 Microsoft 标识平台上使用动态同意模型的应用很有帮助。

有关如何使用此新终结点的详细信息，请参阅[使用管理员同意终结点](https://docs.microsoft.com/azure/active-directory/develop/v2-admin-consent)。

---

### <a name="new-federated-apps-available-in-azure-ad-app-gallery---september-2019"></a>Azure AD 应用库中提供的新联合应用 - 2019 年 9 月

**类型：** 新功能  
**服务类别：** 企业应用  
**产品功能：** 第三方集成

2019 年 9 月，我们在应用库中添加了这 29 个具有联合支持的新应用：

[计划观察](https://schedulelook.bbsonlineservices.net/)， [MS Azure SSO 访问 Ethidex 合规办公室&trade;- 单一登录](https://docs.microsoft.com/azure/active-directory/saas-apps/ms-azure-sso-access-for-ethidex-compliance-office-tutorial)， [iServer 门户](https://docs.microsoft.com/azure/active-directory/saas-apps/iserver-portal-tutorial)， [SKYSITE，](https://docs.microsoft.com/azure/active-directory/saas-apps/skysite-tutorial) [Concur 旅行和费用](https://docs.microsoft.com/azure/active-directory/saas-apps/concur-travel-and-expense-tutorial)，[工作板](https://docs.microsoft.com/azure/active-directory/saas-apps/workboard-tutorial)， `https://apps.yeeflow.com/` [， ARC 设施](https://docs.microsoft.com/azure/active-directory/saas-apps/arc-facilities-tutorial)，[卢瓦斯特拉图斯团队](https://stratus.emea.luware.cloud/login)，[广泛的想法](https://wideideas.online/wideideas/)，[棱镜云](https://docs.microsoft.com/azure/active-directory/saas-apps/prisma-cloud-tutorial)， [JDLT 客户端中心](https://clients.jdlt.co.uk/login)， [RENRAK U，](https://docs.microsoft.com/azure/active-directory/saas-apps/renraku-tutorial) [SealPath安全浏览器](https://protection.sealpath.com/SealPathInterceptorWopiSaas/Open/InstallSealPathEditorOneDrive)，[棱镜云](https://docs.microsoft.com/azure/active-directory/saas-apps/prisma-cloud-tutorial)， `https://app.penneo.com/`， ， `https://app.testhtm.com/settings/email-integration`， ， ， ， [，](https://aec.cintoo.com/login)[白源](https://docs.microsoft.com/azure/active-directory/saas-apps/whitesource-tutorial)，[托管遗产在线 SSO](https://docs.microsoft.com/azure/active-directory/saas-apps/hosted-heritage-online-sso-tutorial)， [IDC，](https://docs.microsoft.com/azure/active-directory/saas-apps/idc-tutorial) [CakeHR，](https://docs.microsoft.com/azure/active-directory/saas-apps/cakehr-tutorial) [BIS，](https://docs.microsoft.com/azure/active-directory/saas-apps/bis-tutorial)[库凯团队建设](https://ms-contacts.coo-kai.jp/)，[声纳库比](https://docs.microsoft.com/azure/active-directory/saas-apps/sonarqube-tutorial)， [Adobe 身份管理](https://docs.microsoft.com/azure/active-directory/saas-apps/adobe-identity-management-tutorial)，[发现福利 SSO，](https://docs.microsoft.com/azure/active-directory/saas-apps/discovery-benefits-sso-tutorial) [Amelio](https://app.amelio.co/)，`https://itask.yipinapp.com/`
...
### <a name="new-azure-ad-global-reader-role"></a>新的 Azure AD 全局读取器角色

**类型：** 新功能  
**服务类别：** Rbac  
**产品功能：** 访问控制

从 2019 年 9 月 24 日开始，我们将开始推出一个名为全局读取器的新 Azure 活动目录 （AD） 角色。 此次推出将从全球云客户和全球云客户 （GCC） 开始，将于 10 月在全球完成。

全局读取器角色是全局管理员的只读对应角色。 此角色中的用户可以跨 Microsoft 365 服务读取设置和管理信息，但不能执行管理操作。 我们创建了"全球读者"角色，以帮助减少组织中的全球管理员数量。 由于全局管理员帐户功能强大且容易受到攻击，因此我们建议您拥有少于 5 个全局管理员。 我们建议使用全局阅读器角色进行规划、审核或调查。 我们还建议将全局阅读器角色与其他有限的管理员角色（如 Exchange Administrator）结合使用，以帮助完成工作，而无需全局管理员角色。

全局阅读器角色与新的 Microsoft 365 管理中心、交换管理中心、团队管理中心、安全中心、合规性中心、Azure AD 管理中心和设备管理管理中心配合使用。

>[!NOTE]
> 在公共预览开始时，全局阅读器角色将不起作用：SharePoint、特权访问管理、客户密码箱、敏感度标签、团队生命周期、团队报告&呼叫分析、团队 IP 电话设备管理和团队应用目录。 

有关详细信息，请参阅[Azure 活动目录中的管理员角色权限](https://docs.microsoft.com/azure/active-directory/users-groups-roles/directory-assign-admin-roles)。

---

### <a name="access-an-on-premises-report-server-from-your-power-bi-mobile-app-using-azure-active-directory-application-proxy"></a>使用 Azure 活动目录应用程序代理从 Power BI 移动应用访问本地报告服务器

**类型：** 新功能  
**服务类别：** 应用代理  
**产品功能：** 访问控制

Power BI 移动应用和 Azure AD 应用程序代理之间的新集成允许您安全地登录到 Power BI 移动应用并查看组织托管在本地 Power BI 报表服务器上的任何报告。

有关 Power BI 移动应用的信息（包括下载应用的位置），请参阅 Power [BI 网站](https://powerbi.microsoft.com/mobile/)。 有关如何使用 Azure AD 应用程序代理设置 Power BI 移动应用的详细信息，请参阅[使用 Azure AD 应用程序代理启用对 Power BI 移动的远程访问](https://docs.microsoft.com/azure/active-directory/manage-apps/application-proxy-integrate-with-power-bi)。

---

### <a name="new-version-of-the-azureadpreview-powershell-module-is-available"></a>AzureAD 预览电源外壳模块的新版本可用

**类型：** 已更改的功能  
**服务类别：** 其他  
**产品功能：** 目录

新 cmdlet 已添加到 AzureADPreview 模块中，以帮助定义和分配 Azure AD 中的自定义角色，包括：
...
### <a name="new-version-of-azure-ad-connect"></a>新版本的 Azure AD 连接

**类型：** 已更改的功能  
**服务类别：** 其他  
**产品功能：** 目录

我们发布了适用于自动升级客户的 Azure AD Connect 的更新版本。 此新版本包括几个新功能、改进和错误修复。 有关此新版本的详细信息，请参阅 Azure [AD 连接：版本发布历史记录](https://docs.microsoft.com/azure/active-directory/hybrid/reference-connect-version-history#14250)。

---

### <a name="azure-multi-factor-authentication-mfa-server-version-802-is-now-available"></a>Azure 多重身份验证 （MFA） 服务器，版本 8.0.2 现已推出

**类型：** 已修复  
**服务类别：** Mfa  
**产品功能：** 标识安全和保护

如果您是在 2019 年 7 月 1 日之前激活 MFA 服务器的现有客户，现在可以下载最新版本的 MFA 服务器（版本 8.0.2）。 在此新版本中，我们：

- 修复了问题，因此当 Azure AD 同步将用户从"已禁用"更改为"已启用"时，将通过电子邮件发送给该用户。

- 修复了问题，以便客户可以成功升级，同时继续使用"标记"功能。

- 添加了科索沃 （+383） 国家代码。

- 将一次性绕过审核日志记录添加到多因子AuthSvc.log 中。

- 提高了 Web 服务 SDK 的性能。

- 修复了其他小错误。

从 2019 年 7 月 1 日起，Microsoft 停止为新部署提供 MFA 服务器。 需要多重身份验证的新客户应使用基于云的 Azure 多重身份验证。 有关详细信息，请参阅[规划基于云的 Azure 多重身份验证部署](https://docs.microsoft.com/azure/active-directory/authentication/howto-mfa-getstarted)。

---

## <a name="august-2019"></a>2019 年 8 月

### <a name="enhanced-search-filtering-and-sorting-for-groups-is-available-in-the-azure-ad-portal-public-preview"></a>Azure AD 门户（公共预览版）中提供了增强的组搜索、筛选和排序功能

**类型：** 新功能  
**服务类别：** 组管理  
**产品功能：** 协作

我们很高兴地在 Azure AD 门户中宣布增强的组相关体验的公开预览可用性。 这些增强功能通过提供：
...
有关详细信息，请参阅在[Azure 门户中管理组](https://docs.microsoft.com/azure/active-directory/fundamentals/active-directory-groups-members-azure-portal?context=azure/active-directory/users-groups-roles/context/ugr-context)。

---

### <a name="new-custom-roles-are-available-for-app-registration-management-public-preview"></a>新的自定义角色可用于应用注册管理（公共预览）

**类型：** 新功能  
**服务类别：** Rbac  
**产品功能：** 访问控制

自定义角色（随 Azure AD P1 或 P2 订阅一起提供）现在可以通过允许您创建具有特定权限的角色定义，然后将这些角色分配给特定资源，从而帮助您提供细粒度访问。 目前，您通过使用管理应用注册的权限，然后将角色分配给特定应用来创建自定义角色。 有关自定义角色的详细信息，请参阅[Azure 活动目录（预览）中的自定义管理员角色](https://docs.microsoft.com/azure/active-directory/users-groups-roles/roles-custom-overview)。

如果您需要支持的其他权限或资源（您当前看不到），您可以将反馈发送到我们的[Azure 反馈网站](https://feedback.azure.com/forums/169401-azure-active-directory?category_id=166032)，我们将将您的请求添加到更新路线图中。

---

### <a name="new-provisioning-logs-can-help-you-monitor-and-troubleshoot-your-app-provisioning-deployment-public-preview"></a>新的预配日志可以帮助您监视和排除应用预配部署（公共预览）

**类型：** 新功能  
**服务类别：** 应用预配  
**产品功能：** 身份生命周期管理

新的预配日志可帮助您监视和排除用户和组预配部署。 这些新日志文件包括有关以下信息：

- 在[ServiceNow](https://docs.microsoft.com/azure/active-directory/saas-apps/servicenow-provisioning-tutorial)中成功创建哪些组
- 从亚马逊 Web[服务 （AWS）](https://docs.microsoft.com/azure/active-directory/saas-apps/amazon-web-service-tutorial#configure-and-test-azure-ad-single-sign-on-for-amazon-web-services-aws)导入的角色
- 哪些员工不是从[工作日](https://docs.microsoft.com/azure/active-directory/saas-apps/workday-inbound-tutorial)导入的

有关详细信息，请参阅[Azure 活动目录门户中的预配报表（预览）。](https://docs.microsoft.com/azure/active-directory/reports-monitoring/concept-provisioning-logs)

---

### <a name="new-security-reports-for-all-azure-ad-administrators-general-availability"></a>所有 Azure AD 管理员的新安全报告（常规可用性）

**类型：** 新功能  
**服务类别：** 身份保护  
**产品功能：** 标识安全和保护

默认情况下，所有 Azure AD 管理员将很快能够在 Azure AD 中访问现代安全报告。 在 9 月底之前，您将能够使用现代安全报告顶部的横幅返回到旧报告。

现代安全报告将提供旧版本的其他功能，包括：

- 高级筛选和排序
- 批量操作，例如消除用户风险
- 确认已泄露或安全实体
- 风险状态，涵盖范围：风险、已排除、修复和已确认已泄露
- 新的风险相关检测（适用于 Azure AD 高级订阅者）
...
### <a name="user-assigned-managed-identity-is-available-for-virtual-machines-and-virtual-machine-scale-sets-general-availability"></a>用户分配的托管标识可用于虚拟机和虚拟机规模集（通用版本）

**类型：** 新功能  
**服务类别：** Azure 资源的托管标识  
**产品功能：** 开发人员体验

用户分配的托管标识现在通常可用于虚拟机和虚拟机缩放集。 作为其中的一部分，Azure 可以在 Azure AD 租户中创建受正在使用的订阅信任的标识，并可以分配给一个或多个 Azure 服务实例。 有关用户分配的托管标识的详细信息，请参阅[Azure 资源的托管标识是什么？](https://aka.ms/azuremanagedidentity)

---

### <a name="users-can-reset-their-passwords-using-a-mobile-app-or-hardware-token-general-availability"></a>用户可以使用移动应用或硬件令牌重置其密码（通用版）

**类型：** 已更改的功能  
**服务类别：** 自助服务密码重置  
**产品功能：** 用户身份验证

已向组织注册移动应用的用户现在可以通过批准来自 Microsoft 身份验证器应用的通知或从移动应用或硬件令牌输入代码来重置自己的密码。

有关详细信息，请参阅[其工作原理：Azure AD 自助服务密码重置](https://aka.ms/authappsspr)。 有关用户体验的详细信息，请参阅[重置自己的工作或学校密码概述](https://docs.microsoft.com/azure/active-directory/user-help/user-help-password-reset-overview)。

---

### <a name="adalnet-ignores-the-msalnet-shared-cache-for-on-behalf-of-scenarios"></a>ADAL.NET忽略代表方案的MSAL.NET共享缓存

**类型：** 已修复  
**服务类别：** 身份验证（登录）  
**产品功能：** 用户身份验证

从 Azure AD 身份验证库 （ADAL.NET） 版本 5.0.0 预览开始，应用开发人员必须[为每个帐户序列化 Web 应用和 Web API 的一个缓存](https://github.com/AzureAD/azure-activedirectory-library-for-dotnet/wiki/Token-cache-serialization#custom-token-cache-serialization-in-web-applications--web-api)。 否则，使用[代流](https://docs.microsoft.com/azure/active-directory/develop/scenario-web-api-call-api-app-configuration#on-behalf-of-flow)的某些方案以及 某些特定的用例`UserAssertion`可能会导致特权的提升。 为了避免此漏洞，ADAL.NET现在忽略代表方案的 dotnet（MSAL.NET） 共享缓存的 Microsoft 身份验证库。

有关此问题的详细信息，请参阅 Azure[活动目录身份验证库提升权限漏洞](https://portal.msrc.microsoft.com/security-guidance/advisory/CVE-2019-1258)。

---

### <a name="new-federated-apps-available-in-azure-ad-app-gallery---august-2019"></a>Azure AD 应用库中提供的新联合应用 - 2019 年 8 月

**类型：** 新功能  
**服务类别：** 企业应用  
**产品功能：** 第三方集成

2019 年 8 月，我们在应用库中添加了这 26 个具有联合支持的新应用：

[公民平台](https://docs.microsoft.com/azure/active-directory/saas-apps/civic-platform-tutorial)，[亚马逊业务](https://docs.microsoft.com/azure/active-directory/saas-apps/amazon-business-tutorial)， [ProNovos 运营经理](https://docs.microsoft.com/azure/active-directory/saas-apps/pronovos-ops-manager-tutorial)， [Cognidox](https://docs.microsoft.com/azure/active-directory/saas-apps/cognidox-tutorial)， [Viareport的Inativ门户 （欧洲）](https://docs.microsoft.com/azure/active-directory/saas-apps/viareports-inativ-portal-europe-tutorial)， [Azure 数据砖](https://azure.microsoft.com/services/databricks)，[罗宾](https://docs.microsoft.com/azure/active-directory/saas-apps/robin-tutorial)，[学院出勤，](https://docs.microsoft.com/azure/active-directory/saas-apps/academy-attendance-tutorial)[优先矩阵](https://sync.appfluence.com/pmwebng/)，[库斯特 MySpace，](https://cousto.platformers.be/account/login)[上传护理](https://uploadcare.com/accounts/signup/)，[碳化物端点备份](https://docs.microsoft.com/azure/active-directory/saas-apps/carbonite-endpoint-backup-tutorial)， [CP QSync由Cincom，](https://docs.microsoft.com/azure/active-directory/saas-apps/cpqsync-by-cincom-tutorial)[收费比](https://docs.microsoft.com/azure/active-directory/saas-apps/chargebee-tutorial)，[交付.&trade;媒体门户](https://portal.deliver.media)，[前线教育](https://docs.microsoft.com/azure/active-directory/saas-apps/frontline-education-tutorial)， [F5，](https://www.f5.com/products/security/access-policy-manager)[藏匿的AD连接](https://www.stashcat.com)，[闪烁](https://docs.microsoft.com/azure/active-directory/saas-apps/blink-tutorial)，[沃科利](https://docs.microsoft.com/azure/active-directory/saas-apps/vocoli-tutorial)，[普罗沃沃斯分析](https://docs.microsoft.com/azure/active-directory/saas-apps/pronovos-analytics-tutorial)，[西格斯特](https://docs.microsoft.com/azure/active-directory/saas-apps/sigstr-tutorial)，[达尔文盒](https://docs.microsoft.com/azure/active-directory/saas-apps/darwinbox-tutorial)，[手表的颜色](https://docs.microsoft.com/azure/active-directory/saas-apps/watch-by-colors-tutorial)，[线束](https://docs.microsoft.com/azure/active-directory/saas-apps/harness-tutorial)， [EAB导航战略护理](https://docs.microsoft.com/azure/active-directory/saas-apps/eab-navigate-strategic-care-tutorial)

有关这些应用的详细信息，请参阅 [SaaS 应用程序与 Azure Active Directory 集成](https://aka.ms/appstutorial)。 要详细了解如何在 Azure AD 应用库中列出应用程序，请参阅[在 Azure Active Directory 应用程序库中列出应用程序](https://aka.ms/azureadapprequest)。

---

### <a name="new-versions-of-the-azuread-powershell-and-azureadpreview-powershell-modules-are-available"></a>AzureAD 电源外壳和 AzureAD 预览电源外壳模块的新版本可用

**类型：** 已更改的功能  
**服务类别：** 其他  
**产品功能：** 目录

AzureAD 和 AzureAD 预览电源外壳模块的新更新可用：

- AzureAD`-Filter`模块中的`Get-AzureADDirectoryRole`参数中添加了一个新参数。 此参数可帮助您筛选 cmdlet 返回的目录角色。
- 新 cmdlet 已添加到 AzureADPreview 模块中，以帮助定义和分配 Azure AD 中的自定义角色，包括：
...
我们对 Azure 门户中提供的动态组规则生成器进行了一些 UI 改进，以帮助您更轻松地设置新规则或更改现有规则。 此设计改进允许您创建最多包含五个表达式的规则，而不仅仅是一个表达式。 我们还更新了设备属性列表以删除已弃用的设备属性。

有关详细信息，请参阅[管理动态成员资格规则](https://docs.microsoft.com/azure/active-directory/users-groups-roles/groups-dynamic-membership)。

---

### <a name="new-microsoft-graph-app-permission-available-for-use-with-access-reviews"></a>新的 Microsoft 图形应用权限可用于访问审核

**类型：** 已更改的功能  
**服务类别：** 访问评论  
**产品功能：** 身份治理

我们引入了新的 Microsoft Graph 应用权限，`AccessReview.ReadWrite.Membership`它允许应用自动创建和检索组成员身份和应用分配的访问审核。 此权限可以由计划作业使用，也可以作为自动化的一部分使用，而无需登录用户上下文。

有关详细信息，请参阅[如何使用使用 PowerShell 博客使用 Microsoft 图形应用权限创建 Azure AD 访问评论的示例](https://techcommunity.microsoft.com/t5/Azure-Active-Directory/Example-how-to-create-Azure-AD-access-reviews-using-Microsoft/m-p/807241)。

---

### <a name="azure-ad-activity-logs-are-now-available-for-government-cloud-instances-in-azure-monitor"></a>Azure AD 活动日志现在可用于 Azure 监视器中的政府云实例

**类型：** 已更改的功能  
**服务类别：** 报告  
**产品功能：** 监视和报告

我们很高兴地宣布 Azure AD 活动日志现在可用于 Azure 监视器中的政府云实例。 现在，您可以将 Azure AD 日志发送到存储帐户或事件中心，以便与 SIEM 工具（如[相扑](https://docs.microsoft.com/azure/active-directory/reports-monitoring/howto-integrate-activity-logs-with-sumologic)[、Splunk](https://docs.microsoft.com/azure/active-directory/reports-monitoring/howto-integrate-activity-logs-with-splunk)和[ArcSight）](https://docs.microsoft.com/azure/active-directory/reports-monitoring/howto-integrate-activity-logs-with-arcsight)集成。 

有关设置 Azure 监视器的详细信息，请参阅[Azure 监视器 中的 Azure AD 活动日志](https://docs.microsoft.com/azure/active-directory/reports-monitoring/concept-activity-logs-azure-monitor#cost-considerations)。

---

### <a name="update-your-users-to-the-new-enhanced-security-info-experience"></a>将用户更新为新的增强的安全信息体验

**类型：** 已更改的功能  
**服务类别：** 身份验证（登录）   
**产品功能：** 用户身份验证

2019 年 9 月 25 日，我们将关闭旧的非增强型安全信息体验，用于注册和管理用户安全信息，并仅打开新的[增强版本](https://techcommunity.microsoft.com/t5/Azure-Active-Directory-Identity/Cool-enhancements-to-the-Azure-AD-combined-MFA-and-password/ba-p/354271)。 这意味着您的用户将不再能够使用旧体验。

有关增强的安全信息体验的详细信息，请参阅我们的[管理文档](https://aka.ms/securityinfodocs)和[用户文档](https://aka.ms/securityinfoguide)。

#### <a name="to-turn-on-this-new-experience-you-must"></a>要开启此新体验，您必须：

1. 以全局管理员或用户管理员身份登录到 Azure 门户。

2. 转到**Azure 活动目录>用户设置>管理访问面板预览功能的设置**。

3. 在"**用户可以使用预览功能注册和管理安全信息增强**区域"中，选择 **"选定**"，然后选择一组用户，或选择 **"全部"** 为租户中的所有用户打开此功能。

4. 在 [用户可以使用预览功能注册和管理安全 [信息] 区域，选择 **"无**"。

5. 保存设置。

    保存设置后，您将无法再访问旧的安全信息体验。

>[!Important]
>如果在 2019 年 9 月 25 日之前未完成这些步骤，则 Azure 活动目录租户将自动启用以进行增强体验。 如果您有任何疑问，请于 联系我们registrationpreview@microsoft.com。

---

### <a name="authentication-requests-using-post-logins-will-be-more-strictly-validated"></a>使用 POST 登录的身份验证请求将受到更严格的验证

**类型：** 已更改的功能  
**服务类别：** 身份验证（登录）  
**产品功能：** 标准

从 2019 年 9 月 2 日开始，使用 POST 方法的身份验证请求将针对 HTTP 标准进行更严格的验证。 具体而言，空格和双引号 （"） 将不再从请求窗体值中删除。 这些更改不会破坏任何现有客户端，并且有助于确保每次可靠地处理发送到 Azure AD 的请求。

有关详细信息，请参阅 Azure [AD 中断更改通知](https://docs.microsoft.com/azure/active-directory/develop/reference-breaking-changes#post-form-semantics-will-be-enforced-more-strictly---spaces-and-quotes-will-be-ignored)。

---

## <a name="july-2019"></a>2019 年 7 月

### <a name="plan-for-change-application-proxy-service-update-to-support-only-tls-12"></a>更改计划：应用程序代理服务更新仅支持 TLS 1.2

**类型：** 更改计划  
**服务类别：** 应用代理  
**产品功能：** 访问控制

为了帮助为您提供我们最强的加密，我们将开始将应用程序代理服务访问限制为仅 TLS 1.2 协议。 此限制最初将推广到已经使用 TLS 1.2 协议的客户，因此您不会看到影响。 TLS 1.0 和 TLS 1.1 协议的完整弃用将于 2019 年 8 月 31 日完成。 仍在使用 TLS 1.0 和 TLS 1.1 的客户将收到提前通知，以准备此更改。

要在整个更改过程中保持与应用程序代理服务的连接，我们建议您确保客户端-服务器和浏览器-服务器组合更新为使用 TLS 1.2。 我们还建议您确保包含员工用于访问通过应用程序代理服务发布的应用的任何客户端系统。

有关详细信息，请参阅在[Azure 活动目录中添加用于远程访问的应用程序](https://docs.microsoft.com/azure/active-directory/manage-apps/application-proxy-add-on-premises-application)。
...
新的用户界面更改即将从 **"添加应用程序**"边栏选项卡**的库区域进行"添加**"的设计。 这些更改将帮助您更轻松地查找支持自动预配、OpenID 连接、安全断言标记语言 （SAML） 和密码单一登录 （SSO） 的应用。
...
我们将从[Office 365 IP 地址和 URL Web 服务](https://docs.microsoft.com/office365/enterprise/office-365-ip-web-service)中删除 MFA 服务器 IP 地址。 如果当前依赖这些页面来更新防火墙设置，则必须确保还包括[Azure](https://docs.microsoft.com/azure/active-directory/authentication/howto-mfaserver-deploy#azure-multi-factor-authentication-server-firewall-requirements) **多重身份验证服务器防火墙要求**部分中记录的 IP 地址列表。
...
2019 年 7 月 26 日，我们改变了通过[客户端凭据授予](https://docs.microsoft.com/azure/active-directory/develop/v1-oauth2-client-creds-grant-flow)提供仅应用令牌的方式。 以前，应用可以获取令牌来调用其他应用，而不管客户端应用是否位于租户中。 我们更新了此行为，因此单个租户资源（有时称为 Web API）只能由资源租户中存在的客户端应用调用。

如果应用不在资源租户中，则会收到一条错误消息，`The service principal named <app_name> was not found in the tenant named <tenant_name>. This can happen if the application has not been installed by the administrator of the tenant.`指出"要解决此问题，必须在租户中创建客户端应用服务主体，使用[管理员同意终结点](https://docs.microsoft.com/azure/active-directory/develop/v2-permissions-and-consent#using-the-admin-consent-endpoint)或通过[PowerShell](https://docs.microsoft.com/azure/active-directory/develop/howto-authenticate-service-principal-powershell)，这可确保租户已授予应用在租户内操作的权限。
...
> [!NOTE]
> 客户端和 API 之间的现有同意仍然不需要。 应用仍应执行自己的授权检查。

---

### <a name="new-passwordless-sign-in-to-azure-ad-using-fido2-security-keys"></a>使用 FIDO2 安全密钥对 Azure AD 进行新的无密码登录

**类型：** 新功能  
**服务类别：** 身份验证（登录）  
**产品功能：** 用户身份验证

Azure AD 客户现在可以为其组织的用户和组设置策略来管理 FIDO2 安全密钥。 最终用户还可以自行注册其安全密钥，在支持 FIDO 的设备上使用密钥登录到其 Microsoft 帐户，以及登录到其 Azure AD 加入的 Windows 10 设备。

有关详细信息，请参阅为[Azure AD 启用无密码登录（预览）](/azure/active-directory/authentication/concept-authentication-passwordless)以获取与管理员相关的信息，以及[设置安全信息以使用安全密钥（预览）](https://docs.microsoft.com/azure/active-directory/user-help/security-info-setup-security-key)以获取最终用户相关信息。

---

### <a name="new-federated-apps-available-in-azure-ad-app-gallery---july-2019"></a>Azure AD 应用库中提供的新联合应用 - 2019 年 7 月

**类型：** 新功能  
**服务类别：** 企业应用  
**产品功能：** 第三方集成

2019 年 7 月，我们在应用库中添加了这 18 个具有联合支持的新应用：

[Ungerboeck 软件](https://docs.microsoft.com/azure/active-directory/saas-apps/ungerboeck-software-tutorial)，[明亮的模式全渠道联系中心](https://docs.microsoft.com/azure/active-directory/saas-apps/bright-pattern-omnichannel-contact-center-tutorial)，[聪明的内利](https://docs.microsoft.com/azure/active-directory/saas-apps/clever-nelly-tutorial)，[收购IO，](https://docs.microsoft.com/azure/active-directory/saas-apps/acquireio-tutorial) [Looop](https://www.looop.co/schedule-a-demo/)，[产品板](https://docs.microsoft.com/azure/active-directory/saas-apps/productboard-tutorial)， [MS Azure SSO 访问 Ethidex 合规办公室&trade;](https://docs.microsoft.com/azure/active-directory/manage-apps/what-is-single-sign-on#password-based-sso)，[海普](https://docs.microsoft.com/azure/active-directory/saas-apps/hype-tutorial)，[抽象](https://docs.microsoft.com/azure/active-directory/saas-apps/abstract-tutorial)，[阿森提斯](https://docs.microsoft.com/azure/active-directory/saas-apps/ascentis-tutorial)，[翻转小吃](https://www.flipsnack.com/accounts/sign-in-sso.html)，[旺达](https://docs.microsoft.com/azure/active-directory/saas-apps/wandera-tutorial)， [TwineSocial，](https://twinesocial.com/) [Kallidus，](https://docs.microsoft.com/azure/active-directory/saas-apps/kallidus-tutorial)[海兰，](https://docs.microsoft.com/azure/active-directory/saas-apps/hyperanna-tutorial)[芬尼废物证人](https://pharmid.com/)， [i2B 连接](https://www.i2b-online.com/sign-up-to-use-i2b-connect-here-sso-access/)， [JFrog 文物](https://docs.microsoft.com/azure/active-directory/saas-apps/jfrog-artifactory-tutorial)
...
有关如何使用自动用户帐户预配更好地保护组织的详细信息，请参阅[使用 Azure AD 自动将用户预配到 SaaS 应用程序](https://docs.microsoft.com/azure/active-directory/manage-apps/user-provisioning)

---

### <a name="new-azure-ad-domain-services-service-tag-for-network-security-group"></a>网络安全组的新 Azure AD 域服务标记

**类型：** 新功能  
**服务类别：** Azure AD 域服务  
**产品功能：** Azure AD 域服务

如果您厌倦了管理 IP 地址和范围的长列表，则可以使用 Azure 网络安全组中的新**AzureActiveDirectoryDomainServices**网络服务标记来帮助保护到 Azure AD 域服务虚拟网络子网的入站流量。
...
### <a name="new-security-audits-for-azure-ad-domain-services-public-preview"></a>Azure AD 域服务的新安全审核（公共预览）

**类型：** 新功能  
**服务类别：** Azure AD 域服务  
**产品功能：** Azure AD 域服务

我们很高兴地宣布发布 Azure AD 域服务安全审核以进行公共预览。 安全审核通过使用 Azure AD 域服务门户将安全审核事件流式传输到目标资源（包括 Azure 存储、Azure 日志分析工作区和 Azure 事件中心），帮助您深入了解身份验证服务。

有关详细信息，请参阅为[Azure AD 域服务启用安全审核（预览）。](https://docs.microsoft.com/azure/active-directory-domain-services/security-audit-events)

---

### <a name="new-authentication-methods-usage--insights-public-preview"></a>新的身份验证方法使用&见解（公共预览）

**类型：** 新功能  
**服务类别：** 自助服务密码重置  
**产品功能：** 监视和报告

新的身份验证方法使用&见解报告可以帮助您了解如何注册和使用 Azure 多重身份验证和自助服务密码重置等功能，包括每个功能的注册用户数、使用自助服务密码重置重置密码的频率以及重置方法。

有关详细信息，请参阅[身份验证方法使用情况&见解（预览）](https://docs.microsoft.com/azure/active-directory/authentication/howto-authentication-methods-usage-insights)。

---

### <a name="new-security-reports-are-available-for-all-azure-ad-administrators-public-preview"></a>新的安全报告适用于所有 Azure AD 管理员（公共预览版）

**类型：** 新功能  
**服务类别：** 身份保护  
**产品功能：** 标识安全和保护

所有 Azure AD 管理员现在都可以选择现有安全报告顶部的横幅（如**标记为风险报告的用户**）开始使用新的安全体验，如**风险用户**和**风险登录**报告所示。 随着时间的推移，所有安全报告都将从旧版本移动到新版本，新报告将为您提供以下附加功能：
...
直接联合通过使用支持 SAML 或 WS-Fed 标准的标识系统，帮助您更轻松地与 IT 托管标识解决方案不是 Azure AD 的合作伙伴合作。 与合作伙伴建立直接联合关系后，您从该域邀请的任何新来宾用户都可以使用其现有组织帐户与您协作，从而使来宾的用户体验更加无缝。

有关详细信息，请参阅与[AD FS 和第三方提供商的直接联合，以便提供来宾用户（预览）。](https://docs.microsoft.com/azure/active-directory/b2b/direct-federation)
...
### <a name="new-check-for-duplicate-group-names-in-the-azure-ad-portal"></a>在 Azure AD 门户中检查重复组名称的新检查

**类型：** 新功能  
**服务类别：** 组管理  
**产品功能：** 协作

现在，当您从 Azure AD 门户创建或更新组名称时，我们将执行检查以查看是否复制了资源中的现有组名称。 如果我们确定该名称已被其他组使用，系统将要求您修改您的姓名。

有关详细信息，请参阅在[Azure AD 门户中管理组](https://docs.microsoft.com/azure/active-directory/fundamentals/active-directory-groups-create-azure-portal?context=azure/active-directory/users-groups-roles/context/ugr-context)。

---

### <a name="azure-ad-now-supports-static-query-parameters-in-reply-redirect-uris"></a>Azure AD 现在支持答复（重定向）URI 中的静态查询参数

**类型：** 新功能  
**服务类别：** 身份验证（登录）  
**产品功能：** 用户身份验证

Azure AD 应用现在可以注册和使用具有静态查询参数（例如`https://contoso.com/oauth2?idp=microsoft`）的响应（重定向）URI的 OAuth 2.0 请求。 静态查询参数受答复 URI 的字符串匹配，就像答复 URI 的任何其他部分一样。 如果没有与 URL 解码重定向 uri 匹配的注册字符串，则请求将被拒绝。 如果找到答复 URI，则整个字符串用于重定向用户，包括静态查询参数。

动态答复 URI 仍然被禁止，因为它们表示安全风险，不能用于跨身份验证请求保留状态信息。 为此，请使用 参数`state`。

目前，Azure 门户的应用注册屏幕仍阻止查询参数。 但是，您可以手动编辑应用清单以在应用中添加和测试查询参数。 有关详细信息，请参阅[身份验证的新增功能？](https://docs.microsoft.com/azure/active-directory/develop/reference-breaking-changes#redirect-uris-can-now-contain-query-string-parameters)

---

### <a name="activity-logs-ms-graph-apis-for-azure-ad-are-now-available-through-powershell-cmdlets"></a>Azure AD 的活动日志 （MS 图形 API） 现在可通过 PowerShell Cmdlet 获得

**类型：** 新功能  
**服务类别：** 报告  
**产品功能：** 监视和报告

我们很高兴地宣布，Azure AD 活动日志（审核和登录报告）现在可通过 Azure AD PowerShell 模块获得。 以前，您可以使用 MS Graph API 终结点创建自己的脚本，现在我们将此功能扩展到 PowerShell cmdlet。

有关如何使用这些 cmdlet 的详细信息，请参阅 Azure [AD PowerShell cmdlet 以进行报告](https://docs.microsoft.com/azure/active-directory/reports-monitoring/reference-powershell-reporting)。

---

### <a name="updated-filter-controls-for-audit-and-sign-in-logs-in-azure-ad"></a>Azure AD 中审核和登录日志的更新筛选器控件

**类型：** 已更改的功能  
**服务类别：** 报告  
**产品功能：** 监视和报告

我们更新了审核和登录日志报表，因此您现在可以应用各种筛选器，而无需将它们作为列添加到报表屏幕上。 此外，您现在可以决定要在屏幕上显示的筛选器数。 这些更新协同工作，使报表更易于阅读，并更广泛地满足您的需求。

有关这些更新的详细信息，请参阅[筛选审核日志](https://docs.microsoft.com/azure/active-directory/reports-monitoring/concept-audit-logs#filtering-audit-logs)和[筛选器登录活动](https://docs.microsoft.com/azure/active-directory/reports-monitoring/concept-sign-ins#filter-sign-in-activities)。

---

## <a name="june-2019"></a>2019 年 6 月

### <a name="new-riskdetections-api-for-microsoft-graph-public-preview"></a>新的风险检测 API 用于微软图形（公共预览版）

**类型：** 新功能  
**服务类别：** 身份保护  
**产品功能：** 标识安全和保护

我们很高兴地宣布，微软图形的新风险检测API现已公开预览。 您可以使用此新 API 查看组织的标识保护相关用户和登录风险检测的列表。 您还可以使用此 API 更有效地查询风险检测，包括有关检测类型、状态、级别等的详细信息。

有关详细信息，请参阅[风险检测 API 参考文档](https://docs.microsoft.com/graph/api/resources/riskdetection?view=graph-rest-beta)。

---

### <a name="new-federated-apps-available-in-azure-ad-app-gallery---june-2019"></a>Azure AD 应用库中提供的新联合应用 - 2019 年 6 月

**类型：** 新功能  
**服务类别：** 企业应用  
**产品功能：** 第三方集成

2019 年 6 月，我们在应用库中添加了这 22 个具有联合支持的新应用：

[Azure AD SAML 工具包](https://docs.microsoft.com/azure/active-directory/saas-apps/saml-toolkit-tutorial)， [Otsuka Shokai （*）](https://docs.microsoft.com/azure/active-directory/saas-apps/otsuka-shokai-tutorial)， [ANAQUA，](https://docs.microsoft.com/azure/active-directory/saas-apps/anaqua-tutorial) [Azure VPN 客户端](https://portal.azure.com/)，[费用In，](https://docs.microsoft.com/azure/active-directory/saas-apps/expensein-tutorial)[帮助器帮助器](https://docs.microsoft.com/azure/active-directory/saas-apps/helper-helper-tutorial)，[成本点](https://docs.microsoft.com/azure/active-directory/saas-apps/costpoint-tutorial)， [GlobalOne，](https://docs.microsoft.com/azure/active-directory/saas-apps/globalone-tutorial)[梅赛德斯-奔驰车载办公室](https://me.secure.mercedes-benz.com/)，[斯科雷](https://app.justskore.it/)，[甲骨文云基础设施控制台](https://docs.microsoft.com/azure/active-directory/saas-apps/oracle-cloud-tutorial)， [CyberArk SAML 认证](https://docs.microsoft.com/azure/active-directory/saas-apps/cyberark-saml-authentication-tutorial)， [Scrible Edu，](https://www.scrible.com/sign-in/#/create-account) [PandaDoc，](https://docs.microsoft.com/azure/active-directory/saas-apps/pandadoc-tutorial)[感知，](https://apexdata.azurewebsites.net/docs.microsoft.com/azure/active-directory/saas-apps/perceptyx-tutorial)[普里斯特操作系统](https://proptimise.co.uk/software/)， [Vtiger CRM （SAML）](https://docs.microsoft.com/azure/active-directory/saas-apps/vtiger-crm-saml-tutorial)甲骨文电子商务套件的 Oracle 访问经理、电子商务套件的 Oracle IDCS、面向人员的 Oracle IDCS、JD Edwards 的 Oracle IDCS
...
我们更新了 Azure AD 预配体验，以包括一个新的进度栏，用于显示您在用户预配过程中有多远。 此更新体验还提供有关当前周期内预配的用户数以及迄今为止预配的用户数的信息。
...
### <a name="company-branding-now-appears-on-sign-out-and-error-screens"></a>公司品牌现在出现在注销和错误屏幕上

**类型：** 已更改的功能  
**服务类别：** 身份验证（登录）  
**产品功能：** 用户身份验证

我们更新了 Azure AD，以便您的公司品牌现在显示在注销和错误屏幕以及登录页上。 无需执行任何操作即可打开此功能，Azure AD 只需使用已在 Azure 门户的 **"公司"品牌**区域中设置的资产。

有关设置公司品牌的详细信息，请参阅[向组织的 Azure 活动目录页面添加品牌](https://docs.microsoft.com/azure/active-directory/fundamentals/customize-branding)。

---

### <a name="azure-multi-factor-authentication-mfa-server-is-no-longer-available-for-new-deployments"></a>Azure 多重身份验证 （MFA） 服务器不再可用于新部署

**类型：** 已弃用  
**服务类别：** Mfa  
**产品功能：** 标识安全和保护

自 2019 年 7 月 1 日起，Microsoft 将不再为新部署提供 MFA 服务器。 希望在组织中需要多重身份验证的新客户现在必须使用基于云的 Azure 多重身份验证。 在 7 月 1 日之前激活 MFA 服务器的客户不会看到更改。 您仍然可以下载最新版本、获取将来的更新并生成激活凭据。

有关详细信息，请参阅使用[Azure 多重身份验证服务器入门](https://docs.microsoft.com/azure/active-directory/authentication/howto-mfaserver-deploy)。 有关基于云的 Azure 多重身份验证的详细信息，请参阅[规划基于云的 Azure 多重身份验证部署](https://docs.microsoft.com/azure/active-directory/authentication/howto-mfa-getstarted)。

---

## <a name="may-2019"></a>2019 年 5 月

### <a name="service-change-future-support-for-only-tls-12-protocols-on-the-application-proxy-service"></a>服务更改：将来仅支持应用程序代理服务上的 TLS 1.2 协议

**类型：** 更改计划  
**服务类别：** 应用代理  
**产品功能：** 访问控制

为了帮助为客户提供一流的加密，我们将仅访问应用程序代理服务上的 TLS 1.2 协议。 此更改正在逐步推广到已经只使用 TLS 1.2 协议的客户，因此您不应看到任何更改。

TLS 1.0 和 TLS 1.1 的弃用发生在 2019 年 8 月 31 日，但我们将提供其他高级通知，因此您有时间准备此更改。 为准备此更改，请确保更新客户端-服务器和浏览器-服务器组合（包括用户用于访问通过应用程序代理发布的应用的任何客户端）以使用 TLS 1.2 协议来维护与应用程序代理服务的连接。 有关详细信息，请参阅在[Azure 活动目录中添加用于远程访问的应用程序](https://docs.microsoft.com/azure/active-directory/manage-apps/application-proxy-add-on-premises-application#before-you-begin)。

---

### <a name="use-the-usage-and-insights-report-to-view-your-app-related-sign-in-data"></a>使用使用情况和见解报告查看与应用相关的登录数据

**类型：** 新功能  
**服务类别：** 企业应用  
**产品功能：** 监视和报告

现在，您可以使用位于 Azure 门户**的企业应用程序**区域中的使用情况和见解报告来获取登录数据以应用程序为中心的视图，包括有关以下信息：
...
有关此功能的详细信息，请参阅 Azure[活动目录门户中的使用情况和见解报告](https://docs.microsoft.com/azure/active-directory/reports-monitoring/concept-usage-insights-report)
...
请按照这些新教程使用 Azure AD 预配服务自动创建、删除和更新以下基于云的应用的用户帐户：

- [科米特](https://docs.microsoft.com/azure/active-directory/saas-apps/comeet-recruiting-software-provisioning-tutorial)

- [动态信号](https://docs.microsoft.com/azure/active-directory/saas-apps/dynamic-signal-provisioning-tutorial)

- [保管员安全](https://docs.microsoft.com/azure/active-directory/saas-apps/keeper-password-manager-digitalvault-provisioning-tutorial)

您还可以按照这个新的[Dropbox 教程](https://docs.microsoft.com/azure/active-directory/saas-apps/dropboxforbusiness-provisioning-tutorial)，提供有关如何预配组对象的信息。

有关如何通过自动用户帐户预配更好地保护组织的详细信息，请参阅[使用 Azure AD 自动向 SaaS 应用程序预配用户](https://docs.microsoft.com/azure/active-directory/manage-apps/user-provisioning)。

---

### <a name="identity-secure-score-is-now-available-in-azure-ad-general-availability"></a>标识安全分数现在可在 Azure AD 中提供（常规版本）

**类型：** 新功能  
**服务类别：** N/A  
**产品功能：** 标识安全和保护

现在，您可以使用 Azure AD 中的标识安全评分功能来监视和改进身份安全状态。 标识安全评分功能使用单个仪表板来帮助您：

- 根据介于 1 和 223 之间的分数客观地衡量您的身份安全姿势。

- 规划身份安全改进

- 查看安全改进的成功

有关标识安全分数功能的详细信息，请参阅 Azure[活动目录中的标识安全分数是什么？](https://docs.microsoft.com/azure/active-directory/fundamentals/identity-secure-score)

---

### <a name="new-app-registrations-experience-is-now-available-general-availability"></a>新的应用注册体验现已推出（一般版本）

**类型：** 新功能  
**服务类别：** 身份验证（登录）  
**产品功能：** 开发人员体验

新的[应用注册](https://aka.ms/appregistrations)体验现已处于通用性。 此新体验包括 Azure 门户和应用程序注册门户中熟悉的所有主要功能，并通过以下功能对其进行改进：

- **更好的应用管理。** 您现在可以在一个位置查看所有应用，而不是跨不同门户查看应用。

- **简化应用注册。** 从改进的导航体验到改进的权限选择体验，现在可以更轻松地注册和管理应用。

- **更多详细信息。** 您可以找到有关应用的更多详细信息，包括快速入门指南等。

有关详细信息，请参阅[Microsoft 标识平台](https://docs.microsoft.com/azure/active-directory/develop/)，[应用程序注册体验现已普遍可用！](https://developer.microsoft.com/identity/blogs/new-app-registrations-experience-is-now-generally-available/) 博客公告。

---

### <a name="new-capabilities-available-in-the-risky-users-api-for-identity-protection"></a>风险用户 API 中用于标识保护的新功能

**类型：** 新功能  
**服务类别：** 身份保护  
**产品功能：** 标识安全和保护

我们很高兴地宣布，您现在可以使用风险用户 API 检索用户的风险历史记录，解雇风险用户，并确认用户已受损。 此更改可帮助您更有效地更新用户的风险状态，并了解其风险历史记录。

有关详细信息，请参阅[风险用户 API 参考文档](https://docs.microsoft.com/graph/api/resources/riskyuser?view=graph-rest-beta)。

---

### <a name="new-federated-apps-available-in-azure-ad-app-gallery---may-2019"></a>Azure AD 应用库中提供的新联合应用 - 2019 年 5 月

**类型：** 新功能  
**服务类别：** 企业应用  
**产品功能：** 第三方集成

2019 年 5 月，我们在应用库中添加了这 21 个具有联合支持的新应用：

[弗里德坎普](https://docs.microsoft.com/azure/active-directory/saas-apps/freedcamp-tutorial)，[真正的链接](https://docs.microsoft.com/azure/active-directory/saas-apps/real-links-tutorial)，[基安达](https://app.kianda.com/sso/OpenID/AzureAD/)，[简单标志](https://docs.microsoft.com/azure/active-directory/saas-apps/simple-sign-tutorial)，[布拉兹](https://docs.microsoft.com/azure/active-directory/saas-apps/braze-tutorial)，[显示器](https://docs.microsoft.com/azure/active-directory/saas-apps/displayr-tutorial)，[坦普拉菲](https://docs.microsoft.com/azure/active-directory/saas-apps/templafy-tutorial)，[市场销售参与](https://toutapp.com/login)， [ACLP，](https://docs.microsoft.com/azure/active-directory/saas-apps/aclp-tutorial) [OutSystems，](https://docs.microsoft.com/azure/active-directory/saas-apps/outsystems-tutorial) [Meta4 全球人力资源](https://docs.microsoft.com/azure/active-directory/saas-apps/meta4-global-hr-tutorial)，[量子工作场所](https://docs.microsoft.com/azure/active-directory/saas-apps/quantum-workplace-tutorial)，[钴](https://docs.microsoft.com/azure/active-directory/saas-apps/cobalt-tutorial)，[网络方法 API 云](https://docs.microsoft.com/azure/active-directory/saas-apps/webmethods-integration-cloud-tutorial)，[红旗](https://pocketstop.com/redflag/)，[什么修复](https://docs.microsoft.com/azure/active-directory/saas-apps/whatfix-tutorial)，[控制](https://docs.microsoft.com/azure/active-directory/saas-apps/control-tutorial)， [JOBHUB，](https://docs.microsoft.com/azure/active-directory/saas-apps/jobhub-tutorial) [NEOGOV，](https://docs.microsoft.com/azure/active-directory/saas-apps/neogov-tutorial)[食品，](https://docs.microsoft.com/azure/active-directory/saas-apps/foodee-tutorial) [MyVR](https://docs.microsoft.com/azure/active-directory/saas-apps/myvr-tutorial)

有关这些应用的详细信息，请参阅 [SaaS 应用程序与 Azure Active Directory 集成](https://aka.ms/appstutorial)。 要详细了解如何在 Azure AD 应用库中列出应用程序，请参阅[在 Azure Active Directory 应用程序库中列出应用程序](https://aka.ms/azureadapprequest)。

---

### <a name="improved-groups-creation-and-management-experiences-in-the-azure-ad-portal"></a>改进 Azure AD 门户中的组创建和管理体验

**类型：** 新功能  
**服务类别：** 组管理  
**产品功能：** 协作

我们在 Azure AD 门户中改进了与组相关的体验。 这些改进使管理员能够更好地管理组列表、成员列表并提供其他创建选项。
...
- 能够多选择组、成员和所有者列表，以便轻松删除。

- 能够在组创建期间选择电子邮件地址并添加所有者。
...
### <a name="configure-a-naming-policy-for-office-365-groups-in-azure-ad-portal-general-availability"></a>在 Azure AD 门户中为 Office 365 组配置命名策略（通用版）

**类型：** 已更改的功能  
**服务类别：** 组管理  
**产品功能：** 协作

管理员现在可以使用 Azure AD 门户为 Office 365 组配置命名策略。 此更改有助于为组织中的用户创建或编辑的 Office 365 组强制实施一致的命名约定。

您可以通过两种不同的方式为 Office 365 组配置命名策略：

- 定义自动添加到组名称的前缀或后缀。

- 为您的组织上传一组自定义的阻止字词，这些单词不允许在组名称中使用（例如，"CEO、工资单、HR"）。

有关详细信息，请参阅为[Office 365 组强制实施命名策略](https://docs.microsoft.com/azure/active-directory/users-groups-roles/groups-naming-policy)。

---

### <a name="microsoft-graph-api-endpoints-are-now-available-for-azure-ad-activity-logs-general-availability"></a>Microsoft 图形 API 终结点现在可用于 Azure AD 活动日志（常规可用性）

**类型：** 已更改的功能  
**服务类别：** 报告  
**产品功能：** 监视和报告

我们很高兴地宣布 Microsoft 图形 API 终结点对 Azure AD 活动日志的支持。 使用此版本，现在可以使用 Azure AD 审核日志的版本 1.0 以及登录日志 API。
...
### <a name="administrators-can-now-use-conditional-access-for-the-combined-registration-process-public-preview"></a>管理员现在可以将条件访问用于合并注册过程（公共预览）

**类型：** 新功能  
**服务类别：** 条件访问  
**产品功能：** 标识安全和保护  

管理员现在可以创建条件访问策略，供组合注册页使用。 这包括在以下方面应用策略以允许注册：
...
有关条件访问和密码重置的详细信息，请参阅 Azure AD[组合 MFA 和密码重置注册体验博客文章的条件访问](https://techcommunity.microsoft.com/t5/Azure-Active-Directory-Identity/Conditional-access-for-the-Azure-AD-combined-MFA-and-password/ba-p/566348)。 有关合并注册过程的条件访问策略的详细信息，请参阅[合并注册的条件访问策略](https://docs.microsoft.com/azure/active-directory/authentication/howto-registration-mfa-sspr-combined#conditional-access-policies-for-combined-registration)。 有关 Azure AD 使用条件功能的详细信息，请参阅[Azure 活动目录使用条款功能](https://docs.microsoft.com/azure/active-directory/conditional-access/terms-of-use)。

---

## <a name="april-2019"></a>2019 年 4 月

### <a name="new-azure-ad-threat-intelligence-detection-is-now-available-as-part-of-azure-ad-identity-protection"></a>新的 Azure AD 威胁智能检测现在作为 Azure AD 标识保护的一部分提供

**类型：** 新功能  
**服务类别：** Azure AD 标识保护  
**产品功能：** 标识安全和保护

Azure AD 威胁智能检测现在可作为更新的 Azure AD 标识保护功能的一部分提供。 此新功能有助于指示特定用户或活动基于 Microsoft 内部和外部威胁情报源的已知攻击模式的异常用户活动。

有关刷新版本的 Azure AD 标识保护的详细信息，请参阅[四个主要 Azure AD 标识保护增强功能现在位于公共预览](https://techcommunity.microsoft.com/t5/Azure-Active-Directory-Identity/Four-major-Azure-AD-Identity-Protection-enhancements-are-now-in/ba-p/326935)博客中[，什么是 Azure 活动目录标识保护（刷新）？](https://docs.microsoft.com/azure/active-directory/identity-protection/overview-v2) 部分。 有关 Azure AD 威胁智能检测的详细信息，请参阅[Azure 活动目录标识保护风险检测](https://docs.microsoft.com/azure/active-directory/identity-protection/concept-identity-protection-risks)一文。

---

### <a name="azure-ad-entitlement-management-is-now-available-public-preview"></a>Azure AD 授权管理现已可用（公共预览版）

**类型：** 新功能  
**服务类别：** 身份治理  
**产品功能：** 身份治理

Azure AD 授权管理（现在处于公共预览版中）可帮助客户委派访问包的管理，该管理定义员工和业务合作伙伴如何请求访问、必须批准的人员以及他们具有访问权限的时间。 访问包可以管理 Azure AD 和 Office 365 组的成员身份、企业应用程序中的角色分配以及 SharePoint Online 网站的角色分配。 在[Azure AD 授权管理概述](https://docs.microsoft.com/azure/active-directory/governance/entitlement-management-overview)中了解有关授权管理的详细信息。 要了解有关 Azure AD 标识治理功能（包括特权标识管理、访问审核和使用条款）广度的更多内容，请参阅[什么是 Azure AD 标识治理？](../governance/identity-governance-overview.md).

---

### <a name="configure-a-naming-policy-for-office-365-groups-in-azure-ad-portal-public-preview"></a>在 Azure AD 门户中为 Office 365 组配置命名策略（公共预览）
...
### <a name="azure-ad-activity-logs-are-now-available-in-azure-monitor-general-availability"></a>Azure AD 活动日志现在可在 Azure 监视器中提供（常规可用性）

**类型：** 新功能  
**服务类别：** 报告  
**产品功能：** 监视和报告

为了帮助使用 Azure AD 活动日志解决有关可视化效果的反馈，我们将在日志分析中引入新的见解功能。 此功能可帮助您使用我们的交互式模板（称为工作簿）获得有关 Azure AD 资源的见解。 这些预构建的工作簿可以为应用或用户提供详细信息，包括：

- **登录。** 为应用和用户提供详细信息，包括登录位置、正在使用的操作系统或浏览器客户端和版本以及成功或失败的登录数。

- **旧版身份验证和条件访问。** 为使用旧版身份验证的应用和用户提供详细信息，包括由条件访问策略触发的多重身份验证使用情况、使用条件访问策略的应用等。

- **登录失败分析。** 帮助您确定登录错误是否由于用户操作、策略问题或基础结构而发生。

- **自定义报表。** 您可以创建新的工作簿或编辑现有工作簿，以帮助为组织自定义见解功能。

有关详细信息，请参阅如何使用[Azure 活动目录报表的 Azure 监视器工作簿](https://docs.microsoft.com/azure/active-directory/reports-monitoring/howto-use-azure-monitor-workbooks)。

---

### <a name="new-federated-apps-available-in-azure-ad-app-gallery---april-2019"></a>Azure AD 应用库中提供的新联合应用 - 2019 年 4 月

**类型：** 新功能  
**服务类别：** 企业应用  
**产品功能：** 第三方集成

2019 年 4 月，我们在应用库中添加了这 21 个具有联合支持的新应用：

[SAP Fiori，](https://docs.microsoft.com/azure/active-directory/saas-apps/sap-fiori-tutorial) [HRworks 单签，](https://docs.microsoft.com/azure/active-directory/saas-apps/hrworks-single-sign-on-tutorial) [Percolate，](https://docs.microsoft.com/azure/active-directory/saas-apps/percolate-tutorial) [MobiControl，](https://docs.microsoft.com/azure/active-directory/saas-apps/mobicontrol-tutorial) [Citrix NetScaler，](https://docs.microsoft.com/azure/active-directory/saas-apps/citrix-netscaler-tutorial) [Shibumi，](https://docs.microsoft.com/azure/active-directory/saas-apps/shibumi-tutorial) [Benchling，](https://docs.microsoft.com/azure/active-directory/saas-apps/benchling-tutorial) [MileIQ，](https://mileiq.onelink.me/991934284/7e980085) [PageDNA，](https://docs.microsoft.com/azure/active-directory/saas-apps/pagedna-tutorial) [EduBrite LMS，](https://docs.microsoft.com/azure/active-directory/saas-apps/edubrite-lms-tutorial) [RStudio Connect，](https://docs.microsoft.com/azure/active-directory/saas-apps/rstudio-connect-tutorial) [AMMS，](https://docs.microsoft.com/azure/active-directory/saas-apps/amms-tutorial) [Mitel Connect，](https://docs.microsoft.com/azure/active-directory/saas-apps/mitel-connect-tutorial)[阿里巴巴云 （基于角色的 SSO），](https://docs.microsoft.com/azure/active-directory/saas-apps/alibaba-cloud-service-role-based-sso-tutorial) [Certent 股权管理](https://docs.microsoft.com/azure/active-directory/saas-apps/certent-equity-management-tutorial)， [Sectigo 证书管理器](https://docs.microsoft.com/azure/active-directory/saas-apps/sectigo-certificate-manager-tutorial)，[格林Orbit，](https://docs.microsoft.com/azure/active-directory/saas-apps/greenorbit-tutorial)[工作网格](https://docs.microsoft.com/azure/active-directory/saas-apps/workgrid-tutorial)[，](https://docs.microsoft.com/azure/active-directory/saas-apps/surveymonkey-enterprise-tutorial) [monday.com](https://docs.microsoft.com/azure/active-directory/saas-apps/mondaycom-tutorial) [Indiggo](https://indiggolead.com/)

有关这些应用的详细信息，请参阅 [SaaS 应用程序与 Azure Active Directory 集成](https://aka.ms/appstutorial)。 要详细了解如何在 Azure AD 应用库中列出应用程序，请参阅[在 Azure Active Directory 应用程序库中列出应用程序](https://aka.ms/azureadapprequest)。

---

### <a name="new-access-reviews-frequency-option-and-multiple-role-selection"></a>新的访问审核频率选项和多个角色选择

**类型：** 新功能  
**服务类别：** 访问评论  
**产品功能：** 身份治理

Azure AD 访问审核中的新更新允许您：

- 除了以前存在的每周、每月、每季度和每年的选项之外，将访问审核的频率更改为**每半年**一次。

- 创建单个访问审阅时，请选择多个 Azure AD 和 Azure 资源角色。 在此情况下，所有角色都使用相同的设置设置，并同时通知所有审阅者。

有关如何创建访问审核的详细信息，请参阅[在 Azure AD 访问审阅中创建组或应用程序的访问审核](https://docs.microsoft.com/azure/active-directory/governance/create-access-review)。

---

### <a name="azure-ad-connect-email-alert-systems-are-transitioning-sending-new-email-sender-information-for-some-customers"></a>Azure AD 连接电子邮件警报系统正在转换，为某些客户发送新的电子邮件发件人信息

**类型：** 已更改的功能  
**服务类别：** AD Sync  
**产品功能：** 平台

Azure AD Connect 正在转换电子邮件警报系统，可能会向某些客户显示新的电子邮件发件人。 要解决此问题，必须添加到`azure-noreply@microsoft.com`组织的允许列表，否则将无法继续接收来自 Office 365、Azure 或同步服务的重要警报。

---

### <a name="upn-suffix-changes-are-now-successful-between-federated-domains-in-azure-ad-connect"></a>UPN 后缀更改现在在 Azure AD 连接中的联合域之间成功

**类型：** 已修复  
**服务类别：** AD Sync  
**产品功能：** 平台

现在，您可以在 Azure AD Connect 中成功地将用户的 UPN 后缀从一个联合域更改为另一个联合域。 此修复意味着不应在同步周期期间再遇到联合域域更改错误错误消息，或收到通知电子邮件，指出"无法在 Azure 活动目录中更新此对象，因为属性 [联合用户.UsertheName]无效。 更新本地目录服务中的值"。

有关详细信息，请参阅[在同步期间排除错误](https://docs.microsoft.com/azure/active-directory/hybrid/tshoot-connect-sync-errors#federateddomainchangeerror)。
...
使用 **"需要应用保护**"策略，现在可以使用基于应用保护的条件访问。 此新策略通过帮助防止：

- 无需 Microsoft Intune 许可证即可访问应用的用户。

- 用户无法获取 Microsoft Intune 应用保护策略。

- 无需配置的 Microsoft Intune 应用保护策略即可访问应用的用户。

有关详细信息，请参阅[如何要求应用保护策略的云应用访问与条件访问](https://docs.microsoft.com/azure/active-directory/conditional-access/app-protection-based-conditional-access)。

---

### <a name="new-support-for-azure-ad-single-sign-on-and-conditional-access-in-microsoft-edge-public-preview"></a>对 Microsoft 边缘中的 Azure AD 单一登录和条件访问的新支持（公共预览版）

**类型：** 新功能  
**服务类别：** 条件访问  
**产品功能：** 标识安全和保护

我们增强了对 Microsoft Edge 的 Azure AD 支持，包括为 Azure AD 单一登录和条件访问提供新的支持。 如果您以前使用过微软 Intune 托管浏览器，现在可以改用 Microsoft Edge。

有关使用条件访问设置和管理设备和应用的详细信息，请参阅[使用条件访问需要托管设备进行云应用访问](https://docs.microsoft.com/azure/active-directory/conditional-access/require-managed-devices)，[以及要求通过条件访问进行云应用访问。](https://docs.microsoft.com/azure/active-directory/conditional-access/app-based-conditional-access) 有关如何使用 Microsoft Edge 与 Microsoft Intune 策略管理访问的详细信息，请参阅[使用 Microsoft Intune 策略保护的浏览器管理 Internet 访问](https://docs.microsoft.com/intune/app-configuration-managed-browser)。

---

## <a name="march-2019"></a>2019 年 3 月

### <a name="identity-experience-framework-and-custom-policy-support-in-azure-active-directory-b2c-is-now-available-ga"></a>Azure 活动目录 B2C 中的标识体验框架和自定义策略支持现已可用 （GA）

**类型：** 新功能  
**服务类别：** B2C - 用户标识管理  
**产品功能：** B2B/B2C

现在，您可以在 Azure AD B2C 中创建自定义策略，包括以下任务，这些任务在规模和 Azure SLA 下得到支持：
...
- 在自定义身份验证用户旅程中使用启用 REST API 的服务。 例如，对于电子邮件提供商、VM 和专有授权系统。

- 与符合 OpenIDConnect 协议的标识提供程序联合。 例如，对于多租户 Azure AD、社交帐户提供程序或双重验证提供程序。

有关创建自定义策略的详细信息，请参阅[Azure 活动目录 B2C 中自定义策略的开发人员注释](https://docs.microsoft.com/azure/active-directory-b2c/active-directory-b2c-developer-notes-custom)，并阅读[Alex Simon 的博客文章，包括案例研究](https://techcommunity.microsoft.com/t5/Azure-Active-Directory-Identity/Azure-AD-B2C-custom-policies-to-build-your-own-identity-journeys/ba-p/382791)。

---

### <a name="new-federated-apps-available-in-azure-ad-app-gallery---march-2019"></a>Azure AD 应用库中提供的新联合应用 - 2019 年 3 月

**类型：** 新功能  
**服务类别：** 企业应用  
**产品功能：** 第三方集成

2019 年 3 月，我们向应用库添加了这 14 个具有联合支持的新应用：

[ISEC7 移动交换代表](https://www.isec7.com/english/)， [MediusFlow，](https://office365.cloudapp.mediusflow.com/) [ePlatform，](https://docs.microsoft.com/azure/active-directory/saas-apps/eplatform-tutorial) [Fulcrum，](https://docs.microsoft.com/azure/active-directory/saas-apps/fulcrum-tutorial) [ExcelityGlobal，](https://docs.microsoft.com/azure/active-directory/saas-apps/excelityglobal-tutorial)[解释为基础的审计系统](https://docs.microsoft.com/azure/active-directory/saas-apps/explanation-based-auditing-system-tutorial)，[精益](https://docs.microsoft.com/azure/active-directory/saas-apps/lean-tutorial)，[动力学校性能事项](https://docs.microsoft.com/azure/active-directory/saas-apps/powerschool-performance-matters-tutorial)， [Cinode，](https://cinode.com/) [Iris 内联网](https://docs.microsoft.com/azure/active-directory/saas-apps/iris-intranet-tutorial)， [Empactis，](https://docs.microsoft.com/azure/active-directory/saas-apps/empactis-tutorial)[智能绘制](https://docs.microsoft.com/azure/active-directory/saas-apps/smartdraw-tutorial)，[确认地平线](https://docs.microsoft.com/azure/active-directory/saas-apps/confirmit-horizons-tutorial)， [TAS](https://docs.microsoft.com/azure/active-directory/saas-apps/tas-tutorial)

有关这些应用的详细信息，请参阅 [SaaS 应用程序与 Azure Active Directory 集成](https://aka.ms/appstutorial)。 要详细了解如何在 Azure AD 应用库中列出应用程序，请参阅[在 Azure Active Directory 应用程序库中列出应用程序](https://aka.ms/azureadapprequest)。

---

### <a name="new-zscaler-and-atlassian-provisioning-connectors-in-the-azure-ad-gallery---march-2019"></a>Azure AD 库中的新 Zscaler 和 Atlass 预配连接器 - 2019 年 3 月
...
[兹卡尔，](https://aka.ms/ZscalerProvisioning)[兹卡尔贝塔](https://aka.ms/ZscalerBetaProvisioning)，[兹卡尔，](https://aka.ms/ZscalerOneProvisioning)[茨卡尔二](https://aka.ms/ZscalerTwoProvisioning)世，[兹卡尔，茨卡尔三](https://aka.ms/ZscalerThreeProvisioning)[，兹卡尔瑟·兹云](https://aka.ms/ZscalerZSCloudProvisioning)，[阿特拉斯云](https://aka.ms/atlassianCloudProvisioning)

有关如何通过自动用户帐户预配更好地保护组织的详细信息，请参阅[使用 Azure AD 自动向 SaaS 应用程序预配用户](https://aka.ms/ProvisioningDocumentation)。
...
您现在可以从 Azure AD 门户查看和管理已删除的 Office 365 组。 此更改可帮助您查看哪些组可供还原，同时允许您永久删除组织不需要的任何组。
...
### <a name="single-sign-on-is-now-available-for-azure-ad-saml-secured-on-premises-apps-through-application-proxy-public-preview"></a>现在，通过应用程序代理（公共预览）对 Azure AD SAML 安全的本地应用提供单一登录

**类型：** 新功能  
**服务类别：** 应用代理  
**产品功能：** 访问控制

现在，您可以为本地 SAML 身份验证的应用提供单个登录 （SSO） 体验，以及通过应用程序代理对这些应用的远程访问。 有关如何使用本地应用设置 SAML SSO 的详细信息，请参阅[使用应用程序代理（预览）的本地应用程序的单一登录](https://docs.microsoft.com/azure/active-directory/manage-apps/application-proxy-configure-single-sign-on-on-premises-apps)。

---

### <a name="client-apps-in-request-loops-will-be-interrupted-to-improve-reliability-and-user-experience"></a>请求循环中的客户端应用将被中断以提高可靠性和用户体验

**类型：** 新功能  
**服务类别：** 身份验证（登录）  
**产品功能：** 用户身份验证

客户端应用可能会在短时间内错误地发出数百个相同的登录请求。 这些请求（无论是否成功）都会导致 IDP 的用户体验不佳和工作负载增加，增加所有用户的延迟并降低 IDP 的可用性。

此更新发送错误`invalid_grant`：`AADSTS50196: The server terminated an operation because it encountered a loop while processing a request`向在短时间内多次发出重复请求的客户端应用发送错误，超出正常操作范围。 遇到此问题的客户端应用应显示交互式提示，要求用户重新登录。 有关此更改的详细信息以及如何修复应用（如果遇到此错误），请参阅[身份验证的新增功能？](https://docs.microsoft.com/azure/active-directory/develop/reference-breaking-changes#looping-clients-will-be-interrupted)

---

### <a name="new-audit-logs-user-experience-now-available"></a>新的审核日志用户体验现已可用

**类型：** 已更改的功能  
**服务类别：** 报告  
**产品功能：** 监视和报告

我们创建了一个新的 Azure AD**审核日志**页，以帮助提高可读性以及搜索信息的方式。 要查看新的**审核日志**页，请在 Azure AD**的活动部分**中选择**审核日志**。

![新的审核日志页面，包含示例信息](media/whats-new/audit-logs-page.png)

有关新的**审核日志**页的详细信息，请参阅 Azure[活动目录门户中的审核活动报告](https://docs.microsoft.com/azure/active-directory/reports-monitoring/concept-audit-logs#audit-logs)。

---

### <a name="new-warnings-and-guidance-to-help-prevent-accidental-administrator-lockout-from-misconfigured-conditional-access-policies"></a>新的警告和指导，有助于防止意外管理员锁定，避免配置错误的条件访问策略

**类型：** 已更改的功能  
**服务类别：** 条件访问  
**产品功能：** 标识安全和保护

为了帮助防止管理员通过配置错误的条件访问策略意外将自己锁定自外租户，我们在 Azure 门户中创建了新的警告并更新了指南。 有关新指南的详细信息，请参阅 Azure[活动目录条件访问中的什么是服务依赖项](https://docs.microsoft.com/azure/active-directory/conditional-access/service-dependencies)。

---

### <a name="improved-end-user-terms-of-use-experiences-on-mobile-devices"></a>改进移动设备上的最终用户使用条款体验

**类型：** 已更改的功能  
**服务类别：** 使用条款  
**产品功能：** 治理

我们更新了现有的使用条款体验，以帮助改进您查看和同意移动设备使用条款的方式。 您现在可以放大和缩小、返回、下载信息以及选择超链接。 有关更新的使用条款的详细信息，请参阅[Azure 活动目录的使用条款功能](https://docs.microsoft.com/azure/active-directory/conditional-access/terms-of-use#what-terms-of-use-looks-like-for-users)。

---

### <a name="new-azure-ad-activity-logs-download-experience-available"></a>新的 Azure AD 活动日志下载体验可用

**类型：** 已更改的功能  
**服务类别：** 报告  
**产品功能：** 监视和报告

现在，可以直接从 Azure 门户下载大量活动日志。 此更新允许您：
...
### <a name="breaking-change-updates-to-condition-evaluation-by-exchange-activesync-eas"></a>重大更改：通过 Exchange ActiveSync （EAS） 更新条件评估
...
如果您以前在条件访问策略中使用过这些条件，请注意条件行为可能会更改。 例如，如果您以前在策略中使用用户位置条件，您可能会发现现在会根据用户的位置跳过策略。
...
您现在可以配置任何受支持的 SAML 应用以接收加密的 SAML 令牌。 当与应用一起配置和使用时，Azure AD 将使用从 Azure AD 中存储的证书获取的公钥对已发出的 SAML 断言进行加密。

有关配置 SAML 令牌加密的详细信息，请参阅配置[Azure AD SAML 令牌加密](https://docs.microsoft.com/azure/active-directory/manage-apps/howto-saml-token-encryption)。

---

### <a name="create-an-access-review-for-groups-or-apps-using-azure-ad-access-reviews"></a>使用 Azure AD 访问审核为组或应用创建访问审核

**类型：** 新功能  
**服务类别：** 访问评论  
**产品功能：** 治理

现在，您可以在单个 Azure AD 访问审核中包含多个组或应用，以进行组成员身份或应用分配。 使用相同的设置设置具有多个组或应用的访问审阅，并同时通知所有包含的审阅者。

有关如何使用 Azure AD 访问审核创建访问审核的详细信息，请参阅[在 Azure AD 访问审核中创建组或应用程序的访问审核](https://docs.microsoft.com/azure/active-directory/governance/create-access-review)

---

### <a name="new-federated-apps-available-in-azure-ad-app-gallery---february-2019"></a>Azure AD 应用库中提供的新联合应用 - 2019 年 2 月

**类型：** 新功能  
**服务类别：** 企业应用  
**产品功能：** 第三方集成
 
2019 年 2 月，我们在应用库中添加了这 27 个具有联合支持的新应用：

[欧洲监控护照](https://docs.microsoft.com/azure/active-directory/saas-apps/euromonitor-passport-tutorial)， [PureCloud by Genesys](https://docs.microsoft.com/azure/active-directory/saas-apps/purecloud-by-genesys-tutorial) [MindTickle，](https://docs.microsoft.com/azure/active-directory/saas-apps/mindtickle-tutorial)FAT [FINGER，](https://seeforgetest-exxon.azurewebsites.net/Account/create?Length=7) [AirStack，](https://docs.microsoft.com/azure/active-directory/saas-apps/airstack-tutorial)[甲骨文融合 ERP，](https://docs.microsoft.com/azure/active-directory/saas-apps/oracle-fusion-erp-tutorial) [IDrive，](https://docs.microsoft.com/azure/active-directory/saas-apps/idrive-tutorial) [Skyward Qmlativ，](https://docs.microsoft.com/azure/active-directory/saas-apps/skyward-qmlativ-tutorial) [Brightidea，](https://docs.microsoft.com/azure/active-directory/saas-apps/brightidea-tutorial) [AlertOps，](https://docs.microsoft.com/azure/active-directory/saas-apps/alertops-tutorial) [Soloinsight-CloudGate SSO，](https://docs.microsoft.com/azure/active-directory/saas-apps/soloinsight-cloudgate-sso-tutorial)权限点击，[Netop Portal](https://docs.microsoft.com/azure/active-directory/saas-apps/netop-portal-tutorial)[品牌文件夹](https://docs.microsoft.com/azure/active-directory/saas-apps/brandfolder-tutorial)， [ClickUp Productivity Platform](https://docs.microsoft.com/azure/active-directory/saas-apps/clickup-productivity-platform-tutorial) [存储gateSmartFile，](https://docs.microsoft.com/azure/active-directory/saas-apps/smartfile-tutorial) [Pexip，](https://docs.microsoft.com/azure/active-directory/saas-apps/pexip-tutorial)[风暴板](https://docs.microsoft.com/azure/active-directory/saas-apps/stormboard-tutorial)，[地震](https://docs.microsoft.com/azure/active-directory/saas-apps/seismic-tutorial)，[共享梦想](https://www.shareadream.org/how-it-works)，[错误，](https://docs.microsoft.com/azure/active-directory/saas-apps/bugsnag-tutorial)[网络方法集成云](https://docs.microsoft.com/azure/active-directory/saas-apps/webmethods-integration-cloud-tutorial)，[知识任何地方 LMS，](https://docs.microsoft.com/azure/active-directory/saas-apps/knowledge-anywhere-lms-tutorial)OU[校园](https://docs.microsoft.com/azure/active-directory/saas-apps/ou-campus-tutorial)，[内窥镜](https://docs.microsoft.com/azure/active-directory/saas-apps/periscope-data-tutorial) [smartvid.io](https://docs.microsoft.com/azure/active-directory/saas-apps/smartvid.io-tutorial)数据

有关这些应用的详细信息，请参阅 [SaaS 应用程序与 Azure Active Directory 集成](https://aka.ms/appstutorial)。 要详细了解如何在 Azure AD 应用库中列出应用程序，请参阅[在 Azure Active Directory 应用程序库中列出应用程序](https://aka.ms/azureadapprequest)。

---

### <a name="enhanced-combined-mfasspr-registration"></a>增强的 MFA/SSPR 联合注册

**类型：** 已更改的功能  
**服务类别：** 自助服务密码重置  
**产品功能：** 用户身份验证

为了响应客户反馈，我们增强了组合的 MFA/SSPR 注册预览体验，帮助您的用户更快地注册 MFA 和 SSPR 的安全信息。 

**要打开当前用户的增强体验，请按照以下步骤操作：**

1. 作为全局管理员或用户管理员，登录到 Azure 门户并转到 Azure**活动目录>用户设置>管理访问面板预览功能的设置**。 

2. 在 **"可以使用预览功能注册和管理安全信息 + 刷新"选项中的"用户"** 中，选择打开**选定用户组**或**所有用户**的功能。

在接下来的几周里，我们将取消为尚未打开的租户打开旧的组合 MFA/SSPR 注册预览体验的能力。

**要查看是否将删除租户的控件，请按照以下步骤操作：**

1. 作为全局管理员或用户管理员，登录到 Azure 门户并转到 Azure**活动目录>用户设置>管理访问面板预览功能的设置**。  

2. 如果**可以使用预览功能注册和管理安全信息选项的用户**设置为 **"无**"，则该选项将从租户中删除。

无论您以前是否为用户打开了旧的组合 MFA/SSPR 注册预览体验，旧体验都将在将来关闭。 因此，我们强烈建议您尽快转向新的增强型体验。

有关增强的注册体验的详细信息，请参阅 Azure [AD 组合 MFA 和密码重置注册体验的 Cool 增强功能](https://techcommunity.microsoft.com/t5/Azure-Active-Directory-Identity/Cool-enhancements-to-the-Azure-AD-combined-MFA-and-password/ba-p/354271)。

---

### <a name="updated-policy-management-experience-for-user-flows"></a>更新用户流的策略管理体验

**类型：** 已更改的功能  
**服务类别：** B2C - 用户标识管理  
**产品功能：** B2B/B2C

我们更轻松地更新了用户流的策略创建和管理过程（以前称为内置策略）。 此新体验现在是所有 Azure AD 租户的默认体验。

您可以使用门户屏幕顶部的 **"向我们发送"反馈**区域中的微笑或皱眉图标提供其他反馈和建议。

有关新的策略管理体验的详细信息，请参阅[Azure AD B2C 现在具有 JavaScript 自定义和更多新功能](https://techcommunity.microsoft.com/t5/Azure-Active-Directory-Identity/Azure-AD-B2C-now-has-JavaScript-customization-and-many-more-new/ba-p/353595)博客。
...
现在，您可以选择 Azure AD B2C 提供的页面元素的特定版本。 通过选择特定版本，您可以在更新显示在页面上之前对其进行测试，并可以获取可预测的行为。 此外，您现在可以选择强制实施特定的页面版本，以允许 JavaScript 自定义。 要打开此功能，请转到用户流中的 **"属性"** 页。

有关选择特定版本的页面元素的详细信息，请参阅[Azure AD B2C 现在具有 JavaScript 自定义和更多新功能](https://techcommunity.microsoft.com/t5/Azure-Active-Directory-Identity/Azure-AD-B2C-now-has-JavaScript-customization-and-many-more-new/ba-p/353595)博客。
...
现在，您可以为最终用户设置组织的密码复杂性，而不必使用本机 Azure AD 密码策略。 从用户流的 **"属性"** 边栏选项卡（以前称为内置策略）中，您可以选择 **"简单**"或"**强"** 的密码复杂性，也可以创建**自定义**要求集。

有关密码复杂性要求配置的详细信息，请参阅[在 Azure 活动目录 B2C 中配置密码的复杂性要求](https://docs.microsoft.com/azure/active-directory-b2c/active-directory-b2c-reference-password-complexity)。
...
您可以使用我们位于用户流的 **"主页"布局**边栏选项卡上的新默认模板（以前称为内置策略）为您的用户创建自定义品牌身份验证体验。
...
- **使用仅 HTTP Cookie。** 在应用程序代理访问权限和会话 Cookie 上设置 **HTTPOnly** 标志。 启用此设置会带来更多的安全好处，例如有助于防止用户通过客户端脚本复制或修改 Cookie。 建议启用此标志（选择“是”****）以享受增加的安全好处。
...
若要使你的一次性密码、应用信息和应用设置更加安全，可以在 Microsoft Authenticator 应用中开启应用锁定功能。 打开应用锁定意味着每次打开 Microsoft 身份验证器应用时，系统都会要求您使用 PIN 或生物识别进行身份验证。
...
我们修复了一个错误，当活动目录域服务 （AD DS） 对象从同步作用域中排除，然后在后续同步周期移动到 Azure AD 中的回收站时，用户的 DirSyncEnabled 标志将错误地切换到**False。** 进行此修复以后，如果将用户从同步范围中排除，然后又将其从 Azure AD 回收站还原，则用户帐户会保持预期的从本地 AD 同步的状态，不能在云中托管，因为其授权源 (SoA) 仍旧为本地 AD。
...
- **分阶段对多个用户进行大规模 ImmutableID 更新**
  ...
  例如，需要进行耗时很长的 AD DS 林间迁移。 解决方案：使用 Azure AD 连接**来配置源锚点**，并在用户迁移时，将现有的不可移动 ID 值从 Azure AD 复制到本地 AD DS 用户的 ms-DS-一致性-Guid 属性的新林。 有关详细信息，请参阅[将 msDS-ConsistencyGuid 用作 sourceAnchor](/azure/active-directory/hybrid/plan-connect-design-concepts#using-ms-ds-consistencyguid-as-sourceanchor)。

- **一次性对多个用户进行大规模 ImmutableID 更新**

  例如，在实现 Azure AD Connect 时犯错，现在需要更改 SourceAnchor 属性。 解决方案：在租户级别禁用 DirSync 并清除所有无效的 Immuid 值。 有关详细信息，请参阅[禁用 Office 365 的目录同步](/office365/enterprise/turn-off-directory-synchronization)。

- **将本地用户与 Azure AD 中的现有用户重新匹配** 例如，在 AD DS 中重新创建的用户会在 Azure AD 帐户中生成一个重复的用户，系统不会将其与现有的 Azure AD 帐户（孤立对象）重新匹配。 解决方案：在 Azure 门户中使用 Azure AD 连接运行状况重新映射源锚点/不可改变 ID。 有关详细信息，请参阅[孤立对象场景](/azure/active-directory/hybrid/how-to-connect-health-diagnose-sync-errors#orphaned-object-scenario)。

### <a name="breaking-change-updates-to-the-audit-and-sign-in-logs-schema-through-azure-monitor"></a>中断更改：通过 Azure 监视器更新审核和登录日志架构
...
风险检测现在由受监督的机器学习模型进行评估，该模型使用用户登录的其他功能和检测模式来计算用户风险。 基于此模型，管理员可以发现风险评分较高的用户，即使与该用户关联的检测具有中低型的风险。 
...
我们意识到，随着时间的推移，您必须在 Azure AD 中刷新和停用组织的设备，以避免环境中有陈旧的设备。 为了帮助完成此过程，Azure AD 现在会使用新的活动时间戳更新设备，以帮助管理设备生命周期。
...
### <a name="administrators-can-require-users-to-accept-a-terms-of-use-on-each-device"></a>管理员可以要求用户接受每台设备上的使用条款

**类型：** 新功能  
**服务类别：** 使用条款  
**产品功能：** 治理
 
管理员现在可以打开 **"要求用户在每台设备上同意**"选项，以要求用户接受您在租户上使用的每个设备上的使用条款。

有关详细信息，请参阅 Azure[活动目录使用函数中的"每设备使用条款"部分](https://docs.microsoft.com/azure/active-directory/conditional-access/terms-of-use#per-device-terms-of-use)。
...
管理员现在可以打开 **"过期同意"** 选项，以便根据指定的定期计划使所有用户的使用条款过期。 可以实施每年、半年、每季或每月计划。 使用条款到期后，用户必须重新接受。

有关详细信息，请参阅 Azure[活动目录使用条款的"添加使用条款"部分](https://docs.microsoft.com/azure/active-directory/conditional-access/terms-of-use#add-terms-of-use)。

---

### <a name="administrators-can-configure-a-terms-of-use-to-expire-based-on-each-users-schedule"></a>管理员可以根据每个用户的日程安排将使用条款配置为过期

**类型：** 新功能  
**服务类别：** 使用条款  
**产品功能：** 治理

管理员现在可以指定用户必须重新接受使用条款的持续时间。 例如，管理员可以指定用户必须每 90 天重新接受使用条款。
...
要开始使用此一键式体验，请转到应用的**Azure 门户** > **SSO 配置**页。 有关详细信息，请参阅 [SaaS 应用程序与 Azure Active Directory 集成](https://docs.microsoft.com/azure/active-directory/saas-apps/tutorial-list)
...
Azure**门户登录页上**的新 **"故障排除和支持**"选项卡旨在帮助管理员和支持工程师解决与 Azure AD 登录相关的问题。此新选项卡提供错误代码、错误消息和修正建议（如果有）以帮助解决问题。 如果无法解决问题，我们还提供使用“复制到剪贴板”体验创建支持票证的新方法，该体验可在支持票证中填充日志文件的“请求 ID”和“日期(UTC)”字段。************  

![显示新选项卡的登录日志](media/whats-new/troubleshooting-and-support.png)
...
### <a name="new-approved-client-apps-for-azure-ad-app-based-conditional-access"></a>基于 Azure AD 应用的条件访问的新已批准客户端应用
...
应用程序代理应用中有一个名为“HTTP-Only Cookie”的新设置。**** 此设置在应用程序代理的访问 Cookie 和会话 Cookie 的 HTTP 响应标头中包含 HTTPOnly 标志，阻止从客户端侧脚本访问 Cookie，并进一步阻止复制或修改 Cookie 等操作，以此提供更高的安全性。 尽管此标志以前未使用过，但您的 Cookie 始终通过 TLS 连接进行加密和传输，以帮助防止不当修改。
...
### <a name="conditional-access-information-added-to-the-azure-ad-sign-ins-report"></a>添加到 Azure AD 登录报表的条件访问信息
...
由于在登录活动日志中引入了“客户端应用”字段，客户现在可以查看使用旧式身份验证的用户****。 客户将能够使用登录 Microsoft 图形 API 或通过 Azure AD 门户中的登录活动日志访问此信息，您可以使用**客户端应用**控件筛选旧版身份验证。 查看文档可了解更多详细信息。
...
### <a name="updates-to-the-terms-of-use-end-user-ui"></a>最终用户 UI 的使用条款的更新
...
由于我们更强的安全强制，我们不得不更改使用委派授权流访问[Azure AD 活动日志 API](https://aka.ms/aadreportsapi)的应用的权限。 此更改在 **2018 年 6 月 26 日**前生效。

如果任何应用使用 Azure AD 活动日志 API，请按照以下步骤操作，以确保应用在更改发生后不会中断。
...
### <a name="new-all-guests-conditional-access-policy-template-created-during-terms-of-use-creation"></a>在使用条款创建期间创建的新"所有来宾"条件访问策略模板
...
### <a name="new-custom-conditional-access-policy-template-created-during-terms-of-use-creation"></a>在创建使用条款期间创建的新"自定义"条件访问策略模板

**类型：** 新功能  
**服务类别：** 使用条款  
**产品功能：** 治理

在创建使用条款期间，还会创建新的"自定义"条件访问策略模板。 此新策略模板允许您创建 ToU，然后立即转到条件访问策略创建边栏选项卡，而无需手动浏览门户。
...
我们添加了用于管理 Azure AD 使用条款的 Microsoft 图形 API。 您可以创建、更新、删除使用对象。
...
Azure AD 活动日志（包括登录日志和审核日志）现在可通过 Microsoft 图形 API 提供。 我们通过 Microsoft 图形 API 公开了两个端点来访问这些日志。 请查看我们的[文档](https://docs.microsoft.com/azure/active-directory/active-directory-reporting-api-getting-started-azure-portal)，了解如何以编程方式访问入门所需的 Azure AD 报告 API。 
...
**及时兑换：** 使用 B2B API 与来宾用户共享资源后，无需发送特殊邀请电子邮件。 大多数情况下，来宾用户可以访问资源，并可及时获得兑换体验。 再也不会因错过电子邮件而受到影响。 不再询问您的访客用户"您是否点击了系统向您发送的兑换链接？ 这意味着，在 SPO 使用邀请管理器以后，云附件可以对所有用户（包括内部用户和外部用户）使用同一个规范的 URL，不管兑换状态如何。

**新式兑换体验：** 再也不会有拆分的屏幕兑换登陆页。 用户会看到包含邀请组织的隐私声明的新式许可体验，就像使用第三方应用一样。

**来宾用户可以离开组织：** 一旦用户与组织的关系结束，他们可以自行离开组织。 不再调用邀请组织管理员"删除"，不再提高支持票证。
...
[奖励斯普林](https://docs.microsoft.com/azure/active-directory/active-directory-saas-awardspring-tutorial)， Infogix Data360治理，[约德克](https://docs.microsoft.com/azure/active-directory/active-directory-saas-infogix-tutorial)， [Jamf Pro，](https://docs.microsoft.com/azure/active-directory/active-directory-saas-jamfprosamlconnector-tutorial)[知识猫头鹰](https://docs.microsoft.com/azure/active-directory/active-directory-saas-knowledgeowl-tutorial)，[环境MMIS，](https://docs.microsoft.com/azure/active-directory/active-directory-saas-envimmis-tutorial)[启动黑暗，](https://docs.microsoft.com/azure/active-directory/active-directory-saas-launchdarkly-tutorial) [Adobe Captivate Prime，](https://docs.microsoft.com/azure/active-directory/active-directory-saas-adobecaptivateprime-tutorial)[蒙太奇在线](https://docs.microsoft.com/azure/active-directory/active-directory-saas-montageonline-tutorial)， [*](https://docs.microsoft.com/azure/active-directory/active-directory-saas-manabipocket-tutorial)* * ， OpenReel， [Arc 出版 - SSO](https://docs.microsoft.com/azure/active-directory/active-directory-saas-arc-tutorial)，[计划网格](https://docs.microsoft.com/azure/active-directory/active-directory-saas-plangrid-tutorial)， [iWellnessnow，](https://docs.microsoft.com/azure/active-directory/active-directory-saas-iwellnessnow-tutorial)[代理点击](https://docs.microsoft.com/azure/active-directory/active-directory-saas-proxyclick-tutorial)，[风险软件](https://docs.microsoft.com/azure/active-directory/active-directory-saas-riskware-tutorial)， [Flock，](https://docs.microsoft.com/azure/active-directory/active-directory-saas-flock-tutorial)[评论快照](https://docs.microsoft.com/azure/active-directory/active-directory-saas-reviewsnap-tutorial)
...
有关如何部署 Azure 活动目录 （Azure AD） 的新分步指南，包括自助服务密码重置 （SSPR）、单一登录 （SSO）、条件访问 （CA）、应用代理、用户预配、活动目录联合服务 （ADFS） 到传递身份验证 （PTA） 和 ADFS 到密码哈希同步 （PHS）。
...
找不到应用程序/服务主体？ 我们增加了在“企业应用程序”下的“所有应用程序”列表中加载更多应用程序的功能。 默认显示 20 个应用程序。 您现在可以单击"**加载更多**"以查看其他应用程序。 
...
在 2018 年 4 月 25 日当天或以后创建的应用将不再能够使用 query response_mode 来请求 id_token********。  这样可以为 Azure AD 提供内联的 OIDC 规范，有助于减少应用的受攻击面。  在 2018 年 4 月 25 之前创建的应用可以将 query response_mode 与值为 id_token 的 response_type 配合使用********。  从 AAD 请求id_token时返回的错误为**AADSTS70007："查询"在请求令牌时不是"response_mode"的受支持值**。
...
### <a name="azure-ad-terms-of-use-now-has-per-user-reporting"></a>Azure AD 的使用条款现在具有每个用户报告
...
此 B2B 协作功能适用于所有 Azure 活动目录客户，可与 Azure AD 高级功能（如条件访问和标识保护）结合使用，以便更精细地控制外部业务用户登录和获取访问权限的时以及如何。
...
有关详细信息，请参阅在[Azure AD 中授予 B2B 用户访问本地应用程序](https://docs.microsoft.com/azure/active-directory/active-directory-b2b-hybrid-cloud-to-on-premises)。
...
### <a name="restrict-browser-access-using-intune-managed-browser-with-azure-ad-application-based-conditional-access-for-ios-and-android"></a>使用 Intune 托管浏览器限制浏览器访问，使用基于 Azure AD 应用程序的条件访问进行 iOS 和 Android 访问
...
**Intune 托管浏览器条件访问支持：** 现在，您可以要求员工使用基于应用程序的条件访问策略使用 Intune 托管浏览器。
...
### <a name="app-proxy-cmdlets-in-powershell-ga-module"></a>PowerShell GA 模块中的应用程序代理 Cmdlet

**类型：** 新功能  
**服务类别：** 应用代理  
**产品功能：** 访问控制
 
支持应用程序代理 cmdlet 现在位于 PowerShell GA 模块中！ 这确实需要您在 PowerShell 模块上保持更新 - 如果您落后一年多，一些 cmdlet 可能会停止工作。 
...
有关详细信息，请参阅[使用无缝 SSO 的本机客户端上的登录如何工作？](https://docs.microsoft.com/azure/active-directory/connect/active-directory-aadconnect-sso-how-it-works#how-does-sign-in-on-a-native-client-with-seamless-sso-work)
...
有关详细信息，请参阅[Azure 活动目录无缝单一登录](https://docs.microsoft.com/azure/active-directory/connect/active-directory-aadconnect-sso)。 
...
有关详细信息，请参阅[Azure 活动目录中组的动态成员资格规则](https://docs.microsoft.com/azure/active-directory/users-groups-roles/groups-dynamic-membership)
...
作为客户反馈的一部分，使非管理员角色能够访问 Azure AD 活动日志，我们启用了处于"报表读取器"角色的用户访问 Azure 门户中的登录和审核活动以及使用 Microsoft 图形 API 的能力。 
...
### <a name="applications-supporting-intune-app-protection-policies-added-for-use-with-azure-ad-application-based-conditional-access"></a>支持 Intune 应用保护策略的应用程序添加，以便与基于 Azure AD 应用程序的条件访问一起使用
...
显示使用条款时，现在可以单击"**查看时遇到问题？"点击这里**。 单击此链接会在设备本地打开使用条款。 不管文档中的字体大小或设备屏幕大小如何，都可以根据需要进行缩放，以方便阅读文档。 
...
检测到的风险检测的见解与 Azure AD 订阅相关联。 使用 Azure AD Premium P2 版本时，可以获取有关所有基础检测的最详细的信息。

使用 Azure AD 高级 P1 版本，许可证未涵盖的检测显示为风险检测登录，并检测到其他风险。
...
在过渡到新管理控制台的过程中，有 2 个新 API 可用于检索 Azure AD 活动日志。 新的 API 集提供更丰富的筛选和排序功能，此外还提供更丰富的审核和登录活动。 以前通过安全报告提供的数据现在可以通过 Microsoft Graph 中的标识保护风险检测 API 进行访问。
...
现在，您可以使用[基于 Azure AD 应用的条件访问](https://docs.microsoft.com/azure/active-directory/conditional-access/app-based-conditional-access)，将对 Office 365 和其他 Azure AD 连接的云应用的访问限制为支持 Intune 应用保护策略[的已批准客户端应用](https://docs.microsoft.com/azure/active-directory/conditional-access/concept-conditional-access-conditions#client-apps-preview)。 Intune 应用保护策略用于配置和保护这些客户端应用程序中的公司数据。

通过将[基于应用](https://docs.microsoft.com/azure/active-directory/conditional-access/app-based-conditional-access)的条件访问策略与[基于设备](https://docs.microsoft.com/azure/active-directory/active-directory-conditional-access-policy-connected-applications)的条件访问策略相结合，您可以灵活地保护个人和公司设备的数据。
...
有关详细信息，请参阅基于[Azure AD 应用的条件访问](https://docs.microsoft.com/azure/active-directory/conditional-access/app-based-conditional-access)。
...
现在，您可以在 Azure AD 条件访问策略中包括（或排除）macOS 作为设备平台条件。 通过将 macOS 添加到支持的设备平台，可以：
...
- **只允许符合条件的 macOS 设备访问 Azure AD 中的应用程序。** 条件访问策略创作将 macOS 作为单独的设备平台选项。 现在，您可以为 Azure 中的目标应用程序集编写特定于 macOS 的条件访问策略。
...
1. 在 Azure AD 管理中心中，在 **"管理**"部分中选择[所有用户](https://aad.portal.azure.com/#blade/Microsoft_AAD_IAM/UserManagementMenuBlade/All)。 
...
现在，您可以将"OR"（需要其中一个选定控件）用于条件访问控件。 可以使用此功能创建在访问控制条件之间包含“OR”的策略。 例如，可以使用此功能创建一个策略，要求用户使用多重身份验证登录，或要求用户在符合条件的设备上操作。

有关详细信息，请参阅[Azure AD 条件访问 中的控件](https://docs.microsoft.com/azure/active-directory/active-directory-conditional-access-controls)。
...
在 Azure AD 标识保护中，现在针对每种风险检测类型聚合源自给定日相同 IP 地址的所有实时风险检测。 此更改限制了显示的风险检测量，而用户安全性没有任何变化。
...
**可用功能**
 ...
 在过渡到新管理控制台的过程中，有两个新 API 可用于检索 Azure AD 活动日志。 新的 API 集提供更丰富的筛选和排序功能，此外还提供更丰富的审核和登录活动。 以前通过安全报告提供的数据现在可以通过 Microsoft Graph 中的标识保护风险检测 API 进行访问。
