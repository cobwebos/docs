...
|targetResources|包括顶层的 **TargetResourceType**。|&nbsp;|<ul><li>策略</li><li>应用</li><li>User</li><li>组</li></ul>|
...
有关 Azure AD 库中支持用户预配的所有应用程序的列表，请[https://aka.ms/appstutorial](https://aka.ms/appstutorial)参阅。
