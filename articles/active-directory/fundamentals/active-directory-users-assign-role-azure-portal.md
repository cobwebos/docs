...
> [!Note]
> 如果有 Azure AD Premium P2 许可计划并已使用 PIM，则所有角色管理任务都将在 [Privileged Identity Management 体验](../users-groups-roles/directory-manage-roles-portal.md)中执行。 此功能当前限制为一次只分配一个角色。 目前不能选择多个角色并同时将其分配给用户。
>
