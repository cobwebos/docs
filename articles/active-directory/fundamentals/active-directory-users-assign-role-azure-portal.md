...
有关可用角色的详细信息，请参阅[在 Azure 活动目录中分配管理员角色](../users-groups-roles/directory-assign-admin-roles.md)。 有关添加用户的详细信息，请参阅[将新用户添加到 Azure Active Directory](add-users-azure-active-directory.md)。
...
1. 转到 [Azure 门户](https://portal.azure.com/)，并使用目录的全局管理员帐户登录。 
...
4. 搜索并选择获得角色分配的用户。 例如，Alain Charon__。
...
6. 选择“添加分配”****，选择要分配给 Alain 的角色（例如“应用程序管理员”__），然后选择“选择”****。
...
1. 选择“Azure Active Directory”，选择“用户”，然后搜索并选择删除分配了角色的用户********。 例如，Alain Charon__。
