...
本指南还将允许管理员以安全受保护的方式配置对 SaaS 和本地应用程序的访问权限，并且适用于云或混合 (同步) 标识，适用于远程工作或在办公室工作的用户。
...
| [将支持的 SaaS 应用程序从库集成到 Azure AD 并启用单一登录](../manage-apps/add-application-portal.md) | Azure AD 的某个库包含数千个预先集成的应用程序。 组织使用的某些应用程序可能就在该库中。可通过 Azure 门户直接访问该库。 提供对企业 SaaS 应用程序的远程访问，并通过改进的用户体验 (SSO)  |
