...
---
# <a name="getting-started-with-azure-active-directory-reporting"></a>Azure Active Directory Reporting 入门
...
### <a name="reporting-pipeline"></a>报告管道
...
### <a name="sign-into-the-azure-classic-portal"></a>登录 Azure 经典门户
...
### <a name="download-the-reports-as-csv"></a>将报表下载为 CSV 文件
...
### <a name="customize-alerts-for-anomalous-sign-in-activity"></a>针对异常登录活动自定义警报
导航到目录的“配置”选项卡。
