...
4. 在搜索框中，键入“Sansan”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-sansan-tutorial/tutorial_sansan_search.png)

5. 在结果面板中，选择“Sansan”，并单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-sansan-tutorial/tutorial_sansan_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-sansan-tutorial/tutorial_sansan_samlbase.png)

3. 在“Sansan 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-sansan-tutorial/tutorial_sansan_url.png)
    ...
    > [!NOTE] 
    > 这些不是实际值。 必须使用实际登录 URL 和标识符更新这些值。 请联系 [Sansan 客户端支持团队](https://www.sansan.com/form/contact)获取这些值。 

4. 在“SAML 签名证书”部分中，单击“证书(Base64)”，然后在计算机上保存证书文件。

    ![配置单一登录](./media/active-directory-saas-sansan-tutorial/tutorial_sansan_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录](./media/active-directory-saas-sansan-tutorial/tutorial_general_400.png)

6. 在“Sansan 配置”部分中，单击“配置 Sansan”，打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![配置单一登录](./media/active-directory-saas-sansan-tutorial/tutorial_sansan_configure.png) 

7. 若要在 Sansan 端配置单一登录，需要将下载的证书、注销 URL、SAML 实体 ID 和 SAML 单一登录服务 URL 发送给 [Sansan 支持团队](https://www.sansan.com/form/contact)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-sansan-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-sansan-tutorial/create_aaduser_02.png) 
...
2. 在应用程序列表中，选择“Sansan”。
    ...
    ![配置单一登录](./media/active-directory-saas-sansan-tutorial/tutorial_sansan_app.png) 
