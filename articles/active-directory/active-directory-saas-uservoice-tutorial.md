...
5. 在“要执行什么操作”对话框中，单击“从库中添加应用程序”。
    ...
    ![从库添加应用程序](./media/active-directory-saas-uservoice-tutorial/IC749322.png "从库添加应用程序")
...
3. 在“配置应用 URL”页上的“UserVoice 登录 URL”文本框中，使用以下模式“https://\<tenant-name\>.UserVoice.com”键入 URL，然后单击“下一步”。
    ...
    ![配置应用 URL](./media/active-directory-saas-uservoice-tutorial/IC777517.png "配置应用 URL")
