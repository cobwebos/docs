...
- 可使用户通过其 Azure AD 帐户自动登录 SpaceIQ（单一登录）。
...
4. 在搜索框中，键入“SpaceIQ”，在结果面板中选择“SpaceIQ”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 SpaceIQ](./media/active-directory-saas-spaceiq-tutorial/tutorial_spaceiq_addfromgallery.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分中，基于一个名为“Britta Simon”的测试用户配置和测试 SpaceIQ 的 Azure AD 单一登录。

若要运行单一登录，Azure AD 需要知道与 Azure AD 用户相对应的 SpaceIQ 用户。 换句话说，需要在 Azure AD 用户与 SpaceIQ 中的相关用户之间建立链接关系。

通过将 Azure AD 中“用户名”的值指定为 SpaceIQ 中“用户名”的值来建立此链接关系。

若要配置和测试 SpaceIQ 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
3. [创建 SpaceIQ 测试用户](#create-a-spaceiq-test-user) - 在 SpaceIQ 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[测试单一登录](#test-single-sign-on)** - 验证配置是否正常工作。

### <a name="configure-azure-ad-single-sign-on"></a>配置 Azure AD 单一登录

在本部分中，将在 Azure 门户中启用 Azure AD 单一登录并在 SpaceIQ 应用程序中配置单一登录。

**若要配置 SpaceIQ 的 Azure AD 单一登录，请执行以下步骤：**

1. 在 Azure 门户中的“SpaceIQ”应用程序集成页上，单击“单一登录”。

    ![配置单一登录链接][4]

2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
 
    ![“单一登录”对话框](./media/active-directory-saas-spaceiq-tutorial/tutorial_spaceiq_samlbase.png)

3. 在“SpaceIQ 域和 URL”部分中，执行以下步骤：

    ![SpaceIQ 域和 URL 单一登录信息](./media/active-directory-saas-spaceiq-tutorial/tutorial_spaceiq_url.png)
...
4. 在“SAML 签名证书”部分中，单击“证书(Base64)”，并在计算机上保存证书文件。
    ...
    ![证书下载链接](./media/active-directory-saas-spaceiq-tutorial/tutorial_spaceiq_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/active-directory-saas-spaceiq-tutorial/tutorial_general_400.png)

6. 在“SpaceIQ 配置”部分，单击“配置 SpaceIQ”打开“配置登录”窗口。 从“快速参考”部分复制“SAML 实体 ID”。

    ![SpaceIQ 配置](./media/active-directory-saas-spaceiq-tutorial/tutorial_spaceiq_configure.png) 

7.  打开一个新的浏览器窗口，并以管理员身份登录到 SpaceIQ 环境。

8. 登录后，单击右上角的拼图标志，然后单击“集成”

    ![帐户设置](./media/active-directory-saas-spaceiq-tutorial/setting1.png) 

9. 在“所有预配和 SSO”下，单击 Azure 磁贴，添加 Azure 实例作为 IDP。

    ![SAML 图标](./media/active-directory-saas-spaceiq-tutorial/setting2.png)

10. 在“SSO”对话框中，执行以下步骤：

    ![SAML 身份验证设置](./media/active-directory-saas-spaceiq-tutorial/setting3.png)
    ...
    c. 在 SpaceIQ“域和网URL”部分下，复制“SAML 受众 URL (只读)”值，并将该值粘贴到 Azure 门户的“标识符”框中。

    d.单击“下一步”。 在记事本中打开下载的证书文件，复制其内容，然后将其粘贴到“X.509 证书”框中。
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-spaceiq-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-spaceiq-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-spaceiq-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-spaceiq-tutorial/create_aaduser_04.png)
...
### <a name="create-a-spaceiq-test-user"></a>创建 SpaceIQ 测试用户
...
**若要将 Britta Simon 分配到 SpaceIQ，请执行以下步骤：**
...
2. 在应用程序列表中，选择“SpaceIQ”。
    ...
    ![应用程序列表中的 SpaceIQ 链接](./media/active-directory-saas-spaceiq-tutorial/tutorial_spaceiq_app.png)  
