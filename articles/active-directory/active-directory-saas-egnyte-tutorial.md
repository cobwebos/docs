...
- 可在 Azure AD 中控制谁有权访问 Egnyte
- 可以让用户使用其 Azure AD 帐户自动登录到 Egnyte（单一登录）
...
4. 在搜索框中，键入“Egnyte”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-egnyte-tutorial/tutorial_egnyte_search.png)

5. 在结果窗格中，选择“Egnyte”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-egnyte-tutorial/tutorial_egnyte_addfromgallery.png)
...
可通过将 Azure AD 中“用户名”的值指定为 Egnyte 中“用户名”的值来建立此链接关系。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-egnyte-tutorial/tutorial_egnyte_samlbase.png)

3. 在“Egnyte 域和 URL”部分中，请执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-egnyte-tutorial/tutorial_egnyte_url.png)
...
5. 单击“保存”按钮。
    ...
    ![配置单一登录](./media/active-directory-saas-egnyte-tutorial/tutorial_general_400.png)

6. 在“Egnyte 配置”部分，单击“配置 Egnyte”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 实体 ID 和 SAML 单一登录服务 URL”。

    ![配置单一登录](./media/active-directory-saas-egnyte-tutorial/tutorial_egnyte_configure.png) 
...
11. 在“单一登录身份验证”部分中，执行以下步骤：
    ...
    d. 将从 Azure 门户复制的“SAML 实体 ID”粘贴到“标识提供者实体 ID”文本框中。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-egnyte-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-egnyte-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-egnyte-tutorial/create_aaduser_03.png) 
...
2. 在应用程序列表中，选择“Egnyte”。
    ...
    ![配置单一登录](./media/active-directory-saas-egnyte-tutorial/tutorial_egnyte_app.png) 
