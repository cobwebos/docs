...
本教程的目的是展示如何将 eDigitalResearch 与 Azure Active Directory (Azure AD) 进行集成。

将 eDigitalResearch 与 Azure AD 集成可提供以下优势：

* 可以在 Azure AD 中控制谁有权访问 eDigitalResearch
* 可以让用户使用其 Azure AD 帐户自动登录到 eDigitalResearch 单一登录 (SSO)
...
若要配置 eDigitalResearch 与 Azure AD 的集成，需要从库中将 eDigitalResearch 添加到托管 SaaS 应用列表。
...
5. 在“要执行什么操作”对话框中，单击“从库中添加应用程序”。
    ...
    ![应用程序][4]
6. 在搜索框中，键入“eDigitalResearch”。
   
    ![创建 Azure AD 测试用户](./media/active-directory-saas-edigitalresearch-tutorial/tutorial_edigitalresearch_01.png)
7. 在结果窗格中，选择“eDigitalResearch”，然后单击“完成”以添加该应用程序。
   
    ![在库中选择应用](./media/active-directory-saas-edigitalresearch-tutorial/tutorial_edigitalresearch_0001.png)

## <a name="configure-and-test-microsoft-azure-ad-sso"></a>配置和测试 Microsoft Azure AD SSO
本部分的目的是说明如何基于名为“Britta Simon”的测试用户配置和测试 eDigitalResearch 的 Microsoft Azure AD SSO。

若要运行 SSO，Azure AD 需要知道与 Azure AD 用户相对应的 eDigitalResearch 用户。 换句话说，需要在 Azure AD 用户与 eDigitalResearch 中的相关用户之间建立链接关系。

可以通过将 Azure AD 中“用户名”的值分配为 eDigitalResearch 中“用户名”的值来建立此链接关系。

若要配置和测试 eDigitalResearch 的 Microsoft Azure AD SSO，需要完成以下构建基块：
...
3. **[创建 eDigitalResearch 测试用户](#creating-a-edigitalresearch-test-user)** - 在 eDigitalResearch 中创建 Britta Simon 的对应用户，将其链接到其 Azure AD 表示形式。
...
在本部分中，将在经典门户中启用 Microsoft Azure AD SSO，并在 eDigitalResearch 应用程序中配置 SSO。

**若要配置 eDigitalResearch 的 Microsoft Azure AD 单一登录，请执行以下步骤：**

1. 在经典门户中，在 **eDigitalResearch** 应用程序集成页上，单击“配置单一登录”，以打开“配置单一登录”对话框。
   
    ![配置单一登录][6] 
2. 在“你希望用户如何登录到 eDigitalResearch”页上，选择“Microsoft Azure AD 单一登录”，然后单击“下一步”。
   
    ![配置单一登录](./media/active-directory-saas-edigitalresearch-tutorial/tutorial_edigitalresearch_03.png) 
3. 在“配置应用设置”对话框页上，执行以下步骤，然后单击“下一步”：
   
    ![配置单一登录](./media/active-directory-saas-edigitalresearch-tutorial/tutorial_edigitalresearch_04.png)
  1. 在“回复 URL”文本框中，使用以下模式键入 URL：`https://<company name>.edigitalresearch.com/login/consume` 
  2. 单击“资源组名称” 的 Azure 数据工厂。
   
   >[!NOTE]
   >在本教程中，“回复 URL”的值只是一个占位符。 若要为你的环境获取实际值，请联系 eDigitalResearch。
   > 
   > 
4. 在“在 eDigitalResearch 处配置单一登录”页上，执行以下步骤并单击“下一步”：
...
4. 若要打开“添加用户”对话框，请在底部工具栏中单击“添加用户”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-edigitalresearch-tutorial/create_aaduser_04.png)
...
请与 eDigitalResearch 支持团队合作来创建用户。

### <a name="assign-the-azure-ad-test-user"></a>分配 Azure AD 测试用户
本部分旨在通过授予 Britta Simon 访问 eDigitalResearch 的权限，允许她使用 Azure SSO。
...
2. 在应用程序列表中，选择“eDigitalResearch”。
    ...
    ![配置单一登录](./media/active-directory-saas-edigitalresearch-tutorial/tutorial_edigitalresearch_50.png)
3. 在顶部菜单中，单击“用户”。
