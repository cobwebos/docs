...
本部分的目的是基于名为“Britta Simon”的测试用户展示如何配置并测试 eDigitalResearch 的 Microsoft Azure AD 单一登录。
...
若要配置并测试 eDigitalResearch 的 Microsoft Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Microsoft Azure AD 单一登录](#configuring-azure-ad-single-single-sign-on)** - 让用户能够使用此功能。
...
在本部分中，将在经典门户中启用 Microsoft Azure AD 单一登录并在 eDigitalResearch 应用程序中配置单一登录。
...
### <a name="creating-a-edigitalresearch-test-user"></a>创建 eDigitalResearch 测试用户
本部分的目的是在 eDigitalResearch 中创建名为 Britta Simon 的用户。 

请与 eDigitalResearch 支持团队合作来创建用户。

### <a name="assigning-the-azure-ad-test-user"></a>分配 Azure AD 测试用户
本部分的目的是通过向 Britta Simon 授予对 eDigitalResearch 的访问权限，使她能够使用 Azure 单一登录。
