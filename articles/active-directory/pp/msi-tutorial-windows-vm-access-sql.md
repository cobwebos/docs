...
创建组并将 VM MSI 添加到成员身份后，可使用以下步骤[配置 SQL 服务器的 Azure AD 身份验证](~/articles/sql-database/sql-database-aad-authentication-configure.md#provision-an-azure-active-directory-administrator-for-your-azure-sql-server)：
