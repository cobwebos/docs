...
此外，如果你尚未安装，请安装[最新版本的 Azure PowerShell](https://www.powershellgallery.com/packages/AzureRM)（版本 4.3.1 或更高版本）。
...
1. 请参阅以下 Azure VM 快速入门之一，仅完成必要部分（“登录到 Azure”、“创建资源组”、“创建网络组”、“创建 VM”）。 
   ...
   - [使用 PowerShell 创建 Windows 虚拟机](~/articles/virtual-machines/windows/quick-create-powershell.md)
   - [使用 PowerShell 创建 Linux 虚拟机](~/articles/virtual-machines/linux/quick-create-powershell.md)
