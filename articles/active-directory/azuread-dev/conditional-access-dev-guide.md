...
假定为[单租户和多租户](../develop/howto-convert-app-to-be-multi-tenant.md?toc=/azure/active-directory/azuread-dev/toc.json&bc=/azure/active-directory/azuread-dev/breadcrumb/toc.json)应用以及[常见身份验证模式](v1-authentication-scenarios.md)的知识。
