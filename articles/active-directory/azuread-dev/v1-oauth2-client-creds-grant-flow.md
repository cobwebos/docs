...
#### <a name="example"></a>示例
以下 HTTP POST 请求 [ Web 服务的](../develop/access-tokens.md?toc=/azure/active-directory/azuread-dev/toc.json&bc=/azure/active-directory/azuread-dev/breadcrumb/toc.json)访问令牌 https://service.contoso.com/。 `client_id` 标识请求访问令牌的 Web 服务。
