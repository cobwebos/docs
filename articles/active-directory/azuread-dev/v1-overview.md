...
- [身份验证基础知识](v1-authentication-scenarios.md)介绍如何使用 Azure AD 进行身份验证。
...
- [术语表](../develop/developer-glossary.md?toc=/azure/active-directory/azuread-dev/toc.json&bc=/azure/active-directory/azuread-dev/breadcrumb/toc.json)本文档中使用的术语和单词的定义。
