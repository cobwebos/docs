...
1. 在 `Multi-Tenanted`Azure 门户`Yes`中，将应用程序注册信息中的 [ 属性设置为 ](https://portal.azure.com/#blade/Microsoft_AAD_IAM/ActiveDirectoryMenuBlade/RegisteredApps)。 默认情况下，在 Azure 门户中创建的应用程序将配置为*单租户[。](#single-tenant-applications)*
