...
4. 在搜索框中键入 **Work.com**，在结果面板中选择“Workrite”，并单击“添加”按钮添加该应用程序。
    ...
    ![从库添加](./media/active-directory-saas-work-com-tutorial/tutorial_work-com_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![基于 SAML 的登录](./media/active-directory-saas-work-com-tutorial/tutorial_work-com_samlbase.png)

3. 在“Work.com 域和 URL”部分中，执行以下步骤：

    ![“Work.com 域和 URL”部分](./media/active-directory-saas-work-com-tutorial/tutorial_work-com_url.png)
...
5. 单击“保存”按钮。
    ...
    ![保存按钮](./media/active-directory-saas-work-com-tutorial/tutorial_general_400.png)

6. 在“Work.com 配置”部分，单击“配置 Work.com”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![“Work.com 配置”部分](./media/active-directory-saas-work-com-tutorial/tutorial_work-com_configure.png) 
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-work-com-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![“用户和组”->“所有用户”](./media/active-directory-saas-work-com-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![添加](./media/active-directory-saas-work-com-tutorial/create_aaduser_03.png) 

4. 在“用户”对话框页上，执行以下步骤：
 
    ![“用户”对话框页](./media/active-directory-saas-work-com-tutorial/create_aaduser_04.png) 
...
5. 在“编辑用户”部分，在要预配到相关文本框的有效 Azure AD 帐户的属性中执行以下步骤：
    ...
    d.单击“下一步”。 在“电子邮件”文本框中，键入用户的**电子邮件地址**（例如 **Brittasimon@contoso.com**）。
    
    e.在“新建 MySQL 数据库”边栏选项卡中，接受法律条款，并单击“确定”。 在“用户名”文本框中，键入用户的用户名（例如 **Brittasimon@contoso.com**）。
...
2. 在应用程序列表中，选择“Work.com”。
    ...
    ![应用列表中的 Work.com](./media/active-directory-saas-work-com-tutorial/tutorial_work-com_app.png) 
