...
本教程的目的是说明如何将 HR2day by Merces 与 Azure Active Directory (Azure AD) 集成。  
...
6. 在搜索框中，键入“HR2day by Merces”。
   
    ![创建 Azure AD 测试用户](./media/active-directory-saas-hr2day-tutorial/tutorial_hr2day_01.png)

7. 在结果窗格中，选择“HR2day by Merces”，然后单击“完成”以添加该应用程序。

## <a name="configuring-and-testing-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录
本部分的目的是说明如何基于一个名为“Britta Simon”的测试用户使用 HR2day by Merces 配置和测试 Azure AD 单一登录。

若要运行单一登录，Azure AD 需要知道与 Azure AD 用户相对应的 HR2day by Merces 用户。 换句话说，需要在 Azure AD 用户与 HR2day by Merces 中相关用户之间建立链接关系。  
通过将 Azure AD 中“用户名”的值分配为 HR2day by Merces 中“用户名”的值来建立此链接关系。
...
3. **[创建 HR2day by Merces 测试用户](#creating-a-hr2day-by-merces-test-user)** - 在 HR2day by Merces 中创建 Britta Simon 的对应者，链接到她的 Azure AD 表示形式。
4. **[分配 Azure AD 测试用户](#assigning-the-azure-ad-test-user)** - 让 Britta Simon 使用 Azure AD 单一登录。
5. **[测试单一登录](#testing-single-sign-on)** - 验证配置是否正常工作。

### <a name="configuring-azure-ad-single-sign-on"></a>配置 Azure AD 单一登录
本部分的目的是概述如何让用户使用基于 SAML 协议的联合身份验证通过他们在 Azure AD 中的帐户向 HR2day by Merces 进行身份验证。
...
在配置 SAML 断言前，需要通过 [servicedesk@merces.nl](mailto:servicedesk@merces.nl) 联系 HR2day 支持团队，并为租户请求唯一标识符属性值。 需要此值才能完成下一部分中的步骤。

**若要使用 HR2day by Merces 配置 Azure AD 单一登录，请执行以下步骤：**

1. 在 Azure 经典门户中的“HR2day by Merces”应用程序集成页上，单击顶部菜单中的“属性”，打开“SAML 令牌属性”对话框。 
...
2. 若要添加所需的属性映射，请执行以下步骤： 
    ...
    d.单击“下一步”。 从“String1”列表中，选择“User.mail”。 

    e.在“新建 MySQL 数据库”边栏选项卡中，接受法律条款，然后单击“确定”。 在“String2”文本框中，键入 HR2day 团队提供的**唯一标识符**。 
...
2. 在顶部菜单中，单击“快速启动”，打开“快速启动”对话框。
   
    ![配置单一登录](./media/active-directory-saas-hr2day-tutorial/tutorial_general_08.png) 

3. 单击“配置单一登录”，打开“配置单一登录”对话框。
   
    ![配置单一登录][6] 

4. 在“你希望用户如何登录 HR2day by Merces”页上，选择“Azure AD 单一登录”，然后单击“下一步”。
...
1. 在 **Azure 经典门户**中，在左侧导航窗格上，单击“Active Directory”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-hr2day-tutorial/create_aaduser_09.png) 
...
5. 在“告诉我们有关此用户的信息”对话框页上，执行以下步骤：
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-hr2day-tutorial/create_aaduser_05.png) 
...
6. 在“用户配置文件”对话框页上，执行以下步骤：
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-hr2day-tutorial/create_aaduser_06.png) 
...
7. 在“获取临时密码”对话框页上，单击“创建”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-hr2day-tutorial/create_aaduser_07.png) 

8. 在“获取临时密码”对话框页上，执行以下步骤：
   
    ![创建 Azure AD 测试用户](./media/active-directory-saas-hr2day-tutorial/create_aaduser_08.png) 
   
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 写下“新密码”的值。
   
    b. 单击“完成”。   

### <a name="creating-a-hr2day-by-merces-test-user"></a>创建 HR2day by Merces 测试用户
本部分的目的是在 HR2day by Merces 中创建名为“Britta Simon”的用户。 请与 HR2day by Merces 支持团队协作，将用户添加到 HR2day 帐户中。 

> [!NOTE]
> 如果需要手动创建用户，则需要联系 HR2day by Merces 支持团队。
> 
> 

### <a name="assigning-the-azure-ad-test-user"></a>分配 Azure AD 测试用户
本部分的目的是通过授予 Britta Simon 访问 HR2day by Merces 的权限，允许她使用 Azure 单一登录。
