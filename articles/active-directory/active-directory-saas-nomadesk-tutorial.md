...
4. 在搜索框中，键入“Nomadesk”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-nomadesk-tutorial/tutorial_nomadesk_search.png)

5. 在结果窗格中，选择“Nomadesk”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-nomadesk-tutorial/tutorial_nomadesk_addfromgallery.png)
...
7. 若要在 Nomadesk 端配置单一登录，需要将下载的证书、注销 URL、SAML 实体 ID 和 SAML 单一登录服务 URL 发送给 [Nomadesk 支持团队](mailto:support@nomadesk.com)。 他们会对此进行设置，使 SAML SSO 连接在两端均正确设置。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-nomadesk-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-nomadesk-tutorial/create_aaduser_02.png) 
