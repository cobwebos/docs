---
title: "教程： 与 Abintegro 的 Azure Active Directory 集成 |Microsoft 文档"
description: "了解如何配置单一登录 Azure Active Directory 与 Abintegro 之间。"
...
在本教程中，你将学习如何与 Azure Active Directory (Azure AD) 集成 Abintegro。

与 Azure AD 集成 Abintegro 提供了以下好处：

- 你可以控制有权访问 Abintegro 的 Azure AD 中
- 你可以使用户可以自动获取登录到 Abintegro （上单一登录） 使用其 Azure AD 帐户
...
若要配置与 Abintegro 的 Azure AD 集成，你需要以下各项：
...
若要配置到 Azure AD Abintegro 的集成，你需要将 Abintegro 从库添加到你的托管的 SaaS 应用的列表。
...
4. 在搜索框中，键入**Abintegro**。
    ...
    ![创建一个 Azure AD 的测试用户](./media/active-directory-saas-abintegro-tutorial/tutorial_abintegro_search.png)

5. 在结果面板中，选择**Abintegro**，然后单击**添加**按钮以添加该应用程序。

    ![创建一个 Azure AD 的测试用户](./media/active-directory-saas-abintegro-tutorial/tutorial_abintegro_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录
在本部分中，可以配置和测试 Azure AD 单一登录与 Abintegro 基于一个名为"Britta 人 Simon。"的测试用户

对于单一登录工作，Azure AD 需要知道什么对应项中的用户 Abintegro 是向用户在 Azure AD 中。 换而言之，Azure AD 用户和 Abintegro 中的相关的用户之间的链接关系需要建立。

在 Abintegro，将分配的值**用户名**作为的值的 Azure AD 中**用户名**建立的链接关系。

若要配置和测试 Azure AD 单一登录与 Abintegro，你需要完成以下构建基块：
...
3. **[创建一个 Abintegro 的测试用户](#creating-an-abintegro-test-user)** -若要链接到用户的 Azure AD 表示的 Abintegro 中具有 Britta 人 Simon 的副本。
...
在本部分中，可以将 Azure AD 单一登录 Azure 门户中启用和配置单一登录 Abintegro 应用程序中。

**若要配置 Azure AD 单一登录与 Abintegro，请执行以下步骤：**

1. 在 Azure 门户中，在**Abintegro**应用程序集成页上，单击**单一登录**。

    ![配置单一登录][4]

2. 上**单一登录**对话框中，选择**模式**作为**SAML 基于登录**若要启用单一登录。
 
    ![配置单一登录](./media/active-directory-saas-abintegro-tutorial/tutorial_abintegro_samlbase.png)

3. 上**Abintegro 域和 Url**部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-abintegro-tutorial/tutorial_abintegro_url.png)

    在**登录 URL**文本框中，键入 URL 使用以下模式：`https://dev.abintegro.com/Shibboleth.sso/Login?entityID=<Issuer>&target=https://dev.abintegro.com/secure/`

    > [!NOTE] 
    > 此值不是真实的。 更新此值替换为实际的登录 URL。 联系人[Abintegro 客户端支持团队](mailto:support@abintegro.com)获取此值。 
 
4. 上**SAML 签名证书**部分中，单击**元数据 XML**然后将保存您的计算机上的元数据文件。

    ![配置单一登录](./media/active-directory-saas-abintegro-tutorial/tutorial_abintegro_certificate.png) 

5. 单击**保存**按钮。

    ![配置单一登录](./media/active-directory-saas-abintegro-tutorial/tutorial_general_400.png)

6. 在上配置单一登录**Abintegro**端，你需要发送下载**元数据 XML**到[Abintegro 支持团队](mailto:support@abintegro.com)。 设置此设置以让 SAML SSO 连接两端正确设置它们。
...
1. 在**Azure 门户**，左侧的导航窗格中，单击**Azure Active Directory**图标。
    ...
    ![创建一个 Azure AD 的测试用户](./media/active-directory-saas-abintegro-tutorial/create_aaduser_01.png) 

2. 若要显示的用户的列表，请转到**用户和组**单击**所有用户**。
    
    ![创建一个 Azure AD 的测试用户](./media/active-directory-saas-abintegro-tutorial/create_aaduser_02.png) 

3. 若要打开**用户**对话框中，单击**添加**对话框顶部。
 
    ![创建一个 Azure AD 的测试用户](./media/active-directory-saas-abintegro-tutorial/create_aaduser_03.png) 

4. 上**用户**对话框页上，执行以下步骤：
 
    ![创建一个 Azure AD 的测试用户](./media/active-directory-saas-abintegro-tutorial/create_aaduser_04.png) 
...
### <a name="creating-an-abintegro-test-user"></a>创建一个 Abintegro 的测试用户

没有为你用于配置用户设置到 Abintegro 操作项。 当分配的用户尝试登录到 Abintegro 使用访问面板时，Abintegro 将会检查该用户是否存在。
  
如果存在尚没有用户帐户可用，它将自动创建 Abintegro。

### <a name="assigning-the-azure-ad-test-user"></a>分配 Azure AD 测试用户

在此部分中，你将启用 Britta 人 Simon 用于通过到 Abintegro 授予访问 Azure 单一登录。

![将用户分配][200] 

**若要将 Britta 人 Simon 分配到 Abintegro，请执行以下步骤：**
...
2. 在应用程序列表中，选择**Abintegro**。
    ...
    ![配置单一登录](./media/active-directory-saas-abintegro-tutorial/tutorial_abintegro_app.png) 
...
当你单击访问面板中的 Abintegro 磁贴时，应获取 Abintegro 应用程序登录页。
