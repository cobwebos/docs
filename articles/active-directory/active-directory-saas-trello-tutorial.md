...
4. 在搜索框中，键入“Trello”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-trello-tutorial/tutorial_trello_search.png)

5. 在结果面板中，选择“Trello”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-trello-tutorial/tutorial_trello_addfromgallery.png)
...
3. **[创建 Trello 测试用户](#creating-a-trello-test-user)** - 以在 Trello 中具有对应的 Britta Simon 用户，该用户与 Azure AD 中表示 Britta Simon 的用户相关联。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-trello-tutorial/tutorial_trello_samlbase.png)

3. 在“Trello 域和 URL”部分中，如果要在“IDP 发起的模式”下配置应用程序，请执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-trello-tutorial/tutorial_trello_url.png)
...
4. 在“Trello 域和 URL”部分中，如果要在“SP 发起的模式”下配置应用程序，请执行以下步骤：
    ...
    b.在“磁贴徽标”下面，选择“删除上传的徽标”。 在“登录 URL”文本框中，使用以下模式键入 URL：`https://trello.com/auth/saml/consume/<enterprise>`
...
5. Trello 应用程序需要 SAML 断言包含特定属性。 请为此应用程序配置以下属性。 可从应用程序的“用户属性”下管理这些属性的值。 以下屏幕截图显示一个示例。
    ...
    ![配置单一登录](./media/active-directory-saas-trello-tutorial/tutorial_trello_attribute.png)
...
6. 在“SAML 令牌属性”对话框中，对于下表中显示的每个行，执行以下步骤：
    ...
    ![配置单一登录](./media/active-directory-saas-trello-tutorial/tutorial_officespace_04.png)

    ![配置单一登录](./media/active-directory-saas-trello-tutorial/tutorial_officespace_05.png)
...
7. 在“SAML 签名证书”部分中，单击“证书(Base64)”，然后在计算机上保存证书文件。
    ...
    ![配置单一登录](./media/active-directory-saas-trello-tutorial/tutorial_trello_certificate.png) 

8. 单击“保存”按钮。

    ![配置单一登录](./media/active-directory-saas-trello-tutorial/tutorial_general_400.png)

6. 在“Trello 配置”部分，单击“配置 Trello”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 单一登录服务 URL”

    ![配置单一登录](./media/active-directory-saas-trello-tutorial/tutorial_trello_configure.png) 

9. 若要为应用程序配置 SSO，请转到 [Trello 企业 SSO 配置](https://trello.com/sso-configuration)页，向 [Trello 支持团队](mailto:support@trello.com)发送 SAML 单一登录服务 URL 并附加证书 (Base64)。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-trello-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-trello-tutorial/create_aaduser_02.png) 
...
在本部分中，将在 Trello 中创建一个名为“Britta Simon”的用户。 在本部分中，将在 Trello 中创建一个名为“Britta Simon”的用户。 Trello 支持实时预配，首次从 Azure AD 登录时会创建一个新帐户。
...
2. 在应用程序列表中，选择“Trello”。
    ...
    ![配置单一登录](./media/active-directory-saas-trello-tutorial/tutorial_trello_app.png) 
