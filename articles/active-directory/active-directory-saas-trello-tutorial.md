...
3. **[创建 Trello 测试用户](#creating-a-trello-test-user)** - 在 Trello 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
在本部分中，会在 Trello 中创建一个名为“Britta Simon”的用户。 在本部分中，会在 Trello 中创建一个名为“Britta Simon”的用户。 Trello 支持实时预配，首次从 Azure AD 登录时会创建一个新帐户。
