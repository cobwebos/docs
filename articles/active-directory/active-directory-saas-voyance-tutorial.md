...
4. 在搜索框中键入“Voyance”，在结果面板中选择“Voyance”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 Voyance](./media/active-directory-saas-voyance-tutorial/tutorial_voyance_addfromgallery.png)
...
3. **[创建一个 Voyance 测试用户](#create-a-voyance-test-user)** -若要链接到用户的 Azure AD 表示的 Voyance 中具有 Britta 人 Simon 的副本。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-voyance-tutorial/tutorial_voyance_samlbase.png)

3. 在“Voyance 域和 URL”部分中，如果要在“IDP”发起的模式下配置应用程序，请执行以下步骤：

    ![IDP 的 Voyance 域和 URL 单一登录信息](./media/active-directory-saas-voyance-tutorial/tutorial_voyance_url1.png)
...
4. 如果要在 SP 发起的模式下配置应用程序，请选中“显示高级 URL 设置”，并执行以下步骤：
    ...
    ![SP 的 Voyance 域和 URL 单一登录信息](./media/active-directory-saas-voyance-tutorial/tutorial_voyance_url2.png)
...
6. 单击“保存”按钮。
    ...
    ![配置单一登录“保存”按钮](./media/active-directory-saas-voyance-tutorial/tutorial_general_400.png)
    
7. 在“Voyance 配置”部分，单击“配置 Voyance”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 单一登录服务 URL”

    ![Voyance 配置](./media/active-directory-saas-voyance-tutorial/tutorial_voyance_configure.png) 

8. 在另一个 Web 浏览器窗口中，以管理员身份登录 Voyance 租户。

9. 转到导航栏的右上角，单击称为“Acme University”的下拉列表。
    
    ![在应用端配置单一登录（Acme University）](./media/active-directory-saas-voyance-tutorial/tutorial_voyance_001.png) 

10. 单击“管理员设置”。

    ![在应用端配置单一登录（管理员设置）](./media/active-directory-saas-voyance-tutorial/tutorial_voyance_002.png)

11. 单击“用户访问”选项卡。

    ![在应用端配置单一登录（用户权限）](./media/active-directory-saas-voyance-tutorial/tutorial_voyance_003.png)

12. 单击“已禁用 SSO”按钮，使用 SAML 2.0 将 Azure AD 配置为 IdP。

    ![在应用端配置单一登录（“已禁用 SSO”按钮）](./media/active-directory-saas-voyance-tutorial/tutorial_voyance_004.png)

13. 转到“SAML v2”部分，并执行以下步骤：

    ![在应用端配置单一登录（SAML v2）](./media/active-directory-saas-voyance-tutorial/tutorial_voyance_005.png)
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-voyance-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-voyance-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![“添加”按钮](./media/active-directory-saas-voyance-tutorial/create_aaduser_03.png) 

4. 在“用户”对话框页上，执行以下步骤：
 
    ![“用户”对话框](./media/active-directory-saas-voyance-tutorial/create_aaduser_04.png) 
...
2. 在应用程序列表中，选择“Voyance”。
    ...
    ![应用程序列表中的 Voyance 链接](./media/active-directory-saas-voyance-tutorial/tutorial_voyance_app.png) 
