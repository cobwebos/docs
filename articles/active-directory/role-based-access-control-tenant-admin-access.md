...
![Azure AD 管理中心 - 属性 - 全局管理员可以管理 Azure 订阅 - 屏幕截图](./media/role-based-access-control-tenant-admin-access/aad-azure-portal-global-admin-can-manage-azure-subscriptions.png)
