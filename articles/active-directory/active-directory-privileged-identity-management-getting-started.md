...
- “审批请求(预览)”显示你的目录中的用户发出的用于激活符合条件的 Azure Active Directory 角色的请求列表，并且已指定由你来审批这些请求。 [了解详细信息。](./privileged-identity-management/azure-ad-pim-approval-workflow.md)
