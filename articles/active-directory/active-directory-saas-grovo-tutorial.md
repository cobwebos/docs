...
5. Grovo 应用程序需要特定格式的 SAML 断言。 请为此应用程序配置以下声明。 可以在应用程序集成页的“用户属性”部分管理这些属性的值。 请将**用户标识符**与 **user.mail** 建立映射并配置其他属性，如以下屏幕截图中所示。
    ...
    ![配置单一登录 attb](./media/active-directory-saas-grovo-tutorial/tutorial_grovo_attribute.png)
...
6. 在“单一登录”对话框的“用户属性”部分，按图中所示配置 SAML 令牌属性，然后执行以下步骤：
    ...
    ![配置单一登录 Add](./media/active-directory-saas-grovo-tutorial/tutorial_attribute_04.png)

    ![配置单一登录 Addattb](./media/active-directory-saas-grovo-tutorial/tutorial_attribute_05.png)
