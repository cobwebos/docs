...
3. **[创建 DocuSign 测试用户](#creating-a-docusign-test-user)** -若要链接到用户的 Azure AD 表示的 DocuSign 中具有 Britta 人 Simon 的副本。
...
8. 在“声明域”对话框中，在“域名”文本框中，键入公司域，然后单击“声明”。 确保对域进行验证并且其状态为活动。
