...
4. 在搜索框中，键入“Igloo Software”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-igloo-software-tutorial/tutorial_igloosoftware_search.png)

5. 在结果面板中，选择“Igloo Software”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-igloo-software-tutorial/tutorial_igloosoftware_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-igloo-software-tutorial/tutorial_igloosoftware_samlbase.png)

3. 在“Igloo Software 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-igloo-software-tutorial/tutorial_igloosoftware_url.png)
...
4. 在“SAML 签名证书”部分中，单击“证书(Base64)”，然后在计算机上保存证书文件。
    ...
    ![配置单一登录](./media/active-directory-saas-igloo-software-tutorial/tutorial_igloosoftware_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录](./media/active-directory-saas-igloo-software-tutorial/tutorial_general_400.png)
    
6. 在“Igloo Software 配置”部分中，单击“配置 Igloo Software”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL 和 SAML 单一登录服务 URL”。

    ![配置单一登录](./media/active-directory-saas-igloo-software-tutorial/tutorial_igloosoftware_configure.png) 
...
11. 在“常规配置”部分中，执行以下步骤：
    ...
    a.在“横幅徽标”下面，选择“删除上传的徽标”。 在“连接名称”文本框中，键入配置的自定义名称。
...
12. 在“响应和身份验证配置”中，执行以下步骤：
    ...
    ![响应和身份验证配置](./media/active-directory-saas-igloo-software-tutorial/IC783971.png "响应和身份验证配置")
      ...
      a.在“横幅徽标”下面，选择“删除上传的徽标”。 对于“标识提供者”，选择“Microsoft ADFS”。
      
      b.在“磁贴徽标”下面，选择“删除上传的徽标”。 对于“标识符类型”，选择“电子邮件地址”。 
...
13. 请执行以下步骤以完成配置：
    ...
    ![登录时创建用户](./media/active-directory-saas-igloo-software-tutorial/IC783972.png "登录时创建用户") 
     ...
     a.在“横幅徽标”下面，选择“删除上传的徽标”。 对于“登录时创建用户”，选择“用户登录时在站点中创建新用户”。

     b.在“磁贴徽标”下面，选择“删除上传的徽标”。 对于“登录设置”，选择“使用‘登录’屏幕上的 SAML 按钮”。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-igloo-software-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-igloo-software-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-igloo-software-tutorial/create_aaduser_03.png) 

4. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-igloo-software-tutorial/create_aaduser_04.png) 
...
2. 在应用程序列表中，选择“Igloo Software”。
    ...
    ![配置单一登录](./media/active-directory-saas-igloo-software-tutorial/tutorial_igloosoftware_app.png) 
