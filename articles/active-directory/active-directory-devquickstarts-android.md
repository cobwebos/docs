...
3. 更新项目的 AndroidManifest.xml 文件以包括：
    ...
    ```Java
      ...
      <application/>
    ```
4. 在主要活动中创建 AuthenticationContext 的实例。 有关此调用的详细信息不在本自述文件的范围内，但你可以通过查看 [Android 本机客户端示例](https://github.com/AzureADSamples/NativeClient-Android)来快速入门。 下面是一个示例：
