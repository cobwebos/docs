...
8. 在“SAML 身份验证详细信息”部分，执行以下步骤：
   ...
   1. 在 Azure 经典门户的“配置 Zoho Mail 的单一登录”对话框页上，复制“远程登录 URL”值，然后将其粘贴到“登录 URL”文本框中。
   2. 在 Azure 经典门户的“配置 Zoho Mail 的单一登录”对话框页上，复制“远程注销 URL”值，然后将其粘贴到“注销 URL”文本框中。
   3. 在 Azure 经典门户的“配置 Zoho Mail 的单一登录”对话框页面上，复制“更改密码 URL”值，然后将其粘贴到“更改密码 URL”文本框。
   4. 根据下载的证书创建 **base-64 编码**文件。  
      ...
      > 
      > 
   5. 在记事本中打开 base-64 编码的证书，将内容复制到剪贴板，然后将其粘贴到“公钥”文本框中。
   6. 选择“RSA”作为**算法**。
   7. 单击 **“确定”**。
...
4. 在“添加用户”对话框中，执行以下步骤：
   ...
   1. 在相关文本框中，键入要预配的有效 Azure Active Directory 帐户的“名字”、“姓氏”、“电子邮件 ID”和“密码”。
   2. 单击 **“确定”**。  
