...
4. 在搜索框中键入 **Trisotech Digital Enterprise Server**，在结果面板中选择“Trisotech Digital Enterprise Server”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的“Trisotech Digital Enterprise Server”](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/tutorial_trisotechdigitalenterpriseserver_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/tutorial_trisotechdigitalenterpriseserver_samlbase.png)

3. 在“Trisotech Digital Enterprise Server 域和 URL”部分中执行以下步骤：

    ![Trisotech Digital Enterprise Server 域和 URL 单一登录信息](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/tutorial_trisotechdigitalenterpriseserver_url.png)
...
7. 单击“菜单”图标并选择“管理”。
    ...
    ![配置单一登录](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/user1.png)

8. 选择“用户提供程序”。

    ![配置单一登录](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/user2.png)

9. 在“用户提供程序配置”部分执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/user3.png)
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/create_aaduser_04.png)
...
2. 在应用程序列表中选择“Trisotech Digital Enterprise Server”。
    ...
    ![应用程序列表中的“Trisotech Digital Enterprise Server”链接](./media/active-directory-saas-trisotechdigitalenterpriseserver-tutorial/tutorial_trisotechdigitalenterpriseserver_app.png)  
