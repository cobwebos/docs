...
|文章 |说明 |
|------|------------|
|[添加工作或学校帐户](microsoft-authenticator-app-add-work-account.md)|介绍如何将工作或学校帐户添加到 Microsoft Authenticator 应用以进行双重验证。|
|[添加 Microsoft 个人帐户](microsoft-authenticator-app-add-personal-account.md)|介绍如何添加 Microsoft 个人帐户以进行双重验证和手机登录（也称为无密码登录）。|
|[添加非 Microsoft 个人帐户](microsoft-authenticator-app-add-non-microsoft-account.md)|介绍如何添加非 Microsoft 个人帐户以进行双重验证。|
|[手动添加帐户](microsoft-authenticator-app-add-account-manual.md)|介绍在相机无法捕获 QR 码的情况下，如何手动将帐户添加到 Microsoft Authenticator 应用。|
