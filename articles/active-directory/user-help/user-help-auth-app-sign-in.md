...
|**如何停用此功能，并重新改用密码登录？**|对于个人帐户，请在登录期间选择“改用密码”链接。 系统会记住你最近的选择，并在下次登录时默认提供此选项。 如果想要改用手机登录，请在登录期间选择“改用应用”链接。<br><br>对于工作或学校帐户，必须转到“其他安全验证”页面（例如 https://aka.ms/MFASetup)并删除 Microsoft Authenticator 应用。|
