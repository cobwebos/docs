...
如果你使用的是新的 Microsoft Edge 浏览器（Chromium 上的边缘），则可以从[Microsoft Edge 加载项商店](https://microsoftedge.microsoft.com/addons/category/EdgeExtensionsEditorsPick)获取扩展。
...
2. 在受支持的 web 浏览器中，打开https://myapps.microsoft.com并中转到，或使用组织提供的链接（如果将您定向到自定义页面， `https://myapps.microsoft.com/contoso.com`如）。
...
2. 如果将您定向到自定义https://myapps.microsoft.com页（例如），请打开 Intune Managed Browser 应用程序，或使用您的组织提供的链接https://myapps.microsoft.com/contoso.com。
...
2. https://myapps.microsoft.com如果将您定向到自定义页面（例如），请参阅或使用组织提供的链接https://myapps.microsoft.com/contoso.com。
