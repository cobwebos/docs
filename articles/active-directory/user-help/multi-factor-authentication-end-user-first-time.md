...
登录时如果未出现类似屏幕，请按照[管理双重验证设置](multi-factor-authentication-end-user-manage-settings.md#using-the-additional-security-verification-page)中的指示操作，找到可以管理验证选项的设置页面。
...
1. 从下拉列表中选择“办公电话”  
    ...
    ![安装](./media/multi-factor-authentication-end-user-first-time/office.png)  
...
5. 如果要使用这些应用，请将提供的应用密码（而不是常规密码）复制并粘贴到应用程序中。 对于多个应用，可以使用相同的应用密码。 有关详细信息，请参阅[什么是应用密码](multi-factor-authentication-end-user-app-passwords.md)。
6. 单击“Done”（完成）。
...
* 使用 [Microsoft Authenticator 应用](user-help-auth-app-download-install.md)完成快速、安全的身份验证（即使没有手机网络服务）。
