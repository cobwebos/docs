...
- **代码生成。** 为支持身份验证器应用的任何其他帐户的代码生成器。

> [!Important]
> Microsoft Authenticator 应用适用于任何帐户使用双重验证并支持基于时间的一次性密码 (TOTP) 标准。
> 
...
>[!Important]
>如果是当前不在你的移动设备中，仍可通过向自己发送下载链接中的获取 Microsoft Authenticator 应用[Microsoft Authenticator 页](https://www.microsoft.com/en-us/account/authenticator)。
