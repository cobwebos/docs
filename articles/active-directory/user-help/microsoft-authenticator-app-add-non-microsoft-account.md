---
title: 将非 Microsoft 个人帐户添加到 Microsoft Authenticator 应用 - Azure Active Directory | Microsoft Docs
description: 如何将非 Microsoft 个人帐户（如 Google 帐户、Facebook 帐户或 GitHub 帐户）添加到 Microsoft Authenticator 应用，以进行双因素验证。
...
ms.locfileid: "55459139"
---
# <a name="add-your-personal-non-microsoft-accounts"></a>添加非 Microsoft 个人帐户
将非 Microsoft 个人帐户（如 Google 帐户、Facebook 帐户或 GitHub 帐户）添加到 Microsoft Authenticator 应用，以进行双因素验证。
...
2. 将帐户添加到 Microsoft Authenticator 应用。
...
- 将帐户添加到应用后，可以在设备上使用 Authenticator 应用登录。 有关详细信息，请参阅[使用应用登录](microsoft-authenticator-app-phone-signin-faq.md)。
