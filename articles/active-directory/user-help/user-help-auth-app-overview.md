...
>[!Important]
>此内容适用于用户。 如果你是管理员，可以在 [Azure Active Directory 文档](https://docs.microsoft.com/azure/active-directory)中查找有关如何设置和管理 Azure Active Directory (Azure AD) 环境的详细信息。<br><br>如果在登录帐户时遇到问题，请参阅[无法登录 Microsoft 帐户](https://support.microsoft.com/help/12429)获取帮助。  详细了解如何解决在尝试登录 Microsoft 帐户时收到“[该 Microsoft 帐户不存在](https://support.microsoft.com/help/13811)”消息的问题。
...
- **验证码。** 在要登录到的设备中，键入工作或学校帐户或 Microsoft 个人帐户的用户名和密码，然后复制 Microsoft Authenticator 应用的“帐户”屏幕中显示的关联验证码。
...
- **工作或学校帐户。** 如果你使用工作或学校帐户（例如 alain@contoso.com），则由你的组织决定是否必须使用双重验证，以及具体的验证方法是什么。 有关多重验证的详细信息，请参阅 [Azure 多重身份验证对我而言有什么用途](multi-factor-authentication-end-user.md)。 若要详细了解如何设置安全信息以使用 Microsoft Authenticator 应用，请参阅[设置安全信息以使用 Authenticator 应用（预览版）](security-info-setup-auth-app.md)。

- **Microsoft 个人帐户。** 可以选择为 Microsoft 个人帐户（例如 alain@outlook.com）设置双重验证。

- **非 Microsoft 个人帐户。** 可以选择为非 Microsoft 个人帐户（例如 alain@gmail.com）设置双重验证。 非 Microsoft 帐户可能不使用“两重验证”这一术语，但你应该可以在“安全性”或“登录”设置中找到类似功能。

## <a name="in-this-section"></a>本节内容

|文章 |说明 |
|------|------------|
|[下载并安装应用](microsoft-authenticator-app-how-to.md)|介绍在何处采用何种方法为运行 Android、iOS 和 Windows Phone 的设备获取和安装 Microsoft Authenticator 应用。|
|[添加工作或学校帐户](microsoft-authenticator-app-add-work-account.md)|介绍如何将各种工作或学校帐户和个人帐户添加到 Microsoft Authenticator 应用。|
|[添加个人帐户](microsoft-authenticator-app-add-personal-account.md)|介绍如何将 Microsoft 个人帐户和非 Microsoft 帐户添加到 Microsoft Authenticator 应用。|
|[手动添加帐户](microsoft-authenticator-app-add-account-manual.md)|介绍在无法扫描所提供的 QR 码的情况下，如何手动将帐户添加到 Microsoft Authenticator 应用。|
|[使用应用登录](microsoft-authenticator-app-phone-signin-faq.md)|介绍如何使用 Microsoft Authenticator 应用登录到各种帐户。|
|[备份和恢复帐户凭据](microsoft-authenticator-app-backup-and-recovery.md)| 提供有关如何使用 Microsoft Authenticator 应用备份和恢复帐户凭据的信息。|
