...
本部分的目的是基于名为“Britta Simon”的测试用户展示如何配置并测试 Condeco 的 Azure AD 单一登录。
...
3. 在“配置应用设置”对话框页上，执行以下步骤：
    ...
    a. 在“登录 URL”文本框中，使用以下模式键入用户用来登录 Condeco 应用程序的 URL：**“https://companyname.condecosoftware.com”**。

    b. 单击“下一步”。


1. 在“在 Condeco 处配置单一登录”页上，执行以下步骤：
