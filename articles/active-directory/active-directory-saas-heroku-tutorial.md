...
* 可以让用户使用其 Azure AD 帐户自动登录到 Heroku 单一登录 (SSO)
...
3. 在“配置应用设置”对话框页上，执行以下步骤：
   ...
   >
    ...
    1. 在“登录 URL”文本框中，使用以下模式键入用户用于登录 Heroku 应用程序的 URL：**“https://sso.heroku.com/saml/\<公司名称\>/init”**。 
    2. 在“标识符”文本框中，使用以下模式键入 URL：“**https://sso.heroku.com/saml/\<公司名称\>**”。  
...
2. 若要在 Heroku 中启用 SSO，请执行以下步骤：
    ...
    1. 以管理员身份登录到 Heroku 帐户。
    2. 单击“设置”选项卡 。
    3. 在“单一登录”页面上，单击“上载元数据”。
    4. 上载从 Azure 经典门户下载的元数据文件。
    5. 安装成功后，管理员会看到一个确认对话框，其中显示最终用户的 SSO 登录 URL。
    6. <a name="x123"></a>复制 **Heroku 登录 URL** 和 **Heroku 实体 ID**，然后在 Azure AD 经典门户中回到“配置应用设置”页，将这些值粘贴到相关文本框中。
...
### <a name="create-an-heroku-test-user"></a>创建 Heroku 测试用户
