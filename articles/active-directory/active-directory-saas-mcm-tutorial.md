...
4. 在搜索框中，键入“MCM”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-mcm-tutorial/tutorial_mcm_search.png)

5. 在结果面板中，选择“MCM”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-mcm-tutorial/tutorial_mcm_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-mcm-tutorial/tutorial_mcm_samlbase.png)

3. 在“MCM 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-mcm-tutorial/tutorial_mcm_url.png)
...
4. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![配置单一登录](./media/active-directory-saas-mcm-tutorial/tutorial_mcm_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录](./media/active-directory-saas-mcm-tutorial/tutorial_general_400.png) 
...
2. 在应用程序列表中，选择“MCM”。
    ...
    ![配置单一登录](./media/active-directory-saas-mcm-tutorial/tutorial_mcm_app.png) 
