...
6. 若要在 MCM 端配置单一登录，需要将下载的元数据 XML 发送给 [MCM 支持团队](http://mcmtechnology.com/support/)。 他们会对此进行设置，使 SAML SSO 连接在两端均正确设置。
...
在本部分中，将在 MCM 中创建一个名为 Britta Simon 的用户。 请与 [MCM 支持团队](http://mcmtechnology.com/support/)协作，将用户添加到 MCM 平台中。
