...
3. **[创建 Blackboard Learn 测试用户](#creating-a-blackboard-learn-test-user)** - 在 Blackboard Learn 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
