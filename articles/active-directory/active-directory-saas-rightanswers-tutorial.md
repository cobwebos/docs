...
## <a name="enable-the-application-integration-for-rightanswers"></a>为 RightAnswers 启用应用程序集成
本部分的目的是概述如何为 RightAnswers 启用应用程序集成。

**若要为 RightAnswers 启用应用程序集成，请执行以下步骤：**
...
要使 Azure AD 用户能够登录 RightAnswers，必须将这些用户预配到 RightAnswers 中。 对于 RightAnswers，预配是一项自动化任务，因此不存在任何操作项。
