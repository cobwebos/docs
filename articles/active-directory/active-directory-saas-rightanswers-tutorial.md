---
title: "教程：Azure Active Directory 与 RightAnswers 集成 | Microsoft 文档"
...
5. 在“要执行什么操作”对话框中，单击“从库中添加应用程序”。
   ...
   ![从库中添加应用程序](./media/active-directory-saas-rightanswers-tutorial/IC749322.png "Add an application from gallerry")
...
3. 在“配置应用设置”页的“登录 URL”文本框中，键入用户用于登录 RightAnswers 应用程序的 URL（例如：*https://fortify.rightanswers.com/portal/ss/*），然后单击“下一步”。
   ...
   ![配置应用设置](./media/active-directory-saas-rightanswers-tutorial/IC802929.png "Configure App Settings")
