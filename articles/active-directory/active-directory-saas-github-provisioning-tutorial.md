---
title: "教程：使用 Azure Active Directory 为自动用户预配配置 GitHub | Microsoft Docs"
...
---
# <a name="tutorial-configuring-github-for-automatic-user-provisioning"></a>教程：为自动用户预配配置 GitHub
