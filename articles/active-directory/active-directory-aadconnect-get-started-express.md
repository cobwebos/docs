...
5. 在“连接到 Azure AD”屏幕上，输入 Azure AD 的全局管理员用户名和密码。单击“下一步”。![连接到 Azure AD](./media/active-directory-aadconnect-get-started-express/connectaad.png) 如果你收到错误消息并且出现连接问题，请参阅[故障排除连接问题](active-directory-aadconnect-troubleshoot-connectivity.md)。
