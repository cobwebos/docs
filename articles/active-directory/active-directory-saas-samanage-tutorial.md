...
4. 在搜索框中，键入“Samanage”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-samanage-tutorial/tutorial_samanage_search.png)

5. 在结果面板中，选择“Samanage”，并单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-samanage-tutorial/tutorial_samanage_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-samanage-tutorial/tutorial_samanage_samlbase.png)

3. 在“Samanage 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-samanage-tutorial/tutorial_samanage_url.png)
...
5. 单击“保存”按钮。
    ...
    ![配置单一登录](./media/active-directory-saas-samanage-tutorial/tutorial_general_400.png)

6. 在“Samanage 配置”部分，单击“配置 Samanage”，打开“配置登录”窗口。 从“快速参考”部分复制“注销 URL 和 SAML 实体 ID”。

    ![配置单一登录](./media/active-directory-saas-samanage-tutorial/tutorial_samanage_configure.png) 
...
2. 在应用程序列表中，选择“Samanage”。
    ...
    ![配置单一登录](./media/active-directory-saas-samanage-tutorial/tutorial_samanage_app.png) 
