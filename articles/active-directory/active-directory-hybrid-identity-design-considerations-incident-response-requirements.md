...
在查明危害级别和严重级别阶段，有必要标识已受到危害的系统、已遭访问的文件并确定这些文件的敏感性。 你的混合标识系统应该能够满足这些要求，以帮助你确定进行这些更改的用户。 
...
标识管理系统应帮助 IT 管理员识别并报告这些可疑活动。 通常可以通过监视所有系统并提供可以突出显示潜在威胁的报告功能，来满足这些技术要求。 使用下面的问题来帮助你设计时考虑到考虑事件响应要求混合标识解决方案：
