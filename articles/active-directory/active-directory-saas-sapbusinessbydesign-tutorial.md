...
若要配置 SAP Business ByDesign 与 Azure AD 的集成，需要从库中将 SAP Business ByDesign 添加到托管 SaaS 应用列表。
...
6. 在搜索框中，键入“SAP Business ByDesign”。
   
    ![创建 Azure AD 测试用户](./media/active-directory-saas-sapbusinessbydesign-tutorial/tutorial_sapbusinessbydesign_01.png)

7. 在结果窗格中，选择“SAP Business ByDesign”，然后单击“完成”以添加该应用程序。
...
若要运行单一登录，Azure AD 需要知道与 Azure AD 用户相对应的 SAP Business ByDesign 用户。 换句话说，需要在 Azure AD 用户与 SAP Business ByDesign 中相关用户之间建立链接关系。

通过将 Azure AD 中“用户名”的值分配为 SAP Business ByDesign 中“用户名”的值来建立此链接关系。
...
3. **[创建 SAP Business ByDesign 测试用户](#creating-an-sap-business-bydesign-test-user)** - 在 SAP Business ByDesign 中创建 Britta Simon 的对应用户，将其链接到她的 Azure AD 表示形式。
4. **[分配 Azure AD 测试用户](#assigning-the-azure-ad-test-user)** - 让 Britta Simon 能够使用 Azure AD 单一登录。
5. **[测试单一登录](#testing-single-sign-on)** - 验证配置是否正常工作。

### <a name="configuring-azure-ad-single-sign-on"></a>配置 Azure AD 单一登录
在本部分中，将在经典门户中启用 Azure AD 单一登录并在 SAP Business ByDesign 应用程序中配置单一登录。

SAP Business ByDesign 应用程序需要特定格式的 SAML 断言。 请为此应用程序配置以下声明。 可从应用程序的“属性”选项卡管理这些属性的值。 以下屏幕截图显示一个示例。 

**若要配置 SAP Business ByDesign 的 Azure AD 单一登录，请执行以下步骤：**

1. 在 Azure 经典门户中的“SAP Business ByDesign”应用程序集成页上，单击顶部菜单中的“属性”。
...
4. 在经典门户中的“SAP Business ByDesign”应用程序集成页上，单击“配置单一登录”，打开“配置单一登录”对话框。
   
    ![配置单一登录][6] 

5. 在“你希望用户如何登录 SAP Business ByDesign”页上，选择“Azure AD 单一登录”，然后单击“下一步”。
...
6. 在“配置应用设置”对话框页上，执行以下步骤：
    ...
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 在“登录 URL”文本框中，使用以下模式键入用户用于登录 SAP Business ByDesign 应用程序的 URL：`https://<servername>.sapbydesign.com`
   
    b.保留“数据库类型”设置，即设置为“共享”。 单击“下一步”
7. 在“配置 SAP Business ByDesign 的单一登录”页上，执行以下步骤：
...
8. 若要为应用程序配置 SSO，请执行以下步骤：
    ...
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 以管理员权限登录到 SAP Business ByDesign 门户。
    ...
    d.单击“下一步”。 若要在 SAML 请求中包括**断言使用者服务 URL**，请选择“包括断言使用者服务 URL”。
...
1. 在 **Azure 经典门户**中，在左侧导航窗格上，单击“Active Directory”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-sapbusinessbydesign-tutorial/create_aaduser_09.png) 

2. 在“目录”列表中，选择要启用目录集成的目录。

3. 若要显示用户列表，请在顶部菜单中，单击“用户”。
   
    ![创建 Azure AD 测试用户](./media/active-directory-saas-sapbusinessbydesign-tutorial/create_aaduser_03.png) 

4. 若要打开“添加用户”对话框，请在底部工具栏中单击“添加用户”。
   
    ![创建 Azure AD 测试用户](./media/active-directory-saas-sapbusinessbydesign-tutorial/create_aaduser_04.png) 

5. 在“告诉我们有关此用户的信息”对话框页上，执行以下步骤：
   
    ![创建 Azure AD 测试用户](./media/active-directory-saas-sapbusinessbydesign-tutorial/create_aaduser_05.png) 
...
6. 在“用户配置文件”对话框页上，执行以下步骤：
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-sapbusinessbydesign-tutorial/create_aaduser_06.png) 
...
7. 在“获取临时密码”对话框页上，单击“创建”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-sapbusinessbydesign-tutorial/create_aaduser_07.png) 

8. 在“获取临时密码”对话框页上，执行以下步骤：
   
    ![创建 Azure AD 测试用户](./media/active-directory-saas-sapbusinessbydesign-tutorial/create_aaduser_08.png) 
   
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 写下“新密码”的值。
   
    b. 单击“完成”。   

### <a name="creating-an-sap-business-bydesign-test-user"></a>创建 SAP Business ByDesign 测试用户
在本部分中，将在 SAP Business ByDesign 中创建一个名为“Britta Simon”的用户。 请协助 SAP Business ByDesign 支持团队将用户添加到 SAP Business ByDesign 平台。 
...
**若要将 Britta Simon 分配到 SAP Business ByDesign，请执行以下步骤：**
...
单击访问面板中的“SAP Business ByDesign”磁贴时，用户应自动登录到 SAP Business ByDesign 应用程序。
