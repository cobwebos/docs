...
3. 阅读[实现](active-directory-playbook-implementation.md)部分，了解各种方案以及它们将对环境的意义。 在每个方案中，介绍如何设置（所谓的[构建基块](active-directory-playbook-building-blocks.md)）和导航方案。 
