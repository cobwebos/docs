...
3. **[创建 JobScore 测试用户](#creating-a-jobscore-test-user)** - 在 JobScore 中创建 Britta Simon 的对应用户，将其链接到用户的 Azure AD 表示形式。
...
在本部分中，将在 JobScore 中创建一个名为“Britta Simon”的用户。 与 [JobScore 支持团队](mailto:support@jobscore.com)协作，将用户添加到 JobScore 平台中。
