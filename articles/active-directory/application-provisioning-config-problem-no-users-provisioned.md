...
-   哪些用户和组已**分配**到应用程序。 有关分配的详细信息，请参阅[在 Azure Active Directory 预览版中向企业应用分配用户或组](https://docs.microsoft.com/azure/active-directory/active-directory-coreapps-assign-user-azure-portal)。
