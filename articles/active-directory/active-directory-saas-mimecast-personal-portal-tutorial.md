...
* 一个有效的 Azure 订阅
* 启用了 Mimecast Personal Portal 单一登录 (SSO) 的订阅
...
**若要为 Mimecast Personal Portal 启用应用程序集成，请执行以下步骤：**
...
5. 在“要执行什么操作”对话框中，单击“从库中添加应用程序”。
   ...
   ![从库添加应用程序](./media/active-directory-saas-mimecast-personal-portal-tutorial/IC749322.png "从库添加应用程序")
...
3. 在“配置应用 URL”页上，在“Mimecast Personal Portal 登录 URL”文本框中，键入用户用来登录 Mimecast Personal Portal 应用程序的 URL（例如：“https://webmail-uk.mimecast.com” 或 “https://webmail-us.mimecast.com”），然后单击“下一步”。
   ...
   ![配置应用 URL](./media/active-directory-saas-mimecast-personal-portal-tutorial/IC794996.png "配置应用 URL")
...
**若要将用户分配到 Mimecast Personal Portal，请执行以下步骤：**
