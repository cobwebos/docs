...
4. 在搜索框中，键入“GaggleAMP”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-gaggleamp-tutorial/tutorial_gaggleamp_search.png)

5. 在结果面板中，选择“GaggleAMP”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-gaggleamp-tutorial/tutorial_gaggleamp_addfromgallery.png)
...
8. 在“SAML SSO”页上执行以下步骤：  
    ...
    a.在“横幅徽标”下面，选择“删除上传的徽标”。 在“标识提供者颁发者”文本框中，粘贴从 Azure 门户复制的“颁发者 URL”值。 
 
    b.在“磁贴徽标”下面，选择“删除上传的徽标”。 在“标识提供者单一登录 URL”文本框中，粘贴从 Azure 门户复制的“单一登录服务 URL”值。 
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-gaggleamp-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-gaggleamp-tutorial/create_aaduser_02.png) 
...
2. 在应用程序列表中，选择“GaggleAMP”。
    ...
    ![配置单一登录](./media/active-directory-saas-gaggleamp-tutorial/tutorial_gaggleamp_app.png) 
