---
title: "教程：Azure Active Directory 与 Teamwork 的集成 | Microsoft 文档"
description: "了解如何在 Azure Active Directory 和 Teamwork 之间配置单一登录。"
...
在本教程中，了解如何将 Teamwork 与 Azure Active Directory (Azure AD) 集成。

将 Teamwork 与 Azure AD 集成提供以下优势：

- 可在 Azure AD 中控制谁有权访问 Teamwork
- 可以让用户使用其 Azure AD 帐户自动登录到 Teamwork（单一登录）
...
若要配置 Azure AD 与 Teamwork 的集成，需要以下项：

- Azure AD 订阅
- 已启用 Teamwork 单一登录的订阅
...
通过将 Azure AD 中“用户名”的值分配为 Teamwork 中“用户名”的值来建立此链接关系。

若要配置并测试 Teamwork 的 Azure AD 单一登录，需要完成以下构建基块：
...
1. 在 Azure 管理门户的“Teamwork”应用程序集成页上，单击“单一登录”。

    ![配置单一登录][4]

2. 在“单一登录”对话框中，选择“基于 SAML 的登录”作为“模式”以启用单一登录。
 
    ![配置单一登录](./media/active-directory-saas-teamwork-tutorial/tutorial_teamwork_01.png)

3. 在“Teamwork 域和 URL”部分的“登录 URL”文本框中，使用以下模式键入 URL：`https://<company name>.teamwork.com`

    ![配置单一登录](./media/active-directory-saas-teamwork-tutorial/tutorial_teamwork_02.png)

    > [!NOTE] 
    > 请注意，这不是实际值。 必须使用实际登录 URL 更新此值。 若要获取此值，请与 [Teamwork 支持团队](mailto:support@teamwork.com)联系。 
...
9. 若要为应用程序配置 SSO，请联系 [Teamwork 支持团队](mailto:support@teamwork.com)，并向他们提供下载的**元数据**。
...
1. 在 Azure 管理门户的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-teamwork-tutorial/create_aaduser_01.png) 

2. 转到“用户和组”，单击“所有用户”显示用户列表。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-teamwork-tutorial/create_aaduser_02.png) 

3. 在对话框顶部单击“添加”，打开“用户”对话框。
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-teamwork-tutorial/create_aaduser_03.png) 
...
在本部分中，通过授予 Britta Simon 访问 Teamwork 的权限，允许她使用 Azure 单一登录。
...
2. 在应用程序列表中，选择“Teamwork”。

    ![配置单一登录](./media/active-directory-saas-teamwork-tutorial/tutorial_teamwork_50.png) 
...
单击访问面板中的“Teamwork”磁贴时，用户应自动登录到 Teamwork 应用程序。
