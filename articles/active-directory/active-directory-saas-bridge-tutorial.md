...
在本部分中，将在 Bridge 中创建一个名为“Britta Simon”的用户。 请协助 [Bridge 客户端支持团队](https://community.bridgeapp.com/community/help)在该平台中创建用户。 可以在<a href="https://community.bridgeapp.com/community/help">此处</a>请求 Bridge 的支持票证，以便将用户添加到 Bridge 平台中。
