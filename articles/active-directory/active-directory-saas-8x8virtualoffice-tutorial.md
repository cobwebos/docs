...
3. 在“8x8 Virtual Office 域和 URL”部分中，执行以下步骤：
    ...
    > [!NOTE] 
    > 这些不是实际值。 请使用实际标识符和回复 URL 更新这些值。 请联系 [8x8 Virtual Office 支持团队](https://www.8x8.com/about-us/contact-us)获取这些值。
...
**要将 Britta Simon 分配到 8x8 Virtual Office，请执行以下步骤：**
