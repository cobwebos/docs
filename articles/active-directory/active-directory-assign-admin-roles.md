...
有权执行的操作 | 无权执行的操作
------------- | -------------
查看公司信息和用户信息<br>管理 Office 支持票证重置用户密码，但有限制。<br> 他/她不能为计费管理员、全局管理员和服务管理员重置密码。<br>创建和管理用户视图<br>创建、编辑和删除用户与组，以及管理用户许可证，但有限制。<br> 他/她不能删除全局管理员或创建其他管理员。 | 为 Office 产品执行计费和采购操作<br>管理域<br>管理公司信息<br>向其他人委派管理角色<br>使用目录同步
