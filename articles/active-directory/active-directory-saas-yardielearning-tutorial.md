...
本部分旨在说明如何基于一个名为“Britta Simon”的测试用户使用 Yardi eLearning 配置和测试 Azure AD 单一登录。
...
本部分的目的是在 Azure 经典门户中启用 Azure AD 单一登录并在 Yardi eLearning 应用程序中配置单一登录。
...
3. 在“配置应用设置”对话框页上，执行以下步骤：
    ...
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 在“登录 URL”文本框中，使用以下模式键入用户用于登录 Yardi eLearning 应用程序的 URL：**“https://\<公司名称\>.yardielearning.com/login”**。

    b. 单击“资源组名称” 的 Azure 数据工厂。


1. 在“配置 Yardi eLearning 的单一登录”页上，执行以下步骤：
    ...
    b. 单击“下一步”。
2. 若要为应用程序配置 SSO，请通过 [elearning@yardi.com](mailto:elearning@yardi.com) 联系 Yardi eLearning 支持团队，然后将下载的元数据文件附加到电子邮件。
...
本部分的目的是通过授予 Britta Simon 访问 Yardi eLearning 的权限，允许她使用 Azure 单一登录。
