...
4. 在搜索框中，键入“TimeLive”，在结果面板中选择“TimeLive”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 TimeLive](./media/active-directory-saas-timelive-tutorial/tutorial_timelive_addfromgallery.png)
...
3. **[创建 TimeLive 测试用户](#create-a-timelive-test-user)** - 在 TimeLive 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-timelive-tutorial/tutorial_timelive_samlbase.png)

3. 在“TimeLive 域和 URL”部分中，执行以下步骤：

    ![TimeLive 域和 URL 单一登录信息](./media/active-directory-saas-timelive-tutorial/tutorial_timelive_url.png)
...
4. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。
    ...
    ![证书下载链接](./media/active-directory-saas-timelive-tutorial/tutorial_timelive_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/active-directory-saas-timelive-tutorial/tutorial_general_400.png)
    
6. 在“TimeLive 配置”部分中，单击“配置 TimeLive”以打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL 和 SAML 单一登录服务 URL”。

    ![TimeLive 配置](./media/active-directory-saas-timelive-tutorial/tutorial_timelive_configure.png)

7. 在另一个 Web 浏览器窗口中，以管理员身份登录到 TimeLive 公司站点。

8. 在“管理选项”下选择“首选项”。

    ![TimeLive 配置](./media/active-directory-saas-timelive-tutorial/configure1.png)

9. 在“应用程序首选项”部分中，执行以下步骤：
    
    ![TimeLive 配置](./media/active-directory-saas-timelive-tutorial/configure2.png)
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-timelive-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-timelive-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-timelive-tutorial/create_aaduser_03.png)
...
2. 在应用程序列表中，选择“TimeLive”。
    ...
    ![应用程序列表中的 TimeLive 链接](./media/active-directory-saas-timelive-tutorial/tutorial_timelive_app.png)  
