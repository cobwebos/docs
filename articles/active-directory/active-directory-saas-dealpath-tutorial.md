...
4. 在搜索框中，键入“Dealpath”，在结果面板中选择“Dealpath”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 Dealpath](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_samlbase.png)

3. 在“Dealpath 域和 URL”部分中，执行以下步骤：

    ![Dealpath 域和 URL 单一登录信息](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_url.png)
...
4. 在“SAML 签名证书”部分中，单击“证书(Base64)”，并在计算机上保存证书文件。
    ...
    ![证书下载链接](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/active-directory-saas-dealpath-tutorial/tutorial_general_400.png)

6. 在“Dealpath 配置”部分中，单击“配置 Dealpath”以打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 实体 ID 和 SAML 单一登录服务 URL”。

    ![Dealpath 配置](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_configure.png) 

7. 在另一个 Web 浏览器窗口中，以管理员身份登录到 Dealpath。

8. 在右上角，单击“管理工具”并导航到“集成”，然后在“SAML 2.0 身份验证”部分中单击“更新设置”：

    ![Dealpath 配置](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_admin.png)

9. 在“设置 SAML 2.0 身份验证”页面上，执行以下步骤：

    ![Dealpath 配置](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_saml.png) 
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-dealpath-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-dealpath-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-dealpath-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-dealpath-tutorial/create_aaduser_04.png)
...
2. 在应用程序列表中，选择“Dealpath”。
    ...
    ![应用程序列表中的 Dealpath 链接](./media/active-directory-saas-dealpath-tutorial/tutorial_dealpath_app.png)  
