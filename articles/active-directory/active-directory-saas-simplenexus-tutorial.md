...
5. 在“要执行什么操作”对话框中，单击“从库中添加应用程序”。
    ...
    ![从库添加应用程序](./media/active-directory-saas-simplenexus-tutorial/IC749322.png "从库添加应用程序")
...
3. 在“配置应用 URL”页上的“SimpleNexus 登录 URL”文本框中，使用模式“*https://simplenexus.com/CompanyName\_login*”键入 URL，然后单击“下一步”。
    ...
    ![配置应用 URL](./media/active-directory-saas-simplenexus-tutorial/IC786904.png "配置应用 URL")
