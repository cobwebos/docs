...
* [自动设备注册常见问题](active-directory-conditional-access-automatic-device-registration-faq.md)
* [排查已加入 Azure AD 域的计算机的自动注册问题 - Windows 10 和 Windows Server 2016](active-directory-conditional-access-automatic-device-registration-troubleshoot-windows.md)
* [排查将已加入域的计算机自动注册到 Azure AD 时发生的问题 - 非 Windows 10](active-directory-conditional-access-automatic-device-registration-troubleshoot-windows-legacy.md)
