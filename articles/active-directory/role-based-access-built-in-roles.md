---
title: 用于 Azure 基于角色的访问控制 (RBAC) 的内置角色 | Microsoft Docs
...
| [API 管理服务操作员角色](#api-management-service-operator-role) | 可管理 API 管理服务 |
| [API 管理服务读者角色](#api-management-service-reader-role) | 可管理 API 管理服务 |
...
| [备份参与者](#backup-contributor) | 可管理所有备份管理操作，但无法创建恢复服务保管库和向他人授予访问权限 |
| [备份操作员](#backup-operator) | 可管理所有备份管理操作，但无法创建保管库和向他人授予访问权限 |
| [备份读取器](#backup-reader) | 可监视恢复服务保管库中的备份管理 |
...
| [数据工厂参与者](#data-factory-contributor) | 创建和管理数据工厂，以及它们包含的子资源。 |
...
| [Site Recovery 参与者](#site-recovery-contributor) | 可以管理所有 Site Recovery 管理操作，但无法创建恢复服务保管库和向其他用户分配访问权限 |
| [Site Recovery 运算符](#site-recovery-operator) | 可以故障转移和故障回复，但不能执行其他 Site Recovery 管理操作或向其他用户分配访问权限 |
| [Site Recovery 读取器](#site-recovery-reader) | 可以监视恢复服务保管库中的 Site Recovery 状态并发出支持票证 |
...
授予用户使用 Application Insights 快照调试器功能的权限
