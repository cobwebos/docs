...
4. 在搜索框中，键入“Replicon”，在结果面板中选择“Replicon”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 Replicon](./media/active-directory-saas-replicon-tutorial/tutorial_replicon_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-replicon-tutorial/tutorial_replicon_samlbase.png)

3. 在“Replicon 域和 URL”部分中，执行以下步骤：

    ![Replicon 域和 URL 单一登录信息](./media/active-directory-saas-replicon-tutorial/tutorial_replicon_url.png)
...
4. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![证书下载链接](./media/active-directory-saas-replicon-tutorial/tutorial_replicon_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/active-directory-saas-replicon-tutorial/tutorial_general_400.png)
...
7. 若要配置 SAML 2.0，请执行以下步骤：
   ...
   d.单击“下一步”。 单击“选择文件”，选择标识提供者元数据 XML 文件，并单击“提交”。
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-replicon-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-replicon-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-replicon-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-replicon-tutorial/create_aaduser_04.png)
...
要使 Azure AD 用户能够登录 Replicon，必须将这些用户预配到 Replicon 中。 对于 Replicon，预配是一项手动任务。
...
4. 在“用户配置文件”部分中，执行以下步骤：
    ...
    d.单击“下一步”。 对于“员工类型”，选择“管理员”。

    e.在“新建 MySQL 数据库”边栏选项卡中，接受法律条款，并单击“确定”。 单击“保存用户配置文件”。
...
2. 在应用程序列表中，选择“Replicon”。
    ...
    ![应用程序列表中的 Replicon 链接](./media/active-directory-saas-replicon-tutorial/tutorial_replicon_app.png)  
