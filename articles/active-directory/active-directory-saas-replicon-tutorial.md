...
6. 若要配置 SAML 2.0，请执行以下步骤：
  ...
  1. 若要显示 **EnableSAML Authentication2** 对话框，请将以下内容追加到 URL 中的公司密钥后面：**/services/SecurityService1.svc/help/test/EnableSAMLAuthentication2**  
    * 下面显示完整 URL 的架构：  
