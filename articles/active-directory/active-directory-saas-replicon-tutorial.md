...
3. 在“配置应用 URL”页上，执行以下步骤：
    ...
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 在“Replicon 登录 URL”文本框中，键入 Replicon 租户 URL（例如：*https://na2.replicon.com/company/saml2/sp-sso/post*）。

    b.保留“数据库类型”设置，即设置为“共享”。 在“Replicon 答复 URL”文本框中，键入 Replicon **AssertionConsumerService** URL（例如：*https://global.replicon.com/!/saml2/company/sso/post*）。  
