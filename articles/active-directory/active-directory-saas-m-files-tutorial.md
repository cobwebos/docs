...
6. 在搜索框中，键入“M-Files”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-m-files-tutorial/tutorial_m_files_01.png)
7. 在结果窗格中，选择“M-Files”，然后单击“完成”以添加该应用程序。
...
3. **[创建 M-Files 测试用户](#creating-a-m-file-test-user)** - 目的是在 M-Files 中拥有一个与 Azure AD 中的 Britta Simon 相对应的关联用户。
...
1. 在经典门户中的“M-Files”应用程序集成页上，单击“配置单一登录”，打开“配置单一登录”对话框。
    ...
    ![配置单一登录][7] 
2. 在“你希望用户如何登录 M-Files”页上，选择“Azure AD 单一登录”，然后单击“下一步”。
   
    ![配置单一登录](./media/active-directory-saas-m-files-tutorial/tutorial_m_files_06.png)
...
1. 在 **Azure 经典门户**中，在左侧导航窗格上，单击“Active Directory”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-m-files-tutorial/create_aaduser_09.png) 
...
2. 在应用程序列表中，选择“M-Files”。
    ...
    ![配置单一登录](./media/active-directory-saas-m-files-tutorial/tutorial_m_files_12.png)
3. 在顶部菜单中，单击“用户”。
