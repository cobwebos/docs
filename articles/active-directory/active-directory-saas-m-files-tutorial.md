...
4. 在搜索框中，键入“M-Files”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-m-files-tutorial/tutorial_m-files_search.png)

5. 在结果面板中，选择“M-Files”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-m-files-tutorial/tutorial_m-files_addfromgallery.png)
...
可通过将 Azure AD 中“用户名”的值指定为 M-Files 中“用户名”的值来建立此链接关系。
...
3. **[创建 M-Files 测试用户](#creating-a-m-files-test-user)** - 目的是在 M-Files 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
4. **[分配 Azure AD 测试用户](#assigning-the-azure-ad-test-user)** - 让 Britta Simon 使用 Azure AD 单一登录。
5. **[测试单一登录](#testing-single-sign-on)** - 验证配置是否正常工作。

### <a name="configuring-azure-ad-single-sign-on"></a>配置 Azure AD 单一登录

在本部分中，将在 Azure 门户中启用 Azure AD 单一登录并在 M-Files 应用程序中配置单一登录。

**若要配置 M-Files 的 Azure AD 单一登录，请按以下步骤操作：**

1. 在 Azure 门户中的“M-Files”应用程序集成页上，单击“单一登录”。

    ![配置单一登录][4]

2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
 
    ![配置单一登录](./media/active-directory-saas-m-files-tutorial/tutorial_m-files_samlbase.png)

3. 在“M-Files 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-m-files-tutorial/tutorial_m-files_url.png)
    ...
    b. 在“标识符”文本框中，使用以下模式键入 URL：`https://<tenantname>.cloudvault.m-files.com`

    > [!NOTE] 
    > 这些不是实际值。 必须使用实际登录 URL 和标识符更新这些值。 请联系 [M-Files 客户端支持团队](mailto:support@m-files.com)获取这些值。 
 
4. 在“SAML 签名证书”部分中，单击“元数据 XML”，然后在计算机上保存元数据文件。

    ![配置单一登录](./media/active-directory-saas-m-files-tutorial/tutorial_m-files_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录](./media/active-directory-saas-m-files-tutorial/tutorial_general_400.png)

6. 若要为应用程序配置 SSO，请联系 [M-Files 支持团队](mailto:support@m-files.com)，并向他们提供下载的元数据。
...
9. 在“文档保管库连接属性”窗口中，执行以下步骤：
   
    ![配置单一登录](./media/active-directory-saas-m-files-tutorial/tutorial_m_files_11.png)  

    在“服务器”部分键入如下值：  

    a.在“横幅徽标”下面，选择“删除上传的徽标”。 键入 `<tenant-name>.cloudvault.m-files.com` 作为“名称”。 
 
    b.保留“数据库类型”设置，即设置为“共享”。 键入 **4466** 作为“端口号”。 

    c. 选择 **HTTPS** 作为“协议”。 

    d.单击“下一步”。 在“身份验证”字段中，选择“特定 Windows 用户”。 然后，会出现签名页提示。 插入 Azure AD 凭据。 
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-m-files-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-m-files-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-m-files-tutorial/create_aaduser_03.png) 

4. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-m-files-tutorial/create_aaduser_04.png) 
...
**若要将 Britta Simon 分配到 M-Files，请执行以下步骤：**
...
2. 在应用程序列表中，选择“M-Files”。
    ...
    ![配置单一登录](./media/active-directory-saas-m-files-tutorial/tutorial_m-files_app.png) 
