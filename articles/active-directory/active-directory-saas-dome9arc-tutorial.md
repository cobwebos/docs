...
4. 在搜索框中，键入“Dome9 Arc”，在结果面板中选择“Dome9 Arc”，然后单击“添加”按钮添加应用程序。
    ...
    ![结果列表中的 Dome9 Arc](./media/active-directory-saas-dome9arc-tutorial/tutorial_dome9arc_addfromgallery.png)
...
3. **[创建 Dome9 Arc 测试用户](#create-a-dome9-arc-test-user)** - 在 Dome9 Arc 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-dome9arc-tutorial/tutorial_dome9arc_samlbase.png)

3. 在“Dome9 Arc 域和 URL”部分，如果要在 IDP 发起的模式下配置应用程序，请执行以下步骤：

    ![Dome9 Arc 域和 URL 单一登录信息](./media/active-directory-saas-dome9arc-tutorial/tutorial_dome9arc_url.png)
...
4. 如果要在 SP 发起的模式下配置应用程序，请选中“显示高级 URL 设置”，并执行以下步骤：
    ...
    ![Dome9 Arc 域和 URL 单一登录信息](./media/active-directory-saas-dome9arc-tutorial/tutorial_dome9arc_url1.png)
...
5. Dome9 Arc 软件应用程序需要采用特定格式的 SAML 断言。 请为此应用程序配置以下声明。 可以在应用程序集成页的“用户属性”部分管理这些属性的值。 以下屏幕截图显示一个示例。

    ![配置单一登录 attb](./media/active-directory-saas-dome9arc-tutorial/tutorial_dome9arc_attribute.png)
...
6. 在“单一登录”对话框的“用户属性”部分中，按上图所示配置 SAML 令牌属性，并执行以下步骤：
    ...
    ![配置单一登录 add 属性](./media/active-directory-saas-dome9arc-tutorial/tutorial_dome9_04.png)

    ![配置单一登录 edit 属性](./media/active-directory-saas-dome9arc-tutorial/tutorial_attribute_05.png)
...
7. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。
    ...
    ![证书下载链接](./media/active-directory-saas-dome9arc-tutorial/tutorial_dome9arc_certificate.png) 

8. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/active-directory-saas-dome9arc-tutorial/tutorial_general_400.png)
    
9. 在“Dome9 Arc 配置”部分，单击“配置 Dome9 Arc”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 实体 ID 和 SAML 单一登录服务 URL”。

    ![Dome9 Arc 配置](./media/active-directory-saas-dome9arc-tutorial/tutorial_dome9arc_configure.png) 

10. 在另一个 Web 浏览器窗口中，以管理员身份登录到 Dome9 Arc 公司站点。

11. 单击右上角的“配置文件设置”，然后单击“帐户设置”。 

    ![Dome9 Arc 配置](./media/active-directory-saas-dome9arc-tutorial/configure1.png)

12. 导航到 **SSO**，然后单击“启用”。

    ![Dome9 Arc 配置](./media/active-directory-saas-dome9arc-tutorial/configure2.png)

13. 在“SSO 配置”部分，执行以下步骤：

    ![Dome9 Arc 配置](./media/active-directory-saas-dome9arc-tutorial/configure3.png)
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-dome9arc-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-dome9arc-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-dome9arc-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-dome9arc-tutorial/create_aaduser_04.png)
...
2. 单击“用户和角色”，然后单击“用户”。
    ...
    ![添加员工](./media/active-directory-saas-dome9arc-tutorial/user1.png)

3. 单击“添加用户”。

    ![添加员工](./media/active-directory-saas-dome9arc-tutorial/user2.png)

4. 在“创建用户”部分中，执行以下步骤：
    
    ![添加员工](./media/active-directory-saas-dome9arc-tutorial/user3.png)
...
2. 在应用程序列表中，选择“Dome9 Arc”。
    ...
    ![应用程序列表中的 Dome9 Arc 链接](./media/active-directory-saas-dome9arc-tutorial/tutorial_dome9arc_app.png)  
