...
4. 在搜索框中，键入“Wizergos Productivity Software”，在结果面板中选择“Wizergos Productivity Software”，然后单击“添加”按钮，以添加该应用程序。
    ...
    ![结果列表中的 Wizergos Productivity Software](./media/active-directory-saas-wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_addfromgallery.png)
...
3. **[创建 Wizergos Productivity Software 测试用户](#create-a-wizergos-productivity-software-test-user)** - 在 Wizergos Productivity Software 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_samlbase.png)

3. 在“Wizergos Productivity Software 域和 URL”部分中，执行以下步骤：

    ![Wizergos Productivity Software 域和 URL 单一登录信息](./media/active-directory-saas-wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_url.png)

    在“标识符”文本框中，键入 URL：`http://www.wizergos.net`

4. 在“SAML 签名证书”部分中单击“证书”，然后在计算机上保存证书文件。

    ![证书下载链接](./media/active-directory-saas-wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/active-directory-saas-wizergosproductivitysoftware-tutorial/tutorial_general_400.png)

6. 在“Wizergos Productivity Software 配置”部分中，单击“配置 Wizergos Productivity Software”，以打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![Wizergos Productivity Software 配置](./media/active-directory-saas-wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_configure.png) 

7. 在其他 Web 浏览器窗口中，以管理员身份登录到 Wizergos Productivity Software 租户。
...
9. 在左侧菜单的“管理员”页中，选择“身份验证”，并单击“Azure AD”。
...
10. 在“身份验证”部分执行以下步骤。
    ...
    d.单击“下一步”。 在“单一注销 URL”文本框中，粘贴从 Azure 门户复制的“SAML 单一注销服务 URL”值。
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-wizergosproductivitysoftware-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-wizergosproductivitysoftware-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-wizergosproductivitysoftware-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-wizergosproductivitysoftware-tutorial/create_aaduser_04.png)
...
2. 在应用程序列表中，选择“Wizergos Productivity Software”。
    ...
    ![应用程序列表中的 Wizergos Productivity Software 链接](./media/active-directory-saas-wizergosproductivitysoftware-tutorial/tutorial_wizergosproductivitysoftware_app.png)  
