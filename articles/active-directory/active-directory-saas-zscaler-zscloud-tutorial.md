...
5. 在“要执行什么操作”对话框中，单击“从库中添加应用程序”。
   ...
   ![从库中添加应用程序](./media/active-directory-saas-zscaler-zscloud-tutorial/IC749322.png "Add an application from gallerry")
...
3. 在“配置应用 URL”页的“Zscaler ZSCloud 登录 URL”文本框中，键入用户登录到 Zscaler ZSCloud 应用程序时使用的 URL，然后单击“下一步”。
   ...
   ![配置应用 URL](./media/active-directory-saas-zscaler-zscloud-tutorial/IC800280.png "Configure App URL")
...
5. 在“添加用户”分区中，执行以下步骤：
   ...
   1. 输入“UserID”、“用户显示名称”、“密码”和“确认密码”，然后选择想要预配的有效 AAD 帐户的“组”和“部门”。
   2. 单击“保存” 。
