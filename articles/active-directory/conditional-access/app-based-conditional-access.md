...
Azure Active Directory 条件访问允许支持 Intune 应用保护策略的客户端应用云应用程序中限制访问。 例如，可以限制为只有 Outlook 应用程序，才能访问 Exchange Online。
...
2. **用户和组**：每个条件性访问策略必须具有至少一个用户或组处于选定状态。
