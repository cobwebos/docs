...
你的员工使用移动设备进行个人任务和工作任务。 既要确保提高员工的工作效率，也要防止数据丢失。 使用 Azure Active Directory （Azure AD）条件性访问，你可以将云应用的访问权限限制为可保护你的公司数据的批准的客户端应用。  
...
1. 条件访问策略的**名称**。
1. **用户和组**：每个条件访问策略必须至少选择一个用户或组。
1. **云应用：** 对于云应用，需选择 Office 365 Exchange Online。 Online 
