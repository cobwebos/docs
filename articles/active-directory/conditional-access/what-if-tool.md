...
在应用于所选用户的策略列表中，还可以找到用户必须满足的[授权控件](concept-conditional-access-grant.md)和[会话控件](concept-conditional-access-session.md)的列表。
...
- 如果已准备好为环境配置条件访问策略，请参阅条件性[访问公用策略](concept-conditional-access-policy-common.md)。 
