...
1. [注册 Azure Monitor 订阅并创建工作区](../../azure-monitor/learn/quick-create-workspace.md)。
1. [将登录日志从 Azure AD 导出到 Azure Monitor](../reports-monitoring/howto-integrate-activity-logs-with-log-analytics.md)。
