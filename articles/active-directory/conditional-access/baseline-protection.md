...
如果脚本中使用了特权帐户，则应将这些帐户替换为 [Azure 资源的托管标识](../managed-identities-azure-resources/overview.md)或[带证书的服务主体](../develop/howto-authenticate-service-principal-powershell.md)。 作为临时解决方法，可以从基线策略中排除特定的用户帐户。 
