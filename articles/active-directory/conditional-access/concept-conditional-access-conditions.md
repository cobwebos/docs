...
> [!WARNING]
> Microsoft 意识到条件访问策略和基于 macOS 10.15.4 的设备存在问题。 有关详细信息，请参阅博客文章[：已知问题：条件访问意外阻止 macOS 10.15.4 本机邮件客户端/其他应用](https://techcommunity.microsoft.com/t5/intune-customer-success/known-issue-conditional-access-unexpectedly-blocking-macos-10-15/ba-p/1322283)。
...
| Windows Server Standard 2012 R2 | Microsoft Edge、Internet Explorer、Chrome |
...
| Visual Studio Team Services 应用 | Visual Studio 团队服务 | Windows 10、Windows 8.1、Windows 7、iOS 和 Android |
