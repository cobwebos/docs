...
1. 选择“新策略”。
1. 为策略指定一个名称。 建议组织为其策略的名称创建有意义的标准。
1. 在“分配”  下，选择“用户和组”  。
   1. 在“包括”下，选择“所有用户”。  
   1. 在“排除”下，选择“用户和组”，并选择组织的紧急访问或不受限帐户。 
   1. 选择“完成”  。
1. 在“云应用或操作”   >   “包括”下，选择“所有云应用”。 
1. 在 "**条件**  >  **用户风险**" 下，将**配置**设置为 **"是"**。 在 **"选择将应用此策略的登录风险级别"** 下 
   1. 选择 "**高**" 和 "**中**"。
   1. 选择“完成” 。
...
[基于用户风险的条件性访问](howto-conditional-access-policy-risk-user.md)
