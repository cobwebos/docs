...
* 使用旧邮件协议，如 IMAP/SMPT/POP3 任何客户端
...
SharePoint Online 启用新式身份验证默认值。 对于 2017 年 8 月 1 日之后创建的目录默认情况下，在 Exchange Online 中启用新式身份验证。 但是，如果以前已禁用新式身份验证，或者是否使用在此日期之前创建的一个目录，按照以下文章中的步骤[Exchange Online 中的启用新式验证](https://docs.microsoft.com/en-us/exchange/clients-and-mobile-in-exchange-online/enable-or-disable-modern-authentication-in-exchange-online)。
