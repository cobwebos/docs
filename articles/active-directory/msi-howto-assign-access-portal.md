...
在 Azure 资源（[如 Azure VM](msi-qs-configure-portal-windows-vm.md) 或 [Azure VMSS](msi-qs-configure-portal-windows-vmss.md)）上启用 MSI 后：
...
- 若要在 Azure 虚拟机上启用 MSI，请参阅[使用 Azure 门户配置 Azure VM 托管服务标识 (MSI)](msi-qs-configure-portal-windows-vm.md)。
