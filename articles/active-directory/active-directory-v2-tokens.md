<properties
	pageTitle="Azure AD v2.0 令牌参考 | Microsoft Azure"
...
若要在令牌响应中接收刷新令牌，应用必须请求并获得 `offline_acesss` 范围。若要深入了解 `offline_access` 范围，请参阅[此处有关同意和范围的文章](active-directory-v2-scopes.md)。
