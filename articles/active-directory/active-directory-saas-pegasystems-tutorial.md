...
4. 在搜索框中，键入“Pega Systems”，在结果面板中选择“Pega Systems”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 Pega Systems](./media/active-directory-saas-pegasystems-tutorial/tutorial_pegasystems_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-pegasystems-tutorial/tutorial_pegasystems_samlbase.png)

3. 在“Pega Systems 域和 URL”部分中，如果要在“IDP”发起的模式下配置应用程序，请执行以下步骤：

    ![Pega Systems 域和 URL 单一登录信息](./media/active-directory-saas-pegasystems-tutorial/tutorial_pegasystems_url.png)
...
4. 如果要在 SP 发起的模式下配置应用程序，请选中“显示高级 URL 设置”，并执行以下步骤：
    ...
    ![Pega Systems 域和 URL 单一登录信息](./media/active-directory-saas-pegasystems-tutorial/tutorial_pegasystems_url1.png)
...
5. Pega Systems 应用程序需要特定格式的 SAML 断言，这要求向 SAML 令牌属性配置添加自定义属性映射。 这些声明是客户特定的，并取决于你的要求。 以下可选的声明只是你可以为应用程序配置的示例。 可以在应用程序集成页的“用户属性”部分管理这些属性的值。 
    ...
    ![配置单一登录](./media/active-directory-saas-pegasystems-tutorial/tutorial_attribute.png)
...
6. 在“单一登录”对话框的“用户属性”部分中，按上图所示配置 SAML 令牌属性，再执行以下步骤：
    ...
    ![配置单一登录](./media/active-directory-saas-pegasystems-tutorial/tutorial_attribute_04.png)

    ![配置单一登录](./media/active-directory-saas-pegasystems-tutorial/tutorial_attribute_05.png)
...
7. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![证书下载链接](./media/active-directory-saas-pegasystems-tutorial/tutorial_pegasystems_certificate.png) 
8. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/active-directory-saas-pegasystems-tutorial/tutorial_general_400.png)
    
9. 要在“Pega Systems”端上配置单一登录，请在另一个浏览器窗口中使用管理员帐户打开“Pega 门户”。

10. 选择“创建” -> “SysAdmin” -> “身份验证服务”。

    ![配置单一登录“保存”按钮](./media/active-directory-saas-pegasystems-tutorial/tutorial_pegasystems_admin.png)
    
11. 在“创建身份验证服务”屏幕上执行以下操作：

    ![配置单一登录“保存”按钮](./media/active-directory-saas-pegasystems-tutorial/tutorial_pegasystems_admin1.png)
...
12. 在“标识提供者 (IdP) 信息”部分中，单击“导入 IdP 元数据”，然后浏览已从 Azure 门户下载的元数据文件。 单击“提交”以加载元数据。
    ...
    ![配置单一登录“保存”按钮](./media/active-directory-saas-pegasystems-tutorial/tutorial_pegasystems_admin2.png)
    
13. 该操作将填充 IdP 数据，如下所示。

    ![配置单一登录“保存”按钮](./media/active-directory-saas-pegasystems-tutorial/tutorial_pegasystems_admin3.png)
    
14. 在“服务提供者 (SP) 设置”部分执行以下操作：

    ![配置单一登录“保存”按钮](./media/active-directory-saas-pegasystems-tutorial/tutorial_pegasystems_admin4.png)
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-pegasystems-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-pegasystems-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-pegasystems-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-pegasystems-tutorial/create_aaduser_04.png)
...
2. 在应用程序列表中，选择“Pega Systems”。
    ...
    ![应用程序列表中的 Pega Systems 链接](./media/active-directory-saas-pegasystems-tutorial/tutorial_pegasystems_app.png)  
