...
4. 在搜索框中，键入“Reward Gateway”。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-reward-gateway-tutorial/tutorial_rewardgateway_search.png)

5. 在结果面板中，选择“Reward Gateway”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-reward-gateway-tutorial/tutorial_rewardgateway_addfromgallery.png)
...
3. [创建 Reward Gateway 测试用户](#creating-a-reward-gateway-test-user) - 在 Reward Gateway 中有一个与 Azure AD 中的 Britta Simon 相对应的关联用户。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-reward-gateway-tutorial/tutorial_rewardgateway_samlbase.png)

3. 在“Reward Gateway 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-reward-gateway-tutorial/tutorial_rewardgateway_url.png)
...
4. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![配置单一登录](./media/active-directory-saas-reward-gateway-tutorial/tutorial_rewardgateway_certificate.png) 
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-reward-gateway-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-reward-gateway-tutorial/create_aaduser_02.png) 
...
2. 在应用程序列表中，选择“Reward Gateway”。
    ...
    ![配置单一登录](./media/active-directory-saas-reward-gateway-tutorial/tutorial_rewardgateway_app.png) 
