...
在本部分中，将在经典门户中启用 Azure AD 单一登录并在 Reward Gateway 应用程序中配置单一登录。
...
3. 在“配置应用设置”对话框页上，执行以下步骤：
    ...
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 在“标识符 URL”文本框中，使用以下模式键入用户用于登录 Reward Gateway 应用程序的 URL： 
...
1. 在“配置 Reward Gateway 的单一登录”页上，执行以下步骤：
...
2. 若要为应用程序配置 SSO，请联系 Reward Gateway [支持团队](mailTo:clientsupport@rewardgateway.com)，并向他们提供以下内容：
...
5. 在“告诉我们有关此用户的信息”对话框页中，执行以下步骤： ![创建 Azure AD 测试用户](./media/active-directory-saas-reward-gateway-tutorial/create_aaduser_05.png) 
...
6. 在“用户配置文件”对话框页面上，执行以下步骤：![创建 Azure AD 测试用户](./media/active-directory-saas-reward-gateway-tutorial/create_aaduser_06.png) 
...
### <a name="creating-an-reward-gateway-test-user"></a>创建 Reward Gateway 测试用户
