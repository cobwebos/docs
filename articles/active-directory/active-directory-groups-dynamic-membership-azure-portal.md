...
我们正在更新 Azure 门户以支持此功能。 在此期间，可按如下所示使用 [Azure 经典门户](https://manage.windowsazure.com)（遵照[此处](active-directory-groups-dynamic-membership-azure-portal.md)的说明）或使用 PowerShell cmdlet。
