...
4. 在搜索框中，键入“Workpath”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-workpath-tutorial/tutorial_workpath_search.png)

5. 在结果窗格中，选择“Workpath”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-workpath-tutorial/tutorial_workpath_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-workpath-tutorial/tutorial_workpath_samlbase.png)
...
4. 选中“显示高级 URL 设置”。 如果要在“SP”发起的模式下配置应用程序，请执行以下步骤：
    ...
    ![配置单一登录](./media/active-directory-saas-workpath-tutorial/tutorial_workpath_url1.png)
...
6. 在“单一登录”对话框的“用户属性”部分，按图中所示配置 SAML 令牌属性，然后执行以下步骤：
    ...
    ![配置单一登录](./media/active-directory-saas-workpath-tutorial/tutorial_attribute_05.png)
...
8. 单击“保存”按钮。
    ...
    ![配置单一登录](./media/active-directory-saas-workpath-tutorial/tutorial_general_400.png)

9. 在“Workpath 配置”部分上，单击“配置 Workpath”，打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![配置单一登录](./media/active-directory-saas-workpath-tutorial/tutorial_workpath_configure.png) 
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-workpath-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-workpath-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-workpath-tutorial/create_aaduser_03.png) 
...
2. 在应用程序列表中，选择“Workpath”。
    ...
    ![配置单一登录](./media/active-directory-saas-workpath-tutorial/tutorial_workpath_app.png) 
