...
3. **[创建一个 OfficeSpace Software 测试用户](#create-a-officespace-software-test-user)** -若要链接到用户的 Azure AD 表示的 OfficeSpace Software 中具有 Britta 人 Simon 的副本。
...
4. 在“用户”对话框中，执行以下步骤：
    ...
    ![“用户”对话框](./media/active-directory-saas-officespace-tutorial/create_aaduser_04.png)
