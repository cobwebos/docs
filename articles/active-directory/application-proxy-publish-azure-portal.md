...
请按照下列步骤使用应用程序代理发布应用。 如果尚未为组织下载并配置连接器，请先转到[开始使用应用程序代理并安装连接器](active-directory-application-proxy-enable.md)，然后发布应用。
...
5. 如有必要，请配置其他设置。 对于大多数应用程序，应保留这些设置的默认状态。 
   ...
   - 转换应用程序正文中的 URL：除非具有指向其他本地应用程序的硬编码 HTML 链接，且不使用自定义域，否则请将此值保留为“否”。 有关详细信息，请参阅[使用应用程序代理进行链接转换](application-proxy-link-translation.md)。
