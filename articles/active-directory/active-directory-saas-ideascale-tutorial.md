...
4. 在搜索框中，键入“IdeaScale”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-ideascale-tutorial/tutorial_ideascale_search.png)

5. 在结果面板中，选择“IdeaScale”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-ideascale-tutorial/tutorial_ideascale_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-ideascale-tutorial/tutorial_ideascale_samlbase.png)

3. 在“IdeaScale 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-ideascale-tutorial/tutorial_ideascale_url.png)
...
4. 在“SAML 签名证书”部分中，单击“元数据 XML”，然后在计算机上保存元数据文件。
    ...
    ![配置单一登录](./media/active-directory-saas-ideascale-tutorial/tutorial_ideascale_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录](./media/active-directory-saas-ideascale-tutorial/tutorial_general_400.png)

6. 在“IdeaScale 配置”部分，单击“配置 IdeaScale”打开“配置登录”窗口。 从“快速参考”部分复制“注销 URL”和“SAML 实体 ID”。

    ![配置单一登录](./media/active-directory-saas-ideascale-tutorial/tutorial_ideascale_configure.png) 
...
11. 在“单一登录设置”对话框上，执行以下步骤：
    ...
    a.在“横幅徽标”下面，选择“删除上传的徽标”。 在“SAML IdP 实体 ID”文本框中，粘贴从 Azure 门户复制的“SAML 实体 ID”值。

    b.在“磁贴徽标”下面，选择“删除上传的徽标”。 从 Azure 门户复制下载的元数据文件内容，然后将其粘贴到“SAML IdP 元数据”文本框。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-ideascale-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-ideascale-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-ideascale-tutorial/create_aaduser_03.png) 

4. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-ideascale-tutorial/create_aaduser_04.png) 
...
5. 在“添加新成员”部分中，执行以下步骤：
    ...
    a.在“横幅徽标”下面，选择“删除上传的徽标”。 在“电子邮件地址”文本框中，键入要预配的有效 AAD 帐户的电子邮件地址。
...
2. 在应用程序列表中，选择“IdeaScale”。
    ...
    ![配置单一登录](./media/active-directory-saas-ideascale-tutorial/tutorial_ideascale_app.png) 
