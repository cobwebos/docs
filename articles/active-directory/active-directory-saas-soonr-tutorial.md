---
title: "教程：Azure Active Directory 与 Soonr Workplace 集成 | Microsoft 文档"
...
本部分的目的是在 Azure 经典门户中启用 Azure AD 单一登录并在 Soonr Workplace 应用程序中配置单一登录。
...
3. 在“配置应用设置”对话框页上，执行以下步骤：
    ...
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 在“登录 URL”文本框中，使用以下模式键入用户用于登录应用程序的 URL：`https://<server-name>.soonr.com/singlesignon/saml/SSO`。

    b.保留“数据库类型”设置，即设置为“共享”。 单击“资源组名称” 的 Azure 数据工厂。

1. 在“配置 Soonr Workplace 的单一登录”页上，执行以下步骤：
    ...
    b.保留“数据库类型”设置，即设置为“共享”。 **颁发者 URL**
   
    C. **SAML SSO URL**
   
    D. **单一注销服务 URL**
2. 若要配置 Soonr Workplace 的单一登录，请在<a href="https://na01.safelinks.protection.outlook.com/?url=http%3A%2F%2Fsoonr.com%2FAWPHelp%2FContent%2F0_HOME%2FSupport_for_End_Clients.htm&data=01%7C01%7Cv-saikra%40microsoft.com%7Ccbb4367ab09b4dacaac408d3eebe3f42%7C72f988bf86f141af91ab2d7cd011db47%7C1&sdata=FB92qtE6m%2Fd8yox7AnL2f1h%2FGXwSkma9x9H8Pz0955M%3D&reserved=0/">此处</a>联系 Sooner 团队。
