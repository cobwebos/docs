...
4. 在搜索框中，键入 SAML SSO for Bamboo by resolution GmbH，在结果面板中选择 SAML SSO for Bamboo by resolution GmbH，然后单击“添加”按钮以添加该应用程序。
    ...
    ![结果列表中的 SAML SSO for Bamboo by resolution GmbH](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_addfromgallery.png)
...
3. **[创建 SAML SSO for Bamboo by resolution GmbH 测试用户](#create-a-saml-sso-for-bamboo-by-resolution-gmbh-test-user)** - 在 SAML SSO for Bamboo by resolution GmbH 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_samlbase.png)

3. 如果想在 IDP 启动模式下配置应用程序，请在“SAML SSO for Bamboo by resolution GmbH 域和 URL”部分执行下列步骤：

    ![SAML SSO for Bamboo by resolution GmbH 域和 URL 单一登录信息](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_url.png)
...
4. 如果要在 SP 发起的模式下配置应用程序，请选中“显示高级 URL 设置”，并执行以下步骤：
    ...
    ![SAML SSO for Bamboo by resolution GmbH 域和 URL 单一登录信息](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_url1.png)
...
5. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![证书下载链接](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_certificate.png) 

6. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/active-directory-saas-bamboo-tutorial/tutorial_general_400.png)

7. 以管理员身份登录到 SAML SSO for Bamboo by resolution GmbH 公司站点。

8. 在主工具栏的右侧，单击“设置” > “加载项”。

    ![设置](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_setings.png)

9. 转到“安全性”部分，在菜单栏上单击“SAML 单一登录”。

    ![Samlsingle](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_samlsingle.png)

10. 在“SAML 单一登录插件配置”页上，单击“添加 idp”。 

    ![添加 idp](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_addidp.png)

11. 在“选择 SAML 标识提供者”页上，执行以下步骤：

    ![标识提供者](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_identityprovider.png)
...
12. 在“标识提供者配置”页上，单击“下一步”。
    ...
    ![标识配置](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_identityconfig.png)
...
15. 单击“保存设置”。
    ...
    ![保存](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_save.png)
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-bamboo-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-bamboo-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-bamboo-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-bamboo-tutorial/create_aaduser_04.png)
...
2. 在应用程序列表中，选择 SAML SSO for Bamboo by resolution GmbH。
    ...
    ![应用程序列表中的 SAML SSO for Bamboo by resolution GmbH 链接](./media/active-directory-saas-bamboo-tutorial/tutorial_bamboo_app.png)  
