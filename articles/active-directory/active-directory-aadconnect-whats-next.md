...
- [更改 Azure AD Connect 的默认配置](active-directory-aadconnect-whats-next-change-default-config.md)
- [使用 Azure AD Connect 同步规则编辑器](active-directory-aadconnect-whats-next-synch-rules-editor.md)
- [使用声明性设置](active-directory-aadconnect-whats-next-declarative-prov.md)

另外，为 Azure AD Sync 创建的某些文档仍有参考价值，并适用于 Azure AD Connect。尽管我们正在努力将这些文档发布到 Azure.com，但有些文档目前仍然只能在 MSDN 范围的库中提供。有关其他文档，请参阅 [MSDN 上的 Azure AD Connect](active-directory-aadconnect.md) 和 [MSDN 上的 Azure AD Sync](https://msdn.microsoft.com/library/azure/dn790204.aspx)。
