...
4. 在搜索框中键入“Onit”，在结果面板中选择“Onit”，然后单击“添加”按钮添加应用程序。
    ...
    ![结果列表中的 Onit](./media/active-directory-saas-onit-tutorial/tutorial_onit_addfromgallery.png)
...
3. **[创建 Onit 测试用户](#create-an-onit-test-user)** - 在 Onit 中创建 Britta Simon 的对应用户，将其链接到用户的 Azure AD 表示形式。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-onit-tutorial/tutorial_onit_samlbase.png)

3. 在“Onit 域和 URL”部分中，执行以下步骤：

    ![Onit 域和 URL 单一登录信息](./media/active-directory-saas-onit-tutorial/tutorial_onit_url.png)
...
4. 在“SAML 签名证书”部分中，复制证书的“指纹”值。
    ...
    ![证书下载链接](./media/active-directory-saas-onit-tutorial/tutorial_onit_certificate.png) 

5. Onit 应用程序需要特定格式的 SAML 断言。 请为此应用程序配置以下声明。 可从应用程序的“属性”选项卡管理这些属性的值。 以下屏幕截图显示一个示例。 

    ![配置单一登录](./media/active-directory-saas-onit-tutorial/tutorial_onit_attribute.png) 
...
6. 在“单一登录”对话框的“用户属性”部分，按图中所示配置 SAML 令牌属性，然后执行以下步骤：
    ...
    ![配置单一登录](./media/active-directory-saas-onit-tutorial/tutorial_attribute_04.png)

    ![配置单一登录](./media/active-directory-saas-onit-tutorial/tutorial_attribute_05.png)
...
7. 单击“保存”按钮。
    ...
    ![配置单一登录“保存”按钮](./media/active-directory-saas-onit-tutorial/tutorial_general_400.png)

8. 在“Onit 配置”部分，单击“配置 Onit”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL 和 SAML 单一登录服务 URL”。

    ![Onit 配置](./media/active-directory-saas-onit-tutorial/tutorial_onit_configure.png)
...
13. 在“安全”选项卡中，执行以下步骤：
    ...
    d.单击“下一步”。 在“Idp 证书指纹(SHA1)”文本框中，粘贴从 Azure 门户复制的证书“指纹”值。
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-onit-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-onit-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-onit-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-onit-tutorial/create_aaduser_04.png)
...
2. 在应用程序列表中，选择“Onit”。
    ...
    ![应用程序列表中的 Onit 链接](./media/active-directory-saas-onit-tutorial/tutorial_onit_app.png)  
