...
完成本教程以后，分配到 Onit 的 Azure AD 用户就可以通过单一登录登录到 Onit 公司站点的应用程序（通过服务提供商启动登录），或者参阅 [Introduction to the Access Panel](active-directory-saas-access-panel-introduction.md)（访问面板简介）进行单一登录。
...
### <a name="to-enable-the-application-integration-for-onit-perform-the-following-steps"></a>若要为 Onit 启用应用程序集成，请执行以下步骤：
...
5. 在“要执行什么操作”对话框中，单击“从库中添加应用程序”。
   ...
   ![从库中添加应用程序](./media/active-directory-saas-onit-tutorial/IC749322.png "Add an application from gallerry")
6. 在**搜索框**中，键入“Onit”。
...
1. 单击“应用更改”。
2. 在浏览器中，单击“后退”以再次打开“快速启动”对话框。
3. 单击“配置单一登录”以打开“配置单一登录”对话框。
   
   ![配置单一登录](./media/active-directory-saas-onit-tutorial/IC791170.png "Configure Single Sign-On")
4. 在“你希望用户如何登录 Onit”页上，选择“Microsoft Azure AD 单一登录”，然后单击“下一步”。
   
   ![配置单一登录](./media/active-directory-saas-onit-tutorial/IC791171.png "Configure Single Sign-On")
5. 在“配置应用 URL”页的“Onit 登录 URL”文本框中，键入用户用于登录 Onit 应用程序的 URL（例如：“*https://ms-sso-test.onit.com*”），然后单击“下一步”。
   
   ![配置应用 URL](./media/active-directory-saas-onit-tutorial/IC791172.png "Configure App URL")
6. 在“配置 Onit 的单一登录”页面上，若要下载证书，请单击“下载证书”，然后将证书文件保存在本地计算机上。
   
   ![配置单一登录](./media/active-directory-saas-onit-tutorial/IC791173.png "Configure Single Sign-On")
7. 在另一 Web 浏览器窗口中，以管理员身份登录到 Onit 公司站点。
8. 在顶部菜单中，单击“管理”。
...
### <a name="to-assign-users-to-onit-perform-the-following-steps"></a>若要将用户分配到 Onit，请执行以下步骤：
