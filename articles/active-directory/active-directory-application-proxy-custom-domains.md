---
title: "使用 Azure AD 应用程序代理中的自定义域 | Microsoft Docs"
...
## <a name="selecting-your-custom-domain"></a>选择自定义域
...
## <a name="frequently-asked-questions-about-working-with-custom-domains"></a>有关使用自定义域的常见问题
