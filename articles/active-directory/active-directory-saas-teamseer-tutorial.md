...
## <a name="enable-the-application-integration-for-teamseer"></a>为 TeamSeer 启用应用程序集成
本部分的目的是概述如何为 TeamSeer 启用应用程序集成。

**若要为 TeamSeer 启用应用程序集成，请执行以下步骤：**
...
1. 在 Azure 经典门户的“TeamSeer”应用程序集成页上，单击“配置单一登录”，打开“配置单一登录”对话框。
