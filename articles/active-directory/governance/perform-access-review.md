---
title: 在访问评审中查看对组 & 应用程序的访问-Azure AD
...
ms.locfileid: "75422458"
---
# <a name="review-access-to-groups-and-applications-in-azure-ad-access-reviews"></a>在 Azure AD 访问评审中查看对组和应用程序的访问权限
