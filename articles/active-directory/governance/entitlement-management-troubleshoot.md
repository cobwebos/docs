...
* 当用户要请求访问包的访问权限时，请确保他们使用访问包的 "**我的访问门户" 链接**。 有关详细信息，请参阅 "[共享链接" 来请求访问包](entitlement-management-access-package-settings.md)。  如果外部用户访问**myaccess.microsoft.com**，则他们会在其组织中看到可供他们使用的访问包。
