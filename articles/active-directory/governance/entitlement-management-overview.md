...
Azure AD 权利管理可帮助解决这些难题。  若要详细了解客户如何使用 Azure AD 的权利管理，你可以阅读[Avanade 案例研究](https://customers.microsoft.com/story/avanade-professional-services-azure-canada)和[Centrica 案例研究](https://customers.microsoft.com/story/757467-centrica-energy-azure)。  此视频概述了权利管理及其价值：
...
- 员工对于特定任务需要有时间限制的访问权限。  例如，你可以使用基于组的许可和动态组来确保所有员工都有 Exchange Online 邮箱，然后在员工需要其他访问权限的情况下使用访问包，如从其他部门读取部门资源。
...
请确保目录中包含的 Azure AD Premium P2 许可证数量至少相同：
