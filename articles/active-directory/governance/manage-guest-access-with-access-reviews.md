...
有关详细信息，[许可证要求](access-reviews-overview.md#license-requirements)。

## <a name="create-and-perform-an-access-review-for-guests"></a>创建和执行来宾的访问评审

首先，作为全局管理员或用户管理员，请转到["标识治理"页](https://portal.azure.com/#blade/Microsoft_AAD_ERM/DashboardBlade/)，以确保访问审核已为您的组织做好准备。
...
1. 要为组创建访问审阅，请选择审核以仅包括来宾用户成员，并且成员自行审阅。 有关详细信息，请参阅[创建组或应用程序的访问评审](create-access-review.md)。

2. 让每个来宾自我评审其成员身份。 默认情况下，接受邀请的每个来宾会收到来自 Azure AD 的电子邮件，其中包含访问评审的链接。 Azure AD 为来宾提供了有关如何[查看对组或应用程序的访问](perform-access-review.md)的说明。
...
1. 要为组创建访问审阅，请选择审核以仅包括来宾用户成员。 然后指定一个或多个审阅者。 有关详细信息，请参阅[创建组或应用程序的访问评审](create-access-review.md)。
...
1. 要为应用程序创建访问审阅，请选择审核以仅包括来宾，以及用户查看自己的访问权限。 有关详细信息，请参阅[创建组或应用程序的访问评审](create-access-review.md)。

2. 让每个来宾自我评审他们对应用程序的访问权限。 默认情况下，接受邀请的每个来宾会收到来自 Azure AD 的电子邮件。 该电子邮件中包含指向组织访问面板中访问评审的链接。 Azure AD 为来宾提供了有关如何[查看对组或应用程序的访问](perform-access-review.md)的说明。
...
1. 要为应用程序创建访问审阅，请选择审核以仅包括来宾。 然后指定一个或多个用户作为审阅者。 有关详细信息，请参阅[创建组或应用程序的访问评审](create-access-review.md)。
...
2. 要为该组创建访问审阅，请选择审阅者作为成员本身。 有关详细信息，请参阅[创建组或应用程序的访问评审](create-access-review.md)。

3. 让每个来宾自我评审其成员身份。 默认情况下，接受邀请的每个来宾会收到来自 Azure AD 的电子邮件，其中包含组织访问面板中访问评审的链接。 Azure AD 为来宾提供了有关如何[查看对组或应用程序的访问](perform-access-review.md)的说明。  未接受其邀请的这些来宾将在评审结果中显示为“未通知”。
