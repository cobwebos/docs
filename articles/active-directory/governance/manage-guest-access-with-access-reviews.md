---
title: 管理来宾访问权限使用访问评审的 Azure Active Directory |Microsoft Docs
...
首先，作为全局管理员或用户管理员，请转到[标识监管页](https://portal.azure.com/#blade/Microsoft_AAD_ERM/DashboardBlade/)确保访问评审为你的组织已准备就绪。
