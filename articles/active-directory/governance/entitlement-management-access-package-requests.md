---
title: 查看 Azure AD 权限管理中访问包的请求 Azure Active Directory
description: 了解如何在 Azure Active Directory 权限管理中查看访问包的请求。
...
ms.locfileid: "78376475"
---
# <a name="view-requests-for-an-access-package-in-azure-ad-entitlement-management"></a>查看 Azure AD 权限管理中访问包的请求

在 Azure AD 授权管理中，可以看到谁已请求访问包、其策略和状态。 本文介绍如何查看访问包的请求。
...
- [请求疑难解答](entitlement-management-troubleshoot.md#requests)
