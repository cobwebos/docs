...
| 管理员可使用5个用户和108个来宾用户创建组 C 的访问评审。 使其成为自我审查。 | 1个许可证，适用于每个用户的管理员 + 5 个许可证，其中每个用户都具有所需的1:5 比，涵盖所有108来宾用户。<br/>1 + 5 = 6 个许可证，涵盖 5 @ no__t-06 = 30 个来宾用户。 对于剩余的（108-5 @ no__t） = 78 个来宾用户，需要 78/5 = 16 个附加许可证。 因此，总共需要 6 + 16 = 22 个许可证。 | 22 |
