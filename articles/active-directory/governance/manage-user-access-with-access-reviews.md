...
> [!NOTE]
> 如果仅评审来宾用户的访问权限，而无需评审所有用户的访问权限，请参阅[使用访问评审管理来宾用户访问权限](manage-guest-access-with-access-reviews.md)。 如果要查看用户在管理角色（如全局管理员）中的成员身份，请参阅[在 Azure AD 特权标识管理中启动访问审核](../privileged-identity-management/pim-how-to-start-security-review.md)。
...
3. 以全局管理员或用户管理员身份，转到[“标识监管”页](https://portal.azure.com/#blade/Microsoft_AAD_ERM/DashboardBlade/)。
