...
### <a name="i-want-to-allow-users-from-my-business-partners-including-users-not-yet-in-my-directory-to-request-access-to-groups-applications-or-sharepoint-sites"></a>我想要允许用户从我的业务合作伙伴 （我的目录中尚不包括用户） 组、 应用程序或 SharePoint 站点的请求访问
