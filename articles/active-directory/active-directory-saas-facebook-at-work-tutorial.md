...
3. 若要添加新应用程序，请单击对话框顶部的“新增应用程序”按钮。
...
3. 在“Workplace by Facebook 域和 URL”部分中，执行以下步骤：
    ...
    ![域和 URL 单一登录信息](./media/active-directory-saas-facebook-at-work-tutorial/tutorial_workplacebyfacebook_url.png)

    a. 在“登录 URL”文本框中，使用以下模式键入 URL：`https://<scim company id>.facebook.com`
...
* [配置用户预配](active-directory-saas-facebook-at-work-provisioning-tutorial.md)
