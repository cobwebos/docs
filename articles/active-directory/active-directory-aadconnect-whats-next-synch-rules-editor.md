...
在 Azure AD Connect 中，你可以通过配置同步规则，来配置和优化 Azure AD 与本地目录之间的对象和属性流。
...
![联接规则](./media/active-directory-aadconnect-whats-next-synch-rules-editor/sync1.png)
...
![联接规则](./media/active-directory-aadconnect-whats-next-synch-rules-editor/sync2.png)
...
![联接规则](./media/active-directory-aadconnect-whats-next-synch-rules-editor/sync3.png)
...
![联接规则](./media/active-directory-aadconnect-whats-next-synch-rules-editor/sync4.png)
...
![联接规则](./media/active-directory-aadconnect-whats-next-synch-rules-editor/sync5.png)
