...
4. 在搜索框中，键入“Showpad”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-showpad-tutorial/tutorial_showpad_search.png)

5. 在结果面板中，选择“Showpad”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-showpad-tutorial/tutorial_showpad_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-showpad-tutorial/tutorial_showpad_samlbase.png)

3. 在“Showpad 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-showpad-tutorial/tutorial_showpad_url.png)
...
5. 单击“保存”按钮。
    ...
    ![配置单一登录](./media/active-directory-saas-showpad-tutorial/tutorial_general_400.png)
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-showpad-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-showpad-tutorial/create_aaduser_02.png) 
...
2. 在应用程序列表中，选择“Showpad”。
    ...
    ![配置单一登录](./media/active-directory-saas-showpad-tutorial/tutorial_showpad_app.png) 
