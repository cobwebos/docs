...
在本部分中，基于一个名为“Britta Simon”的测试用户使用 HireVue 配置和测试 Azure AD 单一登录。

若要运行单一登录，Azure AD 需要知道与 Azure AD 用户相对应的 HireVue 用户。 换句话说，需要在 Azure AD 用户与 HireVue 中相关用户之间建立链接关系。
...
在本部分中，在经典门户中启用 Azure AD 单一登录，并在 HireVue 应用程序中配置单一登录。
...
3. 在“配置应用设置”对话框页上，执行以下步骤：
    ...
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 在“登录 URL”文本框中，使用以下模式键入用户用于登录 HireVue 应用程序的 URL： 
...
1. 在“配置 HireVue 的单一登录”页上，执行以下步骤：
...
### <a name="creating-an-hirevue-test-user"></a>创建 HireVue 测试用户
在本部分中，将在 HireVue 中创建一个名为“Britta Simon”的用户。 请与 HireVue 支持团队协作，将用户添加到 HireVue 平台中。

### <a name="assigning-the-azure-ad-test-user"></a>分配 Azure AD 测试用户
在本部分中，通过授予 Britta Simon 访问 HireVue 的权限，允许她使用 Azure 单一登录。
