...
4. 在搜索框中，键入“HireVue”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-hirevue-tutorial/tutorial_hirevue_search.png)

5. 在结果面板中，选择“HireVue”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-hirevue-tutorial/tutorial_hirevue_addfromgallery.png)
...
3. **[创建 HireVue 测试用户](#creating-a-hirevue-test-user)** - 在 HireVue 中创建 Britta Simon 的对应用户，将其链接到该用户的 Azure AD 表示形式。
...
3. 在“HireVue 域和 URL”部分中，执行以下步骤：
    ...
    b.在“磁贴徽标”下面，选择“删除上传的徽标”。 在“标识符”文本框中，键入 URL：
...
7. 若要在 HireVue 端配置单一登录，需要将下载的证书 (Base64)、注销 URL、SAML 实体 ID 和 SAML 单一登录服务 URL 发送给 [HireVue 支持团队](mailto:samlsupport@hirevue.com)。 他们会对此进行设置，使 SAML SSO 连接在两端均正确设置。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-hirevue-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-hirevue-tutorial/create_aaduser_02.png) 
...
在本部分中，将在 HireVue 中创建一个名为“Britta Simon”的用户。 请与 [HireVue 支持团队](mailto:samlsupport@hirevue.com)协作，将用户添加到 HireVue 平台中。
