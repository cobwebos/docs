...
### <a name="to-enable-the-application-integration-for-mimecast-admin-console-perform-the-following-steps"></a>若要为 Mimecast Admin Console 启用应用程序集成，请执行以下步骤：
...
5. 在“要执行什么操作”对话框中，单击“从库中添加应用程序”。
   ...
   ![从库中添加应用程序](./media/active-directory-saas-mimecast-admin-console-tutorial/IC749322.png "Add an application from gallerry")
...
3. 在“配置应用 URL”页上，在“Mimecast Admin Console 登录 URL”文本框中，键入用户用来登录 Mimecast Admin Console 应用程序的 URL（例如：“https://webmail-uk.mimecast.com” 或 “https://webmail-us.mimecast.com”），然后单击“下一步”。
   ...
   ![配置应用 URL](./media/active-directory-saas-mimecast-admin-console-tutorial/IC795013.png "Configure App URL")
...
8. 单击“新建身份验证配置文件”。
   ...
   ![新建身份验证配置文件](./media/active-directory-saas-mimecast-admin-console-tutorial/IC795000.png "New Authentication Profiles")
...
为了使 Azure AD 用户能够登录到 Mimecast Admin Console，必须将其预配到 Mimecast Admin Console 中。  
对于 Mimecast Admin Console，需要手动执行预配。
...
4. 在创建新域后，单击“新建地址”。
   ...
   ![新建地址](./media/active-directory-saas-mimecast-admin-console-tutorial/IC795005.png "New Address")
...
### <a name="to-assign-users-to-mimecast-admin-console-perform-the-following-steps"></a>若要将用户分配到 Mimecast Admin Console，请执行以下步骤：
