...
* [审核日志](overview-reports.md#activity-reports)，获取更多概念性信息
* [Azure Active Directory 报告 API 入门](concept-reporting-api.md)，获取有关报告 API 的详细信息。

有关疑问、问题或反馈，请联系 [AAD 报告帮助](mailto:aadreportinghelp@microsoft.com)。


## <a name="prerequisites"></a>先决条件
需要先完成[访问 Azure AD 报告 API 的先决条件](howto-configure-prerequisites-for-reporting-api.md)，才能使用本文中的示例。  
...
* 如果想要查看使用 Azure Active Directory 报告 API 的完整概述，请参阅 [Azure Active Directory 报告 API 入门](concept-reporting-api.md)。
* 如果要查找有关 Azure Active Directory 报告的详细信息，请参阅 [Azure Active Directory 报告指南](overview-reports.md)。  
