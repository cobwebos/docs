...
![企业应用程序](./media/howto-find-activity-reports/484.png "企业应用程序")
...
![“筛选器审核日志”页上的类别选项](./media/howto-find-activity-reports/06.png "“筛选器审核日志”页上的类别选项")
...
有关详细信息，请参阅 [Azure Active Directory 风险事件](concept-risk-events.md)。  
...
- [Azure Active Directory 门户中的“有风险的用户”安全报告](concept-user-at-risk.md)
- [Azure Active Directory 门户中的“有风险的登录”报告](concept-risky-sign-ins.md)


要查看“应用程序使用情况”报告，请在“Azure Active Directory”边栏选项卡上的“管理”下，选择“企业应用程序”，并选择“登录”。


![企业应用程序登录报告](./media/howto-find-activity-reports/199.png)
