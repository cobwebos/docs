...
[Azure Active Directory (Azure AD) 报告 API](https://docs.microsoft.com/azure/active-directory/reports-monitoring/concept-reporting-api) 通过一组基于 REST 的 API，可让你以编程方式访问数据。 可从编程语言和工具中调用这些 API。
