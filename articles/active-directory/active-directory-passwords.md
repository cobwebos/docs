...
| 主题 | |
| --------- | --------- |
| 我要注册密码重置 | [如何注册密码重置](active-directory-passwords-update-your-own-password.md#how-to-register-for-password-reset) |
| 我要从 O365 更改密码 | [如何从 Office365 更改密码](active-directory-passwords-update-your-own-password.md#how-to-change-your-password-from-o365) |
| 我要从 myapps.microsoft.com 更改密码 | [如何从访问面板更改密码](active-directory-passwords-update-your-own-password.md#how-to-change-your-password-from-the-access-panel) |
| 我忘记了密码，想要重置密码 | [如何重置密码](active-directory-passwords-update-your-own-password.md#how-to-reset-your-password) |
| 我无法登录，想要解锁我的帐户 | [如何解锁本地帐户](active-directory-passwords-update-your-own-password.md#how-to-unlock-your-account) |
| 我希望你们帮助我排查密码重置失败的原因 | [常见问题及其解决方法](active-directory-passwords-update-your-own-password.md#common-problems-and-their-solutions) |
...
- **Azure AD 高级版** - 任何用户或管理员（包括仅限云、联合或密码同步的用户）可以重置自己的密码（需要[启用密码写回](active-directory-passwords-getting-started.md#enable-users-to-reset-or-change-their-ad-passwords)）
...
| 如何自定义密码重置的外观？ | [设置：公司名称、品牌和徽标](active-directory-passwords-customize.md#password-managment-look-and-feel) |
...
| 如何使用电子邮件营销活动促使我的用户注册并使用密码重置？ | [基于电子邮件的密码重置推广](active-directory-passwords-best-practices.md#email-based-rollout) |
...
| 如何从 API 获取密码重置报告？ | [创建 Azure AD 应用程序以访问报告 API](active-directory-reporting-api-getting-started.md#creating-an-azure-ad-application-to-access-the-api) |
...
- 现在，在启用[强制注册](active-directory-passwords-customize.md#require-users-to-register-when-signing-in)功能后，用户必须使用工作或学校帐户从他们登录的任何位置进行注册。这可以大幅提高许多组织登记密码重置的速度。我们发现，使用此新增功能的组织在短短 2 周内即可完成登记！
