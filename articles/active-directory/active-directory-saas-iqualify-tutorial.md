...
4. 在搜索框中，键入“iQualify LMS”，在结果面板中选择“iQualify LMS”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 iQualify LMS](./media/active-directory-saas-iqualify-tutorial/tutorial_iqualify_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-iqualify-tutorial/tutorial_iqualify_samlbase.png)

3. 在“iQualify MS 域和 URL”部分中，如果要在“IDP”发起的模式下配置应用程序，请执行以下步骤：

    ![iQualify LMS 域和 URL 单一登录信息](./media/active-directory-saas-iqualify-tutorial/tutorial_iqualify_url.png)
...
4. 如果要在 SP 发起的模式下配置应用程序，请选中“显示高级 URL 设置”，并执行以下步骤：
    ...
    ![iQualify LMS 域和 URL 单一登录信息](./media/active-directory-saas-iqualify-tutorial/tutorial_iqualify_url1.png)
...
5. iQualify LMS 应用程序要求以特定的格式显示安全断言标记语言 (SAML) 断言。 在 iQualify 应用程序集成页的“用户属性”部分中配置声明并管理这些属性的值，如以下屏幕截图中所示：
    ...
    ![配置单一登录](./media/active-directory-saas-iqualify-tutorial/atb.png)
...
6. 在“单一登录”对话框的“用户属性”部分，针对下表中所示的每一行，执行以下步骤：
    ...
    ![配置单一登录](./media/active-directory-saas-iqualify-tutorial/atb2.png)

    ![配置单一登录](./media/active-directory-saas-iqualify-tutorial/atb3.png)
    ...
    e.在“新建 MySQL 数据库”边栏选项卡中，接受法律条款，并单击“确定”。 针对后面的表行重复步骤“a”到“d”。 
...
7. 在“SAML 签名证书”部分中，单击“证书 (Base64)”，然后在计算机上保存证书文件。
    ...
    ![证书下载链接](./media/active-directory-saas-iqualify-tutorial/tutorial_iqualify_certificate.png) 

8. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/active-directory-saas-iqualify-tutorial/tutorial_general_400.png)
    
9. 在“iQualify LMS 配置”部分，单击“配置 iQualify LMS”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL 和 SAML 单一登录服务 URL”。

    ![iQualify LMS 配置](./media/active-directory-saas-iqualify-tutorial/tutorial_iqualify_configure.png) 

10.  打开一个新的浏览器窗口，并以管理员身份登录到 iQualify 环境。

11. 登录后，单击右上角的头像，然后单击“帐户设置”。

    ![帐户设置](./media/active-directory-saas-iqualify-tutorial/setting1.png) 
12. 在帐户设置区域，单击左侧的功能区菜单，然后单击“集成”
    
    ![集成](./media/active-directory-saas-iqualify-tutorial/setting2.png)

13. 在“集成”下，单击“SAML”图标。

    ![SAML 图标](./media/active-directory-saas-iqualify-tutorial/setting3.png)

14. 在“SAML 身份验证设置”对话框中，执行以下步骤：

    ![SAML 身份验证设置](./media/active-directory-saas-iqualify-tutorial/setting4.png)
    ...
    d.单击“下一步”。 在“登录按钮标签”中输入要在登录页上显示的按钮的名称。
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-iqualify-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-iqualify-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-iqualify-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-iqualify-tutorial/create_aaduser_04.png)
...
2. 在应用程序列表中，选择“iQualify LMS”。
    ...
    ![应用程序列表中的 iQualify LMS 链接](./media/active-directory-saas-iqualify-tutorial/tutorial_iqualify_app.png)  
...
单击访问面板中的“iQualify LMS”磁贴时，应显示 iQualify LMS 应用程序的登录页。 
   ...
   ![登录页面](./media/active-directory-saas-iqualify-tutorial/login.png) 
