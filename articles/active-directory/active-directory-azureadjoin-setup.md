...
6. 在“设备”选项卡上，设置以下项：  
   ...
   * **需要进行 MULTI-FACTOR AUTH 才能加入设备**：设置是否需要用户提供第二个身份验证因素才能将其设备加入 Azure AD。有关 Azure Multi-Factor Authentication 的详细信息，请参阅[云中的 Azure Multi-Factor Authentication 入门](multi-factor-authentication-get-started-cloud/)。
