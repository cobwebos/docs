...
* 一个有效的 Azure 订阅
* 已启用 ShiftPlanning 单一登录 (SSO) 的订阅
...
## <a name="enable-the-application-integration-for-shiftplanning"></a>为 ShiftPlanning 启用应用程序集成
本部分的目的是概述如何为 ShiftPlanning 启用应用程序集成。

**若要为 ShiftPlanning 启用应用程序集成，请执行以下步骤：**
...
**若要将用户分配到 ShiftPlanning，请执行以下步骤：**
