...
- 可以让用户使用其 Azure AD 帐户自动登录到 Humanity（单一登录）
...
4. 在搜索框中，键入“Humanity”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-shiftplanning-tutorial/tutorial_humanity_search.png)

5. 在结果窗格中，选择“Humanity”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-shiftplanning-tutorial/tutorial_humanity_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录
在本部分中，将基于名为“Britta Simon”的测试用户配置和测试 Humanity 的 Azure AD 单一登录。

若要运行单一登录，Azure AD 需要知道与 Azure AD 用户相对应的 Humanity 用户。 换句话说，需要建立 Azure AD 用户与 Humanity 中相关用户之间的链接关系。

可通过将 Azure AD 中“用户名”的值指定为 Humanity 中“用户名”的值来建立此链接关系。

若要配置和测试 Humanity 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configuring-azure-ad-single-sign-on)** - 让用户使用此功能。
2. **[创建 Azure AD 测试用户](#creating-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
3. **[创建 Humanity 测试用户](#creating-a-humanity-test-user)** - 在 Humanity 中创建 Britta Simon 的对应用户，将其链接到该用户的 Azure AD 表示形式。
4. **[分配 Azure AD 测试用户](#assigning-the-azure-ad-test-user)** - 让 Britta Simon 使用 Azure AD 单一登录。
5. **[测试单一登录](#testing-single-sign-on)** - 验证配置是否正常工作。

### <a name="configuring-azure-ad-single-sign-on"></a>配置 Azure AD 单一登录

在本部分中，将在 Azure 门户中启用 Azure AD 单一登录并在 Humanity 应用程序中配置单一登录。

**若要配置 Humanity 的 Azure AD 单一登录，请执行以下步骤：**

1. 在 Azure 门户中的 Humanity 应用程序集成页上，单击“单一登录”。

    ![配置单一登录][4]

2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
 
    ![配置单一登录](./media/active-directory-saas-shiftplanning-tutorial/tutorial_humanity_samlbase.png)

3. 在“Humanity 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-shiftplanning-tutorial/tutorial_humanity_url.png)
    ...
    > [!NOTE] 
    > 这些不是实际值。 必须使用实际登录 URL 和标识符更新这些值。 请联系 [Humanity 客户端支持团队](https://www.humanity.com/support/)获取这些值。 
 
4. 在“SAML 签名证书”部分中，单击“证书(Base64)”，然后在计算机上保存证书文件。

    ![配置单一登录](./media/active-directory-saas-shiftplanning-tutorial/tutorial_humanity_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录](./media/active-directory-saas-shiftplanning-tutorial/tutorial_general_400.png)

6. 在“Humanity 配置”部分，单击“配置 Humanity”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 单一登录服务 URL 和注销 URL”。

    ![配置单一登录](./media/active-directory-saas-shiftplanning-tutorial/tutorial_humanity_configure.png) 

7. 在另一个 Web 浏览器窗口中，以管理员身份登录 Humanity 公司站点。
...
10. 在“单一登录”部分中，执行以下步骤：
    ...
    b.在“磁贴徽标”下面，选择“删除上传的徽标”。 选择“允许密码登录”。

    c. 将“SAML 单一登录服务 URL”值粘贴到“SAML 颁发者 URL”文本框。

    d. 将“注销 URL”值粘贴到“远程注销 URL”文本框。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-shiftplanning-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-shiftplanning-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-shiftplanning-tutorial/create_aaduser_03.png) 

4. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-shiftplanning-tutorial/create_aaduser_04.png) 
...
### <a name="creating-a-humanity-test-user"></a>创建 Humanity 测试用户
...
5. 在“添加员工”部分中，执行以下步骤：
    ...
    a.在“横幅徽标”下面，选择“删除上传的徽标”。 将要预配的有效 AAD 帐户的“名字”、“姓氏”和“电子邮件”键入到相关文本框中。

    b.在“磁贴徽标”下面，选择“删除上传的徽标”。 单击“保存员工”。
...
若要将 Britta Simon 分配到 Humanity，请执行以下步骤：
...
2. 在应用程序列表中，选择“Humanity”。
    ...
    ![配置单一登录](./media/active-directory-saas-shiftplanning-tutorial/tutorial_humanity_app.png) 
