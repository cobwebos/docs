...
4. 在“SAML 签名证书”部分中，选择“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![AMSL 签名证书下载链接](./media/active-directory-saas-openathens-tutorial/tutorial_openathens_certificate.png) 

5. 选择“保存”按钮。

    ![单一登录“保存”按钮](./media/active-directory-saas-openathens-tutorial/tutorial_general_400.png)
