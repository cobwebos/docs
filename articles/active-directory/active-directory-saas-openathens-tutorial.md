...
4. 在搜索框中，键入“OpenAthens”，在结果面板中选择“OpenAthens”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 OpenAthens](./media/active-directory-saas-openathens-tutorial/tutorial_openathens_addfromgallery.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分中，基于一个名为“Britta Simon”的测试用户使用 OpenAthens 配置和测试 Azure AD 单一登录。

若要运行单一登录，Azure AD 需要知道与 Azure AD 用户相对应的 OpenAthens 用户。 换句话说，需要在 Azure AD 用户与 OpenAthens 中的相关用户之间建立链接关系。
...
1. 在 Azure 门户中的 **OpenAthens** 应用程序集成页上，单击“单一登录”。

    ![配置单一登录链接][4]

2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
 
    ![“单一登录”对话框](./media/active-directory-saas-openathens-tutorial/tutorial_openathens_samlbase.png)

3. 在“OpenAthens 域和 URL”部分的“标识符”文本框中输入值：`https://login.openathens.net/saml/2/metadata-sp`。

    ![OpenAthens 域和 URL 单一登录信息](./media/active-directory-saas-openathens-tutorial/tutorial_openathens_url.png)

4. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。

    ![证书下载链接](./media/active-directory-saas-openathens-tutorial/tutorial_openathens_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/active-directory-saas-openathens-tutorial/tutorial_general_400.png)

6. 在另一个 Web 浏览器窗口中，以管理员身份登录 OpenAthens 公司站点。

7. 在“管理”选项卡下选择“连接”。 

    ![配置单一登录](./media/active-directory-saas-openathens-tutorial/tutorial_openathens_application1.png)

8. 选择“SAML 1.1/2.0”，并单击“配置”按钮。

    ![配置单一登录](./media/active-directory-saas-openathens-tutorial/tutorial_openathens_application2.png)
    
9.  单击“浏览”，然后上传已从 Azure 门户下载的元数据 xml 文件。 单击“添加”添加配置。

    ![配置单一登录](./media/active-directory-saas-openathens-tutorial/tutorial_openathens_application3.png)

10. 在“详细信息”选项卡下执行以下步骤。

    ![配置单一登录](./media/active-directory-saas-openathens-tutorial/tutorial_openathens_application4.png)
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-openathens-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-openathens-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-openathens-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-openathens-tutorial/create_aaduser_04.png)
...
### <a name="create-a-openathens-test-user"></a>创建 OpenAthens 测试用户
...
**若要将 Britta Simon 分配到 OpenAthens，请执行以下步骤：**

1. 在 Azure 门户中打开应用程序视图，导航到目录视图，接着转到“企业应用程序”，并单击“所有应用程序”。

    ![分配用户][201] 

2. 在应用程序列表中，选择“OpenAthens”。

    ![应用程序列表中的 OpenAthens 链接](./media/active-directory-saas-openathens-tutorial/tutorial_openathens_app.png)  
...
单击访问面板中的 OpenAthens 磁贴时，应自动登录到 OpenAthens 应用程序。
