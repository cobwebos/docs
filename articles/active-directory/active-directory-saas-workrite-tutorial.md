...
本教程旨在说明如何将 Workrite 与 Azure Active Directory (Azure AD) 集成。  
...
6. 在搜索框中，键入“Workrite”。
    ...
    ![应用程序][5]
7. 在结果窗格中，选择“Workrite”，然后单击“完成”以添加应用程序。
   
    ![应用程序][500]

## <a name="configuring-and-testing-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录
本部分旨在介绍如何根据名为“Britta Simon”的测试用户的情况，配置和测试 Workrite 的 Azure AD 单一登录。

若要运行单一登录，Azure AD 需要知道与 Azure AD 用户相对应的 Workrite 用户。 换言之，需要建立 Azure AD 用户与 Workrite 中相关用户之间的链接关系。  
通过将 Azure AD 中“用户名”的值分配为 Workrite 中“用户名”的值来建立此链接关系。
...
3. **[创建 Workrite 测试用户](#creating-a-halogen-software-test-user)** - 目的是在 Workrite 中拥有一个与 Azure AD 中的 Britta Simon 相对应的关联用户。
4. **[分配 Azure AD 测试用户](#assigning-the-azure-ad-test-user)** - 让 Britta Simon 使用 Azure AD 单一登录。
5. **[测试单一登录](#testing-single-sign-on)** - 验证配置是否正常工作。

### <a name="configuring-azure-ad-single-sign-on"></a>配置 Azure AD 单一登录
本部分的目的是在 Azure 经典门户中启用 Azure AD 单一登录并在 Workrite 应用程序中配置单一登录。

**若要配置 Workrite 的 Azure AD 单一登录，请执行以下步骤：**

1. 在 Azure 经典门户中的“Workrite”应用程序集成页上，单击“配置单一登录”，以打开“配置单一登录”对话框。
   
    ![配置单一登录][6] 
2. 在“你希望用户如何登录 Workrite”页上，选择“Azure AD 单一登录”，然后单击“下一步”。
...
3. 在“配置应用设置”对话框页上，执行以下步骤：
    ...
    ![Azure AD 单一登录][8] 
     ...
     a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 在“登录 URL”文本框中，键入用户登录到 Workrite 站点所使用的 URL（例如：*https://app.workrite.co.uk/securelogin/samlgateway.aspx?id=1a82b5aa-4dd6-4472-9721-7d0193f59e22*）。
   
   > [!NOTE]
   > 如果不知道“登录 URL”的值，请联系 Workrite 支持团队 [support@workrite.co.uk](mailto:support@workrite.co.uk)。
   > 
   > 
   
     b. 单击“下一步”。
4. 在“配置 Workrite 的单一登录”页上，执行以下步骤：
   
    ![Azure AD 单一登录][9] 
   
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 单击“下载证书”，然后将文件保存在计算机上。
   
    b. 联系 Workrite 支持团队 [support@workrite.co.uk](mailto:support@workrite.co.uk)，向其提供下载的证书、**颁发者 URL**（实体 ID）、**单一登录服务 URL**、**单一注销 URL**，然后请求他们为 Workrite 应用设置 SSO。 
...
1. 在 **Azure 经典门户**中，在左侧导航窗格上，单击“Active Directory”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-workrite-tutorial/create_aaduser_09.png)  
2. 在“目录”列表中，选择要启用目录集成的目录。
3. 若要显示用户列表，请在顶部菜单中，单击“用户”。
   
    ![创建 Azure AD 测试用户](./media/active-directory-saas-workrite-tutorial/create_aaduser_03.png) 
4. 若要打开“添加用户”对话框，请在底部工具栏中单击“添加用户”。 
   
    ![创建 Azure AD 测试用户](./media/active-directory-saas-workrite-tutorial/create_aaduser_04.png) 
5. 在“告诉我们有关此用户的信息”对话框页上，执行以下步骤： 
   
    ![创建 Azure AD 测试用户](./media/active-directory-saas-workrite-tutorial/create_aaduser_05.png)  
...
6. 在“用户配置文件”对话框页上，执行以下步骤： 
   ...
   ![创建 Azure AD 测试用户](./media/active-directory-saas-workrite-tutorial/create_aaduser_06.png) 
...
7. 在“获取临时密码”对话框页上，单击“创建”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-workrite-tutorial/create_aaduser_07.png) 
8. 在“获取临时密码”对话框页上，执行以下步骤：
   
    ![创建 Azure AD 测试用户](./media/active-directory-saas-workrite-tutorial/create_aaduser_08.png) 
   
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 写下“新密码”的值。
   
    b. 单击“完成”。   

### <a name="creating-a-workrite-test-user"></a>创建 Workrite 测试用户
...
4. 在“创建用户”对话框中，执行以下步骤：
    ...
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 键入要预配的有效 Azure AD 用户的**电子邮件**、**名字**和**姓氏**。
...
本部分旨在通过向 Britta Simon 授予对 Workrite 的访问权限，使其能够使用 Azure 单一登录。
