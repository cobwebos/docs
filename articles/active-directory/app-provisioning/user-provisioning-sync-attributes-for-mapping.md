...
6. 在 Azure 门户中，当您[编辑用户属性映射](customize-application-attributes.md)时，"**源属性**" 列表现在将包含格式为 `<attributename> (extension_<appID>_<attributename>)`的已添加属性。 选择属性，并将其映射到目标应用程序进行设置。
