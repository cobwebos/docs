...
<sup>*</sup> – Azure AD Connect 安装程序将用户从 AD 同步到 Azure AD 是必需的。  
...
* [使用系统进行跨域标识管理（SCIM）以自动将用户和组从 Azure Active Directory 设置到应用程序](../app-provisioning/use-scim-to-provision-users-and-groups.md)
