---
title: 导出预配配置，并回滚到已知良好的灾难恢复状态。 |Microsoft Docs
...
---
# <a name="export-your-provisioning-configuration-and-roll-back-to-a-known-good-state"></a>导出预配配置并回滚到已知的良好状态
...
2. 在 " **Azure Active Directory** " 窗格中，选择 "**企业应用程序**"，然后选择你的应用程序。
3. 在左侧导航窗格中，选择 "**设置**"。 在 "设置配置" 页上，单击 "**属性映射**"，然后单击 "**显示高级选项**"，最后**检查架构**。 这会将你转到 "架构编辑器"。 
5. 在页面顶部的命令栏中单击 "下载"，下载架构。
