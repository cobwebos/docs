...
|	[从具有可疑活动的 IP 地址登录](active-directory-reporting-sign-ins-from-ip-addresses-with-suspicious-activity.md) |	可能表示在经过持续入侵尝试后成功登录。 |
|	[从可能受感染的设备登录](active-directory-reporting-sign-ins-from-possibly-infected-devices.md) |	可能表示从已受感染的设备尝试登录。 |
|	[异常登录活动](active-directory-reporting-irregular-sign-in-activity.md) |	可能表示对用户登录模式而言异常的事件。 |
...
- 联系该用户以核实该活动
- 重置用户密码
- [启用多重身份验证](multi-factor-authentication-get-started.md)以提高安全性
