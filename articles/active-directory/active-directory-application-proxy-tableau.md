...
- 已安装[应用程序代理连接器](manage-apps/application-proxy-enable.md)。 
...
准备好使用应用程序时，将收到确认消息。 通常，这大约需要一周的时间。 但是，你可以在等待确认时完成配置。
...
- 步骤 1-8 的详细说明，请参阅[使用 Azure AD 应用程序代理发布应用程序](manage-apps/application-proxy-publish-azure-portal.md)。 
...
有关 Azure AD 应用程序代理的详细信息，请参阅[如何提供对本地应用程序的安全远程访问](manage-apps/application-proxy.md)。
