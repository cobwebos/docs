...
5. 在“域名”边栏选项卡的相应框中输入自定义域的名称（例如“contoso.com”），然后选择“添加域”。 请务必包含 .com、.net 或其他顶级扩展名。
...
1. 使用目录全局管理员的帐户登录到 [Azure 门户](https://portal.azure.com)。
2. 选择“浏览”，在文本框中输入“用户管理”，然后选择 **Enter**。
   
   ![打开“用户管理”](./media/active-directory-domains-add-azure-portal/user-management.png)
3. 在“用户管理 - 域名”边栏选项卡中，选择需要验证但尚未验证的域名。
4. 在“domainname”边栏选项卡（即打开的且其名称中有新域名的边栏选项卡）中，选择“验证”完成验证步骤。

现在，你可以 [分配包含自定义域名的用户名](active-directory-users-create-azure-portal.md)。
