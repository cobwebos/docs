...
4. 在搜索框中，键入“Ariba”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-ariba-tutorial/tutorial_ariba_search.png)

5. 在“结果”窗格中，选择“Ariba”，然后单击“添加”按钮，添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-ariba-tutorial/tutorial_ariba_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-ariba-tutorial/tutorial_ariba_samlbase.png)

3. 在“Ariba 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-ariba-tutorial/tutorial_ariba_url.png)

    a.在“横幅徽标”下面，选择“删除上传的徽标”。 在“登录 URL”文本框中，使用以下模式键入 URL：`https://<subdomain>.sourcing.ariba.com` 或 `https://<subdomain>.supplier.ariba.com`

    b.在“磁贴徽标”下面，选择“删除上传的徽标”。 在“标识符”文本框中，使用以下模式键入 URL：`http://<subdomain>.procurement-2.ariba.com`
...
5. 单击“保存”按钮。
    ...
    ![配置单一登录](./media/active-directory-saas-ariba-tutorial/tutorial_general_400.png)
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-ariba-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-ariba-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-ariba-tutorial/create_aaduser_03.png) 
...
**若要将 Britta Simon 分配到 Ariba，请执行以下步骤：**
...
2. 在应用程序列表中，选择“Ariba”。
    ...
    ![配置单一登录](./media/active-directory-saas-ariba-tutorial/tutorial_ariba_app.png) 
