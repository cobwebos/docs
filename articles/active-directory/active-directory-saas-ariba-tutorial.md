...
本教程的目的是说明如何将 Ariba 与 Azure Active Directory (Azure AD) 集成。
...
6. 在搜索框中，键入“Ariba”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-ariba-tutorial/tutorial_ariba_01.png)
7. 在“结果”窗格中，选择“Ariba”，然后单击“完成”以添加该应用程序。
...
3. **[创建 Ariba 测试用户](#creating-a-ariba-test-user)** - 在 Ariba 中创建 Britta Simon 的对应用户，将其链接到她的 Azure AD 表示形式。
...
1. 在 Azure 经典门户中的 Ariba 应用程序集成页上，单击“配置单一登录”，打开“配置单一登录”对话框。
    ...
    ![配置单一登录][6] 
2. 在“你希望用户如何登录 Ariba”页上，选择“Azure AD 单一登录”，然后单击“下一步”。
...
1. 在 **Azure 经典门户**中，在左侧导航窗格上，单击“Active Directory”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-ariba-tutorial/create_aaduser_09.png) 
