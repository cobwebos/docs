---
title: B2B 协作许可指南 - Azure 活动目录 |微软文档
...
借助 Azure Active Directory (Azure AD) 企业到企业 (B2B) 协作可以邀请外部用户（或“来宾用户”）使用你的付费 Azure AD 服务。 某些功能是免费的，但对于任何付费 Azure AD 功能，您最多可以邀请 5 个来宾用户，用于您为租户中的员工或非来宾用户拥有的每个 Azure AD 版本许可证。

> [!NOTE]
> 有关 Azure AD 定价和 B2B 协作功能的详细信息，请参阅[Azure 活动目录定价](https://azure.microsoft.com/pricing/details/active-directory/)。
...
- 您希望邀请 100 个来宾用户加入 Azure AD 应用或服务，并提供访问管理和预配。 对于其中 50 个来宾用户，您还需要 MFA 和条件访问，因此对于这些功能，您需要 10 个 Azure AD 高级 P1 许可证。 如果你打算对来宾用户使用“标识保护”功能，需要按相同的 1:5 比例提供 Azure AD Premium P2 许可证才能涵盖这些来宾用户。
