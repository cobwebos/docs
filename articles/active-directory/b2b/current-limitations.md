...
使用 Azure AD B2B，可在资源组织（邀请方组织）上进行多重身份验证。 中详细介绍了这种方法的原因[B2B 协作用户的条件性访问](conditional-access.md)。 如果合作伙伴已设置并实施了多重身份验证，则他们的用户可能必须在其主组织中执行一次身份验证，然后在你的组织中再次进行身份验证。
