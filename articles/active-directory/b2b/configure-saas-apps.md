...
1. 要将 Dropbox Business 应用添加到 Azure AD 中，请在左窗格中选择“企业应用程序”，并单击“添加”。
...
2. 按以下顺序来配置单一登录：
   ...
   a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，并单击“添加引用”。 在“登录 URL”框中，确保登录 URL 是在 Azure 门户中为 Box 适当设置的 URL。 此 URL 是 Box.com 租户的 URL。 它应该遵循命名约定 *https://.box.com* 。  
