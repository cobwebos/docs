...
5. 此时将打开 "**编辑声明规则**向导"。
6. 在 "**编辑声明规则**" 向导中，选择 "**添加规则**"。 在 "**选择规则类型**" 中，选择 "**以声明方式发送 LDAP 属性**"。 选择“**下一页**”。
7. 在 "**配置声明规则**" 中，指定以下值： 
...
1. 此时将打开 "**编辑声明规则**向导"。 
1. 在 "**编辑声明规则**" 向导中，选择 "**添加规则**"。 在 "**选择规则类型**" 中，选择 "**使用自定义规则发送声明**"。 选择“*下一页*”。 
1. 在 "**配置声明规则**" 中，指定以下值：
...
1. 在相同的**编辑声明规则**向导中，选择 "**添加规则**"。 在 " **Cohose 规则类型**" 中，选择 "**以声明方式发送 LDAP 属性**"。 选择“**下一页**”。
1. 在 "**配置声明规则**" 中，指定以下值： 
