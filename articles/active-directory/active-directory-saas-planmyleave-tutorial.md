...
若要配置 PlanMyLeave 与 Azure AD 的集成，需要从库中将 PlanMyLeave 添加到托管 SaaS 应用列表。
...
可以通过将 Azure AD 中“用户名”的值分配为 PlanMyLeave 中“用户名”的值来建立此链接关系。
...
在本部分中，将通过向 Britta Simon 授予对 PlanMyLeave 的访问权限使她能够使用 Azure 单一登录。
