...
- 在取消选择整个 [OU](active-directory-aadconnectsync-configure-filtering.md#organizational-unitbased-filtering) 或[域](active-directory-aadconnectsync-configure-filtering.md#domain-based-filtering)的情况下更改为[筛选](active-directory-aadconnectsync-configure-filtering.md)。
- 已删除 OU 中的所有对象。
