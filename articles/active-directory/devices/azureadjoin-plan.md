...
如果当前在云中操作和管理企业的标识，或者即将迁移到云，则可以从 Azure Active Directory Join (Azure AD Join) 获益。 可以使用在 Azure AD 中创建的帐户来登录 Windows 10。 通过[首次运行体验 (FRX) 过程](azuread-joined-devices-frx.md)或通过从[设置菜单](../user-help/device-management-azuread-joined-devices-setup.md)加入 Azure AD，用户可将其计算机加入 Azure AD。  用户还可以在浏览器或 Office 应用程序中通过单一登录 (SSO) 访问云资源（例如 Office 365）。
...
* [设置设备注册](device-management-azure-portal.md)

### <a name="user-tasks"></a>用户任务
* [安装期间使用 Azure AD 设置新的 Windows 10 设备](azuread-joined-devices-frx.md)
* [通过设置菜单使用 Azure AD 设置 Windows 10 设备](../user-help/device-management-azuread-registered-devices-windows10-setup.md)
* [将个人 Windows 10 设备加入组织](../user-help/device-management-azuread-joined-devices-setup.md)
