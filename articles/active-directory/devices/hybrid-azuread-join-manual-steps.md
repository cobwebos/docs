...
> [!TIP]
> 如果使用 Azure AD Connect 是合适的选项，请参阅[选择方案](hybrid-azuread-join-plan.md#select-your-scenario)。 使用 Azure AD Connect，可以简化混合 Azure AD 加入的配置。
...
![公司域的列表](./media/hybrid-azuread-join-manual-steps/01.png)
...
![允许用户注册设备的“全部”按钮](./media/hybrid-azuread-join-manual-steps/23.png)
