...
---
# <a name="use-a-windows-vm-msi-to-access-azure-cosmos-db"></a>使用 Windows VM MSI 访问 Azure Cosmos DB
...
还需在 Windows VM 上安装最新版本的 [Azure CLI 2.0](https://docs.microsoft.com/cli/azure/install-azure-cli)。
