...
| Azure API 管理 | 预览 | 不可用 | [Azure 资源管理器模板](/azure/api-management/api-management-howto-use-managed-service-identity) | 
...
| Azure 存储 | https://azure.microsoft.com/services/storage/ | 预览 | 2018 年 5 月 | |
