...
- 可以让用户使用其 Azure AD 帐户自动登录到 New Relic（单一登录）
...
4. 在搜索框中，键入“New Relic”。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-new-relic-tutorial/tutorial_newrelic_search.png)

5. 在结果面板中，选择“New Relic”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-new-relic-tutorial/tutorial_newrelic_addfromgallery.png)
...
3. [创建 New Relic 测试用户](#creating-a-new-relic-test-user) - 在 New Relic 中有一个与 Azure AD 中的 Britta Simon 相对应的关联用户。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-new-relic-tutorial/tutorial_newrelic_samlbase.png)

3. 在“New Relic 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-new-relic-tutorial/tutorial_newrelic_url.png)

    在“登录 URL”文本框中，使用以下模式键入 URL：`https://<subdomain>.newrelic.com`

    > [!NOTE] 
    > 此值不是真实值。 请使用实际登录 URL 更新此值。 请联系 [New Relic 客户端支持团队](https://support.newrelic.com/)，获取这些值。 
 
4. 在“SAML 签名证书”部分中，单击“证书(Base64)”，然后在计算机上保存证书文件。

    ![配置单一登录](./media/active-directory-saas-new-relic-tutorial/tutorial_newrelic_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录](./media/active-directory-saas-new-relic-tutorial/tutorial_general_400.png)

6. 在“New Relic 配置”部分中，单击“配置 New Relic”打开“配置登录”窗口。 从“快速参考”部分中复制注销 URL 和 SAML 单一登录服务 URL。

    ![配置单一登录](./media/active-directory-saas-new-relic-tutorial/tutorial_newrelic_configure.png) 

7. 在其他 Web 浏览器窗口中，以管理员身份登录 **New Relic** 公司站点。

8. 在顶部菜单中，单击“帐户设置”。
   
    ![帐户设置](./media/active-directory-saas-new-relic-tutorial/ic797036.png "帐户设置")

9. 单击“安全性和身份验证”选项卡，然后单击“单一登录”选项卡。
...
10. 在 SAML 对话框页上执行以下步骤：
   ...
   a.在“横幅徽标”下面，选择“删除上传的徽标”。 单击“选择文件”，上传已下载的 Azure Active Directory 证书。

   b.在“磁贴徽标”下面，选择“删除上传的徽标”。 在“远程登录 URL”文本框中，粘贴从 Azure 门户复制的“SAML 单一登录服务 URL”值。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-new-relic-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-new-relic-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-new-relic-tutorial/create_aaduser_03.png) 

4. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-new-relic-tutorial/create_aaduser_04.png) 
...
### <a name="creating-a-new-relic-test-user"></a>创建 New Relic 测试用户
...
4. 在“活动用户”对话框中，执行以下步骤：
    ...
    a.在“横幅徽标”下面，选择“删除上传的徽标”。 在“电子邮件”文本框中，键入要预配的有效 Azure Active Directory 用户的电子邮件地址。

    b.在“磁贴徽标”下面，选择“删除上传的徽标”。 选择“用户”作为“角色”。
...
2. 在应用程序列表中，选择“New Relic”。

    ![配置单一登录](./media/active-directory-saas-new-relic-tutorial/tutorial_newrelic_app.png) 
