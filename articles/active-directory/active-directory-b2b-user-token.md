---
title: "了解 Azure Active Directory B2B 协作中的用户令牌 | Microsoft 文档"
...
# <a name="understand-user-tokens-in-azure-active-directory-b2b-collaboration"></a>了解 Azure Active Directory B2B 协作中的用户令牌

如果你想要了解 B2B 协作用户的令牌外观，以下是资源租户中 AAD 来宾和 MSA 来宾的持有者令牌详细信息和令牌内容（适用于 tenantid:04dcc6ab-388a-4559-b527-fbec656300ea）。 可以使用 [https://jwt.io/](https://jwt.io/) 或 [http://calebb.net](http://calebb.net/)/ 查看 JWT 令牌内容。

## <a name="azure-ad-guest-user-token"></a>Azure AD 来宾用户令牌
```
...
## <a name="microsoft-account-guest"></a>Microsoft 帐户来宾
```
