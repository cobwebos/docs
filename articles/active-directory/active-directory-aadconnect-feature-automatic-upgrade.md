...
| --- | --- |
| **UpgradeAborted** | |
| UpgradeAbortedSyncExeInUse | 服务器上打开了[同步服务管理器 UI](active-directory-aadconnectsync-service-manager-ui.md)。
...
| UpgradeNotSupportedDeviceWritebackEnabled | 你已启用[设备写回](active-directory-aadconnect-feature-device-writeback.md)功能。 |
