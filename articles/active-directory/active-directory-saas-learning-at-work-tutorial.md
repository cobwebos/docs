...
* 可以让用户使用其 Azure AD 帐户自动登录到 Learning at Work 单一登录 (SSO)
...
## <a name="add-learning-at-work-from-the-gallery"></a>从库添加 Learning at Work
...
3. 在“配置应用设置”对话框页上，执行以下步骤：
    ...
    1. 在“登录 URL”文本框中，使用以下模式键入用户用来登录 Learning at Work 应用程序的 URL：`https://\<company name\>.sabacloud.com/Saba/Web/<company code>`
    2. 在“标识符”文本框中，使用以下模式键入 URL：`https://<company name>.sabacloud.com/Saba/SAML/sso/alias/<company name>`
    3. 单击“下一步”。
...
5. 在“告诉我们有关此用户的信息”对话框页上，执行以下步骤：
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-learning-at-work-tutorial/create_aaduser_05.png) 
...
6. 在“用户配置文件”对话框页上，执行以下步骤：
   ...
   ![创建 Azure AD 测试用户](./media/active-directory-saas-learning-at-work-tutorial/create_aaduser_06.png) 
...
### <a name="create-an-learning-at-work-test-user"></a>创建 Learning at Work 测试用户
