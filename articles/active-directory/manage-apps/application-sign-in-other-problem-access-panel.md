...
-   [Microsoft Edge 访问面板扩展](https://www.microsoft.com/p/my-apps-secure-sign-in-extension/9pc9sckkzk84)
...
1. <span id="_Hlk477187909" class="anchor"><span id="_Hlk477001983" class="anchor"></span></span>打开[**Azure 门户**](https://portal.azure.com/)，以**全局管理员**或**共同管理员**身份登录。
...
6.  在"**从库添加**"部分**输入名称**文本框中，键入应用程序的名称
