...
> [!NOTE]
> 若要打开 "我的应用" 门户，用户可以`https://myapps.microsoft.com`使用组织的链接或自定义链接，例如`https://myapps.microsoft.com/contoso.com`。 启用新的 "我的应用" 体验后，已**更新的 "我的应用程序体验**" 将显示在 "我的应用" 页的顶部，用户可以选择 "**试用**" 以查看新体验。 若要停止使用新体验，用户可以从页面顶部的 "**离开新体验**" 横幅中选择 **"是"** 。
