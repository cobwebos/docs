...
还可以通过从本地网络打开[连接器端口测试工具](https://aadap-portcheck.connectorporttest.msappproxy.net/)来检查是否打开了所有必需的端口。 绿色复选标记越多表示复原能力越强。 
...
-   确保适用于连接器的任何代理或防火墙也应用到此页。 这可以通过去**设置** -&gt;**互联网选项** -&gt;**Connections** -连接&gt;**局域网设置**在互联网资源管理器中完成。 在此页上，会看到“为 LAN 使用代理服务器”字段。 选中此框，将代理地址输入“地址”字段。
