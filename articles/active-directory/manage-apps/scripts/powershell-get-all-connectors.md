...
description: PowerShell 示例，列出目录中的所有 Azure Active Directory （Azure AD）应用程序代理连接器组和连接器。
...
此 PowerShell 脚本示例列出了目录中的所有 Azure Active Directory （Azure AD）应用程序代理连接器组和连接器。
