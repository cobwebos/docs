...
description: PowerShell 示例列出了使用自定义域但未上载有效 TLS/SSL 证书的所有 Azure 活动目录 （Azure AD） 应用程序代理应用程序。
...
---
# <a name="get-all-azure-ad-proxy-application-apps-published-with-no-certificate-uploaded"></a>获取发布的所有 Azure AD 代理应用程序应用程序，无需上载证书

此 PowerShell 脚本示例列出了使用自定义域但未上载有效 TLS/SSL 证书的所有 Azure 活动目录 （Azure AD） 应用程序代理应用。
