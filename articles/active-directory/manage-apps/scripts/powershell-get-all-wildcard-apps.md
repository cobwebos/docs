---
title: PowerShell 示例 - 使用通配符列出应用程序代理应用程序
description: PowerShell 示例列出了使用通配符的所有 Azure 活动目录 （Azure AD） 应用程序代理应用程序。
...
此 PowerShell 脚本示例列出了使用通配符发布的所有 Azure 活动目录 （Azure AD） 应用程序代理应用程序。
