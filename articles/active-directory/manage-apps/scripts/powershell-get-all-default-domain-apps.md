...
description: PowerShell 示例列出了使用默认域 （.msappproxy.net） 的所有 Azure 活动目录 （Azure AD） 应用程序代理应用程序。
...
---
# <a name="get-all-application-proxy-apps-using-default-domains-msappproxynet"></a>使用默认域获取所有应用程序代理应用 （.msappproxy.net）

此 PowerShell 脚本示例列出了使用默认域 （.msappproxy.net） 的所有 Azure 活动目录 （Azure AD） 应用程序代理应用程序。
