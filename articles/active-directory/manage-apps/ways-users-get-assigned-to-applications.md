...
*  管理员启用[自助服务应用程序访问](https://docs.microsoft.com/azure/active-directory/active-directory-self-service-application-access)以允许用户使用["我的应用" "](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction) **添加应用**" 功能添加应用程序，但仅限**从所选的一组业务审批者**那里进行审批
