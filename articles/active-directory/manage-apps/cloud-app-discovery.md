...
1. [设置快照报表](cloud-app-discovery-create-snapshot-reports.md)，检查日志格式，确保日志向 Cloud App Discovery 提供可用信息。 快照报表还可提供对手动从防火墙和代理服务器上传的流量日志的临时可见性。
...
2.  日志格式与预期标准格式匹配。 这将在上传时进行检查。 若要优化 uour 日志格式，请参阅[创建快照 Cloud App Discovery 报表](cloud-app-discovery-create-snapshot-reports.md)。
3.  事件未超过 90 天。
4.  日志文件有效且包含出站流量信息。
...
* [创建快照报表](cloud-app-discovery-create-snapshot-reports.md)
