...
| \<代理应用的外部 Url > | **企业应用**程序 > *代理应用*程序 > **应用程序代理** > **外部 Url** |
| 本机应用 \<应用 ID > |  > **属性** > **应用程序 ID** > *你的本机应用程序的***企业应用程序** |
| 本机应用的 \<重定向 URI > | **Azure Active Directory** > **应用注册** > *本机应用程序* > **重定向 uri** |
| \<代理应用 API Url > | **Azure Active Directory** > **应用注册** > *本机应用程序* > api **/权限名称**的**api 权限** >  |
