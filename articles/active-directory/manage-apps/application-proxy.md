...
- **简单易用**。 用户可以访问本地应用程序，方法与访问与 Azure AD 集成 Microsoft 365 和其他 SaaS 应用程序的方式相同。 无需更改或更新应用程序即可使用应用程序代理。
...
> [!NOTE]
> 与大多数 Azure AD 混合代理一样，应用程序代理连接器无需通过防火墙打开入站连接。 步骤3中的用户流量在 Azure AD) 中的应用程序代理服务 (终止。 应用程序代理连接器 (本地) 负责其他通信。
>
