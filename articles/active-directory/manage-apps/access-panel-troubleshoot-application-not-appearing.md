...
#### <a name="configure-the-application-for-password-single-sign-on"></a><a name="configure-the-application-for-password-single-sign-on-1"></a>将应用程序配置为密码单一登录
...
[将新用户添加到 Azure Active Directory](./../fundamentals/add-users-azure-active-directory.md)
