...
ms.locfileid: "70862104"
---
# <a name="azure-ad-connect-provisioning-agent-version-release-history"></a>Azure AD Connect 预配代理：版本发行历史记录
本文列出了已发布 Azure AD Connect 预配代理的版本和功能。 Azure AD 团队定期用新特性和功能更新设置代理。 发布新版本时，会自动更新设置代理。 
...
* 只能提取在映射中配置为提高同步性能的 AD 属性的功能

### <a name="fixed-issues"></a>修复的问题

* 修复了在 AD 连接失败的情况下，代理进入无响应状态的 bug
* 修复了从读取二进制数据时导致问题的 bug Active Directory
* 修复了：代理未能续订与云混合标识服务的信任的 bug
...
* 改进预配代理 & 连接器体系结构，以获得更好的性能、稳定性和可靠性 
* 使用 UI 驱动的安装向导简化设置代理配置 
* 添加了对自动代理更新的支持
