---
title: 访问面板中基于密码的单一登录 （SSO） |微软文档
description: 讨论提供用于解决与登录到为密码单一登录配置的 Azure AD 库应用程序相关的问题的指导的问题区域。
...
-   必须拥有“编辑设置”权限才能编辑组策略对象 (GPO)。 默认情况下，以下安全组的成员拥有此权限：域管理员、企业管理员和组策略创建者和所有者。 [了解详情](https://technet.microsoft.com/library/cc781991%28v=ws.10%29.aspx)。
