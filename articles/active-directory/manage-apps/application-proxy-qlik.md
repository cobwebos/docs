...
**步骤 5**：外部 URL 现应为包含应用程序所用的身份验证端口的 QlikSense URL。 HTTPS 的默认值为**4244，2018**年 4 月之前 QlikSense 版本的 HTTP 为**4248。** 2018 年 4 月之后 QlikSense 版本的默认值为 HTTPS 为**443，HTTP**为**80。**  例如：**https&#58;//demo.qlik.com:4244**</br></br>
**步骤#10：** 不要设置 SSO，并且禁用**单一登录**
...
有关使用应用程序代理发布 Qlik 感知的更多信息，请参阅以下 Qlik 社区文章： 
- [使用具有 Qlik 感知的 Kerberos 约束委派的集成 Windows 身份验证的 Azure AD](https://community.qlik.com/docs/DOC-20183)
- [Qlik 感知与 Azure AD 应用程序代理的集成](https://community.qlik.com/t5/Technology-Partners-Ecosystem/Azure-AD-Application-Proxy/ta-p/1528396)
