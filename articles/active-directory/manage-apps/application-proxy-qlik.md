...
- [安装应用程序代理连接器](application-proxy-enable.md#install-and-register-a-connector) 
...
**步骤 5**：外部 URL 现应为包含应用程序所用的身份验证端口的 QlikSense URL。 HTTPS 的默认端口为 4244，HTTP 的默认端口为 4248。 例如：**https&#58;//demo.qlik.com:4244**</br></br>**步骤 10：** 请勿设置 SSO，并使 **“单一登录”处于禁用状态**
