...
2. 为了支持安全性和监管，组织需要控制和监督谁可以访问和谁实际上正在访问每个应用程序
...
## <a name="azure-active-directory-integrated-with-applications"></a>将 Azure Active Directory 与应用程序集成
...
管理不同应用程序中的帐户一直以来都是组织中的 IT 或支持人员手动执行的过程。 Azure AD 可在服务提供商集成的应用程序、Microsoft 预先集成的、支持自动用户预配或 SAML 实时预配的应用程序中完全自动地执行帐户管理。
...
要开始将应用程序与 Azure AD 集成，请参阅[将 Azure Active Directory 与应用程序集成入门指南](plan-an-application-integration.md)。

## <a name="see-also"></a>另请参阅
* [有关 Azure Active Directory 中应用程序管理的文章索引](../active-directory-apps-index.md)
* [SSO 到 SaaS 应用程序的分步部署计划](http://aka.ms/ssodeploymentplan)
