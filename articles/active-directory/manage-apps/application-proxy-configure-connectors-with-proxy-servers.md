...
3. 选择“启动本地跟踪”。
   ...
   ![启动网络捕获](./media/application-proxy-configure-connectors-with-proxy-servers/start-local-trace.png)

3. 启动 Azure AD 应用程序代理连接器服务。
4. 停止网络捕获。

   ![停止网络捕获](./media/application-proxy-configure-connectors-with-proxy-servers/stop-trace.png)
