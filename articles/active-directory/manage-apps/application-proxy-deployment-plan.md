...
* **许可**：可以通过 Azure AD Basic 订阅获取应用程序代理。 有关许可选项和功能的完整列表, 请参阅[Azure Active Directory 定价页](https://azure.microsoft.com/pricing/details/active-directory/)。  
