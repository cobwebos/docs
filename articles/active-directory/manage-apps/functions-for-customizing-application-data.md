...
| 名称 | 必选/重复 | 类型 | 说明 |
| --- | --- | --- | --- |
| **源 (source)** |需要 |String |通常是来自源对象的属性的名称。 |
...
| 名称 | 必选/重复 | 类型 | 说明 |
| --- | --- | --- | --- |
| **value1** |需要 |num |应与 value2 一起个的数值|
| **value2** |需要 |num |应为 value1 个的数字值|
...
| 名称 | 必选/重复 | 类型 | 说明 |
| --- | --- | --- | --- |
| **source1  … sourceN** | 需要 | String |必需，次数可变。 通常是来自源对象的属性的名称。 |
...
| 名称 | 必选/重复 | 类型 | 说明 |
| --- | --- | --- | --- |
| **源 (source)** |需要 |String |要转换为 base 64 的字符串|
...
| 名称 | 必选/重复 | 类型 | 说明 |
| --- | --- | --- | --- |
| **源 (source)** |需要 |String |要转换为 UTF8 Hex 的字符串|
...
| 名称 | 必选/重复 | 类型 | 说明 |
| --- | --- | --- | --- |
| **value** |需要 | numeric、reference 或 boolean | 可以是数字值、引用属性或布尔值。 |
...
| 名称 | 必选/重复 | 类型 | 说明 |
| --- | --- | --- | --- |
| **value** |需要 | Date | 要转换为 DateTime 类型的广告日期 |
...
| 名称 | 必选/重复 | 类型 | 说明 |
| --- | --- | --- | --- |
| **value1** |需要 |String |要搜索的字符串 |
| **value2** |需要 |String |要查找的字符串 |
...
| 名称 | 必选/重复 | 类型 | 说明 |
| --- | --- | --- | --- |
| **attribute** |需要 |Attribute |要搜索的多值属性 |
| 索引 |需要 |Integer | 多值字符串中的项的索引|
...
| 名称 | 必选/重复 | 类型 | 说明 |
| --- | --- | --- | --- |
| **字符串** |需要 |Attribute | 要从其返回字符的字符串 |
| **NumChars** |需要 |Integer | 标识从字符串开头（左侧）起返回的字符数的数字|
...
| 名称 | 必选/重复 | 类型 | 说明 |
| --- | --- | --- | --- |
| **源 (source)** |需要 |布尔型字符串 |预期的 **source** 值为“True”或“False”。 |
...
| 名称 | 必选/重复 | 类型 | 说明 |
| --- | --- | --- | --- |
| **源 (source)** |需要 |String |通常是 **source** 对象中的属性的名称。 |
...
| 名称 | 必选/重复 | 类型 | 说明 |
| --- | --- | --- | --- |
| **源 (source)** |需要 |String |要更新的 **source** 值。 |
...
| **键** |需要 |String |用来比较 **source** 值的 **key**。 |
...
| 名称 | 必选/重复 | 类型 | 说明 |
| --- | --- | --- | --- |
| **字符串** |需要 |多值属性 |要从中返回单词的字符串。|
| **WordNumber** |需要 | Integer | 标识应返回的单词编号的数字|
| **限定符** |需要 |String| 表示应该用于标识单词的分隔符的字符串|
