...
可将应用程序配置为在可以访问之前要求分配。 需要分配：

1. 使用管理员帐户登录到 Azure 门户，或以**企业应用**程序下的应用所有者身份登录。
2. 在主菜单中单击“所有服务”项。
3. 选择要用于应用程序的目录。
4. 单击“企业应用程序”选项卡。
...
13. **可选：** **对于公开角色的应用程序**，如果想要将自助服务批准的用户分配给角色，请单击 "**在此应用程序中应向哪个角色分配用户？** " 旁边的选择器，以选择应将这些用户分配到的角色。
