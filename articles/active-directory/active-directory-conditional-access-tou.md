...
description: 本快速入门介绍在访问受 Azure Active Directory 条件访问保护的选定云应用之前，如何要求接受使用条款。
...
![创建策略](./media/active-directory-conditional-access-tou/5555.png)
...
3. 以全局管理员、安全管理员或条件访问管理员的身份登录到 [Azure 门户](https://portal.azure.com)。

4. 在 Azure 门户的左侧导航栏中，单击“Azure Active Directory”。 

    ![Azure Active Directory](./media/active-directory-conditional-access-tou/02.png)

5. 在“Azure Active Directory”页的“管理”部分，单击“条件性访问”。

    ![条件性访问](./media/active-directory-conditional-access-tou/03.png) 

6. 在“管理”部分，单击“使用条款”。

    ![使用条款](./media/active-directory-conditional-access-tou/04.png) 

7. 在顶部菜单中，单击“新建项”。

    ![使用条款](./media/active-directory-conditional-access-tou/05.png) 

8. 在“新建使用条款”页上：

    ![使用条款](./media/active-directory-conditional-access-tou/112.png) 
...
![创建策略](./media/active-directory-conditional-access-tou/1234.png)
...
1. 在“新建”页上的“名称”文本框中，键入“要求 Isabella 接受 TOU”。
    ...
    ![名称](./media/active-directory-conditional-access-tou/71.png)

2. 在“分配”部分中，单击“用户和组”。

    ![用户和组](./media/active-directory-conditional-access-tou/06.png)

3. 在“用户和组”页上：

    ![用户和组](./media/active-directory-conditional-access-tou/24.png)
...
4. 单击“云应用”。
    ...
    ![云应用](./media/active-directory-conditional-access-tou/08.png)

5. 在“云应用”页上：

    ![选择云应用](./media/active-directory-conditional-access-tou/26.png)
...
6. 在“访问控制”部分中，单击“授予”。
    ...
    ![访问控制](./media/active-directory-conditional-access-tou/10.png)

7. 在“授予”页上：

    ![授权](./media/active-directory-conditional-access-tou/111.png)
...
8. 在“启用策略”部分中，单击“开”。
    ...
    ![启用策略](./media/active-directory-conditional-access-tou/18.png)
...
![What if 策略工具](./media/active-directory-conditional-access-tou/79.png)
...
2. 单击“用户”，选择“Isabella Simonsen”，然后单击“选择”。
    ...
    ![用户](./media/active-directory-conditional-access-tou/15.png)

2. 选择云应用：

    ![云应用](./media/active-directory-conditional-access-tou/16.png)
...
![使用条款](./media/active-directory-conditional-access-tou/57.png)
...
- 若要删除策略，请选择该策略，然后在快速访问工具栏中单击“删除”。
    ...
    ![多重身份验证](./media/active-directory-conditional-access-tou/33.png)

- 若要删除使用条款，请将其选中，然后单击顶部工具栏中的“删除条款”。 

    ![多重身份验证](./media/active-directory-conditional-access-tou/29.png)

## <a name="next-steps"></a>后续步骤

> [!div class="nextstepaction"]
> [要求针对特定的应用执行 MFA](./active-directory-conditional-access-app-based-mfa.md)
