<properties
	pageTitle="使用应用代理启用混合访问 | Microsoft Azure"
...
- [启用 Azure AD 应用程序代理](active-directory-application-proxy-enable.md#step-1-enable-application-proxy-in-azure-ad)
- [Publishing applications through Azure AD App Proxy](active-directory-application-proxy-publish.md)（通过 Azure AD 应用代理发布应用程序）
