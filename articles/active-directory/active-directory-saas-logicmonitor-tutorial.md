...
4. 在搜索框中，键入“LogicMonitor”。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-logicmonitor-tutorial/tutorial_logicmonitor_search.png)

5. 在结果面板中，选择“LogicMonitor”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-logicmonitor-tutorial/tutorial_logicmonitor_addfromgallery.png)
...
3. **[创建一个 LogicMonitor 测试用户](#creating-a-logicmonitor-test-user)** -若要链接到用户的 Azure AD 表示的 LogicMonitor 中具有 Britta 人 Simon 的副本。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-logicmonitor-tutorial/tutorial_logicmonitor_samlbase.png)

3. 在“LogicMonitor 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-logicmonitor-tutorial/tutorial_logicmonitor_url.png)
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-logicmonitor-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-logicmonitor-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-logicmonitor-tutorial/create_aaduser_03.png) 
...
2. 在应用程序列表中，选择“LogicMonitor”。
    ...
    ![配置单一登录](./media/active-directory-saas-logicmonitor-tutorial/tutorial_logicmonitor_app.png) 
