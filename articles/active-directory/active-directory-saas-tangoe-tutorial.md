...
4. 在搜索框中，键入“Tangoe Command Premium Mobile”，从结果面板中选择“Tangoe Command Premium Mobile”，然后单击“添加”按钮添加该应用程序。
    ...
    ![从库中添加 Tangoe Command Premium Mobile ](./media/active-directory-saas-tangoe-tutorial/tutorial_tangoe_addfromgallery.png)
...
3. **[创建 Tangoe Command Premium Mobile 测试用户](#create-a-tangoe-command-premium-mobile-test-user)** - 在 Tangoe Command Premium Mobile 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![基于 SAML 的登录](./media/active-directory-saas-tangoe-tutorial/tutorial_tangoe_samlbase.png)

3. 在“Tangoe Command Premium Mobile 域和 URL”部分中，执行以下步骤：

    ![Tangoe Command Premium Mobile 域和 URL](./media/active-directory-saas-tangoe-tutorial/tutorial_tangoe_url.png)
...
5. 单击“保存”按钮。
    ...
    ![“保存”按钮](./media/active-directory-saas-tangoe-tutorial/tutorial_general_400.png)
    
6. 在“Tangoe Command Premium Mobile 配置”部分中，单击“配置 Tangoe Command Premium Mobile”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![“Tangoe Command Premium Mobile 配置”部分](./media/active-directory-saas-tangoe-tutorial/tutorial_tangoe_configure.png) 
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-tangoe-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![“用户和组”->“所有用户”](./media/active-directory-saas-tangoe-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![添加用户](./media/active-directory-saas-tangoe-tutorial/create_aaduser_03.png) 

4. 在“用户”对话框页上，执行以下步骤：
 
    ![“用户”对话框页](./media/active-directory-saas-tangoe-tutorial/create_aaduser_04.png) 
...
2. 在应用程序列表中，选择“Tangoe Command Premium Mobile”。
    ...
    ![应用列表中的 Tangoe Command Premium Mobile](./media/active-directory-saas-tangoe-tutorial/tutorial_tangoe_app.png) 
