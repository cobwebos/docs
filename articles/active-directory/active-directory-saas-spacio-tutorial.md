...
4. 在搜索框中，键入“Spacio”，在结果面板中选择“Spacio”，然后单击“添加”按钮添加该应用程序。

    ![结果列表中的 Spacio](./media/active-directory-saas-spacio-tutorial/tutorial_spacio_addfromgallery.png)
...
3. **[创建 Spacio 测试用户](#create-a-spacio-test-user)** - 在 Spacio 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-spacio-tutorial/tutorial_spacio_samlbase.png)

3. 在“Spacio 域和 URL”部分中，执行以下步骤：

    ![Spacio 域和 URL 单一登录信息](./media/active-directory-saas-spacio-tutorial/tutorial_spacio_url.png)
...
6. 若要在 **Spacio** 端配置单一登录，需要将**应用联合元数据 URL** 发送给 [Spacio 支持团队](mailto:support@spac.io)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-spacio-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-spacio-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-spacio-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-spacio-tutorial/create_aaduser_04.png)
...
在本部分中，将在 Spacio 中创建一个名为“Britta Simon”的用户。 请与 [Spacio 支持团队](mailto:support@spac.io)协作，将用户添加到 Spacio 平台中。 使用单一登录前，必须先创建并激活用户。
...
2. 在应用程序列表中，选择“Spacio”。

    ![应用程序列表中的 Spacio 链接](./media/active-directory-saas-spacio-tutorial/tutorial_spacio_app.png)  
