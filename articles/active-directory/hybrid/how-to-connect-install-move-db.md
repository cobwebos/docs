...
2. 找到 **%程序文件%\微软 Azure AD 同步_数据**文件夹，并将**ADSync.mdf**和**ADSync_log.ldf**文件复制到远程 SQL 服务器。
...
10. 启动新的命令提示符或 PowerShell 会话。 导航到文件夹\<驱动器>\程序文件\微软 Azure AD 连接。 运行命令 .\AzureADConnect.exe /useexistingdatabase，在“使用现有数据库”安装模式下启动 Azure AD Connect 向导。
