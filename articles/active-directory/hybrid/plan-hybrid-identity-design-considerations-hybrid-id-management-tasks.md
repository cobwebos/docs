...
![](./media/plan-hybrid-identity-design-considerations/Directory_synchronization.png) 若要适当地设计混合标识解决方案的同步，请务必回答以下问题：• 适用于混合标识解决方案的同步解决方案是什么？
• 可用的单一登录功能是什么？
