...
如果在完成上述步骤后查看 [Azure Active Directory 管理中心](https://aad.portal.azure.com)的“直通身份验证”边栏选项卡，将看到显示为“非活动”状态**** 的身份验证代理。 这是 _预期_情况。 10天后，身份验证代理会自动从列表中删除。
