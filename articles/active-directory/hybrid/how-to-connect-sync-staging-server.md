...
---
# <a name="azure-ad-connect-staging-server-and-disaster-recovery"></a>Azure AD 连接：暂存服务器和灾难恢复
...
1. 选择 **“连接器”**，然后选择类型为 **“Active Directory 域服务”** 的第一个连接器。 单击“运行”，并依次选择“完全导入”和“确定”。************ 针对此类型的所有连接器执行这些步骤。
