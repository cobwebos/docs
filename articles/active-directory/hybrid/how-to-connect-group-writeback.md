...
有关配置 Office 365 组的其他信息，请参阅[Configure Microsoft 365 groups with 本地 Exchange 混合](https://docs.microsoft.com/exchange/hybrid-deployment/set-up-office-365-groups#enable-group-writeback-in-azure-ad-connect)。
