...
有关需要在防火墙中打开的 URL 和 IP 地址的列表，请参阅[Office 365 URL 和 IP 地址范围](https://support.office.com/article/Office-365-URLs-and-IP-address-ranges-8548a211-3fe7-47cb-abb1-355ea5aa88a2)以及[排除 Azure AD 连接连接的疑难解答](tshoot-connect-connectivity.md#troubleshoot-connectivity-issues-in-the-installation-wizard)。
...
Azure 服务总线端口 5671 不再需要最新版本的代理。 最新的 Azure AD 连接运行状况代理版本仅需要端口 443。
