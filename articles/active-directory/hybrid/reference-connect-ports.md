...
|WinRM  | 5985（TCP） |仅在使用 gMSA 通过 Azure AD Connect 向导安装 AD FS 时使用|
|AD DS Web 服务 | 9389（TCP） |仅在使用 gMSA 通过 Azure AD Connect 向导安装 AD FS 时使用 |
...
有关需要在防火墙中打开的 Url 和 IP 地址的列表，请参阅[Office 365 url 和 ip 地址范围](https://support.office.com/article/Office-365-URLs-and-IP-address-ranges-8548a211-3fe7-47cb-abb1-355ea5aa88a2)和[Azure AD Connect 连接性疑难解答](tshoot-connect-connectivity.md#troubleshoot-connectivity-issues-in-the-installation-wizard)。
