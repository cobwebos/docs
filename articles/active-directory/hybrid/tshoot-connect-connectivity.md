...
ms.locfileid: "78376068"
---
# <a name="troubleshoot-azure-ad-connectivity"></a>Azure AD 连接性疑难解答
...
![密码错误。](./media/tshoot-connect-connectivity/badpassword.png)
...
用户名或密码无效。 有关详细信息，请参阅[无法验证密码](#the-password-cannot-be-verified)。
