...
有关详细信息，请参阅 about_CommonParameters (http://go.microsoft.com/fwlink/?LinkID=113216)。
...
如果已以域管理员的身份运行，则无需提供 AD 凭据的手动水印输入，而可以使用 XML 文件，例如 $ADwatermark = "TVNEUwMAAAAXyK9ir1zSAQAAAAAAAAAA(...)"
