...
| Feature | 权限 |
| --- | --- |
| ms DS ConsistencyGuid 功能 |在设计概念中介绍的 Msds-consistencyguid 属性的写权限[-使用 msds-consistencyguid 作为 sourceAnchor](plan-connect-design-concepts.md#using-ms-ds-consistencyguid-as-sourceanchor)。 | 
