...
3. 使用 Microsoft Intune 的 Office 365 应用程序的条件访问：IT 管理员可以设置条件性访问设备策略来保护公司资源，同时允许信息工作者在符合条件的设备访问的服务上的相同时间。 
