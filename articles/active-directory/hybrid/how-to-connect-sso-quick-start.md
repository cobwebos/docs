...
3. 浏览到 **"用户配置**" " > **策略**" > **管理模板** > **Windows 组件** > **Internet Explorer** > "**安全" 页** > "internet Explorer **"** 。 然后选择“站点到区域分配列表”。
...
6. 浏览到 **"用户配置**" > **策略**" > **管理模板** > **Windows 组件** > **Internet Explorer** > Internet Explorer > " > **Intranet 区域**的**安全页** **"** 。 然后选择“允许通过脚本更新状态栏”。
