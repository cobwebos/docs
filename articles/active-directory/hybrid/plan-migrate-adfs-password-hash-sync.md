---
title: Azure AD Connect：为 Azure AD 从联合迁移到 PHS |Microsoft Docs
...
4. 在“用户登录”页上，选择“密码哈希同步”按钮。 依次选择“启用单一登录”、“下一步”。
   ...
   在启用密码哈希同步之后：![显示用户登录页上的新选项的屏幕截图](media/plan-migrate-adfs-password-hash-sync/migrating-adfs-to-phs_image13.png)<br />
