...
有关管理应用程序的组分配的详细信息，请参阅[向应用程序分配用户和组](../../active-directory/manage-apps/methods-for-assigning-users-and-groups.md#assign-groups)的文档方法。
...
3. 设置组名称配置可选声明。
   ...
   如果希望令牌中的组包含本地 AD 组属性，请在 "可选声明" 部分中指定要应用的标记类型可选声明。  可以列出多个标记类型：
...
[向应用程序分配用户和组的方法](../../active-directory/manage-apps/methods-for-assigning-users-and-groups.md#assign-groups)
