...
>[!IMPORTANT]
> 从2020年11月1日开始，我们将开始实现一个弃用过程，在此过程中，将不推荐使用超过18个月之前发布的 Azure AD Connect 版本。 此时，我们将通过弃用版本1.1.751.0 （发布于4/12/2018）和更早版本的所有 Azure AD Connect 版本来开始此过程，我们将在每次发布新版本时，继续评估 Azure AD Connect 的旧版本的弃用。
>
