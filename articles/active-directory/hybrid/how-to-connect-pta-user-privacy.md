...
应定期检查 **%ProgramData%%\Microsoft_Azure AD 连接身份验证代理\Trace**的内容，并每 48 小时删除此文件夹的内容。 
...
9.  在程序/脚本的框中键入 **"PowerShell"，** 并在标记为"**添加参数（可选）"** 的框中输入之前创建的脚本的完整路径，然后单击"**下一步**"。
10. 下一屏幕会显示要创建的任务摘要。 验证值并单击 **"完成"** 以创建任务：
