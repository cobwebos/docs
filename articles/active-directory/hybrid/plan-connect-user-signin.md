...
* 使用[无缝单一登录 (SSO)](#password-hash-synchronization) 的[密码哈希同步](how-to-connect-sso.md)
* 使用[无缝单一登录 (SSO) ](how-to-connect-pta.md)的[直通身份验证](how-to-connect-sso.md)
