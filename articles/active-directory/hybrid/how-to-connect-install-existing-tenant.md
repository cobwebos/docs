...
ms.locfileid: "89662255"
---
# <a name="azure-ad-connect-when-you-have-an-existing-tenant"></a>Azure AD Connect：有现有租户时
...
> [!WARNING]
> 由于 Azure AD 中的所有属性将被本地值覆盖，因此请确保本地的数据正确。 例如，如果你的 Microsoft 365 中只有托管的电子邮件地址，并且未将其保持在本地 AD DS 中更新，则会丢失 AD DS 中 Azure AD/Microsoft 365 中不存在的任何值。
