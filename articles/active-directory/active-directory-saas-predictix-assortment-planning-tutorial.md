...
* 可以让用户通过其 Azure AD 帐户自动登录到 Predictix Assortment Planning 单一登录 (SSO)
...
* Azure AD 订阅
* 启用了 Predictix Assortment Planning SSO 的订阅
...
在本部分中，将基于名为“Britta Simon”的测试用户配置和测试 Predictix Assortment Planning 的 Microsoft Azure AD SSO。

若要运行 SSO，Azure AD 需要知道与 Azure AD 用户相对应的 Predictix Assortment Planning 用户。 换句话说，需要建立 Azure AD 用户与 Predictix Assortment Planning 中相关用户之间的关联关系。
...
**若要配置 Predictix Assortment Planning 的 Microsoft Azure AD SSO，请执行以下步骤：**
...
3. 在“配置应用设置”对话框页上，执行以下步骤：
  ...
  1. 在“登录 URL”文本框中，使用以下模式键入用户用于登录 Predictix Assortment Planning 应用程序的 URL：**https://\<公司名称-定价\>.ap.predictix.com/sso/request**。
  2. 单击“下一步”
...
5. 在“告诉我们有关此用户的信息”对话框页上，执行以下步骤：
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-predictix-assortment-planning-tutorial/create_aaduser_05.png) 
  1. 在“用户类型”中，选择“你的组织中的新用户”。
  2. 在“用户名”文本框中，键入“BrittaSimon”。
  3. 单击“资源组名称” 的 Azure 数据工厂。
6. 在“用户配置文件”对话框页上，执行以下步骤：

   ![创建 Azure AD 测试用户](./media/active-directory-saas-predictix-assortment-planning-tutorial/create_aaduser_06.png) 
...
### <a name="create-an-predictix-assortment-planning-test-user"></a>创建 Predictix Assortment Planning 测试用户
