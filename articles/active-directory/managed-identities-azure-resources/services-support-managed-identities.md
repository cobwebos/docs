...
| 托管标识类型 | 所有正式发布版<br>全球 Azure 区域 | Azure 政府 | Azure Germany | Azure 中国世纪互联 |
| --- | --- | --- | --- | --- |
| 系统分配 | 可用 | 预览 | 预览 | 预览 | 
| 用户分配 | 可用 | 预览 | 预览 | 预览 |
...
- [Azure 门户](/azure/logic-apps/create-managed-service-identity#azure-portal-system-logic-app)
