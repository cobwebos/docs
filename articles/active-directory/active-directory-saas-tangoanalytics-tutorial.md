...
4. 在搜索框中，键入“Tango Analytics”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-tangoanalytics-tutorial/tutorial_tangoanalytics_search.png)

5. 在结果窗格中，选择“Tango Analyticss”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-tangoanalytics-tutorial/tutorial_tangoanalytics_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-tangoanalytics-tutorial/tutorial_tangoanalytics_samlbase.png)

3. 在“Tango Analytics 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-tangoanalytics-tutorial/tutorial_tangoanalytics_url.png)

    a.在“横幅徽标”下面，选择“删除上传的徽标”。 在“标识符”文本框中，键入值 `TACORE_SSO`

    b.在“磁贴徽标”下面，选择“删除上传的徽标”。 在“回复 URL”文本框中，使用以下模式键入 URL：`https://mts.tangoanalytics.com/saml2/sp/acs/post`
...
4. 在“SAML 签名证书”部分中，单击“元数据 XML”，然后在计算机上保存元数据文件。
    ...
    ![配置单一登录](./media/active-directory-saas-tangoanalytics-tutorial/tutorial_tangoanalytics_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录](./media/active-directory-saas-tangoanalytics-tutorial/tutorial_general_400.png)

6. 若要在 Tango Analytics 端配置单一登录，需要将下载的元数据 XML 发送给 [Tango Analytics 支持团队](mailto:support@tangoanalytics.com)。 他们会对此进行设置，使 SAML SSO 连接在两端均正确设置。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-tangoanalytics-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-tangoanalytics-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-tangoanalytics-tutorial/create_aaduser_03.png) 

4. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-tangoanalytics-tutorial/create_aaduser_04.png) 
...
2. 在应用程序列表中，选择“Tango Analytics”。
    ...
    ![配置单一登录](./media/active-directory-saas-tangoanalytics-tutorial/tutorial_tangoanalytics_app.png) 
