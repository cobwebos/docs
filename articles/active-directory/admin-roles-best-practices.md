...
![采用时间线的路线图的各个阶段](./media/admin-roles-best-practices/roadmap-timeline.png)
...
![阶段 1](./media/admin-roles-best-practices/stage-one.png)
...
![阶段 2](./media/admin-roles-best-practices/stage-two.png)
...
![阶段 3](./media/admin-roles-best-practices/stage-three.png)
...
对于 Azure Active Directory，请使用 [Azure AD Privileged Identity Management](active-directory-privileged-identity-management-configure.md) 功能。 对特权角色进行有时间限制的激活时，可执行以下操作：
...
![阶段 4](./media/admin-roles-best-practices/stage-four.png)
...
![紧急情况](./media/admin-roles-best-practices/emergency.jpeg)
