...
4. 在搜索框中，键入“LaunchDarkly”，在结果面板中选择“LaunchDarkly”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 LaunchDarkly](./media/active-directory-saas-launchdarkly-tutorial/tutorial_launchdarkly_addfromgallery.png)
...
3. **[创建 LaunchDarkly 测试用户](#create-a-launchdarkly-test-user)** - 在 LaunchDarkly 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 身份。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-launchdarkly-tutorial/tutorial_launchdarkly_samlbase.png)

3. 在“LaunchDarkly 域和 URL”部分中，如果要在 IDP 发起的模式下配置应用程序，请执行以下步骤：

    ![LaunchDarkly 域和 URL 单一登录信息](./media/active-directory-saas-launchdarkly-tutorial/tutorial_launchdarkly_url.png)
...
4. 如果要在 SP 发起的模式下配置应用程序，请选中“显示高级 URL 设置”，并执行以下步骤：
    ...
    ![LaunchDarkly 域和 URL 单一登录信息](./media/active-directory-saas-launchdarkly-tutorial/tutorial_launchdarkly_url1.png)

    在“登录 URL”文本框中，键入 URL：`https://app.launchdarkly.com`

5. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。

    ![证书下载链接](./media/active-directory-saas-launchdarkly-tutorial/tutorial_launchdarkly_certificate.png) 

6. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/active-directory-saas-launchdarkly-tutorial/tutorial_general_400.png)
    
7. 在“LaunchDarkly 配置”部分，单击“配置 LaunchDarkly”打开“配置登录”窗口。 从“快速参考”部分中复制“单一登录服务 URL”。

    ![LaunchDarkly 配置](./media/active-directory-saas-launchdarkly-tutorial/tutorial_launchdarkly_configure.png)

8. 在另一个 Web 浏览器窗口中，以管理员身份登录到 LaunchDarkly 公司站点。

9. 从左侧导航面板中选择“帐户设置”。

    ![LaunchDarkly 配置](./media/active-directory-saas-launchdarkly-tutorial/configure1.png)

10. 单击“安全”选项卡。

    ![LaunchDarkly 配置](./media/active-directory-saas-launchdarkly-tutorial/configure2.png)

11. 单击“启用 SSO”，然后单击“编辑 SAML 配置”。

    ![LaunchDarkly 配置](./media/active-directory-saas-launchdarkly-tutorial/configure3.png)

12. 在“编辑 SAML 配置”部分执行以下步骤：

    ![LaunchDarkly 配置](./media/active-directory-saas-launchdarkly-tutorial/configure4.png)
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-launchdarkly-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-launchdarkly-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-launchdarkly-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-launchdarkly-tutorial/create_aaduser_04.png)
...
2. 在应用程序列表中，选择“LaunchDarkly”。
    ...
    ![应用程序列表中的 LaunchDarkly 链接](./media/active-directory-saas-launchdarkly-tutorial/tutorial_launchdarkly_app.png)  
