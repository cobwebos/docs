...
3. **[创建 FreshDesk 测试用户](#creating-a-freshdesk-test-user)** -若要链接到的 Azure AD 表示形式她的 FreshDesk 中具有 Britta 人 Simon 的副本。
4. **[分配 Azure AD 测试用户](#assigning-the-azure-ad-test-user)** - 让 Britta Simon 使用 Azure AD 单一登录。
5. **[测试单一登录](#testing-single-sign-on)** - 验证配置是否正常工作。

### <a name="configuring-azure-ad-single-sign-on"></a>配置 Azure AD 单一登录

在本部分中，会在 Azure 管理门户中启用 Azure AD 单一登录并在 FreshDesk 应用程序中配置单一登录。
...
10. 在“安全”部分中，执行以下步骤：
    ...
    e.在“新建 MySQL 数据库”边栏选项卡中，接受法律条款，并单击“确定”。 从 Azure 门户的下载证书中复制“指纹”值，然后将其粘贴到“安全证书指纹”文本框中。  
...
5. 在“代理信息”对话框中，执行以下步骤：
   ...
   a. 在“完整名称”文本框中，键入要预配的 Azure AD 帐户的名称。
...
**要将 Britta Simon 分配到 FreshDesk，请执行以下步骤：**
