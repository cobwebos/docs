---
title: "在 Azure Active Directory 预览版中管理组的设置 | Microsoft 文档"
...
---
# <a name="manage-the-settings-for-a-group-in-azure-active-directory-preview"></a>在 Azure Active Directory 预览版中管理组的设置
本文介绍如何在 Azure Active Directory (Azure AD) 预览版中更改组的设置。 [预览包括哪些内容？](active-directory-preview-explainer.md)
