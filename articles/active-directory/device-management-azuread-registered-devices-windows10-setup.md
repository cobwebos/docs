---
title: "如何配置已注册 Azure Active Directory 的设备 | Microsoft Docs"
description: "了解如何配置已注册 Azure Active Directory 的设备。"
...
---
# <a name="how-to-configure-azure-active-directory-registered-windows-10-devices"></a>如何配置已注册 Azure Active Directory 的 Windows 10 设备
