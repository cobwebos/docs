...
2. 在左窗格中，单击“Active Directory”。 <br><br>![Cloud App Discovery 的工作原理](./media/active-directory-known-networks/known-netwoks-01.png)
3. 在“目录”选项卡中，选择目录。
4. 在顶部菜单中，单击“配置”。 <br><br>![Cloud App Discovery 的工作原理](./media/active-directory-known-networks/known-netwoks-02.png)
5. 在“配置”选项卡上，转到“组织公共 IP 地址范围” <br><br>![Cloud App Discovery 的工作原理](./media/active-directory-known-networks/known-netwoks-03.png)
6. 单击“添加已知的 IP 地址范围”。
