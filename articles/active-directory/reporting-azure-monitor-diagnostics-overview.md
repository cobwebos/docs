...
**答**：目前，Azure Monitor 可以使用 Splunk、QRadar 和 Sumo Logic。 但是，Splunk 是 Azure AD 日志唯一支持的 SIEM 工具。 若要详细了解连接器的工作方式，请参阅[将 Azure 监视数据流式传输到事件中心供外部工具使用](../monitoring-and-diagnostics/monitor-stream-monitoring-data-event-hubs.md)。
