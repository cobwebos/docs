...
4. 在搜索框中，键入“Yodeck”，在结果面板中选择“Yodeck”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 Yodeck](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_samlbase.png)

3. 在“Yodeck 域和 URL”部分，如果要在“IDP”发起的模式下配置应用程序，请执行以下步骤：

    ![Yodeck 域和 URL 单一登录信息](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_url.png)

    在“标识符(实体 ID)”文本框中，键入 URL：`https://app.yodeck.com/api/v1/account/metadata/`

4. 如果要在 SP 发起的模式下配置应用程序，请选中“显示高级 URL 设置”，并执行以下步骤：

    ![Yodeck 域和 URL 单一登录信息](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_url1.png)

    在“登录 URL”文本框中，键入 URL：`https://app.yodeck.com/login`

5. 在“SAML 签名证书”部分上，单击”复制”按钮，复制“应用联合元数据 URL”并将其粘贴到记事本。

    ![证书下载链接](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_certificate.png)

6. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/active-directory-saas-yodeck-tutorial/tutorial_general_400.png)
    
7. 在另一个 Web 浏览器窗口中，以管理员身份登录到 Yodeck 公司站点。

8. 单击页面右上角的“用户设置”选项表单，然后选择“帐户设置”。

    ![Yodeck 配置](./media/active-directory-saas-yodeck-tutorial/configure1.png)

9. 选择“SAML”并执行以下步骤：

    ![Yodeck 配置](./media/active-directory-saas-yodeck-tutorial/configure2.png)
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-yodeck-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-yodeck-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-yodeck-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-yodeck-tutorial/create_aaduser_04.png)
...
2. 单击页面右上角的“用户设置”选项表单，然后选择“用户”。
    ...
    ![添加员工](./media/active-directory-saas-yodeck-tutorial/user1.png)

3. 单击“+用户”以打开“用户详细信息”选项卡。

    ![添加员工](./media/active-directory-saas-yodeck-tutorial/user2.png)

4. 在“用户详细信息”对话框页上，执行以下步骤：

    ![添加员工](./media/active-directory-saas-yodeck-tutorial/user3.png)
...
2. 在应用程序列表中，选择“Yodeck”。
    ...
    ![应用程序列表中的 Yodeck 链接](./media/active-directory-saas-yodeck-tutorial/tutorial_yodeck_app.png)  
