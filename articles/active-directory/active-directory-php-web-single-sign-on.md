<properties 
	pageTitle="有关 Azure Active Directory 的单一登录 (PHP)" 
	description="了解如何创建使用与 Azure Active Directory 相关的单一登录的 PHP 网站。" 
...
2. 在“开始”菜单中，运行“用于 Windows PowerShell 的 Azure Active Directory 模块”控制台。此控制台提供了用于配置有关 Office 365 租户的属性（如创建和修改服务主体）的命令行环境。
...
3. 在新的 **federation.ini** 文件中，输入以下信息，并提供包含创建服务主体时在第 2 步中保存的信息的值：
	...
	> [AZURE.NOTE] **audienceuris** 和 **realm** 值前面都必须为“spn:”。

4. 在 Eclipse 中，右键单击 **phpSample** 项目，单击“新建”，然后单击“PHP 文件”。
...
有关演示如何使用 Azure Active Directory 和 PHP 网站的单一登录的示例，请参阅 <https://github.com/WindowsAzure/azure-sdk-for-php-samples/tree/master/WAAD.WebSSO.PHP>。
