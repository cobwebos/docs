...
本部分的目的是基于名为“Britta Simon”的测试用户展示如何配置并测试 23 Video 的 Azure AD 单一登录。
...
本部分的目的是在 Azure 经典门户中启用 Azure AD 单一登录并在 23 Video 应用程序中配置单一登录。
...
3. 在“配置应用设置”对话框页上，执行以下步骤：
    ...
    ![Azure AD 单一登录][8] 
     ...
     a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 在“回复 URL”文本框中，键入用户用来登录 23 Video 站点的 URL（例如：*https://britta-simon.23Video.com/saml/login*）。
...
4. 在“配置 23 Video 处的单一登录”页上，执行以下步骤：
    ...
    b.保留“数据库类型”设置，即设置为“共享”。 通过 [support@23company.com](mailto:support@23company.com) 联系 23 Video 支持团队，向其提供下载的证书、**颁发者 URL**、**单一登录服务 URL**、**单一注销 URL**，然后请他们为 23 Video 应用设置 SSO。 
...
本部分的目的是通过向 Britta Simon 授予对 23 Video 的访问权限，使她能够使用 Azure 单一登录。
