...
4. 在搜索框中键入“Versal”，在结果面板中选择“Versal”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 Versal](./media/active-directory-saas-versal-tutorial/tutorial_versal_addfromgallery.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分中，基于一个名为“Britta Simon”的测试用户使用 Versal 配置和测试 Azure AD 单一登录。

若要运行单一登录，Azure AD 需要知道与 Azure AD 用户相对应的 Versal 用户。 换句话说，需要建立 Azure AD 用户与 Versal 中相关用户之间的链接关系。

通过将 Azure AD 中“用户名”的值指定为 Versal 中“用户名”的值来建立此链接关系。
...
在本部分中，将在 Azure 门户中启用 Azure AD 单一登录并在 Versal 应用程序中配置单一登录。

若要配置 Versal 的 Azure AD 单一登录，请执行以下步骤：

1. 在 Azure 门户中的 Versal 应用程序集成页上，单击“单一登录”。

    ![配置单一登录链接][4]

2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
 
    ![“单一登录”对话框](./media/active-directory-saas-versal-tutorial/tutorial_versal_samlbase.png)

3. 在“Versal 域和 URL”部分中，执行以下步骤：

    ![Versal 域和 URL 单一登录信息](./media/active-directory-saas-versal-tutorial/tutorial_versal_url.png)
...
4. 应用程序需要特定格式的 SAML 断言，这要求向 SAML 令牌属性配置添加自定义属性映射。 以下屏幕截图显示一个示例。 “用户标识符”的默认值是“user.userprincipalname”，但 Versal 要求通过用户的电子邮件地址映射此项。 为此，可以使用列表中的 **user.mail** 属性，或使用基于组织配置的相应属性值。
    ...
    ![用户标识符下拉菜单](./media/active-directory-saas-versal-tutorial/tutorial_versal_attribute.png)

5. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。

    ![证书下载链接](./media/active-directory-saas-versal-tutorial/tutorial_versal_certificate.png) 
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-versal-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-versal-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-versal-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-versal-tutorial/create_aaduser_04.png)
...
### <a name="create-a-versal-test-user"></a>创建 Versal 测试用户

在本部分中，将在 Versal 中创建一个名为“Britta Simon”的用户。 请按照[创建 SAML 测试用户](https://support.versal.com/hc/en-us/articles/115011672887-Creating-a-SAML-test-user)支持指南，在组织内创建用户 Britta Simon。 使用单一登录前，必须先在 Versal 中创建并激活用户。 
...
若要将 Britta Simon 分配到 Versal，请执行以下步骤：
...
2. 在应用程序列表中，选择“Versal”。
    ...
    ![应用程序列表中的 Versal 链接](./media/active-directory-saas-versal-tutorial/tutorial_versal_app.png)  
