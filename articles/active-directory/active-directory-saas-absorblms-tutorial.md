...
3. **在“Absorb LMS 域和 URL”部分中，执行以下步骤：**
...
**要将 Britta Simon 分配到 Absorb LMS，请执行以下步骤：**
...
单击访问面板中的 Absorb LMS 磁贴时，会自动登录到 Absorb LMS 应用程序。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://msdn.microsoft.com/library/dn308586)（访问面板简介）。
