...
> *直接转到[图形 API 快速入门指南](active-directory-graph-api-quickstart)和[交互式图形 API 参考文档](https://msdn.microsoft.com/Library/Azure/Ad/Graph/api/api-catalog)。*
...
若要开始使用 Azure Active Directory 图形 API，请参阅[图形 API 快速入门指南](active-directory-graph-api-quickstart)，或查看[交互式图形 API 参考文档](https://msdn.microsoft.com/Library/Azure/Ad/Graph/api/api-catalog)。
