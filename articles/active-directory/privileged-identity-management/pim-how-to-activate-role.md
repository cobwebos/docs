...
当您需要承担 Azure AD 角色时，可以使用"特权标识管理 **"中的"我的角色**导航"选项请求激活。
...
1. 选择 **"我的角色**"，然后选择**Azure AD 角色**以查看符合条件的 Azure AD 角色的列表。
...
1. 选择“激活”打开“激活”窗格。****
    ...
    ![Azure AD 角色 - 激活页包含持续时间和范围](./media/pim-how-to-activate-role/activate-page.png)
...
1. 如果要指定缩小的范围，请选择 **"范围"** 以打开筛选器窗格。 在筛选器窗格中，可以指定需要访问的 Azure AD 资源。 最佳做法是仅请求访问所需的资源。
...
如果激活后有任何延迟，请按照以下步骤激活后立即使用 Azure AD 角色。
...
1. 选择“我的请求”，查看你的 Azure AD 角色和 Azure 资源角色请求列表。****
    ...
    ![我的请求 - 显示挂起请求的 Azure AD 页面](./media/pim-how-to-activate-role/my-requests-page.png)
...
1. 注销 Azure 门户，然后重新登录。
    ...
    激活 Azure AD 角色时，将会看见激活的各阶段。 在所有阶段都完成后，**注销**链接将会显示。 您可以使用此链接注销。这将解决大多数激活延迟的情况。
...
1. 单击 **“激活”**。
    ...
    如果[角色需要批准](./azure-ad-pim-approval-workflow.md)才能激活，则浏览器右上角将显示 Azure 通知，通知您请求正在等待审批。
