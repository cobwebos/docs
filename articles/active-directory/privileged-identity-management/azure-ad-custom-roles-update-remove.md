---
title: 更新或删除 Azure AD 自定义角色 - 特权标识管理 （PIM）
...
> [!NOTE]
> 在预览版中，Azure AD 自定义角色未集成内置的目录角色。 此功能的正式版发布后，可在内置的角色体验中进行角色管理。 如果您看到以下横幅，这些角色应在[内置角色体验中](pim-how-to-add-role-to-user.md)管理，本文不适用：
>
