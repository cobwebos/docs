...
![PIM 仪表板安全警报 - 屏幕截图](./media/pim-how-to-configure-security-alerts/PIM_security_dash.png)
...
2. 依次选择“托管的特权角色” > “设置” > “警报设置”。
    ...
    ![导航到安全警报设置](./media/pim-how-to-configure-security-alerts/PIM_security_settings.png)
