...
ms.locfileid: "87506038"
---
# <a name="audit-activity-history-for-privileged-access-group-assignments-preview-in-privileged-identity-management"></a>Privileged Identity Management 中的特权访问组分配（预览）的审核活动历史记录

使用 Privileged Identity Management （PIM），可以查看 Azure Active Directory （Azure AD）组织内 Azure 特权访问组成员和所有者的活动、激活和审核历史记录。
