...
ms.locfileid: "38506347"
---
# <a name="using-the-audit-log-in-pim"></a>在 PIM 中使用审核日志
可以使用 Privileged Identity Management (PIM) 审核日志查看给定时间段内的所有用户分配和激活。 如果想要在租户中查看活动的完整审核历史记录（包括管理员、最终用户和同步活动），可以使用 [Azure Active Directory 访问和使用情况报告。](../active-directory-reporting-azure-portal.md)
