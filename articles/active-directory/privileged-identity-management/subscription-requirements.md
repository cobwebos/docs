---
title: 使用 PIM 的订阅要求 - Azure | Microsoft Docs
description: 介绍使用 Azure AD Privileged Identity Management (PIM) 的订阅和许可要求。
...
ms.locfileid: "43190604"
---
# <a name="subscription-requirements-to-use-pim"></a>使用 PIM 的订阅要求
