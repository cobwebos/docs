---
title: 查看对 PIM 中 Azure AD 角色的访问权限-Azure AD |Microsoft Docs
description: 了解如何在 Azure AD Privileged Identity Management （PIM）中查看 Azure Active Directory 角色的访问权限。
