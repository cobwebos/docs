...
4. 在“预配”选项页上，单击“下一步”。 
    ...
    ![预配选项](./media/active-directory-saas-workday-inbound-tutorial/IC750997.png "预配选项")
5. 在“开始预配”对话框中，单击“完成”。 
   
    ![开始预配](./media/active-directory-saas-workday-inbound-tutorial/IC750998.png "开始预配")
