...
4. 在搜索框中，键入 BlueJeans。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-bluejeans-tutorial/tutorial_bluejeans_search.png)

5. 在“结果”窗格中，选择“BlueJeans”，再单击“添加”按钮，添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-bluejeans-tutorial/tutorial_bluejeans_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-bluejeans-tutorial/tutorial_bluejeans_samlbase.png)

3. 在“BlueJeans 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-bluejeans-tutorial/tutorial_bluejeans_url.png)
...
5. 单击“保存”按钮。
    ...
    ![配置单一登录](./media/active-directory-saas-bluejeans-tutorial/tutorial_general_400.png)

6. 在“BlueJeans 配置”部分，单击“配置 BlueJeans”，以打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL、更改密码 URL 和 SAML 单一登录服务 URL”。

    ![配置单一登录](./media/active-directory-saas-bluejeans-tutorial/tutorial_bluejeans_configure.png) 
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-bluejeans-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-bluejeans-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-bluejeans-tutorial/create_aaduser_03.png) 
...
为了使 Azure AD 用户登录到 BlueJeans，必须将其预配到 BlueJeans。  

对于 BlueJeans 而言，需要手动完成预配任务。
...
2. 在应用程序列表中选择“BlueJeans”。
    ...
    ![配置单一登录](./media/active-directory-saas-bluejeans-tutorial/tutorial_bluejeans_app.png) 
