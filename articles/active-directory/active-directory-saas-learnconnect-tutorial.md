---
title: "教程：Azure Active Directory 与 Learnconnect 集成 | Microsoft Docs"
description: "了解如何在 Azure Active Directory 和 Learnconnect 之间配置单一登录。"
...
---
# <a name="tutorial-azure-active-directory-integration-with-learnconnect"></a>教程：Azure Active Directory 与 Learnconnect 集成

在本教程中，了解如何将 Learnconnect 与 Azure Active Directory (Azure AD) 集成。

将 Learnconnect 与 Azure AD 集成可提供以下优势：

- 可以在 Azure AD 中控制谁有权访问 Learnconnect
- 可以让用户使用其 Azure AD 帐户自动登录到 Learnconnect（单一登录）
...
若要配置 Azure AD 与 Learnconnect 的集成，需要以下项：

- Azure AD 订阅
- 已启用 Learnconnect 单一登录的订阅
...
1. 从库中添加 Learnconnect
2. 配置和测试 Azure AD 单一登录

## <a name="adding-learnconnect-from-the-gallery"></a>从库中添加 Learnconnect
若要配置 Learnconnect 与 Azure AD 的集成，需要从库中将 Learnconnect 添加到托管 SaaS 应用列表。

**若要从库中添加 Learnconnect，请执行以下步骤：**
...
4. 在搜索框中，键入“Learnconnect”。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-learnconnect-tutorial/tutorial_learnconnect_search.png)

5. 在结果窗格中，选择“Learnconnect”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-learnconnect-tutorial/tutorial_learnconnect_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>配置并测试 Azure AD 单一登录
在本部分中，将基于名为“Britta Simon”的测试用户配置和测试 Learnconnect 的 Azure AD 单一登录。

若要运行单一登录，Azure AD 需要知道与 Azure AD 用户相对应的 Learnconnect 用户。 换句话说，需要在 Azure AD 用户与 Learnconnect 中相关用户之间建立链接关系。

可以通过将 Azure AD 中“用户名”的值分配为 Learnconnect 中“用户名”的值来建立此链接关系。

若要配置和测试 Learnconnect 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configuring-azure-ad-single-sign-on)** - 让用户使用此功能。
2. **[创建 Azure AD 测试用户](#creating-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
3. **[创建 Learnconnect 测试用户](#creating-a-learnconnect-test-user)** - 在 Learnconnect 中创建 Britta Simon 的对应用户，将其链接到该用户的 Azure AD 表示形式。
4. **[分配 Azure AD 测试用户](#assigning-the-azure-ad-test-user)** - 让 Britta Simon 能够使用 Azure AD 单一登录。
5. **[测试单一登录](#testing-single-sign-on)** - 验证配置是否正常工作。

### <a name="configuring-azure-ad-single-sign-on"></a>配置 Azure AD 单一登录

本部分介绍在 Azure 门户中启用 Azure AD 单一登录，并在 Learnconnect 应用程序中配置单一登录。

**若要配置 Learnconnect 的 Azure AD 单一登录，请执行以下步骤：**

1. 在 Azure 门户的“Learnconnect”应用程序集成页上，单击“单一登录”。
...
3. 在“Learnconnect 域和 URL”部分中，如果要在“IDP”发起的模式下配置应用程序，请执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-learnconnect-tutorial/tutorial_learnconnect_url.png)

    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 在“标识符”文本框中，使用以下模式键入 URL：`https://<subdomain>.learningseatlms.com`
...
4. 如果要在“SP”发起的模式下配置应用程序，请选中“显示高级 URL 设置”：
    ...
    > [!NOTE] 
    > 这些不是实际值。 请使用实际的“标识符”、“回复 URL”和“登录 URL”更新这些值。 若要获取这些值，请联系 [Learnconnect 支持团队](http://help.learningseatlms.com/help)。 
...
7. 若要在“Learnconnect”端配置单一登录，需要将下载的**元数据 XML** 发送给 [Learnconnect 支持团队](http://help.learningseatlms.com/help)。
...
### <a name="creating-a-learnconnect-test-user"></a>创建 Learnconnect 测试用户

在本部分中，将在 Learnconnect 中创建一个名为 Britta Simon 的用户。 请联系 [Learnconnect 支持团队](http://help.learningseatlms.com/help)并附上所有用户信息，以便将用户添加到 Learnconnect 应用程序中。

### <a name="assigning-the-azure-ad-test-user"></a>分配 Azure AD 测试用户

在本部分中，通过授予 Britta Simon 访问 Learnconnect 的权限，允许其使用 Azure 单一登录。

![分配用户][200] 

**若要将 Britta Simon 分配到 Learnconnect，请执行以下步骤：**

1. 在 Azure 门户中打开应用程序视图，导航到目录视图，接着转到“企业应用程序”，然后单击“所有应用程序”。

    ![分配用户][201] 

2. 在应用程序列表中，选择“Learnconnect”。
...
单击访问面板中的“Learnconnect”磁贴时，你将自动登录到 Learnconnect 应用程序。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://msdn.microsoft.com/library/dn308586)（访问面板简介）。
