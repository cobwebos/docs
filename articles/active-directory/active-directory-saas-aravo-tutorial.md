...
3. **[创建 Aravo 测试用户](#creating-an-aravo-test-user)** - 在 Aravo 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
3. 在“Aravo 域和 URL”部分中，执行以下步骤：
    ...
    > [!NOTE] 
    > 这些不是实际值。 请使用实际标识符和回复 URL 更新这些值。 请联系 [Aravo 支持团队](http://www.aravo.com/about-us/contact/)获取这些值。
