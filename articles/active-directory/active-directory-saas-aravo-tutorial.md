...
3. **[创建 Aravo 测试用户](#creating-an-aravo-test-user)** - 目的是在 Aravo 中拥有一个与 Azure AD 中的 Britta Simon 相对应的关联用户。
...
3. 在“Aravo 域和 URL”部分中，执行以下步骤：
    ...
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 在“标识符”文本框中，使用以下模式键入 URL：`https://<companyname>.aravo.com`
