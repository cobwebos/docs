...
本部分的目的是说明如何基于名为“Britta Simon”的测试用户配置和测试 Aravo 的 Microsoft Azure AD 单一登录。
...
若要配置和测试 Aravo 的 Microsoft Azure AD 单一登录，需要完成以下构建基块：
...
在本部分中，将在经典门户中启用 Microsoft Azure AD 单一登录，并在 Aravo 应用程序中配置单一登录。

**若要配置 Aravo 的 Microsoft Azure AD 单一登录，请执行以下步骤：**
...
3. 在“配置应用设置”对话框页上，执行以下步骤，然后单击“下一步”：
    ...
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 在“标识符”文本框中，使用以下模式键入 URL：`https://<company name>.aravo.com`
   
    b. 在“回复 URL”文本框中，使用以下模式键入 URL：`https://<company name>.aravo.com/aems/login.do`
...
### <a name="creating-a-aravo-test-user"></a>创建 Aravo 测试用户
本部分的目的是在 Aravo 中创建名为 Britta Simon 的用户。请与 Aravo 支持团队合作，在 Aravo 帐户中添加用户。

### <a name="assigning-the-azure-ad-test-user"></a>分配 Azure AD 测试用户
本部分的目的是通过向 Britta Simon 授予对 Aravo 的访问权限，使她能够使用 Azure 单一登录。
