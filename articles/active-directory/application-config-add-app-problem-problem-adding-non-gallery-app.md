---
title: "添加非库应用程序的问题 | Microsoft Docs"
...
如果你需要了解自定义应用程序的帮助，[Azure AD 应用程序文档库](https://docs.microsoft.com/azure/active-directory/active-directory-apps-index)可帮助你了解有关使用 Azure AD 进行单一登录及其工作原理的详细信息。

<a id="how-to-see-the-details-of-a-portal-notification" class="xliff"></a>

## 如何查看门户通知的详细信息

可以通过执行以下步骤来查看任何门户通知的详细信息：
...
6.  单击“复制错误”文本框右侧的“复制”图标，复制所有通知的详细信息以与支持或产品组工程师共享。

<a id="how-to-get-help-by-sending-notification-details-to-a-support-engineer" class="xliff"></a>

## 如何通过向支持工程师发送通知详细信息来获取帮助

如果需要帮助，与支持工程师共享**下面列出的所有详细信息**非常重要，这有助于他们迅速地帮助你解决问题。 通过**捕获屏幕截图**或单击“复制错误”图标（位于“复制错误”文本框右侧），可以轻松执行此操作。
