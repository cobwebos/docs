...
ms.locfileid: "36335027"
---
# <a name="problem-adding-a-non-gallery-application"></a>添加非库应用程序的问题

本文可帮助你了解添加自定义非库应用程序时常见的问题，以及可以执行哪些操作来加以解决。 
...
如果需要了解自定义应用程序的帮助，[Azure AD 应用程序文档库](https://docs.microsoft.com/azure/active-directory/active-directory-apps-index)可帮助你了解有关使用 Azure AD 进行单一登录及其工作原理的详细信息。
