...
4. 在搜索框中，键入“RFPIO”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-rfpio-tutorial/tutorial_rfpio_search.png)

5. 在结果窗格中，选择“RFPIO”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-rfpio-tutorial/tutorial_rfpio_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-rfpio-tutorial/tutorial_rfpio_samlbase.png)

3. 在“RFPIO 域和 URL”部分中，如果要在“IDP 启动的模式”下配置应用程序，请执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-rfpio-tutorial/tutorial_rfpio_url.png)

    a.在“横幅徽标”下面，选择“删除上传的徽标”。 在“标识符”文本框中，键入 URL：`https://www.rfpio.com`

    ![配置单一登录](./media/active-directory-saas-rfpio-tutorial/tutorial_rfpio_url1.png)

    b.在“磁贴徽标”下面，选择“删除上传的徽标”。 选中“显示高级 URL 设置”。

    c. 在“中继状态”文本框中输入的字符串值。 请联系 [RFPIO 支持团队](https://www.rfpio.com/contact/)获取此值。 

4. 选中“显示高级 URL 设置”。 如果要在“SP”发起的模式下配置应用程序： 

    ![配置单一登录](./media/active-directory-saas-rfpio-tutorial/tutorial_rfpio_url2.png)

    在“登录 URL”文本框中，键入 URL： `https://www.app.rfpio.com`

5. 在“SAML 签名证书”部分中，单击“元数据 XML”，然后在计算机上保存元数据文件。

    ![配置单一登录](./media/active-directory-saas-rfpio-tutorial/tutorial_rfpio_certificate.png) 

6. 单击“保存”按钮。

    ![配置单一登录](./media/active-directory-saas-rfpio-tutorial/tutorial_general_400.png)

7. 在另一个 Web 浏览器窗口中，以管理员身份登录到 RFPIO 网站。

8. 单击左下角的下拉列表。

    ![配置单一登录](./media/active-directory-saas-rfpio-tutorial/app1.png)

9. 单击“组织设置”。 

    ![配置单一登录](./media/active-directory-saas-rfpio-tutorial/app2.png)

10. 单击“功能和集成”。

    ![配置单一登录](./media/active-directory-saas-rfpio-tutorial/app4.png)

11. 在 SAML SSO 配置中，单击“编辑”。

    ![配置单一登录](./media/active-directory-saas-rfpio-tutorial/app3.png)

12. 在本部分中，执行以下操作：

    ![配置单一登录](./media/active-directory-saas-rfpio-tutorial/app5.png)
    
    a.在“横幅徽标”下面，选择“删除上传的徽标”。 复制下载的元数据 XML 文件的内容，然后将其粘贴到“标识配置”字段。

    > [!NOTE]
    >要复制下载的元数据 XML的内容，请使用“Notepad++”或“XML 编辑器”。 

    b.在“磁贴徽标”下面，选择“删除上传的徽标”。 单击“验证”。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-rfpio-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-rfpio-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-rfpio-tutorial/create_aaduser_03.png) 

4. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-rfpio-tutorial/create_aaduser_04.png) 
...
4. 单击“团队成员”。
    ...
    ![配置单一登录](./media/active-directory-saas-rfpio-tutorial/app6.png)

5. 单击“添加成员”。

    ![配置单一登录](./media/active-directory-saas-rfpio-tutorial/app7.png)

6. 在“添加新成员”部分。 执行以下操作：

    ![配置单一登录](./media/active-directory-saas-rfpio-tutorial/app8.png)

    a.在“横幅徽标”下面，选择“删除上传的徽标”。 在“每行输入一个电子邮件”字段输入电子邮件地址。

    b.在“磁贴徽标”下面，选择“删除上传的徽标”。 根据需要选择角色。

    c. 单击“添加成员”。
        
    > [!NOTE]
    > Azure Active Directory 帐户持有者将收到一封电子邮件，并打开其中的链接以在激活帐户前确认帐户。
...
2. 在应用程序列表中，选择“RFPIO”。
    ...
    ![配置单一登录](./media/active-directory-saas-rfpio-tutorial/tutorial_rfpio_app.png) 
