...
对于实际由组织拥有的 IP 地址，Azure Active Directory 可能检测到对“不可能前往异常位置”和“从具有可疑活动的 IP 地址登录”[风险事件类型](active-directory-identity-protection-risk-events.md#risk-event-types)的误报。 
