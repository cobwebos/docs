...
* [Repair Office 365 trust with Azure AD Connect](active-directory-aadconnect-federation-management.md#repairthetrust)（使用 Azure AD Connect 修复 Office 365 信任）
