...
* [Repair Office 365 trust with Azure AD Connect](/documentation/articles/active-directory-aadconnect-federation-management/#repairing-the-trust)（使用 Azure AD Connect 修复 Office 365 信任）
