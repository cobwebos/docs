...
若要配置 Infor Retail - Information Management 与 Azure AD 的集成，需要从库中将 Infor Retail - Information Management 添加到托管 SaaS 应用列表。
...
4. 在搜索框中，键入“Infor Retail – Information Management”。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_001.png)

5. 在结果窗格中，选择“Infor Retail - Information Management”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_0001.png)
...
通过将 Azure AD 中“用户名”的值分配为 Infor Retail - Information Management 中“用户名”的值来建立此链接关系。
...
在本部分中，将在 Azure 管理门户中启用 Azure AD 单一登录并在 Infor Retail - Information Management 应用程序中配置单一登录。

**若要配置 Infor Retail - Information Management 的 Azure AD 单一登录，请执行以下步骤：**

1. 在 Azure 管理门户的“Infor Retail - Information Management”应用程序集成页上，单击“单一登录”。
...
3. 在“Infor Retail - Information Management 域和 URL”部分，如果要在“IDP 发起的模式”下配置应用程序，请执行以下步骤：
...
4. 在“Infor Retail - Information Management 域和 URL”部分，如果要在“SP 发起的模式”下配置应用程序，请执行以下步骤：
    ...
    ![配置单一登录](./media/active-directory-saas-inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_03.png)
...
6. 在“创建新证书”对话框中，单击日历图标，然后选择“到期日期”。 然后单击“保存”按钮。
    ...
    ![配置单一登录](./media/active-directory-saas-inforretailinformationmanagement-tutorial/tutorial_general_300.png)

7. 在“SAML 签名证书”部分中，选择“激活新证书”，然后单击“保存”按钮。

    ![配置单一登录](./media/active-directory-saas-inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_05.png)
...
3. 在对话框顶部单击“添加”，打开“用户”对话框。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-inforretailinformationmanagement-tutorial/create_aaduser_03.png) 
...
在本部分中，通过授予 Britta Simon 访问 Infor Retail - Information Management 的权限，允许她使用 Azure 单一登录。

![分配用户][200] 

**若要将 Britta Simon 分配给 Infor Retail - Information Management，请执行以下步骤：**
...
2. 在应用程序列表中，选择“Infor Retail - Information Management”。
    ...
    ![配置单一登录](./media/active-directory-saas-inforretailinformationmanagement-tutorial/tutorial_inforretailinformationmanagement_50.png) 
