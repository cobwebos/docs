...
4. 在搜索框中，键入“Kiteworks”。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-kiteworks-tutorial/tutorial_kiteworks_search.png)

5. 在结果窗格中，选择“Kiteworks”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-kiteworks-tutorial/tutorial_kiteworks_addfromgallery.png)
...
3. **[创建 Kiteworks 测试用户](#creating-a-kiteworks-test-user)** - 在 Kiteworks 中创建 Britta Simon 的对应者，将其链接到该用户的 Azure AD 表示形式。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-kiteworks-tutorial/tutorial_kiteworks_samlbase.png)

3. 在“Kiteworks 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-kiteworks-tutorial/tutorial_kiteworks_url.png)
...
4. 在“SAML 签名证书”部分中，单击“证书(Base64)”，然后在计算机上保存证书文件。
    ...
    ![配置单一登录](./media/active-directory-saas-kiteworks-tutorial/tutorial_kiteworks_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录](./media/active-directory-saas-kiteworks-tutorial/tutorial_general_400.png)

6. 在“Kiteworks 配置”部分，单击“配置 Kiteworks”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![配置单一登录](./media/active-directory-saas-kiteworks-tutorial/tutorial_kiteworks_configure.png) 

7. 以管理员身份登录到 Kiteworks 公司站点。

8. 在顶部工具栏中，单击“设置”。
   
    ![配置单一登录](./media/active-directory-saas-kiteworks-tutorial/tutorial_kiteworks_06.png) 

9. 在“身份验证和授权”部分中，单击“SSO 设置”。 
...
10. 在“SSO 设置”页上，执行以下步骤：
    ...
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 选择“通过 SSO 进行身份验证”。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-kiteworks-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-kiteworks-tutorial/create_aaduser_02.png) 
...
2. 在应用程序列表中，选择“Kiteworks”。
    ...
    ![配置单一登录](./media/active-directory-saas-kiteworks-tutorial/tutorial_kiteworks_app.png) 
