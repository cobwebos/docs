...
在本部分中，会在 Azure 门户中启用 Azure AD 单一登录并在 Wingspan eTMF 应用程序中配置单一登录。
...
**要将 Britta Simon 分配到 Wingspan eTMF，请执行以下步骤：**
...
单击访问面板中的 Wingspan eTMF 磁贴，会被重定向到组织登录页面。 成功登录后，将登录到 Wingspan eTMF 应用程序。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://msdn.microsoft.com/library/dn308586)（访问面板简介）。
