...
现在可以通过 **Azure AD Graph** 使用这些属性：

我们可以通过 Azure AD Graph 资源管理器 ([https://graphexplorer.azurewebsites.net/](https://graphexplorer.azurewebsites.net/)) 查询 Azure AD Graph

![图形](./media/active-directory-aadconnectsync-feature-directory-extensions/extension4.png)

或通过 **Microsoft Graph API**：

我们可以通过 Microsoft Graph 资源管理器 ([https://developer.microsoft.com/zh-cn/graph/graph-explorer#](https://developer.microsoft.com/en-us/graph/graph-explorer#)) 查询 Microsoft Graph API

>[!NOTE]
> 你需要明确要求返回哪个属性。 为此，请按下面所示显式选择属性：https://graph.microsoft.com/beta/users/abbie.spencer@fabrikamonline.com?$select=extension_9d98ed114c4840d298fad781915f27e4_employeeID,extension_9d98ed114c4840d298fad781915f27e4_division 有关详细信息，请查看 [Microsoft Graph：使用查询参数](https://developer.microsoft.com/en-us/graph/docs/concepts/query_parameters#select-parameter)
