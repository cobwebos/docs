...
# 应用模型 v2.0 预览版：将登录凭据添加到 nodeJS Web 应用
...
- 此外，对于快速入门中的骨架项目，我们将使用预览版的 `passport-azure-ad`。
...
[在 node.js 中使用 v2.0 应用模型保护 Web API >>](/documentation/articles/active-directory-v2-devquickstarts-webapi-nodejs)

有关更多资源，请查看：
- [应用模型 v2.0 预览版 >>](active-directory-appmodel-v2-overview.md)
