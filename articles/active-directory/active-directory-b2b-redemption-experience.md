...
## <a name="social-id-user-first-time-redemption"></a>社交 ID 用户首次兑换
Azure AD B2B 协作可轻松地将任何电子邮件地址用于兑换。 请看一下将非 Microsoft 电子邮件地址用于 B2B 协作时的兑换体验。 此兑换流程更为复杂，因为可能需要在兑换时创建帐户。 在以下视频中一探究竟：
