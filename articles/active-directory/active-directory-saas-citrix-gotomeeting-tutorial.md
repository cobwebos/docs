...
3. **[创建 Citrix GoToMeeting 测试用户](#creating-a-citrix-gotomeeting-test-user)** - 在 Citrix GoToMeeting 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
3. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。
...
7. 单击“标识提供者”选项卡，并执行以下步骤：  
   
    ![SAML 设置](./media/active-directory-saas-citrix-gotomeeting-tutorial/IC6892321.png "SAML setup")
   
    a. 选择“手动”

    b. 在 Azure 门户中的“配置 Citrix GoToMeeting 的单一登录”对话框页上，复制“SAML 单一登录服务 URL”值，然后将其粘贴到“登录页 URL”文本框。 
