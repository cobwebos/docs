...
3. **[创建一个 Symantec Web 安全服务 (WSS) 测试用户](#create-a-symantec-web-security-service-wss-test-user)** -若要在 Symantec Web 安全服务 (WSS) 链接到用户的 Azure AD 表示具有 Britta 人 Simon 的副本。
