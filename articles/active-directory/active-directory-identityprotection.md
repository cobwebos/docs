...
Azure Active Directory Identity Protection 分析配置，并检测影响用户标识的漏洞。 有关详细信息，请参阅 [Azure Active Directory Identity Protection 检测到的漏洞](identity-protection/vulnerabilities.md)。
...
可以将调查活动绑定到 Azure Active Directory Protection 发送的每封电子邮件[通知](identity-protection/notifications.md)。
...
* [有风险的登录恢复](identity-protection/flows.md#risky-sign-in-recovery)
* [有风险的登录已阻止](identity-protection/flows.md#risky-sign-in-blocked)  
* [Azure AD Identity Protection 中的登录体验](identity-protection/flows.md)  
...
* [遭到入侵的帐户恢复流程](identity-protection/flows.md#compromised-account-recovery)。  
* [遭到入侵的帐户阻止流程](identity-protection/flows.md#compromised-account-blocked)。  
...
* [多重身份验证注册流程](identity-protection/flows.md#multi-factor-authentication-registration)。  
* [Azure AD Identity Protection 中的登录体验](identity-protection/flows.md)。  
...
* [启用 Azure Active Directory Identity Protection](identity-protection/enable.md)

* [Azure Active Directory Identity Protection 检测到的漏洞](identity-protection/vulnerabilities.md)
...
* [Azure Active Directory Identity Protection 演练手册](identity-protection/playbook.md)

* [Azure Active Directory Identity Protection 术语表](identity-protection/glossary.md)

* [Azure AD Identity Protection 中的登录体验](identity-protection/flows.md)

* [Azure Active Directory Identity Protection - 如何取消阻止用户](identity-protection/howto-unblock-user.md)

* [Azure Active Directory Identity Protection 和 Microsoft Graph 入门](identity-protection/graph-get-started.md)
