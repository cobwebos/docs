...
4. 在搜索框中，键入“Zendesk”，在结果面板中选择“Zendesk”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 Zendesk](./media/active-directory-saas-zendesk-tutorial/tutorial_zendesk_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-zendesk-tutorial/tutorial_zendesk_samlbase.png)

3. 在“Zendesk 域和 URL”部分中，执行以下步骤：

    ![Zendesk 域和 URL 单一登录信息](./media/active-directory-saas-zendesk-tutorial/tutorial_zendesk_url.png)
...
4. 在“SAML 签名证书”部分中，复制证书的“指纹”值。
    ...
    ![证书下载链接](./media/active-directory-saas-zendesk-tutorial/tutorial_zendesk_certificate.png)
...
5. Zendesk 需要特定格式的 SAML 断言。 没有强制的 SAML 属性，但可以按照以下步骤选择添加“用户属性”部分的属性： 
    ...
    ![配置单一登录 add](./media/active-directory-saas-zendesk-tutorial/tutorial_attribute_04.png)

    ![配置单一登录 addattb](./media/active-directory-saas-zendesk-tutorial/tutorial_attribute_05.png)
...
6. 单击“保存”按钮。
    ...
    ![配置单一登录“保存”按钮](./media/active-directory-saas-zendesk-tutorial/tutorial_general_400.png)

7. 在“Zendesk 配置”部分中，单击“配置 Zendesk”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL 和 SAML 单一登录服务 URL”。

    ![Zendesk 配置](./media/active-directory-saas-zendesk-tutorial/tutorial_zendesk_configure.png) 
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-zendesk-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-zendesk-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-zendesk-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/active-directory-saas-zendesk-tutorial/create_aaduser_04.png)
...
2. 在应用程序列表中，选择“Zendesk”。
    ...
    ![应用程序列表中的 Zendesk 链接](./media/active-directory-saas-zendesk-tutorial/tutorial_zendesk_app.png)  
