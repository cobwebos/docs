...
3. 在“Zendesk 域和 URL”部分中，执行以下步骤：
    ...
    b. 在“标识符”文本框中，使用以下模式键入值：`https://<subdomain>.zendesk.com`
...
4. 键入要预配的现有 Azure AD 帐户的电子邮件地址，并单击“保存”。
