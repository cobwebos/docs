...
4. 在搜索框中，键入“Lynda.com”。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-lynda-tutorial/tutorial_lynda.com_search.png)

5. 在结果面板中，选择“Lynda.com”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/active-directory-saas-lynda-tutorial/tutorial_lynda.com_addfromgallery.png)
...
3. **[创建 Lynda.com 测试用户](#creating-a-lyndacom-test-user)** -若要链接到用户的 Azure AD 表示的 Lynda.com 中具有 Britta 人 Simon 的副本。
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/active-directory-saas-lynda-tutorial/tutorial_lynda.com_samlbase.png)

3. 在“Lynda.com 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-lynda-tutorial/tutorial_lynda.com_url.png)

    在“登录 URL”文本框中，使用以下模式键入 URL：`https://<subdomain>.lynda.com/Shibboleth.sso/InCommon?providerId=<url>&target=<url> `

    > [!NOTE] 
    > 此值不是真实值。 请使用实际登录 URL 更新此值。 请联系 [Lynda.com 客户端支持团队](https://www.linkedin.com/help/lynda/ask)获取这些值。 
 
4. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存 XML 文件。

    ![配置单一登录](./media/active-directory-saas-lynda-tutorial/tutorial_lynda.com_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录](./media/active-directory-saas-lynda-tutorial/tutorial_general_400.png)
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/active-directory-saas-lynda-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/active-directory-saas-lynda-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-lynda-tutorial/create_aaduser_03.png) 

4. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/active-directory-saas-lynda-tutorial/create_aaduser_04.png) 
...
2. 在应用程序列表中，选择“Lynda.com”。
    ...
    ![配置单一登录](./media/active-directory-saas-lynda-tutorial/tutorial_lynda.com_app.png) 
