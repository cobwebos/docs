...
4. 在搜索框中，键入“XaitPorter”，在结果面板中选择“XaitPorter”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 XaitPorter](./media/active-directory-saas-xaitporter-tutorial/tutorial_xaitporter_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/active-directory-saas-xaitporter-tutorial/tutorial_xaitporter_samlbase.png)

3. 在“XaitPorter 域和 URL”部分中，执行以下步骤：

    ![XaitPorter 域和 URL 单一登录信息](./media/active-directory-saas-xaitporter-tutorial/tutorial_xaitporter_url.png)
...
8. 单击“管理”。
    ...
    ![配置单一登录](./media/active-directory-saas-xaitporter-tutorial/user1.png)

9. 从“系统设置”下拉列表中选择“管理单一登录”。

    ![配置单一登录](./media/active-directory-saas-xaitporter-tutorial/user2.png)

10. 在“管理单一登录”部分中执行以下步骤：

    ![配置单一登录](./media/active-directory-saas-xaitporter-tutorial/user3.png)
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/active-directory-saas-xaitporter-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/active-directory-saas-xaitporter-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/active-directory-saas-xaitporter-tutorial/create_aaduser_03.png)
...
2. 在应用程序列表中，选择“XaitPorter”。
    ...
    ![应用程序列表中的 XaitPorter 链接](./media/active-directory-saas-xaitporter-tutorial/tutorial_xaitporter_app.png)  
