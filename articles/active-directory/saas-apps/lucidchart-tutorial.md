...
1. [创建 Lucidchart 测试用户](#creating-a-lucidchart-test-user) - 在 Lucidchart 中创建 Britta Simon 的对应用户，该用户与 Azure AD 中表示 Britta Simon 的用户相关联。
...
1. 在“Lucidchart 域和 URL”部分中，执行以下步骤：
