...
1. 在搜索框中，键入“Communifire”，在结果面板中选择“Communifire”，然后单击“添加”按钮添加该应用程序。

    ![结果列表中的 Communifire](./media/communifire-tutorial/tutorial_communifire_addfromgallery.png)
...
1. **[创建 Communifire 测试用户](#create-a-communifire-test-user)** - 在 Communifire 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/communifire-tutorial/tutorial_communifire_samlbase.png)

1. 在“Communifire 域和 URL”部分中，如果要在“IDP”发起的模式下配置应用程序，请执行以下步骤：
...
1. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![证书下载链接](./media/communifire-tutorial/tutorial_communifire_certificate.png) 

1.  选中“显示高级证书签名设置”并选择“对 SAML 响应和断言进行签名”作为“签名选项”。

    ![证书选项](./media/communifire-tutorial/tutorial_communifire_certificateoption.png) 

1. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/communifire-tutorial/tutorial_general_400.png)
    
1. 若要在“Communifire”端配置单一登录，需要将下载的“元数据 XML”发送给 [Communifire 支持团队](https://my.axerosolutions.com/spaces/77/communifire-support/help/welcome)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/communifire-tutorial/create_aaduser_01.png)

1. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/communifire-tutorial/create_aaduser_02.png)

1. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/communifire-tutorial/create_aaduser_03.png)
...
1. 在应用程序列表中，选择“Communifire”。
    ...
    ![应用程序列表中的 Communifire 链接](./media/communifire-tutorial/tutorial_communifire_app.png)  
