...
1. [创建 Moxi Engage 测试用户](#creating-a-moxi-engage-test-user) - 在 Moxi Engage 中创建 Britta Simon 的对应用户，将其链接到该用户的 Azure AD 表示形式。
...
1. 在“Moxi Engage 域和 URL”部分中，执行以下步骤：
