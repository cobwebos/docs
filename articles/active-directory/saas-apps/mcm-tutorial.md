...
5. 在结果面板中，选择“MCM”，然后单击“添加”按钮添加该应用程序。
...
3. [创建 MCM 测试用户](#creating-a-mcm-test-user) - 在 MCM 中有一个与 Azure AD 中的 Britta Simon 相对应的关联用户。
...
6. 若要在 MCM 端配置单一登录，需要将下载的元数据 XML 发送给 [MCM 支持团队](http://mcmtechnology.com/support/)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
