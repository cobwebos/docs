...
1. [创建 TalentLMS 测试用户](#creating-a-talentlms-test-user) - 在 TalentLMS 中创建 Britta Simon 的对应用户，链接到用户的 Azure AD 表示形式。
...
1. 在“TalentLMS 域和 URL”部分中，执行以下步骤：
...
1. 在“TalentLMS 配置”部分中，单击“配置 TalentLMS”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。
