---
title: 教程：Azure Active Directory 单一登录 (SSO) 与 Web Cargo Air 的集成 | Microsoft Docs
description: 了解如何在 Azure Active Directory 和 Web Cargo Air 之间配置单一登录。
...
本教程介绍如何将 Web Cargo Air 与 Azure Active Directory (Azure AD) 集成。 将 Web Cargo Air 与 Azure AD 集成后，你可以：

* 在 Azure AD 中控制哪一用户有权访问 Web Cargo Air。
* 让用户能够使用其 Azure AD 帐户自动登录到 Web Cargo Air。
...
* 已启用 Web Cargo Air 单一登录 (SSO) 的订阅。
...
配置 Web Cargo Air 的 Azure AD SSO，并使用名为“B.Simon”的测试用户来对其进行测试。 若要使 SSO 正常工作，需要在 Azure AD 用户与 Web Cargo Air 中的相关用户之间建立链接关系。

若要配置并测试 Web Cargo Air 的 Azure AD SSO，请执行以下步骤：

1. **[配置 Azure AD SSO](#configure-azure-ad-sso)** - 使用户能够使用此功能。
    1. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 B. Simon 测试 Azure AD 单一登录。
    1. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 B. Simon 能够使用 Azure AD 单一登录。
1. [配置 Web Cargo Air SSO](#configure-web-cargo-air-sso) - 在应用程序端配置单一登录设置。
    1. [创建 Web Cargo Air 测试用户](#create-web-cargo-air-test-user) - 在 Web Cargo Air 中创建 B.Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
在本部分中，你将授予 B.Simon 访问 Web Cargo Air 的权限，以使其能够使用 Azure 单一登录。

1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”。  
1. 在应用程序列表中，选择“Web Cargo Air”。
...
## <a name="configure-web-cargo-air-sso"></a>配置 Web Cargo Air SSO

若要在 Web Cargo Air 端配置单一登录，需要将从 Azure 门户下载的“证书(base64)”以及复制的相应 URL 发送到 [Web Cargo Air 支持团队](mailto:support@webcargonet.com) 。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
