...
* 可让用户使用其 Azure AD 帐户自动登录到 Spacio（单一登录）。
...
4. 在搜索框中，键入“Spacio”，在结果面板中选择“Spacio”，然后单击“添加”按钮添加该应用程序。
     ...
     ![结果列表中的 Spacio](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分中，根据名为 Britta Simon 的测试用户使用 Spacio 配置和测试 Azure AD 单一登录。
若要运行单一登录，需要在 Azure AD 用户与 Spacio 相关用户之间建立链接关系。

若要配置和测试 Spacio 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 Spacio 单一登录](#configure-spacio-single-sign-on)** - 在应用程序端配置单一登录。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 Spacio 测试用户](#create-spacio-test-user)** - 在 Spacio 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在 [Azure 门户](https://portal.azure.com/)中的 Spacio 应用程序集成页上，选择“单一登录”。
...
### <a name="configure-spacio-single-sign-on"></a>配置 Spacio 单一登录

若要在 **Spacio** 端配置单一登录，需要将**应用联合元数据 URL** 发送给 [Spacio 支持团队](mailto:support@spac.io)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”和“Spacio”。

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在应用程序列表中，选择“Spacio”。

    ![应用程序列表中的 Spacio 链接](common/all-applications.png)
...
### <a name="create-spacio-test-user"></a>创建 Spacio 测试用户
...
单击“访问面板”中的 Spacio 磁贴时，应当会自动登录到为其设置了 SSO 的 Spacio。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
