...
* 可以让用户使用其 Azure AD 帐户自动登录到 ContractWorks（单一登录）。
...
4. 在搜索框中，键入“ContractWorks”，在结果面板中选择“ContractWorks”，然后单击“添加”按钮添加该应用程序。   
     ...
     ![结果列表中的 ContractWorks](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分中，将基于名为 **Britta Simon** 的测试用户配置和测试 ContractWorks 的 Azure AD 单一登录。
若要运行单一登录，需要在 Azure AD 用户与 ContractWorks 中相关用户之间建立链接关系。

若要配置和测试 ContractWorks 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 ContractWorks 单一登录](#configure-contractworks-single-sign-on)** - 在应用程序端配置单一登录。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 ContractWorks 测试用户](#create-contractworks-test-user)** - 在 ContractWorks 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
1. 在 [Azure 门户](https://portal.azure.com/)中，在 **ContractWorks** 应用程序集成页上，选择“单一登录”。 
...
4. 如果要在 **IDP** 发起的模式下配置应用程序，请在“基本 SAML 配置”部分执行以下步骤： 
    ...
    ![ContractWorks 域和 URL 单一登录信息](common/idp-identifier.png)
...
6. ContractWorks 应用程序需要采用特定格式的 SAML 断言。 请为此应用程序配置以下声明。 可以在应用程序集成页的“用户属性”部分管理这些属性的值。  在“使用 SAML 设置单一登录”  页上，单击“编辑”  按钮以打开“用户属性”  对话框。
...
### <a name="configure-contractworks-single-sign-on"></a>配置 ContractWorks 单一登录
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”和“ContractWorks”    。

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在应用程序列表中，选择“ContractWorks”。 

    ![应用程序列表中的 ContractWorks 链接](common/all-applications.png)
...
本部分在 ContractWorks 中创建名为 Britta Simon 的用户。 与  [ContractWorks 支持团队](mailto:support@contractworks.com)协作，在 ContractWorks 平台中添加用户。 使用单一登录前，必须先创建并激活用户。
