...
* 配置 Grok Learning 后，可以强制实施会话控制，从而实时保护组织的敏感数据免于外泄和渗透。 会话控制从条件访问扩展而来。 [了解如何通过 Microsoft Cloud App Security 强制实施会话控制](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app)。

## <a name="adding-grok-learning-from-the-gallery"></a>从库中添加 Grok Learning

若要配置 Grok Learning 与 Azure AD 的集成，需要从库中将 Grok Learning 添加到托管 SaaS 应用列表。
...
在访问面板中单击“Grok Learning”磁贴时，应会自动登录到设置了 SSO 的 Grok Learning。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
