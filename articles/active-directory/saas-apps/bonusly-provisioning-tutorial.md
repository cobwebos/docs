...
3. 若要添加 Bonusly，请单击对话框顶部的“新建应用程序”按钮。

    ![“新增应用程序”按钮][3]

4. 在搜索框中，键入“Bonusly”。

    ![Bonusly 预配](./media/bonusly-provisioning-tutorial/AppSearch.png)

5. 在结果面板中，选择“Bonusly”，然后单击“添加”按钮将 Bonusly 添加到 SaaS 应用程序列表。

    ![Bonusly 预配](./media/bonusly-provisioning-tutorial/AppSearchResults.png)

    ![Bonusly 预配](./media/bonusly-provisioning-tutorial/AppCreation.png)
...
2. 从 SaaS 应用程序列表中选择 Bonusly。
 
    ![Bonusly 预配](./media/bonusly-provisioning-tutorial/AppInstanceSearch.png)
