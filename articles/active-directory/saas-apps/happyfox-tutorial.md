...
1. 在搜索框中，键入“HappyFox”。
    ...
    ![创建 Azure AD 测试用户](./media/happyfox-tutorial/tutorial_happyfox_search.png)

1. 在结果窗格中，选择“HappyFox”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/happyfox-tutorial/tutorial_happyfox_addfromgallery.png)
...
1. [创建 HappyFox 测试用户](#creating-a-happyfox-test-user) - 在 HappyFox 中创建 Britta Simon 的对应用户，将其链接到该用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/happyfox-tutorial/tutorial_happyfox_samlbase.png)

1. 在“HappyFox 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/happyfox-tutorial/tutorial_happyfox_url.png)
...
1. 在“SAML 签名证书”部分中，单击“证书(Base64)”，然后在计算机上保存证书文件。
    ...
    ![配置单一登录](./media/happyfox-tutorial/tutorial_happyfox_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录](./media/happyfox-tutorial/tutorial_general_400.png)

1. 在“HappyFox 配置”部分中，单击“配置 HappyFox”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 单一登录服务 URL”。

    ![配置单一登录](./media/happyfox-tutorial/tutorial_happyfox_configure.png) 

1. 登录到 HappyFox 员工门户并导航到“管理”，然后单击“集成”选项卡。

    ![配置单一登录](./media/happyfox-tutorial/header.png) 

1. 在集成选项卡中，单击“SAML 集成”下的“配置”以打开单一登录设置。

    ![配置单一登录](./media/happyfox-tutorial/configure.png) 

1. 在 SAML 配置部分，将从 Azure 门户复制的 SAML 单一登录服务 URL 粘贴到“SSO 目标 URL”文本框。

    ![配置单一登录](./media/happyfox-tutorial/targeturl.png)

1. 打开从 Azure 门户下载的证书，并将其内容粘贴到 IdP Signature 部分。
 
    ![配置单一登录](./media/happyfox-tutorial/cert.png)

1. 单击“保存设置”按钮。

    ![配置单一登录](./media/happyfox-tutorial/savesettings.png)
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/happyfox-tutorial/create_aaduser_01.png) 

1. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/happyfox-tutorial/create_aaduser_02.png) 

1. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/happyfox-tutorial/create_aaduser_03.png) 

1. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/happyfox-tutorial/create_aaduser_04.png) 
...
1. 在应用程序列表中，选择“HappyFox”。

    ![配置单一登录](./media/happyfox-tutorial/tutorial_happyfox_app.png) 
...
1. 单击访问面板中的 HappyFox 磁贴时，应显示 HappyFox 应用程序的登录页。 应该在登录页上显示“SAML”按钮。
    ...
    ![插件](./media/happyfox-tutorial/saml.png) 

1. 单击“SAML”按钮，使用 Azure AD 帐户登录到 HappyFox。
