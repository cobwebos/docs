...
3. 若要添加 Cisco Spark，请单击对话框顶部的“新建应用程序”按钮。

    ![“新增应用程序”按钮][3]

4. 在搜索框中，键入“Cisco Spark”。

    ![Cisco Spark 预配](./media/cisco-spark-provisioning-tutorial/AppSearch.png)

5. 在结果面板中，选择“Cisco Spark”，然后单击“添加”按钮将 Cisco Spark 添加到 SaaS 应用程序列表。

    ![Cisco Spark 预配](./media/cisco-spark-provisioning-tutorial/AppSearchResults.png)

    ![Cisco Spark 预配](./media/cisco-spark-provisioning-tutorial/AppCreation.png)
...
2. 从 SaaS 应用程序列表中选择 Cisco Spark。

    ![Cisco Spark 预配](./media/cisco-spark-provisioning-tutorial/Successcenter2.png)
