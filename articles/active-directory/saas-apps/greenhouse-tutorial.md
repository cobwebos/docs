...
1. 在搜索框中，键入“Greenhouse”，在结果面板中选择“Greenhouse”，然后单击“添加”按钮添加应用程序。

    ![结果列表中的 Greenhouse](./media/greenhouse-tutorial/tutorial_greenhouse_addfromgallery.png)
...
1. [创建 Greenhouse 测试用户](#create-a-greenhouse-test-user) - 在 Greenhouse 中创建 Britta Simon 的对应用户，并将其关联到用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/greenhouse-tutorial/tutorial_greenhouse_samlbase.png)

1. 在“Greenhouse 域和 URL”部分中，执行以下步骤：
...
1. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![证书下载链接](./media/greenhouse-tutorial/tutorial_greenhouse_certificate.png) 
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/greenhouse-tutorial/create_aaduser_01.png)

1. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/greenhouse-tutorial/create_aaduser_02.png)

1. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/greenhouse-tutorial/create_aaduser_03.png)
...
1. 在顶部菜单中，单击“配置”，并单击“用户”。
   
   ![用户](./media/greenhouse-tutorial/ic790791.png "用户")

1. 单击“新建用户”。
   
   ![新建用户](./media/greenhouse-tutorial/ic790792.png "New User")
...
1. 在应用程序列表中，选择“Greenhouse”。
    ...
    ![应用程序列表中的 Greenhouse 链接](./media/greenhouse-tutorial/tutorial_greenhouse_app.png)  
