...
1. 在搜索框中，键入“Nomadic”，在结果面板中选择“Nomadic”，然后单击“添加”按钮添加应用程序。
...
1. **[创建 Nomadic 测试用户](#create-a-nomadic-test-user)** - 在 Nomadic 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1.  若要为应用程序配置 SSO，请联系 [Nomadic 支持团队](mailto:help@nomadic.fm)，并向他们提供下载的**元数据**。
