...
4. 在搜索框中，键入 ADP Globalview。
    ...
    ![创建 Azure AD 测试用户](./media/adglobalview-tutorial/tutorial_adpglobalview_search.png)

5. 在”结果”窗格中，选择“ADP Globalview”，然后单击“添加”按钮，添加该应用程序。

    ![创建 Azure AD 测试用户](./media/adglobalview-tutorial/tutorial_adpglobalview_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/adglobalview-tutorial/tutorial_adpglobalview_samlbase.png)

3. 在“ADP Globalview 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/adglobalview-tutorial/tutorial_adpglobalview_url.png)
...
4. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。
    ...
    ![配置单一登录](./media/adglobalview-tutorial/tutorial_adpglobalview_certificate.png) 
...
6. 以下屏幕截图显示了一个示例。 声明名称始终是“PersonImmutableID”和映射到包含用户 EmployeeID 的 ExtensionAttribute2 的值。 在此将用户从 Azure AD 映射到 ADP GlobalView 是在 EmployeeID 上完成的，但可将其映射到同样基于应用程序设置的其他值。 首先可与 ADP GlobalView 团队合作，使用用户的正确标识符，并将该值与 **“PersonImmutableID”** 声明一起映射。 也可映射电子邮件和 UserID 声明，如图中所示。
    ...
    ![配置单一登录](./media/adglobalview-tutorial/tutorial_adpglobalview_attribute.png)
...
7. 在“单一登录”对话框的“用户属性”部分，按图中所示配置 SAML 令牌属性，然后执行以下步骤：
    ...
    ![配置单一登录](./media/adglobalview-tutorial/tutorial_attribute_04.png)

    ![配置单一登录](./media/adglobalview-tutorial/tutorial_attribute_05.png)
...
8. 在“ADP Globalview 配置”部分，单击“配置 ADP Globalview”，以打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。
    ...
    ![配置单一登录](./media/adglobalview-tutorial/tutorial_adpglobalview_configure.png) 

9. 单击“保存”按钮。

    ![配置单一登录](./media/adglobalview-tutorial/tutorial_general_400.png)
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/adglobalview-tutorial/create_aaduser_01.png) 

2.  若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/adglobalview-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/adglobalview-tutorial/create_aaduser_03.png) 

4. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/adglobalview-tutorial/create_aaduser_04.png) 
...
2. 在“应用程序列表”中，选择“ADP Globalview”。
    ...
    ![配置单一登录](./media/adglobalview-tutorial/tutorial_adpglobalview_app.png) 
