...
4. 在搜索框中，键入“Absorb LMS”，在结果面板中选择“Absorb LMS”，然后选择“添加”按钮。
    ...
    ![结果列表中的 Absorb LMS](./media/absorblms-tutorial/tutorial_absorblms_addfromgallery.png)
...
2. 在“单一登录”对话框中的“模式”框内，选择“基于 SAML 的登录”，启用单一登录。
    ...
    ![“单一登录”对话框](./media/absorblms-tutorial/tutorial_absorblms_samlbase.png)
...
4. 在“SAML 签名证书”部分中的“下载”列中，选择“元数据 XML”，并将元数据文件保存到计算机上。
    ...
    ![签名证书下载链接](./media/absorblms-tutorial/tutorial_absorblms_certificate.png) 

5. 选择“保存”。

    ![配置单一登录“保存”按钮](./media/absorblms-tutorial/tutorial_general_400.png)
    
6. 在“Absorb LMS 配置”部分中，选择“配置 Absorb LMS”打开“配置登录”窗口，然后在“快速参考部分”中复制“注销 URL”。

    ![“Absorb LMS 配置”窗格](./media/absorblms-tutorial/tutorial_absorblms_configure.png) 
...
10. 选择“用户”选项卡。
    ...
    ![“用户”选项卡](./media/absorblms-tutorial/3.png)
...
12. 将“仅允许 SSO 登录”切换为“启用”。
    ...
    ![“仅允许 SSO 登录”切换](./media/absorblms-tutorial/5.png)
...
1. 在 Azure 门户的左窗格中，选择“Azure Active Directory”。
    ...
    ![“Azure Active Directory”按钮](./media/absorblms-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请选择“用户和组” > “所有用户”。
    
    ![“用户和组”以及“所有用户”链接](./media/absorblms-tutorial/create_aaduser_02.png) 

3. 在对话框顶部，选择“添加”。
 
    ![“添加”按钮](./media/absorblms-tutorial/create_aaduser_03.png) 
...
2. 在左窗格中，选择“用户”。
    ...
    ![“Absorb LMS 用户”链接](./media/absorblms-tutorial/absorblms_users.png)
...
2. 在“应用程序”列表中，选择“Absorb LMS”。
    ...
    ![应用程序列表中的 Absorb LMS 链接](./media/absorblms-tutorial/tutorial_absorblms_app.png) 
