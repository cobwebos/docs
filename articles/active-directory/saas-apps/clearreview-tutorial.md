...
3. **[创建 Clear Review 测试用户](#create-a-clear-review-test-user)** - 在 Clear Review 中创建 Britta Simon 的对应用户，将其链接到该用户的 Azure AD 表示形式。
...
3. 在“Clear Review 域和 URL”部分中，如果要在 **IdP 发起的**模式下配置应用程序，请执行以下步骤：
