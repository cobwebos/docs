...
3. [创建 GaggleAMP 测试用户](#creating-a-gaggleamp-test-user) - 在 GaggleAMP 中创建 Britta Simon 的对应用户，将其链接到用户的 Azure AD 表示形式。
