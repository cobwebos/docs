...
* 可让用户使用其 Azure AD 帐户自动登录到 JDA Cloud（单一登录）。
...
* JDA Cloud 支持启用了 **SP 和 IDP** 的 SSO
...
2. **[配置 JDA Cloud 单一登录](#configure-jda-cloud-single-sign-on)** - 在应用程序端配置单一登录设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 JDA Cloud 测试用户](#create-jda-cloud-test-user)** - 在 JDA Cloud 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
4. 如果要在 **IDP** 发起的模式下配置应用程序，请在“基本 SAML 配置”部分执行以下步骤：
    ...
    ![JDA Cloud 域和 URL 单一登录信息](common/idp-intiated.png)
...
5. 如果要在 SP 发起的模式下配置应用程序，请单击“设置其他 URL”，并执行以下步骤：
    ...
    ![JDA Cloud 域和 URL 单一登录信息](common/metadata-upload-additional-signon.png)
...
### <a name="configure-jda-cloud-single-sign-on"></a>配置 JDA Cloud 单一登录

要在“JDA Cloud”端配置单一登录，需要将下载的“联合元数据 XML”以及从 Azure 门户复制的相应 URL 发送给 [JDA Cloud 支持团队](https://support.jda.com/)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
### <a name="create-jda-cloud-test-user"></a>创建 JDA Cloud 测试用户
...
在访问面板中单击“JDA Cloud”磁贴时，应会自动登录到设置了 SSO 的 JDA Cloud。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
