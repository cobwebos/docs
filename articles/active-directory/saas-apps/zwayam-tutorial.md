...
1. 在搜索框中，键入“Zwayam”，在结果面板中选择“Zwayam”，然后单击“添加”按钮以添加该应用程序。

    ![结果列表中的 Zwayam](./media/zwayam-tutorial/tutorial_Zwayam_addfromgallery.png)
...
1. **[创建 Zwayam 测试用户](#create-a-zwayam-test-user)** - 在 Zwayam 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/zwayam-tutorial/tutorial_Zwayam_samlbase.png)

1. 在“Zwayam 域和 URL”部分中，执行以下步骤：

    ![Zwayam 域和 URL 单一登录信息](./media/zwayam-tutorial/tutorial_Zwayam_url.png)
...
1. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![证书下载链接](./media/zwayam-tutorial/tutorial_Zwayam_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/zwayam-tutorial/tutorial_general_400.png)

1. 在“Zwayam 配置”部分中，单击“配置 Zwayam”以打开“配置登录”窗口。 在“快速参考”部分复制“SAML 实体 ID”，然后将“SAML 实体 ID”值粘贴到“Zwayam 域和 URL”部分的“登录 URL”文本框中。

    ![Zwayam 配置](./media/zwayam-tutorial/tutorial_Zwayam_configure.png) 
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/zwayam-tutorial/create_aaduser_01.png)

1. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/zwayam-tutorial/create_aaduser_02.png)

1. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/zwayam-tutorial/create_aaduser_03.png)

1. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/zwayam-tutorial/create_aaduser_04.png)
...
1. 在应用程序列表中，选择“Zwayam”。

    ![应用程序列表中的 Zwayam 链接](./media/zwayam-tutorial/tutorial_Zwayam_app.png)  
