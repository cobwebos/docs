---
title: 教程：Azure Active Directory 与 ZephyrSSO 集成 | Microsoft Docs
...
本部分需在 ZephyrSSO 中创建名为“Britta Simon”的用户。 请与  [ZephyrSSO 支持团队](https://support.getzephyr.com/)协作，将用户添加到 ZephyrSSO 平台中。 使用单一登录前，必须先创建并激活用户。

### <a name="test-single-sign-on"></a>测试单一登录 

在本部分中，使用访问面板测试 Azure AD 单一登录配置。

单击访问面板中的 ZephyrSSO 磁贴时，应当会自动登录到为其设置了 SSO 的 ZephyrSSO。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
