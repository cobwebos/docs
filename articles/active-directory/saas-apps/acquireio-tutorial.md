---
title: 教程：Azure Active Directory 与 AcquireIO 的集成 | Microsoft Docs
...
ms.locfileid: "67544558"
---
# <a name="tutorial-integrate-acquireio-with-azure-active-directory"></a>教程：Azure Active Directory 与 AcquireIO 的集成
...
本教程在测试环境中配置并测试 Azure AD SSO。 AcquireIO 支持 **IDP** 发起的 SSO。
...
2. **[配置 AcquireIO](#configure-acquireio)** ，以在应用程序端配置 SSO 设置。
...
5. **[创建 AcquireIO 测试用户](#create-acquireio-test-user)** ，在 AcquireIO 中创建 B.Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
