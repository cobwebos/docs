...
3. **[创建 UserVoice 测试用户](#create-a-uservoice-test-user)** - 在 UserVoice 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
3. 在“UserVoice 域和 URL”部分中，执行以下步骤：
...
6. 在“UserVoice 配置”部分，单击“配置 UserVoice”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL 和 SAML 单一登录服务 URL”。

    ![UserVoice 配置](./media/uservoice-tutorial/tutorial_uservoice_configure.png) 

7. 在其他 Web 浏览器窗口中，以管理员身份登录到 UserVoice 公司站点。

8. 在顶部工具栏中，单击“设置”，并从菜单中选择“Web 门户”。
   
    ![应用端上的“设置”部分](./media/uservoice-tutorial/ic777519.png "设置")

9. 在“Web 门户”选项卡的“用户身份验证”部分中，单击“编辑”以打开“编辑用户身份验证”对话框页
   
    ![Web 门户选项卡](./media/uservoice-tutorial/ic777520.png "Web 门户")

10. 在“编辑用户身份验证”对话框页上，执行以下步骤：
