...
1. 在搜索框中，键入“Front”，在结果面板中选择“Front”，然后单击“添加”按钮添加该应用程序。

    ![结果列表中的 Front](./media/front-tutorial/tutorial_front_addfromgallery.png)
...
1. **[创建 Front 测试用户](#create-a-front-test-user)** - 在 Front 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/front-tutorial/tutorial_front_samlbase.png)

1. 在“Front 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/front-tutorial/tutorial_front_url1.png)
...
1. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。
    ...
    ![配置单一登录](./media/front-tutorial/tutorial_front_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录](./media/front-tutorial/tutorial_general_400.png)
    
1. 在“Front 配置”部分中，单击“配置 Front”以打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![配置单一登录](./media/front-tutorial/tutorial_front_configure.png) 

1. 以管理员身份登录到 Front 租户。

1. 转到“设置(左侧边栏底部的齿轮图标) > 首选项”。
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/front-tutorial/create_aaduser_01.png)

1. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/front-tutorial/create_aaduser_02.png)

1. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/front-tutorial/create_aaduser_03.png)

1. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/front-tutorial/create_aaduser_04.png)
...
在本部分中，将在 Front 中创建一个名为 Britta Simon 的用户。 请与  [Front 客户端支持团队](mailto:support@frontapp.com) 协作，将用户添加到 Front 平台中。 使用单一登录前，必须先创建并激活用户。
...
1. 在应用程序列表中，选择“Front”。
    ...
    ![应用程序列表中的 Front 链接](./media/front-tutorial/tutorial_front_app.png)  
