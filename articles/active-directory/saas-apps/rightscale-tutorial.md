...
1. [创建 RightScale 测试用户](#creating-a-rightscale-test-user) - 在 RightScale 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 身份。
...
1. 在“RightScale 域和 URL”部分，如果要在“IDP 发起的模式”下配置应用程序，无需执行任何步骤，因为应用已与 Azure 进行预集成。

    ![配置单一登录](./media/rightscale-tutorial/tutorial_rightscale_url.png)

1. 在“RightScale 域和 URL”部分中，如果要在“SP 发起的模式”下配置应用程序，请执行以下步骤：
