...
4. 如果要在 **IDP** 发起的模式下配置应用程序，请在“基本 SAML 配置”部分中执行以下步骤：
    ...
    ![&frankly 域和 URL 单一登录信息](common/idp-intiated.png)
...
5. 如果要在 SP 发起的模式下配置应用程序，请单击“设置其他 URL”，并执行以下步骤：
    ...
    ![&frankly 域和 URL 单一登录信息](common/metadata-upload-additional-signon.png)
...
单击访问面板中的 &frankly 磁贴时，应当会自动登录到为其设置了 SSO 的 &frankly。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
