...
4. 在搜索框中，键入“&frankly”。
    ...
    ![创建 Azure AD 测试用户](./media/andfrankly-tutorial/tutorial_andfrankly_search.png)

5. 在“结果”窗格中，选择“&frankly”，再单击“添加”按钮，添加该应用程序。

    ![创建 Azure AD 测试用户](./media/andfrankly-tutorial/tutorial_andfrankly_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录
在本部分中，根据名为“Britta Simon”的测试用户的指示配置和测试 &frankly 的 Azure AD 单一登录。

若要使用单一登录，Azure AD 需要知道与 Azure AD 用户相对应的 &frankly 用户。 换句话说，需要建立 Azure AD 用户与 &frankly 中相关用户之间的关联关系。

可通过将 Azure AD 中“用户名”的值指定为 &frankly 中“用户名”的值来建立此链接关系。
...
在本部分中，在 Azure 门户中启用 Azure AD 单一登录，并在 &frankly 应用程序中配置单一登录。

**若要配置 &frankly 的 Azure AD 单一登录，请执行以下步骤：**

1. 在 Azure 门户中的“&frankly”应用程序集成页上，单击“单一登录”。

    ![配置单一登录][4]

2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
 
    ![配置单一登录](./media/andfrankly-tutorial/tutorial_andfrankly_samlbase.png)

3. 在“&frankly 域和 URL”部分中，如果要在 IDP 启动的模式下配置应用程序，请执行以下步骤：

    ![配置单一登录](./media/andfrankly-tutorial/tutorial_andfrankly_url.png)
...
4. 选中“显示高级 URL 设置”。 如果要在“SP”发起的模式下配置应用程序：
    ...
    ![配置单一登录](./media/andfrankly-tutorial/tutorial_andfrankly_url1.png)
...
5. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![配置单一登录](./media/andfrankly-tutorial/tutorial_andfrankly_certificate.png) 

6. 单击“保存”按钮。

    ![配置单一登录](./media/andfrankly-tutorial/tutorial_general_400.png)

7. 若要在“&frankly”端配置单一登录，需要将下载的元数据 XML 发送给 [andfrankly 支持团队](mailto:help@andfrankly.com)。 
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/andfrankly-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/andfrankly-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/andfrankly-tutorial/create_aaduser_03.png) 

4. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/andfrankly-tutorial/create_aaduser_04.png) 
...
2. 在应用程序列表中，选择“&frankly”。
    ...
    ![配置单一登录](./media/andfrankly-tutorial/tutorial_andfrankly_app.png) 
