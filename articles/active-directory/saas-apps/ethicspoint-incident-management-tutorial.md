...
1. 在搜索框中，键入“EthicsPoint Incident Management (EPIM)”。

    ![创建 Azure AD 测试用户](./media/ethicspoint-incident-management-tutorial/tutorial_ethicspoint_search.png)

1. 在结果面板中，选择“EthicsPoint Incident Management (EPIM)”，然后单击“添加”添加应用程序。
...
1. **[创建 EthicsPoint Incident Management (EPIM) 测试用户](#creating-a-ethicspoint-incident-management-epim-test-user)** - 在 EthicsPoint Incident Management (EPIM) 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在“EthicsPoint Incident Management (EPIM) 域和 URL”部分中，执行以下步骤：
...
1. 在应用程序列表中，选择“EthicsPoint Incident Management (EPIM)”。
