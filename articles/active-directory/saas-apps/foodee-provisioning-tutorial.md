...
本文介绍如何配置 Foodee 中的 Azure Active Directory (Azure AD) Azure AD，以及如何将用户或组自动预配或取消预配到 Foodee。
...
使用 Azure AD 配置 Foodee 以实现自动用户预配之前，需要在 Foodee 中启用 (SCIM) 设置的系统进行跨域标识管理。
