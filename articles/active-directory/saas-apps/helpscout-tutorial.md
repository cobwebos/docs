...
4. 在搜索框中，键入“Help Scout”，在结果面板中选择“Help Scout”，然后单击“添加”按钮添加该应用程序。
     ...
     ![结果列表中的 Help Scout](common/search-new-app.png)
...
2. **[配置 Help Scout 单一登录](#configure-help-scout-single-sign-on)** - 在应用程序端配置“单一登录”设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 Help Scout 测试用户](#create-help-scout-test-user)** - 在 Help Scout 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
7. 在“设置 Help Scout”部分中，根据要求复制相应 URL。
...
### <a name="configure-help-scout-single-sign-on"></a>配置 Help Scout 单一登录

1. 在另一个 Web 浏览器窗口中，以管理员身份登录 Help Scout 公司站点。

2. 在顶部菜单中单击“管理”，并从下拉菜单中选择“公司”。
...
在本部分，我们将在 Help Scout 中创建一个名为 Britta Simon 的用户。 Help Scout 支持默认启用的恰时用户预配。 此部分不存在任何操作项。 如果 Help Scout 中尚不存在用户，身份验证后会创建一个新用户。
