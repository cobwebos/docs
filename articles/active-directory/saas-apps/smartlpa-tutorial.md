...
- 可以让用户使用其 Azure AD 帐户自动登录到 SmartLPA（单一登录）。
...
4. 在搜索框中，键入“SmartLPA”，在结果面板中选择“SmartLPA”，然后单击“添加”按钮添加应用程序。
    ...
    ![结果列表中的 SmartLPA](./media/smartlpa-tutorial/tutorial_smartlpa_addfromgallery.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分中，基于一个名为“Britta Simon”的测试用户使用 SmartLPA 配置和测试 Azure AD 单一登录。

若要运行单一登录，Azure AD 需要知道与 Azure AD 用户相对应的 SmartLPA 用户。 换句话说，需要建立 Azure AD 用户与 SmartLPA 中相关用户之间的链接关系。

若要配置和测试 SmartLPA 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
3. [创建 SmartLPA 测试用户](#create-a-smartlpa-test-user) - 在 SmartLPA 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[测试单一登录](#test-single-sign-on)** - 验证配置是否正常工作。

### <a name="configure-azure-ad-single-sign-on"></a>配置 Azure AD 单一登录

在本部分中，将在 Azure 门户中启用 Azure AD 单一登录并在 SmartLPA 应用程序中配置单一登录。

**若要配置 SmartLPA 的 Azure AD 单一登录，请执行以下步骤：**

1. 在 Azure 门户中，在 SmartLPA 应用程序集成页上，单击“单一登录”。

    ![配置单一登录链接][4]

2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
 
    ![“单一登录”对话框](./media/smartlpa-tutorial/tutorial_smartlpa_samlbase.png)

3. 在“SmartLPA 域和 URL”部分中，执行以下步骤：
    ...
    > [!NOTE] 
    > 这些不是实际值。 必须使用实际登录 URL 和标识符更新这些值。 请联系 [SmartLPA 客户端支持团队](mailto:support@smartlpa.com)获取这些值。

4. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。

    ![证书下载链接](./media/smartlpa-tutorial/tutorial_smartlpa_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/smartlpa-tutorial/tutorial_general_400.png)

6. 在“SmartLPA 配置”部分中，单击“配置 SmartLPA”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![SmartLPA 配置](./media/smartlpa-tutorial/tutorial_smartlpa_configure.png) 

7. 若要在 SmartLPA 端配置单一登录，需要将下载的证书 (Base64)、注销 URL、SAML 实体 ID 和 SAML 单一登录服务 URL 发送给 [SmartLPA 支持团队](mailto:support@smartlpa.com)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/smartlpa-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/smartlpa-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/smartlpa-tutorial/create_aaduser_03.png)
...
**若要将 Britta Simon 分配到 SmartLPA，请执行以下步骤：**
...
2. 在应用程序列表中，选择“SmartLPA”。
    ...
    ![应用程序列表中的 SmartLPA 链接](./media/smartlpa-tutorial/tutorial_smartlpa_app.png)  
