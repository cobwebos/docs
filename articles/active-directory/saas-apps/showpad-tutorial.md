...
ms.date: 07/12/2017
ms.author: jeedes
ms.openlocfilehash: 41246717758493257abdce82d34f84c93fd76222
ms.sourcegitcommit: d3200828266321847643f06c65a0698c4d6234da
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 01/29/2019
ms.locfileid: "55167540"
---
...
在本部分中，将基于一个名为“Britta Simon”的测试用户配置并测试 Showpad 的 Azure AD 单一登录。

为使单一登录能正常工作，Azure AD 需要知道与 Azure AD 用户相对应的 Showpad 用户。 换句话说，需要在 Azure AD 用户与 Showpad 中相关用户之间建立链接关系。

可通过将 Azure AD 中“用户名”的值指定为 Showpad 中“用户名”的值来建立此关联关系。
...
在本部分中，将在 Azure 门户中启用 Azure AD 单一登录并在 Showpad 应用程序中配置单一登录。

**若要配置 Showpad 的 Azure AD 单一登录，请执行以下步骤：**

1. 在 Azure 门户中的 Showpad 应用程序集成页上，单击“单一登录”。
...
1. 在“Showpad 域和 URL”部分中，执行以下步骤：
    ...
    > [!NOTE] 
    > 这些不是实际值。 必须使用实际登录 URL 和标识符更新这些值。 请联系 [Showpad 支持团队](https://help.showpad.com)获取这些值。 
...
Showpad 支持实时预配。 已在**[配置 Azure AD 单一登录](#configuring-azure-ad-single-sign-on)** 中启用预配。 
