...
* 可以让用户使用其 Azure AD 帐户自动登录到 4me（单一登录）。
...
若要使单一登录有效，需要在 Azure AD 用户与 4me 相关用户之间建立链接关系。

若要配置和测试 4me 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 4me 单一登录](#configure-4me-single-sign-on)** - 在应用程序端配置单一登录设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 4me 测试用户](#create-4me-test-user)** - 在 4me 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在 [Azure 门户](https://portal.azure.com/)中的 4me 应用程序集成页上，选择“单一登录”。
...
4. 在“基本 SAML 配置”部分中，按照以下步骤操作：
    ...
    ![4me 域和 URL 单一登录信息](common/sp-identifier.png)
...
5. 4me 应用程序需要特定格式的 SAML 断言。 请为此应用程序配置以下声明。 可以在应用程序集成页的“用户属性”部分管理这些属性的值。 在“使用 SAML 设置单一登录”页上，单击“编辑”按钮以打开“用户属性”对话框。
...
### <a name="configure-4me-single-sign-on"></a>配置 4me 单一登录

1. 在另一个 Web 浏览器窗口中，以管理员身份登录到 4me。

2. 在左上角，单击“设置”徽标，然后单击左侧栏中的“单一登录”。
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”和“4me”。
...
单击访问面板中的 4me 磁贴时，应当会自动登录到已为其设置了 SSO 的 4me。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
