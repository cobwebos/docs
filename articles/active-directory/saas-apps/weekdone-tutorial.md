...
4. 在搜索框中，键入“Weekdone”。
    ...
    ![创建 Azure AD 测试用户](./media/weekdone-tutorial/tutorial_weekdone_search.png)

5. 在结果面板中，选择“Weekdone”，并单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/weekdone-tutorial/tutorial_weekdone_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录
在本部分中，基于一个名为“Britta Simon”的测试用户使用 Weekdone 配置和测试 Azure AD 单一登录。

为使单一登录能正常工作，Azure AD 需要知道与 Azure AD 用户相对应的 Weekdone 用户。 换句话说，需要建立 Azure AD 用户与 Weekdone 中相关用户之间的链接关系。

若要配置和测试 Weekdone 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configuring-azure-ad-single-sign-on)** - 让用户使用此功能。
2. **[创建 Azure AD 测试用户](#creating-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
3. **[创建 Weekdone 测试用户](#creating-a-weekdone-test-user)** - 在 Weekdone 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
4. **[分配 Azure AD 测试用户](#assigning-the-azure-ad-test-user)** - 让 Britta Simon 使用 Azure AD 单一登录。
5. **[测试单一登录](#testing-single-sign-on)** - 验证配置是否正常工作。

### <a name="configuring-azure-ad-single-sign-on"></a>配置 Azure AD 单一登录

在本部分中，将介绍如何在 Azure 门户中启用 Azure AD 单一登录并在 Weekdone 应用程序中配置单一登录。

**若要配置 Weekdone 的 Azure AD 单一登录，请执行以下步骤：**

1. 在 Azure 门户中，在 **Weekdone** 应用程序集成页上，单击“单一登录”。

    ![配置单一登录][4]

2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
 
    ![配置单一登录](./media/weekdone-tutorial/tutorial_weekdone_samlbase.png)

3. 在“Weekdone 域和 URL”部分中，如果要在“IDP 发起的模式”下配置应用程序，请执行以下步骤：

    ![配置单一登录](./media/weekdone-tutorial/tutorial_weekdone_url1.png)
...
5. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。
    ...
    ![配置单一登录](./media/weekdone-tutorial/tutorial_weekdone_certificate.png) 

6. 单击“保存”按钮。

    ![配置单一登录](./media/weekdone-tutorial/tutorial_general_400.png)
    
7. 在“Weekdone 配置”部分上，单击“配置 Weekdone”，打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![配置单一登录](./media/weekdone-tutorial/tutorial_weekdone_configure.png) 

8. 若要在 **Weekdone** 端配置单一登录，需要将下载的**元数据 XML、注销 URL、SAML 实体 ID 和 SAML 单一登录服务 URL** 发送给 [Weekdone 支持团队](mailto:hello@weekdone.com)。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/weekdone-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/weekdone-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/weekdone-tutorial/create_aaduser_03.png) 

4. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/weekdone-tutorial/create_aaduser_04.png) 
...
此部分不存在任何操作项。 如果尚不存在用户，则在尝试访问 Weekdone 期间会创建一个新用户。
...
**要将 Britta Simon 分配到 Weekdone，请执行以下步骤：**
...
2. 在应用程序列表中，选择“Weekdone”。
    ...
    ![配置单一登录](./media/weekdone-tutorial/tutorial_weekdone_app.png) 
