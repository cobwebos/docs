...
1. 在结果面板中，选择“Direct”，然后单击“添加”按钮添加该应用程序。
...
1. **[创建 Direct 测试用户](#creating-a-direct-test-user)** - 在 Direct 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在“Direct 域和 URL”部分，如果要在“IDP 发起的模式”下配置应用程序，请执行以下步骤：
...
1. 若要在 Direct 端配置单一登录，需要将下载的元数据 XML 发送给 [Direct 支持团队](https://direct4b.com/ja/support.html#inquiry)。 
