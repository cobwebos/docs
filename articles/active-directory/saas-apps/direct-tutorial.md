...
4. 在搜索框中，键入“direct”。 在结果窗格中，选择“direct”，然后选择“添加”按钮添加该应用程序。
...
若要使单一登录正常工作，Azure AD 需要知道与 Azure AD 用户相对应的 direct 用户。 换句话说，需要建立 Azure AD 用户与 direct 中相关用户之间的链接关系。
