...
1. 在“搜索框”中，键入“ZScaler One”。

    ![创建 Azure AD 测试用户](./media/zscaler-one-tutorial/tutorial_zscalerone_search.png)

1. 在结果面板中，选择“Zscaler One”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/zscaler-one-tutorial/tutorial_zscalerone_addfromgallery.png)
...
1. **[创建 Zscaler One 测试用户](#creating-a-zscaler-one-test-user)** - 在 Zscaler One 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/zscaler-one-tutorial/tutorial_zscalerone_samlbase.png)

1. 在“Zscaler One 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/zscaler-one-tutorial/tutorial_zscalerone_url.png)
...
1. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。
    ...
    ![配置单一登录](./media/zscaler-one-tutorial/tutorial_zscalerone_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录](./media/zscaler-one-tutorial/tutorial_general_400.png)

1. 在“Zscaler One 配置”部分中，单击“配置 Zscaler One”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 单一登录服务 URL”

    ![配置单一登录](./media/zscaler-one-tutorial/tutorial_zscalerone_configure.png) 

1. 在另一 Web 浏览器窗口中，以管理员身份登录 Zscaler One 公司站点。
...
1. 在“管理管理员和角色”下，单击“管理用户和身份验证”。   
    ...
    ![管理用户和身份验证](./media/zscaler-one-tutorial/ic800207.png "管理用户和身份验证")

1. 在“选择组织的身份验证选项”部分中，执行以下步骤：   
                
    ![身份验证](./media/zscaler-one-tutorial/ic800208.png "身份验证")
...
1. 在“配置 SAML 单一登录参数”对话框页上，执行以下步骤，然后单击“完成”
    ...
    ![单一登录](./media/zscaler-one-tutorial/ic800209.png "单一登录")
...
1. 在“配置用户身份验证”对话框页上，执行以下步骤：
    ...
    ![管理](./media/zscaler-one-tutorial/ic800210.png "Administration")
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/zscaler-one-tutorial/create_aaduser_01.png) 

1. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/zscaler-one-tutorial/create_aaduser_02.png) 

1. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/zscaler-one-tutorial/create_aaduser_03.png) 

1. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/zscaler-one-tutorial/create_aaduser_04.png) 
...
1. 单击“管理”。   
    ...
    ![管理](./media/zscaler-one-tutorial/ic781035.png "Administration")

1. 单击“用户管理”。   
        
     ![添加](./media/zscaler-one-tutorial/ic781036.png "Add")

1. 在“用户”选项卡上，单击“添加”。
      
    ![添加](./media/zscaler-one-tutorial/ic781037.png "Add")

1. 在“添加用户”部分中，执行以下步骤：
        
    ![添加用户](./media/zscaler-one-tutorial/ic781038.png "添加用户")
