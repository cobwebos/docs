...
* Kantega SSO for Bitbucket 支持启用了 **SP 和 IDP** 的 SSO
...
4. 在搜索框中键入“Kantega SSO for Bitbucket”，从结果面板中选择“Kantega SSO for Bitbucket”，然后单击“添加”按钮添加该应用程序    。

    ![结果列表中的 Kantega SSO for Bitbucket](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分中，将基于名为“Britta Simon”的测试用户配置和测试 Kantega SSO for Bitbucket 的 Azure AD 单一登录  。
若要运行单一登录，需要在 Azure AD 用户与 Kantega SSO for Bitbucket 中相关用户之间建立链接关系。

若要配置并测试 Kantega SSO for Bitbucket 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 Kantega SSO for Bitbucket 单一登录](#configure-kantega-sso-for-bitbucket-single-sign-on)** - 在应用程序端配置单一登录设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 Kantega SSO for Bitbucket 测试用户](#create-kantega-sso-for-bitbucket-test-user)** - 在 Kantega SSO for Bitbucket 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 身份。
...
1. 在 [Azure 门户](https://portal.azure.com/)中的“Kantega SSO for Bitbucket”应用程序集成页上，选择“单一登录”   。
...
7. 在“设置 Kantega SSO for Bitbucket”部分中，根据要求复制相应的 URL  。
...
### <a name="configure-kantega-sso-for-bitbucket-single-sign-on"></a>配置 Kantega SSO for Bitbucket 单一登录

1. 在另一个 Web 浏览器窗口中，以管理员身份登录到 Bitbucket 管理门户。

1. 单击齿轮，然后单击“查找新加载项”  。

    ![配置单一登录](./media/kantegassoforbitbucket-tutorial/addon1.png)

1. 搜索“Kantega SSO for Bitbucket SAML & Kerberos”  ，然后单击“安装”  按钮安装新的 SAML 插件。
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”、“Kantega SSO for Bitbucket”    。

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在应用程序列表中，选择“Kantega SSO for Bitbucket”  。

    ![应用程序列表中的 Kantega SSO for Bitbucket 链接](common/all-applications.png)
...
### <a name="create-kantega-sso-for-bitbucket-test-user"></a>创建 Kantega SSO for Bitbucket 测试用户

为了使 Azure AD 用户登录到 Bitbucket，必须将其预配到 Bitbucket。 对于 Kantega SSO for Bitbucket，需要手动完成预配任务。

**若要预配用户帐户，请执行以下步骤：**

1. 以管理员身份登录 Bitbucket 公司网站。
...
单击访问面板中的 Kantega SSO for Bitbucket 磁贴时，应当会自动登录到你为其设置了 SSO 的 Kantega SSO for Bitbucket。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
