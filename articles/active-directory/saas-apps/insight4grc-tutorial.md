...
若要运行单一登录，需要在 Azure AD 用户与 Insight4GRC 中相关用户之间建立链接关系。
...
5. **[创建 Insight4GRC 测试用户](#create-insight4grc-test-user)** - 在 Insight4GRC 中创建与 Britta Simon 对等的用户，并将其与 Azure AD 用户相关联。
