...
* 已启用 Predictix Assortment Planning 单一登录的订阅
...
**若要从库中添加 Predictix Assortment Planning，请执行以下步骤：**
...
4. 在搜索框中，键入“Predictix Assortment Planning”，从结果面板中选择“Predictix Assortment Planning”，然后单击“添加”按钮添加该应用程序。
     ...
     ![结果列表中的 Predictix Assortment Planning](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分，我们基于名为 **Britta Simon** 的测试用户来配置并测试 Predictix Assortment Planning 的 Azure AD 单一登录。
若要正常使用单一登录，需要在 Azure AD 用户与 Predictix Assortment Planning 相关用户之间建立链接关系。

要使用 Predictix Assortment Planning 配置和测试 Azure AD 单一登录，需完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 Predictix Assortment Planning 单一登录](#configure-predictix-assortment-planning-single-sign-on)** - 在应用程序端配置单一登录设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 Predictix Assortment Planning 测试用户](#create-predictix-assortment-planning-test-user)** - 在 Predictix Assortment Planning 中创建 Britta Simon 的对应用户，并将其关联到其在 Azure AD 中的表示形式。
...
4. 在“基本 SAML 配置”部分中，按照以下步骤操作：
    ...
    ![Predictix Assortment Planning 域和 URL 单一登录信息](common/sp-identifier.png)
    ...
    > [!NOTE]
    > 这些不是实际值。 使用实际登录 URL 和标识符更新这些值。 请联系 [Predictix Assortment Planning 客户端支持团队](https://www.infor.com/support)获取这些值。 还可以参考 Azure 门户中的“基本 SAML 配置”部分中显示的模式。
...
若要在 **Predictix Assortment Planning** 端配置单一登录，需要将下载的“证书(Base64)”以及从 Azure 门户复制的相应 URL 发送给 [Predictix Assortment Planning 支持团队](https://www.infor.com/support)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”、“Predictix Assortment Planning”。

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在应用程序列表中，选择“Predictix Assortment Planning”。

    ![应用程序列表中的 Predictix Assortment Planning 链接](common/all-applications.png)
...
### <a name="create-predictix-assortment-planning-test-user"></a>创建 Predictix Assortment Planning 测试用户

本部分需在 Predictix Assortment Planning 中创建名为“Britta Simon”的用户。 在  [Predictix Assortment Planning 支持团队](https://www.infor.com/support)的配合下，将用户添加到 Predictix Assortment Planning 平台。 使用单一登录前，必须先创建并激活用户。
...
在访问面板中单击“Predictix Assortment Planning”磁贴时，应会自动登录到设置了 SSO 的 Predictix Assortment Planning。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
