...
3. **[创建 FreshGrade 测试用户](#creating-a-freshgrade-test-user)** - 在 FreshGrade 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
