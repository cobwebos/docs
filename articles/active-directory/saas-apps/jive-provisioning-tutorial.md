...
1. 在“管理员凭据”**** 部分中，提供以下配置设置：
    ...
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 在 **“Jive 管理员用户名”** 文本框中，键入在 Jive.com 中分配有**系统管理员**配置文件的 Jive 帐户名称。
   
    b.保留“数据库类型”设置，即设置为“共享”。 在 **“Jive 管理员密码”** 文本框中，键入该帐户的密码。
