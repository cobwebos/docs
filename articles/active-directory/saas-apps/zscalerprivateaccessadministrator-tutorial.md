...
1. 在搜索框中键入 **Zscaler Private Access Administrator**，从结果面板中选择“Zscaler Private Access Administrator”，然后单击“添加”按钮以添加该应用程序。

    ![结果列表中的 Zscaler Private Access Administrator](./media/zscalerprivateaccessadministrator-tutorial/tutorial_zscalerprivateaccessadministrator_addfromgallery.png)
...
1. **[创建 Zscaler Private Access Administrator 测试用户](#create-a-zscaler-private-access-administrator-test-user)** - 在 Zscaler Private Access Administrator 中创建 Britta Simon 的对应用户，并将其链接到她的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/zscalerprivateaccessadministrator-tutorial/tutorial_zscalerprivateaccessadministrator_samlbase.png)

1. 在“Zscaler Private Access Administrator 域和 URL”部分，如果希望在“IDP”启动模式下配置应用程序：
...
1. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![证书下载链接](./media/zscalerprivateaccessadministrator-tutorial/tutorial_zscalerprivateaccessadministrator_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/zscalerprivateaccessadministrator-tutorial/tutorial_general_400.png)

1. 在另一个 Web 浏览器窗口中，以管理员身份登录 Zscaler Private AccessAdministrator 公司站点。

1. 在顶部单击“管理”，导航到“身份验证”部分，单击“IdP 配置”。
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/zscalerprivateaccessadministrator-tutorial/create_aaduser_01.png)

1. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/zscalerprivateaccessadministrator-tutorial/create_aaduser_02.png)

1. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/zscalerprivateaccessadministrator-tutorial/create_aaduser_03.png)
...
1. 在菜单左侧单击“管理员”。
    ...
    ![Zscaler Private Access Administrator 管理员](./media/zscalerprivateaccessadministrator-tutorial/tutorial_zscalerprivateaccessadministrator_adminstrator.png)

1. 在右上角，单击“添加管理员”。

    ![Zscaler Private Access Administrator 添加管理员](./media/zscalerprivateaccessadministrator-tutorial/tutorial_zscalerprivateaccessadministrator_addadmin.png)
...
1. 在应用程序列表中，选择“Zscaler Private Access Administrator”。
    ...
    ![应用程序列表中的“Zscaler Private Access Administrator”链接](./media/zscalerprivateaccessadministrator-tutorial/tutorial_zscalerprivateaccessadministrator_app.png)  
