...
3. [创建 Projectplace 测试用户](#creating-a-projectplace-test-user) - 在 Projectplace 中创建 Britta Simon 的对应用户，将其链接到该用户的 Azure AD 表示形式。
...
3. 在“Projectplace 域和 URL”部分中，执行以下步骤：
...
4. 在“添加成员”部分执行以下步骤：
    ...
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，并单击“添加引用”。 在“新建成员”文本框中，键入要在相关文本框中预配的有效 AAD 帐户的电子邮件地址。
