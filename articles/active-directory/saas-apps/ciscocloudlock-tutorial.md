...
1. 在搜索框中，键入“Cloud Security Fabric”，从结果面板中选择“Cloud Security Fabric”，然后单击“添加”按钮添加该应用程序。
...
1. **[创建 Cloud Security Fabric 测试用户](#create-a-the-cloud-security-fabric-test-user)** - 在 Cloud Security Fabric 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在“Cloud Security Fabric 域和 URL”部分中，执行以下步骤：
...
1. 若要在“Cloud Security Fabric”端配置单一登录，需要将下载的元数据 XML 发送给 [Cloud Security Fabric 支持团队](mailto:support@cloudlock.com)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
