...
4. 在搜索框中，键入 **10,000ft Plans**。
    ...
    ![创建 Azure AD 测试用户](./media/10000ftplans-tutorial/tutorial_10,000ftplans_search.png)

5. 在结果面板中选择“10,000ft Plans”，并单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/10000ftplans-tutorial/tutorial_10,000ftplans_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/10000ftplans-tutorial/tutorial_10,000ftplans_samlbase.png)

3. 在“10,000ft Plans 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/10000ftplans-tutorial/tutorial_10,000ftplans_url.png)
...
4. 在“SAML 签名证书”部分中，单击“证书(原始)”，并在计算机上保存证书文件。
    ...
    ![配置单一登录](./media/10000ftplans-tutorial/tutorial_10,000ftplans_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录](./media/10000ftplans-tutorial/tutorial_general_400.png)

6. 在“10,000ft Plans 配置”部分中，单击“配置 10,000ft Plans”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![配置单一登录](./media/10000ftplans-tutorial/tutorial_10,000ftplans_configure.png) 
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/10000ftplans-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/10000ftplans-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/10000ftplans-tutorial/create_aaduser_03.png) 

4. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/10000ftplans-tutorial/create_aaduser_04.png) 
...
2. 在应用程序列表中，选择“10,000ft Plans”。
    ...
    ![配置单一登录](./media/10000ftplans-tutorial/tutorial_10,000ftplans_app.png) 
