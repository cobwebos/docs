...
4. 在搜索框中键入“Kiteworks”，在结果面板中选择“Kiteworks”，然后单击“添加”按钮添加该应用程序    。

     ![结果列表中的 Kiteworks](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分中，将基于名为“Britta Simon”的测试用户配置和测试 Kiteworks 的 Azure AD 单一登录  。
若要正常使用单一登录，需要在 Azure AD 用户与 Kiteworks 相关用户之间建立链接关系。

若要配置和测试 Kiteworks 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 Kiteworks 单一登录](#configure-kiteworks-single-sign-on)** - 在应用程序端配置单一登录。
...
1. 在 [Azure 门户](https://portal.azure.com/)中的 Kiteworks 应用程序集成页上，选择“单一登录”   。
...
4. 在“基本 SAML 配置”  部分中，按照以下步骤操作：
    ...
    ![Kiteworks 域和 URL 单一登录信息](common/sp-identifier.png)

    a. 在“登录 URL”文本框中，使用以下模式键入 URL：`https://<subdomain>.kiteworks.com` 

    b. 在“标识符(实体 ID)”文本框中，使用以下模式键入 URL：`https://<subdomain>.kiteworks.com/sp/module.php/saml/sp/saml2-acs.php/sp-sso` 
...
6. 在“设置 Kiteworks”部分中，根据要求复制相应的 URL  。
...
### <a name="configure-kiteworks-single-sign-on"></a>配置 Kiteworks 单一登录
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”和“Kiteworks”    。

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在应用程序列表中，选择“Kiteworks”  。

    ![应用程序列表中的 Kiteworks 链接](common/all-applications.png)
