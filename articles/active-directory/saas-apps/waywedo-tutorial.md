...
4. 在搜索框中，键入“Way We Do”，在结果面板中选择“Way We Do”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 Way We Do](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分，我们基于名为 **Britta Simon** 的测试用户来配置并测试 Way We Do 的 Azure AD 单一登录。
若要正常使用单一登录，需要在 Azure AD 用户与 Way We Do 相关用户之间建立链接关系。

若要配置和测试 Way We Do 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 Way We Do 单一登录](#configure-way-we-do-single-sign-on)** - 在应用程序端配置单一登录设置。
...
1. 在 [Azure 门户](https://portal.azure.com/)中的“Way We Do”应用程序集成页上，选择“单一登录”。
...
6. 在“设置 Way We Do”部分，根据要求复制相应的 URL。
...
### <a name="configure-way-we-do-single-sign-on"></a>配置 Way We Do 单一登录

1. 在另一个 Web 浏览器窗口中，以安全管理员身份登录到 Way We Do。

2. 在 Way We Do 任意页面的右上角，单击“人员图标”，然后在下拉菜单中单击“帐户”。

    ![Way We Do 帐户](./media/waywedo-tutorial/tutorial_waywedo_account.png) 

3. 单击“菜单图标”，打开推送导航菜单，然后单击“单一登录”。
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”、“Way We Do”。

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在应用程序列表中，选择“Way We Do”。

    ![应用程序列表中的 Way We Do 链接](common/all-applications.png)
...
在访问面板中单击“Way We Do”磁贴时，应会自动登录到设置了 SSO 的 Way We Do。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
