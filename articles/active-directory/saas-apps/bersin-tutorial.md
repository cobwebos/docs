...
若要在 Bersin端配置单一登录，需要将下载的“联合元数据 XML”以及从 Azure 门户复制的相应 URL 发送给 [Bersin 支持团队](mailto:ramansabde@gmail.com)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
