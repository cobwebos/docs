...
3. [创建 InsideView 测试用户](#creating-a-insideview-test-user) - 在 InsideView 中创建 Britta Simon 的对应用户，将其链接到该用户的 Azure AD 表示形式。
...
3. 在“InsideView 域和 URL”部分中，执行以下步骤：
...
6. 在“InsideView 配置”部分中，单击“配置 InsideView”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 单一登录服务 URL”

    ![配置单一登录](./media/insideview-tutorial/tutorial_insideview_configure.png) 

7. 在另一个 Web 浏览器窗口中，以管理员身份登录到 InsideView 公司站点。

8. 在顶部工具栏中，依次单击“管理”、“单一登录设置”、“添加 SAML”。
   
   ![SAML 单一登录设置](./media/insideview-tutorial/ic794135.png "SAML Single Sign On Settings")

9. 在“添加新 SAML”部分中，执行以下步骤：
