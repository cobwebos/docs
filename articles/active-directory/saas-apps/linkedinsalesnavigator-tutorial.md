...
3. **[创建 LinkedIn Sales Navigator 测试用户](#creating-a-linkedin-sales-navigator-test-user)** - 在 LinkedIn Sales Navigator 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
