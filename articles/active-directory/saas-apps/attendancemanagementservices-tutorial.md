...
1. 在搜索框中，键入“Attendance Management Services”，从结果面板中选择“Attendance Management Services”，然后单击“添加”按钮添加该应用程序。

    ![结果列表上的 Attendance Management Services](./media/attendancemanagementservices-tutorial/tutorial_attendancemanagementservices_addfromgallery.png)
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/attendancemanagementservices-tutorial/tutorial_attendancemanagementservices_samlbase.png)

1. 在“Attendance Management Services 域和 URL”部分，执行以下步骤：
    ...
    > [!NOTE]
    > 这些不是实际值。 必须使用实际登录 URL 和标识符更新这些值。 请联系 [Attendance Management Services 客户支持团队](https://www.obcnet.jp/)来获取这些值。

1. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。

    ![证书下载链接](./media/attendancemanagementservices-tutorial/tutorial_attendancemanagementservices_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/attendancemanagementservices-tutorial/tutorial_general_400.png)

1. 在“Attendance Management Services 配置”部分，单击“配置 Attendance Management Services”，打开“配置单一登录”窗口。 从“快速参考”部分中复制“SAML 实体 ID 和 SAML 单一登录服务 URL”。

    ![Attendance Management Services 配置](./media/attendancemanagementservices-tutorial/tutorial_attendancemanagementservices_configure.png) 
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/attendancemanagementservices-tutorial/create_aaduser_01.png)

1. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/attendancemanagementservices-tutorial/create_aaduser_02.png)

1. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/attendancemanagementservices-tutorial/create_aaduser_03.png)
...
1. 在“OBCiD 信息”部分执行以下步骤：
    ...
    a. 在中**OBCiD**文本框中，键入用户电子邮件，例如**BrittaSimon\@contoso.com**。
...
1. 在应用程序列表中，选择“Attendance Management Services”。

    ![应用程序列表中的 Attendance Management Services 链接](./media/attendancemanagementservices-tutorial/tutorial_attendancemanagementservices_app.png)  
