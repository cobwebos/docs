...
1. 在搜索框中，键入“LoginRadius”，在结果面板中选择“LoginRadius”，然后单击“添加”按钮添加该应用程序。

    ![结果列表中的 LoginRadius](./media/lr-tutorial/tutorial_LoginRadius_addfromgallery.png)
...
1. **[创建 LoginRadius 测试用户](#create-a-loginradius-test-user)** - 在 LoginRadius 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/lr-tutorial/tutorial_LoginRadius_samlbase.png)

1. 在“LoginRadius 域和 URL”部分中，执行以下步骤：

    ![LoginRadius 域和 URL 单一登录信息](./media/lr-tutorial/tutorial_LoginRadius_url.png)
...
1. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![证书下载链接](./media/lr-tutorial/tutorial_LoginRadius_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/lr-tutorial/tutorial_general_400.png)
    
1. 若要在 LoginRadius 端配置单一登录，需将下载的元数据 XML 发送给 [LoginRadius 支持团队](mailto:support@loginradius.com)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/lr-tutorial/create_aaduser_01.png)

1. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/lr-tutorial/create_aaduser_02.png)

1. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/lr-tutorial/create_aaduser_03.png)

1. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/lr-tutorial/create_aaduser_04.png)
...
本部分将在 LoginRadius 中创建名为“Britta Simon”的用户。 与  [LoginRadius 支持团队](mailto:support@loginradius.com) 协作，将用户添加到 LoginRadius 平台中。 使用单一登录前，必须先创建并激活用户。 
...
1. 在应用程序列表中，选择“LoginRadius”。
    ...
    ![应用程序列表中的 LoginRadius 链接](./media/lr-tutorial/tutorial_LoginRadius_app.png)  
