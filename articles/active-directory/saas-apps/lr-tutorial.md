...
4. 在“基本 SAML 配置”  部分中，按照以下步骤操作：
    ...
    b. 在“标识符(实体 ID)”文本框中，键入 URL：`https://LoginRadius.hub.loginradius.com/`
...
若要在 LoginRadius 端配置单一登录，需要将下载的元数据 XML 以及从 Azure 门户复制的相应 URL 发送给 [ 支持团队](mailto:support@loginradius.com)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
单击访问面板中的 LoginRadius 磁贴时，应当会自动登录到为其设置了 SSO 的 LoginRadius。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
