...
1. **[创建 Lynda.com 测试用户](#creating-a-lyndacom-test-user)** - 在 Lynda.com 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在“Lynda.com 域和 URL”部分中，执行以下步骤：
...
1. 若要在 Lynda.com 端配置单一登录，需要将下载的元数据 XML 发送给 [Lynda.com 支持团队](https://www.linkedin.com/help/lynda/ask)。
...
如果要测试单一登录设置，请打开访问面板。 有关访问面板的详细信息，请参阅 [访问面板简介](../user-help/active-directory-saas-access-panel-introduction.md)。 
