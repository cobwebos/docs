...
* 可让用户使用其 Azure AD 帐户自动登录到 Lynda.com（单一登录）。
...
### <a name="configure-lyndacom-single-sign-on"></a>配置 Lynda.com 单一登录
...
单击访问面板中的 Lynda.com 磁贴时，应会自动登录到为其设置了 SSO 的 Lynda.com。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
