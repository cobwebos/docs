---
title: 教程：Azure Active Directory 单一登录 (SSO) 与 Taskize Connect 集成 | Microsoft Docs
...
## <a name="configure-and-test-azure-ad-single-sign-on-for-taskize-connect"></a>配置并测试 Taskize Connect 的 Azure AD 单一登录

使用名为 B.Simon 的测试用户配置并测试 Taskize Connect 的 Azure AD SSO  。 要使 SSO 正常工作，需要在 Azure AD 用户与 Taskize Connect 相关用户之间建立链接关系。

要配置和测试 Taskize Connect 的 Azure AD SSO，请完成以下构建基块：
...
1. 在 [Azure 门户](https://portal.azure.com/)的 Taskize Connect 应用程序集成页面上，找到“管理”部分，选择“单一登录”    。
...
在访问面板中单击 Taskize Connect 磁贴时，应该会自动登录到设置了 SSO 的 Taskize Connect。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
...
- [尝试 Taskize Connect 与 Azure AD 集成](https://aad.portal.azure.com/)
