...
1. 在搜索框中，键入“SAML SSO for Confluence by resolution GmbH”。

    ![创建 Azure AD 测试用户](./media/samlssoconfluence-tutorial/tutorial_samlssoconfluence_search.png)

1. 在结果窗格中，选择“SAML SSO for Confluence by resolution GmbH”，并单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/samlssoconfluence-tutorial/tutorial_samlssoconfluence_addfromgallery.png)
...
1. **[创建 SAML SSO for Confluence by resolution GmbH 测试用户](#creating-a-saml-sso-for-confluence-by-resolution-gmbh-test-user)** - 在 SAML SSO for Confluence by resolution GmbH 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/samlssoconfluence-tutorial/tutorial_samlssoconfluence_samlbase.png)

1. 在“SAML SSO for Confluence by resolution GmbH 域和 URL”部分中，如果要在“IDP 启动的模式”下配置应用程序，请执行以下步骤：

    ![配置单一登录](./media/samlssoconfluence-tutorial/tutorial_samlssoconfluence_url_1.png)
...
1. 选中“显示高级 URL 设置”。 如果要在“SP”发起的模式下配置应用程序：
    ...
    ![配置单一登录](./media/samlssoconfluence-tutorial/tutorial_samlssoconfluence_url_2.png)
...
1. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![配置单一登录](./media/samlssoconfluence-tutorial/tutorial_samlssoconfluence_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录](./media/samlssoconfluence-tutorial/tutorial_general_400.png)    
...
1. 搜索“SAML Single Sign On (SSO) for Confluence”，并单击“安装”按钮安装新的 SAML 插件。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/samlssoconfluence-tutorial/create_aaduser_01.png) 

1. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/samlssoconfluence-tutorial/create_aaduser_02.png) 

1. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/samlssoconfluence-tutorial/create_aaduser_03.png) 

1. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/samlssoconfluence-tutorial/create_aaduser_04.png) 
...
1. 在应用程序列表中，选择“SAML SSO for Confluence by resolution GmbH”。
    ...
    ![配置单一登录](./media/samlssoconfluence-tutorial/tutorial_samlssoconfluence_app.png) 
