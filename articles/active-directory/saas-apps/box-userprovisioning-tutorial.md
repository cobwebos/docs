...
6. 在“登录以授予对 Box 的访问权限”页上，提供所需的凭据，然后单击“授权”。 
    ...
    ![启用自动用户预配](./media/box-userprovisioning-tutorial/IC769546.png "启用自动用户设置")

7. 单击“授予对 Box 的访问权限”对此操作授权，然后返回到 Azure 门户。 
   
    ![启用自动用户预配](./media/box-userprovisioning-tutorial/IC769549.png "启用自动用户设置")
...
![集成状态](./media/box-userprovisioning-tutorial/IC769556.png "集成状态")
