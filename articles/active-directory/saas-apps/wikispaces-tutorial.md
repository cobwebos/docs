---
title: 教程：Azure Active Directory 与 Wikispaces 集成 | Microsoft Docs
...
4. 在搜索框中键入 **Wikispaces**，在结果面板中选择“Wikispaces”，然后单击“添加”按钮添加该应用程序。

     ![结果列表中的“Wikispaces”](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分，我们基于名为 **Britta Simon** 的测试用户来配置并测试 Wikispaces 的 Azure AD 单一登录。
若要正常使用单一登录，需要在 Azure AD 用户与 Wikispaces 相关用户之间建立链接关系。

若要配置和测试 Wikispaces 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 Wikispaces 单一登录](#configure-wikispaces-single-sign-on)** - 在应用程序端配置单一登录设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 Wikispaces 测试用户](#create-wikispaces-test-user)** - 在 Wikispaces 中创建 Britta Simon 的对应用户，并将其关联到其在 Azure AD 中的表示形式。
...
1. 在 [Azure 门户](https://portal.azure.com/)中的“Wikispaces”应用程序集成页上，选择“单一登录”。
...
6. 在“设置 Wikispaces”部分，根据要求复制相应的 URL。
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”、“Wikispaces”。

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在应用程序列表中，选择“Wikispaces”。

    ![“应用程序”列表中的“Wikispaces”链接](common/all-applications.png)
