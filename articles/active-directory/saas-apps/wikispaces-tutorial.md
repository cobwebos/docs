...
1. [创建 Wikispaces 测试用户](#creating-a-wikispaces-test-user) - 在 Wikispaces 中创建 Britta Simon 的对应用户，将其链接到用户的 Azure AD 表示形式。
...
1. 在“Wikispaces 域和 URL”部分中，执行以下步骤：
...
1. 若要在 Wikispaces 端配置单一登录，需要将下载的元数据 XML 发送给 [Wikispaces 支持团队](https://www.wikispaces.com/site/help)。 配置完成后，会立即收到通知。
