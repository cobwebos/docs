...
1. 在搜索框中，键入“Vidyard”，在结果面板中选择“Vidyard”，然后单击“添加”按钮添加该应用程序。
...
1. **[创建 Vidyard 测试用户](#create-a-vidyard-test-user)** - 在 Vidyard 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
1. 在“Vidyard 域和 URL”部分中，如果要在 **IDP** 发起的模式下配置应用程序，请执行以下步骤：
...
1. 从“单一登录”选项卡中，选择某个现有配置文件旁边的“分配”
...
1. 选择你的组织组，它显示在“可分配的组”中。

    ![Vidyard 配置](./media/vidyard-tutorial/configure5.png)

1. 可以在“当前分配的组”下看到已分配的组。 根据你的组织为组选择一个角色，然后单击“确认”。
