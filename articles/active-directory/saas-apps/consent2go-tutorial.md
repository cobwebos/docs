...
ms.openlocfilehash: 197ceaf38a0a17e9ec876b3bd50abe0475736262
ms.sourcegitcommit: 301128ea7d883d432720c64238b0d28ebe9aed59
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/13/2019
ms.locfileid: "56164402"
---
...
* 可以让用户使用其 Azure AD 帐户自动登录到 Consent2Go（单一登录）。
...
2. **[配置 Consent2Go 单一登录](#configure-consent2go-single-sign-on)** - 在应用程序端配置单一登录设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 Consent2Go 测试用户](#create-consent2go-test-user)** - 在 Consent2Go 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
### <a name="create-consent2go-test-user"></a>创建 Consent2Go 测试用户
...
单击访问面板中的 Consent2Go 磁贴时，应会自动登录到为其设置了 SSO 的 Consent2Go。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
