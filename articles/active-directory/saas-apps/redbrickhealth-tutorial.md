...
1. 在搜索框中，键入“RedBrick Health”，在结果面板中选择“RedBrick Health”，然后单击“添加”按钮添加该应用程序。

    ![结果列表中的 RedBrick Health](./media/redbrickhealth-tutorial/tutorial_redbrickhealth_addfromgallery.png)
...
1. **[创建 RedBrick Health 测试用户](#create-a-redbrick-health-test-user)** - 在 RedBrick Health 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/redbrickhealth-tutorial/tutorial_redbrickhealth_samlbase.png)

1. 在“RedBrick Health 域和 URL”部分中，执行以下步骤：
    ...
    ![RedBrick Health 域和 URL 单一登录信息](./media/redbrickhealth-tutorial/tutorial_redbrickhealth_url1.png)
...
1. RedBrick Health 应用程序需要特定格式的 SAML 断言，这要求向 SAML 令牌属性配置添加自定义属性映射。 这些声明是客户特定的，并取决于你的要求。 以下可选的声明只是你可以为应用程序配置的示例。 可以在应用程序集成页的“用户属性”部分管理这些属性的值。

    ![配置单一登录](./media/redbrickhealth-tutorial/attribute.png)
...
1. 在“单一登录”对话框的“用户属性”部分中，按上图所示配置 SAML 令牌属性，并执行以下步骤：
    ...
    ![配置单一登录](./media/redbrickhealth-tutorial/tutorial_attribute_05.png)
...
1. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。
    ...
    ![证书下载链接](./media/redbrickhealth-tutorial/tutorial_redbrickhealth_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/redbrickhealth-tutorial/tutorial_general_400.png)

1. 在“RedBrick Health 配置”部分中，单击“配置 RedBrick Health”以打开“配置登录”窗口。 从“快速参考”部分复制“SAML 实体 ID”。

    ![RedBrick Health 配置](./media/redbrickhealth-tutorial/tutorial_redbrickhealth_configure.png) 
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/redbrickhealth-tutorial/create_aaduser_01.png)

1. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/redbrickhealth-tutorial/create_aaduser_02.png)

1. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/redbrickhealth-tutorial/create_aaduser_03.png)
...
1. 在应用程序列表中，选择“RedBrick Health”。
    ...
    ![应用程序列表中的 RedBrick Health 链接](./media/redbrickhealth-tutorial/tutorial_redbrickhealth_app.png)  
