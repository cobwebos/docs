...
> [!TIP]
> 你还可以选择启用基于 SAML 的单一登录的 Zscaler Private Access (ZPA) 按照 [Zscaler Private access (ZPA) 单一登录教程](https://docs.microsoft.com/azure/active-directory/saas-apps/zscalerprivateaccess-tutorial)中提供的说明进行操作。 可以独立于自动用户预配配置单一登录，尽管这两个功能互相补充。
