...
* 启用了 New Relic 单一登录的订阅

## <a name="scenario-description"></a>方案描述

本教程会在测试环境中配置和测试 Azure AD 单一登录。

* New Relic 支持 SP 发起的 SSO
...
4. 在搜索框中，键入“New Relic”，在结果面板中选择“New Relic”，然后单击“添加”按钮添加应用程序。
     ...
     ![结果列表中的 New Relic](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分中，将基于一个名为“Britta Simon”的测试用户配置和测试 New Relic 的 Azure AD 单一登录。
若要运行单一登录，需要在 Azure AD 用户与 New Relic 相关用户之间建立链接关系。

若要配置和测试 New Relic 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 New Relic 单一登录](#configure-new-relic-single-sign-on)** - 在应用程序端配置“单一登录”设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 New Relic 测试用户](#create-new-relic-test-user)** - 在 New Relic 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
1. 在 [Azure 门户](https://portal.azure.com/)中的“New Relic”应用程序集成页上，选择“单一登录”。
...
4. 在“基本 SAML 配置”部分中，按照以下步骤操作：
    ...
    ![New Relic 域和 URL 单一登录信息](common/sp-identifier.png)

    a. 在“登录 URL”文本框中，使用以下模式键入 URL：`https://rpm.newrelic.com/accounts/{acc_id}/sso/saml/login` - 请务必将其替换为你自己的 New Relic 帐户 ID。
...
6. 在“设置 New Relic”部分，根据要求复制相应 URL。
...
### <a name="configure-new-relic-single-sign-on"></a>配置 NewRelic 单一登录
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”和“New Relic”。
...
### <a name="create-new-relic-test-user"></a>创建 New Relic 测试用户
...
单击访问面板中的 New Relic 磁贴时，应当会自动登录到为其设置了 SSO 的 New Relic。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
