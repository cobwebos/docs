...
1. 在搜索框中，键入“Mixpanel”。
    ...
    ![创建 Azure AD 测试用户](./media/mixpanel-tutorial/tutorial_mixpanel_search.png)

1. 在结果面板中选择“Mixpanel”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/mixpanel-tutorial/tutorial_mixpanel_addfromgallery.png)
...
1. [创建 Mixpanel 测试用户](#creating-a-mixpanel-test-user) - 在 Mixpanel 中创建 Britta Simon 的对应用户，将其链接到该用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/mixpanel-tutorial/tutorial_mixpanel_samlbase.png)

1. 在“Mixpanel 域和 URL”部分，执行以下步骤：

    ![配置单一登录](./media/mixpanel-tutorial/tutorial_mixpanel_url.png)
...
1. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。
    ...
    ![配置单一登录](./media/mixpanel-tutorial/tutorial_mixpanel_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录](./media/mixpanel-tutorial/tutorial_general_400.png)

1. 在“Mixpanel 配置”部分中，单击“配置 Mixpanel”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 单一登录服务 URL”

    ![配置单一登录](./media/mixpanel-tutorial/tutorial_mixpanel_configure.png) 

1. 在另一个浏览器窗口中，以管理员身份登录到 Mixpanel 应用程序。

1. 在页面底部，单击左下角的小**齿轮**图标。 
   
    ![Mixpanel 单一登录](./media/mixpanel-tutorial/tutorial_mixpanel_06.png) 

1. 单击“访问安全性”选项卡，并单击“更改设置”。
   
    ![Mixpanel 设置](./media/mixpanel-tutorial/tutorial_mixpanel_08.png) 

1. 在“更改证书”对话框页上，单击“选择文件”上传所下载的证书，然后单击“下一步”。
   
    ![Mixpanel 设置](./media/mixpanel-tutorial/tutorial_mixpanel_09.png) 

1.  在“更改身份验证 URL”对话框页的“身份验证 URL”文本框中，粘贴从 Azure 门户复制的“SAML 单一登录服务 URL”的值，然后单击“下一步”。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/mixpanel-tutorial/create_aaduser_01.png) 

1. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/mixpanel-tutorial/create_aaduser_02.png) 

1. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/mixpanel-tutorial/create_aaduser_03.png) 

1. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/mixpanel-tutorial/create_aaduser_04.png) 
...
1. 在页面底部，单击左下角的小齿轮按钮以打开“设置”窗口。

1. 单击“团队”选项卡。

1. 在“团队成员”文本框中，键入 Britta 在 Azure 中的电子邮件地址。
...
1. 在应用程序列表中，选择“Mixpanel”。
    ...
    ![配置单一登录](./media/mixpanel-tutorial/tutorial_mixpanel_app.png) 
