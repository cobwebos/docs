...
* 可让用户使用其 Azure AD 帐户自动登录到 PagerDuty（单一登录）。
...
4. 在搜索框中键入 **PagerDuty**，在结果面板中选择“PagerDuty”，然后单击“添加”按钮添加该应用程序。

     ![结果列表中的 PagerDuty](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分中，我们基于名为“Britta Simon”的测试用户为 PagerDuty 配置和测试 Azure AD 单一登录。
若要使单一登录有效，需要在 Azure AD 用户与 PagerDuty 相关用户之间建立关联。

若要配置和测试 PagerDuty 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 PagerDuty 单一登录](#configure-pagerduty-single-sign-on)** - 在应用程序端配置单一登录设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 PagerDuty 测试用户](#create-pagerduty-test-user)** - 在 PagerDuty 中创建 Britta Simon 的对应用户，并将其关联到用户的 Azure AD 表示形式。
...
要为 PagerDuty 配置 Azure AD 单一登录，请执行以下步骤：

1. 在 [Azure 门户](https://portal.azure.com/)中的 **PagerDuty** 应用程序集成页上，选择“单一登录”。
...
6. 在“设置 PagerDuty”部分，根据要求复制相应的 URL。
...
### <a name="configure-pagerduty-single-sign-on"></a>配置 PagerDuty 单一登录
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”、“PagerDuty”。
