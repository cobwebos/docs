...
1. 在搜索框中键入 **PagerDuty**，在结果面板中选择“PagerDuty”，并单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/pagerduty-tutorial/tutorial_pagerduty_addfromgallery.png)
...
1. **[创建 PagerDuty 测试用户](#create-a-pagerduty-test-user)** - 在 PagerDuty 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在“PagerDuty 域和 URL”部分中，执行以下步骤：
...
1. 单击“保存”按钮。
    ...
    ![配置单一登录“保存”按钮](./media/pagerduty-tutorial/tutorial_general_400.png)

1. 在“PagerDuty 配置”部分，单击“配置 PagerDuty”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL 和 SAML 单一登录服务 URL”。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![“Azure Active Directory”按钮](./media/pagerduty-tutorial/create_aaduser_01.png) 

1. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![“用户和组”以及“所有用户”链接](./media/pagerduty-tutorial/create_aaduser_02.png) 

1. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![“添加”按钮](./media/pagerduty-tutorial/create_aaduser_03.png) 
...
1. 在应用程序列表中，选择“PagerDuty”。
    ...
    ![应用程序列表中的 PagerDuty 链接](./media/pagerduty-tutorial/tutorial_pagerduty_app.png) 
