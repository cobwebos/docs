...
1. [创建 IdeaScale 测试用户](#creating-an-ideascale-test-user) - 在 IdeaScale 中创建 Britta Simon 的对应用户，将其链接到用户的 Azure AD 表示形式。
...
1. 在“IdeaScale 域和 URL”部分中，执行以下步骤：
...
1. 在“IdeaScale 配置”部分，单击“配置 IdeaScale”打开“配置登录”窗口。 从“快速参考”部分复制“注销 URL”和“SAML 实体 ID”。
