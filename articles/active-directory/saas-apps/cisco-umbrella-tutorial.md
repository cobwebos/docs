...
本教程介绍如何将 Cisco Umbrella 与 Azure Active Directory (Azure AD) 集成。
将 Cisco Umbrella 与 Azure AD 集成具有以下优势：

* 可以在 Azure AD 中控制谁有权访问 Cisco Umbrella。
...
若要配置 Azure AD 与 Cisco Umbrella 的集成，需要具有以下项：

* 一个 Azure AD 订阅。 如果你没有 Azure AD 环境，可以在[此处](https://azure.microsoft.com/pricing/free-trial/)获取一个月的试用版。
* 启用了 Cisco Umbrella 单一登录的订阅

## <a name="scenario-description"></a>方案描述

本教程会在测试环境中配置和测试 Azure AD 单一登录。

* Cisco Umbrella 支持 **SP 和 IDP** 发起的 SSO

## <a name="adding-cisco-umbrella-from-the-gallery"></a>从库中添加 Cisco Umbrella

若要配置 Cisco Umbrella 与 Azure AD 的集成，需要从库中将 Cisco Umbrella 添加到托管 SaaS 应用列表。
...
### <a name="configure-cisco-umbrella-single-sign-on"></a>配置 Cisco Umbrella 单一登录
...
为了使 Azure AD 用户能够登录到 Cisco Umbrella，必须将其预配到 Cisco Umbrella 中。  
对于 Cisco Umbrella，需要手动执行预配。
