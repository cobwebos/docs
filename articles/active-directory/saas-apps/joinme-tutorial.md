...
4. 在搜索框中，键入“join.me”，在结果面板中选择“join.me”，然后单击“添加”按钮添加该应用程序    。
     ...
     ![结果列表中的 join.me](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分中，将基于名为 Britta Simon 的测试用户配置和测试 join.me 的 Azure AD 单一登录  。
若要运行单一登录，需要在 Azure AD 用户与 join.me 相关用户之间建立链接关系。

若要配置并测试 join.me 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 join.me 单一登录](#configure-joinme-single-sign-on)** - 在应用程序端配置单一登录。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 join.me 测试用户](#create-joinme-test-user)** - 在 join.me 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
4. 在“基本 SAML 配置”部分中，用户不必执行任何步骤，因为该应用已经与 Azure 预先集成  。
    ...
    ![join.me 域和 URL 单一登录信息](common/preintegrated.png)

5. 在“设置 SAML 单一登录”  页的“SAML 签名证书”  部分中，单击“复制”按钮，以复制“应用联合元数据 URL”  ，并将它保存在计算机上。

    ![证书下载链接](common/copy-metadataurl.png)

### <a name="configure-joinme-single-sign-on"></a>配置 join.me 单一登录

若要在 join.me 端配置单一登录，需将应用联合元数据 URL 发送给 [join.me支持团队](https://help.join.me/s/?language)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”和“join.me”    。

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在应用程序列表中，选择“join.me”。 

    ![应用程序列表中的 join.me 链接](common/all-applications.png)
...
### <a name="create-joinme-test-user"></a>创建 join.me 测试用户
...
单击访问面板中的 join.me 磁贴时，应当会自动登录到为其设置了 SSO 的 join.me。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
