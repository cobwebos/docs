...
ms.locfileid: "67847949"
---
# <a name="tutorial-configure-peakon-for-automatic-user-provisioning"></a>教程：为自动用户预配配置 Peakon
...
* 必须从 Peakon 的自定义 SCIM 用户扩展`urn:ietf:params:scim:schemas:extension:peakon:2.0:User`中扩展 Peakon 中的所有自定义用户属性。
