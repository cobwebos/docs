...
5. 在结果窗格中，选择“Oneteam”，然后单击“添加”按钮添加该应用程序。
...
3. 在“Oneteam 域和 URL”部分中，如果要在“IDP 启动的模式”下配置应用程序，请执行以下步骤：
...
7. 若要为应用程序配置 SSO，可以通过 [Oneteam 支持团队](https://support.one-team.com/hc/requests/new)提出支持票证，并为其提供下载的元数据。 
