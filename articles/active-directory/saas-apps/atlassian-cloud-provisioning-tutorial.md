...
3. 若要添加 Atlassian Cloud，请单击**新的应用程序**在对话框顶部的按钮。

    ![“新增应用程序”按钮][3]

4. 在搜索框中，键入 **Atlassian Cloud**。

    ![预配的 Atlassian Cloud](./media/atlassian-cloud-provisioning-tutorial/app-search.png)

5. 在结果面板中，选择**Atlassian Cloud**，然后单击**添加**按钮将 Atlassian Cloud 添加到 SaaS 应用程序列表。

    ![预配的 Atlassian Cloud](./media/atlassian-cloud-provisioning-tutorial/app-create.png)

    ![预配的 Atlassian Cloud](./media/atlassian-cloud-provisioning-tutorial/app-instance.png)
...
2. 从 SaaS 应用程序列表中选择 Atlassian Cloud。
 
    ![预配的 Atlassian Cloud](./media/atlassian-cloud-provisioning-tutorial/application-instance-search.png)
