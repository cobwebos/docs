...
6. 单击 "**用户设置**"，然后单击 "**创建目录**"。 分别将**目录基 url**和**持有者令牌**复制到 "**租户 URL** " 和 "**机密令牌**" 字段。
    ...
    ![Atlassian 云预配](./media/atlassian-cloud-provisioning-tutorial/secret-token-1.png) ![Atlassian 云预配](./media/atlassian-cloud-provisioning-tutorial/secret-token-2.png) ![Atlassian Cloud 预配](./media/atlassian-cloud-provisioning-tutorial/secret-token-3.png)
