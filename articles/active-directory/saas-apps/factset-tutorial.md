...
* 配置 FactSet 后，就可以强制实施会话控制，从而实时防止组织的敏感数据遭到外泄和渗透。 会话控制从条件访问扩展而来。 [了解如何通过 Microsoft Cloud App Security 强制实施会话控制](https://docs.microsoft.com/cloud-app-security/proxy-deployment-any-app)。
...
- [如何通过高级可见性和控制保护 FactSet](https://docs.microsoft.com/cloud-app-security/proxy-intro-aad)
