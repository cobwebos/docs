...
## <a name="configure-and-test-azure-ad-single-sign-on-for-mimecast-admin-console"></a>配置并测试 Mimecast Admin Console 的 Azure AD 单一登录
...
若要配置并测试 Mimecast Admin Console 的 Azure AD SSO，请完成以下构建基块：
...
1. 在 [Azure 门户](https://portal.azure.com/)中的“Mimecast Admin Console”应用程序集成页面上，找到“管理”部分，选择“单一登录”  。
