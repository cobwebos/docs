...
4. 在搜索框中，键入“Aravo”。
    ...
    ![创建 Azure AD 测试用户](./media/aravo-tutorial/tutorial_aravo_search.png)

5. 在结果面板中，选择“Aravo”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/aravo-tutorial/tutorial_aravo_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/aravo-tutorial/tutorial_aravo_samlbase.png)
...
3. 在“Aravo 域和 URL”部分中，执行以下步骤：
    ...
    > [!NOTE] 
    > 这些不是实际值。 请使用实际标识符和回复 URL 更新这些值。 请联系 [Aravo 支持团队](https://www.aravo.com/about-us/contact/)获取这些值。
 
4. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。

    ![配置单一登录](./media/aravo-tutorial/tutorial_aravo_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录](./media/aravo-tutorial/tutorial_general_400.png)

6. 在“Aravo 配置”部分，单击“配置 Aravo”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![配置单一登录](./media/aravo-tutorial/tutorial_aravo_configure.png) 

7. 若要在 Aravo 端配置单一登录，需要将下载的证书 (Base64)、注销 URL、SAML 实体 ID 和 SAML 单一登录服务 URL 发送给 [Aravo 支持团队](https://www.aravo.com/about-us/contact/)。 
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/aravo-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/aravo-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/aravo-tutorial/create_aaduser_03.png) 
...
本部分的目的是在 Aravo 中创建名为 Britta Simon 的用户。 请与 [Aravo 支持团队](https://www.aravo.com/about-us/contact/)协作，将用户添加到 Aravo 帐户中。
...
2. 在应用程序列表中，选择“Aravo”。
    ...
    ![配置单一登录](./media/aravo-tutorial/tutorial_aravo_app.png) 
