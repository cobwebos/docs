...
* GitHub 中的用户帐户，具有对组织的管理员权限
* 确保为您的组织提供了 OAuth 访问权限，如下[所述](https://help.github.com/en/github/setting-up-and-managing-organizations-and-teams/approving-oauth-apps-for-your-organization)

> [!NOTE]
> Azure AD 预配集成依赖于[GitHub SCIM API，](https://developer.github.com/v3/scim/)在[GitHub 企业计费计划中](https://help.github.com/articles/github-s-billing-plans/#billing-plans-for-organizations)[，GitHub 企业云](https://help.github.com/articles/github-s-products/#github-enterprise)客户可以使用该 API。
...
5. 在“管理员凭据”**** 部分下，单击“授权”****。 此操作将在新的浏览器窗口中打开“GitHub 授权”对话框。 请注意，您需要确保已批准您授权访问。 按照[此处](https://help.github.com/github/setting-up-and-managing-organizations-and-teams/approving-oauth-apps-for-your-organization)描述的方向操作。
