...
* 可让用户使用其 Azure AD 帐户自动登录到 Aha! （单一登录）。
...
4. 在搜索框中键入 **Aha!** ，在结果面板中选择“Aha!”，  然后单击“添加”按钮添加该应用程序。 

     ![Aha! 在结果列表中](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分中，基于一个名为“Britta Simon”的测试用户使用 Aha! 配置和测试 Azure AD 单一登录。 
若要正常使用单一登录，需要建立 Azure AD 用户与 Aha! 相关用户 之间的链接关系。

若要配置和测试 Aha! 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 Aha!单一登录](#configure-aha-single-sign-on)** - 在应用程序端配置单一登录设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. [创建 Aha! 测试用户](#create-aha-test-user)  - 在 Aha! 中创建 Britta Simon 的对应用户， 并将其链接到用户的 Azure AD 表示形式。
...
1. 在 [Azure 门户](https://portal.azure.com/)中的“Aha!”  应用程序集成页上，选择“单一登录”。 
...
4. 在“基本 SAML 配置”  部分中，按照以下步骤操作：
    ...
    ![Aha! 域和 URL 单一登录信息](common/sp-identifier.png)
...
### <a name="configure-aha-single-sign-on"></a>配置 Aha! 单一登录

1. 在其他 Web 浏览器窗口中，作为管理员登录 Aha! 公司站点。
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”、“Aha!”。   

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在应用程序列表中，选择“Aha!”  。

    ![“应用程序”列表中的“Aha!” 链接](common/all-applications.png)
...
在本部分，我们将在 Aha! 中创建名为 Britta Simon 的用户。 Aha! 支持默认已启用的实时用户预配。 此部分不存在任何操作项。 如果 Aha! 中尚不存在用户，身份验证后会创建一个新用户。
