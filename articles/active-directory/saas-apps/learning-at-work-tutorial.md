...
1. [创建 Learning at Work 测试用户](#creating-a-learning-at-work-test-user) - 在 Learning at Work 中有一个与 Azure AD 中的 Britta Simon 相对应的关联用户。
...
1. 在“Learning at Work 域和 URL”部分中，执行以下步骤：
...
1. 在“Learning at Work 配置”部分中，单击“配置 Learning at Work”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![配置单一登录](./media/learning-at-work-tutorial/tutorial_learningatwork_configure.png) 

1. 若要在 Learning at Work 端配置单一登录，需要将下载的元数据 XML、SAML 实体 ID 和 SAML 单一登录服务 URL 和注销 URL 发送到 [Learning at Work 支持”](https://www.learninga-z.com/site/contact/support)。
