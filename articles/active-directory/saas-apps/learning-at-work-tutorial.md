...
* 可在 Azure AD 中控制谁有权访问 Learning at Work。
* 可让用户使用其 Azure AD 帐户自动登录 Learning at Work（单一登录）。
...
4. 在搜索框中键入“Learning at Work”，从结果面板中选择“Learning at Work”，然后单击“添加”按钮以添加应用程序。

     ![结果列表中的 Learning at Work](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分中，将基于名为“Britta Simon”的测试用户配置并测试 Learning at Work 的 Azure AD 单一登录。
若要运行单一登录，需要在 Azure AD 用户与 Learning at Work 中的相关用户之间建立链接关系。

若要配置并测试 Learning at Work 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 Learning at Work 单一登录](#configure-learning-at-work-single-sign-on)** - 在应用程序端配置单一登录。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. [创建 Learning at Work 测试用户](#create-learning-at-work-test-user) - 在 Learning at Work 中有一个与 Azure AD 中的 Britta Simon 相对应的关联用户。
...
1. 在 [Azure 门户](https://portal.azure.com/)中的 Learning at Work 应用程序集成页上，选择“单一登录”。
...
4. 在“基本 SAML 配置”部分中，按照以下步骤操作：
    ...
    ![Learning at Work 域和 URL 单一登录信息](common/sp-identifier.png)
...
### <a name="configure-learning-at-work-single-sign-on"></a>配置 Learning at Work 单一登录

若要在 Learning at Work 配置单一登录，需要将下载的“联合元数据 XML”以及从 Azure 门户复制的相应 URL 发送给 [Learning at Work 支持团队](https://www.learninga-z.com/site/contact/support)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”和“Learning at Work”。

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在应用程序列表中，选择“Learning at Work”。

    ![应用程序列表中的 Learning at Work 链接](common/all-applications.png)
...
在本部分中，会在 Learning at Work 中创建一个名为 Britta Simon 的用户。 请与  [Learning at Work 支持团队](https://www.learninga-z.com/site/contact/support)协作，将用户添加到 Learning at Work 平台中。 使用单一登录前，必须先创建并激活用户。
