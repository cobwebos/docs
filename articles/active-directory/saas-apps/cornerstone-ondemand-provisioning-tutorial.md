...
* 将用户分配到 "基础" OnDemand 时，在 "分配" 对话框中选择任何特定于应用程序的有效角色（如果可用）。 将从设置中排除具有**默认访问**角色的用户。
...
5. 在 "**管理员凭据**" 部分下，输入用户的管理员用户名、管理员密码和域。
    ...
    * 在 "**域**" 框中，填写 ""。 例如，服务位于`https://ws-[corpname].csod.com/feed30/clientdataservice.asmx`，而对于 Contoso，则域为。 `https://ws-contoso.csod.com/feed30/clientdataservice.asmx` 有关如何检索 web 服务 URL 的详细信息，请参阅[此 pdf](https://help.csod.com/help/csod_0/Content/Resources/Documents/WebServices/CSOD_Web_Services_-_User-OU_Technical_Specification_v20160222.pdf)。
