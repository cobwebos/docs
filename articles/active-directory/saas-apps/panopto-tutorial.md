...
若要使单一登录有效，需要在 Azure AD 用户与 Panopto 相关用户之间建立链接关系。
...
5. **[创建 Panopto 测试用户](#create-panopto-test-user)** - 在 Panopto 中创建 Britta Simon 的对应用户，将其链接到该用户的 Azure AD 表示形式。
...
单击访问面板中的 Panopto 磁贴时，应当会自动登录到已为其设置了 SSO 的 Panopto。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
