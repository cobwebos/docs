...
5. 在结果面板中，选择“Printix”，然后单击“添加”按钮添加该应用程序。
...
8. 在“安装”选项卡上，选择“启用 Azure/Office 365 身份验证”
   
    ![配置单一登录](./media/printix-tutorial/tutorial_printix_07.png)

9. 在“Azure”选项卡上，将联合元数据 URL 输入到“联合元数据文档”文本框中。 
