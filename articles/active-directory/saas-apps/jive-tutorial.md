...
1. 在搜索框中，键入“Jive”。
    ...
    ![创建 Azure AD 测试用户](./media/jive-tutorial/tutorial_jive_search.png)

1. 在结果面板中，选择“Jive”，并单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/jive-tutorial/tutorial_jive_addfromgallery.png)
...
1. [创建 Jive 测试用户](#creating-a-jive-test-user) - 在 Jive 中有一个与 Azure AD 中的 Britta Simon 相对应的关联用户。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/jive-tutorial/tutorial_jive_samlbase.png)

1. 在“Jive 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/jive-tutorial/tutorial_jive_url.png)
...
1. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存 XML 文件。
    ...
    ![配置单一登录](./media/jive-tutorial/tutorial_jive_certificate.png)

1. 单击“保存”按钮。

    ![配置单一登录](./media/jive-tutorial/tutorial_general_400.png)
...
1. 在顶部菜单中，单击“Saml”。
    ...
    a. 在“常规”选项卡下选择“已启用”。b. 单击“保存所有 saml 设置”按钮。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/jive-tutorial/create_aaduser_01.png) 

1. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。

    ![创建 Azure AD 测试用户](./media/jive-tutorial/create_aaduser_02.png)

1. 若要打开“用户”对话框，请在对话框顶部单击“添加”。

    ![创建 Azure AD 测试用户](./media/jive-tutorial/create_aaduser_03.png) 

1. 在“用户”对话框页上，执行以下步骤：

    ![创建 Azure AD 测试用户](./media/jive-tutorial/create_aaduser_04.png)
...
1. 在应用程序列表中，选择“Jive”。
    ...
    ![配置单一登录](./media/jive-tutorial/tutorial_jive_app.png) 
