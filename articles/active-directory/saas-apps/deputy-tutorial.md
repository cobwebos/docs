...
1. 在搜索框中，键入“Deputy”。
    ...
    ![创建 Azure AD 测试用户](./media/deputy-tutorial/tutorial_deputy_search.png)

1. 在结果面板中，选择“Deputy”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/deputy-tutorial/tutorial_deputy_addfromgallery.png)
...
1. [创建 Deputy 测试用户](#creating-a-deputy-test-user) - 在 Deputy 中创建 Britta Simon 的对应用户，将其链接到用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/deputy-tutorial/tutorial_deputy_samlbase.png)

1. 在“Deputy 域和 URL”部分中，如果要在“IDP 发起的模式”下配置应用程序，请执行以下步骤：

    ![配置单一登录](./media/deputy-tutorial/tutorial_deputy_url1.png)
...
1. 选中“显示高级 URL 设置”。 如果要在“SP”发起的模式下配置应用程序：
    ...
    ![配置单一登录](./media/deputy-tutorial/tutorial_deputy_url2.png)
...
1. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。
    ...
    ![配置单一登录](./media/deputy-tutorial/tutorial_deputy_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录](./media/deputy-tutorial/tutorial_general_400.png)
    
1. 在“Deputy 配置”部分，单击“配置 Deputy”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 单一登录服务 URL”

    ![配置单一登录](./media/deputy-tutorial/tutorial_deputy_configure.png) 
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/deputy-tutorial/create_aaduser_01.png) 

1. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/deputy-tutorial/create_aaduser_02.png) 

1. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/deputy-tutorial/create_aaduser_03.png) 

1. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/deputy-tutorial/create_aaduser_04.png) 
...
1. AAD 帐户持有者将收到一封电子邮件，并打开其中的链接以在激活帐户前确认帐户。 可以使用 Deputy 提供的任何其他 Deputy 用户帐户创建工具或 API 来预配 AAD 用户帐户。
...
1. 在应用程序列表中，选择“Deputy”。
    ...
    ![配置单一登录](./media/deputy-tutorial/tutorial_deputy_app.png) 
