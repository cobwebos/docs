...
1. 若要在 **Insignia SAML SSO** 端配置单一登录，需将下载的**证书 (Base64)**、**注销 URL 和 SAML 单一登录服务 URL** 发送给 [Insignia SAML SSO 支持团队](http://www.insigniasoftware.com/insignia/Techsupport.aspx)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
