...
1. 在搜索框中，键入“Gigya”。
    ...
    ![创建 Azure AD 测试用户](./media/gigya-tutorial/tutorial_gigya_search.png)

1. 在结果窗格中，选择“Gigya”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/gigya-tutorial/tutorial_gigya_addfromgallery.png)
...
1. **[创建 Gigya 测试用户](#creating-a-gigya-test-user)** - 在 Gigya 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/gigya-tutorial/tutorial_gigya_samlbase.png)

1. 在“Gigya 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/gigya-tutorial/tutorial_gigya_url.png)
...
1. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。
    ...
    ![配置单一登录](./media/gigya-tutorial/tutorial_gigya_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录](./media/gigya-tutorial/tutorial_general_400.png)

1. 在“Gigya 配置”部分中，单击“配置 Gigya”打开“配置登录”窗口。  从“快速参考”部分中复制“SAML 实体 ID 和 SAML 单一登录服务 URL”。

    ![配置单一登录](./media/gigya-tutorial/tutorial_gigya_configure.png) 

1. 在另一个 Web 浏览器窗口中，以管理员身份登录 Gigya 公司站点。

1. 转到“设置”\>“SAML 登录”，并单击“添加”按钮。
   
    ![SAML 登录](./media/gigya-tutorial/ic789532.png "SAML 登录")

1. 在“SAML 登录”部分执行以下步骤：
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/gigya-tutorial/create_aaduser_01.png) 

1. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/gigya-tutorial/create_aaduser_02.png) 

1. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/gigya-tutorial/create_aaduser_03.png) 

1. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/gigya-tutorial/create_aaduser_04.png) 
...
1. 在应用程序列表中，选择“Gigya”。
    ...
    ![配置单一登录](./media/gigya-tutorial/tutorial_gigya_app.png) 
