...
1. 在搜索框中，键入“Mobile Xpense”，在结果面板中选择“Mobile Xpense”，然后单击“添加”按钮添加应用程序。

    ![结果列表中的 Mobile Xpense](./media/mobilexpense-tutorial/tutorial_mobilexpense_addfromgallery.png)
...
1. [创建 Mobile Xpense 测试用户](#create-a-mobile-xpense-test-user) - 在 Mobile Xpense 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/mobilexpense-tutorial/tutorial_mobilexpense_samlbase.png)

1. 在“Mobile Xpense 域和 URL”部分中，如果要在“IDP”发起的模式下配置应用程序，请执行以下步骤：
...
1. 如果要在 SP 发起的模式下配置应用程序，请选中“显示高级 URL 设置”，并执行以下步骤：
    ...
    > [!NOTE] 
    > 这些不是实际值。 请使用实际的回复 URL 和注销 URL 更新这些值。 请联系 [Mobile Xpense 客户端支持团队](https://www.mobilexpense.net/contact)获取这些值。 

1. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。

    ![证书下载链接](./media/mobilexpense-tutorial/tutorial_mobilexpense_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/mobilexpense-tutorial/tutorial_general_400.png)

1. 若要在“Mobile Xpense”端配置单一登录，需将下载的“元数据 XML”发送给 [Mobile Xpense 支持团队](https://www.mobilexpense.net/contact)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/mobilexpense-tutorial/create_aaduser_01.png)

1. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/mobilexpense-tutorial/create_aaduser_02.png)

1. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/mobilexpense-tutorial/create_aaduser_03.png)
...
在本部分中，会在 MobileXpense 中创建一个名为 Britta Simon 的用户。 请与 [MobileXpense 支持团队](https://www.mobilexpense.net/contact) 协作，将用户添加到 MobileXpense 平台中。 使用单一登录前，必须先创建并激活用户。 
...
1. 在应用程序列表中，选择“Mobile Xpense”。

    ![应用程序列表中的 Mobile Xpense 链接](./media/mobilexpense-tutorial/tutorial_mobilexpense_app.png)  
