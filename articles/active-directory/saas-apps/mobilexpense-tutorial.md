...
1. 若要在“Mobile Xpense”端配置单一登录，需将下载的“元数据 XML”发送给 [Mobile Xpense 支持团队](http://www.mobilexpense.net/contact)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
