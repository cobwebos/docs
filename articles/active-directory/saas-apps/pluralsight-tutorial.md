...
1. 在搜索框中，键入“Pluralsight”，在结果面板中选择“Pluralsight”，然后单击“添加”按钮添加该应用程序。

    ![结果列表中的 Pluralsight](./media/pluralsight-tutorial/tutorial_pluralsight_addfromgallery.png)
...
1. **[创建 Pluralsight 测试用户](#create-a-pluralsight-test-user)** - 在 Pluralsight 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/pluralsight-tutorial/tutorial_pluralsight_samlbase.png)

1. 在“Pluralsight 域和 URL”部分中，执行以下步骤：

    ![Pluralsight 域和 URL 单一登录信息](./media/pluralsight-tutorial/tutorial_pluralsight_url.png)
...
1. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![证书下载链接](./media/pluralsight-tutorial/tutorial_pluralsight_certificate.png) 

1. 本部分的目的是在 Azure 门户中启用 Azure AD 单一登录，并在 Pluralsight 应用程序中配置 SSO。

    Pluralsight 应用程序需要特定格式的 SAML 断言，这要求将自定义属性映射添加到 SAML 令牌属性配置。 以下屏幕截图显示一个示例。

    ![配置单一登录](./media/pluralsight-tutorial/tutorial_pluralsight_attribute.png)
...
1. 若要添加必需的 **SAML 令牌属性**，请对下表中显示的每一行执行以下步骤：
   ...
   a. 单击“添加用户属性”，打开“添加用户属性”对话框。
     ...
     ![配置单一登录](./media/pluralsight-tutorial/tutorial_pluralsight_addattribute.png)
...
1. 单击“保存”按钮。
    ...
    ![配置单一登录](./media/pluralsight-tutorial/tutorial_general_400.png)

1. 若要为应用程序配置 SSO，请联系 [Pluralsight专业服务](mailTo:professionalservices@pluralsight.com)团队并提供下载的元数据文件。
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/pluralsight-tutorial/create_aaduser_01.png)

1. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/pluralsight-tutorial/create_aaduser_02.png)

1. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/pluralsight-tutorial/create_aaduser_03.png)

1. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/pluralsight-tutorial/create_aaduser_04.png)
...
1. 在应用程序列表中，选择“Pluralsight”。
    ...
    ![应用程序列表中的 Pluralsight 链接](./media/pluralsight-tutorial/tutorial_pluralsight_app.png)  
