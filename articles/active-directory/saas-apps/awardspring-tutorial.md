...
* 可以让用户使用其 Azure AD 帐户自动登录到 AwardSpring（单一登录）。
...
4. 在搜索框中，键入“AwardSpring”，在结果面板中选择“AwardSpring”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 AwardSpring](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分中，基于一个名为“Britta Simon”的测试用户，配置和测试 AwardSpring 的 Azure AD 单一登录。
若要使单一登录有效，需要在 Azure AD 用户与 AwardSpring 相关用户之间建立链接关系。

若要配置和测试 AwardSpring 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 AwardSpring 单一登录](#configure-awardspring-single-sign-on)** - 在应用程序端配置单一登录设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 AwardSpring 测试用户](#create-awardspring-test-user)** - 在 AwardSpring 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在 [Azure 门户](https://portal.azure.com/)中的“AwardSpring”应用程序集成页上，选择“单一登录”。
...
4. 如果要在 **IDP** 发起的模式下配置应用程序，请在“基本 SAML 配置”部分中执行以下步骤：
    ...
    ![AwardSpring 域和 URL 单一登录信息](common/idp-intiated.png)
...
5. 如果要在 SP 发起的模式下配置应用程序，请单击“设置其他 URL”，并执行以下步骤：
    ...
    ![AwardSpring 域和 URL 单一登录信息](common/metadata-upload-additional-signon.png)
...
6. AwardSpring 应用程序需要特定格式的 SAML 断言。 请为此应用程序配置以下声明。 可以在应用程序集成页的“用户属性”部分管理这些属性的值。 在“使用 SAML 设置单一登录”页上，单击“编辑”按钮以打开“用户属性”对话框。
...
9. 在“设置 AwardSpring”部分，根据要求复制相应的 URL。
...
### <a name="configure-awardspring-single-sign-on"></a>配置 AwardSpring 单一登录
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”和“AwardSpring”。

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在应用程序列表中，选择“AwardSpring”。

    ![应用程序列表中的 AwardSpring 链接](common/all-applications.png)
...
在本部分中，我们将在 AwardSpring 中创建一个名为 Britta Simon 的用户。 AwardSpring 支持默认启用的恰时用户预配。 此部分不存在任何操作项。 如果 AwardSpring 中尚不存在用户，身份验证后会创建一个新用户。
