---
title: 教程：Azure Active Directory 与 AwardSpring 集成 | Microsoft Docs
...
本教程介绍如何将 AwardSpring 与 Azure Active Directory (Azure AD) 集成。

将 AwardSpring 与 Azure AD 集成提供以下优势：

- 可在 Azure AD 中控制谁有权访问 AwardSpring。
- 可以让用户通过其 Azure AD 帐户自动登录到 AwardSpring（单一登录）。
...
若要配置 Azure AD 与 AwardSpring 的集成，需要以下项：

- Azure AD 订阅
- 已启用 AwardSpring 单一登录的订阅
...
4. 在搜索框中，键入“AwardSpring”，在结果面板中选择“AwardSpring”，然后单击“添加”按钮添加该应用程序。

    ![结果列表中的 AwardSpring](./media/awardspring-tutorial/tutorial_awardspring_addfromgallery.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分中，基于一个名为“Britta Simon”的测试用户，配置和测试 AwardSpring 的 Azure AD 单一登录。

若要运行单一登录，Azure AD 需要知道与 Azure AD 用户相对应的 AwardSpring 用户。 换句话说，需要在 Azure AD 用户和 AwardSpring 中的相关用户间建立链接关系。

若要配置和测试 AwardSpring 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
3. **[创建 AwardSpring 测试用户](#create-an-awardspring-test-user)** - 在 AwardSpring 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[测试单一登录](#test-single-sign-on)** - 验证配置是否正常工作。

### <a name="configure-azure-ad-single-sign-on"></a>配置 Azure AD 单一登录

本部分将在 Azure 门户中启用 Azure AD 单一登录并在 AwardSpring 应用程序中配置单一登录。

**若要配置 AwardSpring 的 Azure AD 单一登录，请执行以下步骤：**

1. 在 Azure 门户中的 AwardSpring 应用程序集成页上，单击“单一登录”。

    ![配置单一登录链接][4]

2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
 
    ![“单一登录”对话框](./media/awardspring-tutorial/tutorial_awardspring_samlbase.png)

3. 在“AwardSpring 域和 URL”部分中，如果要在“IDP”发起的模式下配置应用程序，请执行以下步骤：
...
5. AwardSpring 应用程序需要特定格式的 SAML 断言。 请为此应用程序配置以下声明。 可以在应用程序集成页的“用户属性”部分管理这些属性的值。 以下屏幕截图显示一个示例。
    
    ![配置单一登录](./media/awardspring-tutorial/tutorial_awardSpring_attribute.png)
...
6. 在“单一登录”对话框的“用户属性”部分中，按上图所示配置 SAML 令牌属性，并执行以下步骤：
    ...
    ![配置单一登录](./media/awardspring-tutorial/tutorial_attribute_05.png)
...
7. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![证书下载链接](./media/awardspring-tutorial/tutorial_awardspring_certificate.png) 

8. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/awardspring-tutorial/tutorial_general_400.png)
    
9. 若要在 AwardSpring 端配置单一登录，需要将下载的元数据 XML 发送给 [AwardSpring 支持团队](mailto:support@awardspring.com)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/awardspring-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/awardspring-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/awardspring-tutorial/create_aaduser_03.png)
...
### <a name="create-an-awardspring-test-user"></a>创建 AwardSpring 测试用户
...
在本部分中，通过向 Britta Simon 授予 AwardSpring 的访问权限，使之能够使用 Azure 单一登录。

![分配用户角色][200] 

**若要将 Britta Simon 分配到 AwardSpring，请执行以下步骤：**

1. 在 Azure 门户中打开应用程序视图，导航到目录视图，接着转到“企业应用程序”，并单击“所有应用程序”。

    ![分配用户][201] 

2. 在应用程序列表中，选择“AwardSpring”。

    ![应用程序列表中的 AwardSpring 链接](./media/awardspring-tutorial/tutorial_awardspring_app.png)  
