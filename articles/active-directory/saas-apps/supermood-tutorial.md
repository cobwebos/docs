...
- 可以让用户使用其 Azure AD 帐户自动登录到 Supermood（单一登录）。
...
4. 在搜索框中，键入“Supermood”，在结果面板中选择“Supermood”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 Supermood](./media/supermood-tutorial/tutorial_supermood_addfromgallery.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分中，将基于名为 Britta Simon 的测试用户配置和测试 Supermood 的 Azure AD 单一登录。

若要运行单一登录，Azure AD 需要知道与 Azure AD 用户相对应的 Supermood 用户。 换句话说，需要在 Azure AD 用户与 Supermood 中相关用户之间建立链接关系。

若要配置和测试 Supermood 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
3. **[创建 Supermood 测试用户](#create-a-supermood-test-user)** - 在 Supermood 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[测试单一登录](#test-single-sign-on)** - 验证配置是否正常工作。

### <a name="configure-azure-ad-single-sign-on"></a>配置 Azure AD 单一登录

在本部分中，将在 Azure 门户中启用 Azure AD 单一登录并在 Supermood 应用程序中配置单一登录。

**若要配置 Supermood 的 Azure AD 单一登录，请执行以下步骤：**

1. 在 Azure 门户中，在 **Supermood** 应用程序集成页上，单击“单一登录”。

    ![配置单一登录链接][4]

2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
 
    ![“单一登录”对话框](./media/supermood-tutorial/tutorial_supermood_samlbase.png)

3. 在“Supermood 域和 URL”部分中，执行以下步骤：
    ...
    c. 如果要在 **SP** 发起的模式下配置应用程序，请在“登录 URL”文本框中键入一个 URL：`https://supermood.co/app/#!/loginv2`

4. Supermood 应用程序需要特定格式的 SAML 断言。 请为此应用程序配置以下声明。 可以在应用程序集成页的“用户属性”部分管理这些属性的值。 以下屏幕截图显示一个示例。
    
    ![配置单一登录](./media/supermood-tutorial/tutorial_supermood_attribute.png)
...
5. 在“单一登录”对话框的“用户属性”部分中，按上图所示配置 SAML 令牌属性，并执行以下步骤：
    ...
    ![配置单一登录](./media/supermood-tutorial/tutorial_attribute_05.png)
...
6. 在“SAML 签名证书”部分上，单击”复制”按钮来复制**应用联合元数据 URL**，并将其粘贴到记事本。

    ![证书下载链接](./media/supermood-tutorial/tutorial_supermood_certificate.png) 

7. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/supermood-tutorial/tutorial_general_400.png)

8. 作为安全管理员转到 Supermood.co 管理面板。

9. 单击“我的帐户”（左下角）和“单一登录(SSO)”。

    ![证书签名](./media/supermood-tutorial/tutorial_supermood_single.png)
10. 在“SAML 2.0 配置”中，单击“为电子邮件域添加 SAML 2.0 配置”。

    ![证书添加](./media/supermood-tutorial/tutorial_supermood_add.png)

11. 在“为电子邮件域添加 SAML 2.0 配置” 部分中，执行以下步骤：
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/supermood-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/supermood-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/supermood-tutorial/create_aaduser_03.png)
...
### <a name="create-a-supermood-test-user"></a>创建 Supermood 测试用户
...
**若要将 Britta Simon 分配到 Supermood，请执行以下步骤：**
...
2. 在应用程序列表中，选择“Supermood”。
    ...
    ![应用程序列表中的 Supermood 链接](./media/supermood-tutorial/tutorial_supermood_app.png)  
