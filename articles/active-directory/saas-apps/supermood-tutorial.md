...
1. 在搜索框中，键入“Supermood”，在结果面板中选择“Supermood”，然后单击“添加”按钮添加该应用程序。
...
1. **[创建 Supermood 测试用户](#create-a-supermood-test-user)** - 在 Supermood 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
1. 在“Supermood 域和 URL”部分中，执行以下步骤：
...
1. Supermood 应用程序需要特定格式的 SAML 断言。 请为此应用程序配置以下声明。 可以在应用程序集成页的“用户属性”部分管理这些属性的值。 以下屏幕截图显示一个示例。
