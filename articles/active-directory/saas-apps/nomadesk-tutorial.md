...
5. 在结果窗格中，选择“Nomadesk”，然后单击“添加”按钮添加该应用程序。
...
3. 在“Nomadesk 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/nomadesk-tutorial/tutorial_nomadesk_url.png)

    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，并单击“添加引用”。 在“登录 URL”文本框中，使用以下模式键入 URL： `https://mynomadesk.com/logon/saml/<TENANTID>`
...
6. 在“Nomadesk 配置”部分中，单击“配置 Nomadesk”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![配置单一登录](./media/nomadesk-tutorial/tutorial_nomadesk_configure.png) 

7. 若要在 Nomadesk 端配置单一登录，需要将下载的证书、注销 URL、SAML 实体 ID 和 SAML 单一登录服务 URL 发送给 [Nomadesk 支持团队](mailto:support@nomadesk.com)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
