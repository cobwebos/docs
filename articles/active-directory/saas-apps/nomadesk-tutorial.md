...
1. 在搜索框中，键入“Nomadesk”。
    ...
    ![创建 Azure AD 测试用户](./media/nomadesk-tutorial/tutorial_nomadesk_search.png)

1. 在结果窗格中，选择“Nomadesk”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/nomadesk-tutorial/tutorial_nomadesk_addfromgallery.png)
...
可通过将 Azure AD 中“用户名”的值指定为 Nomadesk 中“用户名”的值来建立此链接关系。

若要使用 Nomadesk 配置和测试 Azure AD 单一登录，需完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configuring-azure-ad-single-sign-on)** - 让用户使用此功能。
1. **[创建 Azure AD 测试用户](#creating-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
1. [创建 Nomadesk 测试用户](#creating-a-nomadesk-test-user) - 目的是在 Nomadesk 中有一个与 Azure AD 中的 Britta Simon 相对应的关联用户。
1. **[分配 Azure AD 测试用户](#assigning-the-azure-ad-test-user)** - 让 Britta Simon 使用 Azure AD 单一登录。
1. **[测试单一登录](#testing-single-sign-on)** - 验证配置是否正常工作。

### <a name="configuring-azure-ad-single-sign-on"></a>配置 Azure AD 单一登录

本部分中的步骤在 Azure 门户中启用 Azure AD 单一登录并在 Nomadesk 应用程序中配置单一登录。

**若要通过 Nomadesk 配置 Azure AD 单一登录，请执行以下步骤：**

1. 在 Azure 门户中的 Nomadesk 应用程序集成页上，单击“单一登录”。

    ![配置单一登录][4]

1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
 
    ![配置单一登录](./media/nomadesk-tutorial/tutorial_nomadesk_samlbase.png)

1. 在“Nomadesk 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/nomadesk-tutorial/tutorial_nomadesk_url.png)

    a. 在“登录 URL”文本框中，使用以下模式键入 URL： `https://mynomadesk.com/logon/saml/<TENANTID>`

    b. 在“标识符”文本框中，使用以下模式键入 URL：`https://secure.nomadesk.com/saml/<instancename>`

    > [!NOTE] 
    > 这些不是实际值。 必须使用实际登录 URL 和标识符更新这些值。 请联系 [Nomadesk 客户端支持团队](mailto:support@nomadesk.com)获取这些值。 
 
1. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。

    ![配置单一登录](./media/nomadesk-tutorial/tutorial_nomadesk_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录](./media/nomadesk-tutorial/tutorial_general_400.png)

1. 在“Nomadesk 配置”部分中，单击“配置 Nomadesk”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![配置单一登录](./media/nomadesk-tutorial/tutorial_nomadesk_configure.png) 

1. 若要在 Nomadesk 端配置单一登录，需要将下载的证书、注销 URL、SAML 实体 ID 和 SAML 单一登录服务 URL 发送给 [Nomadesk 支持团队](mailto:support@nomadesk.com)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/nomadesk-tutorial/create_aaduser_01.png) 

1. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/nomadesk-tutorial/create_aaduser_02.png) 

1. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/nomadesk-tutorial/create_aaduser_03.png) 

1. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/nomadesk-tutorial/create_aaduser_04.png) 
...
此部分不存在任何操作项。 如果尚不存在用户，将在尝试访问 Nomadesk 期间创建一个新用户。
...
**要将 Britta Simon 分配到 Nomadesk，请执行以下步骤：**

1. 在 Azure 门户中打开应用程序视图，导航到目录视图，接着转到“企业应用程序”，并单击“所有应用程序”。

    ![分配用户][201] 

1. 在应用程序列表中，选择“Nomadesk”。

    ![配置单一登录](./media/nomadesk-tutorial/tutorial_nomadesk_app.png) 
