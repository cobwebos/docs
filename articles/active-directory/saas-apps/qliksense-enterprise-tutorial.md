...
本教程在测试环境中配置并测试 Azure AD SSO。 Qlik Sense Enterprise 支持 **SP** 发起的 SSO。
...
2. **[配置 Qlik Sense Enterprise SSO](#configure-qlik-sense-enterprise-sso)** - 在应用程序端配置单一登录设置。
