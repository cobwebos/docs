...
* 可在 Azure AD 中控制谁有权访问 Lessonly.com。
* 可让用户使用其 Azure AD 帐户自动登录 Lessonly.com（单一登录）。
...
* 已启用单一登录的 Lessonly.com 订阅

## <a name="scenario-description"></a>方案描述

本教程会在测试环境中配置和测试 Azure AD 单一登录。

* Lessonly.com支持 SP 发起的 SSO 
* Lessonly.com 支持即时用户预配 
...
4. 在搜索框中键入“Lessonly.com”，从结果面板中选择“Lessonly.com”，然后单击“添加”按钮以添加应用程序    。

     ![结果列表中的 Lessonly.com](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分中，将基于名为 Britta Simon 的测试用户配置和测试 Lessonly.com 的 Azure AD 单一登录  。
若要运行单一登录，需要在 Azure AD 用户与 Lessonly.com 中的相关用户之间建立链接关系。

若要配置和测试 Lessonly.com 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 Lessonly.com 单一登录](#configure-lessonlycom-single-sign-on)** - 在应用程序端配置单一登录。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 Lessonly.com 测试用户](#create-lessonlycom-test-user)** - 在 Lessonly.com 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在 [Azure 门户](https://portal.azure.com/)中的 Lessonly.com 应用程序集成页上，选择“单一登录”   。
...
5. Lessonly.com 应用程序需要特定格式的 SAML 断言，这要求向 SAML 令牌属性配置添加自定义属性映射。 以下屏幕截图显示了默认属性的列表。 单击“编辑”图标以打开“用户属性”对话框 ****  。
...
8. 在“设置 Lessonly.com”部分，根据要求复制相应的 URL  。
...
### <a name="configure-lessonlycom-single-sign-on"></a>配置 Lessonly.com 单一登录

若要在 Lessonly.com 端配置单一登录，需要将下载的“证书(Base64)”以及从 Azure 门户复制的相应 URL 发送给 [Lessonly.com 支持团队](mailto:support@lessonly.com)   。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”和“Lessonly.com”    。

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在应用程序列表中，选择“Lessonly.com”。 

    ![应用程序列表中的 Lessonly.com 链接](common/all-applications.png)
...
### <a name="create-lessonlycom-test-user"></a>创建 Lessonly.com 测试用户
...
单击访问面板中的 Lessonly.com 磁贴时，应会自动登录到为其设置了 SSO 的 Lessonly.com。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
