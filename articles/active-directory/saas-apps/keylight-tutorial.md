...
1. 在“编辑 SAML 设置”对话框页上，执行以下步骤：
    ...
    k. 在“电子邮件属性”文本框中，键入 `https://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress`。

    l. 在“名字属性”文本框中，键入 `https://schemas.xmlsoap.org/ws/2005/05/identity/claims/givenname`。

    m. 在“姓氏属性”文本框中，键入 `https://schemas.xmlsoap.org/ws/2005/05/identity/claims/surname`。
