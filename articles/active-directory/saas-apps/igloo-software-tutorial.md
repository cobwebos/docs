...
1. [创建 Igloo Software 测试用户](#creating-an-igloo-software-test-user) - 在 Igloo Software 中创建 Britta Simon 的对应用户，将其链接到用户的 Azure AD 表示形式。
...
1. 在“Igloo Software 域和 URL”部分中，执行以下步骤：
...
1. 在“Igloo Software 配置”部分中，单击“配置 Igloo Software”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL 和 SAML 单一登录服务 URL”。
...
1. 在“成员身份”选项卡中，单击“登录设置”。
   
    ![登录设置](./media/igloo-software-tutorial/ic783968.png "登录设置")

1. 在“SAML 配置”部分中，单击“配置 SAML 身份验证”。
