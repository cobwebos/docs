...
1. 在 **support@mypolicies.com** 联系到你的 myPolicies 代表，以获取配置 SCIM 预配所需的机密令牌。
...
5. 在 "**管理员凭据**" 部分下的 "**租户 URL** " 中输入 `https://<myPoliciesCustomDomain>.mypolicies.com/scim`，其中 `<myPoliciesCustomDomain>` 是 myPolicies 自定义域。 你可以从 URL 检索你的 myPolicies 客户域。
