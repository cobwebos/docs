...
6. 在“LCVista 配置”部分中，单击“配置 LCVista”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 实体 ID 和 SAML 单一登录服务 URL”。

    ![配置单一登录](./media/lcvista-tutorial/tutorial_lcvista_configure.png) 

7.  以管理员身份登录到 LCVista 应用程序。

8. 在“SAML 配置”部分中，选中“启用 SAML 登录”并输入详细信息，如下图所述。 
