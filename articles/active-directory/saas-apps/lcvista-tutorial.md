...
1. 在搜索框中，键入“LCVista”。
    ...
    ![创建 Azure AD 测试用户](./media/lcvista-tutorial/tutorial_lcvista_search.png)

1. 在结果窗格中，选择“LCVista”，并单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/lcvista-tutorial/tutorial_lcvista_addfromgallery.png)

##  <a name="configuring-and-testing-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录
在本部分中，将基于名为“Britta Simon”的测试用户配置和测试 LCVista 的 Azure AD 单一登录。

若要运行单一登录，Azure AD 需要知道与 Azure AD 用户相对应的 LCVista 用户。 换句话说，需要在 Azure AD 用户与 LCVista 中相关用户之间建立链接关系。

可以通过将 Azure AD 中“用户名”的值分配为 LCVista 中“用户名”的值来建立此链接关系。

若要配置和测试 LCVista 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configuring-azure-ad-single-sign-on)** - 让用户使用此功能。
1. **[创建 Azure AD 测试用户](#creating-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
1. **[创建 LCVista 测试用户](#creating-a-lcvista-test-user)** - 在 LCVista 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在 Azure 门户中的 **LCVista** 应用程序集成页上，单击“单一登录”。

    ![配置单一登录][4]

1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
 
    ![配置单一登录](./media/lcvista-tutorial/tutorial_lcvista_samlbase.png)

1. 在“LCVista 域和 URL”部分中，执行以下步骤：
...
1. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![配置单一登录](./media/lcvista-tutorial/tutorial_lcvista_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录](./media/lcvista-tutorial/tutorial_general_400.png)
    
1. 在“LCVista 配置”部分中，单击“配置 LCVista”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 实体 ID 和 SAML 单一登录服务 URL”。

    ![配置单一登录](./media/lcvista-tutorial/tutorial_lcvista_configure.png) 

1.  以管理员身份登录到 LCVista 应用程序。

1. 在“SAML 配置”部分中，选中“启用 SAML 登录”并输入详细信息，如下图所述。 
    ...
    c. 从已从 Azure 门户下载的元数据 (XML) 中，复制值 **X509Certificate**，并将其粘贴到“x509 证书”部分中。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/lcvista-tutorial/create_aaduser_01.png) 

1. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/lcvista-tutorial/create_aaduser_02.png) 

1. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/lcvista-tutorial/create_aaduser_03.png) 
...
1. 在应用程序列表中，选择“LCVista”。

    ![配置单一登录](./media/lcvista-tutorial/tutorial_lcvista_app.png) 
...
在本部分中，使用访问面板测试 Azure AD 单一登录配置。 单击访问面板中的“LCVista”磁贴，将重定向到组织登录页面。 成功登录后，将登录到 LCVista 应用程序。 有关访问面板的详细信息，请参阅[访问面板简介](../user-help/active-directory-saas-access-panel-introduction.md)。
