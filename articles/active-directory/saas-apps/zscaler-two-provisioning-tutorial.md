...
3. 若要添加 Zscaler Two，请单击**新的应用程序**在对话框顶部的按钮。

    ![“新增应用程序”按钮][3]

4. 在搜索框中键入“ZScaler Two”。

    ![Zscaler Two 预配](./media/zscaler-two-provisioning-tutorial/app-search.png)

5. 在结果面板中，选择**Zscaler Two**，然后单击**添加**按钮将 Zscaler Two 添加到 SaaS 应用程序列表。

    ![Zscaler Two 预配](./media/zscaler-two-provisioning-tutorial/app-search-results.png)

    ![Zscaler Two 预配](./media/zscaler-two-provisioning-tutorial/app-creation.png)
...
2. 从 SaaS 应用程序列表中选择 Zscaler Two。

    ![Zscaler Two 预配](./media/zscaler-two-provisioning-tutorial/app-instance-search.png)
