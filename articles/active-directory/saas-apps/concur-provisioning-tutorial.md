...
* 该客户端必须是在应用程序启用后显示的对话框窗口上单击“*是*”的客户端。 此单击将确认客户同意合作伙伴应用程序访问其数据，因此你或合作伙伴无法单击该“是”按钮。
...
2. 从 **“管理”** 菜单中，选择 **“网络服务”**。
    ...
    ![Concur 租户](./media/concur-provisioning-tutorial/IC721729.png "Concur 租户")

3. 从左侧的 **“网络服务”** 窗格中，选择 **“启用合作伙伴应用程序”**。
   
    ![启用合作伙伴应用程序](./media/concur-provisioning-tutorial/ic721730.png "启用合作伙伴应用程序")

4. 从 **“启用应用程序”** 列表中选择 **“Azure Active Directory”**，然后单击 **“启用”**。
   
    ![Microsoft Azure Active Directory](./media/concur-provisioning-tutorial/ic721731.png "Microsoft Azure Active Directory")

5. 单击 **“确定”** 以关闭 **“确认操作”** 对话框。
