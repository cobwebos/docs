...
1. 若要在 Land Gorilla 端完成应用程序的 SSO 配置，请联系 [Land Gorilla 客户端支持团队](https://www.landgorilla.com/support/)并向他们提供下载的**元数据 XML** 文件。
