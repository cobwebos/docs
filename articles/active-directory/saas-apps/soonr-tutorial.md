...
* 可以在 Azure AD 中控制谁有权访问 Soonr Workplace。
...
* Soonr Workplace 支持 **SP 和 IDP** 发起的 SSO
...
若要正常使用单一登录，需要在 Azure AD 用户与 Soonr Workplace 相关用户之间建立链接关系。

若要配置和测试 Soonr Workplace 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 Soonr Workplace 单一登录](#configure-soonr-workplace-single-sign-on)** - 在应用程序端配置单一登录设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 Soonr Workplace 测试用户](#create-soonr-workplace-test-user)** - 在 Soonr Workplace 中创建 Britta Simon 的对应用户，并将其关联到其在 Azure AD 中的表示形式。
...
1. 在 [Azure 门户](https://portal.azure.com/)中的“Soonr Workplace”应用程序集成页上，选择“单一登录”。  
...
7. 在“设置 Soonr Workplace”部分，根据要求复制相应的 URL。 
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”、“Soonr Workplace”。   

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在应用程序列表中，选择“Soonr Workplace”  。

    ![“应用程序”列表中的“Soonr Workplace”链接](common/all-applications.png)
