...
1. [创建 Kantega SSO for JIRA 测试用户](#creating-a-kantega-sso-for-jira-test-user) - 在 Kantega SSO for JIRA 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 身份。
...
1. 在“IDP”发起的模式下，在“Kantega SSO for JIRA 域和 URL”部分，执行以下步骤：
...
1. 在应用程序列表中，选择“Kantega SSO for JIRA”。
