...
1. 在结果面板中，选择“Samanage”，并单击“添加”按钮添加该应用程序。
...
1. [创建 Samanage 测试用户](#creating-a-samanage-test-user) - 在 Samanage 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 身份。
...
1. 在“Samanage 域和 URL”部分中，执行以下步骤：
...
1. 键入要预配的 Azure Active Directory 帐户的“名称”和“电子邮件地址”，并单击“创建用户”。
