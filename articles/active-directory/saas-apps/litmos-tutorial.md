...
1. 在搜索框中，键入“Litmos”，在结果面板中选择“Litmos”，然后单击“添加”按钮添加应用程序。
...
1. [创建 Litmos 测试用户](#create-a-litmos-test-user) - 在 Litmos 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 身份。
...
1. 在配置过程中，需要为 Litmos 应用程序自定义 **SAML 令牌属性**。
...
1. 在“集成”选项卡上，向下滚动到“第三方集成”，并单击“SAML 2.0”选项卡。
   
    ![SAML 2.0 部分][24] 

1. 复制“Litmos 的 SAML 终结点:”下的值并将其粘贴到 Azure 门户中“Litmos 域和 URL”部分中的“回复 URL”文本框。 
   
    ![SAML 终结点][26] 

1. 在 **Litmos** 应用程序中，执行以下步骤：
