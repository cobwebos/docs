...
1. 在搜索框中，键入“Yodeck”，在结果面板中选择“Yodeck”，然后单击“添加”按钮添加该应用程序。
...
1. **[创建 Yodeck 测试用户](#create-a-yodeck-test-user)** - 在 Yodeck 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
1. 在“Yodeck 域和 URL”部分，如果要在“IDP”发起的模式下配置应用程序，请执行以下步骤：
...
1. 单击页面右上角的“用户设置”选项表单，然后选择“用户”。

    ![添加员工](./media/yodeck-tutorial/user1.png)

1. 单击“+用户”以打开“用户详细信息”选项卡。
...
1. 在“用户详细信息”对话框页上，执行以下步骤：
    ...
    c. 在中**电子邮件**文本框中，键入用户电子邮件地址，例如**brittasimon\@contoso.com**。
