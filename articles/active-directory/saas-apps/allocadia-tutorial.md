...
4. 在“搜索框”中，键入“Allocadia”。
    ...
    ![创建 Azure AD 测试用户](./media/allocadia-tutorial/tutorial_allocadia_search.png)

5. 在“结果”窗格中，选择“Allocadia”，然后单击“添加”按钮，添加该应用程序。

    ![创建 Azure AD 测试用户](./media/allocadia-tutorial/tutorial_allocadia_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/allocadia-tutorial/tutorial_allocadia_samlbase.png)
...
4. Allocadia 应用程序需要采用特定格式的 SAML 断言。 请为此应用程序配置以下声明。 可以在应用程序集成页的“用户属性”部分管理这些属性的值。 以下屏幕截图显示了此配置的示例。 
    ...
    ![配置单一登录](./media/allocadia-tutorial/tutorial_allocadia_attributes.png)
...
5. 在“单一登录”对话框的“用户属性”部分，按图中所示配置 SAML 令牌属性，然后执行以下步骤：
    ...
    ![配置单一登录](./media/allocadia-tutorial/tutorial_attribute_05.png)
...
6. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![配置单一登录](./media/allocadia-tutorial/tutorial_allocadia_certificate.png) 


7. 单击“保存”按钮。

    ![配置单一登录](./media/allocadia-tutorial/tutorial_general_400.png)
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/allocadia-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/allocadia-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/allocadia-tutorial/create_aaduser_03.png) 
...
2. 在应用程序列表中，选择“Allocadia”。
    ...
    ![配置单一登录](./media/allocadia-tutorial/tutorial_allocadia_app.png) 
