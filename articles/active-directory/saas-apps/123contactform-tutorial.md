...
4. 在搜索框中，键入“123ContactForm”。
    ...
    ![创建 Azure AD 测试用户](./media/123contactform-tutorial/tutorial_123contactform_search.png)

5. 在结果窗格中，选择“123ContactForm”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/123contactform-tutorial/tutorial_123contactform_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/123contactform-tutorial/tutorial_123contactform_samlbase.png)
...
5. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![配置单一登录](./media/123contactform-tutorial/tutorial_123contactform_certificate.png) 

6. 单击“保存”按钮。

    ![配置单一登录](./media/123contactform-tutorial/tutorial_general_400.png)
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/123contactform-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/123contactform-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/123contactform-tutorial/create_aaduser_03.png) 
...
2. 在应用程序列表中，选择“123ContactForm”。
    ...
    ![配置单一登录](./media/123contactform-tutorial/tutorial_123contactform_app.png) 
