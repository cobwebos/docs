...
1. 在搜索框中，键入“Sequr”，在结果面板中选择“Sequr”，然后单击“添加”按钮添加该应用程序。

    ![结果列表中的 Sequr](./media/sequr-tutorial/tutorial_sequr_addfromgallery.png)
...
1. **[创建 Sequr 测试用户](#create-a-sequr-test-user)** - 在 Sequr 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/sequr-tutorial/tutorial_sequr_samlbase.png)

1. 在“Sequr 域和 URL”部分中，如果要在 **IDP** 发起的模式下配置应用程序，请执行以下步骤：

    ![Sequr 域和 URL 单一登录信息](./media/sequr-tutorial/tutorial_sequr_url.png)
...
1. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。
    ...
    ![证书下载链接](./media/sequr-tutorial/tutorial_sequr_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/sequr-tutorial/tutorial_general_400.png)
    
1. 在“Sequr 配置”部分中，单击“配置 Sequr”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 单一登录服务 URL”

    ![Sequr 配置](./media/sequr-tutorial/tutorial_sequr_configure.png)

1. 在另一个 Web 浏览器窗口中，以管理员身份登录到 Sequr 公司站点。

1. 单击左侧导航面板中的“集成”。

    ![Sequr 配置](./media/sequr-tutorial/configure1.png)

1. 向下滚动到“单一登录”部分并单击“管理”。

    ![Sequr 配置](./media/sequr-tutorial/configure2.png)
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/sequr-tutorial/create_aaduser_01.png)

1. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/sequr-tutorial/create_aaduser_02.png)

1. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/sequr-tutorial/create_aaduser_03.png)
...
在本部分中，将在 Sequr 中创建一个名为 Britta Simon 的用户。 与  [Sequr 客户端支持团队](mailto:support@sequr.io) 协作，将用户添加到 Sequr 平台中。 使用单一登录前，必须先创建并激活用户。 
...
1. 在应用程序列表中，选择“Sequr”。
    ...
    ![应用程序列表中的 Sequr 链接](./media/sequr-tutorial/tutorial_sequr_app.png)  
