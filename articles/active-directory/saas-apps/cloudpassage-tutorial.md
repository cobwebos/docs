...
1. [创建 CloudPassage 测试用户](#creating-a-cloudpassage-test-user) - 在 CloudPassage 中创建 Britta Simon 的对应用户，将其链接到用户的 Azure AD 表示形式。
...
1. 在“CloudPassage 域和 URL”部分中，执行以下步骤：
...
1. CloudPassage 应用程序需要特定格式的 SAML 断言，这要求向 SAML 令牌属性配置添加自定义属性映射。 以下屏幕截图显示一个示例。
...
1. 在“CloudPassage 配置”部分中，单击“配置 CloudPassage”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。
