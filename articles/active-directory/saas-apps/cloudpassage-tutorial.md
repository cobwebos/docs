...
4. 在搜索框中，键入“CloudPassage”。

    ![创建 Azure AD 测试用户](./media/cloudpassage-tutorial/tutorial_cloudpassage_search.png)

5. 在结果面板中，选择“CloudPassage”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/cloudpassage-tutorial/tutorial_cloudpassage_addfromgallery.png)
...
通过将 Azure AD 中“用户名”的值指定为 CloudPassage 中“用户名”的值来建立此链接关系。

若要配置并测试 CloudPassage 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configuring-azure-ad-single-sign-on)** - 让用户使用此功能。
2. **[创建 Azure AD 测试用户](#creating-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
3. [创建 CloudPassage 测试用户](#creating-a-cloudpassage-test-user) - 在 CloudPassage 中创建 Britta Simon 的对应用户，将其链接到用户的 Azure AD 表示形式。
4. **[分配 Azure AD 测试用户](#assigning-the-azure-ad-test-user)** - 让 Britta Simon 使用 Azure AD 单一登录。
5. **[测试单一登录](#testing-single-sign-on)** - 验证配置是否正常工作。

### <a name="configuring-azure-ad-single-sign-on"></a>配置 Azure AD 单一登录

在本部分中，将在 Azure 门户中启用 Azure AD 单一登录并在 CloudPassage 应用程序中配置单一登录。

**若要配置 CloudPassage 的 Azure AD 单一登录，请执行以下步骤：**

1. 在 Azure 门户中的“CloudPassage”应用程序集成页上，单击“单一登录”。

    ![配置单一登录][4]

2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
 
    ![配置单一登录](./media/cloudpassage-tutorial/tutorial_cloudpassage_samlbase.png)

3. 在“CloudPassage 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/cloudpassage-tutorial/tutorial_cloudpassage_url.png)
...
4. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。
    ...
    ![配置单一登录](./media/cloudpassage-tutorial/tutorial_cloudpassage_certificate.png) 

5. CloudPassage 应用程序需要特定格式的 SAML 断言，这要求向 SAML 令牌属性配置添加自定义属性映射。 以下屏幕截图显示一个示例。
   
   ![配置单一登录](./media/cloudpassage-tutorial/tutorial_cloudpassage_25.png) 
...
6. 在“单一登录”对话框的“用户属性”部分中，按上图所示配置 SAML 令牌属性，并执行以下步骤：
    ...
    ![配置单一登录](./media/cloudpassage-tutorial/tutorial_attribute_04.png)
    
    ![配置单一登录](./media/cloudpassage-tutorial/tutorial_attribute_05.png)
...
7. 单击“保存”按钮。
    ...
    ![配置单一登录](./media/cloudpassage-tutorial/tutorial_general_400.png)
    
8. 在“CloudPassage 配置”部分中，单击“配置 CloudPassage”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![配置单一登录](./media/cloudpassage-tutorial/tutorial_cloudpassage_configure.png) 
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/cloudpassage-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/cloudpassage-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/cloudpassage-tutorial/create_aaduser_03.png) 

4. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/cloudpassage-tutorial/create_aaduser_04.png) 
...
2. 在应用程序列表中，选择“CloudPassage”。
    ...
    ![配置单一登录](./media/cloudpassage-tutorial/tutorial_cloudpassage_app.png) 
