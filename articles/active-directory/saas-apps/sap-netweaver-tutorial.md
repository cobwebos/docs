...
将 SAP NetWeaver 与 Azure AD 集成可提供以下优势：
...
1. 在搜索框中，键入“SAP NetWeaver”。

    ![创建 Azure AD 测试用户](./media/sap-netweaver-tutorial/tutorial_sapnetweaver_search.png)

1. 在结果窗格中，选择“SAP NetWeaver”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/sap-netweaver-tutorial/tutorial_sapnetweaver_addfromgallery.png)
...
1. **[创建 SAP NetWeaver 测试用户](#creating-an-sap-netweaver-test-user)** - 在 SAP NetWeaver 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在 Azure 门户中的 SAP NetWeaver 应用程序集成页上，单击“单一登录”。

    ![配置单一登录][4]

1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
 
    ![配置单一登录](./media/sap-netweaver-tutorial/tutorial_sapnetweaver_samlbase.png)

1. 在“SAP NetWeaver 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/sap-netweaver-tutorial/tutorial_sapnetweaver_url.png)

    a. 在“登录 URL”文本框中，使用以下模式键入 URL： `https://<your company instance of SAP NetWeaver>`
...
1. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存 XML 文件。
    ...
    ![配置单一登录](./media/sap-netweaver-tutorial/tutorial_sapnetweaver_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录](./media/sap-netweaver-tutorial/tutorial_general_400.png)
    
1. 在“SAP NetWeaver 配置”部分，单击“配置 SAP NetWeaver”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 实体 ID”。

    ![配置单一登录](./media/sap-netweaver-tutorial/tutorial_sapnetweaver_configure.png) 

1. 若要在 SAP NetWeaver 端配置单一登录，需要将下载的元数据 XML 和 SAML 实体 ID 发送给 [SAP NetWeaver 支持团队](https://www.sap.com/support.html)。 
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/sap-netweaver-tutorial/create_aaduser_01.png) 

1. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/sap-netweaver-tutorial/create_aaduser_02.png) 

1. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/sap-netweaver-tutorial/create_aaduser_03.png) 

1. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/sap-netweaver-tutorial/create_aaduser_04.png) 
...
1. 在应用程序列表中，选择“SAP NetWeaver”。
    ...
    ![配置单一登录](./media/sap-netweaver-tutorial/tutorial_sapnetweaver_app.png) 
...
单击访问面板中的 SAP NetWeaver 磁贴时，应当会自动登录到 SAP NetWeaver 应用程序。
