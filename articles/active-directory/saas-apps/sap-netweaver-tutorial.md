...
3. 在“SAP NetWeaver 域和 URL”部分中，执行以下步骤：
...
6. 在“SAP NetWeaver 配置”部分，单击“配置 SAP NetWeaver”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 实体 ID”。

    ![配置单一登录](./media/sap-netweaver-tutorial/tutorial_sapnetweaver_configure.png) 

7. 若要在 SAP NetWeaver 端配置单一登录，需要将下载的元数据 XML 和 SAML 实体 ID 发送给 [SAP NetWeaver 支持团队](https://www.sap.com/support.html)。 
