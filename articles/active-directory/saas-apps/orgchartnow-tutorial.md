...
1. 在搜索框中键入“OrgChart Now”，在结果面板中选择“OrgChart Now”，然后单击“添加”按钮添加应用程序。

    ![结果列表中的 OrgChart Now](./media/orgchartnow-tutorial/tutorial_orgchartnow_addfromgallery.png)
...
1. **[创建 OrgChart Now 测试用户](#create-an-orgchart-now-test-user)** - 在 OrgChart Now 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/orgchartnow-tutorial/tutorial_orgchartnow_samlbase.png)

1. 在“OrgChart Now 域和 URL”部分中，如果要在“IDP 启动的模式”下配置应用程序，请执行以下步骤：

    ![OrgChart Now 域和 URL 单一登录信息](./media/orgchartnow-tutorial/tutorial_orgchartnow_url.png)
...
1. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![证书下载链接](./media/orgchartnow-tutorial/tutorial_orgchartnow_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/orgchartnow-tutorial/tutorial_general_400.png)
    
1. 在“OrgChart Now 配置”部分中，单击“配置 OrgChart Now”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 实体 ID”，并使用它完成“OrgChart Now 域和 URL”部分中的“登录 URL”。

    ![OrgChart Now 配置](./media/orgchartnow-tutorial/tutorial_orgchartnow_configure.png) 

1. 若要在 **OrgChart Now** 端配置单一登录，需要将下载的**元数据 XML** 发送给 [OrgChart Now 支持团队](mailto:ocnsupport@officeworksoftware.com)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/orgchartnow-tutorial/create_aaduser_01.png)

1. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/orgchartnow-tutorial/create_aaduser_02.png)

1. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/orgchartnow-tutorial/create_aaduser_03.png)
...
1. 若要创建**管理员**用户和**读/写**用户，必须手动创建用户，以通过 SSO 获取对其特权级别的访问。 若要预配用户帐户，请执行以下步骤：
...
1. 在应用程序列表中，选择“OrgChart Now”。
    ...
    ![应用程序列表中的 OrgChart Now 链接](./media/orgchartnow-tutorial/tutorial_orgchartnow_app.png)  
