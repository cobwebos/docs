...
1. 在搜索框中，键入“Fluxx Labs”，在结果面板中选择“Fluxx Labs”，然后单击“添加”按钮添加该应用程序。

    ![结果列表中的 Fluxx Labs](./media/fluxxlabs-tutorial/tutorial_fluxxlabs_addfromgallery.png)
...
1. **[创建 Fluxx Labs 测试用户](#create-a-fluxx-labs-test-user)** - 在 Fluxx Labs 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
1. 在“Fluxx Labs 域和 URL”部分执行以下步骤：

    ![Fluxx Labs 域和 URL 单一登录信息](./media/fluxxlabs-tutorial/tutorial_fluxxlabs_url.png)
...
1. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。
    ...
    ![证书下载链接](./media/fluxxlabs-tutorial/tutorial_fluxxlabs_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/fluxxlabs-tutorial/tutorial_general_400.png)

1. 在“Fluxx Labs 配置”部分，单击“配置 Fluxx Labs”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 单一登录服务 URL”

    ![Fluxx Labs 配置](./media/fluxxlabs-tutorial/tutorial_fluxxlabs_configure.png)

1. 在其他 Web 浏览器窗口中，以管理员身份登录 Fluxx Labs 公司站点。

1. 在“设置”部分下，选择“管理员”。

    ![Fluxx Labs 配置](./media/fluxxlabs-tutorial/config1.png)

1. 在管理面板中，选择“插件” > “集成”，然后选择“SAML SSO (已禁用)”
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/fluxxlabs-tutorial/create_aaduser_01.png)

1. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/fluxxlabs-tutorial/create_aaduser_02.png)

1. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/fluxxlabs-tutorial/create_aaduser_03.png)

1. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/fluxxlabs-tutorial/create_aaduser_04.png)
...
1. 在应用程序列表中，选择“Fluxx Labs”。
    ...
    ![应用程序列表中的 Fluxx Labs 链接](./media/fluxxlabs-tutorial/tutorial_fluxxlabs_app.png)  
