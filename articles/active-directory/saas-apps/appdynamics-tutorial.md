...
4. 在“搜索框”中键入“AppDynamics”。
    ...
    ![创建 Azure AD 测试用户](./media/appdynamics-tutorial/tutorial_appdynamics_search.png)

5. 在结果窗格中，选择“AppDynamics”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/appdynamics-tutorial/tutorial_appdynamics_addfromgallery.png)
...
5. 单击“保存”按钮。
    ...
    ![配置单一登录](./media/appdynamics-tutorial/tutorial_general_400.png)
