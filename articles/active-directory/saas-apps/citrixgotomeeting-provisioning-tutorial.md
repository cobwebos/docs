...
1. 在“管理员凭据”部分中，执行以下步骤：
    ...
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 在“GoToMeeting 管理员用户名”**** 文本框中，键入管理员的用户名。

    b.保留“数据库类型”设置，即设置为“共享”。 在“GoToMeeting 管理员密码”**** 文本框中，键入管理员密码。
...
* [配置单点登录](https://docs.microsoft.com/azure/active-directory/active-directory-saas-citrix-gotomeeting-tutorial)
