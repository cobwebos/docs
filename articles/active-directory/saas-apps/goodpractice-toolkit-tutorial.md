---
title: 教程：Azure Active Directory 与 GoodPractice Toolkit 集成 | Microsoft Docs
description: 了解如何在 Azure Active Directory 和 GoodPractice Toolkit 之间配置单一登录。
...
本教程介绍如何将 GoodPractice Toolkit 与 Azure Active Directory (Azure AD) 集成。
将 GoodPractice Toolkit 与 Azure AD 集成提供以下优势：

* 可在 Azure AD 中控制谁有权访问 GoodPractice Toolkit。
* 可让用户使用其 Azure AD 帐户自动登录到 GoodPractice Toolkit（单一登录）。
...
若要配置 Azure AD 与 GoodPractice Toolkit 的集成，需要准备好以下各项：

* 一个 Azure AD 订阅。 如果你没有 Azure AD 环境，可以在[此处](https://azure.microsoft.com/pricing/free-trial/)获取一个月的试用版。
* 已启用 GoodPractice Toolkit 单一登录的订阅
...
要配置 GoodPractice Toolkit 与 Azure AD 的集成，需要从库中将 GoodPractice Toolkit 添加到托管 SaaS 应用列表。
...
4. [创建 GoodPractice Toolkit 测试用户](#create-goodpractice-toolkit-test-user) - 在 GoodPractice Toolkit 中创建 Britta Simon 的对应用户，并将其关联到用户的 Azure AD 表示形式。
...
单击访问面板中的 GoodPractice Toolkit 磁贴时，应会自动登录到为其设置了 SSO 的 GoodPractice Toolkit。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
