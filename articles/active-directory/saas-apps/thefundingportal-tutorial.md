...
* 可让用户使用其 Azure AD 帐户自动登录到 The Funding Portal（单一登录）。
...
4. 在搜索框中键入“The Funding Portal”，在结果面板中选择“The Funding Portal”，然后单击“添加”按钮添加该应用程序。   

     ![结果列表中的 The Funding Portal](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分中，将基于名为“Britta Simon”的测试用户配置和测试 The Funding Portal 的 Azure AD 单一登录。 
若要正常使用单一登录，需要在 Azure AD 用户与 The Funding Portal 相关用户之间建立链接关系。

若要配置和测试 The Funding Portal 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 The Funding Portal 单一登录](#configure-the-funding-portal-single-sign-on)** - 在应用程序端配置单一登录设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 The Funding Portal 测试用户](#create-the-funding-portal-test-user)** - 在 The Funding Portal 中创建 Britta Simon 的对应用户，将其链接到用户的 Azure AD 表示形式。
...
1. 在 [Azure 门户](https://portal.azure.com/)中的“The Funding Portal”应用程序集成页上，选择“单一登录”。  
...
8. 在“设置 The Funding Portal”部分，根据要求复制相应的 URL  。
...
### <a name="configure-the-funding-portal-single-sign-on"></a>配置 The Funding Portal 单一登录
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”、“The Funding Portal”。   

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在应用程序列表中，选择“The Funding Portal”  。

    ![应用程序列表中的 The Funding Portal 链接](common/all-applications.png)
...
在本部分中，会在 The Funding Portal 中创建一个名为“Britta Simon”的用户。 与  [The Funding Portal 支持团队](mailto:info@regenteducation.com)协作，在 The Funding Portal 平台中添加用户。 使用单一登录前，必须先创建并激活用户。
