...
在本部分中，我们将在 CyberArk SAML Authentication 中创建名为 B.Simon 的用户。 在  [CyberArk SAML Authentication 支持团队](mailto:bizdevtech@cyberark.com)的配合下，将用户添加到 CyberArk SAML Authentication 平台。 使用单一登录前，必须先创建并激活用户。
