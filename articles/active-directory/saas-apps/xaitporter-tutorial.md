...
3. **[创建 XaitPorter 测试用户](#create-a-xaitporter-test-user)** - 在 XaitPorter 中创建 Britta Simon 的对应用户，将其链接到该用户的 Azure AD 表示形式。
...
3. 在“XaitPorter 域和 URL”部分中，执行以下步骤：

    ![XaitPorter 域和 URL 单一登录信息](./media/xaitporter-tutorial/tutorial_xaitporter_url.png)

    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，并单击“添加引用”。 在“登录 URL”文本框中，使用以下模式键入 URL： `https://<subdomain>.xaitporter.com/saml/login`
...
9. 从“系统设置”下拉列表中选择“管理单一登录”。

    ![配置单一登录](./media/xaitporter-tutorial/user2.png)

10. 在“管理单一登录”部分中执行以下步骤：

    ![配置单一登录](./media/xaitporter-tutorial/user3.png)

    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，并单击“添加引用”。 选择“启用单一登录身份验证”。
