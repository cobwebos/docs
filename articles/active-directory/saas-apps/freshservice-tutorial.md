...
1. 在搜索框中，键入“Freshservice”。

    ![创建 Azure AD 测试用户](./media/freshservice-tutorial/tutorial_freshservice_search.png)

1. 在结果窗格中，选择“Freshservice”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/freshservice-tutorial/tutorial_freshservice_addfromgallery.png)
...
1. [创建 Freshservice 测试用户](#creating-a-freshservice-test-user) - 在 Freshservice 中创建 Britta Simon 的对应用户，将其链接到用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/freshservice-tutorial/tutorial_freshservice_samlbase.png)

1. 在“Freshservice 域和 URL”部分中，请执行以下步骤：
...
1. 单击“保存”按钮。
    ...
    ![配置单一登录](./media/freshservice-tutorial/tutorial_general_400.png)

1. 在“Freshservice 配置”部分，单击“配置 Freshservice”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL 和 SAML 单一登录服务 URL”。

    ![配置单一登录](./media/freshservice-tutorial/tutorial_freshservice_configure.png) 

1. 在另一 Web 浏览器窗口中，以管理员身份登录到 Freshservice 公司站点。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/freshservice-tutorial/create_aaduser_01.png) 

1. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/freshservice-tutorial/create_aaduser_02.png) 

1. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/freshservice-tutorial/create_aaduser_03.png) 

1. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/freshservice-tutorial/create_aaduser_04.png) 
...
1. 在应用程序列表中，选择“Freshservice”。
    ...
    ![配置单一登录](./media/freshservice-tutorial/tutorial_freshservice_app.png) 
