...
ms.openlocfilehash: 89ae12d1f4b4add9eca0854c5e16853a65619042
ms.sourcegitcommit: 50ea09d19e4ae95049e27209bd74c1393ed8327e
ms.translationtype: HT
ms.contentlocale: zh-CN
ms.lasthandoff: 02/26/2019
ms.locfileid: "56871649"
---
...
4. **[创建 Workable 测试用户](#create-workable-test-user)** - 在 Workable 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
启用单一登录后，Workable 帐户管理员会通知你，随后便可以使用 Workable 帐户子域通过 [Workable 的 SSO 页](https://www.workable.com/sso/signin)进行登录。
