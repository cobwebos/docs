...
* 可让用户使用其 Azure AD 帐户自动登录到 Gra-Pe（单一登录）。
...
2. **[配置 Gra-Pe 单一登录](#configure-gra-pe-single-sign-on)** - 在应用程序端配置单一登录。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 Gra-Pe 测试用户](#create-gra-pe-test-user)** - 在 Gra-Pe 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
### <a name="create-gra-pe-test-user"></a>创建 Gra-Pe 测试用户
...
单击访问面板中的 Gra-Pe 磁贴时，应当会自动登录到为其设置了 SSO 的 Gra-Pe。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
