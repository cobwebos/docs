...
1. 在“基本 SAML 配置”页上，输入以下字段的值  ：
   ...
   1. 在“回复 URL”文本框中，使用以下模式键入任一 URL：
      ...
      | Smartphone 应用 |`https://internal.api.sansan.com/<company name>/acs` |
      | Smartphone Web |`https://ap.sansan.com/s/saml2/<company name>/acs` |

    > [!NOTE]
    > 这些不是实际值。 检查“Sansan 管理员设置”上的实际值。
...
在本部分中，会在 Sansan 中创建一个名为“Britta Simon”的用户。 若要详细了解如何创建用户，请参阅[此处](https://jp-help.sansan.com/hc/en-us/articles/206508997-Adding-users)的步骤。
