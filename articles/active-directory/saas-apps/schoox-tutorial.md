...
4. 在搜索框中，键入“Schoox”，在结果面板中选择“Schoox”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 Schoox](./media/schoox-tutorial/tutorial_schoox_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/schoox-tutorial/tutorial_schoox_samlbase.png)

3. 在“Schoox 域和 URL”部分中，如果要在 **IDP** 发起的模式下配置应用程序，请执行以下步骤：

    ![Schoox 域和 URL 单一登录信息](./media/schoox-tutorial/tutorial_schoox_url.png)

    在“标识符”文本框中，键入一个 URL：`https://saml.schoox.com/saml/adfsmetadata`

4. 如果要在 SP 发起的模式下配置应用程序，请选中“显示高级 URL 设置”，并执行以下步骤：

    ![Schoox 域和 URL 单一登录信息](./media/schoox-tutorial/tutorial_schoox_url1.png)
...
5. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![证书下载链接](./media/schoox-tutorial/tutorial_schoox_certificate.png) 

6. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/schoox-tutorial/tutorial_general_400.png)

7. 在“Schoox 配置”部分中，单击“配置 Schoox ”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 实体 ID”，并使用它完成“Schoox 域和 URL”部分中的“登录 URL”。 

    ![Schoox 配置](./media/schoox-tutorial/config.png)
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/schoox-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/schoox-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/schoox-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/schoox-tutorial/create_aaduser_04.png)
...
2. 在应用程序列表中，选择“Schoox”。
    ...
    ![应用程序列表中的 Schoox 链接](./media/schoox-tutorial/tutorial_schoox_app.png)  
