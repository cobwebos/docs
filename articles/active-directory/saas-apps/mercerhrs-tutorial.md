...
1. 在搜索框中，键入“Mercer BenefitsCentral (MBC)”，在结果面板中选择“Mercer BenefitsCentral (MBC)”，然后单击“添加”按钮添加应用程序。
...
1. [创建 Mercer BenefitsCentral (MBC) 测试用户](#create-a-mercer-benefitscentral-mbc-test-user) - 在 Mercer BenefitsCentral (MBC) 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
1. 在“Mercer BenefitsCentral (MBC) 域和 URL”部分，执行以下步骤：

    ![Mercer BenefitsCentral (MBC) 域和 URL 单一登录信息](./media/mercerhrs-tutorial/tutorial_mercerhrs_url.png)

    a. 在“标识符”文本框中，使用以下模式键入 URL：`stg.mercerhrs.com/saml2.0`
...
1. 在“Mercer BenefitsCentral (MBC) 配置”部分，单击“Mercer BenefitsCentral (MBC)”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 单一登录服务 URL”
...
1. 在应用程序列表中，选择“Mercer BenefitsCentral (MBC)”。
