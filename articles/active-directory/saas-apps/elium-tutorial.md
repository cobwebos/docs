...
## <a name="configure-and-test-azure-ad-single-sign-on-for-elium"></a>配置并测试 Elium 的 Azure AD 单一登录
...
1. 在 [Azure 门户](https://portal.azure.com/)的“Elium”应用程序集成页上，找到“管理”部分，选择“单一登录”    。
...
- [在 Azure AD 中试用 Elium](https://aad.portal.azure.com/)