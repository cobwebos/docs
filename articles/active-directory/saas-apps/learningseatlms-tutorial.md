---
title: 教程：Azure Active Directory 与 Learning Seat LMS 集成 | Microsoft Docs
...
1. 在搜索框中，键入“Learning Seat LMS”。

    ![创建 Azure AD 测试用户](./media/learningseatlms-tutorial/tutorial_learnconnect_search.png)

1. 在结果面板中，选择“Learning Seat LMS”，然后单击“添加”按钮添加该应用程序。
...
1. **[创建 Learning Seat LMS 测试用户](#creating-a-learnconnect-test-user)** - 在 Learning Seat LMS 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/learningseatlms-tutorial/tutorial_learnconnect_samlbase.png)

1. 若要在“IDP”启动的模式下配置应用程序，请在“Learning Seat LMS 域和 URL”部分执行以下步骤：

    ![配置单一登录](./media/learningseatlms-tutorial/tutorial_learnconnect_url.png)
...
1. 如果要在“SP”发起的模式下配置应用程序，请选中“显示高级 URL 设置”：
    ...
    ![配置单一登录](./media/learningseatlms-tutorial/tutorial_learnconnect_url2.png)
...
1. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![配置单一登录](./media/learningseatlms-tutorial/tutorial_learnconnect_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录](./media/learningseatlms-tutorial/tutorial_general_400.png)

1. 若要在 Learning Seat LMS 端配置单一登录，需要将下载的元数据 XML 发送给 [Learning Seat 支持团队](http://help.learningseatlms.com/help)。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/learningseatlms-tutorial/create_aaduser_01.png) 

1. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/learningseatlms-tutorial/create_aaduser_02.png) 

1. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/learningseatlms-tutorial/create_aaduser_03.png) 

1. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/learningseatlms-tutorial/create_aaduser_04.png) 
...
1. 在应用程序列表中，选择“Learning Seat LMS”。

    ![配置单一登录](./media/learningseatlms-tutorial/tutorial_learnconnect_app.png) 
...
单击访问面板中的 Learning Seat LMS 磁贴，将自动登录到 Learning Seat LMS 应用程序。 有关访问面板的详细信息，请参阅[访问面板简介](../user-help/active-directory-saas-access-panel-introduction.md)。
