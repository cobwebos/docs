...
1. 在结果面板中，选择“Kintone”，然后单击“添加”按钮添加该应用程序。
...
1. **[创建 Kintone 测试用户](#creating-a-kintone-test-user)** - 在 Kintone 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在“Kintone 配置”部分，单击“配置 Kintone”打开“配置登录”窗口。 从“快速参考”部分中复制注销 URL 和 SAML 单一登录服务 URL。
