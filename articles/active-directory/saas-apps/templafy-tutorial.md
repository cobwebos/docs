---
title: 教程：Azure Active Directory 单一登录 (SSO) 与 Templafy 的集成 | Microsoft Docs
...
ms.locfileid: "74081614"
---
# <a name="tutorial-azure-active-directory-single-sign-on-sso-integration-with-templafy"></a>教程：Azure Active Directory 单一登录 (SSO) 与 Templafy 的集成

在本教程中，了解如何将 Templafy 与 Azure Active Directory (Azure AD) 集成。 将 Templafy 与 Azure AD 集成后，可以执行以下操作：

* 在 Azure AD 中控制谁有权访问 Templafy。
* 让用户使用其 Azure AD 帐户自动登录到 Templafy。
...
1. 在“从库中添加”部分的搜索框中，键入“Templafy”   。
1. 从结果面板中选择“Templafy”，然后添加该应用  。 在该应用添加到租户时等待几秒钟。

## <a name="configure-and-test-azure-ad-single-sign-on-for-templafy"></a>配置并测试 Templafy 的 Azure AD 单一登录

使用名为 B.Simon 的测试用户配置和测试 Templafy 的 Azure AD SSO  。 若要运行 SSO，需要在 Azure AD 用户与 Templafy 相关用户之间建立链接关系。

若要配置和测试 Templafy 的 Azure AD SSO，请完成以下构建基块：

1. **[配置 Azure AD SSO](#configure-azure-ad-sso)** - 使用户能够使用此功能。
    * **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 B. Simon 测试 Azure AD 单一登录。
    * **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 B. Simon 能够使用 Azure AD 单一登录。
1. **[配置 Templafy SSO](#configure-templafy-sso)** - 在应用程序端配置单一登录设置。
    * [创建 Templafy 测试用户](#create-templafy-test-user) - 在 Templafy 中创建 B.Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式  。
...
1. 在 [Azure 门户](https://portal.azure.com/)的“Templafy”应用程序集成页上，找到“管理”部分，选择“单一登录”    。
...
1. Templafy 应用程序需要特定格式的 SAML 断言，这要求向 SAML 令牌属性配置添加自定义属性映射。 以下屏幕截图显示了默认属性的列表。

    ![image](common/default-attributes.png)

1. 除了上述属性，Templafy 应用程序还要求在 SAML 响应中传递回更多的属性，如下所示。 这些属性也是预先填充的，但可以根据要求查看它们。
...
在本部分中，将通过授予 B.Simon 访问 Templafy 的权限，允许其使用 Azure 单一登录。

1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”。  
1. 在应用程序列表中，选择“Templafy”。 
...
## <a name="configure-templafy-sso"></a>配置 Templafy SSO
...
- [使用 Azure AD 试用 Templafy](https://aad.portal.azure.com/)