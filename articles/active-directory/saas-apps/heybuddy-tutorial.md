...
* 可让用户使用其 Azure AD 帐户自动登录到 HeyBuddy（单一登录）。
...
4. 在搜索框中，键入“HeyBuddy”，在结果面板中选择“HeyBuddy”，然后单击“添加”按钮添加该应用程序    。
     ...
     ![结果列表中的 HeyBuddy](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>配置和测试 Azure AD 单一登录

在本部分，我们基于一个名为“Britta Simon”的测试用户使用 HeyBuddy 配置和测试 Azure AD 单一登录。 
若要使单一登录有效，需要在 Azure AD 用户与 HeyBuddy 相关用户之间建立链接关系。

若要配置和测试 HeyBuddy 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 HeyBuddy 单一登录](#configure-heybuddy-single-sign-on)** - 在应用程序端配置“单一登录”设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 HeyBuddy 测试用户](#create-heybuddy-test-user)** - 在 HeyBuddy 中创建 Britta Simon 的对应用户，将其链接到该用户的 Azure AD 表示形式。
...
1. 在 [Azure 门户](https://portal.azure.com/)中的 **HeyBuddy** 应用程序集成页上，选择“单一登录”。 
...
### <a name="configure-heybuddy-single-sign-on"></a>配置 HeyBuddy 单一登录
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”和“HeyBuddy”    。

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在应用程序列表中，选择“HeyBuddy”  。

    ![应用程序列表中的 HeyBuddy 链接](common/all-applications.png)
