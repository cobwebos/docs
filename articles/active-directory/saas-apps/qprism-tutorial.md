...
1. 在搜索框中，键入“QPrism”，在结果面板中选择“QPrism”。 然后，单击“添加”按钮以添加该应用程序。

    ![结果列表中的 QPrism](./media/qprism-tutorial/tutorial_qprism_addfromgallery.png)
...
1. [创建 QPrism 测试用户](#create-a-qprism-test-user)，在 QPrism 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/qprism-tutorial/tutorial_qprism_samlbase.png)

1. 在“QPrism 域和 URL”部分中，执行以下操作：
...
1. 在“SAML 签名证书”部分上，单击”复制”按钮来复制**应用联合元数据 URL**，并将其粘贴到记事本。
     ...
     ![证书下载链接](./media/qprism-tutorial/tutorial_qprism_certificate.png)

1. 选择“保存”。

    ![配置单一登录“保存”按钮](./media/qprism-tutorial/tutorial_general_400.png)
    
1. 若要在“QPrism”端配置单一登录，需将应用联合元数据 URL 发送给 [QPrism 支持团队](mailto:qsupport-ce@quatrro.com)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
1. 在 Azure 门户的左窗格中，选择“Azure Active Directory”。
    ...
    ![“Azure Active Directory”按钮](./media/qprism-tutorial/create_aaduser_01.png)

1. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/qprism-tutorial/create_aaduser_02.png)

1. 若要打开“用户”对话框，请在“所有用户”对话框顶部选择“添加”。

    ![“添加”按钮](./media/qprism-tutorial/create_aaduser_03.png)
...
1. 在应用程序列表中，选择“QPrism”。

    ![应用程序列表中的 QPrism 链接](./media/qprism-tutorial/tutorial_qprism_app.png)  

1. 在左侧菜单中，选择“用户和组”。

    ![“用户和组”链接][202]

1. 选择 **添加** 。 然后，在“添加分配”下，选择“用户和组”。

    ![“添加分配”窗格][203]

1. 在“用户和组”对话框中，在“用户”列表中选择“Britta Simon”。
