...
* 可让用户使用其 Azure AD 帐户自动登录到 RingCentral（单一登录）。
...
本部分根据名为“Britta Simon”的测试用户的情况配置和测试 RingCentral 的 Azure AD 单一登录。
若要使单一登录有效，需要在 Azure AD 用户与 RingCentral 相关用户之间建立链接关系。

若要配置并测试 RingCentral 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 RingCentral 单一登录](#configure-ringcentral-single-sign-on)** - 在应用程序端配置单一登录。
...
4. 在“基本 SAML 配置”部分，如果有**服务提供程序元数据文件**，请执行以下步骤：
    ...
    ![RingCentral 域和 URL 单一登录信息](common/sp-identifier-reply.png)
...
### <a name="configure-ringcentral-single-sign-on"></a>配置 RingCentral 单一登录
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”和“RingCentral”。
...
在访问面板中单击“RingCentral”磁贴时，应会自动登录到设置了 SSO 的 RingCentral。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
