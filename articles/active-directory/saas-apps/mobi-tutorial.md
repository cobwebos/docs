...
1. 在搜索框中，键入“MOBI”，在结果面板中选择“MOBI”，然后单击“添加”按钮添加该应用程序。
...
1. **[创建 MOBI 测试用户](#create-a-mobi-test-user)** - 在 MOBI 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
1. 在“MOBI 域和 URL”部分中，如果要在“IDP”发起的模式下配置应用程序，请执行以下步骤：
