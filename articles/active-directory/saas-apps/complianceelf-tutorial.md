...
4. 在搜索框中，键入“Compliance ELF”，在结果面板中选择“Compliance ELF”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 Compliance ELF](./media/complianceelf-tutorial/tutorial_complianceelf_addfromgallery.png)
...
6. 单击“保存”按钮。
    ...
    ![配置单一登录“保存”按钮](./media/complianceelf-tutorial/tutorial_general_400.png)
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/complianceelf-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/complianceelf-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/complianceelf-tutorial/create_aaduser_03.png)
...
2. 在应用程序列表中，选择“Compliance ELF”。
    ...
    ![应用程序列表中的 Compliance ELF 链接](./media/complianceelf-tutorial/tutorial_complianceelf_app.png)  
