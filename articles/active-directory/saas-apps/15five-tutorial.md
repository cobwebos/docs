...
4. 在“搜索框”中，键入“15Five”。
    ...
    ![创建 Azure AD 测试用户](./media/15five-tutorial/tutorial_15five_search.png)

5. 在结果面板中，选择“15Five”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/15five-tutorial/tutorial_15five_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/15five-tutorial/tutorial_15five_samlbase.png)
...
4. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![配置单一登录](./media/15five-tutorial/tutorial_15five_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录](./media/15five-tutorial/tutorial_general_400.png)
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/15five-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/15five-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/15five-tutorial/create_aaduser_03.png) 
...
2. 在应用程序列表中，选择“15Five”。
    ...
    ![配置单一登录](./media/15five-tutorial/tutorial_15five_app.png) 
