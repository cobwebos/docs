...
1. 在搜索框中键入 **Trisotech Digital Enterprise Server**，在结果面板中选择“Trisotech Digital Enterprise Server”，然后单击“添加”按钮添加该应用程序。
...
1. **[创建 Trisotech Digital Enterprise Server 测试用户](#create-a-trisotech-digital-enterprise-server-test-user)** - 在 Trisotech Digital Enterprise Server 中创建 Britta Simon 的对应用户，并将其链接到该用户在 Azure AD 中的表示形式。
...
1. 在“Trisotech Digital Enterprise Server 域和 URL”部分中执行以下步骤：
...
1. 在应用程序列表中选择“Trisotech Digital Enterprise Server”。
