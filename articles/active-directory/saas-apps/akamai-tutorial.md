...
1. 如果要在“IDP”发起的模式下配置应用程序，请在“基本 SAML 配置”部分中输入以下字段的值   ：
    ...
    a. 在“标识符”  文本框中，使用以下模式键入 URL：`https://<Yourapp>.login.go.akamai-access.com/sp/response`

    b. 在“回复 URL”  文本框中，使用以下模式键入 URL：`https:// <Yourapp>.login.go.akamai-access.com/sp/response`
...
1. 登录到“Akamai 企业应用程序访问”控制台。 
1. 在“Akamai EAA 控制台”上，选择“标识” > “标识提供者”。   
...
### <a name="kerberos-applications"></a>Kerberos 应用程序
...
![配置 Akamai](./media/header-akamai-tutorial/configure35.png)

![配置 Akamai](./media/header-akamai-tutorial/configure36.png)

### <a name="create-akamai-test-user"></a>创建 Akamai 测试用户

在本部分，你将在 Akamai 中创建名为 B.Simon 的用户。 在  [Akamai 客户端支持团队](https://www.akamai.com/us/en/contact-us/)的配合下，将用户添加到 Akamai 平台。 使用单一登录前，必须先创建并激活用户。 
