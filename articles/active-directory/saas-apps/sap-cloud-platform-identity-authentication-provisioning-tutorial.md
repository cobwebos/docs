...
本教程的目的是演示要在 SAP Cloud Platform Identity Authentication 和 Azure Active Directory (Azure AD) 中执行的步骤，以将 Azure AD 配置为自动将用户和/或组预配到 SAP Cloud Platform Identity Authentication 并取消其预配。
