...
1. [创建 Zscaler Beta 测试用户](#creating-a-zscaler-beta-test-user) - 在 Zscaler Beta 中创建 Britta Simon 的对应用户，其与用户的 Azure AD 表示形式相关联。
...
1. 在“Zscaler Beta 域和 URL”部分，执行以下步骤：
...
1. 在“Zscaler Beta 配置”部分，单击“配置 Zscaler Beta”，打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 单一登录服务 URL”
