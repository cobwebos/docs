...
1. 在搜索框中键入“SmartRecruiters”，在结果面板中选择“SmartRecruiters”，然后单击“添加”按钮添加该应用程序。

    ![结果列表中的 SmartRecruiters](./media/smartrecruiters-tutorial/tutorial_smartrecruiters_addfromgallery.png)
...
1. **[创建 SmartRecruiters 测试用户](#create-a-smartrecruiters-test-user)** - 在 SmartRecruiters 中创建 Britta Simon 的对应用户，并将其关联到用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/smartrecruiters-tutorial/tutorial_smartrecruiters_samlbase.png)

1. 在“SmartRecruiters 域和 URL”部分中，如果要在“IDP”发起的模式下配置应用程序，请执行以下步骤：

    ![SmartRecruiters 域和 URL 单一登录信息](./media/smartrecruiters-tutorial/tutorial_smartrecruiters_url.png)
...
1. 如果要在 SP 发起的模式下配置应用程序，请选中“显示高级 URL 设置”，并执行以下步骤：
    ...
    ![SmartRecruiters 域和 URL 单一登录信息](./media/smartrecruiters-tutorial/tutorial_smartrecruiters_url1.png)
...
1. 在“SAML 签名证书”部分中，单击“证书(Base64)”，并在计算机上保存证书。

    ![证书下载链接](./media/smartrecruiters-tutorial/tutorial_smartrecruiters_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录“保存”按钮](./media/smartrecruiters-tutorial/tutorial_general_400.png)
    
1. 在“SmartRecruiters 配置”部分中，单击“配置 SmartRecruiters ”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 单一登录服务 URL”

    ![SmartRecruiters 配置](./media/smartrecruiters-tutorial/tutorial_smartrecruiters_configure.png) 
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/smartrecruiters-tutorial/create_aaduser_01.png)

1. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/smartrecruiters-tutorial/create_aaduser_02.png)

1. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/smartrecruiters-tutorial/create_aaduser_03.png)

1. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/smartrecruiters-tutorial/create_aaduser_04.png)
...
1. 在应用程序列表中，选择“SmartRecruiters”。
    ...
    ![应用程序列表中的 SmartRecruiters 链接](./media/smartrecruiters-tutorial/tutorial_smartrecruiters_app.png)  
