...
3. 若要添加 Zscaler Beta，请单击**新的应用程序**在对话框顶部的按钮。

    ![“新增应用程序”按钮][3]

4. 在“搜索框”中，键入 Zscaler Beta。

    ![预配的 Zscaler Beta](./media/zscaler-beta-provisioning-tutorial/app-search.png)

5. 在结果面板中，选择**Zscaler Beta**，然后单击**添加**按钮将 Zscaler Beta 添加到 SaaS 应用程序列表。

    ![预配的 Zscaler Beta](./media/zscaler-beta-provisioning-tutorial/app-search-results.png)

    ![预配的 Zscaler Beta](./media/zscaler-beta-provisioning-tutorial/app-creation.png)
...
2. 从 SaaS 应用程序列表中选择 Zscaler Beta。

    ![预配的 Zscaler Beta](./media/zscaler-beta-provisioning-tutorial/app-instance-search.png)
