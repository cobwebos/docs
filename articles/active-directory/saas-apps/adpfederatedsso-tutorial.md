...
5. 在搜索框中，键入“ADP”，在结果面板中选择“ADP”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 ADP](./media/adpfederatedsso-tutorial/tutorial_adp_addfromgallery.png)
...
3. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/adpfederatedsso-tutorial/tutorial_adp_samlbase.png)

4. 在“ADP 域和 URL”部分中，执行以下步骤：

    ![ADP 域和 URL 单一登录信息](./media/adpfederatedsso-tutorial/tutorial_adp_url.png)
...
5. ADP 应用程序需要特定格式的 SAML 断言，这要求将自定义属性映射添加到 SAML 令牌属性配置。 以下屏幕截图显示一个示例。 声明名称始终是“PersonImmutableID”，其值已映射到 **employeeid**。 
    ...
    ![配置单一登录](./media/adpfederatedsso-tutorial/tutorial_adp_attribute.png)
...
6. 在“单一登录”对话框的“用户属性”部分，按图中所示配置 SAML 令牌属性，然后执行以下步骤：
    ...
    ![配置单一登录](./media/adpfederatedsso-tutorial/tutorial_attribute_05.png)
...
7. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![证书下载链接](./media/adpfederatedsso-tutorial/tutorial_adp_certificate.png) 
...
4. 在搜索框中，键入“ADP”，在结果面板中选择“ADP”，然后单击“添加”按钮添加该应用程序。
    ...
    ![结果列表中的 ADP](./media/adpfederatedsso-tutorial/tutorial_adp_addservicegallery.png)
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/adpfederatedsso-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/adpfederatedsso-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/adpfederatedsso-tutorial/create_aaduser_03.png)
...
2. 在应用程序列表中，选择“ADP”。
    ...
    ![应用程序列表中的 ADP 链接](./media/adpfederatedsso-tutorial/tutorial_adp_app.png)  
