...
1. [创建 RightAnswers 测试用户](#creating-a-rightanswers-test-user) - 在 RightAnswers 中有一个与 Azure AD 中的 Britta Simon 相对应的关联用户。
...
1. 在“RightAnswers 域和 URL”部分中，执行以下步骤：
...
1. 若要在 RightAnswers 端配置单一登录，需要将下载的元数据 XML 发送给 [RightAnswers 支持团队](https://www.rightanswers.com/contact-us/)。
