...
1. 在结果面板中，选择“SmarterU”，然后单击“添加”按钮添加该应用程序。
...
1. **[创建 SmarterU 测试用户](#creating-a-smarteru-test-user)** - 在 SmarterU 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在“SmarterU 域和 URL”部分中，执行以下步骤： 
