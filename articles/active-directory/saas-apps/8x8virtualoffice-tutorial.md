...
4. 在搜索框中，键入“8x8 Virtual Office”。
    ...
    ![创建 Azure AD 测试用户](./media/8x8virtualoffice-tutorial/tutorial_8x8virtualoffice_search.png)

5. 在“结果”窗格中，选择“8x8 Virtual Office”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/8x8virtualoffice-tutorial/tutorial_8x8virtualoffice_addfromgallery.png)
...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/8x8virtualoffice-tutorial/tutorial_8x8virtualoffice_samlbase.png)

3. 在“8x8 Virtual Office 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/8x8virtualoffice-tutorial/tutorial_8x8virtualoffice_url.png)
...
4. 在“SAML 签名证书”部分中，单击“证书(原始)”，并在计算机上保存证书文件。
    ...
    ![配置单一登录](./media/8x8virtualoffice-tutorial/tutorial_8x8virtualoffice_certificate.png) 

5. 单击“保存”按钮。

    ![配置单一登录](./media/8x8virtualoffice-tutorial/tutorial_general_400.png)

6. 在“8x8 Virtual Office 配置”部分，单击“配置 8x8 Virtual Office”以打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![配置单一登录](./media/8x8virtualoffice-tutorial/tutorial_8x8virtualoffice_configure.png) 
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/8x8virtualoffice-tutorial/create_aaduser_01.png) 

2. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/8x8virtualoffice-tutorial/create_aaduser_02.png) 

3. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/8x8virtualoffice-tutorial/create_aaduser_03.png) 

4. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/8x8virtualoffice-tutorial/create_aaduser_04.png) 
