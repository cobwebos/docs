---
title: 教程：Azure Active Directory 与 Hackerone 集成 | Microsoft 文档
...
1. 在搜索框中，键入“HackerOne”。

    ![创建 Azure AD 测试用户](./media/hackerone-tutorial/tutorial_hackerone_search.png)

1. 在结果面板中，选择“HackerOne”，然后单击“添加”按钮添加该应用程序。

    ![创建 Azure AD 测试用户](./media/hackerone-tutorial/tutorial_hackerone_addfromgallery.png)
...
1. [创建 HackerOne 测试用户](#creating-a-hackerone-test-user) - 在 HackerOne 中有一个与 Azure AD 中的 Britta Simon 相对应的关联用户。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/hackerone-tutorial/tutorial_hackerone_samlbase.png)

1. 在“HackerOne 单一登录 URL 和标识符”部分，执行以下步骤：

    ![配置单一登录](./media/hackerone-tutorial/tutorial_hackerone_url.png)
    ...
    > [!NOTE] 
    > 此值不是真实值。 使用实际登录 URL 更新此值。 请联系 [HackerOne 支持团队](mailto:support@hackerone.com)获取此值。 
 
1. 在“SAML 签名证书”部分中，单击“证书(base64)”，并在计算机上保存证书文件。

    ![配置单一登录](./media/hackerone-tutorial/tutorial_hackerone_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录](./media/hackerone-tutorial/tutorial_general_400.png)

1. 在“HackerOne 配置”部分，单击“配置 HackerOne”打开“配置登录”窗口。 从“快速参考”部分中复制“SAML 单一登录服务 URL”

    ![配置单一登录](./media/hackerone-tutorial/tutorial_hackerone_configure.png) 
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/hackerone-tutorial/create_aaduser_01.png) 

1. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/hackerone-tutorial/create_aaduser_02.png) 

1. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/hackerone-tutorial/create_aaduser_03.png) 

1. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/hackerone-tutorial/create_aaduser_04.png) 
...
此部分不存在任何操作项。 访问 HackerOne 时，如果还没有新用户，则会创建新用户。
...
1. 在应用程序列表中，选择“HackerOne”。

    ![配置单一登录](./media/hackerone-tutorial/tutorial_hackerone_app.png) 
