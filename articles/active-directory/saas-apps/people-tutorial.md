...
1. 在“People 域和 URL”部分，执行以下步骤：
    ...
    b. 在“标识符”文本框中，键入 URL：`https://www.peoplehr.com`
...
本部分需在 People 中创建名为“Britta Simon”的用户。 与  [People 客户端支持团队](mailto:customerservices@peoplehr.com) 协作，将用户添加到 People 平台中。 使用单一登录前，必须先创建并激活用户。
