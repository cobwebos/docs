...
若要配置 Acadia 与 Azure AD 的集成，需要从库中将 Acadia 添加到托管 SaaS 应用列表。
...
单击访问面板中的 Acadia 磁贴时，应当会自动登录到已为其设置了 SSO 的 Acadia。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
