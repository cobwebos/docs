...
4. 在搜索框中，键入“Clarizen”。
    ...
    ![Clarizen 预配](./media/clarizen-provisioning-tutorial/AppSearch.png)

5. 在结果面板中，选择“Clarizen”，然后单击“添加”按钮将 Clarizen 添加到 SaaS 应用程序列表。

    ![Clarizen 预配](./media/clarizen-provisioning-tutorial/AppSearchResults.png)

    ![Clarizen 预配](./media/clarizen-provisioning-tutorial/AppCreation.png)
...
> [!TIP]
> 还可选择按照 [Clarizen 单一登录教程](clarizen-tutorial.md)中提供的说明为 Clarizen 启用基于 SAML 的单一登录。 可以独立于自动用户预配配置单一登录，尽管这两个功能互相补充。
...
2. 从 SaaS 应用程序列表中选择 Clarizen。
    ...
    ![Clarizen 预配](./media/clarizen-provisioning-tutorial/AppInstanceSearch.png)

3. 选择“预配”选项卡。
    
    ![Clarizen 预配](./media/clarizen-provisioning-tutorial/ProvisioningTab.png)

4. 将“预配模式”设置为“自动”。

    ![Clarizen 预配](./media/clarizen-provisioning-tutorial/ProvisioningCredentials.png)
...
6. 根据 [Clarizen 的 Rest API 指南](https://success.clarizen.com/hc/en-us/articles/205711828-REST-API-Guide-Version-2)的“身份验证”部分中提到的步骤检索 Clarizen 帐户的 **serverLocation**。 在获取 serverLocation 时，使用下面突出显示的 URL 的子域来填充“域”字段。
    ...
    ![Clarizen 预配](./media/clarizen-provisioning-tutorial/ClarizenDomain.png)

7. 填入步骤 5 中所示的字段后，单击“测试连接”以确保 Azure AD 可以连接到 Clarizen。 如果连接失败，请确保 Clarizen 帐户具有管理员权限，然后重试。

    ![Clarizen 预配](./media/clarizen-provisioning-tutorial/TestConnection.png)
    
8. 在“通知电子邮件”字段中，输入应接收预配错误通知的个人或组的电子邮件地址，并选中复选框“发生故障时发送电子邮件通知”。

    ![Clarizen 预配](./media/clarizen-provisioning-tutorial/NotificationEmail.png)

9. 单击“ **保存**”。

10. 在“映射”部分中，选择“将 Azure Active Directory 用户同步到 Clarizen”。

    ![Clarizen 预配](./media/clarizen-provisioning-tutorial/UserMapping.png)

11. 在“属性映射”部分中，查看从 Azure AD 同步到 Clarizen 的用户属性。 选为“匹配”属性的特性用于匹配 Clarizen 中的用户帐户以执行更新操作。 选择“保存”按钮以提交任何更改。

    ![Clarizen 预配](./media/clarizen-provisioning-tutorial/UserMappingAttributes.png)

12. 在“映射”部分下，选择“将 Azure Active Directory 组同步到 Clarizen”。

    ![Clarizen 预配](./media/clarizen-provisioning-tutorial/GroupMapping.png)

13. 在“属性映射”部分中，查看从 Azure AD 同步到 Clarizen 的组属性。 选为“匹配”属性的特性用于匹配 Clarizen 中的组以执行更新操作。 选择“保存”按钮以提交任何更改。

    ![Clarizen 预配](./media/clarizen-provisioning-tutorial/GroupMappingAttributes.png)
...
15. 若要为 Clarizen 启用 Azure AD 预配服务，请在“设置”部分中将“预配状态”更改为“启用”。
    ...
    ![Clarizen 预配](./media/clarizen-provisioning-tutorial/ProvisioningStatus.png)

16. 通过在“设置”部分的“范围”中选择所需的值，定义要预配到 Clarizen 的用户和/或组。

    ![Clarizen 预配](./media/clarizen-provisioning-tutorial/ScopeSelection.png)

17. 已准备好预配时，单击“保存”。

    ![Clarizen 预配](./media/clarizen-provisioning-tutorial/SaveProvisioning.png)
