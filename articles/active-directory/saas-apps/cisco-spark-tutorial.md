---
title: 教程：Azure Active Directory 与 Cisco Spark 的集成 | Microsoft Docs
...
* 启用了单一登录的 Cisco Spark 订阅

## <a name="scenario-description"></a>方案描述

本教程会在测试环境中配置和测试 Azure AD 单一登录。

* Cisco Spark 支持 **SP** 发起的 SSO
...
在本部分中，将基于名为 **Britta Simon** 的测试用户配置和测试 Cisco Spark 的 Azure AD 单一登录。
若要运行单一登录，需要在 Azure AD 用户与 Cisco Spark 中相关用户之间建立链接关系。

若要配置并测试 Cisco Spark 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 Cisco Spark 单一登录](#configure-cisco-spark-single-sign-on)** - 在应用程序端配置单一登录。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 Cisco Spark 测试用户](#create-cisco-spark-test-user)** - 在 Cisco Spark 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在 [Azure 门户](https://portal.azure.com/)中，在 **Cisco Spark** 应用程序集成页上，选择“单一登录”。
...
4. 在“基本 SAML 配置”部分中，按照以下步骤操作：
    ...
    ![Cisco Spark 域和 URL 单一登录信息](common/sp-identifier.png)
...
8. 在“设置 Cisco Spark”部分中，根据要求复制相应的 URL。
...
### <a name="configure-cisco-spark-single-sign-on"></a>配置 Cisco Spark 单一登录
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”和“Cisco Spark”。
...
### <a name="create-cisco-spark-test-user"></a>创建 Cisco Spark 测试用户
...
单击访问面板中的 Cisco Spark 磁贴时，应当会自动登录到你为其设置了 SSO 的 Cisco Spark。 有关访问面板的详细信息，请参阅 [Introduction to the Access Panel](https://docs.microsoft.com/azure/active-directory/active-directory-saas-access-panel-introduction)（访问面板简介）。
