...
5. 在结果面板中，选择“Cisco Spark”，然后单击“添加”按钮添加该应用程序。
...
3. 在“Cisco Spark 域和 URL”部分中，执行以下步骤：
...
5. Cisco Spark 应用程序需要 SAML 断言包含特定属性。 请为此应用程序配置以下属性。 可以在应用程序集成页的“用户属性”部分管理这些属性的值。 以下屏幕截图显示一个示例。
