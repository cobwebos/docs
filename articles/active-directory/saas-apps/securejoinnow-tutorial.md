...
将 SecureW2 JoinNow 连接器与 Azure AD 集成可提供以下优势：

- 可以在 Azure AD 中控制谁有权限访问 SecureW2 JoinNow 连接器。
- 可以让用户使用其 Azure AD 帐户自动登录到 SecureW2 JoinNow 连接器（单一登录）。
...
若要配置 Azure AD 与 SecureW2 JoinNow 连接器的集成，需要具备以下条件：

- Azure AD 订阅
- 启用了 SecureW2 JoinNow 连接器单一登录的订阅
...
在本部分中，将基于名为“Britta Simon”的测试用户配置和测试 SecureW2 JoinNow 连接器的 Azure AD 单一登录。

若要使用单一登录，Azure AD 需要知道与 Azure AD 用户相对应的 SecureW2 JoinNow 连接器用户。 换句话说，需要在 Azure AD 用户与 SecureW2 JoinNow 连接器中的相关用户之间建立链接关系。

若要配置和测试 SecureW2 JoinNow 连接器的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
3. **[创建 SecureW2 JoinNow 测试用户](#create-a-securew2-joinnow-connector-test-user)** - 在 SecureW2 JoinNow 连接器中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[测试单一登录](#test-single-sign-on)** - 验证配置是否正常工作。

### <a name="configure-azure-ad-single-sign-on"></a>配置 Azure AD 单一登录

在本部分中，将在 Azure 门户中启用 Azure AD 单一登录并在 SecureW2 JoinNow 连接器应用程序中配置单一登录。
...
在本部分中，通过授予 Britta Simon 访问 SecureW2 JoinNow 连接器的权限，使她能够使用 Azure 单一登录。
...
c. 身份验证成功后，应返回到 SecureW2 JoinNow 连接器的初始登陆页。
