...
1. 在搜索框中，键入“TextMagic”，在结果面板中选择“TextMagic”，然后单击“添加”按钮添加应用程序。
...
1. **[创建 TextMagic 测试用户](#create-a-textmagic-test-user)** - 在 TextMagic 中创建 Britta Simon 的对应用户，并将其链接到用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/textmagic-tutorial/tutorial_textmagic_samlbase.png)

1. 在“TextMagic 域和 URL”部分中，如果要在 **IDP** 发起的模式下配置应用程序，请执行以下步骤：
...
1. 如果要在 SP 发起的模式下配置应用程序，请选中“显示高级 URL 设置”，并执行以下步骤：
    ...
    ![TextMagic 域和 URL 单一登录信息](./media/textmagic-tutorial/url1.png)
...
1. 单击“保存”按钮。
    ...
    ![配置单一登录“保存”按钮](./media/textmagic-tutorial/tutorial_general_400.png)
    
1. 在“TextMagic 配置”部分中，单击“配置 TextMagic”以打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![TextMagic 配置](./media/textmagic-tutorial/tutorial_textmagic_configure.png) 
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/textmagic-tutorial/create_aaduser_01.png)

1. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/textmagic-tutorial/create_aaduser_02.png)

1. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/textmagic-tutorial/create_aaduser_03.png)

1. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/textmagic-tutorial/create_aaduser_04.png)
...
1. 在应用程序列表中，选择“TextMagic”。
    ...
    ![应用程序列表中的 TextMagic 链接](./media/textmagic-tutorial/tutorial_textmagic_app.png)  
