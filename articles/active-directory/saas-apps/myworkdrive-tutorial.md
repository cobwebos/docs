...
2. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![“单一登录”对话框](./media/myworkdrive-tutorial/tutorial_myworkdrive_samlbase.png)

3. 在“MyWorkDrive 域和 URL”部分中，如果要在“IDP”发起的模式下配置应用程序，请执行以下步骤：
...
4. 如果要在 SP 发起的模式下配置应用程序，请选中“显示高级 URL 设置”，并执行以下步骤：
    ...
    > [!NOTE] 
    > 这些不是实际值。 请使用实际的回复 URL 和注销 URL 更新这些值。 请联系 [MyWorkDrive 客户端支持团队](mailto:support@myworkdrive.com)来获取这些值。 
...
6. 单击“保存”按钮。
    ...
    ![配置单一登录“保存”按钮](./media/myworkdrive-tutorial/tutorial_general_400.png)
    
7. 在“MyWorkDrive 配置”部分中，单击“配置 MyWorkDrive”以打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL”、“SAML 实体 ID”和“SAML 单一登录服务 URL”。

    ![MyWorkDrive 配置](./media/myworkdrive-tutorial/tutorial_myworkdrive_configure.png) 

8. 若要在 **MyWorkDrive** 端配置单一登录，需要将下载的**证书 (Base64)**、**注销 URL、SAML 实体 ID 和 SAML 单一登录服务 URL** 发送给 [MyWorkDrive 支持团队](mailto:support@myworkdrive.com)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
1. 在 Azure 门户的左窗格中，单击“Azure Active Directory”按钮。
    ...
    ![“Azure Active Directory”按钮](./media/myworkdrive-tutorial/create_aaduser_01.png)

2. 若要显示用户列表，请转到“用户和组”，然后单击“所有用户”。

    ![“用户和组”以及“所有用户”链接](./media/myworkdrive-tutorial/create_aaduser_02.png)

3. 若要打开“用户”对话框，在“所有用户”对话框顶部单击“添加”。

    ![“添加”按钮](./media/myworkdrive-tutorial/create_aaduser_03.png)

4. 在“用户”对话框中，执行以下步骤：

    ![“用户”对话框](./media/myworkdrive-tutorial/create_aaduser_04.png)
...
**若要将 Britta Simon 分配到 MyWorkDrive，请执行以下步骤：**
...
2. 在应用程序列表中，选择“MyWorkDrive”。
    ...
    ![应用程序列表中的 MyWorkDrive 链接](./media/myworkdrive-tutorial/tutorial_myworkdrive_app.png)  
