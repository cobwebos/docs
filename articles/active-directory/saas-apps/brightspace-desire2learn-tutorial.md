...
* Brightspace by Desire2Learn 支持 **IDP** 发起的 SSO
...
若要运行单一登录，需要在 Azure AD 用户与 Brightspace by Desire2Learn 相关用户之间建立链接关系。

若要配置和测试 Brightspace by Desire2Learn 的 Azure AD 单一登录，需要完成以下构建基块：

1. **[配置 Azure AD 单一登录](#configure-azure-ad-single-sign-on)** - 使用户能够使用此功能。
2. **[配置 Brightspace by Desire2Learn 单一登录](#configure-brightspace-by-desire2learn-single-sign-on)** - 在应用程序端配置单一登录设置。
3. **[创建 Azure AD 测试用户](#create-an-azure-ad-test-user)** - 使用 Britta Simon 测试 Azure AD 单一登录。
4. **[分配 Azure AD 测试用户](#assign-the-azure-ad-test-user)** - 使 Britta Simon 能够使用 Azure AD 单一登录。
5. **[创建 Brightspace by Desire2Learn 测试用户](#create-brightspace-by-desire2learn-test-user)** - 在 Brightspace by Desire2Learn 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在 [Azure 门户](https://portal.azure.com/)中的“Brightspace by Desire2Learn”应用程序集成页上，选择“单一登录”   。
...
4. 在“设置 SAML 单一登录”页上，执行以下步骤  ：
    ...
    > [!NOTE]
    > 这些不是实际值。 请使用实际标识符和回复 URL 更新这些值。 若要获取这些值，请与 [Brightspace by Desire2Learn 客户端支持团队](https://www.d2l.com/contact/)联系。 还可以参考 Azure 门户中的“基本 SAML 配置”  部分中显示的模式。

5. 在“使用 SAML 设置单一登录”页的“SAML 签名证书”部分，单击“下载”以根据要求下载从给定选项提供的“联合元数据 XML”并将其保存在计算机上     。

    ![证书下载链接](common/metadataxml.png)

6. 在“设置 Brightspace by Desire2Learn”部分中，根据要求复制相应 URL  。
...
### <a name="configure-brightspace-by-desire2learn-single-sign-on"></a>配置 Brightspace by Desire2Learn 单一登录

若要在 **Brightspace by Desire2Learn** 端配置单一登录，需要将下载的“联合元数据 XML”以及从 Azure 门户复制的相应 URL 发送给 [Brightspace by Desire2Learn 支持团队](https://www.d2l.com/contact/)。 他们会对此进行设置，使两端的 SAML SSO 连接均正确设置。
...
1. 在 Azure 门户中，依次选择“企业应用程序”、“所有应用程序”和“Brightspace by Desire2Learn”    。

    ![“企业应用程序”边栏选项卡](common/enterprise-applications.png)

2. 在应用程序列表中，选择“Brightspace by Desire2Learn”  。

    ![应用程序列表中的 Brightspace by Desire2Learn 链接](common/all-applications.png)
