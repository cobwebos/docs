...
1. 在搜索框中，键入 Brightspace by Desire2Learn。

    ![创建 Azure AD 测试用户](./media/brightspace-desire2learn-tutorial/tutorial_brightspacebydesire2learn_search.png)

1. 在“结果”窗格中，选择“Brightspace by Desire2Learn”，再单击“添加”按钮，添加该应用程序。

    ![创建 Azure AD 测试用户](./media/brightspace-desire2learn-tutorial/tutorial_brightspacebydesire2learn_addfromgallery.png)
...
1. **[创建 Brightspace by Desire2Learn 测试用户](#creating-a-brightspace-by-desire2learn-test-user)** - 在 Brightspace by Desire2Learn 中创建 Britta Simon 的对应用户，并将其链接到该用户的 Azure AD 表示形式。
...
1. 在“单一登录”对话框中，选择“基于 SAML 的单一登录”作为“模式”以启用单一登录。
    ...
    ![配置单一登录](./media/brightspace-desire2learn-tutorial/tutorial_brightspacebydesire2learn_samlbase.png)

1. 在“Brightspace by Desire2Learn 域和 URL”部分中，执行以下步骤：

    ![配置单一登录](./media/brightspace-desire2learn-tutorial/tutorial_brightspacebydesire2learn_url.png)
...
1. 在“SAML 签名证书”部分中，单击“元数据 XML”，并在计算机上保存元数据文件。
    ...
    ![配置单一登录](./media/brightspace-desire2learn-tutorial/tutorial_brightspacebydesire2learn_certificate.png) 

1. 单击“保存”按钮。

    ![配置单一登录](./media/brightspace-desire2learn-tutorial/tutorial_general_400.png)

1. 若要在“Brightspace by Desire2Learn”端配置单一登录，需要将下载的元数据 XML 发送给 [Brightspace by Desire2Learn 支持团队](https://www.d2l.com/contact/)。
...
1. 在 **Azure 门户**的左侧导航窗格中，单击“Azure Active Directory”图标。
    ...
    ![创建 Azure AD 测试用户](./media/brightspace-desire2learn-tutorial/create_aaduser_01.png) 

1. 若要显示用户列表，请转到“用户和组”，单击“所有用户”。
    
    ![创建 Azure AD 测试用户](./media/brightspace-desire2learn-tutorial/create_aaduser_02.png) 

1. 若要打开“用户”对话框，请在对话框顶部单击“添加”。
 
    ![创建 Azure AD 测试用户](./media/brightspace-desire2learn-tutorial/create_aaduser_03.png) 

1. 在“用户”对话框页上，执行以下步骤：
 
    ![创建 Azure AD 测试用户](./media/brightspace-desire2learn-tutorial/create_aaduser_04.png) 
...
1. 在应用程序列表中，选择“Brightspace by Desire2Learn”。

    ![配置单一登录](./media/brightspace-desire2learn-tutorial/tutorial_brightspacebydesire2learn_app.png) 
