...
1. [创建 RunMyProcess 测试用户](#creating-a-runmyprocess-test-user) - 在 RunMyProcess 中有一个与 Azure AD 中的 Britta Simon 相对应的关联用户。
...
1. 在“RunMyProcess 域和 URL”部分中，执行以下步骤：
...
1. 在“RunMyProcess 配置”部分，单击“配置 RunMyProcess”打开“配置登录”窗口。 从“快速参考”部分中复制“注销 URL 和 SAML 单一登录服务 URL”。
