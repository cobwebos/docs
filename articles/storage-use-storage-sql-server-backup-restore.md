...
* Cost Benefits: Pay only for the service that is used. Can be cost-effective as an off-site and backup archive option. See <!--the [Azure pricing calculator](http://go.microsoft.com/fwlink/?LinkId=277060 "Pricing Calculator"), and--> the [Azure Pricing article](http://www.windowsazure.cn/zh-cn/pricing/overview/ "Pricing article") for more information.
