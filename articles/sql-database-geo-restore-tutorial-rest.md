...
> [AZURE.SELECTOR]
- [地域还原 - 门户](/zh-cn/documentation/articles/sql-database-geo-restore-tutorial-management-portal/)
- [地域还原 - PowerShell](/zh-cn/documentation/articles/sql-database-geo-restore-tutorial-powershell/)
...
请参阅[在 Azure 门户中使用地域还原恢复 Azure SQL 数据库](/zh-cn/documentation/articles/sql-database-geo-restore-tutorial-management-portal/)。
...
[在 Azure 门户中使用时间点还原来还原 Azure SQL 数据库](/zh-cn/documentation/articles/sql-database-point-in-time-restore-tutorial-management-portal/)

[在 Azure 门户中还原已删除的 Azure SQL 数据库](/zh-cn/documentation/articles/sql-database-restore-deleted-database-tutorial-management-portal/)
