...
**磁盘读取操作总数** | 否 | 所有磁盘组合的每秒读取操作数。 <br/> 如果无法提供磁盘级数据，请使用此字段。 
**磁盘写入操作总数** | 否 | 所有磁盘组合的每秒写入操作数。 <br/> 如果无法提供磁盘级数据，请使用此字段。
**磁盘读取吞吐量总数** | 否 | 从所有磁盘读取的数据，以 MB/秒为单位。 <br/> 如果无法提供磁盘级数据，请使用此字段。 
**磁盘写入吞吐量总数** | 否 | 写入所有磁盘的数据，以 MB/秒为单位。 <br/> 如果无法提供磁盘级数据，请使用此字段。
...
如果不能提供磁盘级数据，则可以使用以下字段提供每个服务器的磁盘性能数据。 有关每个字段的详细信息，请参阅[此](#add-server-information) 部分。
- 磁盘读取操作总数
- 磁盘写入操作总数
- 磁盘读取吞吐量总数
- 磁盘写入吞吐量总数
