...
## <a name="dependency-analysis-requirements-agentless"></a>依赖关系分析需求（无代理）
...
**Linux VM 权限** | Red Hat Enterprise Linux 7、6、5<br/> Ubuntu Linux 14.04、16.04<br/> Debian 7、8<br/> Oracle Linux 6、7<br/> CentOS 5、6、7。
...
## <a name="dependency-analysis-requirements-agent-based"></a>依赖关系分析需求（基于代理）
