...
1. 在 @no__t 中，0Azure 迁移：服务器评估 @ no__t，单击 "**概述**"。 如果尚未添加服务器评估工具，请[先执行该操作](how-to-assess.md)。
...
1. 在 @no__t 中，0Azure 迁移：服务器评估 @ no__t，单击 "**发现的服务器**"。
...
1. 安装代理后，请转到门户并单击“概述”。
2. 在 @no__t 中，0Azure 迁移：服务器评估 @ no__t，单击 "**概述**"。 单击向下箭头以展开 " **Essentials**"。
