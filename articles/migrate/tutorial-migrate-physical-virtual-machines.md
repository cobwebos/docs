...
[查看](migrate-architecture.md)迁移体系结构。
...
将虚拟机参与者角色分配给 Azure 帐户。 这提供了执行以下操作的权限：
...
- 准备好用来托管复制设备的计算机。 [查看](migrate-replication-appliance.md#appliance-requirements)计算机要求。 该设备不应安装在要复制的源计算机上。
