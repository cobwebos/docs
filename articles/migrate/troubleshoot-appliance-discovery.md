...
如果出现此连接错误，则可能无法连接到 vCenter Server *Servername*. .com：9443。 错误详细信息指示没有侦听`https://\*servername*.com:9443/sdk`方可以接受消息的终结点。
...
1. 在服务器**Azure Migrate 服务器评估**中， **Overview**选择 "概述"。 **Servers** > 
2. 在 "**管理**" 下，选择**代理运行状况**。
3. 选择 "**刷新代理**"。
