...
- SmartHotel 应用跨两个 VM（**WEBVM** 和 **SQLVM**）进行分层，并位于 VMware ESXi 6.5 版主机 (**contosohost1.contoso.com**) 上。 
...
- SQL 托管实例支持 SQL Server 代理，这对于 SmartHotel 应用而言非常重要。 Contoso 需要这种兼容性，否则必须重新设计应用所需的维护计划。
