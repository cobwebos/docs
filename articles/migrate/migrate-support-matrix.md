...
**本地迁移到 Azure** | 将物理服务器、VMware Vm、Hyper-v Vm 和 AWS/GCP 实例上运行的工作负荷和数据迁移到 Azure。 使用 Azure Migrate Server 评估和 Azure 数据库迁移服务 (DMS) 迁移, 并使用包含 Carbonite 和 CorentTech 的第三方工具。
