...
- 备份保留期取决于购买模型。 基于 DTU 的服务层级提供的保留期为 7 天（适用于“基本”层级）到 35 天（适用于其他层级）。
...
- 适用于 Azure DevOps 的[数据保护](/azure/devops/organizations/security/data-protection)。
