...
For information on restoring an Azure web site from backup, see [Restore an Azure web site](http://www.windowsazure.cn/zh-cn/documentation/articles/web-sites-restore/).
