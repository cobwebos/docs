<properties
	pageTitle="通过使用 Azure 门户监视 DocumentDB 帐户 | Microsoft Azure"
...
你可以在 [Microsoft Azure 门户](https://portal.azure.com/)中监视 DocumentDB 帐户。对于每个 DocumentDB 帐户，性能指标（如请求和服务器错误）和使用情况指标（如存储消耗）都可用。

## 查看 DocumentDB 帐户的性能指标
1.	在 [Azure 门户](https://portal.azure.com/)中，单击“浏览”、“DocumentDB 帐户”，然后单击要查看其性能指标的 DocumentDB 帐户的名称。
...
1.	在 [Azure 门户](https://portal.azure.com/)中，单击“浏览全部”、“DocumentDB 帐户”，然后单击要为其设置性能指标警报的 DocumentDB 帐户的名称。
