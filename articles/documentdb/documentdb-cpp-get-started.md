---
title: "DocumentDB 的 NoSQL C++ 教程 | Microsoft 文档"
description: "本 NoSQL C++ 教程使用 DocumentDB 认可的 C++ SDK 创建 C++ 数据库和控制台应用程序。 DocumentDB 是全球规模的 NoSQL 数据库服务。"
services: documentdb
...
让我们创建一个 DocumentDB 帐户。 如果已有一个可以使用的帐户，可以直接跳到[设置 C++ 应用程序](#SetupNode)。
...
5. 在“NuGet: hellodocumentdb”选项卡中，单击“浏览”，然后搜索 *documentdbcpp*。 在结果中选择“DocumentDbCPP”，如以下屏幕截图中所示。 此包将安装对 C++ REST SDK（DocumentDbCPP 的依赖项）的引用。  
    ...
    ![突出显示了 DocumentDbCpp 包的屏幕截图](media/documentdb-cpp-get-started/documentdbcpp.png)
