<properties
	pageTitle="请求提高 DocumentDB 帐户限制| Microsoft Azure"
...
[Microsoft Azure DocumentDB](https://azure.microsoft.com/services/documentdb/) 具有一组默认限制和配额强制要求。可联系 Azure 支持部门来调整多个配额。本文演示了如何请求提高帐户限制。

阅读本文之后，你将能够回答以下问题：

-	可联系 Azure 支持部门来调整哪些 DocumentDB 帐户配额？
