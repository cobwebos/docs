...
- 修复问题 [#100](https://github.com/Azure/azure-documentdb-node/issues/100) - 专用 HTTPS 代理：避免修改 DocumentDB 目的的全局代理。对所有 lib 的请求均使用专用代理。
...
- 问题 [#45](https://github.com/Azure/azure-documentdb-node/issues/45) - 承诺包装不包括有错误的标头。
