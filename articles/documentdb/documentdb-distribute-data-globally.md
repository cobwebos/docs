...
最后，由于 DocumentDB 完全是[架构不可知的][vldb]，因此，你永远无需担心如何跨多个数据中心管理/更新架构或辅助索引。 应用程序和数据模型不断演变时，[SQL 查询][sqlqueries]可继续正常工作。 
...
* [为集合预配吞吐量和存储][throughputandstorage]
* [通过 REST、.NET、Java、Python 和 Node SDK 使用多宿主 API][developingwithmultipleregions]
