<properties
	pageTitle="DocumentDB 连接器的 Power BI 教程 | Microsoft Azure"
...
- 在你的 Azure DocumentDB 帐户中访问我们的演示帐户或数据。
	...
	- 或者，若要创建你自己帐户，请参阅[使用 Azure 门户创建 DocumentDB 数据库帐户](https://azure.microsoft.com/documentation/articles/documentdb-create-account/)。然后，要获取类似于本教程中使用的示例火山数据（但不包含 GeoJSON 块），请参阅 [NOAA 站点](https://www.ngdc.noaa.gov/nndc/struts/form?t=102557&s=5&d=5)，然后使用 [DocumentDB 数据迁移工具](https://azure.microsoft.com/documentation/articles/documentdb-import-data/)导入数据。
...
- 若要了解有关 DocumentDB 的详细信息，请单击[此处](https://azure.microsoft.com/documentation/services/documentdb/)。
