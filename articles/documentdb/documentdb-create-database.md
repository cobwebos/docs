...
若要使用 Microsoft Azure DocumentDB，你必须拥有 [DocumentDB 帐户](/documentation/articles/documentdb-create-account)、数据库、集合和文档。本主题说明如何在 Microsoft Azure 门户中创建 DocumentDB 数据库。有关如何使用某个 SDK 创建数据库的信息，请参阅[创建 DocumentDB 数据库的其他方法](/documentation/articles/#other-ways-to-create-a-documentdb-database)。
