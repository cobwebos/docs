...
- 可以通过 Web 应用使用 [Azure 搜索](https://azure.microsoft.com/services/search/)以使用户能够搜索帖子。
- [Azure App Services](https://azure.microsoft.com/services/app-service/) 可用来托管应用程序和后台进程。
- [Azure Blob 存储](https://azure.microsoft.com/services/storage/)可用来存储包括图像的完整的用户配置文件。
...
此社交网站只是 NoSQL 数据库是针对作业的适当数据模型的其中一种方案。如果你对阅读有关此方案以及如何在社交媒体应用程序中对 DocumentDB 的数据建模的详细信息感兴趣，请参阅 [Going social with DocumentDB（使用 DocumentDB 进行社交）](documentdb-social-media-apps.md)。
...
- [Azure SQL 数据仓库（预览版）](https://azure.microsoft.com/services/sql-data-warehouse/)
- [分析平台系统（本地设备）](https://www.microsoft.com/zh-cn/server-cloud/products/analytics-platform-system/)

如果你对虚拟机上的 SQL Server 或 SQL 数据库感兴趣，则阅读 [选择云 SQL Server 选项：Azure SQL (PaaS) 数据库或 Azure VM 上的 SQL Server (IaaS)](../sql-database/data-management-azure-sql-database-and-sql-server-iaas.md)，了解两者区别的详细信息。
...
- 对于所有 Azure 服务，你可以注册 [free one-month trial（一个月免费试用版）](https://azure.microsoft.com/pricing/free-trial/)，并收到 200 美元专用在任何 Azure 服务上。
    - [Azure DocumentDB](https://azure.microsoft.com/services/documentdb/)
    - [作为 HDInsight 一部分的 Azure HBase](https://azure.microsoft.com/services/hdinsight/)
    - [Azure Redis Cache](https://azure.microsoft.com/services/cache/)
    - [Azure SQL 数据仓库（预览版）](https://azure.microsoft.com/services/sql-data-warehouse/)
...
- 你可以注册[虚拟机上 SQL Server 2016 的评估版](https://azure.microsoft.com/marketplace/partners/microsoft/sqlserver2016ctp33evaluationwindowsserver2012r2/)或下载 [SQL Server 评估版](https://www.microsoft.com/zh-cn/evalcenter/evaluate-sql-server-2016)。
    - [SQL Server](https://www.microsoft.com/server-cloud/products/sql-server-2016/)
    - [Azure 虚拟机中的 SQL Server](https://azure.microsoft.com/services/virtual-machines/sql-server/)
