...
> [AZURE.WARNING] **CreateDocumentCollectionAsync** 将创建一个具有保留吞吐量的新集合，且包含定价。有关详细信息，请访问我们的[定价页](https://azure.microsoft.com/pricing/details/documentdb/)。
...
-	在 [DocumentDB 文档页](https://azure.microsoft.com/documentation/services/documentdb/)的“开发”部分中了解有关编程模型的详细信息。
