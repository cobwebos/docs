---
title: "使用 Azure DocumentDB 中的日期 | Microsoft 文档"
...
可以在[查询 DocumentDB](documentdb-sql-query.md) 中详细了解 DocumentDB 的 SQL 查询语言和 LINQ 提供商。

本文探讨了如何在 DocumentDB 中存储和查询 DateTime 并对其建立索引。
