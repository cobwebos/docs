...
## <a name="database-questions-about-microsoft-azure-documentdb-fundamentals"></a>有关 Microsoft Azure DocumentDB 基本原理的数据库问题
...
[Azure 门户][azure-portal]中已提供 Microsoft Azure DocumentDB。  首先，你必须注册 Microsoft Azure 订阅。  一旦注册 Microsoft Azure 订阅，可将 DocumentDB 帐户添加到你的 Azure 订阅。 有关添加 DocumentDB 帐户的说明，请参阅[创建 DocumentDB 数据库帐户](documentdb-create-account.md)。   
...
可使用某个 [DocumentDB SDK](documentdb-sdk-dotnet.md) 或通过 [REST API](https://msdn.microsoft.com/library/azure/dn781481.aspx) 来创建用户和权限。   
