...
Azure Cosmos DB 通过 [REST API 版本 2015-12-16](https://msdn.microsoft.com/library/azure/dn781481.aspx) 增加了对自动分区的支持。 为了创建已分区容器，必须在支持的 SDK 平台之一（.NET、Node.js、Java、Python、MongoDB）下载 SDK 版本 1.6.0 或更高版本。 
...
* 执行 Cosmos DB 缩放和性能测试。 有关示例，请参阅[执行 Azure Cosmos DB 缩放和性能测试](documentdb-performance-testing.md)。
