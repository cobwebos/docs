...
- Azure 门户，如 [Create a DocumentDB database using the Azure portal（使用 Azure 门户创建 DocumentDB 数据库）](documentdb-create-database.md)中所述。
...
- 综合教程：[.NET](/documentation/articles/documentdb-get-started)、[.NET MVC](documentdb-dotnet-application.md)、[Java](documentdb-java-application.md)、[Node.js](documentdb-nodejs-application.md) 或 [Python](documentdb-python-application.md)。
