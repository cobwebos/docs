<properties 
	pageTitle="创建 DocumentDB 数据库集合 | Microsoft Azure" 
...
若要使用 Microsoft Azure DocumentDB，你必须拥有 [DocumentDB 帐户](/documentation/articles/documentdb-create-account)、[数据库](/documentation/articles/documentdb-create-database)、集合和文档。本主题说明如何在 Azure 门户中创建 DocumentDB 集合。

不确定集合是什么？ 请参阅[什么是 DocumentDB 集合？](#what-is-a-documentdb-collection)

1.  在 [Azure 门户](https://portal.azure.com/)的跳转栏中，单击“DocumentDB 帐户”。如果“DocumentDB 帐户”不可见，则单击“浏览”，再单击“DocumentDB 帐户”。
...
集合不一定要使用门户来创建，你也可以使用 [DocumentDB SDK](documentdb-sdk-dotnet.md) 和 REST API 来创建集合。
