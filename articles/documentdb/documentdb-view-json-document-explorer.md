<properties
	pageTitle="DocumentDB 文档资源管理器（用于查看 JSON）|Microsoft Azure"
...
3.  将在命令栏的下方显示筛选设置。在筛选设置中，提供 WHERE 子句和/或 ORDER BY 子句，然后单击“筛选”。
	...
	文档资源管理器将自动刷新与筛选查询匹配的文档结果。阅读关于 [SQL 查询和 SQL 语法](documentdb-sql-query.md)一文中的 DocumentDB SQL 语法信息或打印 [SQL 查询备忘单](documentdb-sql-query-cheat-sheet.md)的副本。
