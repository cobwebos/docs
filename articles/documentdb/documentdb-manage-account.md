<properties
	pageTitle="通过 Azure 门户管理 DocumentDB 帐户 | Microsoft Azure"
...
在“Microsoft Azure 门户”中，在“DocumentDB 帐户”边栏选项卡的的“Essentials”栏中访问“密钥”边栏选项卡，以查看、复制和重新生成用于访问 DocumentDB 帐户的访问密钥。[](https://portal.azure.com/)
...
请注意，“密钥”边栏选项卡还包括可用来从[数据迁移工具](documentdb-import-data.md)连接到你的帐户的主要和辅助连接字符串。

它还包括为用户提供 DocumentDB 的只读访问权限的只读密钥。读取和查询为只读操作，而创建、删除和替换则不是。

### 在 Azure 门户中查看并复制访问密钥

1.      在 [Azure 门户](https://portal.azure.com/)中，访问你的 DocumentDB 帐户。 
...
2.      为你的 DocumentDB 帐户重新生成主访问密钥。在 [Azure 门户](https://portal.azure.com/)中，访问你的 DocumentDB 帐户。
...
1.      在 [Azure 门户](https://portal.azure.com/)中，访问你要删除的 DocumentDB 帐户。 
