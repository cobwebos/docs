...
* Cosmos DB 帐户、数据库，以及内部已有文档的集合。 有关详细信息，请参阅 [Cosmos DB 入门][getting-started]。 使用 [Cosmos DB 导入工具][documentdb-import-data]将示例数据导入到 Cosmos DB 帐户中。
...
10. 单击“可选配置”，然后单击可选配置边栏选项卡的“脚本操作”。
     ...
     <table border='1'>
         ...
         <tr><td>标头</td>
             <td>单击复选框运行 PowerShell 脚本到标头节点上。</br></br>
             <strong>选中此复选框</strong>。</td></tr>
         <tr><td>辅助角色</td>
             <td>单击复选框运行 PowerShell 脚本到辅助角色节点上。</br></br>
             <strong>选中此复选框</strong>。</td></tr>
         <tr><td>Zookeeper</td>
             <td>单击复选框运行 PowerShell 脚本到 Zookeeper 上。</br></br>
             <strong>无需</strong>。
             </td></tr>
         <tr><td>parameters</td>
