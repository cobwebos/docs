...
| 适用于 Azure 的 Ansible 模块                   |  Ansible 2.4 |  Ansible 2.5 |  Ansible 2.6 |  Playbook Role [azure_preview_module](#introduction-to-azurepreviewmodule) | 
|---------------------------------------------|--------------|--------------|-----------------------------|-------------------------------------| 
| **计算**                    |           |                          |                          |                                  | 
| azure_rm_availabilityset                    | 是          | 是                         | 是          | 是                                 | 
| azure_rm_availabilityset_facts              | 是          | 是                         | 是          | 是                                 | 
| azure_rm_deployment                         | 是          | 是                         | 是          | 是                                 | 
| azure_rm_resource                           | -            | -                           | 是          | 是                                 | 
| azure_rm_resource_facts                     | -            | -                           | 是          | 是                                 | 
| azure_rm_virtualmachine_scaleset_facts      | 是          | 是                         | 是          | 是                                 | 
| azure_rm_virtualmachineimage_facts          | 是          | 是                         | 是          | 是                                 | 
| azure_rm_resourcegroup                      | 是          | 是                         | 是          | 是                                 | 
| azure_rm_resourcegroup_facts                | 是          | 是                         | 是          | 是                                 | 
| azure_rm_virtualmachine                     | 是          | 是                         | 是          | 是                                 | 
| azure_rm_virtualmachine_extension           | 是          | 是                         | 是          | 是                                 | 
| azure_rm_virtualmachine_scaleset            | 是          | 是                         | 是          | 是                                 | 
| azure_rm_image                              |              | 是                         | 是          | 是                                 | 
| **网络**                    |           |                          |                          |                                  | 
| azure_rm_virtualnetwork                     | 是          | 是                         | 是          | 是                                 | 
| azure_rm_virtualnetwork_facts               | 是          | 是                         | 是          | 是                                 | 
| azure_rm_subnet                             | 是          | 是                         | 是          | 是                                 | 
| azure_rm_networkinterface                   | 是          | 是                         | 是          | 是                                 | 
| azure_rm_networkinterface_facts             | 是          | 是                         | 是          | 是                                 | 
| azure_rm_publicipaddress                    | 是          | 是                         | 是          | 是                                 | 
| azure_rm_publicipaddress_facts              | 是          | 是                         | 是          | 是                                 | 
| azure_rm_dnsrecordset                       | 是          | 是                         | 是          | 是                                 | 
| azure_rm_dnsrecordset_facts                 | 是          | 是                         | 是          | 是                                 | 
| azure_rm_dnszone                            | 是          | 是                         | 是          | 是                                 | 
| azure_rm_dnszone_facts                      | 是          | 是                         | 是          | 是                                 | 
| azure_rm_loadbalancer                       | 是          | 是                         | 是          | 是                                 | 
| azure_rm_loadbalancer_facts                 | 是          | 是                         | 是          | 是                                 | 
| azure_rm_appgw                              | -            | -                           | -            | 是                                 | 
| azure_rm_appgwroute                         | -            | -                           | -            | 是                                 | 
| azure_rm_appgwroute                         | -            | -                           | -            | 是                                 |
| azure_rm_appgwroute_facts                   | -            | -                           | -            | 是                                 |
| azure_rm_appgwroutetable                    | -            | -                           | -            | 是                                 |
| azure_rm_securitygroup                      | 是          | 是                         | 是          | 是                                 | 
| azure_rm_appgwroutetable_facts              | -            | -                           | -            | 是                                 | 
| **存储**                    |           |                          |                          |                                  | 
| azure_rm_storageaccount                     | 是          | 是                         | 是          | 是                                 | 
| azure_rm_storageaccount_facts               | 是          | 是                         | 是          | 是                                 | 
| azure_rm_storageblob                        | 是          | 是                         | 是          | 是                                 | 
| azure_rm_managed_disk                       | 是          | 是                         | 是          | 是                                 | 
| azure_rm_managed_disk_facts                 | 是          | 是                         | 是          | 是                                 | 
| **容器**                    |           |                          |                          |                                  | 
| azure_rm_aks                                | -            | -                           | 是          | 是                                 | 
| azure_rm_aks_facts                          | -            | -                           | 是          | 是                                 | 
| azure_rm_acs                                | 是          | 是                         | 是          | 是                                 | 
| azure_rm_containerinstance                  | -            | 是                         | 是          | 是                                 | 
| azure_rm_containerinstance_facts            | -            | -                           | -            | 是                                 | 
| azure_rm_containerregistry                  | -            | 是                         | 是          | 是                                 | 
...
| **Azure Functions**                    |           |                          |                          |                                  | 
| azure_rm_functionapp                        | 是          | 是                         | 是          | 是                                 | 
| azure_rm_functionapp_facts                  | 是          | 是                         | 是          | 是                                 | 
| **数据库**                    |           |                          |                          |                                  | 
| azure_rm_sqlserver                          | -            | 是                         | 是          | 是                                 | 
| azure_rm_sqlserver_facts                    | -            | 是                         | 是          | 是                                 | 
| azure_rm_sqldatabase                        | -            | 是                         | 是          | 是                                 | 
...
| azure_rm_mysqlserver                        | -            | 是                         | 是          | 是                                 | 
| azure_rm_mysqlserver_facts                  | -            | -                           | -            | 是                                 | 
| azure_rm_mysqldatabase                      | -            | 是                         | 是          | 是                                 | 
...
| azure_rm_postgresqlserver                   | -            | 是                         | 是          | 是                                 | 
| azure_rm_postgresqlserver_facts             | -            | -                           | -            | 是                                 | 
| azure_rm_postgresqldatabase                 | -            | 是                         | 是          | 是                                 | 
...
| **Key Vault**                    |           |                          |                          |                                  | 
| azure_rm_keyvault                           | -            | 是                         | 是          | 是                                 |
| azure_rm_keyvault_facts                     | -            | -                           | -            | 是                                 |
| azure_rm_keyvaultkey                        | -            | 是                         | 是          | 是                                 |
| azure_rm_keyvaultsecret                     | -            | 是                         | 是          | 是                                 |
