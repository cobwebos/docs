...
本文包含 IoT 的安全建议。 实施这些建议可帮助你履行我们的责任分担模型中所述的安全义务。 若要详细了解 Microsoft 采取哪些措施来履行服务提供商责任，请参阅[云计算的分担责任](https://gallery.technet.microsoft.com/Shared-Responsibilities-81d0ff91)。
