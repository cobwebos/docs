...
如果您的应用程序的需求超过了单个存储帐户的可伸缩性目标值，您可以创建应用程序以使用多个存储帐户，并将数据对象分布到这些存储帐户中。请参阅[存储定价详细信息](/pricing/details/storage/)，了解有关批量定价的信息。
...
- [高级存储：适用于 Azure 虚拟机工作负荷的高性能存储](../../includesstorage-premium-storage-preview-portal)
