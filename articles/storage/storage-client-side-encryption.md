<properties 
	pageTitle="Windows Azure 存储空间 | Windows Azure 的客户端加密" 
...
# Windows Azure 存储空间的客户端加密入门

## 概述

[用于 .NET 的 Azure 存储空间客户端库](https://www.nuget.org/packages/WindowsAzure.Storage)包含的功能可帮助开发人员在上载到 Azure 存储空间之前加密客户端应用程序内部的数据，以及在下载时解密数据。此库还支持与 Azure [密钥保管库](/documentation/services/key-vault/)集成，以便管理存储帐户密钥。
