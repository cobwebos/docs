...
[存储定价详细信息](/pricing/details/#storage)页提供了针对存储容量、复制和事务的详细定价信息。[数据传输定价详细信息](/pricing/details/data-transfers/)提供了针对数据流出量的详细定价信息。
...
> [AZURE.NOTE] 我们建议你避免与其他人共享你的存储帐户访问密钥。若要允许不提供你的访问密钥即可访问存储空间资源，可使用*共享访问签名*。共享访问签名可用于访问你的帐户中的资源，访问时间间隔由你定义，访问权限由你指定。请参阅[共享访问签名教程](/documentation/articles/storage-dotnet-shared-access-signature-part-1)以了解更多信息。
