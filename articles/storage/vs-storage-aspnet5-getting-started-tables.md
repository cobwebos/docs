...
有关使用 Azure 表存储的更多常规信息，请参阅 [Get started with Azure Table storage using .NET](/documentation/articles/storage-dotnet-how-to-use-tables/)（通过 .NET 开始使用 Azure 表存储）。
