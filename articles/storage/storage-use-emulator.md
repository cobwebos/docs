...
2. 请打开 Azure PowerShell 并运行以下命令。 请记住要使用自己的凭据替换 *ACCOUNT_NAME* 和 *ACCOUNT_KEY==*。 将 *CONTAINER_NAME* 替换为选择的名称。
...
* 存储模拟器现在支持 Blob、队列和表服务终结点上的 2014-02-14 版本的存储服务。 请注意，文件服务终结点目前在存储模拟器中不受支持。 请参阅 [Versioning for the Azure Storage Services](https://msdn.microsoft.com/library/azure/dd894041.aspx)（Azure 存储服务的版本控制）以了解有关 2014-02-14 版本的详细信息。
