...
<a id="use-the-azure-storage-emulator-for-development-and-testing" class="xliff"></a>
...
## 获取存储模拟器
<a id="get-the-storage-emulator" class="xliff"></a>
...
## 存储模拟器的工作原理
<a id="how-the-storage-emulator-works" class="xliff"></a>
...
## 启动和初始化存储模拟器
<a id="start-and-initialize-the-storage-emulator" class="xliff"></a>
若要启动 Azure 存储模拟器：
...
<a id="initialize-the-storage-emulator-to-use-a-different-sql-database" class="xliff"></a>
...
## 对存储模拟器中的资源进行寻址
<a id="addressing-resources-in-the-storage-emulator" class="xliff"></a>
...
<a id="addressing-the-account-secondary-with-ra-grs" class="xliff"></a>
...
## 存储模拟器命令行工具参考
<a id="storage-emulator-command-line-tool-reference" class="xliff"></a>
...
<a id="differences-between-the-storage-emulator-and-azure-storage" class="xliff"></a>
...
### Blob 存储的差异
<a id="differences-for-blob-storage" class="xliff"></a>
...
### 表存储的差异
<a id="differences-for-table-storage" class="xliff"></a>
以下差异适用于模拟器中的表存储：
...
### 队列存储的差异
<a id="differences-for-queue-storage" class="xliff"></a>
模拟器中的队列存储没有任何差异。

## 存储模拟器发行说明
<a id="storage-emulator-release-notes" class="xliff"></a>
### 版本 5.1
<a id="version-51" class="xliff"></a>
* 修复了一个 Bug。出现该 Bug 时，存储模拟器会在某些不包含服务的响应中返回 `DataServiceVersion` 标头。

### 版本 5.0
<a id="version-50" class="xliff"></a>
...
### 版本 4.6
<a id="version-46" class="xliff"></a>
* 存储模拟器现在支持 Blob、队列和表服务终结点上的 2016-05-31 版的存储服务。

### 版本 4.5
<a id="version-45" class="xliff"></a>
* 修复了重命名后备数据库时导致存储模拟器初始化和安装失败的 bug。

### 版本 4.4
<a id="version-44" class="xliff"></a>
...
### 4.0 版
<a id="version-40" class="xliff"></a>
* 存储模拟器可执行文件已重命名为 *AzureStorageEmulator.exe*。

### 版本 3.2
<a id="version-32" class="xliff"></a>
