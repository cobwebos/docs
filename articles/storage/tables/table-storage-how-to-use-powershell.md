...
检索在该存储帐户中的表的列表[Get AzStorageTable](/powershell/module/azure.storage/Get-AzureStorageTable)。
...
若要对表执行操作，需要引用特定表。 获取引用使用[Get AzStorageTable](/powershell/module/azure.storage/Get-AzureStorageTable)。
