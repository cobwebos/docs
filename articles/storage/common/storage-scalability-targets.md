---
title: Azure 存储空间可伸缩性和性能目标-存储帐户
...
> 有关支持这些较大文件共享大小的限制、区域信息和说明的列表，请参阅 Azure 文件规划指南中的 "[更大的文件共享（标准层）](../files/storage-files-planning.md#onboard-to-larger-file-shares-standard-tier) " 一节。
