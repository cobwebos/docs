...
> [!IMPORTANT]
> 对于已启用[虚拟网络服务终结点](../../virtual-network/virtual-network-service-endpoints-overview.md) 功能的存储帐户，请使用“允许受信任的 Microsoft 服务...”设置，[允许导入/导出](/azure/storage/common/storage-network-security)服务将数据导入到 Azure 或从其导出。
