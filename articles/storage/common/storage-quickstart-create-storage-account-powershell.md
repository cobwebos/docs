...
使用[New-AzureRmStorageAccount](/powershell/module/azurerm.storage/New-AzureRmStorageAccount) 创建可用于四种服务的常规用途存储帐户。 将存储帐户命名为 *contosomvcstandard*，并将其配置为启用本地冗余存储和 blob 加密。
