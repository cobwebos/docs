...
| **对象计数**        | BlobCount（维度 BlobType 等于 BlockBlob 或 PageBlob）**************** |
...
| **授权错误** | 事务（维度 ResponseType 等于 AuthorizationError）******** |
| **可用性** | **可用性** |
| **AverageE2ELatency** | **SuccessE2ELatency** |
| **AverageServerLatency** | **SuccessServerLatency** |
| **客户端其他错误** | 事务（维度 ResponseType 等于 ClientOtherError）******** |
| **客户端超时错误** | 事务（维度 ResponseType 等于 ClientTimeoutError）******** |
| **网络错误** | 事务（维度 ResponseType 等于 NetworkError）******** |
...
| **服务器其他错误** | 事务（维度 ResponseType 等于 ServerOtherError）******** |
| **服务器超时错误** | 事务（维度 ResponseType 等于 ServerTimeoutError）******** |
...
* [Azure 监视器中的存储指标](./storage-metrics-in-azure-monitor.md)
