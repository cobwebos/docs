...
| **BlobTier** | Azure 存储提供不同的访问层，使你能够以最具成本效益的方式存储 Blob 对象数据。 请参阅 [Azure 存储 Blob 层](../blobs/storage-blob-storage-tiers.md)中的详细信息。 支持的值包括： <br/> <li>**Hot**：热层</li> <li>**Cool**：冷层</li> <li>**存档**：存档层</li> <li>**Premium**：块 Blob 的高级层</li> <li>**P4/P6/P10/P15/P20/P30/P40/P50/P60**：高级页 Blob 的层类型</li> <li>**标准**：标准页 Blob 的层类型</li> <li>**Untiered**：常规用途 v1 存储帐户的层类型</li> |
