...
1. 安装 [Azure PowerShell](/powershell/azure/install-azurerm-ps) 并 [登录](/powershell/azure/authenticate-azureps)。
...
|Azure 事件网格|Microsoft.EventGrid|启用 Blob 存储事件发布。 [了解详细信息](/azure/event-grid/overview)。|
