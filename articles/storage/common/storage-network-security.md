...
| Azure 监视器            | Microsoft.Insights         | 允许将监视数据写入受保护的存储帐户，包括资源诊断日志、Azure Active Directory 登录和审核日志以及 Microsoft Intune 日志。 [了解详细信息](/azure/monitoring-and-diagnostics/monitoring-roles-permissions-security)。 |
