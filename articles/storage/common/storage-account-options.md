...
用户随时可以通过门户、CLI 或 PowerShell 将 GPv1 帐户升级为 GPv2 帐户。 此更改无法撤消，不允许其他更改。 将 Blob 存储帐户升级为 GPv2 的功能即将推出。
...
可以轻松地将 GPv1 帐户升级为 GPv2，不会造成停机或 API 更改，也不需移动数据。 这是 GPv2 相对于Blob 存储帐户的主要优势之一。
