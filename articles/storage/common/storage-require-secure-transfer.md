...
若要使用 REST API 简化测试，请使用 [ArmClient](https://github.com/projectkudu/ARMClient) 从命令行进行调用。

 使用以下命令行，借助 REST API 检查该设置：
...
在响应中，找到 supportsHttpsTrafficOnly 设置。 例如：
