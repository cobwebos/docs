...
> [!NOTE]
> 本指南假定已熟悉 [Azure 存储](https://azure.microsoft.com/services/storage/)。 如果不熟悉，最好是阅读 [Azure 存储简介](storage-introduction.md)。 最重要的是，需要[创建一个存储帐户](storage-create-storage-account.md#create-a-storage-account)才能开始使用数据移动库。
> 
> 
