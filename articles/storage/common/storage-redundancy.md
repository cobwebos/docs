...
|    BlockBlobStorage<sup>1</sup>    | 亚洲东南部<br /> 西欧<br /> 美国东部    |    仅块 Blob    |
|    FileStorage    | 亚洲东南部<br /> 西欧<br /> 美国东部    |    仅 Azure 文件    |
...
| 整个数据中心（区域性或非区域性）不可用                                           | No                              | 是                              | 是<sup>1</sup>                                  | 是                                  |
