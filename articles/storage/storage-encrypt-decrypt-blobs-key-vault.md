...
有关 Azure 存储空间的客户端加密的概述信息，请参阅 [Microsoft Azure 存储空间的客户端加密入门](/documentation/articles/storage-client-side-encryption)
...
有关 Azure 存储空间的客户端加密的概述，请参阅 [Microsoft Azure 存储空间的客户端加密入门](/documentation/articles/storage-client-side-encryption)
