<properties 
	pageTitle="将 Azure 存储空间用于 Jenkins 持续集成解决方案 | Azure" 
...
3. 在“Microsoft Azure 存储帐户配置”部分：
    ...
    3. 如果你在使用公共 Azure 云，对于“Blob 服务终结点 URL”，请使用默认值。如果你在使用其他 Azure 云，则使用在 [Azure 门户](https://portal.azure.cn)中为你的存储帐户指定的终结点。
