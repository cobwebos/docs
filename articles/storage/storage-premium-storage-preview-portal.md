...
若要开始使用 Azure 高级存储，请访问[开始免费试用](http://www.windowsazure.cn/pricing/1rmb-trial/)页。
...
有关最新信息，请参阅 [Azure 的虚拟机和云服务大小](http://msdn.microsoft.com/zh-cn/library/azure/dn197896.aspx)。若要了解高级存储磁盘及其 IOPS 和吞吐量限制，请参阅本文的[使用高级存储时的缩放性和性能目标](#scalability-and-performance-targets-whzh-CNing-premium-storage)。
...
- [出站数据传输](http://www.windowsazure.cn/pricing/details/data-transfer/)（Azure 数据中心送出的数据）会产生带宽使用费。

有关高级存储与 DS 系列 VM 定价的详细信息，请参阅：

- [Azure 存储定价](http://www.windowsazure.cn/home/features/storage/#price)
- [虚拟机定价](http://www.windowsazure.cn/home/features/virtual-machines/)
...
1.	登录 [Azure 预览门户](https://manage.windowsazure.cn)。如果你没有订阅，请查看[免费试用](http://www.windowsazure.cn/pricing/1rmb-trial/)优惠产品。
...
[创建运行 Windows 的虚拟机](http://www.windowsazure.cn/documentation/articles/virtual-machines-windows-tutorial-azure-preview/)

[Azure 的虚拟机和云服务大小](http://msdn.microsoft.com/zh-cn/library/azure/dn197896.aspx)

[存储文档](http://www.windowsazure.cn/documentation/services/storage/)
