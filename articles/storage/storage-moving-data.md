---
title: "将数据移入和移出 Azure 存储 | Microsoft Docs"
...
---
# <a name="moving-data-to-and-from-azure-storage"></a>将数据移动到和移出 Azure 存储空间
...
## <a name="backing-up-your-data"></a>备份你的数据
...
## <a name="recovering-your-data"></a>恢复你的数据
