...
- 仅受存储帐户注册的 AD 林的支持。 默认情况下，只能使用单个林中的 AD DS 凭据访问 Azure 文件共享。 如果需要从其他林访问 Azure 文件共享，请确保配置了正确的林信任，有关详细信息，请参阅[常见问题解答](storage-files-faq.md#ad-ds--azure-ad-ds-authentication)。
...
使用 AD DS 的 azure 文件身份验证在[所有 Azure 公共区域](https://azure.microsoft.com/global-infrastructure/locations/)中均可用。
