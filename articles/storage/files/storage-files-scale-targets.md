...
> [!NOTE]
> 大于 5 TiB 的标准文件共享具有某些限制和区域限制。
> 有关启用这些较大文件共享大小的限制列表、区域信息和说明，请参阅规划指南的["板载到大型文件共享](storage-files-planning.md#enable-standard-file-shares-to-span-up-to-100-tib)"部分。
