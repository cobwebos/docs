...
description: "查看、下载和运行 Azure 存储空间的示例代码和应用程序 使用 Java 存储客户端库发现 Blob、队列、表和文件的入门示例。"
services: storage
...
* [Java 中 Azure Blob 服务入门](storage-java-how-to-use-blob-storage.md)
* [Java 中 Azure 队列服务入门](storage-java-how-to-use-queue-storage.md)
* [Java 中 Azure 表服务入门](storage-java-how-to-use-table-storage.md)
