---
title: 调优性能：Hive、HDInsight& Azure 数据存储第 2 代 |微软文档
...
---
# <a name="tune-performance-hive-hdinsight--azure-data-lake-storage-gen2"></a>调优性能：Hive、HDInsight & Azure 数据存储第 2 代
...
* **Data Lake Storage Gen2 帐户**。 有关如何创建一个存储帐户的说明，请参阅[快速入门：创建 Azure 数据湖存储 Gen2 存储帐户](data-lake-storage-quickstart-create-account.md)
