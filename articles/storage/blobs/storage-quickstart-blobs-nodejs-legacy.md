...
> [!TIP]
> 适用于 Node.js 的 Azure 存储客户端库的最新版本是 v10。 Microsoft 建议尽可能使用最新版本的客户端库。 若要开始使用 v10，请参阅[快速入门：使用 Azure Storage client library For JavaScript v10 （预览版）上传、下载、列出和删除 blob](storage-quickstart-blobs-nodejs-v10.md)。
