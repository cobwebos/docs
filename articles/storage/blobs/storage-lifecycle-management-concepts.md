...
若要注册公共预览版，需要提交请求，将此功能注册到订阅中。 请求通常会在两周内获得批准。 获得批准后，以下区域中的所有现有和新的 GPv2 或 Blob 存储帐户都将包含此功能：美国西部 2、美国中西部、美国东部 2 和西欧。 预览版仅支持块 Blob。 与大多数预览版一样，不应将此功能用于生产工作负荷，直到正式版发布。
