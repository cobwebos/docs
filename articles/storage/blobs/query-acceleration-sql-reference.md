...
[LIKE](https://docs.microsoft.com/sql/t-sql/language-elements/like-transact-sql?view=sql-server-ver15)函数可帮助你搜索模式。 下面是几个使用[LIKE](https://docs.microsoft.com/sql/t-sql/language-elements/like-transact-sql?view=sql-server-ver15)函数搜索数据字符串的示例 ``abc,abd,cd\ntest,test2,test3\na_bc,xc%d^e,gh[i `` 。
...
查询加速 SQL 语言支持函数的年、月、日、小时、分钟和秒 ``DATE_DIFF`` 。
