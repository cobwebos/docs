...
* 如果使用 Data Lake Storage Gen2 Api 写入文件, 则调用[获取块列表](https://docs.microsoft.comrest/api/storageservices/get-block-list)blob API 时, 将看不到该文件的块。
