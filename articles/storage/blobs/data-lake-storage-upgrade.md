...
| Developer SDK | .NET、Java、Python、Node.js  | .NET、Java、Python、Node.js、C++、Ruby、PHP、Go、Android、iOS| Blob SDK-*现已推出*。 [AZURE DATA LAKE STORAGE GEN2 SDK](https://azure.microsoft.com/blog/extended-filesystem-programming-capabilities-in-azure-data-lake-storage/)- *现已推出-.net、Java、Python （公共预览版）*  |
