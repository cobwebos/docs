...
用于访问数据湖存储第 2 代的文件的 URI 方案所述[这里](../../hdinsight/hdinsight-hadoop-use-data-lake-storage-gen2.md)在详细信息，但概括地说，它是`abfss://<FILE_SYSTEM_NAME>@<ACCOUNT_NAME>.dfs.core.widows.net/<PATH>`。
