...
> * 系统会为存储帐户授予以下角色之一： **Blob 数据读取器**、 **blob 数据参与者**或**blob 数据所有者**。
> * 一个名为 `Drivers.txt` 的示例数据文件，位于存储帐户中。
...
13. 创建一个表示特定国家/地区的每个城市中司机的饼图。 为此，请如下进行选择。
    ...
    我们要使用的列是列4（城市名称）和第7列（国家/地区名称）。 如下所示，从“字段”选项卡将这些列拖动到“可视化”选项卡。
...
14. 通过在页面级别筛选器中选择一个特定的国家/地区，此时会显示所选国家/地区的每个城市中的司机数量。 例如，在“可视化”选项卡中的“页面级别筛选器”中，选择“巴西”。
    ...
    ![页筛选器](media/data-lake-storage-use-power-bi/page-filters.png)
