...
本指南演示如何使用 Blob 存储执行常见方案。 这些示例用 Python 编写并使用[用于 Python 的 Microsoft Azure 存储 SDK]。 涉及的任务包括上传、列出、下载和删除 Blob。
...
在此更改后，Internet 上的任何人都可以查看公共容器中的 Blob，但只有可以修改或删除它们。
