...
中止正在进行的 Blob 复制操作时，目标 blob 的[复制状态设置为](/dotnet/api/microsoft.azure.storage.blob.copystate.status?view=azure-dotnet#Microsoft_Azure_Storage_Blob_CopyState_Status)["复制状态"。](/dotnet/api/microsoft.azure.storage.blob.copystatus?view=azure-dotnet)
