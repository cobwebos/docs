...
高级性能块 blob 存储帐户已针对使用较小千字节范围对象的应用程序进行了优化。 它非常适合需要高事务速率或一致的低延迟存储的应用程序。 高级性能块 blob 存储设计为随应用程序缩放。 如果你的方案要求部署每秒需要数十万个请求或 PB 量级存储容量的应用程序，请通过在 [Azure 门户](https://portal.azure.com/?#blade/Microsoft_Azure_Support/HelpAndSupportBlade)中提交支持请求来与 Microsoft 联系。
