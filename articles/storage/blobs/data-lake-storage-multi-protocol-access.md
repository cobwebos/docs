...
> [!NOTE]
> Data Lake Storage 上的多协议访问是公共预览版, 仅在**美国西部 2**和**美国中北部**区域提供。 若要查看限制, 请参阅[已知问题](data-lake-storage-known-issues.md)一文。 若要注册预览版, 请参阅[此页](https://aka.ms/blobinteropsignup)。
