...
![Azure Databricks 与 Data Lake Storage Gen2 和 SQL 数据仓库](./media/data-lake-storage-handle-data-using-databricks/databricks-extract-transform-load-sql-datawarehouse.png "Azure Databricks 与 Data Lake Storage Gen2 和 SQL 数据仓库")
...
3. 在“创建 Notebook”对话框中，输入 Notebook 的名称。 选择“Scala”作为语言，然后选择前面创建的 Spark 群集。
    ...
    ![在 Databricks 中创建笔记本](./media/data-lake-storage-handle-data-using-databricks/databricks-notebook-details.png "在 Databricks 中创建笔记本")

    选择“创建”。

4. 在第一个单元格中输入以下代码并执行该代码。 请务必将示例中括号内显示的占位符替换为你自己的值：
...
> [!NOTE]
> 如果没有支持 Azure Data Lake Storage Gen2 的帐户，请遵循[快速入门创建一个帐户](./data-lake-storage-quickstart-create-account.md)。
