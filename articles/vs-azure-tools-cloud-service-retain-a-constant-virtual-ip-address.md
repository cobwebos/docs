...
在特定环境（如生产环境）中第一次将云服务部署到 Azure 时，其 VIP 就已分配。 VIP 仅会在你显式删除部署或部署更新过程将其隐式删除时发生更改。 若要保留 VIP，则切勿删除部署，且务必确保 Visual Studio 不会自动删除部署。 
...
3. 在“发布 Azure 应用程序”对话框中，选择要部署的 Azure 订阅。 必要时进行登录，然后选择“下一步”。
...
6. 若要进一步指定要更新角色的方式，请选择“部署更新”旁边的“设置”。 选择“增量更新”或“同时更新”，然后选择“确定”。 选择“增量更新”会逐个更新应用程序的每个实例，以使应用程序始终可用。 选择“同时更新”会同时更新应用程序的所有实例。 同时更新速度更快，但在更新过程中服务可能不可用。 完成后，选择“下一步”。
...
7. 在“发布 Azure 应用程序”对话框中，选择“下一步”，直到显示“摘要”页。 验证你的设置，然后选择“发布”。
