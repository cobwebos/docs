...
当你尝试 IoT Central 或测试设备时, 此方法非常有用。 你可以使用 IoT Central 应用程序中的设备连接信息来生成设备的连接字符串。 有关详细步骤, 请参阅[如何生成用于连接到 Azure IoT Central 应用程序的设备连接字符串](howto-generate-connection-string.md)。
