...
若要配置该设备, 请[按照 GitHub 上的分步说明](https://github.com/Azure/iot-central-firmware/blob/master/RaspberryPi/README.md)进行操作。

1. 配置设备后, 设备开始将遥测度量发送到 Azure IoT Central。
