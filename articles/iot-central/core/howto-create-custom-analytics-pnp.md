...
本操作方法指南介绍了如何将 IoT Central 扩展到其对[内置分析工具](./howto-create-custom-analytics-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)的功能。
...
了解如何创建自定义分析后，建议下一步是了解如何[在 Power BI 仪表板中可视化和分析 Azure IoT Central 数据](./howto-connect-powerbi.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)。
