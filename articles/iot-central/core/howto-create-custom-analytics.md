...
---
# <a name="extend-azure-iot-central-with-custom-analytics-using-azure-databricks"></a>使用 Azure 数据块自定义分析扩展 Azure IoT 中心
...
现在您已经知道如何创建自定义分析，建议的下一步是了解如何[管理应用程序](howto-administer.md)。
