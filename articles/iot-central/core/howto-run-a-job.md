...
7. 单击保存的作业，然后单击 "运行" 按钮以执行该作业。 将显示运行作业弹出窗口。 单击 "运行作业" 按钮进行确认。 

    ![运行作业](./media/howto-run-a-job/run-job.png)

8. 作业经历了挂起、运行和完成的不同阶段。 作业执行详细信息包含结果指标、持续时间详细信息和设备列表网格。 从此概述中，你还可以选择 "**结果日志**" 以下载作业详细信息的 CSV 文件，包括设备及其状态值。 这些信息可用于故障排除。

    ![查看设备状态](./media/howto-run-a-job/download-details.png)

## <a name="manage-jobs"></a>管理作业

若要停止某个正在运行的作业，请将其打开，然后选择 "**停止**"。 作业状态将会更改，以反映该作业已停止。 "**摘要**" 部分显示已完成、失败或仍处于挂起状态的设备。

![管理作业](./media/howto-run-a-job/manage-job.png)

作业处于停止状态后，你可以单击 "**继续**" 以继续执行作业。 作业状态将会更改，以反映该作业现已重新运行。 "**摘要**" 部分继续更新并获得最新进度。

![已停止作业](./media/howto-run-a-job/stopped-job.png)

## <a name="copy-a-job"></a>复制作业

若要复制某个现有作业，请在 "**作业**" 页上选择该作业，然后选择 "**作业详细信息**"。 将显示 "作业详细信息" 页。 

![作业详细信息](./media/howto-run-a-job/job-details.png)

单击 "**复制**"

![作业详细信息](./media/howto-run-a-job/job-details-copy.png)

此时会打开一个作业配置副本供你编辑，并且**复制**将追加到作业名称。 您可以保存或运行新作业：
