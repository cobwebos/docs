...
如果管理员为应用程序创建了自定义主题，此页将包含在 UI 中隐藏**应用程序名称**的选项。 如果自定义主题中的应用程序徽标包含应用程序名称，则此选项很有用。 有关详细信息，请参阅[自定义 Azure IOT CENTRAL UI](./howto-customize-ui-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)。
