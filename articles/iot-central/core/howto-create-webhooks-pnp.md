...
1. 创建[遥测规则](tutorial-create-telemetry-rules-pnp.md)。 保存规则并添加新操作。

    ![Webhook 创建屏幕](media/howto-create-webhooks-pnp/webhookcreate.png)
...
现在，你已了解如何设置和使用 webhook，接下来建议的下一步是探索[配置 Azure Monitor 操作组](howto-use-action-groups-pnp.md)。
