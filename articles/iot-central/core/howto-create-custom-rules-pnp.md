...
现在，你已了解如何创建自定义规则和通知，接下来是了解如何[通过自定义分析来扩展 Azure IoT Central](howto-create-custom-analytics-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)。
