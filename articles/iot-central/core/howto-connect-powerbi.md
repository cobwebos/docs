...
:::image type="content" source="media/howto-connect-powerbi/azure-deployment.png" alt-text="资源组 Azure 门户视图":::
...
Azure 数据工厂每15分钟运行一次，以转换要加载到 SQL 表中的最新批数据（这是**翻转窗口触发器**的最小数字）。
