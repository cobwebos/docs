...
| 映射 | 应用程序和设备仪表板 |地图磁贴显示设备在地图上的位置。 你还可以最多显示100点的设备位置历史记录。 例如，可以显示设备在过去一周内的显示抽样路线。|
...
现在，你已了解如何配置 Azure IoT Central 默认应用程序仪表板，你可以[了解如何创建个人仪表板](howto-create-personal-dashboards.md)。
