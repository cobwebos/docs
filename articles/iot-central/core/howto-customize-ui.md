...
您可以更改页眉的颜色以及用于重音按钮和其他突出显示的颜色。 使用格式 `##ff6347`六个字符的十六进制颜色值。 有关**十六进制值**颜色表示法的详细信息，请参阅[HTML 颜色](https://www.w3schools.com/html/html_colors.asp)。
