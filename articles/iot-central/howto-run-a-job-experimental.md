...
1. 单击“+ 新建”以便开始创建新的作业。
    ...
    ![新建作业](./media/howto-run-a-job-experimental/createnewjob.png)
...
1. 接下来，选择将定义的作业类型（设置、属性或命令）。 单击所选作业类型旁的 **+** 并添加所需的操作。
    ...
    ![配置作业](./media/howto-run-a-job-experimental/configurejob.png)
...
1. 一旦选择了所需的设备，请选择“运行”。 该作业现在将显示在主要的“作业”页上。 在此视图上，能够看到当前正在运行的作业和任何以前运行的作业的历史记录。 正在运行的作业始终会显示在列表顶部。
    ...
    ![查看作业](./media/howto-run-a-job-experimental/viewjob.png)
...
- [对设备模板进行版本控制](howto-version-devicetemplate.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)
