...
![Azure IoT Central 的“创建应用程序”页](media/quick-deploy-iot-central-experimental/iotcentralcreate.png)
...
1. 若要创建**即用即付**应用程序，需要选择“目录”、“Azure 订阅”和“区域”。 
    ...
    - *目录*是用于创建应用程序的 Azure Active Directory。 它包含用户标识、凭据和其他组织信息。 如果没有 AAD，则在创建 Azure 订阅时，系统会为你创建一个。
...
> [浏览一下 IoT Central](https://docs.microsoft.com/azure/iot-central/overview-iot-central-tour)
