...
1. 在设备代码中使用以下连接详细信息：设备标识、设备名称和设备主键，用于预配和连接设备并即时查看数据流。 如果使用 MxChip 设备，请按照[此处的逐步说明](howto-connect-devkit-experimental.md#add-a-real-device)，从“准备 DevKit 设备”部分开始。   
    ...
    *   **Node.js：** 如果要使用 Node.js，请[使用此处的分步说明](tutorial-add-device-experimental.md#prepare-the-client-code)，从“准备客户端代码”部分开始。
...
如果使用 MxChip 设备进行连接，请按照[此处的逐步说明](howto-connect-devkit-experimental.md#add-a-real-device)，从“准备 DevKit 设备”部分开始。   
...
- [将泛型 Node.js 客户端连接到 Azure IoT Central 应用程序](howto-connect-nodejs-experimental.md)
- [将 Raspberry Pi 设备连接到 Azure IoT Central 应用程序](howto-connect-raspberry-pi-python.md)
- [将 DevDiv 工具包设备连接到 Azure IoT Central 应用程序](howto-connect-devkit-experimental.md)。
...
- [准备和连接 DevKit 设备](howto-connect-devkit-experimental.md)
