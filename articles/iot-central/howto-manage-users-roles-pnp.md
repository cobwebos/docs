...
1. 若要将用户添加到 IoT Central 应用程序，请转到“用户”页中的“管理”部分。
    ...
    ![用户列表](media/howto-manage-users-roles-pnp/image1.png)

1. 若要添加用户，在“用户”页上，选择“+ 添加用户”。

1. 从“角色”下拉菜单中为用户选择一个角色。 在本文的[管理角色](#manage-roles)部分详细了解角色。

    ![角色选择](media/howto-manage-users-roles-pnp/image3.png)
...
现在, 你已了解如何管理 Azure IoT Central 中的用户和角色, 接下来是了解如何在 Azure IoT Central 中[查看帐单](howto-view-bill-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json)。
