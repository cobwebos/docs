...
1. 基于“示例 Devkit”应用程序模板创建的 Azure IoT Central 应用程序。 有关详细信息，请参阅[创建应用程序快速入门](quick-deploy-iot-central-experimental.md?toc=/azure/iot-central-experimental/toc.json&bc=/azure/iot-central-experimental/breadcrumb/toc.json)。
...
1. 在 Device Explorer 中添加真实设备，单击“+新增”>“真实设备”以添加真实设备。
    ...
    * 输入设备名或使用建议名称
    ...
    ![添加设备](media/howto-connect-devkit-experimental/add-device.png)

1. 通过单击设备页上的“连接”，获取已添加设备的作用域 ID、设备 ID 和主键等连接详细信息。

    ![连接详细信息](media/howto-connect-devkit-experimental/device-connect.png)
...
1. 打开 Web 浏览器并导航到 [http://192.168.0.1/start](http://192.168.0.1/start)。 将显示以下网页：
    ...
    ![设备配置页](media/howto-connect-devkit-experimental/configpage.png)
...
1. 选择“配置设备”后，会看到以下页：
    ...
    ![设备已配置](media/howto-connect-devkit-experimental/deviceconfigured.png)
...
1. 使用“Device Explorer”导航到所添加的真实 MXChip 设备的“度量”页：
    ...
    ![导航到真实设备](media/howto-connect-devkit-experimental/realdevicenew.png)

1. 在“度量”页上，可以看到来自 MXChip 设备的遥测数据：

    ![查看来自真实设备的遥测数据](media/howto-connect-devkit-experimental/devicetelemetrynew.png)

1. 在“属性”页上，可以查看设备报告的上一个模具编号和设备位置：

    ![查看设备属性](media/howto-connect-devkit-experimental/devicepropertynew.png)

1. 在“设置”页上，可以更新 MXChip 设备上的设置：

    ![查看设备设置](media/howto-connect-devkit-experimental/devicesettingsnew.png)

1. 在“仪表板”页上，可以看到位置地图

    ![查看设备仪表板](media/howto-connect-devkit-experimental/devicedashboardnew.png)
