...
ms.locfileid: "34201925"
---
# <a name="add-a-real-device-to-your-azure-iot-central-application"></a>将真实设备添加到 Azure IoT Central 应用程序
...
1. 然后，以设备开发人员的身份了解真实设备中的代码。 我们会将第一部分检索到的连接字符串添加到示例代码。
...
1. 若要开始连接真实的连接空调设备，请依次选择“新建”、“真实”：

    ![开始添加新的真实连接空调设备](media/tutorial-add-device/newreal.png)

1. （可选）可以重命名新设备，只需选择设备名称并编辑值即可：
...
1. 在新的真实连接空调设备的“属性”页上，将“序列号”设置为 **rcac0010**，将“固件版本”设置为 9.75。 然后选择“保存”：

    ![设置真实设备的属性](media/tutorial-add-device/setproperties.png)

1. 构建人员可以查看真实设备的“度量”、“规则”和“仪表板”页。
...
1. 在“连接”页上，复制并保存“主连接字符串”。 在本教程的后半部分将要使用此值。 设备开发人员将在设备上运行的客户端应用程序中使用此值：
...
## <a name="configure-client-code-for-real-device"></a>配置真实设备的客户端代码
...
1. 将 `{your device connection string}` 替换为真实设备的连接字符串。 在“从应用程序获取真实设备的连接字符串”部分结束时，我们已记下该连接字符串。
