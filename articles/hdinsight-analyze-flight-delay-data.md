...
3. Set the first six variables in the following script, and then run the commands:
		...
		$sqlDatabaseLocation = "<MicrosoftDataCenter>"   #For example, China East.
