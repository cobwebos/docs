...
description: "如何创建并配置文件连接器或 API 应用，以及在 Azure 应用服务中的逻辑应用中使用它"
...
2. 在创建的逻辑应用中打开“触发器和操作”，以打开逻辑应用设计器并配置流。
...
现在已经创建了连接器，可以将其添加到使用逻辑应用的业务工作流中。 请参阅[什么是逻辑应用？](../logic-apps/logic-apps-what-are-logic-apps.md)。
...
你还可以查看连接器的性能统计信息和控制安全性。 请参阅[监视逻辑应用](../logic-apps/logic-apps-monitor-your-logic-apps.md)。
...
[使用混合连接管理器]: ../app-service-web/web-sites-hybrid-connection-get-started.md
