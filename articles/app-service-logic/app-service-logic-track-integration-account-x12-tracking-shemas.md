---
title: "X12 跟踪架构 |Microsoft 文档"
description: "了解有关 X12 跟踪架构的详细信息"
author: padmavc
manager: erikre
editor: 
services: logic-apps
...
* 了解有关[监视 B2B 消息](app-service-logic-monitor-b2b-message.md)的详细信息。
* 了解有关 [AS2 跟踪架构](app-service-logic-track-integration-account-as2-tracking-shemas.md)的详细信息。
* 了解有关 [B2B 自定义跟踪架构](app-service-logic-track-integration-account-custom-tracking-shema.md)的详细信息。
* 了解有关[在 Operations Management Suite 门户中跟踪 B2B 消息](app-service-logic-track-b2b-messages-omsportal.md)的信息。
