---
title: "在 Azure 应用服务中创建贸易合作伙伴协议 | Microsoft Docs"
...
---
# <a name="creating-a-trading-partner-agreement"></a>创建贸易合作伙伴协议
...
### <a name="biztalk-api-apps-that-support-b2b-scenarios"></a>支持 B2B 方案的 BizTalk API 应用
下面的 API 应用支持这些功能在 Azure 门户中使用丰富而直观的体验：

## <a name="biztalk-trading-partner-management-tpm"></a>BizTalk 贸易合作伙伴管理 (TPM)
* 创建和管理合作伙伴、配置文件和标识
* 存储和管理 EDI 架构
* 存储和管理证书（在 AS2 协议中使用）
* 创建和管理 AS2 协议
