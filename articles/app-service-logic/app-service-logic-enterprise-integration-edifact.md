...
> [!NOTE]
> 此页介绍逻辑应用的 EDIFACT 功能。 有关 X12 的信息，请单击[此处](app-service-logic-enterprise-integration-x12.md)。
> 
> 
...
[创建了集成帐户](app-service-logic-enterprise-integration-accounts.md)并[添加了合作伙伴](app-service-logic-enterprise-integration-partners.md)之后，可以通过执行以下步骤来创建 EDIFACT 协议：  
