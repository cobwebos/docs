...
基于消耗量的使用情况中包含一个用于浏览、开发和测试用途的[集成帐户](https://docs.microsoft.com/en-us/azure/app-service-logic/app-service-logic-enterprise-integration-create-integration-account?toc=%2fazure%2flogic-apps%2ftoc.json)，允许你使用逻辑应用的 [B2B/EDI](https://docs.microsoft.com/en-us/azure/app-service-logic/app-service-logic-enterprise-integration-b2b?toc=%2fazure%2flogic-apps%2ftoc.json) 和 [XML 处理](https://docs.microsoft.com/en-us/azure/app-service-logic/app-service-logic-enterprise-integration-xml?toc=%2fazure%2flogic-apps%2ftoc.json)功能且不需要另外付费。 在每个区域最多可以创建一个帐户并且可以存储最多 10 个协议和 25 个地图。 架构、证书和合作伙伴没有限制，你可以根据需要任意上载。

除了包括带有消耗量的集成帐户之外，还可以创建没有这些限制且采用我们的标准逻辑应用 SLA 的标准集成帐户。 有关进一步的详细信息，请参阅[此处](https://azure.microsoft.com/pricing/details/logic-apps)。
...
* [逻辑应用概述][定义]
* [创建你的第一个逻辑应用][创建] [定价]：https://azure.microsoft.com/pricing/details/logic-apps/ [定义]：app-service-logic-what-are-logic-apps.md [创建]：app-service-logic-create-a-logic-app.md
