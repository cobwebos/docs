---
title: "在逻辑应用中调用自定义 API"
description: "在逻辑应用中使用在应用服务中托管的自定义 API"
...
有关在逻辑应用中生成 API 并将其用作触发器或操作的信息，请查阅[这篇文章](app-service-logic-create-api-app.md)。
...
[![部署到 Azure](./media/app-service-logic-custom-hosted-api/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2F201-logic-app-custom-api%2Fazuredeploy.json)
