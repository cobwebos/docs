...
| 代码 | 说明 | 解决方法 |
|:--|:--|:--|
| 0x17 | 库安装程序需要尚未安装的 Windows 更新。 | 查看最新的库安装程序日志（详见上文）。<br><br>如果对“Windows8.1-KB2999226-x64.msu”的引用后跟一行文字“错误 0x80240017：未能执行 MSU 包”，则请参阅知识库文章 https://support.microsoft.com/kb/2919355。<br><br>再次运行 Microsoft 依赖关系代理安装程序。 |
