...
- 在解决方案中包括 [IngestionAPI 模块](https://www.powershellgallery.com/packages/OMSIngestionAPI/1.5)，以供将数据写入到 Log Analytics 存储库的 runbook 使用。  将解决方案配置为[引用](operations-management-suite-solutions-solution-file.md#solution-resource)此资源，以便在删除了解决方案后，此资源仍保留。  这就可以让多个解决方案共享此模块。
...
- 将解决方案配置为[引用](operations-management-suite-solutions-solution-file.md#solution-resource)警报规则，以便用户可以更改其配置。  他们可能想要进行更改，例如修改收件人列表、更改警报的阈值或禁用警报规则。 


## <a name="next-steps"></a>后续步骤
* 演练[设计和生成管理解决方案](operations-management-suite-solutions-creating.md)的基本过程。
* 了解如何[创建解决方案文件](operations-management-suite-solutions-solution-file.md)。
