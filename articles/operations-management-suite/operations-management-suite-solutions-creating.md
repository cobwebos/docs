...
![OMS 解决方案概述](media/operations-management-suite-solutions/solution-overview.png)
...
配置并测试将要成为解决方案一部分的组件以后，即可[创建解决方案文件](operations-management-suite-solutions-solution-file.md)。  可在 [Resource Manager 模板](../azure-resource-manager/resource-group-authoring-templates.md)中实现解决方案组件。该模板包含一个与文件中的其他资源存在多项关系的[解决方案资源](operations-management-suite-solutions-solution-file.md#solution-resource)。  
