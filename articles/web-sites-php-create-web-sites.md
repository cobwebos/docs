...
有关端到端教程，请访问 [PHP 开发中心 - 教程][PHP 开发中心 - 教程]页。
  ...
  [针对 Mac 和 Linux 的 Azure 命令行工具]: /zh-cn/develop/php/how-to-guides/command-line-tools/
  [Azure PowerShell cmdlet]: /zh-cn/develop/php/how-to-guides/powershell-cmdlets/
  [Azure 网站]: /zh-cn/manage/services/web-sites/
  [如何在 Azure 网站中配置 PHP]: /zh-cn/develop/php/common-tasks/configure-php-web-site/
  ...
  [在 Azure 中从库中创建 WordPress 网站]: /zh-cn/develop/php/tutorials/website-from-gallery/
  [选择“快速创建”网站]: ./media/web-sites-php-create-web-sites/select-quickcreate-website.png
  [如何安装针对 Mac 和 Linux 的 Azure 命令行工具]: /zh-cn/develop/php/how-to-guides/command-line-tools/#Download
  [如何下载和导入发布设置]: /zh-cn/develop/php/how-to-guides/command-line-tools/#Account
  [如何创建和管理 Azure 网站]: /zh-cn/develop/php/how-to-guides/command-line-tools/#WebSites
  [Azure PowerShell 入门]: /zh-cn/develop/php/how-to-guides/powershell-cmdlets/#GetStarted
  [如何：导入发布设置]: /zh-cn/develop/php/how-to-guides/powershell-cmdlets/#ImportPubSettings
  [如何：创建和管理 Azure 网站]: /zh-cn/develop/php/how-to-guides/powershell-cmdlets/#WebSite
  [如何配置网站]: /zh-cn/manage/services/web-sites/how-to-configure-websites/
  ...
  [使用 Git 进行发布]: /zh-cn/develop/php/common-tasks/publishing-with-git/
  [PHP 开发中心 - 教程]: /zh-cn/develop/php/tutorials/
