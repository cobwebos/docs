...
| 语言              | 语言代码 | v2 支持 | v3 支持 | 正在启动 v3 模型版本： |              备注 |
|:----------------------|:-------------:|:----------:|:----------:|:--------------------------:|-------------------:|
...
| 语言               | 语言代码 | 版本2.1 支持 | v3 支持 | 从 v3 模型版本开始： |       备注        |
|:-----------------------|:-------------:|:----------:|:----------:|:-------------------------------:|:------------------:|
| 阿拉伯语                |     `ar`      |     ✓      |            |                                 |                    |
| 捷克语                 |     `cs`      |     ✓      |            |                                 |                    |
| 简体中文     |   `zh-hans`   |     ✓      |            |                                 | `zh` 也接受 |
...
| 语言              | 语言代码 | v2 支持 | v3 支持 | 从 v3 模型版本开始提供： |       备注        |
|:----------------------|:-------------:|:----------:|:----------:|:-----------------------------------------:|:------------------:|
| 荷兰语                 |     `nl`      |     ✓      |     ✓      |                2019-10-01                 |                    |
| 英语               |     `en`      |     ✓      |     ✓      |                2019-10-01                 |                    |
| 芬兰语               |     `fi`      |     ✓      |     ✓      |                2019-10-01                 |                    |
