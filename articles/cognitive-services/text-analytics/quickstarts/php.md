...
ms.locfileid: "75378579"
---
# <a name="quickstart-using-php-to-call-the-text-analytics-cognitive-service"></a>快速入门：使用 PHP 调用文本分析认知服务
<a name="HOLTop"></a>

本文展示了如何将[文本分析 API](#Detect)[与 PHP 配合使用来](#SentimentAnalysis)检测语言[、](#KeyPhraseExtraction)分析情绪[、](#Entities)提取关键短语 [以及](//go.microsoft.com/fwlink/?LinkID=759711)识别链接的实体 。
