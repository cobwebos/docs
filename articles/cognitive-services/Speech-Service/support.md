...
description: 如何获取与语音服务集成的应用程序时遇到的问题和问题的帮助和支持
...
如果通过搜索找不到问题的答案，请使用[microsoft 认知 + 语音](https://stackoverflow.com/questions/tagged/microsoft-cognitive+speech)标记将新问题提交到 Stack Overflow。
