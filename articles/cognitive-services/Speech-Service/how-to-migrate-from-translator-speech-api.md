---
title: 从翻译语音 API 迁移到语音服务
titleSuffix: Azure Cognitive Services
description: 了解如何将应用程序从翻译语音 API 迁移到语音服务。
...
---
# <a name="migrate-from-the-translator-speech-api-to-the-speech-service"></a>从翻译语音 API 迁移到语音服务

使用本文将应用程序从 Microsoft 翻译语音 API 迁移到[语音服务](index.yml)。 本指南概述了翻译语音 API 和语音服务之间的差异，并提出了迁移应用程序的策略。

> [!NOTE]
> 您的翻译语音 API 订阅密钥不会被语音服务接受。 您需要创建新的语音服务订阅。
...
| 可用 SDK                                    | :heavy_minus_sign:                                              | :heavy_check_mark:                 | 有关可用的 SDK，请参阅[语音服务文档](index.yml)。                                                                                                                                                    |
| WebSocket 连接                            | :heavy_check_mark:                                              | :heavy_check_mark:                 |                                                                                                                                                                                                                                                                                    |
| 语言 API                                     | :heavy_check_mark:                                              | :heavy_minus_sign:                 | 语音服务支持[翻译 API 语言参考](../translator-speech/languages-reference.md)文章中描述的相同语言范围。 |
...
| 自定义语音模型                              | :heavy_minus_sign:                                              | :heavy_check_mark:                 | 语音服务提供自定义语音模型，使您能够根据组织的独特词汇自定义语音识别。                                                                                                                                           |
...
如果您或您的组织的开发或生产中的应用程序使用翻译语音 API，则应更新它们以使用语音服务。 有关可用的 SDK、代码示例和教程，请参阅[语音服务](index.yml)文档。 迁移时请考虑以下事项：
...
* 如果应用程序使用翻译文本 API 和翻译人员语音 API 启用自定义翻译模型，则可以使用语音服务直接添加类别 ID。

* 与翻译语音 API 不同，语音服务可以在单个请求中完成翻译成多种语言。
