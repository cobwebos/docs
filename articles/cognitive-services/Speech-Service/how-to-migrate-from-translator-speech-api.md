...
description: 了解如何将您的应用程序从语音翻译 API 迁移到语音服务。
...
> [!NOTE]
> 语音服务不接受语音翻译 API 订阅密钥。 你将需要创建新的语音服务订阅。
...
| 可用 SDK                                    | :heavy_minus_sign:                                              | :heavy_check_mark:                 | 请参阅[语音服务文档](index.yml)为提供的 Sdk。                                                                                                                                                    |
| WebSocket 连接                             | :heavy_check_mark:                                              | :heavy_check_mark:                 |                                                                                                                                                                                                                                                                                    |
| 语言 API                                     | :heavy_check_mark:                                              | :heavy_minus_sign:                 | 语音服务支持的语言中所述的相同范围[Translator API 语言参考](../translator-speech/languages-reference.md)一文。 |
...
| 自定义语音模型                              | :heavy_minus_sign:                                              | :heavy_check_mark:                 | 语音服务提供的自定义语音模型，您可以自定义语音识别添加到你组织的唯一词汇。                                                                                                                                           |
...
* 与不同的语音翻译 API，语音服务可以完成为单个请求中的多种语言的翻译。
