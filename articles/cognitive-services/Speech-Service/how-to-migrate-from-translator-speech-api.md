...
ms.locfileid: "73464591"
---
# <a name="migrate-from-the-translator-speech-api-to-the-speech-service"></a>从语音翻译 API 迁移到语音服务

本文介绍了如何将应用程序从 Microsoft 语音翻译 API 迁移到[语音服务](index.md)。 本指南概述了语音翻译 API 与语音服务的区别，并推荐了应用程序迁移策略。
...
| 可用 SDK                                    | :heavy_minus_sign:                                              | :heavy_check_mark:                 | 有关可用 SDK，请参阅[语音服务文档](index.md)。                                                                                                                                                    |
...
如果你或组织有处于开发或生产阶段且使用语音翻译 API 的应用程序，应将应用程序更新为使用语音服务。 有关可用 SDK、代码示例和教程，请参阅[语音服务](index.md)文档。 迁移时请考虑以下事项：
