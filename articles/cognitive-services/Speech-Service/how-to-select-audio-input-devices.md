...
ms.locfileid: "56448528"
---
# <a name="how-to-select-an-audio-input-device-with-the-speech-sdk"></a>如何使用语音 SDK 选择音频输入设备 
...
在 C# 中，可以使用 [NAudio](https://github.com/naudio/NAudio) 库来访问 CoreAudio API 并枚举设备，如下所示：
