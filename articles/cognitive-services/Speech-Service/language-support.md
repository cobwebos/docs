...
en-US | 英语(美国) | 男 | "Microsoft Server Speech Text to Speech Voice (en-US, GuyNeural)" | "英语-美国-GuyNeural"
en-US | 英语(美国) | 女 | "Microsoft Server Speech Text to Speech Voice (en-US, JessaNeural)" | "英语-美国-JessaNeural"
...
de-DE | 德语(德国) | 女 | "Microsoft Server Speech Text to Speech Voice (de-DE, Hedda)" | "de-德国-Hedda"
...
en-AU | 英语(澳大利亚) | 女 | "Microsoft Server Speech Text to Speech Voice (en-AU, Catherine)" | "英语-澳大利亚-Catherine"
...
he-IL| 希伯来语(以色列) | 男| "Microsoft Server Speech Text to Speech Voice (he-IL, Asaf)" | "他 IL Asaf"
hi-IN | 印地语(印度) | 女 | "Microsoft Server Speech Text to Speech Voice (hi-IN, Kalpana, Apollo)" | "hi-IN-Kalpana-Apollo"
| | |女 | "Microsoft Server Speech Text to Speech Voice (hi-IN, Kalpana)" | "大家好-IN-Kalpana"
| | | 男 | "Microsoft Server Speech Text to Speech Voice (hi-IN, Hemant)" | "大家好-IN-Hemant"
...
ro-RO | 罗马尼亚语 | 男 | "Microsoft Server Speech Text to Speech Voice (ro-RO, Andrei)" | "远程办公室 RO Andrei"
...
th-TH | 泰语 | 男 | "Microsoft Server Speech Text to Speech Voice (th-TH, Pattara)" | "第 TH Pattara"
