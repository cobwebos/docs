...
|--|--|--|--|--|--|
| `de-DE` | 德语（德国）    | 女 | "de-DE-KatjaNeural" | 是。 英语（美国） | 常规 |
...
| `es-ES` | 西班牙语（西班牙）     | 女 |  "es-ElviraNeural"| 是。 英语（美国） | 常规 |
| `es-MX` | 西班牙语(墨西哥)    | 女 |  "DaliaNeural" | 是。 英语（美国） | 常规 |
| `fr-CA` | 法语（加拿大）     | 女 |  "fr-SylvieNeural" | 是。 英语（美国） | 常规 |
| `fr-FR` | 法语（法国）     | 女 | "fr-DeniseNeural"  | 是。 英语（美国） | 常规 |
| `it-IT` | 意大利语（意大利）     | 女 |  "it-IT-ElsaNeural"  | 是。 英语（美国） | 常规 |
| `ja-JP` | 日语            | 女 |  "ja-jp-NanamiNeural" | 是。 英语（美国） | 常规 |
| `ko-KR` | 韩语              | 女 |  "SunHiNeural" | 是。 英语（美国） | 常规 |
| `nb-NO` | 挪威语           | 女 | "nb-IselinNeural" | 否 | 常规 |
| `pt-BR` | 葡萄牙语(巴西) | 女 |  "pt-BR-FranciscaNeural" | 否 | 常规 |
| `tr-TR` | 土耳其语             | 女 | "tr-EmelNeural" | 否 | 常规 |
| `zh-CN` | 中文(普通话，简体)  | 女 |  "zh-CN-XiaoxiaoNeural"  | 是。 英语（美国） | 常规，提供多种语音样式 |
|  |  | 女 |  "zh-chs-XiaoyouNeural"  | 是。 英语（美国） | 儿童语音，针对故事 narrating 进行了优化 |
|  |  | 男 |  "zh-chs-YunyangNeural"  | 是。 英语（美国） | 针对新闻阅读进行了优化，提供了多种语音样式 |
