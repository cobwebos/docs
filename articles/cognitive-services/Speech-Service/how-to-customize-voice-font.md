...
> [!IMPORTANT]
> 在个人预览版阶段，订阅必须列入白名单才能使用自定义语音功能。 按照页面上的步骤将订阅列入白名单。
...
成功生成语音字体以后，可以对其先测试后部署，然后就可以使用了。 在“我的语音字体”表的“操作”列中单击“测试”。 此时会显示所选语音字体对应的测试页。 如果尚未提交任何语音测试请求，则此表为空。
...
> [!NOTE]
> 意大利语语音培训从 2000 多句话语的数据集开始。 中英双语模型也支持 2000 多句话语的数据集。
