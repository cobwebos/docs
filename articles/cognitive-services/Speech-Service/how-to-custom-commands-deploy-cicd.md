...
ms.locfileid: "85307448"
---
# <a name="continuous-deployment-with-azure-devops"></a>Azure DevOps 的连续部署
...
1. 请注意，这些脚本假设你使用的是区域，如果不是这样，则会 `westus2` 相应地更新任务的参数
    ...
    > ![发送活动有效负载](media/custom-commands/cicd-new-pipeline-yaml.png)
