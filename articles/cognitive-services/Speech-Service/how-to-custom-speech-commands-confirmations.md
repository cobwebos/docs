...
1. 添加用于确认的高级规则。 
   ...
   | Conditions            | 必需的参数-日期时间                                                    | 确定何时可以运行规则的条件    |   
...
1. 添加高级规则以处理成功的确认（用户说 "是"）
   ...
   | Conditions            | SuccessfulConfirmation & 必需的参数-DateTime                           | 确定何时可以运行规则的条件    |   
...
1. 添加高级规则以处理已拒绝的确认（用户未说）
   ...
   | Conditions            | DeniedConfirmation & 必需的参数-DateTime                               | 确定何时可以运行规则的条件    |   
