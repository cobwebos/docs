...
description: 了解如何使用语音 SDK 翻译语音。 本文介绍语音翻译的对象构造、支持的音频输入格式以及配置选项。
...
ms.locfileid: "87090888"
---
# <a name="learn-the-basics-of-speech-translation"></a>了解语音翻译基础知识

语音服务的核心功能之一是能够识别人类语音并将其翻译成其他语言。 本文介绍如何在应用和产品中使用语音 SDK 来执行高质量的语音翻译。

> [!TIP]
> 如果你没有机会完成我们的快速入门之一，我们建议你在购买之前仔细检查，并自行试用语音翻译。
