...
示例应用将会有一个很简单的 UI：一个按钮，用于启动文件的处理过程；一个文本标签，用于显示结果。
...
1. 在 iOS 模拟器中生成并运行示例代码，方法是在菜单中选择“产品” -> “运行”，或者单击“播放”按钮。 若要在 iOS 设备上运行，请将设备连接到开发计算机，然后选择设备作为运行目标。 目前，语音 SDK 仅支持 64 位 iOS 平台。
1. 在应用中单击“识别!” 按钮以后，会看到音频文件的内容“天气怎么样?” 显示在屏幕下部。
