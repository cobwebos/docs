...
ms.locfileid: "73506233"
---
## <a name="additional-language-and-platform-support"></a>其他语言和平台支持

如果已单击此选项卡，则可能看不到喜欢的编程语言的快速入门。 别担心，我们在 GitHub 上提供了其他快速入门材料和代码示例。 使用表格查找适用于编程语言和平台/OS 组合的示例。

| 语言 | 其他快速入门 | 代码示例 |
|----------|------------------------|--------------|
| C++ | |[快速入门](https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/quickstart/cpp)、[示例](https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/samples/cpp-linux)|
...
| Javascript | |[浏览器](https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/quickstart/js-browser) |
| Node.js | |[Windows、Linux 和 macOS](https://github.com/Azure-Samples/cognitive-services-speech-sdk/tree/master/quickstart/js-node) |
