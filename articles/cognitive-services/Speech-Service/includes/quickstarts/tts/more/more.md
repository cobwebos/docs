...
| 语言 | 其他快速入门 | 代码示例 |
|--|--|--|
| C# | [到音频文件][1-file] | [.NET Framework][dotnet]、[.NET Core][netcore]、[UWP][uwp]、[Unity][unity] 和 [Xamarin][xamarin] |
| C++ | [到音频文件][2-file] | [Windows][cpp-windows]、[Linux][cpp-linux]、[macOS][cpp-mac] |
| Java | [到音频文件][3-file] | [Android][java-android]、[JRE][java-jre] |
| JavaScript | [Node.js 到音频文件][js-node] | [Windows、Linux 和 macOS][js-code] |
| Objective-C | [iOS 到扬声器][obj-iOS-qck]、[macOS 到扬声器][obj-macOS-qck] | [iOS][obj-iOS]、[macOS][obj-macOS] |
| Python | [到音频文件][4-file] | [Windows、Linux 和 macOS][python] |
| Swift | [iOS 到扬声器][swift-iOS-qck]、[macOS 到扬声器][swift-macOS-qck] | [iOS][swift-iOS]、[macOS][swift-macOS] |
