...
ms.locfileid: "80656664"
---
:::row:::
    :::column span="3":::
        语音 SDK 仅支持**Ubuntu 16.04/18.04、Debian** **9、****红帽企业 Linux （RHEL） 8**和**CentOS 7/8**与 Linux 一起使用时的目标体系结构：
        - x86
        - X64
        - ARM32
        - ARM64
...
# <a name="rhel-8-and-centos-78"></a>[RHEL 8 和 CentOS 7/8](#tab/rhel-centos)
