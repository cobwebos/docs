...
> [!IMPORTANT]
> 在 iOS 上流式传输压缩音频需要语音 SDK 版本1.7.0 或更高版本。 同时它也支持 [ C++, C# 和 Linux (Ubuntu 16.04, Ubuntu 18.04, Debian 9) 上的 Java](how-to-use-codec-compressed-audio-input-streams.md) 以及 [Android 上的 Java](how-to-use-codec-compressed-audio-input-streams-android.md)。
