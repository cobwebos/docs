        ...
        <ul class="pivots">
            <li>
                ...
                <ul id="start">
                    ...
                    <li>
                        <a href="#intentrecognition">意向识别</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>阅读文档</h3>
                                                    <p>了解如何将意向识别添加到应用、工具和产品中。 包括概念、教程、API 参考和发行说明。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#conversationtranscription">对话听录</a>
                    ...
                    <li>
                        <a href="#voice-assistants">语音助手</a>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>与 Bot Framework 集成</h3>
                                                    <p>详细了解 Bot Framework、Direct Line 语音通道等。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用自定义命令</h3>
                                                    <p>了解如何轻松构建强大的命令和控制语音应用程序，使用户能够通过其语音完成任务。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>部署语音服务容器</h3>
                                                    <p>了解如何在本地使用语音容器（与 Kubernetes 和 Helm 配合使用）或在 Azure 容器实例中使用语音容器。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用租户模型提高准确性</h3>
                                                    <p>使用 Office 365 数据生成自定义模型，以便针对特定于组织的术语优化语音识别准确性。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>通过自定义语音改进合成</h3>
                                                    <p>使用可用语音数据为文本转语音应用生成可识别的独一无二的语音。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>获取对自定义神经语音的访问权限</h3>
                                                    <p>这是访问权限受到限制的功能，可用于创建自定义神经语音。 了解有关访问和限制的详细信息。
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
