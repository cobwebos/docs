...
只有美国联邦、州、地方和部落政府及其合作伙伴才能访问此专用实例，其操作由经过筛选的美国公民控制。
- 地区：美国弗吉尼亚州州长
- 语音 SDK 中的 SR：*配置。从Host（"wss：//virginia.stt.语音.azure.us"，"\<你的键\>"）;*
- 语音 SDK 中的 TTS：*配置。从Host（"https：//virginia.tts.speech.azure.us"，"[]()\<你的钥匙\>"）;*
