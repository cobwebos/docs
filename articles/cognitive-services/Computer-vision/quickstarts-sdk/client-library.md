---
title: 快速入门：计算机视觉客户端库
titleSuffix: Azure Cognitive Services
description: 了解如何在应用程序中通过所选语言的本机客户端库来使用 Azure 计算机视觉。
...
开始使用计算机视觉客户端库。 计算机视觉服务提供 AI 算法，可用于处理图像并返回其视觉对象特征的相关信息。 请按照以下步骤将包安装到应用程序中并试用基本任务的示例代码。
