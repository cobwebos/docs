---
title: 快速入门：提取印刷体文本 (OCR) - REST、Ruby - 计算机视觉
...
ms.locfileid: "45629520"
---
# <a name="quickstart-extract-printed-text-ocr-using-the-rest-api-and-ruby-in-computer-vision"></a>快速入门：在计算机视觉中使用 REST API 和 Ruby 提取印刷体文本 (OCR)
