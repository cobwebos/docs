...
在在本快速入门中，你将使用计算机视觉的 REST API 分析远程存储的图像以提取视觉特征。 使用 [Analyze Image](https://westcentralus.dev.cognitive.microsoft.com/docs/services/5adf991815e1060e6355ad44/operations/56f91f2e778daf14a499e1fa) 方法，可以根据图像内容提取视觉特征。
...
1. 必要时在代码中进行如下更改：
    ...
    1. 如果需要，将 `vision_base_url` 的值替换为你在其中获取了订阅密钥的 Azure 区域中的计算机视觉资源的终结点 URL。
...
JSON 中返回成功响应。 示例网页会进行分析，并在命令提示符窗口中显示成功的响应，如下例所示：
