...
description: 本快速入门将在认知服务中使用计算机视觉和 JavaScript 从图像中提取打印的文本。
...
ms.locfileid: "43768828"
---
# <a name="quickstart-extract-printed-text-ocr---rest-javascript"></a>快速入门：提取打印的文本 (OCR) - REST、JavaScript
...
JSON 中返回成功响应。 返回的 OCR 结果包括文本以及区域、行和字词的边界框。
