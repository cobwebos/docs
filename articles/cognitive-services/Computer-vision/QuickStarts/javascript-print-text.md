---
title: 快速入门：提取打印的文本 (OCR) - REST、JavaScript - 计算机视觉
...
ms.locfileid: "43842696"
---
# <a name="quickstart-extract-printed-text-ocr---rest-javascript---computer-vision"></a>快速入门：提取打印的文本 (OCR) - REST、JavaScript - 计算机视觉
