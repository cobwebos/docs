---
title: 快速入门：提取打印的文本 (OCR) - REST、C# - 计算机视觉
...
ms.locfileid: "49340216"
---
# <a name="quickstart-extract-printed-text-ocr-using-the-rest-api-and-c35-in-computer-vision"></a>快速入门：在计算机视觉中使用 REST API 和 C&#35; 提取印刷体文本 (OCR)
