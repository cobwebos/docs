---
title: 快速入门：提取印刷体文本和手写文本 - REST、C#
...
ms.locfileid: "72176920"
---
# <a name="quickstart-extract-printed-and-handwritten-text-using-the-computer-vision-rest-api-and-c"></a>快速入门：使用计算机视觉 REST API 和 C# 提取印刷体文本和手写文本
