...
description: 在本快速入门中，你将在认知服务中使用计算机视觉和 Java 从图像中提取手写文本。
...
ms.locfileid: "43768826"
---
# <a name="quickstart-extract-handwritten-text---rest-java"></a>快速入门：提取手写文本 - REST、Java
...
JSON 中返回成功响应。 手写识别结果包括检测到的文本以及区域、行和字词的边界框。
