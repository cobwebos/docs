...
若要创建搜索查询，请为终结点输入参数值。 请注意，门户中显示的参数可能会根据你选择的终结点而更改。 请参阅[自定义搜索 API 参考](https://docs.microsoft.com/rest/api/cognitiveservices/bing-custom-search-api-v7-reference#query-parameters)有关详细信息。 若要更改搜索实例使用的订阅、 添加相应的订阅密钥，并更新相应的市场和/或语言参数。
