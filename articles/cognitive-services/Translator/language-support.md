...
|南非荷兰语| `af`    |仅统计|  神经网络版|
|阿拉伯语|    `ar`    |神经可用|  神经网络版|
|Bangla|    `bn`    |神经可用|  神经网络版|
|波斯尼亚语(拉丁语系)|   `bs`    |神经可用|  神经网络版|
|保加利亚语| `bg`    |神经可用|  神经网络版|
|粤语(繁体)|   `yue`   |仅统计|  统计|
|加泰罗尼亚语|   `ca`    |仅统计|  统计|
|中文(简体)|    `zh-Hans`   |神经默认 |神经网络版|
|中文(繁体)|   `zh-Hant`   |神经默认 |神经网络版|
|克罗地亚语|  `hr`    |神经可用|  神经网络版|
|捷克语| `cs`    |神经可用|  神经网络版|
|丹麦语|    `da`    |神经可用   |神经网络版|
|荷兰语| `nl`    |神经可用|  神经网络版|
...
| 简体中文 | `zh-Hans` | 简体中文 `Hans`| <--> | 拉丁语 `Latn` |
| 简体中文 | `zh-Hans` | 简体中文 `Hans`| <--> | 繁体中文 `Hant`|
| 繁体中文 | `zh-Hant` | 繁体中文 `Hant`| <--> | 拉丁语 `Latn` |
| 繁体中文 | `zh-Hant` | 繁体中文 `Hant`| <--> | 简体中文 `Hans` |
