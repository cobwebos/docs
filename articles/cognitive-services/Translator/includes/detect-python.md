...
“翻译”全局终结点设置为 `endpoint`。 `path` 设置 `detect` 路由并确定我们需使用 API 的版本 3。

>[!NOTE]
> 有关终结点、路由和请求参数的详细信息，请参阅[翻译 3.0：检测](https://docs.microsoft.com/azure/cognitive-services/translator/reference/v3-0-detect)。
