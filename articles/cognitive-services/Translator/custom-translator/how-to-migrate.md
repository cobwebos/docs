...
这些操作在迁移时执行：
* 所有文档和项目定义的名称将附加“hub_”前缀，并随之迁移。  自动生成的测试和优化数据将命名为 hub_systemtune_<modelid> 或 hub_systemtest_<modelid>。  
...
4.  在下一页上，选择以下两个选项之一：
    ...
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，并单击“添加引用”。  仅部署的训练：如果选择此选项，则只会迁移已部署的系统和相关文档。
