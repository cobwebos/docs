...
description: 在本快速入门中，你将使用文本翻译 API 和 Go 将文本从一种语言翻译成另一种语言。
...
ms.locfileid: "49648303"
---
# <a name="quickstart-translate-text-with-the-translator-text-rest-api-go"></a>快速入门：使用文本翻译 REST API (Go) 对文本进行翻译
...
6. 生成文件，例如：“go build quickstart-translate.go”。
7. 运行文件，例如：“quickstart-translate”。
