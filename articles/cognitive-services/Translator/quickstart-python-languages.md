---
title: 快速入门：获取受支持的语言，Python - 文本翻译 API
...
ms.locfileid: "49644719"
---
# <a name="quickstart-get-supported-languages-with-the-translator-text-rest-api-python"></a>快速入门：通过文本翻译 REST API (Python) 获取受支持的语言
