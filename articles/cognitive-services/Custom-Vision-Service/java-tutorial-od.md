---
title: 教程：使用适用于 Java 的自定义视觉 SDK 创建对象检测项目 - 自定义视觉服务
...
ms.locfileid: "49957329"
---
# <a name="tutorial-create-an-object-detection-project-with-the-custom-vision-sdk-for-java"></a>教程：使用适用于 Java 的自定义视觉 SDK 创建对象检测项目
