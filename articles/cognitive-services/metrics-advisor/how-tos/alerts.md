...
> [!Note]
> 指标顾问资源管理员需要配置 **电子邮件设置**，并在指标顾问中输入 SMTP 相关信息，然后才能发送异常警报。
...
单击 " **添加** " 或 " **编辑** " 按钮以获取用于添加或编辑警报设置的窗口。
...
:::image type="content" source="../media/alerts/alert-setting-operator.png" alt-text="多个 "警报设置" 部分的 "运算符"":::
