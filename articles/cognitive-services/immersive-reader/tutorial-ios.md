...
ms.locfileid: "86049306"
---
# <a name="tutorial-launch-the-immersive-reader-using-the-swift-ios-code-sample"></a>教程：使用 Swift iOS 代码示例启动沉浸式阅读器
...
2. 在顶部菜单中，单击“产品”>“方案”>“编辑方案...”
3. 在“运行”视图中，单击“参数”选项卡。
4. 在“环境变量”部分中，添加以下名称和值，并提供在创建沉浸式阅读器资源时给出的值。
