...
```
![Android Studio 中的环境变量](../../media/android/kotlin/android-studio-assets-and-env-file.png)
...
![应用 Gradle 实现](../../media/android/kotlin/android-studio-build-gradle.png)
