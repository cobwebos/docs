...
## <a name="create-the-view-controllers-and-add-sample-content"></a>创建视图控制器并添加示例内容
...
将名为“ImmersiveReaderViewController.swft”的新文件添加到项目根文件夹，并添加以下代码。
...
将另一个名为“LaunchImmersiveReader.swift”的新文件添加到项目根文件夹，并添加以下代码。
...
将名为“iFrameMessaging.js”的文件添加到“Resources”文件夹，并添加以下代码。
