...
在本快速入门中，你将从头开始构建一个 iOS 应用，并集成沉浸式阅读器。 本快速入门的完整工作示例可在[此处](https://github.com/microsoft/immersive-reader-sdk/tree/master/iOS/samples/quickstart-swift)找到。
