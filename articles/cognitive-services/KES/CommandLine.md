...
## <a name="buildgrammar-command"></a>build_grammar Command
...
## <a name="describeindex-command"></a>describe_index command
...
## <a name="describegrammar-command"></a>describe_grammar command
