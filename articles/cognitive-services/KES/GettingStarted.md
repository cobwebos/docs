...
## <a name="defining-schema"></a>Defining schema
...
## <a name="generating-data"></a>Generating data
...
## <a name="building-index"></a>Building index
...
## <a name="authoring-grammar"></a>Authoring grammar
...
## <a name="compiling-grammar"></a>Compiling grammar
...
## <a name="hosting-service"></a>Hosting service
...
<a name="scaling-up"></a>
## <a name="scaling-up"></a>Scaling up
...
## <a name="deploying-service"></a>Deploying service
...
## <a name="testing-service"></a>Testing service
