...
# <a name="semantic-interpretation"></a>Semantic Interpretation
...
## <a name="semantic-functions"></a>Semantic Functions
...
### <a name="all-function"></a>All Function
`query = All();`
...
### <a name="none-function"></a>None Function
`query = None();`
...
### <a name="query-function"></a>Query Function
```
...
### <a name="composite-function"></a>Composite Function
...
### <a name="getvariable-function"></a>GetVariable Function
...
### <a name="setvariable-function"></a>SetVariable Function
