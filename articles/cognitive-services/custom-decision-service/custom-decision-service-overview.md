...
ms.openlocfilehash: 1d7e10ec5529422e6dd9e5c38c9925131902cb2e
...
To use this learning mode, you need to have an [Azure Storage account](../../storage/storage-create-storage-account.md) where your data would be logged. Choose "advanced options" when registering a new application on the portal, and enter the [connection string](../../storage/storage-configure-connection-string.md) for the Azure Storage account.
