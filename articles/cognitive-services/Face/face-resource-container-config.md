...
description: 使用  命令参数配置人脸`docker run`容器运行时环境。 同时存在必需设置和可选设置。
...
请记得将“人脸”路由添加到终结点 URI，如示例所示。 

|必须| 名称 | 数据类型 | 说明 |
|--|------|-----------|-------------|
|是| `Billing` | 字符串 | 账单终结点 URI。 有关获取账单 URI 的详细信息，请参阅[收集必需参数](face-how-to-install-containers.md#gathering-required-parameters)。 有关详细信息和区域终结点的完整列表，请参阅[认知服务的自定义子域名](../cognitive-services-custom-subdomains.md)。 |
