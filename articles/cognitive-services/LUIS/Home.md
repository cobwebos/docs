...
## <a name="language-understanding-intelligent-services-luis-brings-the-power-of-machine-learning-to-your-apps"></a>Language Understanding Intelligent Services (LUIS) brings the power of machine learning to your apps
...
## <a name="accessing-luis-programmatically"></a>Accessing LUIS programmatically
