...
了解如何[OrdinalV2](luis-reference-prebuilt-ordinal-v2.md)，[电话号码](luis-reference-prebuilt-phonenumber.md)，并[温度](luis-reference-prebuilt-temperature.md)实体。 
