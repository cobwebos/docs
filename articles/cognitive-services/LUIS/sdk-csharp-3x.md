---
title: 快速入门：适用于 .NET 的语言理解 (LUIS) 创作客户端库 3.x
titleSuffix: Azure Cognitive Services
description: 适用于 .NET 的 LUIS 客户端库 3.x 入门。 请按照以下步骤安装程序包并试用基本任务的示例代码。
...
ms.locfileid: "74808017"
---
# <a name="quickstart-language-understanding-luis-client-library-3x-for-net"></a>快速入门：适用于 .NET 的语言理解 (LUIS) 客户端库 3.x

适用于 .NET 的语言理解 (LUIS) 客户端库 3.x 入门。 请按照以下步骤安装程序包并试用基本任务的示例代码。  使用语言理解 (LUIS) 可在用户的自然语言对话文本中应用自定义的机器学习智能，以预测整体含义并提炼出相关的详细信息。

可以使用适用于 .NET 的语言理解 (LUIS) 客户端库 3.x 执行以下操作：
