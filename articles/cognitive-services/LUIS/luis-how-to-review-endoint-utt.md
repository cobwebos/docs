...
2. 在“提升应用性能”下，选择“评审终结点陈述”。
    ...
    ![审查陈述](./media/label-suggested-utterances/review.png)
...
若要测试标记建议陈述后的性能提升情况，可通过选择顶部面板中的“测试”访问测试控制台。 有关如何使用测试控制台测试应用的说明，请参阅[训练和测试应用](interactive-test.md)。
