---
title: 教程：了解如何使用 Node.js 调用语言理解智能服务 (LUIS) 应用 | Microsoft Docs
...
ms.locfileid: "36263646"
---
# <a name="tutorial-call-a-luis-endpoint-using-nodejs"></a>教程：使用 Node.js 调用 LUIS 终结点
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-nodejs"></a>在 Node.js 中通过终结点 API 使用 LUIS 结果
...
2. 根据代码注释中所述设置 `LUIS_APP_ID` 环境变量。 

3. 将 `LUIS_SUBSCRIPTION_KEY` 环境变量设置为认知服务订阅密钥。

4. 运行代码。 其中会显示前面在浏览器窗口中显示的相同值。
<!-- 
