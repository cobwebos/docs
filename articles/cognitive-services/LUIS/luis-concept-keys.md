...
> [!CAUTION]
> 为了方便起见，很多示例使用[初学者密钥](#starter-key)，因为该密钥在[配额](luis-limits.md#key-limits)中提供了几个免费的预测终结点调用。
...
**对于[创作资源迁移](luis-migration-authoring.md)的应用**：使用**访问控制（IAM）** 页在创作资源的 Azure 门户中管理_参与者_。 了解如何使用协作者的电子邮件地址和[参与者](luis-how-to-collaborate.md)角色_添加用户_。
...
**对于已迁移的[创作资源迁移了资源](luis-migration-authoring.md)的用户**：作为资源的所有者，你可以添加。 `contributor`
