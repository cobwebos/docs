---
title: 使用 PHP 调用语言理解 (LUIS) 应用 | Microsoft Docs
...
ms.locfileid: "36265120"
---
# <a name="tutorial-call-a-luis-endpoint-using-php"></a>教程：使用 PHP 调用 LUIS 终结点
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-php"></a>在 PHP 中通过终结点 API 使用 LUIS 结果 
...
3. 运行 PHP 应用程序。 其中会显示前面在浏览器窗口中显示的相同 JSON。
