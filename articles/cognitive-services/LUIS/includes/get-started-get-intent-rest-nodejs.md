...
使用 Node.js 查询预测终结点 GET [API](https://aka.ms/luis-apim-v3-prediction) 来获取预测结果。
...
1. 设置以下值：
    ...
    * `YOUR-KEY` 设置为初学者密钥
    * `YOUR-ENDPOINT` 设置为终结点 URL

1. 通过在命令行上运行以下命令来安装依赖项： 
...
> [添加言语并进行训练](../luis-get-started-node-add-utterance.md)