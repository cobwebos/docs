...
LUIS 为诸如 `Number` 这样的常见类型提供[预生成实体](luis-prebuilt-entities.md)，可用于票证顺序中的票证编号。
...
应用获得终结点话语后，计划通过[主动学习](luis-how-to-review-endoint-utt.md)、[短语列表](luis-concept-feature.md)和[模式](luis-concept-patterns.md)来实现预测改进。 
