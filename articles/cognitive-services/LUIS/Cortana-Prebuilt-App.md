...
若要调用终结点，可以将终结点密钥参数和查询字符串追加到终结点。 
...
将该 URL 粘贴到 Web 浏览器中，并将 `{YOUR-SUBSCRIPTION-KEY}` 字段替换为自己的终结点密钥。
...
![使用 Cortana 预构建应用](./media/luis-how-to-prebuilt-cortana/luis-prebuilt-cortana-browser.png)
