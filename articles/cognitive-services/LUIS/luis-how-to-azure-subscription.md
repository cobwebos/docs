...
4. 创建 LUIS 服务后，可选择“资源管理”->“密钥”，查看生成的密钥。  
    ...
    > [!Note] 
    > 登录所在区域的 [LUIS](luis-reference-regions.md) 网站，并[分配新的 LUIS 终结点密钥](luis-how-to-manage-keys.md#assign-endpoint-key)。 需要步骤 3 中 LUIS 订阅的名称。
