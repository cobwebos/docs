...
模式中的实体用花括号 `{}` 括起。 模式可包含实体和带角色的实体。 [模式.any](luis-concept-entity-types.md#patternany-entity)是仅在模式中使用的实体。
...
了解在 .json 响应中如何返回[情绪](luis-reference-prebuilt-sentiment.md)。