---
title: 教程：了解如何使用 Ruby 调用语言理解 (LUIS) 应用 | Microsoft Docs
...
ms.locfileid: "36265103"
---
# <a name="tutorial-call-a-luis-endpoint-using-ruby"></a>教程：使用 Ruby 调用 LUIS 终结点
...
## <a name="consume-a-luis-result-using-the-endpoint-api-with-ruby"></a>在 Ruby 中通过终结点 API 使用 LUIS 结果 
...
2. 在以下代码行中，将 `"YOUR-SUBSCRIPTION-KEY"` 替换为自己的订阅密钥：`subscriptionKey = "YOUR-SUBSCRIPTION-KEY"`

3. 运行 Ruby 应用程序。 其中会显示前面在浏览器窗口中显示的相同 JSON。
