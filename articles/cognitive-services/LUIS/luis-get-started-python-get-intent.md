---
title: 教程：了解如何使用 Python 调用语言理解 (LUIS) 应用 | Microsoft Docs
...
ms.locfileid: "36264578"
---
# <a name="tutorial-call-a-luis-endpoint-using-python"></a>教程：使用 Python 调用 LUIS 终结点
...
2. 请将 `Ocp-Apim-Subscription-Key` 字段的值替换为自己的 LUIS 订阅密钥。

3. 运行该脚本。 其中会显示前面在浏览器窗口中显示的相同 JSON。
<!-- 
