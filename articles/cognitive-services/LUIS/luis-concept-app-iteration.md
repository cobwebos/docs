...
可以从 HTTPS 终结点测试 LUIS 应用。 通过终结点测试, LUIS 可以选择具有低置信度的任何最谈话进行[查看](luis-how-to-review-endpoint-utterances.md)。  

## <a name="recycle"></a>再循环

结束一个创作周期后可以重新开始。 首先, 查看标记为置信度的[最谈话 LUIS 终结点](luis-how-to-review-endpoint-utterances.md)。 检查这些陈述的意向和实体。 评审陈述后，评审列表应为空。  
