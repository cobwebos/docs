---
title: 如何将异常查找器 API 与 Javascript 配合使用 - Microsoft 认知服务 | Microsoft Docs
description: 获取信息和示例代码，帮助用户快速开始将认知服务中的异常查找器与 Javascript 配合使用。
...
本文提供了相关信息和示例代码，帮助用户快速开始将异常情况监测 API 与 Javascript 配合使用，从而获取时序数据的异常情况检测结果。

## <a name="prerequisites"></a>先决条件

[!INCLUDE [GetSubscriptionKey](../includes/get-subscription-key.md)]

## <a name="getting-anomaly-points-with-anomaly-detection-api-using-javascript"></a>通过使用 Javascript 的异常情况监测 API 获取异常点
...
4. 将 requestTextArea 中的数据替换为数据点。
5. 在 Web 浏览器中打开 HTML 文件，然后单击 `Anomaly Detection` 按钮。
...
> [JavaScript 应用](../tutorials/javascript-tutorial.md)
