...
ms.locfileid: "79220816"
---
# <a name="project-answer-search-v7-reference"></a>项目答案搜索 v7 参考

必应答案搜索 API 在接受一个查询参数后，返回 `searchResponse` 为 `answerType` 或 `facts` 的 `entities`。 
...
若要请求答案搜索结果，请向以下终结点发送请求。 使用标头和 URL 参数来定义更多规范。
...
|名称|值|类型|必选|  
|----------|-----------|----------|--------------|  
|<a name="mkt" />mkt|产生结果的市场。 <br /><br />如需获取可能的市场值列表，请参阅“市场代码”。<br /><br /> **注意：** URL 预览 API 目前仅支持 en-us 市场和语言。<br /><br />|String|是|  
