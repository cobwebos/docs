...
## <a name="the-ink-recognizer-api-vs-ocr-services"></a>墨迹识别器 API 与 OCR 服务
...
[Windows Ink](https://docs.microsoft.com/windows/uwp/design/input/pen-and-stylus-interactions) 提供所需的工具和技术用于在多种不同的设备上实现数字墨迹体验。 您可以将 Windows 墨迹平台与墨迹识别器 API 相结合，以创建显示和解释数字墨迹描边的应用程序。
