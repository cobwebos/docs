---
title: 快速入门：使用 Ruby 调用必应 Web 搜索 API
...
在最喜爱的 IDE 或编辑器中新建一个 Ruby 项目。 然后，要求用于请求的 `net/https`，要求用于 URI 处理的 `uri`，并要求用于分析响应的 `json`。
