...
您可以通过使用 [responseFilter](https://docs.microsoft.com/rest/api/cognitiveservices-bingsearch/bing-web-api-v7-reference#responsefilter) 查询参数（以逗号分隔的答案列表）筛选必应包含在响应 (例如图像、视频和新闻) 的答案类型。 如果 Bing 为其查找相关内容，则响应将包含在响应中。 
