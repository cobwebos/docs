...
- 使用在之前对某个[必应图像搜索 API](https://docs.microsoft.com/rest/api/cognitiveservices/bing-images-api-v7-reference) 终结点的调用中从图像获取的见解令牌。
- 发送图像的 URL。
- 上传图像（以二进制格式）
...
* [教程：构建单页 Web 应用 - 必应视觉搜索](../tutorial-bing-visual-search-single-page-app.md)
