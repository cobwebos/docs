...
ms.locfileid: "35366631"
---
# <a name="your-first-bing-visual-search-query-in-javascript"></a>用 JavaScript 编写的第一个必应视觉搜索查询

必应视觉搜索 API 将返回有关所提供的图像的信息。 可以使用图像的 URL、见解令牌或上传图像来提供图像。 有关这些选项的信息，请参阅[什么是必应视觉搜索 API？](../overview.md) 本文演示上传映像。 上传图像在移动方案中非常有用，在这类方案中，你可以拍摄知名地标的照片并取回有关它的信息。 例如，见解可能包括有关地标的琐事。 
