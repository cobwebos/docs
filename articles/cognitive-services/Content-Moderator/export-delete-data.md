...
description: 您可以完全控制数据。 了解如何在内容审阅人中查看、导出或删除数据。
...
| Tags | 空值 | 使用评审 UI 中“标记设置”页面上可用于每个标记的“删除”图标**** 或者使用[评审 UI](https://contentmoderator.cognitive.microsoft.com/)“团队设置”页面中的“删除团队”**** 按钮。 |
