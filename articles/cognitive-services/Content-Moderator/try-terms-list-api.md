...
使用[列表管理 API](https://westus.dev.cognitive.microsoft.com/docs/services/57cf755e3f9b070c105bd2c2/operations/57cf755e3f9b070868a1f67f)来创建要供文本审查 API 使用的自定义术语列表。 **"文本- 屏幕**"操作扫描文本的亵渎行为，并将文本与自定义和共享阻止列表进行比较。
