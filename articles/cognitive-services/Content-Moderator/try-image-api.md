...
使用 Azure 内容审查器中的[图像审查 API](https://westus.dev.cognitive.microsoft.com/docs/services/57cf753a3f9b070c105bd2c1/operations/57cf753a3f9b070868a1f66c)，可以启动图像内容的扫描和审阅式审查工作流。 审核作业会扫描内容的亵渎行为，并将其与自定义和共享阻止列表进行比较。
...
在代码中使用 REST API，或按照[.NET SDK 快速入门](dotnet-sdk-quickstart.md)向应用程序添加映像审核。
