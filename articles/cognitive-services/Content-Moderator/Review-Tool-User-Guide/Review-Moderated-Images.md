...
在本指南中，您学习了如何设置和使用内容审查器[审阅工具](https://contentmoderator.cognitive.microsoft.com)中的评论。 接下来，请参阅[REST API 指南](../try-review-api-review.md)或[.net SDK 快速入门](../dotnet-sdk-quickstart.md)，了解如何以编程方式创建评论。