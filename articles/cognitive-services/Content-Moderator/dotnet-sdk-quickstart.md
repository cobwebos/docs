---
title: 快速入门：适用于 .NET 的内容审查器客户端库 | Microsoft Docs
titleSuffix: Azure Cognitive Services
description: 适用于 .NET 的内容审查器客户端库入门。
...
ms.locfileid: "73045219"
---
# <a name="quickstart-content-moderator-client-library-for-net"></a>快速入门：适用于 .NET 的内容审查器客户端库
...
可使用内容审查器 .NET SDK 将内容馈送到[评审工具](https://contentmoderator.cognitive.microsoft.com)，使审查人员可以评审该内容。 若要详细了解评审工具，请参阅[评审工具概念指南](./review-tool-user-guide/human-in-the-loop.md)。
...
* 可以在 [GitHub](https://github.com/Azure-Samples/cognitive-services-dotnet-sdk-samples/blob/master/documentation-samples/quickstarts/ContentModerator/Program.cs) 上找到此示例的源代码。
