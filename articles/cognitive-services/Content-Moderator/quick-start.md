...
ms.openlocfilehash: d8523c6a0df413ab91de9333481ed5035fdc6076
...
## <a name="what-if-i-want-to-directly-try-the-image-and-text-moderation-apis"></a>What if I want to directly try the image and text moderation APIs?
...
## <a name="1-sign-up-and-invite-others"></a>1. Sign up and invite others
...
## <a name="2-upload-images-or-enter-text"></a>2. Upload images or enter text
...
## <a name="3-submit-for-automated-moderation"></a>3. Submit for automated moderation
...
## <a name="4-review-and-confirm-results"></a>4. Review and confirm results
