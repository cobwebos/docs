...
description: 演示如何在单页 Web 应用程序中使用必应图像搜索 API 的教程的源代码。
...
ms.locfileid: "35365445"
---
# <a name="tutorial-single-page-web-app"></a>教程：单页 Web 应用程序

这是必应图像搜索的[单页应用教程](tutorial-bing-image-search-single-page-app.md)中讨论的完整源代码。 若要运行该应用，请将源代码复制到记事本或其他文本编辑器中，并将其另存为 `bing.html`。 然后，在 Microsoft Edge 或其他常用浏览器中打开已保存的文件。
