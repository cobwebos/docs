---
title: 调用和响应 - 适用于 Azure 认知服务中的必应图像搜索 API 的 Java 快速入门 | Microsoft Docs
...
ms.locfileid: "35366454"
---
# <a name="call-and-response-your-first-bing-image-search-query-in-java"></a>调用和响应：你的采用 Java 的第一个必应图像搜索查询
