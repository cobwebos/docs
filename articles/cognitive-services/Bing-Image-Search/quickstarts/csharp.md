---
title: 调用和响应 - 适用于 Azure 认知服务中的必应图像搜索 API 的 C# 快速入门 | Microsoft Docs
...
ms.locfileid: "35366461"
---
# <a name="call-and-response-your-first-bing-image-search-query-in-c"></a>调用和响应：你的采用 C# 的第一个必应图像搜索查询
...
1. 将 `Program.cs` 替换为所提供的代码。
2. 将 `accessKey` 值替换为对你的订阅有效的访问密钥。
3. 运行该程序。
