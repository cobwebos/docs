---
title: 上传必应图像以获取见解（源代码）| Microsoft Docs
description: 使用必应图像搜索 API 上传图像并获取图像见解的控制台应用的源代码。
...
ms.locfileid: "35365463"
---
# <a name="tutorial-bing-image-upload-for-insights"></a>教程：上传必应图像以获取见解

这是[上传必应图像以获取见解](tutorial-image-post.md)教程的完整源代码，其中结合使用图像搜索终结点和 `POST` 请求。 若要运行应用，请将源代码复制到 C# 控制台应用中。 生成解决方案，并在 Visual Studio 调试程序中运行。
