...
ms.openlocfilehash: 5de2d7ad200c87ed5d1bd73b453d314e5db9aac3
...
## <a name="preparing-your-data-to-customize-the-acoustic-model"></a>Preparing your data to customize the acoustic model
...
### <a name="audio-data-recommendations"></a>Audio Data Recommendations
...
## <a name="step-1-importing-the-acoustic-data-set"></a>Step 1: Importing the acoustic data set
...
## <a name="step-2-creating-a-custom-acoustic-model"></a>Step 2: Creating a custom acoustic model
