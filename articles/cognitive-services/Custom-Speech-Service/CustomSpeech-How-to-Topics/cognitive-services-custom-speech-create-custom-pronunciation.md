---
title: 结合使用自定义发音和 Azure 上的自定义语音服务 | Microsoft Docs
description: 了解如何使用认知服务中的自定义语音服务创建语言模型。
...
![包含多个首字母缩略词发音条目的记事本屏幕截图](../../../media/cognitive-services/custom-speech-service/custom-speech-pronunciation-file.png)
...
>[注意]（发音文件中的）术语显示形式应与语言顺应数据集中的编写方式相同。
...
* 通过创建[自定义声学模型](cognitive-services-custom-speech-create-acoustic-model.md)提高识别准确性。
* [创建自定义语音转文本终结点](cognitive-services-custom-speech-create-endpoint.md)（可以在应用中使用）。
