...
# <a name="get-started-with-bing-speech-recognition-in-java-on-android"></a>Get Started with Bing Speech Recognition in Java on Android
...
#### <a name="get-the-client-library-and-example-application"></a>Get the Client Library and Example Application
...
## <a name="step-1-install-the-example-application-and-create-the-application-framework"></a>Step 1: Install the Example Application and Create the Application Framework
...
```
#### <a name="create-a-client"></a>Create a Client:
...
#### <a name="select-a-locale"></a>Select a Locale
...
#### <a name="select-a-recognition-mode"></a>Select a Recognition Mode
...
#### <a name="attach-an-event-handler"></a>Attach an Event Handler
...
#### <a name="select-confidence-value-and-text-form"></a>Select Confidence Value and Text Form
