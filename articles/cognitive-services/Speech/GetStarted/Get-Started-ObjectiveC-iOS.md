...
# <a name="get-started-with-bing-speech-recognition-api-in-objective-c-on-ios"></a>Get Started with Bing Speech Recognition API in Objective C on iOS
...
<a name="Step2"> </a>
## <a name="step-2-build-the-application--example-code"></a>Step 2: Build the Application / Example Code
...
#### <a name="select-a-language"></a>Select a Language
...
#### <a name="attach-event-handlers"></a>Attach Event Handlers
