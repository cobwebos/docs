...
# <a name="get-started-with-bing-speech-recognition-in-c35-for-net-on-windows-phone-81"></a>Get Started with Bing Speech Recognition in C&#35; for .Net on Windows Phone 8.1
...
### <a name="access-the-client-library-and-download-the-example"></a>Access the client library and download the example
...
<a name="Summary"> </a>
## <a name="summary-remarks"></a>Summary Remarks 
