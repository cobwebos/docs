...
ms.openlocfilehash: 7a29dc764d564c3def74795ee67569f56a1a3f7d
...
> Phrase results are emitted during silence boundaries in the audio stream. In the future, we plan on exposing more real-time partial results which can be used to improve user-experience generally in realtime dictation scenarios.

## <a name="recognition-languages"></a>Recognition Languages
...
### <a name="inverse-text-normalization-itn-form"></a>Inverse Text Normalization (ITN) form
...
### <a name="masked-inverse-text-normalization-itn-form"></a>Masked Inverse Text Normalization (ITN) Form
