...
# <a name="bing-speech-recognition-api"></a>Bing Speech Recognition API
...
### <a name="a-namesampleimplementationrest-api-implementation-sample"></a><a name="SampleImplementation">REST API Implementation Sample
