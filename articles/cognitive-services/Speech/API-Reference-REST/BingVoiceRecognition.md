...
ms.openlocfilehash: a3fca521d36c03640e03ce0c9e9831d6613b0601
ms.contentlocale: zh-cn
ms.lasthandoff: 06/28/2017

---

# <a name="convert-speech-to-text-with-microsoft-apis"></a>Convert speech to text with Microsoft APIs
...
### <a name="conversation-mode"></a>Conversation mode
...
## <a name="recognition-language"></a>Recognition language 
...
#### <a name="profanity-only-utterances"></a>Profanity-only utterances
