...
|PDF / DOC|常见问题解答、<br> 产品手册、<br> 小册子、<br> 论文、<br> 传单策略、<br> 支持指南、<br> 结构化 QnA，<br> 等等|**无多转**<br>[Structured QnA.doc](https://github.com/Azure-Samples/cognitive-services-sample-data-files/blob/master/qna-maker/data-source-formats/structured.docx)、<br> [Sample Product Manual.pdf](https://github.com/Azure-Samples/cognitive-services-sample-data-files/blob/master/qna-maker/data-source-formats/product-manual.pdf)、<br> [Sample semi-structured.doc](https://github.com/Azure-Samples/cognitive-services-sample-data-files/blob/master/qna-maker/data-source-formats/semi-structured.docx)、<br> [示例白皮书.pdf，](https://github.com/Azure-Samples/cognitive-services-sample-data-files/blob/master/qna-maker/data-source-formats/white-paper.pdf)<br><br>**多转**：<br>[表面专业版（多cx）](https://github.com/Azure-Samples/cognitive-services-sample-data-files/blob/master/qna-maker/data-source-formats/multi-turn.docx)<br>[康托索优势 （多 cx）](https://github.com/Azure-Samples/cognitive-services-sample-data-files/blob/master/qna-maker/data-source-formats/Multiturn-ContosoBenefits.docx)<br>[康托索福利 （pdf）](https://github.com/Azure-Samples/cognitive-services-sample-data-files/blob/master/qna-maker/data-source-formats/Multiturn-ContosoBenefits.pdf)|
...
如果需要对数据源进行身份验证，请考虑以下方法将该内容放入 QnA Maker：

* 手动下载文件并导入 QnA 制造商
* 从经过身份验证[的共享点位置](../how-to/add-sharepoint-datasources.md)添加文件

## <a name="url-content"></a>URL 内容

可通过 QnA Maker 中的**URL**导入两种类型的文档：
...
您可以在[QnA Maker 门户](https://www.qnamaker.ai)中从公共源或本地文件系统将文件添加到知识库。

## <a name="content-format-guidelines"></a>内容格式指南

详细了解不同文件的[格式指南](../reference-document-format-guidelines.md)。

## <a name="next-steps"></a>后续步骤

了解哪些信息存储在[问答 （QnA） 集中](question-answer-set.md)。