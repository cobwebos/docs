...
![QnA Maker 与语言理解体系结构](../media/qnamaker-tutorials-qna-luis/qnamaker-luis-architecture.PNG)
...
1. [创建"基本"Web 应用的机器人](https://docs.microsoft.com/azure/bot-service/bot-service-quickstart?view=azure-bot-service-4.0)自动包含 LUIS 应用。 选择的 4.x SDK 和C#编程语言。
...
7. 修改 BasicLuisDialog 类。 每个 LUIS 意向都应具有一个使用 LuisIntent  修饰的方法。 修饰的参数是实际的 LUIS 意向名称。 被修饰的方法名称应  为具备可读性和可维护性的 LUIS 意向名称，但不必与在设计或运行时使用的名称相同。  
