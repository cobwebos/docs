...
* [替换 API （具有相同知识库 ID 的重载）](https://docs.microsoft.com/rest/api/cognitiveservices/qnamaker/knowledgebase/replace)
* [创建 API （具有新知识库 ID 的负载）](https://docs.microsoft.com/rest/api/cognitiveservices/qnamaker/knowledgebase/create)
