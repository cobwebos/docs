...
有关 Visual Studio 和 Python 的更多帮助信息，请参阅：[在 Windows 上的 Visual Studio 中使用 Python](https://docs.microsoft.com/en-us/visualstudio/python/overview-of-python-tools-for-visual-studio)。
