...
QnA Maker 允许多人在同一 QnA Maker 资源中的所有知识库上协作。 此功能通过 Azure [基于角色的访问控制](https://docs.microsoft.com/azure/active-directory/role-based-access-control-configure)提供。

执行以下步骤，与他人共享 QnA Maker 服务：

1. 登录到 Azure 门户，然后转到 QnA Maker 资源。
...
1. 选择“所有者”或“参与者”角色********。 不能通过基于角色的访问控制授予只读访问权限。 所有者和参与者角色对 QnA Maker 服务具有读写访问权限。
...
当此人与此人共享 QnA Maker 服务时，登录到[QnA Maker 门户](https://qnamaker.ai)，他们可以看到该服务中的所有知识库。
