...
## <a name="toplevel-categories"></a>顶级类别 
...
下面的示例根据 `localCategories` 参数获取结果：
...
- [地理搜索边界](specify-geographic-search.md)
- [查询和响应](local-search-query-response.md)
- [采用 C# 的快速入门](quickstarts/local-quickstart.md)
