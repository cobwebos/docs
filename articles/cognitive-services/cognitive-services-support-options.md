...
你是否刚开始探索 Azure 认知服务的功能？ 也许你要在应用程序中实现新功能。 使用该服务后，您是否有关于如何改进它的建议？ 下面是一些选项，可以在其中获取支持、随时了解最新信息、提供反馈，并报告认知服务的错误。
...
为了更快地获得结果，请执行对相关站点的搜索，如[Stack Overflow](https://stackoverflow.com/)、 [Microsoft 文档](https://docs.microsoft.com/azure/cognitive-services/)或[GitHub 代码示例](https://github.com/azure-samples)。 在常用`site:`的[搜索引擎](https://bing.com)中使用查询表示法，例如：
...
如果 Stack Overflow 上的 "搜索" 框中找不到问题的答案，请提交新问题。 Stack Overflow 是开发相关问题的首选渠道。 在这里，Stack Overflow 社区和 Microsoft 团队成员的成员直接参与帮助你解决问题。

[在此](https://go.microsoft.com/fwlink/?linkid=2126464)发布问题。 请为您的问题使用合适的标记，这样我们就可以看到问题所在了。
...
若要及时了解新版本中的功能或 Azure 博客上的新闻，可以帮助您了解编程错误、服务 bug 或认知服务中尚未提供的功能之间的差异。
...
当新版本可用时，认知服务发行说明会更新。 说明包含有关新功能、改进和 bug 修复的信息。
...
Reddit 是社区驱动的讨论网站，其中提供了有关[Azure 认知服务](https://www.reddit.com/r/AZURE/search/?q=Cognitive%20Services&restrict_sr=1)新闻、帮助、信息、提示和技巧的最新对话。 注册的成员可以提交内容，而其他成员则可以对其进行投票，这有机将最相关的内容提升到其源的顶部。
...
> [!NOTE]
> 尽管这是一个公共论坛，但在这里不需要 Microsoft 的支持，但要讨论你希望在未来的认知服务版本中看到的新功能。
...
下面是三种类型的存储库，开发人员可以在其中发布问题或创建拉取请求。 若要创建问题，请使用各自 GitHub 存储库中的 "*问题*" 选项卡，并选择 "*新建问题*"。 若要建议更正，请直接编辑文件以提交拉取请求。 然后，拉取请求将停留在 "*拉取请求*" 选项卡下，直到存储库所有者可以查找它。

#### <a name="cognitive-services-samples"></a>认知服务示例

示例通常在公共存储库中找到为开源。 快速入门示例有自己的存储库，并在 Microsoft 文档中进行了引用。 如果在代码中发现错误，请创建一个问题或拉取请求。
...
* [认知服务：走](https://github.com/Azure-Samples/azure-sdk-for-go-samples)
...
Sdk 的源代码显示了每个服务的 SDK connect-through。 如果已找到 bug 或要建议更正，请提交问题或创建拉取请求。

下面是一系列认知服务 SDK 源代码（按语言）：

* [用于 Dotnet 的 Azure SDK](https://github.com/Azure/azure-sdk-for-net/tree/master/sdk/cognitiveservices)
* [Azure SDK for Go](https://github.com/Azure/azure-sdk-for-go/tree/master/services/cognitiveservices)<br>
* [用于 Java 的 Azure SDK](https://github.com/Azure/azure-sdk-for-java/tree/master/sdk/cognitiveservices)
* [用于 JavaScript 的 Azure SDK](https://github.com/Azure/azure-sdk-for-js/tree/master/sdk/cognitiveservices)
* [用于 Python 的 Azure SDK](https://github.com/Azure/azure-sdk-for-python/tree/master/sdk/cognitiveservices)

#### <a name="azure-cognitive-services-documentation"></a>Azure 认知服务文档

认知服务的文档介绍了如何使用服务，并为开发人员提供了示例和资源。 如果已找到 bug 或要建议更正，请提交问题或创建拉取请求。
