...
要获得更快的结果，请对相关网站执行搜索，如[堆栈溢出](https://stackoverflow.com/)、[微软文档](https://docs.microsoft.com/azure/cognitive-services/)或[GitHub 代码示例](https://github.com/azure-samples)。 在`site:`[您最喜爱的搜索引擎](https://bing.com)中使用查询表示法，例如：
...
随时了解 Azure 博客上的新版本或新闻中的功能，可帮助您找到编程错误、服务错误或认知服务中尚不可用的功能之间的区别。
...
Reddit 是一个社区驱动的讨论网站，提供有关[Azure 认知服务](https://www.reddit.com/r/AZURE/search/?q=Cognitive%20Services&restrict_sr=1)新闻、帮助、信息、提示和技巧的最新对话。 注册会员可以提交内容，其他人可以投票表决，这将有机地将最相关的内容提升到其源的顶部。
...
若要请求新功能，请将其发布到 UserVoice。 分享您的想法，使认知服务及其 API 更好地适用于您开发的应用程序。 

> [!NOTE]
> 虽然这是一个公共论坛，不要指望微软在这里的支持，但确实喜欢讨论你想在即将到来的认知服务版本中看到的新功能。
...
以下是开发人员可能发布问题或创建拉取请求的三种类型的存储库。 要创建问题，请使用相应 GitHub 存储库中的 *"问题*"选项卡，然后选择 *"新问题*"。 如果要建议更正，请直接编辑文件来提交拉取请求。 然后，拉取请求将位于 *"拉取请求*"选项卡下，直到存储库所有者可以查看它。

#### <a name="cognitive-services-samples"></a>认知服务示例

样本通常作为开源在公共存储库中找到。 快速入门示例有自己的存储库，并在 Microsoft 文档中引用。 如果在代码中发现错误，请创建问题或拉取请求。
...
* [认知服务：点网](https://github.com/Azure-Samples/cognitive-services-dotnet-sdk-samples)
* [认知服务：去](https://github.com/Azure-Samples/azure-sdk-for-go-samples)
...
SDK 的源代码显示了每个服务的 SDK 的一些基础。 如果您发现 Bug 或想要建议更正，请提交问题或创建拉取请求。

下面是认知服务 SDK 源代码列表（按语言）：

* [Dotnet 的 Azure SDK](https://github.com/Azure/azure-sdk-for-net/tree/master/sdk/cognitiveservices)
...
认知服务的文档介绍了如何使用服务，并为开发人员提供了示例和资源。 如果您发现 Bug 或想要建议更正，请提交问题或创建拉取请求。
