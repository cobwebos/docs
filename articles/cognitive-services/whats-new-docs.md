---
title: 认知服务：2020年6月1日（年6月 30 2020 日）的文档新增功能
description: 2020年6月1日，年6月 30 2020 日认知服务文档的新增功能。
author: erhopf
manager: nitinme
ms.topic: conceptual
ms.author: erhopf
...
欢迎使用2020年6月1日到年6月 30 2020 日的认知服务文档中的新增功能。 本文列出了在此期间对文档进行的一些重大更改。

## <a name="computer-vision"></a>计算机视觉

### <a name="updated-articles"></a>更新的文章

- [快速入门：使用计算机视觉 REST API 和 Java 提取印刷体文本和手写文本](/azure/cognitive-services/computer-vision/quickstarts/java-hand-text)
- [快速入门：使用计算机视觉 REST API 和 Python 提取印刷体文本和手写文本](/azure/cognitive-services/computer-vision/quickstarts/python-hand-text)

## <a name="face"></a>人脸

### <a name="updated-articles"></a>更新的文章

- [示例：如何实时分析视频](/azure/cognitive-services/face/face-api-how-to-topics/howtoanalyzevideo_face)

## <a name="immersive-reader"></a>沉浸式阅读器

### <a name="new-articles"></a>新文章

- [快速入门：使用沉浸式阅读器客户端库](/azure/cognitive-services/immersive-reader/quickstarts/client-libraries)
...
- [快速入门：使用 cURL 和 REST 获取意向](/azure/cognitive-services/luis/luis-get-started-rest-get-intent)
- [快速入门：使用 cURL 和 REST 来更改模型](/azure/cognitive-services/luis/luis-get-started-rest-get-model)
- [使用 GitHub 操作将 DevOps 应用到 LUIS 应用开发](/azure/cognitive-services/luis/luis-how-to-devops-with-github)

### <a name="updated-articles"></a>更新的文章

- [机器学习功能](/azure/cognitive-services/luis/luis-concept-feature)
- [创建 LUIS 资源](/azure/cognitive-services/luis/luis-how-to-azure-subscription)
- [迁移到 Azure 资源创作密钥](/azure/cognitive-services/luis/luis-migration-authoring)


- [教程：通过 Node.js 使用启用了语言理解的 Web 应用机器人](/azure/cognitive-services/luis/luis-nodejs-tutorial-bf-v4)

## <a name="personalizer"></a>个性化体验创建服务

### <a name="new-articles"></a>新文章

- [将 Personalizer 添加到 .NET web 应用](/azure/cognitive-services/personalizer/tutorial-use-personalizer-web-app)
...
- [语音服务：Docs 中的新增内容](/azure/cognitive-services/speech-service/whats-new)

### <a name="updated-articles"></a>更新的文章

- [什么是批量听录？](/azure/cognitive-services/speech-service/batch-transcription)
- [语音服务的语言和语音支持](/azure/cognitive-services/speech-service/language-support)

## <a name="text-analytics"></a>文本分析

### <a name="updated-articles"></a>更新的文章

- [快速入门：使用 Go 调用文本分析认知服务](/azure/cognitive-services/text-analytics/quickstarts/go)
- [快速入门：使用 Java 调用 Azure 文本分析认知服务](/azure/cognitive-services/text-analytics/quickstarts/java)
- [快速入门：使用 Node.js 调用文本分析认知服务](/azure/cognitive-services/text-analytics/quickstarts/nodejs)
- [快速入门：使用 PHP 调用文本分析认知服务](/azure/cognitive-services/text-analytics/quickstarts/php)
...
- [文本和语音翻译的语言和区域支持](/azure/cognitive-services/translator/language-support)
