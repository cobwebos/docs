---
title: 教程：必应新闻搜索单页 Web 应用（源代码）
titlesuffix: Azure Cognitive Services
description: 演示如何在单页 Web 应用程序中使用必应新闻搜索 API 的教程的源代码。
...
ms.locfileid: "48804287"
---
# <a name="tutorial-single-page-news-search-app"></a>教程：单页新闻搜索应用

这是必应新闻搜索的[单页应用教程](tutorial-bing-news-search-single-page-app.md)中讨论的完整源代码。 若要运行该应用，请将源代码复制到记事本或其他文本编辑器中，并将其另存为 `bing.html`。 然后，在 Microsoft Edge 或其他常用浏览器中打开已保存的文件。
