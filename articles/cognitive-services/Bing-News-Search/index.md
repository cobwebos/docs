...
ms.openlocfilehash: 10fb9fde9d469868b311782f1dd546e7774d39d1
ms.contentlocale: zh-cn
ms.lasthandoff: 05/10/2017

---
<div class="content">
    <h1>Bing News Search API Documentation</h1>
    <div class="introHolder" style="justify-content: space-between;">
        <div class="intro" style="min-width: 200px">
            <p>Learn how to use the Bing News Search API to generate search queries to obtain related news articles.</p>
        </div>
...
<p style="margin-top: 6px; margin-bottom: 6px;">Create an API to provide new articles</p>
<div class="ico48Case">
    <div class="ico48Link">
        <a href="#">
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Top Topics</h3>
                        <p><a href="/azure/cognitive-services/Bing-News-Search/Overview">Overview</a></p>
                        <p><a href="/azure/cognitive-services/Bing-News-Search/UseAndDisplayRequirements">Use and Display Requirements</a></p>
                    </div>
                </div>
            </div>
        </div>
