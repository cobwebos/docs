...
> [!IMPORTANT]
> 用于控制 Azure 中的支持请求的访问权限的这一手动方法已替换为内置角色。 有关详细信息，请参阅[支持请求参与者](../role-based-access-control/built-in-roles.md#support-request-contributor)。 
