...
2. 部署完成后，Visual Studio 会启动浏览器并打开 ASP.NET Web API 服务的根目录，该服务默认侦听端口 8966。 ASP.NET Core Web API 模板不提供根目录的默认行为，因此你将在浏览器中收到错误。
...
## <a name="connecting-to-a-reliable-actors-service"></a>连接到 Reliable Actors 服务
