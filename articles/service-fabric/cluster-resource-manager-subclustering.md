...
* 而且，我们有四个节点。 其中两个节点的 NodeType 设置为 "前端"，另两个设置为 "后端"
...
* 服务 A：无放置约束
* 服务 B：放置约束 "NodeType = = 前端"
* 服务 C：放置约束 "NodeType = = 后端"
...
资源管理器将识别这种情况，并生成运行状况报告，通知你将服务 A 拆分为两个服务-服务 A1，可以放置在前端节点上，并可以放置在后端节点上。 这将使我们返回到第一类可以最佳平衡的情况。
