...
若要将服务添加到使用适用于 Service Fabric 的 Eclipse 插件创建的现有应用程序，请参阅[此处](service-fabric-get-started-eclipse.md#add-a-service-fabric-service-to-your-service-fabric-application)的文档。
