...
ms.locfileid: "60719082"
---
# <a name="why-a-microservices-approach-to-building-applications"></a>为什么通过微服务的方法构建应用程序？

作为软件开发人员，我们已知道思考如何将应用程序因数分解成组件部分。 通常采用一种分层方法，有后端存储、中间层业务逻辑和前端用户界面 (UI)。 过去几年来的*变化*是身为开发人员的我们，开始为云构建分布式应用程序。
...
微服务方法是以许多小服务来组成应用程序。 这些服务在部署于一组计算机上的容器中运行。 较小的团队可针对方案来开发服务，且每个服务独立进行测试、版本控制、部署和缩放，因此整个应用程序可以得到发展。

## <a name="what-is-a-microservice"></a>什么是微服务？

微服务存在多种定义。 但在微服务的以下大部分特性上，已广泛达成共识：
