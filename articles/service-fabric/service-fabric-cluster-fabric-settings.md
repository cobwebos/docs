...
|DiskSpaceHealthReportingIntervalWhenEnoughDiskSpace |时间范围，默认值为 Common::TimeSpan::FromMinutes(15)|动态|指定以秒为单位的时间范围。 当磁盘空间充足时，检查磁盘空间来报告运行状况事件之间的时间间隔。 |
