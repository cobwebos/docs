...
description: 了解如何使用 eclipse 和服务结构提供的插件在 Java 中开始使用 Azure 服务结构。
author: rapatchi
ms.topic: conceptual
ms.date: 04/06/2018
ms.author: rapatchi
...
-   要检查已安装组件的版本，请在 Eclipse 中转到 **"帮助** > **有关 Eclipse** > **安装详细信息**"。
...
-   要检查和安装 Eclipse 的更新，请转到**帮助** > **检查更新**。

安装服务交换矩阵插件，在Eclipse中，转到**帮助** > **安装新软件**。
...
1. 要检查可用更新，请转到 **"关于 Eclipse** > **安装详细信息****的帮助** > "。 
...
1.  在Eclipse中，转到 **"文件** > **新** > **其他**"。 选择“Service Fabric 项目”，并单击“下一步”。********
...
5.  要验证应用程序是否正在运行，请在浏览器窗口中[http://localhost:19080/Explorer](http://localhost:19080/Explorer)打开本地群集上的 Service Fabric 资源管理器。 展开“应用程序”节点，确保应用程序正在运行。**** 
...
有关如何将用 Java 编写的 Service Fabric 可靠服务应用程序部署到安全的 Linux 群集，请参阅[快速入门：部署 Java 可靠服务应用程序](./service-fabric-quickstart-java-reliable-services.md)。
...
1.  转到**运行** > **配置**。 在左窗格中，单击“Gradle 项目”左侧的小箭头。****
...
- 有关构建 Java 可靠服务应用程序并将其部署到本地和 Azure 的快速步骤，请参阅[快速入门：部署 Java 可靠服务应用程序](./service-fabric-quickstart-java-reliable-services.md)。
