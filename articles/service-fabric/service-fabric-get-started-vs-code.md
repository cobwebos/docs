---
title: 具有 VS Code 的 Azure Service Fabric 入门
...
2. 查看具有 Service Fabric Explorer 的本地群集（http：\//localhost： 19080/Explorer）以确认应用程序已安装。 此过程可能需要一段时间，请耐心等待。
...
**Service Fabric：生成应用程序**命令可以生成 Java 或C# Service Fabric 应用程序。 
