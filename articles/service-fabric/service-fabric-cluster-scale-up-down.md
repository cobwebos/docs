...
> [!NOTE]
> 在缩减方案中，除非节点类型具有金级或银级[持续性级别][durability]，否则需要使用相应节点名称来调用 [Remove-ServiceFabricNodeState cmdlet](https://docs.microsoft.com/powershell/module/servicefabric/remove-servicefabricnodestate)。 对于铜牌持久性，不建议一次缩小多个节点。
> 
> 
