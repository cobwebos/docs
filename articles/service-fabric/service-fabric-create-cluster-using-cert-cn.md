...
3. 在 **Microsoft.Compute/virtualMachineScaleSets** 资源中，更新虚拟机扩展以在证书设置中使用公用名称而非指纹。  在**virtualMachineProfile**->**extensionProfile**->**扩展**->**settings****certificate****properties**属性设置->证书中->，添加 
    ```json
       "commonNames": [
