---
title: "Reliable Services 体系结构 | Microsoft 文档"
description: "有状态和无状态服务的 Reliable Service 体系结构概述"
...
有关有状态服务和无状态服务之间的区别的详细信息，请参阅 [Reliable Services 概述](service-fabric-reliable-services-introduction.md)。
...
有关使用 StatelessService 和 StatelessServiceBase 类编写服务的详细信息，请参阅 [Reliable Service 概述](service-fabric-reliable-services-introduction.md)和 [Reliable Service 高级用法](service-fabric-reliable-services-advanced-usage.md)。
...
[Reliable Collections 概述](service-fabric-reliable-services-reliable-collections.md)
