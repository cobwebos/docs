...
对于在 Azure 中运行的群集，可以在 [Azure 状态页][azure-status-dashboard]上查看有关中断的最新信息。 在极少数情况下，物理数据中心部分或全部被销毁，主机上托管的任何 Service Fabric 群集或其中的服务可能会丢失。 此损失包括未在该数据中心或区域外部备份的任何状态。
