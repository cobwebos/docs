...
[Windows 事件跟踪](/windows/win32/etw/event-tracing-portal) (ETW) 是推荐的用于跟踪 Service Fabric 中的消息的技术。 使用 ETW 的一些好处包括：
...
* [如何使用 Azure 诊断收集日志](./service-fabric-diagnostics-event-aggregation-wad.md)
