...
1. 对 `ServiceEventSource.Current.ServiceMessage` 方法中 `RunAsync` 的调用显示了应用程序代码中的自定义 ETW 跟踪的一个示例。
...
2. 在 `ActorEventSource.Current.ActorMessage(this, "Doing Work");`DoWorkAsync*方法中查找代码*。  这是根据应用程序代码编写的自定义 ETW 跟踪的一个示例。  
