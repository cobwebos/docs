...
ms.locfileid: "34363064"
---
<!-- This article was generated by the Python script found in the end of this file -->

# <a name="service-model-xml-schema-documentation"></a>服务模型 XML 架构文档
本文阐述随 Service Fabric SDK 一起安装的 ServiceFabricServiceModel.xsd 架构文件。  默认情况下，架构文件安装在 C:\Program Files\Microsoft SDKs\Service Fabric\schemas\ServiceFabricServiceModel.xsd。

## <a name="namespace-bindings"></a>命名空间绑定
|前缀|命名空间 URI|
|---|---|
|xs|http://www.w3.org/2001/XMLSchema|
|无|http://schemas.microsoft.com/2011/01/fabric|

## <a name="component-summary"></a>组件摘要 
在 ServiceFabricServiceModel.xsd 的 http://schemas.microsoft.com/2011/01/fabric 命名空间中定义以下组件：
- [293 个元素](service-fabric-service-model-schema-elements.md)
- [103 个 complexTypes](service-fabric-service-model-schema-complex-types.md)
- [1 个 simpleTypes](service-fabric-service-model-schema-simple-types.md)
- [3 个元素组](service-fabric-service-model-schema-element-groups.md)
- [16 个属性组](service-fabric-service-model-schema-attribute-groups.md)
