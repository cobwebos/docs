...
在 ServiceFabricServiceModel.xsd 中定义了以下组件：
- [257 个元素](service-fabric-service-model-schema-elements.md)
- [112 个 complexTypes](service-fabric-service-model-schema-complex-types.md)
