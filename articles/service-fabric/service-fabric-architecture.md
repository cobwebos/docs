...
description: 本文介绍了 Service Fabric 的体系结构，这是一个分布式系统平台，用于构建适用于云的可缩放、可靠且易于管理的应用程序。
...
* 资源管理器将服务副本放置在群集中的故障域之间，并确保所有故障转移单元正常运行。 Resource Manager 还会平衡群集节点基础共享池中的服务资源，从而获得最佳的统一负载分布。
