...
description: 本文介绍了 Service Fabric 的体系结构，Service Fabric 是一个分布式系统平台，用于为云构建可扩展、可靠且易于管理的应用程序。
...
* 资源管理器在群集中跨故障域放置服务副本，并确保所有故障转移单元都正常运行。 Resource Manager 还会平衡群集节点基础共享池中的服务资源，从而获得最佳的统一负载分布。
