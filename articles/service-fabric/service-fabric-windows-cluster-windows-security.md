...
| **配置设置** | **说明** |
| --- | --- |
| ClusterCredentialType |设置为*Windows*以启用节点节点通信的 Windows 安全性。  | 
...
> [!NOTE]
> 群集MSA标识值必须采用格式""。mysfgmsa@mydomain
...
将弃用此模型。 建议使用上文详述的 gMSA。 随 [Microsoft.Azure.ServiceFabric.WindowsServer.\<version>.zip](https://go.microsoft.com/fwlink/?LinkId=730690) 独立群集包下载的 ClusterConfig.Windows.MultiMachine.JSON 示例配置文件包含用于配置 Windows 安全性的模板。**  在“属性”部分配置 Windows 安全性：**** 
