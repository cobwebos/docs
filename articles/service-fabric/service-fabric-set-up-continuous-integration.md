---
title: "Service Fabric 的持续集成 |Microsoft 文档"
...
---
# <a name="set-up-continuous-integration-for-a-service-fabric-application-by-using-visual-studio-team-services"></a>使用 Visual Studio Team Services 为 Service Fabric 应用程序设置持续集成
