...
此外，你可以请求 Service Fabric 将此终结点发布到命名服务，以便其他服务可以发现指向此服务的终结点地址。 这使你能够在来宾可执行文件服务之间进行通信。
...
在下面的示例中，在服务部署后，你便会在 Service Fabric Explorer 中看到为服务实例发布的终结点，类似于 `http://10.1.4.92:3000/myapp/`。 或者，如果是在本地计算机上，你会看到 `http://localhost:3000/myapp/`。
