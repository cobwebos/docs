---
title: 平衡 Azure Service Fabric 群集
...
* 群集资源管理器可以识别和处理子群集（这种情况下，当你使用放置约束和平衡时，有时会出现这种情况）。 若要了解子群集如何影响均衡以及如何处理它，请参阅[此处](service-fabric-cluster-resource-manager-subclustering.md)
