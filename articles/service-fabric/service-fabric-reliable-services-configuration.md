<properties
   pageTitle="配置有状态的 Reliable Services"
   description="了解如何在 Service Fabric 中配置有状态 Reliable Services。"
...
# 配置有状态的 Reliable Services
通过为应用程序中每个服务更改 Visual Studio 程序包根目录下的“Config”文件夹中生成的“settings.xml”文件，可以修改有状态 Reliable Service 的默认配置。

Service Fabric 运行时查找“settings.xml”文件中的预定义节名称，并在创建基础运行时组件时使用配置值。
