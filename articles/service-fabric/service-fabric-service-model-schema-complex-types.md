...
可用 CPU 的可用百分比（仅适用于 Windows）。 必须是正整数。
|属性|值|
|---|---|
|type|xs:string|
|名称|CpuPercent|
...
相对块 IO 权重。 必须是 10 到 1000 之间的正整数。
|属性|值|
|---|---|
|type|xs:string|
|名称|BlockIOWeight|
