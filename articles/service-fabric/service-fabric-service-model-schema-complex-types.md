---
title: Azure Service Fabric 服务模型 XML 架构复杂类型
...
指定运行状况评估期间是否将警告性运行状况报告视为错误。 默认值：false。
...
指定将应用程序被视为“错误”之前可以容忍的不正常已部署应用程序的最大百分比。 这是将不正常的已部署应用程序数目除以目前在群集中部署的应用程序节点数目计算得出的。 计算结果向上进一，以容忍少量节点上出现一次失败。 默认百分比：0.
...
容器的隔离模式。 有效值为 default、process 或 hyperv（仅支持 Windows 容器）。
...
容器反复停止运行时要留下的容器数。 默认情况下，该值设置为 0，因此不会留下任何容器。
...
在启用交互标志的情况下运行容器。 有效值为 true/false。 默认值为 false。
...
|---|---|
|name|DllHost|
|类型|[DllHostEntryPointType](#dllhostentrypointtype-complextype)|
...
|---|---|
|name|ContainerHost|
|类型|[ContainerHostEntryPointType](#containerhostentrypointtype-complextype)|
...
|类型|[EnvironmentVariableOverrideType](#environmentvariableoverridetype-complextype)|
|minOccurs|0|
|maxOccurs|unbounded|
...
|---|---|
|name|主体|
|类型|[SecurityPrincipalsType](#securityprincipalstype-complextype)|
...
|---|---|
|name|策略|
|类型|[ApplicationPoliciesType](#applicationpoliciestype-complextype)|
...
|---|---|
|name|诊断|
|类型|[DiagnosticsType](#diagnosticstype-complextype)|
...
|---|---|
|name|EnvironmentVariable|
|类型|[EnvironmentVariableType](#environmentvariabletype-complextype)|
|minOccurs|0|
|maxOccurs|unbounded|
...
|类型|[InputEndpointType](#inputendpointtype-complextype)|
...
|类型|[InternalEndpointType](#internalendpointtype-complextype)|
...
|---|---|
|name|图像|
|类型|[ImageType](#imagetype-complextype)|
|minOccurs|0|
|maxOccurs|unbounded|
...
|---|---|
|name|终结点|
|类型|[FabricEndpointsType](#fabricendpointstype-complextype)|
|minOccurs|0|
...
|---|---|
|name|证书|
|类型|[CertificatesType](#certificatestype-complextype)|
|minOccurs|0|
...
|类型|[ContainerNetworkPolicyType](#containernetworkpolicytype-complextype)|
|minOccurs|0|
|maxOccurs|unbounded|
...
|---|---|
|name|参数|
|类型|[ParameterType](#parametertype-complextype)|
|minOccurs|1|
|maxOccurs|unbounded|
...
|类型|[StatefulServiceTypeType](#statefulservicetypetype-complextype)|
...
|类型|[StatelessServiceTypeType](#statelessservicetypetype-complextype)|
...
|类型|[StatefulServiceGroupTypeType](#statefulservicegrouptypetype-complextype)|
...
|类型|[StatelessServiceGroupTypeType](#statelessservicegrouptypetype-complextype)|
...
|---|---|
|name|RunAsPolicy|
|类型|[RunAsPolicyType](#runaspolicytype-complextype)|
|minOccurs|0|
...
|类型|[SecurityAccessPolicyType](#securityaccesspolicytype-complextype)|
|minOccurs|0|
...
|类型|[PackageSharingPolicyType](#packagesharingpolicytype-complextype)|
|minOccurs|0|
...
|类型|[EndpointBindingPolicyType](#endpointbindingpolicytype-complextype)|
|minOccurs|0|
...
|类型|[ServiceFabricRuntimeAccessPolicyType](#servicefabricruntimeaccesspolicytype-complextype)|
|minOccurs|0|
|maxOccurs|1|
...
|类型|[ServicePackageContainerPolicyType](#servicepackagecontainerpolicytype-complextype)|
|minOccurs|0|
|maxOccurs|1|
...
|类型|[ConfigPackagePoliciesType](#configpackagepoliciestype-complextype)|
|minOccurs|0|
...
|类型|[NetworkPoliciesType](#networkpoliciestype-complextype)|
|minOccurs|0|
|maxOccurs|1|
...
|---|---|
|name|CodePackage|
|类型|[CodePackageType](#codepackagetype-complextype)|
|maxOccurs|unbounded|
...
|---|---|
|name|ConfigPackage|
|类型|[ConfigPackageType](#configpackagetype-complextype)|
|minOccurs|0|
|maxOccurs|unbounded|
...
|---|---|
|name|DataPackage|
|类型|[DataPackageType](#datapackagetype-complextype)|
|minOccurs|0|
|maxOccurs|unbounded|
...
|---|---|
|name|资源|
|类型|[ResourcesType](#resourcestype-complextype)|
|minOccurs|0|
...
|---|---|
|name|诊断|
|类型|[ServiceDiagnosticsType](#servicediagnosticstype-complextype)|
|minOccurs|0|
...
|---|---|
|name|PortBinding|
|类型|[PortBindingType](#portbindingtype-complextype)|
|minOccurs|0|
|maxOccurs|unbounded|
...
|---|---|
|name|ServicePackageResourceGovernancePolicy|
|类型|[ServicePackageResourceGovernancePolicyType](#servicepackageresourcegovernancepolicytype-complextype)|
|minOccurs|0|
|maxOccurs|1|
...
|类型|[StatelessServiceType](#statelessservicetype-complextype)|
...
|类型|[StatefulServiceType](#statefulservicetype-complextype)|
...
|类型|[StatelessServiceGroupType](#statelessservicegrouptype-complextype)|
...
|类型|[StatefulServiceGroupType](#statefulservicegrouptype-complextype)|
...
|类型|[WindowsFabricDeploymentInformation](#windowsfabricdeploymentinformation-complextype)|
|minOccurs|0|
