...
使用熟悉的命令行工具，本快速入门将介绍如何使用 Spring 网站上的[入门](https://spring.io/guides/gs/spring-boot/)示例在 Mac 或 Linux 开发人员计算机上将功能性 Spring Boot 应用程序部署到 Service Fabric。
