...
## <a name="install-the-necessary-java-artifacts-on-vagrant-optional-if-you-want-to-use-the-java-programming-models"></a>在 Vagrant 上安装必需的 Java 项目（如果希望使用 Java 编程模型，则可以选择执行此步骤）
