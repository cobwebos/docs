...
It is important to note here that Azure web sites accepts both CNAME and A records, however you *must* use an A record to enable proper domain mapping. A CNAME cannot be forwarded to another CNAME, which is what Azure created for you with YOUR_DOMAIN.chinacloudsites.cn.
...
[website-from-gallery]: http://azure.microsoft.com/zh-cn/documentation/articles/web-sites-php-web-site-gallery/
[wordpress-codex-create-a-network]: http://codex.wordpress.org/Create_A_Network
[website-w-mysql-and-ftp-ftp-setup]: http://azure.microsoft.com/zh-cn/documentation/articles/web-sites-php-mysql-deploy-use-ftp/#header-0
[website-w-mysql-and-git-git-setup]: http://azure.microsoft.com/zh-cn/documentation/articles/web-sites-php-mysql-deploy-use-git/#header-1
