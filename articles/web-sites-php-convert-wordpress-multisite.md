...
利用 Azure 网站，你可以向一个网站添加无数个域。若要添加另一个域，你需要为每个域执行“验证域”和“设置域 A 记录”两节中所述的操作。
  ...
  [在 Azure 中从库中创建 WordPress 网站]: http://windowsazure.cn/zh-cn/documentation/articles/web-sites-php-web-site-gallery/
  [WordPress Codex]: http://codex.wordpress.org
  [创建网络]: http://codex.wordpress.org/Create_A_Network
  [带 MySQL 和 FTP 的 PHP 网站]: http://windowsazure.cn/zh-cn/documentation/articles/web-sites-php-mysql-deploy-use-ftp/#header-0
  [带 MySQL 和 Git 的 PHP 网站]: http://windowsazure.cn/zh-cn/documentation/articles/web-sites-php-mysql-deploy-use-git/#header-1
