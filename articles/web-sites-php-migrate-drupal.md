...
-   [Azure Blob 存储模块][Azure Blob 存储模块]
  ...
  [Azure 网站、云服务和虚拟机：何时使用何种产品？]: http://windowsazure.cn/zh-cn/documentation/articles/choose-web-site-cloud-service-vm/
  ...
  [创建 PHP-MySQL Azure 网站并使用 Git 进行部署]: http://windowsazure.cn/zh-cn/documentation/articles/web-sites-php-mysql-deploy-use-git/
