...
由于池和池节点通常是临时性的，会不断地添加和删除节点，因此建议保留日志文件。 [任务输出文件](https://docs.microsoft.com/azure/batch/batch-task-output-files)是将日志文件保存到 Azure 存储的一种简便方法。
