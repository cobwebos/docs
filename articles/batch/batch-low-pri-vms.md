...
>
> Azure Batch 池将开始2020的第一季度的点 Vm，并提供新版本的[批处理 api 和工具](https://docs.microsoft.com/azure/batch/batch-apis-tools)。 低优先级 Vm 将继续受到支持，使用最新的 API 和工具版本，至少需要12个月的时间，才能进行迁移来发现 Vm。 
>
