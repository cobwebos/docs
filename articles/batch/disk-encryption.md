...
ms.locfileid: "89038480"
---
# <a name="create-a-pool-with-disk-encryption-enabled"></a>创建启用了磁盘加密的池
...
![Azure 门户中的磁盘加密配置选项的屏幕截图。](./media/disk-encryption/portal-view.png)

创建池后，可在池的 " **属性** " 部分中查看磁盘加密配置目标。

![显示 Azure 门户中的磁盘加密配置目标的屏幕截图。](./media/disk-encryption/disk-encryption-configuration-target.png)
