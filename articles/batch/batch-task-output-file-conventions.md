...
若要使用文件约定库将输出数据持久保存到 Azure 存储，必须先将 Azure 存储帐户关联到 Batch 帐户。 如果尚未这样做，请使用 [Azure 门户](https://portal.azure.com)将存储帐户关联到 Batch 帐户：
