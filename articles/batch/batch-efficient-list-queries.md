...
此 [Batch .NET][api_net] API 代码片段列出了与作业关联的每个任务，以及每个任务的所有属性 ：
...
除了上述 EfficientListQueries 代码示例，还可在 GitHub [azure-batch-samples][github_samples] 存储库中找到 [BatchMetrics][batch_metrics] 项目。 BatchMetrics 示例项目演示了如何使用批处理 API 有效地监视 Azure Batch 作业进度。
