---
title: 教程 - Azure Batch .NET 库入门 | Microsoft Docs
...
> [!TIP]
> [How to use Blob Storage from .NET](../storage/storage-dotnet-how-to-use-blobs.md) 全面概述了如何使用 Azure 存储容器和 Blob。当你开始使用 Batch 时，它应该位于阅读列表顶部附近。
> 
> 
