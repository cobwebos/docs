---
title: 创建没有公共 IP 地址的 Azure Batch 池
...
ms.locfileid: "85962435"
---
# <a name="create-an-azure-batch-pool-without-public-ip-addresses"></a>创建没有公共 IP 地址的 Azure Batch 池
...
> [!IMPORTANT]
> 对于在 Azure Batch 中没有公共 IP 地址的池提供支持，目前在美国西部、美国东部、美国中南部、美国西部2、US Gov 弗吉尼亚州和 US Gov 亚利桑那州区域提供公共预览版。
...
![已选择 NoPublicIPAddresses 的 "添加池" 屏幕](./media/batch-pool-no-public-ip-address/create-pool-without-public-ip-address.png)
