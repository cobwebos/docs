...
1. 在“详细信息”**** 中：
    ...
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 在“提供详细信息”中，指定位置、配额类型和 Batch 帐户。****
    ...
    * **按区域**  
    ...
    b.保留“数据库类型”设置，即设置为“共享”。 根据[业务影响情况][support_sev]选择“严重性”****。
...
* 一[个公共 IP 地址](../virtual-network/virtual-network-ip-addresses-overview-arm.md)
...
* [使用 Azure 门户创建 Azure 批处理帐户](batch-account-create-portal.md)
