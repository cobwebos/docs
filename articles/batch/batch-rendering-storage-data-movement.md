...
此[博客文章](https://blogs.msdn.microsoft.com/windowsazurestorage/2014/05/26/persisting-connections-to-microsoft-azure-files/)和[文档](../storage/files/storage-how-to-use-files-windows.md)介绍了如何装载 Azure 文件共享。
