...
# 快速入门
## [运行 Batch 作业 - CLI](quick-create-cli.md)
## [运行 Batch 作业 - 门户](quick-create-portal.md)
## [运行 Batch 作业 - .NET](quick-run-dotnet.md)
## [运行 Batch 作业 - Python](quick-run-python.md)


# 教程

## [并行文件处理 - .NET](tutorial-parallel-dotnet.md)
## [并行文件处理 - Python](tutorial-parallel-python.md)
## [使用 Arnold 进行场景呈现](tutorial-rendering-cli.md)
## [并行 R 模拟](tutorial-r-doazureparallel.md)

# 示例
## 代码示例
### [Azure 代码示例](https://azure.microsoft.com/resources/samples/?service=batch)
### [Batch 示例存储库](https://github.com/Azure/azure-batch-samples)
## [Azure CLI](cli-samples.md)

# 概念
## [开发人员功能](batch-api-basics.md)
## [API 和工具](batch-apis-tools.md)
## [配额和限制](batch-quota-limit.md)

# 操作指南
## 管理 Batch 帐户
### [使用门户管理 Batch 帐户](batch-account-create-portal.md)
...
## [创建应用程序包](batch-application-packages.md)

## 创建和管理池
### [自动缩放计算节点](batch-automatic-scaling.md)
### [选择计算节点的 VM 大小](batch-pool-vm-sizes.md)
### [配置对计算节点的访问权限](pool-endpoint-configuration.md)
### [使用自定义映像创建池](batch-custom-images.md)
### [在虚拟网络中创建池](batch-virtual-network.md)
### [使用计算密集型 VM](batch-pool-compute-intensive-sizes.md)
### [使用 Linux 计算节点](batch-linux-nodes.md)
### [使用低优先级 VM](batch-low-pri-vms.md)
