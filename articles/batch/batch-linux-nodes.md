...
如上所述，我们建议不要显式创建 [ImageReference][py_imagereference]，而是使用 [list_node_agent_skus][py_list_skus] 方法从当前支持的节点代理/Marketplace 映像组合中动态选择。 以下 Python 代码片段演示如何使用此方法。
