...
<tags ms.service="cache" ms.date="04/23/2015" wacn.date=""/>
...
- Azure PowerShell 0.8.0 版或更高版本。若要安装最新版本并将其与 Azure 订阅相关联，请参阅[如何安装和配置 Azure PowerShell](powershell-install-configure)。
...
## 后续步骤
了解有关使用 Microsoft Azure PowerShell 的详细信息：
