...
你可以从 "**监视**" 菜单中的 "Azure 门户"[查看活动日志](../../azure-monitor/platform/activity-log-view.md)。 若要将结果限制为特定的订阅，请使用筛选器选择特定订阅。 您还可以通过编程方式[查看和检索活动日志事件](../../azure-monitor/platform/activity-log-view.md)。
...
记录的活动在过去90天的 Azure 门户中可用。 若要了解如何存储超过90天的此数据，请参阅[在 Log Analytics 工作区中收集和分析 Azure 活动日志](../../azure-monitor/platform/activity-log-collect.md)。
