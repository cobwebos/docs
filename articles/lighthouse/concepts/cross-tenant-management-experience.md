...
Azure 委派资源管理可更灵活地管理多个客户的资源，而无需登录到不同租户中的不同帐户。 例如，服务提供商可能有两个客户，各自有不同的职责和访问级别。 使用 Azure 委托资源管理，授权用户可以登录到服务提供商的租户来访问这些资源。
...
我们还提供了专用于执行 Azure 委托资源管理任务的 API。 有关详细信息，请参阅“参考”部分。
