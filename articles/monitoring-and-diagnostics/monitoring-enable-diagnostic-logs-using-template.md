...
诊断设置的属性 blob 遵循[此文所述的格式](https://docs.microsoft.com/en-us/rest/api/monitor/diagnosticsettings/createorupdate)。 添加 `metrics` 属性还可将资源指标发送到这些相同输出，前提是[该资源支持 Azure Monitor 指标](monitoring-supported-metrics.md)。
