...
|Capacity|容量（预览）|百分比|最大值|ApiManagement 服务的利用率指标|Location|

## <a name="microsoftautomationautomationaccounts"></a>Microsoft.Automation/automationAccounts

|指标|指标显示名称|单位|聚合类型|说明|维度|
|---|---|---|---|---|---|
|TotalJob|作业总数|Count|总计|作业总数|RunbookName，状态|
...
|compute_limit|计算单位限制|Count|平均值|计算单位限制|无维度|
...
|connections_failed|失败连接总数|Count|平均值|失败连接总数|无维度|
