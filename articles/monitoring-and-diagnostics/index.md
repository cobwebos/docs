        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>使用 Azure 门户为 Azure 服务创建警报</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>使用跨平台 CLI 为 Azure 服务创建警报</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>监视</h3>
                            <p><a href="/azure/monitoring-and-diagnostics/monitoring-supported-metrics">支持的指标列表</a></p>
                            <p><a href="/azure/monitoring-and-diagnostics/monitoring-data-sources">监视数据源</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>诊断</h3>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-versioning-history">Azure 诊断扩展版本历史记录</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema">Azure 诊断扩展架构</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema-1dot0">Azure 诊断扩展架构 1.0</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema-1dot2">Azure 诊断扩展架构 1.2</a></p>
                        <p><a href="/azure/monitoring-and-diagnostics/azure-diagnostics-schema-1dot3-and-later">Azure 诊断扩展架构 1.3 及更高版本</a></p>
                    </div>
                </div>
            </div>
        </div>
