...
> [!NOTE]
> WorkspaceId 参数在 10 月的发行版中不可用。 它将可用于在 11 月的发布版中。
> 
> 

你可以在 Azure 门户中获取 Log Analytics 工作区 ID。
...
| 服务 | 架构和文档 |
| --- | --- |
| 软件负载均衡器 |[用于 Azure 负载平衡器的 Log Analytics（预览版）](../load-balancer/load-balancer-monitor-log.md) |
...
* [使用 OMS Log Analytics 对日志进行分析](../log-analytics/log-analytics-azure-storage-json.md)
