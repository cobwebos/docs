...
---
# <a name="tutorial-provision-an-azure-database-for-mysql-server-using-azure-resource-manager-templates"></a>教程：使用 Azure 资源管理器模板预配 Azure Database for MySQL 服务器
...
要获取 Azure Database for MySQL 服务器的 JSON 模板引用，请转到 Microsoft.DBforMySQL 服务器模板引用(https://docs.microsoft.com/en-us/azure/templates/microsoft.dbformysql/servers)。 下面是示例 JSON 模板，可用于创建运行带有 VNet 服务终结点的 Azure Database for MySQL 的新服务器。
```json
{
