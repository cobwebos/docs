...
description: 本文介绍如何在 Azure 门户中配置和访问 Azure Database for MySQL 中的审核日志。
author: ajlam
ms.author: andrela
ms.service: mysql
ms.topic: conceptual
...
1. 通过更新**audit_log_exclude_users**参数添加要从日志记录中排除的任何 MySQL 用户。 通过提供用户的 MySQL 用户名来指定用户。
