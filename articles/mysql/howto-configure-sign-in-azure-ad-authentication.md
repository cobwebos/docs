...
description: 了解如何设置用于身份验证的 Azure Active Directory （Azure AD） Azure Database for MySQL
author: lfittl-msft
ms.author: lufittl
ms.service: mysql
ms.topic: conceptual
...
3. 在 Azure Database for MySQL `<user>@yourtenant.onmicrosoft.com`中创建用户。
...
* Perl
  ...
  * Net：： MySQL：不支持
* Go
  * sql-驱动程序：支持，添加`?tls=true&allowCleartextPasswords=true`到连接字符串

## <a name="next-steps"></a>后续步骤

* 查看[Azure Active Directory 身份验证](concepts-azure-ad-authentication.md)的总体概念 Azure Database for MySQL
