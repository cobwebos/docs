...
- 安装 [MySQL 的 ODBC 驱动程序](https://dev.mysql.com/downloads/connector/odbc/) 
...
在 macOS 上安装 .NET Core。 下载[正式的安装程序](https://go.microsoft.com/fwlink/?linkid=843444)。 此安装程序会安装工具并将其放置在 PATH 中，使你可以从控制台运行 .net
