---
title: 连接到 Azure App Service-Azure Database for MySQL
...
Azure Database for MySQL 已默认启用 SSL。 如果应用程序不使用 SSL 连接到数据库，则需禁用 MySQL 服务器上的 SSL。 有关如何配置 SSL 的详细信息，请参阅将[ssl 与 Azure Database for MySQL 配合使用](howto-configure-ssl.md)。
