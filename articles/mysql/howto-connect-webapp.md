---
title: 连接到 Azure 应用服务 - MySQL 的 Azure 数据库
...
Azure Database for MySQL 已默认启用 SSL。 如果应用程序不使用 SSL 连接到数据库，则需禁用 MySQL 服务器上的 SSL。 有关如何配置 SSL 的详细信息，请参阅[将 SSL 与 Azure 数据库一起使用 MySQL](howto-configure-ssl.md)。
