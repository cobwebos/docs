...
对重定向的预览支持在[PHP mysqlnd_azure](https://github.com/microsoft/mysqlnd_azure)扩展中提供，该扩展由 Microsoft 开发，在[PECL](https://pecl.php.net/package/mysqlnd_azure)上提供。 有关如何在应用程序中使用重定向的详细信息，请参阅[配置重定向](./howto-redirection.md)一文。 
