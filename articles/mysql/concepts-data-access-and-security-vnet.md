...
- 使用 **Synapse 服务标记** 启用虚拟网络服务终结点 Azure Database for MySQL，还可以为所有 Azure 数据库服务启用终结点： Azure Database for MySQL、Azure Database for PostgreSQL、Azure Sql 数据库和 Azure Analytics (以前的 Sql 数据仓库) 。
