...
# Azure Database for MySQL：使用 PHP 进行连接并查询数据
...
> [在 Azure 中构建 PHP 和 MySQL Web 应用](../app-service-web/app-service-web-tutorial-php-mysql.md?toc=%2fazure%2fmysql%2ftoc.json)
