...
- 在预配时，可以使用 Azure 门户、Azure PowerShell 或跨平台命令行界面指定辅助节点的数目。有关详细信息，请参阅[设置 HDInsight 群集](hdinsight-provision-clusters.md)。以下屏幕显示了 Azure 门户上的辅助节点配置：
...
- [使用 HDInsight 中的 Apache Hive](../hdinsight-using-hive.md)
...
- [将 Hive 与 HDInsight 配合使用来分析来自网站的日志](../hdinsight-hive-analyze-web-site-log.md)
