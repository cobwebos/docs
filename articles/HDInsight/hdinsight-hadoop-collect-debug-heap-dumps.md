...
可以自动收集 Hadoop 服务的堆转储，并将其放置在用户 Azure Blob 存储帐户中的 HDInsightHeapDumps/ 下。服务的堆转储文件包含应用程序内存的快照。这包括创建转储时的变量值。
...
## <a name="powershell"></a>如何使用 Azure PowerShell 启用堆转储
...
## <a name="sdk"></a>如何使用 Azure HDInsight .NET SDK 启用堆转储
