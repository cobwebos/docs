...
有关 HDInsight 高级版的定价和 SLA 的详细信息，请参阅 [HDInsight pricing（HDInsight 定价）](/home/features/hdinsight/#price)。
...
组件|HDInsight 版本 3.4 | HDInsight 版本 3.3 | HDInsight 版本 3.2（默认）|HDInsight 版本 3.1 |HDInsight 版本 3.0|
---|---|---|---|---|---
Hortonworks 数据平台|2\.4|2\.3|2\.2|2\.1.7|2\.0|
Apache Hadoop 和 YARN|2\.7.1|2\.7.1|2\.6.0|2\.4.0|2\.2.0|
Apache Tez|0\.7.0|0\.7.0 | 0\.5.2|0\.4.0||
Apache Pig|0\.15.0|0\.15.0|0\.14.0|0\.12.1|0\.12.0|
Apache Hive 和 HCatalog|1\.2.1|1\.2.1|0\.14.0|0\.13.1|0\.12.0|
...
Apache Spark|1\.6.0（仅限 Linux）|1\.5.2（仅限 Linux/实验性生成）|1\.3.1（仅限 Windows）|||
...
* 特定版本的支持到期后，可能不再通过 Azure 门户提供它。下表列出 Azure 经典门户上提供的版本。可继续使用 Windows PowerShell [New-AzureRmHDInsightCluster](https://msdn.microsoft.com/zh-cn/library/mt619331.aspx) 命令中的 `Version` 参数和 .NET SDK 获取群集版本，直到其弃用日期为止。

HDInsight 版本|HDP 版本|高可用性|发布日期|在 Azure 门户上提供|支持到期日期|弃用日期
---|---|---|---|---|---|---
