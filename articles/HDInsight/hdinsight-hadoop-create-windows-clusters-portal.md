...
了解如何使用 Azure 门户在 HDInsight 中创建 Hadoop 群集。Microsoft [Azure 门户](/documentation/articles/azure-portal-overview/)是一个中心位置，可在其中预配和管理 Azure 资源。Azure 门户是可用于在 HDInsight 中创建基于 Linux 的或基于 Windows 的 Hadoop 群集的工具之一。有关其他群集创建工具和功能，请单击本页顶部的相应选项卡，或参阅[群集创建方法](/documentation/articles/hdinsight-provision-clusters-v1/#cluster-creation-methods)。
...
2. 单击“新建”，单击“数据分析”，然后单击“HDInsight”。
    ...
    ![在 Azure 门户中创建新群集](./media/hdinsight-provision-clusters-v1/HDI.CreateCluster.1.png "在 Azure 门户中创建新群集")
