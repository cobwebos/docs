<properties
   pageTitle="Azure 管理门户的 HDInsight 文章索引 | Microsoft Azure"
   description="一个索引页，包含指向 Azure 管理门户上有关 HDInsight 的文章的链接。Microsoft 建议将 Azure 管理门户用于 HDInsight 上的全新 Hadoop 群集。"
   services="hdinsight"
...
# Azure 管理门户的 HDInsight 文章索引

使用此索引页在 [Azure 管理门户](https://manage.windowsazure.cn/)中查找涉及 HDInsight 的文章。Azure HDInsight 是开源 Hadoop 和 Hortonworks 数据平台的云分发。
...
如果你不熟悉 HDInsight 上的 Hadoop，请转到 [HDInsight 文档页](/documentation/services/hdinsight/)以初步了解 Azure Azure 管理门户。
...
* [优化 Hadoop 的 Hive 查询](hdinsight-hadoop-optimize-hive-query–v1.md)
* [使用 .NET SDK for Hadoop 运行 Pig 作业](hdinsight-hadoop-use-pig-dotnet-sdk-v1.md)
