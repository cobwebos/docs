...
有关使用 Linux 和 Linux 群集的完整的一套文章，请转到 [HDInsight 文档页](/documentation/services/hdinsight/)。
...
* [使用 .NET SDK for Hadoop 运行 Pig 作业](/documentation/articles/hdinsight-hadoop-use-pig-dotnet-sdk-v1.md)
* [将 C# 用户定义函数与 Hive 和 Pig 流式处理配合使用](hdinsight-hadoop-hive-pig-udf-dotnet-csharp)
...
有关在 Azure 门户中使用本机 Apache Spark 群集的文章，请转到 [HDInsight 文档页](/documentation/services/hdinsight/)。

* [概述：Azure HDInsight 上的 Apache Spark](/documentation/articles/hdinsight-apache-spark-overview)
* [在 Hadoop 群集上安装并使用 Spark](/documentation/articles/hdinsight-hadoop-spark-install)
* [HDInsight 群集上的 Spark 作业服务器](/documentation/articles/hdinsight-apache-spark-job-server)
* [预配 Apache Spark 并使用 Spark SQL 运行交互式查询](/documentation/articles/hdinsight-apache-spark-zeppelin-notebook-jupyter-spark-sql-v1)
