...
<!-- deleted by customization Southeast Asia, West Europe, -->
<!-- deleted by customization , or China North -->
...
- **缓解**：用户应该指定唯一且不存在的群集名称，然后重试。如果用户正在使用预览门户，则 UI 将通知他们该群集名称是否已在创建步骤期间使用。
...
<!-- deleted by customization If you are using the Management Portal, the UI will notify them of this issue in advance. -->
