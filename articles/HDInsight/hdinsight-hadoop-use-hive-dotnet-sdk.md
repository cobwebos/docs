...
下面的示例使用用户交互式身份验证。若要使用非交互身份验证，请参阅[Create non-interactive authentication .NET HDInsight applications（创建非交互式身份验证 .NET HDInsight 应用程序）](/documentation/articles/hdinsight-create-non-interactive-authentication-dotnet-applications)
...
* [Manage Hadoop clusters in HDInsight by using the Azure Portal（使用 Azure 门户管理 HDInsight 中的 Hadoop 群集）](/documentation/articles/hdinsight-administer-use-management-portal-v1)
