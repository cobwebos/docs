...
1. 使用[预配 Linux 上的 HDInsight 群集](/documentation/articles/hdinsight-provision-clusters-v1/#portal)中的步骤开始预配群集，但不要完成预配。
...
4. 继续按[预配 Linux 上的 HDInsight 群集](/documentation/articles/hdinsight-provision-clusters-v1/#portal)中所述预配群集。
