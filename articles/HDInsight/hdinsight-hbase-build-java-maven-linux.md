...
* [装有 HBase 的基于 Linux 的 Azure HDInsight 群集](/documentation/articles/hdinsight-hbase-get-started-linux/#create-hbase-cluster)
...
1. 编辑 __pom.xml__ 文件，并将以下代码添加到 `<dependencies>` 部分：
    ...
    有关 HDInsight 版本和组件的详细信息，请参阅 [What are the different Hadoop components available with HDInsight（HDInsight 提供哪些不同的 Hadoop 组件）](/documentation/articles/hdinsight-component-versioning-v1/)。
