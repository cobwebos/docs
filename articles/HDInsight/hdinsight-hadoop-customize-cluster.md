...
> [AZURE.NOTE]本文中的信息特定于基于 Windows 的 HDInsight 群集。有关特定于基于 Linux 的群集的本文版本，请参阅[使用脚本操作自定义 HDInsight 群集 (Linux)](/docementation/articles/hdinsight-hadoop-customize-cluster-linux)
