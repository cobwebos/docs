...
8. 将 mobiledata 表导入 HDInsight 群集。
	...
	若要检查修改后的数据文件，可以使用预览门户、Azure 存储资源管理器工具或 Azure PowerShell。[HDInsight 入门][hdinsight-get-started]中有一个关于使用 Azure PowerShell 下载文件并显示文件内容的代码示例。
