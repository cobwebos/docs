...
>[AZURE.NOTE]要使用最后两部分中上载的推文和 HiveQL 脚本，请将 $hqlScriptFile 设置为“/tutorials/twitter/twitter.hql”。若要使用已为你上载到公共 blob 的推文和 HiveQL 脚本，请将 $hqlScriptFile 设置为“wasb://twittertrend@hditutorialdata.blob.core.chinacloudapi.cn/twitter.hql”。
