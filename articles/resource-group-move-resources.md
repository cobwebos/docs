...
> [AZURE.NOTE] 本文介绍如何在现有 Azure 帐户产品/服务中移动资源。如果你确实想要更改 Azure 帐户产品/服务（如从即用即付升级到预付）同时继续使用现有资源，请参阅 [Switching to a different Azure offer](billing-how-to-switch-azure-offer.md)（切换到其他 Azure 产品/服务）。
