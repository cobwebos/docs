...
>[AZURE.NOTE]本主题说明如何使用 Azure 管理门户创建新的移动服务项目和通用 Windows 应用程序。通过使用 Visual Studio 2013 Update 3，还可以向现有的 Visual Studio 解决方案添加新的移动服务项目。有关详细信息，请参阅[将移动服务添加到现有应用程序](mobile-services-dotnet-backend-windows-universal-dotnet-get-started-data)。

>若要将移动服务添加到 Windows Phone 8.0 或 Windows Phone Silverlight 8.1 应用程序项目，请参阅[将移动服务添加到现有的 Windows Phone 应用程序](mobile-services-dotnet-backend-windows-phone-get-started-data)。
...
[脱机数据同步入门]: mobile-services-windows-store-dotnet-get-started-offline-data
...
[JavaScript backend version]: mobile-services-windows-store-get-started
