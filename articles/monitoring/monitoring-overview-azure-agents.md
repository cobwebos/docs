...
或者，可以使用[事件中心](../event-hubs/event-hubs-about.md)将数据转发到 [Application Insights](../application-insights/app-insights-cloudservices.md)、[Log Analytics](../log-analytics/log-analytics-queries.md) 或非 Azure 服务。 
