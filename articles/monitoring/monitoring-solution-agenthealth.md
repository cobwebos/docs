...
向 OMS 工作区添加解决方案时，“代理运行状况”磁贴将添加到 OMS 仪表板。 此磁贴显示过去 24 小时内的总代理数以及不响应的代理数。<br><br> ![仪表板上的“代理运行状况解决方案”磁贴](./media/monitoring-solution-agenthealth/agenthealth-solution-tile-homepage.png)
...
![“代理运行状况解决方案”仪表板示例](./media/monitoring-solution-agenthealth/agenthealth-solution-dashboard.png)  
