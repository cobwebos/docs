...
1. 单击“创建”并验证应用程序信息。
    ...
    ![已注册的应用](media/monitoring-solution-office-365/registered-app.png)
...
1. 选择“属性”。 将“多租户”更改为“是”。
    ...
    ![设置多租户](media/monitoring-solution-office-365/settings-multitenant.png)

1. 在“设置”菜单中选择“所需权限”，然后单击“添加”。
1. 单击“选择 API”，然后单击“Office 365 管理 API”。 单击“Office 365 管理 API”。 单击“选择”。

    ![选择 API](media/monitoring-solution-office-365/select-api.png)
...
1. 在“选择权限”下，为“应用程序权限”和“委派的权限”选择以下选项：
    ...
    ![选择 API](media/monitoring-solution-office-365/select-permissions.png)

1. 依次单击“选择”、“完成”。
1. 单击“授予权限”，然后在要求确认时单击“是”。

    ![授予权限](media/monitoring-solution-office-365/grant-permissions.png)
...
1. 将会显示类似于以下窗口的窗口。 单击“接受”。
    ...
    ![管理员同意](media/monitoring-solution-office-365/admin-consent.png)
...
![Office 365 摘要磁贴](media/monitoring-solution-office-365/tile.png)  

单击“Office 365”磁贴，打开“Office 365”仪表板。

![Office 365 仪表板](media/monitoring-solution-office-365/dashboard.png)  
