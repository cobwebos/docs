...
![OMSIngestionAPI 模块](media/monitoring-runbook-datacollect/OMSIngestionAPI.png)
...
![编辑 runbook](media/monitoring-runbook-datacollect/edit-runbook.png)
...
![测试 runbook](media/monitoring-runbook-datacollect/test-runbook.png)
...
![发布 runbook](media/monitoring-runbook-datacollect/publish-runbook.png)
...
![日志记录和跟踪](media/monitoring-runbook-datacollect/logging.png)
...
![计划 Runbook](media/monitoring-runbook-datacollect/schedule-runbook.png)
...
5. 滚动到底部，查找类似于下图的项。<br>![详细](media/monitoring-runbook-datacollect/verbose.png)
...
- 打包[管理解决方案](monitoring-solutions-creating.md)中的 runbook，分发给客户。
