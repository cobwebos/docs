...
description: 本文演示如何将工作流提交到 Microsoft 基因组服务，如果您的输入文件是单个 BAM 文件。
services: genomics
author: grhuynh
manager: cgronlun
ms.author: grhuynh
...
本文演示如何将工作流提交到 Microsoft 基因组服务，如果您的输入文件是单个 BAM 文件。 本主题假设你已安装并运行 `msgen` 客户端，且熟悉如何使用 Azure 存储。 如果您已成功使用提供的示例数据提交工作流，则可以继续执行本文。 
