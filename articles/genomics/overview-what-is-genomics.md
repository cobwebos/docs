...
titleSuffix: Azure
description: 了解 Microsoft 基因组学如何使用 Burrows-Wheeler Aligner (BWA) 的云实现以及用于辅助分析的基因组分析工具包 (GATK) 为基因组排序提供支持。 通过 ISO 认证并符合 HIPAA 法规。
services: genomics
author: grhuynh
manager: cgronlun
ms.author: grhuynh
...
Microsoft 基因组学服务已通过 ISO 27001、ISO 27018 和 ISO 9001 认证并符合 HIPAA 法规。 有关 Azure 平台安全性的信息，请访问 [Azure 信任中心](https://www.microsoft.com/en-us/trustcenter/security)。
