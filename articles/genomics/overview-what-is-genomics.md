...
Microsoft 基因组学服务已通过 ISO 27001、ISO 27018 和 ISO 9001 认证并符合 HIPAA 法规。 有关 Azure 平台安全性的信息，请访问 [Azure 信任中心](https://www.microsoft.com/TrustCenter/Security/default.aspx)。
...
- 提交自己的数据，供 Microsoft 基因组学服务处理：[配对 FASTQ](quickstart-input-pair-FASTQ.md) | [BAM](quickstart-input-BAM.md) | [多个 FASTQ 或 BAM](quickstart-input-multiple.md) 
