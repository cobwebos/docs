...
description: 如果输入文件是一对 FASTQ 文件，本文将演示如何向 Microsoft 基因组服务提交工作流。
services: genomics
author: grhuynh
manager: cgronlun
ms.author: grhuynh
...
如果输入文件是一对 FASTQ 文件，本文将演示如何向 Microsoft 基因组服务提交工作流。 本主题假设你已安装并运行 `msgen` 客户端，且熟悉如何使用 Azure 存储。 如果您已成功使用提供的示例数据提交工作流，则可以继续执行本文。 
...
本文介绍了如何将一对 FASTQ 文件上传到 Azure 存储中，以及如何通过 `msgen` Python 客户端将工作流提交到 Microsoft 基因组学服务。 要了解有关工作流提交和其他命令（您可以使用 Microsoft 基因组学服务）的更多内容，请参阅我们的[常见问题解答](frequently-asked-questions-genomics.md)。 
