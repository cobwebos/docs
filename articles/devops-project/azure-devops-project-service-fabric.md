...
1. 退出 Azure 配置区域，然后选择“完成”。   
    ...
    完成所有操作后，DevOps Projects 仪表板会显示在 Azure 门户中。 也可直接从 Azure 门户中的“所有资源”直接转到 DevOps Projects 仪表板。  
...
测试后，可以清理资源，以避免产生费用。 不再需要本教程中创建的 Azure Service Fabric 群集和相关资源时，可将其删除。 为此，可以使用 DevOps Projects 仪表板上的“删除”功能。 
