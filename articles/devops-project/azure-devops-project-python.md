...
ms.locfileid: "37966878"
---
# <a name="create-a-cicd-pipeline-for-python-with-the-azure-devops-project"></a>使用 Azure DevOps 项目创建用于 Python 的 CI/CD 管道

Azure DevOps 项目提供一种简化的体验，适合在 Visual Studio Team Services (VSTS)（Microsoft 推出的适用于 Azure 的 DevOps 解决方案）中为 Python 应用创建 Azure 资源并设置持续集成 (CI) 和持续交付 (CD)管道。  
...
1. 创建**新的** VSTS 帐户，或者选择**现有的**帐户。  为 VSTS 项目选择一个**名称**。  选择 **Azure 订阅**、**位置**，然后为应用程序选择一个**名称**。  完成后，选择“完成”。
    ...
    ![输入 VSTS 信息](_img/azure-devops-project-python/vstsazureinfo.png)
