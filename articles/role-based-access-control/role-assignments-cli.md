...
以下示例将*虚拟机参与者*角色分配给*制药销售*资源组作用域*\@中的contoso.com*用户：
...
下面的示例将*虚拟机参与者*角色分配给 Ann Mack*团队*组，该组 ID 为 ID 2222222-2222-2222-2222-2222222222，该工作组位于名为*Pharma-sales-project-网络*的虚拟网络的资源范围内。
