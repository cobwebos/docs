---
title: 使用 Azure CLI 创建或更新 Azure 资源的自定义角色 |Microsoft Docs
description: 了解如何使用 Azure CLI 使用 Azure 资源的基于角色的访问控制（RBAC）列出、创建、更新或删除自定义角色。
