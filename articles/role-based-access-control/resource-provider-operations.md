...
本文档列出了可对每个 Azure 资源管理器资源提供程序使用的操作。 这些操作可用于 Azure[自定义角色](custom-roles.md)，以便对 Azure 中的资源提供精细的访问控制。 操作字符串的格式如下：`{Company}.{ProviderName}/{resourceType}/{action}`。 有关资源提供程序命名空间如何映射到 Azure 服务的列表，请参阅[将资源提供程序与服务匹配](../azure-resource-manager/management/azure-services-resource-providers.md)。
...
> | 操作 | 微软.Api管理/服务/网关/列表键/操作 | 检索网关密钥。 |
> | 操作 | 微软.Api管理/服务/网关/再生键/操作 | 重新生成指定的网关密钥无效，将验证使用它创建的任何令牌。 |
> | 操作 | 微软.Api管理/服务/网关/生成令牌/操作 | 获取网关的共享访问授权令牌。 |
> |  | **服务/网关/apis** |  |
...
> | 操作 | 微软.Api管理/服务/命名值/列表值/操作 | 获取其标识符指定的命名值的机密。 |
> |  | **服务/网络状态** |  |
...
> | 操作 | 微软.Api管理/服务/门户设置/列表秘密/操作 | 获取门户委派设置的验证密钥。 |
> |  | **服务/产品** |  |
...
> | 操作 | 微软.应用配置/配置存储/私有端点连接审批/操作 | 在指定的配置存储下自动批准专用终结点连接。 |
> |  | **配置存储/事件网格筛选器** |  |
...
> |  | **配置存储/专用端点连接** |  |
> | 操作 | 微软.应用程序配置/配置存储/私有端点连接/读取 | 获取专用终结点连接或在指定的配置存储下列出专用终结点连接。 |
> | 操作 | 微软.应用程序配置/配置存储/私有端点连接/写入 | 在指定的配置存储下批准或拒绝专用终结点连接。 |
> | 操作 | 微软.应用程序配置/配置存储/专用端点连接/删除 | 删除指定配置存储下的专用终结点连接。 |
> |  | **配置存储/私有链接资源** |  |
> | 操作 | 微软.应用程序配置/配置商店/私有链接资源/读取 | 列出指定配置存储下的所有专用链接资源。 |
> |  | **配置商店/提供商/微软.见解/诊断设置** |  |
...
> |  | **自动化帐户/私有端点连接Proxies** |  |
> | 操作 | 微软.自动化/自动化账户/私人端接连接Proxies/读取 | 读取 Azure 自动化专用终结点连接代理 |
> | 操作 | 微软.自动化/自动化账户/私人端接连接Proxies/写 | 创建 Azure 自动化专用终结点连接代理 |
> | 操作 | 微软.自动化/自动化账户/私人端接连接Proxies/验证/操作 | 验证专用终结点连接请求（组 Id 验证） |
> | 操作 | 微软.自动化/自动化账户/私人端接连接Proxies/删除 | 删除 Azure 自动化专用终结点连接代理 |
> |  | **自动化帐目/专用端接策略/操作结果** |  |
> | 操作 | 微软.自动化/自动化账户/私人端接连接Proxies/操作结果/读取 | 获取 Azure 自动化专用终结点代理操作结果。 |
> |  | **自动化帐户/专用端点连接** |  |
> | 操作 | 微软.自动化/自动化账户/专用端点连接/读取 | 获取 Azure 自动化专用终结点连接状态 |
> | 操作 | 微软.自动化/自动化账户/专用端点连接/写入 | 批准或拒绝 Azure 自动化专用终结点连接 |
> |  | **自动化账户/私有链接资源** |  |
> | 操作 | 微软.自动化/自动化账户/私人链接资源/阅读 | 读取专用终结点的组信息 |
> |  | **自动化帐户/python2包** |  |
...
> |  | **云清单文件** |  |
> | 操作 | 微软.AzureStack/云清单文件/读取 | 获取云清单文件 |
> |  | **操作** |  |
...
> |  | **批处理帐户/私有终结点连接结果** |  |
> | 操作 | 微软.批量/批处理账户/私有终结点连接结果/读取 | 获取长时间运行的 Batch 帐户专用终结点连接操作的结果 |
> |  | **批处理帐户/专用终结点连接** |  |
> | 操作 | 微软.批处理/批处理帐户/私有终结点连接/写入 | 更新批处理帐户上的现有专用终结点连接 |
> | 操作 | 微软.批处理/批处理帐户/私有终结点连接/读取 | 获取专用终结点连接或列出批处理帐户上的专用终结点连接 |
> |  | **批处理帐户/私有链接资源** |  |
> | 操作 | 微软.批量/批处理帐户/私有链接资源/读取 | 获取专用链接资源的属性或列出批处理帐户上的专用链接资源 |
> |  | **位置** |  |
...
> |  | **mapApis** |  |
> | 操作 | Microsoft.BingMaps/mapApis/Read | 获取 Microsoft 的资源。 |
> | 操作 | Microsoft.BingMaps/mapApis/Write | 更新微软的资源。 |
> | 操作 | Microsoft.BingMaps/mapApis/Delete | 删除 Microsoft 的资源。 |
> | 操作 | Microsoft.BingMaps/mapApis/regenerateKey/action | 为微软重新生成密钥。 |
> | 操作 | Microsoft.BingMaps/mapApis/listSecrets/action | 列出微软的秘密. BingMaps/mapApis |
> | 操作 | 微软.BingMaps/mapApis/列表使用指标/操作 | 列出微软的指标。 |
> |  | **操作** |  |
> | 操作 | Microsoft.BingMaps/Operations/read | 列出微软的操作。 |
...
> | 操作 | Microsoft.BotService/botServices/channels/read | 阅读机器人服务渠道 |
> | 操作 | Microsoft.BotService/botServices/channels/write | 编写机器人服务通道 |
> | 操作 | Microsoft.BotService/botServices/channels/delete | 删除机器人服务渠道 |
> | 操作 | 微软.Bot服务/自动服务/频道/列表通道与密钥/操作 | 列出带机密的自动服务通道 |
...
> |  | **机器人服务/连接/列表与机密** |  |
> | 操作 | 微软.Bot服务/自动服务/连接/列表与秘密/写入 | 编写机器人服务连接列表  |
> |  | **位置/操作结果** |  |
...
> |  | **操作结果/配置文件结果/终结点结果/原点组结果** |  |
> | 操作 | Microsoft.Cdn/操作结果/配置文件结果/终结点结果/原点组结果/读取 |  |
> | 操作 | Microsoft.Cdn/操作结果/配置文件结果/终结点结果/原点组结果/写入 |  |
> | 操作 | Microsoft.Cdn/操作结果/配置文件结果/终结点结果/原点组结果/删除 |  |
> |  | **操作结果/配置文件结果/端点结果/原点结果** |  |
...
> |  | **配置文件/终结点/原点组** |  |
> | 操作 | 微软.Cdn/配置文件/终结点/源组/读取 |  |
> | 操作 | 微软.Cdn/配置文件/终结点/源组/写入 |  |
> | 操作 | 微软.Cdn/配置文件/终结点/原点组/删除 |  |
...
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/recognizetext/action | 使用此接口可以获取“识别文本”操作的结果。 使用"识别文本"界面时，响应包含名为"操作-位置"的字段。 "操作位置"字段包含必须用于获取识别文本操作结果操作的 URL。 |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/tag/action | 此操作生成与所提供图像内容相关的单词或标记列表。<br>计算机视觉 API 可以根据在图像中找到的对象、生物、风景或动作返回标记。<br>与类别不同，标记不是根据层次结构分类系统进行组织，而是对应于图像内容。<br>标签可能包含提示以避免歧义或提供上下文，例如标签"大提琴"可能伴随着提示"乐器"。<br>所有标记均为英文。 |
...
> |  | **帐户/计算机视觉/文本操作** |  |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/textoperations/read | 此接口用于获取“识别文本”操作的结果。 应从从"识别文本"界面返回<b>的"操作-位置"</b>字段中检索此接口的 URL。 |
> |  | **帐户/内容管理员** |  |
...
> | DataAction | Microsoft.CognitiveServices/accounts/ContentModerator/teams/reviews/frames/read | *未定义* |
> |  | **帐户/内容管理员/团队/设置/模板** |  |
...
> | DataAction | Microsoft.CognitiveServices/accounts/ContentModerator/teams/workflows/read | 获取团队中特定工作流的详细信息，获取团队的所有可用工作流* |
> |  | **帐户/内容管理员/术语列表** |  |
...
> | DataAction | Microsoft.CognitiveServices/accounts/CustomVision.Prediction/user/action | *未定义* |
> | DataAction | Microsoft.CognitiveServices/accounts/CustomVision.Prediction/quota/action | *未定义* |
> |  | **帐户/自定义视觉.预测/分类/迭代** |  |
...
> |  | **帐户/自定义视觉.预测/项目** |  |
> | DataAction | Microsoft.CognitiveServices/accounts/CustomVision.Prediction/project/migrate/action | *未定义* |
> |  | **帐户/自定义视觉.预测/项目** |  |
...
> | DataAction | 微软.认知服务/帐户/自定义视觉.预测/项目/导入/操作 | 导入项目。 |
> |  | **帐户/自定义视觉.预测/项目/导出** |  |
> | DataAction | 微软.认知服务/帐户/自定义视觉.预测/项目/导出/读取 | 导出项目。 |
> |  | **帐户/自定义视觉.预测/项目/图像** |  |
...
> |  | **帐户/自定义视觉.预测/项目/培训** |  |
> | DataAction | 微软.认知服务/帐户/自定义视觉.预测/项目/培训/高级/行动 | 使用管道配置和培训类型进行训练的队列项目。 |
> |  | **帐户/自定义视觉.预测/配额** |  |
> | DataAction | Microsoft.CognitiveServices/accounts/CustomVision.Prediction/quota/delete | *未定义* |
> |  | **帐户/自定义视觉.预测/配额/刷新** |  |
> | DataAction | Microsoft.CognitiveServices/accounts/CustomVision.Prediction/quota/refresh/write | *未定义* |
> |  | **帐户/自定义视觉.预测/使用/预测/用户** |  |
> | DataAction | Microsoft.CognitiveServices/accounts/CustomVision.Prediction/usage/prediction/user/read | 获取 Oxford 用户的预测资源用量 |
> |  | **帐户/自定义视觉.预测/使用/培训/资源/层** |  |
...
> |  | **帐户/自定义视觉.预测/使用/培训/用户** |  |
> | DataAction | Microsoft.CognitiveServices/accounts/CustomVision.Prediction/usage/training/user/read | 获取 Oxford 用户的训练资源用量 |
> |  | **帐户/自定义视觉.预测/用户** |  |
> | DataAction | Microsoft.CognitiveServices/accounts/CustomVision.Prediction/user/delete | *未定义* |
> |  | **帐户/自定义视觉.预测/用户/状态** |  |
> | DataAction | Microsoft.CognitiveServices/accounts/CustomVision.Prediction/user/state/write | 更新用户状态 |
> |  | **帐户/自定义视觉.预测/用户/层** |  |
> | DataAction | Microsoft.CognitiveServices/accounts/CustomVision.Prediction/user/tier/write | *未定义* |
> |  | **帐户/自定义视觉.预测/用户** |  |
> | DataAction | Microsoft.CognitiveServices/accounts/CustomVision.Prediction/users/read | *未定义* |
> |  | **帐户/自定义视觉.预测/白名单** |  |
...
> | DataAction | Microsoft.CognitiveServices/accounts/TextAnalytics/sentiment/action | API 将返回介于 0 与 1 之间的数字评分。<br>接近 1 的分数表示积极情绪，而接近 0 的分数表示消极情绪。<br>评分 0.5 表示缺少情绪（例如<br>factoid 语句）。 |
> |  | **帐户/视频搜索** |  |
...
> |  | **使用情况聚合** |  |
> | 操作 | Microsoft.Commerce/UsageAggregates/read | 按订阅检索 Microsoft Azure 的消耗。 结果包含特定时间范围内的聚合用量数据、订阅和资源相关信息。 |
...
> |  | **位置/专用端点连接代理Azure同步操作** |  |
> | 操作 | 微软.计算/位置/专用端点连接代理Azure同步操作/读取 | 获取异步专用终结点连接代理操作的状态 |
> |  | **位置/专用端接连接操作结果** |  |
> | 操作 | 微软.计算/位置/私人端接代理操作结果/读取 | 获取专用终结点连接代理操作的结果 |
> |  | **位置/发布者** |  |
...
> |  | **sharedVMExtensions** |  |
> | 操作 | 微软.计算/共享VM扩展/读取 | 获取共享 VM 扩展的属性 |
> | 操作 | 微软.计算/共享VM扩展/写入 | 创建新的共享 VM 扩展或更新现有扩展 |
> | 操作 | 微软.计算/共享VM扩展/删除 | 删除共享 VM 扩展 |
> |  | **sharedVMExtensions/versions** |  |
> | 操作 | 微软.计算/共享VM扩展/版本/读取 | 获取共享 VM 扩展版本的属性 |
> | 操作 | 微软.计算/共享VM扩展/版本/写入 | 创建新的共享 VM 扩展版本或更新现有扩展版本 |
> | 操作 | 微软.计算/共享VM扩展/版本/删除 | 删除共享 VM 扩展版本 |
> |  | **sharedVMImages** |  |
...
> |  | **sshPublicKeys** |  |
> | 操作 | 微软.计算/sshPublicKeys/读取 | 获取 SSH 公钥的属性 |
> | 操作 | 微软.计算/sshPublicKeys/写入 | 创建新的 SSH 公钥或更新现有的 SSH 公钥 |
> | 操作 | 微软.计算/sshPublicKeys/删除 | 删除 SSH 公钥 |
> |  | **virtualMachines** |  |
...
> | 操作 | 微软.计算/虚拟机/安装补丁/操作 | 根据用户提供的参数在虚拟机上安装可用的操作系统更新修补程序。 包含可用修补程序列表的评估结果也将作为其中的一部分刷新。 |
> | 操作 | 微软.计算/虚拟机/评估补丁/操作 | 评估虚拟机并查找可用的操作系统更新修补程序的列表。 |
> | 操作 | 微软.计算/虚拟机/取消补丁安装/操作 | 取消虚拟机上正在进行的安装 OS 更新修补程序操作。 |
> |  | **virtualMachines/extensions** |  |
...
> |  | **虚拟机级集/扩展/角色** |  |
> | 操作 | 微软.计算/虚拟机表集/扩展/角色/读取 | 使用虚拟机运行时服务扩展获取虚拟机扩展集中角色的属性 |
> | 操作 | 微软.计算/虚拟机表集/扩展/角色/写入 | 使用虚拟机运行时服务扩展更新虚拟机扩展集中的现有角色的属性 |
> |  | **虚拟机级表集/实例视图** |  |
...
> |  | **虚拟机级设置/虚拟机/网络接口/ip 配置/公共 IP 地址** |  |
...
> |  | **虚拟机级设置虚拟机/扩展** |  |
> | 操作 | 微软.计算/虚拟机规模设置虚拟机/扩展/读取 | 在虚拟机缩放集中获取虚拟机扩展的属性 |
> | 操作 | 微软.计算/虚拟机规模设置虚拟机/扩展/写入 | 在虚拟机缩放集中为虚拟机创建新扩展，或更新现有扩展 |
> | 操作 | 微软.计算/虚拟机规模设置虚拟机/扩展/删除 | 删除虚拟机缩放集中虚拟机的扩展 |
> |  | **virtualMachines** |  |
...
> |  | **注册表/代理池** |  |
> | 操作 | 微软.容器注册/注册表/代理池/列表队列状态/操作 | 列出容器注册表的代理池的所有队列状态。 |
> |  | **注册表/工件** |  |
...
> |  | **注册表/私有端接连接 Proxies** |  |
> | 操作 | 微软.集装箱注册/注册/私人终端连接Proxies/验证/操作 | 验证专用终结点连接代理（仅限 NRP） |
> | 操作 | 微软.集装箱注册/注册/私人端接连接Proxies/读取 | 获取专用终结点连接代理（仅限 NRP） |
> | 操作 | 微软.集装箱注册/注册/私人终端连接Proxies/写 | 创建专用终结点连接代理（仅限 NRP） |
> | 操作 | 微软.集装箱注册/注册/私人终端连接Proxies/删除 | 删除专用终结点连接代理（仅限 NRP） |
> |  | **注册表/私有端接连接状态/操作状态** |  |
> | 操作 | 微软.集装箱注册/注册/私人端接连接Proxies/操作状态/读取 | 获取专用终结点连接代理异步操作状态 |
> |  | **注册表/拉取** |  |
...
> |  | **注册表/任务运行** |  |
> | 操作 | 微软.集装箱注册/注册表/任务运行/列表详细信息/操作 | 列出容器注册表的任务运行的所有详细信息。 |
> |  | **registries/tasks** |  |
...
> |  | **斯克库斯** |  |
> | 操作 | 微软.DataBoxEdge/skus/读取 | 列出或获取 SKU |
...
> | 操作 | 微软.数据砖/工作区/刷新工作区/操作 | 使用 URL 等新详细信息刷新工作区 |
> |  | **工作区/数据库工作区** |  |
> | 操作 | 微软.数据砖/工作区/db工作区/写入 | 初始化数据砖块工作区（仅限内部） |
> |  | **工作区/提供商/微软.见解/诊断设置** |  |
...
> |  | **单服务器** |  |
> | 操作 | 微软.DBforPostgreSQL/单服务器/读取 | 返回服务器列表，或获取指定服务器的属性。 |
> | 操作 | 微软.DBforPostgreSQL/单服务器/写入 | 使用指定参数创建服务器，或更新指定服务器的属性或标记。 |
> | 操作 | 微软.DBforPostgreSQL/单服务器/删除 | 删除现有服务器。 |
> |  | **单服务器/提供商/微软.见解/诊断设置** |  |
> | 操作 | 微软.DBforPostgreSQL/单服务器/提供商/微软.见解/诊断设置/读取 | 获取资源的诊断设置 |
> | 操作 | 微软.DBforPostgreSQL/单服务器/提供商/微软.见解/诊断设置/写入 | 创建或更新资源的诊断设置 |
> |  | **单个服务器/提供商/微软.见解/日志定义** |  |
> | 操作 | 微软.DBforPostgreSQL/单服务器/提供商/微软.见解/日志定义/读取 | 获取 PostgreSQL 服务器的可用日志 |
> |  | **单服务器/提供商/微软.见解/指标定义** |  |
> | 操作 | 微软.DBforPostgreSQL/单服务器/提供商/微软.见解/指标定义/读取 | 返回可用于数据库的指标类型 |
...
> |  | **弹性池/iotHub租户/事件HubEndpoints/消费者组** |  |
...
> | 操作 | 微软.设备/iotHubs/私人端点连接审批/操作 | 批准或拒绝专用终结点连接 |
> |  | **iotHubs/证书** |  |
...
> |  | **iotHubs/数字双星链接** |  |
> | 操作 | 微软.设备/电图中心/数字双星链接/写入 |  |
> | 操作 | 微软.设备/iotHubs/数字双星链接/阅读 |  |
> | 操作 | 微软.设备/iotHubs/数字双星链接/删除 |  |
> |  | **iotHubs/事件网格筛选器** |  |
...
> |  | **iotHubs/私有端点连接Proxies** |  |
> | 操作 | 微软.设备/iotHubs/私人终端连接Proxies/验证/操作 | 在创建期间验证专用终结点连接代理输入 |
> | 操作 | 微软.设备/iotHubs/私人终端连接Proxies/阅读 | 获取指定专用终结点连接代理的属性 |
> | 操作 | 微软.设备/iotHubs/私人终端连接Proxies/写 | 创建或更新专用终结点连接代理 |
> | 操作 | 微软.设备/iotHubs/私人终端连接Proxies/删除 | 删除现有的专用终结点连接代理 |
> |  | **iotHubs/私有端点连接Proxies/操作结果** |  |
> | 操作 | 微软.设备/iotHubs/私人终端连接Proxies/操作结果/阅读 | 获取私有终结点连接代理上的异步操作的结果 |
> |  | **iotHubs/私有端点连接** |  |
> | 操作 | 微软.设备/iotHubs/私人端点连接/读取 | 获取指定专用终结点连接的属性 |
> | 操作 | 微软.设备/iotHubs/私人端点连接/删除 | 删除现有的专用终结点连接 |
> | 操作 | 微软.设备/iotHubs/私有端点连接/写入 | 创建或更新专用终结点连接 |
> |  | **iotHubs/专用端点连接/操作结果** |  |
> | 操作 | 微软.设备/iotHubs/私有端点连接/操作结果/阅读 | 获取私有终结点连接上异步操作的结果 |
> |  | **iotHubs/私有链接资源** |  |
> | 操作 | 微软.设备/iotHubs/私人链接资源/阅读 | 获取 IotHub 的专用链接资源 |
> |  | **iotHubs/配额指标** |  |
...
> |  | **数据库帐户/api/数据库** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/write | （已弃用。 请使用没有"/api/" 段的资源路径创建数据库。 仅适用于 API 类型：“sql”、“mongodb”、“gremlin”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/read | （已弃用。 请使用没有"/api/" 段的资源路径读取数据库或列出所有数据库。 仅适用于 API 类型：“sql”、“mongodb”、“gremlin”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/delete | （已弃用。 请使用没有"/api/" 段的资源路径删除数据库。 仅适用于 API 类型：“sql”、“mongodb”、“gremlin”。 |
> |  | **数据库帐户/apis/数据库/集合** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/write | （已弃用。 请使用没有"/api/" 段的资源路径创建或更新集合。 仅适用于 API 类型：“mongodb”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/read | （已弃用。 请使用没有"/api/" 段的资源路径读取集合或列出所有集合。 仅适用于 API 类型：“mongodb”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/delete | （已弃用。 请使用没有"/api/" 段的资源路径删除集合。 仅适用于 API 类型：“mongodb”。 |
> |  | **数据库帐户/apis/数据库/集合/操作结果** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/operationResults/read | （已弃用。 请使用没有"/api/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“mongodb”。 |
> |  | **数据库帐户/apis/数据库/集合/设置** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/settings/write | （已弃用。 请使用没有"/api/" 段的资源路径更新集合吞吐量。 仅适用于 API 类型：“mongodb”。 仅适用于设置类型：“throughput”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/settings/read | （已弃用。 请使用没有"/api/" 段的资源路径读取集合吞吐量。 仅适用于 API 类型：“mongodb”。 仅适用于设置类型：“throughput”。 |
> |  | **数据库帐户/apis/数据库/集合/设置/操作结果** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/settings/operationResults/read | （已弃用。 请使用没有"/api/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“mongodb”。 仅适用于设置类型：“throughput”。 |
> |  | **数据库帐户/apis/数据库/容器** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/write | （已弃用。 请使用没有"/api/" 段的资源路径创建或更新容器。 仅适用于 API 类型：“sql”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/read | （已弃用。 请使用没有"/api/" 段的资源路径读取容器或列出所有容器。 仅适用于 API 类型：“sql”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/delete | （已弃用。 请使用没有"/api/" 段的资源路径删除容器。 仅适用于 API 类型：“sql”。 |
> |  | **数据库帐户/apis/数据库/容器/操作结果** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/operationResults/read | （已弃用。 请使用没有"/api/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“sql”。 |
> |  | **数据库帐户/apis/数据库/容器/设置** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/settings/write | （已弃用。 请使用没有"/api/" 段的资源路径更新容器吞吐量。 仅适用于 API 类型：“sql”。 仅适用于设置类型：“throughput”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/settings/read | （已弃用。 请使用没有"/api/" 段的资源路径读取容器吞吐量。 仅适用于 API 类型：“sql”。 仅适用于设置类型：“throughput”。 |
> |  | **数据库帐户/apis/数据库/容器/设置/操作结果** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/settings/operationResults/read | （已弃用。 请使用没有"/api/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“sql”。 仅适用于设置类型：“throughput”。 |
> |  | **数据库帐户/apis/数据库/图形** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/write | （已弃用。 请使用没有"/api/" 段的资源路径创建或更新图形。 仅适用于 API 类型：“gremlin”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/read | （已弃用。 请使用没有"/api/" 段的资源路径读取图形或列出所有图形。 仅适用于 API 类型：“gremlin”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/delete | （已弃用。 请使用没有"/api/" 段的资源路径删除图形。 仅适用于 API 类型：“gremlin”。 |
> |  | **数据库帐户/apis/数据库/图形/操作结果** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/operationResults/read | （已弃用。 请使用没有"/api/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“gremlin”。 |
> |  | **数据库帐户/apis/数据库/图形/设置** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/settings/write | （已弃用。 请使用没有"/api/" 段的资源路径更新图形吞吐量。 仅适用于 API 类型：“gremlin”。 仅适用于设置类型：“throughput”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/settings/read | （已弃用。 请使用没有"/api/" 段的资源路径读取图形吞吐量。 仅适用于 API 类型：“gremlin”。 仅适用于设置类型：“throughput”。 |
> |  | **数据库帐户/apis/数据库/图形/设置/操作结果** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/settings/operationResults/read | （已弃用。 请使用没有"/api/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“gremlin”。 仅适用于设置类型：“throughput”。 |
> |  | **数据库帐户/apis/数据库/操作结果** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/operationResults/read | （已弃用。 请使用没有"/api/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“sql”、“mongodb”、“gremlin”。 |
> |  | **数据库帐户/apis/数据库/设置** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/settings/write | （已弃用。 请使用没有"/api/" 段的资源路径更新数据库吞吐量。 仅适用于 API 类型：“sql”、“mongodb”、“gremlin”。 仅适用于设置类型：“throughput”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/settings/read | （已弃用。 请使用没有"/api/" 段的资源路径读取数据库吞吐量。 仅适用于 API 类型：“sql”、“mongodb”、“gremlin”。 仅适用于设置类型：“throughput”。 |
> |  | **数据库帐户/apis/数据库/设置/操作结果** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/settings/operationResults/read | （已弃用。 请使用没有"/api/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“sql”、“mongodb”、“gremlin”。 仅适用于设置类型：“throughput”。 |
> |  | **数据库帐户/api/键空间** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/write | （已弃用。 请使用没有"/api/" 段的资源路径创建键空间。 仅适用于 API 类型：“cassandra”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/read | （已弃用。 请使用没有"/api/" 段的资源路径读取键空间或列出所有键空间。 仅适用于 API 类型：“cassandra”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/delete | （已弃用。 请使用没有"/api/" 段的资源路径删除键空间。 仅适用于 API 类型：“cassandra”。 |
> |  | **数据库帐户/apis/键空间/操作结果** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/operationResults/read | （已弃用。 请使用没有"/api/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“cassandra”。 |
> |  | **数据库帐户/apis/键空间/设置** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/settings/write | （已弃用。 请使用没有"/api/" 段的资源路径更新密钥空间吞吐量。 仅适用于 API 类型：“cassandra”。 仅适用于设置类型：“throughput”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/settings/read | （已弃用。 请使用没有"/api/" 段的资源路径读取密钥空间吞吐量。 仅适用于 API 类型：“cassandra”。 仅适用于设置类型：“throughput”。 |
> |  | **数据库帐户/apis/键空间/设置/操作结果** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/settings/operationResults/read | （已弃用。 请使用没有"/api/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“cassandra”。 仅适用于设置类型：“throughput”。 |
> |  | **数据库帐户/api/键空间/表** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/write | （已弃用。 请使用没有"/api/" 段的资源路径创建或更新表。 仅适用于 API 类型：“cassandra”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/read | （已弃用。 请使用没有"/api/" 段的资源路径读取表或列出所有表。 仅适用于 API 类型：“cassandra”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/delete | （已弃用。 请使用没有"/api/" 段的资源路径删除表。 仅适用于 API 类型：“cassandra”。 |
> |  | **数据库帐户/api/键空间/表/操作结果** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/operationResults/read | （已弃用。 请使用没有"/api/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“cassandra”。 |
> |  | **数据库帐户/apis/键空间/表/设置** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/settings/write | （已弃用。 请使用没有"/api/" 段的资源路径更新表吞吐量。 仅适用于 API 类型：“cassandra”。 仅适用于设置类型：“throughput”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/settings/read | （已弃用。 请使用没有"/api/" 段的资源路径读取表吞吐量。 仅适用于 API 类型：“cassandra”。 仅适用于设置类型：“throughput”。 |
> |  | **数据库帐户/apis/键空间/表/设置/操作结果** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/settings/operationResults/read | （已弃用。 请使用没有"/api/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“cassandra”。 仅适用于设置类型：“throughput”。 |
> |  | **数据库帐户/api/表** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/tables/write | （已弃用。 请使用没有"/api/" 段的资源路径创建或更新表。 仅适用于 API 类型：“table”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/tables/read | （已弃用。 请使用没有"/api/" 段的资源路径读取表或列出所有表。 仅适用于 API 类型：“table”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/tables/delete | （已弃用。 请使用没有"/api/" 段的资源路径删除表。 仅适用于 API 类型：“table”。 |
> |  | **数据库帐户/api/表/操作结果** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/tables/operationResults/read | （已弃用。 请使用没有"/api/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“table”。 |
> |  | **数据库帐户/api/表/设置** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/tables/settings/write | （已弃用。 请使用没有"/api/" 段的资源路径更新表吞吐量。 仅适用于 API 类型：“table”。 仅适用于设置类型：“throughput”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/tables/settings/read | （已弃用。 请使用没有"/api/" 段的资源路径读取表吞吐量。 仅适用于 API 类型：“table”。 仅适用于设置类型：“throughput”。 |
> |  | **数据库帐户/api/表/设置/操作结果** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/tables/settings/operationResults/read | （已弃用。 请使用没有"/api/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“table”。 仅适用于设置类型：“throughput”。 |
> |  | **数据库帐户/卡桑德拉关键空间** |  |
...
> |  | **数据库帐户/mongodb 数据库/吞吐量设置/操作结果** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/mongodbDatabases/throughputSettings/operationResults/read | 读取异步操作的状态。 |
> |  | **数据库帐户/笔记本工作区** |  |
> | 操作 | 微软.文档数据库/数据库帐户/笔记本工作区/写入 | 创建或更新笔记本工作区 |
> | 操作 | 微软.文档数据库/数据库帐户/笔记本工作区/读取 | 阅读笔记本工作区 |
> | 操作 | 微软.文档数据库/数据库帐户/笔记本工作区/删除 | 删除笔记本工作区 |
> | 操作 | 微软.文档数据库/数据库帐户/笔记本工作区/列表连接信息/操作 | 列出笔记本工作区的连接信息 |
> |  | **数据库帐户/笔记本工作区/操作结果** |  |
> | 操作 | 微软.文档数据库/数据库帐户/笔记本工作/操作结果/读取 | 读取笔记本工作区上异步操作的状态 |
> |  | **数据库帐户/操作结果** |  |
...
> |  | **数据库帐户/区域/数据库/集合/分区KeyRangeId/指标** |  |
...
> |  | **域/专用端接连接 Proxies** |  |
> | 操作 | 微软.事件网格/域/私人端接连接Proxies/验证/操作 | 验证域的专用端接连接 Proxie |
> | 操作 | 微软.事件网格/域/私人端接连接Proxies/读取 | 读取域的专用端接连接 Proxie |
> | 操作 | 微软.事件网格/域/私人端接连接Proxies/写入 | 为域编写专用终结点连接 Proxie |
> | 操作 | 微软.事件网格/域/私人端接连接Proxies/删除 | 删除域的专用终结点连接 Proxie |
> |  | **域/专用端点连接** |  |
> | 操作 | 微软.事件网格/域/私有端点连接/读取 | 读取域的专用终结点连接 |
> | 操作 | 微软.事件网格/域/私有端点连接/写入 | 为域写入专用终结点连接 |
> | 操作 | 微软.事件网格/域/私人端点连接/删除 | 删除域的专用终结点连接 |
> |  | **域/私有链接资源** |  |
> | 操作 | 微软.事件网格/域/私有链接资源/读取 | 获取或列出域的私有链接资源 |
> |  | **域/提供商/微软.见解/日志定义** |  |
...
> |  | **合作伙伴命名空间** |  |
> | 操作 | 微软.事件网格/合作伙伴命名空间/写入 | 创建或更新合作伙伴命名空间 |
> | 操作 | 微软.事件网格/合作伙伴命名空间/读取 | 读取合作伙伴命名空间 |
> | 操作 | 微软.事件网格/合作伙伴命名空间/删除 | 删除合作伙伴命名空间 |
> | 操作 | 微软.事件网格/合作伙伴命名空间/列表键/操作 | 列出合作伙伴命名空间的键 |
> | 操作 | 微软.事件网格/合作伙伴命名空间/重新生成键/操作 | 重新生成合作伙伴命名空间的键 |
> |  | **合作伙伴命名空间/事件通道** |  |
> | 操作 | 微软.事件网格/合作伙伴命名空间/事件通道/读取 | 阅读事件通道 |
> | 操作 | 微软.事件网格/合作伙伴命名空间/事件通道/写入 | 创建或更新事件通道 |
> | 操作 | 微软.事件网格/合作伙伴命名空间/事件通道/删除 | 删除事件通道 |
> |  | **合作伙伴注册** |  |
> | 操作 | 微软.事件网格/合作伙伴注册/写入 | 创建或更新合作伙伴注册 |
> | 操作 | 微软.事件网格/合作伙伴注册/阅读 | 阅读合作伙伴注册 |
> | 操作 | 微软.事件网格/合作伙伴注册/删除 | 删除合作伙伴注册 |
> |  | **合作伙伴主题** |  |
> | 操作 | 微软.事件网格/合作伙伴主题/阅读 | 阅读合作伙伴主题 |
> | 操作 | 微软.事件网格/合作伙伴主题/写入 | 创建或更新合作伙伴主题 |
> | 操作 | 微软.事件网格/合作伙伴主题/删除 | 删除合作伙伴主题 |
> | 操作 | 微软.事件网格/合作伙伴主题/激活/操作 | 激活合作伙伴主题 |
> | 操作 | 微软.事件网格/合作伙伴主题/停用/操作 | 停用合作伙伴主题 |
> |  | **Sku** |  |
> | 操作 | 微软.事件网格/sku/读取 | 读取事件网格资源的可用 SKU 定义 |
> |  | **系统主题** |  |
> | 操作 | 微软.事件网格/系统主题/阅读 | 阅读系统主题 |
> | 操作 | 微软.事件网格/系统主题/写入 | 创建或更新系统主题 |
> | 操作 | 微软.事件网格/系统主题/删除 | 删除系统主题 |
> |  | **系统主题/提供商/微软.见解/诊断设置** |  |
> | 操作 | 微软.事件网格/系统主题/提供商/微软.见解/诊断设置/读取 | 获取系统主题的诊断设置 |
> | 操作 | 微软.事件网格/系统主题/提供商/微软.见解/诊断设置/写入 | 创建或更新系统主题的诊断设置 |
> |  | **系统主题/提供商/微软.见解/日志定义** |  |
> | 操作 | 微软.事件网格/系统主题/提供商/微软.见解/日志定义/读取 | 允许访问诊断日志 |
> |  | **系统主题/提供商/微软.见解/指标定义** |  |
> | 操作 | 微软.事件网格/系统主题/提供商/微软.见解/指标定义/读取 | 获取系统主题的可用指标 |
> |  | **主题** |  |
...
> |  | **主题/私有端点连接Proxies** |  |
> | 操作 | 微软.事件网格/主题/私人端接连接Proxies/验证/操作 | 验证主题的专用端接连接 Proxie |
> | 操作 | 微软.事件网格/主题/私人端接连接Proxies/阅读 | 阅读私有端点连接 Proxie 主题 |
> | 操作 | 微软.事件网格/主题/私人端接连接Proxies/写 | 为主题编写私有终结点连接 Proxie |
> | 操作 | 微软.事件网格/主题/私人端接连接Proxies/删除 | 删除主题的专用终结点连接 Proxie |
> |  | **主题/专用端点连接** |  |
> | 操作 | 微软.事件网格/主题/私人端点连接/读取 | 阅读主题的专用终结点连接 |
> | 操作 | 微软.事件网格/主题/私有端点连接/写入 | 为主题编写专用终结点连接 |
> | 操作 | 微软.事件网格/主题/私人端点连接/删除 | 删除主题的专用终结点连接 |
> |  | **主题/私有链接资源** |  |
> | 操作 | 微软.事件网格/主题/私人链接资源/阅读 | 阅读私有链接资源主题 |
> |  | **主题/提供商/微软.见解/诊断设置** |  |
...
> |  | **命名空间/专用端接Proxies** |  |
> | 操作 | 微软.事件Hub/命名空间/私人端接连接Proxies/验证/操作 | 验证专用终结点连接代理 |
> | 操作 | 微软.事件Hub/命名空间/私人端接连接Proxies/读取 | 获取专用终结点连接代理 |
> | 操作 | 微软.事件Hub/命名空间/私人端接连接Proxies/写入 | 创建专用终结点连接代理 |
> | 操作 | 微软.事件Hub/命名空间/私人端接连接Proxies/删除 | 删除专用终结点连接代理 |
> |  | **命名空间/提供商/微软.见解/诊断设置** |  |
...
> |  | **位置/操作结果** |  |
> | 操作 | 微软.混合计算/位置/操作结果/读取 | 读取 Microsoft 上操作的状态。 |
> |  | **机器** |  |
> | 操作 | Microsoft.HybridCompute/machines/read | 读取任何 Azure Arc 计算机 |
> | 操作 | Microsoft.HybridCompute/machines/write | 写入 Azure 弧形计算机 |
> | 操作 | Microsoft.HybridCompute/machines/delete | 删除 Azure 弧形计算机 |
> | 操作 | Microsoft.HybridCompute/machines/reconnect/action | 重新连接 Azure 弧形计算机 |
> |  | **机器/扩展** |  |
> | 操作 | Microsoft.HybridCompute/machines/extensions/read | 读取任何 Azure 电弧扩展 |
> | 操作 | Microsoft.HybridCompute/machines/extensions/write | 安装或更新 Azure 电弧扩展 |
> | 操作 | Microsoft.HybridCompute/machines/extensions/delete | 删除 Azure 电弧扩展 |
> |  | **操作** |  |
> | 操作 | 微软.混合计算/操作/读取 | 读取服务器 Azure 弧的所有操作 |
...
> |  | **myWorkbooks** |  |
> | 操作 | 微软.见解/我的工作簿/写作 | 创建或更新专用工作簿 |
> | 操作 | 微软.见解/我的工作簿/阅读 | 阅读私人工作簿 |
> |  | **操作** |  |
> | 操作 | Microsoft.Insights/Operations/Read | 读取操作 |
> |  | **私有链接范围操作状态** |  |
> | 操作 | 微软.见解/私人链接范围操作状态/阅读 | 读取专用链接作用域操作状态 |
> |  | **私人链接范围** |  |
> | 操作 | 微软.见解/私人链接范围/阅读 | 读取专用链接作用域 |
> | 操作 | 微软.见解/私人链接范围/写入 | 创建或更新专用链接作用域 |
> | 操作 | 微软.见解/私人链接范围/删除 | 删除专用链接范围 |
> |  | **私有链接范围/私有端点连接 Proxies** |  |
> | 操作 | 微软.Insights/私人链接范围/私人端接链接Proxies/阅读 | 读取专用终结点连接代理 |
> | 操作 | 微软.见解/私人链接范围/私人端接链接Proxies/写入 | 创建或更新专用终结点连接代理 |
> | 操作 | 微软.Insights/私人链接范围/私人端接链接Proxies/删除 | 删除专用终结点连接代理 |
> | 操作 | 微软.Insights/私人链接范围/私人端接链接Proxies/验证/操作 | 验证专用终结点连接代理 |
> |  | **私有链接范围/专用端点连接** |  |
> | 操作 | 微软.Insights/私人链接范围/私人端点连接/阅读 | 读取专用终结点连接 |
> | 操作 | 微软.Insights/私人链接范围/私人端点连接/写入 | 创建或更新专用终结点连接 |
> | 操作 | 微软.Insights/私人链接范围/私人端点连接/删除 | 删除专用终结点连接 |
> |  | **私有链接范围/私人链接资源** |  |
> | 操作 | 微软.见解/私人链接范围/私人链接资源/阅读 | 读取专用链接资源 |
> |  | **私有链接范围/范围资源** |  |
> | 操作 | 微软.见解/私人链接范围/范围资源/阅读 | 读取专用链接作用域资源 |
> | 操作 | 微软.见解/私人链接范围/范围资源/写入 | 创建或更新专用链接作用域资源 |
> | 操作 | 微软.见解/私人链接范围/范围资源/删除 | 删除专用链接范围资源 |
> |  | **计划查询规则** |  |
...
> | 操作 | 微软.库斯特/集群/列表语言扩展/操作 | 列出语言扩展。 |
> | 操作 | 微软.库斯托/集群/添加语言扩展/操作 | 添加语言扩展名。 |
> | 操作 | 微软.库斯托/集群/删除语言扩展/操作 | 删除语言扩展名。 |
> |  | **群集/附加数据库配置** |  |
...
> |  | **群集/数据连接** |  |
> | 操作 | 微软.库斯托/集群/数据连接/读取 | 读取群集的数据连接资源。 |
> | 操作 | 微软.库斯托/集群/数据连接/写入 | 写入群集的数据连接资源。 |
> | 操作 | 微软.库斯托/集群/数据连接/删除 | 删除群集的数据连接资源。 |
> |  | **群集/主体分配** |  |
...
> | 操作 | 微软.实验室服务/实验室帐户/获取限制和使用/操作 | 获取此订阅的核心限制和使用情况 |
> |  | **实验室帐户/库图像** |  |
...
> |  | **集成帐户/计划** |  |
> | 操作 | 微软.逻辑/集成帐户/计划/读取 | 在集成帐户中读取计划。 |
> | 操作 | 微软.逻辑/集成帐户/计划/写入 | 在集成帐户中创建或更新计划。 |
> | 操作 | 微软.逻辑/集成帐户/计划/删除 | 删除集成帐户中的计划。 |
> |  | **集成帐户/架构** |  |
...
> | 操作 | 微软.机器学习服务/工作区/专用端点连接审批/操作 | 批准或拒绝到 Microsoft.Network 提供程序的专用终结点资源的连接 |
> |  | **workspaces/computes** |  |
...
> | 操作 | 微软.机器学习服务/工作区/计算/启动/操作 | 在机器学习服务工作区中启动计算资源 |
> | 操作 | 微软.机器学习服务/工作空间/计算/停止/操作 | 停止机器学习服务工作区中的计算资源 |
> | 操作 | 微软.机器学习服务/工作区/计算/重新启动/操作 | 重新启动机器学习服务工作区中的计算资源 |
> |  | **工作空间/数据漂移探测器** |  |
...
> | 操作 | 微软.机器学习服务/工作空间/数据漂移探测器/删除 | 删除机器学习服务工作区中的数据漂移检测器 |
> |  | **工作区/数据集/已注册** |  |
...
> |  | **工作区/实验/运行** |  |
> | 操作 | 微软.机器学习服务/工作空间/实验/运行/提交/操作 | 在机器学习服务工作区中创建或更新脚本运行 |
...
> |  | **工作区/标签** |  |
> | 操作 | 微软.机器学习服务/工作空间/标签/导出/操作 | 机器学习服务工作区中标签项目的导出标签 |
> |  | **工作区/标签/标签** |  |
> | 操作 | 微软.机器学习服务/工作空间/标签/标签/读取 | 获取机器学习服务工作区中标记项目的标签 |
> | 操作 | 微软.机器学习服务/工作空间/标签/标签/写入 | 在机器学习服务工作区中创建标记项目的标签 |
> | 操作 | 微软.机器学习服务/工作空间/标签/标签/拒绝/操作 | 拒绝机器学习服务工作区中标记项目的标签 |
> |  | **工作区/标签/项目** |  |
> | 操作 | 微软.机器学习服务/工作空间/标签/项目/读取 | 获取机器学习服务工作区中的标签项目 |
> | 操作 | 微软.机器学习服务/工作空间/标签/项目/写入 | 在机器学习服务工作区中创建或更新标记项目 |
> | 操作 | 微软.机器学习服务/工作空间/标签/项目/删除 | 删除机器学习服务工作区中的标签项目 |
> |  | **工作区/标签/项目/摘要** |  |
> | 操作 | 微软.机器学习服务/工作空间/标签/项目/摘要/阅读 | 获取机器学习服务工作区中的标签项目摘要 |
> |  | **工作区/元数据/项目** |  |
...
> |  | **工作空间/服务/aks** |  |
> | 操作 | 微软.机器学习服务/工作空间/服务/aks/写入 | 在机器学习服务工作区中创建或更新 AKS 服务 |
> | 操作 | 微软.机器学习服务/工作空间/服务/aks/列表键/操作 | 在机器学习服务工作区中列出 AKS 服务的键 |
> | 操作 | 微软.机器学习服务/工作空间/服务/aks/删除 | 删除机器学习服务工作区中的 AKS 服务 |
> | 操作 | 微软.机器学习服务/工作空间/服务/aks/分数/操作 | 在机器学习服务工作区中对 AKS 服务进行评分 |
...
> |  | **管理组/设置** |  |
> | 操作 | 微软.管理/管理组/设置/读取 | 列出现有的管理组层次结构设置。 |
> | 操作 | 微软.管理/管理组/设置/写入 | 创建或更新管理组层次结构设置。 |
> | 操作 | 微软.管理/管理组/设置/删除 | 删除管理组层次结构设置。 |
> |  | **管理组/订阅** |  |
...
> |  | **帐户/私人地图集** |  |
> | 操作 | 微软.地图/帐户/私人地图集/删除 | 删除私人地图集 |
> | 操作 | 微软.地图/帐户/私人地图集/阅读 | 获取私人地图集 |
> | 操作 | 微软.地图/帐户/私人地图集/写入 | 创建或更新专用地图集 |
> |  | **操作** |  |
...
> |  | **私人商店** |  |
> | 操作 | 微软.市场/私人商店/写入 | 创建专用商店。 |
> | 操作 | 微软.市场/私人商店/删除 | 删除专用商店。 |
> | 操作 | 微软.市场/私人商店/优惠/行动 | 私人商店中的更新产品/服务。 |
> | 操作 | 微软.市场/私人商店/阅读 | 读取私人商店。 |
> |  | **私人商店/优惠** |  |
> | 操作 | 微软.市场/私人商店/优惠/写入 | 在私人商店中创建产品/服务。 |
> | 操作 | 微软.市场/私人商店/优惠/删除 | 从私人商店中删除产品/服务。 |
...
> | 操作 | 微软.混合现实/远程呈现帐户/提供商/微软.见解/指标定义/读取 | 获取 Microsoft 的可用指标。 |
> |  | **空间锚定帐户/提供者/微软.见解/诊断设置** |  |
...
> |  | **对象理解帐户** |  |
> | DataAction | 微软.混合现实/对象理解帐户/摄录/行动 | 创建模型引入作业 |
> |  | **对象理解帐户/摄录** |  |
> | DataAction | 微软.混合现实/对象理解帐户/摄录/阅读 | 获取模型引入作业状态 |
> |  | **远程渲染帐户** |  |
...
> |  | **空间锚点帐户/查询** |  |
> | DataAction | Microsoft.MixedReality/SpatialAnchorsAccounts/query/read | 找到空间定位点 |
> |  | **空间锚点帐户/提交** |  |
...
> | 操作 | 微软.NetApp/NetApp帐户/容量池/卷/恢复/操作 | 将卷还原到特定快照 |
> | 操作 | 微软.NetApp/NetApp帐户/容量池/卷/中断复制/操作 | 中断卷复制关系 |
...
> | 操作 | 微软.NetApp/NetApp 帐户/容量池/卷/删除复制/操作 | 删除目标卷上的复制 |
> |  | **净应用账户/容量池/卷/备份** |  |
...
> |  | **净应用帐户/容量池/卷/装入目标** |  |
> | 操作 | 微软.NetApp/NetApp帐户/容量池/卷/安装目标/读取 | 读取装入目标资源。 |
> |  | **净应用帐户/容量池/卷/复制状态** |  |
> | 操作 | 微软.NetApp/NetApp 帐户/容量池/卷/复制状态/读取 | 读取卷复制的状态。 |
> |  | **净应用帐户/容量池/卷/快照** |  |
...
> |  | **净应用帐户/快照策略** |  |
> | 操作 | 微软.NetApp/NetApp帐户/快照策略/读取 | 读取快照策略资源。 |
> | 操作 | 微软.NetApp/NetApp帐户/快照策略/写入 | 写入快照策略资源。 |
> | 操作 | 微软.NetApp/NetApp帐户/快照策略/删除 | 删除快照策略资源。 |
> | 操作 | 微软.NetApp/NetApp帐户/快照策略/列表卷/操作 | 列表连接到快照策略的卷 |
> |  | **净应用帐户/保管库** |  |
...
> |  | **应用程序规则集合** |  |
> | 操作 | 微软.网络/应用程序规则集合/读取 | 获取 Azure 防火墙应用程序规则集合 |
> | 操作 | 微软.网络/应用程序规则集合/写入 | 创建或更新 Azure 防火墙应用程序规则集合 |
> | 操作 | 微软.网络/应用程序规则集合/删除 | 删除 Azure 防火墙应用程序规则集合 |
...
> | 操作 | 微软.网络/堡垒主机/获取可共享链接/操作 | 返回堡垒子网中指定 VM 的可共享 URL（如果已创建其 URL） |
> | 操作 | 微软.网络/堡垒主机/创建可共享链接/操作 | 为堡垒节点下的 VM 创建可共享的 URL 并返回 URL |
> | 操作 | 微软.网络/堡垒主机/可共享链接/操作 | 删除堡垒节点下提供的 VM 的可共享 URL |
...
> |  | **dns 区域/A** |  |
> | 操作 | Microsoft.Network/dnszones/A/read | 获取类型为"A"的记录集，采用 JSON 格式。 记录集包含记录列表以及 TTL、标记和 etag。 |
> | 操作 | Microsoft.Network/dnszones/A/write | 在 DNS 区域中创建或更新类型为"A"的记录集。 指定的记录将替换记录集中的当前记录。 |
> | 操作 | Microsoft.Network/dnszones/A/delete | 从 DNS 区域中删除给定名称的记录集并键入"A"。 |
> |  | **dns区域/AAA** |  |
> | 操作 | Microsoft.Network/dnszones/AAAA/read | 获取以 JSON 格式的类型"AAAA"的记录集。 记录集包含记录列表以及 TTL、标记和 etag。 |
> | 操作 | Microsoft.Network/dnszones/AAAA/write | 在 DNS 区域中创建或更新类型为"AAAA"的记录集。 指定的记录将替换记录集中的当前记录。 |
> | 操作 | Microsoft.Network/dnszones/AAAA/delete | 从 DNS 区域中删除给定名称的记录集并键入"AAAA"。 |
> |  | **dnszones/all** |  |
> | 操作 | Microsoft.Network/dnszones/all/read | 获取各种类型的 DNS 记录集 |
> |  | **dnszones/CAA** |  |
> | 操作 | Microsoft.Network/dnszones/CAA/read | 获取以 JSON 格式的类型"CAA"的记录集。 记录集包含 TTL、标记和 etag。 |
> | 操作 | Microsoft.Network/dnszones/CAA/write | 在 DNS 区域中创建或更新类型为"CAA"的记录集。 指定的记录将替换记录集中的当前记录。 |
> | 操作 | Microsoft.Network/dnszones/CAA/delete | 从 DNS 区域中删除给定名称的记录集并键入"CAA"。 |
> |  | **dns 区域/CNAME** |  |
> | 操作 | Microsoft.Network/dnszones/CNAME/read | 获取以 JSON 格式的类型"CNAME"的记录集。 记录集包含 TTL、标记和 etag。 |
> | 操作 | Microsoft.Network/dnszones/CNAME/write | 在 DNS 区域中创建或更新类型为"CNAME"的记录集。 指定的记录将替换记录集中的当前记录。 |
> | 操作 | Microsoft.Network/dnszones/CNAME/delete | 从 DNS 区域中删除给定名称的记录集并键入"CNAME"。 |
> |  | **dns 区域/MX** |  |
> | 操作 | Microsoft.Network/dnszones/MX/read | 获取类型为"MX"的记录集，其格式为 JSON 格式。 记录集包含记录列表以及 TTL、标记和 etag。 |
> | 操作 | Microsoft.Network/dnszones/MX/write | 在 DNS 区域中创建或更新类型为"MX"的记录集。 指定的记录将替换记录集中的当前记录。 |
> | 操作 | Microsoft.Network/dnszones/MX/delete | 从 DNS 区域中删除给定名称的记录集并键入"MX"。 |
> |  | **dnszones/NS** |  |
...
> |  | **dns 区域/PTR** |  |
> | 操作 | Microsoft.Network/dnszones/PTR/read | 获取以 JSON 格式的类型"PTR"的记录集。 记录集包含记录列表以及 TTL、标记和 etag。 |
> | 操作 | Microsoft.Network/dnszones/PTR/write | 在 DNS 区域中创建或更新类型为"PTR"的记录集。 指定的记录将替换记录集中的当前记录。 |
> | 操作 | Microsoft.Network/dnszones/PTR/delete | 从 DNS 区域中删除给定名称的记录集并键入"PTR"。 |
> |  | **dnszones/recordsets** |  |
...
> |  | **dns 区域/SRV** |  |
> | 操作 | Microsoft.Network/dnszones/SRV/read | 获取类型为"SRV"的记录集，采用 JSON 格式。 记录集包含记录列表以及 TTL、标记和 etag。 |
> | 操作 | Microsoft.Network/dnszones/SRV/write | 创建或更新 SRV 类型的记录集 |
> | 操作 | Microsoft.Network/dnszones/SRV/delete | 从 DNS 区域中删除给定名称的记录集并键入"SRV"。 |
> |  | **dns 区域/TXT** |  |
> | 操作 | Microsoft.Network/dnszones/TXT/read | 获取以 JSON 格式的类型"TXT"的记录集。 记录集包含记录列表以及 TTL、标记和 etag。 |
> | 操作 | Microsoft.Network/dnszones/TXT/write | 在 DNS 区域中创建或更新类型为"TXT"的记录集。 指定的记录将替换记录集中的当前记录。 |
> | 操作 | Microsoft.Network/dnszones/TXT/delete | 从 DNS 区域中删除给定名称的记录集并键入"TXT"。 |
...
> |  | **ip 分配** |  |
> | 操作 | 微软.网络/ip分配/读取 | 获取 Ip 分配 |
> | 操作 | 微软.网络/ip分配/写入 | 创建 Ip 分配或更新现有 Ip 分配 |
> | 操作 | 微软.网络/ip分配/删除 | 删除 Ip 分配 |
> |  | **ip组** |  |
...
> | 操作 | 微软.网络/负载平衡器/后端地址池/写入 | 创建负载均衡器后端地址池或更新现有负载均衡器后端地址池 |
> | 操作 | 微软.网络/负载平衡器/后端地址池/删除 | 删除负载均衡器后端地址池 |
...
> | 操作 | 微软.网络/位置/批量通知私人终结点资源移动/操作 | 批量通知专用终结点资源移动。 |
...
> |  | **natGateways** |  |
> | 操作 | 微软.网络/natGateways/加入/行动 | 加入 NAT 网关 |
> |  | **纳特鲁尔收集** |  |
> | 操作 | 微软.网络/natRule集合/读取 | 获取 Azure 防火墙 NatRule 集合 |
> | 操作 | 微软.网络/natRule集合/写入 | 创建或更新 Azure 防火墙 NatRule 收集 |
> | 操作 | 微软.网络/natRule集合/删除 | 删除 Azure 防火墙 NatRule 集合 |
> |  | **网络实验配置文件** |  |
> | 操作 | 微软.网络/网络实验配置文件/读取 | 获取互联网分析器配置文件 |
> | 操作 | 微软.网络/网络实验配置文件/写入 | 创建或更新互联网分析器配置文件 |
> | 操作 | 微软.网络/网络实验配置文件/删除 | 删除互联网分析器配置文件 |
> |  | **网络实验配置文件/实验** |  |
> | 操作 | 微软.网络/网络实验配置文件/实验/阅读 | 获取互联网分析仪测试 |
> | 操作 | 微软.网络/网络实验配置文件/实验/写入 | 创建或更新互联网分析器测试 |
> | 操作 | 微软.网络/网络实验配置文件/实验/删除 | 删除互联网分析器测试 |
> | 操作 | 微软.网络/网络实验配置文件/实验/时间序列/操作 | 获取互联网分析仪测试的时间序列 |
> | 操作 | 微软.网络/网络实验配置文件/实验/延迟记分卡/操作 | 获取互联网分析器测试的延迟记分卡 |
> |  | **网络实验配置文件/预配置的终结点** |  |
> | 操作 | 微软.网络/网络实验配置文件/预配置的终结点/读取 | 获取 Internet 分析器配置文件的预配置终结点 |
...
> | 操作 | 微软.网络/网络接口/更新家长附件上弹性/操作 | 更新与弹性 NIC 关联的父 NIC |
> |  | **网络接口/ip 配置** |  |
...
> |  | **网络规则集合** |  |
> | 操作 | 微软.网络/网络规则集合/读取 | 获取 Azure 防火墙网络规则集合 |
> | 操作 | 微软.网络/网络规则收集/写入 | 创建或更新 Azure 防火墙网络规则集合 |
> | 操作 | 微软.网络/网络规则收集/删除 | 删除 Azure 防火墙网络规则集合 |
> |  | **networkSecurityGroups** |  |
...
> | 操作 | 微软.网络/专用 Dns 区域/加入/操作 | 加入专用 DNS 区域 |
> |  | **privateDnsZones/A** |  |
> | 操作 | Microsoft.Network/privateDnsZones/A/read | 获取专用 DNS 区域中键入"A"的记录集，其格式为 JSON 格式。 记录集包含记录列表以及 TTL、标记和 etag。 |
> | 操作 | Microsoft.Network/privateDnsZones/A/write | 在专用 DNS 区域中创建或更新类型为"A"的记录集。 指定的记录将替换记录集中的当前记录。 |
> | 操作 | Microsoft.Network/privateDnsZones/A/delete | 从专用 DNS 区域中删除给定名称的记录集并键入"A"。 |
> |  | **privateDnsZones/AAAA** |  |
> | 操作 | Microsoft.Network/privateDnsZones/AAAA/read | 在专用 DNS 区域中以 JSON 格式获取类型为"AAAA"的记录集。 记录集包含记录列表以及 TTL、标记和 etag。 |
> | 操作 | Microsoft.Network/privateDnsZones/AAAA/write | 在专用 DNS 区域中创建或更新类型为"AAAA"的记录集。 指定的记录将替换记录集中的当前记录。 |
> | 操作 | Microsoft.Network/privateDnsZones/AAAA/delete | 从专用 DNS 区域中删除给定名称的记录集并键入"AAAA"。 |
> |  | **私有 Dns 区域/ALL** |  |
> | 操作 | Microsoft.Network/privateDnsZones/ALL/read | 获取各种类型的专用 DNS 记录集 |
> |  | **privateDnsZones/CNAME** |  |
> | 操作 | Microsoft.Network/privateDnsZones/CNAME/read | 以 JSON 格式在专用 DNS 区域中获取类型"CNAME"的记录集。 |
> | 操作 | Microsoft.Network/privateDnsZones/CNAME/write | 在专用 DNS 区域中创建或更新类型为"CNAME"的记录集。 |
> | 操作 | Microsoft.Network/privateDnsZones/CNAME/delete | 从专用 DNS 区域中删除给定名称的记录集并键入"CNAME"。 |
> |  | **privateDnsZones/MX** |  |
> | 操作 | Microsoft.Network/privateDnsZones/MX/read | 获取专用 DNS 区域内的"MX"类型的记录集，其格式为 JSON 格式。 记录集包含记录列表以及 TTL、标记和 etag。 |
> | 操作 | Microsoft.Network/privateDnsZones/MX/write | 在专用 DNS 区域中创建或更新类型为"MX"的记录集。 指定的记录将替换记录集中的当前记录。 |
> | 操作 | Microsoft.Network/privateDnsZones/MX/delete | 从专用 DNS 区域中删除给定名称的记录集并键入"MX"。 |
> |  | **privateDnsZones/PTR** |  |
> | 操作 | Microsoft.Network/privateDnsZones/PTR/read | 获取专用 DNS 区域内以 JSON 格式的类型"PTR"的记录集。 记录集包含记录列表以及 TTL、标记和 etag。 |
> | 操作 | Microsoft.Network/privateDnsZones/PTR/write | 在专用 DNS 区域中创建或更新类型为"PTR"的记录集。 指定的记录将替换记录集中的当前记录。 |
> | 操作 | Microsoft.Network/privateDnsZones/PTR/delete | 从专用 DNS 区域中删除给定名称的记录集并键入"PTR"。 |
> |  | **私有 Dns 区域/记录集** |  |
> | 操作 | Microsoft.Network/privateDnsZones/recordsets/read | 获取各种类型的专用 DNS 记录集 |
> |  | **privateDnsZones/SOA** |  |
> | 操作 | Microsoft.Network/privateDnsZones/SOA/read | 以 JSON 格式在专用 DNS 区域中获取类型为"SOA"的记录集。 |
> | 操作 | Microsoft.Network/privateDnsZones/SOA/write | 在专用 DNS 区域中更新类型为"SOA"的记录集。 |
> |  | **privateDnsZones/SRV** |  |
> | 操作 | Microsoft.Network/privateDnsZones/SRV/read | 获取专用 DNS 区域内的"SRV"类型的记录集，其格式为 JSON 格式。 记录集包含记录列表以及 TTL、标记和 etag。 |
> | 操作 | Microsoft.Network/privateDnsZones/SRV/write | 在专用 DNS 区域中创建或更新类型为"SRV"的记录集。 指定的记录将替换记录集中的当前记录。 |
> | 操作 | Microsoft.Network/privateDnsZones/SRV/delete | 从专用 DNS 区域中删除给定名称的记录集并键入"SRV"。 |
> |  | **privateDnsZones/TXT** |  |
> | 操作 | Microsoft.Network/privateDnsZones/TXT/read | 获取专用 DNS 区域内的"TXT"类型的记录集，其格式为 JSON 格式。 记录集包含记录列表以及 TTL、标记和 etag。 |
> | 操作 | Microsoft.Network/privateDnsZones/TXT/write | 在专用 DNS 区域中创建或更新类型为"TXT"的记录集。 指定的记录将替换记录集中的当前记录。 |
> | 操作 | Microsoft.Network/privateDnsZones/TXT/delete | 从专用 DNS 区域中删除给定名称的记录集并键入"TXT"。 |
...
> |  | **privateEndpoints** |  |
> | 操作 | 微软.网络/私人终结点/推送属性到资源/操作 | 操作从 NRP 客户端推送专用终结点属性更新 |
...
> |  | **私有终结点/私有 DnsZone 配置** |  |
> | 操作 | 微软.网络/私人终端/私人DnsZone配置/写入 | 放置专用 DNS 区域配置 |
> |  | **privateLinkServices** |  |
...
> |  | **安全合作伙伴提供商** |  |
> | 操作 | 微软.网络/安全合作伙伴提供商/读取 | 获取安全合作伙伴提供商 |
> | 操作 | 微软.网络/安全合作伙伴提供商/写入 | 创建安全合作伙伴提供商或更新现有安全合作伙伴提供商 |
> | 操作 | 微软.网络/安全合作伙伴提供商/验证/操作 | 验证安全合作伙伴提供商 |
> | 操作 | 微软.网络/安全合作伙伴提供商/更新参考/操作 | 更新安全合作伙伴提供商中的引用 |
> | 操作 | 微软.网络/安全合作伙伴提供商/加入/行动 | 加入安全合作伙伴提供商。 不可发出警报。 |
> | 操作 | 微软.网络/安全合作伙伴提供商/删除 | 删除安全合作伙伴提供商 |
...
> | 操作 | 微软.网络/虚拟网络/加入负载平衡器/操作 | 将负载均衡器连接到虚拟网络 |
...
> | 操作 | Microsoft.OffAzure/HyperVSites/runasaccounts/read | 获取作为帐户运行的 Hyper-V 的属性 |
> |  | **超级网站/摘要** |  |
> | 操作 | 微软.关闭Azure/超网站/摘要/阅读 | 获取超 V 站点的摘要 |
> | 操作 | 微软.关闭Azure/超网站/摘要/阅读 | 获取超 V 站点的摘要 |
> | 操作 | 微软.关闭Azure/超网站/摘要/阅读 | 获取超 V 站点的摘要 |
> | 操作 | 微软.关闭Azure/超网站/摘要/阅读 | 获取超 V 站点的摘要 |
> |  | **超级网站/使用** |  |
...
> | 操作 | 微软.关闭Azure/导入网站/导出/操作 | 获取用于导出计算机 CSV 文件的 SAS uri。 |
> | 操作 | Microsoft.OffAzure/ImportSites/read | 获取导入站点的属性 |
> | 操作 | Microsoft.OffAzure/ImportSites/write | 创建或更新导入站点 |
> | 操作 | Microsoft.OffAzure/ImportSites/delete | 删除导入站点 |
> | 操作 | Microsoft.OffAzure/ImportSites/importuri/action | 获取用于导入计算机 CSV 文件的 SAS URI。 |
...
> | 操作 | Microsoft.OffAzure/ServerSites/runasaccounts/read | 获取作为帐户运行的服务器的属性 |
> |  | **服务器站点/摘要** |  |
> | 操作 | 微软.关闭Azure/服务器网站/摘要/阅读 | 获取服务器站点的摘要 |
> | 操作 | 微软.关闭Azure/服务器网站/摘要/阅读 | 获取服务器站点的摘要 |
> | 操作 | 微软.关闭Azure/服务器网站/摘要/阅读 | 获取服务器站点的摘要 |
> | 操作 | 微软.关闭Azure/服务器网站/摘要/阅读 | 获取服务器站点的摘要 |
> |  | **服务器站点/使用情况** |  |
...
> | 操作 | Microsoft.OffAzure/VMwareSites/runasaccounts/read | 获取作为帐户运行的 VMware 的属性 |
> |  | **VMware 网站/摘要** |  |
> | 操作 | 微软.关闭Azure/VMware网站/摘要/阅读 | 获取 VMware 站点的摘要 |
> | 操作 | 微软.关闭Azure/VMware网站/摘要/阅读 | 获取 VMware 站点的摘要 |
> | 操作 | 微软.关闭Azure/VMware网站/摘要/阅读 | 获取 VMware 站点的摘要 |
> | 操作 | 微软.关闭Azure/VMware网站/摘要/阅读 | 获取 VMware 站点的摘要 |
> |  | **VMware 网站/使用情况** |  |
...
> |  | **可用的服务层** |  |
> | 操作 | microsoft.运营见解/可用服务层/读取 | 获取可用的服务层。 |
> |  | **集群** |  |
> | 操作 | 微软.操作见解/集群/阅读 | 获取群集 |
> | 操作 | 微软.操作见解/集群/写入 | 创建或更新群集 |
> | 操作 | 微软.操作见解/集群/删除 | 删除群集 |
> |  | **linkTargets** |  |
...
> |  | **位置/操作 状态** |  |
> | 操作 | 微软.操作见解/位置/操作 状态/读取 | 获取日志分析 Azure 异步操作状态。 |
> |  | **操作** |  |
...
> |  | **工作区/数据导出** |  |
> | 操作 | microsoft.运营见解/工作空间/数据导出/读取 | 获取特定数据导出。 |
> | 操作 | microsoft.运营见解/工作空间/数据导出/写入 | 创建或更新数据导出。 |
> | 操作 | microsoft.运营见解/工作空间/数据导出/删除 | 删除特定数据导出。 |
> |  | **工作区/数据源** |  |
...
> |  | **工作区/查询/ADFSSIS集成运行时日志** |  |
> | 操作 | 微软.操作见解/工作空间/查询/ADFSSIS集成运行时日志/读取 | 从 ADFSIS 集成运行时日志表中读取数据 |
> |  | **工作区/查询/ADFSSIS 包事件消息上下文** |  |
> | 操作 | 微软.操作见解/工作空间/查询/ADFSSIS包事件消息上下文/读取 | 从 ADFSSIS 包事件消息上下文表中读取数据 |
> |  | **工作区/查询/ADFSSIS 包事件消息** |  |
> | 操作 | 微软.操作见解/工作空间/查询/ADFSSIS包事件消息/读取 | 从 ADFSSIS 打包事件消息表中读取数据 |
> |  | **工作区/查询/ADFSSIS 包可执行统计信息** |  |
> | 操作 | 微软.操作见解/工作空间/查询/ADFSSIS包可执行统计/读取 | 从 ADFSSIS 包可执行统计信息表中读取数据 |
> |  | **工作区/查询/ADFSSIS 包执行组件阶段** |  |
> | 操作 | 微软.操作见解/工作空间/查询/ADFSSIS包执行组件阶段/读取 | 从 ADFSSIS 包执行组件阶段表中读取数据 |
> |  | **工作区/查询/ADFSSIS包执行数据统计** |  |
> | 操作 | 微软.操作见解/工作空间/查询/ADFSSIS包执行数据统计/读取 | 从 ADFSSIS 包执行数据统计信息表中读取数据 |
> |  | **工作区/查询/ADF触发器运行** |  |
...
> |  | **工作区/查询/应用程序服务HTTPLogs** |  |
> | 操作 | Microsoft.OperationalInsights/workspaces/query/AppServiceHTTPLogs/read | 从 AppServiceHTTPLogs 表读取数据 |
> |  | **工作区/查询/应用程序系统事件** |  |
> | 操作 | 微软.操作见解/工作空间/查询/应用程序系统事件/读取 | 从 AppSystem 事件表中读取数据 |
> |  | **工作区/查询/应用跟踪** |  |
> | 操作 | 微软.操作见解/工作空间/查询/应用程序跟踪/阅读 | 从 AppTraces 表读取数据 |
> |  | **工作区/查询/审核日志** |  |
...
> |  | **工作区/查询/AzureDevOps审核** |  |
> | 操作 | 微软.操作见解/工作空间/查询/AzureDevOps审核/读取 | 从 AzureDevOps 审核表中读取数据 |
> |  | **工作区/查询/Azure 诊断** |  |
> | 操作 | 微软.操作见解/工作空间/查询/Azure诊断/读取 | 从 Azure 诊断表中读取数据 |
> |  | **工作区/查询/Azure 指标** |  |
...
> |  | **工作区/查询/SqlData 分类** |  |
> | 操作 | 微软.操作见解/工作空间/查询/SqlData 分类/读取 | 从 SqlData 分类表中读取数据 |
> |  | **工作区/查询/SQLQuery性能** |  |
...
> |  | **工作区/查询/WVD检查点** |  |
> | 操作 | 微软.操作见解/工作空间/查询/WVD检查点/读取 | 从 WVD 检查点表中读取数据 |
> |  | **工作区/查询/WVD连接** |  |
> | 操作 | 微软.操作见解/工作空间/查询/WVD连接/读取 | 从 WVDConnections 表中读取数据 |
> |  | **工作区/查询/WVD错误** |  |
> | 操作 | 微软.操作见解/工作空间/查询/WVD错误/读取 | 从 WVDErrors 表中读取数据 |
> |  | **工作区/查询/WVD源** |  |
> | 操作 | 微软.操作见解/工作空间/查询/WVDFeed/读取 | 从 WVD 源表中读取数据 |
> |  | **工作区/查询/WVDHost注册** |  |
> | 操作 | 微软.操作见解/工作空间/查询/WVDHost注册/读取 | 从 WVDHost 注册表读取数据 |
> |  | **工作区/查询/WVD管理** |  |
> | 操作 | 微软.操作见解/工作空间/查询/WVD管理/阅读 | 从 WVD 管理表中读取数据 |
> |  | **工作区/规则** |  |
...
> |  | **工作区/作用域私人链接 Proxies** |  |
> | 操作 | microsoft.操作见解/工作空间/范围PrivateLinkProxies/读取 | 获取作用域专用链接代理。 |
> | 操作 | microsoft.操作见解/工作空间/范围私人链接普洛西/写入 | 放置作用域专用链接代理。 |
> | 操作 | microsoft.操作见解/工作区/范围PrivateLinkProxies/删除 | 删除作用域专用链接代理。 |
> |  | **工作区/搜索** |  |
...
> |  | **保管库/专用端接连接 Proxies** |  |
> | 操作 | 微软.恢复服务/Vault/私人终端连接Proxies/删除 | 等候几分钟时间，并重试操作。 如果该问题仍然存在，请联系 Microsoft 支持部门。 |
> | 操作 | 微软.恢复服务/Vaults/私人端接连接Proxies/读取 | 获取所有可保护的容器 |
> | 操作 | 微软.恢复服务/Vault/私人终端连接Proxies/验证/操作 | 获取所有可保护的容器 |
> | 操作 | 微软.恢复服务/Vaults/私有端接连接Proxies/写入 | 获取所有可保护的容器 |
> |  | **保管库/专用端接连接Proxies/操作状态** |  |
> | 操作 | 微软.恢复服务/Vault/私人终端连接Proxies/操作状态/读取 | 获取所有可保护的容器 |
> |  | **保管库/专用端点连接** |  |
> | 操作 | 微软.恢复服务/Vault/私有端点连接/删除 | 删除专用终结点请求。 此调用由备份管理员进行。 |
> | 操作 | 微软.恢复服务/Vault/私有端点连接/写入 | 批准或拒绝专用终结点请求。 此调用由备份管理员进行。 |
> |  | **保管库/专用端点连接/操作状态** |  |
> | 操作 | 微软.恢复服务/Vault/私有端点连接/操作状态/读取 | 返回专用终结点连接的操作状态。 |
> |  | **保管库/注册标识** |  |
...
> |  | **命名空间/专用端接Proxies** |  |
> | 操作 | 微软.中继/命名空间/私人端接连接Proxies/验证/操作 | 验证专用终结点连接代理 |
> | 操作 | 微软.中继/命名空间/私人端接连接Proxies/读取 | 获取专用终结点连接代理 |
> | 操作 | 微软.中继/命名空间/私人端接连接Proxies/写入 | 创建专用终结点连接代理 |
> | 操作 | 微软.中继/命名空间/私人端接连接Proxies/删除 | 删除专用终结点连接代理 |
> |  | **命名空间/提供商/微软.见解/诊断设置** |  |
...
> |  | **新兴问题** |  |
> | 操作 | 微软.资源健康/新兴问题/阅读 | 获取 Azure 服务的新兴问题 |
> |  | **事件** |  |
...
> |  | **自动预配设置** |  |
> | 操作 | 微软.安全/自动预配设置/读取 | 获取订阅的安全自动预配设置 |
> | 操作 | 微软.安全/自动预配设置/写入 | 为订阅创建或更新安全自动预配设置 |
> |  | **合规性结果** |  |
...
> | 操作 | 微软.安全洞察/数据连接器检查要求/操作 | 检查用户授权和许可证 |
> |  | **聚合** |  |
...
> |  | **事件** |  |
> | 操作 | 微软.安全见解/事件/读取 | 获取事件 |
> | 操作 | 微软.安全见解/事件/写入 | 更新事件 |
> | 操作 | 微软.安全见解/事件/删除 | 删除事件 |
> |  | **事件/评论** |  |
> | 操作 | 微软.安全见解/事件/评论/阅读 | 获取事件注释 |
> | 操作 | 微软.安全见解/事件/评论/写入 | 创建事件注释 |
> |  | **事件/关系** |  |
> | 操作 | 微软.安全见解/事件/关系/阅读 | 获取事件和相关资源之间的关系 |
> | 操作 | 微软.安全见解/事件/关系/写入 | 更新事件和相关资源之间的关系 |
> | 操作 | 微软.安全见解/事件/关系/删除 | 删除事件和相关资源之间的关系 |
> |  | **设置** |  |
...
> |  | **命名空间/专用端接Proxies** |  |
> | 操作 | 微软.服务总线/命名空间/私人端接连接Proxies/验证/操作 | 验证专用终结点连接代理 |
> | 操作 | 微软.服务总线/命名空间/私人端接连接Proxies/读取 | 获取专用终结点连接代理 |
> | 操作 | 微软.服务总线/命名空间/私人端接连接Proxies/写入 | 创建专用终结点连接代理 |
> | 操作 | 微软.服务总线/命名空间/私人端接连接Proxies/删除 | 删除专用终结点连接代理 |
> |  | **命名空间/提供商/微软.见解/诊断设置** |  |
...
> |  | **位置/长期保留管理实例备份** |  |
> | 操作 | 微软.Sql/位置/长期保留管理实例备份/读取 | 返回特定位置的托管实例 LTR 备份列表  |
> |  | **位置/长期保留管理实例/长期保留数据库/长期保留管理实例备份** |  |
> | 操作 | Microsoft.Sql/位置/长期保留管理实例/长期保留数据库/长期保留管理实例备份/读取 | 返回托管实例数据库的 LTR 备份列表 |
> | 操作 | Microsoft.Sql/位置/长期保留管理实例/长期保留数据库/长期保留管理实例备份/删除 | 删除托管实例数据库的 LTR 备份 |
> |  | **位置/长期保留管理实例/长期保留管理实例备份** |  |
> | 操作 | 微软.Sql/位置/长期保留管理实例/长期保留管理实例备份/读取 | 返回特定托管实例的托管实例 LTR 备份列表 |
> |  | **位置/长期保留服务器/长期保留备份** |  |
> | 操作 | Microsoft.Sql/locations/longTermRetentionServers/longTermRetentionBackups/read | 列出服务器上每个数据库的长期保留备份 |
> |  | **位置/长期保留服务器/长期保留数据库/长期保留备份** |  |
...
> |  | **位置/时区** |  |
> | 操作 | 微软.Sql/位置/时区/读取 | 按位置返回托管实例时区的列表。 |
> |  | **位置/透明数据加密Azure同步操作** |  |
> | 操作 | 微软.Sql/位置/透明数据加密Azure同步操作/读取 | 获取逻辑数据库透明数据加密的正在进行的操作 |
> |  | **位置/透明数据加密操作结果** |  |
> | 操作 | 微软.Sql/位置/透明数据加密操作结果/读取 | 获取逻辑数据库透明数据加密的正在进行的操作 |
> |  | **位置/用法** |  |
...
> | 操作 | 微软.Sql/服务器/禁用 AzureAD 唯一身份验证/操作 | 禁用逻辑服务器上仅禁用 Azure 活动目录身份验证 |
...
> | 操作 | Microsoft.Sql/servers/databases/transparentDataEncryption/read | 检索给定托管数据库上逻辑数据库透明数据加密的详细信息 |
...
> |  | **位置** |  |
> | 操作 | 微软.Sql虚拟计算机/位置/寄存器SqlVm候选/操作 | 注册 SQL Vm 候选 |
> |  | **位置/可用性组侦听操作结果** |  |
...
> |  | **存储帐户/本地用户** |  |
> | 操作 | 微软.存储/存储帐户/本地用户/删除 |  |
> | 操作 | 微软.存储/存储帐户/本地用户/列表键/操作 |  |
> | 操作 | 微软.存储/存储帐户/本地用户/读取 |  |
> | 操作 | 微软.存储/存储帐户/本地用户/读取 |  |
> | 操作 | 微软.存储/存储帐户/本地用户/写入 |  |
> |  | **存储帐户/管理策略** |  |
...
> |  | **存储同步服务/同步组/服务器终结点/提供商/微软.见解/指标定义** |  |
...
> |  | **操作** |  |
> | 操作 | Microsoft.Support/operations/read | 列出 Microsoft.支持资源提供程序上可用的所有操作 |
> |  | **操作状态** |  |
> | 操作 | Microsoft.Support/operationsstatus/read | 获取异步操作的状态 |
> |  | **services** |  |
> | 操作 | Microsoft.Support/services/read | 列出一个或所有可用的 Azure 服务，供支持 |
> |  | **服务/问题分类** |  |
> | 操作 | Microsoft.Support/services/problemClassifications/read | 列出 Azure 服务的一个或多个问题分类 |
> |  | **支持门票** |  |
> | 操作 | Microsoft.Support/supportTickets/read | 列出一个或多个支持票证 |
> | 操作 | Microsoft.Support/supportTickets/write | 允许创建和更新支持票证 |
> |  | **支持门票/通信** |  |
> | 操作 | Microsoft.Support/supportTickets/communications/read | 列出一个或多个支持票证通信 |
...
> |  | **站点/插槽/扩展** |  |
> | 操作 | 微软.web/网站/插槽/扩展/读取 | 获取 Web 应用插槽扩展。 |
> | 操作 | 微软.web/网站/插槽/扩展/写入 | 更新 Web 应用插槽扩展。 |
> |  | **站点/插槽/功能** |  |
