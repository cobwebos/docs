...
> | 操作 | ApiManagement/服务/网关/listKeys/action | 检索网关密钥。 |
> | 操作 | ApiManagement/服务/网关/regenerateKey/action | 重新生成指定的网关密钥 invalidationg 用它创建的任何令牌。 |
> | 操作 | ApiManagement/服务/网关/generateToken/action | 获取网关的共享访问授权令牌。 |
> |  | **服务/网关/api** |  |
...
> | 操作 | ApiManagement/namedValues/listValue/action | 获取由标识符指定的已命名值的机密。 |
> |  | **服务/networkstatus** |  |
...
> | 操作 | AutomationAccounts/privateEndpointConnectionProxies/read | 读取 Azure 自动化专用终结点连接代理 |
> | 操作 | AutomationAccounts/privateEndpointConnectionProxies/write | 创建 Azure 自动化专用终结点连接代理 |
> | 操作 | AutomationAccounts/privateEndpointConnectionProxies/validate/action | 验证专用终结点连接请求（groupId 验证） |
> | 操作 | AutomationAccounts/privateEndpointConnectionProxies/delete | 删除 Azure 自动化专用终结点连接代理 |
> |  | **automationAccounts/privateEndpointConnectionProxies/operationResults** |  |
> | 操作 | AutomationAccounts/privateEndpointConnectionProxies/operationResults/read | 获取 Azure 自动化专用终结点代理操作结果。 |
> |  | **automationAccounts/privateEndpointConnections** |  |
> | 操作 | AutomationAccounts/privateEndpointConnections/read | 获取 Azure 自动化专用终结点连接状态 |
> | 操作 | AutomationAccounts/privateEndpointConnections/write | 批准或拒绝 Azure 自动化专用终结点连接 |
> |  | **automationAccounts/privateLinkResources** |  |
> | 操作 | AutomationAccounts/privateLinkResources/read | 读取专用终结点的组信息 |
...
> |  | **cloudManifestFiles** |  |
> | 操作 | Test-azurestack/cloudManifestFiles/read | 获取云清单文件 |
> |  | **操作** |  |
...
> | 操作 | BatchAccounts/privateEndpointConnectionResults/read | 获取长时间运行的批处理帐户专用终结点连接操作的结果 |
> |  | **batchAccounts/privateEndpointConnections** |  |
> | 操作 | BatchAccounts/privateEndpointConnections/write | 更新 Batch 帐户上的现有专用终结点连接 |
> | 操作 | BatchAccounts/privateEndpointConnections/read | 获取专用终结点连接或列出 Batch 帐户上的专用终结点连接 |
> |  | **batchAccounts/privateLinkResources** |  |
> | 操作 | BatchAccounts/privateLinkResources/read | 获取专用链接资源的属性或列出 Batch 帐户上的专用链接资源 |
> |  | **机构** |  |
...
> |  | **配置文件/终结点/origingroups** |  |
> | 操作 | Microsoft Cdn/配置文件/终结点/origingroups/读取 |  |
> | 操作 | Microsoft Cdn/配置文件/终结点/origingroups/写入 |  |
> | 操作 | Microsoft Cdn/配置文件/终结点/origingroups/删除 |  |
...
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/recognizetext/action | 使用此接口可以获取“识别文本”操作的结果。 如果使用识别文本接口，则响应将包含一个名为 "操作-位置" 的字段。 "操作位置" 字段包含您必须用于 Get 识别文本操作结果操作的 URL。 |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/tag/action | 此操作生成与所提供图像内容相关的单词或标记列表。<br>计算机视觉 API 可以根据在图像中找到的对象、生物、风景或动作返回标记。<br>与类别不同，标记不是根据层次结构分类系统进行组织，而是对应于图像内容。<br>标记可能包含用于避免多义性或提供上下文的提示，例如标记 "cello" 可能伴随提示 "乐器"。<br>所有标记均为英文。 |
...
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/textoperations/read | 此接口用于获取“识别文本”操作的结果。 应从识别文本接口返回的<b>"操作位置"</b>字段中检索此接口的 URL。 |
> |  | **帐户/ContentModerator** |  |
...
> | DataAction | Microsoft.CognitiveServices/accounts/ContentModerator/teams/workflows/read | 获取团队中特定工作流的详细信息获取适用于你的团队的所有工作流 * |
...
> | DataAction | Cognitiveservices account/accounts/CustomVision/项目/导入/操作 | 导入项目。 |
> |  | **帐户/CustomVision/项目/导出** |  |
> | DataAction | Cognitiveservices account/accounts/CustomVision/项目/导出/读取 | 导出项目。 |
...
> |  | **accounts/CustomVision/项目/定型** |  |
> | DataAction | Cognitiveservices account/accounts/CustomVision/项目/定型/高级/操作 | 利用 PipelineConfiguration 和定型类型为培训排队项目。 |
> |  | **帐户/CustomVision/配额** |  |
...
> | 操作 | PrivateEndpointConnectionProxyAzureAsyncOperation/位置/读取 | 获取异步专用终结点连接代理操作的状态 |
> |  | **位置/privateEndpointConnectionProxyOperationResults** |  |
> | 操作 | PrivateEndpointConnectionProxyOperationResults/位置/读取 | 获取私有终结点连接代理操作的结果 |
> |  | **位置/发布者** |  |
...
> |  | **sharedVMExtensions** |  |
> | 操作 | SharedVMExtensions/read | 获取共享 VM 扩展的属性 |
> | 操作 | SharedVMExtensions/write | 创建新的共享 VM 扩展或更新现有 VM 扩展 |
> | 操作 | SharedVMExtensions/删除 | 删除共享 VM 扩展 |
> |  | **sharedVMExtensions/versions** |  |
> | 操作 | SharedVMExtensions/版本/读取 | 获取共享 VM 扩展版本的属性 |
> | 操作 | SharedVMExtensions/版本/写入 | 创建新的共享 VM 扩展版本，或更新现有的 |
> | 操作 | SharedVMExtensions/版本/删除 | 删除共享 VM 扩展版本 |
> |  | **sharedVMImages** |  |
...
> |  | **sshPublicKeys** |  |
> | 操作 | SshPublicKeys/read | 获取 SSH 公钥的属性 |
> | 操作 | SshPublicKeys/write | 创建新的 SSH 公钥，或更新现有的 SSH 公钥 |
> | 操作 | SshPublicKeys/删除 | 删除 SSH 公钥 |
> |  | **virtualMachines** |  |
...
> | 操作 | VirtualMachineScaleSetVirtualMachines/extensions/extension/read | 获取虚拟机规模集中虚拟机扩展的属性 |
> | 操作 | VirtualMachineScaleSetVirtualMachines/扩展/写入 | 为虚拟机规模集中的虚拟机创建新的扩展，或者更新现有的扩展 |
> | 操作 | VirtualMachineScaleSetVirtualMachines/扩展/删除 | 删除虚拟机规模集中虚拟机的扩展 |
> |  | **virtualMachines** |  |
...
> |  | **注册表/agentpools** |  |
> | 操作 | Microsoft.containerregistry/注册表/agentpools/listQueueStatus/action | 列出容器注册表的 agentpool 的所有队列状态。 |
> |  | **注册表/项目** |  |
...
> |  | **注册表/taskruns** |  |
> | 操作 | Microsoft.containerregistry/注册表/taskruns/listDetails/action | 列出容器注册表的 k 的所有详细信息。 |
> |  | **registries/tasks** |  |
...
> | 操作 | Databricks/工作区/refreshWorkspaces/action | 使用 URL 等新的详细信息刷新工作区 |
> |  | **工作区/dbWorkspaces** |  |
> | 操作 | Databricks/工作区/dbWorkspaces/写入 | 初始化 Databricks 工作区（仅限内部） |
...
> |  | **singleservers** |  |
> | 操作 | DBforPostgreSQL/singleservers/read | 返回服务器列表，或获取指定服务器的属性。 |
> | 操作 | DBforPostgreSQL/singleservers/write | 使用指定参数创建服务器，或更新指定服务器的属性或标记。 |
> | 操作 | DBforPostgreSQL/singleservers/delete | 删除现有服务器。 |
> |  | **singleservers/providers/diagnosticSettings/** |  |
> | 操作 | DBforPostgreSQL/singleservers/providers/diagnosticSettings/read | 获取资源的诊断设置 |
> | 操作 | DBforPostgreSQL/singleservers/providers/diagnosticSettings/write | 创建或更新资源的诊断设置 |
> |  | **singleservers/providers/logDefinitions/** |  |
> | 操作 | DBforPostgreSQL/singleservers/providers/logDefinitions/read | 获取 PostgreSQL 服务器的可用日志 |
> |  | **singleservers/providers/metricDefinitions/** |  |
> | 操作 | DBforPostgreSQL/singleservers/providers/metricDefinitions/read | 返回可用于数据库的指标类型 |
...
> | 操作 | IotHubs/privateEndpointConnectionsApproval/Action | 批准或拒绝专用终结点连接 |
> |  | **iotHubs/证书** |  |
...
> | 操作 | IotHubs/digitalTwinsLinks/Write |  |
> | 操作 | IotHubs/digitalTwinsLinks/Read |  |
> | 操作 | IotHubs/digitalTwinsLinks/Delete |  |
...
> | 操作 | IotHubs/privateEndpointConnectionProxies/validate/Action | 在创建过程中验证专用终结点连接代理输入 |
> | 操作 | IotHubs/privateEndpointConnectionProxies/Read | 获取指定的专用终结点连接代理的属性 |
> | 操作 | IotHubs/privateEndpointConnectionProxies/Write | 创建或更新专用终结点连接代理 |
> | 操作 | IotHubs/privateEndpointConnectionProxies/Delete | 删除现有的专用终结点连接代理 |
> |  | **iotHubs/privateEndpointConnectionProxies/operationResults** |  |
> | 操作 | IotHubs/privateEndpointConnectionProxies/operationResults/Read | 获取对专用终结点连接代理的异步操作的结果 |
> |  | **iotHubs/privateEndpointConnections** |  |
> | 操作 | IotHubs/privateEndpointConnections/Read | 获取指定的专用终结点连接的属性 |
> | 操作 | IotHubs/privateEndpointConnections/Delete | 删除现有的专用终结点连接 |
> | 操作 | IotHubs/privateEndpointConnections/Write | 创建或更新专用终结点连接 |
> |  | **iotHubs/privateEndpointConnections/operationResults** |  |
> | 操作 | IotHubs/privateEndpointConnections/operationResults/Read | 获取对专用终结点连接的异步操作的结果 |
> |  | **iotHubs/privateLinkResources** |  |
> | 操作 | IotHubs/privateLinkResources/Read | 获取 IotHub 的专用链接资源 |
...
> |  | **databaseAccounts/api/数据库** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/write | （已弃用。 请使用不带 "/apis/" 段的资源路径创建数据库。 仅适用于 API 类型：“sql”、“mongodb”、“gremlin”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取数据库或列出所有数据库。 仅适用于 API 类型：“sql”、“mongodb”、“gremlin”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/delete | （已弃用。 请使用不带 "/apis/" 段的资源路径删除数据库。 仅适用于 API 类型：“sql”、“mongodb”、“gremlin”。 |
> |  | **databaseAccounts/api/数据库/集合** |  |
...
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取集合或列出所有集合。 仅适用于 API 类型：“mongodb”。 |
...
> |  | **databaseAccounts/api/数据库/集合/operationResults** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/operationResults/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“mongodb”。 |
> |  | **databaseAccounts/api/数据库/集合/设置** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/settings/write | （已弃用。 请使用不带 "/apis/" 段的资源路径更新集合吞吐量。 仅适用于 API 类型：“mongodb”。 仅适用于设置类型：“throughput”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/settings/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取集合吞吐量。 仅适用于 API 类型：“mongodb”。 仅适用于设置类型：“throughput”。 |
> |  | **databaseAccounts/api/数据库/集合/settings/operationResults** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/settings/operationResults/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“mongodb”。 仅适用于设置类型：“throughput”。 |
> |  | **databaseAccounts/api/数据库/容器** |  |
...
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/delete | （已弃用。 请使用不带 "/apis/" 段的资源路径删除容器。 仅适用于 API 类型：“sql”。 |
> |  | **databaseAccounts/api/数据库/容器/operationResults** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/operationResults/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“sql”。 |
> |  | **databaseAccounts/api/数据库/容器/设置** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/settings/write | （已弃用。 请使用不带 "/apis/" 段的资源路径更新容器吞吐量。 仅适用于 API 类型：“sql”。 仅适用于设置类型：“throughput”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/settings/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取容器吞吐量。 仅适用于 API 类型：“sql”。 仅适用于设置类型：“throughput”。 |
> |  | **databaseAccounts/api/数据库/容器/settings/operationResults** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/settings/operationResults/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“sql”。 仅适用于设置类型：“throughput”。 |
> |  | **databaseAccounts/api/数据库/图形** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/write | （已弃用。 请使用不带 "/apis/" 段的资源路径）创建或更新关系图。 仅适用于 API 类型：“gremlin”。 |
...
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/delete | （已弃用。 请使用不带 "/apis/" 段的资源路径删除图形。 仅适用于 API 类型：“gremlin”。 |
> |  | **databaseAccounts/api/数据库/图形/operationResults** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/operationResults/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“gremlin”。 |
> |  | **databaseAccounts/api/数据库/图形/设置** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/settings/write | （已弃用。 请使用不带 "/apis/" 段的资源路径更新图形吞吐量。 仅适用于 API 类型：“gremlin”。 仅适用于设置类型：“throughput”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/settings/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取图形吞吐量。 仅适用于 API 类型：“gremlin”。 仅适用于设置类型：“throughput”。 |
> |  | **databaseAccounts/api/数据库/图形/设置/operationResults** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/settings/operationResults/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“gremlin”。 仅适用于设置类型：“throughput”。 |
> |  | **databaseAccounts/api/数据库/operationResults** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/operationResults/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“sql”、“mongodb”、“gremlin”。 |
> |  | **databaseAccounts/api/数据库/设置** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/settings/write | （已弃用。 请使用不带 "/apis/" 段的资源路径来更新数据库吞吐量。 仅适用于 API 类型：“sql”、“mongodb”、“gremlin”。 仅适用于设置类型：“throughput”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/settings/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取数据库吞吐量。 仅适用于 API 类型：“sql”、“mongodb”、“gremlin”。 仅适用于设置类型：“throughput”。 |
> |  | **databaseAccounts/api/数据库/settings/operationResults** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/databases/settings/operationResults/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“sql”、“mongodb”、“gremlin”。 仅适用于设置类型：“throughput”。 |
> |  | **databaseAccounts/api/大量** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/write | （已弃用。 请使用不带 "/apis/" 段的资源路径，创建密钥空间。 仅适用于 API 类型：“cassandra”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/read | （已弃用。 请使用不带 "/apis/" 段的资源路径，读取密钥空间或列出所有大量。 仅适用于 API 类型：“cassandra”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/delete | （已弃用。 请使用不带 "/apis/" 段的资源路径删除密钥空间。 仅适用于 API 类型：“cassandra”。 |
> |  | **databaseAccounts/api/大量/operationResults** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/operationResults/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“cassandra”。 |
> |  | **databaseAccounts/api/大量/settings** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/settings/write | （已弃用。 请使用不带 "/apis/" 段的资源路径更新密钥空间吞吐量。 仅适用于 API 类型：“cassandra”。 仅适用于设置类型：“throughput”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/settings/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取密钥空间吞吐量。 仅适用于 API 类型：“cassandra”。 仅适用于设置类型：“throughput”。 |
> |  | **databaseAccounts/api/大量/settings/operationResults** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/settings/operationResults/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“cassandra”。 仅适用于设置类型：“throughput”。 |
> |  | **databaseAccounts/api/大量/tables** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/write | （已弃用。 请使用不带 "/apis/" 段的资源路径创建或更新表。 仅适用于 API 类型：“cassandra”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取表或列出所有表。 仅适用于 API 类型：“cassandra”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/delete | （已弃用。 请使用不带 "/apis/" 段的资源路径删除表。 仅适用于 API 类型：“cassandra”。 |
> |  | **databaseAccounts/api/大量/tables/operationResults** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/operationResults/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“cassandra”。 |
> |  | **databaseAccounts/api/大量/tables/settings** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/settings/write | （已弃用。 请使用不带 "/apis/" 段的资源路径更新表吞吐量。 仅适用于 API 类型：“cassandra”。 仅适用于设置类型：“throughput”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/settings/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取表吞吐量。 仅适用于 API 类型：“cassandra”。 仅适用于设置类型：“throughput”。 |
> |  | **databaseAccounts/api/大量/tables/settings/operationResults** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/settings/operationResults/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“cassandra”。 仅适用于设置类型：“throughput”。 |
> |  | **databaseAccounts/api/tables** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/tables/write | （已弃用。 请使用不带 "/apis/" 段的资源路径创建或更新表。 仅适用于 API 类型：“table”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/tables/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取表或列出所有表。 仅适用于 API 类型：“table”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/tables/delete | （已弃用。 请使用不带 "/apis/" 段的资源路径删除表。 仅适用于 API 类型：“table”。 |
> |  | **databaseAccounts/api/tables/operationResults** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/tables/operationResults/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“table”。 |
> |  | **databaseAccounts/api/tables/settings** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/tables/settings/write | （已弃用。 请使用不带 "/apis/" 段的资源路径更新表吞吐量。 仅适用于 API 类型：“table”。 仅适用于设置类型：“throughput”。 |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/tables/settings/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取表吞吐量。 仅适用于 API 类型：“table”。 仅适用于设置类型：“throughput”。 |
> |  | **databaseAccounts/api/tables/settings/operationResults** |  |
> | 操作 | Microsoft.DocumentDB/databaseAccounts/apis/tables/settings/operationResults/read | （已弃用。 请使用不带 "/apis/" 段的资源路径读取异步操作的状态。 仅适用于 API 类型：“table”。 仅适用于设置类型：“throughput”。 |
...
> |  | **域/privateEndpointConnectionProxies** |  |
> | 操作 | EventGrid/域/privateEndpointConnectionProxies/验证/操作 | 验证域的 PrivateEndpointConnectionProxies |
> | 操作 | EventGrid/域/privateEndpointConnectionProxies/read | 读取域的 PrivateEndpointConnectionProxies |
> | 操作 | EventGrid/域/privateEndpointConnectionProxies/write | 为域写入 PrivateEndpointConnectionProxies |
> | 操作 | EventGrid/域/privateEndpointConnectionProxies/delete | 删除域的 PrivateEndpointConnectionProxies |
> |  | **域/privateEndpointConnections** |  |
> | 操作 | EventGrid/域/privateEndpointConnections/read | 读取域的 PrivateEndpointConnections |
> | 操作 | EventGrid/域/privateEndpointConnections/write | 为域写入 PrivateEndpointConnections |
> | 操作 | EventGrid/域/privateEndpointConnections/delete | 删除域的 PrivateEndpointConnections |
...
> |  | **partnerNamespaces** |  |
> | 操作 | EventGrid/partnerNamespaces/write | 创建或更新合作伙伴命名空间 |
> | 操作 | EventGrid/partnerNamespaces/read | 读取合作伙伴命名空间 |
> | 操作 | EventGrid/partnerNamespaces/delete | 删除合作伙伴命名空间 |
> | 操作 | EventGrid/partnerNamespaces/listKeys/action | 列出合作伙伴命名空间的键 |
> | 操作 | EventGrid/partnerNamespaces/regenerateKey/action | 为合作伙伴命名空间重新生成密钥 |
> |  | **partnerNamespaces/eventChannels** |  |
> | 操作 | EventGrid/partnerNamespaces/eventChannels/read | 读取事件通道 |
> | 操作 | EventGrid/partnerNamespaces/eventChannels/write | 创建或更新事件通道 |
> | 操作 | EventGrid/partnerNamespaces/eventChannels/delete | 删除事件通道 |
> |  | **partnerRegistrations** |  |
> | 操作 | EventGrid/partnerRegistrations/write | 创建或更新合作伙伴注册 |
> | 操作 | EventGrid/partnerRegistrations/read | 读取合作伙伴注册 |
> | 操作 | EventGrid/partnerRegistrations/delete | 删除合作伙伴注册 |
> |  | **partnerTopics** |  |
> | 操作 | EventGrid/partnerTopics/read | 读取合作伙伴主题 |
> | 操作 | EventGrid/partnerTopics/write | 创建或更新合作伙伴主题 |
> | 操作 | EventGrid/partnerTopics/delete | 删除合作伙伴主题 |
> | 操作 | EventGrid/partnerTopics/activate/action | 激活合作伙伴主题 |
> | 操作 | EventGrid/partnerTopics/停用/操作 | 停用合作伙伴主题 |
> |  | **限量** |  |
> | 操作 | EventGrid/sku/读取 | 读取事件网格资源的可用 Sku 定义 |
> |  | **systemTopics** |  |
> | 操作 | EventGrid/systemTopics/read | 阅读系统主题 |
> | 操作 | EventGrid/systemTopics/write | 创建或更新系统主题 |
> | 操作 | EventGrid/systemTopics/delete | 删除系统主题 |
> |  | **systemTopics/providers/diagnosticSettings/** |  |
...
> |  | **主题/privateEndpointConnectionProxies** |  |
> | 操作 | EventGrid/主题/privateEndpointConnectionProxies/验证/操作 | 验证 PrivateEndpointConnectionProxies 的主题 |
> | 操作 | EventGrid/主题/privateEndpointConnectionProxies/read | 阅读 PrivateEndpointConnectionProxies 主题 |
> | 操作 | EventGrid/主题/privateEndpointConnectionProxies/write | 为主题编写 PrivateEndpointConnectionProxies |
> | 操作 | EventGrid/主题/privateEndpointConnectionProxies/delete | 删除 PrivateEndpointConnectionProxies 主题 |
> |  | **主题/privateEndpointConnections** |  |
> | 操作 | EventGrid/主题/privateEndpointConnections/read | 阅读 PrivateEndpointConnections 主题 |
> | 操作 | EventGrid/主题/privateEndpointConnections/write | 为主题编写 PrivateEndpointConnections |
> | 操作 | EventGrid/主题/privateEndpointConnections/delete | 删除 PrivateEndpointConnections 主题 |
> |  | **主题/privateLinkResources** |  |
> | 操作 | EventGrid/主题/privateLinkResources/read | 阅读 PrivateLinkResources 主题 |
...
> |  | **命名空间/privateEndpointConnectionProxies** |  |
> | 操作 | Node.js/命名空间/privateEndpointConnectionProxies/验证/操作 | 验证专用终结点连接代理 |
> | 操作 | Node.js/命名空间/privateEndpointConnectionProxies/读取 | 获取专用终结点连接代理 |
> | 操作 | Node.js/命名空间/privateEndpointConnectionProxies/写入 | 创建专用终结点连接代理 |
> | 操作 | PrivateEndpointConnectionProxies/命名空间/删除 | 删除专用终结点连接代理 |
...
> | 操作类型 | Operation | 说明 |
> | --- | --- | --- |
> | 操作 | Microsoft.HybridCompute/register/action | 注册 HybridCompute 资源提供程序的订阅 |
...
> | 操作 | Microsoft Insights/PrivateLinkScopeOperationStatuses/Read | 读取专用链接作用域操作状态 |
> |  | **PrivateLinkScopes** |  |
...
> | 操作 | Kusto/集群/ListLanguageExtensions/action | 列出语言扩展。 |
> | 操作 | Kusto/集群/AddLanguageExtensions/action | 添加语言扩展。 |
> | 操作 | Kusto/集群/RemoveLanguageExtensions/action | 删除语言扩展。 |
...
> | 操作 | MachineLearningServices/工作区/privateEndpointConnectionsApproval/action | 批准或拒绝到 Microsoft.Network 提供程序的专用终结点资源的连接 |
> |  | **workspaces/computes** |  |
...
> | 操作 | MachineLearningServices/工作区/datadriftdetectors/delete | 删除机器学习服务工作区中的数据偏差检测程序 |
> |  | **工作区/数据集/已注册** |  |
...
> |  | **工作区/试验/运行** |  |
> | 操作 | MachineLearningServices/工作区/试验/运行/提交/操作 | 在机器学习服务工作区中创建或更新脚本运行 |
...
> |  | **工作区/标签** |  |
> | 操作 | MachineLearningServices/工作区/标记/导出/操作 | 在机器学习服务工作区中导出标记项目的标签 |
> |  | **工作区/标签/标签** |  |
> | 操作 | MachineLearningServices/工作区/标记/标签/读取 | 获取机器学习服务工作区中标记项目的标签 |
> | 操作 | MachineLearningServices/工作区/标记/标签/写入 | 在机器学习服务工作区中创建标签项目的标签 |
> | 操作 | MachineLearningServices/工作区/标记/标签/拒绝/操作 | 拒绝机器学习服务工作区中标记项目的标签 |
> |  | **工作区/标记/项目** |  |
> | 操作 | MachineLearningServices/工作区/标记/项目/读取 | 获取机器学习服务工作区中的标记项目 |
> | 操作 | MachineLearningServices/工作区/标记/项目/写入 | 在机器学习服务工作区中创建或更新标签项目 |
> | 操作 | MachineLearningServices/工作区/标记/项目/删除 | 删除机器学习服务工作区中的标签项目 |
> |  | **工作区/标记/项目/摘要** |  |
> | 操作 | MachineLearningServices/工作区/标记/项目/摘要/读取 | 在机器学习服务工作区中获取标记项目摘要 |
> |  | **工作区/元数据/项目** |  |
...
> |  | **工作区/服务/aks** |  |
> | 操作 | MachineLearningServices/工作区/服务/aks/写入 | 在机器学习服务工作区中创建或更新 AKS 服务 |
> | 操作 | MachineLearningServices/工作区/服务/aks/listkeys/action | 列出机器学习服务工作区中的 AKS services 的密钥 |
> | 操作 | MachineLearningServices/工作区/服务/aks/delete | 删除机器学习服务工作区中的 AKS services |
> | 操作 | MachineLearningServices/工作区/服务/aks/分数/操作 | 在机器学习服务工作区中评分 AKS 服务 |
...
> |  | **帐户/privateAtlases** |  |
> | 操作 | PrivateAtlases/accounts/删除 | 删除专用阿特拉斯 |
> | 操作 | PrivateAtlases/accounts/read | 获取专用阿特拉斯 |
> | 操作 | Microsoft Maps/accounts/privateAtlases/write | 创建或更新专用阿特拉斯 |
> |  | **运算符** |  |
...
> | 操作 | Microsoft Marketplace/privateStores/操作 | 更新 PrivateStore。 |
...
> |  | **privateStores** |  |
> | 操作 | Microsoft Marketplace/privateStores/写入 | 创建 PrivateStore。 |
> | 操作 | PrivateStores/删除 | 删除 PrivateStore。 |
> | 操作 | Microsoft Marketplace/privateStores/产品/服务/操作 | PrivateStore 中的更新提议。 |
> | 操作 | Microsoft Marketplace/privateStores/读取 | 读取 PrivateStores。 |
> |  | **privateStores/产品/服务** |  |
> | 操作 | Microsoft Marketplace/privateStores/产品/服务/写入 | 在 PrivateStore 中创建产品/服务。 |
> | 操作 | Microsoft Marketplace/privateStores/产品/服务/删除 | 删除 PrivateStore 中的产品/服务。 |
...
> | DataAction | MixedReality/ObjectUnderstandingAccounts/摄取/操作 | 创建模型引入作业 |
> |  | **ObjectUnderstandingAccounts/摄取** |  |
> | DataAction | MixedReality/ObjectUnderstandingAccounts/摄取/读取 | 获取模型引入作业状态 |
...
> | 操作 | NetAppAccounts/capacityPools/卷/恢复/操作 | 将卷还原到特定快照 |
> | 操作 | NetAppAccounts/capacityPools/卷/BreakReplication/action | 中断卷复制关系 |
...
> | 操作 | NetAppAccounts/capacityPools/卷/MountTargets/read | 读取装入目标资源。 |
> |  | **netAppAccounts/capacityPools/卷集/ReplicationStatus** |  |
> | 操作 | NetAppAccounts/capacityPools/卷/ReplicationStatus/read | 读取卷复制的状态。 |
...
> | 操作 | ApplicationRuleCollections/read | 获取 Azure 防火墙 ApplicationRuleCollection |
> | 操作 | ApplicationRuleCollections/write | CreatesOrUpdates Azure 防火墙 ApplicationRuleCollection |
> | 操作 | ApplicationRuleCollections/删除 | 删除 Azure 防火墙 ApplicationRuleCollection |
...
> | 操作 | BastionHosts/getShareableLinks/action | 返回堡垒子网中指定 VM 的可共享 URL（如果已创建其 URL） |
> | 操作 | BastionHosts/createShareableLinks/action | 为堡垒节点下的 VM 创建可共享的 URL 并返回 URL |
> | 操作 | BastionHosts/deleteShareableLinks/action | 删除堡垒节点下提供的 VM 的可共享 URL |
...
> |  | **dnszones/A** |  |
> | 操作 | Microsoft.Network/dnszones/A/read | 获取 JSON 格式的类型为 "A" 的记录集。 记录集包含记录列表以及 TTL、标记和 etag。 |
...
> | 操作 | Microsoft.Network/dnszones/PTR/delete | 从 DNS 区域中删除具有给定名称和类型 "PTR" 的记录集。 |
> |  | **dnszones/recordsets** |  |
...
> | 操作 | Microsoft.Network/dnszones/TXT/delete | 从 DNS 区域中删除具有给定名称和类型 "TXT" 的记录集。 |
...
> | 操作 | LoadBalancers/Loadbalancer.backendaddresspools/write | 创建负载均衡器后端地址池或更新现有的负载均衡器后端地址池 |
> | 操作 | LoadBalancers/Loadbalancer.backendaddresspools/delete | 删除负载均衡器后端地址池 |
...
> |  | **natGateways** |  |
> | 操作 | NatGateways/联接/操作 | 加入 NAT 网关 |
> |  | **natRuleCollections** |  |
> | 操作 | NatRuleCollections/read | 获取 Azure 防火墙 NatRuleCollection |
> | 操作 | NatRuleCollections/write | CreatesOrUpdates Azure 防火墙 NatRuleCollection |
> | 操作 | NatRuleCollections/删除 | 删除 Azure 防火墙 NatRuleCollection |
> |  | **networkExperimentProfiles** |  |
> | 操作 | NetworkExperimentProfiles/read | 获取 Internet 分析器配置文件 |
> | 操作 | NetworkExperimentProfiles/write | 创建或更新 Internet 分析器配置文件 |
> | 操作 | NetworkExperimentProfiles/删除 | 删除 Internet 分析器配置文件 |
> |  | **networkExperimentProfiles/试验** |  |
> | 操作 | NetworkExperimentProfiles/试验/读取 | 获取 Internet 分析器测试 |
> | 操作 | NetworkExperimentProfiles/试验/写入 | 创建或更新 Internet 分析器测试 |
> | 操作 | NetworkExperimentProfiles/试验/删除 | 删除 Internet 分析器测试 |
> | 操作 | NetworkExperimentProfiles/timeseries/action | 获取 Internet 分析器测试的时序 |
> | 操作 | NetworkExperimentProfiles/latencyScorecard/action | 获取 Internet 分析器测试的延迟记分卡 |
> |  | **networkExperimentProfiles/preconfiguredEndpoints** |  |
> | 操作 | NetworkExperimentProfiles/preconfiguredEndpoints/read | 获取 Internet 分析器配置文件的预配置终结点 |
...
> | 操作 | NetworkRuleCollections/read | 获取 Azure 防火墙 NetworkRuleCollection |
> | 操作 | NetworkRuleCollections/write | CreatesOrUpdates Azure 防火墙 NetworkRuleCollection |
> | 操作 | NetworkRuleCollections/删除 | 删除 Azure 防火墙 NetworkRuleCollection |
> |  | **networkSecurityGroups** |  |
...
> |  | **privateEndpoints** |  |
> | 操作 | PrivateEndpoints/pushPropertiesToResource/action | 从 NRP 客户端推送私有终结点属性更新的操作 |
...
> | 操作 | SecurityPartnerProviders/read | 获取 SecurityPartnerProvider |
> | 操作 | SecurityPartnerProviders/write | 创建 SecurityPartnerProvider 或更新现有的 SecurityPartnerProvider |
> | 操作 | SecurityPartnerProviders/验证/操作 | 验证 SecurityPartnerProvider |
> | 操作 | SecurityPartnerProviders/updateReferences/action | 更新 SecurityPartnerProvider 中的引用 |
> | 操作 | SecurityPartnerProviders/联接/操作 | 联接 SecurityPartnerProvider。 不可发出警报。 |
> | 操作 | SecurityPartnerProviders/删除 | 删除 SecurityPartnerProvider |
...
> | 操作 | VirtualNetworks/joinLoadBalancer/action | 将负载均衡器加入虚拟网络 |
...
> |  | **坏** |  |
> | 操作 | Microsoft.operationalinsights/群集/读取 | 获取群集 |
> | 操作 | Microsoft.operationalinsights/群集/写入 | 创建或更新群集 |
> | 操作 | Microsoft.operationalinsights/群集/删除 | 删除群集 |
> |  | **linkTargets** |  |
...
> |  | **workspace/query/ADFSSISIntegrationRuntimeLogs** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/ADFSSISIntegrationRuntimeLogs/读取 | 从 ADFSSISIntegrationRuntimeLogs 表中读取数据 |
> |  | **workspace/query/ADFSSISPackageEventMessageContext** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/ADFSSISPackageEventMessageContext/读取 | 从 ADFSSISPackageEventMessageContext 表中读取数据 |
> |  | **workspace/query/ADFSSISPackageEventMessages** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/ADFSSISPackageEventMessages/读取 | 从 ADFSSISPackageEventMessages 表中读取数据 |
> |  | **workspace/query/ADFSSISPackageExecutableStatistics** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/ADFSSISPackageExecutableStatistics/读取 | 从 ADFSSISPackageExecutableStatistics 表中读取数据 |
> |  | **workspace/query/ADFSSISPackageExecutionComponentPhases** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/ADFSSISPackageExecutionComponentPhases/读取 | 从 ADFSSISPackageExecutionComponentPhases 表中读取数据 |
> |  | **workspace/query/ADFSSISPackageExecutionDataStatistics** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/ADFSSISPackageExecutionDataStatistics/读取 | 从 ADFSSISPackageExecutionDataStatistics 表中读取数据 |
...
> |  | **workspace/query/AppAvailabilityResults** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/AppAvailabilityResults/读取 | 从 AppAvailabilityResults 表中读取数据 |
> |  | **workspace/query/AppBrowserTimings** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/AppBrowserTimings/读取 | 从 AppBrowserTimings 表中读取数据 |
...
> |  | **workspace/query/AppDependencies** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/AppDependencies/读取 | 从 AppDependencies 表中读取数据 |
> |  | **workspace/query/AppEvents** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/AppEvents/读取 | 从 AppEvents 表中读取数据 |
> |  | **workspace/query/AppExceptions** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/AppExceptions/读取 | 从 AppExceptions 表中读取数据 |
...
> |  | **workspace/query/AppMetrics** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/AppMetrics/读取 | 从 AppMetrics 表中读取数据 |
> |  | **workspace/query/AppPageViews** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/AppPageViews/读取 | 从 AppPageViews 表中读取数据 |
> |  | **workspace/query/AppPerformanceCounters** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/AppPerformanceCounters/读取 | 从 AppPerformanceCounters 表中读取数据 |
...
> |  | **workspace/query/AppRequests** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/AppRequests/读取 | 从 AppRequests 表中读取数据 |
...
> |  | **workspace/query/AppSystemEvents** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/AppSystemEvents/读取 | 从 AppSystemEvents 表中读取数据 |
> |  | **workspace/query/AppTraces** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/AppTraces/读取 | 从 AppTraces 表中读取数据 |
...
> | 操作 | Microsoft.operationalinsights/工作区/查询/AzureDevOpsAuditing/读取 | 从 AzureDevOpsAuditing 表中读取数据 |
> |  | **workspace/query/AzureDiagnostics** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/AzureDiagnostics/读取 | 从 AzureDiagnostics 表中读取数据 |
...
> |  | **workspace/query/SqlDataClassification** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/SqlDataClassification/读取 | 从 SqlDataClassification 表中读取数据 |
...
> |  | **workspace/query/WVDCheckpoints** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/WVDCheckpoints/读取 | 从 WVDCheckpoints 表中读取数据 |
> |  | **workspace/query/WVDConnections** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/WVDConnections/读取 | 从 WVDConnections 表中读取数据 |
> |  | **workspace/query/WVDErrors** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/WVDErrors/读取 | 从 WVDErrors 表中读取数据 |
> |  | **workspace/query/WVDFeeds** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/WVDFeeds/读取 | 从 WVDFeeds 表中读取数据 |
> |  | **workspace/query/WVDHostRegistrations** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/WVDHostRegistrations/读取 | 从 WVDHostRegistrations 表中读取数据 |
> |  | **workspace/query/WVDManagement** |  |
> | 操作 | Microsoft.operationalinsights/工作区/查询/WVDManagement/读取 | 从 WVDManagement 表中读取数据 |
> |  | **工作区/规则** |  |
...
> |  | **保管库/privateEndpointConnectionProxies** |  |
> | 操作 | Microsoft.recoveryservices/保管库/privateEndpointConnectionProxies/delete | 等候几分钟时间，并重试操作。 如果该问题仍然存在，请联系 Microsoft 支持部门。 |
> | 操作 | Microsoft.recoveryservices/保管库/privateEndpointConnectionProxies/read | 获取所有可保护的容器 |
> | 操作 | Microsoft.recoveryservices/保管库/privateEndpointConnectionProxies/验证/操作 | 获取所有可保护的容器 |
> | 操作 | Microsoft.recoveryservices/保管库/privateEndpointConnectionProxies/write | 获取所有可保护的容器 |
> |  | **保管库/privateEndpointConnectionProxies/operationsStatus** |  |
> | 操作 | Microsoft.recoveryservices/保管库/privateEndpointConnectionProxies/operationsStatus/read | 获取所有可保护的容器 |
> |  | **保管库/privateEndpointConnections** |  |
> | 操作 | Microsoft.recoveryservices/保管库/privateEndpointConnections/delete | 删除私有终结点请求。 此调用由备份管理员进行。 |
> | 操作 | Microsoft.recoveryservices/保管库/privateEndpointConnections/write | 批准或拒绝专用终结点请求。 此调用由备份管理员进行。 |
> |  | **保管库/privateEndpointConnections/operationsStatus** |  |
> | 操作 | Microsoft.recoveryservices/保管库/privateEndpointConnections/operationsStatus/read | 返回专用终结点连接的操作状态。 |
...
> |  | **命名空间/privateEndpointConnectionProxies** |  |
> | 操作 | Microsoft. 中继/命名空间/privateEndpointConnectionProxies/验证/操作 | 验证专用终结点连接代理 |
> | 操作 | Microsoft. 中继/命名空间/privateEndpointConnectionProxies/读取 | 获取专用终结点连接代理 |
> | 操作 | Microsoft. 中继/命名空间/privateEndpointConnectionProxies/写入 | 创建专用终结点连接代理 |
> | 操作 | Microsoft privateEndpointConnectionProxies/命名空间/删除 | 删除专用终结点连接代理 |
> |  | **命名空间/提供程序/diagnosticSettings/** |  |
...
> |  | **emergingissues** |  |
> | 操作 | ResourceHealth/emergingissues/read | 获取 Azure 服务的新兴问题 |
> |  | **事件** |  |
...
> | 操作 | Microsoft. Security/autoProvisioningSettings/write | 为订阅创建或更新安全自动预配设置 |
> |  | **complianceResults** |  |
...
> | 操作 | SecurityInsights/dataConnectorsCheckRequirements/action | 检查用户授权和许可证 |
> |  | **聚合** |  |
...
> |  | **命名空间/privateEndpointConnectionProxies** |  |
> | 操作 | Microsoft. 验证/命名空间/privateEndpointConnectionProxies/验证/操作 | 验证专用终结点连接代理 |
> | 操作 | PrivateEndpointConnectionProxies/命名空间/已读 | 获取专用终结点连接代理 |
> | 操作 | PrivateEndpointConnectionProxies/命名空间/写入 | 创建专用终结点连接代理 |
> | 操作 | PrivateEndpointConnectionProxies/命名空间/删除 | 删除专用终结点连接代理 |
> |  | **命名空间/提供程序/diagnosticSettings/** |  |
...
> |  | **位置/时区** |  |
> | 操作 | Sql-dmo/位置/时区/读取 | 按位置返回托管实例时区的列表。 |
...
> |  | **机构** |  |
> | 操作 | SqlVirtualMachine/位置/registerSqlVmCandidate/action | 注册 SQL Vm 候选项 |
...
> | 操作 | StorageAccounts/localUsers/delete |  |
> | 操作 | StorageAccounts/localusers/listKeys/action |  |
> | 操作 | StorageAccounts/localusers/read |  |
> | 操作 | StorageAccounts/localusers/read |  |
> | 操作 | StorageAccounts/localusers/write |  |
...
> |  | **运算符** |  |
> | 操作 | Microsoft.Support/operations/read | 列出 Microsoft 上所有可用的操作。支持资源提供程序 |
> |  | **operationsstatus** |  |
> | 操作 | Microsoft.Support/operationsstatus/read | 获取异步操作的状态 |
> |  | **services** |  |
> | 操作 | Microsoft.Support/services/read | 列出一个或所有可用于支持的 Azure 服务 |
