---
title: 使用 RBAC 和 Azure 门户添加或删除角色分配
...
要使用户成为 Azure 订阅的管理员，请在订阅范围为其分配[所有者](built-in-roles.md#owner)角色。 “所有者”角色授予用户对订阅中所有资源的完全访问权限，包括将访问权限授予其他用户的权限。 这些步骤与任何其他角色分配相同。
...
- [使用 Azure 管理组组织资源](../governance/management-groups/overview.md)
