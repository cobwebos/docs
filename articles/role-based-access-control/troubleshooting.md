...
- 如果尝试创建新的自定义角色时收到错误消息“角色定义超限。 无法创建更多的角色定义(代码:RoleDefinitionLimitExceeded)”，请删除未在使用的任何自定义角色。 Azure 支持最大**5000**租户中的自定义角色。 （对于专用云，例如 Azure 政府版、 Azure Germany 和 Azure 中国 21Vianet 限制为 2000年自定义角色。）
