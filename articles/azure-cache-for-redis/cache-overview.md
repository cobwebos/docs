...
description: 了解什么是 Azure Cache for Redis 及其常见用途，包括缓存端、内容缓存、用户会话缓存、作业和消息队列以及分布式事务。
author: yegu-ms
ms.author: yegu
ms.service: cache
ms.topic: overview
...
| Standard | 在 Microsoft 托管的双节点（主/辅）配置中提供复制的缓存，并提供高可用性 SLA (99.9%) |
