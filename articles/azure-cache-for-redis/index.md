---
title: Azure Cache for Redis 文档 - 教程和 API 参考
...
ms.locfileid: "74122556"
---
# <a name="azure-cache-for-redis-documentation"></a>“用于 Redis 的 Azure 缓存”文档

了解如何使用用于 Redis 的 Azure 缓存（安全的数据缓存和消息传送中转站，可让应用程序以较高的吞吐量、较低的延迟访问数据）。 教程、API 参考和其他文档介绍了如何从 Azure 上的任何应用程序使用用于 Redis 的 Azure 缓存。
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>了解用于 Redis 的 Azure 缓存高级层</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>通过 .NET 开始使用用于 Redis 的 Azure 缓存</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>通过 ASP.NET MVC 开始使用用于 Redis 的 Azure 缓存</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>通过 Node.js 开始使用用于 Redis 的 Azure 缓存</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>通过 Java 开始使用用于 Redis 的 Azure 缓存</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>通过 Python 开始使用用于 Redis 的 Azure 缓存</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3> 使用 Redis 缓存只读数据，从而优化 Web 应用程序</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>在用于 Redis 的 Azure 缓存中处理可变的部分数据</h3>
                    </div>
                </div>
            </div>
        </div>
...
**[更多交互式学习...](/learn/browse?products=azure-redis-cache)**
