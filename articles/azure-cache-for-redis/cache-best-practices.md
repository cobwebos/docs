 ...
 * **开发系统，使其能够处理连接信号**，[因为修补和故障转移](https://gist.github.com/JonCole/317fe03805d5802e31cfa37e646e419d#file-azureredis-patchingexplained-md)。

 * **配置[maxmemory-reserved 设置](cache-configure.md#maxmemory-policy-and-maxmemory-reserved)以提高**内存压力条件下的系统响应能力。  此设置对于编写繁重的工作负荷或在 Redis 中存储较大的值（100 KB 或更多）尤其重要。 建议从缓存大小的10% 开始，如果有写入繁重的负载，则增加百分比。
...
> redis-benchmark.exe-h yourcache.redis.cache.windows.net-a yourAccesskey-1024 t 
...
> redis-benchmark.exe-h yourcache.redis.cache.windows.net-a yourAccesskey-t 1000000-d 1024-P 50-c 50
