...
登录到 [Azure 门户](https://portal.azure.com/)。 使用 Azure 免费试用订阅无法执行本教程中所述的操作。 在创建群集之前，请转到你的个人资料，并将订阅更改为“即用即付”  。 有关详细信息，请参阅 [Azure 免费帐户](https://azure.microsoft.com/free/)。
