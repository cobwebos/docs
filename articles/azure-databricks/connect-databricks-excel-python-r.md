...
* 如果将 RStudio 用于桌面作为 IDE，还可以从[https://aka.ms/rclient/](https://aka.ms/rclient/)安装 Microsoft R Client。 
...
* 若要了解可以从中将数据导入 Azure Databricks 的源，请参阅[Azure Databricks 的数据源](/azure/databricks/data/data-sources/index)
