---
title: 快速入门 - 使用 Azure 资源管理器创建 Azure Databricks 工作区
...
* [创建 Azure Blob 存储帐户](../storage/common/storage-account-create.md)
