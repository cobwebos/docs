---
title: 快速入门：使用资源管理器模板在 Azure Databricks 上运行 Spark 作业 | Microsoft Docs
...
本快速入门介绍如何使用 Azure 资源管理器模板创建 Azure Databricks 工作区。 然后，使用该工作区创建 Apache Spark 群集并在 Databricks 群集上运行 Spark 作业。 有关 Azure Databricks 的详细信息，请参阅[什么是 Azure Databricks？](what-is-azure-databricks.md)
