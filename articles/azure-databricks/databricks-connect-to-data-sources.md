...
以下列表提供了 Azure 中可用于 Azure Databricks 的数据源。 有关可用于 Azure Databricks 的数据源的完整列表，请参阅 [Azure Databricks 的数据源](/azure/databricks/data/data-sources/index)。
...
- [Azure 事件中心](/azure/databricks/data/data-sources/azure/eventhubs-connector)

    此链接说明了如何通过 Azure Databricks 使用 [Azure 事件中心 Spark 连接器](https://github.com/Azure/azure-event-hubs-spark)访问 Azure 事件中心内的数据。

- [Azure SQL 数据仓库](/azure/databricks/data/data-sources/azure/sql-data-warehouse)
