...
登录到 [Azure 门户](https://portal.azure.com)。 不能使用 Azure 免费试用订阅执行本教程。 若要使用免费帐户创建 Azure Databricks 群集，请在创建群集前转到你的配置文件并将订阅更改为**即用即付**。 有关详细信息，请参阅 [Azure 免费帐户](https://azure.microsoft.com/free/)。
