...
## Azure SDK 2.8
Azure SDK 2.8 添加了将诊断数据发送到 [Application Insights](./application-insights/app-insights-cloudservices.md) 的功能，因此可让你更轻松地在应用程序以及系统和基础结构级别诊断问题。
...
“在发布到 Microsoft Azure 时使用 Microsoft Azure 存储帐户凭据更新诊断和缓存的开发存储连接字符串”复选框为你提供了使用发布过程中指定的 Azure 存储帐户更新任何开发存储帐户连接字符串的简便方法。
