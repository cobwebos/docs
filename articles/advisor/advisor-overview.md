...
您可以通过[Azure 门户](https://aka.ms/azureadvisordashboard)访问顾问。 登录到[门户](https://portal.azure.com)，在导航菜单中查找“顾问”，或在“所有服务”菜单中搜索它********。
...
* **卓越运营**：帮助您实现流程和工作流效率、资源可管理性和部署最佳实践。 . 有关详细信息，请参阅[顾问卓越运营建议](advisor-operational-excellence-recommendations.md)。
...
Advisor 提供应用程序网关、应用服务、可用性集、Azure 缓存、Azure 数据工厂、MySQL Azure 数据库、PostgreSQL Azure 数据库、MariaDB Azure 数据库、Azure ExpressRoute、Azure 宇宙数据库、Azure 公共数据库的建议IP 地址、SQL 数据仓库、SQL 服务器、存储帐户、流量管理器配置文件和虚拟机。
