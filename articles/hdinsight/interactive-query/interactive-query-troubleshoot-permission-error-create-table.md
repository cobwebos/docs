...
ms.locfileid: "68947729"
---
# <a name="scenario-permission-denied-error-when-trying-to-create-an-apache-hive-table-in-azure-hdinsight"></a>方案:尝试在 Azure HDInsight 中创建 Apache Hive 表时出现权限被拒绝错误
