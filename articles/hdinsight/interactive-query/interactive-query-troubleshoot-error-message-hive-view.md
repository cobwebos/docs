---
title: 未在 Apache 蜂巢视图中显示的错误消息 - Azure HDInsight
...
---
# <a name="scenario-query-error-message-not-displayed-in-apache-hive-view-in-azure-hdinsight"></a>方案：查询错误消息未显示在 Azure HDInsight 中的 Apache Hive 视图中
