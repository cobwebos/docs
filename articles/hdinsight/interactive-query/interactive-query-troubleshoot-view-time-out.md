---
title: Apache Hive 视图超时从查询结果 - Azure HDInsight
...
---
# <a name="scenario-apache-hive-view-times-out-when-fetching-a-query-result-in-azure-hdinsight"></a>方案：在 Azure HDInsight 中获取查询结果时，Apache Hive 视图超时
