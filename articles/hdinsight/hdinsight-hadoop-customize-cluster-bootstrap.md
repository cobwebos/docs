---
title: "使用 Bootstrap 自定义 HDInsight 群集 | Microsoft Docs"
...
可在[附录 A](#hdinsight-hadoop-customize-cluster-bootstrap.md/appx-a:-powershell-sample) 中找到完整的有效 PowerShell 脚本。
