...
若要安装针对 Visual Studio 的 Data Lake 工具，请按照[开始使用针对 Visual Studio 的 Data Lake 工具](hdinsight-hadoop-visual-studio-tools-get-started.md)中的步骤操作。
...
2. 在“新建项目”窗口中，展开“已安装” > “模板”，然后选择“Azure Data Lake”。 从模板列表中，选择“Storm 应用程序”。 在屏幕底部，输入 **WordCount** 作为应用程序名称。
    ...
    ![“新建项目”窗口的屏幕截图](./media/hdinsight-storm-develop-csharp-visual-studio-topology/new-project.png)
...
![组件的排列方式关系图](./media/hdinsight-storm-develop-csharp-visual-studio-topology/wordcount-topology.png)
