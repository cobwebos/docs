...
1. 在开发环境中安装 Java 开发人员工具包 (JDK) 7 或更高版本。 可以从 [Oracle](https://aka.ms/azure-jdks) 获取 Oracle JDK。 也可以使用[其他 Java 分发](https://openjdk.java.net/)。
...
3. 创建项目后，应有以下文件：
   ...
   * **Bolt.cs**：保留 Spout 所发出的数字计数的示例 Bolt。
