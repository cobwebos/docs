---
title: "将 HDInsight 群集升级到较新版本 — Azure | Microsoft Docs"
...
> [!NOTE]
> HDInsight 群集版本 3.2 和 3.3 接近停用日期。 有关支持的 HDInsight 版本的信息，请参阅 [HDInsight 组件版本](hdinsight-component-versioning.md#supported-hdinsight-versions)。
>
>
