---
title: "Hadoop 的高可用性 - Azure HDInsight | Microsoft Docs"
...
创建群集时，你可以指定节点的大小。 以下信息介绍了如何使用 [Azure 门户][preview-portal]、[Azure PowerShell][azure-powershell] 和 [Azure CLI][azure-cli] 指定大小：
