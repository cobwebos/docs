---
title: Apache Hadoop & secure tranfser 存储-Azure HDInsight
...
* 若要了解[Apache Hadoop MapReduce](https://hadoop.apache.org/docs/current/hadoop-mapreduce-client/hadoop-mapreduce-client-core/MapReduceTutorial.html)（一种编写处理 Hadoop 上的数据的程序）的方法，请参阅[将 Apache Hadoop MapReduce 与 HDInsight 配合使用][hdinsight-use-mapreduce]。
