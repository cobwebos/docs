...
2. 若要使用 **Hadoop** 命令运行示例 MapReduce 作业，请使用以下命令：
    ...
    这会启动 **wordcount** 类（包含在当前目录中的 **hadoop-mapreduce-examples.jar** 文件内）。 作为输入，它使用 wasbs://example/data/gutenberg/davinci.txt 文档，输出的存储位置：wasbs:///example/data/WordCountOutput。
