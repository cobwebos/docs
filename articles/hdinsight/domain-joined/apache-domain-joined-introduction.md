...
ESP HDInsight 群集使用常见的 Apache Ranger UI 来搜索审核日志。 在后端，Ranger 使用 [Apache Solr](http://hortonworks.com/apache/solr/) 来存储和搜索日志。
...
* [为 ESP HDInsight 群集配置 Hive 策略](apache-domain-joined-run-hive.md)
