...
> [!NOTE]
> 尽管也可以针对基于 Windows 的 HDInsight 群集使用本文档中的 Python 代码，但本文档中的步骤是专门针对基于 Linux 的群集编写的。
> 
> 
...
**mapper.py** 和 **reducer.py** 都必须位于群集的头节点上才能运行。 若要上传这些文件，最简单的方法就是使用 **scp**（如果使用的是 Windows 客户端，则是 **pscp**）。
