...
> [!IMPORTANT]
> Linux 是 HDInsight 3.4 或更高版本上使用的唯一操作系统。 有关详细信息，请参阅 [HDInsight 版本控制文章](hdinsight-component-versioning.md#hdi-version-32-and-33-nearing-deprecation-date)。

##<a name="notes-for-02282017-release-of-spark-21-on-hdinsight-36-preview"></a>Spark 2.1 on HDInsight 3.6 预览版 02/28/2017 发行说明
...
## <a name="notes-for-10262016-release-of-r-server-on-hdinsight"></a>R Server on HDInsight 10/26/2016 版发行说明
...
## <a name="notes-for-08302016-release-of-r-server-on-hdinsight"></a>HDInsight 上的 R Server 2016/08/30 版发行说明
...
## <a name="notes-for-08172016-release-of-r-server-on-hdinsight"></a>HDInsight 上的 R Server 2016/08/17 版发行说明
