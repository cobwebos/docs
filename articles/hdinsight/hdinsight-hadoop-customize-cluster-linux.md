...
还可以将脚本操作作为 HDInsight 应用程序发布到 Azure Marketplace。 有关 HDInsight 应用程序的详细信息，请参阅[将 HDInsight 应用程序发布到 Azure Marketplace 中](hdinsight-apps-publish-applications.md)。
...
可通过 Azure 资源管理器模板使用脚本操作。 请参阅 [https://azure.microsoft.com/resources/templates/hdinsight-linux-run-script-action/](https://azure.microsoft.com/resources/templates/hdinsight-linux-run-script-action/) 查看相关示例。
