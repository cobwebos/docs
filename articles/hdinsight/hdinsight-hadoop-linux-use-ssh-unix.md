---
title: 在 Linux、Unix 或 OS X 中将 SSH 密钥与基于 Linux 的 Hadoop 配合使用 | Microsoft Docs
...
> [!NOTE]
> 本文中的步骤假设你使用 Linux、Unix 或 OS X 客户端。如果已安装提供 `ssh` 和 `ssh-keygen` 的包（如 [Windows 上的 Bash Ubuntu](https://msdn.microsoft.com/commandline/wsl/about)），则可能会在基于 Windows 的客户端上执行这些步骤。
> 
