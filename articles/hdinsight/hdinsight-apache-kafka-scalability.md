...
2. 从“群集大小”边栏选项卡中，使用“每个辅助节点的磁盘数”字段来配置磁盘数。
...
* [Kafka 托管磁盘相关的 HDInsight 博客](https://azure.microsoft.com/blog/announcing-hdinsight-kafka-public-preview-with-azure-managed-disks)
