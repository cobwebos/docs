...
在本教程中，需将原始 CSV 数据文件导入 HDInsight 群集存储，然后在 Azure HDInsight 上使用 Apache Hive 转换数据。  前往下一教程，了解如何使用 Azure 数据工厂创建按需 HDInsight Hadoop 群集。
...
* [将 Apache Sqoop 与 HDInsight 配合使用](hadoop/apache-hadoop-use-sqoop-mac-linux.md)