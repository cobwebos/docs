...
1. 使用以下按钮登录到 Azure，并在 Azure 门户中打开模板。
    ...
    此项目的 GitHub 存储库中提供了 Azure 资源管理器模板 ([https://github.com/Azure-Samples/hdinsight-spark-scala-kafka-cosmosdb](https://github.com/Azure-Samples/hdinsight-spark-scala-kafka-cosmosdb))。
...
本文档中所述的示例代码位于 [https://github.com/Azure-Samples/hdinsight-spark-scala-kafka-cosmosdb](https://github.com/Azure-Samples/hdinsight-spark-scala-kafka-cosmosdb)。
