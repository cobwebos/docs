---
title: Azure HDInsight 中区域错误中的故障域不足
...
---
# <a name="scenario-cluster-creation-failed-due-to-not-sufficient-fault-domains-in-region-in-azure-hdinsight"></a>方案：由于 Azure HDInsight 中导致`not sufficient fault domains in region`群集创建失败
