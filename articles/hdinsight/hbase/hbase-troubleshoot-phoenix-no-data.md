---
title: HDP 升级& Azure HDInsight 中的 Apache 凤凰视图中没有数据
...
---
# <a name="scenario-hdp-upgrade-causes-no-data-in-apache-phoenix-views-in-azure-hdinsight"></a>方案：HDP 升级会导致 Azure HDInsight 中的 Apache 凤凰视图中没有数据
