...
---
# <a name="scenario-apache-phoenix-connectivity-issues-in-azure-hdinsight"></a>方案：Azure HDInsight 中的阿帕奇凤凰连接问题
...
活动动物园管理员节点的IP可以通过以下链接识别从Ambari UI到**HBase** > **快速链接** > **ZK（活动）** > **动物园管理员信息**。 根据需要更正 IP。

---

## <a name="cause-systemcatalog-table-offline"></a>原因：系统。目录表脱机
