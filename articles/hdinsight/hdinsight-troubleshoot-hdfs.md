---
title: "HDFS 故障排除 - Azure HDinsight | Microsoft Docs"
...
从命令行和应用程序代码而不是从 HDInsight 群集内的 WASB 或从 ADLS 进行访问。   
...
```
- 使用以下命令在 HDInsight 群集上运行已编译的 JAR（例如命名为 `java-unit-tests-1.0.jar`）：
