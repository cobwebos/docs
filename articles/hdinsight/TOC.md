...
## [交互式查询入门](hdinsight-hadoop-use-interactive-hive.md)
...
#### [使用 Azure PowerShell](hdinsight-hadoop-use-hive-powershell.md)
...
#### [使用 Azure PowerShell](hdinsight-hadoop-use-mapreduce-powershell.md)
...
#### [使用 Azure PowerShell](hdinsight-hadoop-use-pig-powershell.md)
...
## 使用交互式查询
### [使用 Zeppelin 运行 Hive 查询](hdinsight-connect-hive-zeppelin.md)
## 开发
...
### [使用 HDInsight VSCode 工具](hdinsight-for-vscode.md)
## 分析大数据
### [使用 Power Query 进行分析](hdinsight-connect-excel-power-query.md)
### [将 Power BI 连接到 Hadoop](hdinsight-connect-hive-power-bi.md)
...
#### [使用 Azure PowerShell 运行](hdinsight-hadoop-use-sqoop-powershell.md)
