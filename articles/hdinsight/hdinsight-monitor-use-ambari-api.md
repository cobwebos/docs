---
title: "使用 Ambari API 在 HDInsight 中监视 Hadoop 群集 | Microsoft Docs"
...
以下 Azure PowerShell 脚本可在 HDInsight 3.1 群集中获取 MapReduce 作业跟踪器信息  主要区别在于，我们从 YARN 服务（而非 MapReduce）中拉取这些详细信息。
...
以下 PowerShell 脚本可在 HDInsight 2.1 群集中获取 MapReduce 作业跟踪器信息：
