...
对于长时间运行的作业，请使用 Ambari UI 增加 `livy.server.session.timeout` 的值。 可使用 URL `https://<yourclustername>.azurehdinsight.net/#/main/services/LIVY/configs`从 Ambari UI 访问 Livy 配置。
