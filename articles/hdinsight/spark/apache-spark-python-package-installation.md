...
1. 在[Azure 门户](https://portal.azure.com/)中，导航到群集。  

2. 选择群集后，在左侧窗格中的 "**设置**" 下，选择 "**脚本操作**"。
...
6. 等待脚本完成。  **脚本操作**窗格将声明在执行脚本的过程中 **，当前群集操作完成后，可以提交新的脚本操作**。  可从 "Ambari UI**后台操作**" 窗口查看进度栏。
