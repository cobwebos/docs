...
1. 在“新建”  页面上，选择“分析” > “HDInsight”。  
    ...
    ![Azure 门户“创建 HDInsight”](./media/apache-spark-jupyter-spark-sql-use-portal/azure-portal-create-hdinsight-spark-cluster.png "Azure 门户中的 HDInsight")
...
1. 在“基本”下，提供以下值  ：
    ...
    |群集名称 | 为 HDInsight 群集提供一个名称。 用于本快速入门的群集名称为 **myspark2019**。|
