---
title: JDBC/ODBC &阿帕奇节俭框架的问题 - Azure HDInsight
...
---
# <a name="unable-to-download-large-data-sets-using-jdbcodbc-and-apache-thrift-software-framework-in-hdinsight"></a>无法使用 HDInsight 中的 JDBC/ODBC 和 Apache 节俭软件框架下载大型数据集
