---
title: 无法在 Azure HDInsight 中使用 JDBC/ODBC 和 Apache Thrift software framework 下载大型数据集
...
ms.locfileid: "68668880"
---
# <a name="scenario-unable-to-download-large-data-sets-using-jdbcodbc-and-apache-thrift-software-framework-in-azure-hdinsight"></a>方案:无法在 Azure HDInsight 中使用 JDBC/ODBC 和 Apache Thrift software framework 下载大型数据集
