---
title: 由于 Azure HDInsight 中的 "阻止跨源 API", Jupyter server 404 "找不到" 错误
...
ms.locfileid: "68664961"
---
# <a name="scenario-jupyter-server-404-not-found-error-due-to-blocking-cross-origin-api-in-azure-hdinsight"></a>方案:由于 Azure HDInsight 中的 "阻止跨源 API", Jupyter server 404 "找不到" 错误
