---
title: 将证书内容转换为基本 -64 - Azure HDInsight
...
---
# <a name="converting-service-principal-certificate-contents-to-base-64-encoded-string-format-in-hdinsight"></a>将服务主体证书内容转换为 HDInsight 中的 Base-64 编码字符串格式
