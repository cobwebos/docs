...
description: 群集节点在 Azure HDInsight 中的磁盘空间不足
...
ms.locfileid: "68842447"
---
# <a name="scenario-cluster-node-runs-out-of-disk-space-in-azure-hdinsight"></a>方案:群集节点在 Azure HDInsight 中的磁盘空间不足
