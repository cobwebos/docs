...
description: 在 Azure HDInsight 中排除 Apache Hadoop 群集节点磁盘空间问题。
...
---
# <a name="scenario-cluster-node-runs-out-of-disk-space-in-azure-hdinsight"></a>方案：Azure HDInsight 中的群集节点磁盘空间不足
