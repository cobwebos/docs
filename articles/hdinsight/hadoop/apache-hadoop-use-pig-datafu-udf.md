---
title: 在 HDInsight 上将 Apache DataFu 与 Pig 配合使用 — Azure | Microsoft Docs
description: Apache DataFu Pig 是适用于 Hadoop 上的 Pig 的库集合。 了解如何在 HDInsight 群集上通过 Pig 使用 DataFu。
services: hdinsight
documentationcenter: ''
author: Blackmist
manager: cgronlun
