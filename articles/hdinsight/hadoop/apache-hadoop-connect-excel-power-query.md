...
在 Excel 2016 中，Power Query 已集成到“获取并转换”部分下的“数据”功能区。 对于较旧的 Excel 版本，请从[Microsoft 下载中心][powerquery-download]下载并安装 Microsoft Power Query for Excel。
