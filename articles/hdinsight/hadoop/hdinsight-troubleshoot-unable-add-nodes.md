...
description: 解决无法将节点添加到 Azure HDInsight 中的 Apache Hadoop 群集的原因
...
---
# <a name="scenario-unable-to-add-nodes-to-azure-hdinsight-cluster"></a>方案：无法向 Azure HDInsight 群集添加节点
