...
1. 在计算机上打开 IntelliJ IDEA。 在“新建项目”对话框中，完成以下步骤：
   ...
   ![Intellij 创建新 scala 项目](./media/hdinsight-tools-for-intellij-with-hortonworks-sandbox/intellij-create-scala-project.png)
...
2. 请完成下列步骤：
    ...
    2. 在“主类名”框中，选择或输入主类名。 对于本文，该名称为 GroupByTest。
