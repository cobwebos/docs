...
下载并安装与你将在其中使用 ODBC 驱动程序的应用程序版本匹配的[Microsoft Hive ODBC 驱动程序](https://go.microsoft.com/fwlink/?LinkID=286698)版本。  对于本文，驱动程序用于 Office Excel。
