---
title: 来自 Azure HDInsight 群集的看门狗 BUG 软锁定 CPU 错误
description: 看门狗 BUG 软锁定 CPU 出现在 Azure HDInsight 群集的内核系统日志中
...
---
# <a name="scenario-watchdog-bug-soft-lockup---cpu-error-from-an-azure-hdinsight-cluster"></a>方案："看门狗：BUG：软锁定 - CPU"错误从 Azure HDInsight 群集
...
1. 按照与步骤 3 相同的步骤在 Head 节点上执行脚本操作，但这次使用节点类型：头。
