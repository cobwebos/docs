---
title: 学习使用阿帕奇 Hadoop 沙盒、仿真器 - Azure HDInsight
...
* [甲骨文虚拟盒](https://www.virtualbox.org/)。 从[此处](https://www.virtualbox.org/wiki/Downloads)下载并安装它。
...
1. 选择 Hortonworks 沙盒，依次单击“启动”****、“正常启动”****。 虚拟机完成启动过程后，显示登录说明。
    ...
    ![虚拟盒管理器正常启动](./media/apache-hadoop-emulator-get-started/virtualbox-normal-start.png)
...
1. 在“Hortonworks 沙盒”页的“开始”**** 步骤中，选择“查看高级选项”****。 使用此页上的信息通过 SSH 登录到沙盒。 使用提供的名称和密码。
   ...
   > [!NOTE]
   > 如果没有安装 SSH 客户端，则可以使用 虚拟机在 提供的基于 Web 的**http://localhost:4200/** SSH。
