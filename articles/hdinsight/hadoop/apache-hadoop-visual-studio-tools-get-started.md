...
* [Visual Studio](https://visualstudio.microsoft.com/downloads/)（2013 或更高版本）。  [Visual Studio Community Edition](https://visualstudio.microsoft.com/vs/community/) 是免费的。  此外，请参阅[安装 Visual Studio 2017](https://docs.microsoft.com/visualstudio/install/install-visual-studio)并[Visual Studio 2019](https://visualstudio.microsoft.com/downloads/)。
...
可以通过右键单击链接群集**HDInsight**然后选择**HDInsight 群集链接**。 输入**连接 Url**，**用户名**并**密码**，单击**下一步**然后**完成**，群集应列出成功的 HDInsight 节点下。

![屏幕截图的 Data Lake 工具的 Visual Studio 链接群集对话框](./media/apache-hadoop-visual-studio-tools-get-started/hdinsight-visual-studio-tools-link-cluster-dialog.png)

右键单击链接在群集上，选择**编辑**，用户无法更新群集信息。 请注意添加 HDInsight 群集目前仅支持 Hive。

![屏幕截图的 Data Lake Tools for Visual Studio 链接群集更新](./media/apache-hadoop-visual-studio-tools-get-started/hdinsight-visual-studio-tools-link-cluster-update.png)
