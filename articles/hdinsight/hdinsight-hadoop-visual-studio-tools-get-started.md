...
![用于 Visual Studio 的 Data Lake 工具服务器资源管理器列表链接资源](./media/hdinsight-hadoop-visual-studio-tools-get-started/hdinsight.visual.studio.tools.linked.resources.png "列表链接资源")
