---
title: 了解如何使用 Visual Studio Hadoop Tools for HDInsight | Microsoft Docs
...
* 安装有以下软件的工作站：
  ...
  * Visual Studio（以下版本之一）：
    ...
    * Visual Studio 2015 (Community/Enterprise)
    ...
    > [!NOTE]
    > 目前，适用于 Visual Studio 的 HDInsight 工具仅有英文版本。
    > 
    > 
...
5. 单击“提交”或“提交(高级)”。使用高级提交选项，你可以针对脚本配置“作业名称”、“参数”、“其他配置”和“状态目录”：
