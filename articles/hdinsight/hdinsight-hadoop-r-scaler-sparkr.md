...
- 有关 R Server on Azure HDInsight 的信息，请参阅 [R Server on Azure HDInsight 概述](hdinsight-hadoop-r-server-overview.md)和 [R Server on Azure HDInsight](hdinsight-hadoop-r-server-get-started.md)。
