...
如何在虚拟网络中部署 Azure HDInsight 并借助网络安全组进行安全保护：
...
**指南**：为连接到用于保护 Azure HDInsight 群集的子网的 NSG 启用网络安全组 （NSG） 流日志。 将 NSG 流日志记录到 Azure 存储帐户中，以生成流记录。 如果需要调查异常活动，则启用 Azure 网络观察程序数据包捕获。
...
HDInsight 中具有 Azure 活动目录域服务的企业安全包配置：https://docs.microsoft.com/azure/hdinsight/domain-joined/apache-domain-joined-configure-using-azure-adds
...
尽管可以通过 Azure 资源图发现经典 Azure 资源，但强烈建议今后创建和使用 Azure 资源管理器资源。
