---
title: "将 Ambari Tez 视图与 HDInsight 配合使用 | Microsoft Docs"
...
3. 在 Hive 视图加载以后，将以下内容粘贴到查询编辑器中，然后单击“执行”。
   
        select market, state, country from hivesampletable where deviceplatform='Android' group by market, country, state;
   
    完成该作业后，将看到输出显示在“查询处理结果”部分。 结果应如下所示：
...
8. 请注意，此时页面顶部会存在与顶点和任务相关的链接。
   ...
   * “源和接收器”显示此顶点的数据源和接收器。
     ...
     > 
     > 
9. 选择“任务”，然后选择名为 **00_000000** 的项。 此时会显示此任务的“任务详细信息”。 在此屏幕中，可以查看“任务计数器”和“任务尝试”。
