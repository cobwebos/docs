...
> [!IMPORTANT]
> 虽然可以在基于 Linux 的 HDInsight 群集上使用 Hive 命令，但仍应考虑使用 Beeline。 Beeline 是一个较新的客户端，与 Hive 搭配使用，随附在 HDInsight 群集中。 有关使用 Beeline 的详细信息，请参阅[通过 Beeline 将 Hive 与 HDInsight 中的 Hadoop 配合使用](hdinsight-hadoop-use-hive-beeline.md)。
> 
> 
