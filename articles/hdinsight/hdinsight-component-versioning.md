---
title: "HDInsight 群集提供了哪些不同的组件？ | Microsoft 文档"
...
---
# <a name="what-are-the-different-hadoop-components-available-with-hdinsight"></a>可与 HDInsight 使用的不同 Hadoop 组件有哪些？
...
##<a name="hdinsight-deprecation-on-windows"></a>HDInsight 在 Windows 上弃用
