...
4. 保存 **pom.xml** 文件。
5. 在 **hbaseapp**录中创建名为 conf 的新目录。 在 **conf** 目录中，创建一个名为 **hbase-site.xml** 的文件。 将以下内容用作该文件的内容：
...
4. 在 **hbaseapp\src\main\java\com\microsoft\examples** 目录中，创建名为 **SearchByEmail.java** 的新文件。 将以下代码用作本文件的内容：
