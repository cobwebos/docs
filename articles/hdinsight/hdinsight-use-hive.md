...
* __Spark__：Apache Spark 提供内置的功能用于使用 Hive。 有关详细信息，请参阅 [Spark on HDInsight 入门](hdinsight-apache-spark-jupyter-spark-sql.md)文档。

* __HBase__：HiveQL 可用于查询 HBase 中存储的数据。 有关详细信息，请参阅 [HBase on HDInsight 入门](hdinsight-hbase-tutorial-get-started-linux.md)文档。

## <a name="how-to-use-hive"></a>如何使用 Hive

使用下表来了解如何在 HDInsight 中使用 Hive：

| **使用此方法**，如果想要... | ...**交互式** shell | ...**批处理** | ...使用此**群集操作系统** | ...从此**客户端操作系统** |
|:--- |:---:|:---:|:--- |:--- |
| [Hive 视图](hdinsight-hadoop-use-hive-ambari-view.md) |✔ |✔ |Linux |任何（基于浏览器） |
| [Beeline 客户端](hdinsight-hadoop-use-hive-beeline.md) |✔ |✔ |Linux |Linux、Unix、Mac OS X 或 Windows |
...
* [将 Python 用户定义函数与 Hive 和 Pig 配合使用](hdinsight-python.md)
