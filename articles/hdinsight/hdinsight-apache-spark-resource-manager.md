---
title: "使用 Resource Manager 向 HDInsight 中的 Apache Spark 群集分配资源 | Microsoft Docs"
...
---
# <a name="manage-resources-for-the-apache-spark-cluster-on-hdinsight-linux"></a>管理 HDInsight Linux 上 Apache Spark 群集的资源
...
2. 在 Spark 群集边栏选项卡中，单击“仪表板”。 出现提示时，输入 Spark 群集的管理员凭据。
    ...
    ![启动 Ambari](./media/hdinsight-apache-spark-resource-manager/hdispark.cluster.launch.dashboard.png "Start Resource Manager")
...
3. 单击“保存”以保存配置更改。 在页面顶部，系统将提示是否重新启动所有受影响的服务。 请单击“重启”。
...
1. 如上所示启动 Ambari Web UI。 在左侧导航窗格中，依次单击“Jupyter”、“服务操作”和“全部重启”。 随后将在所有头节点上启动 Jupyter 服务。
   
    ![重新启动 Jupyter](./media/hdinsight-apache-spark-resource-manager/restart-jupyter.png "Restart Jupyter")
