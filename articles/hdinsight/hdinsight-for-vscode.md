...
> [!NOTE]
>
>你可以使用 Spark/Hive:列出群集”检查已链接的群集。
>
...
> [!NOTE]
> 
>可以在 Azure 门户中获取存储帐户的访问密钥。 有关信息，请参阅[查看和复制访问密钥](https://docs.microsoft.com/azure/storage/common/storage-account-manage#access-keys)。
