...
本指南将演示如何使用 Azure 队列服务执行常见方案。这些示例通过使用 Windows SDK for PHP 中的类编写。涉及的方案包括**插入**、**查看**、**获取**和**删除**队列消息以及**创建和删除队列**。有关队列的更多信息，请参见[后续步骤][后续步骤]一节。
...
## <a id="create-account"></a>创建 Azure 存储帐户

[WACOM.INCLUDE [create-storage-account](../includes/create-storage-account.md)]

## <a id="create-app"></a>创建 PHP 应用程序
...
## <a id="configure-app"></a>配置你的应用程序以访问队列服务
...
## <a id="connection-string"></a>设置 Azure 存储连接
...
## <a id="peek-message"></a>如何：扫视下一条消息
...
## <a id="dequeue-message"></a>如何：取消对下一条消息的排队
...
## <a id="change-message"></a>如何：更改已排队消息的内容
...
## <a id="additional-options"></a>用于取消对消息进行排队的其他选项
...
## <a id="get-queue-length"></a>如何：获取队列长度
