...
如果有 1 到 10 个标准作业集合，会按照一个标准计费单位向你计费。 如果有 11 到 20 个标准作业集合，会按照两个标准计费单位向你计费。 如果有 21 到 30 个标准作业集合，会按照三个标准计费单位向你计费，依次类推。
...
如果有 1 到 10,000 个高级作业集合，会按照一个 P10 高级计费单位计费。 如果有 10,001 到 20,000 个高级作业集合，会按照 2 个 P10 高级计费单位计费，依此类推。
...
作业集合始终处于活动状态，除非整个订阅由于计费问题而进入某种临时禁用状态。 要确保作业集合不被计费，只能删除该作业集合。
