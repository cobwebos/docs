...
如果有一个标准作业集合和一个高级作业集合，则根据一个标准计费单位*和*一个高级计费单位计费。 计划程序服务根据设置为标准或高级的基于活动作业集合计费；接下来的两个部分进一步对此做出解释。
...
如果有 1 到 10 个标准作业集合，则会按照 1 个标准计费单位计费。 如果你有 11 到 20 个标准作业集合，会按照 2 个标准计费单位向你计费。 如果你有 21 到 30 个标准作业集合，会按照 3 个标准计费单位向你计费，依次类推。
