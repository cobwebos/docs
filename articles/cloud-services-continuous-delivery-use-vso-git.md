...
If you want to create a web site, choose the ASP.NET Web Application project template, and then choose MVC. See [Get started with Azure and ASP.NET](http://www.windowsazure.cn/zh-cn/documentation/articles/web-sites-dotnet-get-started/).
...
<br/>
For cloud services, if the [storage account](http://www.windowsazure.cn/zh-cn/documentation/articles/storage-whatis-account) property is left blank, Azure searches for one. If there is a storage
