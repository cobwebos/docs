...
* ILB 应用服务环境使用的 ILB 地址。 此信息位于 **"设置** > **IP 地址**"下的"应用服务环境"门户中：
...
1. 在 Azure 门户中，转到**新** > **网络** > **应用程序网关**。

2. 在“基本信息”区域中****：

   a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 对于“名称”，输入应用程序网关的名称****。

   b.保留“数据库类型”设置，即设置为“共享”。 对于“层级”，选择“WAF”********。

   c. 对于“订阅”，选择应用服务环境虚拟网络使用的相同订阅****。

   d.单击“下一步”。 对于“资源组”，创建或选择资源组****。

   e.在“新建 MySQL 数据库”边栏选项卡中，接受法律条款，然后单击“确定”。 对于“位置”，选择应用服务环境虚拟网络使用的位置****。

   ![新应用程序网关创建基本信息][2]

3. 在“设置”区域中****：

   a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 对于“虚拟网络”，选择应用服务环境虚拟网络****。

   b.保留“数据库类型”设置，即设置为“共享”。 对于“子网”，选择需要将应用程序网关部署到的子网****。 请勿使用 GatewaySubnet，因为它会阻止创建 VPN 网关。

   c. 对于“IP 地址类型”，选择“公共”********。

   d.单击“下一步”。 对于“公共 IP 地址”，选择一个公共 IP 地址****。 如果没有，请立即创建一个。

   e.在“新建 MySQL 数据库”边栏选项卡中，接受法律条款，然后单击“确定”。 对于“协议”，选择“HTTP”或“HTTPS”************。 如果要配置 HTTPS，需要提供 PFX 证书。
