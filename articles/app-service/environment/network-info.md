...
在端口扫描上, 有2个其他端口可显示为打开状态, 7654 和1221。 它们使用 IP 地址进行回复, 而不是更多。 如果需要, 可以将其阻止。 
...
可以通过服务终结点将多租户服务的访问权限限制给一组 Azure 虚拟网络和子网。 有关服务终结点的详细信息, 请参阅[虚拟网络服务终结点][serviceendpoints]文档。 
