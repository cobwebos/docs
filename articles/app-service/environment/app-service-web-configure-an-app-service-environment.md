---
title: 配置 ASE v1
description: 应用服务环境 v1 的配置、管理和监视。 此文档仅为使用旧版 v1 ASE 的客户提供。
author: ccompy
...
**设置** > **属性**：打开 ASE 边栏选项卡时，"**设置**" 边栏选项卡会自动打开。 位于顶部的是“属性”****。 此处显示了许多与“基本信息”**** 重复的项，但“虚拟 IP 地址”**** 和“出站 IP 地址”**** 是非常有用的项。
...
**设置** > **前端池** / **辅助角色池**：除了提供控制来完全缩放资源池以外，每个资源池的边栏选项卡还提供仅查看该资源池上的信息的能力。  
...
若要在特定资源池中使用手动或自动缩放功能，请根据需要切换到 "**设置** > **前端池** / "**工作线程池**。 然后打开要更改的池。 请参阅 "**设置** > "**Scale Out**或 "**设置** > **"。** 通过“扩大”**** 边栏选项卡可控制实例数量。 使用“增加”**** 可控制资源大小。  
