...
6. 在 **Facebook 登录**下，单击“设置”，在 **Facebook 登录**下左侧导航栏中选择“设置”。
7. 将应用程序的“重定向 URI”添加到“有效的 OAuth 重定向 URI”中，然后单击“保存更改”。
   ...
   > 
   > 
8. 在左侧导航栏中，单击“设置” > “基本”。 在“应用密钥”字段中，单击“显示”，在收到请求时提供密码，并记下“应用程序 ID”和“应用密钥”的值。 稍后会在 Azure 中使用这些值来配置应用程序。
