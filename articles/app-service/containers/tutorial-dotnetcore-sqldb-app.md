...
使用 [`az sql db create`](/cli/azure/sql/db?view=azure-cli-latest#az_sql_db_create) 命令在服务器中创建 [S0 性能级别](../../sql-database/sql-database-service-tiers-dtu.md)的数据库。
