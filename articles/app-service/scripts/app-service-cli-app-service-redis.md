...
| [`az redis create`](/cli/azure/redis?view=azure-cli-latest#az-redis-create) | 创建新的 Redis 缓存实例。 |
| [`az redis list-keys`](/cli/azure/redis?view=azure-cli-latest#az-redis-list-keys) | 列出 Redis 缓存实例的访问密钥。 |
