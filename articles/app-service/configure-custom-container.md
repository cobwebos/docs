...
本指南提供有关应用服务中 Linux 应用的容器化的重要概念和说明。 如果你从未使用过 Azure App Service，请先按照 [自定义容器快速入门](quickstart-custom-container.md?pivots=container-linux) 和 [教程](tutorial-custom-container.md?pivots=container-linux) 操作。 还有 [多容器应用快速入门](quickstart-multi-container.md) 和 [教程](tutorial-multi-container-app.md)。
...
> [!NOTE]
> 你还可以 [配置自己的持久存储](configure-connect-to-azure-storage.md?pivots=platform-linux)。
