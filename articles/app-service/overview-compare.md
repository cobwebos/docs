---
title: 比较应用服务、VM、Service Fabric 和云服务 - Azure | Microsoft Docs
...
| Feature | 应用服务（Web 应用） | 云服务（web 角色） | 虚拟机 | Service Fabric | 说明 |
| --- | --- | --- | --- | --- | --- |
...
| 托管多层体系结构的中间层 |X |X |X |X |应用服务 Web 应用可轻松托管 REST API 中间层，而 [WebJobs](https://go.microsoft.com/fwlink/?linkid=390226) 功能可托管后台处理作业。 可在专用网站中运行 WebJobs，实现层的独立可扩展性。 |
...
* 快速创建[移动应用](../app-service-mobile/app-service-mobile-value-prop.md)或 API 应用，以便在 Azure 全球分布的某个数据中心内托管 HTTP Web 服务。
* 迁移现有服务或创建新的服务。
