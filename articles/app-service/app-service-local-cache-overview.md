...
建议将本地缓存与[过渡环境](../app-service/web-sites-staged-publishing.md)功能结合在一起使用。
...
* 针对“过渡”槽来测试站点。  
* 准备就绪以后，在过渡槽和生产槽之间执行[交换操作](../app-service/web-sites-staged-publishing.md#Swap)。  
