...
本主题说明如何将 Azure App Service 或 Azure Functions 配置为使用 AAD 来支持个人 Microsoft 帐户登录名。
...
1. 在“身份验证提供程序”  下，选择“Azure Active Directory”  。 在“管理模式”下，选择“高级”。   粘贴前面获取的应用程序（客户端）ID 和客户端机密。 对于“颁发者 URL”字段，请使用 **`https://login.microsoftonline.com/9188040d-6c67-4c5b-b112-36a304b66dad/v2.0`** 。 
1. 选择“确定”  。
