...
* 在 Azure 门户中，使用“应用设置”  。
  ...
  4. 中转到你的**Kudu 控制台**（`https://*yourwebsitename*.scm.azurewebsites.net`）。
...
1.  中转到你的**Kudu 控制台**（`https://*yourwebsitename*.scm.azurewebsites.net/DebugConsole`）。
...
应用服务没有内置电子邮件功能。 有关从应用发送电子邮件的一些良好替代方案，请参阅此 [Stack Overflow 讨论](https://stackoverflow.com/questions/17666161/sending-email-from-azure)。
