...
请求消息正文必须包含 **amqp-value** 节，其中包含具有以下条目的**映射**。  
...
响应消息正文必须包含 **amqp-value** 节，其中包含具有以下条目的**映射**。  
...
**correlation-filter** 映射必须包含以下条目之一。  
...
|receiver-settle-mode|ubyte|是|AMQP 核心 v1.0 中指定的接收方结算模式。|  
