...
ms.locfileid: "83650953"
---
# <a name="integrate-azure-service-bus-with-azure-private-link"></a>将 Azure 服务总线与 Azure 专用链接集成
...
4. 在“批准连接”页上输入可选“注释”，然后选择“是”。   如果选择“否”，则不会执行任何操作。 
...
1. 如果你要拒绝任何专用终结点连接（不管是挂起的请求还是已批准的现有连接），请选择该终结点连接并单击“拒绝”按钮。
...
1. 指定“虚拟网络”和“子网”。  必须选择要在其上部署专用终结点的虚拟网络。
2. 指定“公共 IP”资源。
