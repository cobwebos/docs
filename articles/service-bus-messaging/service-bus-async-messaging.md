...
description: 了解 Azure 服务总线如何通过存储和转发机制（队列、主题和订阅）支持异步。
...
---
# <a name="asynchronous-messaging-patterns-and-high-availability"></a>异步消息模式和高可用性
...
在这些情况下，客户端应用程序将生成 [System.TimeoutException][System.TimeoutException] 或 [MessagingException][MessagingException] 异常。 服务总线通过自动客户端重试逻辑来缓解该问题。 一旦重试周期用尽并且邮件未送达，你就可以使用本文中提到的有关[处理中断和灾难][handling outages and disasters]的其他文章进行探索。

## <a name="next-steps"></a>后续步骤
现在，你已了解有关服务总线中的异步消息传送的基础知识，请参阅有关[处理中断和灾难][handling outages and disasters]的更多详细信息。
