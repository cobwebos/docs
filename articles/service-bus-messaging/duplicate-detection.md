...
> [!NOTE]
> 如果已启用重复侦测，未设置会话 ID 或分区键的消息 ID 用作分区键。 如果还未设置消息 ID，.NET 和 AMQP 库自动生成的消息的消息 ID。 有关详细信息，请参阅[使用的分区键](service-bus-partitioning.md#use-of-partition-keys)。
