---
title: "如何通过 Node.js 使用服务总线主题 | Microsoft 文档"
...
创建一个空的 Node.js 应用程序。 有关创建 Node.js 应用程序的说明，请参阅[创建 Node.js 应用程序并部署到 Azure 网站]、使用 Windows PowerShell 创建并部署 [Node.js 云服务][Node.js 云服务]，或者使用 WebMatrix 创建并部署 Node.js 网站。
...
主题和订阅具有持久性，必须通过 [Azure 经典门户][Azure 经典门户]或以编程方式显式删除。
...
* 请访问 GitHub 上的 [Azure SDK for Node][Azure SDK for Node] 存储库。
...
[创建 Node.js 应用程序并部署到 Azure 网站]: ../app-service-web/web-sites-nodejs-develop-deploy-mac.md
