...
1. 若要仅允许从指定的 IP 地址进行访问，请选择 "**所选网络**" 选项（如果尚未选择）。 在“防火墙”部分中执行以下步骤：
    ...
    3. 指定是否要“允许受信任的 Microsoft 服务绕过此防火墙”。 
        ...
        ![防火墙 - 选中了“所有网络”选项](./media/service-bus-ip-filtering/firewall-selected-networks-trusted-access-disabled.png)
