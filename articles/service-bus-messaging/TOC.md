# 概述
## [什么是服务总线消息传送？](service-bus-queues-topics-subscriptions.md)
...
### [将 AMQP 与 .NET API 配合使用](service-bus-dotnet-advanced-message-queuing.md)
### [将 AMQP 与分区队列和主题配合使用](service-bus-partitioned-queues-and-topics-amqp-overview.md)
