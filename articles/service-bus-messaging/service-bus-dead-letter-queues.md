...
description: 介绍 Azure 服务总线中的死信队列。 服务总线队列和主题订阅提供称为死信队列的辅助子队列。
...
如果使用的是 .NET SDK，则可以使用 SubscriptionClient. FormatDeadLetterPath （）方法获取死信队列的路径。 此方法将主题名称/订阅名称和后缀与 **/$DeadLetterQueue**。
