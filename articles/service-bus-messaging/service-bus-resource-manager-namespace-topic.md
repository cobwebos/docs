---
title: "使用 Azure Resource Manager 模板创建 Azure 服务总线命名空间主题订阅 | Microsoft Docs"
...
本文介绍如何使用 Azure Resource Manager 模板创建服务总线命名空间，并且该命名空间内包含主题和订阅。 将了解如何定义要部署的资源以及如何定义执行部署时指定的参数。 可将此模板用于自己的部署，或自定义此模板以满足要求
