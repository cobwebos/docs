...
---
# <a name="manage-service-bus-with-powershell"></a>使用 PowerShell 管理服务总线
...
两个 PowerShell cmdlet 支持服务总线命名空间操作。 可以使用 [Get-AzureSBNamespace][Get-AzureSBNamespace] 和 [New-AzureSBNamespace][New-AzureSBNamespace]，而不是使用 .NET SDK API。
