...
[SQL Database](sql-database-technical-overview.md) 采用基本、标准和高级服务层。这三个服务层都提供 99.99% 的运行时间 [SLA](http://azure.microsoft.com/support/legal/sla/) 和可预测的性能、灵活的业务连续性选项、安全功能和按小时计费。由于每个服务层包含多个性能级别，你可以灵活选择最适合工作负载需求的级别。如果你需要向上或向下缩放，可以在 Azure 门户中轻松更改数据库层，且不会给应用程序造成任何中断。有关详细信息，请参阅[更改数据库服务层和性能级别](https://msdn.microsoft.com/library/azure/dn369872.aspx)。

> [AZURE.IMPORTANT] Web 和企业版即将停用。了解如何[升级 Web 和企业版](sql-database-upgrade-new-service-tiers.md)。如果你打算继续使用 Web 和企业版，请阅读[版本停用常见问题](http://azure.microsoft.com/pricing/details/sql-database/web-business/)。
...
[SQL Database 定价](http://azure.microsoft.com/pricing/details/sql-database/)中提供了有关这些层的价格详细信息。
