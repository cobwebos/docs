---
title: Azure 监视器中的 Azure 中继指标 |微软文档
...
ms.locfileid: "78273117"
---
# <a name="azure-relay-metrics-in-azure-monitor"></a>Azure 监视器中的 Azure 中继指标 
...
|ActiveConnections |活动连接数。 此值是时间点值。<br/><br/> 单位：计数 <br/> 聚合类型：总计 <br/> 维度：EntityName|
|ActiveListeners |活动侦听器的数量。 此值是时间点值。<br/><br/> 单位：计数 <br/> 聚合类型：总计 <br/> 维度：EntityName|
