<properties pageTitle="通过 NSP 配置 Expressroute" description="本教程将指导你通过 NSP 设置 ExpressRoute。" documentationCenter="na" services="expressroute" authors="cherylmc" manager="adinah" editor="tysonn"/>
...
3. **发出对服务密钥的请求，并将该请求传递给你的 Exchange 提供商。**
