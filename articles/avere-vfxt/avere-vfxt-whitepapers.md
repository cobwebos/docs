---
title: 白皮书和案例研究 - 适用于 Azure 的 Avere vFXT
...
---
# <a name="azure-vfxt-for-azure-whitepapers-and-other-resources"></a>Azure vFXT 用于 Azure 白皮书和其他资源

本文列出了案例研究、技术白皮书、信息图表和其他资源，可帮助您了解 Azure 的 Avere vFXT 如何适合工作流。

## <a name="deploy-agisoft-photoscan-on-azure"></a>在 Azure 上部署 Agisoft PhotoScan

**链接：**[在 Azure 上部署 Agisoft 照片扫描，在 Azure 或 BeeGFS 使用 Avere vFXT](https://azure.microsoft.com/mediahandler/files/resourcefiles/deploy-agisoft-photoscan-on-azure-with-azere-vfxt-for-azure-or-beegfs/AgiSoft%20PhotoScan%20on%20Azure%20using%20Avere%20vFXT%20or%20BeeGFS.pdf)
...
## <a name="datasheet-avere-vfxt-for-azure"></a>数据表：适用于 Azure 的 Avere vFXT

**链接：**[适用于 Azure 数据表的 Avere vFXT](https://azure.microsoft.com/resources/avere-vfxt-for-azure-data-sheet/)

这个两个页面的简介包含基本信息和图形，说明了如何在多个用例方案中使用 Avere vFXT for Azure。

## <a name="hybrid-cloud-for-file-based-workloads"></a>适用于基于文件的工作负荷的混合云

**链接：**[信息图：为基于文件的工作负载构建混合云](https://azure.microsoft.com/resources/building-a-hybrid-cloud-for-file-based-hpc-workloads/)
