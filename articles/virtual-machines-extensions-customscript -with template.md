<properties
   pageTitle="使用自定义脚本扩展 Azure 资源管理器模板"
   description="将自定义脚本与 ARM 模板配合使用，以自动执行 Azure 虚拟机配置任务"
...
<a href="https://azure.microsoft.com/zh-CN/documentation/articles/resource-group-overview/" target="_blank">资源组概述</a>。
<br/>
<a href="https://azure.microsoft.com/zh-CN/documentation/articles/virtual-machines-deploy-rmtemplates-azure-cli/" target="_blank">使用 Azure CLI 部署模板</a>。
<br/>
<a href="https://azure.microsoft.com/zh-CN/documentation/articles/virtual-machines-deploy-rmtemplates-powershell/" target="_blank">使用 Azure Powershell 部署模板。</a>
