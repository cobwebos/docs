...
ms.locfileid: "76722728"
---
# <a name="recover-a-deleted-dashboard-in-the-azure-portal"></a>在 Azure 门户中恢复已删除的仪表板

如果在 Azure 门户中删除_已发布_的仪表板，则可以在删除之前的90天内恢复该仪表板。 如果仪表板未发布，则不能恢复它，您必须重新生成它。 有关发布仪表板的详细信息，请参阅[发布仪表板](azure-portal-dashboard-share-access.md#publish-dashboard)。 请按照以下步骤恢复已发布的仪表板：
