...
* 使用[适用于 JavaScript 应用和网页的 Application Insights](/documentation/articles/app-insights-web-track-usage) 获取有关访问网页的浏览器的客户端分析。
* 使用 Application Insights [监视任何网页的可用性和响应能力](/documentation/articles/app-insights-monitor-web-app-availability)，以便可以在页面出现故障时及时发现。
