...
##  <a name="a-nameapilista-api-list"></a><a name="APIList"></a> API 列表  
...
### <a name="controls"></a>控制  
 `API list` 模板使用以下[页面控件](api-management-page-controls.md)。  
...
##  <a name="a-namecodesamplesa-code-samples"></a><a name="CodeSamples"></a>代码示例  
