...
在以管理员身份登录时，可从“开发人员门户”**** 编辑模板。 要首先打开 Azure 门户，然后从 API 管理实例的服务工具栏单击**开发人员门户**。
...
单击模板转到由该模板自定义的开发人员门户页面。 在此示例中，将显示**产品列表**模板。 “产品列表”**** 模板控制红色矩形所示的屏幕区域。
...
在前面的示例中，开发人员门户中显示的两个产品是从**模板数据**窗格中显示的数据中检索到的，如以下示例所示：
