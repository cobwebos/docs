...
如果自承载网关部署在 Azure Kubernetes 服务中，则可以启用[适用于容器的 Azure Monitor](https://docs.microsoft.com/azure/azure-monitor/insights/container-insights-overview)，以便从工作负载收集 `stdout` 和 `stderr` 并查看 Log Analytics 中的日志。 
