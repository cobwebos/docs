...
可在 API 管理服务中访问指标，或在 Azure Monitor 中访问你的所有 Azure 资源的指标。 查看 API 管理服务中的指标：
1. 打开 Azure 门户。
2. 转到 API 管理服务。
3. 单击“指标”。
...
可在 API 管理服务中访问活动日志，或在 Azure Monitor 中访问你的所有 Azure 资源的日志。 查看 API 管理服务中的活动日志：
1. 打开 Azure 门户。
2. 转到 API 管理服务。
3. 单击“活动日志”。
...
可在 API 管理服务中访问诊断日志，或在 Azure Monitor 中访问你的所有 Azure 资源的日志。 查看 API 管理服务中的诊断日志：
1. 打开 Azure 门户。
2. 转到 API 管理服务。
3. 单击“诊断日志”。
