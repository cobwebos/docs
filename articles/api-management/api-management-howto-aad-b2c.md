...
1.  指定**登录租户**中 Azure Active Directory B2C 租户的域名。

1.  "**颁发机构**" 字段允许您控制要使用的 AZURE AD B2C 登录 URL。 将值设置为 **< your_b2c_tenant_name > b2clogin**。
...
在开发人员门户中，可以通过 "**登录" 按钮**进行 AAD B2C 登录： OAuth 小组件。 小组件已包含在默认开发人员门户内容的登录页中。
