...
- 导入并发布 Azure API 管理实例。 For more information, see [Import and publish](import-and-publish.md)
...
1. Click on **Publish website** in the **Operations** section of the menu. 此操作可能需要几分钟的时间。  
