...
description: 了解可在 Azure API 管理中使用的缓存策略。 请参阅示例并查看其他可用资源。
...
| vary-by-developer              | 设置为 `true` 即可按[订阅密钥](./api-management-subscriptions.md)缓存响应。                                                                                                                                                                                                                                                                                                         | 是      |         错误          |
