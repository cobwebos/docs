---
title: 在 Azure API 管理中使用托管标识 |微软文档
description: 了解如何在 API 管理中使用托管标识
...
ms.locfileid: "79249628"
---
# <a name="use-managed-identities-in-azure-api-management"></a>在 Azure API 管理中使用托管标识

本文介绍如何为 API 管理服务实例创建托管标识以及如何访问其他资源。 Azure 活动目录 （Azure AD） 生成的托管标识允许 API 管理实例轻松安全地访问其他受 Azure AD 保护的资源，如 Azure 密钥保管库。 此标识由 Azure 管理，不需要预配或轮换任何机密。 有关托管标识的详细信息，请参阅 Azure[资源的托管标识](../active-directory/managed-identities-azure-resources/overview.md)是什么。

## <a name="create-a-managed-identity-for-an-api-management-instance"></a>为 API 管理实例创建托管标识

### <a name="using-the-azure-portal"></a>使用 Azure 门户

要在门户中设置托管标识，首先将像往常一样创建 API 管理实例，然后启用该功能。
...
> [!NOTE]
> 目前，托管标识可用于从 Azure 密钥保管库获取 API 管理自定义域名的证书。 不久后会支持更多方案。
>
>
...
了解有关 Azure 资源的托管标识详细信息：

* [Azure 资源的托管标识是什么](../active-directory/managed-identities-azure-resources/overview.md)
* [Azure 资源管理器模板](https://github.com/Azure/azure-quickstart-templates)
* [使用策略中的托管标识进行身份验证](./api-management-authentication-policies.md#ManagedIdentity)
