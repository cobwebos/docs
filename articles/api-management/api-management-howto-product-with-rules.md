...
> 在 API 管理中，使用组来管理产品对开发人员的可见性。 产品向组授予可见性，并且开发人员可以查看和订阅对他们所属的组可见的产品。 有关详细信息，请参阅[如何在 Azure API 管理中创建和使用组][如何在 Azure API 管理中创建和使用组]。
> 
> 
...
[查看产品的订户]: api-management-howto-add-products.md#view-subscribers
[创建 API 管理服务实例]: api-management-get-started.md
...
[为开发人员帐户订阅产品]: #subscribe-account
[调用操作并测试速率限制]: #test-rate-limit

[限制调用速率]: https://msdn.microsoft.com/library/azure/dn894078.aspx#LimitCallRate
[设置使用配额]: https://msdn.microsoft.com/library/azure/dn894078.aspx#SetUsageQuota
