...
* **增量更新**：对网络进行更改时，请参阅 [NetworkStatus API](/rest/api/apimanagement/2019-12-01/networkstatus)，验证并确保 API 管理服务尚未丧失对所依赖的任何关键资源的访问权限。 连接状态应每 15 分钟更新一次。
