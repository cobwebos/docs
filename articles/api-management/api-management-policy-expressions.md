...
|Jwt|Algorithm: 字符串<br /><br /> 受众：IEnumerable<string\><br /><br /> 声明：IReadOnlyDictionary<string, string[]><br /><br /> ExpirationTime：DateTime?<br /><br /> Id: 字符串<br /><br /> Issuer: 字符串<br /><br /> NotBefore：DateTime?<br /><br /> Subject: 字符串<br /><br /> Type: 字符串|
