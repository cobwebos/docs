---
title: 在 Azure 虚拟网络中部署具有基本负载均衡器的 IPv6 双堆栈应用程序 - 资源管理器模板（预览）
...
---
# <a name="deploy-an-ipv6-dual-stack-application-with-basic-load-balancer-in-azure---template-preview"></a>在 Azure - 模板（预览）中部署具有基本负载均衡器的 IPv6 双堆栈应用程序
