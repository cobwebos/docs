...
12. 你还可以根据需要更改模板中的其他参数，并根据需要进行选择：
    ...
    * **地址空间**-在保存之前，可以在模板中更改 VNET 的地址空间，方法是修改**resources** > **addressSpace**节并更改模板中的**addressPrefixes**属性 **。 json**文件：
    ...
    * **子网**-子网名称和子网地址空间可以通过修改**模板 json**文件中的**子网**部分来更改或添加。 可以通过更改**模板 json**文件中的 "**名称**" 属性更改子网的名称。  可以通过更改**addressPrefix** **文件中的 "** 属性" 属性来更改子网地址空间：
