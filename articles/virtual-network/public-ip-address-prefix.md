...
- 你可以创建最多16个 IP 地址的前缀或/28。 有关详细信息，请参阅 [Azure 限制](../azure-subscription-service-limits.md?toc=%2fazure%2fvirtual-network%2ftoc.json#azure-resource-manager-virtual-networking-limits)。
- 创建前缀后，无法更改该范围。
