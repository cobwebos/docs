...
description: 使用 Azure 虚拟网络中的 Powershell 启用 IPv6 终结点
...
| [New-AzAvailabilitySet](/powershell/module/az.compute/new-azavailabilityset) | 创建可用性集。 可用性集通过将虚拟机分布到物理资源上来确保应用程序运行时间，以便在发生故障时，不会影响整个集。 |
