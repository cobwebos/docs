<properties 
   pageTitle="在资源管理器中使用模板部署多 NIC VM | Microsoft Azure"
...
1. 导航到[模板页](https://raw.githubusercontent.com/Azure/azure-quickstart-templates/master/IaaS-Story/11-MultiNIC)。
...
> [AZURE.IMPORTANT]请确保先执行[先决条件](#Pre-requisites)步骤，然后再按照下面的说明操作。
