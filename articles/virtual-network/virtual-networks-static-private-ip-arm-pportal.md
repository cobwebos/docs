...
2. 单击“**新建**” > “**计算**” > “**Windows Server 2012 R2 Datacenter**”（注意此时“**选择部署模型**”列表已显示“**Resource Manager**”），并单击“**创建**”，如下图所示。
...
7. 在“**摘要**”边栏选项卡中，单击“**确定**”。 注意，以下磁贴会显示在仪表板中。
...
1. 在 Azure 门户中，单击“**全部浏览**” > “**虚拟机**” > “**DNS01**” > “**所有设置**” > “**网络接口**”，并单击列出的唯一网络接口。
...
从上面所示的“**IP 地址**”边栏选项卡中，单击“**分配**”下面的“**动态**”，并单击“**保存**”。
