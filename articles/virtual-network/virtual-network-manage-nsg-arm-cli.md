---
title: "使用 Azure CLI 管理 NSG| Microsoft 文档"
description: "了解如何使用 Azure CLI 管理现有的 NSG。"
...
---
# <a name="manage-nsgs-using-the-azure-cli"></a>使用 Azure CLI 管理 NSG
...
若要再次将 **NSG-FrontEnd** NSG 关联到 **FronEnd** 子网，请运行 以下命令：
