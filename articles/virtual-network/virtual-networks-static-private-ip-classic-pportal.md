...
2. 选择 **"新** > **计算** > **Windows 服务器 2012 R2 数据中心**"，请注意"**选择部署模型**列表"已显示**经典**，然后选择"**创建**"。
...
1. 从 Azure 门户中选择 **"浏览所有** > **虚拟机（经典** > **）DNS01** > **所有设置** > **IP 地址**"，并注意 IP 地址分配和 IP 地址，如下所示。
