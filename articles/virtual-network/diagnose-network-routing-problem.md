...
3. 在左侧的 "**设置**" 下，选择 "**网络**"，并通过选择网络接口资源的名称导航到该资源。
     ![查看网络接口](./media/diagnose-network-routing-problem/view-nics.png)
4. 在左侧，选择 "**有效路由**"。 将显示名为**myVMNic1**的网络接口的有效路由，如下图所示： ![查看有效路由](./media/diagnose-network-routing-problem/view-effective-routes.png)
...
获取具有[AzEffectiveRouteTable](/powershell/module/az.network/get-azeffectiveroutetable)的网络接口的有效路由。 以下示例获取名为*myVMNic1*的网络接口的有效路由，该网络接口位于名为*myResourceGroup*的资源组中：
