...
常见的 Azure 资源管理器设置：若要详细了解常见的 Azure 资源管理器设置，请参阅[活动日志](../role-based-access-control/overview.md)、[访问控制 (IAM)](../azure-resource-manager/management/tag-resources.md?toc=%2fazure%2fvirtual-network%2ftoc.json)、[标记](../azure-resource-manager/management/lock-resources.md?toc=%2fazure%2fvirtual-network%2ftoc.json)、[锁定](../azure-resource-manager/templates/export-template-portal.md)和自动化脚本。
