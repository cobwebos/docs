---
title: "在 ARM 中使用 PowerShell 创建虚拟网络 | Microsoft Docs"
...
---
# <a name="create-a-virtual-network-by-using-powershell"></a>使用 PowerShell 创建虚拟网络
...
本文档介绍如何使用资源管理器部署模型创建 VNet。 你还可以 [使用经典部署模型创建虚拟网络](virtual-networks-create-vnet-classic-netcfg-ps.md)。
