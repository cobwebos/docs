...
### 网络安全组
#### [门户](virtual-networks-create-nsg-arm-portal.md)
...
#### [多个 IP 地址](virtual-network-multiple-ip-addresses-powershell.md)
...
## [API（经典）](https://msdn.microsoft.com/library/jj157182.aspx)
