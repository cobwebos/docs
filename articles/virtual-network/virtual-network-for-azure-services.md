...
| 容器 | [Azure Kubernetes 服务 (AKS)](../aks/concepts-network.md?toc=%2fazure%2fvirtual-network%2ftoc.json)<br/>[Azure 容器实例 (ACI)](https://www.aka.ms/acivnet)<br/>带有 Azure 虚拟网络 CNI [插件](https://github.com/Azure/acs-engine)的 [Azure 容器服务引擎](https://github.com/Azure/acs-engine/tree/master/examples/vnet)|No ²<br/> 是 <br/><br/> 否
