...
2. 允许本地网络以安全方式通过 Internet 上的 VPN 隧道与两个虚拟网络通信。 *或者，可以使用 ExpressRoute 连接，但在此示例中，使用 VPN 连接。*
...
- [使用路由和网络虚拟设备创建一个用户定义的路由表](tutorial-create-route-table-portal.md)
- [为 Azure VPN 网关配置 BGP](../vpn-gateway/vpn-gateway-bgp-resource-manager-ps.md?toc=%2fazure%2fvirtual-network%2ftoc.json)
- [将 BGP 与 ExpressRoute](../expressroute/expressroute-routing.md?toc=%2fazure%2fvirtual-network%2ftoc.json#route-aggregation-and-prefix-limits)
