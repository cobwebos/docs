<properties 
   pageTitle="如何在 ARM 模式下使用 PowerShell 设置静态专用 IP | Microsoft Azure"
...
- 了解[保留公共 IP](../virtual-networks-reserved-public-ip) 地址。
- 了解[实例层级公共 IP (ILPIP)](../virtual-networks-instance-level-public-ip) 地址。
