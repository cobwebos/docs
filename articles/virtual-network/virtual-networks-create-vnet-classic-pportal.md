---
title: "使用 Azure 门户创建虚拟网络（经典）| Microsoft Docs"
...
本文档介绍如何使用经典部署模型创建 VNet。 还可以[使用 Azure 门户在 Resource Manager 部署模型中创建虚拟网络](virtual-networks-create-vnet-arm-pportal.md)。
