...
[AZURE.INCLUDE [azure-arm-classic-important-include](../../includes/azure-arm-classic-important-include.md)] 本文档介绍如何使用资源管理器部署模型创建 VNet。还可以[通过 Azure 预览门户使用经典部署模型创建虚拟网络](virtual-networks-create-vnet-classic-pportal.md)。
