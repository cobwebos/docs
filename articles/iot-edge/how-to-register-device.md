...
* 用于可视化工作室代码的[Azure IoT 工具](https://marketplace.visualstudio.com/items?itemName=vsciot-vscode.azure-iot-tools)
...
1. 在 VS 代码资源管理器中，展开**Azure IoT 中心设备**部分。
