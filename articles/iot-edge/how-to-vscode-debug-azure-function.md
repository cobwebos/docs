...
本教程假设你正在使用运行 Windows 或 Linux 的计算机或虚拟机作为开发计算机。 IoT Edge 设备可以是另一台物理设备，也可以在开发计算机上模拟 IoT Edge 设备。
...
3. 在“选择文件夹”窗口中，导航到“FilterFunction”项目，然后单击“选择文件夹作为 EXE_DIR”。
...
6. 可以重复使用 `deployment.json` 进行重新部署。 在命令面板中，键入并选择 **Edge: Restart Edge** 来使筛选器函数以调试版本运行。
