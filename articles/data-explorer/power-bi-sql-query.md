---
title: 使用 Power BI SQL 查询可视化 Azure 数据资源管理器中的数据
...
1. 在"电源 BI 桌面"中，在 **"主页**"选项卡上，选择 **"获取数据**，然后**获取更多**"。
...
1. 在“SQL Server 数据库”屏幕的窗体中填充以下信息。****
    ...
    **设置** | **价值** | **字段说明**
    |---|---|---|
    | 服务器 | *help.kusto.windows.net* | 帮助群集的 URL（没有 *https://*）。 对于其他群集，URL 位于*\<"群集名称"\>窗体中\<。区域\>.kusto.windows.net*。 |
