...
## <a name="supported-streaming-ingestion-types"></a>支持的流式处理引入类型
...
* VM 和群集大小增加时, 流式处理引入性能和容量可扩展性。 对于单个 D11 节点, 推荐的负载最多每秒20个请求。 对于单个 D14 节点, 建议的负载最多为每秒150请求。
