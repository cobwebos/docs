...
如果不喜欢默认调色板，可使用调色板选项自定义图表。 可在此处找到可用的调色板：[为 KQL 魔术查询图表结果选择调色板](https://mybinder.org/v2/gh/Microsoft/jupyter-Kqlmagic/master?filepath=notebooks%2FColorYourCharts.ipynb)
...
KQL magic 可用于在 Kusto 查询语言与 Python 之间进行简单的交换。 要了解更多信息：[使用 Python 参数化 KQL 魔术查询](https://mybinder.org/v2/gh/Microsoft/jupyter-Kqlmagic/master?filepath=notebooks%2FParametrizeYourQuery.ipynb)
