...
* [了解企业注册的 Azure 保留使用情况](../cost-management-billing/reservations/understand-reserved-instance-usage-ea.md) 
...
有关如何交换或退款预订的详细信息，请参阅[保留交换和退款](../cost-management-billing/reservations/exchange-and-refund-azure-reservations.md)。
...
> * 若要了解如何管理 Azure 数据资源管理器保留容量保留，请参阅[管理 azure 数据资源管理器保留容量](../cost-management-billing/reservations/understand-azure-data-explorer-reservation-charges.md)。
