---
title: 使用适用于 Power BI 的 Azure 数据资源管理器连接器可视化数据
...
1. 在“Azure 数据资源管理器(Kusto)”**** 屏幕上，使用以下信息填写表单。
    ...
    **设置** | **价值** | **字段说明**
    |---|---|---|
    | 群集 | *https://help.kusto.windows.net* | 帮助群集的 URL。 对于其他群集，URL 以*群集\<名称\>https://形式。\<区域\>.kusto.windows.net*。 |
    ...
    > * 数据集很小。
    > * 不需要接近实时的数据。 
    > * 数据已聚合，或在 Kusto 中执行[聚合](/azure/kusto/query/summarizeoperator#list-of-aggregation-functions)    
    >
