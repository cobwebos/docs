...
- 有两个泛型筛选函数：
    - [`series_fir()`](/azure/kusto/query/series-firfunction)：应用 FIR 滤波器。 用于方便计算变化检测中时序的移动平均值和差异。
...
* 了解如何在 Azure 数据资源管理器中进行[时序异常情况检测和预测](/azure/data-explorer/anomaly-detection)。
