---
title: 气象服务理念 |微软 Azure 地图
description: 在本文中，您将了解适用于 Microsoft Azure 地图天气服务的概念。
author: philmea
ms.author: philmea
ms.date: 11/20/2019
ms.topic: conceptual
...
---
# <a name="weather-services-in-azure-maps"></a>Azure 地图中的天气服务

本文介绍了适用于[Azure 地图天气服务的概](https://aka.ms/AzureMapsWeatherService)念。 我们建议您先先了解一下本文，然后再开始使用天气 API。 

## <a name="unit-types"></a>单位类型

某些天气服务 API 允许用户指定数据是以公制单位还是以英制单位返回。 这些 API 的返回响应包括单位类型和可用于单位转换的数值。 请参阅下表来解释这些值。
...
某些天气服务 API 返回 响应`iconCode`中的 。 是`iconCode`用于定义图标的数值。 不要直接从应用程序链接到这些图像，URL 可以而且将会更改。

| 图标编号 |图标| 日期 | 晚上 | Text |
|-------------|:----:|-----|-------|------|
| 1           |![](./media/weather-services-concepts/sunny-i.png)                      | 是 |  否    | 晴|
| 2           |![](./media/weather-services-concepts/mostly-sunny.png)                | 是 |  否    | 大部分为晴天|
| 3           |![](./media/weather-services-concepts/partly-sunny.png)                | 是 |  否    | 部分阳光|
| 4           |![](./media/weather-services-concepts/intermittent-clouds.png)         | 是 |  否    | 间歇性云|
| 5           |![](./media/weather-services-concepts/hazy-sunshine.png)               | 是 |  否    | 朦胧的阳光 |
| 6           |![](./media/weather-services-concepts/mostly-cloudy.png)               | 是 |  否    | 多云|
| 7           |![](./media/weather-services-concepts/cloudy-i.png)                     | 是 |  是   | 多云 |
| 8           |![](./media/weather-services-concepts/dreary-overcast.png)             | 是 |  是   | 沉闷（阴天）|
| 11           |![](./media/weather-services-concepts/fog-i.png)                       | 是 |  是   | 雾|
| 12           |![](./media/weather-services-concepts/showers-i.png)                   | 是 |  是   | 淋浴|
| 13           |![](./media/weather-services-concepts/mostly-cloudy-showers.png)       | 是 |  否    | 多云与淋浴|
| 14           |![](./media/weather-services-concepts/partly-sunny-showers.png)        | 是 |  否    | 部分阳光明媚，带淋浴|
| 15           |![](./media/weather-services-concepts/tstorms-i.png)                   | 是 |  是   | 雷暴|
| 16           |![](./media/weather-services-concepts/mostly-cloudy-tstorms.png)       | 是 |  否    | 多云与雷雨|
| 17           |![](./media/weather-services-concepts/partly-sunny-tstorms.png)        | 是 |  否    | 部分阳光与雷雨|
| 18           |![](./media/weather-services-concepts/rain-i.png)                      | 是 |  是   | 雨|
| 19           |![](./media/weather-services-concepts/flurries-i.png)                  | 是 |  是   | 弗鲁里斯|
| 20           |![](./media/weather-services-concepts/mostly-cloudy-flurries.png)      | 是 |  否    | 多云 与 Flurries|
| 21           |![](./media/weather-services-concepts/partly-sunny-flurries.png)       | 是 |  否    | 部分阳光与弗瑞里斯|
| 22           |![](./media/weather-services-concepts/snow-i.png)                      | 是 |  是   | 雪|
| 23           |![](./media/weather-services-concepts/mostly-cloudy-snow.png)          | 是 |  否    | 多云与雪|
| 24           |![](./media/weather-services-concepts/ice-i.png)                       | 是 |  是   | Ice |
| 25           |![](./media/weather-services-concepts/sleet-i.png)                     | 是 |  是   | 雨夹雪|
| 26           |![](./media/weather-services-concepts/freezing-rain.png)              | 是 |  是   | 冻雨|
...
| 35           |![](./media/weather-services-concepts/partly-cloudy-night.png)         | 否  |  是   | 部分多云|
| 36           |![](./media/weather-services-concepts/intermittent-clouds-Night.png)   | 否  |  是   | 间歇性云|
| 37           |![](./media/weather-services-concepts/hazymoon-light.png)             | 否  |  是   | 朦胧的月光|
| 38           |![](./media/weather-services-concepts/mostly-cloudy-night.png)         | 否  |  是   | 多云|
| 39           |![](./media/weather-services-concepts/partly-cloudy-showers-night.png)  | 否  |  是   | 部分多云与淋浴|
| 40           |![](./media/weather-services-concepts/mostly-cloudy-showers-night.png)  | 否  |  是   | 多云与淋浴|
| 41           |![](./media/weather-services-concepts/partly-cloudy-tstorms-night.png)  | 否  |  是   | 部分多云与雷雨|
| 42           |![](./media/weather-services-concepts/mostly-cloudy-tstorms-night.png)  | 否  |  是   | 多云与雷雨|
| 43           |![](./media/weather-services-concepts/mostly-cloudy-flurries-night.png) | 否  |  是   | 多云 与 Flurries|
| 44           |![](./media/weather-services-concepts/mostly-cloudy-snow.png)          | 否  |  是   | 多云与雪|


## <a name="radar-and-satellite-imagery-color-scale"></a>雷达和卫星图像颜色比例

通过[获取地图磁贴 v2 API](https://aka.ms/AzureMapsWeatherTiles)用户可以请求最新的雷达和红外卫星图像。 请参阅下面的指南，以帮助解释用于雷达和卫星切片的颜色。

### <a name="radar-images"></a>雷达图像

下表提供了解释雷达图像和为雷达切片数据创建地图图例的指导。
...
| #dc250e        | ![](./media/weather-services-concepts/color-dc250e.png) | 雨-严重 |
...
下表提供了解释红外卫星图像的指南，这些图像按云的温度显示云，以及如何为这些切片创建地图图例。 
