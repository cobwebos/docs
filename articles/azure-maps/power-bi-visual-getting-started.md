...
<Token>**适用于：** ![是 ](media/power-bi-visual/yes.png) Power BI 服务适用于***使用者***的 "是" ![ ](media/power-bi-visual/yes.png) Power BI 服务设计人员 & 开发人员 ![ 是 ](media/power-bi-visual/yes.png) Power BI Desktop ![ 不 ](media/power-bi-visual/no.png) 需要 Pro 或 Premium 许可证</Token>
