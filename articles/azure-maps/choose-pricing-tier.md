...
如果核心地理空间 Api 满足你的服务要求，则 S0 定价层适用于你。 如果想为应用程序的提供更高级的功能，请考虑选择 S1 定价层。 高级功能包括：高空加混合图像、获取路由范围和批处理地理编码。 查看**定价层功能**表，以选择最适合你的应用程序的定价层。
...
| S1            |    <p>S1 定价层适用于具有大规模企业应用程序、任务关键型应用程序或大量并发用户的客户。 它也适用于那些需要高级地理空间服务的客户。</p>|
