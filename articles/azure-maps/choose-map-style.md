...
在下面的代码中，在加载映射实例之后， `grayscale_dark` `satellite` 使用[system.windows.forms.control.setstyle](https://docs.microsoft.com/javascript/api/azure-maps-control/atlas.map?view=azure-maps-typescript-latest#setstyle-styleoptions-)函数将映射样式从更新为。
...
:::image type="content" source="./media/choose-map-style/style-picker-icon-layout.png" alt-text="样式选取器列表布局":::
