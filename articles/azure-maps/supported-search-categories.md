...
执行兴趣点的[类别搜索](https://docs.microsoft.com/en-us/rest/api/maps/search/getsearchpoicategory)时，会涉及到 100 多个支持的类别。 下面是支持的类别名称的类别代码列表。 类别代码是针对顶级类别生成的。 所有子类别共享相同的类别代码。 请注意，每次发布新数据时，此类别列表都会变化。
