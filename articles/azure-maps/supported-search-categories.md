...
description: 本文将介绍 Microsoft Azure Maps 中支持的搜索类别。
author: sataneja
ms.author: sataneja
ms.date: 05/14/2018
ms.topic: conceptual
...
执行兴趣点的[类别搜索](https://docs.microsoft.com/rest/api/maps/search/getsearchpoicategory)时，会涉及到 100 多个支持的类别。 下面是支持的类别名称的类别代码列表。 类别代码是针对顶级类别生成的。 所有子类别共享相同的类别代码。 每次发布新数据时，此类别列表都会变化。
...
| ADMINISTRATIVE\_DIVISION | 省/自治区/直辖市、第四级行政区划、第一级行政区划、历史第一级行政区划、第四级行政区划政府所在地、第二级行政区划政府所在地、相关政治实体、居民点、第三级行政区划政府所在地、居民点、第二级行政区划、第一级行政区划政府所在地、行政区划、聚居地、历史区域、历史遗迹、历史居民地、以色列定居点、历史第四级行政区划、第五级行政区划、历史第一级行政区划、第三级行政区划、历史政治实体、历史行政区划、政治实体政府所在地、历史第二级行政区划、政治实体首府/主要城市 |
