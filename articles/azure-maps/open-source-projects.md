...
ms.locfileid: "75908939"
---
# <a name="azure-maps-community---open-source-projects"></a>Azure Maps 社区-开源项目

这些是由 Azure Maps 团队创建和维护的开源、社区驱动的计划，但不是标准产品或服务产品的一部分。 下面列出了一些更常用的 Azure Maps 创建的开源项目和示例。
...
- Azure Maps 开源项目和示例的支持方式与通过社区提供给 Microsoft 的其他开源项目的支持方式类似。
