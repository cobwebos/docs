...
| id         | 名称                   |  映射 | 搜索 | 路由 | 交通事故 | JS 地图控件 | 时区 |
|------------|------------------------|:-----:|:------:|:-------:|:-----------------:|:--------------:|:---------:|
| af-ZA      | 南非荷兰语              |       |    ✓   |    ✓    |                   |                |     ✓     |
| ar-SA      | 阿拉伯语                 |   ✓   |    ✓   |    ✓    |         ✓         |        ✓       |     ✓     |
| eu-ES      | 巴斯克语                 |       |    ✓   |         |                   |                |     ✓     |
...
| ro-RO      | 罗马尼亚语               |       |    ✓    |         |         ✓         |                |     ✓     |
| ru-RU      | 俄语                |   ✓   |    ✓   |    ✓    |         ✓         |        ✓       |     ✓     |
| sr-Cyrl-RS | 塞尔维亚语(西里尔文)     |       |    塞尔维亚语（西里尔文）（sr-iov）   |         |                   |                |     ✓     |
...
Azure Maps **View**参数（也称为 "用户区域参数"）是一个由两个字母组成的3166国家/地区代码，它将显示该国家/地区的正确地图，其中指定通过 Azure Maps 返回的 geopolitically 争议内容集服务，包括在地图上显示的边框和标签。 
