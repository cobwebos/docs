...
- [Configuring Azure Diagnostics][]
  ...
  [DiagnosticMonitorTraceListener Class]: http://msdn.microsoft.com/zh-cn/library/windowsazure/microsoft.windowsazure.diagnostics.diagnosticmonitortracelistener.aspx
  [How to Use the Azure Diagnostics Configuration File]: http://msdn.microsoft.com/zh-cn/library/windowsazure/hh411551.aspx
  ...
  [Using performance counters in Azure]: /zh-cn/develop/net/common-tasks/performance-profiling/
  [How to Configure Local Storage Resources]: http://msdn.microsoft.com/zh-cn/library/windowsazure/ee758708.aspx
  [Browsing Storage Resources with Server Explorer]: http://msdn.microsoft.com/zh-cn/library/windowsazure/ff683677.aspx
  ...
  [Use the Azure Diagnostics Configuration File]: http://msdn.microsoft.com/zh-cn/library/windowsazure/hh411551.aspx
  [LogLevel Enumeration]: http://msdn.microsoft.com/zh-cn/library/windowsazure/microsoft.windowsazure.diagnostics.loglevel.aspx
  [OnStart method]: http://msdn.microsoft.com/zh-cn/library/microsoft.windowsazure.serviceruntime.roleentrypoint.onstart.aspx
  [Azure Diagnostics Configuration Schema]: http://msdn.microsoft.cn/zh-cn/library/gg593185.aspx
  [How to use the Table Storage Service]: http://www.windowsazure.cn/zh-cn/develop/net/how-to-guides/table-services/
  [How to use the Azure Blob Storage Service]: http://www.windowsazure.cn/zh-cn/develop/net/how-to-guides/blob-storage/
