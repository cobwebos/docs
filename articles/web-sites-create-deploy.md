...
For information about how to deploy your content to an Azure Web Site that you have created, see the **Deploy** section in [Azure Web Sites](/zh-cn/documentation/services/web-sites/).
...
For more information, see [Azure Web Sites](/zh-cn/documentation/services/web-sites/).
