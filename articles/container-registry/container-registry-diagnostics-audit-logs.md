...
> [!NOTE]
> 仅当配置了注册表[保留策略](container-registry-retention-policy.md)时，才会记录清除事件。
...
### <a name="identity-of-user-or-object-that-deleted-tag"></a>已删除标记的用户或对象的标识
...
### <a name="reposity-level-operation-failures"></a>Reposity 级操作失败
