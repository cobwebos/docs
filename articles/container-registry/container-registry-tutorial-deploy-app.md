...
## <a name="automatic-deployment-to-web-app-for-containers"></a>自动部署到用于容器的 Web 应用
...
选择“存储库” > “acr-helloworld”，右键单击“标记”下面的“v1”标记，并选择“部署到应用服务”。

![在 Azure 门户中部署到应用服务][deploy-app-portal-01]

在显示的“Linux 上的 Web 应用(预览)”下，为每项设置指定以下值：
...
使用上一部分中所述的过程，将第二个 Web 应用部署到“美国东部”区域。 在“Linux 上的 Web 应用(预览)”下，指定以下值：
