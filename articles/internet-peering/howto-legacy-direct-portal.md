...
---
# <a name="convert-a-legacy-direct-peering-to-azure-resource-using-the-portal"></a>使用门户将旧版直接对等互连转换为 Azure 资源

本文介绍如何使用门户将现有旧版直接对等互连转换为 Azure 资源。
...
### <a name="convert-legacy-direct-peering"></a><a name=create></a>转换旧版直接对等互连
