...
将现有搜索解决方案升级到2020年10月15日 REST API 的最新版本。 此时，将不再支持 Azure 认知搜索 REST API 的以下版本：
...
此外，还将停用早于 [**3.0.0**](https://www.nuget.org/packages/Microsoft.Azure.Search/3.0.0-rc) 的 Azure 认知搜索 .net SDK 的版本，因为这些版本以这些 REST API 版本之一为目标。 

在此日期之后，使用任何弃用的 REST API 或 SDK 版本的应用程序将不再有效，必须进行升级。 对于这种类型的任何更改，我们将提供12个月的通知，以便你有足够的时间进行调整。

若要继续使用 Azure 认知搜索，请将目标为 [REST API](search-api-migration.md) 的现有代码迁移到 [REST API 版本 2020-06-30](https://docs.microsoft.com/rest/api/searchservice/) 或2020年10月15日到较新的 SDK。  如果你对更新到最新版本有任何疑问，请 azuresearch_contact@microsoft.com 通过 2020 5 月15日向发送邮件，以确保你有足够的时间来更新你的代码。
...
| 搜索 2015-02-28 | 10-10-2020 之后不受支持   | 第一个正式发布版本。  |
| 搜索 2015-02-28-Preview | 10-10-2020 之后不受支持  | 与稳定版本关联的预览版本。 |
| 搜索 2014-10-20-Preview | 10-10-2020 之后不受支持 | 第二个公共预览版。 |
| 搜索 2014-07-31-Preview | 10-10-2020 之后不受支持  | 第一个公共预览版。 |
...
若要详细了解更早版本的 Microsoft. Azure，请在任何版本中执行 [NuGet 包页](https://www.nuget.org/packages/Microsoft.Azure.Search/) ，向下滚动到 " **版本历史记录**"，然后展开部分以查看完整的发布列表。
