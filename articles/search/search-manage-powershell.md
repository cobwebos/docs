---
title: 使用 Powershell 脚本管理 Azure 搜索服务 - Azure 搜索
...
这些命令与 [Azure 搜索管理 REST API](https://docs.microsoft.com/rest/api/searchmanagement) 中的可用管理选项并行使用。
