...
[文本翻译 API v3.0](https://docs.microsoft.com/azure/cognitive-services/translator/reference/v3-0-reference) 是一项非区域性认知服务，这意味着，我们不保证你的数据与 Azure 认知搜索或附加的认知服务资源位于同一区域。
