...
> [!NOTE]
> 本入门教程需要 [Azure 订阅](../../includes/free-trial-note.md)和 [Azure 搜索服务](search-create-service-portal.md)。
> 
> 
...
> [!NOTE]
> 新发布的索引器支持搜索 Azure Blob 存储，但该功能处于预览状态，尚不是门户选项。若要试用该索引器，需要编写代码。有关详细信息，请参阅 [Indexing Azure Blob storage in Azure Search](search-howto-indexing-azure-blob-storage.md)（在 Azure 搜索中为 Azure Blob 存储编制索引）。<a id="apdx-sampledata"></a>
> 
> 
