---
title: 快速入门：创建、 加载和查询使用 PowerShell 和 REST API-Azure 搜索索引
...
1. [登录到 Azure 门户](https://portal.azure.com/)，并在搜索服务中**概述**页上，获取该 URL。 示例终结点可能类似于 `https://mydemo.search.windows.net`。
