...
|平台 |说明 |
|-----|------------|
|[REST](/rest/api/searchservice/) | 任何编程平台和语言（包括 Java、Python 和 JavaScript）支持的 HTTP 命令|
