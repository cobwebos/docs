---
title: 示例：使用必应实体搜索 API 创建自定义认知技能-Azure 搜索
...
此示例在一个文件中包含所有必要的代码，以方便使用。 您可以找到此同一技能的更多结构化版本，还可以找到有关[power 技能存储库](https://aka.ms/entity-search-power-skill)中的自定义技能的其他示例。
...
1. 部署完成后，请注意站点 URL。 这是 Azure 中你的函数应用的地址。 
