...
description: 评估非结构化文本，对于每个记录，在 Azure 认知搜索中返回 AI 扩充管道中的关键短语列表。
manager: nitinme
author: luiscabrer
ms.author: luisca
...
| 输入                | 描述 |
|---------------------|-------------|
| defaultLanguageCode | （可选）要应用到未显式指定语言的文档的语言代码。  如果未指定默认语言代码，会将英语 (en) 用作默认语言代码。 <br/> 请参阅[支持语言的完整列表](https://docs.microsoft.com/azure/cognitive-services/text-analytics/text-analytics-supported-languages)。 |
