---
title: 快速入门：Postman 和 REST API - Azure 搜索
...
对于目标，请复制以下 URL 的修改版本：`https://<YOUR-SEARCH-SERVICE-NAME>.search.windows.net/indexes?api-version=2019-05-06`
...
以下示例查询取自[搜索文档 REST API](https://docs.microsoft.com/rest/api/searchservice/Search-Documents) 一文。 本问中的许多示例查询包含空格，这在 Fiddler 中是不允许的。 在粘贴查询字符串前，请将每个空格替换为“+”字符，然后再在 Fiddler 中尝试查询。
