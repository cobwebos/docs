...
:::image type="content" source="media/search-indexer-overview/sample-debug-session.png" alt-text="索引器阶段" lightbox="media/search-indexer-overview/sample-debug-session.png":::
