...
查询字符串**`search=*`** 是等效于空搜索或空搜索的未指定的搜索。 它是可以执行的最简单搜索。
...
## <a name="example-1-query-scoped-to-a-list-of-fields"></a>示例 1：查询范围为字段列表
...
## <a name="example-2-fielded-search"></a>示例 2：字段搜索
