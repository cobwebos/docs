...
>
> 由于此项变更，你很可能会发现搜索结果的顺序稍有变化。 对于想要测试此更改影响的用户，可以在 api 版本 2019-05-06-Preview 和2020-06-30 中获得 BM25 算法。  
...
创建新索引时，可以设置 similarity**** 属性来指定该算法。 您可以使用 `api-version=2019-05-06-Preview` ，如下所示，或 `api-version=2020-06-30` 。
