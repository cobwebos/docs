...
+ 对于搜索操作， [ **`2019-05-06-Preview`** ](https://docs.microsoft.com/rest/api/searchservice/index-2019-05-06-preview)为当前预览版本。
+ 对于管理操作， [ **`2019-10-01-Preview`** ](https://docs.microsoft.com/rest/api/searchmanagement/index-2019-10-01-preview)为当前预览版本。
...
| IP 访问限制 | 使用管理 REST API [`api-version=2019-10-01-Preview`](https://docs.microsoft.com/rest/api/searchmanagement/index-2019-10-01-preview) ，你可以创建对允许访问哪些 IP 地址有限制的服务。 |
