...
- Azure SQL Database 上的现有 AdventureWorks 数据库。[在数分钟内即可创建一个](sql-database-get-started.md)。
- [装有 .NET Framework 的 Visual Studio](https://www.visualstudio.com/en-us/visual-studio-homepage-vs.aspx)
...
1. 打开 [Azure 门户](http://portal.azure.com/)。
