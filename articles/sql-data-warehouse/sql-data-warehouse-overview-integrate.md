...
有关详细信息，请参阅[与 Azure 数据工厂集成](../sql-data-warehouse-integrate-azure-data-factory.md)或 [Azure 数据工厂文档](/documentation/services/data-factory/)。
...
有关详细信息，请参阅[与 Azure 机器学习集成](../sql-data-warehouse-integrate-azure-machine-learning.md)或 [Azure 机器学习文档](/services/machine-learning/)。
