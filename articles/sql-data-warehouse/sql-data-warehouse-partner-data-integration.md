...
若要创建端到端数据仓库解决方案，请从行业领先的各种工具中进行选择。下面是多个合作伙伴公司的列表，这些公司使用了针对 SQL 数据仓库的数据集成解决方案。

## 我们的数据集成合作伙伴

| 合作伙伴 | 说明 | 链接 | 视频 |
| ------- | ----------- |------ | ------ |
| ![Alteryx][1] | **Alteryx**<br> Alteryx Designer 通过可重复的工作流进行自助性数据分析，在数小时内即可获得深入的见解，这与传统方法动辄需数周的时间形成鲜明的对比！ Alteryx Designer 使用同一种直观的用户界面将数据准备、数据混合和分析组合在一起，为数据分析师提供了一种强大的助力工具，可以进行预测、统计和空间分析。 | [应用商店][alteryx_marketplace]<br>[网站][alteryx_designer_website]<br>[数据表][alteryx_designer_datasheet]<br>[Twitter][alteryx_designer_twitter]<br>[YouTube][alteryx_designer_youtube] | [![Alteryx 视频](./media/sql-data-warehouse-partner-data-integration/alteryx_designer_video.jpg)](https://www.youtube.com/watch?v=CdqSDPyNDKc) |
...
| ![Informatica][4] | **Informatica Cloud**<br>Informatica Cloud Integration 组合可以让你轻松地连接到各种云数据源、本地数据源、移动数据源和社交性数据源，确保你能够有效地共享相关的且值得信赖的业务信息。我们提供最完整的云集成套件，适用于批处理和实时处理模式应用程序、云测试数据管理应用程序、云数据质量应用程序，以及云主数据管理应用程序。 | [应用商店][informatica_Cloud_Services_marketplace]<br>[免费试用版][informatica_cloud_free_trial]<br>[配置指南][informatica_cloud_services_config]<br>[网站][informatica_Cloud_Services_website]<br>[数据表][informatica_cloud_datasheet]<br>[Twitter][informatica_cloud_twitter]<br>[YouTube][informatica_cloud_youtube] | |
| ![Informatica][4] | **Informatica PowerCenter**<br>Informatica 是全球最知名的独立数据集成软件提供商之一。PowerCenter 是你所有数据集成方案的基础，这些方案包括分析和数据仓库、应用程序迁移，或者合并和数据管理。 | [应用商店（标准）][informatica_PowerCenter_std_marketplace]<br>[应用商店（高级）][informatica_PowerCenter_adv_marketplace]<br>[网站][informatica_PowerCenter_website]<br>[数据表][informatica_powercenter_datasheet]<br>[Twitter][informatica_powercenter_twitter]<br>[YouTube][informatica_powercenter_youtube] | |
| ![Redgate][5] | **Redgate Data Platform Studio（预览版）**<br>Redgate 的 Data Platform Studio 可以让你通过简单而可靠的方式将本地 SQL 数据库迁移到 Azure SQL 数据仓库。它经过专门的设计，可以让你在实施完全自动化迁移时进行明智的决策，并且可以免费用来进行一次性迁移。 | [网站][redgate_website]<br>[Twitter][redgate_twitter]<br>[YouTube][redgate_youtube] | |
| ![SnapLogic][6] | **SnapLogic**<br>SnapLogic 集成平台即服务 (iPaaS) 可让客户在 Microsoft Azure SQL 数据仓库中快速传入和传出数据。SnapLogic 能够在云、本地或混合模式下集成超过数百个应用程序、服务和 IoT，快速、有效率地提供见解。 | [应用商店][snaplogic_marketplace]<br>[网站][snaplogic_website]<br>[数据表][snaplogic_datasheet]<br>[Twitter][snaplogic_twitter]<br>[YouTube][snaplogic_youtube] | [![SnapLogic 视频](./media/sql-data-warehouse-partner-data-integration/snaplogic_video.jpg)](https://www.youtube.com/watch?v=YiJCwObOh5Y) |
...
<!--Marketplace Links -->
[alteryx_marketplace]: https://azure.microsoft.com/zh-cn/marketplace/partners/alteryx/alteryx-designer/
...
[informatica_Cloud_Services_marketplace]: https://azure.microsoft.com/zh-cn/marketplace/partners/informatica-cloud/informatica-cloud/
[informatica_PowerCenter_std_marketplace]: https://azure.microsoft.com/zh-cn/marketplace/partners/informatica/informatica-powercenter-standard-10-0pc-std-10-0-windows/
[informatica_PowerCenter_adv_marketplace]: https://azure.microsoft.com/zh-cn/marketplace/partners/informatica/informatica-powercenter-advanced-10-0pc-adv-10-0-ubuntu/
<!--[redgate_marketplace]:-->
[snaplogic_marketplace]: https://azure.microsoft.com/zh-cn/marketplace/partners/snaplogic/snaplogic-elastic-integration-windows/
