...
<!--Article references-->
[使用 Azure 门户创建 Azure SQL 数据库逻辑服务器]: /documentation/articles/sql-database-get-started.md#create-an-azure-sql-database-logical-server
...
[resource groups]: /documentation/articles/resource-group-template-deploy-portal.md
[最佳实践]: /documentation/articles/sql-data-warehouse-best-practices.md
[DWU]: /documentation/articles/sql-data-warehouse-overview-what-is.md#data-warehouse-units
[订阅]: /documentation/articles/azure-glossary-cloud-terminology.md#subscription
[resource group]: /documentation/articles/azure-glossary-cloud-terminology.md#resource-group
...
[MSDN Azure 信用额度]: /pricing/member-offers/msdn-benefits-details
