...
- [dbo.server\_quotas（Azure SQL 数据库）](http://msdn.microsoft.com/library/dn308512.aspx)
- [sys.bandwidth\_usage（Azure SQL 数据库）](http://msdn.microsoft.com/library/dn269985.aspx)
- [sys.database\_connection\_stats（Azure SQL 数据库）](http://msdn.microsoft.com/library/dn269986.aspx)
- [sys.database\_firewall\_rules（Azure SQL 数据库）](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.database\_usage（Azure SQL 数据库）](http://msdn.microsoft.com/library/azure/ff951626.aspx)
- [sys.event\_log（Azure SQL 数据库）](http://msdn.microsoft.com/library/dn270018.aspx)
- [sys.database\_firewall\_rules（Azure SQL 数据库）](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.firewall\_rules（Azure SQL 数据库）](http://msdn.microsoft.com/library/azure/ff951627.aspx)
- [sys.resource\_stats（Azure SQL 数据库）](http://msdn.microsoft.com/library/dn269979.aspx)
