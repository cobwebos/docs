...
现在，我们已向你提供了一些时间来处理示例数据，请参阅如何[开发](sql-data-warehouse-overview-develop.md)或[加载](design-elt-data-loading.md)。 也可浏览 [Power BI 网站](https://www.powerbi.com/)。
