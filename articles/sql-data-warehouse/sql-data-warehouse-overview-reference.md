---
title: SQL 数据仓库参考主题 | Microsoft 文档
...
ms.locfileid: "30198405"
---
# <a name="reference-topics-for-sql-data-warehouse"></a>SQL 数据仓库参考主题
以下文章包含有关 SQL 数据仓库的参考信息。

* [Transact-SQL 语言元素][Transact-SQL language elements]
* [Transact-SQL 语句][Transact-SQL statements]
* [Transact-SQL 系统视图][Transact-SQL system views]
* [PowerShell cmdlet][PowerShell cmdlets]

## <a name="next-steps"></a>后续步骤
有关开发信息，请参阅[开发概述][development overview]。
