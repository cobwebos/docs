...
请参阅[下载 Visual studio 2019][]下载并安装 visual studio。 在安装过程中, 选择数据存储和处理工作负荷。 Visual Studio 2019 中不再需要单独的 SSDT 安装。
...
<!--Other-->
[下载 Visual Studio 2019]: https://visualstudio.microsoft.com/vs/preview/
