...
<!--Article references-->
[连接到 SQL 数据仓库]: /documentation/articles/sql-data-warehouse-develop-connections.md
[SQL 数据库审核入门]: /documentation/articles/sql-database-auditing-get-started.md
[透明数据加密 (TDE) 入门]: /documentation/articles/sql-data-warehouse-encryption-tde.md
...
[Role-based access control in Azure Portal（Azure 门户中基于角色的访问控制）]: https://azure.microsoft.com/documentation/articles/role-based-access-control-configure
