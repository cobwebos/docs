...
- [审核概述](/documentation/articles/sql-data-warehouse-auditing-overview/)
- [审核下层客户端](/documentation/articles/sql-data-warehouse-auditing-downlevel-clients/)
...
从 Azure 经典门户或使用 Azure Resource Manager API 管理数据库和逻辑服务器的操作将会根据你的门户用户帐户的角色分配进行控制。有关此主题的详细信息，请参阅 [Azure 门户中基于角色的访问控制][]。
...
[使用 Azure Active Directory 身份验证连接到 SQL 数据仓库]: /documentation/articles/sql-data-warehouse-get-started-connect-aad-authentication
