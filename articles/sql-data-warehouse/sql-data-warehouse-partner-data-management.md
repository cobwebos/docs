...
| ![Sentry One][5] |**DW Sentry**<br>借助智能数据移动仪表板和事件日历，可以始终知道什么在影响工作负荷。 旨在可视化运行的查询和加载、备份或还原数据等作业，永远无需担心是否充分利用 Azure 资源。 |[市场][sql_sentry_marketplace]<br>[网站][sql_sentry_website]<br>[新闻发布][sql_sentry_press]<br>[Twitter][sql_sentry_twitter]<br>[YouTube][sql_sentry_youtube] | |
