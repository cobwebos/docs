...
若要更改 DWU，请使用[创建或更新数据库][创建或更新数据库] REST API。 以下示例将托管在服务器 MyServer 上的数据库 MySQLDW 的服务级别目标设置为 DW1000。 该服务器位于名为 ResourceGroup1 的 Azure 资源组中。
...
若要暂停数据库，请使用[暂停数据库][暂停数据库] REST API。 以下示例将暂停 Server01 服务器上托管的 Database02 数据库。 该服务器位于名为 ResourceGroup1 的 Azure 资源组中。
...
若要启动数据库，请使用[恢复数据库][恢复数据库] REST API。 以下示例将启动 Server01 服务器上托管的 Database02 数据库。 该服务器位于名为 ResourceGroup1 的 Azure 资源组中。 
...
<!--MSDN references-->
[暂停数据库]: https://msdn.microsoft.com/library/azure/mt718817.aspx
[恢复数据库]: https://msdn.microsoft.com/library/azure/mt718820.aspx
[创建或更新数据库]: https://msdn.microsoft.com/library/azure/mt163685.aspx
