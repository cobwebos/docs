...
| ![Looker][7] |**Looker BI**<br>Looker 可以让贵公司的所有人能够浏览和了解那些推动业务发展的数据。 Looker 还为数据分析师提供了一个既灵活又可重复使用的建模图层，用于控制和组织这些数据。  各公司基本上都在使用 Looker 作为催化剂来转换企业文化。|[产品页][looker_website]<br> [Azure Marketplace][looker_marketplace]<br> |
| ![Microstrategy][14] |**MicroStrategy**<br>MicroStrategy 平台提供了一组完整的商业智能和分析功能，使组织能够充分利用其业务数据。 MicroStrategy 的功能强大的分析引擎、 全面的工具集、 各种不同的数据连接器和可缩放，请打开体系结构确保提供全部所需方式将对 analytics 的访问扩展到每个团队和业务函数 |[产品页][microstrategy_website]<br> [Azure Marketplace][microstrategy_marketplace]<br> |
...
| ![Tableau][10] |**Tableau**<br>Tableau 的自助分析可帮助任何人查看和了解数据，从平面文件到数据库，数据种类包罗万象。 Tableau 提供本机、优化的连接器用于连接 Microsoft Azure SQL 数据仓库，支持实时数据和内存中分析。 |[产品页][tableau_website]<br> [Azure Marketplace][tableau_marketplace]<br>|
| ![Targit][11] |**Targit （决策套件）**<br>Targit Decision Suite 提供 BI 和分析平台，以单个且一致的解决方案提供实时仪表板、自助分析、方便使用的报告、令人赞叹的移动功能和简单的数据发现技术。 Targit 为企业带来了行动的勇气。 |[产品页][targit_website]<br> [Azure Marketplace][targit_marketplace]<br> |
| ![Yellowfin][12] |**Yellowfin**<br>Yellowfin 评选为云 BI 供应商为即席报告和仪表板领域最顶级BI 调查中。 连接到 Azure SQL 数据仓库，并使用屡获殊荣的协作 BI 和定位智能功能来创建和共享优雅的报告与仪表板。 |[产品页][yellowfin_website]<br> [Azure Marketplace][yellowfin_marketplace] |
