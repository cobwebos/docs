<properties
   pageTitle="对 SQL 数据仓库中的表进行分区 | Microsoft Azure"
...
若要了解详细信息，请参阅有关[表概述][Overview]、[表数据类型][Data Types]、[分布表][Distribute]、[为表编制索引][Index]、[维护表统计信息][Statistics]和[临时表][Temporary]的文章。有关最佳实践的详细信息，请参阅 [SQL 数据仓库最佳实践][]。
...
[分区方案]: https://msdn.microsoft.com/library/ms179854.aspx
