<properties
   pageTitle="管理 Azure SQL 数据仓库中的计算能力 (概述) | Microsoft Azure"
...
[通过 REST API 暂停计算]: ./sql-data-warehouse-manage-compute-rest-api.md#pause-compute-bk
...
[为表选择哈希分布键]: sql-data-warehouse-develop-hash-distribution-key.md
