<properties
   pageTitle="在 Azure SQL 数据仓库中还原数据库（Azure 门户）| Microsoft Azure"
...
> [AZURE.SELECTOR]
- [概述](sql-data-warehouse-overview-manage-database-restore.md)
- [门户](sql-data-warehouse-manage-database-restore-portal.md)
