...
- **Azure 帐户**：若要创建帐户，请参阅 [Azure 免费试用版][]或 [MSDN Azure 信用额度][]。
...
[使用 PowerShell 创建 Azure SQL 数据库逻辑服务器]: /documentation/articles/sql-database-get-started-powershell.md#database-setup-create-a-resource-group-server-and-firewall-rule
...
[Azure 免费试用版]: /pricing/free-trial/?WT.mc_id=A261C142F
