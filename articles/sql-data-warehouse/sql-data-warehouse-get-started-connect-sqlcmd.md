<properties
   pageTitle="查询 Azure SQL 数据仓库 (sqlcmd)| Microsoft Azure"
...
本演练使用 [sqlcmd][] 命令行实用工具查询 Azure SQL 数据仓库。
...
> [AZURE.NOTE] 需要[启用 Azure Active Directory 身份验证](sql-data-warehouse-authentication.md)才能使用 Active Directory 进行身份验证。
