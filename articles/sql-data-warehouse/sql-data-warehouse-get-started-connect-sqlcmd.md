---
title: "查询 Azure SQL 数据仓库 (sqlcmd)| Microsoft Docs"
...
---
# <a name="query-azure-sql-data-warehouse-sqlcmd"></a>查询 Azure SQL 数据仓库 (sqlcmd)
...
本演练使用 [sqlcmd][sqlcmd] 命令行实用工具查询 Azure SQL 数据仓库。  
