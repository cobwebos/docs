...
若要使用 Visual Studio 进行连接和查询，请参阅[使用 Visual Studio 进行查询][Query with Visual Studio]。 若要详细了解身份验证选项，请参阅[对 Azure SQL 数据仓库进行身份验证][Authentication to Azure SQL Data Warehouse]。
