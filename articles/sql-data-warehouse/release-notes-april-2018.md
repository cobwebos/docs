...
ms.locfileid: "34738947"
---
# <a name="whats-new-in-azure-sql-data-warehouse-april-2018"></a>Azure SQL 数据仓库（2018 年 4 月）中的新增功能。
...
### <a name="dbcc-commands-do-not-consume-concurrency-slots"></a>DBCC 命令不会占用并发插槽
...
### <a name="updated-error-message-for-excessive-literals"></a>更新了文本过多时的错误消息
...
### <a name="removed-the-syspdwdatabasemappings-view"></a>删除了 SYS.PDW_DATABASE_MAPPINGS 视图
