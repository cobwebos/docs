<properties
   pageTitle="将数据从 Azure Blob 存储载入 SQL 数据仓库 (PolyBase) | Microsoft Azure"
...
[manage columnstore indexes]: sql
[Statistics]: sql-data-warehouse-develop-statistics.md
[CTAS]: sql-data-warehouse-develop-ctas.md
[label]: sql-data-warehouse-develop-label.md

<!--MSDN references-->
[CREATE EXTERNAL DATA SOURCE]: https
[CREATE EXTERNAL FILE FORMAT]: https
