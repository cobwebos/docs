...
Azure Active Directory (Azure AD) is a modern, REST-based service that provides identity management and access control capabilities for cloud applications. Azure AD easily integrates with cloud services as well as Azure, Microsoft Office 365, Dynamics CRM Online, and Windows Intune. Existing on-premise Active Directory deployments can also take full advantage of Azure AD. To learn more, see the [Identity page][] on [windowsazure.cn][].
...
[Identity page]: http://azure.microsoft.com/zh-cn/services/multi-factor-authentication/

[downloaded here]: http://go.microsoft.com/fwlink/?LinkId=271213
[port assignment in Visual Studio]: http://msdn.microsoft.com/zh-cn/library/ms178109(v=vs.100).aspx
[Microsoft Seller Dashboard]: https://sellerdashboard.microsoft.com/
[create an account profile]: http://msdn.microsoft.com/zh-cn/library/jj552460.aspx
[Create Client IDs and Secrets in the Microsoft Seller Dashboard]: http://msdn.microsoft.com/zh-cn/library/jj552461.aspx
[Get an Azure AD tenant]: https://account.windowsazure.cn/organization
[this topic]: http://msdn.microsoft.com/zh-cn/library/azure/hh974476.aspx
[Add Apps in the Microsoft Seller Dashboard]: http://msdn.microsoft.com/zh-cn/library/jj552465.aspx
