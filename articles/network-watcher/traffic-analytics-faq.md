...
流量分析计量。 该计量的基础是由服务处理流日志数据，并将生成的增强日志存储在 Log Analytics 工作区中。 有关详细信息，请参阅[定价计划](https://azure.microsoft.com/en-us/pricing/details/network-watcher/)。 
