...
可以轻松验证 blob 的 TTL。  通过使用浏览器的[开发人员工具](https://developer.microsoft.com/microsoft-edge/platform/documentation/f12-devtools-guide/)，测试 blob 是否包含 *Cache-Control* 响应标头。  还可以使用类似于 **wget**、[Postman](https://www.getpostman.com/) 或 [Fiddler](http://www.telerik.com/fiddler) 的工具检查响应标头。
