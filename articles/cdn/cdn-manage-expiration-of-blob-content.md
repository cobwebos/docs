...
[Azure PowerShell](/powershell/azure/overview) 是管理 Azure 服务的最快、 最强大的方式之一。  使用 `Get-AzureStorageBlob`cmdlet 来获取对 blob 的引用，然后设置 `.ICloudBlob.Properties.CacheControl` 属性。 
