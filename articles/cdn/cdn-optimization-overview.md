...
> [!NOTE]
> Microsoft 提供的动态站点加速通过[Azure 前门服务](https://docs.microsoft.com/azure/frontdoor/front-door-overview)提供。
...
> [!NOTE]
> Microsoft 提供的动态站点加速通过[Azure 前门服务](https://docs.microsoft.com/azure/frontdoor/front-door-overview)提供，该服务是利用 microsoft 的专用全球网络来提供应用工作负荷的全局可[广播](https://en.wikipedia.org/wiki/Anycast)服务。
