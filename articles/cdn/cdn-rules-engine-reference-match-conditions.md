...
- 国家/地区匹配：设置为所需的国家/地区集国家/地区匹配条件。
   - 允许：设置为国家/地区匹配条件**不符**以允许仅指定的国家/地区访问 URL 路径通配符匹配条件定义的位置中存储的内容。
   - 阻止：设置为国家/地区匹配条件**匹配**阻止指定的国家/地区访问 URL 路径通配符匹配条件定义的位置中存储的内容。
