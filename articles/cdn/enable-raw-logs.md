...
1. 从 "Azure 门户" 菜单中，选择 "**所有资源** >> **\<"-CDN 配置文件>**。
...
| 终结点              | CDN 终结点主机已在父 CDN 配置文件下进行配置。                                                                                                                                   |
...
> [!IMPORTANT]
> 对于在**2020 年2月 25**日后创建或更新的任何配置文件，可以自动使用 HTTP 原始日志功能。 对于之前创建的 CDN 配置文件，应在设置日志记录后更新 CDN 终结点。 例如，可以导航到 CDN 终结点下的地区筛选，并阻止任何与工作负荷无关的国家/地区，并按保存。 
