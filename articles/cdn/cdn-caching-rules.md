...
> [!NOTE] 
> 缓存规则仅适用于 **Verizon 提供的标准 Azure CDN** 和 **Akamai 提供的标准 Azure CDN** 配置文件。 对于**来自 Microsoft**配置文件的 Azure CDN，必须使用[标准规则引擎](cdn-standard-rules-engine-reference.md)来**从 Verizon**配置文件中 Azure CDN premium，你必须在**管理**门户中使用[Verizon 高级规则引擎](cdn-rules-engine.md)来了解类似功能。
