...
当设置这些规则，为请求 _&lt;终结点主机名&gt;_ .azureedge.net/home/index.html 触发器自定义缓存规则 #2 中，它设置为：**缺少时设置**和 3 天。 因此，如果 *index.html* 文件包含 `Cache-Control` 或 `Expires` HTTP 标头，则会遵循这些标头；如果未设置这些标头，则会将文件缓存 3 天。
