...
确保用户始终获取资产的最新副本的最佳做法是针对每次更新将资产版本化，并将其发布为新 URL。  CDN 会立即检索下用于一个客户端请求的新资产。  有时你可能想要从所有边缘节点清除缓存的内容并强制这些所有检索新的更新的资产。  这可能是由于 Web 应用程序获得了更新，或快速更新的资产包含不正确的信息。
...
1. 在[Azure 门户](https://portal.azure.com)，浏览到包含你想要清除的终结点的 CDN 配置文件。
...
3. 上的清除边栏选项卡，选择你想要清除 URL 下拉列表中的服务地址。
   ...
   > 
   > 
4. 选择你想要从边缘节点中清除哪些资产。  如果想清除所有资产，单击“**全部清除**”复选框。  否则，请在“路径”文本框中输入要清除的每个资产的路径。 路径支持以下格式。
