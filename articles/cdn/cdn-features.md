---
title: Azure 内容交付网络 (CDN) 产品功能 | Microsoft Docs
description: 了解每个 Azure 内容交付网络 (CDN) 产品支持的功能。
services: cdn
documentationcenter: ''
author: dksimpson
manager: akucer
...
三种 Azure 内容交付网络 (CDN) 产品：**来自 Akamai 的标准 Azure CDN**、**来自 Verizon 的标准 Azure CDN** 和**来自 Verizon 的高级 Azure CDN**。 下表比较了每个产品的可用功能。

| **性能特色和优化** | 标准 Akamai | 标准 Verizon | 高级 Verizon |
| --- | --- | --- | --- |
...
||||
 **安全性** | **标准 Akamai** | **标准 Verizon** | **高级 Verizon** | 
| 对 CDN 终结点的 HTTPS 支持 |**&#x2713;** |**&#x2713;** |**&#x2713;** |
...
||||
| **分析和报告** | **标准 Akamai** | **标准 Verizon** | **高级 Verizon** | 
...
||||
| **易于使用** | **标准 Akamai** | **标准 Verizon** | **高级 Verizon** | 
...
\* Verizon 支持直接通过常规 Web 传送优化交付大型文件和媒体。
