...
## <a name="active-cypher"></a>活动加密

![活动加密徽标](./media/partners/active-cypher.png)

Active 加密是一个 Windows 虚拟桌面增值服务提供程序, 它为 IT 提供加密技术, 以帮助防止企业遭受泄露和数据丢失。 利用 Active 加密, 创新性的加密技术支持在 Azure 上运行 Windows 虚拟桌面的总体文件保护策略。

与 Windows 虚拟桌面一起使用时, Active 加密提供了额外的功能来启用用户数据的可访问性和移动性, 同时防止意外的数据丢失。 使用 Active 加密, 可以利用 Azure 信息保护中的现有组安全策略和权限, 在使用 Windows 虚拟桌面时对用户文件进行加密。

- [请参阅联合解决方案简述。](https://query.prod.cms.rt.microsoft.com/cms/api/am/binary/RE3oNLu)
- [请参阅合作伙伴网站。](https://activecypher.com/)
