...
Citrix 是一家经过批准的提供商，它为 Azure 中的虚拟应用和桌面工作负载提供了企业集中式混合管理，与本地部署并存。 使用虚拟应用和桌面服务的 Citrix 工作区，用户可以从任何设备访问应用和桌面，利用高级 Citrix HDX 协议从任何位置提供高定义的体验。

Citrix 扩展了 Windows 虚拟桌面的价值和强大的企业工具，以提高用户的密度和性能，按需预配工作负荷，并简化映像和应用程序管理。 它可以使用智能缩放工具来优化成本，同时提供了令人难以置信的最终用户体验，这些体验经过现场测试，适用于跨行业的应用程序。
