...
>[!IMPORTANT]
>本教程的内容适用于包含 Azure 资源管理器 Windows 虚拟桌面对象的 Windows 虚拟桌面。 如果你使用的是不包含 Azure 资源管理器对象的 Windows 虚拟桌面（经典），请参阅[此文](./virtual-desktop-fall-2019/troubleshoot-vm-configuration-2019.md)。
...
如果在将虚拟机 (Vm) 加入到域中时遇到问题，请按照这些说明进行操作。
...
### <a name="error-the-status-filed-in-get-azwvdsessionhost-cmdlet-shows-status-as-unavailable"></a>错误： Get-AzWvdSessionHost cmdlet 中存档的状态将状态显示为 "不可用"
...
### <a name="error-windows-virtual-desktop-agent-isnt-reporting-a-heartbeat-when-running-get-azwvdsessionhost"></a>错误：在运行时 Windows 虚拟桌面代理未报告检测信号 Get-AzWvdSessionHost
