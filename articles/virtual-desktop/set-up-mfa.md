...
9. 根据所使用的 Windows 虚拟桌面版本，选择以下应用组之一。
   ...
   >[!IMPORTANT]
   > Windows 虚拟桌面客户端应用程序用于 web 客户端。 不过，请不要选择名为 Windows 虚拟桌面 Azure 资源管理器提供程序 (50e95039-b200-4007-bc97-8d5790743a63) 的应用。 此应用仅用于检索用户源，而不应具有 MFA。

1. 选择应用后，选择 "**选择**"，然后选择 "**完成**"。
...
10. 在 "**访问控制**" "  >  **授权**" 下，选择 "**授予访问权限**，**需要多重身份验证**"，然后**选择**。
11. 在 **"访问控制**"  >  **会话**下，选择 "**登录频率**"，将 "值" 设置为**1** ，将 "单位" 设置为 "**小时**"，然后选择 "**选择**"。
12. 确认设置，然后将“启用策略”设置为“打开”。 
13. 选择 "**创建**" 以启用策略。
