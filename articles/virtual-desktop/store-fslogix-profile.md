...
|层和性能|Standard<br>高级<br>每个共享最大为每个共享的最大 100k IOPS 约3毫秒，延迟|Standard<br>高级<br>黑体<br>最多 320k (16K) IOPS，每卷 4.5 GBps，大约1毫秒延迟|标准 HDD：每个磁盘最多 500 IOPS<br>标准 SSD：最多为 4k IOPS 每个磁盘的限制<br>高级 SSD：每个磁盘的最大 IOPS 限制<br>建议存储空间直通的高级磁盘|
...
|Backup|Azure 备份快照集成|Azure NetApp 文件快照|Azure 备份快照集成|
