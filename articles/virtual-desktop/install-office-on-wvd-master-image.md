...
description: 如何在 Windows 虚拟桌面预览主映像到 Azure 上安装和自定义 Office。
...
- 从预览体验频道安装 Office, 并在执行时从预览体验频道中提供更新。
- 使用 x64 体系结构。
- 禁用自动更新。
- 安装 Visio 和项目。
...
>[!NOTE]
>Visio 中的模具搜索功能在预览配置过程中无法在 Windows 虚拟桌面中运行。
