...
>[!NOTE]
>目前我们不会受理 Windows 虚拟桌面预览版的支持案例。 每当我们引用 Windows 虚拟桌面支持时, 请立即访问我们的技术社区论坛。 请访问[Windows 虚拟桌面技术社区](https://techcommunity.microsoft.com/t5/Windows-Virtual-Desktop/bd-p/WindowsVirtualDesktop), 讨论产品团队和活动社区成员的问题。 如果需要解决支持问题, 请为发生此问题的时间包括活动 ID 和大致时间范围。

| **问题**                                                            | **建议的解决方案**  |
|----------------------------------------------------------------------|-------------------------------------------------|
| 创建租户                                                    | 如果出现 Azure 中断, 请联系[Azure 支持](https://azure.microsoft.com/support/options/)部门;否则, 请联系**远程桌面服务/Windows 虚拟桌面支持**。|
...
| 从 Azure 门户管理 Windows 虚拟桌面会话主机环境    | 联系**Azure 支持部门**。 <br> <br> 有关使用远程桌面服务/Windows 虚拟桌面 PowerShell 时的管理问题, 请参阅[Windows 虚拟桌面 powershell](troubleshoot-powershell.md)或与**远程桌面服务/windows 虚拟桌面支持团队**联系。 |
| 管理绑定到主机池和应用程序组的 Windows 虚拟桌面配置 (应用组)      | 请参阅[Windows 虚拟桌面 PowerShell](troubleshoot-powershell.md), 或与**远程桌面服务/Windows 虚拟桌面支持团队**联系。 <br> <br> 如果问题与示例图形用户界面 (GUI) 相关联, 请联系 Yammer 社区。|
| 远程桌面客户端在启动时无法正常工作                                                 | 请参阅[远程桌面客户端连接](troubleshoot-client-connection.md), 如果这不能解决问题, 请与**远程桌面服务/Windows 虚拟桌面支持团队**联系。  <br> <br> 如果这是网络问题, 用户需要联系其网络管理员。 |
| 已连接但无源                                                                 | 使用[远程桌面客户端连接](troubleshoot-client-connection.md)的 "用户连接但不显示任何数据源 (无源)" 部分进行故障排除。 <br> <br> 如果已将用户分配到应用组, 请升级到**远程桌面服务/Windows 虚拟桌面支持团队**。 |
