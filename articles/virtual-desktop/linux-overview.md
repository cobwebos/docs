...
您可以使用 Windows 虚拟桌面的 Linux SDK 构建独立的 Windows 虚拟桌面客户端。 您还可以使用它在客户端应用程序上启用 Windows 虚拟桌面支持。 本快速指南将解释什么是 Linux SDK 以及如何开始使用它。
...
> [!NOTE]
> SDK 目前正在开发中。 我们将更新本文档，并提供访问 SDK 的说明（当它可用时）。
