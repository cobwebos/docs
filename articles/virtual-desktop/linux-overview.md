...
ms.locfileid: "89649154"
---
# <a name="linux-support"></a>Linux 支持

你可以使用 Linux 瘦客户端合作伙伴提供的以下受支持的客户端访问 Windows 虚拟桌面资源。 我们正在与许多合作伙伴合作，在基于 Linux 的操作系统和设备上启用受支持的 Windows 虚拟桌面客户端。 如果在此处未列出的 Linux 平台上需要 Windows 虚拟桌面支持，请在我们的 [UserVoice 页面](https://remotedesktop.uservoice.com/forums/923035-remote-desktop-support-on-linux)上告知我们。
