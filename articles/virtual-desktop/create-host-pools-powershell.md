---
title: 使用 PowerShell 创建 Windows 虚拟桌面预览主机池-Azure
...
运行以下 cmdlet, 将注册令牌导出到变量, 稍后会在将[虚拟机注册到 Windows 虚拟机主机池](#register-the-virtual-machines-to-the-windows-virtual-desktop-preview-host-pool)时使用。
...
## <a name="prepare-the-virtual-machines-for-windows-virtual-desktop-preview-agent-installations"></a>为 Windows 虚拟桌面预览代理安装准备虚拟机
...
## <a name="register-the-virtual-machines-to-the-windows-virtual-desktop-preview-host-pool"></a>向 Windows 虚拟桌面预览主机池注册虚拟机
