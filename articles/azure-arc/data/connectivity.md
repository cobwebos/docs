...
|**名称**|**连接源**|**连接目标**|**协议**|**端口**|**可以使用代理**|**身份验证**|**备注**|
|---|---|---|---|---|---|---|---|
...
> [!NOTE]
> 目前，所有与 Grafana 和 Kibana 仪表板的浏览器 HTTPS/443 连接以及从 Azure 数据 CLI 到数据控制器 API 的所有连接都是使用自签名证书进行 SSL 加密的。  未来将推出一项功能，该功能允许你提供自己的证书来加密这些 SSL 连接。
