...
1. 在 Azure 门户中，导航到你的某个 `connectedCluster` 资源，然后在边栏的“设置”部分中，选择“策略”。 （AKS 群集的 UX 尚未实现，但即将推出。）
