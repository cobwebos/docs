...
4. 选择“固定到启动板”。只有这样才能完成本教程。
5. 单击“创建”。将转到门户启动板。此时，一个新磁贴已添加到启动板，其中的标签显示“正在部署 Azure Data Lake Analytics”。创建 Data Lake Analytics 帐户需要几分钟时间。创建帐户后，门户将在一个新边栏选项卡上打开该帐户。
...
6. 单击“Data Lake Analytics 帐户”边栏选项卡顶部的“数据资源管理器”。
...
7. 在“默认的 Data Lake Store 帐户”边栏选项卡中，单击“示例”展开相应的文件夹，然后单击“数据”展开相应的文件夹。应会看到以下文件和文件夹：
...
1. 单击顶部的“提交作业”。此时将打开新的“作业详细信息”窗格。标题栏显示了作业状态。
2. 请等到作业状态变为“成功”。完成作业后，门户将在新边栏选项卡中打开作业详细信息：
...
3. 在“作业详细信息”边栏选项卡底部，单击“SearchLog-from-Data-Lake.csv”中的作业名称。可以预览、下载、重命名和删除输出文件。
