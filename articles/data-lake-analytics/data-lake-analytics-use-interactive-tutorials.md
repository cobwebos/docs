---
title: 使用 Azure 门户交互式教程学习 Data Lake Analytics 和 U SQL | Microsoft Docs
...
> [!NOTE]
> 如果想要通过使用 Visual Studio 完成同一个教程，请参阅[使用 Data Lake Analytics 分析网站日志](data-lake-analytics-analyze-weblogs.md)。还有更多可添加到门户的交互式教程。
> 
> 
...
9. 单击“创建”。将转到门户启动板。一个新的磁贴添加主页并带有显示为“部署 Azure Data Lake Analytics”的标签。需要花一些时间来创建一个 Data Lake Analytics 帐户。帐户创建后，门户将在新的边栏选项卡上打开该帐户。
