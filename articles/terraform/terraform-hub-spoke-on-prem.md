---
title: 在 Azure 中使用 Terraform 创建本地虚拟网络
description: 本教程说明如何在 Azure 中实现包含本地资源的本地 VNet
services: terraform
ms.service: azure
keywords: terraform, 中心辐射型, 网络, 混合网络, devops, 虚拟机, azure, VNet 对等互连, 本地
author: VaijanathB
manager: jeconnoc
ms.author: vaangadi
ms.topic: tutorial
...
ms.locfileid: "58000838"
---
# <a name="tutorial-create-on-premises-virtual-network-with-terraform-in-azure"></a>教程：在 Azure 中使用 Terraform 创建本地虚拟网络

在本教程中，你将使用 Azure 虚拟网络 (VNet) 实现本地网络。 Azure VNet 可以由你自己的专用虚拟网络替换。 为此，请在子网中映射相应的 IP 地址。
...
要模拟本地网络，请创建 Azure 虚拟网络。 演示 VNet 取代了实际的私有本地网络。 要对现有的本地网络执行相同操作，请在子网中映射相应的 IP 地址。
