...
资源运行状况 [支持](resource-health-alert-arm-template-guide.md) 基于活动日志的警报。 活动日志警报使用[操作组](../azure-monitor/platform/action-groups.md)来通知用户已触发警报。 操作组支持各种通知通道，例如电子邮件、短信、Webhook 和 ITSM 操作。
