---
title: 使用 ServiceNow 使用 webhook 将发送 Azure 服务运行状况警报
...
ms.locfileid: "67067123"
---
# <a name="send-azure-service-health-alerts-with-servicenow-using-webhooks"></a>使用 ServiceNow 使用 webhook 将发送 Azure 服务运行状况警报
