...
[Azure 状态](https://azure.microsoft.com/en-us/status/)可提供 Azure 服务运行状况的全局视图。 通过 Azure 状态可获取有关服务可用性的最新信息。 所有人均可访问 Azure 状态并查看报告其服务运行状况的所有服务。 
...
虽然 Azure 状态页始终显示最新运行状况信息，但是可使用 [Azure 状态历史记录页](https://azure.microsoft.com/en-us/status/history/)查看先前事件。
