...
- [使用 PowerShell 和 Azure 服务管理创建 Windows 虚拟机](virtual-machines-create-windows-powershell-service-manager)
...
如果你尚未这样做，请按[如何安装和配置 Azure PowerShell](install-configure-powershell) 中的说明在本地计算机上安装 Azure PowerShell。然后，打开 Azure PowerShell 命令提示符。
