<properties 
	...
	description="本主题概述 Azure Media Encoder 格式和编解码器" 
...
[Media Encoder 导入格式](#import_formats)

[Media Encoder 导出格式](#export_formats)


## <a id="import_formats"></a>Media Encoder 导入格式 
...
## <a id="export_formats"></a>Media Encoder 导出格式
...
有关 Media Services 中支持的其他编解码器和筛选器，请参阅 [Windows DirectShow 筛选器](https://msdn.microsoft.com/zh-cn/library/windows/desktop/dd375464.aspx)。
