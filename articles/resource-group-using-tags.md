...
对于受支持的服务，您可以使用标记对计费数据进行分组。例如，[与 Azure 资源管理器集成的虚拟机](/virtual-machines/virtual-machines-azurerm-versus-azuresm.md)可让你定义并应用标签来组织虚拟机的计费使用情况。如果您针对不同组织运行多个虚拟机，可以使用标记根据成本中心对使用情况进行分组。
...
- 有关使用预览门户的说明，请参阅[使用 Azure 门户管理 Azure 资源](./resource-group-portal.md)  
