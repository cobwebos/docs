...
完成后，你的预算将以最高成本的报表显示在 **"成本" &gt;** **成本分析**"和" 成本与总预算 "报表中。 还可以使用“操作”根据预算阈值安排生成报告。
...
![成本与基于时间的总预算报表中显示的累计成本和总预算示例](./media/manage-budgets/accumulated-budget.png)
...
在 "成本与预算随时间推移" 报表中，单击 "**操作**"，然后选择 "**计划报表**"。 在“阈值”选项卡上，选择阈值指标。 例如，“成本百分比与预算”。 选择警报类型，并输入预算百分比值。 如果只要收到一次通知，请选择“连续警报数”，再键入“1”。 单击“ **保存**”。
