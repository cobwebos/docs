...
* VNet 中使用 Azure NetApp 文件（包括对等互连 Vnet）的 Ip 数不能超过1000。 我们正在努力提高此限制，以满足客户的规模要求。 
...
* 在上述体系结构中，如果分支 VNET 中还存在一个网关，则将丢失通过该中心网关连接到和卷的连接。 按照设计，将首选项提供给分支 VNet 中的网关，因此只有通过该网关连接的计算机才能连接到和卷。
