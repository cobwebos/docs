...
The following table shows the different distribution versions, Linux Integration Services (LIS) drivers and Azure Linux Agent versions that have been tested to work on Azure. LIS drivers are available at [http://www.microsoft.com/en-us/download/details.aspx?id=34603](http://www.microsoft.com/zh-cn/download/details.aspx?id=34603). Linux Agent versions are available at [https://github.com/Azure/WALinuxAgent](https://github.com/Azure/WALinuxAgent).
