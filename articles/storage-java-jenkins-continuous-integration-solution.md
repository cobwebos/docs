...
-   [先决条件][先决条件]
-   [如何将 Blob 服务用于 Jenkins CI][如何将 Blob 服务用于 Jenkins CI]
...
有关 Jenkins 的更多信息，请访问 [Jenkins 概览][Jenkins 概览]。
...
<h2><a name="prerequisites"></a><span class="short header">先决条件先决条件</span>先决条件先决条件</h2>
...
##<a name="howtoinstall"></a>如何安装 Azure 存储插件
...
##<a name="howtocreatebuildstep"></a>如何创建生成步骤如何创建从 Azure Blob 存储进行下载的生成步骤
