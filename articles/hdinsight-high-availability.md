...
-   [使用 HDInsight .NET SDK][]
  ...
  [使用 RDP 连接到 HDInsight 群集]: http://windowsazure.cn/zh-cn/documentation/articles/hdinsight-administer-use-management-portal/#rdp
  [1]: http://i.imgur.com/MYTkCHW.png
  [2]: http://i.imgur.com/eL6jzgB.png
  [使用 PowerShell 管理 HDInsight]: http://windowsazure.cn/zh-cn/documentation/articles/hdinsight-administer-use-powershell/
  [使用 HDInsight .NET SDK]: http://windowsazure.cn/zh-cn/documentation/articles/hdinsight-provision-clusters/#sdk
