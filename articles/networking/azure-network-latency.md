...
## <a name="april-2020-round-trip-latency-figures"></a>2020年4月往返延迟的数据

过去30天的 Azure 区域之间的每月平均往返时间（从2020年4月30日结束），如下所示。 以下度量值由[ThousandEyes](https://thousandeyes.com)提供支持。
