---
title: Batch AI 文档（预览版）
description: 借助 Azure Batch AI，可以使用任何框架在 AI 模型中进行试验，然后在 GPU 和 CPU 群集中大规模训练这些模型。 通过快速入门和示例了解如何使用 Batch AI。
services: batch-ai
author: czeumault
manager: carolz
layout: LandingPage
...
---
# <a name="batch-ai-documentation-preview"></a>Batch AI 文档（预览版）

借助 Azure Batch AI，可以使用任何框架在 AI 模型中进行试验，然后在 GPU 和 CPU 群集中大规模训练这些模型。 通过快速入门和示例了解如何使用 Batch AI。
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/batchai">REST API 参考</a></p>
                    </div>
                </div>
            </div>
        </div>
