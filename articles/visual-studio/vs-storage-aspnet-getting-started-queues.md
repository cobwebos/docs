...
1. 运行应用程序，并选择“创建队列”，查看结果是否与以下屏幕截图类似：
...
1. 运行应用程序，并选择“添加消息”，查看结果是否与以下屏幕截图类似：
...
1. 运行应用程序，并选择“速览消息”，查看结果是否与以下屏幕截图类似：
...
1. 运行应用程序，并选择“读取/删除消息”，查看结果是否与以下屏幕截图类似：
...
1. 运行应用程序，并选择“获取队列长度”，查看结果是否与以下屏幕截图类似：
