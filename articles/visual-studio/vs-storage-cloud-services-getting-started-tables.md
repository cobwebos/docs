---
title: 开始使用表存储和 Visual Studio 连接服务（云服务）| Microsoft Docs
...
**注意：** 一些执行调出 Azure 存储的 Api 是异步的。 有关详细信息，请参阅[使用 Async 和 Await 进行异步编程](https://msdn.microsoft.com/library/hh191443.aspx)。 下面的代码假定正在使用异步编程方法。
