...
有关云服务以及如何将它们与 Azure 网站和虚拟机进行比较的更多信息，请参阅[Azure 网站、云服务和虚拟机：何时使用何种产品？][]
...
![浏览器窗口中显示“Hello World”页面。URL 指示该页面托管在 Azure 上。][]
...
4.  如果云服务尚不存在，将创建一个新的“云服务”。**云服务**是一个容器，用于在将应用程序部署到 Azure 后托管该应用程序。有关详细信息，请参阅[创建 Azure 托管服务概述][]。
