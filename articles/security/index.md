        ...
        <div class="cardSize">
            <div class="cardPadding" style="padding-bottom: 0;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h2 style="margin-top: 0">了解 Azure 安全</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">我在考虑为我的公司使用 Azure。 Azure 一定会提供什么安全措施？</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="http://aka.ms/sharedresponsibility">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Microsoft 如何与我的组织共同承担安全责任？</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-isolation">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Azure 如何将我的资源与其他 Azure 客户的资源隔离开？</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/security-storage-overview">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">存储安全概述</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/security-network-overview">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">网络安全概述</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/security-azure-encryption-overview">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">数据加密概述</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-log-audit">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Azure 中提供的监视和日志记录选项有哪些？</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-encryption-atrest">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Azure 如何保护静态数据？</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-disk-encryption">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">如何加密 Azure 虚拟机</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            <li style="list-style: none;">
                                <a class="barLink" href="http://aka.ms/SecurityResponsepaper">云中的 Azure 安全响应</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/azure-threat-detection">Azure 高级威胁检测</a>
                            </li>
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/azure-network-security">Azure 网络安全</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            ...
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/azure-service-fabric-security-best-practices">Service Fabric 安全</a>
                            </li>
                            <li style="list-style: none;">
        ...
        <div class="cardPadding">
            <div class="card">
                <div class="cardText">
                     ...
                     <ul class="noBullet">
                        <li style="list-style: none;">
                            <a class="barLink" href="/azure/security/azure-database-security-checklist">保护数据库</a>
                        </li>
                        <li style="list-style: none;">
                            <a class="barLink" href="/azure/security/azure-operational-security-checklist">运营安全</a>
                        </li>
                        <li style="list-style: none;">
                            <a class="barLink" href="/azure/security/azure-service-fabric-security-checklist">Service Fabric 安全</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding" style="padding-bottom: 0;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h2 style="margin-top: 0">资源和服务</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <a href="https://www.microsoft.com/en-us/trustcenter/">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">MSFT 信任中心</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="https://azuremarketplace.microsoft.com/en-us/marketplace/apps?search=security&page=1">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Azure 安全合作伙伴</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-cyber-services">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">网络安全咨询</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-pen-testing">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">渗透测试</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security-center/">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Azure 安全中心</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-disk-encryption">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">磁盘加密</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/information-protection/understand-explore/what-is-information-protection">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Azure 信息保护</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/multi-factor-authentication/">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">多重身份验证 (MFA)</p>
                        </div>
                    </div>
                </div>
            </div>
