        ...
        <a href="/azure/security/develop">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">开发和部署安全的应用程序</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/develop/secure-dev-overview">安全开发最佳做法</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            ...
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/fundamentals/abstract-network-security">Azure 网络安全</a>
                            </li>
                            <li style="list-style: none;">
