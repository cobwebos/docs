...
Azure 提供了一个安全的平台，你可以基于其构建你的解决方案。 我们还提供了一些服务和技术，使你的解决方案在 Azure 上更加安全。 由于有许多选项可供使用，许多人对 Microsoft 推荐的用于提高安全性的最佳实践和模式表示了兴趣。

我们理解你的兴趣，并已创建一个文档集（其中描述了你可以做的事情），给出了正确的上下文，以提高 Azure 部署的安全性。
