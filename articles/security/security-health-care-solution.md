...
description: " 这篇文章可帮助你了解如何使用 Azure 服务和你配置的功能提高卫生保健解决方案的安全性。 "
services: security
...
[Microsoft Azure 中设计安全卫生保健解决方案实践指南](https://aka.ms/azureindustrysecurity)帮助你了解如何可以提高安全性，你的解决方案使用的 Azure 服务和功能，你可以配置基于你的要求。
该内容分为三个主要部分：
