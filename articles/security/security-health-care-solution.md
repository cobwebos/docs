...
description: " 本文帮助你了解如何通过使用 Azure 服务和你配置功能改进卫生保健解决方案的安全性。 "
services: security
...
[在 Microsoft Azure 中设计安全卫生保健解决方案的实践指南](https://aka.ms/azureindustrysecurity)可帮助你了解：如何可根据要求加以配置的 Azure 服务和功能，提高解决方案的安全性。
该内容分为三个主要部分：
...
我们希望[设计安全卫生保健解决方案的实用指南](https://aka.ms/azureindustrysecurity)能对你有所帮助，如果你有任何疑问或建议，请在下面留下你的意见以让我们知道。
