...
- [Azure 存储空间](https://docs.microsoft.com/azure/storage/common/storage-introduction/)。 提供针对新式数据存储方案的解决方案。
