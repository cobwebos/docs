...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **引用**              | [XSS 保护筛选器](https://www.owasp.org/index.php/List_of_useful_HTTP_headers#X-XSS-Protection) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **引用**              | [ASP.NET 调试概述](https://msdn.microsoft.com/library/ms227556.aspx)、[ASP.NET 跟踪概述](https://msdn.microsoft.com/library/bb386420.aspx)、[如何：为 ASP.NET 应用程序启用跟踪](https://msdn.microsoft.com/library/0x5wc973.aspx)、[如何：为 ASP.NET 应用程序启用调试](https://msdn.microsoft.com/library/e8z01xdh(VS.80).aspx) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **引用**              | [OWASP 点击劫持防御备忘表](https://www.owasp.org/index.php/Clickjacking_Defense_Cheat_Sheet)， [IE 内部 - 打击点击劫持与 X 帧选项](https://blogs.msdn.microsoft.com/ieinternals/2010/03/30/combating-clickjacking-with-x-frame-options/) |
...
| **适用的技术** | Web 窗体、MVC5 |
| **属性**              | 空值  |
| **引用**              | [请求验证 - 阻止脚本攻击](https://www.asp.net/whitepapers/request-validation) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **引用**              | [IE8 安全性第五部分：全面保护](https://blogs.msdn.com/ie/archive/2008/07/02/ie8-security-part-v-comprehensive-protection.aspx)、[MIME 类型](https://en.wikipedia.org/wiki/Mime_type) |
...
| **引用**              | [在 Windows Azure 网站中删除标准服务器标头](https://azure.microsoft.com/blog/removing-standard-server-headers-on-windows-azure-web-sites/) |
...
| **属性**              | 不适用，SQL 版本 - V12 |
| **引用**              | [如何配置 Azure SQL 数据库防火墙](https://azure.microsoft.com/documentation/articles/sql-database-firewall-configure/)、[为数据库引擎访问配置 Windows 防火墙](https://msdn.microsoft.com/library/ms175043) |
...
| **适用的技术** | MVC 5 |
| **属性**              | 空值  |
| **引用**              | [在 ASP.NET Web API 2 中启用跨域请求](https://www.asp.net/web-api/overview/security/enabling-cross-origin-requests-in-web-api)、[ASP.NET Web API - ASP.NET Web API 2 中的 CORS 支持](https://msdn.microsoft.com/magazine/dn532203.aspx) |
...
| **适用的技术** | MVC 6 |
| **属性**              | 空值  |
| **引用**              | [在 ASP.NET Core 1.0 中启用跨域请求 (CORS)](https://docs.asp.net/en/latest/security/cors.html) |
| **步骤** | <p>在 ASP.NET Core 1.0 中，可以使用中间件或 MVC 启用 CORS。 使用 MVC 启用 CORS 时，将使用相同的 CORS 服务，但使用 CORS 中间件启用 CORS 时则不是这样。</p>|

**方式 1** 使用中间件启用 CORS：要为整个应用程序启用 CORS，请使用 UseCors 扩展方法将 CORS 中间件添加到请求管道。 使用 CorsPolicyBuilder 类添加 CORS 中间件时，可以指定跨域策略。 有两种方法可以实现此目的：
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **引用**              | [在 Windows 10 IoT 内核上启用安全启动和位锁定设备加密](https://docs.microsoft.com/windows/iot-core/secure-your-device/securebootandbitlocker) |
...
| **引用**              | [IoT 中心设备管理概述](https://azure.microsoft.com/documentation/articles/iot-hub-device-management-overview/)、[如何更新设备固件](../../iot-hub/tutorial-firmware-update.md) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **引用**              | [Azure 存储安全指南 - 管理存储帐户密钥](https://azure.microsoft.com/documentation/articles/storage-security-guide/#_managing-your-storage-account-keys) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **引用**              | [Azure 存储服务的 CORS 支持](https://msdn.microsoft.com/library/azure/dn535601.aspx) |
...
| **属性**              | 空值  |
| **引用**              | [MSDN](https://msdn.microsoft.com/library/ff648500.aspx)、[巩固王国](https://vulncat.fortify.com) |
