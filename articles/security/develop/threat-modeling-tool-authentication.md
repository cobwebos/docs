...
| **参考**              | [针对包含的数据库的安全最佳做法](https://msdn.microsoft.com/library/ff929055.aspx) |
...
| **参考**              | 不适用，[使用 .NET 的 Azure IoT 中心](https://azure.microsoft.com/documentation/articles/iot-hub-csharp-csharp-getstarted/)、[IoT 中心和 Node JS 入门](https://azure.microsoft.com/documentation/articles/iot-hub-node-node-getstarted)、[使用 SAS 和证书保护 IoT](https://azure.microsoft.com/documentation/articles/iot-hub-sas-tokens/)、[Git 存储库](https://github.com/Azure/azure-iot-sdks/) |
...
## <a name="grant-limited-access-to-objects-in-azure-storage-using-sas-or-sap"></a><a id="limited-access-sas"></a>使用 SAS 或 SAP 授予对 Azure 存储中的对象的受限访问权限
