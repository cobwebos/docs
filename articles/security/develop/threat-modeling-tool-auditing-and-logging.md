...
ms.locfileid: "68728411"
---
# <a name="security-frame-auditing-and-logging--mitigations"></a>安全框架：审核与日志记录 | 缓解措施 

| 产品/服务 | 项目 |
| --------------- | ------- |
| **Dynamics CRM**    | <ul><li>[确定解决方案中的敏感实体并实施变更审核](#sensitive-entities)</li></ul> |
| **Web 应用程序** | <ul><li>[确保对应用程序执行审核和日志记录](#auditing)</li><li>[确保日志旋转和分离到位](#log-rotation)</li><li>[确保应用程序不记录敏感的用户数据](#log-sensitive-data)</li><li>[确保对审核与日志文件限制访问](#log-restricted-access)</li><li>[确保记录用户管理事件](#user-management)</li><li>[确保在系统中针对滥用提供内置防御机制](#inbuilt-defenses)</li><li>[在 Azure 应用服务中启用 Web 应用的诊断日志记录](#diagnostics-logging)</li></ul> |
...
| **IoT 云网关** | <ul><li>[确保在云网关上实施适当的审核和日志记录](#logging-cloud-gateway)</li></ul> |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **引用**              | [配置登录审核](https://msdn.microsoft.com/library/ms175850.aspx) |
...
| **适用的技术** | SQL Azure |
| **属性**              | SQL 版本 - V12 |
| **引用**              | [开始使用 SQL 数据库威胁检测](https://azure.microsoft.com/documentation/articles/sql-database-threat-detection-get-started/)|
...
| **适用的技术** | 泛型 |
| **属性**              | 空值 |
| **引用**              | [使用存储分析来监视授权类型](https://azure.microsoft.com/documentation/articles/storage-security-guide/#storage-analytics) |
...
| **适用的技术** | .NET Framework |
| **属性**              | 空值  |
| **引用**              | [MSDN](https://msdn.microsoft.com/library/ff648500.aspx)、[巩固王国](https://vulncat.fortify.com/en/detail?id=desc.config.dotnet.wcf_misconfiguration_insufficient_logging) |
...
| **适用的技术** | .NET Framework |
| **属性**              | 空值  |
| **引用**              | [MSDN](https://msdn.microsoft.com/library/ff648500.aspx)、[巩固王国](https://vulncat.fortify.com/en/detail?id=desc.config.dotnet.wcf_misconfiguration_insufficient_audit_failure_handling) |
...
| **适用的技术** | 泛型 |
| **属性**              | 空值  |
| **引用**              | [IoT 中心操作监视简介](https://azure.microsoft.com/documentation/articles/iot-hub-operations-monitoring/) |
