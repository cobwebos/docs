...
| Azure 存储空间 | <ul><li>[使用 Azure 存储分析来审核对 Azure 存储的访问](#analytics)</li></ul> |
...
| 步骤 | <p>规划如何通过 IoT 中心操作监视收集和存储审核数据。 启用以下监视类别：</p><ul><li>设备标识操作</li><li>设备到云的通信</li><li>云到设备的通信</li><li>连接</li><li>文件上载</li></ul>|
