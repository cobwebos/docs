---
title: Azure 安全性和符合性蓝图 - 适用于英国官方的三层 IaaS Web 应用程序
description: Azure 安全性和符合性蓝图 - 适用于英国官方的三层 IaaS Web 应用程序
services: security
author: jomolesk
...
## <a name="architecture-diagram-and-components"></a>体系结构示意图和组件
 ...
 Azure 模板在 Azure 云环境中提供一个支持英国官方工作负荷的三层 Web 应用程序体系结构。 该体系结构提供一个可将本地网络扩展到 Azure，让企业用户或 Internet 用户安全访问基于 Web 的工作负荷的安全混合环境。

![适用于英国官方的三层 IaaS Web 应用程序的参考体系结构关系图](images/ukofficial-iaaswa-architecture.png?raw=true "适用于英国官方的三层 IaaS Web 应用程序的参考体系结构关系图")
...
[客户责任矩阵](https://aka.ms/ukofficial-crm)（Excel 工作簿）中列出了所有 14 项云安全原则，并指明每项原则（或原则的细则）的实施是由 Microsoft、客户还是两者共同负责。

[原则实施矩阵](https://aka.ms/ukofficial-iaaswa-pim)（Excel 工作簿）中列出了所有 14 项云安全原则，并针对在“客户责任矩阵”中指定由客户负责的每项原则（或原则的细则）指明：1) 蓝图自动化是否实施该原则；2) 如何根据原则要求完成实施的说明。
