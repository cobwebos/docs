...
#### <a name="incident-monitoring--automated-tracking--data-collection--analysis"></a>事件监视 | 自动跟踪/数据收集/分析
...
**IR-9.d** 组织应根除受污染的信息系统或组件中的信息，从而响应信息泄漏。
