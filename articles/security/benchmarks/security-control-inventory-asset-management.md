...
库存和资产管理建议侧重于解决与主动管理（清单、跟踪和更正）所有 Azure 资源相关的问题，以便仅授予授权资源访问权限，并且未经授权的和非托管资源已识别并删除。
...
## <a name="611-limit-users-ability-to-interact-with-azure-resource-manager-via-scripts"></a>6.11：限制用户通过脚本与 Azure 资源管理器交互的能力

| Azure ID | 独联体的代用品 | 职责 |
|--|--|--|
| 6.11 | 2.8 | 客户 |

使用 Azure 条件访问&quot;通过配置&quot;&quot;Microsoft Azure 管理&quot;应用的块访问来限制用户与 Azure 资源管理器交互的能力。
...
使用操作系统特定的配置或第三方资源来限制用户在 Azure 计算资源中执行脚本的能力。
