...
![Azure 模具更新](./media/azure-security-threat-modeling-tool-releases-71509112/tmt_azure_stencil_update-300x70.png)
...
![使用高分辨率屏幕时的已知问题](./media/azure-security-threat-modeling-tool-releases-71509112/tmt_screen_resolution-300x153.png)
...
![已删除 OneDrive 功能](./media/azure-security-threat-modeling-tool-releases-71509112/tmt_save_error-300x131.png)
...
![已删除 OneDrive 功能](./media/azure-security-threat-modeling-tool-releases-71509112/tmt_save_onedrive-300x149.png)
...
![2016 客户端中的 Azure 模具更新](./media/azure-security-threat-modeling-tool-releases-71509112/tmt_azure_stencils-300x212.png)
