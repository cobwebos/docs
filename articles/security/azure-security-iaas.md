...
description: " 工作负荷迁移到 Azure IaaS 为重新评估我们的设计带来了机会 "
services: security
...
有关在 Azure IaaS 中管理修补的详细信息，请查看[有关 Microsoft Azure IaaS 上软件更新的最佳实践](azure-security-best-practices-software-updates-iaas.md)。
