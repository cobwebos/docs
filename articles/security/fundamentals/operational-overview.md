...
安全中心使用[基于角色的访问控制 (RBAC)](/azure/role-based-access-control/role-assignments-portal)。 RBAC 提供了[内置角色](https://docs.microsoft.com/azure/role-based-access-control/built-in-roles)，可分配给 Azure 中的用户、组和服务。
