...
- [诚信](infrastructure-integrity.md)
- [数据保护](protection-customer-data.md)

## <a name="next-steps"></a>后续步骤

- 了解您在[云中的共同责任](shared-responsibility.md)。

- 了解[Azure 安全中心](https://azure.microsoft.com/services/security-center/)如何通过提高 Azure 资源的安全性并控制威胁来帮助预防、检测和响应威胁。
