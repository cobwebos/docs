...
|Azure 容器服务（ACS）（不推荐使用）|*. azurecontainer.io|
|[Azure 内容分发网络（CDN）](https://azure.microsoft.com/services/cdn/)|*. vo.msecnd.net|
|[Azure 文件](https://docs.microsoft.com/azure/storage/files/storage-files-introduction)|*.file.core.windows.net|
