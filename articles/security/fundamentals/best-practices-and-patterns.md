---
title: 安全最佳实践和模式 - 微软 Azure |微软文档
description: 本文将您链接到不同 Azure 资源的安全最佳实践和模式。
...
* [Azure 边界安全最佳做法](/azure/security/fundamentals/network-best-practices#adopt-a-zero-trust-approach)
* [Azure 数据库安全性最佳做法](database-best-practices.md)
* [Azure 数据安全和加密最佳实践](data-encryption-best-practices.md)
* [Azure 标识管理和访问控制安全最佳实践](identity-management-best-practices.md)
* [Azure 网络安全最佳实践](network-best-practices.md)
* [Azure 操作安全性最佳做法](operational-best-practices.md)
* [Azure PaaS 最佳实践](paas-deployments.md)
* [Azure Service Fabric 安全性最佳做法](service-fabric-best-practices.md)
* [Azure VM 安全最佳做法](iaas.md)
* [在 Azure 中实现安全混合网络体系结构](/azure/architecture/reference-architectures/dmz/secure-vnet-hybrid)
* [物联网安全最佳实践](iot-best-practices.md)
...
* [Azure 中 IaaS 工作负荷的安全性最佳实践](iaas.md)
