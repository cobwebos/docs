...
|[<br>安全策略和建议](../../security-center/security-center-planning-and-operations-guide.md)|<ul><li>使用 [Azure 安全中心](../../security-center/security-center-install-endpoint-protection.md)部署终结点解决方案。</li><li>添加 [Web 应用程序防火墙 (WAF)](../../application-gateway/waf-overview.md) 来保护 Web 应用程序。</li><li>   使用从 Microsoft 合作伙伴的[下一代防火墙 (NGFW)](../../security-center/security-center-add-next-generation-firewall.md) 来增强安全保护。 </li><li>为 Azure 订阅应用安全联系人详细信息；如果 [Microsoft 安全响应中心 (MSRC)](https://technet.microsoft.com/security/dn528958.aspx) 发现客户数据被非法或未授权的一方访问，MSRC 会联系你。</li></ul> |
