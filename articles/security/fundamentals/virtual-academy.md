...
在此页上，会发现特选的与 Azure 安全性相关的课程集合。 若要查看所有可选课程，请访问 [Microsoft Virtual Academy](https://mva.microsoft.com/)。

[云中的开发/测试](https://mva.microsoft.com/en-us/training-courses/devtest-in-the-cloud-16274?l=9aAijd7LC_2005190311)

是否是需要提供更快更好的应用程序的开发人员？ 将开发和测试移到云环境，可帮助你精准实现此目标！ 了解如何开展工作，并找出进行此项移动的好处。 此外，请参阅演示及演示文稿，了解 Microsoft Azure 如何支持开发和测试需求。 包含有关安全开发和部署实践的课程。

[Azure 上 Linux 的一般任务](https://mva.microsoft.com/en-us/training-courses/common-tasks-for-linux-on-azure-16191?l=J0Hvb7qJC_1204668937)

如果有在 Microsoft Azure 平台上使用 Linux 的问题，此详细课程将解答。 与来自 [Linux Academy](https://linuxacademy.com/) 的专家一起探讨一些常见的任务。 了解如何在 Azure 中创建创建 Linux 虚拟机 (VM)、使用远程桌面软件访问 Linux VM，以及如何运行虚拟主机。 本课程介绍了许多安全技术和配置。
...
了解 Microsoft 云数据平台解决方案的特性和功能 。 获取平台概述并了解相关安全功能、高可用性选项、监视和管理云数据的技术等等。 此外，获取有关指南，了解如何识别利弊，以及如何使用 Microsoft 云数据平台功能为公开和混合云解决方案作出决策。

[在云和移动环境中管理和保护身份](https://mva.microsoft.com/en-us/training-courses/manage-and-secure-identities-in-a-cloud-and-mobile-world-14013?l=GIJ2GcvrB_405192797)

在本课中，了解 Azure Active Directory 和 Microsoft 高级威胁分析如何帮助你保护并管理用户身份、在造成损害前找出安全漏洞，并且为用户提供单一身份用于访问公司的所有资源。 探索各种技术，用于发现 Shadow IT、管理应用程序访问，并通过高级安全报告、用户行为分析，审核并发出相应警报来监视可疑活动。
...
了解如何使用 Microsoft Azure 基础结构功能。 如果是 IT 专业人员，无需具有以前使用过 Azure 的经验。 本课程将逐步指导完成创建和配置 Azure 虚拟机、Azure 虚拟网络和跨界连接，以在云上启动和运行作业。 整个课程会包含安全功能和注意事项。
...
了解信息保护为什么是组织中的“必须”项目，以及权限管理如何保护组织的知识产权（只要通过设备和云）。 从 Microsoft 专家那里获取实践经验和技术专业知识。
