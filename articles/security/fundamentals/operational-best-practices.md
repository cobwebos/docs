...
安全中心还与[Windows Defender 高级威胁防护 (ATP)](../../security-center/security-center-wdatp.md)集成, 提供全面的终结点检测和响应 (EDR) 功能。 使用 Windows Defender ATP 集成可以查明异常。 你还可以检测和响应安全中心监视的服务器终结点上的高级攻击。
