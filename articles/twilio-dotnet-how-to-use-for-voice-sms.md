...
Twilio 是一种现用现付服务。 没有设置费用，并且可以随时关闭帐户。 可以在 [Twilio 定价](http://www.twilio.com/voice/pricing)中找到更多详细信息。
...
这些库可以[使用 NuGet 程序包管理器扩展进行安装](http://www.twilio.com/docs/csharp/install)，该扩展适用于 Visual Studio 2010 到 2015。  源代码托管在 [GitHub][twilio_github_repo] 上，其中的 Wiki 包含有关使用这些库的完整文档。
