...
Azure 客户在升级 Twilio 帐户后即可获得[特惠套餐](https://www.twilio.com/azure)：10 美元的 Twilio 信用额度。 此 Twilio 信用可应用于任何 Twilio 使用（10 美元信用等价于发送多达 1,000 条 SMS 消息或接收长达 1000 分钟的入站语音，具体取决电话号码和消息或呼叫目标的位置）。 赎回这个Twilio信贷，并开始[在twilio.com/azure。](https://twilio.com/azure)
...
### <a name="twilio-verbs"></a><a id="Verbs"></a>特维利奥动词
...
默认情况下，Microsoft Visual Studio 2010 安装 1.2 版的 NuGet。 安装 Twilio 库需要 1.6 或更高版本的 NuGet。 有关安装或更新 NuGet 的信息，[https://nuget.org/][nuget]请参阅。
...
## <a name="how-to-provide-twiml-responses-from-your-own-website"></a><a id="howto_provide_twiml_responses"></a>如何：从您自己的网站提供 TwiML 响应
...
> [!NOTE]
> 虽然 TwiML 专供 Web 服务使用，但可以在浏览器中查看 TwiML。 例如，单击以查看[https://twimlets.com/message][twimlet_message_url]空元素;单击`<Response>`以查看空元素。作为[https://twimlets.com/message?Message%5B0%5D=Hello%20World](https://twimlets.com/message?Message%5B0%5D=Hello%20World)另一`<Response>`个示例，单击以查看包含&lt;Say&gt;元素的元素。
>
