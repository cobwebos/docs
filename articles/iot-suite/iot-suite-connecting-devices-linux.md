...
## <a name="add-code-to-specify-the-behavior-of-the-device"></a>添加用于指定设备行为的代码
...
IoT 中心序列化程序客户端库使用一个模型来指定设备发送到 IoT 中心的消息的格式，以及从 IoT 中心所接收的命令的格式。
...
### <a name="add-code-to-implement-the-behavior-of-the-device"></a>添加代码以实现设备的行为
...
### <a name="add-code-to-invoke-the-remotemonitoringrun-function"></a>添加用于调用 remote_monitoring_run 函数的代码
...
## <a name="use-cmake-to-build-the-client-application"></a>使用 CMake 生成客户端应用程序
