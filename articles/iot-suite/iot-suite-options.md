...
description: 选择如何使用 Azure IoT 解决方案加速器、Microsoft IoT Central 或 Azure IoT 中心实现 IoT 解决方案。
services: iot-suite
suite: iot-suite
author: dominicbetts
manager: timlt
...
* [Azure IoT 解决方案加速器](index.md)是基于 Azure 平台即服务 (PaaS) 的企业级[解决方案加速器](iot-suite-what-are-solution-accelerators.md)集合，用于加速自定义 IoT 解决方案的开发。
...
Azure IoT 中心是核心的 Azure PaaS，可供 Microsoft IoT Central 和 Azure IoT 解决方案加速器使用。 可以通过 IoT 中心在数百万个 IoT 设备和一个云解决方案之间实现安全可靠的双向通信。 可以借助 IoT 中心克服 IoT 实现难题，例如：
...
## <a name="compare-azure-iot-solution-accelerators-and-microsoft-iot-central"></a>比较 Azure IoT 解决方案加速器和 Microsoft IoT Central

选择 Azure IoT 产品是规划 IoT 解决方案的重要一环。 IoT 中心是单项 Azure 服务，其本身不提供端到端 IoT 解决方案。 任何 IoT 解决方案都可以从 IoT 中心入手，不需使用 Azure IoT 解决方案加速器或 Microsoft IoT Central 即可使用它。 Azure IoT 解决方案加速器和 Microsoft IoT Central 都使用 IoT 中心以及其他 Azure 服务。 下表汇总了 Azure IoT 解决方案加速器和 Microsoft IoT Central 之间的主要差异，你可以根据要求进行正确的选择：

|                        | Azure IoT 解决方案加速器 | Microsoft IoT Central |
| ---------------------- | --------- | ----------- |
...
* **Azure IoT 解决方案加速器**[Azure IoT 解决方案加速器是什么？](iot-suite-what-are-solution-accelerators.md)
