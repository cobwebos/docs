---
title: Azure IoT 预配置解决方案 | Microsoft Docs
...
> [!NOTE]
> 若要部署预配置解决方案之一，请访问 [Microsoft Azure IoT 套件][lnk-azureiotsuite]。[IoT 预配置解决方案入门][lnk-getstarted-preconfigured]这篇文章介绍了有关如何部署并运行其中一个解决方案的详细信息。
> 
> 
