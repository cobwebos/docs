...
![连接的工厂解决方案仪表板](media/iot-suite-connected-factory-features/dashboard.png)
...
[为警报配置基于阈值的规则](iot-suite-connected-factory-configure.md)。
...
- [自定义](iot-suite-v1-guidance-on-customizing-preconfigured-solutions.md)解决方案来满足特定的业务需求。
