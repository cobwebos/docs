...
1. 要克隆 “Azure IoT SDK” GitHub 存储库并在桌面环境中安装“适用于 Node.js 的 Azure IoT 设备 SDK”，请按照[准备开发环境][lnk-github-prepare]说明进行操作。
...
[lnk-github-prepare]: /documentation/articles/node-devbox-setup
