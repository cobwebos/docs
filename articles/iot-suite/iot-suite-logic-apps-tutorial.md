...
10. 输入连接名称，例如 **SendGridConnection**，输入设置 SendGrid 帐户时创建的 **SendGrid API 密钥**，然后单击“**创建**”。
    
    ![](media/iot-suite-logic-apps-tutorial/sendgridconnection.png)
11. 在“**发件人**”和“**收件人**”字段中添加你自己的电子邮件地址。 将“**远程监视警报 [DeviceId]**”添加到“**主题**”字段。 在“**电子邮件正文**”字段中，添加“**设备 [DeviceId] 已报告具有值 [measuredValue] 的 [measurementName]**”。 可以通过在**你可以从前面的步骤插入数据**部分中单击，添加 **[DeviceId]**、**[measurementName]** 和 **[measuredValue]**。
