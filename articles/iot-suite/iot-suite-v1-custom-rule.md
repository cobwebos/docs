...
## <a name="rule-storage-locations"></a>规则存储位置
...
## <a name="update-the-remotemonitoring-visual-studio-solution"></a>更新 RemoteMonitoring Visual Studio 解决方案
...
## <a name="rebuild-and-redeploy-the-solution"></a>重新生成并重新部署解决方案。
...
## <a name="update-the-stream-analytics-job"></a>更新流分析作业
...
## <a name="add-your-new-rule-in-the-dashboard"></a>在仪表板中添加新规则
