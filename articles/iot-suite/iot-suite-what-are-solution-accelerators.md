...
* [预测性维护](iot-suite-predictive-overview.md)
...
| [预测性维护](iot-suite-predictive-overview.md)   |是 |是 |-   |-   |是 |是 |是 |
...
新版远程监视解决方案加速器使用微服务体系结构。 此解决方案加速器由多个微服务（例如 IoT 中心管理器和存储管理器）组成。 每个微服务的 Java 和 .NET 版及其相关的开发人员文档均可供下载。 有关微服务的详细信息，请参阅[远程监视体系结构](iot-suite-remote-monitoring-sample-walkthrough.md)。
...
* [了解远程监视解决方案](iot-suite-remote-monitoring-explore.md)。
* [预测性维护解决方案加速器概述](iot-suite-predictive-overview.md)。
* [连接工厂解决方案加速器入门](iot-suite-connected-factory-overview.md)。
