---
title: "MyDriving Azure IoT 示例：快速入门 | Microsoft Docs"
description: "开始使用一个应用，该应用全面演示如何通过使用 Microsoft Azure（包括流分析、机器学习和事件中心）构建 IoT 系统。"
services: 
...
## <a name="use-the-mobile-experience"></a>使用移动体验
如果你有 Android、iOS 或 Windows 10 设备，则可以使用 MyDriving 应用。

### <a name="android-and-windows-10-mobile-installation"></a>Android 和 Windows 10 移动版安装
在设备上：
...
### <a name="ios-installation"></a>iOS 安装
...
3. 从 HockeyApp 为 beta 版本授权：
   ...
   a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 转到“**设置** > **常规** > **配置文件和设备管理**”。
...
有关详细信息，请参阅 [MyDriving 参考指南](http://aka.ms/mydrivingdocs)。

## <a name="get-an-obd-adapter-optional"></a>获取 OBD 适配器（可选）
...
2. 获取 OBD 适配器：
   ...
   * 如果你正在使用 Android 或 Windows 手机，你将需要启用蓝牙的 OBD II 适配器。 我们使用 [BAFX Products 34t5 Bluetooth OBDII 扫描工具]。
   * 如果你使用的是 iOS 手机，则需要启用 Wi-Fi 的 OBD 适配器。 我们使用 [ScanTool OBDLink MX Wi-Fi：OBD 适配器/诊断扫描仪]。
...
有关应用如何使用 OBD 适配器中的数据，以及有关在 2.1 节“IoT 设备”中描述的用于创建你自己 OBD 设备的选项的详细信息，请参阅 [MyDriving 参考指南](http://aka.ms/mydrivingdocs)。

## <a name="use-the-app"></a>使用应用
启动应用。 有一个初始快速入门可帮助你了解其工作原理。

### <a name="track-your-trips"></a>跟踪你的行程
...
### <a name="review-your-trips"></a>回顾你的行程
![过去的行程示例](./media/iot-solution-get-started/image4.png)

### <a name="review-your-profile"></a>回顾你的配置文件
![驾驶方式配置文件示例](./media/iot-solution-get-started/image5.png)

## <a name="send-us-your-test-feedback"></a>向我们发送你的测试反馈
...
在 MyDriving 应用内部，你可以使用内置的 HockeyApp 反馈机制：只需摇一摇你的 iOS 和 Android 手机或使用“**反馈**”菜单命令即可。 这将自动附加屏幕截图，这样我们便能了解你想说明的内容。 如果不幸出现了故障，HockeyApp 将收集故障日志并告知我们。 你也可以通过 [HockeyApp 门户]提供反馈。

你也可以在 [GitHub 上提出问题]，或者在下面留言（英文版）。

我们期待收到你的反馈！

## <a name="next-steps"></a>后续步骤
* 浏览 [MyDriving 参考指南](http://aka.ms/mydrivingdocs)，了解我们如何设计并生成整个 MyDriving 系统。
* 使用我们的 Azure Resource Manager 脚本[创建和部署你自己的系统](iot-solution-build-system.md)。 [MyDriving 参考指南](http://aka.ms/mydrivingdocs)还将指导你了解你将进行最多自定义操作的区域。
...
[BAFX Products 34t5 Bluetooth OBDII 扫描工具]: http://www.amazon.com/gp/product/B005NLQAHS
[ScanTool OBDLink MX Wi-Fi：OBD 适配器/诊断扫描仪]: http://www.amazon.com/gp/product/B00OCYXTYY/ref=s9_simh_gw_g263_i1_r?pf_rd_m=ATVPDKIKX0DER&pf_rd_s=desktop-2&pf_rd_r=1MWRMKXK4KK9VYMJ44MP
