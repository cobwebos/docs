...
当设备首次连接到解决方案后，它会将其元数据发送到解决方案。当你通过解决方案仪表板编辑设备元数据时，会将新的元数据值发送到设备，并将新值存储在解决方案的 DocumentDB 数据库中。有关详细信息，请参阅 [Device identity registry and DocumentDB][lnk-devicemetadata]（设备标识注册表和 DocumentDB）。
...
[lnk-rm-walkthrough]: /documentation/articles/iot-suite/iot-suite-remote-monitoring-sample-walkthrough/
[lnk-connect-rm]: /documentation/articles/iot-suite/iot-suite-connecting-devices/
