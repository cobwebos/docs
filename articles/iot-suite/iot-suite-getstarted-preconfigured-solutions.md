...
该作业在所有通过筛选器选择的设备上调用 **InitiateFirmwareUpdate** 直接方法。 设备会即时响应 IoT 中心，然后异步启动固件更新过程。 设备通过报告的属性值提供有关固件更新过程的状态信息，如以下屏幕截图所示。 请选择“刷新”图标更新设备和作业列表中的信息：
...
1. 导航回仪表板。 一小段时间之后，将在新设备所报告的温度超过 47 度阈值时，在“警报历史记录”  窗格中看到新的条目：
