---
title: "安装 Azure 命令行接口 | Microsoft Docs"
...
## <a name="run-azure-cli-commands"></a>运行 Azure CLI 命令
...
* 如果需要，还可以尝试基于 Python 的 [Azure CLI 2.0 预览版](https://github.com/azure/azure-cli)。
