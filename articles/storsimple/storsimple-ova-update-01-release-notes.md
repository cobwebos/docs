...
下表提供了 StorSimple Virtual Array 的已知问题的摘要，包括早期版本中发行说明的问题。 **此版本中注意到的问题版本标有星号。此列表中几乎所有问题都从 StorSimple 虚拟阵列的 GA 版本中转移过来。**
...
| **12.** |CHAP |CHAP 凭据一旦创建之后便无法删除。 此外，如果要修改 CHAP 凭据，首先需要使这些卷脱机，再使它们联机，以使更改生效。 |这些问题会在更高版本中得以解决。 |
...
[在](storsimple-ova-install-update-01.md)StorSimple 虚拟阵列上安装更新。
