...
本文介绍通过本地 Web UI 和 Azure 门户在 StorSimple Virtual Array 上安装 Update 0.5 所需的步骤。 你需要应用软件更新或修补程序，使 StorSimple Virtual Array 保持最新。
...
完成安装后，转到 StorSimple Device Manager 服务。 选择“设备”，然后选择并单击刚刚更新的设备。 转到“设置”>“管理”>“设备更新”。 显示的软件版本应为 **10.0.10290.0**。
...
3. 在 Microsoft 更新目录的搜索框中，输入要下载的修补程序的知识库 (KB) 编号。 针对 Update 0.5 输入 **4021576**，然后单击“搜索”。
...
6. 打开文件所在的文件夹。
    ...
    - Geneva 监视代理程序包文件 `GenevaMonitoringAgentPackageInstaller`。 此文件用于更新监视和诊断服务 (MDS) 代理。 双击 cab 文件。 随即显示一个 .msi 文件。 选择该文件，右键单击然后“提取”该文件。 将使用该 _.msi_ 文件来更新代理。
...
5. 重新启动完成后，你将转到“登录”页。 若要验证设备软件是否已更新，请在本地 Web UI 中，转到“维护” > “软件更新”。 Update 0.5 显示的软件版本应为 **10.0.0.0.0.10290.0**。
