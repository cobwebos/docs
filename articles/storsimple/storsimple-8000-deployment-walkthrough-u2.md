...
---
# 部署本地 StorSimple 设备（Update 3 及更高版本）
<a id="deploy-your-on-premises-storsimple-device-update-3-and-later" class="xliff"></a>
...
这些教程中的信息均假定你已阅读安全预防措施，并已打开 StorSimple 设备包、装入机架，并连接好电缆。 如果你仍然需要执行这些任务，请从阅读 [安全预防措施](storsimple-8000-safety.md)开始。 按照设备具体说明，将设备解包、装入机架并连接好电缆。
...
| [步骤 3︰通过 Windows PowerShell for StorSimple 配置和注册设备](#step-3-configure-and-register-the-device-through-windows-powershell-for-storsimple) |若要使用管理服务完成设置，请将设备连接到网络并将其注册到 Azure。 |
...
## 部署配置清单
<a id="deployment-configuration-checklist" class="xliff"></a>
在部署设备之前，需要收集信息来配置 StorSimple 设备上的软件。 提前准备其中的一些信息有助于简化在你的环境中部署 StorSimple 设备的过程。 下载并使用此清单，以记下部署设备时的配置详细信息。
...
### 对于 StorSimple Device Manager 服务
<a id="for-the-storsimple-device-manager-service" class="xliff"></a>
在开始之前，请确保：
...
### 对于数据中心中的设备
<a id="for-the-device-in-the-datacenter" class="xliff"></a>
...
### 对于数据中心中的网络
<a id="for-the-network-in-the-datacenter" class="xliff"></a>
在开始之前，请确保：
...
## 逐步部署
<a id="step-by-step-deployment" class="xliff"></a>
使用下面的分步说明在数据中心部署 StorSimple 设备。

## 步骤 1：创建新服务
<a id="step-1-create-a-new-service" class="xliff"></a>
StorSimple Device Manager 服务可以管理多个 StorSimple 设备。 执行以下步骤创建 StorSimple Device Manager 服务实例。

[!INCLUDE [storsimple-create-new-service](../../includes/storsimple-8000-create-new-service.md)]

> [!IMPORTANT]
> 如果未启用服务的自动创建存储帐户，则在成功创建服务后，需要创建至少一个存储帐户。 在创建卷容器时将使用此存储帐户。
>
...
## 步骤 2：获取服务注册密钥
<a id="step-2-get-the-service-registration-key" class="xliff"></a>
...
<a id="step-3-configure-and-register-the-device-through-windows-powershell-for-storsimple" class="xliff"></a>
...
## 步骤 4：完成最低版本的设备安装
<a id="step-4-complete-minimum-device-setup" class="xliff"></a>
...
## 步骤 5：创建卷容器
<a id="step-5-create-a-volume-container" class="xliff"></a>
...
## 步骤 6：创建卷
<a id="step-6-create-a-volume" class="xliff"></a>
...
## 步骤 7：装载、初始化和格式化卷
<a id="step-7-mount-initialize-and-format-a-volume" class="xliff"></a>
...
## 步骤 8：执行备份
<a id="step-8-take-a-backup" class="xliff"></a>
...
## 针对服务配置新的存储帐户
<a id="configure-a-new-storage-account-for-the-service" class="xliff"></a>
...
## 使用 PuTTY 连接到设备串行控制台
<a id="use-putty-to-connect-to-the-device-serial-console" class="xliff"></a>
