...
11. 在 **“高级设置”** 对话框中，执行以下操作：
    ...
    1. 在**本地适配器**下拉列表中，选择 Microsoft iSCSI 开始器。
...
> [!IMPORTANT]
> **我们建议您不要混合 1 GbE 和 10 GbE 网络接口。如果使用两个网络接口，则两个接口的类型应相同。**
...
12. 要查看会话中显示的设备，请选择"**设备**"选项卡。要为所选设备配置 MPIO 策略，请单击**MPIO**。 此时将显示 **“设备详细信息”** 对话框。 在 **“MPIO”** 选项卡上，你可以选择相应的 **“负载平衡策略”** 设置。 还可以查看 **“活动”** 或 **“备用”** 路径类型。
