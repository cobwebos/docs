...
1. 在本地 Web UI 中，转到“维护” > “软件更新”。 记下运行的软件版本。 **仅当运行 Update 1 （10.0.10296.0）时才继续此更新。如果运行的是更新0.6，请先在设备上[安装 update 1](storsimple-virtual-array-install-update-1.md) ，然后应用更新1.1。**
