...
> [!IMPORTANT] 
> **仅当运行更新 1 （10.0.10296.0） 时，才继续此更新。如果运行更新 0.6，请先在设备上[安装更新 1，](storsimple-virtual-array-install-update-1.md)然后应用更新 1.1。**
...
1. 在本地 Web UI 中，转到**维护** > **软件更新**。 记下运行的软件版本。 **仅当运行更新 1 （10.0.10296.0） 时，才继续此更新。如果运行更新 0.6，请先在设备上[安装更新 1，](storsimple-virtual-array-install-update-1.md)然后应用更新 1.1。**
...
5. 重新启动完成后，会转到“登录”**** 页。 要验证设备软件是否已更新，请转到**维护** > **软件更新**。 对于 Update 1.1，显示的软件版本应该是 **10.0.0.0.0.10307**。
