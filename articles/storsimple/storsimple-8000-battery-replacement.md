---
title: 更换 Microsoft Azure StorSimple 8000 系列设备上的电池
...
2. 确定其中的电池发生故障的 PCM。 图 1 显示 StorSimple 设备的背面。
   ...
   | 4 |控制器 1 |
    ...
    ![设备 PCM 监控指示器 LED 底板](./media/storsimple-battery-replacement/IC740992.png)
...
4. 移除 PCM 之后，请抬起并旋转电池模块把手（如下图所示），并向上拉将电池移除。
    ...
    ![将电池从 PCM 取出](./media/storsimple-battery-replacement/IC741019.png)
