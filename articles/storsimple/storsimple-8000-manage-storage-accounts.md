...
* **自动生成的存储帐户** – 顾名思义，这种存储帐户是首次创建服务时自动生成的。 若要详细了解如何创建此存储帐户，请参阅[部署本地 StorSimple 设备](storsimple-8000-deployment-walkthrough-u2.md#step-1-create-a-new-service)中的[步骤 1：创建新服务](storsimple-8000-deployment-walkthrough-u2.md)。 
