...
> [!IMPORTANT] 
> **仅当运行更新 0.6 （10.0.10293.0） 时，才继续此更新。如果您正在运行早期版本，请先在设备上[安装更新 0.6，](storsimple-virtual-array-install-update-06.md)然后应用更新 1。**
...
1. 在本地 Web UI 中，转到**维护** > **软件更新**。 记下运行的软件版本。 **仅当运行更新 0.6 （10.0.10293.0） 时，才继续此更新。如果您正在运行早期版本，请先在设备上[安装更新 0.6，](storsimple-virtual-array-install-update-06.md)然后应用更新 1。**
...
5. 重新启动完成后，会转到“登录”**** 页。 要验证设备软件是否已更新，请转到**维护** > **软件更新**。 Update 1.0 显示的软件版本应为 10.0.0.0.0.10296****。
