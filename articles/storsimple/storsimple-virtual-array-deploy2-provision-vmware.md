---
title: "部署 Microsoft Azure StorSimple 虚拟阵列（在 VMware 中预配）| Microsoft 文档"
...
* 已查看部署 StorSimple 虚拟设备的网络要求，并已根据要求配置数据中心网络。 有关详细信息，请参阅 [StorSimple 虚拟阵列系统要求](storsimple-virtual-array-system-requirements.md)。
