...
---
# <a name="storsimple-8000-series-update-3-release-notes"></a>StorSimple 8000 系列 Update 3 发行说明
...
| 22 |更新 |应用 Update 3 时，Azure 经典门户的“**维护**”页将显示以下与 Update 2 相关的消息  -“StorSimple 8000 系列 Update 2 包括适用于 Microsoft 的功能，当我们检测到潜在问题时，Microsoft 会主动收集设备的日志信息”。 该消息可能会产生误导，因为它指示设备将被更新到 Update 2。 设备成功更新到 Update 3 后，此消息将消失。 |未来版本中将解决此行为。 |是 |否 |
