...
description: 介绍 StorSimple 8000 系列更新 2.2 的新功能、问题和解决方法。
services: storsimple
...
| 7 |Windows Management Instrumentation (WMI) |在以前的软件版本中，Web 代理失败的例子很多，但"\<管理异常>提供程序负载故障"。 此 bug 属于 WMI 内存泄露问题，现已修复。 |是 |否 |
