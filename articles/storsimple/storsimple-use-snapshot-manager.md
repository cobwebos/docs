...
---
# <a name="storsimple-snapshot-manager-user-interface"></a>StorSimple Snapshot Manager 用户界面
...
| 打开 |单击“**打开**”可打开现有的控制台。 |
| 保存 |单击“**保存**”可保存当前控制台。 |
| 另存为 |单击“**另存为**”可创建新的、已重命名的当前控制台的实例。 使用“**另存为**”选项可自定义并保存视图以供将来检索。 例如，可以创建指向特定服务器的 StorSimple Snapshot Manager 管理单元。 |
...
| 文件路径的列表 |单击编号列表中的路径以重新打开最近打开的文件。 |
| 退出 |单击“**退出**”可关闭“**文件**”菜单。 |
...
| 切换导入显示 |右键单击“**作用域**”窗格中的顶级节点（示例中的 **StorSimple Snapshot Manager** 节点）。 |单击“**切换导入显示**”以显示或隐藏从 StorSimple Manager 服务仪表板导入的卷组和关联的备份。 |
...
| 级联 |单击“**级联**”可显示以级联方式打开的控制台窗口。 |
| 横向平铺 |单击“**横向平铺**”可显示以磁贴（或网格）格式打开的控制台窗口。 |
...
可以使用“**作用域**”窗格完成特定节点上的操作。 若要选择任务，请执行以下任一操作：
...
* 若要查看可用操作的菜单，请右键单击“**设备**”节点或展开视图中显示的任何节点。
...
卷组也称为一致性组。 每个卷组都是一个与应用程序相关的卷的池，可用来帮助确保在备份操作过程中应用程序的一致性。 使用“**卷组**”节点可配置这些组并执行交互备份或创建备份计划。 

* 若要展开此节点，请单击“**卷组**”旁边的箭头图标。
* 若要查看可用操作的菜单，请右键单击“**卷组**”节点或展开视图中显示的任何节点。
* 若要查看卷组的列表，请单击“**作用域**”窗格中的“**卷组**”。 卷组列表以及每个卷组的相关信息都显示在“**结果**”窗格中。

### <a name="backup-policies-node"></a>备份策略节点
备份策略是本地快照和云快照的作业计划。 使用“**备份策略**”节点可指定创建备份的频率以及应保留备份的时间。 

* 若要展开此节点，请单击“**备份策略**”旁边的箭头图标。
* 若要查看可用操作的菜单，请右键单击“**备份策略**”节点或展开视图中显示的任何节点。
...
* 若要查看计划作业的列表，请展开“**作业**”节点，然后单击“**已计划**”。 以前配置的作业列表以及每个作业的相关信息都显示在“**结果**”窗格中。 
...
“**操作**”窗格是 StorSimple Snapshot Manager UI 中的右窗格。 它包含可以对在“**作用域**”或“**结果**”窗格中所选的节点、视图或数据执行的操作的菜单。 “**操作**”窗格包含与“**操作**”菜单相同的命令，后者可用于“**作用域**”和“**结果**”窗格中的项目。 有关每个操作的说明，请参阅“**操作**”菜单部分中的表。
