...
使用“**操作**”菜单从可用操作中进行选择。 可供你使用的项取决于在“**作用域**”窗格或“**结果**”窗格中所做的选择。

#### <a name="menu-access"></a>菜单访问
若要查看“**操作**”菜单，请执行以下操作之一：

* 右键单击“**作用域**”窗格或“**结果**”窗格中的项。
* 选择“**作用域**”窗格或“**结果**”窗格中的项，并单击菜单栏上的“**操作**”。 

例如，如果选择“**作用域**”窗格中的顶级节点，然后右键单击或单击菜单栏中的“**操作**”，即出现以下菜单。
...
* 若要查看节点的状态或内容，请单击节点名称。 这些信息会显示在“**结果**”窗格中。 
...
* 要查看已计划作业的列表，请展开“**作业**”节点，并单击“**已计划**”。 此前配置的作业列表以及每个作业的相关信息都显示在“**结果**”窗格中。 
* 要查看最近完成的作业列表，请展开“**作业**”节点，并单击“**过去 24 小时**”。 过去 24 小时内完成的作业列表会显示在“**结果**”窗格中。 “**结果**”窗格还包含每个已完成作业的相关信息。
* 要查看当前正在运行的作业列表，请展开“**作业**”节点，并单击“**正在运行**”。 当前正在运行的作业列表以及每个作业的相关信息都显示在“**结果**”窗格中。
...
要查看以下示例，请在“**作用域**”窗格中展开“**作业**”节点，并单击“**已计划**”。 “**操作**”窗格中显示“**已计划**”节点的可用操作。

![“操作”窗格中的计划作业示例](./media/storsimple-use-snapshot-manager/HCS_SSM_ActionsPane.png) 

要查看更多选项，请在“**作用域**”窗格中展开“**作业**”节点，单击“**已计划**”，并单击“**结果**”窗格中的计划作业。 “**操作**”窗格中显示计划作业的可用操作，如以下示例所示。
