...
你在部署 StorSimple 解决方案期间[创建了一个卷](storsimple-deployment-walkthrough-u2.md#step-6-create-a-volume)。 添加卷的过程与此类似。
...
5. 如果卷已脱机，可以在“其他设置”下修改 ACR。 如果卷已联机，需要先将它脱机。 修改 ACR 之前，请参阅[使卷脱机](#take-a-volume-offline)中的步骤。
   ...
   > 
   > 
6. 单击勾选图标保存更改 ![check-icon](./media/storsimple-manage-volumes-u2/HCS_CheckIcon.png)。 Azure 经典门户将显示一条正在更新卷消息。 成功更新卷后，它将显示一条成功消息。
