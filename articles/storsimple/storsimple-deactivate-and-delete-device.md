...
2. 通过以下操作停用设备：
   ...
   1. 在 StorSimple Manager 服务的“设备”页上，选择要停用的设备，然后在页面底部单击“停用”。
   2. 将显示确认消息。 单击“是”继续。 停用过程将开始，需要花费几分钟时间才能完成。
...
对于 StorSimple 虚拟设备，停用会释放虚拟机。 然后，用户就可以删除虚拟机以及在预配虚拟机时创建的资源。 停用虚拟设备之后，无法将它还原到以前的状态。 
