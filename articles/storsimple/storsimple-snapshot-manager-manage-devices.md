...
1. 重新配置到新设备的 iSCSI 连接。 有关说明，请转到[部署本地 StorSimple 设备](storsimple-deployment-walkthrough-u2.md)中的“步骤 7：装载、初始化和格式化卷”。 
...
5. 若要配置新 StorSimple 设备，请完成[部署 StorSimple Snapshot Manager](storsimple-snapshot-manager-deployment.md) 中“步骤 2：连接 StorSimple 设备”中的步骤。 
