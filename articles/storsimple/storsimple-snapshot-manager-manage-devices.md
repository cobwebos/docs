...
如果右键单击 **“作用域”** 窗格中的 **“设备”** 节点，则可以从以下操作中进行选择：

* 添加或替换设备
* 连接设备并验证导入
* 刷新连接的设备

如果单击 **“设备”** 节点，然后右键单击 **“结果”** 窗格中的设备名称，则可以从以下操作中进行选择：
...
1. 要将设备连接到 StorSimple Snapshot Manager，请按照“添加或替换设备”中的说明进行操作。 连接到设备后，StorSimpleSnapshot Manager 会做出如下响应：
   ...
   * 如果设备可用，则 StorSimple Snapshot Manager 会添加一个连接。 选择设备后，设备将显示在 **“结果”** 窗格中，并且状态字段将指示该设备 **“可用”** 。 StorSimple Snapshot Manager 会导入为该设备配置的任何卷组，前提是这些卷组具有关联的备份。 备份策略将不导入。 没有关联备份的卷组将不被导入。
2. 单击桌面图标启动 StorSimple Snapshot Manager。
3. 右键单击 **“作用域”** 窗格中的顶级节点，然后单击 **“切换导入显示”** 。
   
    ![选择切换导入显示](./media/storsimple-snapshot-manager-manage-devices/HCS_SSM_Toggle_Imports_Display.png) 
...
1. 单击桌面图标启动 StorSimple Snapshot Manager。
2. 在 **“作用域”** 窗格中，单击 **“设备”** 。
3. 在 **“结果”** 窗格中，右键单击设备名称，然后单击 **“身份验证”** 。
4. 此时将显示 **“身份验证”** 对话框。 键入设备密码，然后单击 **“确定”** 。
...
1. 单击桌面图标启动 StorSimple Snapshot Manager。 
2. 在 **“作用域”** 窗格中，单击 **“设备”** 。 
3. 在 **“结果”** 窗格中，右键单击设备名称，然后单击 **“刷新设备”** 。 这会同步该设备与 StorSimple Snapshot Manager。
...
1. 单击桌面图标启动 StorSimple Snapshot Manager。
2. 在 **“作用域”** 窗格中，单击 **“设备”** 。 
3. 在 **“结果”** 窗格中，右键单击设备名称，然后单击 **“删除”** 。 
4. 此时会显示以下消息。 单击 **“是”** 以删除配置，或者单击 **“否”** 以取消删除。
