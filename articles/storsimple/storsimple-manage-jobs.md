...
* **状态** – 作业状态可以是正在运行、已计划、失败、已完成、正在取消或已取消。
* **类型** – 可以通过计划内备份、按需备份（**单次备份**）、克隆、设备还原或更新操作创建作业。
...
* **类型** – 备份、克隆、还原、故障转移或更新。
* **状态** – 正在运行、已计划、失败、已完成、正在取消或已取消。
* **实体** – 作业可以与卷、备份策略或设备相关联。 克隆作业与卷相关联，计划备份作业与备份策略相关联。 设备作业是在执行灾难恢复 (DR) 或还原操作后创建的。
* **设备** – 在其上启动作业的设备的名称。
* **启动时间** – 启动作业的时间。
