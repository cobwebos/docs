...
[!INCLUDE [创建虚拟设备](../../includes/storsimple-create-virtual-device-u2.md)]

### 步骤 2：配置和注册虚拟设备
开始此过程之前，请确保已获得服务数据加密密钥的副本。服务数据加密密钥是在配置第一个 StorSimple 设备时创建的，系统已指示将它保存在安全位置。如果没有服务数据加密密钥的副本，则必须联系 Microsoft 支持部门获得帮助。

执行以下步骤配置和注册 StorSimple 虚拟设备。[!INCLUDE [配置和注册虚拟设备](../../includes/storsimple-configure-register-virtual-device.md)]
...
[!INCLUDE [通过 HTTP 为虚拟设备配置远程管理](../../includes/storsimple-configure-remote-management-http-device.md)]
...
[!INCLUDE [在虚拟设备上创建公共终结点](../../includes/storsimple-create-public-endpoints-virtual-device.md)]
...
[!INCLUDE [停止和重新启动虚拟设备](../../includes/storsimple-stop-restart-virtual-device.md)]
...
[!INCLUDE [关闭虚拟设备](../../includes/storsimple-shutdown-virtual-device.md)]

[!INCLUDE [删除虚拟设备](../../includes/storsimple-delete-virtual-device.md)]
