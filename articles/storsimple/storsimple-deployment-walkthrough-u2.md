...
> * [版本公开上市](storsimple-deployment-walkthrough.md)
> 
> 
...
> [!IMPORTANT]
> 如果未启用服务的自动创建存储帐户，则在成功创建服务后，将需要创建至少一个存储帐户。在创建卷容器时将会使用此帐户。
> 
...
[!INCLUDE [使用 PuTTY 连接到设备串行控制台](../../includes/storsimple-use-putty.md)]
...
[!INCLUDE [创建手动备份](../../includes/storsimple-get-iqn.md)]

## 创建手动备份
请在管理门户执行以下步骤，以在 StorSimple 设备上为单独的卷创建一个按需手动备份。

[!INCLUDE [创建手动备份](../../includes/storsimple-create-manual-backup.md)]
