<properties pageTitle="通过 Exchange 提供商配置 ExpressRoute" description="本教程将指导你通过 Exchange 提供商 (EXP) 设置 ExpressRoute。" documentationCenter="na" services="expressroute" authors="cherylmc" manager="adinah" editor="tysonn"/>
...
8. **配置虚拟网络和网关。**
	...
	请参阅[为 ExpressRoute 配置虚拟网络和网关](https://msdn.microsoft.com/zh-cn/library/azure/dn643737.aspx)。请注意，网关子网必须是 /28 才能用于 ExpressRoute 连接。
