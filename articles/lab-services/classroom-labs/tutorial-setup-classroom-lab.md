...
1. 实验室帐户创建者将其他用户添加到“实验室创建者”角色。  例如，实验室帐户创建者/管理员将教授添加到“实验室创建者”角色，这样教授就可以创建课堂实验室。  
2. 然后，教授为其课堂创建带 VM 的实验室，并向课堂中的学生发送注册链接。 
3. 学生使用从教授处接收的注册链接注册到实验室。 注册以后，他们可以使用实验室中的 VM 完成课堂作业和家庭作业。 
