...
| ------------------- | ------------ |
| Marketplace 映像 | 启用[Data Science Virtual Machine-Windows 2016](https://azuremarketplace.microsoft.com/marketplace/apps/microsoft-dsvm.dsvm-windows)映像以便在实验室帐户中使用。 |
