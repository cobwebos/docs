...
本文概述了如何在实验室服务中设置模板计算机，以及如何使用[Jupyter 笔记本](http://jupyter-notebook.readthedocs.io)讲授学生所需的工具。  Jupyter Notebooks 是一个开源项目，可让你轻松地在名为“笔记本”的单张画布上组合使用丰富的文本和可执行的 [Python](https://www.python.org/) 源代码。  运行笔记本会生成输入和输出的线性记录。  这些输出可能包括文本、信息表、散点图等。
...
| 实验室帐户设置 | 说明 |
| ------------------- | ------------ |
| 市场映像 | 启用[Data Science Virtual Machine-Windows 2019](https://azuremarketplace.microsoft.com/marketplace/apps/microsoft-dsvm.dsvm-win-2019)映像以便在实验室帐户中使用。 |

>[!TIP]
>本文重点介绍如何配置使用 Windows Server 操作系统的模板计算机。  还可以使用 Azure Marketplace 中的[适用于 Linux （Ubuntu）的 Data Science Virtual Machine For Linux （Ubuntu）](https://azuremarketplace.microsoft.com/marketplace/apps/microsoft-dsvm.ubuntu-1804)映像设置具有 Python 和 Jupyter 笔记本的数据科学类。
...
25名\*学生（20个计划小时 + 10 个\*配额小时） \* 139 实验室单位0.01 美元/小时 = 1042.5 USD
