...
下面的脚本适用于指定的 VM 指定的项目。 [Invoke-azurermresourceaction](/powershell/module/azurerm.resources/invoke-azurermresourceaction?view=azurermps-6.13.0)命令是执行该操作。  
