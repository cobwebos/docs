...
此设置与在未启用 "按需 OneDrive 文件" 的设备上以无提示方式登录用户的 Windows 凭据一起使用。 如果任何用户的 OneDrive 大于指定的阈值（以 MB 为单位），则在 OneDrive 同步客户端（OneDrive.exe）下载文件之前，系统将提示其选择要同步的文件夹。  在我们的示例中，"1111-2222-3333-4444" 是 Office 365 租户 ID，0005000将阈值设置为 5 GB。
