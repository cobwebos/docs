...
1. 中转到团队集合的主页（例如`https://contoso-web-team.visualstudio.com`），然后选择你的项目。
2. 在项目主页上，选择“代码”****。
...
| ArtifactRepositoryDisplayName | 项目存储库的显示名称。 这是在 Azure 门户中显示的名称（https://portal.azure.com)查看实验室的所有项目存储库时）。 |
