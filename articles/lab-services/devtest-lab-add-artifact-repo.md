...
* 要了解如何创建具有 Git 存储库的 Azure DevOps 服务项目，请参阅[连接到 Azure DevOps 服务](https://www.visualstudio.com/get-started/setup/connect-to-visual-studio-online)。
