...
每个标记由**名称**/**值**对组成。 例如，可以创建一个标记，其中名称 costcenter** 对应的值为 34543**。 此类标记可能有助于稍后发现在组织的这一特定区域可计费的实验室资源。 可以选择对所需订阅整理方式有意义的名称和值。

## <a name="steps-to-manage-tags-in-an-existing-lab"></a>在现有实验室中管理标记的具体步骤

1. 登录到 Azure[门户](https://go.microsoft.com/fwlink/p/?LinkID=525040)。
1. 如果需要，请选择“所有服务”****，并从列表中选择“开发测试实验室”****。 您的实验室可能已经显示在 **"所有资源**"下的仪表板上。
...
1. 在左侧的“管理”**** 下，选择“标记”****。
1. 要为此实验室创建新标记，请输入**名称**/**值**对并选择 **"保存**"。 还可以从列表中选择现有标记，从而查看或管理与此标记相关联的资源。

    ![管理标记](./media/devtest-lab-add-tag/devtestlab-manage-tags.png)

> [!NOTE]
> 在实验室级别创建的标记流经实验室在订阅中旋转的所有计费资源。 例如，实验室级标记流向实验室 VM 的基础计算 VM。 实验室级别标记显示在成本管理的标签筛选器中。
...
* 浏览[DevTest 实验室 Azure 资源管理器快速入门模板库](https://github.com/Azure/azure-devtestlab/tree/master/samples/DevTestLabs/QuickStartTemplates)。
