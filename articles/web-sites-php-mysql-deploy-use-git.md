...
> [WACN.NOTE]
> If you are performing this tutorial on Windows, you can set up your machine for PHP and automatically configure IIS (the built-in web server in Windows) by installing the <a href="http://www.windowsazure.cn/zh-cn/downloads/?sdk=php">Azure SDK for PHP</a>.
...
3. Browse to **http://[site name].chinacloudsites.cn/index.php** to see your application and any changes you may have made:
