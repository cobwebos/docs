...
1. 在[Azure 门户](https://portal.azure.com)的 "主页" 中，单击 " **+ 创建资源**"。

1. 在 "**新建**" 页上的 "*搜索应用商店"* 字段中，键入**堡垒**，然后单击**Enter**转到搜索结果。

1. 在结果中，单击 "**堡垒**"。 请确保发布者是*Microsoft* ，并且类别为 "*网络*"。
...
1. 打开 [Azure 门户](https://portal.azure.com)。 导航到你的虚拟机，然后单击 "**连接**"。
