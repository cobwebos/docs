---
title: Azure IoT 安全模块基础知识的概念说明-Azure RTO
description: 了解有关 Azure RTO IoT 安全模块概念和工作流的基础知识。
...
为 IoT 设备免费下载提供 Azure RTO 安全模块。 适用于 IoT 云服务的 Azure 安全中心，每个 Azure 订阅30天试用版。 [立即下载安全模块](https://github.com/azure-rtos/azure-iot-preview/releases) ，让我们开始吧。 
