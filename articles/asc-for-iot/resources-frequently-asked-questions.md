...
虽然其他解决方案提供了一组功能，允许客户创建自己的解决方案，但 IoT Azure 安全中心提供了独特的端到端 IoT 安全解决方案，可在所有相关 Azure 资源的安全性范围内提供广泛的视图。 Azure 支持快速部署和与 IoT 中心模块孪生完全集成，以便轻松与现有设备管理工具集成。
...
1. 创建您自己的代理并实现适用于 IoT 安全消息架构的 Microsoft Azure 安全中心。 此选项允许在设备安全代理之上使用 Microsoft Azure 安全中心进行 IoT 分析工具。

1. IoT 设备上没有安全代理安装。 此选项支持 IoT 中心通信监视，降低了安全监视和管理功能。
...
1. 检查[服务已成功启用](quickstart-onboard-iot-hub.md)到 IoT 中心中的 **"安全**"。

1. 检查设备是否[配置在 IoT 中心与 IoT 模块的 Azure 安全中心](quickstart-create-security-twin.md)。
