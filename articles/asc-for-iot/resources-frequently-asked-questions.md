...
适用于 IoT security agent 的 Azure 安全中心是开放源代码, 在 GitHub 上的32位和64位 Windows 和 Linux 版本中 https://github.com/Azure/Azure-Security-IoT 提供:。

## <a name="where-does-the-azure-security-center-for-iot-agent-get-installed"></a>用于 IoT 代理的 Azure 安全中心安装在何处？ 

可在 GitHub 中找到详细的安装和代理部署信息 https://github.com/Azure/Azure-Security-IoT:。
...
## <a name="what-next-ive-installed-an-agent-and-dont-see-any-activities-or-logs"></a>接下来执行什么操作? 我安装了一个代理, 但没有看到任何活动或日志 。
