---
title: 配置 ASC for IoT 解决方案（预览）| Microsoft Docs
description: 了解如何使用 ASC for IoT 配置端到端的 IoT 解决方案。
services: ascforiot
...
使用 ASC for IoT， 可在一个仪表板中监视整个 IoT 解决方案，并显示 Azure 中你的所有 IoT 设备、IoT 平台和后端资源。
