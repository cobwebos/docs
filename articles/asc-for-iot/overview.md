---
title: 服务概述
description: 了解有关 Azure 安全中心 IoT 功能和服务的详细信息，并了解 Azure 安全中心 IoT 如何提供全面的 IoT 安全性。
...
用于 IoT 的 Azure 安全中心通过在边缘、本地、Azure 和其他云中运行的工作负荷提供统一的可见性和控制、自适应威胁防护以及智能威胁检测和响应，简化混合工作负荷保护。
