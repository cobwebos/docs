---
title: '安全代理本地配置 (c # ) '
description: '了解有关适用于 Azure 的 Azure 安全中心的详细信息，请参阅适用于 c # 的安全代理本地配置文件。'
...
| deviceId | string | 在 Azure IoT 中心) 中注册的设备 ID (。 || schedulerInterval | TimeSpan 字符串 | 内部计划程序间隔。 |
