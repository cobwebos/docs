---
title: 了解适用于的代理本地配置文件的C# Azure 安全中心 |Microsoft Docs
description: 了解适用于的代理本地配置文件的C#Azure 安全中心。
...
| gatewayHostname | string | Azure Iot 中心的主机名。 通常 < 集线器 >。 devices.net |
