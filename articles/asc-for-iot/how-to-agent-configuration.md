---
title: Azure 安全中心配置适用于 IoT 代理预览 |Microsoft Docs
description: 了解如何为 IoT 与 Azure 安全中心配置为使用代理。
...
本文介绍 Azure 安全中心 (ASC) 的 IoT 安全代理，如何更改它们 ASC 为 IoT 安全代理配置。
...
|事件名称| PropertyName | Default Value| 快照事件| 详细信息状态  |
|----------|------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------|---------------|
