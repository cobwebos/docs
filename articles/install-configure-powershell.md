...
> [WACN.NOTE] A variety of subscription options are available. For information, see [Get Started with Azure](http://go.microsoft.com/fwlink/p/?LinkId=320795).
...
3. To check the state of the website, type:
	...
	> [WACN.NOTE] Run as shown, this command lists information about all the web sites associated with the current subscription.
