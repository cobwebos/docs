<properties
    pageTitle="创建包含事件中心和使用者组的服务总线命名空间 | Azure"
    description="使用 ARM 模板创建包含事件中心和使用者组的服务总线命名空间"
...
# 使用 ARM 模板创建包含事件中心和使用者组的服务总线命名空间

本文介绍如何使用创建包含事件中心和使用者组的服务总线命名空间的 Azure Resource Manager (ARM) 模板。你将了解如何定义要部署的资源以及如何定义执行部署时指定的参数。可将此模板用于自己的部署，或自定义此模板以满足要求
...
了解有关 [Azure 事件中心](/documentation/articles/event-hubs-what-is-event-hubs)的详细信息。

若要自动运行部署，请单击以下按钮：

[![部署到 Azure](./media/service-bus-arm-namespace-event-hub/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2F201-servicebus-create-eventhub-and-consumergroup%2Fazuredeploy.json)
