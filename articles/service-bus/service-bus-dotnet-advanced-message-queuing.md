<properties 
	pageTitle="如何将 AMQP 1.0 用于 .NET 服务总线 API | Microsoft Azure" 
...
其中，[namespace] 和 [SAS key] 可从 Azure 管理门户获得。有关详细信息，请参阅 [如何使用服务总线队列](/develop/net/how-to-guides/service-bus-queues/)。
