...
> [AZURE.NOTE]在从 Service Bus 主题订阅中接收时，在 JNDI 中指定的物理名称应该是该主题的名称。在 JMS 应用程序代码中创建可持久订阅时提供该订阅名称。[服务总线 AMQP 1.0 开发人员指南](http://msdn.microsoft.com/library/jj841071.aspx)提供了有关从 JMS 使用服务总线主题订阅的详细信息。
