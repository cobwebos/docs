<properties
    pageTitle="使用 ARM 模板创建服务总线授权规则 | Azure"
    description="使用 ARM 模板为命名空间和队列创建服务总线授权规则"
...
# 使用 ARM 模板为命名空间和队列创建服务总线授权规则

本文介绍如何使用为服务总线命名空间和队列创建授权规则的 Azure Resource Manager (ARM) 模板。你将了解如何定义要部署的资源以及如何定义执行部署时指定的参数。可将此模板用于自己的部署，或自定义此模板以满足要求。
...
[![部署到 Azure](./media/service-bus-arm-namespace-auth-rule/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2F301-servicebus-create-authrule-namespace-and-queue%2Fazuredeploy.json)
