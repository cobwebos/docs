...
[Azure 自动化](/documentation/articles/automation/automation-intro.md)是用于通过流程自动化和所需的状态配置简化云管理的一项 Azure 服务。使用 Azure 自动化可以自动完成那些人工操作、重复、长时间运行且易出错的任务，从而改善组织的可靠性、效率和价值生成时间。
...
* 请参阅 Azure 自动化[入门教程](/documentation/articles/automation/automation-first-runbook-graphical/)
* 了解如何[使用 PowerShell 管理服务总线](/documentation/articles/automation/service-bus-powershell-how-to-provision/)
