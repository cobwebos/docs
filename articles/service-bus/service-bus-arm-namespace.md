<properties
    pageTitle="使用 ARM 模板创建服务总线命名空间 | Azure"
...
本文介绍如何使用创建包含标准/基本 SKU 的服务总线“消息传送”命名空间的 Azure Resource Manager (ARM) 模板。本文还定义了为执行部署指定的参数。可将此模板用于自己的部署，或自定义此模板以满足要求。
...
[![部署到 Azure](./media/service-bus-arm-namespace/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2F101-servicebus-create-namespace%2Fazuredeploy.json)
...
此外，每个月只需支付 10 美元的标准层基础费用，便可执行最多 1250 万个操作，无任何其他费用。基本层每 100 万次操作花费 0.05 美元。
...
- [使用 Azure 自动化管理 Azure Service Bus](/pricing/details/service-bus/service-bus-automation-manage)
- [使用 PowerShell 管理服务总线](/pricing/details/service-bus/service-bus-powershell-how-to-provision)
- [使用服务总线资源管理器管理服务总线资源](https://code.msdn.microsoft.com/Service-Bus-Explorer-f2abca5a)

  [创作 Azure Resource Manager 模板]: /pricing/details/service-bus/resource-group-authoring-templates.md
  ...
  [Using Azure PowerShell with Azure Resource Manager]: /pricing/details/service-bus/powershell-azure-resource-manager
  [Using the Azure CLI for Mac, Linux, and Windows with Azure Resource Management]: /pricing/details/service-bus/xplat-cli-azure-resource-manager
