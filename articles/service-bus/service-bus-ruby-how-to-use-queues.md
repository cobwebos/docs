...
有关本文中讨论的 Azure 服务总线队列与[如何使用 Azure 队列服务](/develop/ruby/how-to-guides/queue-service/)一文中讨论的 Azure 队列的比较，请参阅 [Azure 队列和 Azure 服务总线队列 - 比较与对照](http://msdn.microsoft.com/zh-cn/library/windowsazure/hh767287.aspx)
