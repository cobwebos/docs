...
若要开始在 Azure 中使用服务总线队列，必须先创建一个服务命名空间。服务命名空间提供了用于对应用程序中的服务总线资源进行寻址的范围容器。必须通过命令行界面创建命名空间，因为门户不会使用 ACS 连接创建服务总线。
...
> [AZURE.NOTE]登录到 [Azure 管理门户](http://manage.windowsazure.com/)并导航到服务总线命名空间的连接信息后，也可以看到此密钥。
