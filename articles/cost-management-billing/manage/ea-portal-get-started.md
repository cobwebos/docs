...
还可以通过报告 API 访问使用情况数据。 有关详细信息和示例代码，请参阅[报告 API 文档](https://ea.azure.com/helpdocs/reportingAPI)。
...
也可以通过 API 访问使用情况。 有关详细信息和示例代码，请参阅 Azure Enterprise 门户文档中的[报告 API](https://ea.azure.com/helpdocs/reportingAPI)。
