...
只要使用量总和不超过使用限制，就可以创建多个免费服务实例。 例如，通过 Azure 免费帐户获得每月可免费使用 750 小时的 B1S Windows 虚拟机。 这 750 小时可以按你所需的任意组合方式使用。 例如，可以创建 5 个 B1S Windows 虚拟机，每个虚拟机使用 150 小时。
