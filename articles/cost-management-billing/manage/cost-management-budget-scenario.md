...
4.  在**逻辑应用设计器**的搜索框中搜索 "分析 JSON"，查找并选择 "**数据操作-分析 json** "[操作](https://docs.microsoft.com/azure/logic-apps/logic-apps-overview#logic-app-concepts)。
