---
title: 查看你的 Microsoft 合作伙伴协议发票-Azure
description: 了解如何查看你的帐单和资源使用情况，并验证你的 Microsoft 合作伙伴协议发票的费用。
author: jureid
manager: jureid
tags: billing
...
---
# <a name="tutorial-review-your-microsoft-partner-agreement-invoice"></a>教程：查看你的 Microsoft 合作伙伴协议发票

 在 Microsoft 合作伙伴协议的计费帐户中，每月将为每个计费对象信息生成一份发票。 该发票包括上个月的所有客户费用。 可以通过分析 Azure 门户中的每笔交易来了解发票中的费用。 您还可以在 Azure 门户中查看发票，并将费用与使用情况详细信息文件进行比较。

有关详细信息，请参阅[如何从 Azure 门户下载发票](download-azure-invoice.md)。

本教程仅适用于具有 Microsoft 合作伙伴协议的 Azure 合作伙伴。
...
您必须有权访问 Microsoft 合作伙伴协议的计费帐户。

它必须在订阅到 Azure 的日期之前30天以上。 在发票周期结束时，Azure 会向你开具账单。
...
![显示 "属性" 页中的 Microsoft 合作伙伴协议的屏幕截图](./media/review-partner-agreement-bill/billing-account-properties-partner-agreement.png)

如果有权访问多个计费范围，请检查“计费帐户”列中的类型。 如果任何范围的计费帐户类型为“Microsoft 合作伙伴协议”，则有权访问 Microsoft 合作伙伴协议的计费帐户。

![显示 "帐单帐户列表" 页中的 Microsoft 合作伙伴协议的屏幕截图](./media/review-partner-agreement-bill/mpa-in-the-list.png)

## <a name="review-invoiced-transactions-in-the-azure-portal"></a>查看 Azure 门户中的已开票交易

在 "成本管理 + 计费" 中，选择页面左侧的 "**所有事务**"。 根据你的访问权限，可能需要选择某个计费帐户、计费对象信息或客户，然后选择“所有交易”。
...
了解如何使用适用于合作伙伴的 Azure 成本管理。

> [!div class="nextstepaction"]
> [适用于合作伙伴的 Azure 成本管理入门](../costs/get-started-partners.md)
