...
<li>View the Blob service reference documentation for complete details about available APIs:
  <ul>
    <li><a href="http://msdn.microsoft.com/zh-cn/library/azure/dn495001(v=azure.10).aspx">Storage Client Library for .NET reference</a>
    </li>
...
<li>View more feature guides to learn about additional options for storing data in Azure.
  ...
  [.NET client library reference]: http://msdn.microsoft.com/zh-cn/library/azure/dn495001(v=azure.10).aspx
