...
1. 在本地计算机上，使用 "[使用 Windows 的 azure 文件共享](../storage/files/storage-how-to-use-files-windows.md)" 一文中的 "[装载 azure 文件共享](../storage/files/storage-how-to-use-files-windows.md#mount-the-azure-file-share)的脚本" 部分。 
