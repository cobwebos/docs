---
title: Azure 策略 json 示例 - 每个子网上的 NSG x | Microsoft Docs
description: 此 json 示例策略要求每个虚拟子网使用特定网络安全组。
...
ms.locfileid: "34601864"
---
# <a name="nsg-x-on-every-subnet"></a>每个子网上的 NSG X
