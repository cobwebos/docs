...
| 操作 | 说明 |
|--------|-------------|
| **获取威胁情报指标** | 基于一个或多个[tiIndicator 属性](https://docs.microsoft.com/graph/api/resources/tiindicator?view=graph-rest-beta)（例如）筛选 tiIndicators`threatType eq 'MaliciousUrl' or 'DDoS'` |
