...
#### <a name="error-the-provider-being-used-is-deprecated-systemdataoracleclient-requires-oracle-client-software-version-817-or-greater-see-httpsgomicrosoftcomfwlinkplinkid272376-to-install-the-official-provider"></a>**错误**：要使用的提供程序已弃用：“System.Data.OracleClient 需要 Oracle 客户端软件 8.1.7 或更高版本”。 请参阅[https://go.microsoft.com/fwlink/p/?LinkID=272376](https://go.microsoft.com/fwlink/p/?LinkID=272376)安装官方提供程序。
...
您可以通过在 投票和提交您的想法来帮助改进逻辑应用和连接器[https://aka.ms/logicapps-wish](https://aka.ms/logicapps-wish)。 
