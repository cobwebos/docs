...
* FTP 连接器仅支持 TLS/SSL 上的显式 FTP （FTPS），并且不兼容隐式 FTPS。
...
有关此连接器的更多技术详细信息，如连接器的 Swagger 文件所述的触发器、操作和限制，请参阅[连接器的参考页](https://docs.microsoft.com/connectors/ftpconnector/)。
