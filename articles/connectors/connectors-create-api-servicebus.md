...
服务总线连接器一次最多可以从服务总线向连接器缓存保存1500个唯一会话。 如果会话计数超过此限制，则将从缓存中删除旧会话。 有关详细信息，请参阅[消息会话](../service-bus-messaging/message-sessions.md)。

有关由连接器的 OpenAPI （以前的 Swagger）说明描述的触发器、操作和限制的其他技术详细信息，请查看连接器的[参考页](/connectors/servicebus/)。 有关 Azure 服务总线消息传送的详细信息，请参阅[什么是 Azure 服务总线](../service-bus-messaging/service-bus-messaging-overview.md)？
