...
在[使用通知中心发送突发新闻][]中，你生成了一个使用**标记**订阅不同新闻类别通知的应用程序。
...
模板是很强大的功能，你可以在[通知中心指南][]一文中了解其更多信息。一个模板表达语言的参考是[针对 Windows 应用商店的通知中心操作指南][]。
...
有关使用模板的详细信息，请参阅[使用通知中心通知用户：ASP.NET][]、[使用通知中心通知用户：移动服务][]和[通知中心指南][]。一个模板表达语言的参考是[针对 Windows 应用商店的通知中心操作指南][]。
