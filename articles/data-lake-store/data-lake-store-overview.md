...
## <a name="applications-compatible-with-azure-data-lake-store"></a>与 Azure Data Lake Store 兼容的应用程序
...
## <a name="what-is-azure-data-lake-store-file-system-adl"></a>什么是 Azure Data Lake Store 文件系统 (adl://)？
