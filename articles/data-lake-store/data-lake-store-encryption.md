...
有关详细信息，请 [参阅入门](./data-lake-store-get-started-portal.md)。
...
使用客户管理的密钥时，可以轮换 MEK。 若要了解如何使用客户管理的密钥设置 Data Lake Storage Gen1 帐户，请参阅[入门](./data-lake-store-get-started-portal.md)。
