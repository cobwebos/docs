...
5. 单击“ **保存**”。 已添加的安全组如下所示。
    ...
    ![添加的安全组](./media/data-lake-store-secure-data/adl.add.user.3.png "已添加的安全组")
...
3. “访问”边栏选项卡会列出所有者和已分配给 root 的已分配权限。 单击“添加”图标以添加更多访问 ACL。
    ...
    ![列出标准访问和自定义访问](./media/data-lake-store-secure-data/adl.acl.2.png "列出标准及自定义访问权限")
...
5. 单击“选择权限”，选择权限、是否应当以递归方式应用权限，以及要将权限分配为访问 ACL、默认 ACL 还是同时分配为这两者。 单击“确定”。
    ...
    ![向组分配权限](./media/data-lake-store-secure-data/adl.acl.4.png "分配权限给组")
...
6. 在“选择权限”边栏选项卡中单击“确定”后，新添加的组和关联的权限现在将在“访问”边栏选项卡中列出。
    ...
    ![向组分配权限](./media/data-lake-store-secure-data/adl.acl.5.png "分配权限给组")
...
2. 在“访问控制 (IAM)”边栏选项卡中，单击要删除的安全组。 单击 **“删除”** 。
    ...
    ![安全组已删除](./media/data-lake-store-secure-data/adl.remove.group.png "已删除的安全组")
...
3. 在“访问”边栏选项卡中，单击要删除的安全组。 在“访问详细信息”边栏选项卡中，单击“删除”。
    ...
    ![向组分配权限](./media/data-lake-store-secure-data/adl.remove.acl.png "分配权限给组")
