...
[Call a custom API from the client]: mobile-services-dotnet-backend-ios-call-custom-api
[如何对 .NET 后端移动服务进行数据模型更改]: mobile-services-dotnet-backend-how-to-use-code-first-migrations
