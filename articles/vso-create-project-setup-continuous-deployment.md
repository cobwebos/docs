...
5.  选择要用于项目的版本控制的类型。你可以选择 Git（分布式版本控制系统）或 Team Foundation 版本控制（集中式版本控制系统）。不确定要用哪种系统？在[此处][]了解更多信息。
6.  选择过程模板。有关过程模板的比较，请参阅[处理团队项目组件][]。
