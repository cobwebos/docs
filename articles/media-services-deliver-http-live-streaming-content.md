<properties linkid="develop-media-services-how-to-guides-deliver-apple-live-streaming" urlDisplayName="Deliver Apple HTTP Live Streaming (HLS)" pageTitle="如何交付 Apple HTTP 实时流 (HLS) - Azure" metaKeywords="" description="了解如何在 Media Services 来源服务器上创建一个定位符，以指向 Apple HTTP 实时流 (HLS) 内容。代码示例用 C# 编写且使用 Media Services SDK for .NET。" metaCanonical="" services="media-services" documentationCenter="" title="How to: Deliver Apple HLS streaming content" authors="migree" solutions="" manager="" editor="" />





<h1>如何：交付 Apple HLS 流内容</h1>

本文是介绍 Azure Media Services 编程的系列主题中的一篇。前一个主题是[如何：交付流内容](/zh-cn/documentation/articles/media-services-deliver-streaming-content/)。
...
有关交付资产的详细信息，请参阅：
<ul>
<li><a href="http://msdn.microsoft.com/library/jj129575.aspx">使用 Media Services for .NET 交付资产</a></li>
<li><a href="http://msdn.microsoft.com/library/jj129578.aspx">使用 Media Services REST API 交付资产</a></li>
</ul>
...
-   [Azure Media Services 文档][]
-   [Media Services SDK for .NET 入门][]
-   [Media Services 论坛][]
-  [如何监视 Media Services 帐户](/zh-cn/documentation/articles/media-services-monitor-services-account/)
-	[如何管理 Media Services 中的内容](/zh-cn/documentation/articles/media-services-manage-content/)
...
[Media Services 论坛]: https://social.msdn.microsoft.com/Forums/azure/zh-CN/home?forum=windowsazurezhchs
