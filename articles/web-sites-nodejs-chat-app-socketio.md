...
> [AZURE.NOTE] 在本任务中的过程适用于 Azure 网站；关于云服务，请参阅 <a href="/zh-cn/documentation/articles/cloud-services-nodejs-chat-app-socketio//">在 Azure 云服务中使用 Socket.IO 生成 Node.js 聊天应用程序</a>。
...
> [AZURE.NOTE] 要完成本教程，您需要一个 Azure 帐户。如果你没有帐户，只需花费几分钟就能创建一个免费试用帐户。有关详细信息，请参阅： <a href="http://www.windowsazure.cn/zh-cn/pricing/1rmb-trial/?WT.mc_id=A7171371E" target="_blank">Azure 免费试用版</a>。
...
> [AZURE.NOTE] 保存适用于缓存的__主机名称__和__主键__，因为接下来的步骤需要这些信息。

### 添加 redis 和 socket.io redis 模块

1. 从命令行中，更改为__\\node\\chat__目录，并使用以下命令。
...
从__\\node\\chat__目录中的命令行中，使用以下命令提交更改，并重新部署该应用程序。
...
[cloudservice]: /zh-cn/documentation/articles/cloud-services-nodejs-chat-app-socketio/

[chat-example-view]: ./media/web-sites-nodejs-chat-app-socketio/socketio-2.png
[npm-output]: ./media/web-sites-nodejs-chat-app-socketio/socketio-7.png
[定价]: /zh-cn/pricing/details/web-sites/
