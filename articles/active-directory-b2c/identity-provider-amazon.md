...
要在 Azure 活动目录 B2C（Azure AD B2C）中使用 Amazon 帐户作为[标识提供程序](authorization-code-flow.md)，需要在租户中创建表示它的应用程序。 如果您还没有亚马逊帐户，您可以在 注册[https://www.amazon.com/](https://www.amazon.com/)。
...
1. 选择**身份提供商**，然后选择**亚马逊**。
1. 输入“名称”****。 例如，*亚马逊*。
1. 对于**客户端 ID，** 输入您之前创建的 Amazon 应用程序的客户端 ID。
