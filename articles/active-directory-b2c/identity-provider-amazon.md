...
若要使用 Amazon 帐户作为 Azure Active Directory B2C （Azure AD B2C）中的[标识提供者](authorization-code-flow.md)，需要在租户中创建表示它的应用程序。 如果还没有 Amazon 帐户，可以在[https://www.amazon.com/](https://www.amazon.com/)注册。
