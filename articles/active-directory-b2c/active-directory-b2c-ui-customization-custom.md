...
# Azure Active Directory B2C：在自定义策略中配置 UI 自定义
...
6. 单击“上传”。
7. 单击“选择文件”旁边的文件夹图标。
8. 转到“customize-ui.html”，这是你之前在“页面 UI 自定义”部分中创建的。[](#the-page-ui-customization-feature)
9. 单击“上传”。
...
在“修改注册或登录自定义策略”部分中，你已配置了 `api.idpselections` 的内容定义。[](#modify-your-sign-up-or-sign-in-custom-policy) 下表中列出了 Azure AD B2C 标识体验框架可以识别的整组内容定义 ID 及其说明：
