...
Azure AD B2C 还支持[自定义策略](custom-policy-overview.md)。 自定义策略允许你为支持[OpenID connect](https://openid.net/specs/openid-connect-core-1_0.html)或 SAML 的任何标识提供者创建你自己的策略。 查看我们的[自定义策略初学者包](https://github.com/Azure-Samples/active-directory-b2c-custom-policy-starterpack)，开始使用自定义策略。
...
阅读[在 Azure AD 中比较 B2B 协作和 B2C](../active-directory/b2b/compare-with-b2c.md) ，详细了解如何将适当的功能应用于外部标识方案。
...
是，请参阅[语言自定义](user-flow-language-customization.md)。 我们提供 36 种语言的翻译版本，并且你可以根据需要替代任何字符串。
