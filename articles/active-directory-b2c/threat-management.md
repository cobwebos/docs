...
1. 输入所需的密码保护设置，然后选择 "**保存**"。
    ...
    Azure AD 设置](./media/threat-management/portal-02-password-protection.png)
...
![显示锁定帐户的 Azure AD 登录报表部分](./media/threat-management/portal-01-locked-account.png)
