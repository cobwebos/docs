...
# Azure Active Directory B2C：构建 .NET Web API
...
- 为 Web 应用使用**重定向统一资源标识符** `https://localhost:44316/`。这是用于本代码示例的 Web 应用客户端的默认位置。
...
### 添加 OWIN 启动类
将名为 `Startup.cs` 的 OWIN 启动类添加到 `TaskService` 项目。右键单击项目，选择“添加”和“添加项”，然后搜索 OWIN。
