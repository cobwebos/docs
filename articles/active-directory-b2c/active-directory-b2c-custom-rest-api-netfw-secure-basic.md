...
2. 在“名称”框中，键入 **ClientAuthMiddleware.cs**。
   ...
   ![在 Visual Studio C#中的 "添加新项" 对话框中创建新类](media/aadb2c-ief-rest-api-netfw-secure-basic/rest-api-netfw-secure-basic-OWIN-startup-auth2.png)
...
1. 右键单击项目，选择“添加” > “新建项”，并搜索“OWIN”。
   ...
   ![在 Visual Studio 中的 "添加新项" 对话框中创建 OWIN startup 类](media/aadb2c-ief-rest-api-netfw-secure-basic/rest-api-netfw-secure-basic-OWIN-startup.png)
...
5. 紧靠在 `<Metadata>` 元素右括号的后面添加以下 XML 片段：
    ...
    ![向技术配置文件添加基本身份验证 XML 元素](media/aadb2c-ief-rest-api-netfw-secure-basic/rest-api-netfw-secure-basic-add-1.png)
...
3. 在“名”框中键入 **Test** 来测试该过程。
    ...
    ![在标识 API 中测试给定名称输入验证](media/aadb2c-ief-rest-api-netfw-secure-basic/rest-api-netfw-test.png)
