...
若要将 Microsoft 帐户用作 Azure Active Directory B2C （Azure AD B2C）中的[标识提供者](openid-connect.md)，需要在 Azure AD 租户中创建应用程序。 Azure AD 租户与 Azure AD B2C 租户不同。 如果还没有 Microsoft 帐户，可以在[https://www.live.com/](https://www.live.com/)获取一个。
