...
* 可以在 URL 中删除对 Microsoft 的所有引用（可以将 `<YourTenantName>.onmicrosoft.com` 替换为你的租户 ID）。 例如：`https://<tenantname>.b2clogin.com/tfp/<tenantname>/<policyname>/v2.0/.well-known/openid-configuration`。
