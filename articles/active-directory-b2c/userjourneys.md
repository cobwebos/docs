...
| JourneyList | 0:1 | 业务流程步骤的 sub 旅程候选项的列表。 |
...
| Attribute | 必须 | 说明 |
| --------- | -------- | ----------- |
| SubJourneyReferenceId | 是 | 要执行的 [sub 旅程](subjourneys.md) 的标识符。 |
