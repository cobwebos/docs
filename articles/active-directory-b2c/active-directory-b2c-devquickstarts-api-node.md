---
title: 在 Azure Active Directory B2C 中使用 Node.js 保护 Web API | Microsoft Docs
...
## <a name="add-passport-azuread-to-your-web-api"></a>将 passport-azuread 添加到 Web API
