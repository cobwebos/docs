...
若要在 Azure Active Directory B2C （Azure AD B2C）中使用 GitHub 帐户作为[标识提供者](active-directory-b2c-reference-oauth-code.md)，需要在租户中创建表示它的应用程序。 如果还没有 GitHub 帐户，可以[https://www.github.com/](https://www.github.com/)进行注册。
