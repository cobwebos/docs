...
---
# <a name="tutorial-customize-the-interface-of-user-experiences-in-azure-active-directory-b2c"></a>教程：自定义 Azure 活动目录 B2C 中的用户体验界面
...
3. 对于**允许的方法**，选择`GET``PUT`、`OPTIONS`和 。
4. 对于“允许的标头”****，请输入一个星号 (*)。
5. 对于“公开的标头”****，请输入一个星号 (*)。
6. 对于“最大期限”****，请输入 200。
...
1. 选择 Azure 门户左上角**的所有服务**，搜索并选择**存储帐户**。
