...
1. 登录到 Azure[门户](https://portal.azure.com/)。 使用 Azure 帐户登录，该帐户至少分配有[参与者](../role-based-access-control/built-in-roles.md)角色（位于订阅中或订阅的资源组中）。
...
1. 输入**组织名称**和**初始域名**。 选择**国家或地区**（以后不能更改），然后选择“创建”。****
    ...
    域名将用作完整租户域名的一部分。 在此示例中，租户名称*contosob2c.onmicrosoft.com*：
...
1. 如果要更改新收藏的位置，请转到 Azure 门户菜单，选择“Azure AD B2C”****，然后将其上移或下移到所需的位置。
    ...
    ![Azure AD B2C，收藏夹菜单，微软 Azure 门户](media/tutorial-create-tenant/portal-08-b2c-favorite.png)
