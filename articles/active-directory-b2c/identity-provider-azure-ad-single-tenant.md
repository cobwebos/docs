...
1. 对于 "**元数据 url**"，请输入`{tenant}`以下 url，并将替换为 Azure AD 租户的域名：
...
1. 可有可无对于**域提示**，输入`contoso.com`。 有关详细信息，请参阅[使用 Azure Active Directory B2C 设置直接登录](direct-signin.md#redirect-sign-in-to-a-social-provider)。
