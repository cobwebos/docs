...
要将 Amazon 用作 Azure Active Directory (Azure AD) B2C 中的标识提供者，需要创建 Amazon 应用程序并向其提供合适的参数。 需要一个 Amazon 帐户来完成此操作。 如果没有此帐户，可以在 [http://www.amazon.com/](http://www.amazon.com/) 上获取。
