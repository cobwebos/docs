...
2. 选择“创建新应用”。
3. 输入“名称”、“说明”和“网站”。
4. 在“回调 URL” 中输入 `https://{tenant}.b2clogin.com/te/{tenant}.onmicrosoft.com/{policyId}/oauth1/authresp`。 将 {tenant} 替换为租户名称（例如 contosob2c），将 {policyId} 替换为策略 ID（例如 b2c_1_policy）。 应该为使用 Twitter 帐户的所有策略添加回调 URL。 
