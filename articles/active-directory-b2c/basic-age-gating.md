...
使用年龄门控可通过 Azure AD B2C 标识应用程序中的未成年人。  可以选择阻止用户登录到应用程序，或者允许他们带着标识用户的年龄组及其家长同意状态的附加声明返回到应用程序。  
...
3. 等待操作完成，系统将为年龄门控设置目录。

##<a name="enabling-age-gating-in-your-user-flow"></a>在用户流中启用“年龄门控”
...
##<a name="age-gating-options"></a>年龄门控选项
