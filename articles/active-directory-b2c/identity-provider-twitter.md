...
若要将 Twitter 用作 Azure AD B2C 中的身份提供程序，则需要创建 Twitter 应用程序。 如果还没有 Twitter 帐户，可以[https://twitter.com/signup](https://twitter.com/signup)进行注册。
