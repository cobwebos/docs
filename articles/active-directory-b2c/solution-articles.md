...
| Title | 描述 |
| ----- | ----------- |
| [使用 Azure AD B2C 进行客户身份管理](https://channel9.msdn.com/Shows/On-NET/Customer-Identity-Management-with-Azure-AD-B2C) | 在该服务的概述中，Azure AD B2C 团队的 Parakh Jain （[@jainparakh](https://twitter.com/jainparakh)） 为我们提供了服务工作原理的概述，并演示如何快速将 B2C 连接到ASP.NET核心应用程序。 |
