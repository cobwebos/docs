...
| 标题 | 说明 |
| ----- | ----------- |
| [使用 Azure AD B2C 进行客户标识管理](https://channel9.msdn.com/Shows/On-NET/Customer-Identity-Management-with-Azure-AD-B2C) | 在本服务的这一概述中，Azure AD B2C[@jainparakh](https://twitter.com/jainparakh)团队的 Parakh Jain （）提供了该服务的工作原理的概述，并说明了如何快速将 B2C 连接到 ASP.NET Core 应用程序。 |
