...
若要在 Azure Active Directory B2C （Azure AD B2C）中使用 Google 帐户作为[标识提供者](authorization-code-flow.md)，需要在 Google 开发人员控制台中创建应用程序。 如果还没有 Google 帐户，可以在上注册 [https://accounts.google.com/SignUp](https://accounts.google.com/SignUp) 。
