...
若要将 WeChat 用作 Azure Active Directory (Azure AD) B2C 中的标识提供者，需要创建 WeChat 应用程序并向其提供合适的参数。 需要使用 WeChat 帐户来完成此操作。 如果没有帐户，可以通过其移动应用之一或使用 QQ 号注册来获得一个。 之后，获得已向 WeChat 开发人员计划注册的帐户。 可以在[此处](http://kf.qq.com/faq/161220Brem2Q161220uUjERB.html)查看详细信息。
...
5. 单击“标识提供者类型”，选择“WeChat”，然后单击“确定”。
6. 单击“设置此标识提供者”
7. 输入先前作为**客户端 ID** 复制的**应用密钥**。
8. 输入先前作为**客户端机密**复制的**应用机密**。
9. 单击“确定”，然后单击“创建”以保存 WeChat 配置。
