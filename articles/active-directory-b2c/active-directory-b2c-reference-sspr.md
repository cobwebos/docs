...
ms.openlocfilehash: 2987f5b7ed59869f933b08da3a1d3107b584acc3
...
默认情况下，你的目录未开启自助密码重置功能。 使用以下步骤启用该功能：
...
若要进行测试，请对任何具有作为标识提供者的本地帐户的登录策略使用“立即运行”功能。 在本地帐户登录页上（可在其中输入电子邮件地址和密码，或用户名和密码），单击“无法访问你的帐户？”以验证使用者体验。
