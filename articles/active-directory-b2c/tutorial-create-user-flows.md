...
---
# <a name="tutorial-create-user-flows-in-azure-active-directory-b2c"></a>教程：在 Azure 活动目录 B2C 中创建用户流

在应用程序中，您可能具有允许用户注册、登录或管理其配置文件[的用户流](user-flow-overview.md)。 可以在 Azure Active Directory B2C (Azure AD B2C) 租户中创建多个不同类型的用户流，并根据需要在应用程序中使用它们。 可以跨应用程序重复使用用户流。
...
接下来，了解如何向应用程序添加标识提供程序，以便与 Azure AD、亚马逊、Facebook、GitHub、LinkedIn、微软或 Twitter 等提供商进行用户登录。
