...
| IssuanceClaimPattern | 是 | 控制颁发者 (iss) 声明。 值为下列其中一项：<ul><li>AuthorityAndTenantGuid-iss 声明包括域名，例如 `login.microsoftonline` 或 `tenant-name.b2clogin.com`，以及租户标识符 https： \//microsoftonline/00000000-0000-0000-0000-000000000000/v2.0/</li><li>AuthorityWithTfp - iss 声明包含域名（例如 `login.microsoftonline` 或 `tenant-name.b2clogin.com`）、租户标识符和信赖方策略名称。 https： \//microsoftonline/tfp/00000000-0000-0000-0000-000000000000/b2c_1a_tp_sign////</li></ul> |
