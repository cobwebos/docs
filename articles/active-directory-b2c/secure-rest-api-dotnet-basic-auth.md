---
title: 使用 HTTP 基本身份验证保护 RESTful 服务
...
在[相关的 Azure AD B2C 文章](rest-api-claims-exchange-dotnet.md)中，我们已创建一个无需身份验证即可集成到 Azure Active Directory B2C (Azure AD B2C) 用户旅程的 RESTful 服务 (Web API)。
...
1. 右键单击“App_Start”文件夹，依次选择“添加”、“类”。
   ...
   ![在 App_Start 文件夹中添加 ClientAuthMiddleware.cs 类](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-OWIN-startup-auth1.png)

2. 在“名称”框中，键入 **ClientAuthMiddleware.cs**。

   ![在 Visual Studio C#中的 "添加新项" 对话框中创建新类](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-OWIN-startup-auth2.png)
...
1. 右键单击项目，选择“添加” > “新建项”，并搜索“OWIN”。
   ...
   ![在 Visual Studio 中的 "添加新项" 对话框中创建 OWIN startup 类](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-OWIN-startup.png)
...
![将 Authorize 标记添加到控制器](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-authorize.png)
...
5. 紧靠在 `<Metadata>` 元素右括号的后面添加以下 XML 片段：
    ...
    ![向技术配置文件添加基本身份验证 XML 元素](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-secure-basic-add-1.png)
...
3. 在“名”框中键入 **Test** 来测试该过程。
    ...
    ![在标识 API 中测试给定名称输入验证](./media/secure-rest-api-dotnet-basic-auth/rest-api-netfw-test.png)
...
* 完成[自定义策略入门](custom-policy-get-started.md)演练后，我们建议你使用自己的自定义策略文件来构建方案。 我们已提供[示例策略文件](https://github.com/Azure-Samples/active-directory-b2c-custom-policy-starterpack/tree/master/scenarios/aadb2c-ief-rest-api-netfw-secure-basic)用于参考。
