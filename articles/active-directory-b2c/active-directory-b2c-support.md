...
1. 从 B2C 租户切换到另一个拥有与其关联的 Azure 订阅的租户。 通常，后者是员工租户或在注册 Azure 订阅时创建的默认租户。 若要了解详细信息，请参阅 [Azure 订阅如何与 Azure AD 关联](../active-directory/fundamentals/active-directory-how-subscriptions-associated-directory.md)。
    ...
    ![Azure 门户中使用租户选择突出显示](./media/active-directory-b2c-support/support-switch-dir.png)

3. 切换租户后，请单击“帮助 + 支持”  。

    ![帮助 + 支持在 Azure 门户中突出显示的磁贴](./media/active-directory-b2c-support/support-support.png)

4. 单击“新建支持请求”  。

    ![在 Azure 门户中突出显示的新支持请求磁贴](./media/active-directory-b2c-support/support-new.png)
5. 在“基础知识”  边栏选项卡中，使用这些详细信息，并单击“下一步”  。
   ...
   * 选择适当的“支持计划”  。 如果没有计划，可以[在此](https://azure.microsoft.com/support/plans/)注册一个。
     ...
     ![在 Azure 门户中突出显示的下一步按钮的基本信息页](./media/active-directory-b2c-support/support-basics.png)
6. 在“问题”  边栏选项卡中，使用这些详细信息，并单击“下一步”  。
   ...
   * 在“文件上传”下，上传所有你认为有助于解决问题的屏幕截图和文件  。
     ...
     ![在 Azure 门户中突出显示的下一步按钮问题页](./media/active-directory-b2c-support/support-problem.png)
7. 在“联系人信息”  边栏选项卡中，添加联系人信息。 单击“创建”。 

    ![使用 Azure 门户中突出显示创建按钮的联系信息页](./media/active-directory-b2c-support/support-contact.png)
