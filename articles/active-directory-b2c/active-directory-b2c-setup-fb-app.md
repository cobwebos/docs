...
3. 单击“我的应用程序”，然后单击“添加新的应用程序”。 选择“网站”作为平台，然后单击“跳过并创建应用程序 ID”。
   
    ![Facebook — 添加新的应用程序](./media/active-directory-b2c-setup-fb-app/fb-add-new-app.png)
   
    ![Facebook — 添加新的应用程序 — 网站](./media/active-directory-b2c-setup-fb-app/fb-add-new-app-website.png)
   
    ![Facebook — 创建应用程序 ID](./media/active-directory-b2c-setup-fb-app/fb-new-app-skip.png)
4. 在窗体上，提供“显示名称”、有效的“联系人电子邮件”、适当的“类别”，然后单击“创建应用程序 ID”。 该操作要求接受 Facebook 平台策略并完成在线安全检查。
   
    ![Facebook — 创建应用程序 ID](./media/active-directory-b2c-setup-fb-app/fb-create-app-id.png)
5. 在左侧导航窗格上，单击“设置”。
6. 单击“+ 添加平台”，然后选择“网站”。
...
7. 在“站点 URL”字段中输入“https://login.microsoftonline.com/”，然后单击“保存更改”。[](https://login.microsoftonline.com/)
   
    ![Facebook — 站点 URL](./media/active-directory-b2c-setup-fb-app/fb-site-url.png)
8. 复制“应用程序 Id”的值。 单击“显示”，并复制“应用程序密码”的值。 将 Facebook 帐户配置为租户中的标识提供者时需要此两项。 **应用程序密码**是一个非常重要的安全凭据。
   
    ![Facebook — 应用程序 ID 和应用程序密码](./media/active-directory-b2c-setup-fb-app/fb-app-id-app-secret.png)
9. 单击左侧导航窗格中的“+ 添加产品”，然后单击“Facebook 登录”旁边的“开始”按钮。
   
    ![Facebook — Facebook 登录](./media/active-directory-b2c-setup-fb-app/fb-login.png)
10. 在“客户端 OAuth 设置”部分的“有效的 OAuth 重定向 URI”字段中输入 `https://login.microsoftonline.com/te/{tenant}/oauth2/authresp`。 将 **{tenant}** 替换为你的租户名称（例如 contosob2c.onmicrosoft.com）。 单击页面底部的“保存更改”。
    
    ![Facebook — OAuth 重定向 URI](./media/active-directory-b2c-setup-fb-app/fb-oauth-redirect-uri.png)
11. 若要使 Facebook 应用程序可供 Azure AD B2C 使用，需要使其公开可用。 若要执行此操作，可单击左侧导航窗格上的“应用程序查看”，将该页顶部的开关设置为“是”，并单击“确认”。
