...
本文是“用户迁移”一文的延续，重点介绍社交标识迁移。 在开始之前，请阅读[用户迁移](user-migration.md)。
...
4. 使用管理员帐户登录。
5. 运行以下 GET 请求。 将 userObjectId 替换为复制的用户 ID。 **获取**https://graph.windows.net/tenant-name.onmicrosoft.com/users/userObjectId
...
**修补**https://graph.windows.net/tenant-name.onmicrosoft.com/users/userObjectId
...
有关如何使用示例应用的详细信息，请参阅 [Azure Active Directory B2C：用户迁移](user-migration.md)
