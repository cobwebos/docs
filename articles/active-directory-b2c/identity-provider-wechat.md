...
要将微信帐户用作 Azure Active Directory B2C (Azure AD B2C) 中的标识提供者，需要在表示它的租户中创建一个应用程序。 如果您还没有微信帐户，您可以在 上[https://kf.qq.com/faq/161220Brem2Q161220uUjERB.html](https://kf.qq.com/faq/161220Brem2Q161220uUjERB.html)获取信息。

### <a name="register-a-wechat-application"></a>注册微信应用程序

1. [https://open.weixin.qq.com/](https://open.weixin.qq.com/)使用微信凭据登录。
