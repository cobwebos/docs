...
Azure PowerShell 是一个功能强大的脚本编写环境，可用于在 Azure 中控制和自动执行工作负荷的部署和管理。在本文中，你将了解如何通过使用 Windows PowerShell 借助于本地 Azure PowerShell 控制台来管理 HDInsight 群集。有关 HDInsight PowerShell cmdlet 的列表，请参阅 [HDInsight cmdlet 参考][HDInsight cmdlet 参考]。

**先决条件：**

在开始阅读本文前，你必须具有：

-   Azure 订阅。Azure 是基于订阅的平台。HDInsight PowerShell cmdlet 通过订阅执行任务。有关获取订阅的详细信息，请参阅[购买选项][购买选项]、[成员优惠][azure-member-offers] 或[免费试用][免费试用]。

-   配备 Azure PowerShell 的工作站。有关说明，请参阅[安装和配置 Azure PowerShell][安装和配置 Azure PowerShell]。
...
-   [提交 MapReduce 作业][提交 MapReduce 作业]
-   [提交 Hive 作业][提交 Hive 作业]
-   [将数据上载到 Blob 存储][将数据上载到 Blob 存储]
-   [从 Blob 存储下载 MapReduce 输出数据][从 Blob 存储下载 MapReduce 输出数据]
...
有关使用管理门户创建 Azure 存储帐户的信息，请参阅[如何创建存储帐户][如何创建存储帐户]。
...
也可以使用 Windows Azure 管理门户完成此操作。请参阅[使用管理门户管理 HDInsight][使用管理门户管理 HDInsight]。
...
有关开发和运行 MapReduce 作业的详细信息，请参阅[将 MapReduce 与 HDInsight 配合使用][将 MapReduce 与 HDInsight 配合使用]。
...
有关使用 Hive 的详细信息，请参阅[将 Hive 与 HDInsight 配合使用][将 Hive 与 HDInsight 配合使用]。
...
请参阅本文中的[提交 MapReduce 作业][提交 MapReduce 作业]一节。

## 另请参阅

-   [HDInsight Cmdlet 参考文档][HDInsight cmdlet 参考]
-   [使用管理门户管理 HDInsight][使用管理门户管理 HDInsight]
-   [使用命令行接口管理 HDInsight][使用命令行接口管理 HDInsight]
