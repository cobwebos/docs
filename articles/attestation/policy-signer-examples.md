---
title: Azure 证明策略签名者证书的示例
description: Azure 证明策略签名者证书内容的示例。
...
## <a name="policy-signer-certificates-file-content"></a>策略签名者证书文件内容
