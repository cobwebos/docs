...
Commvault、Veritas 和 Veeam 在基于 VMware 的环境中具有领先的备份和还原解决方案。 客户广泛采用这些解决方案来实现其本地部署。 现在，这些合作伙伴已将其解决方案扩展到 Azure VMware 解决方案，使用 Azure 提供备份存储库和用于长期保留和存档的存储目标。
