---
title: 创建内容库以在 Azure VMware 解决方案 (AVS) 中部署 VM
...
ms.locfileid: "86014206"
---
# <a name="create-a-content-library-to-deploy-vms-in-azure-vmware-solution-avs"></a>创建内容库以在 Azure VMware 解决方案 (AVS) 中部署 VM
