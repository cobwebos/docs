<properties pageTitle="如何在 Azure 中创建运行 Windows 的自定义虚拟机" description="了解如何在 Azure 中创建运行 Windows 的自定义虚拟机。" services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor=""/>
