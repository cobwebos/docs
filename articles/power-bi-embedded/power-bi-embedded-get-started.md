...
> [AZURE.NOTE] **Power BI Embedded** 具有其他一些 API，用于更改数据集所指向的服务器和数据库，以及设置数据集将用于连接数据库的服务帐户凭据。请参阅[发布 SetAllConnections](https://msdn.microsoft.com/library/mt711505.aspx) 和[修补网关数据源](https://msdn.microsoft.com/library/mt711498.aspx)。
