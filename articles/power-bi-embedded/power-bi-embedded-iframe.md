...
在 [Microsoft Power BI Embedded 预览版入门](power-bi-embedded-get-started.md) 中，了解如何配置**工作区集合**，为报表内容保留一个或多个**工作区**。然后，在 [Microsoft Power BI Embedded 示例入门](power-bi-embedded-get-started-sample.md)中，了解如何将报表导入**工作区**。
...
- 步骤 1：[在工作区中获取一个报表](#GetReport)。在此步骤中，请使用应用程序令牌流来获取调用 [Get Reports（获取报表）](https://msdn.microsoft.com/library/mt711510.aspx)REST 操作的访问令牌。从“获取报表”列表中获取报表后，即可将该报表嵌入带有**IFrame** 元素的应用程序中。
...
- **AccessKey**：**AccessKey** 用于生成 JSON Web 令牌 (JWT)，以获取报表和嵌入报表。若要了解如何获取 **AccessKey**，请参阅 [Microsoft Power BI Embedded 预览版入门](power-bi-embedded-get-started.md)。
- **WorkspaceName**：若要了解如何获取 **WorkspaceName**，请参阅 [Microsoft Power BI Embedded 预览版入门](power-bi-embedded-get-started.md)。
- **WorkspaceId**：若要了解如何获取 **WorkspaceId**，请参阅 [Microsoft Power BI Embedded 预览版入门](power-bi-embedded-get-started.md)。
...
若要将报表集成到应用程序中，需要报表 **ID** 和 **embedUrl**。若要获取报表 **ID** 和 **embedUrl**，请调用 [Get Reports（获取报表）](https://msdn.microsoft.com/library/mt711510.aspx)REST 操作，并从 JSON 列表中选择一个报表。在[将报表嵌入应用程序中](#EmbedReport)，请使用报表 **ID** 和 **embedUrl** 将报表嵌入应用程序中。
...
若要调用 [Get Reports（获取报表）](https://msdn.microsoft.com/library/mt711510.aspx) REST 操作，请使用应用程序令牌。若要了解有关应用程序令牌流的详细信息，请参阅[关于 Power BI Embedded 中的应用程序令牌流](power-bi-embedded-app-token-flow.md)。下面的代码说明如何获取报表的 JSON 列表。若要嵌入报表，请参阅[将报表嵌入应用程序中](#EmbedReport)。
...
- [Get Reports（获取报表）](https://msdn.microsoft.com/library/mt711510.aspx)
