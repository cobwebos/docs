...
本指南介绍 Azure Automation 服务，以及如何使用它来简化 Azure 虚拟机的管理。
...
可以使用 [Azure PowerShell 工具](https://msdn.microsoft.com/library/azure/jj156055.aspx)中提供的 PowerShell cmdlet 在 Azure Automation 中管理虚拟机。Azure Automation 现成地提供了这些 VM PowerShell cmdlet，因此，你可以在该服务中执行所有 VM 管理任务。你还可以将 Azure Automation 中的这些 cmdlet 与其他 Azure 服务的 cmdlet 搭配使用，以自动完成跨 Azure 服务和第三方系统的复杂任务。


## 后续步骤

在了解 Azure Automation 以及如何使用它来管理 Azure 虚拟机的基础知识后，请使用以下链接了解有关 Azure Automation 的更多信息。
