...
ms.locfileid: "39631985"
---
# <a name="get-started-with-queries-in-log-analytics"></a>Log Analytics 中的查询入门


> [!NOTE]
> 在完成本教程之前，应先完成 [Analytics 门户入门](get-started-analytics-portal.md)。
...
时间选取器位于左上角，其中指示我们只要查询过去 24 小时的记录。 这是应用到所有查询的默认时间范围。 如果只要获取过去一个小时的记录，请选择“过去一小时”并再次运行查询。
