...
![数字磁贴](media/log-analytics-view-designer-tiles/tile-number.png)
...
![两个数字磁贴](media/log-analytics-view-designer-tiles/tile-two-numbers.png)
...
![圆环图磁贴](media/log-analytics-view-designer-tiles/tile-donut.png)
...
![折线图和标注磁贴](media/log-analytics-view-designer-tiles/tile-line-chart.png)
...
![折线图和标注磁贴](media/log-analytics-view-designer-tiles/tile-line-chart-callout.png)
...
![两个时间线磁贴](media/log-analytics-view-designer-tiles/tile-two-timelines.png)
