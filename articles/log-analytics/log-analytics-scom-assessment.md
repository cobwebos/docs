...
![“System Center Operations Manager 运行状况检查”符号](./media/log-analytics-scom-assessment/scom-assessment-symbol.png)
...
![System Center Operations Manager 解决方案磁贴](./media/log-analytics-scom-assessment/log-analytics-scom-healthcheck-tile.png)

![“System Center Operations Manager 运行状况检查”仪表板](./media/log-analytics-scom-assessment/log-analytics-scom-healthcheck-dashboard-01.png)
...
5.  请务必将“已启用”参数值的重写值更改为 **True**。<br><br> ![重写参数](./media/log-analytics-scom-assessment/rule.png)
...
4. 将“间隔”参数值更改为所需的间隔值。 在以下示例中，该值设置为 1440 分钟（一天）。<br><br> ![间隔参数](./media/log-analytics-scom-assessment/interval.png)<br>  
...
2. 使用以下查询列出对于环境中计算机失败的建议。
    ...
    下面是显示日志搜索查询的屏幕截图：<br><br> ![日志搜索](./media/log-analytics-scom-assessment/scom-log-search.png)<br>
