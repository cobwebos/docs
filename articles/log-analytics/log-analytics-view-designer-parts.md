...
![查询列表视图](media/log-analytics-view-designer-parts/view-list-queries.png)
...
![查询列表视图](media/log-analytics-view-designer-parts/view-number-list.png)
...
| **标题** | |
| 图例 |标头顶部显示的文本。 |
| Query |针对标头运行的查询。 显示由查询返回的记录数。 |
| 点击导航 | 单击标题时执行的操作。  有关详细信息，请参阅[通用设置](#click-through-navigation)。 |
| **列表** | |
| Query |针对列表运行的查询。 将显示结果中前十个记录的前两个属性。 第一个属性应为文本值，第二个属性应为数值。 根据数值列的相关值自动创建条形图。<br><br>在查询中使用 `Sort` 命令可对列表中的记录进行排序。 可以选择“全部查看”来运行查询并返回所有记录。 |
...
![两个数字和列表视图](media/log-analytics-view-designer-parts/view-two-numbers-list.png)
...
![圆环图和列表视图](media/log-analytics-view-designer-parts/view-donut-list.png)
...
![两条时间线和列表视图](media/log-analytics-view-designer-parts/view-two-timelines-list.png)
...
| 图例 |在第一个序列的标注下显示的文本。 |
| 颜色 |用于序列中的列的颜色。 |
| Query |针对第一个序列运行的查询。 每个时间间隔内记录数由图表列表示。 |
...
![信息视图](media/log-analytics-view-designer-parts/view-information.png)
...
![折线图、标注和列表视图](media/log-analytics-view-designer-parts/view-line-chart-callout-list.png)
...
| 副标题 |标头顶部的标题下显示的文本。 |
| **折线图** | |
| Query |要为折线图运行的查询。 第一个属性应为文本值，第二个属性应为数值。 此查询通常使用 *measure* 关键字来汇总结果。 如果查询使用 *interval* 关键字，则图表的 X 轴将使用此时间间隔。 如果查询不包含 *interval* 关键字，则 X 轴使用每小时间隔。 |
| 点击导航 | 单击标题时执行的操作。  有关详细信息，请参阅[通用设置](#click-through-navigation)。 |
| **折线图** |**> 标注** |
| 标注标题 |标注值上方显示的文本。 |
...
![折线图和列表视图](media/log-analytics-view-designer-parts/view-line-chart-callout-list.png)
...
![折线图的堆栈](media/log-analytics-view-designer-parts/view-stack-line-charts.png)
