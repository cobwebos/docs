...
> [!NOTE]
> 用于 Microsoft Flow 的 Azure Log Analytics 连接器需要将工作区升级至新的 Log Analytics 查询语言。 若要了解有关新语言的详细信息和工作区升级过程，请参阅[将 Azure Log Analytics 工作区升级到新日志搜索](log-analytics-log-search-upgrade.md)。  
