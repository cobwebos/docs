...
9. 第三步也是最后一步，指定“操作组”，确保每次触发警报时都执行相同的操作，而且这些操作可以用于定义的每项规则。  使用以下信息配置新操作组：  
   ...
   e. 在“电子邮件/短信/推送/语音”窗格中启用“电子邮件”，并提供有效的可以接收邮件的电子邮件 SMTP 地址。 f. 单击“确定”  保存更改。<br><br> ![创建新的操作组](./media/log-analytics-tutorial-response/action-group-properties-01.png)<br>
10. 单击“确定”，完成操作组。 
