---
title: Azure 应用配置作为事件网格源
description: 本文介绍如何使用 Azure 应用配置作为事件网格事件源。 它提供了与教程和"访问者"文章的架构和链接。
services: event-grid
author: banisadr
...
---
# <a name="azure-app-configuration-as-an-event-grid-source"></a>Azure 应用配置作为事件网格源
本文提供 Azure 应用程序配置事件的属性和架构。 有关事件架构的简介，请参阅 [Azure 事件网格事件架构](event-schema.md)。 它还为您提供了使用 Azure 应用配置作为事件源的快速启动和教程的列表。
