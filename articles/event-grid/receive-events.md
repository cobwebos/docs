...
若要以编程方式回显验证码，请运行下面的代码（相关示例的网址为 https://github.com/Azure-Samples/event-grid-dotnet-publish-consume-events/tree/master/EventGridConsumer):
