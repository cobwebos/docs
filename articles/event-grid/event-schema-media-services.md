...
ms.locfileid: "81394327"
---
# <a name="azure-media-services-as-an-event-grid-source"></a>Azure 媒体服务作为事件网格源
...
您可以在[实时事件错误代码](../media-services/latest/live-event-error-codes.md)中找到错误结果代码。
...
- [直播活动错误代码](../media-services/latest/live-event-error-codes.md)
