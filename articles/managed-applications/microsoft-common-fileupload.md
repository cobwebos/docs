---
title: "Azure 托管应用程序 FileUpload UI 元素 | Microsoft Docs"
description: "介绍了 Azure 托管应用程序的 Microsoft.Common.FileUpload UI 元素"
...
一个允许用户指定要上传的一个或多个文件的控件。 [创建 Azure 托管应用程序](publish-service-catalog-app.md)时使用此元素。
