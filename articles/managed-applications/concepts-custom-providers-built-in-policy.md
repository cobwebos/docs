...
有关关联的详细信息，请参阅[Azure 自定义提供程序资源载入](./concepts-custom-providers-resourceonboarding.md)
...
![分配内置策略](media/builtin-policy/assign-builtin-policy-customprovider.png)
...
- [概念： Azure 自定义提供程序资源载入](./concepts-custom-providers-resourceonboarding.md)
