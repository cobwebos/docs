...
ms.locfileid: "73933137"
---
# <a name="microsoftcommontagsbyresource-ui-element"></a>TagsByResource UI 元素

用于将[标记](../azure-resource-manager/resource-group-using-tags.md)与部署中的资源相关联的控件。
...
- 在访问 tagsByResource 参数时使用[if](../azure-resource-manager/resource-group-template-functions-logical.md#if)函数。 当没有任何标记分配给给定的资源类型时，可以使用它来分配空的对象。
