---
title: 自定义提供程序C#RESTful 终结点引用-Azure
description: 本文是自定义提供程序的基本引用C#RESTful 终结点。
...
ms.locfileid: "67800102"
---
# <a name="custom-provider-c-restful-endpoint-reference"></a>自定义提供程序C#RESTful 终结点引用

本文是自定义提供程序的基本引用C#RESTful 终结点。 如果您不熟悉 Azure 自定义提供程序，请参阅[对自定义资源提供程序概述](./custom-providers-overview.md)。

## <a name="azure-function-restful-endpoint"></a>Azure 函数 RESTful 终结点

下面的代码适用于 Azure 函数。 若要了解如何设置 Azure 函数来使用自定义提供程序，请参阅[for Azure 自定义提供程序中设置 Azure 函数](./tutorial-custom-providers-function-setup.md)
