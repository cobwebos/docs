---
title: "如何在虚拟机中使用 Azure 诊断 | Microsoft Docs"
...
若要更改你收集的数据、排查问题或者了解有关诊断的一般信息，请参阅[与虚拟机相关的 Azure 诊断文章列表](azure-diagnostics.md#virtual-machines-using-azure-diagnostics)。
