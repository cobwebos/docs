<properties
	pageTitle="如何在虚拟机中使用 Azure 诊断 | Microsoft Azure"
...
2.	创建面向 .NET Framework 4.5 的新 Visual C# 控制台应用程序。将该项目命名为“WadExampleVM”。
	![CloudServices\_diag\_new\_project](./media/virtual-machines-dotnet-diagnostics/NewProject.png)
...
有关详细信息，请参阅 [Azure 诊断故障排除](azure-diagnostics-troubleshooting.md)。


## 后续步骤
若要更改你收集的数据、排查问题或者了解更多有关诊断的一般信息，请参阅[与虚拟机相关的 Azure 诊断文章列表](azure-diagnostics.md#virtual-machines-using-azure-diagnostics)。
