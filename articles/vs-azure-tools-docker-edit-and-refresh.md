...
ms.locfileid: "50968725"
---
# <a name="debugging-apps-in-a-local-docker-container"></a>在本地 Docker 容器中调试应用
## <a name="overview"></a>概述
Visual Studio 2017 提供了在本地在 Docker 容器中进行开发以及对应用程序进行验证的一致方法。
...
* [使用 Visual Studio 的容器开发](/visualstudio/containers) - 容器开发中心页
* [ Azure Pipelines 的 Docker 集成](http://aka.ms/dockertoolsforvsts) - 生成和部署 docker 容器
...
* [Azure Kubernetes 服务](https://azure.microsoft.com/services/kubernetes-service/) - [Azure Kubernetes 服务文档](/azure/aks)
