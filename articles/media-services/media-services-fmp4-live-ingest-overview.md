<properties 
	...
	description="本规范描述基于分片 MP4 的实时流引入协议和格式（适用于 Microsoft Azure 媒体服务）。Microsoft Azure 媒体服务提供实时流服务，让客户使用 Microsoft Azure 作为云平台来实时流式传输实时事件和广播内容。截至撰写本文时，预编码的分片 MP4 是 Microsoft Azure 媒体服务中唯一的实时流引入机制。本文档还介绍了有关构建高度冗余和稳健的实时引入机制的最佳实践。" 
...
本规范描述基于分片 MP4 的实时流引入协议和格式（适用于 Microsoft Azure 媒体服务）。Microsoft Azure 媒体服务提供实时流服务，让客户使用 Microsoft Azure 作为云平台来实时流式传输实时事件和广播内容。截至撰写本文时，预编码的分片 MP4 是 Microsoft Azure 媒体服务中唯一的实时流引入机制。本文档还介绍了有关构建高度冗余和稳健的实时引入机制的最佳实践。
