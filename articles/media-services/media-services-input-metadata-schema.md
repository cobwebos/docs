...
| 名称​​ | Type | 说明 |
| --- | --- | --- |
| **Name**<br /><br /> 必需 |**xs:string** |资产文件名。 |
| **大小**<br /><br /> 必需 |**xs:long** |资产文件的大小（以字节为单位）。 |
| **持续时间**<br /><br /> 必需 |**xs:duration** |内容播放持续时间。 示例：持续时间 =“PT25M37.757S”。 |
| **NumberOfStreams**<br /><br /> 必需 |**xs:int** |资产文件中的流数。 |
| **FormatNames**<br /><br /> 必需 |**xs: string** |格式名。 |
...
| 名称​​ | Type | 说明 |
| --- | --- | --- |
| **Id**<br /><br /> 必需 |**xs:int** |此音频轨或视频轨从零开始的索引。<br /><br /> 这不一定是 MP4 文件中使用的 TrackID。 |
| **编解码器** |**xs:string** |视频轨编解码器字符串。 |
| **CodecLongName** |**xs: string** |音频或视频轨编解码器长名称。 |
| **TimeBase**<br /><br /> 必需 |**xs:string** |时间基数。 示例：TimeBase =“1/48000” |
...
| **通道**<br /><br /> 必需 |**xs:int** |音频通道数（0 个或多个）。 |
| **SamplingRate**<br /><br /> 必需 |**xs:int** |音频采样速率（以采样数/秒或 Hz 为单位）。 |
...
| 名称​​ | Type | 说明 |
| --- | --- | --- |
| **键**<br /><br /> 必需 |**xs:string** |键/值对中的键。 |
| **值**<br /><br /> 必需 |**xs:string** |键/值对中的值。 |
...
| **NumberOfPrograms**<br /><br /> 必需 |**xs:int** |节目的数量。 |
...
| 名称​​ | Type | 说明 |
| --- | --- | --- |
| **默认**<br /><br /> 必需 |**xs: int** |将此属性设置为 1，表示此为默认演示。 |
| **复录**<br /><br /> 必需 |**xs:int** |将此属性设置为 1，表示此为译制演示。 |
| **原始**<br /><br /> 必需 |**xs: int** |将此属性设置为 1，表示此为原始演示。 |
| **评论**<br /><br /> 必需 |**xs:int** |将此属性设置为 1，表示此轨道包含注释。 |
| **歌词**<br /><br /> 必需 |**xs:int** |将此属性设置为 1，表示此轨道包含歌词。 |
| **卡拉 Ok**<br /><br /> 必需 |**xs:int** |将此属性设置为 1，表示此为卡拉 OK 轨道（仅背景音乐，没有歌唱部分）。 |
| **强制**<br /><br /> 必需 |**xs:int** |将此属性设置为 1，表示此为强制演示。 |
| **HearingImpaired**<br /><br /> 必需 |**xs:int** |将此属性设置为 1，表示此轨道用于听力障碍人士。 |
| **VisualImpaired**<br /><br /> 必需 |**xs:int** |将此属性设置为 1，表示此轨道用于视觉障碍人士。 |
| **CleanEffects**<br /><br /> 必需 |**xs: int** |将此属性设置为 1，表示该轨道有清晰的效果。 |
| **AttachedPic**<br /><br /> 必需 |**xs: int** |将此属性设置为 1，表示该轨道包含图片。 |
