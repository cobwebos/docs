<properties 
	...
	description="介绍如何使用 Azure Media Services 执行编码、加密和流式处理资源等常见任务。" 
...
若要设置你的 Media Services 帐户，请使用 Azure 管理门户。请参阅主题[如何创建媒体服务帐户](/documentation/articles/media-services-create-account)。在管理门户中创建帐户后，便可以设置你的计算机以进行 Media Services 开发。
...
在使用此代码之前，需要设置一个 Media Services 帐户。有关设置帐户的信息，请参阅[如何创建媒体服务帐户](/documentation/articles/media-services-create-account)。
