---
title: 使用 Azure 媒体服务 v3 配置脱机播放就绪流
...
* 播放就绪LA_URL（内部）：[https://willzhan12.cloudapp.net/playready/rightsmanager.asmx](https://willzhan12.cloudapp.net/playready/rightsmanager.asmx)
