...
`x-ms-long-running-operation`在 Azure 媒体服务[swagger 文件](https://github.com/Azure/azure-rest-api-specs/blob/master/specification/mediaservices/resource-manager/Microsoft.Media/stable/2018-07-01/streamingservice.json)中标记为的操作是长时间运行的操作。 
...
* [停止 LiveEvent](https://docs.microsoft.com/rest/api/media/liveevents/stop)
  ...
  停止事件`removeOutputsOnStop`时，使用参数删除所有关联的实时输出。  
