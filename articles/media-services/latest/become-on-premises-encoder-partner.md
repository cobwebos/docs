...
---
# <a name="how-to-verify-your-on-premises-live-streaming-encoder"></a>如何验证本地实时流式处理器
...
5. 创建新的**资产**对象。
6. 创建**实时输出**并使用您创建的资产名称。
7. 使用内置**流式处理策略**类型创建**流式处理器。**
