...
> * [元素直播](media-services-configure-elemental-live-encoder.md)
...
当通道启动时，您可以[配置编码器](media-services-configure-tricaster-live-encoder.md#configure_tricaster_rtmp)。
...
## <a name="configure-the-newtek-tricaster-encoder"></a><a id="configure_tricaster_rtmp"/>配置 NewTek TriCaster 编码器
