...
本文介绍了从2020年3月1日停用的旧 Azure 媒体编码器（AME）媒体处理器迁移到 Media Encoder Standard 媒体处理器的步骤。  
...
如果已使用 AME 的架构为 AME 创建了自己的编码预设，则会有一个[用于 Media Encoder Standard 的等效架构](media-services-mes-schema.md)。 如果你有关于如何将较旧的设置映射到新编码器的问题，请通过 mailto:amshelp@microsoft.com 联系我们  
