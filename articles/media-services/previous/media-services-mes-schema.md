...
| Name | 类型 | 描述 |
| --- | --- | --- |
| **版本**<br/><br/> 需要 |**xs: decimal** |预设版本。 以下限制适用：xs:fractionDigits 值 =“1”和 xs:minInclusive 值 =“1”，例如，**版本 =“1.0”** 。 |
...
| **复杂性**<br/><br/> minOccurs=“0”<br/><br/> 默认值 =“平衡” |**xs:string** |控制编码速度和视频质量之间的平衡。 可以是以下值之一：**Speed**、**Balanced** 或 **Quality**<br/><br/> 默认值：**Balanced** |
...
| Name | 类型 | 描述 |
| --- | --- | --- |
| Profile <br/><br/> minOccurs=“0”<br/><br/> 默认值 =“自动” |**xs: string** |可以是以下 **xs: string** 值之一：**Auto**、**Baseline**、**Main**、**High**。 |
...
| **切片**<br/><br/> minOccurs=“0”<br/><br/> 默认值 =“0” |**xs:int** |确定一帧分为多少切片。 建议使用默认值。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| **配置文件**<br/><br/> minOccurs="0"<br/><br/> 默认值 =“AACLC” |**xs: string** |可以是以下值之一：**AACLC**、**HEAACV1** 或 **HEAACV2**。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| 通道 <br/><br/> minOccurs=“0” |**xs: int** |音频通道数。 下面是有效选项：1、2、5、6、8。<br/><br/> 默认值：2. |
...
| **宽度**<br/><br/> minOccurs=“0” |**xs:int** | |
| **高度**<br/><br/> minOccurs=“0” |**xs:int** | |
| **质量**<br/><br/> minOccurs=“0” |**xs:int** |有效值：1（最坏）-100（最好） |
