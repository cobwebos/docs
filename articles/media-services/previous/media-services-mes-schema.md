...
| **Complexity**<br/><br/> minOccurs=“0”<br/><br/> 默认值 =“Balanced” |**xs:string** |控制编码速度和视频质量之间的平衡。 可以是以下值之一：**Speed**、**Balanced** 或 **Quality**<br/><br/> 默认值：**Balanced** |
...
| 名称 | 类型 | 说明 |
| --- | --- | --- |
| **Condition** |**xs:string** | 当输入不包含视频时，建议强制编码器插入单色视频轨。为此，请使用 Condition="InsertBlackIfNoVideoBottomLayerOnly"（仅在最低比特率处插入视频）或 Condition="InsertBlackIfNoVideo"（在所有输出比特率处插入视频）。 有关详细信息，请参阅[此](media-services-advanced-encoding-with-mes.md#no_video)文章。|
...
| 名称 | 类型 | 说明 |
| --- | --- | --- |
| **Profile**<br/><br/> minOccurs=“0”<br/><br/> 默认值 =“Auto” |**xs: string** |可以是以下 **xs: string** 值之一：**Auto**、**Baseline**、**Main**、**High**。 |
| **Level**<br/><br/> minOccurs=“0”<br/><br/> 默认值 =“Auto” |**xs: string** | |
...
| **EntropyMode**<br/><br/> minOccurs=“0”<br/><br/> 默认值 =“Cabac” |**xs: string** |可以是以下值之一：**Cabac** 和 **Cavlc**。 |
...
| **Slices**<br/><br/> minOccurs=“0”<br/><br/> 默认值 =“0” |**xs:int** |确定将帧切分成多少片。 建议使用默认值。 |
...
| 名称 | 类型 | 说明 |
| --- | --- | --- |
| **Profile**<br/><br/> minOccurs="0"<br/><br/> 默认值 =“AACLC” |**xs: string** |可以是以下值之一：**AACLC**、**HEAACV1** 或 **HEAACV2**。 |

### <a name="attributes"></a>属性
| 名称 | 类型 | 说明 |
| --- | --- | --- |
| **Condition** |**xs: string** |若要强制编码器在输入不包含音频时生成包含静音曲目的资产，请指定“InsertSilenceIfNoAudio”值。<br/><br/> 默认情况下，如果要向编码器发送仅包含视频而不包含音频的输入，则输出资产将包含仅有视频数据的文件。 某些播放器可能无法处理此类输出流。 对于这种方案，可以使用此设置来强制编码器将静音曲目添加到输出。 |
...
| 名称 | 类型 | 说明 |
| --- | --- | --- |
| **Channels**<br/><br/> minOccurs=“0” |**xs: int** |音频通道数。 下面是有效选项：1、2、5、6、8。<br/><br/> 默认值：2. |
...
| **Duration** |**xs:duration** |指定演示文稿的持续时间（例如，视频中覆盖的外观）。 |
...
| **Width**<br/><br/> minOccurs=“0” |**xs:int** | |
| **Height**<br/><br/> minOccurs=“0” |**xs:int** | |
| **Quality**<br/><br/> minOccurs=“0” |**xs:int** |有效值：1（最坏）-100（最好） |
