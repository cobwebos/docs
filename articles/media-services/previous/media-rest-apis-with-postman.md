...
description: 本文介绍如何为 Media Services REST API 调用配置 Postman。
...
ms.locfileid: "76694984"
---
# <a name="configure-postman-for-media-services-v2-rest-api-calls"></a>为 Media Services v2 REST API 调用配置 Postman  
