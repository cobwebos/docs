...
- 有关详细信息，请参阅[使用 Azure AD 身份验证通过 REST 访问媒体服务 API](https://docs.microsoft.com/en-us/azure/media-services/previous/media-services-rest-connect-with-aad)一文。
