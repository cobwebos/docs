<properties 
	pageTitle="如何在 Media Services 帐户中管理流式处理终结点" 
...
4. 按“保存”按钮保存更改。
	...
	>[AZURE.NOTE]为 24 小时期间指定的最大单位数将用于计算成本。有关定价详细信息，请参阅 [Media Services 定价详细信息](http://go.microsoft.com/fwlink/?LinkId=275107)。
