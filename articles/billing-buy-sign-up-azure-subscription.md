<properties
	pageTitle="如何注册、购买、升级或激活 Azure 订阅 | Microsoft Azure"
...
| 经销商（开放批量许可计划） |• [激活联机服务密钥 - 分步指南](billing-buy-sign-up-azure-subscription.md#activateKey)</br>• [Purchase, Benefits, Activate](https://azure.microsoft.com/offers/ms-azr-0111p/)（购买、权益、激活）</br> |
| EA（企业协议） |• [为企业获得 Azure 许可](https://azure.microsoft.com/pricing/enterprise-agreement/)</br>• 若要激活，请与 Microsoft 客户经理或经销商联系，以便马上开始 |

<a name="SignupFreeTrial"></a>
## 注册 Azure 免费试用版订阅

若要注册 Azure 免费试用版订阅，必须提供电话号码、信用卡以及 Microsoft 帐户。你的 Microsoft 帐户是你使用的电子邮件地址，可以与密码一起用于登录任何 Windows Live 程序或服务，例如 Outlook、Hotmail 或 OneDrive。你可以使用属于你的任何电子邮件地址（包括公司电子邮件）来设置 Microsoft 帐户。如需更多详细信息，请参阅 [Microsoft account FAQ](https://www.microsoft.com/account/faq.aspx)（Microsoft 帐户常见问题）。

>[AZURE.NOTE] 你的电话号码和信用卡详细信息仅用于验证你的身份。虽然不会向你的信用卡收费，但 Microsoft 会通过收取小额的授权保证金来验证信用卡是否有效。该保证金将在 3-5 个工作日内返回给你，具体取决于金融机构的政策。

1. 打开 [Azure 免费试用](https://azure.microsoft.com/pricing/free-trial/)页，然后选择“马上试用”。
2. 使用你的 Microsoft 帐户或学校/工作帐户登录。
3. 在“关于你”部分，输入个人信息。
![个人信息的屏幕快照](./media/billing-buy-sign-up-azure-subscription/AboutYou.png)

 **注意** 你注册 Azure 订阅时提供的电子邮件地址和“国家/地区”信息将始终与订阅相关联，不能在以后更改。</br>
...
1. 通过你在注册免费试用版时使用的 Microsoft 帐户或学校/工作帐户登录到 [Azure 帐户门户](https://account.windowsazure.com/subscriptions)。
2. 选择该订阅，然后选择“升级”。</br>![billpage](./media/billing-buy-sign-up-azure-subscription/billpage.png)
3. 选择“是”，然后选择“立即升级”。</br>![升级](./media/billing-buy-sign-up-azure-subscription/Upgrade.png)
...
如果你从经销商处购买了 Azure 开放许可信用额度并获得了激活密钥（5x5 密钥），请按以下步骤激活你的订阅：

1. 转到 azure.com 上的[订阅摘要](https://account.windowsazure.com/subscriptions)页。

2. 选择“Azure 开放许可”。在 [Azure in Open License key](https://azure.microsoft.com/offers/ms-azr-0111p/)（Azure 开放许可密钥）页中，选择“激活新订阅或现有订阅”。
