...
Azure 安全中心的 endpoint protection 评估和建议检测并提供[支持](https://docs.microsoft.com/azure/security-center/security-center-os-coverage#supported-platforms-for-windows-computers-and-vms)的 Endpoint protection 解决方案版本的运行状况评估。 本主题介绍 Azure 安全中心为 Endpoint protection 解决方案生成以下两个建议的方案。
