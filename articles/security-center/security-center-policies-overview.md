...
- 安全策略：确定安全中心监视和建议哪些控件（可以在安全中心内编辑[安全策略](https://docs.microsoft.com/en-us/azure/security-center/security-center-policies)，也可以使用 [Azure 策略](security-center-azure-policy.md)在受限制的预览版中新建定义、定义其他策略和跨管理组分配策略）。
