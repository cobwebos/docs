...
ms.locfileid: "77603700"
---
# <a name="azure-security-policies-monitored-by-security-center"></a>安全中心监视的 Azure 安全策略

本文提供了可在 Azure 安全中心监视的[Azure 策略](../governance/policy/overview.md)定义和计划的列表。 有关安全策略的详细信息，请参阅[使用安全策略](tutorial-security-policy.md)。
...
* [Azure 策略](../governance/policy/overview.md)：了解如何审核和管理 Azure 资源。