...
- 要识别未受监视的 VM 和计算机问题，请处理：
    ...
    如果计算机未运行日志分析代理扩展，则安全中心将不受监视 VM 或计算机。 计算机上可能已安装了本地代理，例如 OMS 直接代理或 System Center Operations Manager 代理。 装有这些代理的计算机被标识为未受监视，因为安全中心不完全支持这些代理。 为了充分受益于安全中心的所有功能，需要日志分析代理扩展。
