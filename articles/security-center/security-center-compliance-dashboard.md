...
若要了解详细信息，请参阅[定价页](https://azure.microsoft.com/pricing/details/security-center/)。 快速入门教程“[将 Azure 订阅载入到安全中心标准版](https://docs.microsoft.com/en-us/azure/security-center/security-center-get-started)”详细介绍了如何升级到标准版。
