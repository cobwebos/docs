...
- 首次在 Azure 门户中访问 Azure 安全中心仪表板时，或者如果通过 API 启用了 progremmaticaly，则会在所有 Azure 订阅上启用**免费**级别。 如果添加其他订阅 aftewards，则默认情况下，新订阅将不会启用安全中心，但你只需启动安全中心门户，新订阅就会注册并应用免费层。 免费层提供安全策略、持续的安全评估和切实可行的安全建议，以帮助你保护 Azure 资源。
...
（图中的价格仅用于举例目的。） ![Security 中心定价 ](./media/security-center-pricing/get-standard.png)
