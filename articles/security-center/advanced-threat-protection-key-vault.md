...
1. 在 "**按资源类型组选择定价层**" 中，找到 "**密钥保管库**" 行，然后选择 "**已启用**" 或 "**禁用**"。
    ...
    [![启用或禁用 Azure 安全中心 Key Vault 的高级威胁防护](media/advanced-threat-protection-key-vault/atp-for-akv-enable-atp-for-akv.png)](media/advanced-threat-protection-key-vault/atp-for-akv-enable-atp-for-akv.png#lightbox)
