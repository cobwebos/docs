...
1. 在左窗格中，选择“威胁防护”下的“威胁智能”。 此时将打开映射。

    ![威胁智能地图](./media/security-center-threat-intel/security-center-threat-intel.png)

1. 在映射的顶部，选择“查看经典威胁智能”。 此时将打开“威胁智能”仪表板。
    ...
    >
1. 如果有多个工作区需要调查，则根据“恶意 IP”栏来确定调查的优先级。 该栏显示此工作区中恶意 IP 的当前数目。 选择要使用的工作区，将显示“威胁智能”仪表板。
