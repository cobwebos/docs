...
ms.locfileid: "77623953"
---
# <a name="threat-protection-in-azure-security-center"></a>Azure 安全中心的威胁防护

此页简要介绍了 Azure 安全中心为标准定价层上的用户显示的安全警报源。

当安全中心检测到下面列出的环境中的任何区域存在威胁时，它将生成警报。 这些警报描述了受影响资源的详细信息、建议的修正步骤，以及在某些情况下用于触发逻辑应用响应的选项。

无论警报是由安全中心生成，还是由其他安全产品的安全中心接收，你都可以将其导出。 若要将警报导出到 Azure Sentinel （或第三方 SIEM）或任何其他外部位置，请按照[导出警报和建议](continuous-export.md)中的说明进行操作。 




## Windows 计算机的威胁防护<a name="windows-machines"></a>
...
## 适用于 Linux 计算机的威胁防护<a name="linux-machines"></a>
...
## Azure App Service 威胁防护<a name="app-services"></a>
...
## Azure 容器的威胁防护<a name="azure-containers"></a>
...
## Azure 网络层的威胁防护<a name="network-layer"></a>
...
## Azure Key Vault 的威胁防护（预览版）<a name="azure-keyvault"></a>
...
## 针对 SQL 数据库和 SQL 数据仓库的威胁防护<a name="data-sql"></a>
...
## Azure 存储的威胁防护<a name="azure-storage"></a>
...
## Azure Cosmos DB 威胁防护<a name="cosmos-db"></a>
...
## Azure 管理层威胁防护（Azure 资源管理器）（预览版）<a name ="management-layer"></a>
...
## 来自其他 Microsoft 服务的安全警报<a name="alerts-other"></a>

### Azure WAF 的威胁防护<a name="azure-waf"></a>
...
### Azure DDoS 保护的威胁防护<a name="azure-ddos"></a>
