...
本文演示安全中心如何帮助保护运行 Linux 操作系统的 Azure 虚拟机 (VM)。

## <a name="why-use-security-center"></a>为什么要使用安全中心？
在安全中心可以查看虚拟机的安全设置和监视威胁，帮助保护 Azure 中的虚拟机数据。 安全中心可对虚拟机进行以下监视： 
...
* 有关操作系统可支持性的信息，请参阅 [Azure 安全中心常见问题 (FAQ)](faq-vms.md)。 
