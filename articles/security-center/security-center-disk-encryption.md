...
> [!NOTE]
> 如果想知道为何需要创建 Azure Active Directory 应用程序，请参阅 [Getting Started with Azure Key Vault](../key-vault/key-vault-get-started.md)（Azure 密钥保管库入门）一文的“将应用程序注册到 Azure Active Directory”部分。
> 
> 
