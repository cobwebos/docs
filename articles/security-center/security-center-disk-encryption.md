...
6. 保存记事本文件 – 单击“文件”，并单击“另存为”。 在文件名称文本框中，输入 **"ADEPrereqScript.ps1"**，并单击“保存”。 （确保对名称使用引号，否则会使用 .txt 文件扩展名保存文件）。
...
5. 单击“文件”，并单击“打开”。 导航到 **C:\AzureADEScript** 文件夹，并双击“ADEPrereqScript”。
...
将 **<’your_vm_name’>** 替换为 VM 的名称（确保名称使用单引号），并按 **ENTER**。
...
在加密进程正在进行时，可回到 Azure 门户查看虚拟机的状态。 在页面左侧单击“虚拟机”，并在“虚拟机”边栏选项卡中单击要加密的虚拟机的名称。 在显示的边栏选项卡中，会注意到“状态”为“正在更新”。 这说明加密正在进行。
...
要展示一下虚拟机现在已加密，可回到 Azure 门户，并单击页面左侧的“虚拟机”。 单击已加密的虚拟机的名称。 在“设置”边栏选项卡中，单击“磁盘”。
