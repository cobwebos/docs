...
安全中心利用云的规模和 Azure 作为云提供商的可见性来监视常见的 web 应用攻击。 安全中心可能会发现对你的应用程序的攻击并识别新兴攻击，即使攻击者处于侦测阶段，扫描还可以识别多个 Azure 托管应用程序的漏洞。 作为 Azure 本机服务，安全中心也处于独一无二的位置，可提供基于主机的安全分析，涵盖此 PaaS 的基础计算节点，使安全中心能够检测到对已被利用的 web 应用程序的攻击。
