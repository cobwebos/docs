...
警报是安全中心在检测到资源遭受威胁时生成的通知。 它划分优先级并列出警报，以及快速调查问题所需的信息。 安全中心还提供有关如何针对攻击采取补救措施的建议。
...
## <a name="validate-alerts-on-kubernetes"></a>验证 Kubernetes 上的警报<a name="validate-kubernetes"></a>
