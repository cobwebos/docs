...
ms.locfileid: "84234718"
---
# <a name="azure-policy-built-in-policy-definitions-for-azure-security-center"></a>Azure 安全中心的 Azure Policy 内置策略定义

此页是 Azure 安全中心的 [Azure Policy](../governance/policy/overview.md) 内置策略定义的索引。 有关其他服务的其他 Azure Policy 内置定义，请参阅 [Azure Policy 内置定义](../governance/policy/samples/built-in-policies.md)。
