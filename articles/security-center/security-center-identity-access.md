...
|订阅|50|在订阅中启用安全中心标准层 |在所有订阅中启用安全中心标准层，以获得高级威胁检测、JIT、应用程序允许列表和高级建议|
|订阅|40|为具有订阅写入权限的 Azure 管理应用帐户启用 MFA|为具有写入特权的所有订阅帐户启用多重身份验证 (MFA)，以防止破坏帐户或资源。|
|订阅|30|从订阅中删除具有所有者权限的外部帐户|从订阅中删除具有所有者权限的外部帐户，以防止发生未受监视的访问。 |
|订阅|30|为具有订阅读取权限的 Azure 管理应用帐户启用 MFA|为具有读取特权的所有订阅帐户启用多重身份验证 (MFA)，以防止破坏帐户或资源。|
|订阅|25|从订阅中删除具有写入权限的外部帐户|从订阅中删除具有写入权限的外部帐户，以防止发生未受监视的访问。 |
|订阅|20|从订阅中删除拥有所有者权限的已弃用帐户|从订阅中删除拥有所有者权限的已弃用帐户。 不推荐使用的帐户是为其登录已被阻止在 Azure AD 中的帐户。|
|订阅|5|从订阅中删除弃用的帐户|从订阅中删除已弃用的帐户，以便只允许当前用户访问。 不推荐使用的帐户是为其登录已被阻止在 Azure AD 中的帐户。|
|订阅|5|对订阅指定多个所有者|指定多个订阅所有者，以实现管理员访问权限冗余。|
