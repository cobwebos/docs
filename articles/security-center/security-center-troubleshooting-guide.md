<properties
   pageTitle="Azure 安全中心故障排除指南 | Microsoft Azure"
...
> [AZURE.NOTE] 如果 Azure 安全中心代理产生错误行为，将需要重新启动目标 VM，因为没有命令来停止和启动代理。
...
可以使用本文中提供的指南来识别一些问题，还可以在安全中心公共[论坛](https://social.msdn.microsoft.com/Forums/zh-CN/home?forum=AzureSecurityCenter)中查找记录的其他问题。但是，如果需要进一步进行故障排除，可以使用 Azure 门户打开新的支持请求，如下所示：
