...
> [!NOTE]
> 若要启用高级检测，请升级到 Azure 安全中心标准版。提供 90 天的免费试用期。若要升级，请选择[安全策略](security-center-policies.md)中的“定价层”。若要了解详细信息，请参阅[定价页](https://azure.microsoft.com/pricing/details/security-center/)。
> 
> 
