...
## <a name="supported-features-for-virtual-machines-and-servers"></a>支持的虚拟机和服务器功能<a name="vm-server-features"></a>
...
|[Microsoft Defender ATP 集成](security-center-wdatp.md)|✔</br>（支持的版本）|✔</br>（支持的版本）|✔|标准|
|[虚拟机行为分析（和安全警报）](threat-protection.md)|✔|✔|✔|建议（免费） </br></br> 安全警报（标准）|
|[Fileless 安全警报](alerts-reference.md#alerts-windows)|✔|✔|✔|标准|
...
|Docker 托管的 IaaS 容器上的建议和威胁防护|-|-|-|标准|
|缺少操作系统修补程序评估|✔|✔|✔|免费|
|安全错误配置评估|✔|✔|✔|免费|
...
## <a name="supported-endpoint-protection-solutions"></a>支持的 endpoint protection 解决方案<a name="endpoint-supported"></a>
