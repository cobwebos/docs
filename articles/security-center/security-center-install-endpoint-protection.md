...
description: 了解安全中心如何监视 endpoint protection，以及如何修正出现的任何问题。
...
ms.locfileid: "74558617"
---
# <a name="manage-endpoint-protection-issues-with-azure-security-center"></a>使用 Azure 安全中心管理 Endpoint Protection 问题
Azure 安全中心监视反恶意软件防护的状态，并在 "Endpoint protection 问题" 页下报告此问题。 安全中心会突出显示此类问题，如检测到威胁和保护不充分，这可能会导致虚拟机 (VM) 和计算机容易受到反恶意软件威胁的攻击。 参考“Endpoint Protection 问题”下的信息，可以制定计划来解决发现的任何问题。
...
本示例使用“计算”。  下文将介绍如何在 Azure VM 和非 Azure 计算机上安装反恶意软件。
...
2. 在“未在非 Azure 计算机上安装 Endpoint Protection”下，选择一个工作区。 筛选到工作区 Azure Monitor 日志搜索查询会打开并列出缺少反恶意软件的计算机。 从列表中选择一个计算机以了解详细信息。
