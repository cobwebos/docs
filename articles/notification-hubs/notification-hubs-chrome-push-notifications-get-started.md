...
3. 提供相应的**项目名称**，并单击“创建”按钮。
4. 在工具栏上选择通知图标（铃铛），然后选择“创建项目”消息。

    ![项目创建通知](media/notification-hubs-chrome-get-started/project-creation-notification.png)
5. 在已创建项目的“项目”页上记下**项目编号**。 请使用项目编号作为 Chrome 应用中的 **GCM 发送器 ID**，以在 GCM 中进行注册。
...
&emsp;&emsp;6. 在“通知设置”类别中选择“Google (GCM)”，输入 GCM 项目的 **API 密钥**，然后单击“保存”。

&emsp;&emsp;&emsp;&emsp;![Azure 通知中心 - Google (GCM)](media/notification-hubs-chrome-get-started/configure-gcm-api-key.png)
...
> [!NOTE]
> 可以使用通知中心通过公共 [REST 接口](https://msdn.microsoft.com/library/windowsazure/dn223264.aspx)从任意后端发送推送通知。 有关其他跨平台示例，请查看[文档门户](https://azure.microsoft.com/documentation/services/notification-hubs/)。
