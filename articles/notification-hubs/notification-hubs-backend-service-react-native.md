---
title: 使用 Azure 通知中心通过后端服务向 React Native 应用发送推送通知 | Microsoft Docs
description: 了解如何使用 Azure 通知中心通过后端服务向 React Native 应用推送通知。
author: alexeystrakh
...
[![下载示例](./media/notification-hubs-backend-service-react-native/download.png)下载示例](https://github.com/xamcat/mobcat-samples/tree/master/notification_hub_backend_service)  
...
> * [创建跨平台 React Native 应用程序](#create-a-cross-platform-react-native-application)。
...
## <a name="create-a-cross-platform-react-native-application"></a>创建跨平台 React Native 应用程序

在本部分中，将构建一个 [React Native](https://reactnative.dev/) 移动应用程序，实施以跨平台的方式推送通知。
...
现在应具有一个通过后端服务连接到通知中心的基本 React Native 应用，可以发送和接收通知。
