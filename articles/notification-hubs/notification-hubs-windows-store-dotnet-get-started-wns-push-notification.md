<properties
	pageTitle="适用于通用 Windows 平台应用的 Azure 通知中心入门 | Microsoft Azure"
...
+ 一个有效的 Azure 帐户<br/>如果你没有帐户，只需花费几分钟就能创建一个免费试用帐户。有关详细信息，请参阅 [Azure 免费试用](https://azure.microsoft.com/pricing/free-trial/?WT.mc_id=A0E0E5C02&amp;returnurl=http%3A%2F%2Fazure.microsoft.com%2Fzh-CN%2Fdocumentation%2Farticles%2Fnotification-hubs-windows-store-dotnet-get-started%2F)。
...
3. 在 Visual Studio 中，使用“**空白应用程序**”模板来创建一个新的 Visual C# 应用商店应用项目，然后单击“**确定**”。
...
8. 返回新应用的“[Windows 开发人员中心](http://go.microsoft.com/fwlink/p/?LinkID=266582)”页，依次单击“**服务**”、“**推送通知**”，然后在“**Windows 推送通知服务 (WNS) 和 Microsoft Azure 移动应用**”下面单击“**Live 服务网站**”。

   	![](./media/notification-hubs-windows-store-dotnet-get-started/notification-hubs-uwp-app-live-services.png)

9. 在应用的“注册”页面，记下位于 **Windows 应用商店**平台设置中的“**应用程序密钥**”密码和“**程序包安全标识符 (SID)**”。
...
<ol start="6">
<li><p>选择“<b>通知服务</b>”选项和“<b>Windows (WNS)</b>”选项。然后在“<b>安全密钥</b>”字段中输入“<b>应用程序密钥</b>”密码。输入在上一部分从 WNS 获取的“<b>程序包 SID</b>”值，然后单击“<b>保存</b>”。</p>
</li>
</ol>
...
4. 另外在 App.xaml.cs 中，将以下 **InitNotificationsAsync** 方法定义添加到 **App** 类中：
    ...
    >[AZURE.NOTE] 确保将“your hub name”占位符替换为出现在 Azure 门户中通知中心的名称。此外，将连接字符串占位符替换为从上一部分通知中心的“**访问策略**”页中获取的 **DefaultListenSharedAccessSignature** 连接字符串。
...
5. 在 **Program** 类中，添加以下方法：
   	...
   	确保将“hub name”占位符替换为出现在 Azure 门户中通知中心的名称。此外，将连接字符串占位符替换为从通知中心（在称为“配置通知中心”的部分中）的“**访问策略**”页获取的 **DefaultListenSharedAccessSignature** 连接字符串。
...
[使用通知中心向用户推送通知]: notification-hubs-aspnet-backend-windows-dotnet-notify-users.md
