...
4. 在应用的“注册”页面，记下位于 **Windows 应用商店**平台设置中的“**应用程序密钥**”密码和“**程序包安全标识符 (SID)**”。
...
4. 另外在 App.xaml.cs 中，将以下 **InitNotificationsAsync** 方法定义添加到 **App** 类中：
   ...
   > [!NOTE]
   > 确保将“your hub name”占位符替换为出现在 Azure 门户中通知中心的名称。此外，将连接字符串占位符替换为从上一部分通知中心的“**访问策略**”页中获取的 **DefaultListenSharedAccessSignature** 连接字符串。
   > 
   > 
