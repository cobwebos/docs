...
1. 按 **Ctrl** 的同时从视图中的组件拖至 ViewController.h 并添加这些新插座。
    ...
    ```
2. 在 ViewController.h 中，在 import 语句后面添加以下 `#define`。 将 *< 输入后端终结点>\>* 占位符替换为在上一节中用于部署应用后端的目标 URL。 例如，*http://you_backend.azurewebsites.net*。
