...
- PHP：请参阅[如何通过 PHP 使用通知中心](/documentation/articles/notification-hubs-php-push-notification-tutorial/)。
...
[移动服务入门]: /documentation/articles/partner-xamarin-mobile-services-android-get-started/#create-new-service
