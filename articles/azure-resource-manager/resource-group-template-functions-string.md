---
title: "Azure Resource Manager 模板函数 - 字符串 | Microsoft Docs"
description: "介绍可在 Azure Resource Manager 模板中用来处理字符串的函数。"
...
以下示例演示显示如何根据资源组创建存储帐户的唯一名称。 在资源组中，如果以相同的方式构造，则名称不是唯一的。
