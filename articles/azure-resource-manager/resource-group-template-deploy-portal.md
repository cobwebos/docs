...
ms.locfileid: "72390351"
---
# <a name="deploy-resources-with-resource-manager-templates-and-azure-portal"></a>使用 Resource Manager 模板和 Azure 门户部署资源

了解如何通过[azure 资源管理器](resource-group-overview.md)使用[Azure 门户](https://portal.azure.com)来部署 azure 资源。 若要了解有关管理资源的信息，请参阅[使用 Azure 门户管理 Azure 资源](manage-resources-portal.md)。
...
1. 你会看到用于创建模板的几个选项：
    ...
    - **常见模板**：创建 Linux 虚拟机、Windows 虚拟机、web 应用程序和 Azure SQL 数据库有四个常见 templatess。
