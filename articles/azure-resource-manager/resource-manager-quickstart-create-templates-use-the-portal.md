...
2. 在 Azure 门户菜单中，选择“创建资源”  。
    ...
    ![在 Azure 门户菜单中，选择“创建资源”](./media/resource-manager-quickstart-create-templates-use-the-portal/azure-resource-manager-template-tutorial-create-a-resource.png)
