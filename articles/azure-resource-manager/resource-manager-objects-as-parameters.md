---
title: "Azure Resource Manager 模板 - 对象即参数 | Microsoft Docs"
...
11. 在“自定义部署”边栏选项卡中选择你的订阅，新建资源组或使用现有资源组，然后选择位置。 查看条款和条件，然后选中“我同意”复选框。
12.    选择“购买”按钮。

## <a name="next-steps"></a>后续步骤

如果所需的参数数目超过了每个部署允许的最大参数数目 (255)，请使用此模式在模板中指定更少的参数。 也可以使用此模式来更轻松地管理资源的属性，然后使用顺序循环模式部署资源，这样就会发生冲突。
