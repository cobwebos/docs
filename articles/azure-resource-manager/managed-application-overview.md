...
本文对两种体验都进行概述。 首先，让我们来了解一下托管应用程序如何工作。 
...
如需了解供应商体验的详细信息，请参阅[创建和发布 Azure 托管应用程序](managed-application-publishing.md)。

如需了解使用者体验的详细信息，请参阅[使用 Azure 托管应用程序](managed-application-consumption.md)。
