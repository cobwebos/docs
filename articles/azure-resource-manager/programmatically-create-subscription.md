...
使用 [New-AzureRmSubscription](/powershell/module/azurerm.subscription) 并将 `enrollmentAccount` 对象 ID 作为创建新订阅的 `EnrollmentAccountObjectId` 参数。 
