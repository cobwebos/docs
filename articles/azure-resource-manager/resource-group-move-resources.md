...
* 虚拟机规模集
* 虚拟网络 - 当前无法移动对等虚拟网络，直到禁用了 VNet 对等互连为止。 禁用后，即可成功移动虚拟网络，然后可启用 VNet 对等互连。 此外，如果虚拟网络的任何子网包含资源导航链接，无法将虚拟网络移到其他订阅。 例如，将 Microsoft.Cache redis 资源部署到虚拟网络子网时，此子网包含资源导航链接。
* VPN 网关
