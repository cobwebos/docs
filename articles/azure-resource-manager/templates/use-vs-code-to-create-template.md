...
![Visual Studio Code 资源管理器工具扩展 - 色彩含义](./media/use-vs-code-to-create-template/resource-manager-tools-extension-colorization.png)
...
![Visual Studio Code 资源管理器工具扩展 - 签名函数](./media/use-vs-code-to-create-template/resource-manager-tools-extension-signature-function.png)
...
![Visual Studio Code 资源管理器工具扩展 - 速览编辑器](./media/use-vs-code-to-create-template/resource-manager-tools-extension-peek-editor.png)
...
![Visual Studio Code 资源管理器工具扩展 - 查找所有引用](./media/use-vs-code-to-create-template/resource-manager-tools-extension-find-all-references.png)
...
![Visual Studio Code 资源管理器工具扩展 - 将鼠标悬停在定义上](./media/use-vs-code-to-create-template/resource-manager-tools-extension-hover-parameters.png)

### <a name="brace-matching"></a>大括号匹配

将光标靠近某个匹配括号时，会立即突出显示该括号。 单击某个括号时，还会突出显示匹配的括号，如以下屏幕截图所示：

![Visual Studio Code 资源管理器工具扩展 - 括号匹配](./media/use-vs-code-to-create-template/resource-manager-tools-extension-brace-matching.png)
