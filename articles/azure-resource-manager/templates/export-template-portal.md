...
1. 此时将显示导出的模板，并且该模板可供下载和部署。
   ...
   ****“包括参数”默认情况下已选中。  如果选中，生成模板时将包括所有模板参数。 如果要编写自己的参数，请选中此复选框以不包含它们。
...
1. 此时将显示导出的模板，并且该模板可供下载和部署。 模板只包含单个资源。 ****“包括参数”默认情况下已选中。  如果选中，生成模板时将包括所有模板参数。 如果要编写自己的参数，请选中此复选框以不包含它们。
