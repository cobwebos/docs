---
title: "使用 Resource Manager 执行审核操作 | Microsoft Docs"
description: "使用 Resource Manager 中的活动日志查看用户操作和错误。 显示 Azure 门户、PowerShell、Azure CLI 和 REST。"
...
---
# <a name="audit-operations-with-resource-manager"></a>使用资源管理器执行审核操作
通过活动日志，可以确定：
...
## <a name="portal-to-view-activity-logs"></a>通过门户查看活动日志
...
## <a name="powershell-to-view-activity-logs"></a>通过 PowerShell 查看活动日志
...
## <a name="azure-cli-to-view-activity-logs"></a>通过 Azure CLI 查看活动日志
...
## <a name="rest-api-to-view-audit-logs"></a>查看审核日志的 REST API
