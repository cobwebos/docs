...
1. 将显示最近操作的摘要。 系统会向这些操作应用一组默认的筛选器。

    ![查看最近操作的摘要](./media/resource-group-audit/audit-summary.png)

1. 若要快速运行一组预定义的筛选器，请选择“快速见解”并选择其中一个选项。

    ![选择查询](./media/resource-group-audit/quick-insights.png)
...
* 若要检索日志条目，请运行 **Get-AzureRmLog** 命令。 可以提供附加参数来筛选条目列表。 如果未指定开始和结束时间，将返回最后七天的条目。
