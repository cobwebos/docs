...
# 快速入门
## [创建模板 - 门户](resource-manager-quickstart-create-templates-use-the-portal.md)
## [创建模板 - VS Code](resource-manager-quickstart-create-templates-use-visual-studio-code.md)
## [创建模板 - Visual Studio](vs-azure-tools-resource-groups-deployment-projects-create-deploy.md)
