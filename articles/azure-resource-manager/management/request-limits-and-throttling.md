...
[Azure 资源图](../../governance/resource-graph/overview.md)限制对其操作的请求数。 本文中的步骤确定剩余的请求以及在达到限制时如何做出响应也适用于资源图。 但是，资源图表会设置其自己的限制和重置速率。 有关详细信息，请参阅[资源图阻止标头](../../governance/resource-graph/concepts/guidance-for-throttled-requests.md#understand-throttling-headers)。
