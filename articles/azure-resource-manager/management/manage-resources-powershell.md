...
[基于角色的访问控制 （RBAC）](../../role-based-access-control/overview.md)是管理对 Azure 中资源的访问的方式。 有关详细信息，请参阅[使用 RBAC 和 Azure PowerShell 管理访问权限](../../role-based-access-control/role-assignments-powershell.md)。
