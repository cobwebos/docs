...
> <!-- -->
> 因此，应确定 Azure 资源组配额在任何一个区域中的工作负荷。 然后，在要部署到的每个区域中请求该数量。 有关如何确定特定区域的当前配额的帮助，请参阅[排查部署问题](../templates/common-deployment-errors.md)。
>
>
...
* [Azure 数据资源管理器](#azure-data-explorer-limits)
