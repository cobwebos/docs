...
> | 工作区/privateEndpointConnectionProxies | 否 | 否 |
> | 工作区/privateEndpointConnections | 否 | 否 |
> | 工作区/privateLinkResources | 否 | 否 |
> | 工作区/查询 | 否 | 否 |
...
> | managedInstances/数据库 | 是（请参阅[下面的注释](#sqlnote)） | 是 |
