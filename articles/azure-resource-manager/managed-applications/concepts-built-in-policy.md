...
- [教程：使用自定义提供程序进行资源载入](../custom-providers/tutorial-resource-onboarding.md)
...
- [如何：将自定义操作添加到 Azure REST API](../custom-providers/custom-providers-action-endpoint-how-to.md)
- [如何：将自定义资源添加到 Azure REST API](../custom-providers/custom-providers-resources-endpoint-how-to.md)
