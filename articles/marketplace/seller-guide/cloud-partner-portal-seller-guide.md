...
欢迎使用 Azure Marketplace 卖家指南。 本指南专为想要向 IT 专业人员和开发人员销售 Azure 认证虚拟机映像和托管应用程序的独立软件供应商 (ISV) 业务用户和产品经理而设。 [Azure Marketplace](https://azuremarketplace.microsoft.com/) 能够为世界各地的 Azure 客户提供极佳的产品市场宣传和曝光度。

> [!NOTE]
> 如果想要销售[托管应用程序](https://docs.microsoft.com/azure/managed-applications/overview)，应按照说明将其在 Azure Marketplace 的[此处](https://docs.microsoft.com/azure/managed-applications/publish-marketplace-app)列出。
...
Azure Marketplace 是一个在线应用程序和服务市场，其中各种规模的 ISV（从创业公司到大型企业）可向全球 Azure 客户提供解决方案。 Marketplace 允许 Azure 发布者向希望在 Azure 中快速开发基于云的应用程序和移动解决方案的其他专业人员分发和销售虚拟机映像、托管应用程序和 SaaS 应用程序。 Azure Marketplace 支持多种多样的产品，从支持数据处理的端到端数据分析应用程序、数据存储、分析层到分层电子商务应用（数据、服务和 Internet）。
...
此时此刻，可能会疑惑，Azure Marketplace 是否适合业务。 如果适合，它能够带来哪种优势？ Marketplace 创造了新的销售机会：
...
云合作伙伴门户是在 Marketplace 中创建产品的中心。 若要认证产品/服务，使其随时可供发布，必须满足某些先决条件。 详情请参见下一节。


## <a name="whats-next"></a>后续步骤

可能认为 Azure Marketplace 确实很适合产品。 那么，如何开始？ 本部分重点介绍在 Marketplace（图 1）上启动并运行虚拟机映像的方法： 
* 通过 Azure 认证。
* 获取销售产品的批准。
* 通过云合作伙伴门户创建并发布产品/服务。 
...
现在，可以请求批准在 Marketplace 中销售产品（图 3）。 
...
现在，可以认证虚拟机映像并发布产品/服务。 为此，可以使用云合作伙伴门户。 可将云合作伙伴门户视为发布和管理解决方案的中心。 基本上，只需上传你的 VHD、添加营销内容和 SKU 详细信息，并提交产品/服务进行认证和审阅。 可以预览产品/服务，查看其在 Marketplace 推出之前的外观。
...
- **已在我自己的网站上促销我的产品**，引导客户在 Marketplace 中选购我的产品。
