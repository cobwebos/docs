...
## <a name="issue-dev-center-registration"></a>问题：开发人员中心注册  
...
*   **为何需要开发人员中心帐户？**
> Microsoft 需要使用开发人员中心帐户代表发布者向客户计收“事务处理”商品类型的费用。 Microsoft 通过开发人员中心帐户注册来验证公司的法律、税务和银行信息。 有关详细信息，请单击[此处](https://docs.microsoft.com/en-us/azure/marketplace/become-publisher#register-in-dev-center)。
...
<br>若要详细了解注册过程，请单击[此处](https://docs.microsoft.com/en-us/azure/marketplace/register-dev-center)。</br>
...
*   **完成开发人员中心验证后，接下来要怎么做？**
> 转到“你的计划”(https://developer.microsoft.com/en-us/dashboard/Account/Programs) 并登录到开发人员中心帐户。 应会看到一个标题为“为你推荐的计划”部分，其下面是“Azure”。 请单击“开始”并完成设置 Azure 帐户的过程。
...
*   **如何添加税务和付款信息？**
> 如果未在开发人员中心帐户中填写税务和银行信息，则无法发布事务处理产品/服务。  有关添加帐户信息的详细信息，请访问[如何添加银行和税务信息](https://docs.microsoft.com/en-us/azure/marketplace/register-dev-center#how-to-add-bank-and-tax-information)。
