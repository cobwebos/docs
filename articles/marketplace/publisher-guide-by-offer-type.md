...
| [**解决方案模板**](./marketplace-solution-templates.md) | 如果你的解决方案需要在单个 VM 之外额外部署和配置自动化，请使用解决方案模板 (也称为 Azure 应用程序) 产品/服务类型。 解决方案模板可以使用多种不同类型的 Azure 资源，包括但不限于 Vm。  |
...
- 请在以下各节中查看产品/服务类型 (的符合性要求，) 以完成产品/服务的选择和配置。
