...
| [**解决方案模板**](https://docs.microsoft.com/azure/marketplace/marketplace-solution-templates) | 当解决方案需要额外的部署和配置自动化，超过简单 VM 时，请使用 "解决方案模板" （也称为 Azure 应用程序） "产品/服务" 类型。 解决方案模板可以使用多种不同类型的 Azure 资源，包括但不限于 Vm。  |
