...
* **为何需要开发人员中心帐户？**
  > 开发人员中心帐户是一种必需的，使 Microsoft 能够代表发布者为 "事务" 列表类型为客户计费。 Microsoft 通过开发人员中心帐户注册来验证公司的法律、税务和银行信息。 若要了解详细信息，请单击[此处。](https://docs.microsoft.com/azure/marketplace/become-publisher)
...
* **完成注册后预期会出现什么情况？**
  > 使用 "需要操作： verify@microsoft.com验证你的电子邮件帐户" 中的主题行查找电子邮件。 请单击有时间限制的验证链接以完成注册。 *如果在 24 小时内未收到电子邮件，请检查垃圾邮件文件夹。*
