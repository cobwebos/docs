---
title: Azure 市场和 AppSource 发布者指南 | Azure
...
2.  访问[成为市场店面的发布者](./become-publisher.md)页。  
3.  访问[按商品信息类型列出的要求](./listing-type-requirements.md)页。  

---   

## <a name="publishing-checklists"></a>发布清单  
*   访问 [AppSource 的发布清单](publishing-checklist-appsource.md)页。  
*   访问[云合作伙伴门户上 Azure 市场的发布清单](./publishing-checklist-azure-marketplace.md)页。  
...
## <a name="guides"></a>指南  
*   访问 [Azure 市场咨询服务](consulting-services.md)页。  
*   访问 [Azure 市场 SaaS 应用技术发布指南](marketplace-saas-applications-technical-publishing-guide.md)页。  
...
*   访问[通过 Azure AD 启用试用](./enable-trial-using-azure-ad.md)页。  
*   访问 [Azure 市场的计费选项](./billing-options-azure-marketplace.md)页。  
