...
Azure Marketplace 和 AppSource 支持 Microsoft 的系统集成商（SI）合作伙伴提供的咨询服务产品/服务的列表，目的是提供质量咨询服务，让客户能够与他们所需的专家服务联系。 帮助客户评估、评价和部署可帮助他们实现业务目标的正确解决方案和实施。  
...
**注意：** 除 "*简报*" 服务类型外，咨询服务可以亲自提供（即，在客户所在位置或合作伙伴的设施中），也可以以虚拟方式（即通过电话会议、web 会议或远程实现）提供。 简报必须面对面提供。
