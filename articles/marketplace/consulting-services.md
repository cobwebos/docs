...
Azure 应用商店和 AppSource 支持 Microsoft 系统集成商 （SI） 合作伙伴提供的咨询服务产品列表 - 目标是提供高质量的咨询服务，使客户能够与所需的专家服务进行连接。 帮助客户评估、评价和部署可帮助他们实现业务目标的正确解决方案和实施。  

这些咨询服务产品是特定于客户的互动， 发布者可以选择确定列表类型以及固定范围和持续时间，也可选择固定价格或免费，并且已制定了向客户交付成果的明确议程。 通过合作伙伴 CRM 系统中的通知接收潜在客户，目标是在 48 小时内响应客户。 
...
1. [微软云支持台](https://aka.ms/CEDnominate) <br> 云支持台指导体验合作伙伴提名表旨在帮助提供云计划专家，以阐明 MPN 权益，并作为能力实现指南。  
2. 如何在 Power BI 展示牌上列出？ <br> 首先提交要列出的请求，请参阅[成为合作伙伴](https://powerbi.microsoft.com/become-a-partner/)。

<b>有关详细信息，请参阅通过[Microsoft 合作伙伴网络的能力](https://partner.microsoft.com/membership/competencies)。</b>

**SI 合作伙伴可以为以下 21 个国家/地区提交咨询服务产品**
...
5. **暂存**：提交内容将暂存以供查阅。 
6. **发布：** 在你和 Microsoft 都对暂存内容感到满意后，所列产品便可以在市场中推出。 您的上市日期取决于产品/产品中指定的国家/地区。 如果所选国家/地区的目录已在 Azure 应用商店或 AppSource 上驻点，则列表将在几小时内显示。 否则，该目录一推出，就会显示列表。
...
* **研讨会**：在客户场所进行的互动互动互动。 它可以涉及基于客户数据或环境的培训、简报、评估或演示。 

**注：** 除*简报*服务类型外，可亲自（即客户所在地或合作伙伴设施现场）或虚拟（即通过电话会议、网络会议或远程实施）提供咨询服务。 简报必须面对面提供。

当你配置好上面列出的所需元素以后，内容审核团队会验证你的产品/服务描述所提供的信息对于目标受众来说是否足够充分。 

#### <a name="listing-title"></a>列出标题
...
#### <a name="listing-summaries-and-descriptions"></a>列出摘要和说明
...
|**实现**    |  包括一个详细的适用于多日或多周实现的议程，并说明客户参加后预期可以获得的工程变化、技术项目或其他项目       |    使用最常用的搜索引擎优化关键字来优化产品/服务摘要     |
