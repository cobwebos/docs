...
description: 用于发布应用程序的分步指南和发布清单，适用于 Office 365、Dynamics 365、Power Apps 和 Power BI Microsoft AppSource。
author: dsindona
...
Microsoft AppSource 包括在 Office 365、Dynamics 365、Power Apps 和 Power BI 上构建或扩展的产品/服务。 其中每个产品都有特定的文档，可指导你在发布过程中进行操作。 

AppSource 包含付费的、列出的试用版和试用版，并通过调用操作*立即获取它*，*与我联系*，然后*立即试用*。
