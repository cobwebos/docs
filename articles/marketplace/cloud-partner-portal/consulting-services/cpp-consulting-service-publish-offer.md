---
title: Azure 和 Dynamics 365 咨询服务产品/服务发布 |Azure Marketplace
description: 为 Azure Marketplace 或 AppSource 云合作伙伴门户中发布 Azure 或 Dynamics 365 的顾问服务产品。
...
## <a name="lead-destination"></a>潜在客户目标

可以选择用于存储潜在顾客信息的 CRM 系统。 在 AppSource 中试用应用的用户的信息将写入到此处所选的 CRM 系统。

根据选择的 CRM 系统，从以下列表中选择相应的 URL，以获取有关如何填写下一组字段的信息。
