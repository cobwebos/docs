...
> [!NOTE]
> 由于此菜单会定期更新以反映新产品/服务类型和名称的更改，因此你看到的菜单项可能与上表中的那些项不完全匹配。


### <a name="next-steps"></a>后续步骤

如果要创建新的产品/服务，可以使用上表以导航到产品/服务部分以寻求创建和发布产品/服务的指导。  否则，门户教程将继续进行针对[所有产品/服务页面](./cpp-all-offers-page.md)的检查部分。
