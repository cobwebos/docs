---
title: 适用于客户服务的 Dynamics 365 提供先决条件 |Azure Marketplace
description: 已弃用的 CPP 文章，链接到电脑文章。 是 "在 Azure Marketplace 中发布 Azure 应用程序产品/服务的先决条件"
