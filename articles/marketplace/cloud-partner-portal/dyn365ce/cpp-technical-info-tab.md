---
title: Dynamics 365 for Customer Engagement 技术信息选项卡 |Azure Marketplace
description: 链接到电脑文章的不推荐使用的 CPP 文章;"如何在 AppSource Marketplace 上指定 Dynamics 365 for Customer Engagement 应用程序的技术信息"。
author: dsindona
