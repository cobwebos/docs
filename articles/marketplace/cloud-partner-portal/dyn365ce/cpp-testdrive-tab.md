---
title: Dynamics 365 for Customer Engagement 应用程序产品/服务 "测试驱动器" 选项卡 |Azure Marketplace
description: 链接到电脑文章的不推荐使用的 CPP 文章;"如何在 AppSource Marketplace 上配置 Dynamics 365 for Customer Engagement 应用程序产品/服务的测试驱动器"。
