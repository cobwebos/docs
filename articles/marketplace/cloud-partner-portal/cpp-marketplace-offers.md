...
以下视频介绍 Azure Marketplace 或 AppSource 中提供的各种功能和不同的产品/服务类型。  此外，其中还介绍了在这些市场中发布应用程序或服务的重要技术与业务要求。
...
你将了解你可以在 marketplace 产品[/服务的](./manage-offers/cpp-manage-offers.md)常用技术特性和资产上执行的常规操作。
