...
以下视频介绍了 Azure 应用商店或 AppSource 中提供的各种功能和不同的产品/服务类型。  此外，其中还介绍了在这些市场中发布应用程序或服务的重要技术与业务要求。
...
*体验版*是一项市场功能，它针对启用了此功能的每个产品/服务为客户提供了一个“先试后买”演示选项。  测试驱动器功能仅限于以下产品类型子集[：Azure 应用程序](./azure-applications/cpp-azure-app-offer.md)[、Dynamics 365 业务中心](../cloud-partner-portal-orig/cpp-business-central-offer.md)、[面向客户参与的动态 365、](./dyn365ce/cpp-customer-engagement-offer.md)[财务和运营动态 365、SaaS](../cloud-partner-portal-orig/cpp-dynamics-365-operations-offer.md)[应用程序](./saas-app/cpp-saas-offer.md)和[虚拟机](./virtual-machine/cpp-virtual-machine-offer.md)。  此功能需要发布者创建为其产品/服务自定义的体验版模板。  有关详细信息，请参阅[体验版](./test-drive/what-is-test-drive.md)部分。
...
| [动态 365 商务中心](../cloud-partner-portal-orig/cpp-business-central-offer.md) | AppSource | 一个可以扩展此企业资源规划 (ERP) 和业务管理系统的包。 |
| [面向客户互动的动态 365](./dyn365ce/cpp-customer-engagement-offer.md) | AppSource | 通过销售、服务、项目服务和现场服务模块扩展此客户资源管理 （CRM） 系统的包  |
| [Dynamics 365 for Finance and Operations](../cloud-partner-portal-orig/cpp-dynamics-365-operations-offer.md) | AppSource | 扩展此企业资源规划 （ERP） 服务的软件包，支持高级财务、运营、制造和供应链管理 |
| [IoT Edge 模块](./iot-edge-module/cpp-offer-process-parts.md) | Azure | 一个可在 IoT Edge 设备上运行的 Docker 兼容容器。  它由使用自定义代码、其他 Azure 服务和第三方服务组合的小型计算模块组成。 |
| [Power BI 应用](./power-bi/cpp-power-bi-offer.md) | AppSource | 打包可自定义的 Power BI 内容（包括数据集、报表和仪表板）的 Power BI 应用 |
| [SaaS 应用](./saas-app/cpp-saas-offer.md) | Azure | 解决方案是一种软件即服务订阅，由发布者管理，用户通过使用 Azure 活动目录的自定义界面登录。 |
...
您将在"[管理优惠](./manage-offers/cpp-manage-offers.md)"一文中了解您可以对市场优惠执行的一般操作及其共同的技术属性和资产。
