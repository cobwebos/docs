---
title: Azure 资源管理器体验版 |Azure Marketplace
...
请注意:如果用户正在活跃地使用任何体验版，则这些体验版将继续运行，直到用户的会话过期。
...
填写所有体验版字段后，请继续  重新发布产品/服务。 在体验版通过认证后，应该对产品/服务预览版  中的客户体验进行广泛的测试。 在 UI 中启动体验版，然后在 Azure 门户内打开 Azure 订阅并验证是否已正确地完整部署了体验版。
