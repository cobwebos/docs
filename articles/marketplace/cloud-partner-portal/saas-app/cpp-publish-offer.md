---
title: 发布 Azure SaaS 应用程序产品/服务 | Microsoft Docs
description: 在 Azure 市场上发布 SaaS 应用程序产品/服务的过程和步骤。
...
|     **步骤**       |     **时间**      |  **说明**  |
|  ---------------   |  ---------------  |  ---------------  |
|         认证           |       2 周            |          Azure 认证团队对套餐进行分析。 此步骤将针对病毒、恶意软件、安全合规性和安全问题执行扫描。 它还将验证此产品/服务是否符合所有资格条件（请参阅[先决条件](./cpp-prerequisites.md)）。 如果发现了问题，则提供反馈。         |
