---
title: 用于预验证 Azure SaaS 应用程序的自测试客户端 | Microsoft Docs
description: 如何创建用于预验证 Azure SaaS 应用程序的自测试客户端。
...
ms.locfileid: "54081649"
---
# <a name="create-a-self-test-client-to-pre-validate-an-azure-saas-application"></a>创建用于预验证 Azure SaaS 应用程序的自测试客户端
...
|          用户          |          用于连接和登录虚拟机的用户名。         |
|           密码         |         用于连接和登录 VM 的密码。          |
|          操作系统          |         VM 操作系统，“Linux”或“Windows”。          |
|         PortNo           |         用于连接 VM 的开放端口号。 Linux 的端口号通常为“22”；Windows 的端口号为“5986”。          |
...
以下屏幕截图显示了在联机 JSON 查看器中查看的 JSON 测试结果的示例。
...
3. 在“创建”下，提供以下字段所需的信息：
   ...
   - **登录 URL** - 键入“https://isvapp.azurewebsites.net/selftest”
...
要向 Auth0 请求任何授权的应用程序的令牌，请使用以下格式的有效负载对 [https://soamtenant.auth0.com/oauth/token ](https://soamtenant.auth0.com/oauth/token) 终结点执行 POST 操作：
...
成功测试 Azure SaaS 应用程序后，可以[发布产品/服务](./cpp-publish-offer.md)