---
title: Azure 应用程序提供先决条件 |Azure 应用商店
...
ms.locfileid: "80281742"
---
# <a name="azure-application-prerequisites"></a>Azure 应用程序先决条件

本文介绍了在 Azure 市场上发布托管应用程序产品/服务的技术和业务先决条件。  如果您尚未这样做，请查看以下信息来源：
- 根据您的 SKU 类型[，Azure 应用程序：解决方案模板提供发布指南](../../marketplace-solution-templates.md)或[Azure 应用程序：托管应用程序提供发布指南](../../marketplace-managed-apps.md)
- [为 Azure 应用商店视频构建解决方案模板和托管应用程序](https://channel9.msdn.com/Events/Build/2018/BRK3603)
...
* Azure 快速入门模板。<br> 有关详细信息，请参阅：
  ...
  * [GitHub：Azure 资源管理器快速启动模板](https://github.com/azure/azure-quickstart-templates)。 此存储库包含由社区提供的所有当前可用的 Azure 资源管理器模板。 https://azure.microsoft.com/documentation/templates/ 中维护了一个可搜索的模板索引。
* 创建 UI 定义<br>
...
* 你必须是已注册的云市场发布者。 如果您尚未注册，请按照文章"[成为云市场发布者](https://docs.microsoft.com/azure/marketplace/become-publisher
)"中的步骤操作。

>[!NOTE]
>应当使用相同的 Microsoft Developer Center 注册帐户登录到云合作伙伴门户。 对于 Azure 市场产品/服务，只应具有一个 Microsoft 帐户。 此帐户不应特定于单个服务或优惠。

* 您的公司（或其子公司）必须位于 Azure 应用商店支持的"销售来自国家/地区"的地区。 有关这些国家/地区的当前列表，请参阅 Microsoft [Azure 应用商店参与策略](https://azure.microsoft.com/support/legal/marketplace/participation-policies/)。
* 您的产品必须以与 Azure 应用商店支持的计费模型兼容的方式获得许可。 有关详细信息，请参阅 Azure 市场中的[计费选项](https://docs.microsoft.com/azure/marketplace/marketplace-commercial-transaction-capabilities-and-considerations)。
...
* 准备好元数据以备使用。 下面的列表（非详尽）显示了此元数据的示例：
  * 标题
  * 说明（采用 HTML 格式）
  * 徽标图像（以 PNG 格式）和这些固定图像大小：40 x 40 像素、90 x 90 像素、115 x 115 像素和 255 x 115 像素。
* 使用*条款*和*隐私政策*文档
* 应用程序文档
* 支持联系人
