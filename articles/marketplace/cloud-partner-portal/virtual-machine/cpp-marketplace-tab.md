---
title: Azure 应用商店云合作伙伴门户中的虚拟机应用商店选项卡
...
![虚拟机的应用商店选项卡的概述部分](./media/publishvm_008.png)

下表描述了这些字段的用途和内容。 必填字段用星号 (*) 表示。

|  **字段**                |     **说明**                                                          |
|  ---------                |     ---------------                                                          |
| **Title\***                 | 套餐的标题，通常是较长的正式名称。 此标题将在市场中突出显示。  最大长度为 50 个字符。 |
| **总结\***               | 解决方案用途或功能的简短描述。  最大长度为 100 个字符。 |
| **长摘要\***          | 解决方案的用途或功能。  最大长度为 256 个字符。 |
| **描述\***           | 解决方案的说明。  最大长度为 3000 个字符，支持简单 HTML 格式。 |
| **微软CSP经销商渠道\*** | 云解决方案提供商 （CSP） 合作伙伴渠道选择加入现已可用。  有关通过 Microsoft CSP 合作伙伴渠道营销产品/服务的更多信息[，请参阅云解决方案提供商](../../cloud-solution-providers.md)。 |
...
| **预览订阅代码\*** | 为预览版添加 1 到 100 个订阅标识符。 在套餐发布之后、上线之前，这些已加入允许列表的订阅将有权访问该套餐。 |
| **有用链接**          | 将 URL 添加到文档、发行说明、常见问题解答等内容。 |
| **建议类别\*** | 最多选择两 （2） 个类别，包括主类别和辅助类别（可选）。 为每个主类别和/或辅助类别最多选择两 （2） 个子类别。 如果未选择子类别，则仅在所选类别上仍可发现您提供的产品。 |
|  |  |
