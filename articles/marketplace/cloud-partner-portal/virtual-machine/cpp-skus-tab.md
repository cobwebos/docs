---
title: Azure Marketplace 的云合作伙伴门户中的虚拟机 Sku 选项卡
...
![虚拟机的新建产品/服务窗体上的 SKU 选项卡](./media/publishvm_006.png)
...
| **这是一种专用的 SKU？\*** | 指示该 SKU 是专用还是公共 SKU。 默认值为“否”（即公共 SKU）。  有关详细信息，请参阅[公共和专用 SKU](../../cloud-partner-portal-orig/cloud-partner-portal-azure-private-skus.md)。 |
| **国家/地区/区域可用性\*** | 确定可在哪些国家或地区购买你的 SKU。 至少选择一个国家/地区。 <!-- TD: Is this parameter an AMP visibility control or a contractual one, or both? --> |  
|  *定价*   |  |
...
* Microsoft 将分类为某些国家/地区*汇款国家/地区的税务*。  在此类国家/地区，Microsoft 客户，然后向政府支付 （汇寄） 税款。  在其他国家/地区，合作伙伴是通常负责从客户收集税款并向政府支付税款。 如果你选择在后一种的国家/地区销售，必须计算和支付当地税率的功能。  <!-- TD: Find a good reference on taxing policies. The best I found was in the UWP section: https://docs.microsoft.com/windows/uwp/publish/tax-details-for-paid-apps -->
...
（可选） 将指定[测试驱动器](./cpp-test-drive-tab.md)信息如果支持此功能; 否则，提供[marketplace](./cpp-marketplace-tab.md)产品/服务的数据。
