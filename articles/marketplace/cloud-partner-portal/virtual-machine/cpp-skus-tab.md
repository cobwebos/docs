---
title: Azure 应用商店云合作伙伴门户中的虚拟机 SKU 选项卡
...
此时会显示“新建 SKU”对话框。****  输入新 SKU 的标识符，然后单击“确定”。**** （有关标识符命名约定，请参阅下文。 **SKU**选项卡现在将显示可用于编辑的字段。    名称旁边附有星号 (*) 的字段表示必填字段。

<!-- TD: This tab has been updated, now has "Old Pricing" and "Simplified Currency Pricing" sections"! -->

![虚拟机"新优惠"窗体上的 SKU 选项卡](./media/publishvm_006.png)
...
|  *定价*   |  |
| **许可证模型\***| 要使用的标准化计费模型。  如果选择“基于用量的每月计费 SKU”，则会打开一个可折叠部分，可在其中指定每个核心的定价详细信息，以及是否要提供免费试用。****  在此部分，还可将此定价计划导出和导入到 Excel。 有关详细信息，请参阅[Azure 应用商店中的计费选项](../../billing-options-azure-marketplace.md)。 | 
|  *VM 映像*   |  |
| **操作系统系列\*** | 指示解决方案 VM 是基于 Windows 还是 Linux。 |
| **选择操作系统类型** | 指定的 OS 的特定供应商或版本。 |
| **操作系统友好名称\*** | 向客户显示的操作系统名称。  |
| **推荐的 VM 大小\*** | 从标准化列表中最多选择六个建议的 VM 大小。  此列表将传递给 Azure 门户和 Microsoft 市场。  此列表中的第一个 VM 大小有效（对于该客户订阅、区域、区域等）设置为该潜在客户的默认值。  用户可以将此大小更改为与解决方案映像兼容的任何大小。 | 
...
* 微软将一些国家/地区归类为*纳税汇出国*。  在这些国家/地区，Microsoft 向客户征税，然后向政府支付（汇入）税款。  在其他国家/地区，合作伙伴通常负责向客户征税并向政府纳税。 如果您选择在后一国家/地区销售，您必须有能力计算和支付当地税款。  <!-- TD: Find a good reference on taxing policies. The best I found was in the UWP section: https://docs.microsoft.com/windows/uwp/publish/tax-details-for-paid-apps -->
...
* 要单独设置每个区域的价格，请导出定价电子表格，应用自定义定价，然后导入。 


## <a name="next-steps"></a>后续步骤

或者，如果您支持此功能，则可以指定["试驾"](./cpp-test-drive-tab.md)信息;否则，您可以为您的产品/[服务提供市场](./cpp-marketplace-tab.md)数据。
