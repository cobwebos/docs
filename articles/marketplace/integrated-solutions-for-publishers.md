...
ms.locfileid: "82160556"
---
# <a name="publish-an-integrated-solution"></a>发布集成解决方案

在单个捆绑产品中，集成解决方案结合了软件供应商的点解决方案技术与服务合作伙伴的部署和支持。 服务合作伙伴将 Microsoft AppSource 或 Azure Marketplace 中的产品/服务作为[咨询服务](./consulting-services.md)列出。
...
* 服务合作伙伴创建预集成的预集成解决方案，该解决方案具有一流的技术，可在更多客户帐户中进行缩放、土地和扩展。
* Microsoft 可以使用这些预先集成的符合行业的解决方案来更轻松地与客户进行共同销售。 将提前排序定价和条款。
...
批准你的提名后，请使用链接的程序资源开发你的集成解决方案。 请执行下列步骤：
...
1. 以研讨会格式完成重要的业务和技术讨论，以定义解决方案和集成方法。
    ...
    * [业务决策研讨会讨论指南](https://assetsprod.microsoft.com/mpn/integrated-solutions-discussion-guide-for-business-workshop.pptx)
    * [技术决策研讨会讨论指南](https://assetsprod.microsoft.com/mpn/integrated-solutions-discussion-guide-for-technical-workshop.pptx)
...
1. 完成 Microsoft AppSource 或 Azure Marketplace 列表的营销宣传品，其中包括：
    ...
    * 组合解决方案名称。
    * 集成解决方案的列表说明。 遵循[产品/服务-列出最佳实践](./gtm-offer-listing-best-practices.md)。
    * 与客户之间的一页跨度。 使用[单页导航模板](https://assetsprod.microsoft.com/mpn/integrated-solutions-customer-one-pager-template.pptx)。
    * 客户演示。 使用[表示模板](https://assetsprod.microsoft.com/mpn/customer-presentation-template.pptx)。
    * 组合解决方案的徽标。

## <a name="publish-your-integrated-solution"></a>发布集成解决方案

完成技术集成和市场宣传材料后，请参阅适用于[Microsoft AppSource 和 Azure Marketplace 咨询服务](./consulting-services.md)的发布者指南。 使用此资源确定是否将在 Microsoft AppSource 或 Azure Marketplace 中发布解决方案。 还可以使用指南准备发布项目并完成发布过程。

尽管有5种服务类型可用于咨询服务产品/服务，但集成解决方案必须是概念证明或完全实现。

## <a name="go-to-market-with-your-integrated-solution"></a>通过集成解决方案进入市场

如果你的解决方案居住在 Microsoft AppSource 或 Azure Marketplace 中，你将希望通过市场营销活动推动认知和需求。 查看[项目计划和时间线](https://aka.ms/AA5qiuc)中列出的活动。 此资源包括合作伙伴可在其自己的团队中推动的活动。 然后为在 marketplace 中发布的合作伙伴访问[市场推广权益](./gtm-your-marketplace-benefits.md#list-trial-and-consulting-benefits)。 所有集成解决方案产品/服务都有资格获得试用级别的权益。

## <a name="next-steps"></a>后续步骤

有关在 marketplace 中购买集成解决方案的信息，请参阅[集成解决方案](./integrated-solutions.md)。
