...
发布者可以选择部署到启用的任何 Azure 数据中心区域。 我们建议选择距离服务最近的数据中心位置，以优化性能和控制预算。
...
当前，仅免费和自带许可 (BYOL)市场产品可供 Azure CSP 和 Open 客户使用。
...
不是。 部署免费层或 BYOL 套餐无需付款方式。 但是，部署免费试用套餐则需要付款方式。 附带“立即获取”或“免费软件试用”按钮的商品将部署到选定的 Azure 订阅中。  这些商品将使用选定帐户的已注册付款方式进行计费。 Azure 使用费将与软件许可证费用分开计费。
...
客户可以选择部署到发布者启用的任何 Azure 数据中心区域。 可选择距离其服务最近的数据中心位置，以优化性能、管理预算。
...
**可从 Azure 云解决方案提供商 (CSP) 处购买 Azure 市场解决方案吗？**
...
不是。 部署免费层或 BYOL 套餐无需付款方式。 但是，部署免费试用套餐则需要付款方式。
...
不是。 拥有 Azure 市场中解决方案的 ISV 可以定价。 标准 Microsoft 批量许可折扣不适用于 Azure 市场购买内容。
