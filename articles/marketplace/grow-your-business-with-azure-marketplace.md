...
| 可与应用配合使用的具体产品（最多 3&nbsp; 个）：仅限 AppSource 应用 | 列出解决方案使用或扩展的其他产品和技术：<br>例如，Azure IoT 中心或 Azure 机器学习。 |
