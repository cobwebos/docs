...
4.  在“创建”页上，输入应用程序的注册信息：
    -   **名称**：输入有意义的应用程序名称
    -   **应用程序类型**： 
        - 为安装在设备本地的**客户端应用程序**选择“本机”[](https://docs.microsoft.com/azure/active-directory/develop/active-directory-dev-glossary#client-application)。 此设置用于 OAuth 公共[本机客户端](https://docs.microsoft.com/azure/active-directory/develop/active-directory-dev-glossary#native-client)。
        - 为安装在安全服务器上的**客户端应用程序**和[资源/API 应用程序](https://docs.microsoft.com/azure/active-directory/develop/active-directory-dev-glossary#client-application)选择“Web 应用/API”[](https://docs.microsoft.com/azure/active-directory/develop/active-directory-dev-glossary#resource-server)。 此设置用于 OAuth 机密性 [Web 客户端](https://docs.microsoft.com/azure/active-directory/develop/active-directory-dev-glossary#web-client)和公共的[基于用户代理的客户端](https://docs.microsoft.com/azure/active-directory/develop/active-directory-dev-glossary#user-agent-based-client)。
...
5.  完成后，单击“创建”。 Azure AD 将唯一的*应用程序 ID*分配给你的应用程序，并且你\'在应用程序\'的主要注册页上执行此操作。 根据应用程序是 Web 应用程序还是本机应用程序，会提供不同的选项用于将更多功能添加到应用程序。

>[!Note]
>默认情况下，新注册的应用程序配置为只允许同一租户中的用户登录到你的应用程序。
