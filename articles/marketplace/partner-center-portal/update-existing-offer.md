...
1. 选择要更新的产品/服务的名称。 产品/服务的状态可能会列为**预览**、**实时**、**正在进行的发布**、**草稿**、**需要注意**或不可**用**（如果你之前已选择停止销售此产品/服务）。 选择后，该产品/服务的 "产品/服务**概述**" 页将打开。
...
1. 选择计划**名称**、**定价模型**或**可用性**。 *目前，计划仅提供英语（美国）*。
