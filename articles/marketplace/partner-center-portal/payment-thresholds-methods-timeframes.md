...
title: 商业市场中的付款阈值、方法和时间范围 |Azure 应用商店
ms.date: 12/10/2019
ms.topic: conceptual
author: dsindona
ms.author: dsindona
...
ms.locfileid: "80279719"
---
# <a name="payment-thresholds-methods-and-time-frames"></a>付款阈值、方法和时间范围

付款的预计时间以及您可以接收付款的 Microsoft 市场可能因您所在的国家/地区和付款帐户类型而异。 本主题概述了每个国家/地区支持的付款方式。
...
## <a name="payment-methods-in-countriesregions"></a>国家/地区的付款方式

> [!NOTE]
> 所有地区的付款门槛为 50 美元。

| 国家/地区                          | Azure 市场 | 商店、广告、混合器和 Minecraft | Office | 贝宝支付 |
|----------------------------------|-------------------|------------------------------------------|--------|-----------------|
| 阿富汗                      | 是               | 是                                      | 否     | 否              |
| 阿尔巴尼亚                          | 是               | 是                                      | 是    | 是             |
| 阿尔及利亚                          | 是               | 是                                      | 是    | 是             |
