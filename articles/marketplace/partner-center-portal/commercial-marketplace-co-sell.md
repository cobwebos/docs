...
最多可为产品/服务添加三个解决方案区域。 对于每个解决方案区域，最多可以选择两个解决方案子区域。 若要选择多个子类别，请在 `Ctrl` Mac OS) 上使用 Windows) 或命令键 (上的键 (。
...
| *频道跨度 (可选) * | 一张幻灯片，其中包含的信息将帮助渠道经销商详细了解你的解决方案并使其销售团队能够销售你的产品/服务。 它通常包括电梯间推介、有关目标客户的信息、询问客户的问题、谈话点，以及视频、文档和支持信息的链接。 |
