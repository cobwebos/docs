...
ms.locfileid: "69036834"
---
# <a name="create-a-new-dynamics-365-business-central-offer"></a>创建新的 Dynamics 365 业务中心产品/服务

本主题介绍如何创建新的 Dynamics 365 Business Central 产品/服务。 [Microsoft Dynamics 365 Business Central](https://dynamics.microsoft.com/business-central)是一种企业资源规划 (ERP) 系统, 可处理各种业务流程, 包括财务、运营、供应链、CRM 以及项目管理和电子商务。 高级包还支持服务管理和制造。 Dynamics 365 业务中心的所有产品/服务都必须经过我们的认证流程。
...
如果选择了上面的 "**添加"** , 则可以在其中上传产品/服务的包文件, 以及包含依赖项的任何扩展的包文件。
...
如果你的产品/服务必须与已发布到 marketplace 的另一个扩展一起安装, 则需要此服务。 如果是这样, 请在此处上传其 app.config 或 .zip 文件。
...
还必须在此处上传**应用测试自动化**文件 (app.config)。
