...
ms.locfileid: "80285157"
---
# <a name="tax-details-for-commercial-marketplace-publishers"></a>商业市场出版商的税务详情

要了解价格选择的税收注意事项以及[Microsoft Azure 应用商店发布商协议](https://go.microsoft.com/fwlink/p/?LinkID=699560)或现代发布商协议下的税务责任，请参阅下表中的分发国家/区域。

> [!NOTE]
> 商业扩张调整也许在一些特定的国家/地区中具有付款含义。 有关商务扩展调整及其应用市场的详细信息，请参阅[Microsoft Azure 应用商店发布商协议](https://go.microsoft.com/fwlink/p/?LinkID=699560)和受影响国家/地区列表。

> [!IMPORTANT]
> 尽管下表中提供了相关信息，[但 Microsoft Azure 应用商店发布商协议](https://go.microsoft.com/fwlink/p/?LinkID=699560)附件 A 涵盖经销商国家/地区和情况的税务责任（[如下](#reseller-countriesregions)所述）。
> 请注意，"**付款"含义**列仅适用于发布者。 本专栏中注明的税率随时可能会发生变化，Microsoft 无法保证下表中的税率始终准确。
...
| 亚美尼亚                          | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去 20% 的税费，减去商店费用       | Microsoft          |
| 阿鲁巴                      | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
| 澳大利亚                        | 所选择的价格就是最终售价并且包含所有适用的税款。                                                             | 价格减去 10% 的税费，减去商店费用             | Microsoft          |
| 奥地利                          | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。       | 价格减去 20% 的税费，减去商店费用     | Microsoft          |
| 阿塞拜疆                       | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
| 巴哈马                      | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
| 巴林                          | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去 5% 税，减去商店费用                 | Microsoft          |
| 孟加拉                       | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
| 巴巴多斯                         | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
| 白俄罗斯                          | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                  | 价格减去 20% 的税费，减去商店费用         | Microsoft          |
| 比利时                          | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 21% 税，减去商店费用 | Microsoft          |
...
| 保加利亚                         | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。       | 价格减去 20% 的税费，减去商店费用   | Microsoft          |
...
| 哥伦比亚                         | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 16% 的税费，减去商店费用  | Microsoft          |
| 科摩罗联盟                          | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
| 刚果                            | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
| 刚果（金）                      | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
...
| 克罗地亚                          | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。       | 价格减去 25% 的税费，减去商店费用   | Microsoft          |
| 库拉索岛                          | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
| 塞浦路斯                           | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。       | 价格减去 19% 的税费，减去商店费用  | Microsoft          |
| 捷克共和国                   | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。       | 价格减去 21% 税，减去商店费用   | Microsoft        |
| 丹麦                          | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。       | 价格减去 25% 的税费，减去商店费用   | Microsoft          |
...
| 爱沙尼亚                          | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 20% 的税费，减去商店费用 | Microsoft          |
...
| 芬兰                          | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 24% 税，减去商店费用 | Microsoft          |
| 法国                           | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 20% 的税费，减去商店费用 | Microsoft          |
| 加蓬                            | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
| 冈比亚                       | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
| 格鲁吉亚                          | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
| 德国                          | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 19% 的税费，减去商店费用 | Microsoft          |
| 加纳                            | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
| 直布罗陀                        | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
| 希腊                           | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 24% 税，减去商店费用 | Microsoft          |
...
| 匈牙利                          | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 27% 税，减去商店费用） | Microsoft          |
| 冰岛                          | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去 24% 税，减去商店费用）               | Microsoft         |
| 印度                            | 将向所选价格中增加税款。                                                                                                      | 价格减去商店费用                 | Microsoft          |
| 印度尼西亚                        | 所选择的价格就是最终售价并且包含所有适用的税款。  | 价格减去商店费用                 | 发布者          |
| 伊拉克                             | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
| 爱尔兰                          | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 23% 税，减去商店费用 | Microsoft          |
| 以色列                           | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
| 意大利                            | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 22% 的税费，减去商店费用 | Microsoft          |
...
| 韩国                            | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 10% 的税费，减去商店费用 | Microsoft          |
...
| 拉脱维亚                           | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 21% 税，减去商店费用 | Microsoft          |
...
| 列支敦士登                    | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 8% 税，减去商店费用  | Microsoft          |
| 立陶宛                        | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 21% 税，减去商店费用 | Microsoft          |
| 卢森堡                       | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 17% 的税费，减去商店费用 | Microsoft          |
...
| 马耳他                            | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 18% 的税费，减去商店费用 | Microsoft          |
...
| 摩纳哥                           | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 20% 的税费，减去商店费用 | Microsoft          |
...
| 荷兰                      | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 21% 税，减去商店费用 | Microsoft          |
| 新西兰                      | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 15% 的税费，减去商店费用 | Microsoft          |
...
| 挪威                           | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 25% 的税费，减去商店费用 | Microsoft          |
...
| 波兰                           | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 23% 税，减去商店费用 | Microsoft          |
| 葡萄牙                         | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 23% 税，减去商店费用 | Microsoft          |
| 卡塔尔                            | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
| 留尼汪岛                          | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
| 罗马尼亚                          | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 19% 的税费，减去商店费用 | Microsoft          |
| 俄罗斯                           | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 18% 的税费，减去商店费用 | Microsoft          |
...
| 圣马丁（法国部分）       | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
...
| 沙特阿拉伯                     | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去 5% 税，减去商店费用                 | Microsoft          |
| 塞内加尔                          | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
| 塞尔维亚                           | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 20% 的税费，减去商店费用 | Microsoft          |
...
| 斯洛伐克                         | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 20% 的税费，减去商店费用 | Microsoft          |
| 斯洛文尼亚                         | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 22% 的税费，减去商店费用 | Microsoft          |
| 所罗门群岛                  | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
| 索马里                          | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去商店费用                 | 发布者          |
| 南非                     | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 15% 的税费，减去商店费用  | Microsoft          |
| 西班牙                            | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 21% 税，减去商店费用 | Microsoft          |
...
| 瑞典                           | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 25% 的税费，减去商店费用 | Microsoft          |
| 瑞士                      | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 8% 税，减去商店费用  | Microsoft          |
| 中国台湾                           | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。              | 价格减去 5% 税，减去商店费用  | Microsoft          |
...
| 土耳其                           | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去 18% 的税费，减去商店费用 | Microsoft          |
...
| 阿拉伯联合酋长国             | 所选择的价格就是最终售价并且包含所有适用的税款。                                                                   | 价格减去 5% 税，减去商店费用                 | Microsoft          |
| United Kingdom                   | 所选择的价格就是最终售价并且包含所有适用的税款。 在付款之前，将从价格中扣除税款。            | 价格减去 20% 的税费，减去商店费用 | Microsoft          |
...
以下内容仅适用于 Azure 应用商店发布服务器，尽管上述情况与此相反： 

| 国家/地区                   | 价格选择的税收注意事项                                                                                                             | 税务管理                    | 
|----------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------|
| 澳大利亚（对于通过除企业协议外的所有客户购买方案进行的购买） | 所选择的价格就是最终售价并且包含所有适用的税款。 | Microsoft |
| 澳大利亚（仅适用于通过企业协议客户购买方案进行的购买） | 所选择的价格就是最终售价并且包含所有适用的税款。 | 发布者 |
| 巴西 | 所选择的价格就是最终售价并且包含所有适用的税款。 | 发布商 **（请参阅经销商国家/地区）** |
| 墨西哥 | 所选择的价格就是最终售价并且包含所有适用的税款。 | 发布商 **（请参阅经销商国家/地区）** |

## <a name="mixed-remittance-countriesregions-for-publishers"></a>出版者的混合汇款国家/地区
...
在某些国家/地区中，Microsoft 将充当经销商（而不是代理），从而使你的应用和应用内产品在应用商店中可用。 有关经销商国家/地区的条款和条件的详细信息，请参阅[Microsoft Azure 应用商店发布商协议](https://go.microsoft.com/fwlink/p/?LinkID=699560)。

以下内容仅适用于 Azure 应用商店发布者： 

|                    经销商国家/地区                                                                          |
|------------------------------------------------------------------------------------------------------------------------|
| 巴西（对于通过 CSP 以外的所有客户购买方案进行的采购） |
