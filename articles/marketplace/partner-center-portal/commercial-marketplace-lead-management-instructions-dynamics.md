...
本文介绍如何为客户参与（以前的 Dynamics CRM Online）设置 Dynamics 365，详细了解[此处](https://docs.microsoft.com/dynamics365/customerengagement/on-premises/admin/on-prem-server-based-sharepoint-online)的更改，以便处理 marketplace 产品的销售潜在顾客。 
...
2.  通过导航到 Dynamics 实例的 URL （例如 `https://tenant.crm.dynamics.com`），打开 Dynamics 365 以供客户参与。
...
1. 通过导航到 Dynamics 实例的 URL （例如 `https://tenant.crm.dynamics.com`），打开 Dynamics 365 以供客户参与。
