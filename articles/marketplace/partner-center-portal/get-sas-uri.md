...
如果您在创建 SAS URI 时遇到困难，请参阅[常见的 SAS URL 问题](https://docs.microsoft.com/azure/marketplace/partner-center-portal/common-sas-uri-issues)。 否则，请将 SAS URI 保存到安全位置供将来使用。 您需要它在合作伙伴中心发布 VM 产品/服务。
