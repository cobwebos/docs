...
注册后，你将转到 "商业市场概述" 页。 **商业应用商店**显示在左侧导航栏中。 如果选择 "**设置**" > "**合作伙伴设置**" > **计划**"，则会看到" 商业市场 "列出为" 已注册 "。
...
1. 从 "合作伙伴中心"，**选择 "** **设置**" > **开发人员设置**" >  > **计划**"，然后输入你的工作电子邮件地址。
2. 完成发布者配置文件页上的详细信息。
3. 阅读[Microsoft 市场发布者协议](https://go.microsoft.com/fwlink/?LinkID=699560)中的条款和条件，然后选择 "**接受并继续**" 完成注册。
...
注册后，你将转到 "商业市场概述" 页。 **商业应用商店**显示在左侧导航栏中。 如果你选择 "**设置**" > **开发人员设置**" > **计划**"，你会看到 "商业市场" 列出为 "已注册"。
...
组织可以有多个发布者与一个商业 Marketplace 帐户关联。 现有用户可以通过选择 "**帐户设置**" > **发布**者 > "**添加发布者**"，来添加更多的发布者。

>[!NOTE]
>在添加新发布服务器之前，请先登录到合作伙伴中心，然后选择 "**帐户设置**" > **发布者**查看现有发布者列表，然后再添加新的发布服务器。
...
5. 更新窗体上的**发布服务器详细信息**。
   ...
   1. **发布者名称**：将显示在 Azure Marketplace 中或产品/服务 AppSource 的名称。
   1. **PublisherID**：合作伙伴中心用于唯一标识发布者的标识符。 此字段的默认值映射到系统中的现有和唯一的 `PublisherID`，这是不能重复使用的，因此，需要更新此字段。
   1. **联系信息**：需要时更新联系信息。
