...
* 如已安装 [Visual Studio 2012 Update 3](https://docs.microsoft.com/visualstudio/releasenotes/vs2012-update3-vs)，则可使用以下两个选项：
  
  * 重启 Visual Studio，或者
  * 重启解决方案。 然后，只对解决方案执行“生成”操作。  
* 如未安装 [Visual Studio 2012 Update 3](https://docs.microsoft.com/visualstudio/releasenotes/vs2012-update3-vs)，请打开任务管理器，并依次单击“进程”选项卡、“MSBuild.exe”进程和“结束进程”按钮。  
