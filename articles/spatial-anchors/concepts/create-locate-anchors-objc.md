---
title: 创建并找到在 OBJECTIVE-C 中使用 Azure 空间的定位点的定位点 |Microsoft Docs
...
ms.locfileid: "57850728"
---
# <a name="create-and-locate-anchors-using-azure-spatial-anchors-in-objective-c"></a>创建并找到在 OBJECTIVE-C 中使用 Azure 空间的定位点的定位点
...
借助 Azure 空间定位点，可以在不同设备之间共享全球的定位点。 它支持多个开发环境。 在本文中，我们将深入了解如何执行此操作在 OBJECTIVE-C
