...
本文提供了一些指导原则和注意事项，以帮助你使用空间锚来有效地创建和定位锚。

## <a name="good-anchors"></a>良好锚

空间锚可帮助你创建良好锚。 在用户体验（UX）中培训或指导用户创建良好锚，这一点很重要。 通过预先投资创建良好的定位点，可帮助最终用户可靠地查找锚点：
...
首先，如果用户在几秒钟内未找到定位点，则应用应鼓励用户移动设备以捕获更多透视。 该应用程序还可以鼓励用户在环境中进行移动，从更多角度扫描定位点。 设备看到的功能越多，效果越好。
