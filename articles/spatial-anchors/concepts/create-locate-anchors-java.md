---
title: 创建和使用 Azure，Java 中的空间定位点的定位点定位 |Microsoft Docs
...
ms.locfileid: "57880137"
---
# <a name="create-and-locate-anchors-using-azure-spatial-anchors-in-java"></a>创建并查找使用 Azure，Java 中的空间定位点的定位点
...
借助 Azure 空间定位点，可以在不同设备之间共享全球的定位点。 它支持多个开发环境。 在本文中，我们将深入了解如何在 Java 中执行此操作。
