---
title: 在 C++/WinRT 中创建和查找定位点
description: 深入介绍如何使用 Azure 空间定位点在 C++/WinRT 中创建和查找定位点。
...
借助 Azure 空间定位点，可以在不同设备之间共享全球的定位点。 它支持多个不同的开发环境。 本文将深入介绍如何使用 Azure 空间定位点 SDK 在 C++/WinRT 中执行以下操作：
