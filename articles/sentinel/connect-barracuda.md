---
title: Barracuda 数据连接到 Azure Sentinel 预览版 |Microsoft Docs
description: 了解如何连接到 Azure Sentinel Barracuda 数据。
services: sentinel
...
6. 若要使用 Log Analytics 中为 Barracuda 事件相关的架构，搜索**CommonSecurityLog**并**barracuda_CL**。
