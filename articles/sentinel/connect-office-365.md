...
- 你必须是租户的全局管理员或安全管理员。
- 租户必须启用统一审核。 默认情况下，使用 Office 365 E3 或 E5 许可证的租户启用了统一审核功能。 <br>如果你的租户没有这些许可证之一，则必须使用以下方法之一在你的租户上启用统一审核：
    ...
    - [使用 Security & 相容性中心 UI](https://docs.microsoft.com/office365/securitycompliance/search-the-audit-log-in-security-and-compliance#before-you-begin)。
