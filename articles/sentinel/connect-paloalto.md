---
title: 将 Palo Alto Networks 数据连接到 Azure Sentinel 预览版 |Microsoft Docs
...
> [!NOTE]
> 从 pdf 文件的复制/粘贴操作可能会更改的文本并插入随机字符组成。 若要避免此问题，将文本复制到编辑器并删除任何可能会破坏日志格式然后再粘贴它，正如您可以看到在此示例中的字符。
