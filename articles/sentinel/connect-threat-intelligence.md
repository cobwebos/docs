...
你可以通过使用下一节中列出的集成威胁情报平台 (提示) 产品将威胁指标流式传输到 Azure Sentinel，并连接到 TAXII 服务器，或者使用与 [Microsoft Graph Security TIINDICATORS API](https://aka.ms/graphsecuritytiindicators)的直接集成。
