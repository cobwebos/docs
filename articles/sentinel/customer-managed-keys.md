...
> [!NOTE]
> -   仅**向不熟悉的客户**提供 AZURE Sentinel CMK 功能，并通过 azure 功能注册来控制对此功能的访问。你可以通过联系azuresentinelCMK@microsoft.com来请求访问权限，并且当容量可用时，将批准挂起的请求。
...
1.  [启用恢复选项：](../key-vault/general/best-practices.md#turn-on-recovery-options)

    -   请确保已启用[软删除](../key-vault/general/overview-soft-delete.md)。

    -   启用[清除保护](../key-vault/general/overview-soft-delete.md#purge-protection)，防止在软删除后强行删除密钥/保管库。
