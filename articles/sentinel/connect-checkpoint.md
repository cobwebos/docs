...
若要连接到 Azure Sentinel 检查点设备，需要部署上的专用机 （VM 或本地） 来支持的设备和 Azure Sentinel 之间通信的代理。 你可以自动或手动部署代理。 仅在专用的计算机是否在 Azure 中创建新的 VM 提供了自动部署。 
...
在本文档中，您学习了如何将检查点设备连接到 Azure Sentinel。 若要了解有关 Azure Sentinel 的详细信息，请参阅以下文章：
