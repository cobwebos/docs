...
## <a name="view-available-notebooks-from-azure-sentinel"></a>查看 Azure Sentinel 中的可用笔记本
...
2. 选择各个笔记本以阅读其说明、所需的数据类型和数据源。 例如：
    ...
    > [!div class="mx-imgBorder"]
    > ![启动笔记本](./media/notebooks/sentinel-azure-notebooks-nolaunch.png)

3. 选择 "**启动笔记本**"，浏览[Azure Sentinel 社区 GitHub 存储库](https://github.com/Azure/Azure-Sentinel)中的笔记本。

目前无法直接从 Azure Sentinel 启动笔记本。 请改用以下过程，逐步完成将 GitHub 上的笔记本克隆到 Azure Notebooks 项目。
