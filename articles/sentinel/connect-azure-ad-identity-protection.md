...
ms.locfileid: "80616826"
---
# <a name="connect-data-from-azure-ad-identity-protection"></a>连接来自 Azure AD 标识保护的数据



您可以将[Azure AD 标识保护](https://docs.microsoft.com/azure/active-directory/identity-protection/overview-identity-protection)中的日志流式传输到 Azure Sentinel 中，以将警报流式传输到 Azure Sentinel 中，以查看仪表板、创建自定义警报并改进调查。 Azure 活动目录标识保护提供风险用户、风险检测和漏洞的整合视图，并能够立即修复风险，并设置策略以自动修复未来事件。 该服务基于 Microsoft 保护消费者身份的经验，从每天超过 130 亿次登录的信号中获得极大的准确性。 
