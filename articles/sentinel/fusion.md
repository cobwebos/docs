...
在接下来的说明中，Azure Sentinel 会将此页上表示的数据的实际值显示为方括号中的变量。 例如，帐户的实际显示名称而不是\<*帐户名称*>，而是实际数字而不是\<*数字*>。
...
- **从不熟悉的位置登录事件，导致 Exchange Online 邮箱渗透**
    ...
    此警报表示通过\<*帐户名称*> 从\<*位置*>、不熟悉的位置，然后在用户的收件箱中设置了可疑的收件箱转发规则。
    
    这可能表示帐户已泄露，并且邮箱正在用于盗取你的组织中的信息。 用户\<*帐户名称*> 创建或更新了收件箱转发规则，该规则将所有传入电子邮件\<转发到外部地址*电子邮件地址*>。 

- **来自不熟悉的位置的登录事件，导致云应用管理活动可疑**
    
    此警报表示通过\<*帐户名称*> 从\<*位置*> （不熟悉的位置）登录事件。 
...
- **从通向 Office 365 邮箱渗透的匿名 IP 地址登录事件**
    ...
    此警报表示通过\<*帐户名称*> 来自匿名代理 IP 地址\< *ip 地址*> 的登录事件，后跟用户收件箱中设置的可疑收件箱转发规则。
    
    这可能表示帐户已泄露，并且邮箱正在用于盗取你的组织中的信息。 用户\<*帐户名称*> 创建或更新了收件箱转发规则，该规则将所有传入电子邮件\<转发到外部地址*电子邮件地址*>。 

- **来自匿名 IP 地址的登录事件，导致云应用管理活动可疑**
    
    此警报表示通过\<*帐户名称*> 从匿名代理 IP 地址\< *ip 地址*> 的登录事件。 
