...
- 你必须已经设置了 HDInsight 群集。有关可用于创建此类群集的不同方法的说明，请参阅[使用自定义选项在 HDInsight 中设置 Hadoop 群集](hdinsight-provision-clusters)

- 你必须已经安装了 Azure PowerShell，并且已将其配置为可用于你的帐户。有关如何进行此配置的说明，请参阅[如何安装和配置 Azure PowerShell][powershell-install-configure]。
...
* [调试 HDInsight 中的 Hadoop：错误消息][hdinsight-errors]
