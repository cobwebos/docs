...
1. 在存储资源管理器（预览版）中，选择“Azure 帐户设置”。
    ...
    ![Azure 帐户设置][0]
2. 现在，左窗格中会显示已登录的所有 Microsoft 帐户。若要连接到另一个帐户，请选择“添加帐户”，然后遵循对话框中的说明，使用与至少一个活动 Azure 订阅相关联的 Microsoft 帐户登录。
...
2. 在“连接到 Azure 存储”对话框中，指定帐户密钥（Azure 门户中的“密钥 1”值），然后选择“下一步”。
   ...
   ![“连接到 Azure 存储”对话框][24]
3. 在“附加外部存储”对话框中的“帐户名”框内输入存储帐户名，指定其他任何所需的设置，然后在完成时选择“下一步”。
   
   ![“附加外部存储”对话框][8]
4. 在“连接摘要”对话框中检查信息。如果想要更改任何设置，请选择“返回”并重新输入所需的设置。完成后，选择“连接”。
5. 建立连接后，将显示外部存储帐户，其中的存储帐户名后面追加了“(外部)”字样。
