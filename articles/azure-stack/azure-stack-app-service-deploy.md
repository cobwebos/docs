...
ms.sourcegitcommit: 1231fbcbfcfa14c983b22815c8220a2bdba9131d
ms.openlocfilehash: 7e32d737929fe544bc1a286908876947f214ae8b
...
## <a name="register-the-newly-deployed-app-service-provider-with-azure-resource-manager"></a>Register the newly deployed App Service provider with Azure Resource Manager
1.  Open a PowerShell instance as **azurestack\administrator**.
2.  Navigate to the location of the scripts downloaded and extracted in the [prerequisite step](#Download-Required-Components).
...
## <a name="register-the-app-service-gallery-items-in-the-azure-stack-gallery"></a>Register the App Service Gallery Items in the Azure Stack Gallery.
1.  Open a PowerShell instance as **azurestack\administrator**.
2.  Navigate to the location of the scripts downloaded and extracted in the [prerequisite step](#Download-Required-Components).
