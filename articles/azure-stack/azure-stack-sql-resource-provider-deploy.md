...
<a name="to-eliminate-any-manual-configuration-when-deploying-the-resource-provider-you-can-customize-the-following-script"></a>若要在部署资源提供程序时消除任何手动配置，可以自定义以下脚本。  
-  
