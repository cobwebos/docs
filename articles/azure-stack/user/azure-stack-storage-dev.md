...
对于存储客户端库，请注意与 REST API 兼容的版本。 此外必须在代码中指定的 Azure Stack 终结点。
...
### <a name="previous-versions-1802-to-1809-update"></a>以前的版本 （到 1809 1802年更新）
