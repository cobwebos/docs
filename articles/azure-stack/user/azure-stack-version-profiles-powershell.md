...
ms.locfileid: "45985475"
---
# <a name="use-api-version-profiles-for-powershell-in-azure-stack"></a>在 Azure Stack 中使用 PowerShell 的 API 版本配置文件

*适用于：Azure Stack 集成系统和 Azure Stack 开发工具包*

API 版本配置文件提供一种管理 Azure 与 Azure Stack 之间版本差异的方式。 API 版本配置文件是一组具有特定 API 版本 AzureRM PowerShell 模块。 每个云平台都有一组支持的 API 版本配置文件。 例如，Azure Stack 支持特定日期的配置文件版本等**2018年-03-01-混合**，而 Azure 则支持**最新**API 版本配置文件。 安装配置文件时，会安装与指定的配置文件对应的 AzureRM PowerShell 模块。
...
下表列出了所需的 API 配置文件版本和用于 Azure Stack 的最新版本的 PowerShell 管理员模块名字对象。 如果您使用本文使用版本之前 1808年，使用正确的值更新版本配置文件和名字对象。

| 版本不能。 | API 版本配置文件 | PS 管理员模块名字对象 |
| --- | --- | --- |
| 1808 或更高版本 | 2018-03-01-混合 | 1.5.0 |
| 1804 或更高版本 | 2017-03-09-配置文件 | 1.4.0 |
| 1804 之前的版本 | 2017-03-09-配置文件 | 1.2.11 |

> [!Note]  
> 若要从 1.2.11 升级版本，请参阅[迁移指南](https://aka.ms/azpsh130migration)。

## <a name="install-a-profile"></a>安装配置文件

使用**Install-azurermprofile** cmdlet 并结合**2018年-03-01-混合**API 版本配置文件来安装 Azure Stack 所需的 AzureRM 模块。 Azure Stack 操作员模块并不会随此 API 版本配置文件一起安装。 应该根据[安装适用于 Azure Stack 的 PowerShell](../azure-stack-powershell-install.md) 一文的“步骤 3”中所述，单独安装这些模块。
