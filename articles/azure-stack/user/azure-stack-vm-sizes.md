---
title: "在 Azure 堆栈中受支持的虚拟机大小 |Microsoft 文档"
description: "针对 Azure 堆栈中受支持的 VM 大小的引用。"
...
---
# <a name="virtual-machine-sizes-supported-in-azure-stack"></a>在 Azure 堆栈中受支持的虚拟机大小

本文列出了受 Azure 堆栈的虚拟机 (VM) 大小。 


## <a name="general-purpose"></a>常规用途

### <a name="basic-a"></a>基本 A
|大小 - 大小\名称 |vCPU     |内存 | 最大临时磁盘大小 | Max OS 磁盘吞吐量: (IOPS) | 最大临时存储吞吐量 (IOPS) | 最大数据磁盘吞吐量 (IOPS) | 最大 NIC 数 |    
|-----------------|-----|---------|---------|-----|------|-----------|----|
...
|大小     |vCPU     |内存 (GiB) | 临时存储 (GiB)  | Max OS 磁盘吞吐量 (IOPS) | 最大临时存储吞吐量 (IOPS) | 最大数据磁盘 / 吞吐量 (IOPS) | 最多可有 Nic/预期网络带宽 (Mbps) |    
|----------------|--|------|----|----|----|-------|---------|
