...
登录后，你可以[将模板部署](azure-stack-deploy-template-visual-studio.md)或浏览可用的资源类型和资源组以创建你自己的模板。  
