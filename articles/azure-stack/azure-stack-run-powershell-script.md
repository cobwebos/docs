...
ms.openlocfilehash: cb0986593f088f7abe687e9831ffa2f7904cb243
...
## <a name="download-and-extract-microsoft-azure-stack-poc"></a>Download and extract Microsoft Azure Stack POC
...
## <a name="prepare-the-poc-host"></a>Prepare the POC host
...
### <a name="aad-deployment-script-examples"></a>AAD deployment script examples
...
### <a name="using-static-ip-addresses"></a>Using static IP addresses
...
## <a name="activate-the-administrator-and-tenant-portals"></a>Activate the administrator and tenant portals
