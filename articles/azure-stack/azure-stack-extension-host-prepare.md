...
description: 了解如何准备扩展主机自动启用通过将来的 Azure Stack 更新包。
...
ms.locfileid: "42889959"
---
# <a name="prepare-for-extension-host-for-azure-stack"></a>准备适用于 Azure Stack 扩展主机

扩展主机可用于通过减少所需的 TCP/IP 端口的数量来帮助保护 Azure Stack。 此文章讨论了为 1808年更新后的 Azure Stack 更新包通过自动启用的扩展主机准备 Azure Stack。
