...
1. 通过让用户订阅仅包含订阅服务的套餐，来创建委托的提供商订阅。 然后，订阅此套餐的用户可通过为其他用户注册委托的套餐，将这些套餐扩展到其他用户。
...
4. 目前，只能通过委托门户查看公开的已委托套餐。 若要查找和更改此 URL，请执行以下操作：
    ...
    a.  选择**浏览** > **所有服务**，然后在**常规**类别中，选择**订阅**。 选择委托的提供商订阅。 例如“DPSubscription” > “属性”。
