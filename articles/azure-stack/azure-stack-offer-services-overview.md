...
- 应用程序服务、 API Apps、 API 函数、 SQL、 MySQL，如平台即服务 (PaaS) 服务。
...
**容量规划**： 你可能会关心抓住大量的资源和拥塞系统为所有用户的用户。 若要帮助提高性能，您可以[配额配置你的计划](azure-stack-plan-offer-quota-overview.md#plans)cap 使用情况。
