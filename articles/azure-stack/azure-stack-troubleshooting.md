...
### <a name="after-starting-my-azure-stack-tp2-host-some-vms-may-not-automatically-start"></a>After starting my Azure Stack TP2 host, some VMs may not automatically start.
