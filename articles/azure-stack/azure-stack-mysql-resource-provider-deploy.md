...
ms.openlocfilehash: bf169ad8e39c2db94ebcd4515cb68b787908b83f
...
## <a name="steps-to-deploy-the-resource-provider"></a>Steps to deploy the resource provider
...
## <a name="provide-capacity-by-connecting-it-to-a-mysql-hosting-server"></a>Provide capacity by connecting it to a MySQL hosting server
