...
应用商店映像是可用于为你的使用付费或 BYOL (EA/SPLA) 授权。 不支持在单个 Azure 堆栈实例上的使用。 

仅 Datacenter edition 中可用应用商店;客户可以将其自己的服务器映像包括其他版本。
...
| Red Hat Enterprise Linux 7.x（待定） | 64 位 | Red Hat |将你自己的映像 |
