...
1. [登录](azure-stack-connect-azure-stack.md)到门户，作为云管理员，然后选择 **+ 创建资源** > **产品/服务 + 计划** > **提供**。

   ![新产品/服务](media/azure-stack-tutorial-tenant-vm/image01.png)

1. 在中**新产品/服务**，输入**显示名称**并**资源名称**，然后选择一个新的或现有**资源组**。 显示名称是产品/服务的友好名称。 只有云操作员可以看到该资源名称是管理员用于在使用作为 Azure 资源管理器资源的产品/服务的名称。
...
1. 在中**新的计划**部分中，填写**显示名称**并**资源名称**。 显示名称是用户可以看到的计划友好名称。 只有云操作员可以看到该资源名称是云操作员使用使用作为 Azure 资源管理器资源的计划的名称。
...
1. **订阅套餐**
   ...
   c. 若要查看的订阅，请选择**所有服务**，然后在**常规**类别中，选择**订阅**。 选择新订阅，以查看其中包含的服务。
...
1. **预配虚拟机**
   ...
   b.  在仪表板中，选择 **+ 创建资源** > **计算** > **Windows Server 2016 Datacenter Eval**，然后选择**创建**。
