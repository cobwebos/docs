...
![体系结构图示](media/azure-stack-integrate-endpoints/Integrate-Endpoints-01.png)
...
|门户 （管理员）|`Adminportal.[Region].[External FQDN]`|HTTPS|443<br>12495<br>12499<br>12646<br>12647<br>12648<br>12649<br>12650<br>13001<br>13003<br>13010<br>13011<br>13020<br>13021<br>13026<br>30015|
|Azure 资源管理器 （管理员）|`Adminmanagement.[Region].[External FQDN]`|HTTPS|443<br>30024|
|门户 （用户）|`Portal. [Region].[External FQDN]`|HTTPS|443<br>12495<br>12649<br>13001<br>13010<br>13011<br>13020<br>13021<br>30015<br>13003|
|Azure 资源管理器 （用户）|`Management.[Region].[External FQDN]`|HTTPS|443<br>30024|
|图形|`Graph.[Region].[External FQDN]`|HTTPS|443|
|证书吊销列表|`Crl.[Region].[External FQDN]`|HTTP|80|
|DNS|`*.[Region].[External FQDN]`|TCP 和 UDP|53|
|密钥保管库 （用户）|`*.vault.[Region].[External FQDN]`|TCP|443|
|密钥保管库 （管理员）|`*.adminvault.[Region].[External FQDN]`|TCP|443|
|存储队列|`*.queue.[Region].[External FQDN]`|HTTP<br>HTTPS|80<br>443|
|存储表|`*.table.[Region].[External FQDN]`|HTTP<br>HTTPS|80<br>443|
|存储 Blob|`*.blob.[Region].[External FQDN]`|HTTP<br>HTTPS|80<br>443|
