...
> [!IMPORTANT]
> 支持完整的 Azure 堆栈功能，包括 marketplace 联合需要注册。 此外，你将会违反许可条款，如果你没有注册使用作为你的使用付费计费模型时的 Azure 堆栈。 若要了解有关 Azure 堆栈授权模型的详细信息，请参阅[如何购买页面](https://azure.microsoft.com/overview/azure-stack/how-to-buy/)。
