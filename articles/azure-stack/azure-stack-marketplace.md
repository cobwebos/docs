...
> [!Caution]  
> 名为图像和 json 文件的所有库项项目都都可以访问无需后使其 Azure 堆栈应用商店中可用的身份验证。 有关更多注意事项发布自定义应用商店项时，请参阅[创建和发布的应用商店项](azure-stack-create-and-publish-marketplace-item.md)。
