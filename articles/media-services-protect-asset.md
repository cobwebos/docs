<properties linkid="develop-media-services-how-to-guides-encrypt-assets" urlDisplayName="Encrypt Assets in Media Services" pageTitle="如何在 Media Services 中加密资产 - Azure" metaKeywords="" description="了解如何在 Media Services 中使用 Microsoft PlayReady 保护加密资产。代码示例用 C# 编写且使用 Media Services SDK for .NET。代码示例用 C# 编写且使用 Media Services SDK for .NET。" metaCanonical="" services="media-services" documentationCenter="" title="How to: Protect an Asset with PlayReady Protection" authors="migree" solutions="" manager="" editor="" />





<h1><a name="playready"></a>如何：使用 PlayReady 保护功能保护资产</h1>

本文是介绍 Azure Media Services 编程的系列主题中的一篇。前一个主题是[如何：检查作业进度](/zh-cn/documentation/articles/media-services-check-job-progress/)。
...
以下示例演示如何创建一个简单的作业来提供 PlayReady 保护。
   ...
   1. 检索配置数据。你可以从 [Azure Media Encryptor 的任务预设](http://msdn.microsoft.com/library/hh973610.aspx)主题中获取示例配置文件。
   2. 上载 MP4 输入文件
...
<ul>
<li><a href="http://msdn.microsoft.com/library/dn189154.aspx">使用 Microsoft PlayReady 保护资产</a></li>
<li><a href="http://www.microsoft.com/PlayReady/">Microsoft PlayReady</a></li>
</ul>

<h2>后续步骤</h2>
了解如何使用 Media Services 保护资产后，请转到[如何管理资产](/zh-cn/documentation/articles/media-services-manage-assets/)主题。
