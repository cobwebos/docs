...
<!-- URLs. -->
[将移动服务添加到现有应用程序]: /develop/mobile/tutorials/get-started-data
[移动服务快速入门]: /develop/mobile/tutorials/get-started-ios
[Get started with Mobile Services]: /zh-cn/documentation/articles/mobile-services-javascript-backend-windows-store-dotnet-get-started-ios
[Validate and modify data in Mobile Services by using server scripts]: /zh-cn/documentation/articles/mobile-services-ios-validate-modify-data-server-scripts
...
[服务器端授权]: mobile-services-javascript-backend-service-side-authorization
