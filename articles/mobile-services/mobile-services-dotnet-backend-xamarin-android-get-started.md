---
title: 适用于 Xamarin.Android 应用的移动服务入门 | Microsoft Docs
...
> 有关本主题的对等移动应用版本，请参阅[创建 Xamarin.Android 应用](../app-service-mobile/app-service-mobile-xamarin-android-get-started.md)。
> 
> 
...
> [!NOTE]
> 本主题将介绍如何使用 Azure 经典门户创建新的移动服务项目。通过使用 Visual Studio 2013 Update 2，还可以向现有的 Visual Studio 解决方案添加新的移动服务项目。有关详细信息，请参阅[快速入门：添加移动服务（.NET 后端）](http://msdn.microsoft.com/library/windows/apps/dn629482.aspx)
> 
> 
...
> [!NOTE]
> 若要完成本教程，你需要一个 Azure 帐户。如果你没有帐户，可以注册 Azure 试用版并取得多达 10 个免费的移动服务，即使在试用期结束之后仍可继续使用这些服务。有关详细信息，请参阅 [Azure 免费试用](https://azure.microsoft.com/pricing/free-trial/?WT.mc_id=A0E0E5C02&amp;returnurl=http%3A%2F%2Fazure.microsoft.com%2Fzh-CN%2Fdocumentation%2Farticles%2Fmobile-services-dotnet-backend-xamarin-android-get-started)。本教程需要安装 [Visual Studio Professional 2013](https://go.microsoft.com/fwLink/p/?LinkID=257546)。可以使用免费试用版。
> 
> 
...
1. 如果尚未进行此操作，请安装 Visual Studio with Xamarin。可在 [Visual Studio 和 Xamarin 的设置与安装](https://msdn.microsoft.com/library/mt613162.aspx)上找到相关说明。也可以在 Mac OS X 计算机上使用 Xamarin Studio，请参阅 [Mac 用户的设置、安装和验证](https://msdn.microsoft.com/library/mt488770.aspx)。
2. 在[经典门户]中，单击“移动服务”，然后单击刚刚创建的移动服务。
3. 在快速入门选项卡中，单击“选择平台”下的“Xamarin”，然后展开“创建新的 Xamarin 应用程序”。
...
5. 下载发布配置文件，将下载的文件保存到本地计算机，然后记下保存位置。
...
[身份验证入门]: mobile-services-dotnet-backend-xamarin-android-get-started-users.md
[推送通知入门]: mobile-services-dotnet-backend-xamarin-android-get-started-push.md
