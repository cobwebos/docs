...
>[AZURE.NOTE]本主题仅支持 Windows Phone 8.0 和 Windows Phone 8.1 Silverlight 应用程序。如果你有 Windows Phone 应用商店 8.1 或通用 Windows 应用程序，请遵循[本主题的通用 Windows 应用程序版本](mobile-services-dotnet-backend-windows-universal-dotnet-get-started-users.md)。
