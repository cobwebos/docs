...
>[AZURE.TIP]如果你不熟悉如何使用 Microsoft Azure 进行移动开发，请[开始使用 Azure Mobile Apps](/documentation/articles/app-service-mobile-dotnet-backend-ios-get-started-preview) 而不是 Azure 移动服务，因为前者提供[更多的优势](/documentation/articles/app-service-mobile-value-prop-migration-from-mobile-services-preview)。
