<properties
	pageTitle="适用于 Windows 应用商店应用的移动服务入门 | Microsoft Azure"
...
<!-- URLs. -->
[Get started with data]: /zh-cn/documentation/articles/mobile-services-javascript-backend-windows-universal-dotnet-get-started-data
