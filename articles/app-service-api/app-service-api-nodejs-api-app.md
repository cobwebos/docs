---
title: Azure App Service 中的 Node.js API 应用 | Microsoft Docs
...
4. 导航到包含基架代码的文件夹（在本例中为 *ContactList* 子文件夹）。
5. 运行 `npm install`。
...
4. 在“资源组”下拉列表中单击“新建”，然后在“新建资源组名称”中输入“NodejsAPIAppGroup”或其他喜好的名称。
    ...
    [资源组](../resource-group-overview.md)是 Azure 资源的集合，例如 API 应用、数据库和 VM。在本教程中，最好创建新的资源组，因为这样可以通过一个步骤轻松删除针对本教程创建的所有 Azure 资源。
