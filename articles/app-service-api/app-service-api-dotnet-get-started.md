<properties
	pageTitle="应用服务中的 API 应用和 ASP.NET 入门 | Microsoft Azure"
...
2. 在 Visual Studio 2015 或 2013 中打开 ToDoList 解决方案。
   1. 将需要信任每个解决方案。![安全警告](./media/app-service-api-dotnet-get-started/securitywarning.png)
...
5. 在“解决方案资源管理器”的 ToDoListDataAPI 项目中，打开“App\_Start\\SwaggerConfig.c”文件，然后向下滚动到行 174 并将以下代码取消注释。
...
2.  在“发布 Web”向导的“配置文件”步骤中，单击“Microsoft Azure App Service”。
...
6. 在“资源组”下拉列表中单击“新建”，然后输入“ToDoListGroup”或其他喜好的名称。
	...
	使用此框可以选择现有[资源组](../resource-group-overview.md)，或通过键入与订阅中任何现有资源组不同的名称，来创建新资源组。
...
6. 在 ToDoListAPI 项目中，打开“Controllers\\ToDoListController.cs”，查看可使用已生成客户端调用 API 的行 40 上的代码。
...
2.  在“发布 Web”向导的“配置文件”选项卡中，单击“Microsoft Azure App Service”。
...
3. 在 API 应用的“应用程序设置”边栏选项卡中，向下滚动到“应用设置”部分并添加以下密钥和值。该值将为你在本教程中发布的第一个 API 应用的 URL。

	| **键** | toDoListDataAPIURL |
	|---|---|
	| **值** | https://{your data tier API app name}.azurewebsites.net |
