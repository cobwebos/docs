...
9. 使用 [Postman] 对位于 http://localhost:8080/api/contacts/2 中的“get specific contact”API 方法发出请求。
...
6. Git 会将 WAR 文件推送到联机存储库。 为此，请导航到前面创建的 **deploy** 文件夹，以便轻松地将代码提交到应用服务中运行的存储库。 进入控制台窗口并导航到 webapps 文件夹所在的文件夹后，请发出以下 Git 命令启动过程并开始部署。 
