...
1. In the [Management Portal](http://manage.windowsazure.cn), select **Web Sites** to display the list of web sites created by the currently logged on account.
...
For information about configuring your web site to use a custom domain name, see [Configuring a custom domain name for an Azure Web Site](http://www.windowsazure.cn/zh-cn/documentation/articles/web-sites-custom-domain-name/).

##<a name="howtoconfigSSL"></a>How to: Configure a web site to use SSL##

For information about configuring SSL for a custom domain on Azure, see [Enable HTTPS for an Azure web site](http://www.windowsazure.cn/zh-cn/documentation/articles/web-sites-configure-ssl-certificate/). 

##<a name="next"></a>Next steps

* [How to Scale Web Sites](http://www.windowsazure.cn/zh-cn/documentation/articles/web-sites-scale/)

* [How to Monitor Web Sites](http://www.windowsazure.cn/zh-cn/documentation/articles/web-sites-monitor/)
