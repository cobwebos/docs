...
* 若要从 PowerShell 执行该操作，必须使用 Azure PowerShell 0.8.14 或更高版本。你可以在 [Azure 下载](http://www.windowsazure.cn/zh-cn/downloads) 网站上，从"命令行工具"区域下载最新版本的 PowerShell。可以从 PowerShell 窗口使用以下命令，检查所安装的 Azure PowerShell 版本： `(get-module Azure).Version`
