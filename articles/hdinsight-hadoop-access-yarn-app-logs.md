<properties 
	pageTitle="以编程方式访问 HDInsight 应用程序日志 | Azure" 
	description="以编程方式访问 HDInsight 应用程序日志" 
	services="hdinsight" 
	documentationCenter="" 
	authors="bradsev" 
	manager="paulettm" 
...
若要从 Visual Studio 应用程序安装 HDInsight SDK，请转到"工具"菜单，单击"Nuget Package Manager"，然后单击"Package Manager Console"。在控制台中运行以下命令，以安装程序包：
