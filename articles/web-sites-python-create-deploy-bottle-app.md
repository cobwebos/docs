<properties linkid="develop-python-web-site-with-bottle" urlDisplayName="具有 Bottle 的网站" pageTitle="具有 Bottle 的 Python 网站 - Azure 教程" metaKeywords="Azure bottle, bottle website" description="本教程向您介绍在 Azure 上运行 Python 网站。" metaCanonical="" services="web-sites" documentationCenter="Python" title="Creating Websites with Bottle" authors="huvalo" solutions="" manager="" editor="" />
...
您将使用 Bottle web 框架创建应用程序（请参阅本教程针对 [Django](../web-sites-python-create-deploy-django-app) 和 [Flask](../web-sites-python-create-deploy-flask-app) 的备选版本)。将从 Azure 库中创建网站，设置 Git 部署和本地克隆存储库。然后将本地运行应用程序，将其更改、 提交和推送到 Azure。本教程演示如何从 Windows 或 Mac/Linux 执行此操作。
...
对于 Git，我们建议 [Git for Windows](http://msysgit.github.io/) 或 [GitHub for Windows](https://windows.github.com/)。如果您使用 Visual Studio，可以使用集成的 Git 支持。
...
<!--Link references-->
[具有 Python Tools 2.1 for Visual Studio 的 Azure 上的 Bottle 和 MongoDB]: ../web-sites-python-ptvs-bottle-table-storage
[具有 Python Tools 2.1 for Visual Studio 的 Azure 上的 Bottle 和 Azure 表存储]: ../web-sites-python-ptvs-bottle-mongodb
