...
2. 在私有云中创建一个用户，用于 vSphere 复制和 SRM 安装。 下面的[VCENTER UI：在私有 Cloud For vRA 中创建用户 &AMP; SRM 安装](#vcenter-ui-create-a-user-in-private-cloud-for-vra-and-srm-installation)。
3. 准备私有云环境以进行 vRA 安装。
