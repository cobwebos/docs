...
查看所选私有云的完整摘要。  "摘要" 页包括私有云上部署的 DNS 服务器。  可以设置从本地 DNS 服务器到私有云 DNS 服务器的 DNS 转发。  有关 DNS 转发的详细信息，请参阅[为本地云 VCenter 配置 dns 进行名称解析](https://docs.microsoft.com/azure/vmware-cloudsimple/on-premises-dns-setup/)。
...
* [添加 vlan/子网](https://docs.microsoft.com/azure/vmware-cloudsimple/create-vlan-subnet/)。 向此私有云添加 VLAN/子集。
