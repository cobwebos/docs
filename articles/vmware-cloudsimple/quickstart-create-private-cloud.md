...
CloudSimple 提供了一条 ExpressRoute 线路的私有云。 您可以在 Azure 上的将虚拟网络连接到 ExpressRoute 线路。 设置该连接的完整详细信息，请按照中的步骤[Azure 虚拟网络连接，使用 ExpressRoute](https://docs.azure.cloudsimple.com/azure-er-connection)
