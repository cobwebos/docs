...
若要更改的密码，请按照中的说明[管理用户的密码](https://docs.vmware.com/en/VMware-NSX-T-Data-Center/2.4/administration/GUID-DB31B304-66A5-4516-9E55-2712D12B4F27.html)。

> [!WARNING]
> 默认情况下，NSX 管理员密码在 90 天后过期。
