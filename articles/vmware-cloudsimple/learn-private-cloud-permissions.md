...
| **Folder** | 创建文件夹 <br> 删除文件夹 <br> 移动文件夹 <br> 重命名文件夹 |
| **全局** | 取消任务 <br> 容量计划 <br> 诊断 <br> 禁用方法 <br> 启用方法 <br> 全局标记 <br> 运行状况 <br> 许可证 <br> 日志事件 <br> 管理自定义属性 <br> 代理 <br> 脚本操作 <br> 服务管理器 <br> 设置自定义属性 <br> 系统标记 |
