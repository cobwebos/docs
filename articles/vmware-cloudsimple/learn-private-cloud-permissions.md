...
| **dvPort 组** | Create <br> 删除 <br> 修改 <br> 策略操作 <br> 作用域操作 |
...
| **全局** | 取消任务 <br> 容量规则 <br> 诊断 <br> 禁用方法 <br> 启用方法 <br> 全局标记 <br> 医疗业 <br> 许可证 <br> 日志事件 <br> 管理自定义属性 <br> 代理 <br> 脚本操作 <br> 服务管理器 <br> 设置自定义属性 <br> 系统标记 |
...
| **Network** | 分配网络 <br> 配置 <br> 移动网络 <br> 移除 |
| **“性能”** | 修改间隔 |
| **主机配置文件** | 查看 |
