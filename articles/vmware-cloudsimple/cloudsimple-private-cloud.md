---
title: VMware 解决方案中通过 CloudSimple 的私有云-Azure
...
* CloudSimple 完全兼容:
  ...
  * 技能
  * 进程
* 这种兼容性使你的团队能够在 Azure 云中管理工作负荷, 而不会中断策略:
  * 网络
  * 安全性  
  * 数据保护  
  * 审核
...
* 可以配置包含 RAID-1、PSC 和 NSX 管理器的 Vm, 并将其用于保护存储故障。 然后, 它们受 vSphere HA 针对节点和网络故障的保护。
...
* **Azure 云中的灾难恢复和虚拟桌面**
  ...
  * 使用 CloudSimple 门户和熟悉的 VMware 工具复制云中的所有策略和网络。 此复制降低了创建和管理 DR 和 VDI 实现的工作量和风险。
