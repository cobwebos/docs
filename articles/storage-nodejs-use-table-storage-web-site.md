...
> [WACN.NOTE] These steps can also be performed by using the Azure portal. For steps on using the Azure portal to deploy a Node.js application, see [Create and deploy a Node.js application to an Azure Web Site].
...
[WACN.INCLUDE [antares-iaas-signup](../includes/antares-iaas-signup.md)]
...
2. Use the following command to create a new Azure Web Site
	...
	> [WACN.NOTE] If this is the first Azure Web Site for your subscription, you will be instructed to use the portal to create the web site. For more information, see [Create and deploy a Node.js application to an Azure Web Site].
