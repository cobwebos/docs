---
title: 使用 SQL 服务器管理工作室查询 Azure 区块链工作台数据
...
利用 Microsoft SQL Server Management Studio，可以快速编写和测试针对 Azure Blockhain Workbench 的 SQL DB 的查询。 本节包含有关如何从 SQL Server 管理工作室连接到 Azure 区块链工作台的 SQL 数据库的分步演练。
