...
3. 添加新密钥：指定密钥**说明**，并选择**过期**期限值。 
    ...
    ![创建密钥](media/deploy/app-key-create.png)
...
7.  完成“Azure Active Directory 设置”。
    ...
    ![Azure AD 设置](media/deploy/blockchain-workbench-settings-aad.png)
...
9.  在“网络设置和性能”中，选择是要创建新的区块链网络还是使用现有的权威证明区块链网络。
    ...
    ![网络设置和性能](media/deploy/blockchain-workbench-settings-network-new.png)
    ...
    * PoA 区块链网络应配置为将天然气价格设置为零（注意：Blockchain Workbench 帐户不会获得资助。 如果需要资金，交易会失败）。
    ...
    ![网络设置和性能](media/deploy/blockchain-workbench-settings-network-existing.png)
