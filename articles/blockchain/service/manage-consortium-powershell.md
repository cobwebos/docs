...
1. 选择“连接字符串”。
    ...
    替换 *\<Endpoint address\>* 为 **Https (访问密钥 1) ** 或 **https (访问密钥 2) **中的值。
...
| Web3Client | New-Web3Connection 中获取的 Web3Client 对象 | 是 |
...
| 名称 | 要删除的成员名称 | 是 |
| 成员 | 从 Import-ConsortiumManagementContracts 获取的成员对象 | 是 |
| Web3Account | Import-Web3Account 中获取的 Web3Account 对象 | 是 |
| Web3Client | New-Web3Connection 中获取的 Web3Client 对象 | 是 |
