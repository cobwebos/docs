...
1.  在表格模型资源管理器中，转到“数据源”，右键单击连接，并单击“导入新表”。  
    ...
    如果出现“模拟凭据”对话框，请键入在第 2 课中使用的模拟凭据：添加数据。
