---
title: 用于 Azure 分析服务的本地数据网关 |微软文档
...
此处提供的信息特定于 Azure 分析服务如何与本地数据网关一起工作。 要了解有关网关一般及其与其他服务的工作方式的更多内容，请参阅[什么是本地数据网关？](/data-integration/gateway/service-gateway-onprem)
...
- **注册网关** - 在这一步中，指定网关的名称和恢复密钥，然后选择区域，在网关云服务中注册你的网关。 您的网关资源可以在任何区域注册，但建议它位于与分析服务服务器相同的区域。 

- **在 Azure 中创建网关资源**- 在此步骤中，在 Azure 中创建网关资源。

- **将服务器连接到网关资源**- 拥有网关资源后，即可开始将服务器连接到它。 您可以连接多个服务器和其他资源，前提是它们位于同一区域。
...
2. 网关云服务分析查询并将请求推送到[Azure 服务总线](https://azure.microsoft.com/documentation/services/service-bus/)。
...
### <a name="forcing-https-communication-with-azure-service-bus"></a><a name="force-https"></a>强制与 Azure 服务总线进行 HTTPS 通信
...
* [疑难解答](https://docs.microsoft.com/data-integration/gateway/service-gateway-tshoot)
