...
## [Analysis Services 是什么？](analysis-services-overview.md)

# 快速入门

## [创建服务器 - 门户](analysis-services-create-server.md)
## [创建服务器 - PowerShell](analysis-services-create-powershell.md)
## [配置服务器防火墙 - 门户](analysis-services-qs-firewall.md)

# 教程

## [1 - 从门户添加示例模型](analysis-services-create-sample-model.md) 
## [2 - 配置服务器管理员和用户角色](tutorials/analysis-services-tutorial-roles.md)
## [3 - 使用 Power BI Desktop 进行连接](tutorials/analysis-services-tutorial-pbid.md)
...
### [从 Visual Studio (SSDT) 部署](analysis-services-deploy.md)
