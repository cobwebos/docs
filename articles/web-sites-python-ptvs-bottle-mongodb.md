<properties linkid="web-sites-python-ptvs-bottle-mongodb" title="具有 Python Tools 2.1 for Visual Studio 的 Azure 上的 Bottle 和 MongoDB" pageTitle="具有 Python Tools 2.1 for Visual Studio 的 Azure 上的 Bottle 和 MongoDB" description="了解如何使用 Python Tools for Visual Studio 来创建 Bottle 应用程序，该应用程序在 MongoDB 数据库实例中存储数据并且可以部署到网站。" metaKeywords="" services="web-sites" solutions="" documentationCenter="Python" authors="huvalo" videoId="" scriptId="" manager="wpickett" editor="" />
...
在本教程中，我们将使用 PTVS 样本模板之一创建一个简单轮询应用程序。还以[视频](https://www.youtube.com/watch?v=8hQMyf8p_Jo)形式提供了本教程。
...
1.  浏览到**有关**页后以验证该应用程序是否正在使用   **MongoDB** 存储库。
