...
1.  获取 Twilio 帐户和身份验证令牌。若要开始使用 Twilio，请在 [][]<http://www.twilio.com/pricing></a> 上计算价格。你可以在 [][1]<https://www.twilio.com/try-twilio></a> 上注册。有关 Twilio 提供的 API 的信息，请参阅 [][2]<http://www.twilio.com/api></a>。
...
3.  获取 Twilio JAR。在 [][4]<https://github.com/twilio/twilio-java></a> 上，你可以下载 GitHub 源并创建自己的 JAR，或者下载预生成的 JAR（带有或不带依赖项）。
