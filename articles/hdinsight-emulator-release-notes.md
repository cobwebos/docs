...
* [已更新 Hadoop 组件版本](/zh-cn/documentation/articles/hdinsight-component-versioning/) ，使其对应于服务版本 3.1。这包括 Hive 0.13 和 Tez 支持。
...
* 临时目录 
	...
	hadoop.tmp.dir 文件指向错误的位置。它不指向 C:\hadoop\hdfs，而是指向 c:\hdfs。此 Bug 将在下一个 HDP 位的更新中修复。 
