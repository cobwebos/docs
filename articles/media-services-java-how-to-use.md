...
You'll need to set up a media services account before using this code. For information about setting up an account, see [How to Create a Media Services Account](http://www.windowsazure.com/zh-cn/manage/services/media-services/how-to-create-a-media-services-account/).
...
For Media Services Javadoc documentation, see [Azure Libraries for Java documentation][].
  ...
  [Azure Java Developer Center]: http://www.windowsazure.cn/zh-cn/develop/java/
