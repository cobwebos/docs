...
* [使用用于 IntelliJ IDEA 的 HDInsight 工具插件为 HDInsight Spark Linux 群集创建 Spark 应用程序][用于 IntelliJ 的 HDInsight 工具插件]
...
[在 IntelliJ 中调试 Azure 上的 Java Web 应用]: ./app-service-web/app-service-web-debug-java-web-app-in-intellij.md
