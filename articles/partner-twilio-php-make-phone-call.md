...
以下示例演示了如何使用 Twilio 从 Azure 中托管的 PHP 网页发起呼叫。 生成的应用程序将提示用户电话呼叫值，如下图所示。

![使用 Twilio 和 PHP 的 Azure 呼叫窗体][twilio_php]

需要执行以下操作来使用本主题中的代码：

1. 从 [Twilio 控制台][twilio_console]获取 Twilio 帐户和身份验证令牌。 要开始使用 Twilio，请评估[https://www.twilio.com/pricing][twilio_pricing]定价。 您可以在 注册试用帐户。 [https://www.twilio.com/try-twilio][try_twilio]
