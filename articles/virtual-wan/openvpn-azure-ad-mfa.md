...
## <a name="option-1---per-user-access"></a><a name="peruser"></a>选项 1 - 每个用户访问
...
若要连接到虚拟网络，必须创建并配置 VPN 客户端配置文件。 有关[指向站点连接到 Azure，请参阅配置 Azure AD 身份验证](virtual-wan-point-to-site-azure-ad.md)。
