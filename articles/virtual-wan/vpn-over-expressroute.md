...
## <a name="1-create-a-virtual-wan-and-hub-with-gateways"></a><a name="openvwan"></a>1. 使用网关创建虚拟 WAN 和中心
...
当不再需要这些资源时，可以使用[AzResourceGroup](/powershell/module/az.resources/remove-azresourcegroup)删除资源组及其包含的所有资源。 运行以下 PowerShell 命令，并将替换`myResourceGroup`为资源组的名称：
