...
|[Cisco 云服务路由器 (CSR) VWAN](https://aka.ms/ciscoMarketPlaceOffer)| 在公共预览版的 Cisco 云服务 (CSR) WAN 集成到 VWAN 中心时，Cisco 要求最终客户通过向发送电子邮件 vwan_public_preview@external.cisco.com 并请求 VManage 部署指南，将其注册为 CISCO EFT (早于现场试用) 客户。 |
