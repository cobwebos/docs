...
description: 在本教程中，了解如何在虚拟 WAN 中心部署网络虚拟设备。
...
ms.locfileid: "87096356"
---
# <a name="how-to-create-a-network-virtual-appliance-in-an-azure-virtual-wan-hub-preview"></a>如何在 Azure 虚拟 WAN 中心（预览版）中创建网络虚拟设备

本教程介绍如何使用虚拟 WAN 通过 Azure 中的**网络虚拟设备**（NVA）连接到 azure 中的资源。 此类型的连接要求位于本地的 VPN 设备分配有一个面向外部的公共 IP 地址。 有关虚拟 WAN 的详细信息，请参阅[虚拟 WAN 概述](virtual-wan-about.md)。

本文中的步骤可帮助你在虚拟 WAN 集线器中创建**Barracuda CLOUDGEN WAN**网络虚拟设备。 若要完成此练习，必须在开始之前，为部署到中心的 Barracuda CloudGen WAN 设备设置 Barracuda Cloud 本地设备（CPE）和许可证。
...
* 若要了解有关虚拟 WAN 中心中的 Nva 的详细信息，请参阅[关于虚拟 wan 中心（预览版）中的网络虚拟设备](about-nva-hub.md)。