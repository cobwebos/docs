...
* 创建没有任何虚拟网络网关的虚拟网络。 确认本地网络的任何子网都不会与要连接到的虚拟网络重叠。 若要在 Azure 门户中创建虚拟网络，请参阅[快速入门](../virtual-network/quick-create-portal.md)。
...
4. 可在虚拟网络网关的“连接”**** 页中查看连接。
   ...
   ![连接](./media/connect-virtual-network-gateway-vwan/connect.png "connection")
