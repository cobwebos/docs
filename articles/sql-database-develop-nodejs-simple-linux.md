...
本主题中的代码示例需要一个 **AdventureWorks** 测试数据库。如果你尚未创建一个这样的数据库，请参阅 [SQL Database 入门](sql-database-get-started.md)。必须根据指南创建 **AdventureWorks 数据库模板**。下面所示的示例只适用于 **AdventureWorks 架构**。 
