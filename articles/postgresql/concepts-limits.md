...
| 最大连接数        |                   |
| 基本 50 个计算单元     | 55 个连接    |
| 基本 100 个计算单元    | 105 个连接   |
| 标准 100 个计算单元 | 150 个连接   |
| 标准 200 个计算单元 | 250 个连接   |
| 标准 400 个计算单元 | 480 个连接   |
| 标准 800 个计算单元 | 950 个连接   |
| 最大计算单元数      |                   |
| 基本服务层         | 100 个计算单元 |
| 标准服务层      | 800 个计算单元 |
| 最大存储            |                   |
...
Azure 系统需要使用五个连接来监视 Azure Database for PostgreSQL 服务器。 连接数过多时，可能会收到以下错误：
> 严重：很抱歉，客户端数过多
