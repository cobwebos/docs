...
*虚拟网络规则*是一种防火墙安全功能，用于控制 Azure Database for PostgreSQL 服务器是否接受从虚拟网络中的特定子网发送的通信。 本文说明了为何有时候最好选择虚拟网络规则功能来安全地允许与 Azure Database for PostgreSQL 服务器的通信。
...
> - 请确保这两个订阅都注册**了** **DBforPostgreSQL**资源提供程序。 有关详细信息，请参阅[资源管理器注册][resource-manager-portal]
...
仅设置 VNet 防火墙规则不会帮助将服务器保护到 VNet。 还必须打开 VNet**服务终结点，以使**安全生效。 当**你启用服务终结点**时，VNet 子网会经历停机时间，直到它完成从**Off**到**On**的转换。 这在大型 VNet 的上下文中尤其如此。 可以使用 **IgnoreMissingServiceEndpoint** 标志，减少或消除转换期间的停机时间。
