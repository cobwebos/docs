---
title: 配置服务器参数 - Azure 门户 - 后数据库的 Azure 数据库 - 单个服务器
description: 本文介绍如何通过 Azure 门户为 PostgreSQL 在 Azure 数据库中配置 Postgres 参数。
author: rachel-msft
ms.author: raagyema
...
若要逐步执行本操作方法指南，需要：
- [后格雷SQL服务器的 Azure 数据库](quickstart-create-server-database-portal.md)
