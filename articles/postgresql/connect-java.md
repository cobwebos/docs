...
ms.locfileid: "65067380"
---
# <a name="azure-database-for-postgresql---single-server-use-java-to-connect-and-query-data"></a>Azure Database for PostgreSQL - 单一服务器：使用 Java 连接和查询数据
