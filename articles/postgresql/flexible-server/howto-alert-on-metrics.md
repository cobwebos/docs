...
* [Azure 门户](https://docs.microsoft.com/azure/azure-monitor/platform/alerts-metric#create-with-azure-portal)
...
* 了解[在警报中配置 Webhook](https://docs.microsoft.com/azure/azure-monitor/platform/alerts-webhooks)的详细信息。
* 获取[指标集合概述](https://docs.microsoft.com/azure/monitoring-and-diagnostics/insights-how-to-customize-monitoring)以确保服务可用且响应迅速。
