...
description: 本文介绍如何从 Azure 门户配置和访问 Azure Database for PostgreSQL 单服务器的指标警报。
author: rachel-msft
ms.author: raagyema
...
ms.locfileid: "74766831"
---
# <a name="use-the-azure-portal-to-set-up-alerts-on-metrics-for-azure-database-for-postgresql---single-server"></a>使用 Azure 门户为 Azure Database for PostgreSQL 单一服务器的指标设置警报
