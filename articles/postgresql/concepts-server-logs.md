...
Azure Database for PostgreSQL 生成查询和错误日志。 但不支持访问事务日志。 这些日志可用于识别、排除和修复配置错误和性能不佳问题。 有关详细信息，请参阅[错误报告和日志记录](https://www.postgresql.org/docs/9.6/static/runtime-config-logging.html)。
