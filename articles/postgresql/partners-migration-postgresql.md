---
title: Azure Database for PostgreSQL 迁移合作伙伴 | Microsoft Docs
...
ms.locfileid: "36753070"
---
# <a name="azure-database-for-postgresql-migration-partners"></a>Azure Database for PostgreSQL 迁移合作伙伴
为了广泛支持 Azure Database for PostgreSQL 解决方案，请从众多行业领先的合作伙伴和工具中进行选择。 本文重点介绍了提供支持 Azure Database for PostgreSQL 的迁移解决方案的 Microsoft 合作伙伴公司。

## <a name="migration-partners"></a>迁移合作伙伴
| 合作伙伴 | 说明 | 链接 | 视频 |
| --- | --- | --- | --- |
| ![SNP Technologies][1] |**SNP Technologies**<br>SNP Technologies 是一家仅限云的服务提供商，负责为未来的创新型企业构建安全可靠的解决方案。 此公司的信念是为企业创造真正的价值。 从思考到执行，SNP Technologies 都与客户目标一致，即将投资转化为优势。|[网站][snp_website]<br>[Twitter][snp_twitter]<br>[联系][snp_contact] | |
...
| ![Infosys][4] |**Infosys**<br>Infosys 是最新数字服务和咨询领域的全球领导者。 拥有三十多年管理全球企业系统的经验，Infosys 让组织获得以 AI 技术为后盾的核心，帮助组织设置变更执行优先级，在整个数字之旅全程为客户提供专家级指导。 Infosys 还为企业提供大规模的敏捷数字解决方案，实现了前所未有的性能和客户满意度。|[网站][infosys_website]<br>[Twitter][infosys_twitter]<br>[YouTube][infosys_youtube]<br>[联系][infosys_contact] | |
