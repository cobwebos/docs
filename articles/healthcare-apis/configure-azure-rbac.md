...
:::image type="content" source="media/rbac/add-azure-rbac-role-assignment.png" alt-text="添加 Azure RBAC 角色分配":::
...
本文介绍了如何为 FHIR 数据平面分配 Azure RBAC 角色。 接下来了解适用于 FHIR 的 Azure API 的其他设置：
