<properties linkid="web-sites-python-ptvs-flask-table-storage" title="具有 Python Tools 2.1 for Visual Studio 的 Azure 上的 Flask 和 Azure 表存储" pageTitle="具有 Python Tools 2.1 for Visual Studio 的 Azure 上的 Flask 和 Azure 表存储" description="了解如何使用 Python Tools for Visual Studio 来创建 Flask 应用程序，该应用程序在 Azure 表存储中存储数据并且可以部署到网站。" metaKeywords="" services="" solutions="" documentationCenter="Python" authors="huvalo" videoId="" scriptId="" manager="wpickett" editor="" />
...
在本教程中，我们将使用 PTVS 样本模板之一创建一个简单轮询应用程序。还以[视频](https://www.youtube.com/watch?v=qUtZWtPwbTk)形式提供了本教程。
...
1.  在 Visual Studio 中，右键单击 Solution Explorer 中的项目节点，然后选择**属性**。在**调试**选项卡上。
...
1.  以 <kbd>F5</kbd>. 运行应用程序、使用**创建示例轮询**创建的轮询以及通过投票提交的数据将在 Azure 表存储中序列化。
