...
- **手动**：相反，如果服务使用者没有对服务提供者资源的 RBAC 权限，则使用者可以选择手动批准方法。 在这种情况下，连接请求会以**挂起**状态出现在服务资源上。 服务提供商必须手动批准请求，然后才能建立连接。 在手动情况下，服务使用者还可以指定包含请求的消息来向服务提供商提供更多上下文。 服务提供商可以为所有专用终结点连接选择以下选项：**已批准**、**拒绝**、**删除**。
