...
创建 [Azure Cosmos SQL API 帐户](../cosmos-db/create-cosmosdb-resources-portal.md#create-an-azure-cosmos-db-account)。 为简单起见，你可以在与 "WestCentralUS" )  (的其他资源相同的区域中创建 Azure Cosmos 帐户。
