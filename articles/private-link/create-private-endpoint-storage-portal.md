...
> [!IMPORTANT]
> 用于存储的 DNS 配置需要对主机文件进行手动修改才能包含特定帐户的 FQDN。请在 Windows 上使用管理员权限修改以下文件： c:\Windows\System32\Drivers\etc\hosts 或 Linux/etc/hosts 包括上一步中的帐户的 DNS 信息，格式如下 [专用 IP 地址] myaccount.blob.core.windows.net
