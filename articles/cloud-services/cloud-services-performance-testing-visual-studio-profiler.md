...
首先，提供了几个 Visual Studio 配置选项，这些选项在分析时可能会有用。 要使分析报告变得有意义，需要应用程序的符号（.pdb 文件）与系统库的符号。 需要确保引用可用的符号服务器。 为此，请在 Visual Studio 中的“**工具**”菜单上，依次选择“**选项**”、“**调试**”和“**符号**”。 确保**符号文件 (.pdb) 位置**下方列出了 Microsoft 符号服务器。  还可以引用 https://referencesource.microsoft.com/symbols，它可能具有附加的符号文件。
...
如果项目文件夹位于网络驱动器上，则探查器将要求提供其他位置来保存分析报告。
