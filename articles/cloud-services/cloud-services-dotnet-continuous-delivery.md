---
title: "在 Azure 中使用 TFS 持续交付云服务 | Microsoft Docs"
...
7. 在“在代理上运行”结束时添加一个新的序列：
   ...
   8. 在“**处理标准输出**”部分的正下方添加一个 WriteBuildMessage 活动。 设置 Importance = 'Microsoft.TeamFoundation.Build.Client.BuildMessageImportance.High' 和 Message='data'。 这可确保脚本的标准输出将写入到生成输出中。
