...
要了解哪个云服务在运行哪个 OS 系列，可以在 Azure PowerShell 中运行以下脚本，但必须首先[设置 Azure PowerShell](/powershell/azureps-cmdlets-docs)。 有关该脚本的详细信息, 请[参阅 Azure 来宾 OS 系列1生命周期:2014](https://blogs.msdn.com/b/ryberry/archive/2014/04/02/azure-guest-os-family-1-end-of-life-june-2014.aspx)年6月。
