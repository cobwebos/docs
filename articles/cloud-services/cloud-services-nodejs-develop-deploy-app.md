...
>[AZURE.TIP] 想要构建一个简单的网站？ 如果你的方案只涉及一个简单的网站前端，则可以考虑[使用轻型 Web 应用](/documentation/articles/web-sites-nodejs-develop-deploy-mac)。</a> 随着你的 Web 应用的不断扩大和你的需求的变化，你可以轻松升级到云服务。
...
[A browser window displaying http://www.windowsazure.cn/ with the Free Trial link highlighted]: ./media/cloud-services-nodejs-develop-deploy-app/getting-started-12.png
