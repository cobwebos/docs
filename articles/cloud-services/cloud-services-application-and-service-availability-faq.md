...
有关重启的有用信息以及有关来宾和主机 OS 更新的技术详情链接，请阅读 MSDN 博客文章[角色实例因 OS 升级而重启](https://blogs.msdn.com/b/kwill/archive/2012/09/19/role-instance-restarts-due-to-os-upgrades.aspx)。
