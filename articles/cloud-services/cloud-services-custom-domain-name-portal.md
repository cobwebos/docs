...
> [AZURE.TIP]快速入门 - 使用全新的 Azure [操作实例指南](http://support.microsoft.com/kb/2990804)！ 它可使自定义域名快速地与 Azure 云服务或 Azure 网站相关联，并确保通信安全 (SSL)。
...
> [AZURE.NOTE]**www.contoso.com** 的访问者将不会看到真正的主机 (contoso.cloudapp.net)，因此，转发过程对最终用户不可见。
