...
- 如果你要部署使用安全套接字层 (SSL) 进行数据加密的云服务，请[为应用程序配置 SSL](cloud-services-configure-ssl-certificate-portal.md#modify)。

- 如果要配置与角色实例的远程桌面连接，请[为这些角色配置远程桌面](cloud-services-role-enable-remote-desktop.md)。这只能在经典门户中进行。
