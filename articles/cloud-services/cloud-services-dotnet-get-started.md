...
1. 在 [Azure 经典门户](http://manage.windowsazure.com)中，单击“新建”>“数据服务”>“SQL 数据库”>“快速创建”。
...
1. 在 [Azure 经典门户](http://manage.windowsazure.com)中，单击“新建”>“数据服务”>“存储”>“快速创建”。
...
1. 在 ContosoAdsWeb 项目中，为应用程序 *Web.config* 文件打开 *Web.Release.config* 转换文件，删除包含 `<connectionStrings>` 元素的注释块，并在其原位置粘贴下面的代码。
    ...
    保持文件打开进行编辑。
2. 在 [Azure 经典门户](http://manage.windowsazure.com)中，依次单击左窗格中的“SQL 数据库”、在本教程中创建的数据库、“仪表板”选项卡、“显示连接字符串”。
