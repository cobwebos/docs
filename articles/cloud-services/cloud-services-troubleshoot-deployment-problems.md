...
## <a name="problem-i-cannot-access-my-website-but-my-deployment-is-started-and-all-role-instances-are-ready"></a>问题：我无法访问我的网站，但我部署已启动且所有角色实例都准备就绪
...
## <a name="problem-my-role-instances-recycled-without-me-doing-anything"></a>问题：我的角色实例回收而无需执行任何操作
...
## <a name="problem-i-cannot-do-a-vip-swap-and-receive-an-error"></a>问题：我不能进行 VIP 交换并收到错误
...
## <a name="problem-a-role-instance-is-looping-between-started-initializing-busy-and-stopped"></a>问题：已启动、 正在初始化、 繁忙、 和已停止之间循环的角色实例
