...
>
>来宾 OS 系列 6 版本通过显式禁用 TLS 1.0 和 1.1 并定义一组特定的密码套件来强制执行 TLS 1.2。 [了解更多]。
...
已安装 .NET 框架：3.5（包括 2.0 和 3.0），4.5
