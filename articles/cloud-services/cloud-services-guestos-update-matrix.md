...
9 月版来宾 OS 将从 2016 年 9 月 13 日开始推出，预计于 2016 年 10 月 13 日正式发行。

###### <a name="august-9-2016"></a>**2016 年 8 月 9 日**
8 月版来宾 OS 将从 2016 年 8 月 9 日开始推出，预计于 2016 年 9 月 8 日正式发行。 
...
| 配置字符串 | 发行日期 | 停用日期 | 失效日期 |
| --- | --- | --- | --- |
| WA-GUEST-OS-4.38_201611-01 |2016 年 12 月 14 日 |4.4 发行后 |TBD |
...
| WA-GUEST-OS-2.56_201610-01 |2016 年 11 月 16 日 |2.58 发行后 |TBD |
...
**失效**日期过后，仍旧使用该来宾 OS 的所有云服务将被停止、删除或强行升级。 可在[此处][retirepolicy]了解有关停用策略的详细信息。
...
如果手动更新来宾 OS，请阅读[来宾 OS 停用策略][retirepolicy]。
