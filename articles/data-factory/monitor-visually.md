...
2. 在 Azure 门户中，导航到所创建的数据工厂边栏选项卡并单击“监视和管理”磁贴。 这将启动 ADF v2 可视化监视体验。
...
参阅[以编程方式监视和管理管道](https://docs.microsoft.com/en-us/azure/data-factory/monitor-programmatically)一文，了解有关监视和管理管道的信息
