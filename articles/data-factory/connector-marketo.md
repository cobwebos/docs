---
title: 使用 Azure 数据工厂从 Marketo 复制数据 | Microsoft Docs
...
ms.locfileid: "37051071"
---
# <a name="copy-data-from-marketo-using-azure-data-factory"></a>使用 Azure 数据工厂从 Marketo 复制数据
