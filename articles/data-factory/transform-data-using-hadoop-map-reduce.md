...
> [!NOTE]
> 本文适用于目前处于预览状态的版本 2 的数据工厂。 如果使用数据工厂服务版本 1（正式版 (GA)），请参阅 [V1 中的 MapReduce 活动](v1/data-factory-map-reduce.md)。
...
| jarlibs           | 提供作业引用的 Jar 库文件的路径，该作业存储在由 jarLinkedService 引用的 Azure 存储中。 文件名称需区分大小写。 | 否       |
