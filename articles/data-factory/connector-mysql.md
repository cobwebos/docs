...
> * [版本 1 - GA](v1/data-factory-onprem-mysql-connector.md)
...
- 在集成运行时计算机上安装 6.6.5 或更高版本的[适用于 Microsoft Windows 的 MySQL 连接器/Net](https://dev.mysql.com/downloads/connector/net/)。 此 32 位驱动程序与 64 位 IR 兼容。
...
| password | 指定该用户帐户的密码。 将此字段标记为 SecureString。 | 是 |
...
有关可用于定义活动的各个部分和属性的完整列表，请参阅[管道](concepts-pipelines-activities.md)一文。 本部分提供 MySQL 源支持的属性列表。
