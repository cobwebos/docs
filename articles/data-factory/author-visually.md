...
| 设置 | 描述 | 值 |
|:--- |:--- |:--- |
| **存储库类型** | Azure Repos 代码存储库的类型。<br/> | Azure Repos Git |
...
| **GitHub 帐户**                                       | GitHub 帐户名。 此名称可从 https:\//github.com/{account 名称} / {存储库名称}。 导航到此页时，系统会提示输入 GitHub 帐户的 GitHub OAuth 凭据。                                                                                                                                                                                                                                               |                    |
