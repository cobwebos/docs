...
> * [Hadoop 流式处理](transform-data-using-hadoop-streaming.md)
...
> [!NOTE]
> 本文适用于目前处于预览状态的数据工厂版本 2。 如果使用数据工厂服务版本 1（即正式版 (GA)），请参阅[数据工厂版本 1 中的转换活动](v1/data-factory-data-transformation-activities.md)。
