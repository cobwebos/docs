---
title: 以 Dynamics 复制数据（Common Data Service）
...
|:--- |:--- |:--- |
| Common Data Service <br> Dynamics 365 联机 <br> Dynamics CRM Online | AAD 服务主体 <br> Office365 | [Dynamics online + AAD 服务主体或 Office365 auth](#dynamics-365-and-dynamics-crm-online) |
...
| servicePrincipalId | 指定 Azure Active Directory 应用程序的客户端 ID。 | 使用 `AADServicePrincipal` 身份验证时为是 |
| servicePrincipalCredentialType | 指定要用于服务主体身份验证的凭据类型。 允许的值为： **ServicePrincipalKey**或**ServicePrincipalCert**。 | 使用 `AADServicePrincipal` 身份验证时为是 |
