...
1. 使用单个复制活动创建一个数据工厂管道，以便将多 Tb 数据从 Data Lake Storage Gen1 复制到 Data Lake Storage Gen2 以获取复制性能基线。 从[数据集成单元（DIUs）](copy-activity-performance-features.md#data-integration-units)开始，128。 
...
> [Azure Data Lake Storage Gen1](connector-azure-data-lake-store.md)连接器
> [Azure Data Lake Storage Gen2 连接器](connector-azure-data-lake-storage.md)的复制活动概述