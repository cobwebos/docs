...
- 让用户仅能在链接服务中测试连接
    ...
    创建具有以下操作权限的自定义角色角色 **：Microsoft.DataFactory/Factory/getAroleValue/read**和**Microsoft.数据工厂/工厂/getDataPlaneAccess/read**。 在用户的数据工厂资源上分配此自定义角色。
