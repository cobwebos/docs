---
title: 使用 Azure 数据工厂从 Xero 复制数据 | Microsoft Docs
...
ms.locfileid: "72930956"
---
# <a name="copy-data-from-xero-using-azure-data-factory"></a>使用 Azure 数据工厂从 Xero 复制数据

本文概述了如何使用 Azure 数据工厂中的复制活动从 Xero 复制数据。 是基于总体介绍复制活动的[复制活动概述](copy-activity-overview.md)一文进行扩展的。
...
要从 Xero 复制数据，请将复制活动中的源类型设置为“XeroSource”。 复制活动源部分支持以下属性：
