...
|[大容量复制](scripts/bulk-copy-powershell.md?toc=%2fpowershell%2fmodule%2ftoc.json)| 此示例 PowerShell 脚本将数据从 Azure SQL 数据库中的数据库中的多个表复制到 Azure Synapse Analytics (以前的 SQL 数据仓库) 。 |
