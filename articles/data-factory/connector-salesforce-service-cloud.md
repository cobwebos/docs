---
title: 使用 Azure 数据工厂从/向 Salesforce Service Cloud 复制数据
...
有关可用于定义数据集的各个部分和属性的完整列表，请参阅[数据集](concepts-datasets-linked-services.md)一文。 本部分提供 Salesforce Service Cloud 数据集支持的属性列表。
...
有关可用于定义活动的各节和属性的完整列表，请参阅[管道](concepts-pipelines-activities.md)一文。 本部分提供 Salesforce Service Cloud 源和接收器支持的属性列表。
