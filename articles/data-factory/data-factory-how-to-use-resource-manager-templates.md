...
有关参数化的最佳做法，请参阅[创建 Azure Resource Manager 模板的最佳做法](../resource-manager-template-best-practices.md#parameters)一文。 通常，应将参数使用率降到最低，可改用变量时尤其如此。 仅在以下情况提供参数：
