...
**Azure SQL 数据库**。 本文中的演练使用托管 SSIS 目录的 Azure SQL 数据库。 还可使用 Azure SQL 托管实例（预览版）。
...
2. 在“活动”工具箱中展开“常规”，将“执行 SSIS 包”活动拖放到管道设计器图面。 
   ...
   ![将“执行 SSIS 包”活动拖到设计器图面](media/how-to-invoke-ssis-package-ssis-activity/ssis-activity-designer.png) 
