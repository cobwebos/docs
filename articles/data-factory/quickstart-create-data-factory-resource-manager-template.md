...
> * [版本 1 - 正式版](v1/data-factory-build-your-first-pipeline-using-arm.md)
> * [版本 2 - 预览版](quickstart-create-data-factory-resource-manager-template.md) 
...
## <a name="json-definitions-for-entities"></a>实体的 JSON 定义
JSON 模板中定义了以下数据工厂实体： 
