...
使用 Azure 数据工厂，可以轻松创建对预测分析使用已发布 [Azure 机器学习][azure-machine-learning] Web 服务的管道。 有关 Azure 数据工厂服务的快速入门，请参阅文章 [Azure 数据工厂简介](data-factory-introduction.md)和[生成第一个管道](data-factory-build-your-first-pipeline.md)。
