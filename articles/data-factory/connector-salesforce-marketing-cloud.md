...
Salesforce 市场营销云连接器支持 OAuth 2 身份验证。 它构建的[Salesforce 市场营销云 REST API](https://developer.salesforce.com/docs/atlas.en-us.mc-apis.meta/mc-apis/index-api.htm)。
