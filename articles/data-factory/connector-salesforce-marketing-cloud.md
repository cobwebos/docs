---
title: 使用 Azure 数据工厂从 Salesforce Marketing Cloud 复制数据 | Microsoft 文档
...
本文概述了如何使用 Azure 数据工厂中的复制活动从 Salesforce Marketing Cloud 复制数据。 是基于总体介绍复制活动的[复制活动概述](copy-activity-overview.md)一文进行扩展的。
...
Salesforce 营销云连接器支持 OAuth 2 身份验证。 它基于[Salesforce 营销云 REST API](https://developer.salesforce.com/docs/atlas.en-us.mc-apis.meta/mc-apis/index-api.htm)构建。
...
| properties | 描述 | 需要 |
|:--- |:--- |:--- |
| type | 类型属性必须设置为：SalesforceMarketingCloud。 | 是 |
