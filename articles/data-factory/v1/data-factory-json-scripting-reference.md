...
#### <a name="example-json-for-using-sql-authentication"></a>示例：用于使用 SQL 身份验证的 JSON
...
| 脚本 |指定内联脚本，而不是指定 scriptPath 和 scriptLinkedService。 示例："script":"CREATE DATABASE test"。 |否（如果使用 scriptPath 和 scriptLinkedService） |
