...
为使数据管理网关连接到 Teradata 数据库，需要在数据管理网关所在的系统上安装 14 版本或更高版本的 [.NET Data Provider for Teradata](https://go.microsoft.com/fwlink/?LinkId=278886)（用于 Teradata 的 .Net 数据提供程序）。 支持 12 版本和更高版本的 Teradata。
