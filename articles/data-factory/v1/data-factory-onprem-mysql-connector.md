...
要使数据管理网关连接到 MySQL 数据库，需要在数据管理网关所在的同一系统上安装6.6.5 和 6.10.7) 的 [MySQL Connector/NET For Microsoft Windows](https://dev.mysql.com/downloads/connector/net/) (版本。 此 32 位驱动程序与 64 位数据管理网关兼容。 支持 5.1 和更高版本的 MySQL。
