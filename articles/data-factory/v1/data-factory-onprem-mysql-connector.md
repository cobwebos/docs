...
> [!NOTE]
> 请参阅[网关问题故障排除](data-factory-data-management-gateway.md#troubleshooting-gateway-issues)了解连接/网关相关问题故障排除的提示。
...
管道包含配置为使用输入和输出数据集、且计划每小时运行一次的复制活动。 在管道 JSON 定义中，“源”类型设置为 **RelationalSource**，“接收器”类型设置为 **BlobSink**。 为“查询”属性指定的 SQL 查询选择过去一小时内要复制的数据。
