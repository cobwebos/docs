...
1. 在"数据工厂编辑器"中，选择**更多** > **新的计算** > **HDInsight 群集**。
...
1. 在"数据工厂编辑器"中，选择**更多** > **新数据集** > **Azure Blob 存储**。
