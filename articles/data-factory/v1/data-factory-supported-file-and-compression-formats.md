...
要在 Azure Cosmos DB 中按原样导入/导出 JSON 文件，请参阅**将数据移入/移出 Cosmos DB** 一文中的[导入/导出 JSON 文档](data-factory-azure-documentdb-connector.md#importexport-json-documents)部分。[](data-factory-azure-documentdb-connector.md)
