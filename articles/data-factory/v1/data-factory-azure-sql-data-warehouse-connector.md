...
> [!NOTE]
> 使用 PolyBase 和暂存将数据从本地数据存储复制到 Azure SQL 数据仓库时，如果数据管理网关版本低于2.4，则网关计算机上需要 JRE （Java Runtime Environment）来转换源数据转换为正确的格式。 建议将网关升级到最新版本，以避免此类依赖项。
>
