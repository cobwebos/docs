...
单击“文件或文件夹”**** 的“浏览”**** 按钮，找到其中一个文件夹（例如，2016-> 03-> 01-> 02），并单击“选择”****。 应该会在文本框中看到 `2016/03/01/02`。 现在，将**2016**替换为 **{year}，03**替换为 **{month}，01**替换为 **{day}，02**替换为 **{小时}，** 然后按 Tab。 **03** **01** **02**您应该会看到下拉列表，以选择以下四个变量的格式：
