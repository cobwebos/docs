...
> * [版本 1 - 正式版](data-factory-sap-business-warehouse-connector.md)
> * [版本 2 - 预览版](../connector-sap-business-warehouse.md)

> [!NOTE]
> 本文适用于数据工厂版本 1（正式版 (GA)）。 如果使用数据工厂服务版本 2（预览版），请参阅 [V2 中的 SAP Business Warehouse 连接器](../connector-sap-business-warehouse.md)。
