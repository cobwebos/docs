...
你可以使用 Azure PowerShell) cmdlet 的 [AzDataFactoryEncryptValue](https://docs.microsoft.com/powershell/module/az.datafactory/new-azdatafactoryencryptvalue) (1.0 版或 [new-azuredatafactoryencryptvalue](https://msdn.microsoft.com/library/dn834940.aspx) (0.9 或更早版本的 Azure PowerShell) 来加密凭据。
