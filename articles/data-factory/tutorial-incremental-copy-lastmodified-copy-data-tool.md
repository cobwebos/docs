...
3. 在“源数据存储”页上，完成以下步骤：
    ...
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，并单击“添加引用”。 选择“+ 创建新连接”添加一个连接。
...
4. 在“选择输入文件或文件夹”页中完成以下步骤：
    ...
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，并单击“添加引用”。 浏览并选择 **source** 文件夹，然后选择“选择”。
...
6. 在“选择输出文件或文件夹”页中完成以下步骤：
    ...
    a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，并单击“添加引用”。 浏览并选择 **destination** 文件夹，然后选择“选择”。
