---
title: 使用 Azure 数据工厂从 PayPal 复制数据 | Microsoft Docs
...
ms.locfileid: "37054392"
---
# <a name="copy-data-from-paypal-using-azure-data-factory"></a>使用 Azure 数据工厂从 PayPal 复制数据
