...
5. 使用 **Invoke-Command**运行命令。
   
        $results = Invoke-Command -scriptblock $cmd;
6. 查看结果。 如果已成功创建数据集， **结果**中会显示该数据集的 JSON；否则，会显示错误消息。
...
| 主题 | 说明 |
|:--- |:--- |
| [Data Factory REST API Reference](https://msdn.microsoft.com/library/azure/dn906738.aspx) |参阅有关数据工厂 cmdlet 的综合文档 |
