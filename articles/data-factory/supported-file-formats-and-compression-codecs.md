---
title: Azure 数据工厂中的复制活动支持的文件格式
description: 本主题介绍 Azure 数据工厂中的复制活动支持的文件格式和压缩代码。
author: linda33wj
manager: shwang
ms.reviewer: craigg
...
---
# <a name="supported-file-formats-and-compression-codecs-by-copy-activity-in-azure-data-factory"></a>Azure 数据工厂中的复制活动支持的文件格式和压缩编解码器
