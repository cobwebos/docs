...
!["映射" 选项卡](media/data-flow/sink2.png "接收器 2")中的选项
...
!["优化" 选项卡](media/data-flow/opt001.png "接收器选项")上的选项
...
![接收器选项卡](media/data-flow/sink1.png "接收器 1")
...
!["设置" 选项卡，显示 sql 接收器选项](media/data-flow/alter-row2.png "sql 选项")
...
![Sql 数据集设置，显示编辑表名称](media/data-flow/dataset2.png "SQL 架构")的位置
