...
---
# <a name="tutorial-build-your-azure-first-data-factory-using-microsoft-visual-studio"></a>教程：使用 Microsoft Visual Studio 构建第一个 Azure 数据工厂
...
3. 将 **accountname** 和 **accountkey** 替换为 Azure 存储帐户及其密钥。 若要了解如何获取存储访问密钥，请参阅 [View, copy and regenerate storage access keys](../storage/storage-create-storage-account.md#view-copy-and-regenerate-storage-access-keys)
