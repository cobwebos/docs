...
> [!IMPORTANT]
> 执行本教程前，请通读[教程概述](data-factory-copy-data-from-azure-blob-storage-to-sql-database.md)并完成**先决条件**步骤。
> 
> 
...
4. 在“新建数据工厂”边栏选项卡中单击“创建”。
   ...
   > 
   > 
5. 单击左侧的“通知”中心，查找创建过程中的通知。如果“通知”边栏选项卡处于打开状态，则单击“X”将其关闭。
6. 完成创建后，将看到如下图所示的“数据工厂”边栏选项卡：
...
9. 在“指定 Azure SQL 数据库”页中：
   ...
   4. 输入**用户名**和**密码**。
   5. 单击“下一步”。
10. 在“表映射”页，从下拉列表选择“emp”作为“目标”字段，单击**向下箭头**查看架构和预览数据（可选）。
    
     ![复制工具 - 表映射](./media/data-factory-copy-data-wizard-tutorial/copy-tool-table-mapping-page.png)
11. 在“架构映射”页中，单击“下一步”。
12. 在“性能设置”页上，单击“下一步”。
13. 在“摘要”页中查看信息，然后单击“完成”。复制向导在数据工厂（即启动该向导的位置）中创建两个链接服务、两个数据集（输入和输出）和一个管道。
14. 在“部署成功”页上，单击链接：**单击此处监控副本管道**。
    
    ![复制工具 - 部署成功](./media/data-factory-copy-data-wizard-tutorial/copy-tool-deployment-succeeded.png)
15. 查看[使用监视应用监视和管理管道](data-factory-monitor-manage-app.md)中的说明，学习如何监视所创建的管道。单击**活动时段**列表中的“刷新”图标进行查看。
