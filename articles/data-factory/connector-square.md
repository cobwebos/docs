...
ms.locfileid: "74931009"
---
# <a name="copy-data-from-square-using-azure-data-factory-preview"></a>使用 Azure 数据工厂（预览版）从 Square 复制数据

本文概述了如何使用 Azure 数据工厂中的复制活动从 Square 复制数据。 是基于总体介绍复制活动的[复制活动概述](copy-activity-overview.md)一文进行扩展的。
...
| redirectUri | 在 Square 应用程序仪表板中分配重定向 URL。 （例如 http：\//localhost：2500）  | 是 |
