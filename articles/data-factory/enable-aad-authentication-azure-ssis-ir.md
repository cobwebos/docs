...
3.  将 ADF 的托管标识添加到该组。 你可以按照文章为[数据工厂托管标识](https://docs.microsoft.com/azure/data-factory/data-factory-service-identity)一文获取主体托管标识对象 id （例如 765ad4ab-51ed985819dc，但不要使用托管标识应用程序 ID 实现此目的）。
