...
- **建议**：查看详细信息中的错误。 请参阅 blob 帮助文档： https://docs.microsoft.com/rest/api/storageservices/blob-service-error-codes 。 如果需要帮助，请联系存储团队。
...
- **建议**：检查 ADLS Gen2 引发的详细错误消息。 如果是暂时性故障导致的，请重试。 如果需要进一步的帮助，请联系 Azure 存储支持，并提供错误消息中的请求 ID。
