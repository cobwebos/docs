...
|[使用 Azure 数据工厂进行 SAP 数据集成](https://github.com/Azure/Azure-DataFactory/blob/master/whitepaper/SAP%20Data%20Integration%20using%20Azure%20Data%20Factory.pdf) | 本文总结了 Azure 数据工厂当前对 SAP 数据集成的支持，包括目标方案、SAP 连接器选项和不同要求的比较，以及数据工厂中每个 SAP 连接器的介绍。 | 
...
|[Azure 数据工厂 = DevOps](https://azure.microsoft.com/mediahandler/files/resourcefiles/whitepaper-adf-on-azuredevops/Azure%20data%20Factory-Whitepaper-DevOps.pdf)| 本白皮书介绍了有关 Azure 数据工厂持续集成和部署的一些最佳实践。 |
