...
此连接器需要 AWS 标识和访问管理 (IAM) 帐户的访问密钥才能从 Amazon S3 复制数据。 [暂时安全凭据](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp.html)目前不受支持。
