---
title: 使用 Azure 数据工厂从 Amazon 简单存储服务（S3）复制数据
...
有关可用于定义活动的各节和属性的完整列表，请参阅[管道](concepts-pipelines-activities.md)一文。 本部分提供 Amazon S3 源支持的属性列表。
