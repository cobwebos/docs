...
* 请使用 Internet Explorer 或与 Microsoft ClickOnce 兼容的 Web 浏览器。
    ...
    对于 Firefox，请执行相同的操作（安装外接程序）。 在工具栏上单击“打开菜单”按钮（右上角的三条横线），单击“扩展程序”，使用“ClickOnce”关键字进行搜索，然后选择一个 ClickOnce 扩展并安装它。
...
有关步骤，请参阅[监视管道](data-factory-build-your-first-pipeline-using-editor.md#monitor-pipeline)。
