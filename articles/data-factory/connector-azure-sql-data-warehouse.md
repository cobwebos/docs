...
如果表具有物理分区，你会看到 "HasPartition" 为 "是"。
...
**启用暂存：** 确定在写入 Azure Synapse Analytics 时是否使用 [PolyBase](https://docs.microsoft.com/sql/relational-databases/polybase/polybase-guide)
