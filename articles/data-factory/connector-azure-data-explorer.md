...
>[!TIP]
>对于 Azure 数据工厂和 Azure 数据资源管理器集成，有关详细信息，请参阅将[azure 数据资源管理器与 Azure 数据工厂集成](../data-explorer/data-factory-integration.md)。
...
>[!TIP]
>有关 Azure 数据资源管理器连接器的演练，请参阅[使用 Azure 数据工厂将数据复制到 azure 数据资源管理器](../data-explorer/data-factory-load-data.md)和从[数据库大容量复制到 azure 数据资源管理器](../data-explorer/data-factory-template.md)。
...
有关可用于定义活动的各部分和属性的完整列表，请参见 [Azure 数据工厂中的管道和活动](concepts-pipelines-activities.md)。 本部分提供了 Azure 数据资源管理器源和接收器支持的属性列表。
