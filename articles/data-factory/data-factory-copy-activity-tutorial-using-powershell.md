...
4. 启动记事本。 复制以下文本，将文件命名为 **emp.txt**，然后将其保存到硬盘上的 **C:\ADFGetStartedPSH** 文件夹。
...
| 主题 | 说明 |
|:--- |:--- |
| [Data Factory Cmdlet Reference](/powershell/module/azurerm.datafactories) | 本部分介绍所有数据工厂 cmdlet |
