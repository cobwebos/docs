...
ms.locfileid: "90528408"
---
# <a name="quickstart-provision-a-simulated-device-to-iot-hub-with-symmetric-keys"></a>使用对称密钥向 IoT 中心预配模拟设备
...
1. 在“设备预配服务”菜单中选择“概述”，并记下“ID 范围”和“预配服务全局终结点”。****____
...
2. 打开 Java 设备示例代码进行编辑。 设备示例代码的完整路径为：
   ...
   - 添加 DPS 实例的“ID 范围”和“预配服务全局终结点”____。 另外，包含你为单独注册选择的主对称密钥和注册 ID。 保存所做更改。 
