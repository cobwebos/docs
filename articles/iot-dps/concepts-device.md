...
description: 描述设备配置概念，这些概念特定于设备配置服务 （DPS） 和 IoT 中心
author: nberdy
ms.author: nberdy
ms.date: 11/06/2019
ms.topic: conceptual
...
* 基于共享访问签名 （SAS）[安全令牌](../iot-hub/iot-hub-devguide-security.md#security-tokens)的**对称密钥**，其中包括哈希签名和嵌入式过期。 有关详细信息，请参阅[对称密钥证明](concepts-symmetric-key-attestation.md)。
