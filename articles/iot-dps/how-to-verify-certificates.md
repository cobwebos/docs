...
- 可以遵循 IoT 中心文档中[用于管理 CA 签名的 X.509 证书的 PowerShell 脚本](https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-security-x509-create-certificates)中的步骤，具体而言，请运行标题为 [X.509 CA 证书的所有权证明](https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-security-x509-create-certificates#signverificationcode)的部分中所述的脚本。
