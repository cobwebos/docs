---
title: 快速入门：如何使用 C# 将 X.509 设备注册到 Azure 设备预配服务
...
1. 根据[管理示例和教程的测试 CA 证书](https://github.com/Azure/azure-iot-sdk-c/blob/master/tools/CACertificates/CACertificateOverview.md)中的步骤进行操作。
