...
学习如何在 HDInsight 上定义工作流以及如何运行该工作流。若要了解 Oozie 协调器，请参阅[将基于时间的 Oozie 协调器与 HDInsight 配合使用][]。
...
> [WACOM.NOTE] 有关 HDInsight 群集上支持的 Oozie 版本，请参阅 [HDInsight 提供的群集版本有哪些新功能？][]。
...
*C:\\apps\\dist\\oozie-3.3.2.1.3.2.0-05\\oozie-win-distro\\logs\\Oozie.log* 或 *C:\\apps\\dist\\oozie-4.0.0.2.0.7.0-1528\\oozie-win-distro\\logs\\Oozie.log*。有关 RDP 的信息，请参阅[使用管理门户管理 HDInsight 群集][]。
...
-   [为 HDInsight 开发 Java MapReduce 程序][]
  ...
  [将基于时间的 Oozie 协调器与 HDInsight 配合使用]: ../hdinsight-use-oozie-coordinator-time/
  ...
  [运行工作流]: #run
  [后续步骤]: #nextsteps
  [工作流关系图]: ./media/hdinsight-use-oozie/HDI.UseOozie.Workflow.Diagram.png
  ...
  [教程准备的输出结果]: ./media/hdinsight-use-oozie/HDI.UseOozie.Preparation.Output1.png
  [教程运行工作流输出]: ./media/hdinsight-use-oozie/HDI.UseOozie.RunWF.Output.png
