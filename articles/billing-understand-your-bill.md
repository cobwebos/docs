...
可能会有数千行的日常使用数据，具体取决于你的使用情况。如果您想分析此数据，请单击“下载使用量”，然后选择逗号分隔变量文件 (.csv) 版本，以查看相应计费周期内的每日使用量数据。您可以下载每个版本的示例 .csv 文件，以供您参考。
 ...
 名称 | 下载 |
 :----------:| :-------: |
 详细的使用量 .csv 版本 1| [示例文件](https://azurepricing.blob.core.windows.net/sampleinvoices/Micorosft_Azure_Detailed_Usage_v1.csv)
 详细的使用量 .csv 版本 2 | [示例文件](https://azurepricing.blob.core.windows.net/sampleinvoices/Micorosft_Azure_Detailed_Usage_v2.csv)
