...
在“使用量和计费门户”[](https://account.windowsazure.cn/subscriptions)中，您可以查看当前的帐单，并能下载过去的帐单。

查看或下载帐单：

1. 使用您的 Microsoft 帐户 ID 或者工作或学校帐户 ID，登录“使用量和计费门户”[](https://account.windowsazure.cn/subscriptions)。
...
“客户信息”部分中指明了与使用量和配置文件相关的信息。![标头的值开始缓存响应](./media/billing-understand-your-bill/Header.png)
