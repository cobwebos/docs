...
> [WACOM.NOTE] This tutorial covers using Hadoop 2.4 clusters in HDInsight (preview). For other supported version, click the selector on the top of the page. For version information, see [What's new in the cluster versions provided by HDInsight?][hdinsight-versions]
...
- For notes on the latest HDInsight releases, see [HDInsight Release Notes](http://azure.microsoft.com/en-us/documentation/articles/hdinsight-release-notes/).
...
4. From the Cluster Details tab, enter or select the following values:
	...
	<tr><td><strong>HDInsight Version</strong></td><td>Choose <strong>3.1</strong> to create a Hadoop 2.4 cluster on HDInsight.</td></tr>
