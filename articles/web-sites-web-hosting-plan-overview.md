...
Each pricing tier (e.g. Free, Shared, Basic, and Standard) has its own set of features.  [Go here](http://azure.microsoft.com/zh-cn/pricing/details/web-sites/) for the latest feature and pricing info.
...
Clicking on the plan will launch a blade that lets you manage your web hosting plan.  [Learn more about managing web hosting plans](http://azure.microsoft.com/zh-cn/documentation/articles/azure-web-sites-web-hosting-plans-in-depth-overview/).
