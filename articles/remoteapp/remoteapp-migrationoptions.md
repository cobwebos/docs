...
如果由于[停用公告](https://go.microsoft.com/fwlink/?linkid=821148)或已经完成评估，从而停止使用 Azure RemoteApp，你需要从 Azure RemoteApp 迁移到另一个应用服务。 有两种迁移方法：自托管（通常称为基础结构即服务 [IaaS]）部署或完全托管（通常称为平台即服务或软件即服务 [PaaS/SaaS]）产品/服务。 
...
了解详细信息：
- [从 Azure RemoteApp 迁移到 Citrix XenApp Essentials](remoteapp-migrate-citrix.md)
- [Citrix 和 Microsoft](https://www.citrix.com/global-partners/microsoft/remote-app.html)
- [Citrix XenApp Essentials presentation](https://www.youtube.com/watch?v=91Z7CCfQ-9k)（Citrix XenApp Essentials 演示）。  
...
[Caase.com](http://www.caase.com/) 可帮助公司、当地政府、非政府机构和医疗保健机构更智能地使用 Microsoft 云工作。 无论在任何位置、使用任何设备都能以较低 IT 成本保证工作效率和工作安全。 Caase.com 是 Microsoft Office365、Azure、企业移动性和安全性以及 Windows 领域的真正专家。 通过咨询、迁移服务、采用计划、培训、管理和支持，Caase.com 构建出最佳的安全平台，供双方客户的雇员、合作伙伴和供应者协作。
Caase.com 是 Azure 远程工作区（移动工作区）和数字工作区（社交 Intranet）的优秀策划者。 这两种解决方案（都通过采用计划实现）作为基础，能确保这两种解决方案的用户在使用 Microsoft 云时拥有最愉悦、最成功和最高效的体验。
有关荷兰语翻译和辅助影片，请访问： http://caase.com/over-ons/

> 运营区域：立足荷兰，覆盖全球
> 
> 合作伙伴状态：[金牌](https://partnercenter.microsoft.com/pcv/solution-providers/caasecom_4295593260/51159_3)
> 
> Microsoft 云服务提供商：是
> 
> 提供基于会话的 RemoteApp 和桌面解决方案：是，两者
> 
> Azure RemoteApp 迁移解决方案：是，[了解更多](http://caase.com/diensten/microsoft-azure/)。
> 
> 
> 荷兰：
> 
...
[Nerdio for Azure](http://getnerdio.com/nfa/) 是 IT 自动化平台，可用于在 Microsoft 云中十分简单地预配、管理和优化完整的 IT 环境。 在数小时内便可设置好虚拟桌面、远程应用和服务器。 使用 Nerdio 管理员门户最多单击三次便可管理环境。 使用智能自动缩放便可节省 40 - 60% 的 Azure IaaS 资源。

> 主要地点：芝加哥；IL 运营区域：全球合作伙伴状态：[金牌](https://partnercenter.microsoft.com/en-us/pcv/solution-providers/adar-inc_341c9afa-f12c-46f5-8f7b-3f9ef59a66a5/3a7ae479-3ac2-42f6-84e2-d456dc7424e1) Microsoft 云服务提供商：是
> 
> 提供基于会话的 RemoteApp 和桌面解决方案：是，两者
> 
> Azure RemoteApp 迁移解决方案：是
> 
> 
> 8001 Lincoln Ave
> 
...
2. 联络 [Azure 支持部门](https://portal.azure.com/?#blade/Microsoft_Azure_Support/HelpAndSupportBlade)。 首先打开 [Azure 支持案例](https://portal.azure.com/?#blade/Microsoft_Azure_Support/HelpAndSupportBlade)。
