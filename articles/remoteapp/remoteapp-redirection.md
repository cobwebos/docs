...
通过一起使用 Microsoft Azure PowerShell 与 SDK，你可以更改某个集合的设备重定向设置。 在安装了新的 PowerShell 和 SDK 之后，首先将其配置为管理你的订阅，如[如何安装和配置 Azure PowerShell](../powershell-install-configure.md) 中所述。
