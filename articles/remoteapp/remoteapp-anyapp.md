...
1. 单击先前创建的集合，访问其他选项并配置该集合。![新的 RemoteApp 云集合](./media/remoteapp-anyapp/ra-anyappcollection.png)
2. 在“发布”选项卡上，单击屏幕底部的“发布”，然后单击“发布开始菜单程序”。![发布 RemoteApp 程序](./media/remoteapp-anyapp/ra-anyapppublish.png)
3. 从列表中选择要发布的应用。出于我们的目的，选择“Access”。单击“完成”。等待应用完成发布。![在 RemoteApp 中发布 Access](./media/remoteapp-anyapp/ra-anyapppublishaccess.png)
...
3. 现在，从 RemoteApp 启动 File Explorer 应用。将要在共享的应用中使用的任何 Access 文件复制到文件共享。![将 Access 文件放在 Azure 共享中](./media/remoteapp-anyapp/ra-anyappuseraccess.png)
4. 最后，打开 Access，然后打开刚共享的数据库。应在从云运行的 Access 中看到你的数据。![从云中运行的实际 Access 数据库](./media/remoteapp-anyapp/ra-anyapprunningaccess.png)
