...
* [SQL Data Sync (WA Portal)](http://msdn.microsoft.com/zh-cn/library/azure/jj856263.aspx)
* [Getting Started with Azure SQL Database](../getting-started-w-sql-databases/)
* [SQL Server Database Lifecycle ](http://msdn.microsoft.com/zh-cn/library/hh213416.aspx)
