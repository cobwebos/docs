...
## [从 Key Vault 读取 - .NET](quick-create-net.md)
## [从 Key Vault 读取 - Node.js](quick-create-node.md)
# 教程
...
## Node.js
### [保管库管理](https://docs.microsoft.com/javascript/api/azure-arm-keyvault/)
### [保管库客户端库](https://docs.microsoft.com/javascript/api/azure-keyvault/)
## 开发
