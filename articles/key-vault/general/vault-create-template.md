...
| 机密 | 键 | 证书 |
|--|--|--|
|[快速入门](https://docs.microsoft.com/azure/key-vault/secrets/quick-create-template)<br>[引用](https://docs.microsoft.com/azure/templates/microsoft.keyvault/vaults/secrets)|不适用|不适用|
