---
title: 如何为 Azure Key Vault Azure Key Vault 生成和传输受 HSM 保护的密钥
...
> 
> 通过 nCipher 软件版本12.50 随附 new-world.exe 创建的安全体系与此 BYOK 过程不兼容。 可以使用两个选项：
> 1) 将 nCipher software 版本降级为12.40.2，以创建新的安全体系。
> 2) 请联系 nCipher 支持人员并请求他们提供12.50 软件版本的修补程序，使你能够使用与此 BYOK 过程兼容的 new-world.exe 的12.40.2 版本。
