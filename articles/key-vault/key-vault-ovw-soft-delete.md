...
创建新密钥保管库时，软删除默认处于打开状态。 您可以通过[Azure CLI](key-vault-soft-delete-cli.md)或[Azure Powershell](key-vault-soft-delete-powershell.md)创建密钥保管库，而无需软删除。 在密钥保管库上启用软删除后，无法禁用
