...
1. 接下来，打开一个页面文件（如*Index.cshtml.cs* ）并编写以下代码：
   ...
   1. 更新 `OnGet` 方法。 将此处显示的占位符值更新为在上述命令中创建的机密名称。
...
## <a name="how-your-aspnet-core-project-is-modified"></a>如何修改您的 ASP.NET Core 项目
