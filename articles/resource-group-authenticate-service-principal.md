<properties
   pageTitle="通过 Azure Resource Manager 对服务主体进行身份验证 | Azure"
...
## 概念
1. Azure Active Directory - 云的标识与访问管理服务。有关详细信息，请参阅[什么是 Azure Active Directory](active-directory/active-directory-whatis.md)
