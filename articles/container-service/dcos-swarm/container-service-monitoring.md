...
[部署](container-service-deployment.md)和[连接](../container-service-connect.md)由 Azure 容器服务配置的群集。 探究 [Marathon UI](container-service-mesos-marathon-ui.md)。 若要 [https://datadoghq.com](https://datadoghq.com) 设置 Datadog 帐户，请参阅。 
...
通过 `http://localhost:80/` 访问 DC/OS UI。 进入 DC/OS UI 中后，导航到左下角的“Universe”，并搜索“Datadog”，单击“安装”。
