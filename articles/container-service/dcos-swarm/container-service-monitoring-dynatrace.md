...
[部署](container-service-deployment.md)和[连接](./../container-service-connect.md)由 Azure 容器服务配置的群集。 探究 [Marathon UI](container-service-mesos-marathon-ui.md)。 若要 [https://www.dynatrace.com/trial/](https://www.dynatrace.com/trial/) 设置 Dynatrace SaaS 帐户，请参阅。  
...
1. 通过 `http://localhost:80/` 访问 DC/OS UI。 在位于 DC/OS UI 中后，导航到“Universe”**** 选项卡，并搜索“Dynatrace”****。
