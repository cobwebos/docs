...
[部署](container-service-deployment.md)和[连接](../container-service-connect.md)由 Azure 容器服务配置的群集。 探究 [Marathon UI](container-service-mesos-marathon-ui.md)。 若要 [https://app.sysdigcloud.com](https://app.sysdigcloud.com) 设置 Sysdig 云帐户，请参阅。 
...
通过 `http://localhost:80/` 访问 DC/OS UI，然后从此处导航到左下角的“Universe”，再搜索“Sysdig”。
