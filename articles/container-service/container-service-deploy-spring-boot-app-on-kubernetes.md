...
> [!NOTE]
>
> 由于本教程中的虚拟化要求，你无法在虚拟机上执行本文中的步骤；必须使用启用虚拟化功能的物理计算机。
>
...
1. 显示“部署容器化应用”页面后，请指定以下选项：
   ...
   a.在“解决方案资源管理器”中，右键单击项目文件夹下的“引用”文件夹，然后单击“添加引用”。 选择“指定以下应用详细信息”。
...
* [在 Azure 容器服务中运行 Linux 上的 Spring Boot 应用程序](../container-service/container-service-deploy-spring-boot-app-on-linux.md)
