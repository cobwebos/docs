---
title: "在 Azure 容器服务中使用 Kubernetes Web 用户 UI | Microsoft Docs"
...
# <a name="microsoft-azure-container-service-engine---using-the-kubernetes-web-ui"></a>Microsoft Azure 容器服务引擎 - 使用 Kubernetes Web UI
