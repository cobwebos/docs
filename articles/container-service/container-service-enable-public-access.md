---
title: "启用对 ACS 应用的公共访问 | Microsoft Docs"
description: "如何启用对 Azure 容器服务的公共访问。"
...
3. 选择代理负载均衡器（名称类似于 **XXXX-agent-lb-XXXX**）。
    ...
    ![Azure 容器服务负载均衡器](media/container-service-dcos-agents/agent-load-balancer.png)
4. 单击“探测”，然后单击“添加”。
   
    ![Azure 容器服务负载均衡器探测](media/container-service-dcos-agents/add-probe.png)
5. 填写探测窗体，然后单击“确定”。
...
6. 返回到代理负载均衡器的属性，单击“负载平衡规则”，然后单击“添加”。
   
    ![Azure 容器服务负载均衡器规则](media/container-service-dcos-agents/add-balancer-rule.png)
7. 填写负载均衡器窗体，然后单击“确定”。
...
接下来，需要添加将流量通过防火墙从打开的端口路由的安全性规则。
