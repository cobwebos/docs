...
description: 本教程将引导你如何结合使用 Web 应用程序防火墙和 Azure Front Door 服务
services: frontdoor
documentationcenter: ''
author: duongau
...
ms.locfileid: "90531196"
---
# <a name="tutorial-quickly-scale-and-protect-a-web-application-using-azure-front-door-and-azure-web-application-firewall-waf"></a>教程：使用 Azure Front Door 和 Azure Web 应用程序防火墙 (WAF) 快速缩放和保护 Web 应用程序
...
## <a name="create-an-azure-front-door-afd-resource"></a>创建 Azure Front Door (AFD) 资源
...
## <a name="add-managed-rulesets-to-this-waf-policy"></a>将托管规则集添加到此 WAF 策略
...
## <a name="associate-the-waf-policy-with-the-afd-resource"></a>将 WAF 策略与 AFD 资源关联
...
## <a name="configure-custom-domain-for-your-web-application"></a>为 Web 应用程序配置自定义域
...
如果不再需要本教程中的资源，请使用 [az group delete](https://docs.microsoft.com/cli/azure/group?view=azure-cli-latest#az-group-delete) 命令删除资源组、Front Door 和 WAF 策略。

```azurecli-interactive
  az group delete \
    --name <>
```
--name：本教程中部署的所有资源的资源组名称。

## <a name="next-steps"></a>后续步骤

要了解如何排查 Front Door 问题，请继续查看操作指南。
