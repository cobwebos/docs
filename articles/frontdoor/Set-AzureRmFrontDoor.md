...
## 说明
**Set-AzureRmFrontDoor** cmdlet 可更新 Front Door 负载均衡器。 如果未提供输入参数，将使用现有 Front Door 的旧参数。
...
### 示例 2：使用 PSFrontDoor 对象更新现有 Front Door。
```powershell
...
### 示例 3：使用 ResourceId 更新现有 Front Door
```powershell
