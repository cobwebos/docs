...
ms.locfileid: "47045913"
---
# New-AzureRmFrontDoor

创建新的 Azure Front Door 负载均衡器
...
## 说明
**New-AzureRmFrontDoor** cmdlet 可在当前订阅下的指定资源组中创建新的 Azure Front Door 负载均衡器

## 示例

### 示例1：根据给定参数创建 Front Door。
```powershell
