...
## 说明
**Get-AzureRmFrontDoor** cmdletGet 可获取当前订阅中与提供的信息匹配的所有现有 Front Door。

## 示例

### 示例 1：获取当前订阅中的所有 FrontDoor。
```powershell
...
获取当前订阅中的所有 FrontDoor。

### 示例 2：获取当前订阅的资源组“rg1”中的所有 FrontDoor。
```powershell
...
获取当前订阅的资源组“rg1”中的所有 FrontDoor。

### 示例 3：获取当前订阅的资源组“rg1”中名为“frontDoor1”的 FrontDoor。
```powershell
...
获取当前订阅的资源组“rg1”中名为“frontDoor1”的 FrontDoor。
