---
title: 第一道防线的 azure 服务的 HTTP 标头支持 |Microsoft Docs
...
ms.locfileid: "58407311"
---
# <a name="azure-front-door-service---http-headers-support"></a>第一道防线的 azure 服务的 HTTP 标头支持
...
| 标头  | 示例和说明 |
| ------------- | ------------- |
| Via |  *通过：1.1 Azure* </br> 第一道防线添加 Azure 的值为跟通过标头的客户端的 HTTP 版本。 添加以指示客户端的 HTTP 版本和该 Azure 的第一道防线是请求客户端和后端之间的中间收件人。  |
