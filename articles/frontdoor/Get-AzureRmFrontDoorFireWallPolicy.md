...
## 说明
**Get-AzureRmFrontDoorFireWallPolicy** cmdletGet 可在当前订阅下的资源组中获取 WAF 策略

## 示例

### 示例 1：在 $resourceGroup 中获取名为 $Name 的 WAF 策略
```powershell
...
在 $resourceGroup 中获取名为 $Name 的 WAF 策略

### 示例 2：获取 $resourceGroup 中的所有 WAF 策略
```powershell
