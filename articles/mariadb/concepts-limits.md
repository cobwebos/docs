...
查看[MariaDB 文档](https://mariadb.com/kb/en/server-system-variables/#query_cache_size)以了解有关此参数的详细信息。
...
查看[MariaDB 文档](https://mariadb.com/kb/en/server-system-variables/#sort_buffer_size)以了解有关此参数的详细信息。
...
查看[MariaDB 文档](https://mariadb.com/kb/en/server-system-variables/#join_buffer_size)以了解有关此参数的详细信息。
...
查看[MariaDB 文档](https://mariadb.com/kb/en/server-system-variables/#max_heap_table_size)以了解有关此参数的详细信息。
...
查看[MariaDB 文档](https://mariadb.com/kb/en/server-system-variables/#tmp_table_size)以了解有关此参数的详细信息。
