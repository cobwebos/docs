...
8. 选择“保存”。  
   ...
   :::image type="content" source="./media/howto-configure-server-logs-portal/3-save-discard.png" alt-text="慢速查询日志参数的屏幕截图和保存。":::
...
- 请参阅[CLI 中访问慢速查询日志](howto-configure-server-logs-cli.md)，了解如何以编程方式下载慢速查询日志。
