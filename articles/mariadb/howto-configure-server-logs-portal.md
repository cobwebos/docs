---
title: 在 Azure Database for MariaDB 中配置和访问服务器日志 Azure 门户
...
---
# <a name="configure-and-access-server-logs-from-the-azure-portal"></a>在 Azure 门户中配置和访问服务器日志
...
5. 更改需要调整的参数，包括将**slow_query_log**为**ON**。 在此会话中所做的更改都突出显示为紫色。 
