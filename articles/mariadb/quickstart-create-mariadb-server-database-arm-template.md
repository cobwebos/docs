...
ms.locfileid: "84266417"
---
# <a name="quickstart-use-a-resource-manager-template-to-create-an-azure-database-for-mariadb-server"></a>快速入门：使用资源管理器模板创建 Azure DB for MariaDB 服务器
