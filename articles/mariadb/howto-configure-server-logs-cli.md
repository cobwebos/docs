...
ms.locfileid: "86118488"
---
# <a name="configure-and-access-azure-database-for-maria-db-slow-query-logs-by-using-azure-cli"></a>使用 Azure CLI 为 Maria DB 慢速查询日志配置和访问 Azure 数据库
