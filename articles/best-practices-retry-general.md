---
title: "有关重试的一般性指南 | Microsoft Docs"
...
---
# <a name="retry-general-guidance"></a>有关重试的一般性指南
...
本文档提供有关处理暂时性故障的一般指导。 有关处理使用 Microsoft Azure 服务时发生的暂时性故障的信息，请参阅[特定于 Azure 服务的重试指南](best-practices-retry-service-specific.md)。
...
* [特定于 Azure 服务的重试指导原则](best-practices-retry-service-specific.md)
