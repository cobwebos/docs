...
| 标题 | 说明 |
|:--- |:--- |
|[通过运行延伸数据库顾问来识别符合延伸数据库条件的数据库和表](sql-server-stretch-database-identify-databases.md) |了解如何识别符合延伸数据库条件的数据库和表。 |
|[Stretch Database 的限制](sql-server-stretch-database-limitations.md) |了解 Stretch Database 的限制。 |
|[延伸数据库概述](sql-server-stretch-database-overview.md) |了解 Stretch Database 如何透明、安全地将冷数据迁移到 Microsoft Azure 云。 |
...
|[数据迁移的监视和故障排除 (Stretch Database)](sql-server-stretch-database-monitor.md) |了解如何监视数据迁移状态。 |
