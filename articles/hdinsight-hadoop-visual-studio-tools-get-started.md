...
### 查看 **hivesampletable** 
所有 HDInsight 群集都附带有名为  *hivesampletable* 的示例 Hive 表。我们将使用此表向你说明如何列出 Hive 表，查看表架构，以及列出 Hive 表中的行。
...
6. 单击底部的链接以查看以下内容：**"作业查询"**、**"作业输出"**、**"作业日志"**或**"Yarn 日志"**。
...
<!--Anchors-->
[安装]: #installation
[连接到你的 Azure 订阅]: #connect-to-your-azure-subscription
