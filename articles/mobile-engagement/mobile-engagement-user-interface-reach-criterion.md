...
* **技术人员：**可以根据可在“分析”和“监视器”部分中看到的相同技术信息来确定目标。 **另请参阅：**[UI 文档 - 分析][Link 15]、[UI 文档 - 监视器][Link 16]
...
* **市场宣传反馈：**可以基于其反馈确定访问群体，这些反馈包括以前市场宣传通知的反馈乃至公告、投票和数据推送的市场宣传反馈。 在参与两个或三个市场宣传活动后，与第一个相比你能够更好地确定访问群体。 通过将活动设置为不发送到已接收到特定的上一个活动的用户，还可用于筛选出已接收到含有类似内容的通知的用户。 甚至可以禁止仍处于活动状态的特定活动包含的用户接收新推送。 **另请参阅：**[UI 文档 - 市场宣传 - 推送内容][Link 29]
