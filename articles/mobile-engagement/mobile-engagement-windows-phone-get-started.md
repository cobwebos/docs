...
> [!NOTE]
> 如果要以 Windows Phone 8.1（非 Silverlight）为目标，请参阅 [Windows Universal 教程](mobile-engagement-windows-store-dotnet-get-started.md)。
> 
> 
...
2. 在弹出窗口中，选择“Windows 8” -> “Windows Phone” -> “空白应用 (Windows Phone Silverlight)”。 输入应用“名称”和“解决方案名称”，并单击“确定”。
   
    ![][1]
3. 可以选择面向 **Windows Phone 8.0** 或 **Windows Phone 8.1**。

现在已创建了新的空白 Windows Phone Silverlight 应用，我们会在其中集成 Azure Mobile Engagement SDK。
...
已经完成全部设置。 现在我们会验证是否已正确执行了此基本集成。

## <a id="send"></a>向应用发送通知
[!INCLUDE [Create Windows Push campaign](../../includes/mobile-engagement-windows-push-campaign.md)]

现在应在设备上看到一条通知，如果应用是打开的，会显示为应用内通知，否则会显示为 toast 通知，如下所示︰ 
