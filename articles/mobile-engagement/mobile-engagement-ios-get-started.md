---
title: 适用于 Objective C 中 iOS 的 Azure Mobile Engagement 入门 | Microsoft Docs
...
> [!NOTE]
> 若要完成本教程，你必须有一个有效的 Azure 帐户。如果你没有帐户，只需花费几分钟就能创建一个免费试用帐户。有关详细信息，请参阅 [Azure 免费试用](https://azure.microsoft.com/pricing/free-trial/?WT.mc_id=A0E0E5C02&amp;returnurl=http%3A%2F%2Fazure.microsoft.com%2Fzh-CN%2Fdocumentation%2Farticles%2Fmobile-engagement-ios-get-started)。
> 
> 
...
### 创建新的 iOS 项目
[!INCLUDE [创建新的 iOS 项目](../../includes/mobile-engagement-create-new-ios-app.md)]
