---
title: "配置流量管理器路由方法 | Microsoft Docs"
...
# <a name="configure-traffic-manager-routing-methods"></a>配置流量管理器路由方法
...
## <a name="configure-priority-routing-method"></a>配置优先级路由方法
...
1. 在 Azure 经典门户中，在左窗格中，单击流量管理器图标以打开“**流量管理器**”窗格。
2. 在 Azure 经典门户的“流量管理器”窗格中，找到要修改其设置的流量管理器配置文件。 若要打开配置文件设置页，请单击配置文件名称右侧的箭头。
...
## <a name="configure-weighted-routing-method"></a>配置加权路由方法
...
3. 在配置文件页面上，单击页面顶部的“终结点”，验证要在配置中包含的服务终结点是否都存在。
