...
2. 在“中心”菜单上，单击“新建” > “网络” > “全部查看”，并单击“流量管理器配置文件”，打开“创建流量管理器配置文件”边栏选项卡。
3. 在“创建流量管理器配置文件”边栏选项卡上：
    1. 提供配置文件的名称。 此名称必须在 trafficmanager.net 区域中唯一，并将生成 DNS 名称（<profilename>,trafficmanager.net），该名称用于访问流量管理器配置文件。
    2. 选择“地理”路由方法。
    3. 选择要创建此配置文件的订阅。
...
1. 在门户的搜索栏中搜索刚创建的流量管理器配置文件名称，并在显示结果后单击该结果。
2. 导航到“流量管理器”边栏选项卡中的“设置” -> “终结点”。
3. 单击“添加”以显示“添加终结点”边栏选项卡。
3. 在“终结点”边栏选项卡中，单击“添加”，并在显示的“添加终结点”边栏选项卡中，按如下所示完成输入：
