...
1. 从浏览器登录到[Azure 门户](https://portal.azure.com)。 如果您还没有帐户，您可以注册一[个月的免费试用](https://azure.microsoft.com/free/)。 
2. 单击 **"创建资源** > **网络** > **流量管理器"配置文件** > **创建**。
...
3. 从浏览器登录到[Azure 门户](https://portal.azure.com)。
2. 在门户的搜索栏中，搜索要修改的**流量管理器配置文件**名称，然后单击显示结果中的流量管理器配置文件。
3. 单击 **"概述** > **禁用**"。
4. 确认禁用流量管理器配置文件。

### <a name="to-enable-a-profile"></a>启用配置文件

1. 从浏览器登录到[Azure 门户](https://portal.azure.com)。
2. 在门户的搜索栏中，搜索要修改的**流量管理器配置文件**名称，然后单击显示结果中的流量管理器配置文件。
3. 单击 **"启用概述** > **"。**
