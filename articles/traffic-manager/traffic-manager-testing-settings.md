...
# <a name="test-your-traffic-manager-settings"></a>测试流量管理器设置
...
### <a name="check-traffic-manager-profile-using-nslookup-and-ipconfig-in-windows"></a>在 Windows 中使用 nslookup 和 ipconfig 检查流量管理器配置文件
...
## <a name="how-to-test-the-weighted-traffic-routing-method"></a>如何测试加权流量路由方法
