...
1. 选中“更改通行短语”复选框。<br>
1. 输入新的通行短语，或单击“生成通行短语”。
1. 单击“浏览”以保存新的通行短语。

    ![生成通行短语](./media/backup-azure-manage-mars/passphrase.png)

1. 单击“确定”以应用更改。  如果在恢复服务保管库的 Azure 门户上启用了[安全功能](./backup-azure-security-feature.md#enable-security-features)，则系统会提示输入安全 PIN。 若要接收该 PIN，请遵循[此文](./backup-azure-security-feature.md#authentication-to-perform-critical-operations)中列出的步骤。<br>
1. 粘贴门户中的安全 PIN，然后单击“确定”以应用更改。<br>
