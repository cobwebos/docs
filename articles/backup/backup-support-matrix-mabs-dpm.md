...
**支持的备份** | 这些操作系统支持适用于你想要备份的 Vm:<br/><br/> Windows Server 半年频道 (Datacenter、 Enterprise、 Standard)<br/><br/> Windows Server 2016 中，Windows Server 2012 R2、 Windows Server 2012、 Windows Server 2008 R2
...
**备份** | **版本** | **MABS** | **详细信息** |
--- | --- | --- | --- |
**Windows 10<br/>Windows 8.1<br/>Windows 8<br/>Windows 7**<br/><br/>（32/64 位） | MABS v3、v2、v1 | 本地。 | 卷/共享/文件夹/文件。<br/><br/> 支持已删除重复数据的卷。<br/><br/> 卷必须至少为 1 GB，且采用 NTFS。 |
...
**Windows Storage Server 2008** | MABS v1、v2、v3 | MABS 作为本地物理服务器/的 HYPER-V VM。 <br/><br/> 不支持 Azure VM 上运行的 MABS。 | 卷/共享/文件夹/文件；系统状态/裸机。
...
**Exchange 2016**<br/><br/> **Exchange 2013**<br/><br/> **Exchange 2010** | MABS v3、v2、v1 | 本地。 | 备份独立 Exchange 服务器、 DAG 下的数据库。<br/><br/> 恢复邮箱和 DAG 下的邮箱数据库。<br/><br/> 不支持 ReFS。<br/><br/> 备份非共享的磁盘群集。<br/><br/> 备份配置为连续复制的 Exchange 服务器。 |
**SharePoint 2016**<br/><br/> **SharePoint 2013**<br/><br/> **SharePoint 2010** | MABS v3、v2、v1 | 本地/Azure VM。 | 备份场，前端 web 服务器。<br/><br/> 恢复场、 数据库、 web 应用、 文件或列表项、 SharePoint 搜索、 前端 web 服务器。<br/><br/> 无法备份的内容数据库使用 SQL Server AlwaysOn 的场。 |
...
**VMware VM：vCenter/vSphere ESXi 5.5/6.0/6.5** | MABS v3、v2、v1<br/><br/> MABS v1 需要更新汇总 1 | 本地。 | VMware Vm 备份 Csv、 NFS 和 SAN 存储上。<br/><br/> 恢复整个 VM。<br/><br/> Windows/Linux 备份。<br/><br/> 文件夹/文件的项级恢复（仅适用于 Windows VM）。<br/><br/> 不支持 VMware vApp。<br/><br/> Linux VM 的恢复是针对整个计算机进行的。 | 
...
**Windows Server 2012（Datacenter 和 Standard）**<br/><br/> 64/32 位 |  本地/Azure VM。 | **本地保护**：卷/共享/文件夹/文件；系统状态/裸机。<br/><br/> **Azure VM 保护**：卷/共享/文件夹/文件。<br/><br/> 使用 DPM 2012 R2 和更高版本支持的卷删除了重复数据。
...
**VMware VM：vCenter/vSphere ESXi 5.5/6.0/6.5** | MABS v3、v2、v1<br/><br/> DPM 2012 R2 需要 System Center 更新汇总 1 <br/><br/>本地。 | VMware Vm 备份 Csv、 NFS 和 SAN 存储上。<br/><br/> 恢复整个 VM。<br/><br/> Windows/Linux 备份。<br/><br/> 文件夹/文件的项级恢复（仅适用于 Windows VM）。<br/><br/> 不支持 VMware vApp。<br/><br/> Linux VM 的恢复是针对整个计算机进行的。
