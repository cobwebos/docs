---
title: 常见问题解答-在 Azure Vm 上备份 SAP HANA 数据库
...
请参阅[先决条件](tutorial-backup-sap-hana-db.md#prerequisites)和[设置权限](tutorial-backup-sap-hana-db.md#setting-up-permissions)部分。
...
运行预注册脚本会将所需的权限设置为允许 Azure 备份 SAP HANA 数据库。 可在[此处](tutorial-backup-sap-hana-db.md#setting-up-permissions)找到有关权限的详细信息。
