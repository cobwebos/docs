...
Azure ExpressRoute | 如果使用私有或 Microsoft 对等互连配置 Azure ExpressRoute，则不能用于将数据备份到 Azure。<br/><br/> 如果 Azure ExpressRoute 公共对等互连配置，它可以用于将数据备份到 Azure。<br/><br/> **注意：** 公共对等互连不推荐使用适用于新线路。
