...
- [备份 Azure VM 中的 SQL Server 数据库](https://docs.microsoft.com/azure/backup/backup-sql-server-database-azure-vms)
...
- [使用恢复服务保管库的诊断设置](https://docs.microsoft.com/azure/backup/backup-azure-diagnostic-events)
...
- [了解 Azure 备份可用的安全控制](https://docs.microsoft.com/azure/backup/backup-security-controls)
