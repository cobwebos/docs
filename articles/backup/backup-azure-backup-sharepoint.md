...
使用 DPM 将 SharePoint 备份到 Azure 的过程与本地将 SharePoint 备份到 DPM 的过程非常相似。 本文将注意 Azure 的特定注意事项。
...
其他先决条件和限制可在 DPM 文章中找到备份[共享点](https://docs.microsoft.com/system-center/dpm/back-up-sharepoint?view=sc-dpm-2019#prerequisites-and-limitations)。

## <a name="configure-backup"></a>配置备份

要备份 SharePoint 场，则使用 ConfigureSharePoint.exe 配置 SharePoint 保护，然后在 DPM 中创建保护组。 有关说明，请参阅在 DPM 文档中[配置备份](https://docs.microsoft.com//system-center/dpm/back-up-sharepoint?view=sc-dpm-2019#configure-backup)。

## <a name="monitoring"></a>监视

要监视备份作业，请按照[监视 DPM 备份](https://docs.microsoft.com/system-center/dpm/back-up-sharepoint?view=sc-dpm-2019#monitoring)中的说明操作

## <a name="restore-sharepoint-data"></a>还原 SharePoint 数据

要了解如何从具有 DPM 的磁盘还原 SharePoint 项，请参阅[还原 SharePoint 数据](https://docs.microsoft.com/system-center/dpm/back-up-sharepoint?view=sc-dpm-2019#restore-sharepoint-data)。
...
如果您有多个前端 Web 服务器，并且想要切换 DPM 用于保护服务器场的服务器，请按照[切换前端 Web 服务器](https://docs.microsoft.com/system-center/dpm/back-up-sharepoint?view=sc-dpm-2019#switching-the-front-end-web-server)中的说明操作。
