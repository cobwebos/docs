...
- 选择备份策略
  ...
  - 备份类型
    ...
    - 你可以选择的最有效策略是对每周/每月/每年完整备份使用“每日差异”。 Azure 备份也可以通过单击从差异还原。
...
- 选择备份策略
  - 备份类型
    - 你可以选择的最有效策略是对**每周/每月/每年**完整备份使用“每日差异”。 Azure 备份也可以通过单击从差异还原。
...
- 要备份的文件共享上预期的数据改动量。 <br>改动是指数据的更改量，并直接影响快照存储大小。 例如，如果你有一个文件共享，其中包含 200 GB 的数据要备份，每日更改量为 10 GB，则每日改动量为5%。
  - 较大的改动意味着文件共享内容每天的数据更改量很高，因此增量快照 (仅捕获数据更改) 大小也会更多。
