...
- [常见错误](backup-azure-vms-troubleshoot.md#troubleshoot-backup-of-encrypted-vms)时备份和还原加密的 Azure Vm。
- [常规](backup-azure-vms-troubleshoot.md)的 Azure VM 问题。
