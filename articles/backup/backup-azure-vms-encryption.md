...
> * 仅同时使用 BitLocker 加密密钥和 Key 加密秘钥加密的虚拟机支持。 仅使用 BitLocker 加密密钥加密的虚拟机不支持。 <br>
>
>
...
6. 在“根据模板配置”下拉框中选择“Azure 备份”。 此时会预先填充“密钥权限”和“机密权限”下拉框中的所需权限。 
