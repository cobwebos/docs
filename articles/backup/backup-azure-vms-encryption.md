...
- 阅读 Azure VM 磁盘加密的[常见问题解答](../security/fundamentals/azure-disk-encryption-vms-vmss.md)。
...
1. 在 "**虚拟机**" 下，选择 "**添加**"。
    ...
    ![打开“方案”边栏选项卡](./media/backup-azure-vms-encryption/add-virtual-machines.png)
...
仅可通过还原 VM 磁盘来还原加密的 Vm，如下所述。 不支持**替换现有**和**还原 VM** 。
