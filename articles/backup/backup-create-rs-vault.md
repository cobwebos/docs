...
2. 选择 " **在此保管库中启用跨区域还原** " 以启用该功能。
   ...
   ![在此保管库中选择 "启用跨区域还原" 之前](./media/backup-azure-arm-restore-vms/backup-configuration1.png)

   ![在此保管库中选择 "启用跨区域还原" 后](./media/backup-azure-arm-restore-vms/backup-configuration2.png)
