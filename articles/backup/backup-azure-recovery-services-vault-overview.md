...
- **有助于确保备份数据安全的增强功能**：使用恢复服务保管库时，Azure 备份提供用于保护云备份的安全功能。 这些安全功能确保你可以保护备份并从云备份安全地恢复数据，即使生产服务器和备份服务器受损。 [了解详细信息](backup-azure-security-feature.md)
...
在 Azure 门户中创建和管理恢复服务保管库很容易，因为备份服务已集成到“Azure 设置”边栏选项卡中。 这种集成意味着，可以在目标服务上下文中创建和管理恢复服务保管库。 例如，若要查看 VM 的恢复点，请选中该 VM，然后在“设置”边栏选项卡中单击“备份”。 特定于该 VM 的备份信息就会显示。 在以下示例中，ContosoVM 是虚拟机的名称。 **ContosoVM-demovault** 是恢复服务保管库的名称。 不需记住用于存储恢复点的恢复服务保管库的名称，可以在虚拟机中访问该信息。  

![VM 中的恢复服务保管库详细信息](./media/backup-azure-recovery-services-vault-overview/rs-vault-in-context.png)

如果多个服务器使用同一恢复服务保管库进行保护，则更应查看恢复服务保管库。 可以在订阅中搜索所有恢复服务保管库，然后从列表中选择一个。
