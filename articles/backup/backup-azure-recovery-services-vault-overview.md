...
在 Azure 门户中创建和管理恢复服务保管库很容易，因为备份服务已集成到“Azure 设置”边栏选项卡中。 这种集成意味着，可以在目标服务上下文中创建和管理恢复服务保管库。 例如，要查看 VM 的恢复点，请选中该 VM，并在“设置”边栏选项卡中单击“备份”。 特定于该 VM 的备份信息就会显示。 在以下示例中，ContosoVM 是虚拟机的名称。 **ContosoVM-demovault** 是恢复服务保管库的名称。 不需记住用于存储恢复点的恢复服务保管库的名称，可以在虚拟机中访问该信息。  
