...
| Azure 备份服务器 | <p>是</p><p>了解有关[使用 Azure 备份服务器保护 Azure 中工作负荷](backup-azure-microsoft-azure-backup.md)的详细信息。</p> | <p>是</p><p>了解有关[使用 Azure 备份服务器保护 Azure 中工作负荷](backup-azure-microsoft-azure-backup.md)的详细信息。</p> | <p>Azure 备份保管库</p> |
| Azure 备份（VM 扩展） | <p>是</p><p>专门用于[备份 Azure IaaS 虚拟机](backup-azure-vms-introduction.md)。</p> | <p>否</p><p>请使用 SCDPM 备份数据中心内的虚拟机。</p> | <p>Azure 备份保管库</p> |

## 可以备份哪些应用程序和工作负荷？

| 工作负载 | 源计算机 | Azure 备份解决方案 |
| --- | --- |---|
| 文件和文件夹 | Windows Server | <p>[Azure 备份代理](backup-configure-vault.md)、</p><p>[System Center DPM](backup-azure-dpm-introduction.md)、</p><p>[Azure 备份服务器](backup-azure-microsoft-azure-backup.md)</p> |
| 文件和文件夹 | Windows 客户端 | <p>[Azure 备份代理](backup-configure-vault.md)、</p><p>[System Center DPM](backup-azure-dpm-introduction.md)、</p><p>[Azure 备份服务器](backup-azure-microsoft-azure-backup.md)</p> |
| Hyper-V 虚拟机 (Windows) | Windows Server | <p>System Center DPM、</p><p>[Azure 备份服务器](backup-azure-microsoft-azure-backup.md)</p> |
| Hyper-V 虚拟机 (Linux) | Windows Server | <p>System Center DPM、</p><p>[Azure 备份服务器](backup-azure-microsoft-azure-backup.md)</p> |
| Microsoft SQL Server | Windows Server | <p>[System Center DPM](backup-azure-backup-sql.md)、</p><p>[Azure 备份服务器](backup-azure-microsoft-azure-backup.md)</p> |
| Microsoft SharePoint | Windows Server | <p>[System Center DPM](backup-azure-backup-sql.md)、</p><p>[Azure 备份服务器](backup-azure-microsoft-azure-backup.md)</p> |
| Microsoft Exchange | Windows Server | <p>[System Center DPM](backup-azure-backup-sql.md)、</p><p>[Azure 备份服务器](backup-azure-microsoft-azure-backup.md)</p> |
