...
1. [将 VM 恢复点还原到标准存储。](backup-azure-restore-vms.md)
2. [将磁盘复制到高级存储。](../storage/storage-use-azcopy.md)
3. [创建 Azure IaaS VM。](../virtual-machines/virtual-machines-windows-hero-tutorial.md)
