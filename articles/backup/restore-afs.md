...
1. 选择 " **还原共享**" 后，将打开 " **还原** " 窗格。 若要选择要用于执行还原操作的还原点，请选择 "**还原点**" 文本框下的 "**选择**链接文本"。

    ![选择还原点，方法是选择 "选择"](./media/restore-afs/select-restore-point.png)
...
1. 此时会在右侧打开 " **选择还原点** " 上下文窗格，其中列出了可用于所选文件共享的还原点。 选择要用于执行还原操作的还原点，然后选择 **"确定"**。
    ...
    >[!NOTE]
    >默认情况下，" **选择还原点** " 窗格列出了过去30天内的还原点。 如果要查看在特定时间段内创建的还原点，请选择相应的 **开始时间** 和 **结束时间** ，然后选择 " **刷新** " 按钮来指定范围。
...
1. 选择 " **文件恢复**" 后，将打开 " **还原** " 窗格。 若要选择要用于执行还原操作的还原点，请选择 "**还原点**" 文本框下的 "**选择**链接文本"。
    ...
    ![选择 "选择" 链接，选择还原点](./media/restore-afs/select-restore-point.png)
...
1. 若要选择要还原的文件或文件夹，请选择 " **添加文件** " 按钮。 这将打开右侧的上下文窗格，并显示你选择用于还原的文件共享恢复点的内容。
...
1. 在 " **文件夹名称** " 框中，指定要在目标文件共享中使用还原的内容创建的文件夹名称。
1. 选择是否要在存在冲突时跳过或覆盖。
1. 若要选择要还原的文件或文件夹，请选择 " **添加文件** " 按钮。 这会在右侧显示一个上下文窗格，其中显示了所选的用于还原的文件共享恢复点的内容。
