...
- 如果在5月 1 2020 之前注册了恢复服务资源提供程序，则需要重新注册该提供程序。 若要重新注册提供程序，请转到 Azure 门户中的订阅，导航到左侧导航栏上的“资源提供程序”，然后选择“Microsoft.RecoveryServices”，并单击“重新注册”。
...
Q. 我是否可以使用自己的 DNS 服务器，而不使用 Azure 专用 DNS 区域或集成的专用 DNS 区域？<br>
