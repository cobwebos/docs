...
## <a name="use-instant-restore-to-restore-data-to-the-same-machine"></a>使用即时还原将数据还原到同一台计算机
...
4. 在“选择恢复模式”窗格中，选择是否要还原以下各项：
    - **单个文件和文件夹** - 如果想要还原特定的文件和文件夹，请使用此选项。
    - **卷** - 使用此选项可还原所选卷中的所有文件和文件夹。
...
> [!NOTE]
> 如果想要使用即时还原将数据还原到另一台计算机，需要安装 [Azure 备份 2017 年 1 月更新](https://support.microsoft.com/en-us/help/3216528?preview)。 此外，必须在支持文章所列的区域中的保管库内保护备份数据。 即时还原目前并非在所有区域都可用。
>
