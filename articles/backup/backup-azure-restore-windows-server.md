...
4. 在“选择恢复模式”页上，选择“单个文件和文件夹”>“下一步”。**** **** ****
   ...
   > [!TIP]
   > 使用“单个文件和文件夹”选项**** 可以快速访问恢复点数据。 它适用于恢复每个文件，其大小总计不超过 80 GB，在恢复过程中，将传输或副本速度提高到 6 MBps。 “卷”**** 选项恢复指定卷中的所有备份数据。 此选项提供更快的传输速度（高达 40 MBps），这是用于恢复大大小数据或整个卷的理想选择。
