...
| **OS 版本**            | SLES 12 SP2、SP3 和 SP4;SLES 15 with SP0 和 SP1 <br><br>   **预览版**-RHEL 7.4、7.6、7.7 和8。1  <br>     RHEL SAP HANA 备份预览[入门](https://docs.microsoft.com/azure/backup/tutorial-backup-sap-hana-db)（7.4、7.6、7.7 和8.1）。 如需深入咨询，请通过 [AskAzureBackupTeam@microsoft.com](mailto:AskAzureBackupTeam@microsoft.com) 联系我们。                |                                             |
