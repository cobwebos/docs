...
| **OS 版本**            | 带 SP2、SP3 和 SP4 的 SLES 12；带 SP0 和 SP1 的 SLES 15 <br><br>   **预览版** - RHEL 7.4、7.6、7.7 和 8.1  <br>     RHEL（7.4、7.6、7.7 和 8.1）的 SAP HANA 备份预览版[入门](./tutorial-backup-sap-hana-db.md)。 如需深入咨询，请通过 [AskAzureBackupTeam@microsoft.com](mailto:AskAzureBackupTeam@microsoft.com) 联系我们。                |                                             |
| **HANA 版本**          | HANA 1.x 上的 SDC，HANA 2.x 上的 MDC <= SPS04 Rev 48，SPS05 （有待验证启用了加密的方案）      |                                                            |
...
> [!NOTE]
> 现在可以在 Azure 门户中[监视到同一计算机的备份和还原作业](./sap-hana-db-manage.md#monitor-manual-backup-jobs-in-the-portal)，这些作业是从 HANA 原生客户端 (SAP HANA Studio/Cockpit/DBA Cockpit) 触发的。
