...
| **OS 版本**            | 带 SP2、SP3 和 SP4 的 SLES 12；带 SP0 和 SP1 的 SLES 15 <br><br>   **预览版** - RHEL 7.4、7.6、7.7 和 8.1  <br>     RHEL（7.4、7.6、7.7 和 8.1）的 SAP HANA 备份预览版[入门](https://docs.microsoft.com/azure/backup/tutorial-backup-sap-hana-db)。 如需深入咨询，请通过 [AskAzureBackupTeam@microsoft.com](mailto:AskAzureBackupTeam@microsoft.com) 联系我们。                |                                             |
