...
| **OS 版本**            | 带 SP2、SP3 和 SP4 的 SLES 12；带 SP0 和 SP1 的 SLES 15 <br><br>  截至8月1日，2020，RHEL 的 SAP HANA 备份（7.4、7.6、7.7 & 8.1）已正式发布。                |                                             |
...
> [!NOTE]
> 你现在可以在 Azure 门户中监视从 HANA native clients （SAP HANA Studio/考核中心考核中心）触发[的备份和还原](./sap-hana-db-manage.md#monitor-manual-backup-jobs-in-the-portal)作业。
