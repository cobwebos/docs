...
> [!NOTE]
>
> 此数据模型引用向 Log Analytics （LA）发送诊断事件的 Azure 诊断模式。 若要了解新资源特定模式的数据模型，可以参阅以下文章： [Azure 备份诊断事件的数据模型](https://docs.microsoft.com/azure/backup/backup-azure-reports-data-model)
