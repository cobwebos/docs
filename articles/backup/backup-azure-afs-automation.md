...
如果你不熟悉 Azure 备份服务，请参阅[什么是 Azure 备份？](backup-introduction-to-azure-backup.md)以大致了解该服务。 在开始之前，请参阅[备份 Azure 文件共享](backup-azure-files.md)中用于备份 Azure 文件共享的预览功能。
