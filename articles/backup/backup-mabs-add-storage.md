...
>
> 若要实现增强的备份性能，建议在 Windows Server 2019 上部署包含分层存储的 MABS v3。 有关配置分层存储的步骤，请参阅 DPM 文章 "[通过分层存储设置 mb](/system-center/dpm/add-storage#set-up-mbs-with-tiered-storage)"。
