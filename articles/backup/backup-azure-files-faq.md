...
### <a name="why-cant-i-protect-file-shares-connected-to-a-sync-group-in-azure-file-sync-br"></a>为什么无法保护已连接到 Azure 文件同步中的某个同步组的文件共享？ <br/>
...
删除 Azure 文件共享时，系统会显示也会被删除的备份的列表，并会要求你进行确认。 无法还原已删除的 Azure 文件共享。
