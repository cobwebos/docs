...
答 11.备份的所有数据在传输之前都会经过压缩和加密。根据所备份的数据类型，你应该会获得 30-40% 压缩率。
...
+ 更新以下注册表项，使路径指向新的缓存空间文件夹：
	...
	| 注册表路径 | 注册表项 | 值 |
	| ------ | ------- | ------ |
	| `HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Microsoft Azure Backup\Config` | ScratchLocation | <i>新的缓存文件夹位置</i> |
	| `HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Microsoft Azure Backup\Config\CloudBackupProvider` | ScratchLocation | <i>新的缓存文件夹位置</i> |
