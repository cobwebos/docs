---
title: "Azure 备份：Azure Linux VM 的应用程序一致性备份 | Microsoft Docs"
description: "Azure Linux VM 的应用程序一致性备份"
services: backup
...
> [!Note]
> 只有 Resource Manager 部署的 Linux 虚拟机才支持操作前和操作后脚本框架，经典虚拟机或 Windows 虚拟机不支持该框架。
>
