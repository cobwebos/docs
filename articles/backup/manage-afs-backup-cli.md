...
下面的示例使用[az backup container](https://docs.microsoft.com/cli/azure/backup/container?view=azure-cli-latest#az-backup-container-unregister) afsaccount cmdlet 从*azurefilesvault*中取消注册 " *afsaccount* " 存储帐户。
