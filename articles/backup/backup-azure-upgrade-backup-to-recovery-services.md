...
**应有哪些权限才能触发保管库升级？**</br>
若要执行保管库升级，必须在 Azure 经典门户中将你添加为订阅的协同管理员。 即使已在 Azure 门户中被列为所有者，仍需执行此操作。 请尝试在 Azure 经典门户中添加订阅的协同管理员，确定你是否为订阅的协同管理员。 如果无法添加协同管理员，请联系订阅的服务管理员或协同管理员，他们可将你添加为协同管理员。
