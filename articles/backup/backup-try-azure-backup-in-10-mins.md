---
title: 了解如何通过 Azure 备份并使用 Resource Manager 部署模型将 Windows 中的文件和文件夹备份到 Azure | Microsoft Docs
