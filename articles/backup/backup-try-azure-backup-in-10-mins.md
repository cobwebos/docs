---
title: "了解如何使用 Resource Manager 部署模型通过 Azure 备份将 Windows 中的文件和文件夹备份到 Azure | Microsoft Docs"
...
---
# <a name="first-look-back-up-files-and-folders-with-azure-backup-using-the-resource-manager-deployment-model"></a>初步了解：通过 Azure 备份并使用 Resource Manager 部署模型备份文件和文件夹
...
## <a name="step-1-get-an-azure-subscription"></a>步骤 1：获取 Azure 订阅
...
4. 从“工作负荷的运行位置?”菜单中选择“本地”。
5. 从“要备份的项?”菜单中选择“文件和文件夹”，然后单击“确定”。
...
## <a name="step-5-back-up-your-files-and-folders"></a>步骤 5：备份文件和文件夹
初始备份包括两个关键任务：
