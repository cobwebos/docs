...
| 备份 | 发生内部错误，备份失败 - 请在几分钟后重试操作。如果问题持续出现，请联系 Microsoft 支持 | 请查看在访问 VM 存储时是否存在一过性问题。请检查“Azure 状态”，以确定区域中的计算/存储/网络是否存在任何相关问题。[](https://azure.microsoft.com/status/)解决问题后，请重试备份。 |
