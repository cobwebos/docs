...
10. 在“指定联机备份计划”页上，选择偏好的计划，并单击“下一步”********。
    ...
    > [!NOTE]
    > MABS 从当时可用的最新磁盘备份点为 Azure 最多提供两个每日备份。 Azure 备份还可以通过使用[Azure 备份网络限制](backup-windows-with-mars-agent.md#enable-network-throttling)来控制可用于高峰和非高峰时间备份的 WAN 带宽量。
    >
    >
