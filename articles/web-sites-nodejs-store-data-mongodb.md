...
[使用 Git 发布到 Azure 网站][使用 Git 发布到 Azure 网站]
  ...
  [如何在安装了 Linux 的 Azure 上使用 SSH]: http://windowsazure.cn/zh-cn/documentation/articles/linux-use-ssh-key/
