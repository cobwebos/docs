...
1. 创建一个名为“APP_CONFIGURATION_ENDPOINT”  的环境变量。 将其值设为你的应用配置存储的终结点。 可以在 Azure 门户的“访问密钥”  边栏选项卡上找到该终结点。

1. 打开“resources”  文件夹中的 bootstrap.properties  。 将此文件更新为使用应用配置终结点（而不是使用连接字符串）。
