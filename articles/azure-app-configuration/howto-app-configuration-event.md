...
## <a name="create-an-app-configuration"></a>创建一个应用程序配置

将 `<appconfig_name>` 替换为该应用程序配置的唯一名称，将 `<resource_group_name>` 替换为前面创建的资源组。 该名称必须唯一，因为它将用作 DNS 名称。
...
## <a name="subscribe-to-your-app-configuration"></a>订阅应用程序配置
