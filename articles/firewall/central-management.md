...
防火墙策略是一种 Azure 资源，其中包含 NAT、网络和应用程序规则集合以及威胁情报设置。 这是一项全局资源，可跨*安全虚拟中心*和*中心虚拟网络*中的多个 Azure 防火墙实例使用。 可以从头开始创建新策略，或者从现有策略继承策略。 DevOps 可以通过继承在组织规定的基本策略之上创建本地防火墙策略。 策略跨区域和订阅工作。
