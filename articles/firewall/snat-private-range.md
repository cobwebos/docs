...
当目标 IP 地址处于每个[IANA RFC 1918](https://tools.ietf.org/html/rfc1918)的专用 ip 地址范围时，Azure 防火墙不会使用网络规则。 应用程序规则始终使用[透明代理](https://wikipedia.org/wiki/Proxy_server#Transparent_proxy)应用，而不考虑目标 IP 地址。
