...
|Azure HDInsight<br>（预览版）|允许出站访问用于 HDInsight 平台流量。 此标记未涵盖从 HDInsight 的特定于客户的存储或 SQL 流量。 通过启用这些[服务终结点](../virtual-network/tutorial-restrict-network-access-to-resources.md)也可以手动添加。|
