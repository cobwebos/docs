...
4. 在“入站端口规则”下，对于 **“公共入站端口”**，请单击“允许所选端口”。
5. 对于“选择入站端口”，请选择“RDP (3389)”。

6. 接受其他默认值，并单击“下一步:磁盘”。
7. 接受磁盘默认值，并单击“下一步:网络”。
8. 请确保选择 **Test-FW-VN** 作为虚拟网络，子网是 **Jump-SN**。
9. 对于“公共 IP”，请单击“新建”。
10. 键入 **Srv-Jump-PIP** 作为公共 IP 地址名称，然后单击“确定”。
11. 接受其他默认值，并单击“下一步:管理”。
12. 单击“关闭”以禁用启动诊断。 接受其他默认值，并单击“复查 + 创建”。
13. 在“摘要”页上复查设置，然后单击“创建”。

重复此过程，创建名为 **Srv-Work** 的另一个虚拟机。

使用下表中的信息配置 Srv-Work 虚拟机。 剩余的配置与 Srv-Work 虚拟机相同。
...
3. 打开 Internet Explorer 并浏览到 https://msn.com。
4. 出现安全警报时单击“确定” > “关闭”。
