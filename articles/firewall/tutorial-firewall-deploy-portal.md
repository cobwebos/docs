---
title: 教程：部署 & 使用 Azure 门户配置 Azure 防火墙
...
在本教程中，你将创建一个包含三个子网的单个简化 VNet，以便于部署。 对于生产部署，建议使用[中心辐射型模型](https://docs.microsoft.com/azure/architecture/reference-architectures/hybrid-networking/hub-spoke)。 防火墙位于其自身的 VNet 中。 工作负荷服务器在包含一个或多个子网的同一区域中的对等 VNet 内。
...
4. 对于“优先级”，请键入 **200**。
5. 对于“操作”，请选择“允许”。
6. 在 "**规则**"、" **IP 地址**"、"**名称**" 下，键入**Allow-DNS**。
7. 对于“协议”，请选择“UDP”。
9. 对于 "**源类型**"，请选择 " **IP 地址**"。
