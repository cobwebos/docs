<properties linkid="develop-python-web-site-with-flask" urlDisplayName="Websites with Flask" pageTitle="具有 Flask 的 Python 网站 - Azure 教程" metaKeywords="Azure flask, flask website" description="本教程向您介绍在 Azure 上运行 Python 网站。" metaCanonical="" services="web-sites" documentationCenter="Python" title="Creating Websites with Flask" authors="huvalo" solutions="" manager="" editor="" />
...
您将使用 Flask web 框架创建应用程序（请参阅本教程针对 [Django] 的备选版本(../web-sites-python-create-deploy-django-app) and [Bottle](../web-sites-python-create-deploy-bottle-app)）。将从 Azure 库中创建网站，设置 Git 部署和本地克隆存储库。然后将本地运行应用程序，将其更改、 提交和推送到 Azure。本教程演示如何从 Windows 或 Mac/Linux 执行此操作。
...
<!--Link references-->
[具有 Python Tools 2.1 for Visual Studio 的 Azure 上的 Flask 和 MongoDB]: ../web-sites-python-ptvs-flask-table-storage
[具有 Python Tools 2.1 for Visual Studio 的 Azure 上的 Flask 和 Azure 表存储]: ../web-sites-python-ptvs-flask-mongodb
