---
title: 浏览 Azure 资源
description: 了解如何使用资源图查询语言来探索资源并了解这些资源的连接方式。
ms.date: 10/18/2019
ms.topic: conceptual
...
> [!NOTE]
> Azure PowerShell `Search-AzGraph` cmdlet 默认情况下会返回 PSCustomObject****。 若要让输出与 Azure CLI 返回的内容相同，请使用 `ConvertTo-Json` cmdlet。 “深度”**** 的默认值是“2”__。 将它设置为“100”__ 应转换所有返回的级别。
