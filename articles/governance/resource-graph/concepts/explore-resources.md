---
title: 使用 Resource Graph 浏览 Azure 资源
...
“别名”下的第一组属性提供了多个相关的属性值。 要获取有关别名的详细信息并发现可用的别名，请参阅 [Azure Policy 定义结构 - 别名](../../policy/concepts/definition-structure.md#aliases)。 Azure Policy 主要使用别名来管理对组织规则和治理的符合性。

其他属性显示有关虚拟机资源本身的其他信息，包括 SKU、OS、磁盘、标记以及它所属的资源组和订阅信息。
...
> [!NOTE]
> 获得 SKU 的另一种方法是使用 aliases 属性 Microsoft.Compute/virtualMachines/sku.name。
