...
此蓝图通过分配对无限制访问、白名单活动和威胁提供保护性监视的 [Azure Policy](../../../policy/overview.md) 定义，帮助保护信息系统资产。
...
## <a name="9-secure-user-management--10-identity-and-authentication"></a>9 保护用户管理 / 10 标识和身份验证
