...
以下映射适用于**PCI-DSS v 3.2.1： 2018**控件。 使用右侧的导航栏可直接跳转到特定的控制映射。 许多的映射控制措施都是使用 [Azure Policy](../../../policy/overview.md) 计划实施的。 若要查看完整计划，请在 Azure 门户中打开“策略”，并选择“定义”页。 然后，查找并选择 **\[Preview @ no__t-2 AUDIT PCI v2.0 3.2.1：2018控件并部署特定的 VM 扩展，以支持审核要求**内置策略计划。
