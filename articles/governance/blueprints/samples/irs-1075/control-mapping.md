---
title: 示例 - IRS 1075 蓝图 - 控制映射
description: IRS 1075 蓝图示例到 Azure Policy 的控制映射。
author: DCtheGeek
ms.author: dacoulte
ms.date: 08/07/2019
ms.topic: sample
...
> [!IMPORTANT]
> 下面的每个控件都与一个或多个 [Azure Policy](../../../policy/overview.md) 定义关联。 这些策略可以帮助你[评估控件的符合性](../../../policy/how-to/get-compliance-data.md)；但是，控件与一个或多个策略之间通常不是 1:1 或完全匹配。 因此，Azure Policy 中的符合性  仅引用策略本身；这不确保你完全符合控件的所有要求。 此外，符合性标准包含目前未由任何 Azure Policy 定义处理的控件。 因此，Azure Policy 中的符合性只是整体符合性状态的部分视图。 此符合性蓝图示例的控件和 Azure Policy 定义之间的关联可能会随着时间的推移而发生变化。 若要查看更改历史记录，请参阅 [GitHub 提交历史记录](https://github.com/MicrosoftDocs/azure-docs/commits/master/articles/governance/blueprints/samples/irs-1075/control-mapping.md)。
...
## <a name="9321-ac-2-12-account-management--account-monitoring--atypical-usage"></a>9.3.2.1 AC-2 (12) 帐户管理 | 帐户监视/异常使用
...
## <a name="9314-ac-4-information-flow-enforcement"></a>9.3.1.4 AC-4 信息流强制
...
## <a name="9315-ac-5-separation-of-duties"></a>9.3.1.5 AC-5 职责分离
...
## <a name="9316-ac-6-7-least-privilege--review-of-user-privileges"></a>9.3.1.6 AC-6 (7) 最小特权 | 用户特权评审
...
## <a name="9313-au-3-2-content-of-audit-records--centralized-management-of-planned-audit-record-content"></a>9.3.1.3 AU-3 (2) 审核记录的内容 | 计划的审核记录内容的集中管理
...
## <a name="9335-au-5-response-to-audit-processing-failures"></a>9.3.3.5 AU-5 对审核处理失败的响应
...
## <a name="9336-au-6-4-audit-review-analysis-and-reporting--central-review-and-analysis"></a>9.3.3.6 AU-6 (4) 审核评审、分析和报告 | 中心评审和分析
...
## <a name="93311-au-12-audit-generation"></a>9.3.3.11 AU-12 审核生成
...
## <a name="9357-cm-7-2-least-functionality--prevent-program-execution"></a>9.3.5.7 CM-7 (2) 最少的功能 | 防止程序执行
...
## <a name="9357-cm-7-5-least-functionality--authorized-software--whitelisting"></a>9.3.5.7 CM-7 (5) 最少的功能 | 授权软件/允许列表
...
## <a name="93511-cm-11-user-installed-software"></a>9.3.5.11 CM-11 用户安装的软件
...
## <a name="9366-cp-7-alternate-processing-site"></a>9.3.6.6 CP-7 备用处理站点
...
## <a name="9372-ia-2-1-identification-and-authentication-organizational-users--network-access-to-privileged-accounts"></a>9.3.7.2 IA-2 (1) 标识和身份验证（组织用户）| 对特权帐户的网络访问
...
## <a name="9372-ia-2-2-identification-and-authentication-organizational-users--network-access-to-non-privileged-accounts"></a>9.3.7.2 IA-2 (2) 标识和身份验证（组织用户）| 网络访问非特权帐户
...
## <a name="9375-ia-5-authenticator-management"></a>9.3.7.5 IA-5 验证器管理
...
## <a name="9375-ia-5-1-authenticator-management--password-based-authentication"></a>9.3.7.5 IA-5 (1) 验证器管理 |基于密码的身份验证
...
## <a name="93143-ra-5-vulnerability-scanning"></a>9.3.14.3 RA-5 漏洞扫描
...
## <a name="93164-sc-5-denial-of-service-protection"></a>9.3.16.4 SC-5 拒绝服务保护
...
## <a name="93165-sc-7-boundary-protection"></a>9.3.16.5 SC-7 边界保护
...
## <a name="93165-sc-7-3-boundary-protection--access-points"></a>9.3.16.5 SC-7 (3) 边界保护 | 接入点
...
## <a name="93165-sc-7-4-boundary-protection--external-telecommunications-services"></a>9.3.16.5 SC-7 (4) 边界保护 | 外部电信服务
...
## <a name="96163-sc-8-1-transmission-confidentiality-and-integrity--cryptographic-or-alternate-physical-protection"></a>9.6.16.3 SC-8 (1) 传输保密性和完整性 | 加密或备用物理保护
...
## <a name="93166-sc-28-1-protection-of-information-at-rest--cryptographic-protection"></a>9.3.16.6 SC-28 (1) 保护静态信息 | 加密保护
...
## <a name="93172-si-2-flaw-remediation"></a>9.3.17.2 SI-2 缺陷修正
...
## <a name="93173-si-3-malicious-code-protection"></a>9.3.17.3 SI-3 恶意代码防护
...
## <a name="93173-si-3-1-malicious-code-protection--central-management"></a>9.3.17.3 SI-3 (1) 恶意代码防护 | 集中管理
...
## <a name="93174-si-4-information-system-monitoring"></a>9.3.17.4 SI-4 信息系统监视
...
## <a name="93174-si-4-18-information-system-monitoring--analyze-traffic--covert-exfiltration"></a>9.3.17.4 SI-4 (18) 信息系统监视 | 分析流量 / 隐蔽性外泄
