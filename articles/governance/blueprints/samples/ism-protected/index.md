...
ms.locfileid: "90038682"
---
# <a name="overview-of-the-australian-government-ism-protected-blueprint-sample"></a>澳大利亚政府 ISM PROTECTED 蓝图示例概述

ISM Governance 蓝图示例提供了一组监管防护措施，这些措施使用 [Azure Policy](../../../policy/overview.md) 来帮助通过 ISM PROTECTED 认证（2020 年 2 月版本）。 如果 Azure 部署的任一体系结构需要符合 ISM 框架或通过其认证，此蓝图可帮助客户为此体系结构部署一组核心策略。 “控制映射”部分详细介绍了此计划中包含的策略，还详述了这些策略如何帮助满足由 ISM 框架定义的各项控制要求。 在将资源分配给体系结构时，Azure Policy 将评估这些资源是否不符合已分配的策略。
