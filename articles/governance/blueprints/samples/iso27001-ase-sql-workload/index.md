...
- 名为 DevOps 的 [Azure 角色](../../../../role-based-access-control/overview.md)，该角色有权在按蓝图示例部署的 [Azure 应用服务环境](../../../../app-service/environment/intro.md)中部署和管理资源
- [Azure Policy](../../../policy/overview.md) 定义，用于锁定哪些服务可部署到该环境并可拒绝创建任何公共 IP 地址 (PIP) 资源
