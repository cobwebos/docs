...
1. 在更新后的分配详细信息页上，查看新状态。 在此示例中，我们向分配添加了“锁定”****。
   ...
   :::image type="content" source="../media/update-existing-assignments/updated-assignment.png" alt-text="突出显示 &quot;更新分配&quot; 按钮的蓝图分配页的屏幕截图。" border="false":::

1. 使用下拉菜单浏览有关其他 **分配操作** 的详细信息。 **托管资源**的表由所选的分配操作更新。

   :::image type="content" source="../media/update-existing-assignments/assignment-operations.png" alt-text="突出显示 &quot;更新分配&quot; 按钮的蓝图分配页的屏幕截图。" border="false":::
