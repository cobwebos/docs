...
以下文章详细说明了 Azure Policy 法规符合性内置计划定义如何映射到 CIS Microsoft Azure 基础基准的符合性域和控制措施 。
...
然后，找到并选择“审核 CIS Microsoft Azure 基础基准检验 1.1.0 建议，并部署特定的支持 VM 扩展”法规符合性内置计划定义。
...
### <a name="ensure-that-net-framework-version-is-the-latest-if-used-as-a-part-of-the-web-app"></a>确保用作 Web 应用一部分的“.Net Framework”版本是最新的
...
### <a name="ensure-server-parameter-log_duration-is-set-to-on-for-postgresql-database-server"></a>确保 PostgreSQL 数据库服务器的服务器参数“log_duration”设置为“ON”

**ID**：CIS Azure 4.16 所有权：客户
...
### <a name="ensure-that-email-service-and-co-administrators-is-enabled"></a>确保“电子邮件服务和协同管理员”设置为“已启用”

**ID**：CIS Azure 4.7 所有权：客户
...
### <a name="ensure-that-send-alerts-to-is-set"></a>确保设置“将警报发送到”

**ID**：CIS Azure 4.6 所有权：客户
...
### <a name="ensure-that-threat-detection-types-is-set-to-all"></a>确保“威胁检测类型”设置为“全部”
...
|名称<br /><sub>（Azure 门户）</sup> |说明 |效果 |版本<br /><sub>(GitHub)</sub> |
|---|---|---|---|---|
|[不应存在自定义订阅所有者角色](https://portal.azure.com/#blade/Microsoft_Azure_Policy/PolicyDetailBlade/definitionId/%2Fproviders%2FMicrosoft.Authorization%2FpolicyDefinitions%2F10ee2ea2-fb4d-45b8-a7e9-a2e770044cd9) |此策略确保不存在自定义订阅所有者角色。 |Audit、Disabled |[1.0.0](https://github.com/Azure/azure-policy/blob/master/built-in-policies/policyDefinitions/General/CustomSubscription_OwnerRole_Audit.json) |
