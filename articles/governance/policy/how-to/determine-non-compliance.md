...
> - [更改历史记录 (预览)](#change-history-preview)
...
1. "**符合性详细信息**" 窗格显示从最新的资源评估到当前策略分配的信息。 在此示例中, 在策略定义应为_14.0_时, 12.0 字段的字段为 。 如果资源出于多种原因不符合, 则每个原因都列在此窗格中。
...
这些详细信息解释资源当前不符合的原因, 但不显示对资源所做的更改导致不符合的情况。 有关此信息, 请参阅下面的[更改历史记录 (预览版)](#change-history-preview) 。
