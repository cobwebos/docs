...
1. 在列表中选择国家云：
   ...
   :::image type="content" source="../media/extension-for-vscode/set-default-azure-cloud-sign-in.png" alt-text="选择用于 Visual Studio Code 的 Azure 云登录的屏幕截图。" border="false":::
...
1. 通过 Azure Policy 扩展或命令面板登录到 Azure。
   ...
   - Azure Policy 扩展
     ...
     :::image type="content" source="../media/extension-for-vscode/azure-cloud-sign-in-policy-extension.png" alt-text="Visual Studio Code 和 Azure 策略扩展的图标的屏幕截图。" border="false":::
