...
若要创建 Guest Configuration 策略，必须添加资源模块。 此资源模块可用于本地安装的 PowerShell、 [Azure Cloud Shell](https://shell.azure.com)或[Azure PowerShell 核心 Docker 映像](https://hub.docker.com/r/azuresdk/azure-powershell-core)。
