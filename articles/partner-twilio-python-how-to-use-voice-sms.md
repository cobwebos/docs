...
使用 Twilio 服务且在 Azure 中运行的 Python 应用程序与任何其他使用 Twilio 服务的 Python 应用程序没有任何差别。 尽管 Twilio 服务是基于 REST 的，可以通过多种方式从 Python 调用，本文将重点介绍如何将 Twilio 服务与 GitHub 中的用于[Python 的 Twilio 库][twilio_python]一起使用。 有关使用用于 Python 的 Twilio 库的详细信息，请参阅[https://www.twilio.com/docs/libraries/python][twilio_lib_docs]。
