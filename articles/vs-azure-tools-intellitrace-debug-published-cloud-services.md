---
title: "使用 IntelliTrace 和 Visual Studio 调试已发布的云服务 | Microsoft Docs"
...
---
# <a name="debugging-a-published-cloud-service-with-intellitrace-and-visual-studio"></a>使用 IntelliTrace 和 Visual Studio 调试已发布的云服务
...
## <a name="to-configure-an-azure-application-for-intellitrace"></a>为 IntelliTrace 配置 Azure 应用程序
...
3. 如果希望在云中发布应用程序时收集其 IntelliTrace 日志，请选中“启用 IntelliTrace”复选框。
...
## <a name="downloading-intellitrace-logs-for-a-role-instance"></a>下载角色实例的 IntelliTrace 日志
...
[调试云服务](https://msdn.microsoft.com/library/ee405479.aspx)
