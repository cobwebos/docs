...
We have created an easy way for you to create a management certificate for Azure by visiting: [https://manage.windowsazure.cn/publishsettings/Index?client=vs&SchemaVersion=1.0](https://manage.windowsazure.cn/publishsettings/Index?client=vs&SchemaVersion=1.0)
...
You can create a management certificate in a variety of ways.  For more information about creating certificates, see [Create a Management Certificate for Azure](http://msdn.microsoft.com/zh-cn/library/azure/gg551722.aspx).  After you create the certificate, add it to your subscription in Azure. 
