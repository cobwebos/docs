...
> [WACN.NOTE] If you want to raise the limit above the **Default Limit**, open an incident with [customer support][customersupport]. The limits cannot be raised above the **Maximum Limit** value in the tables below. If there is no **Maximum Limit** column, then the specified resource does not have adjustable limits.
