...
| [Get-AzCosmosDBTable](https://docs.microsoft.com/powershell/module/az.cosmosdb/get-azcosmosdbtable) | 列出帐户中的 Cosmos DB 表 API 表，或在帐户中获取指定的 Cosmos DB 表 API 表。 |
|**Azure 资源组**| |
