...
description: Azure PowerShell 脚本示例-Azure Cosmos 帐户获取连接字符串
author: markjbrown
...
---
# <a name="get-connection-strings-for-an-azure-cosmos-account-using-powershell"></a>使用 PowerShell 的 Azure Cosmos 帐户获取连接字符串
