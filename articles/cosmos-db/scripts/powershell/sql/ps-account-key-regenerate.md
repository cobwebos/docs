---
title: Azure PowerShell 脚本-Azure Cosmos 帐户重新生成密钥
description: Azure PowerShell 脚本示例-Azure Cosmos 帐户重新生成密钥
author: markjbrown
...
ms.locfileid: "65078350"
---
# <a name="regenerate-keys-for-an-azure-cosmos-account-using-powershell"></a>使用 PowerShell 的 Azure Cosmos 帐户重新生成密钥
