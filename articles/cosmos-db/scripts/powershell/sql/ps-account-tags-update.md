---
title: Azure PowerShell 脚本-Azure Cosmos 帐户更新标记
description: Azure PowerShell 脚本示例-Azure Cosmos 帐户更新标记
author: markjbrown
...
ms.locfileid: "65078335"
---
# <a name="update-tags-for-an-azure-cosmos-account-using-powershell"></a>使用 PowerShell 的 Azure Cosmos 帐户更新标记
