---
title: Azure PowerShell 脚本-Azure Cosmos 帐户中的所有数据库的列表
description: Azure PowerShell 脚本示例-Azure Cosmos 帐户中的所有数据库的列表
author: markjbrown
...
ms.locfileid: "65077675"
---
# <a name="list-all-databases-in-an-azure-cosmos-account-using-powershell"></a>列出在使用 PowerShell 的 Azure Cosmos 帐户中的所有数据库
