---
title: Azure PowerShell 脚本-Azure Cosmos 帐户更改故障转移优先级
description: Azure PowerShell 脚本示例-Azure Cosmos 帐户更改故障转移优先级
author: markjbrown
...
ms.locfileid: "65079295"
---
# <a name="change-failover-priority-for-an-azure-cosmos-account-using-powershell"></a>使用 PowerShell 的 Azure Cosmos 帐户更改故障转移优先级
