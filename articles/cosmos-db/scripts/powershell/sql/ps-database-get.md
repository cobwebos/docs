---
title: Azure PowerShell 脚本-获取 Azure Cosmos 帐户中的数据库的属性
description: Azure PowerShell 脚本示例-获取 Azure Cosmos 帐户中的数据库的属性
author: markjbrown
...
ms.locfileid: "65077660"
---
# <a name="get-the-properties-of-a-database-in-an-azure-cosmos-account-using-powershell"></a>获取数据库的属性中使用 PowerShell 的 Azure Cosmos 帐户
