---
title: Azure PowerShell 脚本-获取 Azure Cosmos 帐户密钥
description: Azure PowerShell 脚本示例-Azure Cosmos 帐户获取密钥
author: markjbrown
...
ms.locfileid: "65078395"
---
# <a name="get-keys-for-an-azure-cosmos-account-using-powershell"></a>获取使用 PowerShell 的 Azure Cosmos 帐户密钥
