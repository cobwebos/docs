...
[!code-azurecli[主要](../../../cli_scripts/cosmosdb/secure-cosmosdb-get-mongodb-connection-string/secure-cosmosdb-get-mongodb-connection-string.sh?highlight=36-39 "获取 MongoDB 应用的 Azure Cosmos DB 连接字符串")]
...
| [az cosmosdb list-connection-strings](/cli/azure/cosmosdb/list-connection-strings) | 获取帐户的连接字符串。|
