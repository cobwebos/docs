---
title: "Azure PowerShell 脚本 - 为 Azure Cosmos DB 创建防火墙 | Microsoft Docs"
...
[!code-powershell[main](../../../powershell_scripts/cosmosdb/create-firewall/create-firewall.ps1?highlight=35-36,39-43 "为 Azure Cosmos DB 创建防火墙")]
