---
title: Azure CLI 脚本 - 创建 Azure Cosmos DB 表 API 帐户、数据库和表 | Microsoft Docs
...
| [az cosmosdb collection create](/cli/azure/cosmosdb/collection#az-cosmosdb-collection-create) | 创建 Azure Cosmos DB 表。 |
