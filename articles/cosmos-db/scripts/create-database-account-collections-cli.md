...
[!code-azurecli-interactive[主要](../../../cli_scripts/cosmosdb/create-cosmosdb-account-database/create-cosmosdb-account-database.sh?highlight=15-35 "创建 Azure Cosmos DB DocumentDB API 帐户、 数据库和集合")]
