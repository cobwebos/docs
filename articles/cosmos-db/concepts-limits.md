...
| Resource | 默认限制 |
| --- | --- |
| 每个容器的最大 RU 数（[专用吞吐量预配模式](databases-containers-items.md#azure-cosmos-containers)） | 默认为 1,000,000。 可以通过[开具 Azure 支持票证](https://docs.microsoft.com/azure/azure-supportability/how-to-create-azure-support-request)来提高此限制 |
| 每个数据库的最大 RU 数（[共享吞吐量预配模式](databases-containers-items.md#azure-cosmos-containers)） | 默认为 1,000,000。 可以通过[开具 Azure 支持票证](https://docs.microsoft.com/azure/azure-supportability/how-to-create-azure-support-request)来提高此限制 |
...
| Resource | 默认限制 |
| --- | --- |
| 每个订阅的最大数据库帐户数 | 默认为 50。 可以通过[开具 Azure 支持票证](https://docs.microsoft.com/azure/azure-supportability/how-to-create-azure-support-request)来提高此限制|
| 最大区域故障转移次数 | 默认为每小时 1 次。 可以通过[开具 Azure 支持票证](https://docs.microsoft.com/azure/azure-supportability/how-to-create-azure-support-request)来提高此限制|
...
| 主令牌最长过期时间 | 15 分钟  |
| 资源令牌最短过期时间 | 10 分钟  |
| 资源令牌最长过期时间 | 默认为 24 小时。 可以通过[开具 Azure 支持票证](https://docs.microsoft.com/azure/azure-supportability/how-to-create-azure-support-request)来提高此限制|
| 令牌授权的最大时钟偏差| 15 分钟 |
