---
title: Azure Cosmos DB 和 Azure Functions 无服务器数据库计算
...
**实现：** 对 Cosmos DB 使用 Azure Functions 触发器和输出绑定
...
**实现：** 侦听一个容器 Cosmos DB 多个 Azure Functions 触发器
...
Azure Cosmos DB 和 Azure Functions 之间的本机集成在 Azure 门户和 Visual Studio 2019 中提供。
