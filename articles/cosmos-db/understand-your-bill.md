...
*我们还假设，导出 100 GB 数据的每月从美国西部，要将数据复制到美国东部、 北欧和东亚中的容器。 出口数据传输费率根据计费。*
...
*定价可能因区域。 有关最新定价，请参阅[定价页](https://azure.microsoft.com/pricing/details/cosmos-db/)。*
...
|**区域**| **每 100 RU/秒的每小时价格**|**单位数 (RU/s)**|**计费数量（每小时）**| **计费数量（每月）**|
|----|----|----|----|----|
