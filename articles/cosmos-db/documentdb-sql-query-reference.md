---
title: "Azure Cosmos DB DocumentDB API：SQL 语法 | Microsoft Docs"
description: "Azure Cosmos DB DocumentDB API SQL 查询语言的引用文档。"
services: cosmos-db
author: mimig1
manager: jhubbard
editor: mimig
...
3.  引用表示某个文档路径表达式的别名。  
     ...
     **语法约定**  
     ...
     下表描述了用于说明 DocumentDB API 查询语言引用中的语法的约定。  
