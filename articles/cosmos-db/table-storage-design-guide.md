...
有关一些直接影响查询设计的主要 Azure 表服务功能，请参阅上一章节：[Azure 表服务概述](#overview)。 这些功能产生了以下设计表服务查询的通用准则。 下述示例中所用的筛选器语法源自表服务 REST API，详细信息请参阅 [Query Entities](http://msdn.microsoft.com/library/azure/dd179421.aspx)（查询实体）。  
