...
* 获取最新版本的 [Java 开发工具包 (JDK)](http://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html) 
...
从 Azure 门户获取连接字符串信息，并将其复制到 Java 配置文件。 这样，应用程序就可以与托管的数据库进行通信。 
