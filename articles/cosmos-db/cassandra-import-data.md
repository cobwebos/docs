...
[CQL COPY 命令](http://cassandra.apache.org/doc/latest/tools/cqlsh.html#cqlsh)用于将本地数据复制到 Azure Cosmos DB 中的 Cassandra API 帐户。 使用以下步骤复制数据：
