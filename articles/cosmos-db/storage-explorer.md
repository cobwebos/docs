...
1. 右键单击数据库，选择 **"创建集合**"，然后提供以下信息，如**集合 ID、****存储容量**等。单击 **"确定"** 以完成。 
...
如果没有解决方案适合您，请发送电子邮件至 Azure Cosmos DB 开发工具团队 （），[cosmosdbtooling@microsoft.com](mailto:cosmosdbtooling@microsoft.com)了解有关此问题的详细信息，以解决此问题。
