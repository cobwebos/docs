---
title: 通过 Azure Cosmos DB Azure Active Directory 基于证书的身份验证
...
1. 填写 "**注册应用程序**" 窗体, 并提供以下详细信息:  
   ...
   * **重定向 URL** -选择类型为 " **Web** " 的应用程序并提供托管应用程序的 url, 可以是任何 url。 在此示例中, 你可以提供测试 URL (如`https://sampleApp.com` ), 即使应用不存在也是如此。
