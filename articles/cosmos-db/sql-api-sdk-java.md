---
title: Azure 宇宙数据库：SQL Java API、SDK &资源
...
* 更新了数据库帐户上的正确客户端副本策略标记，并使得数据库帐户配置从缓存读取。

### <a name="245"></a><a name="2.4.5"/>2.4.5
* 如果用户提供 pkRangeId，则避免重试无效的分区密钥范围错误。

### <a name="244"></a><a name="2.4.4"/>2.4.4
* 优化分区密钥范围缓存刷新。
* 修复了 SDK 不接受服务器分区拆分提示，导致客户端路由缓存刷新不正确的情况。

### <a name="242"></a><a name="2.4.2"/>2.4.2
* 优化的集合缓存刷新。

### <a name="241"></a><a name="2.4.1"/>2.4.1
* 添加了从请求诊断字符串检索内部异常消息的支持。
...
* 修复了在 DirectHttps 模式下的查询在遇到油门故障时可能会停止响应的 Bug。
* 修复了一个会话一致性模式的 bug。
...
> [!WARNING]
> Java SQL SDK 的所有版本**1.x**将于**2020 年 5 月 30**日停用。
> 
>
...
| [1.16.2](#1.16.2) |2018 年 6 月 29日 |2020年5月30日 |
| [1.16.1](#1.16.1) |2018 年 5 月 16日 |2020年5月30日 |
| [1.16.0](#1.16.0) |2018 年 3 月 15 日 |2020年5月30日 |
| [1.15.0](#1.15.0) |2017 年 11 月 14 日 |2020年5月30日 |
| [1.14.0](#1.14.0) |2017 年 10 月 28日 |2020年5月30日 |
| [1.13.0](#1.13.0) |2017 年 8 月25 日 |2020年5月30日 |
...
| [1.9.4](#1.9.4) |2016 年 11 月 24 日 |2020年5月30日 |
