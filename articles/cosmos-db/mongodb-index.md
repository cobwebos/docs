---
title: "Azure Cosmos DB：MongoDB API 文章 | Microsoft Docs"
...
这些文章不适用于 Cosmos DB API、图形 API 或表 API。 
...
- [MongoDB + Express + AngularJS + Node.js + Web 应用](create-mongodb-nodejs.md)
