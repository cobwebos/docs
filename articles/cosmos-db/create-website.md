...
:::image type="content" source="./media/create-website/template-deployment.png" alt-text="部署到 Azure":::
...
:::image type="content" source="./media/create-website/resource-group.png" alt-text="部署到 Azure":::

### <a name="view-cosmos-db-endpoint-and-keys"></a>查看 Cosmos DB 终结点和密钥

接下来在门户中打开 Azure Cosmos 帐户。 以下屏幕截图显示 Azure Cosmos 帐户的终结点和密钥。

:::image type="content" source="./media/create-website/cosmos-keys.png" alt-text="部署到 Azure":::
...
:::image type="content" source="./media/create-website/application-settings.png" alt-text="部署到 Azure":::
...
:::image type="content" source="./media/create-website/deployment-center.png" alt-text="部署到 Azure":::
...
:::image type="content" source="./media/create-website/app-home-screen.png" alt-text="部署到 Azure":::
...
:::image type="content" source="./media/create-website/startup.png" alt-text="部署到 Azure":::
...
:::image type="content" source="./media/create-website/template-keys.png" alt-text="部署到 Azure":::
...
:::image type="content" source="./media/create-website/deploy-from-github.png" alt-text="部署到 Azure":::
