---
title: "Azure Cosmos DB SQL 备忘单 PDF | Microsoft Docs"
description: "可打印的 SQL 备忘单 PDF 有助于用户使用 Azure Cosmos DB 的 SQL 语法在其数据库（SQL 快速参考）中查询 JSON 文档"
...
## <a name="download-the-cosmos-db-sql-query-cheat-sheet-pdf"></a>下载 Cosmos DB SQL 查询备忘单 PDF
通过下载 SQL 查询备忘单并将其用作快速参考可以加快编写查询的速度。 SQL 备忘单 PDF 显示了用于检索两个示例 JSON 文档中的数据的常见查询。 若要随身携带，可以采用信纸幅面尺寸（8.5 x 11 英寸）打印单面 SQL 查询备忘单。

**在此处下载 SQL 备忘单：[Microsoft Azure Cosmos DB SQL 备忘单](http://go.microsoft.com/fwlink/?LinkId=623215)**

![Azure Cosmos DB SQL 查询备忘单：Azure Cosmos DB 支持的 SQL 语法的快速参考 PDF - SQL 备忘单、SQL 备忘单 PDF、SQL 快速参考][cheat-sheet]
