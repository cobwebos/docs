...
1. **连接模式：使用 DirectHttps**
   ...
   2. [DirectHttps](https://docs.microsoft.com/java/api/com.microsoft.azure.documentdb.connectionmode)
    ...
    ### <a name="sync-java-sdk-v2-maven-commicrosoftazureazure-documentdb"></a><a id="syncjava2-connectionpolicy"></a>Sync Java SDK V2 (Maven com.microsoft.azure::azure-documentdb)
      ...
      :::image type="content" source="./media/performance-tips-java/connection-policy.png" alt-text="关系图显示 Azure Cosmos D B 连接策略。" border="false":::
...
2. **将客户端并置在同一 Azure 区域中以提高性能**
    ...
    :::image type="content" source="./media/performance-tips/same-region.png" alt-text="关系图显示两个区域中的请求和响应，其中计算机通过中间层服务连接到 Cosmos D B 帐户。" border="false":::
