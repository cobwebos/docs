...
description: 使用 Azure Cosmos DB 的 Bulk Executor .NET 库在 Azure Cosmos DB 容器中批量导入和更新文档。
keywords: .NET 批量执行程序
services: cosmos-db
author: tknandu
manager: kfile
...
“BulkImportSample”应用程序会生成随机文档并将其批量导入 Azure Cosmos DB。 “BulkUpdateSample”应用程序通过指定要对特定文档字段执行的修补操作，来批量更新导入的文档。 在后续部分，我们将查看其中每个示例应用中的代码。
