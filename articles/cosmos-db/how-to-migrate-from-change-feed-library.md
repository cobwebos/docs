...
1. 使用 `WithProcessorOptions` 的自定义应更新为对时间间隔使用 `WithLeaseConfiguration` 和 `WithPollInterval`、对 [开始时间](how-to-configure-change-feed-start-time.md)使用 `WithStartTime` 以及使用 `WithMaxItems` 来定义最大项计数。
