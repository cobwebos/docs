...
description: 本文介绍如何创建和使用 Azure Cosmos 帐户。 它还显示 Azure Cosmos 帐户中元素的层次结构
author: markjbrown
ms.author: mjbrown
...
若要安全地管理对你的 Azure Cosmos 帐户中的所有数据的访问，你可以使用与你的帐户关联的[主密钥](secure-access-to-data.md)。 为了进一步保护对数据的访问，你可以在 Azure Cosmos 帐户上配置[VNET 服务终结点](vnet-service-endpoint.md)和[IP 防火墙](firewall-support.md)。 
