---
title: 使用 MongoB API 的 Node.Js、Angular 应用（第 4 部分）
...
ms.locfileid: "53136216"
---
# <a name="create-a-mongodb-app-with-angular-and-azure-cosmos-db---part-4-create-an-azure-cosmos-db-account"></a>通过 Angular 和 Azure Cosmos DB 创建 MongoDB 应用 - 第 4 部分：创建 Azure Cosmos DB 帐户
