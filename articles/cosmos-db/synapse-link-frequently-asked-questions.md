...
在公共预览版中，Azure Cosmos DB SQL (Core) API 和适用于 MongoDB 的 Azure Cosmos DB API 支持 Synapse 链接。 目前支持 Cassandra API 位于封闭预览版下。 若要请求对封闭预览版的访问权限，请联系 [Azure Cosmos DB 团队](mailto:cosmosdbsynapselink@microsoft.com)。
