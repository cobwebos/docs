...
如果希望我们直接与你联系，请将电子邮件地址附在评论中，或者[通过此途径联系我们](https://www.research.net/r/8BKRJ3Z)。 
...
[文档](documentdb-resources.md#documents)是用户定义的（任意）JSON 内容。 现在，可以将文档插入 Azure Cosmos DB 中。 将以下代码复制到 main 函数的末尾即可创建文档。 
