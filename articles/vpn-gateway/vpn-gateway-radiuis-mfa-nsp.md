...
2. 打开 NPS 控制台中，右键单击**RADIUS 客户端**，然后选择**新建**。 通过指定以下设置创建 RADIUS 客户端：

    - **友好名称**：键入任何名称。
    - **地址（IP 或 DNS）** ：键入在步骤 1 中创建的网关子网。
    - **共享机密**：键入任何密钥，并记住它以供将来使用。

      ![有关 RADIUS 客户端设置的图像](./media/vpn-gateway-radiuis-mfa-nsp/create-radius-client1.png)
