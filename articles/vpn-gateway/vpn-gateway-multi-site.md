...
导出网络配置文件。 导出的文件将用于配置新的多站点设置。 如果需要有关如何导出文件的说明，请参阅文章中的相应部分：[如何在 Azure 门户中创建经典 VNet](../virtual-network/virtual-networks-create-vnet-classic-pportal.md#how-to-create-a-classic-vnet-in-the-azure-portal)。
...
导入网络配置文件。 在导入这个包含更改的文件时，将会添加新的隧道。 这些隧道将使用你前面创建的动态网关。 如果需要有关如何导入文件的说明，请参阅文章中的相应部分：[如何在 Azure 门户中创建经典 VNet](../virtual-network/virtual-networks-create-vnet-classic-pportal.md#how-to-create-a-classic-vnet-in-the-azure-portal)。  
