---
title: "如何使用 Azure Resource Manager 和 PowerShell 在 Azure VPN 网关上配置 BGP | Microsoft 文档"
...
---
# <a name="how-to-configure-bgp-on-azure-vpn-gateways-using-azure-resource-manager-and-powershell"></a>如何使用 Azure Resource Manager 和 PowerShell 在 Azure VPN 网关上配置 BGP
...
## <a name="a-name-enablebgpapart-1---configure-bgp-on-the-azure-vpn-gateway"></a><a name ="enablebgp"></a>第 1 部分 - 在 Azure VPN 网关上配置 BGP
...
## <a name="a-name-crossprembbgpapart-2---establish-a-cross-premises-connection-with-bgp"></a><a name ="crossprembbgp"></a>第 2 部分 - 使用 BGP 建立跨界连接
...
## <a name="a-name-v2vbgpapart-3---establish-a-vnet-to-vnet-connection-with-bgp"></a><a name ="v2vbgp"></a>第 3 部分 - 使用 BGP 建立 VNet 到 VNet 连接
