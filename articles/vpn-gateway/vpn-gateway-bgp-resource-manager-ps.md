...
#### <a name="2-create-the-vpn-gateway-with-the-as-number"></a>2. 用 AS 编号创建 VPN 网关
...
#### <a name="3-create-the-vpn-gateway-for-testvnet2-with-bgp-parameters"></a>3. 创建具有 BGP 参数的 TestVNet2 的 VPN 网关
