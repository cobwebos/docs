...
配置 VPN 网关时，使用的说明取决于用于创建虚拟网络的部署模型。 例如，如果使用经典部署模型创建的 VNet，则使用经典部署模型的指导原则和说明来创建及配置 VPN 网关设置。 有关部署模型的详细信息，请参阅 [了解 Resource Manager 和经典部署模型](../resource-manager-deployment-model.md)。
...
## <a name="sitetosite-and-multisite"></a>站点到站点和多站点
### <a name="sitetosite"></a>站点到站点
...
### <a name="deployment-models-and-methods-for-sitetosite-and-multisite"></a>适用于站点到站点和多站点的部署模型和方法
[!INCLUDE [vpn-gateway-table-site-to-site](../../includes/vpn-gateway-table-site-to-site-include.md)]

## <a name="vnettovnet"></a>VNet 到 VNet
...
### <a name="deployment-models-and-methods-for-vnettovnet"></a>适用于 VNet 到 VNet 的部署模型和方法
[!INCLUDE [vpn-gateway-table-vnet-to-vnet](../../includes/vpn-gateway-table-vnet-to-vnet-include.md)]

## <a name="pointtosite"></a>点到站点
...
### <a name="deployment-models-and-methods-for-pointtosite"></a>适用于点到站点的部署模型和方法
...
## <a name="sitetosite-and-expressroute-coexisting-connections"></a>站点到站点和 ExpressRoute 的共存连接
