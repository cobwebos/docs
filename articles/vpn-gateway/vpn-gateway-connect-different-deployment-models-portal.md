...
4. 对于“本地站点”，单击“配置所需设置”。 这会打开“本地站点”边栏选项卡。
...
1. 在“新建 VPN 连接”边栏选项卡上，选择“立即创建网关”复选框，并单击“可选网关配置”，打开“网关配置”边栏选项卡。 
...
5. 验证“路由类型”是否为“动态”，并单击“确定”，返回“新建 VPN 连接”边栏选项卡。
...
2. 单击“配置”并验证 IP 地址值是否是经典 VNet 的 VPN 网关。 如果需要，进行更新，并单击“保存”。 关闭边栏选项卡。
3. 在“所有资源”中，单击本地网络网关。
...
使用提升的权限打开 PowerShell 控制台并登录 Azure 帐户。 以下 cmdlet 会提示提供 Azure 帐户的登录凭据。 登录后将下载帐户设置，以便 Azure PowerShell 使用这些设置。
