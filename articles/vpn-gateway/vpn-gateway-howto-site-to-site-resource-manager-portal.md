...
> * [电源外壳](vpn-gateway-create-site-to-site-rm-powershell.md)
...
- 虚拟网络网关的“公共 IP 地址”。 可以通过 Azure 门户、PowerShell 或 CLI 查看公共 IP 地址。 要使用 Azure 门户查找 VPN 网关的公共 IP 地址，请导航到**虚拟网络网关**，然后单击网关的名称。
...
* 有关强制隧道的信息，请参阅[有关强制隧道](vpn-gateway-forced-tunneling-rm.md)的信息。
