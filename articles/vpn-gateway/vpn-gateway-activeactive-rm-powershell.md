---
title: "如何使用 Azure Resource Manager 和 PowerShell 来配置与 Azure VPN 网关的主动-主动 S2S VPN 连接 | Microsoft 文档"
...
---
# <a name="configure-active-active-s2s-vpn-connections-with-azure-vpn-gateways-using-azure-resource-manager-and-powershell"></a>使用 Azure Resource Manager 和 PowerShell 来配置与 Azure VPN 网关的主动-主动 S2S VPN 连接
...
## <a name="a-name-aagatewayapart-1---create-and-configure-active-active-vpn-gateways"></a><a name ="aagateway"></a>第 1 部分 - 创建并设置主动-主动 VPN 网关
...
## <a name="a-name-aacrosspremapart-2---establish-an-active-active-cross-premises-connection"></a><a name ="aacrossprem"></a>第 2 部分 - 建立主动-主动跨界连接
...
## <a name="a-name-aav2vapart-3---establish-an-active-active-vnet-to-vnet-connection"></a><a name ="aav2v"></a>第 3 部分 - 建立主动-主动 VNet 到 VNet 连接
...
## <a name="a-name-aaupdateapart-4---update-existing-gateway-between-active-active-and-active-standby"></a><a name ="aaupdate"></a>第 4 部分 - 更新主动-主动和主动-待机连接之间的现有网关
...
必须在 PowerShell 中设置网关对象以触发实际更新。 网关对象的 SKU 同时也必须更改为 HighPerformance，因为之前将其创建为 Standard。
