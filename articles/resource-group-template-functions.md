...
本主题介绍你可以在 Azure Resource Manager 模板中使用的所有函数。
...
此函数始终用于 **copy** 对象。有关使用 **copyIndex** 的示例，请参阅[在 Azure Resource Manager 中创建多个资源实例](/documentation/articles/resource-group-create-multiple)。
...
## 后续步骤
- 有关 Azure Resource Manager 模板中对各部分的说明，请参阅[创作 Azure Resource Manager 模板](/documentation/articles/resource-group-authoring-templates)
- 若要合并多个模板，请参阅[将已链接的模板与 Azure Resource Manager 配合使用](/documentation/articles/resource-group-linked-templates)
