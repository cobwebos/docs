...
2. 通过单击 **"应用** > **设置** > **添加帐户**"将 Google 帐户添加到 Android 设备。 然后按提示操作，将现有的 Google 帐户添加到设备，或者新建一个。
...
2. 在App.xaml.cs中，添加以下**Init通知Async**方法：
...
4. 在可视化工作室的解决方案资源管理器中，打开**包.appxmanifest 文件**，并将 **"Toast"设置为****"** 通知"下的 **"是**"。
