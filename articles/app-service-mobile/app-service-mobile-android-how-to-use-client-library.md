...
### <a name="a-namegradle-buildaupdate-the-gradle-build-file"></a><a name="gradle-build"></a>更新 Gradle 生成文件
...
### <a name="a-nameenable-internetaenable-internet-permission"></a><a name="enable-internet"></a>启用 Internet 权限
...
### <a name="a-namedata-objectadefine-client-data-classes"></a><a name="data-object"></a>定义客户端数据类
...
### <a name="a-namecreate-clientahow-to-create-the-client-context"></a><a name="create-client"></a>如何创建客户端上下文
...
### <a name="a-namebindingahow-to-bind-data-to-the-user-interface"></a><a name="binding"></a>如何将数据绑定到用户界面
数据绑定涉及到三个组件：
...
#### <a name="a-namelayoutahow-to-define-the-layout"></a><a name="layout"></a>如何定义布局
...
#### <a name="a-nameadapterahow-to-define-the-adapter"></a><a name="adapter"></a>如何定义适配器
...
### <a name="a-nameapiathe-api-structure"></a><a name="api"></a>API 结构
...
#### <a name="a-nameuse-adapterahow-to-use-the-adapter"></a><a name="use-adapter"></a>如何使用适配器
...
## <a name="a-namequeryingahow-to-query-data-from-your-mobile-app-backend"></a><a name="querying"></a>如何查询移动应用后端中的数据
...
### <a name="a-nameshowallahow-to-return-all-items-from-a-table"></a><a name="showAll"></a>如何返回表中的所有项
...
### <a name="a-namechainingahow-to-concatenate-query-methods"></a><a name="chaining"></a>如何连接查询方法
...
## <a name="a-nameinsertingahow-to-insert-data-into-the-backend"></a><a name="inserting"></a>如何将数据插入后端
...
## <a name="a-nameupdatingahow-to-update-data-in-a-mobile-app"></a><a name="updating"></a>如何更新移动应用中的数据
...
## <a name="a-namedeletingahow-to-delete-data-in-a-mobile-app"></a><a name="deleting"></a>如何删除移动应用中的数据
...
## <a name="a-namelookupahow-to-look-up-a-specific-item"></a><a name="lookup"></a>如何查找特定的项
...
## <a name="a-nameuntypedahow-to-work-with-untyped-data"></a><a name="untyped"></a>如何处理非类型化数据
...
### <a name="a-namejsoninstanceahow-to-create-an-instance-of-an-untyped-table"></a><a name="json_instance"></a>如何创建非类型化表的实例
...
### <a name="a-namejsoninsertahow-to-insert-into-an-untyped-table"></a><a name="json_insert"></a>如何插入到非类型化表中
...
### <a name="a-namejsondeleteahow-to-delete-from-an-untyped-table"></a><a name="json_delete"></a>如何从非类型化表中删除数据
...
### <a name="a-namejsongetahow-to-return-all-rows-from-an-untyped-table"></a><a name="json_get"></a>如何返回非类型化表中的所有行
...
## <a name="a-namecustom-apiahow-to-call-a-custom-api"></a><a name="custom-api"></a>如何：调用自定义 API
...
## <a name="a-nameauthenticationahow-to-add-authentication-to-your-app"></a><a name="authentication"></a>如何将身份验证添加到应用
教程已详细说明如何添加这些功能。
...
### <a name="a-namecachingahow-to-add-authentication-code-to-your-app"></a><a name="caching"></a>如何向应用程序添加身份验证代码
...
### <a name="a-namecachingahow-to-cache-authentication-tokens"></a><a name="caching"></a>如何缓存身份验证令牌
...
## <a name="a-namecustomizingahow-to-customize-the-client"></a><a name="customizing"></a>如何自定义客户端
可以通过多种方法自定义客户端的默认行为。
...
### <a name="a-nameserializationahow-to-customize-serialization"></a><a name="serialization"></a>如何自定义序列化
...
### <a name="a-namecolumnsahow-to-map-different-client-and-server-names"></a><a name="columns"></a>如何映射不同的客户端名称和服务器名称
...
### <a name="a-nametableahow-to-map-different-table-names-between-the-client-and-the-backend"></a><a name="table"></a>如何在客户端与后端之间映射不同的表名称
使用替代 [getTable()][4] 方法将客户端表名称映射到其他移动服务表名称中：

    mToDoTable = mClient.getTable("ToDoItemBackup", ToDoItem.class);

### <a name="a-nameconversionsahow-to-automate-column-name-mappings"></a><a name="conversions"></a>如何自动执行列名称映射
...
### <a name="a-namecomplexahow-to-store-an-object-or-array-property-into-a-table"></a><a name="complex"></a>如何将对象或数组属性存储到表中
