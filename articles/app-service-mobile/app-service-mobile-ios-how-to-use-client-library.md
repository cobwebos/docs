...
4. 根据使用的语言，将以下代码添加到应用程序。 在每个应用程序中，进行以下替换：
   ...
   * 将 **INSERT-AUTHORITY-HERE** 替换为在其中预配应用程序的租户的名称。 格式应为 https://login.microsoftonline.com/contoso.onmicrosoft.com。可以在 [Azure 门户]中从 Azure Active Directory 的“域”选项卡复制此值。
