...
---
# <a name="creating-an-internetfacing-load-balancer-using-the-azure-portal"></a>使用 Azure 门户创建面向 Internet 的负载平衡器
...
## <a name="what-is-required-to-create-an-internetfacing-load-balancer"></a>创建面向 Internet 的负载平衡器需要什么？
需要创建和配置以下对象以部署负载平衡器。
