...
```
使用 [New-AzBastion](/powershell/module/az.network/new-azbastion) 创建 Bastion 主机：
...
* 有关 Azure Bastion 的详细信息，请参阅[什么是 Azure Bastion？](https://docs.microsoft.com/azure/bastion/bastion-overview)。
