---
title: "内部负载平衡器概述 | Microsoft Docs"
...
Azure 内部负载平衡 (ILB) 可在驻留在云服务或虚拟网络（具有区域性作用域）中的虚拟机之间进行负载平衡。 有关如何使用和配置具有区域性作用域的虚拟网络的信息，请参阅 Azure 博客中的[区域虚拟网络](https://azure.microsoft.com/blog/2014/05/14/regional-virtual-networks/)。 已配置关联组的现有虚拟网络无法使用 ILB。
