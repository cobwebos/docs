...
7. 通过步骤 1-6 创建名为 *VM2* 的另一个 VM（将 *myAvailibilityset* 作为其可用性集，将 *myVnet* 作为其虚拟网络，将 *myBackendSubnet* 作为其子网，**myNetworkSecurityGroup* 作为其网络安全组）。 
...
3. 在“添加后端池”页上执行以下操作：
    ...
    ![添加到后端地址池 - ](./media/load-balancer-standard-public-portal/3-load-balancer-backend-02.png)
