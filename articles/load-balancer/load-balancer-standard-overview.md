...
description: 使用此学习路径，开始了解 Azure 标准负载均衡器功能的概述。
...
>[!NOTE]
> Azure 为方案提供了一套完全托管的负载均衡解决方案。 如果正在寻找传输层安全性（TLS）协议终止（"SSL 卸载"）或按 HTTP/HTTPS 请求，请参阅[什么是 Azure 应用程序网关](../application-gateway/overview.md)。 如果正在寻找全局 DNS 负载平衡，请参阅[什么是 > 流量管理器](../traffic-manager/traffic-manager-overview.md)。 你的端到端方案可能会受益于组合这些解决方案。
>
