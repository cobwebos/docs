---
title: 创建公共标准负载均衡器 - Azure CLI | Microsoft Docs
description: 了解如何使用 Azure CLI 创建公共负载均衡器
...
---
# <a name="create-a-standard-load-balancer-to-load-balance-vms-using-azure-cli-20"></a>使用 Azure CLI 2.0 创建标准负载均衡器以对 VM 进行负载均衡
