...
有关如何创建虚拟机和分配 NIC 的分步说明，请参阅[使用 PowerShell 创建 Azure VM](../virtual-machines/scripts/virtual-machines-windows-powershell-sample-create-vm.md?toc=%2fazure%2fload-balancer%2ftoc.json)。
