...
本文假设你有一个春季 Boot 2.x 应用程序，该应用程序可以在 Azure 春季云服务上成功部署和启动。  请参阅[快速入门：使用 Azure 门户启动现有的 Azure 春季云应用程序](spring-cloud-quickstart-launch-app-portal.md)
...
>[!TIP]
> * 如果应用返回前端页面并通过相对路径引用其他文件，请确认测试终结点以斜杠（/）结尾。 这将确保正确加载 CSS 文件。
...
* [了解 Azure 春季云中的应用状态](spring-cloud-concept-app-status.md)）