...
ms.locfileid: "89269601"
---
# <a name="quickstart-launch-a-java-spring-application-using-the-azure-cli"></a>快速入门：使用 Azure CLI 启动 Java Spring 应用程序

使用 Azure Spring Cloud 可以在 Azure 上轻松运行基于 Spring Boot 的微服务应用程序。  在运行此示例之前，可以尝试[基础知识快速入门](spring-cloud-quickstart.md)。
...
3. 导航到上一个命令提供的 URL，以运行 PiggyMetrics 应用程序。
    ![正在运行的 PiggyMetrics](media/spring-cloud-quickstart-launch-app-cli/launch-app.png)
...
3. 选择“网关”
    ...
    ![PiggyMetrics 导航](media/spring-cloud-quickstart-launch-app-cli/navigate-app1.png)
    
4. 在“网关概述”页上查找 URL ![PiggyMetrics 导航 2](media/spring-cloud-quickstart-launch-app-cli/navigate-app2-url.png)
