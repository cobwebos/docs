...
* 要监视的 Azure 资源，例如，在以下文章中实施的数据库：[如何将 Spring Data Apache Cassandra API 用于 Azure Cosmos DB](https://docs.microsoft.com/azure/java/spring-framework/configure-spring-data-apache-cassandra-with-cosmos-db)
...
1. 在“创建规则”页上，指定“资源”、“条件”和“操作”。      在“操作”窗格中，选择前面定义的**操作组**。 
