...
ms.locfileid: "86172532"
---
# <a name="java-and-base-os-for-spring-microservice-apps"></a>用于春季微服务 Apps 的 Java 和基本 OS
...
* [快速入门：使用 Azure 门户启动现有的 Azure 春季云应用程序](spring-cloud-quickstart-launch-app-portal.md)
