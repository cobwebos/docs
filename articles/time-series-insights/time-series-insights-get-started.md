...
1. 选择“物联网”类别，再选择“时序见解”。
   ...
   [@no__t 时序见解环境）（1Create](media/time-series-insights-get-started/1-new-tsi.png)](media/time-series-insights-get-started/1-new-tsi.png#lightbox)）

1. 在“时序见解”页上，选择“创建”。

1. 填写必需的参数。 下表解释了每个参数：
   
   [@no__t 时序见解资源组的1Create](media/time-series-insights-get-started/2-create-tsi.png)](media/time-series-insights-get-started/2-create-tsi.png#lightbox)
...
1. 若要监视部署过程，请选择“通知”符号（钟形图标）。
   ...
   [@no__t 1Watch 通知](media/time-series-insights-get-started/3-notifications.png)](media/time-series-insights-get-started/3-notifications.png#lightbox)

    部署成功后，可以选择“转到资源”配置其他属性、设置数据访问策略的安全性、添加事件源，以及执行其他操作。

1. 在资源**概述**中，选择右上角的 "**固定" 图标**，以便在将来轻松访问时序见解环境。

   [@no__t 将时序见解固定到仪表板（1Create）](media/time-series-insights-get-started/4-pin-create.png)](media/time-series-insights-get-started/4-pin-create.png#lightbox)
