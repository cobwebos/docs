---
title: Power BI 集成-Azure 时序见解第2代 |Microsoft Docs
...
ms.locfileid: "86495306"
---
# <a name="connect-azure-time-series-insights-gen-2-to-power-bi"></a>将 Azure 时序见解第2代连接到 Power BI  
...
连接数据需时不到一分钟。 通过快速将视图从 Azure 时序见解资源管理器导出到 Power BI，你的组织中的任何人都可以直观地访问和直观地转换数据。
...
有关分步说明，请参阅[如何将 Azure 时序见解连接到 Power BI](./how-to-connect-power-bi.md) 。

## <a name="flexible-workflow"></a>灵活的工作流
 
从工作流中的任何位置使用连接器：

* 如果在 Azure 时序见解资源管理器中，可以快速将视图导出到 Power BI。 
* 如果你已在 Power BI，使用 Azure 时序见解扩展现有的可视化方案以查询数据。
