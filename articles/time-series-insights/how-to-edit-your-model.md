---
title: Gen2 环境中的数据建模-Azure 时序见解 |Microsoft Docs
description: 了解 Azure 时序见解 Gen2 中的数据建模。
author: deepakpalled
ms.author: dpalled
manager: diviso
...
ms.locfileid: "87096300"
---
# <a name="data-modeling-in-azure-time-series-insights-gen2"></a>Azure 时序见解 Gen2 中的数据建模

本文介绍如何在 Azure 时序见解 Gen2 中使用时序模型。 它详细介绍了几个常见数据方案。

> [!TIP]
> * 阅读有关[时序模型](concepts-model-overview.md)的详细信息。
...
首先，从 Azure 时序见解资源管理器的 "**分析**" 视图中选择**模型**视图。

### <a name="create-a-single-instance"></a>创建单个实例

1. 转到“时序模型”选择器面板，并从菜单中选择“实例”****。 将显示与所选 Azure 时序见解环境关联的所有实例。
...
1. 转到“时序模型”选择器面板，并从菜单中选择“层次结构”****。 将显示与所选 Azure 时序见解环境关联的所有层次结构。
...
1. 转到“时序模型”选择器面板，并从菜单中选择“类型”****。 将显示与所选 Azure 时序见解环境关联的所有类型。
