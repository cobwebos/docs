...
默认情况下，Azure IoT 中心和事件中心具有内置恢复功能。

若要了解有关 IoT 中心的 BCDR 策略的详细信息，请访问[此处](https://docs.microsoft.com/azure/iot-hub/iot-hub-ha-dr)。  

若要了解有关事件中心的 BCDR 策略的详细信息，请访问[此处](https://docs.microsoft.com/azure/event-hubs/event-hubs-geo-dr)。
