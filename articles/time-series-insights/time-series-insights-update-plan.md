...
> [!NOTE]
> 若要获得计划正式推出时序见解实例的最佳实践，请参阅[规划 Azure 时序见解一般可用性环境](time-series-insights-environment-planning.md)。
...
> [!NOTE]
> 若要详细了解如何查询你的温数据，请阅读[API 参考](https://docs.microsoft.com/rest/api/time-series-insights/dataaccess(preview)/query/execute#uri-parameters)。
...
有关详细信息，请参阅[形状事件](./time-series-insights-send-events.md#supported-json-shapes)。
