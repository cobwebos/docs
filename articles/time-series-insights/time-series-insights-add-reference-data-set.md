...
参考数据不以追溯方式进行联接。 因此，只有当前和将来的入口数据是匹配并联接到参考数据集，一旦配置并上传。

## <a name="video"></a>视频

### <a name="learn-about-time-series-insights-reference-data-modelbr"></a>了解有关时间时序见解引用数据模型。</br>
