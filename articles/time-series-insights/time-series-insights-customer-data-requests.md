...
也可使用 REST API 对访问策略执行删除操作。 有关详细信息，请参阅 [Access Policies - Delete](/rest/api/time-series-insights/management/accesspolicies/delete)（访问策略 - 删除）。
...
也可使用提供的 REST API 中的“按环境列出”操作对访问策略执行导出操作。 有关详细信息，请参阅 [Access Policies - List By Environment](/rest/api/time-series-insights/management/accesspolicies/listbyenvironment)（访问策略 - 按环境列出）。
