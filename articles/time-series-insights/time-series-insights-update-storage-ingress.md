...
Azure 时序见解支持通过 Azure IoT 中心或 Azure 事件中心提交的 JSON。 若要优化 IoT JSON 数据，请了解[如何塑造 JSON](./time-series-insights-send-events.md#supported-json-shapes)。
