...
1. 转到“时序模型”选择器面板，并从菜单中选择“实例”****。 随即将显示与所选时序见解环境关联的所有实例。
    ...
    [![通过首次选择实例创建单个实例。](media/v2-update-how-to-tsm/how-to-tsm-instances-panel.png)](media/v2-update-how-to-tsm/how-to-tsm-instances-panel.png#lightbox)

1. 选择“+ 添加”****。

    [![通过选择 " 添加"按钮添加实例。](media/v2-update-how-to-tsm/how-to-tsm-add-instance.png)](media/v2-update-how-to-tsm/how-to-tsm-add-instance.png#lightbox)
...
1. 选择包含实例有效负载的文件。
    ...
    [![通过 JSON 批量上载实例。](media/v2-update-how-to-tsm/how-to-tsm-bulk-upload-instances.png)](media/v2-update-how-to-tsm/how-to-tsm-bulk-upload-instances.png#lightbox)
...
1. 选择 **"上传**"。
    ...
    [![批量上载层次结构的选择。](media/v2-update-how-to-tsm/how-to-tsm-bulk-upload-hierarchies.png)](media/v2-update-how-to-tsm/how-to-tsm-bulk-upload-hierarchies.png#lightbox)
...
1. 进行所需的更改，然后选择“保存”。****
    ...
    [![用于编辑单个层次结构的选择。](media/v2-update-how-to-tsm/how-to-tsm-edit-hierarchy.png)](media/v2-update-how-to-tsm/how-to-tsm-edit-hierarchy.png#lightbox)
...
1. 转到“时序模型”选择器面板，并从菜单中选择“类型”****。 随即将显示与所选时序见解环境关联的所有类型。
    ...
    [![时间序列模型类型窗格。](media/v2-update-how-to-tsm/how-to-tsm-type-panel.png)](media/v2-update-how-to-tsm/how-to-tsm-type-panel.png#lightbox)

1. 选择“+ 添加”以显示“添加新类型”弹出模型。********
1. 输入类型的属性和变量。 输入后，选择“保存”****。 

    [![要添加类型的配置设置。](media/v2-update-how-to-tsm/how-to-tsm-add-new-type.png)](media/v2-update-how-to-tsm/how-to-tsm-add-new-type.png#lightbox)
...
1. 选择 **"上传**"。
    ...
    [![批量类型上载选项。](media/v2-update-how-to-tsm/how-to-tsm-bulk-upload-types-json.png)](media/v2-update-how-to-tsm/how-to-tsm-bulk-upload-types-json.png#lightbox)
...
1. 选择该实例，然后选择“删除”或“垃圾桶图标”********。 .
   ...
   [![通过选择"删除"删除类型。](media/v2-update-how-to-tsm/how-to-tsm-delete-type.png)](media/v2-update-how-to-tsm/how-to-tsm-delete-type.png#lightbox)
...
- 要了解支持的 JSON 形状，请阅读[支持的 JSON 形状](./time-series-insights-send-events.md#supported-json-shapes)。
