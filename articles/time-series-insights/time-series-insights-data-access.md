...
1. 在“选择用户角色”页中，选择“确定”********。
    ...
    [![选择 "选择用户角色" 页上的 "确定"](media/data-access/data-access-confirm-user-and-role.png)](media/data-access/data-access-confirm-user-and-role.png#lightbox)
...
1. 输入要邀请的用户的电子邮件地址。 此电子邮件地址必须与 Azure AD 关联。 你可以根据情况在邀请中包括个人消息。
    ...
    [![输入用于查找所选用户的电子邮件地址](media/data-access/data-access-invite-guest-by-email.png)](media/data-access/data-access-invite-guest-by-email.png#lightbox)
...
1. 选择 "**开始**" 后，会向来宾用户显示一个与管理员的组织关联的 "权限" 框。 通过选择“接受”授予权限后，来宾用户就会登录。****
...
1. 在时序资源管理器的右上角选择其配置文件图标后，将向来宾用户显示管理员的租户。
    ...
    [![Insights.azure.com 上的头像选择](media/data-access/data-access-select-tenant-and-instance.png)](media/data-access/data-access-select-tenant-and-instance.png#lightbox)
...
* 向[事件源发送事件](./time-series-insights-send-events.md)。
