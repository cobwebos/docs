...
- Azure PowerShell 1.0。有关此版本及其安装方法的信息，请参阅 [How to install and configure Azure PowerShell（如何安装和配置 Azure PowerShell）](/documentation/articles/powershell-install-configure)。
...
>[AZURE.NOTE] Resource Manager 模块要求使用 Add-AzureRmAccount。一个发布设置文件是不够的。
