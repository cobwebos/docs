...
键入 `docker-machine create --driver azure` 查看选项及其默认值；也可以参阅 [Docker Azure 驱动程序文档](https://docs.docker.com/machine/drivers/azure/)。 （请注意，如果启用了双重身份验证，系统将提示你使用第二个因素进行身份验证）。
