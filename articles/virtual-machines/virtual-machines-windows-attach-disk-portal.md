...
1. 连接到虚拟机。有关说明，请参阅 [How to connect and log on to an Azure virtual machine running Windows Server](/documentation/articles/virtual-machines-windows-connect-logon)（如何连接并登录到运行 Windows Server 的 Azure 虚拟机）。
