...
- [Dav4 和 Dasv4 系列](dav4-dasv4-series.md)在多线程配置中利用 AMD 的 2.35 Ghz EPYC<sup>TM</sup> 7452 处理器实现了新的大小，具有256多线程配置，每 8 mb 三级缓存专用于 8 mb 三级缓存，增加了运行其常规用途工作负载的客户选项。 Dav4 系列和 Dasv4 具有与 D & Dsv3 系列相同的内存和磁盘配置。
...
- [Dv2 和 Dsv2 系列](dv2-dsv2-series.md)Vm 是原始 D 系列的跟进，它具有更强大的 CPU 和最佳 CPU 到内存配置，使其适用于大多数生产工作负荷。 Dv2 系列比 D 系列快大约 35%。 Dv2 系列在 Intel® Xeon® 8171M 2.1GHz (Skylake)、Intel® Xeon® E5-2673 v4 2.3 GHz (Broadwell) 或 Intel® Xeon® E5-2673 v3 2.4 GHz (Haswell) 处理器上运行，并采用 Intel Turbo Boost Technology 2.0。 Dv2 系列的内存和磁盘配置与 D 系列相同。
