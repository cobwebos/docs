...
有关 NSG、入站和出站规则的详细信息，请参阅 [Allow external access to your VM using the Azure portal](virtual-machines-windows-nsg-quickstart-portal.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)（使用 Azure 门户对 VM 实现外部访问）。
...
* 还可以体验[将数据磁盘附加到](virtual-machines-windows-attach-disk-portal.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)虚拟机。 数据磁盘可为虚拟机提供更多存储空间。
