---
title: "使用 SCP 将文件移到 Linux VM 和从 Linux VM 移动文件 | Microsoft 文档"
...
有关配置 `~/.ssh/config` 以及 SSH 公钥和私钥的详细信息，请按照此文（[创建 SSH 密钥](virtual-machines-linux-mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)）进行操作。
