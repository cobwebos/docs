...
对于 Azure 中 HPC Pack 群集的生产部署，我们建议采用自动部署方法，如 [HPC Pack IaaS 部署脚本](virtual-machines-hpcpack-cluster-powershell-script.md)或者 Azure 资源管理器[快速入门模板](https://azure.microsoft.com/documentation/templates/)。
