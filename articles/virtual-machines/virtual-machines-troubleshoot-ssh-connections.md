<properties
	pageTitle="对与基于 Linux 的 VM 的安全外壳 (SSH) 连接进行故障排除 | Microsoft Azure"
...
若要向全世界的 Azure 专家寻求帮助，你可以将问题提交到 MSDN Azure 论坛或 CSDN 论坛。有关详细信息，请参阅 [Microsoft Azure 论坛](http://www.windowsazure.cn/support/forums/)。
