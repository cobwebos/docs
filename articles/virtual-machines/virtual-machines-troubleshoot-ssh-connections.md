<properties
	pageTitle="对 Azure VM 的 SSH 连接进行故障排除 | Microsoft Azure"
...
1. 从 [Azure 门户](https://manage.windowsazure.cn)**重置远程访问**。单击“浏览全部”>“虚拟机(经典)”> 你的 Windows 虚拟机 >“重置远程访问”。
	...
	![显示重置 SSH 配置的屏幕截图](./media/virtual-machines-troubleshoot-ssh-connections/Portal-SSH-Reset-Windows.png)

2. **重新启动**虚拟机。在 [Azure 门户](https://manage.windowsazure.cn)中，单击“浏览全部”>“虚拟机(经典)”> 你的 Windows 虚拟机 >“重新启动”。在 [Azure 管理门户](https://manage.windowsazure.cn)中，打开“虚拟机”>“实例”，然后单击“重新启动”。
...
5. 检查 VM 的资源运行状况以了解是否有任何平台问题。
	单击“浏览全部”>“虚拟机(经典)”> 你的 Linux 虚拟机 >“检查运行状况”
...
1. 使用 Azure CLI 或 Azure PowerShell，在命令行上为 Linux VM **重置 SSH 连接**。确保已安装 [Microsoft Azure Linux 代理](/documentation/articles/virtual-machines-linux-agent-user-guide)版本 2.0.5 或更高版本。
...
2. 从门户**重新启动** Linux VM。在 [Azure 门户](https://manage.windowsazure.cn)中，单击“浏览全部”>“虚拟机”> 你的 Windows 虚拟机 >“重新启动”。

	![显示重新启动 V2 虚拟机的屏幕截图](./media/virtual-machines-troubleshoot-ssh-connections/Portal-SSH-Restart-V2-Windows.png)
