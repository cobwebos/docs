...
如果你对本文中的任何点需要更多帮助，可以联系 [MSDN Azure 和堆栈溢出论坛](/support/forums/)上的 Azure 专家。或者，你也可以提出 Azure 支持事件。请转到 [Azure 支持站点](/support/contact/)并单击“获取支持”。有关使用 Azure 支持的信息，请阅读 [Microsoft Azure 支持常见问题](/support/faq/)。
...
- 如果使用第三方应用程序来管理远程桌面连接，而不是使用任何 Azure 管理门户，请验证应用程序配置是否包括远程桌面通信的正确 TCP 端口。可以通过在 [Azure 管理门户](portal.azure.com)中单击 VM 的“设置”>“终结点”来检查经典虚拟机的此端口。
