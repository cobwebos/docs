...
> [AZURE.SELECTOR]
- [资源管理器](/documentation/articles/virtual-machines-sql-server-azure-key-vault-integration-resource-manager)
- [经典](/documentation/articles/virtual-machines-sql-server-azure-key-vault-integration)
...
|**$rgName**|**资源组名称**：与 SQL VM 关联的资源组名称。|“myrgname”|
