...
有关详细信息，请参阅 [Azure 诊断故障排除](../monitoring-and-diagnostics/azure-diagnostics-troubleshooting.md)。

## <a name="next-steps"></a>后续步骤
若要更改你收集的数据、排查问题或者了解有关诊断的一般信息，请参阅[与虚拟机相关的 Azure 诊断文章列表](../monitoring-and-diagnostics/azure-diagnostics.md#virtual-machines-using-azure-diagnostics)。
