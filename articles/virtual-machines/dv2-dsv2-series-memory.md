...
Dv2 和 Dsv2 系列是原始 D 系列系列的后续功能，具有更强大的 CPU 功能。 DSv2 系列大小在 Intel® Xeon® 8171M 2.1 GHz (Skylake) 或 Intel® Xeon® E5-2673 v4 2.3 GHz (Broadwell) 或 Intel® Xeon® E5-2673 v3 2.4 GHz (Haswell) 处理器上运行。 Dv2 系列的内存和磁盘配置与 D 系列相同。

## <a name="dv2-series-11-15"></a>Dv2 系列 11-15

Dv2 系列尺寸在英特尔® Xeon ® 8171M 2.1 GHz（天湖）或英特尔® Xeon ® E5-2673 v4 2.3 GHz（Broadwell）或英特尔® Xeon ® E5-2673 v3 2.4 GHz（哈斯韦尔）处理器上运行。
...
<sup>2</sup>实例与基于英特尔哈斯韦尔的硬件隔离，专用于单个客户。  
