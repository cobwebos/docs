...
---
# <a name="sap-netweaver-on-azure-linux-virtual-machines-vms--planning-and-implementation-guide"></a>Azure Linux 虚拟机 (VM) 上的 SAP NetWeaver - 规划和实施指南
...
可在[此文][virtual-machines-linux-capture-image-resource-manager]中找到有关从虚拟机创建映像的详细信息。
