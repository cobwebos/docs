...
```
chrisL@fedora$ ssh ops@testsubdomain.westeurope.chinacloudapp.cn           
The authenticity of host 'testsubdomain.westeurope.chinacloudapp.cn (XX.XXX.XX.XXX)' can't be established.
RSA key fingerprint is b6:a4:7g:4b:cb:cd:76:87:63:2d:84:83:ac:12:2d:cd.
Are you sure you want to continue connecting (yes/no)? yes
Warning: Permanently added 'testsubdomain.westeurope.chinacloudapp.cn,XX.XXX.XX.XXX' (RSA) to the list of known hosts.
