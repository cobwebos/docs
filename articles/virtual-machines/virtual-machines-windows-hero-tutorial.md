<properties
	pageTitle="创建你的第一个 Windows VM | Microsoft Azure"
...
3. 在“**Windows Server 2012 R2 Datacenter**”边栏选项卡上，确保在“**选择部署模型**”下选择“**资源管理器**”。单击“创建”。
...
3. 选择现有的[资源组](../resource-group-overview.md#resource-groups)，或键入新资源组的名称。键入 Azure 数据中心的**位置**，如**美国西部**。

4. 完成后，单击“**确定**”转到下一部分。

	![显示“**基本信息**”边栏选项卡上用于配置 Azure VM 设置的屏幕截图](./media/virtual-machines-windows-hero-tutorial/basics-blade.png)
...
7. 单击“摘要”以查看你的选择。当看到“**验证已通过**”消息时，单击“**确定**”。
...
6.	你将收到无法验证证书的警告。这是一般警报。单击“是”以验证虚拟机的 ID 并完成登录。
...
如果你并未真正在使用 VM，最好将它停止，以免产生费用。只需单击“**停止**”，然后单击“**是**”。
...
- 你也可以[使用 Powershell 创建 Windows VM](virtual-machines-windows-ps-create.md) 或[使用 Azure CLI 创建 Linux 虚拟机](virtual-machines-linux-quick-create-cli.md)。
