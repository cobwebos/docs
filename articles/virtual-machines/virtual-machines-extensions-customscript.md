...
## 自定义脚本扩展方案：
 ...
 ### 将文件上载到默认容器：如果你的脚本位于你的订阅的默认帐户的存储容器中，则下面的 cmdlet 代码片段展示了如何在 VM 上运行它们。下面的示例中的 ContainerName 是你将脚本上载到的位置。可以使用 cmdlet“Get-AzureSubscription –Default”验证默认存储帐户。
...
### 从门户中添加自定义脚本扩展。
在 <a href="https://management.windowsazure.cn/ " target="_blank">Azure 门户</a>中浏览找到虚拟机，并通过指定要运行的脚本文件添加扩展。![][5]
