...
Azure 库或应用商店中的 Linux 映像由很多合作伙伴提供，并且我们正在与各个 Linux 社区合作，以便向“认可的分发版”列表添加更多风格。 在此期间，对于该库未提供的分发版，始终可以按照[此页](linux/classic/create-upload-vhd.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json)中的指南自备 Linux。
