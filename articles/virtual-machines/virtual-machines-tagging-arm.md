...
通过 Azure 资源管理器放置在计算、网络和存储资源中的标记将在[计费门户](https://account.windowsazure.cn/)中的使用情况详细信息中填充。
...
[将 PowerShell 环境用于 Azure 资源管理器]: ../powershell-azure-resource-manager.md
...
[Azure 资源管理器概述]: ../resource-group-overview.md
