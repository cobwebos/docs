...
你可以使用 Azure PowerShell 从[专用化和通用化](https://docs.microsoft.com/azure/virtual-machines/windows/shared-image-galleries#generalized-and-specialized-images) VM 捕获映像。 
