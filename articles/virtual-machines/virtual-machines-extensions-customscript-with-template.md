...
[AZURE.INCLUDE [了解部署模型](../includes/learn-about-deployment-models-rm-include.md)] [经典部署模型](/documentation/articles/virtual-machines-extensions-customscript)。
...
- [使用 Azure CLI 部署模板](/documentation/articles/virtual-machines-deploy-rmtemplates-azure-cli)
- [使用 Azure Powershell 部署模板](/documentation/articles/virtual-machines-deploy-rmtemplates-powershell)

### 先决条件

1. 从[此处](/downloads)安装最新的 Azure PowerShell Cmdlet 或 Azure CLI。
2. 如果脚本将在现有 VM 上运行，请确保已在该 VM 上启用了 VM 代理，如果没有启用，请根据[此文](/documentation/articles/virtual-machines-extensions-install)来安装一个。
