...
3.	打开 parameters.json 文件，然后添加以下 JSON 内容：
    ...
    >[AZURE.NOTE]映像库中的映像 vhd 名称经常发生变化，因此你需要获取当前映像名称以部署虚拟机。为此，请参阅[关于虚拟机的映像](https://msdn.microsoft.com/zh-cn/library/azure/dn790330.aspx)，然后用你要使用的 vhd 文件的名称代替 {source-image-name}。例如“a699494373c04fc0bc8f2bb1389d6106\_\_Windows-Server-2012-R2-201412.01-en.us-127GB.vhd”。将 {subscription-id} 替换为订阅的标识符。
