...
> [AZURE.NOTE]你必须已经有一个运行 Linux 的 Microsoft Azure 虚拟机，才能完成本教程。在继续操作前，请参阅 [Azure Linux VM 教程](virtual-machines-linux-tutorial.md)创建并设置一个 Linux VM，其中 `mysqlnode` 为 VM 名称，`azureuser` 为用户。
