...
[AZURE.INCLUDE [了解部署模型](../includes/learn-about-deployment-models-include.md)]本文介绍如何使用经典部署模型创建 Windows VM。你还可以使用[资源管理器部署模型](virtual-machines-deploy-rmtemplates-powershell.md)创建 Windows VM。
