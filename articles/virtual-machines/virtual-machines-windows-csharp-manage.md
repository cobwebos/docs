...
创建应用程序并安装库后，请使用应用程序信息创建令牌。 此令牌用于对发往 Azure Resource Manager 的请求进行身份验证。
...
2. 将变量添加到 Program 类的 Main 方法，指定资源组的名称、虚拟机的名称以及订阅标识符：
...
## <a name="resize-a-virtual-machine"></a>调整虚拟机的大小
本示例演示如何更改运行中虚拟机的大小。
