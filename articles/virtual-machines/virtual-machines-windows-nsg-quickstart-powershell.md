...
## 快速命令
若要创建网络安全组和 ACL 规则，你需要 [ 安装最新版本的 Azure PowerShell](/documentation/articles/powershell-install-configure)。你也可以 [ 使用 Azure 门户执行这些步骤](/documentation/articles/virtual-machines-windows-nsg-quickstart-portal)。
