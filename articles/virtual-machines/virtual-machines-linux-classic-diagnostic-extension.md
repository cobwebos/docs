...
若要直接从 Azure 门户查看和配置系统与性能数据，请执行 [Azure 博客上的以下步骤](https://azure.microsoft.com/blog/2014/09/02/windows-azure-virtual-machine-monitoring-with-wad-extension/“Windows 博客 URL”/)。
