...
通用 VM 已使用 [Sysprep](virtual-machines-windows-generalize-vhd.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) 删除所有个人帐户信息。 若要创建通用 VM，可在本地 VM 上运行 Sysprep，然后[将 VHD 上传到 Azure](virtual-machines-windows-upload-image.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)；或者在现有 Azure VM 上运行 Sysprep，然后[捕获 VM 的映像](virtual-machines-windows-capture-image-resource.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)。



## <a name="prerequisites"></a>先决条件

必须已[创建托管 VM 映像](virtual-machines-windows-capture-image-resource.md)以用于创建新 VM。 
