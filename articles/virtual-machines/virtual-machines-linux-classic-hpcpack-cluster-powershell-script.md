...
<!-- should be deleted -->
* 你还可以使用 Azure 资源管理器模板来部署 HPC Pack 群集。有关示例，请参阅 [Create an HPC cluster with Linux compute nodes（使用 Linux 计算节点创建 HPC 群集）](https://azure.microsoft.com/documentation/templates/create-hpc-cluster-linux-cn/)。
<!-- should be deleted -->
