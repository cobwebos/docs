---
title: "模拟的混合云测试环境 | Microsoft Docs"
...
---
# <a name="set-up-a-simulated-hybrid-cloud-environment-for-testing"></a>设置用于测试的模拟混合云环境
本文逐步说明如何使用两个 Azure 虚拟网络在 Microsoft Azure 上创建模拟混合云环境。 这是生成的配置。
...
此配置需要 Azure 订阅。 如果有 MSDN 或 Visual Studio 订阅，请参阅 [Visual Studio 订户的每月 Azure 信用额度](https://azure.microsoft.com/pricing/member-offers/msdn-benefits-details/)。
...
## <a name="phase-1-configure-the-testlab-virtual-network"></a>阶段 1：配置 TestLab 虚拟网络
按照 [Base Configuration test environment](https://technet.microsoft.com/library/mt771177.aspx)（基本配置测试环境）主题中的说明，在名为 TestLab 的 Azure 虚拟网络中配置 DC1、APP1 和 CLIENT1 计算机。 
...
## <a name="phase-2-create-the-testvnet-virtual-network"></a>阶段 2：创建 TestVNET 虚拟网络
...
## <a name="phase-3-create-the-vnet-to-vnet-connection"></a>阶段 3：创建 VNet 到 VNet 连接
...
## <a name="phase-4-configure-dc2"></a>阶段 4：配置 DC2
...
* 在此环境中设置[基于 Web 的业务线应用程序](virtual-machines-windows-ps-hybrid-cloud-test-env-lob.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)。
