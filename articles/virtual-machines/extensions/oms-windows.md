---
title: 适用于 Windows 的 Azure Monitor 虚拟机扩展 |Microsoft Docs
...
| 10.20.18001 | 1.0.18001 | 2019 年 7 月 | <ul><li> 次要 bug 修复和稳定性改进 </li><li> 添加了在建立代理连接时禁用默认凭据的功能 (对 WINHTTP_AUTOLOGON_SECURITY_LEVEL_HIGH 的支持) </li></ul>|
