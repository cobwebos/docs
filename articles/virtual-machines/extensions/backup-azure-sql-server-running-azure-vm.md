...
description: 本文介绍如何在 Azure 虚拟机中运行 SQL Server 中注册 Azure 备份。
services: backup
author: dcurwin
manager: carmonm
ms.service: backup
...
ms.locfileid: "73748959"
---
# <a name="azure-backup-for-sql-server-running-in-azure-vm"></a>Azure 备份，适用于在 Azure VM 中运行的 SQL Server

Azure 备份在其他产品中，提供对备份工作负荷（例如 SQL Server 在 Azure Vm 中运行的工作负荷）的支持。 由于 SQL 应用程序在 Azure VM 中运行，因此备份服务需要访问应用程序和提取必要详细信息的权限。
