...
在[Azure 快速入门库中](https://github.com/Azure/azure-quickstart-templates/tree/master/chef-json-parameters-linux-vm)可以找到包含 Chef VM 扩展的示例资源管理器模板。
...
> [!NOTE]
> 有关与厨师直接相关的任何其他内容，请联系[厨师支持](https://www.chef.io/support/)。
