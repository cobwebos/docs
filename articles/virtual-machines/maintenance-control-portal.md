...
维护控制允许您决定何时将更新应用于隔离的 Vm 和 Azure 专用主机。 本主题介绍用于维护控制的 Azure 门户选项。 有关使用维护控制、其限制和其他管理选项的好处的详细信息，请参阅[使用维护控制管理平台更新](maintenance-control.md)。
...
![显示如何检查主机维护的屏幕截图](media/virtual-machines-maintenance-control-portal/maintenance-configurations-pending-vm.png)
...
![显示如何检查主机维护的屏幕截图](media/virtual-machines-maintenance-control-portal/maintenance-configurations-delete.png)
