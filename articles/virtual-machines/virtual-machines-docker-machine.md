...
## 后续步骤
转到 [Docker 用户指南](https://docs.docker.com/userguide/)并在 Microsoft Azure 上创建一些应用程序。或者，在 Azure 上玩 [**docker** 和 swarm](https://github.com/docker/swarm)](/documentation/articles/virtual-machines-docker-swarm)，并了解如何将 swarm 用于 docker 和 Azure。
