<properties pageTitle="三服务器 SharePoint 场资源管理器模板" description="逐步完成三服务器 SharePoint 场的 Azure 资源管理器模板结构。" services="virtual-machines" documentationCenter="" authors="JoeDavies-MSFT" manager="timlt" editor=""/>
