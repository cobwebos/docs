...
有关预配的详细演练，请参阅[《Provision a SQL Server virtual machine in the Azure Portal》（在 Azure 门户中预配 SQL Server 虚拟机）](/documentation/articles/virtual-machines-windows-portal-sql-server-provision/)。
