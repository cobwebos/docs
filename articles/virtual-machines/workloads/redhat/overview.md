...
与第 1 代 VM 相比，第 2 代 VM 提供了许多较新的功能。 [第 2 代文档](https://docs.microsoft.com/azure/virtual-machines/linux/generation-2)中将详细介绍。 RHEL 映像透视图的主要区别在于，第 2 代 VM 使用 UEFI 而非 BIOS 固件接口，并且在引导时使用 GUID 分区表 (GPT) 而非主引导记录 (MBR)。 这将允许 OS 磁盘大小超过 2TB，并允许更多事项。 此外，[Mv2 系列 VM](../../mv2-series.md) 仅在第 2 代映像上运行。
