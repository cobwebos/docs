...
SR-IOV 上手动配置 InfiniBand 启用的 Vm （当前 HB 和 HC 系列），请执行以下步骤。 这些步骤仅适用于 RHEL/CentOS。 对于 Ubuntu （16.04 和 18.04） 和 SLES （12 SP4 和 15），收件箱驱动程序能正常工作。
