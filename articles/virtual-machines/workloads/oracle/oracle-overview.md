...
本文介绍如何使用 Azure 基础结构运行 Oracle 解决方案。 另请参阅 Azure Marketplace 中可用[ORACLE VM 映像](oracle-vm-solutions.md)的详细介绍，以及将[Azure 与 Oracle 云基础结构进行互连的功能（OCI）](oracle-oci-overview.md)。
...
* 与 Unbreakable Enterprise 内核（UEK）6.8、6.9、6.10、7.3、7.4、7.5 和 7.6 Oracle Linux 
...
## <a name="integration-of-azure-with-oci"></a>Azure 与 OCI 的集成
...
使用 Terraform 模板设置 Azure 基础结构和安装 Oracle 应用程序。 
...
* 查看来自 Ignite 2019 的[Oracle On Azure 概述会话](https://myignite.techcommunity.microsoft.com/sessions/82915)。 
