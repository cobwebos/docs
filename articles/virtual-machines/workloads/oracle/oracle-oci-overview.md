...
跨云连接仅限于以下区域：
* Azure 美国东部（eastus） & OCI 阿什本（美国东部）
* Azure 英国南部（uksouth） & OCI 伦敦（英国南部）
* Azure 加拿大中部（canadacentral） & OCI 多伦多（加拿大东南部）
* Azure 西欧（westeurope） & OCI 阿姆斯特丹（荷兰西北部）
