...
6.  订阅的 Azure 订阅数和核心配额。 根据需要[打开支持请求以增加 Azure 订阅配额](https://docs.microsoft.com/azure/azure-portal/supportability/resource-manager-core-quotas-request)。
   ...
   5. 超时设置。
    ...
    6. OS 设置或修补程序
        - 若要在 SAP 上运行 HANA，请阅读以下说明和文档：
            ...
            -   [SAP 支持说明 # https://launchpad.support.sap.com/#/notes/0002455582)(https://launchpad.support.sap.com/#/notes/0002455582)
