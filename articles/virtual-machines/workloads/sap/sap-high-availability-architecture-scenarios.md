...
* **使用群集共享磁盘群集化 SAP ASCS/scs 实例**：有关此体系结构的详细信息，请参阅[使用群集共享磁盘在 Windows 故障转移群集上群集化 SAP ASCS/scs 实例][sap-high-availability-guide-wsfc-shared-disk]。   
