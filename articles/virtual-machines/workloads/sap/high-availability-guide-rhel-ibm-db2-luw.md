...
若要部署 IBM Db2 配置, 需执行以下步骤:
  ...
  + 安装和配置 Pacemaker。
  + 设置[glusterfs 群集][glusterfs] or [Azure NetApp Files][anf-rhel]
...
完整的资源列表:
 ...
 rsc_st_azure (stonith: fence_azure_arm):    已启动 az-idb01 Master/从属集:Db2_HADR_ID2 [Db2_HADR_ID2] master: [az-idb01] 从属服务器: [az-idb02] 资源组: g_ipnc_db2id2_ID2 vip_db2id2_ID2 (ocf:: 检测信号: IPaddr2):     已启动 az-idb01 nc_db2id2_ID2 (ocf:: 检测信号: azure-lb):    已启动 az-idb01
...
所有测试用例的初始状态如下所示: (crm_mon 或 pc 状态)
