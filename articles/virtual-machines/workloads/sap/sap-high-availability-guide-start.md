...
* 以下操作系统上的 SAP 高可用性：
  ...
  * 使用**Linux 群集框架**![Linux][Logo_Linux] **linux**
...
本文介绍 ![Windows][Logo_Windows] **windows**和 ![Linux][Logo_Linux] **linux**。
...
* ![Windows][Logo_Windows] 为 sap [ASCS/SCS 实例使用 windows 故障转移群集和**共享磁盘**准备 sap 高可用性的 Azure 基础结构][sap-high-availability-infrastructure-wsfc-shared-disk]

* ![Windows][Logo_Windows][为 SAP ASCS/SCS 实例使用 windows 故障转移群集和**文件共享**准备 sap 高可用性的 Azure 基础结构][sap-high-availability-infrastructure-wsfc-file-share]

* ![Linux][Logo_Linux][为 SAP ASCS/SCS 实例使用 SUSE Linux Enterprise Server 群集框架准备 sap 高可用性的 Azure 基础结构][sap-suse-ascs-ha-setting-ha-nfs]

* ![Linux][Logo_Linux][使用 Azure NetApp 文件的 SAP ASCS/SCS 实例的 SUSE Linux Enterprise Server 群集框架为 sap 高可用性准备 Azure 基础结构][sap-suse-ascs-ha-setting-ha-anf]
...
* ![Linux][Logo_Linux][使用 Azure NetApp 文件的 SAP ASCS/SCS 实例的 SUSE Linux Enterprise Server 群集框架安装 Sap NetWeaver 高可用性][sap-suse-ascs-ha-sap-installation-anf]
