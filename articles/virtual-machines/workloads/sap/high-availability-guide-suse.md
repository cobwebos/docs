...
在示例配置中，安装命令等。使用 ASCS 实例编号00、ERS 实例编号02和 SAP 系统 ID NW1。 示例中的资源名称（例如虚拟机、虚拟网络）假设你已将[聚合模板][template-converged]与 SAP 系统 ID NW1 一起使用来创建资源。
