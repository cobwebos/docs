...
Linux 提供多种不同的 I/O 计划模式。 通过 Linux 供应商和 SAP 的常见建议是重新配置磁盘卷的 I/O 调度程序模式，从**cfq**模式到**noop（** 非多队列）或**无**（多队列）模式。 详细信息在[SAP 说明#1984787](https://launchpad.support.sap.com/#/notes/1984787)中引用。 
