...
3. [创建出站规则](../../../load-balancer/configure-load-balancer-outbound-cli.md#create-outbound-rule)。 暂无法在 Azure 门户中创建出站规则。 可以使用 [Azure CLI](../../../cloud-shell/overview.md?view=azure-cli-latest) 创建出站规则。  
