...
本文介绍如何使用适用于 SAP 应用程序的 SUSE Linux Enterprise Server 在 Azure Vm 的两个节点群集中部署多个 SAP NetWeaver 高度可用系统（即多 SID）。  
...
8. **[1]** 创建新安装的 sap 系统的 sap 群集资源。 
   ...
   此处显示的示例适用于 SAP 系统**NW2**和**NW3**，假设它使用的是队列服务器1体系结构（ENSA1）：
