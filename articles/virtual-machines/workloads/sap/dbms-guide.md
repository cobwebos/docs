...
---
# <a name="sap-netweaver-on-azure-virtual-machines--dbms-deployment-guide"></a>Azure 虚拟机上的 SAP NetWeaver — DBMS 部署指南
...
* 第三方工具 有关 Azure 上备份和 SAP 的更完整的讨论，请参阅 [SAP 备份指南](sap-hana-backup-guide.md)了解详细信息。
...
此外，也可以按本文档的[软件 RAID][dbms-guide-2.2] 一章中所述，使用 LVM（逻辑卷管理器）或 MDADM 基于已装载的多个 VHD 磁盘来创建一个大型逻辑设备。
