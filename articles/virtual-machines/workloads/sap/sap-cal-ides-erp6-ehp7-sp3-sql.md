---
title: "在 Microsoft Azure 上为 SAP ERP 6.0 部署 SAP IDES EHP7 SP3 | Microsoft Docs"
description: "在 Microsoft Azure 上为 SAP ERP 6.0 部署 SAP IDES EHP7 SP3"
...
本文介绍如何通过 SAP Cloud Appliance Library 3.0，在 Microsoft Azure 上部署运行 SQL Server 和 Windows OS 的 SAP IDES。 屏幕截图将逐步显示此过程。 部署列表中的其他解决方案在过程上是相同的， 只需选择不同的解决方案即可。
...
以下屏幕截图逐步显示如何在 Microsoft Azure 上部署 SAP IDES。 其他解决方案的部署过程相同。

![](./media/sap-cal-ides-erp6-ehp7-sp3-sql/ides-pic1.jpg)

第一张图显示 Microsoft Azure 上的所有可用解决方案。 本文选择了突出显示的、只可在 Azure 上使用的基于 Windows 的 SAP IDE 解决方案来演练部署过程。
...
[此处](https://caldocs.hana.ondemand.com/caldocs/help/Getting_Started_Guide_IDES607MSSQL.pdf)提供了 IDES 解决方案指南的链接。
