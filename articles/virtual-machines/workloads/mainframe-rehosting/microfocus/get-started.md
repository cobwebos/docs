...
description: 使用 Azure 虚拟机（Vm）上的微聚焦解决方案 Rehost IBM z/OS 大型机工作负荷。
author: njray
ms.author: sread
ms.date: 03/30/2020
ms.topic: article
...
在 Azure 上开始使用开发和测试环境是一种提高现代化工作量的好办法。 依赖于传统系统（如 IBM CICS （客户信息控制系统）和 IMS （信息管理系统））的大型机应用程序可在 Azure 上使用合作伙伴解决方案进行重新承载。
