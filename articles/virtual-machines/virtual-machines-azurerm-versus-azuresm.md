...
# Azure Resource Manager 中的 Azure 计算、网络和存储提供程序
...
## 将计算、网络和存储集成到 Azure Resource Manager 下的优点

借助 Azure 资源管理器，你可以轻松利用预建的应用程序模板或构建一个应用程序模板，在 Azure 上部署和管理计算、网络和存储资源。在本部分内容中，我们将了解通过 Azure Resource Manager 部署资源的优点。
...
Azure 门户将继续提供相关选项，使用户既能使用经典部署模型来部署虚拟机，同时又能使用 Resource Manager 部署模型来部署虚拟机。Azure 门户还将允许自定义模板部署。
