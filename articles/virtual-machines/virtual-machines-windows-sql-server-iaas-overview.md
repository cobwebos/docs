<properties
	pageTitle="Azure 虚拟机上的 SQL Server 概述 | Microsoft Azure"
...
>[AZURE.NOTE] 如果你已经熟悉 SQL Server，并且只是想了解如何部署 SQL Server VM，请参阅[在 Azure 门户中设置 SQL Server 虚拟机](virtual-machines-windows-portal-sql-server-provision.md)。
