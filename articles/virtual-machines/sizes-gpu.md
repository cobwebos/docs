...
description: 列出 Azure 中的虚拟机可用的不同 GPU 优化大小。 针对此系列中的大小列出了 vCPU、数据磁盘和 NIC 的数量，以及存储吞吐量和网络带宽。
...
- [NC 系列](nc-series.md)、 [NCv2 系列](ncv2-series.md)、 [NCv3 系列](ncv3-series.md)大小针对计算密集型和网络密集型应用程序和算法进行了优化。 一些示例包括 CUDA 和基于 OpenCL 的应用程序以及模拟、AI 和深度学习。 NCv3 系列专用于采用 NVIDIA Tesla V100 GPU 的高性能计算工作负载。 NC 系列使用 Intel 2690 v3 2.60 GHz v3 （Haswell）处理器，NCv2 系列和 NCv3 系列 Vm 使用 Intel 至强 E5-2690 v4 （Broadwell）处理器。
