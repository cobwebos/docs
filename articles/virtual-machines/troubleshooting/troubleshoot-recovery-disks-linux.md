...
title: 将 Linux 故障排除 VM 与 Azure CLI 配合使用 | Microsoft Docs description: 了解如何通过使用 Azure CLI 将 OS 磁盘连接到恢复 VM 来排查 Linux VM 问题 services: virtual-machines-linux documentationCenter: '' authors: genlin manager: jeconnoc editor: ''
...
若要执行这些故障排除步骤，需要安装最新的 [Azure CLI](/cli/azure/install-az-cli2)，并使用 [az login](/cli/azure/reference-index#az_login) 登录到 Azure 帐户。
