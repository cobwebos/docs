...
* 如果遇到错误**错误 15:找不到文件或未找到**初始 RAM 磁盘或**initrd/initramfs 文件**, 请按照以下步骤操作。
   ...
   * 如果缺少的文件是`/boot/grub/menu.lst`, 则此错误适用于较旧的操作系统版本 (**RHEL**1.x、 **Centos** 1.x 和**Ubuntu 14.04**), 因此这些命令可能会延迟。 你将需要启动旧服务器并进行测试, 以确保提供正确的命令。
