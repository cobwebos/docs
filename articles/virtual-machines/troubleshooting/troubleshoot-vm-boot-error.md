...
---
# <a name="linux-vm-boots-to-grub-rescue"></a>Linux VM 引导到格鲁布救援
...
* 如果出现“未知的文件系统”错误，则请注意，此错误可能是由于启动分区中的文件系统损坏，或者是由于内核配置不正确。****
   ...
   * 对于文件系统问题，请按照文章["Linux 恢复：由于文件系统错误（fsck，iode）"而无法 SSH 到 Linux VM 的步骤](https://blogs.msdn.microsoft.com/linuxonazure/2016/09/13/linux-recovery-cannot-ssh-to-linux-vm-due-to-file-system-errors-fsck-inodes/)。
   * 对于内核问题，请按照文章[《Linux 恢复：手动修复与内核问题相关的非引导问题](https://blogs.msdn.microsoft.com/linuxonazure/2016/10/09/linux-recovery-manually-fixing-non-boot-issues-related-to-kernel-problems/)》或["Linux 恢复：使用 chroot 修复与内核问题相关的非引导问题](https://blogs.msdn.microsoft.com/linuxonazure/2016/10/09/linux-recovery-fixing-non-boot-issues-related-to-kernel-problems-using-chroot/)"中的步骤。
   
### <a name="error---file-not-found"></a>错误 - 找不到文件

* 如果您收到**错误错误 15：找不到文件或未找到初始 RAM 磁盘**或**未找到 initrd/initramfs 文件**，请按照以下步骤操作。
