---
title: 排查 Azure 中 Windows VM 的 RDP 问题 | Microsoft Docs
...
本部分将介绍创建 RDP 以连接到 VM 时可能遇到的以下问题：
...
- [排除特定错误](troubleshoot-specific-rdp-errors.md)
- [排查“无许可证服务器”错误](troubleshoot-rdp-no-license-server.md)
