...
- 日志
  ...
  - /var/log/waagent.log
  - /var/log/azure/[extension folder]/\*日志\*
...
在**PerformanceDiagnostics 中\_yyyy-mm-dd\_hh-mm-ss-fff.zip gz**文件中，可以找到一个 HTML 报告，其中详细说明了 PerfInsights 的调查结果。 若要查看报表，请展开 " **PerformanceDiagnostics"\_yyyy-mm-dd\_hh-mm-ss-fff.zip gz**文件，然后打开**PerfInsights report .html**文件。
...
登录后，你将看到一个对话框，用于上传 PerfInsights 收集的**PerformanceDiagnostics\_yyyy-mm-dd\_hh-mm-ss-fff.zip gz**文件。
