...
在**PerformanceDiagnostics\_yyyy-MM\_hh-mm-ss-fff.zip**文件中，可以找到一个 HTML 报告，其中详细说明了 PerfInsights 的调查结果。 若要查看报表，请展开 **"\_PerformanceDiagnostics"\_Hh-mm-ss-fff.zip**文件，然后打开**PerfInsights 报表 .html**文件。
