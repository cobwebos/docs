<properties
	pageTitle="在 Linux VM 上设置 Apache Tomcat | Microsoft Azure"
...
假定读者已拥有 Azure 订阅。如果没有，可以在 [http://azure.microsoft.com](http://azure.microsoft.com) 上注册免费试用版。如果你已有 MSDN 订阅，请参阅 [Microsoft Azure 特价：MSDN、MPN 和 Bizspark 优惠](http://azure.microsoft.com/pricing/member-offers/msdn-benefits/?c=14-39)。若要了解有关 Azure 的详细信息，请参阅[什么是 Azure？](http://azure.microsoft.com/overview/what-is-azure/)。
...
###步骤 2：在 Azure 预览门户中创建映像。
在 [Azure 预览门户](https://manage.windowsazure.cn)中，单击任务栏中的“新建”以创建映像，并根据你的需要选择 Linux 映像。以下示例使用 Ubuntu 14.04 映像。
![][3]
...
1.	在 Azure 预览门户中，单击“浏览”->“虚拟机”，然后单击你创建的虚拟机。  
![][5]
...
首先，从 Azure 预览门户获取你的虚拟机的 DNS 名称。依次单击**“浏览”**->**“虚拟机”**->你的虚拟机的名称->**“属性”**，然后查看**“属性”**磁贴的**“域名”**字段。
