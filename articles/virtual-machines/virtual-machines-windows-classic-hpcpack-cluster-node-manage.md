...
* **Azure VM 中的 HPC Pack 2012 R2 群集**：在经典部署模型中创建一个 HPC Pack 2012 R2 群集。 例如，可以通过使用 Azure 应用商店中的 HPC Pack 2012 R2 VM 映像和 Azure PowerShell 脚本，自动执行部署。 有关信息和先决条件，请参阅[使用 HPC Pack IaaS 部署脚本创建 HPC 群集](virtual-machines-windows-classic-hpcpack-cluster-powershell-script.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json)。
