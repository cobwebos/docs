...
从 SQL Server 2014 开始，此新功能[SQL Server Azure 中的数据文件](https://msdn.microsoft.com/library/dn385720.aspx)。 在 SQL Server 上运行 Azure 中的数据文件，与使用 Azure 数据磁盘时的性能特征相当。
