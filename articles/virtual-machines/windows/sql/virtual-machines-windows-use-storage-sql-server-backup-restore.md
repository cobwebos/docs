...
* **成本**：只需为所使用的服务付费。 可以作为经济合算的站点外备份存档方案。 有关详细信息，请参阅 [Azure 定价计算器](https://go.microsoft.com/fwlink/?LinkId=277060 "定价计算器")和 [Azure 定价文章](https://go.microsoft.com/fwlink/?LinkId=277059 "定价文章")。
...
| **Blob** |任意类型和大小的文件。 Blob 可通过以下 URL 格式寻址 **：https：//[存储帐户]blob.core.windows.net/[容器]/[blob]。** 有关页 Blob 的详细信息，请参阅[了解块和页 Blob](https://msdn.microsoft.com/library/azure/ee691964.aspx)。 |
...
> [!NOTE]
> SQL Server 2016 已更新以支持块 blob。 有关详细信息[，请参阅教程：将 Microsoft Azure Blob 存储服务与 SQL Server 2016 数据库一起使用](https://msdn.microsoft.com/library/dn466438.aspx)。
> 
> 
