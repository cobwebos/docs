...
- 用所需的 SQL Server**版本**设置媒体。 具有[软件保障](https://www.microsoft.com/licensing/licensing-programs/software-assurance-default)的客户可以从[批量许可中心](https://www.microsoft.com/Licensing/servicecenter/default.aspx)获得其安装媒体。 没有软件保障的客户可以使用具有所需版本的 Azure Marketplace SQL Server VM 映像（通常位于中`C:\SQLServerFull`）。 
