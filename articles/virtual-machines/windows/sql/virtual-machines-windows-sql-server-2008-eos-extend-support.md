...
- **SQL Server 备份**：使用 Azure 备份，通过15分钟 RPO 和时间点恢复，帮助保护你的 EOS SQL Server 2008 和 2008 R2 免受勒索软件、意外删除和损坏。 有关更多详细信息，请参阅[此文](https://docs.microsoft.com/azure/backup/sql-support-matrix#scenario-support)。
...
* [结束支持](/sql/sql-server/end-of-support/sql-server-end-of-life-overview) & [扩展安全更新](/sql/sql-server/end-of-support/sql-server-extended-security-updates)