...
- **SQL Server 备份**:使用 Azure 备份来保护您免受勒索软件、 意外删除和损坏的 EOS SQL 服务器。 解决方案目前处于预览状态 EOS SQL server 和 SQL Server 2008 和 2008 R2 支持在 Windows 2008 R2 SP1 上运行。 有关更多详细信息，请参阅此[文章](https://docs.microsoft.com/azure/backup/backup-azure-sql-database#support-for-sql-server-2008-and-sql-server-2008-r2)
