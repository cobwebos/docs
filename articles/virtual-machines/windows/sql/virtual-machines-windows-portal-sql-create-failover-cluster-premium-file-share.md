...
1. 在**测试选择**时，包含除**存储**和**存储空间直通**以外的所有测试。 参阅下图：
   ...
   :::image type="content" source="media/virtual-machines-windows-portal-sql-create-failover-cluster-premium-file-share/cluster-validation.png" alt-text="群集验证测试":::
