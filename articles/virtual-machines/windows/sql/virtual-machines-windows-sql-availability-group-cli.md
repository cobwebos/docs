...
- 在域中具有 "**创建计算机对象**" 权限的现有域用户帐户。 例如，域管理员帐户通常拥有足够的权限（例如： account@domain.com）。 __ 该帐户还应该属于每个 VM 上负责创建群集的本地管理员组。
...
* [配置 Always On 可用性组 &#40;SQL Server 的服务器实例&#41;](/sql/database-engine/availability-groups/windows/configuration-of-a-server-instance-for-always-on-availability-groups-sql-server)   
