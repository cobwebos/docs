...
The new virtual network has one subnet, named **Admin**. The domain controllers use this subnet. SQL Server VM 使用名为 SQL 的另一个子网。 配置此子网：
