...
本文提供有关使用较新的 Azure H 系列和较早的 A8、A9、A10 和 A11 实例（也称为*计算密集型*实例）的背景信息和一些注意事项。 本文重点介绍如何对 Windows VM 使用这些实例。 还可将其用于 [Linux VM](../linux/a8-a9-a10-a11-specs.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)。

有关基本规范、存储容量和磁盘详细信息，请参阅[虚拟机的大小](sizes.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)。
...
有关在 Windows Server 上配合使用计算密集型实例和 HPC Pack 的详细信息和清单，请参阅[使用 HPC Pack 设置一个用于运行 MPI 应用程序的 Windows RDMA 群集](classic/hpcpack-rdma-cluster.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json)。
...
* 有关 VM 存储容量和磁盘详细信息，请参阅 [Sizes for virtual machines](../linux/sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)（虚拟机大小）。
* 若要开始在 Windows 上通过 HPC Pack 部署和使用计算密集型实例，请参阅[使用 HPC Pack 设置一个用于运行 MPI 应用程序的 Windows RDMA 群集](classic/hpcpack-rdma-cluster.md?toc=%2fazure%2fvirtual-machines%2fwindows%2fclassic%2ftoc.json)。
