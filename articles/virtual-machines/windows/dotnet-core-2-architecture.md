---
title: "使用 Azure Resource Manager 模板部署 Windows 计算资源 | Microsoft Docs"
...
通过以下链接查看 Resource Manager 模板中的 JSON 示例 - [Azure SQL 数据库](https://github.com/Microsoft/dotnet-core-sample-templates/blob/master/dotnet-core-music-windows/azuredeploy.json#L379)。
