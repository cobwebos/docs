...
> [!NOTE]
> 根据 Microsoft 服务策略，Visual Studio 2015 最初发布的 (RTW) 版本已过期，无法提供服务。 Visual Studio 2015 Update 3 是为 Visual Studio 2015 产品线提供的唯一剩余版本。  此外，自 Visual Studio 2017 版本 15.9 发布起，我们已停用了 15.9 预览版中包含的“最新预览版”映像。
