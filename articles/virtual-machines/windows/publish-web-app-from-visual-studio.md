---
title: "通过 Visual Studio 将 Web 应用发布到 Azure VM | Microsoft Docs"
...
若要使用 Visual Studio Team Service 设置持续交付管道，请参阅[部署到 Windows 虚拟机](https://docs.microsoft.com/en-us/vsts/build-release/apps/cd/deploy-webdeploy-iis-deploygroups)。
