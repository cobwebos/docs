...
本文向你介绍如何通过 Azure 门户将新磁盘和现有磁盘附加到 Windows 虚拟机。 也可以[在 Azure 门户中将磁盘数据附加到 Linux VM](../linux/attach-disk-portal.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)。 在开始之前，请查看以下提示：
