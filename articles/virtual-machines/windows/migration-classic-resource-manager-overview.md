...
ms.locfileid: "86508672"
---
# <a name="platform-supported-migration-of-iaas-resources-from-classic-to-azure-resource-manager-in-windows"></a>平台支持的从经典部署模型到 Azure 资源管理器 Windows 中的 IaaS 资源迁移
