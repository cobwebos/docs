...
## <a name="set-up-an-azure-ad-app-and-service-principal"></a>设置 Azure AD 的应用程序和服务主体 
...
### <a name="set-key-vault-advanced-access-policies-through-the-azure-portal"></a>通过 Azure 门户设置密钥保管库的高级访问策略
