...
> [!IMPORTANT]
> 自从本文编写完成以来，现已正式支持在 Azure 中使用 MATLAB 应用程序。 建议使用这些较新功能，而不是本文中引用的模板和脚本。 在 [Azure 市场](https://azuremarketplace.microsoft.com/)中搜索“matlab”；有关在 Azure 上运行 MATLAB 应用程序的更多信息可从 [MathWorks](https://www.mathworks.com/solutions/cloud.html#public-cloud) 获得。
