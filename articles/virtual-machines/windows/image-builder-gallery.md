---
title: 将 Azure 映像生成器用于 Windows 虚拟机的映像库 (预览)
description: 通过 Azure 映像生成器和共享映像库创建 Windows 映像。
author: cynthn
ms.author: cynthn
ms.date: 05/02/2019
ms.topic: article
...
ms.locfileid: "68698673"
---
# <a name="preview-create-a-windows-image-and-distribute-it-to-a-shared-image-gallery"></a>预览版：创建 Windows 映像并将其分发给共享映像库 
