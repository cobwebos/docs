...
<a id="how-to-set-up-endpoints-on-a-classic-windows-virtual-machine-in-azure" class="xliff"></a>
...
在 Azure 门户中创建 Windows 虚拟机时，通常会自动创建常用终结点（如用于远程桌面和 Windows PowerShell 远程处理的终结点）。 你可以在创建虚拟机时或之后根据需要配置其他终结点。
