...
* 已经查看 [Oracle Virtual Machine images - Miscellaneous Considerations](oracle-considerations.md)（Oracle 虚拟机映像 - 其他注意事项）主题中的“高可用性和灾难恢复注意事项”部分。 请注意，Azure 支持独立的 Oracle 数据库实例，但目前不支持 Oracle 真正应用程序群集 (Oracle RAC)。
...
* 已使用 Windows Server 上的 Oracle 企业版在 Azure 中创建了两个虚拟机 (VM)。 确保这些虚拟机位于[相同的云服务](../../virtual-machines-linux-load-balance.md)和相同的[虚拟网络](https://azure.microsoft.com/documentation/services/virtual-network/)中，以确保它们可以通过持久性专用 IP 地址相互访问。
...
[Azure 的 Oracle 虚拟机映像](../../linux/classic/oracle-images.md)
