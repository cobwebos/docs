---
title: "在 Azure VM 上配置 SQL Server 的 Azure 密钥保管库集成（经典）"
...
---
# <a name="configure-azure-key-vault-integration-for-sql-server-on-azure-vms-classic"></a>在 Azure VM 上配置 SQL Server 的 Azure 密钥保管库集成（经典）
