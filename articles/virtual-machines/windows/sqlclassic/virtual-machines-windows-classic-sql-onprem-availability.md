...
除了使用“添加 Azure 副本向导”将 AlwaysOn 可用性组扩展到 Azure 外，还可以将某些 SQL Server 工作负荷完全移动到 Azure。 若要开始，请参阅[在 Azure 上预配 SQL Server 虚拟机](../../../azure-sql/virtual-machines/windows/create-sql-vm-portal.md)。
