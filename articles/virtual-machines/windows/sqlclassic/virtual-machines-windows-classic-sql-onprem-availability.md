...
* 一个有效的 Azure 订阅。 你可以[注册免费试用版](https://azure.microsoft.com/pricing/free-trial/)。
* 一个现有的本地 AlwaysOn 可用性组。 有关可用性组的详细信息，请参阅 [AlwaysOn 可用性组](https://msdn.microsoft.com/library/hh510230.aspx)。
* 本地网络和 Azure 虚拟网络之间的连接。 有关创建此虚拟网络的详细信息，请参阅[在 Azure 经典门户中配置站点到站点 VPN](../../../vpn-gateway/vpn-gateway-site-to-site-create.md)。
...
3. 默认情况下，将显示“将副本添加到可用性组向导”。 单击“资源组名称” 的 Azure 数据工厂。  如果在上一次启动此向导期间在页面底部选择了“不再显示此页”选项，将不会显示此屏幕。
