...
* 你已有一个 Azure 帐户。
* 你已经知道如何使用 GUI 从虚拟机库预配经典 SQL Server VM。
...
你将从一个新的 Azure 试用帐户开始。 完成帐户设置后，你将位于 Azure 经典门户的主页屏幕。
...
配置完新虚拟机后，请等待对 VM 设置完成。 此过程需要一些时间才能完成，如果单击 Azure 经典门户中的“虚拟机”选项卡，可以看到 ContosoDC 逐一经历状态，范围从“正在启动(预配)”、“已停止”、“正在启动”、“正在运行(预配)”到最后的“正在运行”。
