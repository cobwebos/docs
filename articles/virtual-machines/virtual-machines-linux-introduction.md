<properties pageTitle="Azure 中的 Linux 简介 - Azure 教程" description="了解如何在 Azure 上使用 Linux 虚拟机。"  services="virtual-machines" documentationCenter="Python" authors="szark" manager="timlt" editor="" />
<tags  
