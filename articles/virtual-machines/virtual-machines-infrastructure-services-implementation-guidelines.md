...
> [AZURE.NOTE]云服务不存在于 Azure 资源管理器中。有关资源管理器优点的简介，请参阅 [Azure 资源管理器中的 Azure 计算、网络和存储提供程序](../articles/virtual-machines/virtual-machines-azurerm-versus-azuresm.md)。
