...
- 从世界各地的 Azure 专家那里获取帮助。向 MSDN Azure 或堆栈溢出论坛提交问题。有关详细信息，请参阅 [Microsoft Azure 论坛](http://azure.microsoft.com/support/forums/)。
- 提出 Azure 支持事件。转到[“Azure 支持站点”](http://azure.microsoft.com/support/options/)，单击“技术和帐单支持”下的“获得支持”。
