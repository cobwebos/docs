<properties
	pageTitle="捕获运行 Linux 的虚拟机的映像 | Microsoft Azure"
...
## 后续步骤
该映像已就绪，可用作创建虚拟机的模板了。你可以使用 Azure CLI 命令 `azure vm create` 并提供刚创建的映像名称。有关此命令的详细信息，请参阅[将 Azure CLI 用于服务管理 API](virtual-machines-command-line-tools.md)。此外，你也可以使用[管理门户][]来创建自定义虚拟机，只需使用**“从库中”**方法并选择你刚创建的映像即可。如需更多详细信息，请参阅[如何创建自定义虚拟机][]。
