...
ms.locfileid: "78372913"
---
# <a name="tutorial-monitor-changes-and-update-a-linux-virtual-machine-in-azure"></a>教程：在 Azure 中监视更改和更新 Linux 虚拟机
...
| 重新启动控制| 确定应如何处理重新启动。 可用选项有：</br>需要时重新启动(默认)</br>永远重启</br>永不重启</br>仅重启 - 不安装更新|
