...
> [!IMPORTANT]
> 不能使用门户从另一个 Azure 租户中的映像部署 VM。 要从租户之间共享的映像创建 VM，必须使用 Azure CLI 或[Powershell](../windows/share-images-across-tenants.md)。
