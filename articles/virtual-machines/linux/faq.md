...
如果遇到问题，请查看[安全外壳（SSH）连接故障排除](../troubleshooting/troubleshoot-ssh-connection.md?toc=/azure/virtual-machines/linux/toc.json)。
...
根据所使用的工具，有不同的密码长度要求：
 ...
 - CLI-介于 12-123 个字符之间
 - 不允许使用 Azure 资源管理器（ARM）模板-不允许使用 12-72 字符和控制字符
