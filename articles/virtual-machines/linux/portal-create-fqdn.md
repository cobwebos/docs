---
title: 为 Azure 门户中的 Linux VM 创建 FQDN
...
阅读本文的前提是已创建 VM。 如果需要，可以[在门户中创建 VM](quick-create-portal.md)，也可以[使用 Azure CLI 创建 VM](quick-create-cli.md)。 在启动和运行 VM 后，请执行下列步骤：
