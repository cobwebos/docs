...
| [将托管磁盘的 VHD 导出到存储帐户](../scripts/virtual-machines-linux-cli-sample-copy-managed-disks-vhd.md?toc=%2fcli%2fmodule%2ftoc.json) | 将托管磁盘的基础 VHD 导出到不同区域的存储帐户。 |
...
|**监视虚拟机**||
| [使用 Azure Log Analytics 监视 VM](./../scripts/virtual-machines-linux-cli-sample-create-vm-oms.md?toc=%2fcli%2fazure%2ftoc.json) | 创建一个虚拟机，安装 Log Analytics 代理，并在 Log Analytics 工作区中注册该 VM。  |
|**对虚拟机进行故障排除**||
