...
- [Azure CLI 2.0](../windows/troubleshoot-recovery-disks.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json) - 适用于资源管理部署模型的下一代 CLI
...
确保已安装并登录[最新版 Azure CLI 1.0](../../cli-install-nodejs.md) 并使用 Resource Manager 模式：
