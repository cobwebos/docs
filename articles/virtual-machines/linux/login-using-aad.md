...
有关 Azure Active Directory 的详细信息，请参阅[什么是 Azure Active Directory](../../active-directory/active-directory-whatis.md) 和 [Azure Active Directory 入门方式](../../active-directory/get-started-azure-ad.md)
