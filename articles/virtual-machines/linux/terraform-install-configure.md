...
> [!TIP]
若要了解有关如何在 Azure 中使用 Terraform 的详细信息，请访问 [Terraform 中心](/azure/terraform)。 默认情况下，Terraform 安装在 [Cloud Shell](/azure/terraform/terraform-cloud-shell) 中。 通过使用 Cloud Shell，可跳过本文档的安装/设置部分。
