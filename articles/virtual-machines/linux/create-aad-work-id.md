...
但是，利用最近所做的更改，可以使用[此处](../../xplat-cli-connect.md)所述的 `azure login` 交互式登录方法，通过任何类型的 Azure 帐户管理你的订阅。 你可以使用该机制，也可以遵循后面的说明。 还可以[在 Azure Active Directory 中创建工作或学校标识以用于 Windows VM](../windows/create-aad-work-id.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)。
