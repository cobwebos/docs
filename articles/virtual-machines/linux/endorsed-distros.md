...
Oracle 的战略是为公共云和私有云提供广泛的解决方案组合。 让客户面临如何在 Oracle 云以及其他云中部署 Oracle 软件这一问题时拥有更多选择权和灵活性。 Oracle 与 Microsoft 的合作使客户能够放心地获得 Oracle 的认证和支持，在 Microsoft 公共云和私有云中部署 Oracle 软件。  甲骨文对甲骨文公共和私有云解决方案的承诺和投资没有改变。
