...
11. 在“立即备份”边栏选项卡中单击日历图标，使用日历控件选择保留此恢复点的最后一天，然后单击“备份”。
...
1. 在本地计算机上打开浏览器，然后键入 VM 的公共 IP 地址查看默认的 nginx 网页。
...
6. 在左侧菜单中选择“虚拟机”。 
7. 从列表中选择 VM。
8. 在 VM 边栏选项卡上的“设置”部分中，单击“备份”。 此时将打开“备份”边栏选项卡。 
9. 在边栏选项卡顶部的菜单中，选择“文件恢复(预览)”。 此时将打开“文件恢复(预览)”边栏选项卡。
