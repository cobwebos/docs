---
title: 在 Linux VM 上对 Azure 资源管理器部署中的存储资源删除错误进行故障排除 | Microsoft 文档
...
Azure VM 中使用的 VHD 是在 Azure 的标准或高级存储帐户中作为页 Blob 存储的 .vhd 文件。 有关 Azure 磁盘的详细信息，请参阅[有关 Microsoft Azure Linux VM 的非托管和托管磁盘存储](about-disks-and-vhds.md)。 
