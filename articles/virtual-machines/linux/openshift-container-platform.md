...
> [!NOTE] 
> 必须使用 Azure CLI.8 或更高版本，才能运行下面的命令。 可以使用 `az --version` 命令检查 CLI 版本。 若要更新 CLI 版本，请参阅[安装 Azure CLI](https://docs.microsoft.com/cli/azure/install-azure-cli?view=azure-cli-latesti)。
