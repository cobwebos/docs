...
N 系列 Linux VM 支持 Azure 应用商店中的以下发行版以及列出的 NVIDIA 驱动程序。


| VM 系列 | 支持的发行版 | 支持的驱动程序 |
| --- | --- | --- |
| **NC**（Tesla K80 卡） | Ubuntu 16.04 LTS<br/><br/> Red Hat Enterprise Linux 7.3<br/><br/> 基于 CentOS 的 7.3 | NVIDIA CUDA 8.0、driver branch R375<br/>[安装步骤](#install-cuda-drivers-for-nc-vms) |
| **NV**（Tesla M60 卡）| Ubuntu 16.04 LTS<br/><br/>Red Hat Enterprise Linux 7.3<br/><br/>基于 CentOS 的 7.3 | NVIDIA GRID 4.2、driver branch R367<br/>[安装步骤](#install-grid-drivers-for-nv-vms) |
