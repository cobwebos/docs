...
>
> Azure 虚拟机串行控制台可以用于对 VM 的控制台访问，如果修改 fstab 导致启动失败。 中提供了更多详细信息[串行控制台文档](https://docs.microsoft.com/en-us/azure/virtual-machines/troubleshooting/serial-console-linux)。
