...
* 如果在 Resource Manager 部署模型中创建虚拟机，可以在 Resource Manager 模式下使用 Azure CLI [创建网络安全组](../../../virtual-network/tutorial-filter-network-traffic-cli.md)，控制发往 VM 的流量。
