...
---
# 将使用经典部署模型创建的 Linux 虚拟机连接到虚拟网络或云服务
<a id="connect-linux-virtual-machines-created-with-the-classic-deployment-model-with-a-virtual-network-or-cloud-service" class="xliff"></a>
> [!IMPORTANT]
