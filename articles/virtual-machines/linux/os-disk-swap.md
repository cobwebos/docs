---
title: 使用 CLI 交换 Azure VM 的 OS 磁盘
...
本文需要 Azure CLI 2.0.25 或更高版本。 可以运行 `az --version` 来查找版本。 如果需要进行安装或升级，请参阅[安装 Azure CLI]( /cli/azure/install-azure-cli)。 
