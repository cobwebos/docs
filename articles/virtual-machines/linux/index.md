...
<div class="columnHolder">
    <div class="column50">
        ...
        <p>构建和部署 Linux 虚拟机。</p>
        <ul class="spaced">
            <li><a href="/azure/virtual-machines/linux/tutorial-manage-vm">创建和管理 Windows VM</a></li>
            <li><a href="/azure/virtual-machines/linux/tutorial-load-balance-nodejs">对高度可用的 VM 进行负载均衡</a></li>
