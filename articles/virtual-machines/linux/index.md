...
<div class="content">
    <h1>Linux 虚拟机文档</h1>
    <p style="padding-bottom: 0px; max-width: 1050px;">Azure Linux 虚拟机使用所选 Red Hat、Ubuntu 或 Linux 分发按需提供具有高可伸缩性且十分安全的虚拟化基础结构。  使用我们的快速入门、教程和示例了解如何创建、配置、管理和缩放 Linux VM。</p>
<h2 style="margin-top: 36px; margin-bottom: 0px;">快速入门</h2>
<p style="margin-top: 6px; margin-bottom: 6px;">使用以下工具创建 Linux VM：</p>
<div class="ico48Case">
    <div class="ico48Link">
...
<div class="columnHolder">
    <div class="column50">
        ...
        <p>构建和部署 Linux 虚拟机。</p>
        <ul class="spaced">
            <li><a href="/azure/virtual-machines/virtual-machines-linux-tutorial-manage-vm?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json">创建和管理 Linux VM</a></li>
            <li><a href="/azure/virtual-machines/virtual-machines-linux-tutorial-load-balance-nodejs?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json">对高度可用的 VM 进行负载均衡</a></li>
        </ul>
        <h2>示例</h2>
