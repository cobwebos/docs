...
| Standard_A9 |16 |#N/A |Intel Xeon CPU E5-2670 0 @ 2.6 GHz |189 |210,816 |2,126 |
| Standard_A10 |8 |1 |Intel Xeon CPU E5-2670 0 @ 2.6 GHz |188 |110,025 |1,045 |
| Standard_A11 |16 |#N/A |Intel Xeon CPU E5-2670 0 @ 2.6 GHz |188 |210,727 |2,073 |

## <a name="dv2-series"></a>Dv2 系列
| 大小 | vCPU | NUMA 节点 | CPU | 运行次数 | 迭代次数/秒 | 标准偏差 |
| --- | --- | --- | --- | --- | --- | --- |
| Standard_D1_v2 |1 |1 |Intel Xeon E5-2673 v3 @ 2.4 GHz |140 |14,852 |780 |
| Standard_D2_v2 |#N/A |1 |Intel Xeon E5-2673 v3 @ 2.4 GHz |133 |29,467 |1,863 |
...
| Standard_D5_v2 |16 |#N/A |Intel Xeon E5-2673 v3 @ 2.4 GHz |126 |205,332 |9,998 |
| Standard_D11_v2 |#N/A |1 |Intel Xeon E5-2673 v3 @ 2.4 GHz |125 |28,598 |1,510 |
...
| Standard_D14_v2 |16 |#N/A |Intel Xeon E5-2673 v3 @ 2.4 GHz |140 |208,186 |8,839 |
| Standard_D15_v2 |20 |#N/A |Intel Xeon E5-2673 v3 @ 2.4 GHz |28 |268,560 |4,667 |

## <a name="f-series"></a>F 系列
| 大小 | vCPU | NUMA 节点 | CPU | 运行次数 | 迭代次数/秒 | 标准偏差 |
| --- | --- | --- | --- | --- | --- | --- |
| Standard_F1 |1 |1 |Intel Xeon E5-2673 v3 @ 2.4 GHz |154 |15,602 |787 |
| Standard_F2 |#N/A |1 |Intel Xeon E5-2673 v3 @ 2.4 GHz |126 |29,519 |1,233 |
...
| Standard_F16 |16 |#N/A |Intel Xeon E5-2673 v3 @ 2.4 GHz |42 |218,571 |5,113 |

## <a name="g-series"></a>G 系列
| 大小 | vCPU | NUMA 节点 | CPU | 运行次数 | 迭代次数/秒 | 标准偏差 |
| --- | --- | --- | --- | --- | --- | --- |
| Standard_G1 |#N/A |1 |Intel Xeon E5-2698B v3 @ 2 GHz |83 |31,310 |2,891 |
...
| Standard_G5 |32 |#N/A |Intel Xeon E5-2698B v3 @ 2 GHz |84 |360,329 |14,212 |

## <a name="gs-series"></a>GS 系列
| 大小 | vCPU | NUMA 节点 | CPU | 运行次数 | 迭代次数/秒 | 标准偏差 |
| --- | --- | --- | --- | --- | --- | --- |
| Standard_GS1 |#N/A |1 |Intel Xeon E5-2698B v3 @ 2 GHz |84 |28,613 |1,884 |
...
| Standard_GS5 |32 |#N/A |Intel Xeon E5-2698B v3 @ 2 GHz |84 |357,396 |16,228 |

## <a name="h-series"></a>H 系列
| 大小 | vCPU | NUMA 节点 | CPU | 运行次数 | 迭代次数/秒 | 标准偏差 |
| --- | --- | --- | --- | --- | --- | --- |
| Standard_H8 |8 |1 |Intel Xeon E5-2667 v3 @ 3.2 GHz |28 |140,782 |2,512 |
| Standard_H16 |16 |#N/A |Intel Xeon E5-2667 v3 @ 3.2 GHz |35 |275,289 |7,110 |
| Standard_H18m |8 |1 |Intel Xeon E5-2667 v3 @ 3.2 GHz |28 |139,071 |3,988 |
| Standard_H16m |16 |#N/A |Intel Xeon E5-2667 v3 @ 3.2 GHz |28 |275,988 |6,963 |
| Standard_H16r |16 |#N/A |Intel Xeon E5-2667 v3 @ 3.2 GHz |28 |273,982 |6,069 |
| Standard_H16mr |16 |#N/A |Intel Xeon E5-2667 v3 @ 3.2 GHz |28 |274,523 |5,698 |
