...
---
# <a name="application-architecture-with-azure-resource-manager-templates-for-linux-vms"></a>适用于 Linux VM 的使用 Azure Resource Manager 模板的应用程序体系结构
...
音乐应用商店应用程序包含一个可供客户浏览和购买音乐的 Web 应用程序。 尽管有多个 Azure 服务可以托管 Web 应用程序，但是本示例使用虚拟机。 使用示例音乐应用商店模板可以部署虚拟机、安装 Web 服务器，以及安装并配置音乐应用商店网站。 本文只详细说明虚拟机部署。 Web 服务器和应用程序的配置在下一篇文章中详细说明。
...
部署后，可以在 Azure 门户中看到虚拟机属性。

![虚拟机](./media/dotnet-core-2-architecture/vm.png)

## <a name="storage-account"></a>存储帐户
存储帐户有许多存储选项和功能。 在 Azure 虚拟机的上下文中，存储帐户保存虚拟机和任何其他数据磁盘的虚拟硬盘。 音乐应用商店示例包含一个存储帐户，其中保存了部署中每个虚拟机的虚拟硬盘。 
...
![存储帐户](./media/dotnet-core-2-architecture/storacct.png)

单击进入存储帐户 Blob 容器，即可看到使用模板部署的每个虚拟机的虚拟硬盘文件。

![虚拟硬盘](./media/dotnet-core-2-architecture/vhd.png)

有关 Azure 存储的信息，请参阅 [Azure 存储文档](https://azure.microsoft.com/documentation/services/storage/)。
...
![虚拟网络](./media/dotnet-core-2-architecture/vnet.png)
...
![网络接口](./media/dotnet-core-2-architecture/nic.png)

有关 Azure 虚拟网络的详细信息，请参阅 [Azure 虚拟网络文档](https://azure.microsoft.com/documentation/services/virtual-network/)。
...
有关部署 Azure SQL 数据库的详细信息，请参阅 [Azure SQL 数据库文档](https://azure.microsoft.com/documentation/services/sql-database/)。

## <a name="next-step"></a>后续步骤
<hr>

[步骤 2 - Azure Resource Manager 模板中的访问权限和安全性](dotnet-core-3-access-security.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
