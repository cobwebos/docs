...
|RedHat 7.7 |RHEL |7-RAW-CI |7.7.2019081601 | 是（注意：这是预览图像 **，不能再使用**，此操作将在 9 2020 月1日之前删除） | 不适用 |
...
| 发布者/版本 | 产品/服务 | SKU | 版本 | 映像 cloud-init 准备就绪 | Azure 上的 cloud-init 包支持|
|:--- |:--- |:--- |:--- |:--- |:--- |
|OpenLogic 7.7 |CentOS |7-CI |7.7.20190920 |是（注意：这是预览图像 **，不能再使用**，此操作将在 9 2020 月1日之前删除） | 不适用 |
|OpenLogic 7.7 |CentOS | 7.7 |7.7.2020062400 |是 | 是-包版本支持：`18.5-6.el7.centos.5`|
|OpenLogic 7.7 （Gen2） |CentOS | 7_7-gen2 |7.7.2020062401 |是 | 是-包版本支持：`18.5-6.el7.centos.5`|
|OpenLogic 7.7 |CentOS-HPC | 7.7 |7.6.2020062600 |是 | 是-包版本支持：`18.5-6.el7.centos.5`|
|OpenLogic 7.7 （Gen2） |CentOS-HPC | 7_7-gen2 |7.6.2020062601 |是 | 是-包版本支持：`18.5-6.el7.centos.5`|
|OpenLogic 8。1 |CentOS | 8_1 |8.1.2020062400 |是 | 是-包版本支持：`18.5-7.el8_1.1`|
|OpenLogic 8.1 （Gen2） |CentOS | 8_1-gen2 |8.1.2020062401 |是 | 是-包版本支持：`18.5-7.el8_1.1`|
|OpenLogic 8。1 |CentOS-HPC | 8_1 |8.1.2020062400 |是 | 是-包版本支持：`18.5-7.el8_1.1`|
|OpenLogic 8.1 （Gen2） |CentOS-HPC： 8_1-gen2 | 8_1-gen2 |8.1.2020062401 |是 | 是-包版本支持：`18.5-7.el8_1.1`|
