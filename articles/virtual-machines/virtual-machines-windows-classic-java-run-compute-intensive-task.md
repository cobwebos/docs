---
title: "VM 上的计算密集型 Java 应用程序 | Microsoft Docs"
...
1. 在开发计算机（不需要为所创建的虚拟机）上，下载 [Azure SDK for Java](https://azure.microsoft.com/develop/java/)。
