<properties 
	pageTitle="注册 Windows 应用商店应用程序包以进行 Microsoft 身份验证" 
	description="了解如何在 Azure 移动服务应用程序中注册 Windows 应用商店应用程序以进行 Microsoft 身份验证" 
...
>[AZURE.NOTE]使用 Visual Studio 2013 可以轻松地将 Windows 应用商店应用程序包注册到移动服务。有关详细信息，请参阅 Windows 开发中心上的<a href="http://msdn.microsoft.com/zh-cn/library/windows/apps/xaml/dn263182.aspx">为移动服务添加推送通知</a>。
...
[使用 Live Connect 单一登录对 Windows 应用商店应用程序进行身份验证]: /documentation/articles/mobile-services-windows-store-dotnet-single-sign-on
