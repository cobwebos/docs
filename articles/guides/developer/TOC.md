...
## [在 Linux 上部署 Docker Web 应用](https://docs.microsoft.com/azure/app-service/containers/quickstart-docker-go) 
...
### [键-值对](https://docs.microsoft.com/azure/cosmos-db/create-table-dotnet)
### [JSON 文档](https://docs.microsoft.com/azure/cosmos-db/create-sql-api-dotnet)
...
# 资源
## [Azure 限制和配额](../../azure-subscription-service-limits.md?toc=%2fazure%2fguides%2fdeveloper%2ftoc.json)
