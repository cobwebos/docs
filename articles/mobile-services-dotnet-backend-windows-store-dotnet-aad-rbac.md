<properties 
	pageTitle="移动服务和 Azure Active Directory 中基于角色的访问控制（Windows 应用商店）| 移动开发人员中心" 
...
[访问 Azure Active Directory Graph 信息]: mobile-services-dotnet-backend-windows-store-dotnet-aad-graph-info
