...
|diff_backup_size_bytes|差异备份存储大小|字节|最大值|累积差异备份存储大小。 适用于常规用途和业务关键数据库。 当前不适用于管理实例数据库。|无维度|
...
|full_backup_size_bytes|完整备份存储大小|字节|最大值|累积完整备份存储大小。 适用于常规用途和业务关键数据库。 当前不适用于管理实例数据库。|无维度|
|local_tempdb_usage_percent|本地 tempdb 百分比|百分比|平均值|本地 tempdb 百分比。 仅适用于数据仓库。|无维度|
|log_backup_size_bytes|日志备份存储大小|字节|最大值|累积日志备份存储大小。 适用于常规用途和业务关键数据库。 当前不适用于管理实例数据库。|无维度|
