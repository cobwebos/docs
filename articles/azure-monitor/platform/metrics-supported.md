...
|d2c.endpoints.egress.builtIn.events|路由：发送到消息/事件的消息数|计数|总计|IoT 中心路由成功将消息发送到内置终结点（消息/事件）的次数。|无维度|
...
|TotalRequestUnits|总请求单位数|计数|总计|已消耗的请求单位|DatabaseName, CollectionName, Region, StatusCode|
|TotalRequests|请求总数|计数|计数|已发出的请求数|DatabaseName, CollectionName, Region, StatusCode|
...
|DroppedEventCount|删除的事件数|计数|总计|与此事件订阅匹配的已删除事件总数|无维度|
...
|指标|指标显示名称|单位|聚合类型|说明|维度|
|---|---|---|---|---|---|
|SuccessfulRequests|成功的请求数（预览版）|计数|总计|Microsoft.EventHub 成功请求数。 （预览版）|EntityName|
|ServerErrors|服务器错误数。 （预览版）|计数|总计|Microsoft.EventHub 的服务器错误数。 （预览版）|EntityName|
|UserErrors|用户错误数。 （预览版）|计数|总计|Microsoft.EventHub 用户错误数。 （预览版）|EntityName|
|QuotaExceededErrors|超过限额错误。 （预览版）|计数|总计|Microsoft.EventHub 的超过限额错误数。 （预览版）|EntityName|
|ThrottledRequests|限制的请求数。 （预览版）|计数|总计|Microsoft.EventHub 限制的请求数。 （预览版）|EntityName|
|IncomingRequests|传入的请求数（预览版）|计数|总计|Microsoft.EventHub 传入的请求数。 （预览版）|EntityName|
|IncomingMessages|传入的消息数（预览版）|计数|总计|Microsoft.EventHub 传入的消息数。 （预览版）|EntityName|
|OutgoingMessages|传出的消息数（预览版）|计数|总计|Microsoft.EventHub 传出的消息数。 （预览版）|EntityName|
...
|ActiveConnections|ActiveConnections（预览版）|计数|平均值|Microsoft.EventHub 的活动连接总数。 （预览版）|无维度|
|ConnectionsOpened|打开的连接数。 （预览版）|计数|平均值|Microsoft.EventHub 打开的连接数。 （预览版）|EntityName|
|ConnectionsClosed|已关闭的连接数。 （预览版）|计数|平均值|Microsoft.EventHub 已关闭的连接数。 （预览版）|EntityName|
|CaptureBacklog|捕获积压工作(backlog)。 （预览版）|计数|总计|捕获有关 Microsoft.EventHub 的积压工作(backlog)。 （预览版）|EntityName|
|CapturedMessages|已捕获的消息数。 （预览版）|计数|总计|Microsoft.EventHub 已捕获的消息数。 （预览版）|EntityName|
...
|INREQS|传入请求数|计数|总计|命名空间的传入发送请求总数|无维度|
...
|指标|指标显示名称|单位|聚合类型|说明|维度|
|---|---|---|---|---|---|
|SuccessfulRequests|成功的请求数（预览版）|计数|总计|Microsoft.EventHub 成功请求数。 （预览版）|无维度|
|ServerErrors|服务器错误数。 （预览版）|计数|总计|Microsoft.EventHub 的服务器错误数。 （预览版）|无维度|
|UserErrors|用户错误数。 （预览版）|计数|总计|Microsoft.EventHub 用户错误数。 （预览版）|无维度|
|QuotaExceededErrors|超过限额错误。 （预览版）|计数|总计|Microsoft.EventHub 的超过限额错误数。 （预览版）|无维度|
|ThrottledRequests|限制的请求数。 （预览版）|计数|总计|Microsoft.EventHub 限制的请求数。 （预览版）|无维度|
|IncomingRequests|传入的请求数（预览版）|计数|总计|Microsoft.EventHub 传入的请求数。 （预览版）|无维度|
|IncomingMessages|传入的消息数（预览版）|计数|总计|Microsoft.EventHub 传入的消息数。 （预览版）|无维度|
|OutgoingMessages|传出的消息数（预览版）|计数|总计|Microsoft.EventHub 传出的消息数。 （预览版）|无维度|
...
|ActiveConnections|ActiveConnections（预览版）|计数|平均值|Microsoft.EventHub 的活动连接总数。 （预览版）|无维度|
|ConnectionsOpened|打开的连接数。 （预览版）|计数|平均值|Microsoft.EventHub 打开的连接数。 （预览版）|无维度|
|ConnectionsClosed|已关闭的连接数。 （预览版）|计数|平均值|Microsoft.EventHub 已关闭的连接数。 （预览版）|无维度|
|CaptureBacklog|捕获积压工作(backlog)。 （预览版）|计数|总计|捕获有关 Microsoft.EventHub 的积压工作(backlog)。 （预览版）|无维度|
|CapturedMessages|已捕获的消息数。 （预览版）|计数|总计|Microsoft.EventHub 已捕获的消息数。 （预览版）|无维度|
...
|billingMeters/telemetryCount|数据点计数|计数|总计|发送到此 Application Insights 资源的数据点数。 使用多达两小时的延迟时间处理此指标。|billing/telemetryItemType, billing/telemetryItemSource|
...
|dependencies/failed|依赖项失败次数|计数|计数|应用程序对外部资源所进行的依赖项调用失败的计数。|dependency/type, dependency/performanceBucket, operation/synthetic, cloud/roleInstance, cloud/roleName|
...
|exceptions/count|例外|计数|总计|所有未捕获异常的已合并计数。|cloud/roleName, cloud/roleInstance, client/type|
|exceptions/browser|浏览器异常|计数|总计|浏览器中所引发未捕获异常的计数。|无维度|
|exceptions/server|服务器异常|计数|总计|服务器应用程序中引发的未捕获的异常计数。|cloud/roleName, cloud/roleInstance|
|traces/count|跟踪计数|计数|总计|跟踪文档计数|trace/severityLevel, operation/synthetic, cloud/roleName, cloud/roleInstance|
...
|IoBytesPerOtherOps|每个其他操作的 IO 字节数|字节数/操作|平均值|每个其他操作（非读取或写入）的输入/输出字节数|无维度|
|IoBytesPerReadOps|每个读取操作的 IO 字节数|字节数/操作|平均值|每个读取操作的输入/输出字节数|无维度|
|IoBytesPerTotalOps|经所有操作的每个操作的 IO 字节数|字节数/操作|平均值|所有输入/输出字节操作的总数|无维度|
|IoBytesPerWriteOps|每个写入操作的 IO 字节数|字节数/操作|平均值|每个写入操作的输入/输出字节数|无维度|
|OtherIops|其他 IOPS|操作数/秒|平均值|每秒其他输入/输出操作数|无维度|
|OtherThroughput|其他吞吐量|MBps|平均值|其他（非读取或写入）吞吐量（兆字节/秒）|无维度|
|ReadIops|读取 IOPS|操作数/秒|平均值|每秒读取输入/输出操作数|无维度|
|ReadThroughput|读取吞吐量|MBps|平均值|读取吞吐量（兆字节/秒）|无维度|
|TotalIops|IOPS 总数|操作数/秒|平均值|每秒所有输入/输出操作的总数|无维度|
...
|WriteIops|写入 IOPS|操作数/秒|平均值|每秒写入输入/输出操作数|无维度|
...
|CurrentConnections|当前连接|计数|总计|使用应用程序网关建立的当前连接计数|无维度|
...
|outgoing.gcm.expiredchannel|GCM 已过期通道错误|计数|总计|因为注册中的 registrationId 过期而失败的推送的计数（GCM 结果：NotRegistered）。|无维度|
...
|ServerErrors|服务器错误数。 （预览版）|计数|总计|Microsoft.ServiceBus 的服务器错误数。 （预览版）|EntityName|
|UserErrors|用户错误数。 （预览版）|计数|总计|Microsoft.ServiceBus 的用户错误数。 （预览版）|EntityName|
|ThrottledRequests|限制的请求数。 （预览版）|计数|总计|Microsoft.ServiceBus 限制的请求数。 （预览版）|EntityName|
|IncomingRequests|传入的请求数（预览版）|计数|总计|Microsoft.ServiceBus 传入的请求数。 （预览版）|EntityName|
|IncomingMessages|传入的消息数（预览版）|计数|总计|Microsoft.ServiceBus 传入的消息数。 （预览版）|EntityName|
|OutgoingMessages|传出的消息数（预览版）|计数|总计|Microsoft.ServiceBus 传出的消息数。 （预览版）|EntityName|
|ActiveConnections|ActiveConnections（预览版）|计数|总计|Microsoft.ServiceBus 的活动连接总数。 （预览版）|无维度|
|大小|大小（预览版）|字节|平均值|队列/主题的大小（以字节为单位）。 （预览版）|EntityName|
|消息|队列/主题中的消息计数。 （预览版）|计数|平均值|队列/主题中的消息计数。 （预览版）|EntityName|
...
|EarlyInputEvents|早期输入事件数|计数|总计|早期输入事件数|无维度|
...
* [将指标导出到存储、事件中心或 Log Analytics](../../monitoring-and-diagnostics/monitoring-overview-of-diagnostic-logs.md)
