...
| 检索 | 从命令行使用访问指标值[PowerShell cmdlet](https://docs.microsoft.com/powershell/module/azurerm.insights/?view=azurermps-6.7.0)<br>从自定义应用程序使用访问指标值[REST API](rest-api-walkthrough.md)。<br>从命令行使用访问指标值[CLI](/azure/monitor/metrics)。 |
