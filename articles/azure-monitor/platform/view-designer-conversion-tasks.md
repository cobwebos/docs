...
可以通过在参数名称前后添加大括号{}来在查询中使用参数。 有关参数的更多详细信息，请参阅[有关参数的工作簿文档](https://github.com/microsoft/Application-Insights-Workbooks/blob/master/Documentation/Parameters/Parameters.md)。
...
在查询中添加行： `| where TimeGenerated {TimeRange}`如下例所示：
