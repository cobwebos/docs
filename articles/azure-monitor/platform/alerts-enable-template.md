...
> [!NOTE]
> 
> 本文介绍如何使用资源管理器模板创建经典指标警报。 如果你正在寻找使用模板创建[较新指标警报](../../monitoring-and-diagnostics/monitoring-near-real-time-metric-alerts.md)的方法，那么[本文](alerts-metric-create-templates.md)可提供详细信息。
>
