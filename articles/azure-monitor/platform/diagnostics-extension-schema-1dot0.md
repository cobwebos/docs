...
|**scheduledTransferPeriod**|持续时间|可选。 指定计划的数据传输之间的时间间隔，向上舍入为最接近的分钟数。<br /><br /> 默认是 PT0S。|  
...
|**sampleRate**|持续时间|必需。 应收集性能计数器的速率。|  
...
|特性|type|描述|  
|---------------|----------|-----------------|  
|**名称**|string|必需。 指定要收集的日志的 XPath 表达式。|  
