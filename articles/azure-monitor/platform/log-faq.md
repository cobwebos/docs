...
答：默认情况下，会自动注册多个资源提供程序，但可能需要手动注册某些资源提供程序。 这样可以配置订阅，使之适合资源提供程序。 注册的作用域始终是订阅。 有关详细信息，请参阅[资源提供程序和类型](../../azure-resource-manager/resource-manager-supported-services.md#azure-portal)。
