...
3. 将在 omiagent_trace 文件中转储调用堆栈，如果注意到许多卷曲和 NSS 函数调用，请遵循下面的解决方法步骤。

### <a name="resolution-step-by-step"></a>解决方法（分步）

1. 将 nss-pem 包升级到[v 1.0.3 wget-1.12-5.el6. el7 _ 6.1](https://centos.pkgs.org/7/centos-x86_64/nss-pem-1.0.3-7.el7.x86_64.rpm.html)。 <br/>
