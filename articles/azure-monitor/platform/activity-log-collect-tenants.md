---
title: 跨 Azure 租户 Azure 活动日志收集到 Log Analytics 工作区 |Microsoft Docs
...
如果 Log Analytics 工作区在同一 Azure 订阅，或在不同的订阅但相同的 Azure Active Directory 中，请使用中的步骤[收集和分析 Azure 活动日志中 Log Analytics 工作区中 Azure Monitor](activity-log-collect.md)收集 Azure 活动日志。
