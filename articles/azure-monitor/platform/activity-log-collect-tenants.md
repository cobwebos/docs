...
如果 Log Analytics 工作区位于相同的 Azure 订阅中，或位于不同的订阅中，但在同一 Azure Active Directory 中，请使用在[Azure Monitor 中的 Log Analytics 工作区中收集和分析 azure 活动日志](activity-log-collect.md)中的步骤来收集 azure 活动日志。
