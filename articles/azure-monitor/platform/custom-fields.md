---
title: Azure 监视器中的自定义字段（预览） |微软文档
...
ms.locfileid: "77655355"
---
# <a name="create-custom-fields-in-a-log-analytics-workspace-in-azure-monitor-preview"></a>在 Azure 监视器中的日志分析工作区中创建自定义字段（预览）
...
4. 字段**提取向导**将打开，您选择的记录将显示在 **"主示例"** 列中。  将为所选属性中具有相同值的记录定义自定义字段。  
...
1. 突出显示示例记录中要用于填充自定义字段的文本。  然后会显示一个对话框，用于命名字段和设置字段的数据类型，以及执行初始提取。  字符**\_CF**将自动追加。
2. 单击“提取”**** 以执行已收集记录的分析。  
