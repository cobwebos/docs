...
| 是否可通过诊断设置导出？  | 发出 Null |  ResourceType  |  指标  |  MetricDisplayName  |  单位  |  AggregationType | 
|---|---| ---- | ----- | ------ | ---- | ---- | 
...
| **是**  | **是** |  Microsoft.ApiManagement/service  |  EventHubDroppedEvents  |  已丢弃 EventHub 事件  |  Count  |  总计 | 
| **是**  | **是** |  Microsoft.ApiManagement/service  |  EventHubRejectedEvents  |  拒绝 EventHub 事件  |  Count  |  总计 | 
| **是**  | **是** |  Microsoft.ApiManagement/service  |  EventHubSuccessfulEvents  |  成功的 EventHub 事件  |  Count  |  总计 | 
| **是**  | **是** |  Microsoft.ApiManagement/service  |  EventHubThrottledEvents  |  限制 EventHub 事件  |  Count  |  总计 | 
| **是**  | **是** |  Microsoft.ApiManagement/service  |  EventHubTimedoutEvents  |  已超时 EventHub 事件  |  Count  |  总计 | 
...
| **是**  | **是** |  Microsoft.ApiManagement/service  |  EventHubTotalFailedEvents  |  故障 EventHub 事件  |  Count  |  总计 | 
| **是**  | **是** |  Microsoft.ApiManagement/service  |  FailedRequests  |  失败的网关请求数（已弃用）  |  Count  |  总计 | 
| **是**  | **是** |  Microsoft.ApiManagement/service  |  OtherRequests  |  其他网关请求（不推荐使用）  |  Count  |  总计 | 
...
| **是**  | **是** |  Microsoft.ApiManagement/service  |  TotalRequests  |  网关请求总数（不推荐使用）  |  Count  |  总计 | 
| **是**  | **是** |  Microsoft.ApiManagement/service  |  UnauthorizedRequests  |  未经授权的网关请求（不推荐使用）  |  Count  |  总计 | 
| **是**  | 否 |  AppPlatform/春季  |  AppCpuUsagePercentage  |  应用 CPU 使用率百分比  |  百分比  |  平均值 | 
| **是**  | 否 |  AppPlatform/春季  |  AppMemoryCommitted  |  已分配应用内存  |  字节  |  平均值 | 
| **是**  | 否 |  AppPlatform/春季  |  AppMemoryMax  |  最大应用内存  |  字节  |  最大值 | 
| **是**  | 否 |  AppPlatform/春季  |  AppMemoryUsed  |  使用的应用内存  |  字节  |  平均值 | 
| **是**  | 否 |  AppPlatform/春季  |  GCPauseTotalCount  |  GC 暂停计数  |  Count  |  总计 | 
| **是**  | 否 |  AppPlatform/春季  |  GCPauseTotalTime  |  GC 暂停总时间  |  毫秒  |  总计 | 
| **是**  | 否 |  AppPlatform/春季  |  MaxOldGenMemoryPoolBytes  |  最大可用旧生成数据大小  |  字节  |  平均值 | 
| **是**  | 否 |  AppPlatform/春季  |  OldGenMemoryPoolBytes  |  旧生成数据大小  |  字节  |  平均值 | 
| **是**  | 否 |  AppPlatform/春季  |  OldGenPromotedBytes  |  提升为旧的生成数据大小  |  字节  |  最大值 | 
| **是**  | 否 |  AppPlatform/春季  |  SystemCpuUsagePercentage  |  系统 CPU 使用率百分比  |  百分比  |  平均值 | 
| **是**  | 否 |  AppPlatform/春季  |  TomcatErrorCount  |  Tomcat 全局错误  |  Count  |  总计 | 
| **是**  | 否 |  AppPlatform/春季  |  TomcatReceivedBytes  |  Tomcat 收到的总字节数  |  字节  |  总计 | 
| **是**  | 否 |  AppPlatform/春季  |  TomcatRequestMaxTime  |  Tomcat 请求最大时间  |  毫秒  |  最大值 | 
| **是**  | 否 |  AppPlatform/春季  |  TomcatRequestTotalCount  |  Tomcat 请求总数  |  Count  |  总计 | 
| **是**  | 否 |  AppPlatform/春季  |  TomcatRequestTotalTime  |  Tomcat 请求总时间  |  毫秒  |  总计 | 
| **是**  | 否 |  AppPlatform/春季  |  TomcatResponseAvgTime  |  Tomcat 请求平均时间  |  毫秒  |  平均值 | 
| **是**  | 否 |  AppPlatform/春季  |  TomcatSentBytes  |  Tomcat 发送的总字节数  |  字节  |  总计 | 
| **是**  | 否 |  AppPlatform/春季  |  TomcatSessionActiveCurrentCount  |  Tomcat 会话活动计数  |  Count  |  总计 | 
| **是**  | 否 |  AppPlatform/春季  |  TomcatSessionActiveMaxCount  |  Tomcat 会话最大活动计数  |  Count  |  总计 | 
| **是**  | 否 |  AppPlatform/春季  |  TomcatSessionAliveMaxTime  |  Tomcat 会话最大活动时间  |  毫秒  |  最大值 | 
| **是**  | 否 |  AppPlatform/春季  |  TomcatSessionCreatedCount  |  Tomcat 会话创建计数  |  Count  |  总计 | 
| **是**  | 否 |  AppPlatform/春季  |  TomcatSessionExpiredCount  |  Tomcat 会话过期计数  |  Count  |  总计 | 
| **是**  | 否 |  AppPlatform/春季  |  TomcatSessionRejectedCount  |  Tomcat 会话已拒绝计数  |  Count  |  总计 | 
| **是**  | 否 |  AppPlatform/春季  |  YoungGenPromotedBytes  |  提升为年轻生成数据大小  |  字节  |  最大值 | 
| **是**  | 否 |  Microsoft.Automation/automationAccounts  |  TotalJob  |  作业总数  |  Count  |  总计 | 
| **是**  | 否 |  Microsoft.Automation/automationAccounts  |  TotalUpdateDeploymentMachineRuns  |  运行更新部署计算机总数  |  Count  |  总计 | 
| **是**  | 否 |  Microsoft.Automation/automationAccounts  |  TotalUpdateDeploymentRuns  |  更新部署运行总数  |  Count  |  总计 | 
...
| **是**  | 否 |  BatchAI/工作区  |  活动核心  |  活动核心  |  Count  |  平均值 | 
| **是**  | 否 |  BatchAI/工作区  |  活动节点  |  活动节点  |  Count  |  平均值 | 
| **是**  | 否 |  BatchAI/工作区  |  空闲内核数  |  空闲内核数  |  Count  |  平均值 | 
| **是**  | 否 |  BatchAI/工作区  |  空闲节点  |  空闲节点  |  Count  |  平均值 | 
| **是**  | 否 |  BatchAI/工作区  |  作业已完成  |  作业已完成  |  Count  |  总计 | 
| **是**  | 否 |  BatchAI/工作区  |  已提交作业  |  已提交作业  |  Count  |  总计 | 
| **是**  | 否 |  BatchAI/工作区  |  正在离开内核  |  正在离开内核  |  Count  |  平均值 | 
| **是**  | 否 |  BatchAI/工作区  |  退出节点  |  退出节点  |  Count  |  平均值 | 
| **是**  | 否 |  BatchAI/工作区  |  抢先核心  |  抢先核心  |  Count  |  平均值 | 
| **是**  | 否 |  BatchAI/工作区  |  抢占节点  |  抢占节点  |  Count  |  平均值 | 
| **是**  | 否 |  BatchAI/工作区  |  配额使用率百分比  |  配额使用率百分比  |  Count  |  平均值 | 
| **是**  | 否 |  BatchAI/工作区  |  内核总数  |  内核总数  |  Count  |  平均值 | 
| **是**  | 否 |  BatchAI/工作区  |  节点总数  |  节点总数  |  Count  |  平均值 | 
| **是**  | 否 |  BatchAI/工作区  |  不可用内核  |  不可用内核  |  Count  |  平均值 | 
| **是**  | 否 |  BatchAI/工作区  |  不可用节点  |  不可用节点  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.Blockchain/blockchainMembers  |  ConnectionAccepted  |  接受的连接  |  Count  |  总计 | 
| **是**  | 否 |  Microsoft.Blockchain/blockchainMembers  |  ConnectionActive  |  活动连接数  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.Blockchain/blockchainMembers  |  ConnectionHandled  |  处理的连接  |  Count  |  总计 | 
...
| **是**  | 否 |  Microsoft.Blockchain/blockchainMembers  |  PendingTransactions  |  挂起的事务  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.Blockchain/blockchainMembers  |  ProcessedBlocks  |  处理的块  |  Count  |  总计 | 
| **是**  | 否 |  Microsoft.Blockchain/blockchainMembers  |  ProcessedTransactions  |  处理的事务  |  Count  |  总计 | 
| **是**  | 否 |  Microsoft.Blockchain/blockchainMembers  |  QueuedTransactions  |  排队事务  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.Blockchain/blockchainMembers  |  RequestHandled  |  处理的请求  |  Count  |  总计 | 
| **是**  | 否 |  Microsoft.Blockchain/blockchainMembers  |  StorageUsage  |  存储使用情况  |  字节  |  平均值 | 
...
| **是**  | 否 |  ClassicStorage/storageAccounts/blobServices  |  可用性  |  可用性  |  百分比  |  平均值 | 
| 否  | 否 |  ClassicStorage/storageAccounts/blobServices  |  BlobCapacity  |  Blob 容量  |  字节  |  平均值 | 
| 否  | 否 |  ClassicStorage/storageAccounts/blobServices  |  BlobCount  |  Blob 计数  |  Count  |  平均值 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/blobServices  |  ContainerCount  |  Blob 容器计数  |  Count  |  平均值 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/blobServices  |  流出量  |  流出量  |  字节  |  总计 | 
| 否  | 否 |  ClassicStorage/storageAccounts/blobServices  |  IndexCapacity  |  索引容量  |  字节  |  平均值 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/blobServices  |  流入量  |  流入量  |  字节  |  总计 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/blobServices  |  SuccessE2ELatency  |  成功 E2E 延迟  |  毫秒  |  平均值 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/blobServices  |  SuccessServerLatency  |  成功服务器延迟  |  毫秒  |  平均值 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/blobServices  |  事务  |  事务  |  Count  |  总计 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/fileServices  |  可用性  |  可用性  |  百分比  |  平均值 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/fileServices  |  流出量  |  流出量  |  字节  |  总计 | 
| 否  | 否 |  ClassicStorage/storageAccounts/fileServices  |  FileCapacity  |  文件容量  |  字节  |  平均值 | 
| 否  | 否 |  ClassicStorage/storageAccounts/fileServices  |  FileCount  |  文件计数  |  Count  |  平均值 | 
| 否  | 否 |  ClassicStorage/storageAccounts/fileServices  |  FileShareCount  |  文件共享计数  |  Count  |  平均值 | 
| 否  | 否 |  ClassicStorage/storageAccounts/fileServices  |  FileShareQuota  |  文件共享配额大小  |  字节  |  平均值 | 
| 否  | 否 |  ClassicStorage/storageAccounts/fileServices  |  FileShareSnapshotCount  |  文件共享快照计数  |  Count  |  平均值 | 
| 否  | 否 |  ClassicStorage/storageAccounts/fileServices  |  FileShareSnapshotSize  |  文件共享快照大小  |  字节  |  平均值 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/fileServices  |  流入量  |  流入量  |  字节  |  总计 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/fileServices  |  SuccessE2ELatency  |  成功 E2E 延迟  |  毫秒  |  平均值 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/fileServices  |  SuccessServerLatency  |  成功服务器延迟  |  毫秒  |  平均值 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/fileServices  |  事务  |  事务  |  Count  |  总计 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/queueServices  |  可用性  |  可用性  |  百分比  |  平均值 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/queueServices  |  流出量  |  流出量  |  字节  |  总计 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/queueServices  |  流入量  |  流入量  |  字节  |  总计 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/queueServices  |  QueueCapacity  |  队列容量  |  字节  |  平均值 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/queueServices  |  QueueCount  |  队列计数  |  Count  |  平均值 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/queueServices  |  QueueMessageCount  |  队列消息计数  |  Count  |  平均值 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/queueServices  |  SuccessE2ELatency  |  成功 E2E 延迟  |  毫秒  |  平均值 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/queueServices  |  SuccessServerLatency  |  成功服务器延迟  |  毫秒  |  平均值 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/queueServices  |  事务  |  事务  |  Count  |  总计 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/tableServices  |  可用性  |  可用性  |  百分比  |  平均值 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/tableServices  |  流出量  |  流出量  |  字节  |  总计 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/tableServices  |  流入量  |  流入量  |  字节  |  总计 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/tableServices  |  SuccessE2ELatency  |  成功 E2E 延迟  |  毫秒  |  平均值 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/tableServices  |  SuccessServerLatency  |  成功服务器延迟  |  毫秒  |  平均值 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/tableServices  |  TableCapacity  |  表容量  |  字节  |  平均值 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/tableServices  |  TableCount  |  表计数  |  Count  |  平均值 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/tableServices  |  TableEntityCount  |  表实体计数  |  Count  |  平均值 | 
| **是**  | 否 |  ClassicStorage/storageAccounts/tableServices  |  事务  |  事务  |  Count  |  总计 | 
| **是**  | 否 |  Microsoft.CognitiveServices/accounts  |  BlockedCalls  |  阻止的调用数  |  Count  |  总计 | 
| **是**  | 否 |  Microsoft.CognitiveServices/accounts  |  CharactersTrained  |  训练的字符  |  Count  |  总计 | 
...
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  入站流  |  入站流  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  入站流最大创建速率  |  入站流最大创建速率（预览）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  网络传入  |  收费网络（不推荐使用）  |  字节  |  总计 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  网络总数  |  网络总数  |  字节  |  总计 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  网络传出  |  网络出量（不推荐使用）  |  字节  |  总计 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  网络传出总数  |  网络传出总数  |  字节  |  总计 | 
...
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  OS 每磁盘 QD  |  OS Disk QD （已弃用）  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  OS 每磁盘读取字节数/秒  |  OS 磁盘读取字节数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  OS 每磁盘读取操作数/秒  |  OS 磁盘读取操作数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  OS 每磁盘写入字节数/秒  |  OS 磁盘写入字节数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  OS 每磁盘写入操作数/秒  |  OS 磁盘写入操作数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  出站流  |  出站流  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  出站流的最大创建速率  |  出站流的最大创建速率（预览）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  每磁盘 QD  |  数据磁盘 QD （已弃用）  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  每磁盘读取字节数/秒  |  数据磁盘读取字节数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  每磁盘读取操作数/秒  |  数据磁盘读取操作数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  每磁盘写入字节数/秒  |  数据磁盘写入字节数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  每磁盘写入操作数/秒  |  数据磁盘写入操作数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
...
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  入站流  |  入站流  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  入站流最大创建速率  |  入站流最大创建速率（预览）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  网络传入  |  收费网络（不推荐使用）  |  字节  |  总计 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  网络总数  |  网络总数  |  字节  |  总计 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  网络传出  |  网络出量（不推荐使用）  |  字节  |  总计 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  网络传出总数  |  网络传出总数  |  字节  |  总计 | 
...
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  OS 每磁盘 QD  |  OS Disk QD （已弃用）  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  OS 每磁盘读取字节数/秒  |  OS 磁盘读取字节数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  OS 每磁盘读取操作数/秒  |  OS 磁盘读取操作数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  OS 每磁盘写入字节数/秒  |  OS 磁盘写入字节数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  OS 每磁盘写入操作数/秒  |  OS 磁盘写入操作数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  出站流  |  出站流  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  出站流的最大创建速率  |  出站流的最大创建速率（预览）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  每磁盘 QD  |  数据磁盘 QD （已弃用）  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  每磁盘读取字节数/秒  |  数据磁盘读取字节数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  每磁盘读取操作数/秒  |  数据磁盘读取操作数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  每磁盘写入字节数/秒  |  数据磁盘写入字节数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets  |  每磁盘写入操作数/秒  |  数据磁盘写入操作数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
...
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  入站流  |  入站流  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  入站流最大创建速率  |  入站流最大创建速率（预览）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  网络传入  |  收费网络（不推荐使用）  |  字节  |  总计 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  网络总数  |  网络总数  |  字节  |  总计 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  网络传出  |  网络出量（不推荐使用）  |  字节  |  总计 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  网络传出总数  |  网络传出总数  |  字节  |  总计 | 
...
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  OS 每磁盘 QD  |  OS Disk QD （已弃用）  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  OS 每磁盘读取字节数/秒  |  OS 磁盘读取字节数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  OS 每磁盘读取操作数/秒  |  OS 磁盘读取操作数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  OS 每磁盘写入字节数/秒  |  OS 磁盘写入字节数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  OS 每磁盘写入操作数/秒  |  OS 磁盘写入操作数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  出站流  |  出站流  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  出站流的最大创建速率  |  出站流的最大创建速率（预览）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  每磁盘 QD  |  数据磁盘 QD （已弃用）  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  每磁盘读取字节数/秒  |  数据磁盘读取字节数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  每磁盘读取操作数/秒  |  数据磁盘读取操作数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  每磁盘写入字节数/秒  |  数据磁盘写入字节数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Compute/virtualMachineScaleSets/virtualMachines  |  每磁盘写入操作数/秒  |  数据磁盘写入操作数/秒（不推荐使用）  |  每秒计数  |  平均值 | 
...
| **是**  | 否 |  Microsoft.ContainerRegistry/registries  |  SuccessfulPullCount  |  成功的请求计数  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.ContainerRegistry/registries  |  SuccessfulPushCount  |  推送计数成功  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.ContainerRegistry/registries  |  TotalPullCount  |  请求总数  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.ContainerRegistry/registries  |  TotalPushCount  |  推送计数总计  |  Count  |  平均值 | 
...
| **是**  | 否 |  Microsoft.DataBoxEdge/dataBoxEdgeDevices  |  BytesUploadedToCloud  |  已上传云字节（设备）  |  字节  |  平均值 | 
| **是**  | 否 |  Microsoft.DataBoxEdge/dataBoxEdgeDevices  |  BytesUploadedToCloudPerShare  |  已上传云字节数（共享）  |  字节  |  平均值 | 
...
| **是**  | 否 |  Microsoft.DataBoxEdge/dataBoxEdgeDevices  |  HyperVMemoryUtilization  |  边缘计算-内存使用情况  |  百分比  |  平均值 | 
| **是**  | 否 |  Microsoft.DataBoxEdge/dataBoxEdgeDevices  |  HyperVVirtualProcessorUtilization  |  边缘计算-CPU 百分比  |  百分比  |  平均值 | 
...
| **是**  | 否 |  Microsoft.DataFactory/factories  |  ActivityCancelledRuns  |  已取消的活动运行指标  |  Count  |  总计 | 
...
| **是**  | 否 |  Microsoft.DataFactory/factories  |  FactorySizeInGbUnits  |  总工厂大小（GB 单位）  |  Count  |  最大值 | 
...
| **是**  | 否 |  Microsoft.DataFactory/factories  |  MaxAllowedFactorySizeInGbUnits  |  允许的最大工厂大小（GB 单位）  |  Count  |  最大值 | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  MaxAllowedResourceCount  |  允许的最大实体计数  |  Count  |  最大值 | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  PipelineCancelledRuns  |  已取消的管道运行指标  |  Count  |  总计 | 
...
| **是**  | 否 |  Microsoft.DataFactory/factories  |  TriggerCancelledRuns  |  已取消的触发器运行指标  |  Count  |  总计 | 
...
| **是**  | **是** |  Microsoft. 设备/帐户  |  digitaltwins  |  数字孪生节点遥测占位符  |  Count  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.commands.egress.abandon.success  |  C2D 消息已放弃  |  Count  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.commands.egress.complete.success  |  已完成 C2D 消息传递  |  Count  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.commands.egress.reject.success  |  已拒绝 C2D 消息  |  Count  |  总计 | 
...
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  C2DMessagesExpired  |  C2D 消息已过期（预览版）  |  Count  |  总计 | 
...
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  deviceDataUsage  |  设备数据总使用量  |  字节  |  总计 | 
...
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  EventGridDeliveries  |  事件网格传递（预览）  |  Count  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  EventGridLatency  |  事件网格延迟（预览版）  |  毫秒  |  平均值 | 
...
| 否  | 否 |  EnterpriseKnowledgeGraph/服务  |  FailureCount  |  失败计数  |  Count  |  Count | 
| 否  | 否 |  EnterpriseKnowledgeGraph/服务  |  成功计数  |  成功计数  |  Count  |  Count | 
| 否  | 否 |  EnterpriseKnowledgeGraph/服务  |  SuccessLatency  |  成功延迟  |  毫秒  |  平均值 | 
| 否  | 否 |  EnterpriseKnowledgeGraph/服务  |  TransactionCount  |  事务计数  |  Count  |  Count | 
...
| **是**  | **是** |  Microsoft.EventGrid/domains  |  PublishFailCount  |  发布失败事件  |  Count  |  总计 | 
...
| **是**  | **是** |  Microsoft.EventGrid/extensionTopics  |  PublishFailCount  |  发布失败事件  |  Count  |  总计 | 
...
| **是**  | **是** |  Microsoft.EventGrid/topics  |  PublishFailCount  |  发布失败事件  |  Count  |  总计 | 
...
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHABL  |  存档积压消息（已弃用）  |  Count  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHAMBS  |  存档消息吞吐量（不推荐使用）  |  字节  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHAMSGS  |  存档消息（已弃用）  |  Count  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHINBYTES  |  传入字节（已弃用）  |  字节  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHINMBS  |  传入字节（已过时）（不推荐使用）  |  字节  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHINMSGS  |  传入消息（已弃用）  |  Count  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHOUTBYTES  |  传出字节（已弃用）  |  字节  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHOUTMBS  |  传出字节数（已过时）（不推荐使用）  |  字节  |  总计 | 
...
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  INMSGS  |  传入消息（已过时）（不推荐使用）  |  Count  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  INREQS  |  传入请求（已弃用）  |  Count  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  INTERR  |  内部服务器错误（已弃用）  |  Count  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  MISCERR  |  其他错误（不推荐使用）  |  Count  |  总计 | 
...
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  OUTMSGS  |  传出消息（已过时）（不推荐使用）  |  Count  |  总计 | 
...
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  SVRBSY  |  服务器忙错误（已弃用）  |  Count  |  总计 | 
...
| **是**  | 否 |  Microsoft.HDInsight/clusters  |  ScalingRequests  |  缩放请求  |  Count  |  最大值 | 
...
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  ContinuousExportMaxLatenessMinutes  |  连续导出最大迟到分钟数  |  Count  |  最大值 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  ContinuousExportNumOfRecordsExported  |  连续导出-导出记录的数目  |  Count  |  总计 | 
...
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  EventsProcessedForEventHubs  |  处理的事件数（适用于事件/IoT 中心）  |  Count  |  总计 | 
...
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  IngestionVolumeInMB  |  引入卷（MB）  |  Count  |  总计 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  KeepAlive  |  保持活动状态  |  Count  |  平均值 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  QueryDuration  |  查询持续时间  |  毫秒  |  平均值 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  SteamingIngestRequestRate  |  流式处理引入请求速率  |  Count  |  RateRequestsPerSecond | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  StreamingIngestDataRate  |  流引入数据速率  |  Count  |  平均值 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  StreamingIngestDuration  |  流摄取持续时间  |  毫秒  |  平均值 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  StreamingIngestResults  |  流式处理引入结果  |  Count  |  平均值 | 
...
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  RunsCancelled  |  已取消运行  |  Count  |  总计 | 
...
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  RunStartThrottledEvents  |  运行启动限制事件  |  Count  |  总计 | 
...
| **是**  | **是** |  Microsoft.Logic/workflows  |  RunsCancelled  |  已取消运行  |  Count  |  总计 | 
...
| **是**  | **是** |  Microsoft.Logic/workflows  |  RunStartThrottledEvents  |  运行启动限制事件  |  Count  |  总计 | 
...
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  活动核心  |  活动核心  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  活动节点  |  活动节点  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  已完成运行  |  已完成运行  |  Count  |  总计 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  失败的运行次数  |  失败的运行次数  |  Count  |  总计 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  空闲内核数  |  空闲内核数  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  空闲节点  |  空闲节点  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  正在离开内核  |  正在离开内核  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  退出节点  |  退出节点  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  模型部署失败  |  模型部署失败  |  Count  |  总计 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  模型部署已启动  |  模型部署已启动  |  Count  |  总计 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  模型部署成功  |  模型部署成功  |  Count  |  总计 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  模型注册失败  |  模型注册失败  |  Count  |  总计 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  模型注册成功  |  模型注册成功  |  Count  |  总计 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  抢先核心  |  抢先核心  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  抢占节点  |  抢占节点  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  配额使用率百分比  |  配额使用率百分比  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  已开始运行  |  已开始运行  |  Count  |  总计 | 
...
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  不可用内核  |  不可用内核  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  不可用节点  |  不可用节点  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.Maps/accounts  |  可用性  |  可用性  |  百分比  |  平均值 | 
| 否  | 否 |  Microsoft.Maps/accounts  |  使用情况  |  使用情况  |  Count  |  Count | 
| **是**  | 否 |  Microsoft. Media/windowsazure.mediaservices  |  AssetCount  |  资产计数  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft. Media/windowsazure.mediaservices  |  AssetQuota  |  资产配额  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft. Media/windowsazure.mediaservices  |  AssetQuotaUsedPercentage  |  资产配额已用百分比  |  百分比  |  平均值 | 
| **是**  | 否 |  Microsoft. Media/windowsazure.mediaservices  |  ContentKeyPolicyCount  |  内容密钥策略计数  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft. Media/windowsazure.mediaservices  |  ContentKeyPolicyQuota  |  内容密钥策略配额  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft. Media/windowsazure.mediaservices  |  ContentKeyPolicyQuotaUsedPercentage  |  内容密钥策略配额已用百分比  |  百分比  |  平均值 | 
| **是**  | 否 |  Microsoft. Media/windowsazure.mediaservices  |  StreamingPolicyCount  |  流式处理策略计数  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft. Media/windowsazure.mediaservices  |  StreamingPolicyQuota  |  流式处理策略配额  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft. Media/windowsazure.mediaservices  |  StreamingPolicyQuotaUsedPercentage  |  流式处理策略配额已用百分比  |  百分比  |  平均值 | 
| **是**  | 否 |  Windowsazure.mediaservices/Streamingendpoint  |  流出量  |  流出量  |  字节  |  总计 | 
| **是**  | 否 |  Windowsazure.mediaservices/Streamingendpoint  |  Requests  |  Requests  |  Count  |  总计 | 
| **是**  | 否 |  Windowsazure.mediaservices/Streamingendpoint  |  SuccessE2ELatency  |  成功的端到端延迟  |  毫秒  |  平均值 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  GCPauseTotalCount  |  GC 暂停计数  |  Count  |  总计 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  GCPauseTotalTime  |  GC 暂停总时间  |  毫秒  |  总计 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  MaxOldGenMemoryPoolBytes  |  最大可用旧生成数据大小  |  字节  |  平均值 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  OldGenMemoryPoolBytes  |  旧生成数据大小  |  字节  |  平均值 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  OldGenPromotedBytes  |  提升为旧的生成数据大小  |  字节  |  最大值 | 
...
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatErrorCount  |  Tomcat 全局错误  |  Count  |  总计 | 
...
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatRequestTotalCount  |  Tomcat 请求总数  |  Count  |  总计 | 
...
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionActiveCurrentCount  |  Tomcat 会话活动计数  |  Count  |  总计 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionActiveMaxCount  |  Tomcat 会话最大活动计数  |  Count  |  总计 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionAliveMaxTime  |  Tomcat 会话最大活动时间  |  毫秒  |  最大值 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionCreatedCount  |  Tomcat 会话创建计数  |  Count  |  总计 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionExpiredCount  |  Tomcat 会话过期计数  |  Count  |  总计 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionRejectedCount  |  Tomcat 会话已拒绝计数  |  Count  |  总计 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  YoungGenPromotedBytes  |  提升为年轻生成数据大小  |  字节  |  最大值 | 
...
| **是**  | 否 |  NetAppAccounts/capacityPools/卷  |  AverageReadLatency  |  平均读取延迟  |  毫秒  |  平均值 | 
| **是**  | 否 |  NetAppAccounts/capacityPools/卷  |  AverageWriteLatency  |  平均写入延迟  |  毫秒  |  平均值 | 
| **是**  | 否 |  NetAppAccounts/capacityPools/卷  |  ReadIops  |  读取 IOPS  |  每秒计数  |  平均值 | 
| **是**  | 否 |  NetAppAccounts/capacityPools/卷  |  VolumeLogicalSize  |  卷逻辑大小  |  字节  |  平均值 | 
| **是**  | 否 |  NetAppAccounts/capacityPools/卷  |  VolumeSnapshotSize  |  卷快照大小  |  字节  |  平均值 | 
| **是**  | 否 |  NetAppAccounts/capacityPools/卷  |  WriteIops  |  写入 IOPS  |  每秒计数  |  平均值 | 
| 否  | 否 |  Microsoft.Network/applicationGateways  |  ApplicationGatewayTotalTime  |  应用程序网关总时间  |  毫秒  |  平均值 | 
| 否  | 否 |  Microsoft.Network/applicationGateways  |  AvgRequestCountPerHealthyHost  |  每分钟每个正常主机的请求数  |  Count  |  平均值 | 
| 否  | 否 |  Microsoft.Network/applicationGateways  |  BackendConnectTime  |  后端连接时间  |  毫秒  |  平均值 | 
| 否  | 否 |  Microsoft.Network/applicationGateways  |  BackendFirstByteResponseTime  |  后端首字节响应时间  |  毫秒  |  平均值 | 
| 否  | 否 |  Microsoft.Network/applicationGateways  |  BackendLastByteResponseTime  |  后端最后字节响应时间  |  毫秒  |  平均值 | 
...
| 否  | 否 |  Microsoft.Network/applicationGateways  |  ComputeUnits  |  当前计算单元  |  Count  |  平均值 | 
...
| **是**  | 否 |  Microsoft.Network/azurefirewalls  |  ApplicationRuleHit  |  应用程序规则命中计数  |  Count  |  总计 | 
...
| **是**  | 否 |  Microsoft.Network/azurefirewalls  |  NetworkRuleHit  |  网络规则命中计数  |  Count  |  总计 | 
...
| 否  | 否 |  ExpressRouteGateways/网络  |  ErGatewayConnectionBitsInPerSecond  |  BitsInPerSecond  |  每秒计数  |  平均值 | 
| 否  | 否 |  ExpressRouteGateways/网络  |  ErGatewayConnectionBitsOutPerSecond  |  BitsOutPerSecond  |  每秒计数  |  平均值 | 
| **是**  | 否 |  ExpressRoutePorts/网络  |  AdminState  |  AdminState  |  Count  |  平均值 | 
| **是**  | 否 |  ExpressRoutePorts/网络  |  LineProtocol  |  LineProtocol  |  Count  |  平均值 | 
| **是**  | 否 |  ExpressRoutePorts/网络  |  PortBitsInPerSecond  |  BitsInPerSecond  |  每秒计数  |  平均值 | 
| **是**  | 否 |  ExpressRoutePorts/网络  |  PortBitsOutPerSecond  |  BitsOutPerSecond  |  每秒计数  |  平均值 | 
| **是**  | 否 |  ExpressRoutePorts/网络  |  RxLightLevel  |  RxLightLevel  |  Count  |  平均值 | 
| **是**  | 否 |  ExpressRoutePorts/网络  |  TxLightLevel  |  TxLightLevel  |  Count  |  平均值 | 
...
| **是**  | 否 |  Microsoft.Network/virtualNetworks  |  PingMeshProbesFailedPercent  |  向 VM 进行 Ping 操作失败  |  百分比  |  平均值 | 
...
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. 磁盘秒数/读取  |  Avg. Disk sec/Read  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. 磁盘秒数/读取  |  Avg. Disk sec/Read  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. 磁盘秒数/传输  |  Avg. Disk sec/Transfer  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. 磁盘秒数/写入  |  Avg. Disk sec/Write  |  Count  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. 磁盘秒数/写入  |  Avg. Disk sec/Write  |  Count  |  平均值 | 
...
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  CPUXNS  |  CPU （不推荐使用）  |  百分比  |  最大值 | 
...
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  ScheduledMessages  |  队列/主题中计划消息的计数。  |  Count  |  平均值 | 
...
| **是**  | 否 |  Microsoft.Sql/servers/databases  |  allocated_data_storage  |  已分配数据空间  |  字节  |  平均值 | 
| **是**  | 否 |  Microsoft.Sql/servers/databases  |  app_cpu_billed  |  应用 CPU 计费  |  Count  |  总计 | 
...
| **是**  | 否 |  Microsoft.Sql/servers/databases  |  tempdb_log_used_percent  |  使用的 Tempdb 百分比日志  |  百分比  |  最大值 | 
...
| **是**  | 否 |  Microsoft.Sql/servers/elasticPools  |  allocated_data_storage  |  已分配数据空间  |  字节  |  平均值 | 
| **是**  | 否 |  Microsoft.Sql/servers/elasticPools  |  allocated_data_storage_percent  |  已分配的数据空间百分比  |  百分比  |  最大值 | 
...
| 否  | 否 |  Microsoft.Sql/servers/elasticPools  |  database_allocated_data_storage  |  已分配数据空间  |  字节  |  平均值 | 
...
| **是**  | 否 |  Microsoft.Sql/servers/elasticPools  |  tempdb_log_used_percent  |  使用的 Tempdb 百分比日志  |  百分比  |  最大值 | 
...
| **是**  | 否 |  StorageCache/缓存  |  ClientIOPS  |  客户端 IOPS 总数  |  Count  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  ClientLatency  |  平均客户端延迟  |  毫秒  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  ClientLockIOPS  |  客户端锁定 IOPS  |  每秒计数  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  ClientMetadataReadIOPS  |  客户端元数据读取 IOPS  |  每秒计数  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  ClientMetadataWriteIOPS  |  客户端元数据写入 IOPS  |  每秒计数  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  ClientReadIOPS  |  客户端读取 IOPS  |  每秒计数  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  ClientReadThroughput  |  平均缓存读取吞吐量  |  每秒字节数  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  ClientWriteIOPS  |  客户端写入 IOPS  |  每秒计数  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  ClientWriteThroughput  |  平均缓存写入吞吐量  |  每秒字节数  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  StorageTargetAsyncWriteThroughput  |  StorageTarget 异步写入吞吐量  |  每秒字节数  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  StorageTargetFillThroughput  |  StorageTarget 填充吞吐量  |  每秒字节数  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  StorageTargetHealth  |  存储目标运行状况  |  Count  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  StorageTargetIOPS  |  StorageTarget IOPS 总数  |  Count  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  StorageTargetLatency  |  StorageTarget 延迟  |  毫秒  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  StorageTargetMetadataReadIOPS  |  StorageTarget 元数据读取 IOPS  |  每秒计数  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  StorageTargetMetadataWriteIOPS  |  StorageTarget 元数据写入 IOPS  |  每秒计数  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  StorageTargetReadAheadThroughput  |  StorageTarget 读取提前吞吐量  |  每秒字节数  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  StorageTargetReadIOPS  |  StorageTarget 读取 IOPS  |  每秒计数  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  StorageTargetSyncWriteThroughput  |  StorageTarget 同步写入吞吐量  |  每秒字节数  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  StorageTargetTotalReadThroughput  |  StorageTarget 总读取吞吐量  |  每秒字节数  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  StorageTargetTotalWriteThroughput  |  StorageTarget 总写入吞吐量  |  每秒字节数  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  StorageTargetWriteIOPS  |  StorageTarget 写入 IOPS  |  Count  |  平均值 | 
| **是**  | 否 |  StorageCache/缓存  |  运行时间  |  运行时间  |  Count  |  平均值 | 
...
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  StorageSyncRecalledNetworkBytesByApplication  |  云分层通过应用程序撤回大小  |  字节  |  总计 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  StorageSyncRecalledTotalNetworkBytes  |  云分层撤回大小  |  字节  |  总计 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  StorageSyncRecallIOTotalSizeBytes  |  云分层回调  |  字节  |  总计 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  StorageSyncRecallThroughputBytesPerSecond  |  云分层召回吞吐量  |  每秒字节数  |  平均值 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  StorageSyncServerHeartbeat  |  服务器联机状态  |  Count  |  最大值 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  StorageSyncSyncSessionAppliedFilesCount  |  已同步文件  |  Count  |  总计 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  StorageSyncSyncSessionPerItemErrorsCount  |  未同步的文件  |  Count  |  总计 | 
| **是**  | 否 |  storagesync.sys/storageSyncServices/registeredServers  |  ServerHeartbeat  |  服务器联机状态  |  Count  |  最大值 | 
| **是**  | 否 |  storagesync.sys/storageSyncServices/registeredServers  |  ServerRecallIOTotalSizeBytes  |  云分层回调  |  字节  |  总计 | 
| **是**  | 否 |  storagesync.sys/storageSyncServices/syncGroups  |  SyncGroupBatchTransferredFileBytes  |  同步的字节数  |  字节  |  总计 | 
| **是**  | 否 |  storagesync.sys/storageSyncServices/syncGroups  |  SyncGroupSyncSessionAppliedFilesCount  |  已同步文件  |  Count  |  总计 | 
| **是**  | 否 |  storagesync.sys/storageSyncServices/syncGroups  |  SyncGroupSyncSessionPerItemErrorsCount  |  未同步的文件  |  Count  |  总计 | 
| **是**  | 否 |  storagesync.sys/storageSyncServices/syncGroups/serverEndpoints  |  ServerEndpointBatchTransferredFileBytes  |  同步的字节数  |  字节  |  总计 | 
| **是**  | 否 |  storagesync.sys/storageSyncServices/syncGroups/serverEndpoints  |  ServerEndpointSyncSessionAppliedFilesCount  |  已同步文件  |  Count  |  总计 | 
| **是**  | 否 |  storagesync.sys/storageSyncServices/syncGroups/serverEndpoints  |  ServerEndpointSyncSessionPerItemErrorsCount  |  未同步的文件  |  Count  |  总计 | 
...
| **是**  | 否 |  Microsoft.VMwareCloudSimple/virtualMachines  |  MemoryUsed  |  使用的内存  |  字节  |  平均值 | 
...
| **是**  | 否 |  Microsoft.VMwareCloudSimple/virtualMachines  |  NetworkInBytesPerSecond  |  网络字节数/秒  |  每秒字节数  |  平均值 | 
...
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpClosing  |  TCP 关闭  |  Count  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpEstablished  |  已建立 TCP  |  Count  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpFinWait1  |  TCP Fin 等待1  |  Count  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpFinWait2  |  TCP Fin 等待2  |  Count  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpLastAck  |  TCP 上次确认  |  Count  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpSynReceived  |  已收到 TCP Syn  |  Count  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpSynSent  |  TCP Syn 已发送  |  Count  |  平均值 | 
