...
|---|---| ---- | ----- | ------ | ---- | ---- | 
| 是 * * * *  | 否 |  Microsoft.AnalysisServices/servers  |  CleanerCurrentPrice  |  内存: 清理器当前价格  |  计数  |  平均值 | 
...
| 是 * * * *  | 否 |  Microsoft.AnalysisServices/servers  |  CommandPoolBusyThreads  |  线程: 命令池繁忙线程数  |  计数  |  平均值 | 
| 是 * * * *  | 否 |  Microsoft.AnalysisServices/servers  |  CommandPoolIdleThreads  |  线程: 命令池空闲线程数  |  计数  |  平均值 | 
| 是 * * * *  | 否 |  Microsoft.AnalysisServices/servers  |  CommandPoolJobQueueLength  |  命令池作业队列长度  |  计数  |  平均值 | 
| 是 * * * *  | 否 |  Microsoft.AnalysisServices/servers  |  CurrentConnections  |  连接: 当前连接数  |  计数  |  平均值 | 
| 是 * * * *  | 否 |  Microsoft.AnalysisServices/servers  |  CurrentUserSessions  |  当前用户会话数  |  计数  |  平均值 | 
| 是 * * * *  | 否 |  Microsoft.AnalysisServices/servers  |  LongParsingBusyThreads  |  线程: 长分析繁忙线程数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.AnalysisServices/servers  |  LongParsingIdleThreads  |  线程: 长分析空闲线程数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.AnalysisServices/servers  |  LongParsingJobQueueLength  |  线程: 长分析作业队列长度  |  计数  |  平均值 | 
...
| **是**  | 否 |  Microsoft.AnalysisServices/servers  |  mashup_engine_qpu_metric  |  M 引擎 QPU  |  计数  |  平均值 | 
...
| **是**  | 否 |  Microsoft.AnalysisServices/servers  |  MemoryUsage  |  内存: 内存使用量  |  字节  |  平均值 | 
| **是**  | 否 |  Microsoft.AnalysisServices/servers  |  private_bytes_metric  |  专用字节  |  字节  |  平均值 | 
| **是**  | 否 |  Microsoft.AnalysisServices/servers  |  ProcessingPoolBusyIOJobThreads  |  线程: 处理池繁忙 I/O 作业线程数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.AnalysisServices/servers  |  ProcessingPoolBusyNonIOThreads  |  线程: 处理池繁忙非 I/O 线程数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.AnalysisServices/servers  |  ProcessingPoolIdleIOJobThreads  |  线程: 处理池空闲 I/O 作业线程数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.AnalysisServices/servers  |  ProcessingPoolIdleNonIOThreads  |  线程: 处理池空闲非 I/O 线程数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.AnalysisServices/servers  |  ProcessingPoolIOJobQueueLength  |  线程: 处理池 I/O 作业队列长度  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.AnalysisServices/servers  |  ProcessingPoolJobQueueLength  |  处理池作业队列长度  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.AnalysisServices/servers  |  qpu_metric  |  QPU  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.AnalysisServices/servers  |  QueryPoolBusyThreads  |  查询池繁忙线程数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.AnalysisServices/servers  |  QueryPoolIdleThreads  |  线程: 查询池空闲线程数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.AnalysisServices/servers  |  QueryPoolJobQueueLength  |  线程: 查询池作业队列长度  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.AnalysisServices/servers  |  Quota  |  内存: 配额  |  字节  |  平均值 | 
| **是**  | 否 |  Microsoft.AnalysisServices/servers  |  QuotaBlocked  |  内存: 阻止的配额  |  计数  |  平均值 | 
...
| **是**  | 否 |  Microsoft.AppPlatform/Spring  |  OldGenMemoryPoolBytes  |  旧代数据大小  |  字节  |  平均值 | 
...
| **是**  | 否 |  Microsoft.Batch/batchAccounts  |  PoolResizeStartEvent  |  池调整大小启动事件数  |  计数  |  总计 | 
...
| **是**  | 否 |  Microsoft.Cache/redis  |  evictedkeys9  |  逐出的密钥数(分片 9)  |  计数  |  总计 | 
...
| **是**  | 否 |  Microsoft.Cache/redis  |  totalcommandsprocessed6  |  总操作数(分片 6)  |  计数  |  总计 | 
...
| **是**  | 否 |  Microsoft.CognitiveServices/accounts  |  TotalTokenCalls  |  令牌调用总数  |  计数  |  总计 | 
...
| **是**  | 否 |  Microsoft.Compute/virtualMachines  |  高级数据磁盘缓存读取命中  |  高级数据磁盘缓存读取命中（预览版）  |  百分比  |  平均值 | 
...
| **是**  | 否 |  Microsoft.DataFactory/factories  |  ActivityFailedRuns  |  失败的活动运行数指标  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  ActivitySucceededRuns  |  成功的活动运行数指标  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  FactorySizeInGbUnits  |  总工厂大小（以 GB 为单位）  |  计数  |  最大值 | 
...
| **是**  | 否 |  Microsoft.DataFactory/factories  |  IntegrationRuntimeQueueLength  |  集成运行时队列长度  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  MaxAllowedFactorySizeInGbUnits  |  允许的最大工厂大小（以 GB 为单位）  |  计数  |  最大值 | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  MaxAllowedResourceCount  |  允许的最大实体计数  |  计数  |  最大值 | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  PipelineCancelledRuns  |  已取消的管道运行指标数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  PipelineFailedRuns  |  失败的管道运行数指标  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  PipelineSucceededRuns  |  成功的管道运行数指标  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  ResourceCount  |  实体总数  |  计数  |  最大值 | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  TriggerCancelledRuns  |  已取消的触发器运行指标数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  TriggerFailedRuns  |  失败的触发器运行数指标  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.DataFactory/factories  |  TriggerSucceededRuns  |  成功的触发器运行数指标  |  计数  |  总计 | 
...
| **是**  | 否 |  Microsoft.DataLakeAnalytics/accounts  |  JobEndedCancelled  |  取消的作业数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.DataLakeAnalytics/accounts  |  JobEndedFailure  |  失败作业数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.DataLakeAnalytics/accounts  |  JobEndedSuccess  |  成功作业数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.DataLakeStore/accounts  |  DataRead  |  读取的数据量  |  字节  |  总计 | 
| **是**  | 否 |  Microsoft.DataLakeStore/accounts  |  DataWritten  |  写入的数据量  |  字节  |  总计 | 
| **是**  | 否 |  Microsoft.DataLakeStore/accounts  |  ReadRequests  |  读取请求数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.DataLakeStore/accounts  |  TotalStorage  |  总存储  |  字节  |  最大值 | 
| **是**  | 否 |  Microsoft.DataLakeStore/accounts  |  WriteRequests  |  写入请求数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.DBforMariaDB/servers  |  active_connections  |  活动连接数  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.DBforMariaDB/servers  |  backup_storage_used  |  已用的备份存储  |  字节  |  平均值 | 
| **是**  | **是** |  Microsoft.DBforMariaDB/servers  |  connections_failed  |  失败的连接数  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.DBforMariaDB/servers  |  seconds_behind_master  |  复制延迟（秒）  |  计数  |  最大值 | 
...
| **是**  | **是** |  Microsoft.DBforMySQL/servers  |  active_connections  |  活动连接数  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.DBforMySQL/servers  |  backup_storage_used  |  已用的备份存储  |  字节  |  平均值 | 
| **是**  | **是** |  Microsoft.DBforMySQL/servers  |  connections_failed  |  失败的连接数  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.DBforMySQL/servers  |  seconds_behind_master  |  复制延迟（秒）  |  计数  |  最大值 | 
...
| **是**  | 否 |  Microsoft.DBforPostgreSQL/servers  |  active_connections  |  活动连接数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.DBforPostgreSQL/servers  |  backup_storage_used  |  已用的备份存储  |  字节  |  平均值 | 
| **是**  | 否 |  Microsoft.DBforPostgreSQL/servers  |  connections_failed  |  失败的连接数  |  计数  |  总计 | 
...
| **是**  | 否 |  Microsoft.DBforPostgreSQL/serversv2  |  active_connections  |  活动连接数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.DBforPostgreSQL/serversv2  |  cpu_percent  |  CPU 百分比  |  百分比  |  平均值 | 
| **是**  | 否 |  Microsoft.DBforPostgreSQL/serversv2  |  iops  |  IOPS  |  计数  |  平均值 | 
...
| **是**  | **是** |  Microsoft. 设备/帐户  |  digitaltwins  |  数字孪生节点遥测占位符  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.commands.egress.abandon.success  |  丢弃的 C2D 消息数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.commands.egress.complete.success  |  已完成的 C2D 消息传递次数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.commands.egress.reject.success  |  拒绝的 C2D 消息数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.methods.failure  |  失败的直接方法调用数  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.methods.success  |  成功的直接方法调用数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.twin.read.failure  |  后端的失败克隆读取数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.twin.read.size  |  后端的克隆读取的响应大小  |  字节  |  平均值 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.twin.read.success  |  后端的成功克隆读取数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.twin.update.failure  |  后端的失败克隆更新数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.twin.update.size  |  后端的克隆更新的大小  |  字节  |  平均值 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  c2d.twin.update.success  |  后端的成功克隆更新数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  C2DMessagesExpired  |  过期的 C2D 消息数（预览版）  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  配置  |  配置指标  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.Devices/IotHubs  |  connectedDeviceCount  |  已连接设备数（预览）  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.endpoints.egress.builtIn.events  |  路由：发送到消息/事件的消息数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.endpoints.egress.eventHubs  |  路由：已发送到事件中心的消息数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.endpoints.egress.serviceBusQueues  |  路由：已发送到服务总线队列的消息数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.endpoints.egress.serviceBusTopics  |  路由：发送到服务总线主题的消息数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.endpoints.egress.storage  |  路由：发送到存储器的消息数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.endpoints.egress.storage.blobs  |  路由：发送到存储器的 blob 数  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.egress.dropped  |  路由：已删除的遥测消息数   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.egress.fallback  |  路由：发送到回退的消息数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.egress.invalid  |  路由：不兼容的遥测消息数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.egress.orphaned  |  路由：已孤立的遥测消息数   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.egress.success  |  路由：已发送的遥测消息数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.ingress.allProtocol  |  遥测消息发送尝试次数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.ingress.sendThrottle  |  限制错误数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.telemetry.ingress.success  |  已发送的遥测消息数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.twin.read.failure  |  设备的失败克隆读取数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.twin.read.size  |  设备的克隆读取的响应大小  |  字节  |  平均值 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.twin.read.success  |  设备的成功克隆读取数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.twin.update.failure  |  设备的失败克隆更新数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.twin.update.size  |  设备的克隆更新的大小  |  字节  |  平均值 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  d2c.twin.update.success  |  设备的成功克隆更新数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  dailyMessageQuotaUsed  |  已使用的消息总数  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  deviceDataUsage  |  设备数据用量总计  |  字节  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  deviceDataUsageV2  |  设备数据使用总量（预览）  |  字节  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  devices.connectedDevices.allProtocol  |  （已弃用）连接设备数   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  devices.totalDevices  |  （已弃用）设备总数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  EventGridDeliveries  |  事件网格传递次数（预览版）  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  EventGridLatency  |  事件网格延迟（预览）  |  毫秒  |  平均值 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.cancelJob.failure  |  失败的作业取消数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.cancelJob.success  |  成功的作业取消数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.completed  |  已完成的作业  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.createDirectMethodJob.failure  |  方法调用作业的创建失败数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.createDirectMethodJob.success  |  方法调用作业的创建成功数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.createTwinUpdateJob.failure  |  克隆更新作业创建失败数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.createTwinUpdateJob.success  |  克隆更新作业创建成功数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.failed  |  失败的作业数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.listJobs.failure  |  对列出作业的失败调用数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.listJobs.success  |  对列出作业的成功调用数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.queryJobs.failure  |  失败的作业查询数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  jobs.queryJobs.success  |  成功的作业查询数  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.Devices/IotHubs  |  totalDeviceCount  |  设备总数（预览）  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  twinQueries.failure  |  失败的克隆查询  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  twinQueries.resultSize  |  克隆查询结果大小  |  字节  |  平均值 | 
| **是**  | **是** |  Microsoft.Devices/IotHubs  |  twinQueries.success  |  成功的克隆查询  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/provisioningServices  |  AttestationAttempts  |  证明尝试次数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/provisioningServices  |  DeviceAssignments  |  已分配设备  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Devices/provisioningServices  |  RegistrationAttempts  |  注册尝试次数  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.DocumentDB/databaseAccounts  |  AvailableStorage  |  可用存储  |  字节  |  总计 | 
| 否  | 否 |  Microsoft.DocumentDB/databaseAccounts  |  CassandraConnectionClosures  |  Cassandra 连接关闭数  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.DocumentDB/databaseAccounts  |  CassandraRequestCharges  |  Cassandra 请求费用  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.DocumentDB/databaseAccounts  |  CassandraRequests  |  Cassandra 请求数  |  计数  |  计数 | 
| 否  | 否 |  Microsoft.DocumentDB/databaseAccounts  |  DataUsage  |  数据使用情况  |  字节  |  总计 | 
| **是**  | 否 |  Microsoft.DocumentDB/databaseAccounts  |  DeleteVirtualNetwork  |  DeleteVirtualNetwork  |  计数  |  计数 | 
| 否  | 否 |  Microsoft.DocumentDB/databaseAccounts  |  DocumentCount  |  文档计数  |  计数  |  总计 | 
...
| 否  | 否 |  Microsoft.DocumentDB/databaseAccounts  |  MetadataRequests  |  元数据请求  |  计数  |  计数 | 
| **是**  | **是** |  Microsoft.DocumentDB/databaseAccounts  |  MongoRequestCharge  |  Mongo 请求费用  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.DocumentDB/databaseAccounts  |  MongoRequests  |  Mongo 请求  |  计数  |  计数 | 
...
| 否  | 否 |  Microsoft.DocumentDB/databaseAccounts  |  ProvisionedThroughput  |  预配的吞吐量  |  计数  |  最大值 | 
...
| **是**  | **是** |  Microsoft.DocumentDB/databaseAccounts  |  TotalRequests  |  请求总数  |  计数  |  计数 | 
| **是**  | **是** |  Microsoft.DocumentDB/databaseAccounts  |  TotalRequestUnits  |  总请求单位数  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.EnterpriseKnowledgeGraph/services  |  FailureCount  |  失败计数  |  计数  |  计数 | 
| 否  | 否 |  Microsoft.EnterpriseKnowledgeGraph/services  |  SuccessCount  |  成功计数  |  计数  |  计数 | 
| 否  | 否 |  Microsoft.EnterpriseKnowledgeGraph/services  |  SuccessLatency  |  成功延迟  |  毫秒  |  平均值 | 
| 否  | 否 |  Microsoft.EnterpriseKnowledgeGraph/services  |  TransactionCount  |  事务计数  |  计数  |  计数 | 
| **是**  | **是** |  Microsoft.EventGrid/domains  |  DeadLetteredCount  |  死信事件数  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.EventGrid/domains  |  DeliveryAttemptFailCount  |  发送失败的事件数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventGrid/domains  |  DeliverySuccessCount  |  发送的事件数  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.EventGrid/domains  |  DestinationProcessingDurationInMs  |  目标处理持续时间  |  毫秒  |  平均值 | 
| **是**  | **是** |  Microsoft.EventGrid/domains  |  DroppedEventCount  |  删除的事件数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventGrid/domains  |  MatchedEventCount  |  匹配的事件数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventGrid/domains  |  PublishFailCount  |  发布失败的事件数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventGrid/domains  |  PublishSuccessCount  |  发布的事件数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventGrid/domains  |  PublishSuccessLatencyInMs  |  发布成功延迟  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventGrid/eventSubscriptions  |  DeadLetteredCount  |  死信事件数  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.EventGrid/eventSubscriptions  |  DeliveryAttemptFailCount  |  发送失败的事件数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventGrid/eventSubscriptions  |  DeliverySuccessCount  |  发送的事件数  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.EventGrid/eventSubscriptions  |  DestinationProcessingDurationInMs  |  目标处理持续时间  |  毫秒  |  平均值 | 
| **是**  | **是** |  Microsoft.EventGrid/eventSubscriptions  |  DroppedEventCount  |  删除的事件数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventGrid/eventSubscriptions  |  MatchedEventCount  |  匹配的事件数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventGrid/extensionTopics  |  PublishFailCount  |  发布失败的事件数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventGrid/extensionTopics  |  PublishSuccessCount  |  发布的事件数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventGrid/extensionTopics  |  PublishSuccessLatencyInMs  |  发布成功延迟  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventGrid/extensionTopics  |  UnmatchedEventCount  |  不匹配的事件数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventGrid/topics  |  PublishFailCount  |  发布失败的事件数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventGrid/topics  |  PublishSuccessCount  |  发布的事件数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventGrid/topics  |  PublishSuccessLatencyInMs  |  发布成功延迟  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventGrid/topics  |  UnmatchedEventCount  |  不匹配的事件数  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.EventHub/clusters  |  ActiveConnections  |  ActiveConnections  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.EventHub/clusters  |  AvailableMemory  |  可用内存  |  百分比  |  最大值 | 
| 否  | 否 |  Microsoft.EventHub/clusters  |  CaptureBacklog  |  捕获积压工作(backlog)。  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.EventHub/clusters  |  CapturedBytes  |  已捕获的字节数。  |  字节  |  总计 | 
| 否  | 否 |  Microsoft.EventHub/clusters  |  CapturedMessages  |  已捕获的消息数。  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.EventHub/clusters  |  ConnectionsClosed  |  已关闭的连接数。  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.EventHub/clusters  |  ConnectionsOpened  |  打开的连接数。  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.EventHub/clusters  |  CPU  |  CPU  |  百分比  |  最大值 | 
| **是**  | **是** |  Microsoft.EventHub/clusters  |  IncomingBytes  |  传入字节数。  |  字节  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/clusters  |  IncomingMessages  |  传入消息数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/clusters  |  IncomingRequests  |  传入请求数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/clusters  |  OutgoingBytes  |  传出字节数。  |  字节  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/clusters  |  OutgoingMessages  |  传出消息数  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.EventHub/clusters  |  QuotaExceededErrors  |  超过限额错误。  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.EventHub/clusters  |  ServerErrors  |  服务器错误数。  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.EventHub/clusters  |  SuccessfulRequests  |  成功的请求数  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.EventHub/clusters  |  ThrottledRequests  |  限制的请求数。  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.EventHub/clusters  |  UserErrors  |  用户错误数。  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  ActiveConnections  |  ActiveConnections  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  CaptureBacklog  |  捕获积压工作(backlog)。  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  CapturedBytes  |  已捕获的字节数。  |  字节  |  总计 | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  CapturedMessages  |  已捕获的消息数。  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  ConnectionsClosed  |  已关闭的连接数。  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  ConnectionsOpened  |  打开的连接数。  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHABL  |  存档积压工作消息数（已弃用）  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHAMBS  |  存档消息吞吐量（已弃用）  |  字节  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHAMSGS  |  存档消息数（已弃用）  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHINBYTES  |  传入字节（已弃用）  |  字节  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHINMBS  |  传入字节数（已过时）（已弃用）  |  字节  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHINMSGS  |  传入消息（已弃用）  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  EHOUTMSGS  |  传出消息（已弃用）  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  FAILREQ  |  失败的请求数（已弃用）  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  IncomingBytes  |  传入字节数。  |  字节  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  IncomingMessages  |  传入消息数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  IncomingRequests  |  传入请求数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  INMSGS  |  传入的消息数（已过时）（已弃用）  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  INREQS  |  传入的请求数（已弃用）  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  INTERR  |  内部服务器错误数（已弃用）  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  MISCERR  |  其他错误（已弃用）  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  OutgoingBytes  |  传出字节数。  |  字节  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  OutgoingMessages  |  传出消息数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  OUTMSGS  |  传出的消息数（已过时）（已弃用）  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  QuotaExceededErrors  |  超过限额错误。  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  ServerErrors  |  服务器错误数。  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  大小  |  大小  |  字节  |  平均值 | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  SuccessfulRequests  |  成功的请求数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  SUCCREQ  |  成功的请求数（已弃用）  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.EventHub/namespaces  |  SVRBSY  |  服务器繁忙错误数（已弃用）  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  ThrottledRequests  |  限制的请求数。  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.EventHub/namespaces  |  UserErrors  |  用户错误数。  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.HDInsight/clusters  |  CategorizedGatewayRequests  |  已分类的网关请求数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.HDInsight/clusters  |  GatewayRequests  |  网关请求数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.HDInsight/clusters  |  NumActiveWorkers  |  活动辅助角色数目  |  计数  |  最大值 | 
| **是**  | 否 |  Microsoft.HDInsight/clusters  |  ScalingRequests  |  缩放请求  |  计数  |  最大值 | 
| **是**  | 否 |  Microsoft.Insights/AutoscaleSettings  |  MetricThreshold  |  指标阈值  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Insights/AutoscaleSettings  |  ObservedCapacity  |  观察到的容量  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Insights/AutoscaleSettings  |  ObservedMetricValue  |  观察到的指标值  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Insights/AutoscaleSettings  |  ScaleActionsInitiated  |  启动的缩放操作  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Insights/Components  |  availabilityResults/availabilityPercentage  |  可用性  |  百分比  |  平均值 | 
| 否  | 否 |  Microsoft.Insights/Components  |  availabilityResults/count  |  可用性测试  |  计数  |  计数 | 
...
| 否  | 否 |  Microsoft.Insights/Components  |  dependencies/count  |  依赖项调用  |  计数  |  计数 | 
| **是**  | 否 |  Microsoft.Insights/Components  |  dependencies/duration  |  依赖项持续时间  |  毫秒  |  平均值 | 
| 否  | 否 |  Microsoft.Insights/Components  |  dependencies/failed  |  依赖项调用失败次数  |  计数  |  计数 | 
| 否  | 否 |  Microsoft.Insights/Components  |  exceptions/browser  |  浏览器异常  |  计数  |  计数 | 
| **是**  | **是** |  Microsoft.Insights/Components  |  exceptions/count  |  例外  |  计数  |  计数 | 
| 否  | 否 |  Microsoft.Insights/Components  |  exceptions/server  |  服务器异常  |  计数  |  计数 | 
| **是**  | **是** |  Microsoft.Insights/Components  |  pageViews/count  |  页面视图  |  计数  |  计数 | 
...
| **是**  | **是** |  Microsoft.Insights/Components  |  performanceCounters/requestsInQueue  |  应用程序队列中的 HTTP 请求  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Insights/Components  |  performanceCounters/requestsPerSecond  |  HTTP 请求速率  |  每秒计数  |  平均值 | 
| 否  | 否 |  Microsoft.Insights/Components  |  requests/count  |  服务器请求数  |  计数  |  计数 | 
| **是**  | 否 |  Microsoft.Insights/Components  |  requests/duration  |  服务器响应时间  |  毫秒  |  平均值 | 
| 否  | 否 |  Microsoft.Insights/Components  |  requests/failed  |  失败的请求  |  计数  |  计数 | 
| 否  | 否 |  Microsoft.Insights/Components  |  requests/rate  |  服务器请求速率  |  每秒计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Insights/Components  |  traces/count  |  跟踪  |  计数  |  计数 | 
| **是**  | 否 |  Microsoft.KeyVault/vaults  |  ServiceApiHit  |  服务 API 命中总计  |  计数  |  计数 | 
| **是**  | 否 |  Microsoft.KeyVault/vaults  |  ServiceApiLatency  |  总体服务 API 延迟  |  毫秒  |  平均值 | 
| **是**  | 否 |  Microsoft.KeyVault/vaults  |  ServiceApiResult  |  服务 API 结果总计  |  计数  |  计数 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  CacheUtilization  |  缓存利用率  |  百分比  |  平均值 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  ContinuousExportMaxLatenessMinutes  |  连续导出最大延迟分钟数  |  计数  |  最大值 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  ContinuousExportNumOfRecordsExported  |  连续导出-导出记录的数目  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  ContinuousExportPendingCount  |  连续导出挂起计数  |  计数  |  最大值 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  ContinuousExportResult  |  连续导出结果  |  计数  |  计数 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  CPU  |  CPU  |  百分比  |  平均值 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  EventsProcessedForEventHubs  |  处理的事件数（适用于事件中心/IoT 中心）  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  IngestionResult  |  引入结果  |  计数  |  计数 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  IngestionUtilization  |  引入利用率  |  百分比  |  平均值 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  IngestionVolumeInMB  |  引入量 (MB)  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  KeepAlive  |  保持活动状态  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  QueryDuration  |  查询持续时间  |  毫秒  |  平均值 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  SteamingIngestRequestRate  |  流引入请求速率  |  计数  |  RateRequestsPerSecond | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  StreamingIngestDataRate  |  流引入数据速率  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  StreamingIngestDuration  |  流引入持续时间  |  毫秒  |  平均值 | 
| **是**  | **是** |  Microsoft.Kusto/Clusters  |  StreamingIngestResults  |  流引入结果  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Logic/integrationServiceEnvironments  |  ActionLatency  |  操作延迟   |  秒  |  平均值 | 
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  ActionsCompleted  |  完成的操作数   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  ActionsFailed  |  失败的操作数   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  ActionsSkipped  |  跳过的操作数   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  ActionsStarted  |  启动的操作数   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  ActionsSucceeded  |  成功的操作数   |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Logic/integrationServiceEnvironments  |  ActionSuccessLatency  |  操作成功延迟   |  秒  |  平均值 | 
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  ActionThrottledEvents  |  操作限制事件数  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  RunsCancelled  |  已取消的运行数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  RunsCompleted  |  已完成的运行数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  RunsFailed  |  失败的运行数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  RunsStarted  |  已启动的运行数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  RunsSucceeded  |  成功的运行数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  RunStartThrottledEvents  |  运行启动限制事件  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Logic/integrationServiceEnvironments  |  RunSuccessLatency  |  运行成功延迟  |  秒  |  平均值 | 
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  RunThrottledEvents  |  运行限制事件数  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  TriggersCompleted  |  完成的触发器数   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  TriggersFailed  |  失败的触发器数   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  TriggersFired  |  激发的触发器数   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  TriggersSkipped  |  跳过的触发器数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  TriggersStarted  |  启动的触发器数   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  TriggersSucceeded  |  成功的触发器数   |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Logic/integrationServiceEnvironments  |  TriggerSuccessLatency  |  触发器成功延迟   |  秒  |  平均值 | 
| **是**  | **是** |  Microsoft.Logic/integrationServiceEnvironments  |  TriggerThrottledEvents  |  触发器限制事件数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Logic/workflows  |  ActionLatency  |  操作延迟   |  秒  |  平均值 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  ActionsCompleted  |  完成的操作数   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  ActionsFailed  |  失败的操作数   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  ActionsSkipped  |  跳过的操作数   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  ActionsStarted  |  启动的操作数   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  ActionsSucceeded  |  成功的操作数   |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Logic/workflows  |  ActionSuccessLatency  |  操作成功延迟   |  秒  |  平均值 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  ActionThrottledEvents  |  操作限制事件数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  BillableActionExecutions  |  计费的操作执行数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  BillableTriggerExecutions  |  计费的触发器执行数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  BillingUsageNativeOperation  |  本机操作执行的计费使用情况  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  BillingUsageNativeOperation  |  本机操作执行的计费使用情况  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  BillingUsageStandardConnector  |  标准连接器执行的计费使用情况  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  BillingUsageStandardConnector  |  标准连接器执行的计费使用情况  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  BillingUsageStorageConsumption  |  存储使用执行的计费使用情况  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  BillingUsageStorageConsumption  |  存储使用执行的计费使用情况  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  RunFailurePercentage  |  运行失败百分比  |  百分比  |  总计 | 
| **是**  | 否 |  Microsoft.Logic/workflows  |  RunLatency  |  运行延迟  |  秒  |  平均值 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  RunsCancelled  |  已取消的运行数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  RunsCompleted  |  已完成的运行数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  RunsFailed  |  失败的运行数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  RunsStarted  |  已启动的运行数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  RunsSucceeded  |  成功的运行数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  RunStartThrottledEvents  |  运行启动限制事件  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Logic/workflows  |  RunSuccessLatency  |  运行成功延迟  |  秒  |  平均值 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  RunThrottledEvents  |  运行限制事件数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  TotalBillableExecutions  |  计费的执行总数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Logic/workflows  |  TriggerFireLatency  |  触发器激发延迟   |  秒  |  平均值 | 
| **是**  | 否 |  Microsoft.Logic/workflows  |  TriggerLatency  |  触发器延迟   |  秒  |  平均值 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  TriggersCompleted  |  完成的触发器数   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  TriggersFailed  |  失败的触发器数   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  TriggersFired  |  激发的触发器数   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  TriggersSkipped  |  跳过的触发器数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  TriggersStarted  |  启动的触发器数   |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  TriggersSucceeded  |  成功的触发器数   |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Logic/workflows  |  TriggerSuccessLatency  |  触发器成功延迟   |  秒  |  平均值 | 
| **是**  | **是** |  Microsoft.Logic/workflows  |  TriggerThrottledEvents  |  触发器限制事件数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  活动核心数  |  活动核心数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  活动节点数  |  活动节点数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  已完成的运行数  |  已完成的运行数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  失败的运行次数  |  失败的运行次数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  空闲核心数  |  空闲核心数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  空闲节点数  |  空闲节点数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  正在退出的核心数  |  正在退出的核心数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  正在退出的节点数  |  正在退出的节点数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  失败的模型部署数  |  失败的模型部署数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  已启动的模型部署数  |  已启动的模型部署数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  成功的模型部署数  |  成功的模型部署数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  失败的模型注册数  |  失败的模型注册数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  成功的模型注册数  |  成功的模型注册数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  占用的核心数  |  占用的核心数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  占用的节点数  |  占用的节点数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  配额利用率百分比  |  配额利用率百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  已启动的运行数  |  已启动的运行数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  核心总数  |  核心总数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  节点总数  |  节点总数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  不可用的核心数  |  不可用的核心数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.MachineLearningServices/workspaces  |  不可用的节点数  |  不可用的节点数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Maps/accounts  |  可用性  |  可用性  |  百分比  |  平均值 | 
| 否  | 否 |  Microsoft.Maps/accounts  |  使用情况  |  使用情况  |  计数  |  计数 | 
| **是**  | 否 |  Microsoft.Media/mediaservices  |  AssetCount  |  资产计数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Media/mediaservices  |  AssetQuota  |  资产配额  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Media/mediaservices  |  AssetQuotaUsedPercentage  |  资产配额已用百分比  |  百分比  |  平均值 | 
| **是**  | 否 |  Microsoft.Media/mediaservices  |  ContentKeyPolicyCount  |  内容密钥策略计数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Media/mediaservices  |  ContentKeyPolicyQuota  |  内容密钥策略配额  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Media/mediaservices  |  ContentKeyPolicyQuotaUsedPercentage  |  内容密钥策略配额已用百分比  |  百分比  |  平均值 | 
| **是**  | 否 |  Microsoft.Media/mediaservices  |  StreamingPolicyCount  |  流式处理策略计数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Media/mediaservices  |  StreamingPolicyQuota  |  流式处理策略配额  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Media/mediaservices  |  StreamingPolicyQuotaUsedPercentage  |  流式处理策略配额已用百分比  |  百分比  |  平均值 | 
| **是**  | 否 |  Microsoft.Media/mediaservices/streamingEndpoints  |  流出量  |  流出量  |  字节  |  总计 | 
| **是**  | 否 |  Microsoft.Media/mediaservices/streamingEndpoints  |  Requests  |  Requests  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Media/mediaservices/streamingEndpoints  |  SuccessE2ELatency  |  成功端到端延迟  |  毫秒  |  平均值 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  GCPauseTotalCount  |  GC 暂停计数  |  计数  |  总计 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  GCPauseTotalTime  |  GC 暂停总时间  |  毫秒  |  总计 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  MaxOldGenMemoryPoolBytes  |  最大可用的旧代数据大小  |  字节  |  平均值 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  OldGenMemoryPoolBytes  |  旧代数据大小  |  字节  |  平均值 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  OldGenPromotedBytes  |  提升为旧代数据大小  |  字节  |  最大值 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  ServiceCpuUsagePercentage  |  服务 CPU 使用率百分比  |  百分比  |  平均值 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  ServiceMemoryCommitted  |  分配的服务内存  |  字节  |  平均值 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  ServiceMemoryMax  |  服务内存最大值  |  字节  |  最大值 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  ServiceMemoryUsed  |  使用的服务内存  |  字节  |  平均值 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  SystemCpuUsagePercentage  |  系统 CPU 使用率百分比  |  百分比  |  平均值 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatErrorCount  |  Tomcat 全局错误  |  计数  |  总计 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatReceivedBytes  |  Tomcat 收到的总字节数  |  字节  |  总计 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatRequestMaxTime  |  Tomcat 请求最大时间  |  毫秒  |  最大值 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatRequestTotalCount  |  Tomcat 请求总数  |  计数  |  总计 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatRequestTotalTime  |  Tomcat 请求总时间  |  毫秒  |  总计 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatResponseAvgTime  |  Tomcat 请求平均时间  |  毫秒  |  平均值 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSentBytes  |  Tomcat 发送的总字节数  |  字节  |  总计 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionActiveCurrentCount  |  Tomcat 会话活动计数  |  计数  |  总计 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionActiveMaxCount  |  Tomcat 会话最大活动计数  |  计数  |  总计 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionAliveMaxTime  |  Tomcat 会话最大活动时间  |  毫秒  |  最大值 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionCreatedCount  |  Tomcat 创建的会话数  |  计数  |  总计 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionExpiredCount  |  Tomcat 过期的会话数  |  计数  |  总计 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  TomcatSessionRejectedCount  |  Tomcat 拒绝的会话数  |  计数  |  总计 | 
| **是**  | 否 |  Microservices4Spring/appClusters  |  YoungGenPromotedBytes  |  提升为新代数据大小  |  字节  |  最大值 | 
...
| 否  | 否 |  Microsoft.Network/applicationGateways  |  AvgRequestCountPerHealthyHost  |  每个正常主机每分钟的请求数  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.Network/applicationGateways  |  BackendConnectTime  |  后端连接时间  |  毫秒  |  平均值 | 
| 否  | 否 |  Microsoft.Network/applicationGateways  |  BackendFirstByteResponseTime  |  后端第一个字节响应时间  |  毫秒  |  平均值 | 
| 否  | 否 |  Microsoft.Network/applicationGateways  |  BackendLastByteResponseTime  |  后端最后一个字节响应时间  |  毫秒  |  平均值 | 
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  BackendResponseStatus  |  后端响应状态  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  BlockedCount  |  Web 应用程序防火墙阻止的请求规则分发  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  BlockedReqCount  |  Web 应用程序防火墙阻止的请求计数  |  计数  |  总计 | 
...
| 否  | 否 |  Microsoft.Network/applicationGateways  |  CapacityUnits  |  当前容量单位数  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.Network/applicationGateways  |  ClientRtt  |  客户端 RTT  |  毫秒  |  平均值 | 
| 否  | 否 |  Microsoft.Network/applicationGateways  |  ComputeUnits  |  当前计算单位数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  CurrentConnections  |  当前连接  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  FailedRequests  |  失败的请求数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  HealthyHostCount  |  正常的主机计数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  MatchedCount  |  Web 应用程序防火墙规则分发总数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  ResponseStatus  |  响应状态  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.Network/applicationGateways  |  吞吐量  |  吞吐量  |  每秒字节数  |  平均值 | 
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  TlsProtocol  |  客户端 TLS 协议  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  TotalRequests  |  请求总数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Network/applicationGateways  |  UnhealthyHostCount  |  不正常的主机计数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Network/azurefirewalls  |  ApplicationRuleHit  |  应用程序规则命中次数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Network/azurefirewalls  |  DataProcessed  |  已处理的数据  |  字节  |  总计 | 
| **是**  | 否 |  Microsoft.Network/azurefirewalls  |  FirewallHealth  |  防火墙运行状况  |  百分比  |  平均值 | 
| **是**  | 否 |  Microsoft.Network/azurefirewalls  |  NetworkRuleHit  |  网络规则命中次数  |  计数  |  总计 | 
...
| **是**  | 否 |  Microsoft.Network/dnszones  |  QueryVolume  |  查询量  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.Network/dnszones  |  RecordSetCapacityUtilization  |  记录集容量使用率  |  百分比  |  最大值 | 
| **是**  | 否 |  Microsoft.Network/dnszones  |  RecordSetCount  |  记录集计数  |  计数  |  最大值 | 
...
| **是**  | 否 |  Microsoft.Network/expressRoutePorts  |  AdminState  |  AdminState  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Network/expressRoutePorts  |  LineProtocol  |  LineProtocol  |  计数  |  平均值 | 
...
| **是**  | 否 |  Microsoft.Network/expressRoutePorts  |  RxLightLevel  |  RxLightLevel  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Network/expressRoutePorts  |  TxLightLevel  |  TxLightLevel  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Network/frontdoors  |  BackendHealthPercentage  |  后端运行状况百分比  |  百分比  |  平均值 | 
| **是**  | **是** |  Microsoft.Network/frontdoors  |  BackendRequestCount  |  后端请求计数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Network/frontdoors  |  BackendRequestLatency  |  后端请求延迟  |  毫秒  |  平均值 | 
| **是**  | **是** |  Microsoft.Network/frontdoors  |  BillableResponseSize  |  计费响应大小  |  字节  |  总计 | 
| **是**  | **是** |  Microsoft.Network/frontdoors  |  RequestCount  |  请求计数  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.Network/frontdoors  |  WebApplicationFirewallRequestCount  |  Web 应用程序防火墙请求计数  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.Network/loadBalancers  |  AllocatedSnatPorts  |  已分配的 SNAT 端口数（预览）  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Network/loadBalancers  |  ByteCount  |  字节计数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Network/loadBalancers  |  DipAvailability  |  运行状况探测状态  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Network/loadBalancers  |  PacketCount  |  数据包计数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Network/loadBalancers  |  SnatConnectionCount  |  SNAT 连接计数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Network/loadBalancers  |  SYNCount  |  SYN 计数  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.Network/loadBalancers  |  UsedSnatPorts  |  已使用的 SNAT 端口数（预览）  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Network/loadBalancers  |  VipAvailability  |  数据路径可用性  |  计数  |  平均值 | 
...
| **是**  | 否 |  Microsoft.Network/networkInterfaces  |  PacketsReceivedRate  |  已接收的数据包数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Network/networkInterfaces  |  PacketsSentRate  |  发送的数据包数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Network/networkWatchers/connectionMonitors  |  AverageRoundtripMs  |  平均往返时间（毫秒）  |  毫秒  |  平均值 | 
| **是**  | 否 |  Microsoft.Network/networkWatchers/connectionMonitors  |  ChecksFailedPercent  |  检查失败百分比（预览版）  |  百分比  |  平均值 | 
| **是**  | 否 |  Microsoft.Network/networkWatchers/connectionMonitors  |  ProbesFailedPercent  |  失败的探测百分比  |  百分比  |  平均值 | 
| **是**  | 否 |  Microsoft.Network/networkWatchers/connectionMonitors  |  RoundTripTimeMs  |  往返时间（毫秒）（预览版）  |  毫秒  |  平均值 | 
| **是**  | 否 |  Microsoft.Network/publicIPAddresses  |  ByteCount  |  字节计数  |  计数  |  总计 | 
...
| **是**  | 否 |  Microsoft.Network/publicIPAddresses  |  IfUnderDDoSAttack  |  是否遭到 DDoS 攻击  |  计数  |  最大值 | 
| **是**  | 否 |  Microsoft.Network/publicIPAddresses  |  PacketCount  |  数据包计数  |  计数  |  总计 | 
...
| **是**  | 否 |  Microsoft.Network/publicIPAddresses  |  SynCount  |  SYN 计数  |  计数  |  总计 | 
...
| **是**  | 否 |  Microsoft.Network/publicIPAddresses  |  VipAvailability  |  数据路径可用性  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Network/trafficManagerProfiles  |  ProbeAgentCurrentEndpointStateByProfileResourceId  |  按终结点显示的终结点状态  |  计数  |  最大值 | 
| **是**  | **是** |  Microsoft.Network/trafficManagerProfiles  |  QpsByEndpoint  |  按终结点返回的查询  |  计数  |  总计 | 
...
| **是**  | 否 |  Microsoft.Network/virtualNetworkGateways  |  P2SConnectionCount  |  P2S 连接计数  |  计数  |  最大值 | 
...
| **是**  | 否 |  Microsoft.Network/virtualNetworkGateways  |  TunnelEgressPacketDropTSMismatch  |  隧道流出 TS 不匹配数据包丢弃  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Network/virtualNetworkGateways  |  TunnelEgressPackets  |  隧道流出数据包  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Network/virtualNetworkGateways  |  TunnelIngressBytes  |  隧道流入字节  |  字节  |  总计 | 
| **是**  | 否 |  Microsoft.Network/virtualNetworkGateways  |  TunnelIngressPacketDropTSMismatch  |  隧道流入 TS 不匹配数据包丢弃  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Network/virtualNetworkGateways  |  TunnelIngressPackets  |  隧道流入数据包  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Network/virtualNetworks  |  PingMeshAverageRoundtripMs  |  Ping 某个 VM 所需的往返时间  |  毫秒  |  平均值 | 
| **是**  | 否 |  Microsoft.Network/virtualNetworks  |  PingMeshProbesFailedPercent  |  VM Ping 失败次数  |  百分比  |  平均值 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  incoming  |  传入消息数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  incoming.all.failedrequests  |  所有传入的失败请求数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  incoming.all.requests  |  所有传入请求数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  incoming.scheduled  |  已发送的已安排推送通知数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  incoming.scheduled.cancel  |  已取消的已安排推送通知数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  installation.all  |  安装管理操作数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  installation.delete  |  删除安装操作数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  installation.get  |  获取安装操作数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  installation.patch  |  修补安装操作数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  installation.upsert  |  创建或更新安装操作数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  notificationhub.pushes  |  所有传出通知  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.allpns.badorexpiredchannel  |  坏通道或已过期通道错误数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.allpns.channelerror  |  通道错误数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.allpns.invalidpayload  |  有效负载错误数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.allpns.pnserror  |  外部通知系统错误数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.allpns.success  |  成功的通知数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.apns.badchannel  |  APNS 坏通道错误  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.apns.expiredchannel  |  APNS 已过期通道错误  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.apns.invalidcredentials  |  APNS 授权错误数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.apns.invalidnotificationsize  |  APNS 无效通知大小错误  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.apns.pnserror  |  APNS 错误数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.apns.success  |  APNS 成功的通知数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.gcm.authenticationerror  |  GCM 身份验证错误数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.gcm.badchannel  |  GCM 坏通道错误  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.gcm.expiredchannel  |  GCM 已过期通道错误  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.gcm.invalidcredentials  |  GCM 授权错误数（凭据无效）  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.gcm.invalidnotificationformat  |  GCM 无效的通知格式  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.gcm.invalidnotificationsize  |  GCM 无效通知大小错误  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.gcm.pnserror  |  GCM 错误数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.gcm.success  |  GCM 成功的通知数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.gcm.throttled  |  GCM 受限的通知数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.gcm.wrongchannel  |  GCM 通道不正确错误  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.mpns.authenticationerror  |  MPNS 身份验证错误数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.mpns.badchannel  |  MPNS 坏通道错误  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.mpns.channeldisconnected  |  MPNS 通道断开连接  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.mpns.dropped  |  MPNS 丢弃的通知数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.mpns.invalidcredentials  |  MPNS 无效的凭据  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.mpns.invalidnotificationformat  |  MPNS 无效的通知格式  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.mpns.pnserror  |  MPNS 错误数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.mpns.success  |  MPNS 成功的通知数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.mpns.throttled  |  MPNS 受限的通知数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.authenticationerror  |  WNS 身份验证错误数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.badchannel  |  WNS 坏通道错误  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.channeldisconnected  |  WNS 通道断开连接  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.channelthrottled  |  WNS 通道受限  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.dropped  |  WNS 丢弃的通知数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.expiredchannel  |  WNS 已过期通道错误  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.invalidcredentials  |  WNS 授权错误数（凭据无效）  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.invalidnotificationformat  |  WNS 无效的通知格式  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.invalidnotificationsize  |  WNS 无效通知大小错误  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.invalidtoken  |  WNS 授权错误数（令牌无效）  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.pnserror  |  WNS 错误数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.success  |  WNS 成功的通知数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.throttled  |  WNS 受限的通知数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.tokenproviderunreachable  |  WNS 授权错误数（无法访问）  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  outgoing.wns.wrongtoken  |  WNS 授权错误数（令牌错误）  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  registration.all  |  注册操作  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  registration.create  |  注册创建操作数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  registration.delete  |  注册删除操作数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  registration.get  |  注册读取操作数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  registration.update  |  注册更新操作数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.NotificationHubs/Namespaces/NotificationHubs  |  scheduled.pending  |  挂起的已安排通知数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% Available Memory  |  可用内存百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% Available Swap Space  |  可用交换空间百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% Committed Bytes In Use  |  提交的在用字节数百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% DPC Time  |  DPC 时间百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% Free Inodes  |  可用 Inode 百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% Free Space  |  可用空间百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% Free Space  |  可用空间百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% Idle Time  |  空闲时间百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% Interrupt Time  |  中断时间百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% IO Wait Time  |  IO 等待时间百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% Nice Time  |  良好时间百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% Privileged Time  |  特权时间百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% Processor Time  |  处理器时间百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% Processor Time  |  处理器时间百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% Used Inodes  |  已用 Inode 百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% Used Memory  |  已用内存百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% Used Space  |  已用空间百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% Used Swap Space  |  已用交换空间百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_% User Time  |  用户时间百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Available MBytes  |  可用兆字节数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Available MBytes Memory  |  可用内存 MB 数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Available MBytes Swap  |  可用交换空间 MB 数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. 磁盘秒数/读取  |  Avg. Disk sec/Read  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. 磁盘秒数/读取  |  Avg. Disk sec/Read  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. 磁盘秒数/传输  |  Avg. Disk sec/Transfer  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. 磁盘秒数/写入  |  Avg. Disk sec/Write  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Avg. 磁盘秒数/写入  |  Avg. Disk sec/Write  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Bytes Received/sec  |  收到的字节数/秒  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Bytes Sent/sec  |  发送的字节数/秒  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Bytes Total/sec  |  字节总数/秒  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Current Disk Queue Length  |  Current Disk Queue Length  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Disk Read Bytes/sec  |  磁盘读取字节数/秒  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Disk Reads/sec  |  磁盘读取数/秒  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Disk Reads/sec  |  磁盘读取数/秒  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Disk Transfers/sec  |  磁盘传输数/秒  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Disk Transfers/sec  |  磁盘传输数/秒  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Disk Write Bytes/sec  |  磁盘写入字节数/秒  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Disk Writes/sec  |  磁盘写入数/秒  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Disk Writes/sec  |  磁盘写入数/秒  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Free Megabytes  |  可用 MB 数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Free Megabytes  |  可用 MB 数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Free Physical Memory  |  可用物理内存  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Free Space in Paging Files  |  分页文件中的可用空间  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Free Virtual Memory  |  可用虚拟内存  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Logical Disk Bytes/sec  |  逻辑磁盘字节数/秒  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Page Reads/sec  |  页面读取数/秒  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Page Writes/sec  |  页面写入数/秒  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Pages/sec  |  页面数/秒  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Pct Privileged Time  |  特权时间百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Pct User Time  |  用户时间百分比  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Physical Disk Bytes/sec  |  物理磁盘字节数/秒  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Processes  |  进程  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Processor Queue Length  |  处理器队列长度  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Size Stored In Paging Files  |  分页文件中存储的大小  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Total Bytes  |  字节数总计  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Total Bytes Received  |  已接收的字节数总计  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Total Bytes Transmitted  |  已传输的字节数总计  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Total Collisions  |  冲突数总计  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Total Packets Received  |  已接收的包数总计  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Total Packets Transmitted  |  已传输的包数总计  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Total Rx Errors  |  Rx 错误数总计  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Total Tx Errors  |  Tx 错误数总计  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Uptime  |  运行时间  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Used MBytes Swap Space  |  已用交换空间 MB 数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Used Memory kBytes  |  已用内存 KB 数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Used Memory MBytes  |  已用内存 MB 数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Users  |  用户  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  Average_Virtual Shared Memory  |  虚拟共享内存  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  事件  |  事件  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.OperationalInsights/workspaces  |  检测信号  |  检测信号  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.OperationalInsights/workspaces  |  更新  |  更新  |  计数  |  平均值 | 
...
| **是**  | 否 |  Microsoft.PowerBIDedicated/capacities  |  qpu_high_utilization_metric  |  QPU 高利用率  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.PowerBIDedicated/capacities  |  QueryDuration  |  查询持续时间（数据集）  |  毫秒  |  平均值 | 
| **是**  | 否 |  Microsoft.PowerBIDedicated/capacities  |  QueryPoolJobQueueLength  |  查询池作业队列长度（数据集）  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  ActiveConnections  |  ActiveConnections  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  ActiveListeners  |  ActiveListeners  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Relay/namespaces  |  BytesTransferred  |  BytesTransferred  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  ListenerConnections-ClientError  |  ListenerConnections-ClientError  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  ListenerConnections-ServerError  |  ListenerConnections-ServerError  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  ListenerConnections-Success  |  ListenerConnections-Success  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  ListenerConnections-TotalRequests  |  ListenerConnections-TotalRequests  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  ListenerDisconnects  |  ListenerDisconnects  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  SenderConnections-ClientError  |  SenderConnections-ClientError  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  SenderConnections-ServerError  |  SenderConnections-ServerError  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  SenderConnections-Success  |  SenderConnections-Success  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  SenderConnections-TotalRequests  |  SenderConnections-TotalRequests  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.Relay/namespaces  |  SenderDisconnects  |  SenderDisconnects  |  计数  |  总计 | 
...
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  ActiveConnections  |  ActiveConnections  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  ActiveMessages  |  队列/主题中的活动消息计数。  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  ConnectionsClosed  |  已关闭的连接数。  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  ConnectionsOpened  |  打开的连接数。  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  CPUXNS  |  CPU（已弃用）  |  百分比  |  最大值 | 
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  DeadletteredMessages  |  队列/主题中的死信消息计数。  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.ServiceBus/namespaces  |  IncomingMessages  |  传入消息数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.ServiceBus/namespaces  |  IncomingRequests  |  传入请求数  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  消息  |  队列/主题中的消息计数。  |  计数  |  平均值 | 
...
| **是**  | **是** |  Microsoft.ServiceBus/namespaces  |  OutgoingMessages  |  传出消息数  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  ScheduledMessages  |  队列/主题中的计划消息计数。  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  ServerErrors  |  服务器错误数。  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  大小  |  大小  |  字节  |  平均值 | 
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  SuccessfulRequests  |  成功的请求数  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  ThrottledRequests  |  限制的请求数。  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  UserErrors  |  用户错误数。  |  计数  |  总计 | 
| 否  | 否 |  Microsoft.ServiceBus/namespaces  |  WSXNS  |  内存使用率（已弃用）  |  百分比  |  最大值 | 
| 否  | 否 |  Microsoft.ServiceFabricMesh/applications  |  ActualCpu  |  ActualCpu  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.ServiceFabricMesh/applications  |  ActualMemory  |  ActualMemory  |  字节  |  平均值 | 
| 否  | 否 |  Microsoft.ServiceFabricMesh/applications  |  AllocatedCpu  |  AllocatedCpu  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.ServiceFabricMesh/applications  |  AllocatedMemory  |  AllocatedMemory  |  字节  |  平均值 | 
| 否  | 否 |  Microsoft.ServiceFabricMesh/applications  |  ApplicationStatus  |  ApplicationStatus  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.ServiceFabricMesh/applications  |  ContainerStatus  |  ContainerStatus  |  计数  |  平均值 | 
...
| 否  | 否 |  Microsoft.ServiceFabricMesh/applications  |  RestartCount  |  RestartCount  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.ServiceFabricMesh/applications  |  ServiceReplicaStatus  |  ServiceReplicaStatus  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.ServiceFabricMesh/applications  |  ServiceStatus  |  ServiceStatus  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.SignalRService/SignalR  |  ConnectionCount  |  连接计数  |  计数  |  最大值 | 
| **是**  | **是** |  Microsoft.SignalRService/SignalR  |  InboundTraffic  |  入站流量  |  字节  |  总计 | 
| **是**  | **是** |  Microsoft.SignalRService/SignalR  |  MessageCount  |  消息计数  |  计数  |  总计 | 
...
| **是**  | 否 |  Microsoft.Sql/managedInstances  |  io_requests  |  IO 请求计数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Sql/managedInstances  |  reserved_storage_mb  |  预留的存储空间  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Sql/managedInstances  |  storage_space_used_mb  |  已使用的存储空间  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Sql/managedInstances  |  virtual_core_count  |  虚拟核心计数  |  计数  |  平均值 | 
...
| **是**  | **是** |  Microsoft.Sql/servers  |  dtu_used  |  已用的 DTU  |  计数  |  平均值 | 
...
| **是**  | 否 |  Microsoft.Sql/servers/databases  |  app_cpu_billed  |  计费的应用 CPU  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.Sql/servers/databases  |  blocked_by_firewall  |  被防火墙阻止  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.Sql/servers/databases  |  connection_failed  |  失败的连接数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Sql/servers/databases  |  connection_successful  |  成功的连接数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.Sql/servers/databases  |  cpu_limit  |  CPU 限制  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Sql/servers/databases  |  cpu_percent  |  CPU 百分比  |  百分比  |  平均值 | 
| **是**  | **是** |  Microsoft.Sql/servers/databases  |  cpu_used  |  已用 CPU  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Sql/servers/databases  |  deadlock  |  死锁数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Sql/servers/databases  |  dtu_consumption_percent  |  DTU 百分比  |  百分比  |  平均值 | 
| **是**  | 否 |  Microsoft.Sql/servers/databases  |  dtu_limit  |  DTU 限制  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Sql/servers/databases  |  dtu_used  |  已用的 DTU  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Sql/servers/databases  |  dwu_consumption_percent  |  DWU 百分比  |  百分比  |  最大值 | 
| **是**  | 否 |  Microsoft.Sql/servers/databases  |  dwu_limit  |  DWU 限制  |  计数  |  最大值 | 
| **是**  | **是** |  Microsoft.Sql/servers/databases  |  dwu_used  |  已用的 DWU  |  计数  |  最大值 | 
...
| **是**  | 否 |  Microsoft.Sql/servers/databases  |  tempdb_data_size  |  Tempdb 数据文件大小 (KB)  |  计数  |  最大值 | 
| **是**  | 否 |  Microsoft.Sql/servers/databases  |  tempdb_log_size  |  Tempdb 日志文件大小 (KB)  |  计数  |  最大值 | 
| **是**  | 否 |  Microsoft.Sql/servers/databases  |  tempdb_log_used_percent  |  Tempdb 日志已用百分比  |  百分比  |  最大值 | 
...
| **是**  | 否 |  Microsoft.Sql/servers/elasticPools  |  cpu_limit  |  CPU 限制  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Sql/servers/elasticPools  |  cpu_percent  |  CPU 百分比  |  百分比  |  平均值 | 
| **是**  | 否 |  Microsoft.Sql/servers/elasticPools  |  cpu_used  |  已用 CPU  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.Sql/servers/elasticPools  |  database_allocated_data_storage  |  已分配的数据空间  |  字节  |  平均值 | 
| 否  | 否 |  Microsoft.Sql/servers/elasticPools  |  database_cpu_limit  |  CPU 限制  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.Sql/servers/elasticPools  |  database_cpu_percent  |  CPU 百分比  |  百分比  |  平均值 | 
| 否  | 否 |  Microsoft.Sql/servers/elasticPools  |  database_cpu_used  |  已用 CPU  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.Sql/servers/elasticPools  |  database_dtu_consumption_percent  |  DTU 百分比  |  百分比  |  平均值 | 
| 否  | 否 |  Microsoft.Sql/servers/elasticPools  |  database_eDTU_used  |  已用的 eDTU  |  计数  |  平均值 | 
...
| **是**  | 否 |  Microsoft.Sql/servers/elasticPools  |  eDTU_limit  |  eDTU 限制  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Sql/servers/elasticPools  |  eDTU_used  |  已用的 eDTU  |  计数  |  平均值 | 
...
| **是**  | 否 |  Microsoft.Sql/servers/elasticPools  |  tempdb_data_size  |  Tempdb 数据文件大小 (KB)  |  计数  |  最大值 | 
| **是**  | 否 |  Microsoft.Sql/servers/elasticPools  |  tempdb_log_size  |  Tempdb 日志文件大小 (KB)  |  计数  |  最大值 | 
| **是**  | 否 |  Microsoft.Sql/servers/elasticPools  |  tempdb_log_used_percent  |  Tempdb 日志已用百分比  |  百分比  |  最大值 | 
...
| **是**  | 否 |  Microsoft.Storage/storageAccounts  |  事务  |  事务  |  计数  |  总计 | 
...
| 否  | 否 |  Microsoft.Storage/storageAccounts/blobServices  |  BlobCount  |  Blob 计数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Storage/storageAccounts/blobServices  |  ContainerCount  |  Blob 容器计数  |  计数  |  平均值 | 
...
| **是**  | 否 |  Microsoft.Storage/storageAccounts/blobServices  |  事务  |  事务  |  计数  |  总计 | 
...
| 否  | 否 |  Microsoft.Storage/storageAccounts/fileServices  |  FileCount  |  文件计数  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.Storage/storageAccounts/fileServices  |  FileShareCount  |  文件共享计数  |  计数  |  平均值 | 
| 否  | 否 |  Microsoft.Storage/storageAccounts/fileServices  |  FileShareQuota  |  文件共享配额大小  |  字节  |  平均值 | 
| 否  | 否 |  Microsoft.Storage/storageAccounts/fileServices  |  FileShareSnapshotCount  |  文件共享快照计数。  |  计数  |  平均值 | 
...
| **是**  | 否 |  Microsoft.Storage/storageAccounts/fileServices  |  事务  |  事务  |  计数  |  总计 | 
...
| **是**  | 否 |  Microsoft.Storage/storageAccounts/queueServices  |  QueueCount  |  队列计数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Storage/storageAccounts/queueServices  |  QueueMessageCount  |  队列消息计数  |  计数  |  平均值 | 
...
| **是**  | 否 |  Microsoft.Storage/storageAccounts/queueServices  |  事务  |  事务  |  计数  |  总计 | 
...
| **是**  | 否 |  Microsoft.Storage/storageAccounts/tableServices  |  TableCount  |  表计数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Storage/storageAccounts/tableServices  |  TableEntityCount  |  表实体计数  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.Storage/storageAccounts/tableServices  |  事务  |  事务  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.StorageCache/caches  |  ClientIOPS  |  总客户端 IOPS  |  计数  |  平均值 | 
...
| **是**  | 否 |  Microsoft.StorageCache/caches  |  StorageTargetHealth  |  存储目标运行状况  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.StorageCache/caches  |  StorageTargetIOPS  |  总 StorageTarget IOPS  |  计数  |  平均值 | 
...
| **是**  | 否 |  Microsoft.StorageCache/caches  |  StorageTargetWriteIOPS  |  StorageTarget 写入 IOPS  |  计数  |  平均值 | 
| **是**  | 否 |  Microsoft.StorageCache/caches  |  运行时间  |  运行时间  |  计数  |  平均值 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  ServerSyncSessionResult  |  同步会话结果  |  计数  |  平均值 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  StorageSyncBatchTransferredFileBytes  |  同步的字节数  |  字节  |  总计 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  StorageSyncRecalledNetworkBytesByApplication  |  应用程序的云分层重调大小  |  字节  |  总计 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  StorageSyncRecalledTotalNetworkBytes  |  云分层重调大小  |  字节  |  总计 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  StorageSyncRecallIOTotalSizeBytes  |  云分层回调  |  字节  |  总计 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  StorageSyncRecallThroughputBytesPerSecond  |  云分层重调吞吐量  |  每秒字节数  |  平均值 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  StorageSyncServerHeartbeat  |  服务器联机状态  |  计数  |  最大值 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  StorageSyncSyncSessionAppliedFilesCount  |  已同步的文件数  |  计数  |  总计 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices  |  StorageSyncSyncSessionPerItemErrorsCount  |  未同步的文件  |  计数  |  总计 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices/registeredServers  |  ServerHeartbeat  |  服务器联机状态  |  计数  |  最大值 | 
...
| **是**  | 否 |  microsoft.storagesync/storageSyncServices/syncGroups  |  SyncGroupSyncSessionAppliedFilesCount  |  已同步的文件数  |  计数  |  总计 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices/syncGroups  |  SyncGroupSyncSessionPerItemErrorsCount  |  未同步的文件  |  计数  |  总计 | 
...
| **是**  | 否 |  microsoft.storagesync/storageSyncServices/syncGroups/serverEndpoints  |  ServerEndpointSyncSessionAppliedFilesCount  |  已同步的文件数  |  计数  |  总计 | 
| **是**  | 否 |  microsoft.storagesync/storageSyncServices/syncGroups/serverEndpoints  |  ServerEndpointSyncSessionPerItemErrorsCount  |  未同步的文件  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  AMLCalloutFailedRequests  |  失败的函数请求数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  AMLCalloutInputEvents  |  函数事件数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  AMLCalloutRequests  |  函数请求数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  ConversionErrors  |  数据转换错误数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  DeserializationError  |  输入反序列化错误  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  DroppedOrAdjustedEvents  |  失序事件数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  EarlyInputEvents  |  早期输入事件数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  错误  |  运行时错误  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  InputEventBytes  |  输入事件字节数  |  字节  |  总计 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  InputEvents  |  输入事件数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  InputEventsSourcesBacklogged  |  积压的输入事件数  |  计数  |  最大值 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  InputEventsSourcesPerSecond  |  收到的输入源数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  LateInputEvents  |  延迟输入事件数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.StreamAnalytics/streamingjobs  |  OutputEvents  |  输出事件数  |  计数  |  总计 | 
...
| **是**  | 否 |  Microsoft.VMwareCloudSimple/virtualMachines  |  DiskReadOperations  |  磁盘读取操作次数  |  计数  |  总计 | 
...
| **是**  | 否 |  Microsoft.VMwareCloudSimple/virtualMachines  |  DiskWriteOperations  |  磁盘写入操作次数  |  计数  |  总计 | 
| **是**  | 否 |  Microsoft.VMwareCloudSimple/virtualMachines  |  MemoryActive  |  活动的内存量  |  字节  |  平均值 | 
| **是**  | 否 |  Microsoft.VMwareCloudSimple/virtualMachines  |  MemoryGranted  |  授予的内存量  |  字节  |  平均值 | 
| **是**  | 否 |  Microsoft.VMwareCloudSimple/virtualMachines  |  MemoryUsed  |  已用内存量  |  字节  |  平均值 | 
...
| **是**  | 否 |  Microsoft.VMwareCloudSimple/virtualMachines  |  NetworkInBytesPerSecond  |  网络输入字节数/秒  |  每秒字节数  |  平均值 | 
| **是**  | 否 |  Microsoft.VMwareCloudSimple/virtualMachines  |  NetworkOutBytesPerSecond  |  网络输出字节数/秒  |  每秒字节数  |  平均值 | 
| **是**  | 否 |  Microsoft.VMwareCloudSimple/virtualMachines  |  CPU 百分比  |  CPU 百分比  |  百分比  |  平均值 | 
| **是**  | 否 |  Microsoft.VMwareCloudSimple/virtualMachines  |  PercentageCpuReady  |  已就绪 CPU 百分比  |  毫秒  |  总计 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  ActiveRequests  |  活动请求数  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  DiskQueueLength  |  磁盘队列长度  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  Http101  |  Http 101  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  Http2xx  |  Http 2xx  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  Http3xx  |  Http 3xx  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  Http401  |  Http 401  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  Http403  |  Http 403  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  Http404  |  Http 404  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  Http406  |  Http 406  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  Http4xx  |  Http 4xx  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  Http5xx  |  Http 服务器错误  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  HttpQueueLength  |  Http 队列长度  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  LargeAppServicePlanInstances  |  大型应用服务计划工作线程数  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  MediumAppServicePlanInstances  |  中型应用服务计划工作线程数  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  MemoryPercentage  |  内存百分比  |  百分比  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  Requests  |  Requests  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  SmallAppServicePlanInstances  |  小型应用服务计划工作线程数  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/multiRolePools  |  TotalFrontEnds  |  前端总数  |  计数  |  平均值 | 
...
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/workerPools  |  WorkersAvailable  |  可用工作线程数  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/workerPools  |  WorkersTotal  |  工作线程总数  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/hostingEnvironments/workerPools  |  WorkersUsed  |  使用的工作线程数  |  计数  |  平均值 | 
...
| **是**  | **是** |  Microsoft.Web/serverfarms  |  DiskQueueLength  |  磁盘队列长度  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  HttpQueueLength  |  Http 队列长度  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  MemoryPercentage  |  内存百分比  |  百分比  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpCloseWait  |  TCP 关闭等待  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpClosing  |  TCP 正在关闭  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpEstablished  |  已建立的 TCP  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpFinWait1  |  TCP Fin 等待 1  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpFinWait2  |  TCP Fin 等待 2  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpLastAck  |  TCP 上一次的 Ack  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpSynReceived  |  收到的 TCP Syn  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpSynSent  |  发送的 TCP Syn  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/serverfarms  |  TcpTimeWait  |  TCP 时间等待  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/sites  |  AppConnections  |  连接  |  计数  |  平均值 | 
...
| **是**  | **是** |  Microsoft.Web/sites  |  CurrentAssemblies  |  当前程序集  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/sites  |  FunctionExecutionCount  |  函数执行计数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites  |  FunctionExecutionUnits  |  函数执行单位数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Gen0Collections  |  第 0 代垃圾回收  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Gen1Collections  |  第 1 代垃圾回收  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Gen2Collections  |  第 2 代垃圾回收  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites  |  控点  |  句柄计数  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/sites  |  HealthCheckStatus  |  运行状况检查状态  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Http101  |  Http 101  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Http2xx  |  Http 2xx  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Http3xx  |  Http 3xx  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Http401  |  Http 401  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Http403  |  Http 403  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Http404  |  Http 404  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Http406  |  Http 406  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Http4xx  |  Http 4xx  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites  |  Http5xx  |  Http 服务器错误  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.Web/sites  |  Requests  |  Requests  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites  |  RequestsInApplicationQueue  |  应用程序队列中的请求数  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/sites  |  线程  |  线程计数  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/sites  |  TotalAppDomains  |  应用程序域总数  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/sites  |  TotalAppDomainsUnloaded  |  卸载的应用程序域总数  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  AppConnections  |  连接  |  计数  |  平均值 | 
...
| **是**  | **是** |  Microsoft.Web/sites/slots  |  CurrentAssemblies  |  当前程序集  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  FunctionExecutionCount  |  函数执行计数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  FunctionExecutionUnits  |  函数执行单位数  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Gen0Collections  |  第 0 代垃圾回收  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Gen1Collections  |  第 1 代垃圾回收  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Gen2Collections  |  第 2 代垃圾回收  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  控点  |  句柄计数  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  HealthCheckStatus  |  运行状况检查状态  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Http101  |  Http 101  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Http2xx  |  Http 2xx  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Http3xx  |  Http 3xx  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Http401  |  Http 401  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Http403  |  Http 403  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Http404  |  Http 404  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Http406  |  Http 406  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Http4xx  |  Http 4xx  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Http5xx  |  Http 服务器错误  |  计数  |  总计 | 
...
| **是**  | **是** |  Microsoft.Web/sites/slots  |  Requests  |  Requests  |  计数  |  总计 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  RequestsInApplicationQueue  |  应用程序队列中的请求数  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  线程  |  线程计数  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  TotalAppDomains  |  应用程序域总数  |  计数  |  平均值 | 
| **是**  | **是** |  Microsoft.Web/sites/slots  |  TotalAppDomainsUnloaded  |  卸载的应用程序域总数  |  计数  |  平均值 | 
