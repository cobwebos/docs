...
目前，仅可以使用 Log Analytics 中已保存的搜索来创建警报。  有关详细信息，请参阅[日志搜索 REST API](../../log-analytics/log-analytics-queries.md)。
...
* 在 Log Analytics 中使用 [REST API 执行日志搜索](../../log-analytics/log-analytics-queries.md)。
