...
可以使用适用于 Linux 的 Log Analytics 代理将自定义 JSON 数据源收集到 [Azure Monitor](data-platform.md) 中。  这些自定义数据源可以是返回 JSON 的简单脚本，如[卷曲](https://curl.haxx.se/)或[FluentD 的 300 多个插件](https://www.fluentd.org/plugins/all)之一。 本文介绍此数据收集所需的配置。
