...
> [!NOTE]
> 若要查看通过[Azure Monitor 指标](../../azure-monitor/platform/metrics-charts.md)从 Log Analytics 工作区中提取的支持指标，必须针对该特定指标创建日志指标警报。 在 "日志" 的 "指标警报" 中选择的维度仅在通过 Azure Monitor 度量值时才会显示。
