...
例如，你可以使用 Microsoft Flow 来使用 Office 365 的电子邮件通知中的 Azure Monitor 日志数据，在 Azure DevOps 中创建 bug，或发布一个可宽延时间消息。  可通过简单计划或从连接的服务中的某些操作（例如收到电子邮件或推文时）触发工作流。  
