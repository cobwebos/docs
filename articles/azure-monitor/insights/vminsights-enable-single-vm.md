...
1. 如果 VM 尚未连接到 Log Analytics 工作区，则系统将提示你选择一个。 如果你以前未[创建过工作区](../learn/quick-create-workspace.md)，则可以选择在订阅中部署 VM 或 VMSS 的位置的默认值。 如果此工作区尚不存在，则将创建并配置它。
