...
Log Analytics 中的所有资源都包含在[工作区](../../log-analytics/log-analytics-manage-access.md)中。  如 [Log Analytics 工作区和自动化帐户](solutions.md#log-analytics-workspace-and-automation-account)中所述，工作区不包括在管理解决方案中，但必须存在才可以安装解决方案。  如果不存在工作区，解决方案安装将失败。
