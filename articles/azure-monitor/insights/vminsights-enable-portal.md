---
title: 为 Azure 门户中的单个虚拟机或虚拟机规模集启用 Azure Monitor
...
---
# <a name="enable-azure-monitor-for-single-virtual-machine-or-virtual-machine-scale-set-in-the-azure-portal"></a>为 Azure 门户中的单个虚拟机或虚拟机规模集启用 Azure Monitor
