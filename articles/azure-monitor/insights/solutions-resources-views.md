...
按照[Log Analytics 视图设计器](../../azure-monitor/platform/view-designer.md)中的说明将视图导出到文件。  导出的文件是[与解决方案文件具有相同元素的 JSON 格式](solutions-solution-file.md)。  
...
* 了解创建[管理解决方案](solutions-creating.md)的完整详细信息。
* 包括[管理解决方案中的自动化 runbook](solutions-resources-automation.md)。
