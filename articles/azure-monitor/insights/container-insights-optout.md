...
使用 [az aks disable-addons](https://docs.microsoft.com/cli/azure/aks?view=azure-cli-latest#az-aks-disable-addons) 命令禁用容器的 Azure Monitor。 此命令从群集节点删除代理，它不会删除该解决方案或已收集和存储在 Azure Monitor 资源中的数据。  
