...
可以在 Azure Monitor 中针对你使用的任何应用程序和服务添加监视解决方案。 它们通常免费提供，但会收集可以调用使用费用的数据。 除了由 Microsoft 提供的解决方案以外，合作伙伴和客户还可以[创建管理解决方案](solutions-creating.md)，以便在各自环境中使用或通过社区提供给客户使用。
...
1. 单击磁贴以获取解决方案以打开其视图，其中包括更详细的分析其收集的数据。
...
1. 浏览或搜索解决方案。 您也可以[浏览此搜索链接](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/category/management-tools?page=1&subcategories=management-solutions)的解决方案。
1. 找到所需的监视解决方案并阅读其说明。
1. 单击“创建”**** 以启动安装进程。
