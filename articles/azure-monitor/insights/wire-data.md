...
依赖关系代理不会传输任何数据本身, 也不需要对防火墙或端口进行任何更改。 Wire Data 中的数据始终由 Log Analytics 代理直接或通过 Log Analytics 网关传输到 Azure Monitor。
...
#### <a name="windows-desktop"></a>Windows 桌面版
