...
1. 对于某些数据类型（例如活动日志），需要有一些在存储帐户中生成事件的活动。 若要在活动日志中生成活动，请按照[这些说明](./../../azure-monitor/platform/quick-audit-notify-action-subscription.md)操作。 可能最多需等待 5 分钟，事件即会在存储帐户中显示。
