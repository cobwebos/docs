...
如果有一个 Web 应用程序在 J2EE 服务器上运行，无需更改代码或重新编译项目，就能开始使用 [Application Insights](../../application-insights/app-insights-overview.md) 来监视该应用程序。 使用此选项可以获取发送到服务器的 HTTP 请求、未经处理的异常和性能计数器的相关信息。
