...
2. 在下一个向导页上，必须先提供凭据才能登录到 Microsoft Azure。
   ...
   * 否则，创建为该应用的新资源。 如果有其他应用是同一系统的组件，请将它们放入同一资源组中，以使对遥测的访问更易于管理。
     ...
     ![在“Application Insights 设置”选项卡上，单击“登录”并为 Azure 提供 Microsoft 帐户凭据。 然后选择订阅、资源组和资源。](./media/scom/060.png)
3. 完成该向导。
...
在 [Azure 门户](https://portal.azure.com)中，浏览到应用的资源。 从应用[查看显示遥测的图表](../../azure-monitor/app/app-insights-dashboards.md)。 （如果它尚未显示在主页上，请单击“实时指标流”。)
