...
description: Application Insights 代理 API 参考。 Enable-ApplicationInsightsMonitoring。 无需重新部署网站即可监视网站性能。 使用托管在本地、VM 或 Azure 上的 ASP.NET Web 应用。
ms.topic: conceptual
...
ms.locfileid: "81536737"
---
# <a name="application-insights-agent-api-enable-applicationinsightsmonitoring"></a>应用程序见解代理 API：启用应用程序见解监视
