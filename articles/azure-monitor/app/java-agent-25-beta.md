---
title: Azure 应用程序 Insights 中的 Java web 应用的性能监视 (2.5.0) |Microsoft Docs
description: 使用 Application Insights (2.5.0) 对 Java 网站进行扩展的性能和使用情况监视。
