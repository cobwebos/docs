...
3. 查看该包在 [ApplicationInsights.config](../../azure-monitor/app/configuration-with-applicationinsights-config.md) 中添加的默认选项：
...
如果某个快照适用于给定的异常或问题 ID，Application Insights 门户上的[异常](../../azure-monitor/app/asp-net-exceptions.md)区域中会显示“打开调试快照”按钮。

![异常区域中的“打开调试快照”按钮](./media/snapshot-debugger/snapshot-on-exception.png)
