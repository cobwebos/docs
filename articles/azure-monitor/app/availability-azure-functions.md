...
>![Azure 门户中的 Azure 函数 run.csx](media/availability-azure-functions/runcsx.png)
...
>[!div class="mx-imgBorder"]
>![右选择 "添加"。 将文件命名为 proj](media/availability-azure-functions/addfile.png)
...
>[!div class="mx-imgBorder"]
>![可用性 "选项卡，其中包含成功的结果](media/availability-azure-functions/availtab.png)
...
>[!div class="mx-imgBorder"]
>![选择一个示例可用性测试](media/availability-azure-functions/sample.png)
