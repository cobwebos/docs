...
有关 Java 关联的详细信息以及如何为非 SpringBoot 应用程序配置云角色名称，请查看相关的此[部分](https://docs.microsoft.com/azure/application-insights/application-insights-correlation#role-name)。
...
或者，在**云角色名称**告诉你 web 前端中某个位置的问题的情况下，**云角色实例**可能非常有用，但你可能在多个负载平衡的服务器上运行 web 前端，以便能够通过 Kusto 查询深入了解层并了解问题是否会影响所有 web 前端服务器/实例，或者只是一个非常重要的问题。
