...
* [Application Insights](https://github.com/Microsoft/ApplicationInsights-Java/tree/master/azure-application-insights-spring-boot-starter) 1.1.0 或更高版本
...
* 若要了解有关 Micrometer 的详细信息, 请参阅官方的[Micrometer 文档](https://micrometer.io/docs)。
