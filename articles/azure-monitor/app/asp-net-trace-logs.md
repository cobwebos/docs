 ...
 * **ProviderGuid**指定要收集的 ETW 提供程序的 GUID。 它可以用来代替 `ProviderName`。
...
* 请确保使用最新版本的 Application Insights。 在 Visual Studio 中，切换到 "**工具**"  >  "**扩展和更新**"，并打开 "**更新**" 选项卡。如果**Developer Analytics Tools**存在，请选择它以对其进行更新。
