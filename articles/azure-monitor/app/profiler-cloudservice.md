...
* [Service Fabric 应用程序](profiler-servicefabric.md ?toc=/azure/azure-monitor/toc.json)
* [虚拟机](profiler-vm.md?toc=/azure/azure-monitor/toc.json)
...
1. 使用 Application Insights 跟踪请求：
    ...
    对于辅助角色，请[添加代码来跟踪请求。](profiler-trackrequests.md ?toc=/azure/azure-monitor/toc.json)
...
- 在 [Profiler 故障排除](profiler-troubleshooting.md ?toc=/azure/azure-monitor/toc.json)中获得有关排查 Profiler 问题的帮助。