---
title: 在 Azure 应用程序 Insights 中浏览 Java 跟踪日志 (2.5.0) |Microsoft Docs
description: 在 Application Insights 中搜索 Log4J 或 Logback 跟踪 (2.5.0)
...
ms.locfileid: "68298355"
---
# <a name="explore-java-trace-logs-in-application-insights-250-beta"></a>在 Application Insights 中探索 Java 跟踪日志 (2.5.0)
如果使用 Logback 或 Log4J（v1.2 或 v2.0）进行跟踪，可将跟踪日志自动发送到 Application Insights，以便在其中发现和搜索日志。

## <a name="note-if-you-are-using-the-application-insights-java-agent"></a>注意: 如果你正在使用 Application Insights Java 代理
