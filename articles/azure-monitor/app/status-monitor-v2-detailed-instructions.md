...
> 有关更早版本的信息，请参阅[安装 PowerShellGet](https://docs.microsoft.com/powershell/gallery/installing-psget)。
...
3. 安装 ApplicationMonitor 模块。
    ...
    - 可选参数：
        ...
        - `-AcceptLicense`。 绕过 "接受许可证" 提示
        - `-Force`。 跳过 "不受信任的存储库" 警告。
