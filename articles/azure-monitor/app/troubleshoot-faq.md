...
* [.NET 应用](../../azure-monitor/app/asp-net-troubleshoot-no-data.md)
* [监视已经在运行的应用](../../azure-monitor/app/monitor-performance-live-website-now.md#troubleshoot)
* [Azure 诊断](../../azure-monitor/platform/diagnostics-extension-to-application-insights.md)
* [Java Web 应用](../../azure-monitor/app/java-troubleshoot.md)

*我无法从服务器获取任何数据*

* [设置防火墙异常](../../azure-monitor/app/ip-addresses.md)
* [设置 ASP.NET 服务器](../../azure-monitor/app/monitor-performance-live-website-now.md)
* [设置 Java 服务器](../../azure-monitor/app/java-agent.md)

## <a name="can-i-use-application-insights-with-"></a>是否可以将 Application Insights 用于...？

* [IIS 服务器上的 Web 应用 - 本地或在 VM 中](../../azure-monitor/app/asp-net.md)
* [Java Web 应用](../../azure-monitor/app/java-get-started.md)
* [Node.js 应用](../../azure-monitor/app/nodejs.md)
* [Azure 上的 Web 应用](../../azure-monitor/app/azure-web-apps.md)
* [Azure 上的云服务](../../azure-monitor/app/cloudservices.md)
* [在 Docker 中运行的应用服务器](../../azure-monitor/app/docker.md)
* [单页 Web 应用](../../azure-monitor/app/javascript.md)
* [SharePoint](sharepoint.md)
* [Windows 桌面应用](../../azure-monitor/app/windows-desktop.md)
...
较大的遥测量按 Gb 收费。 我们提供了一些有关如何[限制费用](../../azure-monitor/app/pricing.md)的提示。
...
请参阅[发行说明](../../azure-monitor/app/release-notes.md)了解对应于应用程序类型的 SDK。
...
[了解详细信息](../../azure-monitor/app/monitor-performance-live-website-now.md#questions)。
...
* HTTP 请求
* [依赖项](../../azure-monitor/app/asp-net-dependencies.md)。 调用: SQL 数据库; 对外部服务的 HTTP 调用; Azure Cosmos DB、表、blob 存储和队列。 
* [异常](../../azure-monitor/app/asp-net-exceptions.md)和堆栈跟踪。
* [性能计数器](../../azure-monitor/app/performance-counters.md) - 如果使用[状态监视器](../../azure-monitor/app/monitor-performance-live-website-now.md)、[Azure 监视](../../azure-monitor/app/azure-web-apps.md)或 [Application Insights 收集编写器](../../azure-monitor/app/java-collectd.md)。
* [自定义编码的事件和指标](../../azure-monitor/app/api-custom-events-metrics.md)。
* 如果配置相应的收集器，则会[跟踪日志](../../azure-monitor/app/asp-net-trace-logs.md)。

从[客户端网页](../../azure-monitor/app/javascript.md)：

* [页面视图计数](usage-overview.md)
* [AJAX 调用](../../azure-monitor/app/asp-net-dependencies.md)，从运行脚本发出的请求。
* 页面视图加载数据
* 用户和会话计数
* [已经过身份验证的用户 ID](../../azure-monitor/app/api-custom-events-metrics.md#authenticated-users)

从其他源中（如果有配置）：

* [Azure 诊断](../../azure-monitor/platform/diagnostics-extension-to-application-insights.md)
* [导入到 Analytics](https://docs.microsoft.com/azure/log-analytics/log-analytics-data-collector-api)
...
可以[使用 Power BI](../../azure-monitor/app/export-power-bi.md ) 在映射中显示请求遥测。
...
如果代码发送了此类数据，则有可能。 如果堆栈跟踪中的变量包括个人数据，也可能发生这种情况。 开发团队应进行风险评估，确保妥善处理个人数据。 [深入了解数据保留和隐私](../../azure-monitor/app/data-retention-privacy.md)。
...
* [示例 - 辅助角色和 Web 角色的云服务](../../azure-monitor/app/cloudservices.md)
...
* 若要识别跨计算机和浏览器登录的用户，请添加对 [setAuthenticatedUserContext()](../../azure-monitor/app/api-custom-events-metrics.md#authenticated-users) 的调用。

## <a name="q17"></a> 我是否已在 Application Insights 中启用所有内容？
| 应看到 | 如何获取 | 为何需要它 |
| --- | --- | --- |
| 可用性图表 |[Web 测试](../../azure-monitor/app/monitor-web-app-availability.md) |知道 Web 应用已启动 |
| 服务器应用性能：响应时间、... |[将 Application Insights 添加到项目](../../azure-monitor/app/asp-net.md)或[在服务器上安装 AI 状态监视器](../../azure-monitor/app/monitor-performance-live-website-now.md)（或编写自己的代码以[跟踪依赖项](../../azure-monitor/app/api-custom-events-metrics.md#trackdependency)） |检测性能问题 |
| 依赖项遥测 |[在服务器上安装 AI 状态监视器](../../azure-monitor/app/monitor-performance-live-website-now.md) |诊断数据库或其他外部组件问题 |
| 获取异常的堆栈跟踪 |[在代码中插入 TrackException 调用](../../azure-monitor/app/asp-net-exceptions.md)（但有些会自动报告） |检测和诊断异常 |
| 搜索日志跟踪 |[添加日志记录适配器](../../azure-monitor/app/asp-net-trace-logs.md) |诊断异常、性能问题 |
| 客户端使用基础知识：页面视图、会话、... |[网页中的 JavaScript 初始值设定项](../../azure-monitor/app/javascript.md) |使用情况分析 |
| 客户端自定义指标 |[在网页中跟踪调用](../../azure-monitor/app/api-custom-events-metrics.md) |增强用户体验 |
| 服务器自定义指标 |[在服务器中跟踪调用](../../azure-monitor/app/api-custom-events-metrics.md) |商业智能 |

## <a name="why-are-the-counts-in-search-and-metrics-charts-unequal"></a>为什么搜索图表和指标图表中的计数不一致？

[采样](../../azure-monitor/app/sampling.md)减少了实际从应发送到门户的遥测项（请求、自定义事件等）数量。 在搜索中，看到的是实际接收到的项数。 在显示事件计数的指标图表中，看到的是发生的原始事件数。 
...
可以使用 Azure 资源监视器[编写 PowerShell 脚本](../../azure-monitor/app/powershell.md)：
...
使用 [REST API](https://dev.applicationinsights.io/) 运行 [Analytics](../../azure-monitor/app/analytics.md) 查询。
...
建议使用我们的 SDK 并使用 [SDK API](../../azure-monitor/app/api-custom-events-metrics.md)。 为各种[平台](../../azure-monitor/app/platforms.md)提供了相应的 SDK 变体。 这些 SDK 可处理缓冲、压缩、限制以及重试等。 但是，[引入架构](https://github.com/Microsoft/ApplicationInsights-dotnet/tree/develop/Schema/PublicSchema)和[终结点协议](https://github.com/Microsoft/ApplicationInsights-Home/blob/master/EndpointSpecs/ENDPOINT-PROTOCOL.md)是公共的。
...
我们的 [Web 测试](../../azure-monitor/app/monitor-web-app-availability.md)可在遍布全球的各个接入点上运行。 可运用以下两种解决方案：

* 防火墙门 - 允许从[长且可更改的 Web 测试代理列表](../../azure-monitor/app/ip-addresses.md)中请求自己的服务器。
