...
> [!IMPORTANT]
> 如果你使用的是[基于工作区的 Application Insights 资源](../app/create-workspace-resource.md)遥测存储在具有所有其他日志数据的 Log Analytics 工作区中。 使用 log （）表达式编写包含多个工作区中的应用程序的查询。 对于同一工作区中的多个应用程序，不需要跨工作区查询。
