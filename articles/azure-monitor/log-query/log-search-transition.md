...
在日志搜索中，可以通过操作栏中的“保存的搜索”项使用已保存的查询  。 在 Azure Monitor 日志中，可以从[“查询资源管理器”](./get-started-portal.md#save-queries)访问已保存的查询。
...
在日志搜索中，可以通过选择“执行操作”，从搜索结果[启动 Runbook](../platform/action-groups.md)  。
