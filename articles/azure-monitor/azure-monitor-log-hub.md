...
layout: HubPage
hide_bc: false
title: Azure Monitor 日志数据文档 | Microsoft Docs
...
ms.locfileid: "55223401"
---
<div id="main" class="v2">
    <div class="container">
        <h1>Azure Monitor 日志数据文档</h1>
        <p>Azure Monitor 可以收集不同的数据源作为日志数据，将其存储以进行关联并使用其查询语言进行分析。</p>
        <p>浏览关于如何计划、收集和分析日志数据的最热门的内容。</p>
