...
本文介绍如何在其他 Azure 区域中创建工作区并发布 Web 服务。
...
2. 区域选择器一次只会显示一个区域的工作区。 在以后，你将能够查看可同时访问所有地区的工作区的完整列表。  
3. 免费工作区或来宾访问（匿名）工作区将在美国中南部创建并托管在以后，你将能够在选择的区域中创建免费/来宾访问工作区。  
4. 从东南亚工作区部署的 Web 服务也将在东南亚托管。 在以后，你将能够灵活地在一个区域中创建实验，并将生成的 Web 服务终结点部署到其他区域。  
