...
1. 登录 Azure 机器学习 Web 服务门户，网址为：[https://services.azureml.net](https://services.azureml.net)。 若要在经典 Web 服务中到达此门户，可在机器学习工作室中单击机器学习 Web 服务页上的“新 Web 服务体验”。
   ...
   ![新 Web 服务体验链接](media/machine-learning-web-services-logging/new-web-services-experience-link.png)

2. 在顶部菜单栏，单击“Web 服务”用作新 Web 服务，或单击“经典 Web 服务”用作经典 Web 服务。

   ![选择新 Web 服务或经典 Web 服务](media/machine-learning-web-services-logging/select-web-service.png)
...
5. 将“启用日志记录”选项设置为“错误”（用于仅记录错误）或“全部”（用于记录完整日志）。
   ...
   ![选择日志记录级别](media/machine-learning-web-services-logging/enable-logging.png)
...
7. 对于经典 Web 服务，创建“ml-diagnostics”容器。
   ...
   3. 如果容器“ml-diagnostics”不存在，请单击“+容器”，将容器命名为“ml-diagnostics”，然后选择“访问类型”作为“Blob”。 单击 **“确定”**。
      ...
      ![选择日志记录级别](media/machine-learning-web-services-logging/create-ml-diagnostics-container.png)
