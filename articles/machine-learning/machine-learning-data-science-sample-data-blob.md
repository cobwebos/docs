...
你可以使用以下示例代码向下采样数据，并直接在 Azure ML 使用：
...
3. 使用 Azure ML [导入数据](https://msdn.microsoft.com/library/azure/4e1b0fe6-aded-4b3f-a36f-39b8862b9004/)从 Azure blob 中读取数据，如下图中所示：
