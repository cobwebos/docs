...
+ 要生成一组用于评估模型准确性（性能）的指标，可以将评分数据集连接到[评估模型](./evaluate-model.md)， 
...
评分的一个常见用途是在预测 Web 服务中返回输出。 有关详细信息，请参阅有关如何基于 Azure 机器学习设计器中的管道部署实时终结点的[教程](https://docs.microsoft.com/azure/machine-learning/tutorial-designer-automobile-price-deploy)。
