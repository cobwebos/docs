...
要克隆存储库并修改本地计算机或 DSVM 上的内容，或将 Azure 文件存储装载到 DSVM，需要考虑以下检查表：
...
1. 在 Azure DevOps 中，转到团队的项目摘要页面*https：\//\<服务器名称>/\<组织名称>/\<团队名称>，* 例如**https：\//dev.azure.com/DataScienceUnit/MyTeam**。
