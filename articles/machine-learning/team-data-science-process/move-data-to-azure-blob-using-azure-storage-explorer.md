...
2. 要打开“**登录到你的帐户**”向导，请选择“**Azure 帐户设置**”图标，选择“**添加帐户**”并输入凭据。 ![添加 Azure 存储帐户](./media/move-data-to-azure-blob-using-azure-storage-explorer/add-an-azure-store-account.png)
...
4. 在“**连接到 Azure 存储**”向导中，输入 Azure 存储帐户中的访问密钥，并选择“**下一步**”。 ![输入 Azure 存储帐户访问密钥](./media/move-data-to-azure-blob-using-azure-storage-explorer/connect-to-azure-storage-2.png)
