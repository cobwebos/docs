...
Microsoft 的 Cortana Intelligence 是一个完全托管的大数据和高级分析套件，使你得以将数据转换为智能操作。 我们要向你介绍 Cortana Intelligence 车辆遥测分析解决方案模板。 此解决方案演示了汽车经销商、汽车制造商和保险公司如何使用Cortana Intelligence 的功能获得车辆运行状况和驾驶习惯的实时和预测性深入了解。 
