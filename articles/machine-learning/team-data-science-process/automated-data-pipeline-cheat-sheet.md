...
根据数据是本地、云还是实时流，可以使用不同的机制将数据移动到 Web 服务终结点进行评分。
...
* 有关 Microsoft Azure 机器学习的概述，请参阅[Microsoft Azure 上的机器学习简介](../studio/what-is-machine-learning.md)。
