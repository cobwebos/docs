---
title: "使用简单模型（回归模型）预测答案 | Microsoft Docs"
...
* 视频 4：使用简单的模型预测答案
* 视频 5：[复制他人的工作以研究数据科学](machine-learning-data-science-for-beginners-copy-other-peoples-work-to-do-data-science.md)（3 分 18 秒）

## <a name="transcript-predict-an-answer-with-a-simple-model"></a>抄本：使用简单的模型预测答案
...
![钻石数据列](./media/machine-learning-data-science-for-beginners-predict-an-answer-with-a-simple-model/diamond-data.png)
...
![重量轴和价格轴](./media/machine-learning-data-science-for-beginners-predict-an-answer-with-a-simple-model/weight-and-price-axes.png)
...
![散点图](./media/machine-learning-data-science-for-beginners-predict-an-answer-with-a-simple-model/scatter-plot.png)
...
![线性回归线](./media/machine-learning-data-science-for-beginners-predict-an-answer-with-a-simple-model/linear-regression-line.png)
...
![在模型上找出答案](./media/machine-learning-data-science-for-beginners-predict-an-answer-with-a-simple-model/find-the-answer.png)
...
![置信区间](./media/machine-learning-data-science-for-beginners-predict-an-answer-with-a-simple-model/confidence-interval.png)
...
* [获取 Microsoft Azure 上的机器学习的简介](machine-learning-what-is-machine-learning.md)
