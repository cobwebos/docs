...
Azure 机器学习工作室提供一个交互式的可视化工作区，可以轻松地在预测分析模型上构建、测试和迭代。可以将“数据集”和分析“模块”拖放到交互式画布，将它们连接在一起构成“试验”，然后在机器学习工作室中运行该实验。若要在模型设计上迭代，则需要编辑试验，可根据需要保存一个副本，并重新运行该试验。准备就绪后，可以将“训练实验”转换为“预测试验”，然后将其作为“Web 服务”发布，以便其他人可以访问模型。
