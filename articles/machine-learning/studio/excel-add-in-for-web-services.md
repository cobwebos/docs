...
部署 Web 服务或使用现有的 Web 服务。 有关部署 Web 服务的详细信息，请参阅教程[3：部署信用风险模型](tutorial-part3-credit-risk-deploy.md)。
...
1. 部署 Web 服务或使用现有的 Web 服务。 有关部署 Web 服务的详细信息，请参阅教程[3：部署信用风险模型](tutorial-part3-credit-risk-deploy.md)。
2. 单击“**使用**”。
3. 查找**基本使用信息**部分。 复制并保存**主密钥**和**请求-响应** URL。
