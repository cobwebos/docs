...
有关简短概述，请观看 [Data Science for Beginners](data-science-for-beginners-the-5-questions-data-science-answers.md)（适合初学者的数据科研）系列视频。 “Data Science for Beginners”（适合初学者的数据科学）介绍了机器学习，并逐步讲解了一个简单的预测模型，整篇文章未使用行语或数学理论。
 ...
 * [部署 Web 服务](publish-a-machine-learning-web-service.md)
 * [通过 API 重新训练模型](retrain-models-programmatically.md)
 * [管理 Web 服务终结点](create-endpoint.md)
 * [缩放 Web 服务](scaling-webservice.md)
 * [使用 Web 服务](consume-web-services.md)
