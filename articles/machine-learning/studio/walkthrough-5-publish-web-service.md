...
要使此模型准备好进行部署，需要将此训练实验转换为预测实验。 这涉及到三个步骤：
...
3. 对于“价格计划”，可以选择现有的定价计划，也可以选择“新建”，并为新计划提供一个名称并选择每月计划选项。 计划层默认为默认区域的计划，并且 Web 服务将部署到该区域。
