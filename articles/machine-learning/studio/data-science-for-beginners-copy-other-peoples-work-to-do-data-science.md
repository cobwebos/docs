...
* 视频 3：[提出可用数据回答的问题（4 分钟 17 秒）](data-science-for-beginners-ask-a-question-you-can-answer-with-data.md) **
...
![在机器学习工作室（经典）中打开库试验 - 处理缺失值的方法](./media/data-science-for-beginners-copy-other-peoples-work-to-do-data-science/experiment-methods-for-handling-missing-values.png)
