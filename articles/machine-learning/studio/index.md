---
title: "Azure 机器学习工作室文档 - 教程和 API 参考 | Microsoft Docs"
description: "有关机器学习工作室（面向在应用程序中使用预测分析的数据科研人员和开发人员的云服务）的文档、视频和示例模型。"
...
Azure 机器学习工作室是一个协作型拖放式工具，可用于根据数据构建、测试和部署预测分析解决方案。
教程、视频和示例模型演示了如何使用工作室来生成及部署机器学习模型。
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/machinelearning">REST API 参考</a></p>
                        <p><a href="/azure/machine-learning/studio/web-service-error-codes">Web 服务错误代码</a></p>
                    </div>
                </div>
            </div>
        </div>
