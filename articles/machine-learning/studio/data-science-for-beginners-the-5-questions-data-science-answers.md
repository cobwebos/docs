...
如果您有信用卡，您已经受益于异常检测。 信用卡公司分析购买模式，使他们可提醒用户可能的欺诈行为。 “异常”费用可能是在一家通常不会去购物的商店购物时，或购买非常昂贵的物品时所产生的费用。

此问题在很多方面都很有用。 例如：

* 如果汽车上配有压力表，可能会想知道：此压力表读数是否正常？
* 如果你正在监视互联网，你会想知道：这条来自互联网的消息是典型的吗？
...
有时希望了解数据集的结构 - 组织方式为何？ 对于这个问题，您没有已经知道结果的示例。
