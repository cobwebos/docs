...
编写调用最终 Web 服务的应用程序时，可能要在运行时指定不同的输入查询或目标表。 若要配置这些输入和输出，可使用 Web 服务参数功能设置*导入数据*模块*数据源*属性和*导出数据*模式数据目标属性。  有关 Web 服务参数的详细信息，请参阅 Cortana 智能和机器学习博客上的[Azure 机器学习工作室 Web 服务参数条目](https://blogs.technet.microsoft.com/machinelearning/2014/11/25/azureml-web-service-parameters/)。
...
5. 在可视化工作室中，创建一个 C# 控制台应用程序：**新项目** > **Project** > **可视化 C#** > **Windows 经典桌面** > **控制台应用程序 （.NET 框架）。**
...
3. 在"部署实验"页上，输入 Web 服务的名称，然后选择定价计划，然后单击"**部署**"。
4. 在“快速启动”**** 页上，单击“使用”****。
5. 在“示例代码”**** 部分中，单击“批处理”****。
6. 在可视化工作室中，创建一个 C# 控制台应用程序：**新项目** > **Project** > **可视化 C#** > **Windows 经典桌面** > **控制台应用程序 （.NET 框架）。**
