---
title: 导入/导出 web services 中的数据-Azure 机器学习 Studio （经典） |Microsoft Docs
...
编写调用最终 Web 服务的应用程序时，可能要在运行时指定不同的输入查询或目标表。 若要配置这些输入和输出，可使用 Web 服务参数功能设置*导入数据*模块*数据源*属性和*导出数据*模式数据目标属性。  有关 Web 服务参数的详细信息，请参阅 Cortana Intelligence 上的[Azure 机器学习 Studio Web 服务参数](https://blogs.technet.microsoft.com/machinelearning/2014/11/25/azureml-web-service-parameters/)"和" 机器学习 "博客。
