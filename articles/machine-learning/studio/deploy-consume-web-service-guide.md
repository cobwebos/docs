...
用于 web 服务的 Azure 机器学习 Studio 资源提供程序的经典版本支持通过使用 REST API 调用来部署和管理 web 服务。 有关详细信息，请参阅[机器学习 Web 服务 (REST)](/rest/api/machinelearning/index) 参考。

<!-- [Machine Learning Web Service (REST)](https://msdn.microsoft.com/library/azure/mt767538.aspx) reference. -->

### <a name="with-powershell-cmdlets"></a>使用 PowerShell cmdlet

使用适用于 web 服务的 Azure 机器学习 Studio 资源提供程序的经典版本，可以使用 PowerShell cmdlet 来部署和管理 web 服务。
