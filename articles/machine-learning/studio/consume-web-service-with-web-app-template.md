...
* [Azure 机器学习工作室请求-响应服务 Web 应用模板](https://azure.microsoft.com/marketplace/partners/microsoft/azuremlaspnettemplateforrrs/)
* [Azure 机器学习工作室批处理执行服务 Web 应用模板](https://azure.microsoft.com/marketplace/partners/microsoft/azuremlbeswebapptemplate/)
...
1. 按照与 RRS 模板相同的步骤来创建 BES Web 应用。 但在本例中，需转到 [Azure 机器学习工作室批处理执行服务 Web 应用模板](https://azure.microsoft.com/marketplace/partners/microsoft/azuremlbeswebapptemplate/)以打开 Azure 市场中的 BES 模板。 选择“创建 Web 应用”。
