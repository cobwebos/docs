...
ms.locfileid: "88691269"
---
# <a name="create-and-share-an-machine-learning-studio-classic-workspace"></a>创建并共享机器学习 Studio (经典) 工作区
...
创建机器学习 Studio (经典) 工作区后，可以邀请用户进入工作区，以便共享对工作区及其所有试验、数据集等的访问权限。你可以将用户添加到以下两个角色之一：
