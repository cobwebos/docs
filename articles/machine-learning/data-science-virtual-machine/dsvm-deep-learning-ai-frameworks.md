...
| 支持的版本 | 1.3.0 |
| 支持的 DSVM 版本      | Windows 和 Linux   |
| 如何在 DSVM 上配置/安装它？  | MXNet 安装在 Windows 上的 `C:\dsvm\tools\mxnet` 中，并 `/dsvm/tools/mxnet` 在 Ubuntu 上。 Python 绑定安装在[Windows 2016](dsvm-languages.md#python-windows-server-2016-edition)上的 python 3.6 中，在[Linux](./dsvm-languages.md#python-linux-edition)上的 python 3.5 中也包含在 Ubuntu DSVM。 |
