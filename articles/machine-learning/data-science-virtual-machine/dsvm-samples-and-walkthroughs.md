...
若要访问 Jupyter, 请选择 "桌面" 或 "应用程序" 菜单上的 " **Jupyter** " 图标。 你还可以在 DSVM 的 Linux 版本上访问 Jupyter。 若要从 web 浏览器远程访问, 请`https://<Full Domain Name or IP Address of the DSVM>:8000`在 Ubuntu 上访问。
