...
description: 在 Azure 上配置和创建 Geo AI Data Science Virtual Machine，用于进行地理空间分析和机器学习。
...
ms.locfileid: "83646609"
---
# <a name="quickstart-set-up-a-geo-artificial-intelligence-virtual-machine-on-azure"></a>快速入门：在 Azure 上设置地理人工智能虚拟机 

Geo AI Data Science Virtual Machine (Geo-DSVM) 是流行的 [Azure Data Science Virtual Machine](https://aka.ms/dsvm) 的一个专门配置的扩展，它将 AI 和地理空间分析组合在一起。 VM 中的地理空间分析由 [ArcGIS Pro](https://www.arcgis.com/features/index.html) 提供支持。 Data Science Virtual Machine (DSVM) 能够快速训练机器学习模型，甚至深度学习模型。 为了开发这些模型，它将使用以地理信息扩充的数据。 Geo-DSVM 仅在 Windows 2016 DSVM 上受支持。 
...
## <a name="create-your-geo-ai-data-science-vm"></a>创建 Geo AI Data Science VM
...
- 位置：选择最合适的数据中心。 通常，最合适的数据中心应拥有大部分数据，或者最接近实际位置以实现最快的网络访问。 如果你打算在 GPU 上运行深度学习，必须选择 Azure 中包含 NC 系列 GPU VM 实例的某个位置。 目前，这些位置为：美国东部、美国中北部、美国中南部、美国西部 2、北欧、西欧。 有关最新列表，请查看[“Azure 产品(按区域)”页](https://azure.microsoft.com/regions/services/)并在“计算”下查找“NC 系列”。 
...
## <a name="how-to-access-the-geo-ai-data-science-virtual-machine"></a>如何访问 Geo AI Data Science Virtual Machine
...
* [使用 Geo AI Data Science VM](use-geo-ai-dsvm.md)
