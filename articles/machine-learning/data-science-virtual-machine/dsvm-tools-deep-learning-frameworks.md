...
> 以下 VM 映像已弃用：
>
> * Windows Server 2016 DSVM 映像
> * Ubuntu 16.04 DSVM 映像 
>
> 这些 VM 映像仅适用于使用 ARM 部署的现有客户。 这些映像将继续接收关键安全修补程序，直到其停用日期为止，但将不会用今后最新的数据科学工具更新。
> 
> 请参阅 [DSVM Image 弃用功能页](./reference-deprecation.md)。
...
| ------------- | ------------- |
| 支持的版本 | 10.0.130|
| 支持的 DSVM 版本      | Windows Server 2019<br>Ubuntu 18.04<br> Windows 2016 (弃用) <br> Ubuntu 16.04 (弃用)   |
...
| ------------- | ------------- |
| 支持的版本 | 0.16.1|
| 支持的 DSVM 版本      | Ubuntu 18.04<br> Ubuntu 16.04 (弃用)    |
...
| ------------- | ------------- |
| 支持的版本 | 2.5.1 |
| 支持的 DSVM 版本      | Windows 2016 (弃用) <br> Ubuntu 16.04 (弃用)    |
...
| 支持的 DSVM 版本      | Windows Server 2019<br>Ubuntu 18.04<br> Ubuntu 16.04 (弃用)  |
