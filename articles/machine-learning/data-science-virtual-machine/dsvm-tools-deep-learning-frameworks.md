...
| 运行方式      | 终端：启动 Python，并导入 Caffe2。 <br/> * JupyterHub：[连接到 JupyterHub](dsvm-ubuntu-intro.md#how-to-access-the-ubuntu-data-science-virtual-machine)，然后前往 Caffe2 目录以查找示例笔记本。 某些笔记本需要在 Python 代码中设置 Caffe2 根；输入 /opt/caffe2。 |
...
| 运行方式      | 终端：激活 Python 3.5 环境，运行，然后运行 `python` `import chainer` 。 <br/> * JupyterHub：[连接到 JupyterHub](dsvm-ubuntu-intro.md#how-to-access-the-ubuntu-data-science-virtual-machine)，然后前往 Chainer 目录以查找示例笔记本。| 
...
| 运行方式      | 终端：激活正确的环境，然后运行 Python。 <br/>Jupyter：连接到[Jupyter](provision-vm.md)或[JupyterHub](dsvm-ubuntu-intro.md#how-to-access-the-ubuntu-data-science-virtual-machine)，然后打开示例的 CNTK 目录。 |
...
| 运行方式      | 终端：激活正确的 conda 环境，然后运行 `import mxnet` 。 <br/>Jupyter：连接到[Jupyter](provision-vm.md#access-the-dsvm)或[JupyterHub](dsvm-ubuntu-intro.md#how-to-access-the-ubuntu-data-science-virtual-machine)，然后打开示例的 `mxnet` 目录。 |
...
| 运行方式      | 终端：激活正确的环境，然后运行 Python。 <br/> * Jupyter：连接到[Jupyter](provision-vm.md)或[JupyterHub](dsvm-ubuntu-intro.md#how-to-access-the-ubuntu-data-science-virtual-machine)，然后打开示例的 TensorFlow 目录。   |
