<properties
	pageTitle="使用机器学习的信用风险预测解决方案 | Microsoft Azure"
...
>[AZURE.TIP] 若要下载并打印“Microsoft Azure 机器学习工作室功能概述”示意图，请参阅 [Azure Machine 机器学习工作室功能概述](machine-learning-studio-overview-diagram.md)。
