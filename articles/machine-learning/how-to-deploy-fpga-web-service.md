...
转换后的模型和所有依赖项都将添加到 Docker 映像。  然后，可以部署并实例化此 Docker 映像。  支持的部署目标包括云中的 AKS 或 [Azure Data Box Edge](https://docs.microsoft.com/azure/databox-online/data-box-edge-overview) 等边缘设备。  还可以为已注册的 Docker 映像添加标记和说明。
