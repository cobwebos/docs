...
- 你自己的 Jupyter 笔记本服务器
    ...
    - 下载 chainer_mnist 的示例脚本文件。 [py](https://github.com/Azure/MachineLearningNotebooks/tree/master/how-to-use-azureml/ml-frameworks/chainer/deployment/train-hyperparameter-tune-deploy-with-chainer)。
...
将训练脚本**chainer_mnist py**复制到项目目录中。
...
本文介绍了如何在 Azure 机器学习上使用 Chainer 训练和注册深度学习和神经网络。 若要了解如何部署模型，请继续学习我们的[模型部署](how-to-deploy-and-where.md)一文。
