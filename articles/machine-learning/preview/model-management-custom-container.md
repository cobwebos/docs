...
1. Depenencies.yml 文件：若要管理可从 [PyPi]( https://pypi.python.org/pypi) 安装的依赖关系，可使用 Workbench 项目中的 conda_dependencies.yml 文件，或者自己创建。 这是安装可安装 pip 的 Python 依赖关系的建议方法。
