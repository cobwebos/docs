...
这种实际方案的公共 GitHub 存储库包含此示例需要的所有材料，其中包括代码示例：
...
* 确保你已经按照[安装和创建快速入门](quickstart-installation.md)中的说明正确安装 [Azure Machine Learning Workbench](./overview-what-is-azure-ml.md)。
