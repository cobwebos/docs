...
Azure 订阅的管理员需创建工作区，然后将用户添加为所有者或参与者。 有关详细信息，请参阅[创建和共享 Azure 机器学习工作区](machine-learning-create-workspace.md)。

创建工作区后，打开机器学习工作室 ([https://studio.azureml.net](https://studio.azureml.net))。 如果这是唯一的工作区，Studio 会自动将其打开。 或者可在窗口右上角中的工具栏中选择工作区。
