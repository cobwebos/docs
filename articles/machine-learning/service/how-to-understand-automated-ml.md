...
示例1：准确度 ![分类模型的准确性较差的分类模型](./media/how-to-understand-automated-ml/azure-machine-learning-auto-ml-confusion-matrix1.png)

示例2：具有高准确度的分类模型 ![高准确度的分类模型](./media/how-to-understand-automated-ml/azure-machine-learning-auto-ml-confusion-matrix2.png)
...
示例1：一个分类模型，精度和低召回 ![分类模型，精度较低且](./media/how-to-understand-automated-ml/azure-machine-learning-auto-ml-precision-recall1.png) 较低

示例2：分类模型的精度为100%，~ 100% 召回（理想） ![分类模型高精度和召回](./media/how-to-understand-automated-ml/azure-machine-learning-auto-ml-precision-recall2.png)

### <a name="roc"></a>ROC

接收方操作特征 (ROC) 是特定模型的正确分类标签与错误分类标签的对比图。 以较高的偏差基于数据集训练模型时，ROC 曲线提供的信息可能较少，因为它不会显示误报标签。

示例1：具有低 true 标签和高 false 标签 ![分类模型的分类模型，具有较低的标签和高 false 标签](./media/how-to-understand-automated-ml/azure-machine-learning-auto-ml-roc-1.png)

示例2：具有高 true 标签和低 false 标签 ![分类模型，其中包含高 true 标签和低假标签](./media/how-to-understand-automated-ml/azure-machine-learning-auto-ml-roc-2.png)
...
示例1：模型的性能比随机选择模型更糟 ![分类模型是否比随机选择模型更糟](./media/how-to-understand-automated-ml/azure-machine-learning-auto-ml-lift-curve1.png)

示例2：模型的执行效果优于随机选择模型 ![执行更好](./media/how-to-understand-automated-ml/azure-machine-learning-auto-ml-lift-curve2.png) 的分类模型
...
示例1：具有最小收益 ![分类模型的分类模型](./media/how-to-understand-automated-ml/azure-machine-learning-auto-ml-gains-curve1.png)

示例2：一个分类模型，其中包含大量收益 ![分类模型](./media/how-to-understand-automated-ml/azure-machine-learning-auto-ml-gains-curve2.png)
...
示例1：更好的更好的模型 ![ 更好地校准的模型](./media/how-to-understand-automated-ml/azure-machine-learning-auto-ml-calib-curve1.png)

示例2： ![超出置信度的模型](./media/how-to-understand-automated-ml/azure-machine-learning-auto-ml-calib-curve2.png)
...
示例1：预测的回归模型在预测 ![的回归模型的准确性较低](./media/how-to-understand-automated-ml/azure-machine-learning-auto-ml-regression1.png)

示例2：其预测中具有高准确度的回归模型[![其预测中具有高准确度的回归模型](./media/how-to-understand-automated-ml/azure-machine-learning-auto-ml-regression2.png)](./media/how-to-understand-automated-ml/azure-machine-learning-auto-ml-regression2-expanded.png)
...
示例1：在错误中有偏差的回归模型 ![SA 回归模型，其中发生错误](./media/how-to-understand-automated-ml/azure-machine-learning-auto-ml-regression3.png)

示例2：一种回归模型，其中包含更多的错误分布 ![回归模型，更均匀地分布错误](./media/how-to-understand-automated-ml/azure-machine-learning-auto-ml-regression4.png)
