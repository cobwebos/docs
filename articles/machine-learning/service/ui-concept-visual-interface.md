...
若要了解如何开始处理视觉对象界面, 请参阅[教程:通过视觉对象界面](ui-tutorial-automobile-price-train-score.md)预测汽车价格。
...
计算目标会附加到机器学习[工作区](concept-workspace.md)。 在[Azure 门户](https://portal.azure.com)的工作区中管理计算目标。
