...
数据集包含14个特征和一个标签列。 有多种类型的功能，包括数字和分类。 下图显示了数据集的摘录： ![数据](media/how-to-ui-sample-classification-predict-income/data.png)
...
![应用转换](media/how-to-ui-sample-classification-predict-income/transformation.png)
...
![评估结果](media/how-to-ui-sample-classification-predict-income/evaluate-result.png)
