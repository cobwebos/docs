...
![管道的图形](media/how-to-ui-sample-regression-predict-automobile-price-basic/overall-graph.png)
...
4. 为示例1管道选择 "**打开**" 按钮：
    ...
    ![打开管道](media/how-to-ui-sample-regression-predict-automobile-price-basic/open-sample1.png)
