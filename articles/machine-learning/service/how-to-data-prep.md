...
使用 Azure 机器学习数据准备 SDK 查看数据准备的[示例笔记本](https://github.com/Microsoft/MSDataPrepDocs/blob/master/Scenarios/GettingStarted/getting-started.ipynb)。
