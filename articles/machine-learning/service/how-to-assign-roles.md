...
> [!IMPORTANT]
> 可以在 Azure 中的多个级别到作用域角色的访问权限。 例如，具有对工作组所有者访问权限的人员可能不具有对包含工作组的资源组所有者访问权限。 有关详细信息，请参阅[如何 RBAC 适用](/azure/role-based-access-control/overview#how-rbac-works)。
