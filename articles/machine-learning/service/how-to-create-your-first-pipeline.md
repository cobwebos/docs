...
有关更详细的示例，请参阅[示例笔记本](https://aka.ms/pl-databricks)GitHub 上。
...
有关更详细的示例，请参阅[示例笔记本](https://aka.ms/pl-adla)GitHub 上。
