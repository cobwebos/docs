...
```
 ...
 若要详细了解如何使用数据集，请参阅[添加 & register dataset](how-to-create-register-datasets.md)或[此示例笔记本](https://aka.ms/tabulardataset-samplenotebook)。
