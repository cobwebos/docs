...
如果使用 Jupyter Notebook，则使用此 [Jupyter 小组件](https://docs.microsoft.com/python/api/azureml-widgets/azureml.widgets?view=azure-ml-py)可以看到一个包含所有结果的图形和表：
