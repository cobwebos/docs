...
这些演练在 HDInsight Hadoop 群集中使用 Hive 执行预测分析。 它们遵循 Team Data Science Process 中所述的步骤。 有关 Team Data Science Process 的概述，请参阅[数据科学过程](data-science-process-overview.md)。 有关 Azure HDInsight 的简介，请参阅 [Azure HDInsight、Hadoop 技术堆栈和 Hadoop 群集简介](../hdinsight/hdinsight-hadoop-introduction.md)。
...
[使用 HDInsight Hadoop 群集](machine-learning-data-science-process-hive-walkthrough.md)演练使用纽约出租车中的数据来预测： 
