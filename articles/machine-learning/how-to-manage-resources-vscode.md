...
ms.locfileid: "87306139"
---
# <a name="manage-azure-machine-learning-resources-with-the-vs-code-extension-preview"></a>用 VS Code 扩展管理 Azure 机器学习资源（预览版）
...
1. VS Code 中将出现一个配置文件。 如果对配置文件满意，请选择 "**保存并继续**" 或打开 VS Code 命令面板（**查看 > 命令面板**）并键入 " **Azure ML：保存并继续**"。
...
1. 在提示符下：
    ...
    1. 定义环境配置：
        ...
        - *自定义*：定义自己的通道和依赖项
    1. 配置文件将在编辑器中打开。 如果对配置满意，请选择 "**保存并继续**" 或打开 VS Code 命令面板（**查看 > 命令面板**）并键入 " **Azure ML：保存并继续**"。
...
1. 进行修改后，如果对配置满意，请选择 "**保存并继续**" 或打开 VS Code 命令面板（**查看 > 命令面板**）并键入 " **Azure ML：保存并继续**"。
...
1. 计算的配置文件将在编辑器中打开。 如果对配置满意，请选择 "**保存并继续**" 或打开 VS Code 命令面板（**查看 > 命令面板**）并键入 " **Azure ML：保存并继续**"。
...
1. 在提示符下：
    ...
    1. 可有可无选择是否要为训练运行创建数据引用。 这样做会提示你在运行配置中定义一个数据集。
        1. 从一个已注册的数据集中选择一个链接到运行配置的数据集的配置文件将在编辑器中打开。 如果对配置满意，请选择 "**保存并继续**" 或打开 VS Code 命令面板（**查看 > 命令面板**）并键入 " **Azure ML：保存并继续**"。
    1. 如果对配置满意，请选择 "**保存并继续**" 或打开 VS Code 命令面板（**查看 > 命令面板**）并键入 " **Azure ML：保存并继续**"。
...
1. 运行配置的配置文件将在编辑器中打开。 如果对配置满意，请选择 "**保存并继续**" 或打开 VS Code 命令面板（**查看 > 命令面板**）并键入 " **Azure ML：保存并继续**"。
...
1. 在提示符下：
    ...
    1. 选择您的模型是文件还是文件夹。
    1. 查找本地 PC 中的模型。
    1. 编辑器中模型的配置文件。 如果对配置满意，请选择 "**保存并继续**" 或打开 VS Code 命令面板（**查看 > 命令面板**）并键入 " **Azure ML：保存并继续**"。
...
1. 在提示符下：
    ...
    1. 提供要在对模型进行评分时运行的脚本。
    1. 提供 Conda 依赖项文件。
    1. 你的部署的配置文件将显示在编辑器中。 如果对配置满意，请选择 "**保存并继续**" 或打开 VS Code 命令面板（**查看 > 命令面板**）并键入 " **Azure ML：保存并继续**"。
...
1. 右键单击要管理的部署：
    - 若要编辑设置，请选择 "**编辑服务**"。
        - 你的部署的配置文件将显示在编辑器中。 如果对配置满意，请选择 "**保存并继续**" 或打开 VS Code 命令面板（**查看 > 命令面板**）并键入 " **Azure ML：保存并继续**"。
