...
description: 了解 Azure SQL 数据库基于 DTU 的购买模型中的服务层，以提供计算和存储大小。
...
> [!NOTE]
> 有关基于 vCore 的服务层级的信息，请参阅[基于 vCore 的服务层级](service-tiers-vcore.md)。 有关区分基于 DTU 的服务层和基于 vCore 的服务层的信息，请参阅[购买模型](purchasing-models.md)。
