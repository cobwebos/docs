...
ms.locfileid: "84025808"
---
# <a name="find-and-apply-performance-recommendations"></a>查找并应用性能建议
[!INCLUDE[appliesto-sqldb](../includes/appliesto-sqldb.md)]

你可以使用 Azure 门户来查找可优化 Azure SQL 数据库中的数据库性能的性能建议，或者更正工作负荷中标识的某个问题。 利用 "Azure 门户中的"**性能建议**"页，您可以根据其潜在影响找到最重要的建议。
...
使用以下步骤查找 Azure 门户上的性能建议：

1. 登录到 [Azure 门户](https://portal.azure.com/)。
2. 中转到 "**所有服务**  >  " "**SQL 数据库**"，然后选择数据库。
...
还可以查看历史操作的状态。 选择建议或状态以查看详细信息。

下面是 Azure 门户中的 "创建索引" 建议的示例。
...
Azure SQL 数据库提供了有关提高数据库性能的建议。 通过提供 T-SQL 脚本，可以获得帮助来优化数据库并最终提升查询性能。

## <a name="next-steps"></a>后续步骤

监视建议并继续应用它们以优化性能。 数据库工作负荷是动态的，并且不断地更改。 Azure SQL 数据库将继续监视和提供可能提高数据库性能的建议。

* 请参阅[自动优化](automatic-tuning-overview.md)，了解有关 Azure SQL 数据库中自动优化的详细信息。
