...
另一系列教程展示了流量管理器的用途，它们是[异地还原](../../sql-database/saas-dbpertenant-dr-geo-restore.md)和[异地复制](../../sql-database/saas-dbpertenant-dr-geo-replication.md)教程。 在这些教程中，流量管理器用来在发生区域性服务中断时帮助切换到 SaaS 应用的恢复实例。
