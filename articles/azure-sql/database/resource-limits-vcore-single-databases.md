...
|最大并发会话数|30,000|30,000|30,000|30,000|30,000|
|副本数|1|1|1|1|1|
|Multi-AZ|空值|空值|空值|不适用|空值|
|读取横向扩展|空值|空值|空值|不适用|不适用|
|随附的备份存储|1 倍数据库大小|1 倍数据库大小|1 倍数据库大小|1 倍数据库大小|1 倍数据库大小|
...
|列存储支持|是|是|是|是|是|是|
|内存中 OLTP 存储 (GB)|空值|空值|空值|不适用|不适用|不适用|
...
|[RBPEX](service-tier-hyperscale.md#compute) 大小|3 倍内存|3 倍内存|3 倍内存|3 倍内存|3 倍内存|3 倍内存|
|列存储支持|是|是|是|是|是|是|
|内存中 OLTP 存储 (GB)|空值|不适用|不适用|不适用|不适用|不适用|
|最大数据大小 (TB)|100 |100 |100 |100 |100 |100 |
|最大日志大小 (TB)|无限制 |无限制 |无限制 |无限制 |无限制 |无限制 |
...
|列存储支持|是|是|是|是|是|是|是|
|内存中 OLTP 存储 (GB)|空值|不适用|不适用|不适用|不适用|不适用|不适用|
...
|Multi-AZ|空值|不适用|不适用|不适用|不适用|不适用|不适用|
...
|最大并发会话数|30,000|30,000|30,000|30,000|30,000|30,000|30,000|
|副本数|1|1|1|1|1|1|1|
|Multi-AZ|空值|空值|空值|空值|不适用|不适用|不适用|
...
|最大并发会话数|30,000|30,000|30,000|30,000|30,000|30,000|30,000|
|副本数|1|1|1|1|1|1|1|
|Multi-AZ|空值|空值|空值|不适用|不适用|不适用|不适用|
|读取横向扩展|不适用|不适用|不适用|不适用|不适用|不适用|不适用|
|随附的备份存储|1 倍数据库大小|1 倍数据库大小|1 倍数据库大小|1 倍数据库大小|1 倍数据库大小|1 倍数据库大小|1 倍数据库大小|
