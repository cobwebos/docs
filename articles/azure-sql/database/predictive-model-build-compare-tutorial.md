...
* 本教程的第二部分假定你已完成[**第一部分**](predictive-model-prepare-data-tutorial.md)及其先决条件。
...
![比较两个模型](./media/predictive-model-build-compare-tutorial/compare-models.png)
...
> [教程：使用 Azure SQL 数据库机器学习服务（预览版）在 R 中部署预测模型](predictive-model-deploy-tutorial.md)
