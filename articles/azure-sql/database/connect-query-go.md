...
- Azure SQL 数据库或 Azure SQL 托管实例中的数据库。 可以使用以下快速入门之一来创建数据库：
  ...
  |||[从本地进行的连接](../managed-instance/point-to-site-p2s-configure.md) | [连接到 SQL Server 实例](../virtual-machines/windows/sql-vm-create-portal-quickstart.md)
