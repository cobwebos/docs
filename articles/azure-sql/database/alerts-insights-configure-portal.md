...
本文介绍如何使用 Azure 门户在 Azure SQL 数据库和 Azure Synapse Analytics (以前的 SQL 数据仓库) 上设置数据库警报。 当某些指标（例如数据库大小或 CPU 使用率）达到阈值时，警报可以向你发送电子邮件或调用 Webhook。
