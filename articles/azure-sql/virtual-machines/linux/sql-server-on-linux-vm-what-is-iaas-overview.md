...
## <a name="get-started-with-sql-vms"></a><a id="create"></a> SQL VM 入门
...
* [虚拟机概述](../../../virtual-machines/linux/overview.md)
...
* [Azure Linux 虚拟机中的 SQL Server 常见问题解答](frequently-asked-questions-faq.md)
