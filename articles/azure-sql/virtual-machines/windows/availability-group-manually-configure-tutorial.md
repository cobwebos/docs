...
|![方块字 ](./media/availability-group-manually-configure-tutorial/square.png) **Windows Server**    | 用于群集见证的文件共享 |  
...
|![方形 ](./media/availability-group-manually-configure-tutorial/square.png) **安装域帐户**    | - 每个 SQL Server 上的本地管理员帐户 <br/> - 每个 SQL Server 实例的 SQL Server sysadmin 固定服务器角色的成员  |
