...
向 [SQL VM 资源提供程序](sql-vm-resource-provider-register.md)注册 SQL Server VM 时，会安装 SQL Server IaaS 扩展。 如有必要，可以使用以下 PowerShell 命令手动安装 SQL Server IaaS 代理： 
