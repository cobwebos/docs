---
title: 为 FCI 准备虚拟机
description: 准备 Azure 虚拟机，以便将其与故障转移群集实例（FCI）一起使用，并在 Azure 虚拟机上 SQL Server。
...
ms.locfileid: "85965438"
---
# <a name="prepare-virtual-machines-for-an-fci-sql-server-on-azure-vms"></a>为 FCI （Azure Vm 上 SQL Server）准备虚拟机
[!INCLUDE[appliesto-sqlvm](../../includes/appliesto-sqlvm.md)]

本文介绍如何准备 Azure 虚拟机（Vm），以便将其与 SQL Server 故障转移群集实例（FCI）配合使用。 根据 FCI 存储解决方案的不同，配置设置会有所不同，因此请验证是否选择了正确的配置以满足你的环境和业务的需要。 
...
- Microsoft Azure 订阅。 [免费试用](https://azure.microsoft.com/free/)。 
...
1. 如果使用的是基于 SQL Server 的虚拟机映像之一，请删除 SQL Server 实例：
   ...
   1. 选择“删除”。
   1. 选择默认实例。
   1. 删除“数据库引擎服务”下的所有功能。 请勿在 "**共享功能**" 下删除任何内容。 此时的屏幕显示如以下屏幕截图所示：
