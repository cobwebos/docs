...
本文不逐一介绍 Azure 中公开的每个 API，而以某些 API 为例，说明如何继续连接到这些 API。如果你有一定的基础知识，则可继续阅读 [Azure Resource Manager REST API 参考](https://msdn.microsoft.com/library/azure/dn790568.aspx)，以查找有关如何使用其余 API 的详细信息。
...
[此处介绍了 Azure Resource Manager REST API](https://msdn.microsoft.com/library/azure/dn790568.aspx)，本教程不再阐述每个 API 的用法。本文档只使用几个 API 来说明 API 的基本用法，然后会提供正式文档的链接。
