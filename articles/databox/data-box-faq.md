...
A. 如果系统故障指示器 LED 灯亮起，则表示系统不正常。 有关后续步骤，[请联系 Microsoft 支持部门](data-box-disk-contact-microsoft-support.md)。
...
A. 是的。 Microsoft 还仅在 US Gov 区域提供自我管理的发货。 放置 Data Box 订单时，可以选择 "自行管理的装运选项"。 若要选取 Data Box 设备，请执行以下步骤：
...
### <a name="q-e-ink-display-is-not-showing-the-return-shipment-label-what-should-i-do"></a>Q. 电子墨水显示屏未显示退货发货标签。   应采取何种操作？
