...
A. 可以。 丢失或损坏的设备也会产生费用。 [定价页](https://azure.microsoft.com/pricing/details/storage/databox/)和[产品服务条款](https://www.microsoft.com/licensing/product-licensing/products)中提到了这笔费用。
...
A.  在 Azure 门户中，转到 Data Box 订单，并导航到“设备详细信息”。 复制解锁密码。 在 Data Box 上使用此密码登录本地 Web UI。 有关详细信息，请转到[教程：解压缩、布线和连接 Azure Data Box](data-box-deploy-set-up.md)。
...
A.  可以。 可以使用 Data Box 连接 SMB 和 NFS 客户端。 有关详细信息，请转到主机的[受支持操作系统](data-box-system-requirements.md)列表。
...
A. 可以。 可将 Data Box 连接到多台主机来传输数据，并且可以并行运行多个复制作业。 有关详细信息，请转到[教程：将数据复制到 Azure Data Box](data-box-deploy-copy-data.md)。
...
A. 可以。 可以同时连接到 Data Box 上的两个 10-GbE 接口来复制数据。 有关如何复制数据的详细信息，请参阅[教程：将数据复制到 Azure Data Box](data-box-deploy-copy-data.md)。
...
### <a name="q-the-system-fault-indicator-led-on-the-front-operating-panel-is-on-what-should-i-do"></a>Q. 前操作面板上的系统故障指示器 LED 灯亮起。 我应该怎么做？
...
- 使用多个数据复制流。 例如，在 Robocopy 中使用多线程选项。 有关所用的确切命令的详细信息，请转到[教程：将数据复制到 Azure Data Box 并验证](data-box-deploy-copy-data.md)。
- 使用多个会话。
...
A.  可以。 Data Box 最多支持 10 个存储帐户（常规用途帐户、经典帐户或 blob 存储帐户）。 支持热 Blob 和冷 Blob。 
...
### <a name="q-my-device-was-delivered-but-the-device-seems-to-be-damaged-what-should-i-do"></a>Q. 我的设备已送达，但似乎已损坏。 我应该怎么做？
...
### <a name="q-can-i-pick-up-my-data-box-order-myself-can-i-return-the-data-box-via-a-carrier-that-i-choose"></a>Q. 我能否自行选取 Data Box 顺序？ 是否可以通过所选的承运人返回 Data Box？
A. 可以。 Microsoft 还仅在 US Gov 区域提供自我管理的发货。 放置 Data Box 订单时，可以选择 "自行管理的装运选项"。 若要选取 Data Box 设备，请执行以下步骤：
    
1. 下订单后，将处理订单，并准备好 Data Box。 将通过电子邮件通知你订单已准备好进行提货。 
...
### <a name="q-will-my-data-box-devices-cross-country-borders-during-shipping"></a>Q. 我的 Data Box 设备在运输过程中是否将跨越国家/地区边界？
...
### <a name="q-e-ink-display-is-not-showing-the-return-shipment-label-what-should-i-do"></a>Q. 电子墨水显示屏未显示退货发货标签。 我应该怎么做？
...
### <a name="q-i-have-finished-prepare-to-ship-and-shut-down-the-device-can-i-still-add-more-data-to-data-box"></a>Q. 我已完成“准备交付”，并关闭了设备。 是否仍能向 Data Box 添加更多数据？
A. 可以。 可以打开设备并添加更多数据。 完成数据复制后，需要再次运行“准备交付”。
...
A.  不。 Azure 数据中心目前不接受客户或 UPS 以外的承运人交付 Data Box。
