...
本文适用于 Microsoft Azure 数据盒磁盘，并介绍了在使用解锁工具时用于解决任何问题的工作流。 
...
若要解锁 Data Box Disk，需要使用 Data Box Disk解锁工具并从 Azure 门户提供密码。 有关详细信息，请转到[教程：解包、连接和解锁 Azure 数据框磁盘](data-box-disk-deploy-set-up.md#connect-to-disks-and-get-the-passkey)。
