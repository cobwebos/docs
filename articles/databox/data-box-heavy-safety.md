...
* 检查收到的原始设备是否有损坏。** 如果设备机柜已损坏，请联系[Microsoft 支持以获取](data-box-disk-contact-microsoft-support.md)更换。 请勿尝试操作设备。 
* 设备上配备了防篡改螺丝。 如果您怀疑设备出现故障[，Microsoft 支持](data-box-disk-contact-microsoft-support.md)以获取更换。 请勿尝试自行维修设备。 
* 设备不包含任何用户可维修部件。 内有危险电压、电流和能量。 请勿拆开机箱。 请将设备退回到 Microsoft 进行检修。

![警告图标](./media/data-box-heavy-safety/warning-icon.png)![重磅图标](./media/data-box-heavy-safety/heavy-weight-hazard-icon.png)**警告！** 
...
* 根据以下电源规格提供带电力过载保护的合适电源：
    ...
    - 电流：6 A 至 10 A，每根电源线最大。 提供了四条电源线。
    - 频率：50Hz 到 60Hz
...
* **仅限维修人员**：如果电池更换为不正确的类型，则有爆炸风险。 请根据说明处置已用完的电池。
...
- 设计为在以下环境中工作。 
    - 工作温度：41°至95°F（5°至35°C）
    - 贮藏温度：-40° 到 149°F（-40° 到 65°C）
    - 相对湿度：20%至85%（无冷凝） 
    - 工作高度：测试高度可达 6，560 英尺（高达 2000 米）
...
[索取](mailto:CSI_Compliance@microsoft.com)欧盟《符合性声明》的副本。
...
微软 爱尔兰 桑迪福德 Ind Est 都柏林 D18 KX32 IRL 电话号码： +353 1 295 3826 传真号码： +353 1 706 4110 
