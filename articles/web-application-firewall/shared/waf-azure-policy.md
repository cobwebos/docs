...
description: Azure Web 应用程序防火墙（WAF）与 Azure 策略结合在一起，可帮助实施组织标准并评估 WAF 资源的符合性
...
Azure Web 应用程序防火墙（WAF）与 Azure 策略结合在一起，可帮助强制实施组织标准并评估 WAF 资源的符合性。 Azure 策略是一种管理工具，它提供了汇总视图来评估环境的整体状态，并能够向下钻取每个资源的每个策略粒度。 Azure 策略还有助于通过对现有资源进行大容量修正和对新资源进行自动修正来使资源符合要求。
