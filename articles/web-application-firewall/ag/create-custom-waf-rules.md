...
Azure 应用程序网关上的 Web 应用程序防火墙（WAF） v2 为 web 应用程序提供保护。 该保护通过打开 Web 应用程序安全性项目 (OWASP) 核心规则集 (CRS) 来提供。 在某些情况下，可能需要根据具体需求创建自己的自定义规则。 有关 WAF 自定义规则的详细信息，请参阅[自定义 Web 应用程序防火墙规则概述](custom-waf-rules-overview.md)。
...
在此示例中，需阻止来自某个 IP 地址范围的所有流量。 规则的名称为*myrule1* ，优先级设置为10。
