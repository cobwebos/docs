...
按照[快速入门：为高度可用的全局 web 应用程序创建前门](../../frontdoor/quickstart-create-front-door.md)中所述的说明创建 Azure 前门服务配置文件。
...
- 了解如何[创建 Azure 前门服务配置文件](../../frontdoor/quickstart-create-front-door.md)。
