...
description: 本文提供了有关 Azure 前门服务上的 Web 应用程序防火墙的常见问题的解答。
...
## <a name="what-is-waf-on-azure-front-door-service"></a>什么是 Azure 前门服务上的 WAF？ 
...
前门服务提供 SSL 卸载。 WAF 本机与前门集成，并可以在请求解密后检查请求。
