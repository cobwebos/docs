...
[如何将 Azure Redis Cache 与 Node.js 配合使用](cache-nodejs-get-started)展示了在使用 Node.js 和 [node_redis](https://github.com/mranney/node_redis) 客户端的情况下使用 Azure Redis Cache 的入门知识。

[如何将 Azure Redis Cache 与 Java 配合使用](cache-java-get-started)展示了在使用 Java 和 [Jedis](https://github.com/xetorthio/jedis) 客户端的情况下使用 Azure Redis Cache 的入门知识。

[如何将 Azure Redis Cache 与 Python 配合使用](cache-python-get-started)展示了在使用 Python 和 [redis-py](https://github.com/andymccurdy/redis-py) 客户端的情况下使用 Azure Redis Cache 的入门知识。
