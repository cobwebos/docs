...
* 一个 Azure 订阅。 如果没有 Azure 订阅，可以创建一个[免费帐户][az-portal-create-account]。
...
## <a name="enable-azure-dev-spaces-using-the-azure-portal"></a>使用 Azure 门户启用 Azure Dev Spaces
