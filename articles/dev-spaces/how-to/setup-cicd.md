...
1. 单击 "**浏览**" `samples/release.json` ，然后从项目中选择。
...
部署后，可使用如下公共 URL 访问 webfrontend** 的 dev__ 版本：`http://dev.webfrontend.fedcba098.eus.azds.io`。 可以通过运行以下`azds list-uri`命令来查找此 URL： 
