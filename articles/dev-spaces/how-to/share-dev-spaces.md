---
title: 如何共享 Azure 开发空间
services: azure-dev-spaces
ms.date: 05/11/2018
ms.topic: conceptual
description: 了解如何使用 Azure 开发人员空间与团队中的其他人共享 Azure Kubernetes 服务中的开发空间
...
1. 确保每个团队成员具有访问[Azure 开发人员空间控制器的适当权限](../troubleshooting.md#incorrect-rbac-permissions-for-calling-dev-spaces-controller-and-apis)。 例如，可以将 Azure 开发人员空间**的资源组**配置为[为每个团队成员授予参与者访问权限](/azure/active-directory/role-based-access-control-configure)。 可以运行下面的命令来检查开发空间的资源组：`azds show-context`
1. 让团队成员选择要用于开发的开发空间****。
