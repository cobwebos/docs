...
## <a name="aks-clusters-with-different-virtual-network-or-subnet-configurations"></a>具有不同虚拟网络或子网配置的 AKS 群集
...
## <a name="using-azure-container-networking-with-azure-dev-spaces"></a>将 Azure 容器联网与 Azure Dev Spaces 配合使用
...
## <a name="using-api-server-authorized-ip-ranges-with-azure-dev-spaces"></a>将 API 服务器授权的 IP 范围用于 Azure Dev Spaces
...
## <a name="using-aks-private-clusters-with-azure-dev-spaces"></a>在 Azure Dev Spaces 中使用 AKS 专用群集

目前， [AKS 专用群集][aks-private-clusters]不支持 Azure Dev Spaces。

## <a name="azure-dev-spaces-client-requirements"></a>Azure Dev Spaces 客户端要求
