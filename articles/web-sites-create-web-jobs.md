...
- WebJobs-related videos:
	...
	[Azure WebJobs 101 - Basic WebJobs with Jamie Espinosa](http://www.windowsazure.cn/zh-cn/documentation/videos/azure-webjobs-basics/)
	
	[Azure WebJobs 102 - Scheduled WebJobs and the WebJobs Dashboard with Jamie Espinosa](http://www.windowsazure.cn/zh-cn/documentation/videos/azure-webjobs-schedule-and-dashboard/)
	
	[Azure Scheduler 101 - Kevin Lam explains how to schedule stuff](http://www.windowsazure.cn/zh-cn/documentation/videos/azure-scheduler-how-to/)

###Get Started
To get started with Azure, see [Microsoft Azure Free Trial](http://azure.microsoft.cn/zh-cn/pricing/free-trial/).
