...
description: 本文档介绍了数据库连接从 Azure 内或从 Azure SQL 连接体系结构在 Azure 之外。
...
下表列出了 IP 地址的网关的区域。 若要连接到 Azure SQL 数据库，需要允许网络流量，到和移**所有**网关的区域。

今后，我们将在每个区域中添加多个网关和停用已解除授权的网关 IP 地址列在下表中的网关。 有关取消配置过程的以下文章中提供的更多详细信息：[Azure SQL 数据库流量迁移到更高版本网关](sql-database-gateway-migration.md)


| 区域名称          | 网关 IP 地址 | 已解除授权的网关 </br> IP 地址| 有关说明解除授权 | 
| --- | --- | --- | --- |
...
| 加拿大中部       | 40.85.224.249      |                 | |
| 加拿大东部          | 40.86.226.166      |                 | |
| 美国中部           | 13.67.215.62, 52.182.137.15 | 23.99.160.139 | 2019 年 9 月 1 日之后的任何连接 |
| 中国东部 1         | 139.219.130.35     |                 | |
| 中国东部 2         | 40.73.82.1         |                 | |
| 中国北部 1        | 139.219.15.17      |                 | |
| 中国北部 2        | 40.73.50.0         |                 | |
| 东亚            | 191.234.2.139, 52.175.33.150 |       | |
| 美国东部 1            | 40.121.158.30, 40.79.153.12 | 191.238.6.43 | 2019 年 9 月 1 日之后的任何连接 |
| 美国东部 2            | 40.79.84.180, 52.177.185.181, 52.167.104.0 | 191.239.224.107    | 2019 年 9 月 1 日之后的任何连接 |
...
| 印度西部           | 104.211.160.80     |                 | |
| 日本东部           | 13.78.61.196, 40.79.184.8, 13.78.106.224 | 191.237.240.43 | 2019 年 9 月 1 日之后的任何连接 |
| 日本西部           | 104.214.148.156, 40.74.100.192 | 191.238.68.11 | 2019 年 9 月 1 日之后的任何连接 |
| 韩国中部        | 52.231.32.42       |                 | |
| 韩国南部          | 52.231.200.86      |                 | |
| 美国中北部     | 23.96.178.199      | 23.98.55.75     | 2019 年 9 月 1 日之后的任何连接 |
| 北欧         | 40.113.93.91       | 191.235.193.75  | 2019 年 9 月 1 日之后的任何连接 |
| 美国中南部     | 13.66.62.124       | 23.98.162.75    | 2019 年 9 月 1 日之后的任何连接 |
| 东南亚      | 104.43.15.0        | 23.100.117.95   | 2019 年 9 月 1 日之后的任何连接 |
| 英国南部             | 51.140.184.11      |                 | |
| 英国西部              | 51.141.8.11        |                 | |
| 美国中西部      | 13.78.145.25       |                 | |
...
### <a name="azure-cli-in-a-bash-shell"></a>在 bash shell 中的 azure CLI

> [!IMPORTANT]
> 此脚本需要 [Azure CLI](https://docs.microsoft.com/cli/azure/install-azure-cli)。

以下 CLI 脚本演示如何更改连接策略在 bash shell。
...
### <a name="azure-cli-from-a-windows-command-prompt"></a>在 Windows 命令提示符下的 azure CLI

> [!IMPORTANT]
> 此脚本需要 [Azure CLI](https://docs.microsoft.com/cli/azure/install-azure-cli)。

以下 CLI 脚本演示如何更改连接策略从 Windows 命令提示符 （使用 Azure CLI 安装)。
