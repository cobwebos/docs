...
1. 启动 <a href="https://portal.azure.com" target="_blank">Azure 预览门户</a> (https://portal.azure.com) 。或者，你也可以启动<a href= "https://manage.windowsazure.cn/" target="_bank">经典 Azure 门户</a> (https://manage.windowsazure.cn/) 。请参考以下详细信息。
