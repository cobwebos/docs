...
审核工具有助于遵从法规标准，但不能保证遵从法规。有关可帮助你遵从标准的 Azure 计划的详细信息，请参阅 [Azure 信任中心](http://azure.microsoft.com/support/trust-center/compliance)。
...
本部分中的说明与以上屏幕截图相关。可以使用 [Azure 预览门户](https://manage.windowsazure.cn)或[经典 Azure 门户](https://manage.windowsazure.cn/)。
