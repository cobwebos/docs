...
## <a name="a-idsubheading-8ablobtable-differences-in-server-auditing-policy-inheritance"></a><a id="subheading-8"></a>Blob/表在服务器审核策略继承中的差异
...
1. 通过 [Azure 门户](https://portal.azure.com)打开相关数据库。 在数据库的“审核和威胁检测”边栏选项卡的顶部，单击“查看审核日志”。
