...
1. 在 [Azure 门户](https://portal.azure.cn/)中，选择“浏览”>“SQL Server”浏览到要升级的服务器，然后选择要升级的 v2.0 服务器。
...
除监视单个数据库外，还可以监视弹性数据库池。使用[Azure 门户](/documentation/articles/sql-database-elastic-pool-manage-portal/)或通过 [PowerShell](/documentation/articles/sql-database-elastic-pool-powershell/#monitoring-elastic-databases-and-elastic-database-pools) 监视、管理弹性数据库池并设置其大小。
