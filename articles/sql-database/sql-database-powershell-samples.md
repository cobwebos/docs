...
| [创建和管理托管实例](https://blogs.msdn.microsoft.com/sqlserverstorageengine/2018/06/27/quick-start-script-create-azure-sql-managed-instance-using-powershell/) | 这些 CLI 脚本显示必须使用 Azure PowerShell 创建和管理托管实例 |
|**配置异地复制和故障转移**||
