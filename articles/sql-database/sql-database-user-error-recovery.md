...
- [通过 Azure 门户进行时间点还原](/documentation/articles/sql-database-point-in-time-restore-portal/)
...
- [通过 Azure 门户还原已删除的数据库](/documentation/articles/sql-database-restore-deleted-database-portal/)
