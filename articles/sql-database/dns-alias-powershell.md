...
description: PowerShell cmdlet，例如新建 AzSqlServerDNSAlias，可以将新客户端连接重定向到不同的 Azure SQL 数据库服务器，而无需触摸任何客户端配置。
...
- Azure PowerShell 模块，使用 cmdlet**新建 AzSqlServerDNSAlias**。
