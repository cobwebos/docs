...
开发人员可能会考虑开发自定义应用程序使用 Azure SQL 数据库的性能建议。 可以通过访问数据库，在门户中列出所有建议[Get AzSqlDatabaseRecommendedAction](https://docs.microsoft.com/powershell/module/az.sql/get-azsqldatabaserecommendedaction) API。
