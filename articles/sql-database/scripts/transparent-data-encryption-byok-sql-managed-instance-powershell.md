---
title: '电源外壳：启用 BYOK TDE - Azure SQL 数据库托管实例 '
...
在本地使用 PowerShell 或使用 Azure 云外壳都需要 AZ PowerShell 2.3.2 或更高版本。 如果需要升级，请参阅[安装 Azure PowerShell 模块](/powershell/azure/install-az-ps)，或运行以下示例脚本，以便为当前用户安装该模块：
