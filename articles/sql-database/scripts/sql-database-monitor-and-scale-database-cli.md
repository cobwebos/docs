---
title: "Azure CLI 脚本 - 监视和缩放单个 SQL 数据库 | Microsoft 文档"
...
[!code-azurecli[main](../../../cli_scripts/sql-database/monitor-and-scale-database/monitor-and-scale-database.sh "监视和缩放单个 SQL 数据库")]
