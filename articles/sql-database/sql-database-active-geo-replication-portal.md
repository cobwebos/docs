...
本文介绍如何使用 [Azure 门户](http://portal.azure.com)在 SQL 数据库中的逻辑服务器 (sql-database-active-geo-replication.md#active-geo-replication-terminology-and-capabilities) 上 [为单一数据库与入池数据库配置活动异地复制]，以及如何启动故障转移。
