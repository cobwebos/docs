---
title: 内存中 OLTP 改进了 SQL txn perf
...
> [!NOTE] 
> 了解[Quorum 如何使密钥数据库的工作负载翻倍，同时使用 SQL 数据库将 DTU 降低 70%](https://customers.microsoft.com/story/quorum-doubles-key-databases-workload-while-lowering-dtu-with-sql-database)
...
3. 在向导中，单击“迁移验证”****（或“下一步”**** 按钮），以查看该表是否有任何在内存优化表中不受支持的功能。 有关详细信息，请参阅：
   ...
   * [内存内 OLTP 不支持的转换 SQL 构造](https://msdn.microsoft.com/library/dn246937.aspx)。
