...
可以向资源添加警报规则，以便在资源达到你设置的使用阈值时，向 [URL 终结点](https://msdn.microsoft.com/library/mt718036.aspx)发送电子邮件通知或警报字符串。 使用 Add-AzureRmMetricAlertRule cmdlet。
...
## <a name="add-alerts-to-all-databases-in-a-pool"></a>将警报添加到池中的所有数据库
...
## <a name="example-retrieve-resource-consumption-metrics-for-a-pool-and-its-databases"></a>示例：检索池及其数据库的资源消耗指标值
...
## <a name="migrate-from-v11-to-v12-servers"></a>从 V11 服务器迁移到 V12 服务器
