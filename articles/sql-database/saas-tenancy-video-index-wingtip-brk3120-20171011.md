---
title: '视频已编制索引，Azure SaaS SQL 应用 '
...
该视频扩充了以下书面文档中的信息： 
- *概念性：* [多租户 SaaS 数据库租户模式][saas-concept-design-patterns-563e]
...
- [博客文章，5月22日2017][resource-blog-saas-patterns-app-dev-sql-db-768h]
