...
服务器防火墙规则将影响 Azure SQL Server 上的所有 SQL 数据库。若要配置仅影响单一数据库的数据库级别的防火墙规则，请参阅 [sp\_set\_database\_firewall\_rule（Azure SQL 数据库）](https://msdn.microsoft.com/zh-cn/library/dn270010.aspx")。
