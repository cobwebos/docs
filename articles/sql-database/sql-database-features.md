...
| [SQL Server 复制](https://docs.microsoft.com/sql/relational-databases/replication/sql-server-replication) | [仅限事务性和快照复制订户](sql-database-cloud-migrate.md) | [仅限事务性和快照复制订户](sql-database-cloud-migrate.md) |
