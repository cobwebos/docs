...
| 资源池 | 是，用作[弹性池](sql-database-elastic-pool.md) | 是的。 单个托管实例可以有多个共享同一资源池的数据库。 此外，还可以在可共享资源的[实例池（预览版）](sql-database-instance-pools.md)中部署多个托管实例。 |
