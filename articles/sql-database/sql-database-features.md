...
| [Azure Active Directory （AAD）身份验证](sql-database-aad-authentication.md) | 是。 仅限 AAD 用户。 | 是。 包括服务器级别 AAD 登录名。 |
...
| 备份保留 | 是。 默认值为7天，最长35天。 | 是。 默认值为7天，最长35天。 |
