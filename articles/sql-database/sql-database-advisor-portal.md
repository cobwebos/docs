---
title: "使用 Azure 门户的 Azure SQL 数据库顾问 | Microsoft 文档"
description: "可以在 Azure 门户中使用 Azure SQL 数据库顾问查看和实施为现有 SQL 数据库提供的建议，这些建议可以提高当前查询性能。"
...
成功实施建议后（当前仅限索引操作和参数化查询建议），可单击建议详细信息边栏选项卡上的“查询见解”打开[查询性能见解](sql-database-query-performance.md)，然后查看排位靠前的查询的性能影响。
