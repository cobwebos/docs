...
| ODBC | Suse Linux | [ODBC for SQL Server](http://www.microsoft.com/zh-cn/download/details.aspx?id=34687) | 11\.0+ | 用于 SQL Server 的 Microsoft ODBC 驱动程序 | [链接](https://msdn.microsoft.com/zh-cn/library/hh568451.aspx) |
| ODBC | Redhat Linux | [ODBC for SQL Server](http://www.microsoft.com/zh-cn/download/details.aspx?id=34687) | 11\.0+ | 用于 SQL Server 的 Microsoft ODBC 驱动程序 | [链接](https://msdn.microsoft.com/zh-cn/library/hh568451.aspx) |
