---
title: "多租户 SaaS 应用程序与 Azure SQL 数据库的设计模式 | Microsoft 文档"
...
---
# <a name="design-patterns-for-multitenant-saas-applications-and-azure-sql-database"></a>多租户 SaaS 应用程序与 Azure SQL 数据库的设计模式
...
## <a name="multitenant-applications"></a>多租户应用程序
...
## <a name="multitenant-application-design-trade-offs"></a>多租户应用程序设计的利弊
...
## <a name="popular-multitenant-data-models"></a>流行的多租户数据模型
...
## <a name="multitenancy-support-in-azure-sql-database"></a>Azure SQL 数据库中的多租户支持
