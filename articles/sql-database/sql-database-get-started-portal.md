...
description: 在 Azure 门户中创建 Azure SQL 数据库服务器和数据库，并对其进行查询。
...
Azure SQL 数据库具有一组已定义的[计算和存储资源](sql-database-service-tiers-dtu.md)。 在 [Azure 资源组](../azure-resource-manager/resource-group-overview.md)中的 [SQL 数据库服务器](sql-database-features.md)中创建数据库。
