<properties 
	...
	description="提供了一个可以用于从 Windows 客户端连接到 Azure SQL Database 的 Python 代码示例。该示例使用 pymssql 驱动程序。"
...
本主题提供以 Python 编写的代码示例。该示例在 Windows 计算机上运行。该示例将使用 **pymssql** 驱动程序连接到 Azure SQL Database。
