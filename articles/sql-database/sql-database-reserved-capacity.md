...
可在 [Azure 门户](https://portal.azure.com)中购买 Azure SQL 数据库预留容量。 通过[提前付款或按月付款](../billing/billing-monthly-payments-reservations.md)的方式为预留付款。 购买 SQL 数据库预留容量：
