...
根据具体数据库的详细信息，执行升级或降级通常不会立即发生。当数据库过渡到新层时，管理门户会提供通知；你也可以通过在 SQL Database 服务器的 master 数据库中查询 [sys.dm\_operation\_status (Azure SQL Database)](https://msdn.microsoft.com/zh-cn/library/dn270022.aspx) 视图，来监视升级状态。
