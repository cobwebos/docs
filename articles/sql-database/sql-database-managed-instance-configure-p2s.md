...
ms.locfileid: "47162995"
---
# <a name="configure-a-point-to-site-connection-to-connect-to-an-azure-sql-database-managed-instance-from-on-premises-computer"></a>配置点到站点连接，以便从本地计算机连接到 Azure SQL 数据库托管实例
