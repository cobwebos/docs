<properties
	pageTitle="连接到带 C# 查询的 SQL 数据库 | Microsoft Azure"
...
2. 依次单击“更多服务”>“SQL 数据库”
3. 通过找到并单击 *AdventureWorks* 数据库，打开“AdventureWorks”数据库边栏选项卡。

6. 在该数据库边栏选项卡顶部，单击“工具”按钮：
...
8. Visual Studio 将与“连接到服务器”窗口（已设置为连接到在门户中所选的服务器和数据库）一起打开。（单击“选项”，验证连接是否设置为正确的数据库。） 键入服务器管理员密码，然后单击“连接”。
