...
如果有多个订阅，则可以将它们添加为逗号，以表示分隔为脚本标题中的"$subscriptions"属性。
...
单击右上角的"**保存**"按钮以保存脚本。 当您对脚本满意时，单击"**发布**"按钮以发布此 Runbook。

在主 Runbook 窗格中，您可以选择单击"**开始**"按钮**来测试**脚本。 单击"**输出**"以查看执行的脚本的结果。 此输出将是电子邮件的内容。 脚本的示例输出如以下屏幕截图中所示。
