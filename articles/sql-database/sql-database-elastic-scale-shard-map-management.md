...
在此代码中，应用程序尝试使用 TryGetSqlShardMap管理器[（Java](/java/api/com.microsoft.azure.elasticdb.shard.mapmanager.shardmapmanagerfactory.trygetsqlshardmapmanager). [NET](/dotnet/api/microsoft.azure.sqldatabase.elasticscale.shardmanagement.shardmapmanager)方法）打开现有的**ShardMap管理器**。 如果数据库中尚不存在表示全局 ShardMapManager**** (GSM) 的对象，客户端库会使用 CreateSqlShardMapManager（[Java](/java/api/com.microsoft.azure.elasticdb.shard.mapmanager.shardmapmanagerfactory.createsqlshardmapmanager)、[.NET](/dotnet/api/microsoft.azure.sqldatabase.elasticscale.shardmanagement.shardmapmanagerfactory.createsqlshardmapmanager)）方法创建这些对象。
...
* 要添加或删除分片：使用分片（Java，.NET）和删除分片[（Java，.NET）](/java/api/com.microsoft.azure.elasticdb.shard.map.shardmap)类的[.NET](https://docs.microsoft.com/dotnet/api/microsoft.azure.sqldatabase.elasticscale.shardmanagement.shardmap)CreateShard（Java，.NET）。 **CreateShard** [Java](/java/api/com.microsoft.azure.elasticdb.shard.map.shardmap.createshard) [.NET](https://docs.microsoft.com/dotnet/api/microsoft.azure.sqldatabase.elasticscale.shardmanagement.shardmap.createshard) **DeleteShard** [Java](https://docs.microsoft.com/java/api/com.microsoft.azure.elasticdb.shard.map.shardmap.deleteshard) [.NET](https://docs.microsoft.com/dotnet/api/microsoft.azure.sqldatabase.elasticscale.shardmanagement.shardmap.deleteshard)
