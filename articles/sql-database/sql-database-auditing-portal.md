...
* 通过 [Azure 门户](https://portal.azure.com)打开相关数据库。 在数据库的“审核和威胁检测”边栏选项卡顶部，单击“查看审核日志”。
...
* 其他方法：
   ...
   * 我们已创建一个[示例应用程序](https://github.com/Microsoft/Azure-SQL-DB-auditing-OMS-integration)，它在 Azure 中运行，并利用 OMS 公共 API 将 SQL 审核日志推送到 OMS，以便通过 OMS 仪表板使用。
