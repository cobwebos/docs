...
连接到逻辑服务器后，你可以连接到数据库并运行示例查询。如果没有使用 [Microsoft Azure SQL 数据库入门](/documentation/articles/sql-database-get-started)中的 AdventureWorks 示例创建数据库，此查询将不会正常工作。请直接跳到“后续步骤”以了解详细信息。
