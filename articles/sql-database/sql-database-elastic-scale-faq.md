...
#### <a name="why-are-my-credentials-not-working-when-i-add-a-shard-from-a-different-server"></a>为什么从另一台服务器添加分片时，凭据不起作用？
请勿使用“用户 ID=username@servername”的形式，而只需使用“用户 ID = username”。  此外，请确保“用户名”登录名对分片具有权限。
