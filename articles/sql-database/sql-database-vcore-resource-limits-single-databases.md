...
## <a name="general-purpose-service-tier-for-provisioned-compute"></a>用于预配计算的常规用途服务层
...
|最大对数速率（MBps）|26.25|30|30|30|30|30|
...
|最大对数速率（MBps）|3.75|7.5|11.25|15|18.75|22.5|26.25|
...
## <a name="general-purpose-service-tier-for-serverless-compute"></a>常规用途用于无服务器计算的服务层

[无服务器计算层](sql-database-serverless.md)处于预览阶段。
...
## <a name="business-critical-service-tier-for-provisioned-compute"></a>用于预配计算的业务关键服务层
...
### <a name="gen5-compute-compute-part-1"></a>Gen5 计算计算（第1部分）
...
|最大对数速率（MBps）|12|24|36|48|60|72|84|
|最大并发工作线程数（请求数）|200|400|600|800|1000|1200|1400|
...
## <a name="hyperscale-service-tier-for-provisioned-compute"></a>用于预配计算的超大规模服务层

### <a name="gen5-compute-generation"></a>Gen5 计算生成
...
|内存中 OLTP 存储 (GB)|N/A|N/A|N/A|N/A|N/A|N/A|N/A|N/A|
|最大数据大小 (TB)|100 |100 |100 |100 |100 |100 |100 |100 |
|最大日志大小 (TB)|第 |第 |第 |第 |第 |第 |第 |第 |
|TempDB 最大数据大小（GB）|64|128|256|384|384|384|384|384|
|存储类型| [备注1](#notes) |[备注1](#notes)|[备注1](#notes) |[备注1](#notes) |[备注1](#notes) |[备注1](#notes) |[备注1](#notes) | [备注1](#notes) |
...
|辅助副本|0-4|0-4|0-4|0-4|0-4|0-4|0-4|0-4|
