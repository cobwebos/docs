...
|列存储支持|是|是|是|是|是|
|内存中 OLTP 存储 (GB)|不可用|不可用|不可用|不可用|不可用|
...
|副本数|第|1|1|1|第|
|Multi-AZ|不可用|不可用|不可用|不可用|不可用|
|读取横向扩展|不可用|不可用|不可用|不可用|不可用|
...
|列存储支持|是|是|是|是|
|内存中 OLTP 存储 (GB)|不可用|不可用|不可用|不可用|
...
|副本数|第|1|1|第|
|Multi-AZ|不可用|不可用|不可用|不可用|
|读取横向扩展|不可用|不可用|不可用|不可用|
...
|内存中 OLTP 存储 (GB)|不可用|不可用|不可用|不可用|不可用|不可用|不可用|不可用|
...
|Multi-AZ|不可用|不可用|不可用|不可用|不可用|不可用|不可用|不可用|
...
**备注 2**：超大规模多层体系结构具有多个级别的缓存。 有效 IOPS 将取决于工作负荷。

**备注 3**：对于缓存最常使用的数据页的计算副本上基于 RBPEX SSD 的缓存中的数据，延迟为1-2 毫秒。 从页面服务器中检索到的数据的延迟较高。
