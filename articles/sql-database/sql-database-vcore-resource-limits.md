...
|最大日志大小|307|307|461|922|1229|
|TempDB 大小 (DB)|32|64|128|256|384|
|目标 IOPS|320|640|1280|2560|5120|
|IO 延迟（近似）|5-7 毫秒（写入）
|最大并发工作线程数（请求数）|200|400|800|1600|3200|
|允许的最大会话数|30000|30000|30000|30000|30000|
|副本数|1|1|1|1|1|
...
|内存 (GB)|7|14|28|56|112|
|列存储支持|是|是|是|是|是|
|内存中 OLTP 存储 (GB)|1|2|4|8|20|
|存储类型|附加的 SSD|附加的 SSD|附加的 SSD|附加的 SSD|附加的 SSD|
|最大数据大小 (GB)|1024|1024|1024|1024|1024|
|最大日志大小|307|307|307|307|307|
|TempDB 大小 (DB)|32|64|128|256|384|
|目标 IOPS|5000|10000|20000|40000|80000|
