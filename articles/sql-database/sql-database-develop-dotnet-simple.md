---
title: "使用 .NET (C#) 连接 SQL 数据库| Microsoft 文档"
...
[配置用于 ADO.NET 开发的开发环境](https://msdn.microsoft.com/library/mt718321.aspx)
...
* [使用 ADO.NET 连接到 SQL 以进行概念证明](https://msdn.microsoft.com/library/mt718320.aspx)
* [使用 ADO.NET 弹性连接到 SQL](https://msdn.microsoft.com/library/mt703195.aspx)

## <a name="next-steps"></a>后续步骤
* [创建具有身份验证和 SQL 数据库的 ASP.NET MVC 应用程序并将其部署到 Azure App Service](../app-service-web/web-sites-dotnet-deploy-aspnet-mvc-app-membership-oauth-sql-database.md)
* 参阅 [SQL 数据库开发概述](sql-database-develop-overview.md)
* 有关 [Microsoft ADO.Net Driver for SQL Server](https://msdn.microsoft.com/library/mt657768.aspx) 的详细信息
