...
如需脚本示例，请参阅[创建 SQL 数据库 PowerShell 脚本](sql-database-get-started-powershell.md#create-a-sql-database-powershell-script)。
...
有关详细信息，请参阅 [什么是 SQL 数据库](sql-database-technical-overview.md)。 如需脚本示例，请参阅[创建 SQL 数据库 PowerShell 脚本](sql-database-get-started-powershell.md#create-a-sql-database-powershell-script)。
...
有关详细信息，请参阅 [Azure SQL 数据库防火墙](https://msdn.microsoft.com/library/azure/ee621782.aspx)。 如需脚本示例，请参阅[创建 SQL 数据库 PowerShell 脚本](sql-database-get-started-powershell.md#create-a-sql-database-powershell-script)。
...
## <a name="how-do-i-create-and-manage-elastic-database-pools-using-powershell"></a>如何使用 PowerShell 创建和管理弹性数据库池？
如需详细了解如何使用 PowerShell 创建弹性数据库池，请参阅 [使用 PowerShell 创建新的弹性数据库池](sql-database-elastic-pool-create-powershell.md)。

如需详细了解如何使用 PowerShell 管理弹性数据库池，请参阅[使用 PowerShell 监视和管理弹性数据库池](sql-database-elastic-pool-manage-powershell.md)。
