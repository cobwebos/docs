...
- 在恢复到最新备份点的任何区域中的任一逻辑服务器上创建新数据库。
...
### <a name="recover-to-a-point-in-time-using-azure-portal"></a>使用 Azure 门户恢复到某个时间点
...
### <a name="recover-a-deleted-database-using-the-azure-portal"></a>使用 Azure 门户恢复已删除的数据库
