...
- 如果数据库最大大小超过 250 GB，将 P1–P6 或 PRS1–PRS6 还原为 S4-S12。
...
要使用 Azure 门户在[保留期](sql-database-service-tiers.md)期间对数据库进行异地还原，请打开 SQL 数据库页，并单击“添加”。 在“选择源”文本框中，选择“备份”。 指定在选择的区域和服务器上执行还原的备份。 
