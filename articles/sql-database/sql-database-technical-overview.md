...
- 借助使用 vCore 购买模型的[超大规模服务层](sql-database-hyperscale.md)（预览版），你可以通过快速备份和还原功能扩展到 100 TB。
...
> [!IMPORTANT]
> 无法从“常规用途”或“业务关键”服务层缩放到[超大规模服务层](sql-database-hyperscale.md)。 但是，可以更改“超大规模”服务层中的性能级别。
...
- **Azure Log Analytics**：用于具有报告、警报和缓解功能的内置监视解决方案。 Azure Log Analytics 是 [Operations Management Suite (OMS)](../operations-management-suite/operations-management-suite-overview.md) 的一项功能
