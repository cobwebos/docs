...
1.	使用[列出可恢复的数据库](https://msdn.microsoft.com/zh-CN/library/azure/dn800984.aspx)操作获取可恢复数据库的列表。
	
2.	使用[获取可恢复的数据库](https://msdn.microsoft.com/zh-CN/library/azure/dn800985.aspx)操作获取你要恢复的数据库。
	
3.	使用[创建数据库恢复请求](https://msdn.microsoft.com/zh-CN/library/azure/dn800986.aspx)操作创建恢复请求。
	
4.	使用[数据库操作状态](https://msdn.microsoft.com/zh-CN/library/azure/dn720371.aspx)操作跟踪恢复状态。
