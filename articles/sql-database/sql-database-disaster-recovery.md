...
* [使用 Azure 门户将数据库异地还原到新的区域](sql-database-geo-restore-portal.md)
...
需确保应用程序使用的所有登录名都存在于托管已恢复数据库的服务器上。 相关详细信息，请参阅[异地复制的安全性配置](sql-database-geo-replication-security-config.md)。
