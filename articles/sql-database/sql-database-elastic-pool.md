...
> [!IMPORTANT]
> 选择定价层并在最后一个步骤中单击“确定”来提交更改之后，便无法更改池的定价层。 要更改现有弹性池的定价层，请在所需的定价层中创建弹性池，然后将数据库移转到这个新池。
>
...
|[数据库 - 创建或更新](/rest/api/sql/databases/createorupdate)|创建新数据库或更新现有的数据库。|
