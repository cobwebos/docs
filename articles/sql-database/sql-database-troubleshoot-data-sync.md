...
## <a name="troubleshooting-sync"></a>排查同步问题
...
#### <a name="resolution-or-workaround"></a>解决方法或折中方法
...
## <a name="troubleshooting-the-client-agent"></a>排查客户端代理问题
...
-   在与同步组相同的数据中心中创建新的代理。 然后使用该代理注册数据库。
...
## <a name="troubleshooting-setup-and-maintenance"></a>排查设置和维护问题
...
如果要从备份还原丢失或损坏的数据库，则数据库所属的同步组中的数据可能会不收敛。
