<properties
	pageTitle="使用 Azure 经典门户管理 Azure SQL 数据库"
	description="了解如何使用 Azure 经典门户管理云中的关系数据库。"
...
此外，可以设置警报规则以监视指定的指标，并在达到预设的阈值时通知指定的管理员和协同管理员。在[此处][Azure part monitoring]可找到有关如何在 Azure 经典门户中设置警报规则的详细信息。
