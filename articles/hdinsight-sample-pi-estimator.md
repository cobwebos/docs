<properties
	pageTitle="HDInsight 中的 Pi estimator Hadoop 示例 | Azure"
	description="了解如何在 HDInsight 上运行 Hadoop MapReduce 示例。"
	editor="cgronlun"
	manager="paulettm"
	services="hdinsight"
	documentationCenter=""
...
# HDInsight 中的 pi estimator Hadoop 示例

本主题说明如何使用 Azure PowerShell，在 Azure HDInsight 中运行一个用于估算数学常量 pi 值的 Hadoop MapReduce 程序。另外还提供了在 MapReduce 程序中使用的用于估算 pi 值以供检查的 Java 代码。
...
- 你必须已经设置了 HDInsight 群集。有关可用于创建这类群集的不同方法的说明，请参阅[配置 HDInsight 群集](hdinsight-provision-clusters)。
...
<h2><a id="java-code"></a>pi estimator MapReduce 程序的 Java 代码</h2>
