...
ms.locfileid: "38972907"
---
# <a name="quickstart-deploy-a-cloud-based-solution-to-run-a-predictive-maintenance-analysis-on-my-connected-devices"></a>快速入门：部署基于云的解决方案，以便在连接的设备上运行预测性维护分析

本快速入门介绍如何部署 Azure IoT 预测性维护解决方案加速器，该加速器将用作 IoT 设备的基于云的预测性维护解决方案。 在部署解决方案加速器以后，请使用解决方案“仪表板”页通过飞机引擎数据运行模拟。
...
在“创建预测性维护解决方案”页上，为预测性维护解决方案加速器输入唯一的“解决方案名称”。
...
完成到 Azure 订阅的部署后，可以登录到预测性维护解决方案加速器仪表板。
