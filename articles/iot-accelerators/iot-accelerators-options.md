...
ms.locfileid: "34725575"
---
# <a name="compare-azure-iot-options"></a>比较 Azure IoT 选项

[Azure 和物联网](iot-accelerators-what-is-azure-iot.md)一文介绍了典型的具有以下层的 IoT 解决方案体系结构：
...
* [Azure IoT 解决方案加速器](../active-directory-domain-services/index.yml)是基于 Azure 平台即服务 (PaaS) 的企业级[解决方案加速器](iot-accelerators-what-are-solution-accelerators.md)集合，用于加速自定义 IoT 解决方案的开发。
...
* **Azure IoT 解决方案加速器**[Azure IoT 解决方案加速器是什么？](iot-accelerators-what-are-solution-accelerators.md)
