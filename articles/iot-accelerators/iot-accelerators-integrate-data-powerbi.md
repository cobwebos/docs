...
description: 本教程使用 Power BI 桌面和 Cosmos DB 将远程监视解决方案中的数据集成到自定义可视化中。 这样，用户便可以生成其自己的自定义仪表板，并将其与解决方案外部的用户共享。
author: dominicbetts
manager: hegate
ms.author: dobett
