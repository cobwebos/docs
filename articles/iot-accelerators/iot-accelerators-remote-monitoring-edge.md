...
![关系图显示油泵千斤顶已连接到 IoT Edge 设备中的 IoT Edge 流分析模块，用于执行遥测和命令。 筛选的遥测转到云中远程监视解决方案加速器中的 IoT Edge 设备。 云中还有部署和包。 部署在设备中部署 IoT Edge 运行时。](media/iot-accelerators-remote-monitoring-edge/overview.png)
...
1. 在“创建部署”>“检查部署”页上，单击“提交”：********
    ...
    [![评审部署](./media/iot-accelerators-remote-monitoring-edge/reviewdeployment-inline.png)](./media/iot-accelerators-remote-monitoring-edge/reviewdeployment-expanded.png#lightbox)
