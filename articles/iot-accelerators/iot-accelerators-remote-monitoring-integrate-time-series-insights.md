---
title: 将 Azure 时序见解与远程监视集成 | Microsoft Docs
...
远程监控解决方案加速器现可与时序见解进行自动部署和集成。 在本操作指南中，你将学习如何为尚未包含时序见解的现有远程监视解决方案配置时序见解。
...
接下来，将时序见解作为附加资源部署到远程监控解决方案中，并将其连接到 IoT 中心。
...
要确保有权访问远程监控解决方案的所有用户都能够在时序见解资源管理器中浏览数据，请在 Azure 门户中的数据访问策略下添加应用程序和用户。 
