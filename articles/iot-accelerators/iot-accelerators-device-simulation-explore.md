...
description: IoT 解决方案加速器模拟解决方案是一项工具，可以用来协助开发和测试 IoT 解决方案。 模拟服务是一项独立的服务，可以与其他解决方案加速器或自己的自定义解决方案结合使用。
author: troyhopwood
manager: ''
ms.author: troyhop
...
ms.locfileid: "34627119"
---
# <a name="device-simulation-walkthrough"></a>设备模拟演练

Azure IoT 设备模拟是一项工具，可以用来协助开发和测试 IoT 解决方案。 设备模拟是一项独立的服务，可以与其他解决方案加速器或自己的自定义解决方案结合使用。
...
如果尚未部署设备模拟，则应完成[部署 Azure IoT 设备模拟](iot-accelerators-device-simulation-deploy.md)教程。

## <a name="configuring-device-simulation"></a>配置设备模拟

在仪表板中即可配置和运行设备模拟。 从 IoT 解决方案加速器[预配的解决方案](https://www.azureiotsolutions.com/)页打开仪表板。 在新的设备模拟部署下单击“启动”。

### <a name="target-iot-hub"></a>以 IoT 中心为目标

可以将设备模拟与预配的 IoT 中心或任何其他 IoT 中心配合使用：

![目标 IoT 中心](./media/iot-accelerators-device-simulation-explore/targethub.png)
...
![目标 IoT 中心](./media/iot-accelerators-device-simulation-explore/connectionstring.png)

### <a name="device-model"></a>设备型号

可以通过设备型号来选择要模拟的设备类型。 可以选择一个预配置的设备型号，也可以针对自定义设备型号定义一个传感器列表：

![设备型号](./media/iot-accelerators-device-simulation-explore/devicemodel.png)
...
![添加传感器](./media/iot-accelerators-device-simulation-explore/customsensors.png)
...
![设备数](./media/iot-accelerators-device-simulation-explore/numberofdevices.png)
...
![遥测频率](./media/iot-accelerators-device-simulation-explore/frequency.png)
