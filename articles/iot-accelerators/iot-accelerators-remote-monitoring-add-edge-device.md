...
1. 在远程监视解决方案加速器 Web UI 中的 **"设备资源管理器**"页上添加边缘设备。
...
当您在远程监视解决方案加速器中直接向 IoT 中心注册设备时，设备将列在 Web UI 中的 **"设备资源管理器**"页上。
...
- [在 Linux 上安装 Azure IoT Edge 运行时 (ARM32v7/armhf)](../iot-edge/how-to-install-iot-edge-linux-arm.md)
