...
description: Azure IoT 预测性维护解决方案加速器概述，用于预测业务方案可能发生故障的点。
author: dominicbetts
manager: timlt
...
机器学习组件使用派生自数据的模型，这些数据是从实际飞机引擎收集的。 您可以在[azureiotsolutions.com][lnk-azureiotsolutions]页面上的解决方案磁贴导航到机器学习工作区。 当解决方案处于“就绪”状态时，会提供一个磁贴。****
...
*\[1\] A. 萨克塞纳和K.戈贝尔（2008年）。"涡轮风扇发动机降解模拟数据集"，美国宇航局艾梅斯预测数据存储库（，https://c3.nasa.gov/dashlink/resources/139/)美国宇航局艾姆斯研究中心，莫菲特菲尔德，加利福尼亚州*
