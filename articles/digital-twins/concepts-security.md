...
有关如何定义内置角色的详细信息，请参阅了解 Azure RBAC 文档中的[角色定义](../role-based-access-control/role-definitions.md)。 有关创建自定义 RBAC 角色的详细信息，请参阅[Azure 资源的自定义角色](../role-based-access-control/custom-roles.md)。
