...
此示例使用设备模拟器，其中包括使用设备预配服务的预配。 设备模拟器位于此处： [Azure 数字孪生和 IoT 中心集成示例](/samples/azure-samples/digital-twins-iothub-integration/adt-iothub-provision-sample/)。 如果尚未下载该示例，请导航到示例链接，并选择标题下面的 " *下载 ZIP* " 按钮，立即获取该示例。 解压缩已下载文件夹。
