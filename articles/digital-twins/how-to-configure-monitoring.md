...
1. 填写请求的字段并选择保存数据的方式和位置：
    ...
    [![诊断设置2](media/how-to-configure-monitoring/diagnostic-settings-two.png)](media/how-to-configure-monitoring/diagnostic-settings-two.png#lightbox)
