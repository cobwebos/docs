...
* 如何配置 Azure Active Directory 应用程序以使用 OAuth 2.0 隐式授权流。
* 如何配置 Postman REST 客户端以向管理 API 发出令牌承载 HTTP 请求。
...
1. 复制并保留 Azure Active Directory 应用的“应用程序 ID”。 下面将用到它。
