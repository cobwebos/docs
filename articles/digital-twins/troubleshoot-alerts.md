...
2. 从菜单中选择 "**警报**"，然后选择 " **+ 新建警报规则**"。
    ...
    :::image type="content" source="media/troubleshoot-alerts/alerts-pre.png" alt-text="显示 "警报" 页和要添加的按钮的屏幕截图。尚未配置任何警报" lightbox="media/troubleshoot-alerts/alerts-pre.png":::
