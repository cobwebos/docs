...
4. 保存新设置。 
    ...
    :::image type="content" source="media/how-to-set-up-diagnostics/diagnostic-settings-details.png" alt-text="显示 &quot;诊断设置&quot; 页和要添加的按钮的屏幕截图" 页上显示在配置的目标中。 
