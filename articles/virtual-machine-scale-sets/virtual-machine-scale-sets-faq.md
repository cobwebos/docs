---
title: "Azure 虚拟机规模集常见问题 | Microsoft 文档"
...
是的。 请参阅 https://docs.microsoft.com/azure/monitoring-and-diagnostics/insights-autoscale-best-practices
...
请参阅这份受支持指标的列表：https://docs.microsoft.com/azure/monitoring-and-diagnostics/insights-autoscale-common-metrics。 下面是规模集的完整示例（在本例中，我们使用了主机级 CPU 指标和消息计数指标）：
...
在 KeyVault 中创建自签名证书的一种方法是参考以下 Service Fabric 文章中的说明：https://azure.microsoft.com/documentation/articles/service-fabric-cluster-security/
...
### <a name="why-do-we-have-to-specify-the-exact-location-for-the-certificate-url-as-referenced-here-per-httpsazuremicrosoftcomdocumentationarticlesservice-fabric-cluster-security"></a>为何需要按以下网页中所述，为证书 URL 指定确切的位置：https://azure.microsoft.com/documentation/articles/service-fabric-cluster-security/ 
...
要正常运行此方案，必须使用存储帐户密钥和名称指定保护设置。 请参阅 https://azure.microsoft.com/documentation/articles/virtual-machines-windows-extensions-customscript/#template-example-for-a-windows-vm-with-protected-settings
...
### <a name="what-is-the-resourceguid-property-on-a-nic-for-its-not-documented-here"></a>NIC 上的 resourceGuid 属性有什么作用？ 本主题不会详细介绍此属性。
...
请参阅：https://docs.microsoft.com/azure/virtual-machine-scale-sets/virtual-machine-scale-sets-upgrade-scale-set
