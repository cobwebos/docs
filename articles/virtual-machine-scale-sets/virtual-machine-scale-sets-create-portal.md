---
title: 在 Azure 门户中创建虚拟机规模集 | Microsoft Docs
...
在此入门文章中，将在 Azure 门户中创建基本规模集。 若要改进可伸缩性和自动化，请阅读以下操作指南文章，了解如何扩展规模集：

- [在虚拟机规模集上部署应用程序](virtual-machine-scale-sets-deploy-app.md)
- 通过 [Azure PowerShell](virtual-machine-scale-sets-autoscale-powershell.md)、[Azure CLI](virtual-machine-scale-sets-autoscale-cli.md) 或 [Azure 门户](virtual-machine-scale-sets-autoscale-portal.md)自动进行缩放
