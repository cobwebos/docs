...
您还可以使用此[快速入门模板](https://github.com/Azure/azure-quickstart-templates/tree/master/201-vmss-automatic-repairs-slb-health-probe)部署虚拟机规模集，其中启用了负载均衡器运行状况探测和自动实例修复，宽限期为 30 分钟。
