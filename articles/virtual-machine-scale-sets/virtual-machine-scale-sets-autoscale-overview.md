...
- [Azure 资源浏览器]() - 要浏览缩放集的当前状态，这是最好的工具。遵循此路径，应该会看到所创建的缩放集的实例视图：
subscriptions > {您的订阅} > resourceGroups > {您的资源组} > providers > Microsoft.Compute > virtualMachineScaleSets > {您的缩放集} > virtualMachines
