...
- [Azure 电源外壳](tutorial-autoscale-powershell.md)
...
本概述文章详细介绍了如何使用自动缩放规则来横向缩放以及增加或减少规模集中的 VM 实例数目。** 还可进行纵向缩放，即增大或减小 VM 实例的大小**。 有关详细信息，请参阅[使用虚拟机缩放集的垂直自动缩放](virtual-machine-scale-sets-vertical-scale-reprovision.md)。
