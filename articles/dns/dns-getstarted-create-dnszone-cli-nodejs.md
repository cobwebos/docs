---
title: "使用 Azure CLI 1.0 创建 DNS 区域 | Microsoft Docs"
description: "了解如何在 Azure DNS 中创建 DNS 区域。 这是有关使用 Azure CLI 1.0 创建和管理第一个 DNS 区域的分步指南。"
services: dns
...
# <a name="create-an-azure-dns-zone-using-azure-cli-10"></a>使用 Azure CLI 1.0 创建 Azure DNS 区域
