---
title: 快速入门：创建 Azure DNS 区域和记录 - Azure 资源管理器模板（ARM 模板）
...
ms.locfileid: "89596384"
---
# <a name="quickstart-create-an-azure-dns-zone-and-record-using-an-arm-template"></a>快速入门：使用 ARM 模板创建 Azure DNS 区域和记录
