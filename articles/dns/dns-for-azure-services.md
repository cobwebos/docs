...
| 流量管理器 |公共名称 |只能创建映射到分配给流量管理器配置文件的 trafficmanager.net 名称的 CNAME。 有关详细信息，请参阅[流量管理器工作原理](../traffic-manager/traffic-manager-how-it-works.md)。 |
