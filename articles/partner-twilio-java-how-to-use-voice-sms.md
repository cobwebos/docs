...
Twilio 是一种电话 web 服务 API，允许你使用你的现有 web 语言和技术来生成语音和 SMS 应用程序。 Twilio 属于第三方服务（而非 Azure 功能和 Microsoft 产品）。
