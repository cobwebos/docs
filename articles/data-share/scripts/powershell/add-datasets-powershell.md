---
title: PowerShell 脚本：将 Blob 数据集添加到 Azure 数据共享 |微软文档
...
此 PowerShell 脚本将 Blob 数据集添加到现有数据共享。
...
| 命令 | 说明 |
|---|---|
| [新-阿兹数据共享数据集](/powershell/module/az.datashare/new-azdatasharedataset?view=azps-2.6.0) | 将数据集添加到数据共享。 |
|||
