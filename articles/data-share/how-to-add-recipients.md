...
ms.locfileid: "87513462"
---
# <a name="how-to-add-a-recipient-to-an-existing-data-share-in-azure-data-share"></a>如何将收件人添加到 Azure 数据共享中的现有数据共享
...
单击 " **添加并发送邀请**"。 新接收方 () 将向此数据共享发送邀请电子邮件。
