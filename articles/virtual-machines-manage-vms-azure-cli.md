...
<tags ms.service="virtual-machines" ms.date="04/23/2015" wacn.date=""/>
...
有关 Azure CLI 用法和 **arm** 模式的更多示例，请参阅[将适用于 Mac、Linux 和 Windows 的 Microsoft Azure CLI 用于 Azure 资源管理](xplat-cli-resource-manager)。若要了解有关 Azure 资源及其概念的详细信息，请参阅 [Azure 资源管理器概述](resource-group-overview)。
