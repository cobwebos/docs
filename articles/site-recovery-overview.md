...
SCOM | Y | Y | Y | 即将支持
<p>SAP</p><p>将非群集 SAP 站点复制到 Azure</p> | Y（Microsoft 已测试） | Y（Microsoft 已测试） | Y（Microsoft 已测试） | 即将支持
Exchange（非 DAG） | Y | 即将支持 | Y | 即将支持
远程桌面/VDI | Y | Y | Y | 即将支持
<p>Linux</p> <p>（操作系统和应用程序）</p> | Y（Microsoft 已测试） | Y（Microsoft 已测试） | Y（Microsoft 已测试） | 即将支持
