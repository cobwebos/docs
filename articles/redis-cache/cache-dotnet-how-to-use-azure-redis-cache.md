<properties 
	pageTitle="如何使用 Azure Redis 缓存 | Microsoft Azure" 
...
>[AZURE.NOTE] 默认情况下，将为新缓存禁用非 SSL 端口。有关启用非 SSL 端口的说明，请参阅[访问端口](cache-configure.md#access-ports)。
