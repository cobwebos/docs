...
Azure Multi-Factor Authentication | Multi-Factor Authentication 提供最丰富的功能集。<br><br>它通过 Azure 管理门户、高级报告及支持一系列本地和云应用程序来提供其他配置选项。Azure Multi-Factor Authentication 可以通过单独的许可证购买，也可能与 Azure Active Directory Premium 和 Enterprise Mobility Suite 捆绑在一起。<br><br>还可以通过在 Azure 订阅中创建 Azure Multi-Factor Authentication 提供程序，根据使用量购买。
##版本功能比较
