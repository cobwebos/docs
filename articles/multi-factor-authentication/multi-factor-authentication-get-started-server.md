---
title: "Azure Multi-Factor Authentication 服务器入门"
...
---
# <a name="getting-started-with-the-azure-multifactor-authentication-server"></a>Azure Multi-Factor Authentication 服务器入门
...
## <a name="download-the-azure-multifactor-authentication-server"></a>下载 Azure Multi-Factor Authentication 服务器
...
### <a name="to-download-the-azure-multifactor-authentication-server-from-the-azure-portal"></a>从 Azure 门户下载 Azure Multi-Factor Authentication 服务器
- - -
...
### <a name="to-download-the-azure-multifactor-authentication-server-via-the-service-settings"></a>通过服务设置下载 Azure Multi-Factor Authentication 服务器
1. 以管理员身份登录到 Azure 门户。
2. 在左侧选择“Active Directory”。
3. 双击 Azure AD 的实例。
4. 在顶部单击“配置”****
...
## <a name="install-and-configure-the-azure-multifactor-authentication-server"></a>安装和配置 Azure Multi-Factor Authentication 服务器
...
### <a name="azure-multifactor-authentication-server-firewall-requirements"></a>Azure Multi-Factor Authentication 服务器防火墙要求
- - -
...
如果你不使用 Azure 多重身份验证事件确认功能，并且用户不在公司网络中使用设备上的多重身份验证移动应用进行身份验证，则可以将 IP 范围缩小为：
...
### <a name="to-install-and-configure-the-azure-multifactor-authentication-server"></a>安装和配置 Azure 多重身份验证服务器
- - -
1. 双击可执行文件。 随即将会开始安装。
...
### <a name="to-import-users-from-active-directory"></a>从 Active Directory 导入用户
- - -
...
### <a name="configuring-email-and-email-templates"></a>配置电子邮件和电子邮件模板
...
## <a name="how-the-azure-multifactor-authentication-server-handles-user-data"></a>Azure Multi-Factor Authentication 服务器如何处理用户数据
...
## <a name="advanced-azure-multifactor-authentication-server-configurations"></a>Azure Multi-Factor Authentication 服务器高级配置
