...
Azure Multi-Factor Authentication | Multi-Factor Authentication 提供最丰富的功能集。它通过 Azure 管理门户、高级报告及支持一系列本地和云应用程序来提供其他配置选项。Azure Multi-Factor Authentication 随附在 Azure Active Directory Premium 和企业移动套件中。
