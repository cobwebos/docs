---
title: Azure Multi-Factor Authentication 服务器和 Active Directory 联合身份验证服务入门
...
|:--- |:--- |:--- |
| 使用 Azure Multi-Factor Authentication 保护 Azure AD 资源 |<li>第一重身份验证使用 AD FS 在本地执行。</li> <li>第二因素身份验证是使用云身份验证实施的基于手机的方法。</li> |
| 使用 Active Directory 联合身份验证服务保护 Azure AD 资源 |<li>第一重身份验证使用 AD FS 在本地执行。</li><li>第二重身份验证遵循声明在本地执行。</li> |
