<properties 
	pageTitle="使用 Azure Multi-Factor Authentication 与第三方 VPN 的高级方案" 
...
## Cisco ASA VPN 设备和 Azure Multi-Factor Authentication
...
## Citrix NetScaler SSL VPN 与 Azure Multi-Factor Authentication
