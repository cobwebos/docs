...
+ C 语言开发环境。对于本教程，我们将假定 gcc 堆栈在使用 Ubuntu 14.04 的 [Azure Linux 虚拟机](http://www.windowsazure.cn/zh-cn/documentation/articles/virtual-machines-linux-tutorial/)上。有关其他环境的说明，将在外部链接中提供。
