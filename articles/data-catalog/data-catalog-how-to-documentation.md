...
在 [如何对数据源进行批注](data-catalog-how-to-annotate.md)中，你了解到知道数据源的专家可以使用标记和说明对其进行批注。 **Azure 数据目录**门户包含 RTF 编辑器，使用户可以完整地记录数据资产和容器。 编辑器包括段落格式设置（如标题）、文本格式设置、项目符号列表、编号列表和表。
