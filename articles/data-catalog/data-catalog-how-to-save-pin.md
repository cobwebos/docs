...
保存一个或多个搜索后，“保存的搜索”**** 选项会显示在“当前搜索”**** 框下。 展开列表时，将显示所有已保存的搜索。
 ...
 ![数据目录 - 已保存搜索的列表](./media/data-catalog-how-to-save-pin/03-list.png)
...
组织中的所有用户都可以保存搜索供自己使用。 数据目录管理员还可以保存搜索供组织内所有用户使用。 当管理员保存搜索时，会看到“在公司内共享”**** 选项。 选择此选项会与组织中的所有用户共享该保存的搜索。
 ...
 ![数据目录 - 组织保存的搜索](./media/data-catalog-how-to-save-pin/08-organizational-saved-search.png)
...
![数据目录 - 数据资产引脚图标](./media/data-catalog-how-to-save-pin/05-pinning.png)
