...
* [How to register data sources](data-catalog-how-to-register.md)（如何注册数据源）
* [How to discover data sources](data-catalog-how-to-discover.md)（如何发现数据源）
* [How to annotate data sources](data-catalog-how-to-annotate.md)（如何批注数据源）
* [How to document data sources](data-catalog-how-to-documentation.md)（如何阐述数据源）
* [How to connect to data sources](data-catalog-how-to-connect.md)（如何连接到数据源）
* [How to work with big data](data-catalog-how-to-big-data.md)（如何使用大数据）
* [How to manage data assets](data-catalog-how-to-manage.md)（如何管理数据资产）
* [How to set up the Business Glossary](data-catalog-how-to-business-glossary.md)（如何设置业务词汇）
