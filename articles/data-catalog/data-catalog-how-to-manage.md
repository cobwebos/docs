...
用户可以通过在"数据目录"门户中选择 **"获取所有权**"选项来获取数据资产的所有权。 要取得无所有者数据资产的所有权并不需要任何特殊权限。 任何用户都可取得无所有者数据资产的所有权。
...
将自己删除为所有者的资产所有者无法再管理资产。 如果资产所有者将自己作为所有者删除，并且没有其他共同所有者，则资产将还原为非拥有状态。
