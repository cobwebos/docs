...
<tags ms.service="load-balancer" ms.date="06/01/2015" wacn.date=""/>
...
默认情况下，VIP 是动态的，这意味着，分配给云服务的实际 IP 地址会随着时间改变。为了防止发生这种情况，你可以为服务保留 VIP。若要了解有关保留 VIP 的详细信息，请参阅[保留的公共 IP](virtual-networks-reserved-public-ip)。
