---
title: "使用 Azure Resource Manager 创建、启动或删除应用程序网关 | Microsoft Docs"
...
## <a name="create-a-public-ip-address-for-the-frontend-configuration"></a>创建前端配置的公共 IP 地址
...
## <a name="create-an-application-gateway-by-using-newazurermapplicationgateway"></a>使用 New-AzureRmApplicationGateway 创建应用程序网关
