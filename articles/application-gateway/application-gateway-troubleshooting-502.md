---
title: 排除错误网关错误 - Azure 应用程序网关
description: 了解如何排除应用程序网关服务器错误：502 - Web 服务器在充当网关或代理服务器时收到无效响应。
...
配置应用程序网关后，您可能会看到一个错误是"服务器错误：502 - Web 服务器在充当网关或代理服务器时收到无效响应"。 此错误可能是以下主要原因造成的：
...
* [请求超时或用户请求的连接问题](#request-time-out)。
