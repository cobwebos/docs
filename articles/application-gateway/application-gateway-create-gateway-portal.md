...
在本文中，你已创建了资源组、网络资源和后端服务器。 然后可以使用这些资源来创建应用程序网关。 若要详细了解应用程序网关及其关联的资源，请参阅[什么是 Azure 应用程序网关？](overview.md)
