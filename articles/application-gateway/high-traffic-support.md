...
>[!NOTE]
> 本文介绍了几条建议的指导原则，可帮助你设置应用程序网关，以处理因 COVID-19 危机而导致的高流量量的额外流量。
...
v2 SKU 提供自动缩放功能，确保应用程序网关能够随着流量的增加而纵向扩展。 与 v1 相比，它还提供其他重要性能优势，例如，TLS 卸载性能要高出 5 倍、部署和更新时间更快、支持区域冗余，等等。 有关详细信息，请参阅我们的 [v2 文档](https://docs.microsoft.com/azure/application-gateway/application-gateway-autoscaling-zone-redundant)。 
