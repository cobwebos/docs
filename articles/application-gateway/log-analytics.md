...
要将防火墙日志导入日志分析，请参阅[应用程序网关的后端运行状况、诊断日志和指标](application-gateway-diagnostics.md#diagnostic-logging)。 当您的日志分析工作区中包含防火墙日志时，您可以查看数据、编写查询、创建可视化效果以及将它们添加到门户仪表板。
