...
- 对于专用 IP，可以指定在其中创建应用程序网关的子网中的专用 IP 地址。 如果未指定此项，则会自动从子网中选择任意 IP 地址。 有关详细信息，请参阅[创建具有内部负载均衡器的应用程序网关](https://docs.microsoft.com/azure/application-gateway/application-gateway-ilb-arm)。
