...
使用自定义规则，你可以创建自己的规则，这些规则是通过 web 应用程序防火墙（WAF）传递的每个请求的评估。 这些规则的优先级高于托管规则集中的其他规则。 若要允许完全自定义，自定义规则具有操作（允许或阻止）、匹配条件和运算符。
...
若要在一个可复制、粘贴和运行的连续脚本中运行本文中 Azure PowerShell 的代码，请参阅[Azure 应用程序网关 PowerShell 示例](powershell-samples.md)。

## <a name="prerequisites"></a>先决条件
* [!INCLUDE [quickstarts-free-trial-note](../../includes/quickstarts-free-trial-note.md)]

* 需要 Azure PowerShell 模块。 如果选择在本地安装并使用 Azure PowerShell，则此脚本需要 Azure PowerShell module 版本2.1.0 或更高版本。 请执行以下操作：
