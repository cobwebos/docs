                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">适用于 Azure 的云采用框架</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <span class="likeAnH3">来自 Pluralsight 的免费 Azure 课程</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <ul id="get-started1" class="cardsL">
                                        ...
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li><a class="barLink" href="/azure/governance/blueprints/">Azure 蓝图</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card">
                                            <div class="cardText">
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li><a class="barLink" href="/azure/sql-database-edge/">用于边缘的 SQL 数据库</a></li>
                                                    <li><a class="barLink" href="/azure/virtual-machines/windows/sql/">Azure VM 上的 SQL Server</a></li>
                                                    <li><a class="barLink" href="/azure/sql-data-warehouse/">Synapse Analytics（以前称为 SQL DW）</a></li>
                                                ...
                                                <ul class="noBullet">
                                                    ...
                                                    <li>
                                                        <a class="barLink" href="https://azure.microsoft.com/features/azure-portal/mobile-app/">
                                                            <img src="https://docs.microsoft.com/media/common/i_mobile-app-developement.svg" alt=""> Azure 移动应用</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <li>
                                <div class="cardSize">
                                    <div class="cardPadding">
                                        <div class="card">
                                            <div class="cardText">
                                                <h3>利用 Microsoft Learn 掌握技能</h3>
                                                <ul class="noBullet">
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/tour-azure-portal/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/tour-azure-services-and-features.svg" alt=""> 浏览 Azure 服务和功能</a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/principles-cloud-computing/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/principles-cloud-computing.svg" alt=""> 云计算原则</a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/control-azure-services-with-cli/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/control-azure-services-with-cli.svg" alt=""> 使用 CLI 控制 Azure 服务</a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/modules/automate-azure-tasks-with-powershell/">
                                                            <img src="https://docs.microsoft.com/learn/achievements/automate-azure-tasks-with-powershell.svg" alt=""> 将脚本与 PowerShell 配合使用，自动完成 Azure 任务</a>
                                                    </li>
                                                    <li>
                                                        <a class="barLink" href="/learn/browse/?products=azure">更多交互式学习...</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                            ...
                            <li class="bottomRightItem">
                                <a href="https://docs.microsoft.com/azure/index#pivot=products&panel=all">
                                    <button style="cursor: pointer;position: relative; background: #0050C5; border:none; padding:8px 16px; padding-right:30px;color: white; font-size:14px;">查看所有 Azure 服务<svg viewBox="0 0 10 14" style="fill:white;height: 14px;position: absolute;bottom: 13px;right: 12px;width: 1em;"><path d="M7.4 7L1 .6l.6-.6 7 7-7 7-.6-.7L7.4 7z" /></svg></button>
                                </a>
                            </li>
                        </ul>
                    </li>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="/azure/sql-data-warehouse/">
                                                ...
                                                <p>Azure Synapse Analytics（以前称为 SQL DW）</p>
                                            </a>
                                        </li>
                                        <li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Synapse Analytics（以前称为 SQL DW）</h3>
                                                    <p>无限制的分析服务，以无以伦比的速度提供见解</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure NetApp 文件</h3>
                                                    <p>由 NetApp 提供支持的企业级 NFS 文件服务</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>与 Red Hat 联合运行的完全托管的 OpenShift 服务</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>认知服务</h3>
                                                    <p>将 Azure 认知服务容器与 Docker、Kubernetes、AKS 和容器实例配合使用</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure SQL 数据库边缘</h3>
                                                    <p>已针对 IoT 和边缘部署进行了优化的关系数据库引擎。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>安全信息</h3>
                                                    <p>了解如何通过我们的最佳做法和指导来保护 Azure 上的云解决方案</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<li>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>IoT 即插即用</h3>
                                                    <p>将设备连接到 IoT 解决方案而无需编写任何设备代码</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Web 应用程序防火墙</h3>
                                                    <p>为 Web 应用程序提供集中保护，使其免受常见攻击和漏洞的侵害</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>对等互连服务</h3>
                                                    <p>获得最佳 Internet 连接以访问 Microsoft 网络</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure Internet 分析器</h3>
                                                    <p>评估网络基础结构更改对客户性能的影响</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Azure 专用链接</h3>
                                                    <p>以私密方式访问托管在 Azure 平台上的服务，将数据保留在 Microsoft 网络内</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>了解如何使用 Microsoft 的 SIEM，为整个企业提供云规模的智能安全分析。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>适用于 IoT 的 Azure 安全中心</h3>
                                                    <p>了解如何在整个 IoT 解决方案中统一安全管理并实现高级威胁防护</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        <a href="#windowsvirtualdesktop">Windows 虚拟桌面</a>
...
面向 Python 开发人员的 Azure </h3>
                                                <p>
                                                    <a href="/azure/python">入门</a>
                                                </p>
                                                <p>
                                                    <a href="/python/api/?view=azure-python">API 参考</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure 门户</h3>
                                                <p>
                                                    <a href="/azure/azure-portal/">入门</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardPadding">
                                        <div class="card">
                                            ...
                                            <div class="cardText">
                                                <h3>Azure 移动应用</h3>
                                                <p>
                                                    <a href="https://azure.microsoft.com/features/azure-portal/mobile-app/">入门</a>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
