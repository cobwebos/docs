...
最新版本（2.3.0000.0 或以上）的[用于 Visual Studio 的流分析工具](https://docs.microsoft.com/en-us/azure/stream-analytics/stream-analytics-tools-for-visual-studio)增加了对 MSBuild 的支持。
...
了解如何使用[用于 Visual Studio 的流分析工具](https://docs.microsoft.com/en-us/azure/stream-analytics/stream-analytics-tools-for-visual-studio)。
