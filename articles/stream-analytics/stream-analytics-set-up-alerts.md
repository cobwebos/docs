...
可以通过门户或[以编程方式](https://code.msdn.microsoft.com/windowsazure/Receive-Email-Notifications-199e2c9a)从操作日志数据中定义指标的规则。
...
5. 在“配置信号逻辑”下，将“事件级别”更改为“所有”，将“状态”更改为“失败”。 使**事件**保持为空，并选择 "**完成**"。
