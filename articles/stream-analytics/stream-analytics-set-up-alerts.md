...
可以通过门户以及[采用编程方式](https://code.msdn.microsoft.com/windowsazure/Receive-Email-Notifications-199e2c9a)针对操作日志数据中的指标定义规则。

## <a name="set-up-alerts-in-the-azure-portal"></a>在 Azure 门户中设置警报
### <a name="get-alerted-when-a-job-stops-unexpectedly"></a>作业意外停止时收到警报
...
|运行时错误|大于|总计|0|检查活动或资源日志，并对输入、查询或输出进行适当的更改。|
...
|输入反序列化错误|大于|总计|0|检查活动或资源日志，并对输入进行适当的更改。 有关资源日志的详细信息，请参阅[使用资源日志排查 Azure 流分析问题](stream-analytics-job-diagnostic-logs.md)|
