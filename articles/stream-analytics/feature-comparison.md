...
ms.locfileid: "75443661"
---
# <a name="azure-stream-analytics-feature-comparison"></a>Azure 流分析功能比较

使用 Azure 流分析，可以在云中以及使用[Azure 门户](stream-analytics-quick-create-portal.md)、 [Visual Studio](stream-analytics-quick-create-vs.md)和[Visual Studio Code](quick-create-vs-code.md)在 IoT Edge 中创建流式处理解决方案。 本文中的表显示了每个作业类型的每个平台支持哪些功能。
