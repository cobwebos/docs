<properties
	pageTitle="使用 Azure Functions 从 Azure 流分析输出到 Azure Redis 缓存 | Microsoft Azure"
...
如果是 Microsoft Azure 的新用户，我们邀请通过注册一个 [Azure 免费试用帐户](https://azure.microsoft.com/pricing/free-trial/)，以尝试这项服务。如果不熟悉流分析，我们邀请[创建第一个流分析作业](stream-analytics-create-a-job.md)。
...
- [Azure Functions developer reference](../azure-functions/functions-reference.md)（Azure Functions 开发人员参考）
- [Azure Functions C# developer reference](../azure-functions/functions-reference-csharp.md)（Azure Functions C# 开发人员参考）
- [Azure Functions NodeJS developer reference](../azure-functions/functions-reference.md)（Azure Functions NodeJS 开发人员参考）
- [Azure Functions triggers and bindings](../azure-functions/functions-triggers-bindings.md)（Azure Functions 触发器和绑定）
- [如何监视 Azure Redis 缓存](../redis-cache/cache-how-to-monitor.md)

若想及时了解最新的新闻和功能，请在 Twitter 上关注 [@AzureStreaming](https://twitter.com/AzureStreaming)。
