...
本文介绍如何高效地缩放使用 Azure 机器学习函数的 Azure 流分析作业。 有关如何缩放流分析作业的常规信息，请参阅文章 [缩放作业](stream-analytics-scale-jobs.md)。
...
![使用机器学习函数 2 作业缩放流分析的示例](./media/stream-analytics-scale-with-ml-functions/stream-analytics-scale-with-ml-functions-00.png "使用机器学习函数两作业缩放流分析的示例")
