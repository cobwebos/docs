---
title: 通过 PowerShell 监视和管理 Azure 流分析作业
...
### <a name="get-azurestreamanalyticsjob--get-azstreamanalyticsjob"></a>Get-azurestreamanalyticsjob |AzStreamAnalyticsJob
...
### <a name="get-azurestreamanalyticsinput--get-azstreamanalyticsinput"></a>Get-azurestreamanalyticsinput |AzStreamAnalyticsInput
...
### <a name="get-azurestreamanalyticsoutput--get-azstreamanalyticsoutput"></a>Get-azurestreamanalyticsoutput |AzStreamAnalyticsOutput
...
### <a name="get-azurestreamanalyticsquota--get-azstreamanalyticsquota"></a>Get-azurestreamanalyticsquota |AzStreamAnalyticsQuota
...
### <a name="new-azurestreamanalyticsinput--new-azstreamanalyticsinput"></a>Get-azurestreamanalyticsinput |新-AzStreamAnalyticsInput
...
### <a name="new-azurestreamanalyticsjob--new-azstreamanalyticsjob"></a>Get-azurestreamanalyticsjob |新-AzStreamAnalyticsJob
...
### <a name="new-azurestreamanalyticsoutput--new-azstreamanalyticsoutput"></a>Get-azurestreamanalyticsoutput |新-AzStreamAnalyticsOutput
...
### <a name="new-azurestreamanalyticstransformation--new-azstreamanalyticstransformation"></a>Get-azurestreamanalyticstransformation |新-AzStreamAnalyticsTransformation
...
### <a name="remove-azurestreamanalyticsinput--remove-azstreamanalyticsinput"></a>Get-azurestreamanalyticsinput |AzStreamAnalyticsInput
...
### <a name="remove-azurestreamanalyticsjob--remove-azstreamanalyticsjob"></a>Get-azurestreamanalyticsjob |AzStreamAnalyticsJob
...
### <a name="remove-azurestreamanalyticsoutput--remove-azstreamanalyticsoutput"></a>Get-azurestreamanalyticsoutput |AzStreamAnalyticsOutput
...
### <a name="start-azurestreamanalyticsjob--start-azstreamanalyticsjob"></a>Get-azurestreamanalyticsjob |AzStreamAnalyticsJob
...
### <a name="stop-azurestreamanalyticsjob--stop-azstreamanalyticsjob"></a>Get-azurestreamanalyticsjob |停止-AzStreamAnalyticsJob
...
### <a name="test-azurestreamanalyticsinput--test-azstreamanalyticsinput"></a>Get-azurestreamanalyticsinput |AzStreamAnalyticsInput
测试流分析能否连接到指定的输入。
