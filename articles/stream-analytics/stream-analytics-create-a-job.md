<properties 
	pageTitle="创建作业 | Microsoft Azure" 
...
2.  在 Azure 门户中：依次单击“新建”、“数据服务”，再单击“流分析”和“快速创建”。
    ...
    在 Azure 预览门户中：依次单击“新建”、“数据 + 分析”，再单击“Azure 流分析”。

    ![Azure 门户创建作业](./media/stream-analytics-create-a-job/4-stream-analytics-create-a-job.png)
...
4.  当新的流分析作业选项配置完成后，请单击“创建流分析作业”。创建流分析作业需要几分钟时间。要查看状态，你可以在通知中心监视进度。
    ...
    ![Azure 预览门户创建作业](./media/stream-analytics-create-a-job/5-stream-analytics-create-a-job.png)
...
5.  新作业在显示时的状态为**“已创建”**。请注意，“启动”按钮被禁用。你必须先配置作业输入、查询和输出，然后才能启动作业。
    ...
    ![Azure 预览门户作业状态](./media/stream-analytics-create-a-job/6-stream-analytics-create-a-job.png)
