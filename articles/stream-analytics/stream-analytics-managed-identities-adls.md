...
2. **[用户分配标识](../active-directory/managed-identities-azure-resources/overview.md)**： 不支持。 这意味着用户不能输入他们自己的服务主体，以供其 Stream Analytics 作业。 服务主体由 Azure 流分析生成。
