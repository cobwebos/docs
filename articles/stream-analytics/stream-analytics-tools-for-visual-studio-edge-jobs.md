...
|**类别**  | **命令**  |
|---------|---------|
|其他运算符 | <ul><li>分区依据</li><li>TIMESTAMP BY OVER</li><li>JavaScript UDF</li><li>用户定义聚合（UDA）</li><li>GetMetadataPropertyValue</li><li>在一个步骤中使用超过14个聚合</li></ul>   |
