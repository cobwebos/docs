...
概述边栏选项卡将显示 HTTP 请求数据。 （如果未显示，请稍候片刻，然后单击“刷新”。）
...
打开已更新的网页并使用它们。 等待一两分钟，然后返回 Application Insights，打开使用情况边栏选项卡。 （在“概述”边栏选项卡中，向下滚动并单击“使用情况”。）

页面视图、用户和会话指标将显示在使用情况边栏选项卡上：
...
在“概述”边栏选项卡中，向下滚动并单击“服务器”磁贴。 此时将显示一系列性能计数器。
