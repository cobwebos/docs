...
![导航到工作簿的屏幕截图](./media/app-insights-usage-workbooks/001-workbooks.png)

这将启动包含大量预先构建工作簿的工作簿库，以帮助你入门。

![工作簿库的屏幕截图](./media/app-insights-usage-workbooks/002-workbook-gallery.png)

我们将从“默认模板”开始，位于“快速入门”标题下方。

![工作簿库的屏幕截图](./media/app-insights-usage-workbooks/003-default-template.png)
...
![Application Insights 工作簿部分编辑控件](./media/app-insights-usage-workbooks/editing-controls-new.png)
...
![工作簿中的查询部分](./media/app-insights-usage-workbooks/analytics-section-new.png)
...
每个部分都有自己的高级设置，可通过位于“添加参数”按钮右侧的设置图标 ![Application Insights 工作簿部分编辑控件](./media/app-insights-usage-workbooks/005-settings.png)访问。

![Application Insights 工作簿部分编辑控件](./media/app-insights-usage-workbooks/0006-settings-expanded.png)
...
![Application Insights 工作簿部分编辑控件](./media/app-insights-usage-workbooks/003-active-users.png)

第个部分也基于分析查询数据，但在第一个表中选择某一行将交互更新图表的内容：

![Application Insights 工作簿部分编辑控件](./media/app-insights-usage-workbooks/004-active-users-trend.png)

 这可以通过使用在表格的分析查询中启用的高级设置“选择项目后，导出参数”实现。

![Application Insights 工作簿部分编辑控件](./media/app-insights-usage-workbooks/007-settings-export.png)
...
![Application Insights 工作簿部分编辑控件](./media/app-insights-usage-workbooks/008-metrics-grid.png)
...
![Application Insights 工作簿部分编辑控件](./media/app-insights-usage-workbooks/009-time-range.png)

这将启动“编辑参数”菜单项：

![Application Insights 工作簿部分编辑控件](./media/app-insights-usage-workbooks/010-time-range-edit.png)
...
![Application Insights 工作簿部分编辑控件](./media/app-insights-usage-workbooks/011-data-table.png)
...
![国家/地区下拉列表](./media/app-insights-usage-workbooks/012-country-dropdown.png)
...
![国家/地区下拉列表](./media/app-insights-usage-workbooks/013-resource-picker.png)
