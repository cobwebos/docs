...
* [应用服务](app-insights-profiler.md?toc=/azure/azure-monitor/toc.json)
...
* [虚拟机和 VM 规模集](app-insights-profiler-vm.md?toc=/azure/azure-monitor/toc.json)

如果已启用 Profiler 但未看到跟踪，请查看[故障排除指南](app-insights-profiler-troubleshooting.md?toc=/azure/azure-monitor/toc.json)。
