...
![为用户流选择初始事件](./media/app-insights-usage-flows/00002-flows-initial-event.png)
...
![使用用户流，了解用户单击的位置](./media/app-insights-usage-flows/00003-flows-one-step.png)
