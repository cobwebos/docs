...
| 指标组 | 收集器模块 |
| --- | --- |
| basicExceptionBrowser、<br/>clientPerformance、<br/>view |[浏览器 JavaScript](app-insights-javascript.md) |
| performanceCounter |[性能](app-insights-configuration-with-applicationinsights-config.md) |
| remoteDependencyFailed |[依赖项](app-insights-configuration-with-applicationinsights-config.md) |
| request、<br/>requestFailed |[服务器请求](app-insights-configuration-with-applicationinsights-config.md) |

## <a name="webhooks"></a>Webhook
可[自动执行对警报的响应](../monitoring-and-diagnostics/insights-webhooks-alerts.md)。 引发警报时，Azure 将调用所选的 Web 地址。

## <a name="see-also"></a>另请参阅
* [用于配置 Application Insights 的脚本](app-insights-powershell-script-create-resource.md)
