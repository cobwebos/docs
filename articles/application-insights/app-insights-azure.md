---
title: "适用于 Microsoft Azure 应用的 Application Insights | Microsoft Docs"
...
诊断和解决问题，持续改进应用程序。 快速诊断实时应用程序中的任何问题。 了解用户使用它来做了些什么。
...
* [Azure 外部的应用程序](app-insights-overview.md)
