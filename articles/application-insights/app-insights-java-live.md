...
如果你有一个 Web 应用程序在 J2EE 服务器上运行，无需更改代码或重新编译项目，就能开始使用 [Application Insights](app-insights-overview.md) 来监视该应用程序。 使用此选项可以获取发送到服务器的 HTTP 请求、未经处理的异常和性能计数器的相关信息。
...
概述边栏选项卡显示了有关 HTTP 请求的遥测数据。 （如果未显示，请稍候片刻，然后单击“刷新”。）
