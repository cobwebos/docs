...
该服务目前支持各种迁移方案。 有关每个可用迁移方案的状态的完整列表，请参阅文章 [Azure 数据库迁移服务支持的迁移方案的状态](https://docs.microsoft.com/azure/dms/resource-scenario-status)。 其他迁移方案处于预览状态，需要提交提名通过 DMS 预览站点。 在预览版中和注册参加这些产品/服务的方案的完整列表，请参阅[DMS 预览站点](https://aka.ms/dms-preview/)。
