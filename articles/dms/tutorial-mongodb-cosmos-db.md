---
title: 教程：将蒙戈DB脱机迁移到蒙戈DB的 Azure 宇宙 DB API
...
ms.locfileid: "78255589"
---
# <a name="tutorial-migrate-mongodb-to-azure-cosmos-dbs-api-for-mongodb-offline-using-dms"></a>教程：使用 DMS 将蒙戈DB迁移到 Azure Cosmos DB 的 API，使蒙戈DB脱机
