---
title: 教程：将 MongoDB 脱机迁移到 Azure Cosmos DB 适用于 MongoDB 的 API
titleSuffix: Azure Database Migration Service
description: 了解如何使用 Azure 数据库迁移服务从本地的 MongoDB 迁移到 Azure Cosmos DB API 以使 MongoDB 脱机。
services: dms
author: HJToland3
ms.author: jtoland
manager: craigg
...
ms.locfileid: "75437632"
---
# <a name="tutorial-migrate-mongodb-to-azure-cosmos-dbs-api-for-mongodb-offline-using-dms"></a>教程：使用 DMS 将 MongoDB 迁移到 Azure Cosmos DB 的 API 以使 MongoDB 脱机
...
* 确保 VNet 网络安全组（NSG）规则不会阻止以下通信端口：53、443、445、9354和10000-20000。 有关 Azure VNet NSG 流量筛选的更多详细信息，请参阅[使用网络安全组筛选网络流量](https://docs.microsoft.com/azure/virtual-network/virtual-networks-nsg)一文。
