---
title: 已知问题：在线迁移到 SQL 数据库
titleSuffix: Azure Database Migration Service
description: 使用 Azure 数据库迁移服务了解有关 Azure SQL 数据库联机迁移的已知问题/迁移限制。
...
如果 LOB 列大于 32 KB，请与["询问 Azure 数据库迁移"](mailto:AskAzureDatabaseMigrations@service.microsoft.com)中的工程团队联系。
...
如果需要 Azure 数据库迁移服务来迁移源表中存储的确切时间戳值，请与[询问 Azure 数据库迁移](mailto:AskAzureDatabaseMigrations@service.microsoft.com)的工程团队联系。
