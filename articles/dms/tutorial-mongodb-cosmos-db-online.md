---
title: 教程：将蒙戈DB联机迁移到蒙戈DB的 Azure 宇宙 DB API
...
---
# <a name="tutorial-migrate-mongodb-to-azure-cosmos-dbs-api-for-mongodb-online-using-dms"></a>教程：使用 DMS 将蒙戈DB迁移到 Azure Cosmos DB 的 API，用于在线蒙戈DB
...
* 通过使用 Azure 资源管理器部署模型为 Azure 数据库迁移服务创建 Microsoft Azure 虚拟网络，该模型通过使用[ExpressRoute](https://docs.microsoft.com/azure/expressroute/expressroute-introduction)或[VPN](https://docs.microsoft.com/azure/vpn-gateway/vpn-gateway-about-vpngateways)提供与本地源服务器的站点到站点的连接。
...
* 确保您的虚拟网络网络安全组 （NSG） 规则不会阻止以下通信端口：53、443、445、9354 和 10000-20000。 有关虚拟网络 NSG 流量筛选的更多详细信息，请参阅[使用网络安全组筛选网络流量](https://docs.microsoft.com/azure/virtual-network/virtual-networks-nsg)一文。
