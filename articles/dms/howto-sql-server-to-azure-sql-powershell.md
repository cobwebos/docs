...
* Azure SQL 数据库实例。 可以按照[在 Azure 门户中创建 Azure SQL 数据库中的数据库](https://docs.microsoft.com/azure/sql-database/sql-database-get-started-portal)一文中的详细说明来创建 Azure SQL 数据库实例。
