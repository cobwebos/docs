...
- 若要下载并使用从 PowerShell 库安装 Az.DataMigration 模块[Install-module PowerShell cmdlet](https://docs.microsoft.com/powershell/module/powershellget/Install-Module?view=powershell-5.1); 请务必打开 powershell 命令窗口中使用以管理员身份运行。
...
- *TargetConnection*。 AzDmsConnInfo 对象，表示目标 Azure SQL 数据库连接。
