---
title: 教程：将 SQL 服务器联机迁移到 SQL 单个数据库
...
ms.locfileid: "80298971"
---
# <a name="tutorial-migrate-sql-server-to-a-single-database-or-pooled-database-in-azure-sql-database-online-using-dms"></a>教程：使用 DMS 在线将 SQL 服务器迁移到 Azure SQL 数据库中的单个数据库或池数据库
...
- 确保虚拟网络网络安全组规则不会阻止以下到 Azure 数据库迁移服务的入站通信端口：443、53、9354、445、12000。 有关 Azure 虚拟网络 NSG 流量筛选的更多详细信息，请参阅文章["使用网络安全组筛选网络流量](https://docs.microsoft.com/azure/virtual-network/virtual-networks-nsg)"。
