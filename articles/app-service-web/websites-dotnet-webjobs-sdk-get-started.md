<properties 
	pageTitle="在 Azure App Service 中创建 .NET Web 作业" 
	description="了解如何使用 ASP.NET MVC 和 Azure 创建多层应用程序。前端在 Azure App Service 的 Web 应用中运行，后端以 Web 作业的形式运行。应用程序使用实体框架、SQL 数据库和 Azure 存储队列和 Blob。" 
...
你可以从 MSDN 代码库[下载 Visual Studio 项目][download]。
...
9. 在“在 Microsoft Azure 上创建 Web 应用”对话框框中，在“Web 应用名称”框中输入唯一名称。
