---
title: 在五分钟内将第一个 Web 应用部署到 Azure | Microsoft Docs
...
6. 在“部署成功”边栏选项卡中，单击“资源”链接打开新的 Web 应用的边栏选项卡。
...
3. 返回 Web 应用边栏选项卡中，单击“部署凭据”。
4. 设置部署凭据，然后单击“保存”。
5. 返回到 Web 应用边栏选项卡中，向下滚动到“属性”或搜索它，然后单击它。单击“Git URL”旁边的“复制”按钮。
...
8. 对前几个步骤中从门户中复制的 Azure 应用的 Git URL 远程配置 Git。
