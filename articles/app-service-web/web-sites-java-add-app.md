...
按照[在 Azure App Service 中创建 Java Web 应用](web-sites-java-get-started.md)中的说明完成初始化 [Azure App Service][Azure App Service] 中的 Java Web 应用后，即可通过将 WAR 放置在**webapps** 文件夹来上传应用程序。
