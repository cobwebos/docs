...
## <a name="a-idconvertaenable-webjobs-deployment-for-an-existing-console-application-project"></a><a id="convert"></a>为现有控制台应用程序项目启用 Web 作业部署
可以使用两个选项：
...
### <a name="a-idconvertlinka-enable-automatic-webjobs-deployment-with-a-web-project"></a><a id="convertlink"></a>使用 Web 项目启用自动 Web 作业部署
...
### <a name="a-idconvertnolinka-enable-webjobs-deployment-without-a-web-project"></a><a id="convertnolink"></a>不使用 Web 项目启用 Web 作业部署
...
## <a name="a-idcreateacreate-a-new-webjobs-enabled-project"></a><a id="create"></a>创建已启用 Web 作业的新项目
...
### <a name="a-idcreatenolinka-use-the-webjobs-new-project-template-for-an-independent-webjob"></a><a id="createnolink"></a>为独立的 Web 作业使用 Web 作业新建项目模板
...
### <a name="a-idcreatelinka-use-the-webjobs-new-project-template-for-a-webjob-linked-to-a-web-project"></a><a id="createlink"></a>在链接到 Web 项目的 Web 作业中使用 Web 作业新建项目模板
...
## <a name="a-idconfigureathe-add-azure-webjob-dialog"></a><a id="configure"></a>添加 Azure Web 作业对话框
...
## <a name="a-iddeployadeploy-a-webjobs-project"></a><a id="deploy"></a>部署 Web 作业项目
