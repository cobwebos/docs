...
> [AZURE.NOTE]本指南展示为面向公众的 .COM 站点开发而进行调整的一些最常见领域和任务。但是，还有可在特定实施中使用的其他一些 Azure 网站功能。若要查看这些功能，另请参阅[全球网络影响力](/zh-cn/documentation/articles/web-sites-global-web-presence-solution-overview)和[数字市场营销活动](/zh-cn/documentation/articles/web-sites-digital-marketing-application-solution-overview)中的其他指南。
...
<tr>
  ...
  [adoverview]: /zh-cn/documentation/services/active-directory/
  ...
  [troubleshoot Websites]: /zh-cn/documentation/articles/web-sites-dotnet-troubleshoot-visual-studio
