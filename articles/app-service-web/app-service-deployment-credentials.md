...
1. 在 [Azure 门户](https://portal.azure.com)中，单击“应用服务”> **&lt;any_app>** > “部署凭据”。
    ...
    > [!NOTE]
    > 在门户中必须至少有一个应用，然后才能访问部署凭据边栏选项卡。 但在使用 [Azure CLI](app-service-web-app-azure-resource-manager-xplat-cli.md) 时，却可在没有应用的情况下配置用户级凭据。
...
> [!NOTE]
> Azure 不会显示你的用户级部署密码。 如果忘记了密码，则无法检索它。 但是，可以按照本部分的步骤重置凭据。
>
>  
