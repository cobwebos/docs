...
4. 如果尚未登录到 Microsoft Azure，则会提示进行登录。 按照提示登录到 Azure。
...
3. 单击“我接受”以接受 10gen, Inc. 的许可条款。
4. 安装驱动程序后，单击“关闭”。
    ![MongoDB C# 驱动程序已安装][MongoDBCsharpDriverInstalled]
...
为了设置 Task List 菜单，请打开 *\Views\Home\Index.cshtml* 文件，将现有代码替换为以下代码：
...
若要增加创建新任务的功能，请右键单击“Views\Home\”文件夹并添加一个视图。*\\*  将该视图命名为 *Create*。 将此代码替换为以下代码：
