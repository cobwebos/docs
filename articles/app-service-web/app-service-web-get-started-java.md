...
[Azure App Service](../app-service/app-service-value-prop-what-is.md) 的 [Web 应用](https://docs.microsoft.com/azure/app-service-web/app-service-web-overview)功能提供高度可缩放、自助修补的 Web 托管服务。 本快速入门演示如何使用 [Eclipse IDE for Java EE Developers](http://www.eclipse.org/) 将 Java Web 应用部署到应用服务。
...
* 在“应用服务计划”选项卡中：
  ...
  * **位置**：选择“西欧”或你附近的位置。
  * **定价层**：选择免费选项。 有关功能，请参阅[应用服务定价](https://azure.microsoft.com/pricing/details/app-service/)。
