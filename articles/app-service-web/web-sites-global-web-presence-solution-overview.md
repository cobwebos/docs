<properties 
	pageTitle="在 Azure App Service Web Apps 上打造全球网络影响力" 
	description="本指南提供有关如何在 Azure App Service Web Apps 上托管组织 (.COM) 站点的技术概述。内容包括部署、自定义域、SSL 和监视。" 
	editor="jimbe" 
	manager="wpickett" 
	authors="cephalin" 
