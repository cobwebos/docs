...
description: "获取有关 Azure App Service 的 Web 应用功能的开放源代码技术常见问题解答。"
...
本文包含有关针对 [Azure App Service 的 Web 应用功能](https://azure.microsoft.com/services/app-service/web/)的开放源代码技术问题的常见问题 (FAQ) 解答。
...
有关详细信息，请参阅 [ClearDB MySQL 数据库与 Azure App Service 搭配使用时的常见问题解答](https://docs.microsoft.com/azure/store-cleardb-faq/)。
