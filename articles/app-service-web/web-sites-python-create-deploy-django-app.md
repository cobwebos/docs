...
本教程描述如何开始在 [Azure 网站](http://go.microsoft.com/fwlink/?LinkId=529714)上运行 Python。Web Apps 提供有限的免费托管和快速部署功能，现在，您可以使用 Python！ 随着您的应用增长，可以切换到付费托管，并且还可以与所有其他 Azure 服务集成。
...
Azure 提供可以从 Django 应用程序方便地使用的数据库服务。从 Django 应用程序使用 [SQL 数据库](../web-sites-python-ptvs-django-sql)和 [MySQL](../web-sites-python-ptvs-django-mysql) 的教程展示了创建数据库服务、更改 `DjangoWebProject/settings.py` 中的数据库设置所需的步骤以及安装所需的库。
