---
title: "在 5 分钟内将第一个 Web 应用部署到 Azure（CLI 2.0 预览版）| Microsoft 文档"
...
---
# <a name="deploy-your-first-web-app-to-azure-in-five-minutes-cli-20-preview"></a>在 5 分钟内将第一个 Web 应用部署到 Azure（CLI 2.0 预览版）
