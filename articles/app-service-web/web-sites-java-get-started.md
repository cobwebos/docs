<properties
	pageTitle="在 Azure App Service 中创建 Java Web 应用"
...
> [AZURE.NOTE]若要完成本教程，你需要一个 Microsoft Azure 帐户。如果你没有帐户，则可以<a href="/zh-cn/pricing/member-offers/msdn-benefits-details/?WT.mc_id=A261C142F" target="_blank">激活 MSDN 订户权益</a>或<a href="/zh-cn/pricing/1rmb-trial/?WT.mc_id=A261C142F" target="_blank">注册获取免费试用版</a>。
> 
> 如果你想要在注册帐户之前开始使用 Azure 网站，请转到 <a href="https://trywebsites.chinacloudsites.cn/?language=java">https://trywebsites.chinacloudsites.cn</a>，你可以通过该网站在 Azure 网站中立即免费创建一个生存期较短的 ASP.NET 入门站点。你不需要使用信用卡，也不需要做出承诺。
