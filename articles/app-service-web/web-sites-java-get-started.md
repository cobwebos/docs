<properties
	pageTitle="在 Azure 网站中创建 Java Web 应用 | Microsoft Azure"
...
本教程演示如何通过 [Azure 管理门户](https://manage.windowsazure.cn)[在 Azure 网站中创建 Java Web 应用](/documentation/services/web-sites/)。
...
3. 创建一个应用，然后手动复制和编辑配置文件
	...
	你可能需要托管一个自定义 Java 应用程序，该程序不部署在 App Service 所提供的任何 Web 容器中。例如，你可能出于以下原因而需要这样做：
...
现在，你有了一台在 Azure App Service 的 Web 应用中运行的 Java 应用程序服务器。若要将你自己的代码部署到 Web 应用，请参阅[将应用程序或网页添加到 Java Web 应用](/documentation/articles/web-sites-java-add-app)。
