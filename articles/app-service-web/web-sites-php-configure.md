<properties
	pageTitle="在 Azure App Service Web Apps 中配置 PHP"
...
本指南将向你演示如何执行以下操作：在 Azure 网站中配置 Web Apps 的内置 PHP 运行时，提供自定义 PHP 运行时，以及启用扩展。若要使用 App Service，请注册[免费试用版]。若要充分利用本指南，你应先在 App Service 中创建一个 PHP Web 应用。
