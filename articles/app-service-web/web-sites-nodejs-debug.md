...
若要重新启动 Web 应用，请在 [Azure 管理门户](https://manage.windowsazure.cn)中选择该 Web 应用，然后单击“重新启动”按钮：
...
若要通过 FTP 访问诊断信息，请访问 [Azure 管理门户](https://manage.windowsazure.cn)，选择你的 Web 应用，然后选择“仪表板”。在“快速链接”部分中，“FTP 诊断日志”和“FTPS 诊断日志”链接提供使用 FTP 协议对日志的访问。
