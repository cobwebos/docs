---
title: "在 Azure Web 应用中创建 PHP 应用程序 | Microsoft Docs"
...
本快速入门教程逐步讲解如何开发 PHP 应用并将其部署到 Azure。 我们将使用 [Azure 应用服务计划](https://docs.microsoft.com/azure/app-service/azure-web-sites-web-hosting-plans-in-depth-overview)运行该应用，然后使用 Azure CLI 在其中创建并配置一个新的 Web 应用。 然后，我们使用 git 将该 PHP 应用部署到 Azure。
