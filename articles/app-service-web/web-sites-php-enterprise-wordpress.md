<properties
	pageTitle="Azure App Service 上的企业级 WordPress"
...
3. 创建新的数据库并恢复备份。
	...
	3. 更新数据库，将域条目更改为新的 Azure App Service 域。例如，mywordpress.azurewebsites.net。使用[搜索和替换为 WordPress 数据库脚本][searchandreplace]，安全地更改所有实例。
