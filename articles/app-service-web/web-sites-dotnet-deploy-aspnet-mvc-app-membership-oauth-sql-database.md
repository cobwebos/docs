...
>[AZURE.NOTE] 这是一篇很长的教程。如果你想要快速了解 Azure 和 Visual Studio Web 项目，请参阅[在 Azure 中创建 ASP.NET Web 应用](/documentation/articles/web-sites-dotnet-get-started)。有关疑难解答信息，请参阅[疑难解答](#troubleshooting)部分。
>
