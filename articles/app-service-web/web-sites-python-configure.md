...
本教程介绍在 [Azure App Service Web 应用](http://go.microsoft.com/fwlink/?LinkId=529714)中创作和配置符合基本 Web 服务器网关接口 (WSGI) 的 Python 应用程序的选项。
...
如果没有现成的 Web 应用，可从 [Azure 门户](https://portal.azure.com)中创建一个。  单击左上角的“新建”按钮，然后依次单击“Web + 移动” > “Web 应用”。
