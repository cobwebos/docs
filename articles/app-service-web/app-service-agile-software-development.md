...
>
>若要在 Azure 中存储 GitHub 凭据，请在 [Azure 门户](https://portal.azure.cn/)中创建 Web 应用，并[配置 GitHub 部署](/documentation/articles/app-service-continuous-deployment/)。您只需执行此操作一次。
