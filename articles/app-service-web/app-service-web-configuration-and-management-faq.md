...
有关将自定义域名用于 Azure Web 应用的常见问题解答，请参阅我们的七分钟视频[添加自定义域名](https://channel9.msdn.com/blogs/Azure-App-Service-Self-Help/Add-a-Custom-Domain-Name)。 该视频提供有关如何添加自定义域名的演练。 它介绍如何将自己的 URL（而不是 *.azurewebsites.net URL）用于应用服务 Web 应用。 还可以查看有关[如何映射自定义域名](web-sites-custom-domain-name.md)的详细演练。
...
如果你的网站在适用于 PowerApps 的应用服务环境中承载，则若要了解如何获取出站 IP 地址，请参阅[出站网络地址](app-service-app-service-environment-network-architecture-overview.md#outbound-network-addresses)。
...
有关详细信息，请参阅[如何创建应用服务环境](app-service-web-how-to-create-an-app-service-environment.md)。
...
有关应用服务中的身份验证和授权的详细文档，请参阅[应用服务安全](../app-service/app-service-security-readme.md)。 该文档还包含有关设置应用服务以使用各种身份提供程序登录的信息：
...
* [Microsoft 帐户](../app-service-mobile/app-service-mobile-how-to-configure-microsoft-authentication.md)
