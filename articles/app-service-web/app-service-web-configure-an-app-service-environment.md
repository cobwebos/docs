---
title: "如何配置应用服务环境 | Microsoft Docs"
description: "应用服务环境的配置、管理和监视"
...
---
# <a name="configuring-an-app-service-environment"></a>配置应用服务环境
...
但是你可以设置资源池的数量和大小。 在 ASE 中，你有四个大小选项，标记为 P1 到 P4。 有关这些大小及其定价的详细信息，请参阅[应用服务定价](../app-service/app-service-value-prop-what-is.md)。
...
若要打开列出所有的应用服务环境的 UI，可以使用图标，或选择边栏底部的 V 形标记（“>”符号），然后选择应用服务环境。 选择其中一个列出的 ASE 会打开用于监视和管理该 ASE 的 UI。
...
每个资源池的基本边栏选项卡分别提供一个图表，其中包含该资源池的度量值。 就像 ASE 边栏选项卡中的图表一样，你可以进入该图表并设置所需的警报。 从 ASE 边栏选项卡为特定的资源池设置警报，效果等同于从资源池进行设置。 在辅助角色池的“设置”边栏选项卡中，你有权访问在此辅助角色池中运行的所有应用或应用服务计划。
...
若要使用特定资源池中的手动或自动缩放功能，请根据需要转到“设置” > “前端池” / “辅助角色池”。 然后打开你要更改的池。 转到“设置” > “扩大”或“设置” > “增加”。 通过“扩大”边栏选项卡可控制实例数量。 使用“增加”可控制资源大小。  
