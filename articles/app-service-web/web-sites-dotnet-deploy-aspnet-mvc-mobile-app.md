...
-	如何使用 Visual Studio 2013 将 Web 应用程序直接发布到 Microsoft Azure 网站。
...
7.	在“发布 Web”中，单击“Microsoft Azure 网站”。
...
>[AZURE.NOTE]虽然可以从 Visual Studio 内部调试 MVC 5 应用程序，但可以再次将网站发布到 Microsoft Azure，以直接从移动浏览器或浏览器模拟器验证实时网站。
...
-	将 ASP.NET MVC 5 应用程序部署到 Microsoft Azure 网站
...
<!-- Internal Links -->
[将初学者项目部署到 Microsoft Azure 网站]: #bkmk_DeployStarterProject
