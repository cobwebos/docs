...
我们将了解如何创建 Azure 存储帐户、如何将 Web 应用配置为使用 Azure 表存储，以及如何将 Web 应用发布到 [Azure App Service Web Apps](/documentation/services/web-sites/) 中。
...
1.  在 Web 应用的边栏选项卡中，依次单击“配置”和“应用程序设置”。
