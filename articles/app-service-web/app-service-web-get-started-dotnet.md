<properties 
	pageTitle="在 5 分钟内将第一个 .NET Web 应用部署到 Azure | Microsoft Azure" 
...
>[AZURE.NOTE] 无需 Azure 帐户就可以[试用应用服务](http://go.microsoft.com/fwlink/?LinkId=523751)。创建入门级应用并玩转长达一小时 — 无需信用卡，也无需做出任何承诺。
...
5. 在“部署成功”边栏选项卡中，单击“资源”链接即可打开新的 Web 应用的边栏选项卡。
...
7. 返回到 Web 应用边栏选项卡，单击“部署凭据”。

8. 设置部署凭据，单击“保存”。

7. 返回到 Web 应用边栏选项卡，向下滚动到“属性”或搜索它，然后单击它。单击“Git URL”旁边的“复制”按钮。
...
3. 对前几个步骤中从门户中复制的 Azure 应用的 Git URL 配置 Git remote。
