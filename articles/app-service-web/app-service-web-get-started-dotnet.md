...
description: "了解如何通过部署一个示例应用，轻松地在应用服务中运行 Web 应用。 迅速开始进行实际开发并立即查看结果。"
...
---
# <a name="deploy-your-first-net-web-app-to-azure-in-five-minutes"></a>在 5 分钟内将第一个 .NET Web 应用部署到 Azure
本教程帮助用户将一个简单的 .NET Web 应用部署到 [Azure 应用服务](../app-service/app-service-value-prop-what-is.md)。
...
## <a name="deploy-an-net-web-app"></a>部署 .NET Web 应用
