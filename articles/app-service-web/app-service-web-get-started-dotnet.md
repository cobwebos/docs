---
title: "在 5 分钟内将第一个 ASP.NET Web 应用部署到 Azure（CLI 2.0 预览版）| Microsoft 文档"
description: "了解如何通过部署一个示例 ASP.NET 应用，轻松地在应用服务中运行 Web 应用。 快速开始进行实际开发并立即查看结果。"
...
---
# <a name="deploy-your-first-aspnet-web-app-to-azure-in-five-minutes-cli-20-preview"></a>在 5 分钟内将第一个 ASP.NET Web 应用部署到 Azure（CLI 2.0 预览版）
...
本教程帮助用户将一个简单的 ASP.NET Web 应用部署到 [Azure 应用服务](../app-service/app-service-value-prop-what-is.md)。
...
- [Azure CLI 1.0](app-service-web-get-started-dotnet-cli-nodejs.md) - 适用于经典部署模型和资源管理部署模型的 CLI
- [Azure CLI 2.0（预览版）](app-service-web-get-started-dotnet.md)- 适用于资源管理部署模型的下一代 CLI
...
## <a name="deploy-an-aspnet-web-app"></a>部署 ASP.NET Web 应用
...
4. 接下来，获取所要部署的示例 ASP.NET 代码。 切换到工作目录 (`CD`) 并克隆示例应用，如下所示：
