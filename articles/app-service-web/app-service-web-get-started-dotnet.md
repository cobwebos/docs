...
description: "了解如何通过部署一个示例 ASP.NET 应用，轻松地在应用服务中运行 Web 应用。"
...
本快速入门帮助你在数分钟内将你的第一个 ASP.NET Web 应用部署到 [Azure 应用服务](../app-service/app-service-value-prop-what-is.md)。
