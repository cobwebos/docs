---
title: "在 5 分钟内将第一个 Python Web 应用部署到 Azure（CLI 2.0 预览版）| Microsoft 文档"
...
---
# <a name="deploy-your-first-python-web-app-to-azure-in-five-minutes-cli-20-preview"></a>在 5 分钟内将第一个 Python Web 应用部署到 Azure（CLI 2.0 预览版）
...
## <a name="deploy-a-python-web-app"></a>部署 Python Web 应用
...
4. 接下来，获取所要部署的示例 Python 代码。 切换到工作目录 (`CD`) 并克隆示例应用，如下所示：
...
7. 像使用 Git 推送任何代码一样，将示例代码部署到 Azure 应用。 出现提示时，使用之前配置的密码。
    ...
    如果项目（存储库）根目录中存在 requirements.txt (Python) 文件，部署脚本会还原所需的包。 
