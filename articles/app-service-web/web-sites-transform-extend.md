---
title: "Azure App Service Web 应用高级配置和扩展"
description: "使用 XML 文档转换 (XDT) 声明可以转换 Azure App Service Web 应用中的 ApplicationHost.config 文件，以及添加专用扩展来启用自定义管理操作。"
author: cephalin
writer: cephalin
editor: mollybos
manager: erikre
...
---
# <a name="azure-app-service-web-app-advanced-config-and-extensions"></a>Azure App Service Web 应用高级配置和扩展
使用 [XML 文档转换](http://msdn.microsoft.com/library/dd465326.aspx) (XDT) 声明，可以转换 Azure App Service 中 Web 应用的 [ApplicationHost.config](http://www.iis.net/learn/get-started/planning-your-iis-architecture/introduction-to-applicationhostconfig) 文件。 你还可使用 XDT 声明添加专用扩展，启用自定义 Web 应用管理操作。 本文包括一个 PHP Manager Web 应用扩展示例，可用于通过 Web 界面管理 PHP 设置。

[!INCLUDE [app-service-web-to-api-and-mobile](../../includes/app-service-web-to-api-and-mobile.md)]

## <a name="a-idtransformaadvanced-configuration-through-applicationhostconfig"></a><a id="transform"></a>通过 ApplicationHost.config 完成的高级配置
...
## <a name="a-idextenda-extend-your-web-app"></a><a id="extend"></a> 扩展 Web 应用
### <a name="a-idoverviewa-overview-of-private-web-app-extensions"></a><a id="overview"></a> 专用 Web 应用扩展概述
...
**注意**：有关这些关键元素的其他信息，请参阅 [https://github.com/projectkudu/kudu/wiki/Azure-Site-Extensions](https://github.com/projectkudu/kudu/wiki/Azure-Site-Extensions)。
...
### <a name="a-idsitesamplea-web-app-extension-example-php-manager"></a><a id="SiteSample"></a> Web 应用扩展示例：PHP Manager
...
#### <a name="a-idphpwebappa-the-php-manager-web-application"></a><a id="PHPwebapp"></a> PHP Manager Web 应用程序
PHP Manager 部署主页如下：
...
#### <a name="a-idxdta-the-applicationhostxdt-file"></a><a id="XDT"></a>applicationHost.xdt 文件
...
这样做可以将新应用程序路径添加到 SCM 站点下的 `system.applicationHost` 站点列表中。 SCM 站点为具有特定访问凭据的站点管理终结点。 其 URL 为 `https://[your-site-name].scm.azurewebsites.net`。  
...
### <a name="a-iddeploya-web-app-extension-deployment"></a><a id="deploy"></a> Web 应用扩展部署
