...
从管理门户选择“部署选项”后，即可使用本地 Git 或 GitHub 存储库部署应用程序。 剩下的说明与非 Linux Web 应用的说明类似，用户可以按照 GitHub 的[本地 Git 部署](app-service-deploy-local-git.md)或[持续部署](app-service-continuous-deployment.md)文章中的说明进行操作。
