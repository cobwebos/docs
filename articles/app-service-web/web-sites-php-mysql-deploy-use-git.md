...
本教程演示如何创建 PHP-MySQL Web 应用以及如何使用 Git 将该应用部署到[应用服务](/documentation/services/web-sites/)。需要使用计算机上已安装的 [PHP][install-php]、MySQL 命令行工具（[MySQL][install-mysql] 的一部分）和 [Git][install-git]。本教程中的说明适用于任何操作系统，包括 Windows、Mac 和 Linux。完成本指南之后，你将拥有一个在 Azure 中运行的 PHP/MySQL Web 应用。

你将学习以下内容：

* 如何使用 [Azure 门户][management-portal]创建 Web 应用和 MySQL 数据库。由于[应用服务 Web 应用](/documentation/services/web-sites/)已默认启用 PHP，因此运行 PHP 代码没有任何特殊要求。
...
1. 在 [Azure 门户][management-portal]中的 PHP Web 应用的边栏选项卡中，请单击“工具”>“扩展”。
