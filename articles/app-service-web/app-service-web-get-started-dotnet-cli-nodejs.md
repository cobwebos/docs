---
title: "在 5 分钟内将第一个 ASP.NET Web 应用部署到 Azure | Microsoft 文档"
...
---
# <a name="deploy-your-first-aspnet-web-app-to-azure-in-five-minutes"></a>在 5 分钟内将第一个 ASP.NET Web 应用部署到 Azure
