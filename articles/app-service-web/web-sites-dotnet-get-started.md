<properties
	pageTitle="在 Azure App Service 中创建 ASP.NET Web 应用"
	description="本教程说明如何在 Visual Studio 2013 中创建一个 ASP.NET Web 项目，并将其部署到 Azure App Service 中的 Web 应用。在不到 15 分钟内，你即可在云中启动并运行一个应用程序。"
...
![网站主页](./media/web-sites-dotnet-get-started-vs2013/deployedandazure.png)
...
6. 在“登录到 Azure”对话框中，输入用于管理 Azure 订阅的帐户的 ID 和密码。
	...
	![已登录到 Azure](./media/web-sites-dotnet-get-started-vs2013/configuresitesettings.png)
...
4. 单击“配置”选项卡。
	...
	[配置](/zh-cn/documentation/articles/web-sites-configure//)选项卡可让你控制用于站点的 .NET 版本、启用 [WebSockets](/blog/2013/11/14/introduction-to-websockets-on-windows-azure-web-sites/) 和[诊断日志记录](/zh-cn/documentation/articles/web-sites-enable-diagnostic-log/)等功能、设置[连接字符串值](http://azure.microsoft.com/blog/2013/07/17/windows-azure-web-sites-how-application-strings-and-connection-strings-work/)，等等。[](/zh-cn/documentation/articles/web-sites-configure//)

	![门户网站配置选项卡](./media/web-sites-dotnet-get-started-vs2013/portalconfigure.png)
  
5. 单击“缩放”选项卡。

	对于网站服务的付费层，[缩放](/zh-cn/documentation/articles/web-sites-scale/)选项卡允许你控制为 Web 应用程序提供服务的计算机的大小和数量，以处理流量的变化。[](/zh-cn/documentation/articles/web-sites-scale/)
...
* 如何在 Visual Studio 中管理 Web 应用
	...
	有关可在“服务器资源管理器”中执行的 Web 应用管理功能的信息，请参阅[在 Visual Studio 中对 Azure Web 应用进行故障排除](web-sites-dotnet-troubleshoot-visual-studio.md)。

* 如何对 Web 应用进行故障排除

	Visual Studio 提供了相应的功能使你能够在 Azure 日志生成时轻松实时地对其进行查看。你还可以在 Azure 中采用调试模式远程运行。有关详细信息，请参阅[在 Visual Studio 中对 Azure Web 应用进行故障故障](web-sites-dotnet-troubleshoot-visual-studio.md)。

* 如何添加数据库和授权功能

	有关说明如何访问数据库以及将某些站点功能限制给已授权用户的教程，请参阅[将包含成员资格、OAuth 和 SQL 数据库的安全 ASP.NET MVC 应用程序部署到 Azure 网站](/zh-cn/documentation/articles/web-sites-dotnet-deploy-aspnet-mvc-app-membership-oauth-sql-database)。
