---
title: "在 Azure 中使用 Bottle 的 Python Web 应用"
...
## <a name="web-app-creation-on-the-azure-portal"></a>在 Azure 门户中创建 Web 应用
创建您的应用的第一步是通过 [Azure 门户](https://portal.azure.com)创建 Web 应用。  

1. 登录到 Azure 门户，然后单击左下角的“新建”  按钮。 
2. 在搜索框中，键入“python”。
3. 在搜索结果中，选择“Bottle”，然后单击“创建”。
4. 配置新的 Bottle 应用，如为其创建新的 App Service 计划和新的资源组。 然后单击 **创建**。
