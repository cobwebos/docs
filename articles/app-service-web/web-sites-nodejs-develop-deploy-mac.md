<properties
	pageTitle="在 Azure 网站中创建 Node.js 网站 | Microsoft Azure"
...
* 如何使用 Azure 管理门户在 Azure 网站中创建网站。
...
[Git](http://git-scm.com/) 是一个分布式版本控制系统，可用来部署 Azure 网站。你将在本地 Git 存储库中存储你为网站编写的代码，并通过推送到远程存储库将代码部署到 Azure。这种部署方法是 Azure 网站的一项功能。
...
5. 若要查看你的应用，请在 Azure 管理门户的 **Web Apps** 部分中单击“浏览”按钮。
