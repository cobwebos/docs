<properties
	pageTitle="在 Azure 网站中创建 Node.js Web 应用 | Microsoft Azure"
...
> [AZURE.NOTE]若要完成本教程，您需要一个 Microsoft Azure 帐户。如果你没有帐户，可以[注册试用版](/pricing/1rmb-trial/?WT.mc_id=A261C142F)。
