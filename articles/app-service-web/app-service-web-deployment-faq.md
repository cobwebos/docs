...
description: "获取有关 Azure App Service 的 Web 应用功能的部署常见问题解答。"
...
本文包含有关针对 [Azure App Service 的 Web 应用功能](https://azure.microsoft.com/services/app-service/web/)的部署问题的常见问题 (FAQ) 解答。
