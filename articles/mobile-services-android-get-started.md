...
5. 现在请下载你的应用程序：
	...
	- 较低的应用程序版本使用早期版本的 SDK。若要使用它，请在"下载并运行应用程序"下面单击"下载"。随即将会下载已连接到移动服务的示例待办事项列表应用程序的项目。项目文件已压缩，因此请浏览到它们所在的位置，并在计算机上展开这些文件。
...
4. 如果你下载了 SDK 版本 2.0，则需要使用移动服务的 Url 和密钥更新代码：
	...
	- 	将"AppKey"替换为移动服务的密钥。
	- 	有关详细信息，请查阅教程<a href="/zh-cn/documentation/articles/mobile-services-android-get-started-data/">将移动服务添加到现有应用程序</a>。 
