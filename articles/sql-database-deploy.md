...
5. In Server name, enter the 10-character server name, followed by .database.chinacloudapi.cn.
...
[Getting Started with SQL Database Administration]: /zh-cn/manage/services/sql-databases/getting-started-w-sql-databases/  
