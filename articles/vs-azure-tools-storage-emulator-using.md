...
>[AZURE.NOTE] 存储模拟器的模拟与 Azure 存储空间服务之间在功能上存在一些差异。有关具体差异的信息，请参阅 Azure SDK 文档中的 [Differences Between the Storage Emulator and Azure Storage Services](/documentation/articles/storage-use-emulator)（存储模拟器与 Azure 存储空间服务之间的差异）。
